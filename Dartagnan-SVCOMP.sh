...
if [ $1 == "-v" ] || [ $1 == "--version" ]; then
    ...
    cmd="java -jar svcomp/target/svcomp.jar --method=eager --solver=yices2 $skip_assertions_of_type --svcomp.step=5 --svcomp.umax=27 cat/svcomp.cat --svcomp.property="$propertypath" "$programpath" "$witness
fi
$cmd
