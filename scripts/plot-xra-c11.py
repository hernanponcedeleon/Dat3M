...
cFiles = [
        csvPath + 'TSO-assume-cav19-C11.csv',
        csvPath + 'TSO-assume-xra-C11.csv',
        csvPath + 'TSO-assume-xra-acy-C11.csv',
        csvPath + 'TSO-caat-cav19-C11.csv',
        csvPath + 'TSO-caat-xra-C11.csv',
        csvPath + 'ARM8-assume-cav19-C11.csv',
        csvPath + 'ARM8-assume-xra-C11.csv',
        csvPath + 'ARM8-assume-xra-acy-C11.csv',
        csvPath + 'ARM8-caat-cav19-C11.csv',
        csvPath + 'ARM8-caat-xra-C11.csv',
        csvPath + 'POWER-assume-cav19-C11.csv',
        csvPath + 'POWER-assume-xra-C11.csv',
        csvPath + 'POWER-assume-xra-acy-C11.csv',
        csvPath + 'POWER-caat-cav19-C11.csv',
        csvPath + 'POWER-caat-xra-C11.csv',
        csvPath + 'RISCV-assume-cav19-C11.csv',
        csvPath + 'RISCV-assume-xra-C11.csv',
        csvPath + 'RISCV-assume-xra-acy-C11.csv',
        csvPath + 'RISCV-caat-cav19-C11.csv',
        csvPath + 'RISCV-caat-xra-C11.csv',
]
...
for a in arch:
    ...
    current_df = pd.DataFrame(pd.read_csv(csvPath + a + '-assume-cav19-C11.csv'))
    ...
    stats.loc[mapping_method['assume-cav19'] , 'unknown'] = str(current_df.iloc[:, 2].sum() - current_df.iloc[:, 2].sum()).split(".")[0]
    ...
    current_df = pd.DataFrame(pd.read_csv(csvPath + a + '-assume-xra-C11.csv'))
    ## colums are: benchmark, threads, may-size, must-size, act-size, smt-vars, acyc-size, result, ra_time, xra_time, veri_time
    ...
    stats.loc[mapping_method['assume-xra'], 'unknown'] = str(current_df.iloc[:, 2].sum() - current_df.iloc[:, 2].sum()).split(".")[0]
    ...
    current_df = pd.DataFrame(pd.read_csv(csvPath + a + '-assume-xra-acy-C11.csv'))
    ## colums are: benchmark, threads, may-size, must-size, act-size, smt-vars, acyc-size, result, ra_time, xra_time, veri_time
    ...
    stats.loc[mapping_method['assume-xra-acy'], 'unknown'] = str(current_df.iloc[:, 2].sum() - current_df.iloc[:, 2].sum()).split(".")[0]
    ...
    current_df = pd.DataFrame(pd.read_csv(csvPath + a + '-caat-cav19-C11.csv'))
    ## colums are: benchmark, threads, may-size, must-size, act-size, smt-vars, acyc-size, result, ra_time, xra_time, veri_time
    ...
    stats.loc[mapping_method['caat-cav19'], 'unknown'] = str(current_df.iloc[:, 2].sum() - current_df.iloc[:, 2].sum()).split(".")[0]
    stats.loc[mapping_method['caat-cav19'], 'act-set'] = str(current_df.iloc[:, 4].sum() - current_df.iloc[:, 2].sum()).split(".")[0]
    ...
    current_df = pd.DataFrame(pd.read_csv(csvPath + a + '-caat-xra-C11.csv'))
    ## colums are: benchmark, threads, may-size, must-size, act-size, smt-vars, acyc-size, result, ra_time, xra_time, veri_time
    ...
    stats.loc[mapping_method['caat-xra'], 'unknown'] = str(current_df.iloc[:, 2].sum() - current_df.iloc[:, 2].sum()).split(".")[0]
    stats.loc[mapping_method['caat-xra'], 'act-set'] = str(current_df.iloc[:, 4].sum() - current_df.iloc[:, 2].sum()).split(".")[0]
    ...
    ## Save stats
    stats.to_csv(outputPath + '/csv/' + a + '-Stats-C11.csv', index=True)
