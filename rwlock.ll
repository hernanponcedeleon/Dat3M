; ModuleID = 'benchmarks/progress64/rwlock.c'
source_filename = "benchmarks/progress64/rwlock.c"
...
@.str.4 = private unnamed_addr constant [31 x i8] c"x == NTHREADS && y == NTHREADS\00", align 1
...
16:                                               ; preds = %6
  call void @__assert_rtn(ptr noundef @__func__.p64_rwlock_acquire_rd, ptr noundef @.str, i32 noundef 61, ptr noundef @.str.1) #5
  unreachable
...
41:                                               ; preds = %32
  call void @__assert_rtn(ptr noundef @__func__.wait_for_no, ptr noundef @.str, i32 noundef 49, ptr noundef @.str.5) #5
  unreachable
...
16:                                               ; preds = %6
  call void @__assert_rtn(ptr noundef @__func__.p64_rwlock_acquire_wr, ptr noundef @.str, i32 noundef 114, ptr noundef @.str.1) #5
  unreachable
...
44:                                               ; preds = %35
  call void @__assert_rtn(ptr noundef @__func__.p64_rwlock_acquire_wr, ptr noundef @.str, i32 noundef 126, ptr noundef @.str.2) #5
  unreachable
...
49:                                               ; preds = %43
  call void @__assert_rtn(ptr noundef @__func__.main, ptr noundef @.str.3, i32 noundef 36, ptr noundef @.str.4) #5
  unreachable
