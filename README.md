...
Usage
======
Dat3M comes with a user interface where it is easy the select the tool to use (Dartagnan or Porthos), import, export and modify both the program and the memory model and select the options for the verification engine (see below).
