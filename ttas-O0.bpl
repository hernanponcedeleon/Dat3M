...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/home/Dat3M/include/ -bpl /home/Dat3M/output/ttas-O0.bpl /home/Dat3M/output/ttas_tmp.c
...
const my_lock: ref;
axiom (my_lock == $sub.ref(0, 2056));
const .str: ref;
axiom (.str == $sub.ref(0, 3082));
const {:count 10} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4116));
const {:count 12} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 5152));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 6184));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/ttas_tmp.c", 7, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas_tmp.c", 7, 22} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 3, .str.2);
  assume {:sourceloc "output/ttas_tmp.c", 7, 22} true;
  assume {:verifier.code 0} true;
  assume false;
}
const __assert_fail: ref;
axiom (__assert_fail == $sub.ref(0, 7216));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 8248));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/ttas_tmp.c", 10, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/ttas_tmp.c", 10, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/ttas_tmp.c", 10, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/ttas_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/ttas_tmp.c", 10, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/ttas_tmp.c", 11, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/ttas_tmp.c", 11, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ttas_tmp.c", 11, 27} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 9280));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.dbg.label: ref;
axiom (llvm.dbg.label == $sub.ref(0, 10312));
procedure  llvm.dbg.label($p0: ref);
const lock_init: ref;
axiom (lock_init == $sub.ref(0, 11344));
procedure  lock_init($p0: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "output/ttas_tmp.c", 22, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas_tmp.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32($p0, 0, 5);
  assume {:sourceloc "output/ttas_tmp.c", 23, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_store_explicit: ref;
axiom (atomic_store_explicit == $sub.ref(0, 12376));
procedure  atomic_store_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const lock_acquire: ref;
axiom (lock_acquire == $sub.ref(0, 13408));
procedure  lock_acquire($p0: ref)
{
  var $i1: i32;
  var $i2: i1;
  var $i3: i32;
  var $i4: i1;
$bb0:
  assume {:sourceloc "output/ttas_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/ttas_tmp.c", 27, 9} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "output/ttas_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32($p0, 0);
  assume {:sourceloc "output/ttas_tmp.c", 27, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "output/ttas_tmp.c", 27, 9} true;
...
$bb4:
  assume !(($i2 == 1));
  assume {:sourceloc "output/ttas_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "output/ttas_tmp.c", 28, 13} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_exchange_explicit.ref.i32.i32($p0, 1, 2);
  assume {:sourceloc "output/ttas_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "output/ttas_tmp.c", 28, 5} true;
...
$bb7:
  assume !(($i4 == 1));
  assume {:sourceloc "output/ttas_tmp.c", 29, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_load_explicit: ref;
axiom (atomic_load_explicit == $sub.ref(0, 14440));
procedure  atomic_load_explicit.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const atomic_exchange_explicit: ref;
axiom (atomic_exchange_explicit == $sub.ref(0, 15472));
procedure  atomic_exchange_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const lock_release: ref;
axiom (lock_release == $sub.ref(0, 16504));
procedure  lock_release($p0: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "output/ttas_tmp.c", 32, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas_tmp.c", 32, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32($p0, 0, 3);
  assume {:sourceloc "output/ttas_tmp.c", 33, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 17536));
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/ttas_tmp.c", 37, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas_tmp.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call lock_acquire(my_lock);
  assume {:sourceloc "output/ttas_tmp.c", 38, 6} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, a);
  assume {:sourceloc "output/ttas_tmp.c", 38, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/ttas_tmp.c", 39, 5} true;
  assume {:verifier.code 0} true;
  call lock_release(my_lock);
  assume {:sourceloc "output/ttas_tmp.c", 40, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/ttas_tmp.c", 45, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/ttas_tmp.c", 45, 5} true;
  assume {:verifier.code 0} true;
  call lock_init(my_lock);
  assume true;
  assume true;
  assume {:sourceloc "output/ttas_tmp.c", 49, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/ttas_tmp.c", 50, 9} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ttas_tmp.c", 50, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "output/ttas_tmp.c", 51, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_1, $0.ref);
  assume {:sourceloc "output/ttas_tmp.c", 51, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "output/ttas_tmp.c", 51, 9} true;
...
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "output/ttas_tmp.c", 52, 9} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ttas_tmp.c", 52, 9} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "output/ttas_tmp.c", 54, 22} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "output/ttas_tmp.c", 54, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "output/ttas_tmp.c", 55, 9} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ttas_tmp.c", 55, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "output/ttas_tmp.c", 56, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p1);
  assume {:sourceloc "output/ttas_tmp.c", 56, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "output/ttas_tmp.c", 57, 9} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ttas_tmp.c", 57, 9} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "output/ttas_tmp.c", 59, 23} true;
  assume {:verifier.code 1} true;
  $i12 := $load.i32($M.0, a);
  assume {:sourceloc "output/ttas_tmp.c", 59, 25} true;
  assume {:verifier.code 1} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "output/ttas_tmp.c", 59, 25} true;
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "output/ttas_tmp.c", 59, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i14);
  assume {:sourceloc "output/ttas_tmp.c", 61, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 19600));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 20632));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 21664));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 22696));
...
axiom (__SMACK_dummy == $sub.ref(0, 23728));
...
axiom (__SMACK_and32 == $sub.ref(0, 24760));
...
axiom (__SMACK_and64 == $sub.ref(0, 25792));
...
axiom (__SMACK_and16 == $sub.ref(0, 26824));
...
axiom (__SMACK_and8 == $sub.ref(0, 27856));
...
axiom (__SMACK_or32 == $sub.ref(0, 28888));
...
axiom (__SMACK_or64 == $sub.ref(0, 29920));
...
axiom (__SMACK_or16 == $sub.ref(0, 30952));
...
axiom (__SMACK_or8 == $sub.ref(0, 31984));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 33016));
