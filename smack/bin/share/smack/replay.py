...
def replay_error_trace(verifier_output, args):
  ...
  try_command(['clang-3.9', '-c', '-emit-llvm', '-o', stubs_bc, args.replay_harness])
  try_command(['clang-3.9', '-Wl,-e,_smack_replay_main', '-o', args.replay_exe_file, args.bc_file, stubs_bc])
