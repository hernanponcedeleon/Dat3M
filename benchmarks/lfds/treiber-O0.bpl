...
const TOP: ref;
axiom (TOP == $sub.ref(0, 1032));
const assert_: ref;
axiom (assert_ == $sub.ref(0, 2064));
...
axiom (__VERIFIER_assert == $sub.ref(0, 4128));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/treiber_tmp.c", 23, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/treiber_tmp.c", 23, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/treiber_tmp.c", 23, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/treiber_tmp.c", 23, 95} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/treiber_tmp.c", 23, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/treiber_tmp.c", 23, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/treiber_tmp.c", 23, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/treiber_tmp.c", 23, 83} true;
  assume {:verifier.code 0} true;
...
axiom (reach_error == $sub.ref(0, 6192));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/treiber_tmp.c", 21, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/treiber_tmp.c", 21, 22} true;
  assume {:verifier.code 0} true;
  call assert_(0);
  assume {:sourceloc "output/treiber_tmp.c", 21, 33} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const init: ref;
axiom (init == $sub.ref(0, 7224));
procedure  init()
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "output/treiber_tmp.c", 41, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/treiber_tmp.c", 41, 5} true;
  assume {:verifier.code 0} true;
  call $i0 := atomic_init.ref.ref(TOP, $0.ref);
  assume {:sourceloc "output/treiber_tmp.c", 42, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_init: ref;
axiom (atomic_init == $sub.ref(0, 8256));
procedure  atomic_init.ref.ref(p.0: ref, p.1: ref)
  returns ($r: i32);
const push: ref;
axiom (push == $sub.ref(0, 9288));
procedure  push($i0: i32)
{
  ...
  var $i12: i1;
$bb0:
  assume {:sourceloc "output/treiber_tmp.c", 46, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(8, $zext.i32.i64(1)));
  call {:cexpr "push:arg:e"} boogie_si_record_i32($i0);
  assume true;
  assume {:sourceloc "output/treiber_tmp.c", 46, 9} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(16);
  ...
  assume {:sourceloc "output/treiber_tmp.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "output/treiber_tmp.c", 47, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, $i0);
  assume {:sourceloc "output/treiber_tmp.c", 49, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/treiber_tmp.c", 50, 13} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_load_explicit.ref.i32(TOP, 2);
  assume {:sourceloc "output/treiber_tmp.c", 50, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "output/treiber_tmp.c", 50, 13} true;
  assume {:verifier.code 0} true;
  $p7 := $i2p.i64.ref($i6);
  assume {:sourceloc "output/treiber_tmp.c", 50, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p1, $p7);
  assume {:sourceloc "output/treiber_tmp.c", 51, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/treiber_tmp.c", 51, 9} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_store_explicit.ref.ref.i32($p8, $p9, 0);
  assume {:sourceloc "output/treiber_tmp.c", 53, 13} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(TOP, $p1, $p3, 4, 0);
  assume {:sourceloc "output/treiber_tmp.c", 53, 13} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "output/treiber_tmp.c", 53, 13} true;
...
$bb2:
  assume ($i12 == 1);
  assume {:sourceloc "output/treiber_tmp.c", 54, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i12 == 1));
  ...
  goto $bb1;
$bb4:
  assume {:sourceloc "output/treiber_tmp.c", 57, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const malloc: ref;
axiom (malloc == $sub.ref(0, 10320));
  ...
  returns ($r: i32)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "output/treiber_tmp.c", 62, 5} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "output/treiber_tmp.c", 63, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(TOP, 2);
  assume {:sourceloc "output/treiber_tmp.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $sext.i32.i64($i1);
  assume {:sourceloc "output/treiber_tmp.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $i2p.i64.ref($i2);
  assume {:sourceloc "output/treiber_tmp.c", 63, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p0, $p3);
  assume {:sourceloc "output/treiber_tmp.c", 64, 13} true;
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.0, $p0);
  assume {:sourceloc "output/treiber_tmp.c", 64, 15} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.ref($p4, $0.ref);
  assume {:sourceloc "output/treiber_tmp.c", 64, 13} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "output/treiber_tmp.c", 65, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32(0, 1);
  goto $bb4;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "output/treiber_tmp.c", 67, 17} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.0, $p0);
  assume {:sourceloc "output/treiber_tmp.c", 67, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p11 := $i2p.i64.ref($i10);
  assume {:sourceloc "output/treiber_tmp.c", 68, 17} true;
  assume {:verifier.code 0} true;
  call $i12 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(TOP, $p0, $p11, 4, 0);
  assume {:sourceloc "output/treiber_tmp.c", 68, 17} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "output/treiber_tmp.c", 68, 17} true;
  ...
  goto $bb5, $bb6;
$bb4:
  assume {:sourceloc "output/treiber_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/treiber_tmp.c", 75, 1} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
$bb5:
  assume ($i13 == 1);
  assume {:sourceloc "output/treiber_tmp.c", 70, 17} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i13 == 1));
  ...
  goto $bb8;
$bb7:
  assume {:sourceloc "output/treiber_tmp.c", 74, 12} true;
  assume {:verifier.code 0} true;
  $p14 := $load.ref($M.0, $p0);
  assume {:sourceloc "output/treiber_tmp.c", 74, 15} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p14, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "output/treiber_tmp.c", 74, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, $p15);
  assume {:sourceloc "output/treiber_tmp.c", 74, 5} true;
  assume {:verifier.code 0} true;
  $i6 := $i16;
  goto $bb4;
$bb8:
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/treiber_tmp.c", 83, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/treiber_tmp.c", 83, 2} true;
  assume {:verifier.code 0} true;
  call push(42);
  assume {:sourceloc "output/treiber_tmp.c", 84, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := pop();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/treiber_tmp.c", 86, 22} true;
  assume {:verifier.code 1} true;
  $i2 := $eq.i32($i1, 42);
  assume {:sourceloc "output/treiber_tmp.c", 86, 22} true;
  assume {:verifier.code 1} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "output/treiber_tmp.c", 86, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i3);
  assume {:sourceloc "output/treiber_tmp.c", 88, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/treiber_tmp.c", 95, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/treiber_tmp.c", 95, 2} true;
  assume {:verifier.code 0} true;
  call push(41);
  assume {:sourceloc "output/treiber_tmp.c", 96, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := pop();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/treiber_tmp.c", 98, 22} true;
  assume {:verifier.code 1} true;
  $i2 := $eq.i32($i1, 41);
  assume {:sourceloc "output/treiber_tmp.c", 98, 22} true;
  assume {:verifier.code 1} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "output/treiber_tmp.c", 98, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i3);
  assume {:sourceloc "output/treiber_tmp.c", 100, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/treiber_tmp.c", 107, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call init();
  assume {:sourceloc "output/treiber_tmp.c", 109, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/treiber_tmp.c", 110, 2} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/treiber_tmp.c", 110, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "output/treiber_tmp.c", 111, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "output/treiber_tmp.c", 112, 2} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/treiber_tmp.c", 112, 2} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "output/treiber_tmp.c", 114, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "output/treiber_tmp.c", 114, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "output/treiber_tmp.c", 115, 2} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/treiber_tmp.c", 115, 2} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "output/treiber_tmp.c", 116, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p1);
  assume {:sourceloc "output/treiber_tmp.c", 116, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "output/treiber_tmp.c", 117, 2} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/treiber_tmp.c", 117, 2} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "output/treiber_tmp.c", 119, 11} true;
  assume {:verifier.code 0} true;
  call $i12 := pop();
  call {:cexpr "r"} boogie_si_record_i32($i12);
  assume {:sourceloc "output/treiber_tmp.c", 120, 23} true;
  assume {:verifier.code 1} true;
  $i13 := $eq.i32($i12, $sub.i32(0, 1));
  assume {:sourceloc "output/treiber_tmp.c", 120, 23} true;
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "output/treiber_tmp.c", 120, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i14);
  assume {:sourceloc "output/treiber_tmp.c", 124, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
