...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 25, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 25, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 25, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 25, 95} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 25, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/ms_datCAS_tmp.c", 25, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/ms_datCAS_tmp.c", 25, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ms_datCAS_tmp.c", 25, 83} true;
  assume {:verifier.code 0} true;
...
axiom (reach_error == $sub.ref(0, 7224));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 23, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ms_datCAS_tmp.c", 23, 22} true;
  assume {:verifier.code 0} true;
  call assert_(0);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 23, 33} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const init: ref;
axiom (init == $sub.ref(0, 8256));
procedure  init()
{
  var $p0: ref;
  var $p1: ref;
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 38, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ms_datCAS_tmp.c", 38, 15} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(16);
  ...
  assume {:sourceloc "output/ms_datCAS_tmp.c", 39, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 39, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_init.ref.ref($p2, $0.ref);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.ref(Head, $p1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 41, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_init.ref.ref(Tail, $p1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 42, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
axiom (atomic_init == $sub.ref(0, 10320));
procedure  atomic_init.ref.ref(p.0: ref, p.1: ref)
  returns ($r: i32);
const enqueue: ref;
axiom (enqueue == $sub.ref(0, 11352));
procedure  enqueue($i0: i32)
{
  ...
  var $i23: i1;
$bb0:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 47, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/ms_datCAS_tmp.c", 48, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 48, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, $i0);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 49, 21} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 49, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_init.ref.ref($p4, $0.ref);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 51, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 52, 10} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_load_explicit.ref.i32(Tail, 2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 52, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 52, 10} true;
  assume {:verifier.code 0} true;
  $p8 := $i2p.i64.ref($i7);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 53, 26} true;
  assume {:verifier.code 1} true;
  $i9 := $ne.ref($p8, $0.ref);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 53, 26} true;
  assume {:verifier.code 1} true;
  $i10 := $zext.i1.i32($i9);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 53, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i10);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 54, 10} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p8, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 54, 10} true;
  assume {:verifier.code 0} true;
  call $i12 := atomic_load_explicit.ref.i32($p11, 2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 54, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p14 := $i2p.i64.ref($i13);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 56, 15} true;
  assume {:verifier.code 0} true;
  call $i15 := atomic_load_explicit.ref.i32(Tail, 2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 56, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p17 := $i2p.i64.ref($i16);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 56, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.ref($p8, $p17);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 56, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i18 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 57, 13} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.ref($p14, $0.ref);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 57, 8} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i19 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 58, 5} true;
  assume {:verifier.code 0} true;
  call $i20 := __DAT3M_CAS.ref.ref.ref.i32(Tail, $p8, $p14, 4);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 60, 4} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i19 == 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 61, 9} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p8, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 61, 9} true;
  assume {:verifier.code 0} true;
  call $i22 := __DAT3M_CAS.ref.ref.ref.i32($p21, $p14, $p2, 4);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 61, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb8, $bb9;
$bb7:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 66, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb8:
  assume ($i22 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 62, 9} true;
  assume {:verifier.code 0} true;
  call $i23 := __DAT3M_CAS.ref.ref.ref.i32(Tail, $p8, $p2, 4);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 63, 6} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i22 == 1));
  ...
  goto $bb7;
$bb10:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 68, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_load_explicit: ref;
axiom (atomic_load_explicit == $sub.ref(0, 12384));
procedure  atomic_load_explicit.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const __DAT3M_CAS: ref;
axiom (__DAT3M_CAS == $sub.ref(0, 13416));
procedure  __DAT3M_CAS.ref.ref.ref.i32(p.0: ref, p.1: ref, p.2: ref, p.3: i32)
  returns ($r: i1);
const dequeue: ref;
axiom (dequeue == $sub.ref(0, 14448));
procedure  dequeue()
  returns ($r: i32)
{
  var $i0: i32;
  ...
  var $i19: i32;
$bb0:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 74, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ms_datCAS_tmp.c", 74, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 75, 10} true;
  assume {:verifier.code 0} true;
  call $i0 := atomic_load_explicit.ref.i32(Head, 2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 75, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $sext.i32.i64($i0);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 75, 10} true;
  assume {:verifier.code 0} true;
  $p2 := $i2p.i64.ref($i1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 76, 26} true;
  assume {:verifier.code 1} true;
  $i3 := $ne.ref($p2, $0.ref);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 76, 26} true;
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 76, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i4);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 77, 10} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_load_explicit.ref.i32(Tail, 2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 77, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 77, 10} true;
  assume {:verifier.code 0} true;
  $p7 := $i2p.i64.ref($i6);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 78, 26} true;
  assume {:verifier.code 1} true;
  $i8 := $ne.ref($p7, $0.ref);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 78, 26} true;
  assume {:verifier.code 1} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 78, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i9);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 79, 10} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 79, 10} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_load_explicit.ref.i32($p10, 2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 79, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p13 := $i2p.i64.ref($i12);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 81, 15} true;
  assume {:verifier.code 0} true;
  call $i14 := atomic_load_explicit.ref.i32(Head, 2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 81, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p16 := $i2p.i64.ref($i15);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 81, 12} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.ref($p2, $p16);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 81, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i17 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 82, 13} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.ref($p13, $0.ref);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 82, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  goto $bb5, $bb6;
$bb3:
...
$bb5:
  assume ($i18 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 84, 5} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i32(0, 1);
  goto $bb7;
$bb6:
  assume !(($i18 == 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 87, 14} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.ref($p2, $p7);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 87, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb8, $bb9;
$bb7:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ms_datCAS_tmp.c", 101, 2} true;
  assume {:verifier.code 0} true;
  $r := $i19;
  $exn := false;
  return;
$bb8:
  assume ($i20 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 88, 6} true;
  assume {:verifier.code 0} true;
  call $i21 := __DAT3M_CAS.ref.ref.ref.i32(Tail, $p7, $p13, 4);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 90, 5} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i20 == 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 91, 21} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p13, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 91, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i32($M.0, $p22);
  call {:cexpr "result"} boogie_si_record_i32($i23);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 92, 10} true;
  assume {:verifier.code 0} true;
  call $i24 := __DAT3M_CAS.ref.ref.ref.i32(Head, $p2, $p13, 4);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 92, 10} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i24 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 94, 25} true;
  assume {:verifier.code 0} true;
  $i19 := $i23;
  goto $bb7;
$bb12:
  ...
  goto $bb10;
$bb13:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 98, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
}
const worker_1: ref;
axiom (worker_1 == $sub.ref(0, 15480));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 111, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ms_datCAS_tmp.c", 111, 2} true;
  assume {:verifier.code 0} true;
  call enqueue(42);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 112, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 114, 22} true;
  assume {:verifier.code 1} true;
  $i2 := $ne.i32($i1, $sub.i32(0, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 114, 22} true;
  assume {:verifier.code 1} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 114, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i3);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 116, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const worker_2: ref;
axiom (worker_2 == $sub.ref(0, 16512));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/ms_datCAS_tmp.c", 123, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ms_datCAS_tmp.c", 123, 2} true;
  assume {:verifier.code 0} true;
  call enqueue(41);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 124, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 126, 22} true;
  assume {:verifier.code 1} true;
  $i2 := $ne.i32($i1, $sub.i32(0, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 126, 22} true;
  assume {:verifier.code 1} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 126, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i3);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 128, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/ms_datCAS_tmp.c", 136, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call init();
  assume {:sourceloc "output/ms_datCAS_tmp.c", 138, 7} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_create($p0, $0.ref, worker_1, $0.ref);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 138, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 138, 7} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 139, 2} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ms_datCAS_tmp.c", 139, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 140, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 141, 2} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ms_datCAS_tmp.c", 141, 2} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 143, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 143, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 144, 2} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ms_datCAS_tmp.c", 144, 2} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 145, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 145, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 146, 2} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/ms_datCAS_tmp.c", 146, 2} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 148, 11} true;
  assume {:verifier.code 0} true;
  call $i12 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i12);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 149, 23} true;
  assume {:verifier.code 1} true;
  $i13 := $eq.i32($i12, $sub.i32(0, 1));
  assume {:sourceloc "output/ms_datCAS_tmp.c", 149, 23} true;
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 149, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i14);
  assume {:sourceloc "output/ms_datCAS_tmp.c", 153, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_and32 == $sub.ref(0, 23736));
...
axiom (__SMACK_and64 == $sub.ref(0, 24768));
...
axiom (__SMACK_and16 == $sub.ref(0, 25800));
...
axiom (__SMACK_and8 == $sub.ref(0, 26832));
...
axiom (__SMACK_or32 == $sub.ref(0, 27864));
...
axiom (__SMACK_or64 == $sub.ref(0, 28896));
...
axiom (__SMACK_or16 == $sub.ref(0, 29928));
...
axiom (__SMACK_or8 == $sub.ref(0, 30960));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 31992));
...
axiom (llvm.dbg.value == $sub.ref(0, 37152));
