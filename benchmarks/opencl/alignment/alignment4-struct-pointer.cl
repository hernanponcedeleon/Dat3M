// clang -x cl -cl-std=CL2.0 -target spir-unknown-unknown -fno-discard-value-names -cl-opt-disable -emit-llvm -c alignment4-struct-pointer.cl -o a.bc
// llvm-spirv a.bc -o a.spv
// spirv-dis a.spv > alignment4-struct-pointer.spvasm

// clspv -O0 alignment4-struct-pointer.cl --cl-std=CL2.0 --inline-entry-points --spv-version=1.6
// spirv-opt --upgrade-memory-model -o a.opt.spv a.spv
// spirv-dis a.opt.spv > alignment4-struct-pointer.spvasm
