...
define dso_local i32 @main() #0 !dbg !166 {
  ...
  call void @llvm.dbg.declare(metadata [6 x i64]* %2, metadata !169, metadata !DIExpression()), !dbg !176
...
!170 = !DICompositeType(tag: DW_TAG_array_type, baseType: !171, size: 384, elements: !174)
