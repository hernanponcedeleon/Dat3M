...
70:                                               ; preds = %63
  call void @__assert_rtn(ptr noundef @__func__.main, ptr noundef @.str, i32 noundef 80, ptr noundef @.str.1) #7
  unreachable
...
define internal ptr @ck_pr_md_load_ptr(ptr noundef %0) #0 {
  ...
  %5 = call i64 asm sideeffect "ldr $0, [$1]\0A", "=r,r,~{memory}"(ptr %4) #8, !srcloc !14
...
define internal zeroext i1 @ck_pr_cas_ptr_value(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3) #0 {
  ...
  %14 = call { ptr, ptr } asm sideeffect "1:\0Aldxr $0, [$2]\0Acmp  $0, $4\0Ab.ne 2f\0Astxr ${1:w}, $3, [$2]\0Acbnz ${1:w}, 1b\0A2:", "=&r,=&r,r,r,r,~{memory},~{cc}"(ptr %11, ptr %12, ptr %13) #8, !srcloc !15
...
define internal void @ck_pr_fence_strict_store() #0 {
  call void asm sideeffect "dmb ishst", "r,~{memory}"(i32 0) #8, !srcloc !16
  ret void
}
...
!13 = distinct !{!13, !7}
!14 = !{i64 2148649329}
!15 = !{i64 2148670752, i64 2148670802, i64 2148670869, i64 2148670935, i64 2148670988, i64 2148671060, i64 2148671118}
!16 = !{i64 2148646565}
!17 = !{i64 2148647108}
