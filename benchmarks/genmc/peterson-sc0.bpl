...
// via /usr/local/bin/smack -q -t --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include -bpl benchmarks/genmc/peterson-sc0.bpl benchmarks/genmc/peterson-sc0.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54674));
...
const flag1: ref;
axiom (flag1 == $sub.ref(0, 1025));
const turn: ref;
axiom (turn == $sub.ref(0, 2053));
const flag2: ref;
axiom (flag2 == $sub.ref(0, 3078));
const x: ref;
axiom (x == $sub.ref(0, 4103));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 5141));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 6173));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 7200));
const {:count 14} .str.15: ref;
axiom (.str.15 == $sub.ref(0, 8238));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 9266));
const assert_: ref;
axiom (assert_ == $sub.ref(0, 10298));
...
axiom (llvm.dbg.declare == $sub.ref(0, 11330));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 12362));
procedure  __VERIFIER_assert($i0: i32);
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 13394));
  ...
  returns ($r: ref)
{
  ...
  var $i14: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 16, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 16, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(flag1, 1, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 17, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(turn, 1, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 19, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(flag2, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 19, 74} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 19, 79} true;
  assume {:verifier.code 0} true;
  $i5 := 1;
...
$bb2:
  ...
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 19, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i8);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_store_explicit.ref.i32.i32(x, 0, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 24, 12} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_load_explicit.ref.i32(x, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 24, 59} true;
  assume {:verifier.code 0} true;
  $i11 := $sle.i32($i10, 0);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 24, 59} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i12);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := atomic_load_explicit.ref.i32(x, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 28, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := atomic_store_explicit.ref.i32.i32(flag1, 0, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 29, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 20, 15} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_load_explicit.ref.i32(turn, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 20, 65} true;
  assume {:verifier.code 1} true;
  $i7 := $ne.i32($i6, 1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 19, 79} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i14: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 34, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 34, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(flag2, 1, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 35, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(turn, 0, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 37, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(flag1, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 37, 74} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 37, 79} true;
  assume {:verifier.code 0} true;
  $i5 := 1;
  assume {:branchcond $i4} true;
  goto $bb1, $bb3;
...
$bb2:
  ...
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 37, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i8);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 41, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_store_explicit.ref.i32.i32(x, 1, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 42, 12} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_load_explicit.ref.i32(x, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 42, 59} true;
  assume {:verifier.code 0} true;
  $i11 := $sge.i32($i10, 1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 42, 59} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 42, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i12);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 43, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := atomic_load_explicit.ref.i32(x, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 46, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := atomic_store_explicit.ref.i32.i32(flag2, 0, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 38, 15} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_load_explicit.ref.i32(turn, 5);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 38, 65} true;
  assume {:verifier.code 1} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 37, 79} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 54, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 55, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 55, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 56, 6} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 57, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 57, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 59, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 59, 6} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 60, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 60, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 61, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 61, 6} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 62, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 62, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson-sc0.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 18554));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const abort: ref;
axiom (abort == $sub.ref(0, 19586));
procedure  abort();
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 20618));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 21650));
...
axiom (__SMACK_code == $sub.ref(0, 22682));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 23714));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 24746));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 25778));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 26810));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 27842));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 28874));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 29906));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 30938));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 31970));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 33002));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 34034));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 35066));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 36098));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 37130));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 38162));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 39194));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 40226));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 41258));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 42290));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 43322));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 44354));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 45386));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 46418));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 47450));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 48482));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 49514));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 50546));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 51578));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 52610));
...
axiom (llvm.dbg.value == $sub.ref(0, 53642));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54674));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i8($M.0, flag1, 0);
  call {:cexpr "flag1"} boogie_si_record_i8(0);
  $M.0 := $store.i32($M.0, turn, 0);
  call {:cexpr "turn"} boogie_si_record_i32(0);
  $M.0 := $store.i8($M.0, flag2, 0);
  call {:cexpr "flag2"} boogie_si_record_i8(0);
  $M.0 := $store.i8($M.0, x, 0);
