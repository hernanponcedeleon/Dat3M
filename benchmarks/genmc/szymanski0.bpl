...
// via /usr/local/bin/smack -q -t --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include -bpl benchmarks/genmc/szymanski0.bpl benchmarks/genmc/szymanski0.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54687));
...
const flag1: ref;
axiom (flag1 == $sub.ref(0, 1028));
const flag2: ref;
axiom (flag2 == $sub.ref(0, 2056));
const x: ref;
axiom (x == $sub.ref(0, 3084));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4122));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 5154));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 6181));
const {:count 14} .str.15: ref;
axiom (.str.15 == $sub.ref(0, 7219));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 8247));
const assert_: ref;
axiom (assert_ == $sub.ref(0, 9279));
...
axiom (llvm.dbg.declare == $sub.ref(0, 10311));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 11343));
procedure  __VERIFIER_assert($i0: i32);
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 12375));
  ...
  returns ($r: ref)
{
  ...
  var $i32: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 23, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(flag1, 1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 25, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(flag2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 25, 74} true;
  assume {:verifier.code 1} true;
  $i4 := $slt.i32($i3, 3);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 25, 74} true;
  assume {:verifier.code 1} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 25, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_store_explicit.ref.i32.i32(flag1, 3, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 28, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 29, 9} true;
  assume {:verifier.code 0} true;
  call $i8 := atomic_load_explicit.ref.i32(flag2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 29, 60} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 29, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i9 == 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 30, 9} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_store_explicit.ref.i32.i32(flag1, 2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 31, 9} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 32, 27} true;
  assume {:verifier.code 0} true;
  call $i12 := atomic_load_explicit.ref.i32(flag2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 32, 78} true;
  assume {:verifier.code 1} true;
  $i13 := $eq.i32($i12, 4);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 32, 78} true;
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 32, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i14);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 33, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 29, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 35, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := atomic_store_explicit.ref.i32.i32(flag1, 4, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 36, 5} true;
  assume {:verifier.code 0} true;
  call $i16 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 37, 23} true;
  assume {:verifier.code 0} true;
  call $i17 := atomic_load_explicit.ref.i32(flag2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 37, 74} true;
  assume {:verifier.code 1} true;
  $i18 := $slt.i32($i17, 2);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 37, 74} true;
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 37, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i19);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 40, 5} true;
  assume {:verifier.code 0} true;
  call $i20 := atomic_store_explicit.ref.i32.i32(x, 0, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 41, 5} true;
  assume {:verifier.code 0} true;
  call $i21 := atomic_load_explicit.ref.i32(x, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 42, 12} true;
  assume {:verifier.code 0} true;
  call $i22 := atomic_load_explicit.ref.i32(x, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 42, 59} true;
  assume {:verifier.code 0} true;
  $i23 := $sle.i32($i22, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 42, 59} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i32($i23);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 42, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i24);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 43, 5} true;
  assume {:verifier.code 0} true;
  call $i25 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 46, 27} true;
  assume {:verifier.code 0} true;
  call $i26 := atomic_load_explicit.ref.i32(flag2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 46, 25} true;
  assume {:verifier.code 0} true;
  $i27 := $sgt.i32(2, $i26);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 46, 78} true;
  assume {:verifier.code 0} true;
  $i28 := 1;
...
$bb5:
  ...
  assume {:verifier.code 1} true;
  $i31 := $zext.i1.i32($i28);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 46, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i31);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 48, 5} true;
  assume {:verifier.code 0} true;
  call $i32 := atomic_store_explicit.ref.i32.i32(flag1, 0, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 49, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb6:
  assume !(($i27 == 1));
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 47, 15} true;
  assume {:verifier.code 0} true;
  call $i29 := atomic_load_explicit.ref.i32(flag2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 47, 66} true;
  assume {:verifier.code 1} true;
  $i30 := $sgt.i32($i29, 3);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 46, 78} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i32: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 54, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 54, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(flag2, 1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 55, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 56, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(flag1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 56, 74} true;
  assume {:verifier.code 1} true;
  $i4 := $slt.i32($i3, 3);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 56, 74} true;
  assume {:verifier.code 1} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 56, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 58, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_store_explicit.ref.i32.i32(flag2, 3, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 59, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 60, 9} true;
  assume {:verifier.code 0} true;
  call $i8 := atomic_load_explicit.ref.i32(flag1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 60, 60} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 60, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i9 == 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 61, 9} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_store_explicit.ref.i32.i32(flag2, 2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 62, 9} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 63, 27} true;
  assume {:verifier.code 0} true;
  call $i12 := atomic_load_explicit.ref.i32(flag1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 63, 78} true;
  assume {:verifier.code 1} true;
  $i13 := $eq.i32($i12, 4);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 63, 78} true;
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 63, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i14);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 64, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 60, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 66, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := atomic_store_explicit.ref.i32.i32(flag2, 4, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 67, 5} true;
  assume {:verifier.code 0} true;
  call $i16 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 68, 23} true;
  assume {:verifier.code 0} true;
  call $i17 := atomic_load_explicit.ref.i32(flag1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 68, 74} true;
  assume {:verifier.code 1} true;
  $i18 := $slt.i32($i17, 2);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 68, 74} true;
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 68, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i19);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 71, 5} true;
  assume {:verifier.code 0} true;
  call $i20 := atomic_store_explicit.ref.i32.i32(x, 1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 72, 5} true;
  assume {:verifier.code 0} true;
  call $i21 := atomic_load_explicit.ref.i32(x, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 73, 12} true;
  assume {:verifier.code 0} true;
  call $i22 := atomic_load_explicit.ref.i32(x, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 73, 59} true;
  assume {:verifier.code 0} true;
  $i23 := $sge.i32($i22, 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 73, 59} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i32($i23);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 73, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i24);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call $i25 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 77, 27} true;
  assume {:verifier.code 0} true;
  call $i26 := atomic_load_explicit.ref.i32(flag1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 77, 25} true;
  assume {:verifier.code 0} true;
  $i27 := $sgt.i32(2, $i26);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 77, 78} true;
  assume {:verifier.code 0} true;
  $i28 := 1;
  assume {:branchcond $i27} true;
  goto $bb4, $bb6;
...
$bb5:
  ...
  assume {:verifier.code 1} true;
  $i31 := $zext.i1.i32($i28);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 77, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i31);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 79, 5} true;
  assume {:verifier.code 0} true;
  call $i32 := atomic_store_explicit.ref.i32.i32(flag2, 0, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 80, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb6:
  assume !(($i27 == 1));
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 78, 15} true;
  assume {:verifier.code 0} true;
  call $i29 := atomic_load_explicit.ref.i32(flag1, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 78, 66} true;
  assume {:verifier.code 1} true;
  $i30 := $sgt.i32($i29, 3);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 77, 78} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 87, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 87, 6} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_create($p0, $0.ref, thread_1, $0.ref);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 87, 6} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 87, 6} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 88, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 88, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 89, 6} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 89, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 89, 6} true;
...
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 90, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 90, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 92, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 92, 6} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 93, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 93, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 94, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 94, 6} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 95, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 95, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "benchmarks/genmc/szymanski0.c", 100, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 18567));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const abort: ref;
axiom (abort == $sub.ref(0, 19599));
procedure  abort();
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 20631));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 21663));
...
axiom (__SMACK_code == $sub.ref(0, 22695));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 23727));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 24759));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 25791));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 26823));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 27855));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 28887));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 29919));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 30951));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 31983));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 33015));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 34047));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 35079));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 36111));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 37143));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 38175));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 39207));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 40239));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 41271));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 42303));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 43335));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 44367));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 45399));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 46431));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 47463));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 48495));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 49527));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 50559));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 51591));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 52623));
...
axiom (llvm.dbg.value == $sub.ref(0, 53655));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54687));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, flag1, 0);
  call {:cexpr "flag1"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, flag2, 0);
  call {:cexpr "flag2"} boogie_si_record_i32(0);
