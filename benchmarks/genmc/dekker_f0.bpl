...
// via /usr/local/bin/smack -q -t --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include -bpl benchmarks/genmc/dekker_f0.bpl benchmarks/genmc/dekker_f0.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 53655));
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 12, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 12, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(y, 1, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 13, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 14, 10} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(x, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 14, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 18, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_store_explicit.ref.i32.i32(c, 1, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 16, 16} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_load_explicit.ref.i32(c, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 16, 63} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 1);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 16, 63} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call assert_($i8);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 17, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 23, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 25, 10} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(y, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 25, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 25, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb3;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 29, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 26, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_store_explicit.ref.i32.i32(c, 0, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 27, 16} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_load_explicit.ref.i32(c, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 27, 63} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 27, 63} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 27, 9} true;
  assume {:verifier.code 0} true;
  call assert_($i8);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 36, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 37, 9} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 37, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 38, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 39, 9} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 39, 9} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/genmc/dekker_f0.c", 41, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 20631));
...
axiom (__SMACK_code == $sub.ref(0, 21663));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 22695));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 23727));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 24759));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 25791));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 26823));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 27855));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 28887));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 29919));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 30951));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 31983));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 33015));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 34047));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 35079));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 36111));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 37143));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 38175));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 39207));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 40239));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 41271));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 42303));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 43335));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 44367));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 45399));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 46431));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 47463));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 48495));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 49527));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 50559));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 51591));
...
axiom (llvm.dbg.value == $sub.ref(0, 52623));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 53655));
