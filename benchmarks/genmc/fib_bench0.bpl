...
// via /usr/local/bin/smack -q -t --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include -bpl benchmarks/genmc/fib_bench0.bpl benchmarks/genmc/fib_bench0.c
...
axiom (.str.15 == $sub.ref(0, 6191));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 7219));
const assert_: ref;
axiom (assert_ == $sub.ref(0, 8251));
...
axiom (__VERIFIER_assert == $sub.ref(0, 10315));
procedure  __VERIFIER_assert($i0: i32);
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 11347));
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 14, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 14, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 14, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 15, 22} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(x, 2);
  call {:cexpr "prev_x"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 16, 22} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_load_explicit.ref.i32(y, 2);
  call {:cexpr "prev_y"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 17, 42} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i3, $i4);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 17, 9} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_store_explicit.ref.i32.i32(x, $i5, 3);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 14, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 24, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 24, 10} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 24, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 24, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 25, 22} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(x, 2);
  call {:cexpr "prev_x"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 26, 22} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_load_explicit.ref.i32(y, 2);
  call {:cexpr "prev_y"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 27, 42} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i3, $i4);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 27, 9} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_store_explicit.ref.i32.i32(y, $i5, 3);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 29, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 24, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 24, 5} true;
...
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 15475));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 34, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 34, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(x, 2);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 34, 56} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i1, 144);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 34, 62} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb3;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 36, 9} true;
  assume {:verifier.code 0} true;
  call assert_(0);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 36, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 35, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(y, 2);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 35, 56} true;
  assume {:verifier.code 0} true;
  $i4 := $sgt.i32($i3, 144);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 34, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 37, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 44, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 45, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 46, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread_3, $0.ref);
  assume {:sourceloc "benchmarks/genmc/fib_bench0.c", 48, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 17539));
