...
// via /usr/local/bin/smack -q -t --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include -bpl benchmarks/genmc/peterson0.bpl benchmarks/genmc/peterson0.c
  ...
  returns ($r: ref)
{
  ...
  var $i14: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 16, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 16, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(flag1, 1, 3);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 17, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(turn, 1, 3);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 19, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(flag2, 2);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 19, 74} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 19, 79} true;
  assume {:verifier.code 0} true;
  $i5 := 1;
...
$bb2:
  ...
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 19, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i8);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_store_explicit.ref.i32.i32(x, 0, 3);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 24, 12} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_load_explicit.ref.i32(x, 2);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 24, 59} true;
  assume {:verifier.code 0} true;
  $i11 := $sle.i32($i10, 0);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 24, 59} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i12);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := atomic_load_explicit.ref.i32(x, 2);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 28, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := atomic_store_explicit.ref.i32.i32(flag1, 0, 3);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 29, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 20, 15} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_load_explicit.ref.i32(turn, 2);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 20, 65} true;
  assume {:verifier.code 1} true;
  $i7 := $ne.i32($i6, 1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 19, 79} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i14: i32;
$bb0:
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 34, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 34, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(flag2, 1, 3);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 35, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(turn, 0, 3);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 37, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(flag1, 2);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 37, 74} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 37, 79} true;
  assume {:verifier.code 0} true;
  $i5 := 1;
  assume {:branchcond $i4} true;
  goto $bb1, $bb3;
...
$bb2:
  ...
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 37, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i8);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 41, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_store_explicit.ref.i32.i32(x, 1, 3);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 42, 12} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_load_explicit.ref.i32(x, 2);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 42, 59} true;
  assume {:verifier.code 0} true;
  $i11 := $sge.i32($i10, 1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 42, 59} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 42, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i12);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 43, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := atomic_load_explicit.ref.i32(x, 2);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 46, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := atomic_store_explicit.ref.i32.i32(flag2, 0, 3);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 38, 15} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_load_explicit.ref.i32(turn, 2);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 38, 65} true;
  assume {:verifier.code 1} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 37, 79} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 54, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 55, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 55, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 56, 6} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 57, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 57, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 59, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 59, 6} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 60, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 60, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 61, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 61, 6} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 62, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 62, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "benchmarks/genmc/peterson0.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
