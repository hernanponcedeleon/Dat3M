...
public class ProgramParser {
    ...
    public List < List <ParserEvent> > threads;
    public List <ParserEvent> events;
    ...
    public String print_program()
    {
        ...
        for( String event_str : program_str.split("\n") ) {
            ParserEvent event = new ParserEvent( event_str );
