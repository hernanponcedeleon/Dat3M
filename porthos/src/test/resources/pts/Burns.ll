; ModuleID = 'benchmarks/Burns.c'
source_filename = "benchmarks/Burns.c"
...
@.str.1 = private unnamed_addr constant [19 x i8] c"benchmarks/Burns.c\00", align 1
...
; <label>:22:                                     ; preds = %18, %2
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 40, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
