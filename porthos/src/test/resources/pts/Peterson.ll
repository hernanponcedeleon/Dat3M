; ModuleID = 'benchmarks/Peterson.c'
source_filename = "benchmarks/Peterson.c"
...
@.str.1 = private unnamed_addr constant [22 x i8] c"benchmarks/Peterson.c\00", align 1
...
; <label>:22:                                     ; preds = %18, %2
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 41, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
