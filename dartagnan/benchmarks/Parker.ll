...
@.str.1 = private unnamed_addr constant [9 x i8] c"Parker.c\00", align 1
...
; <label>:9:                                      ; preds = %6
  %10 = load i32, i32* @parkCounter, align 4
  store i32 %10, i32* %4, align 4
  store i32 0, i32* @parkCounter, align 4
  %11 = load i32, i32* @cond, align 4
...
define i8* @thrd1(i8*) #0 {
  ...
  store i32 1, i32* @parkCounter, align 4
  ret i8* null
}
...
; <label>:22:                                     ; preds = %18, %2
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), i32 33, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
