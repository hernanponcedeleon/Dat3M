...
do
   ...
   timeout 600 java porthos/Porthos -s arm -t power -i $file -state
...
#   timeout 600 herd7 -model ~/Documents/Projects/Memory-Models/herd/power.cat $file
#   timeout 600 herd7 -model ~/Documents/Projects/Memory-Models/herd/arm.cat $file
