...
public class LitmusParser extends Parser {
	...
	public static final String[] tokenNames = {
		...
		"'.'", "'PPC'", "'LC'", "'EBX'", "':'", "'MOV'", "'['", "'r1'", "'|'", 
		"'EDX'", "'>'", "'r6'", "'_'", "'xor'", "',0'", "'!'", "'%'", "'mr'", 
		"'lwz'", "'r10'", "')'", "'stw'", "'r14'", "'/\\'", "'-'", "ARCH", "X86", 
		"POWER", "LETTER", "DIGIT", "'~'", "SYMBOL", "WS", "'lwsync'", "'sync'", 
		"'isync'"
	};
	public static final int
	...
	public final ProgramContext program(String name) throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__67) | (1L << T__66) | (1L << T__65) | (1L << T__64) | (1L << T__62) | (1L << T__61) | (1L << T__60) | (1L << T__59) | (1L << T__58) | (1L << T__57) | (1L << T__56) | (1L << T__55) | (1L << T__54) | (1L << T__52) | (1L << T__51) | (1L << T__50) | (1L << T__49) | (1L << T__48) | (1L << T__46) | (1L << T__45) | (1L << T__44) | (1L << T__43) | (1L << T__42) | (1L << T__41) | (1L << T__38) | (1L << T__37) | (1L << T__36) | (1L << T__34) | (1L << T__32) | (1L << T__31) | (1L << T__30) | (1L << T__29) | (1L << T__28) | (1L << T__27) | (1L << T__26) | (1L << T__24) | (1L << T__23) | (1L << T__21) | (1L << T__20) | (1L << T__18) | (1L << T__17) | (1L << T__16) | (1L << T__15) | (1L << T__14) | (1L << T__13) | (1L << T__12) | (1L << T__10) | (1L << T__9) | (1L << T__8))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (T__5 - 65)) | (1L << (T__4 - 65)) | (1L << (T__2 - 65)) | (1L << (T__0 - 65)) | (1L << (LETTER - 65)) | (1L << (DIGIT - 65)) | (1L << (SYMBOL - 65)) | (1L << (LWSYNC - 65)) | (1L << (SYNC - 65)) | (1L << (ISYNC - 65)))) != 0)) {
				{
				{
				setState(50); text();
				}
			...
			do {
				...
				case 1:
					{
					setState(57); ((ProgramContext)_localctx).l = location();
					setState(58); match(T__66);
					setState(59); match(DIGIT);
					setState(60); match(T__36);
				...
				case 2:
					...
					setState(69); ((ProgramContext)_localctx).thrd = match(DIGIT);
					setState(70); match(T__20);
					setState(71); ((ProgramContext)_localctx).r = registerPower();
					setState(72); match(T__66);
					setState(78);
					switch (_input.LA(1)) {
					case LETTER:
						{
						setState(73); ((ProgramContext)_localctx).l = location();
					...
					case DIGIT:
						{
						setState(76); ((ProgramContext)_localctx).d = match(DIGIT);
			...
			setState(87); ((ProgramContext)_localctx).threadsList = threads();
			...
			while (_la==T__25 || _la==MONIO) {
				...
				case LETTER:
					{
					setState(109); ((ProgramContext)_localctx).l = location();
					setState(110); match(T__66);
					setState(111); ((ProgramContext)_localctx).value = match(DIGIT);
				...
				case DIGIT:
					{
					setState(114); ((ProgramContext)_localctx).thrd = match(DIGIT);
					setState(115); match(T__20);
					setState(116); ((ProgramContext)_localctx).r = registerPower();
					setState(117); match(T__66);
					setState(118); ((ProgramContext)_localctx).value = match(DIGIT);
				...
				while (_la==T__33 || _la==T__1) {
					...
					case 1:
						{
						setState(123); bop();
						setState(124); ((ProgramContext)_localctx).l = location();
						setState(125); match(T__66);
						setState(126); ((ProgramContext)_localctx).value = match(DIGIT);
					...
					case 2:
						{
						setState(129); bop();
						setState(130); ((ProgramContext)_localctx).thrd = match(DIGIT);
						setState(131); match(T__20);
						setState(132); ((ProgramContext)_localctx).r = registerPower();
						setState(133); match(T__66);
						setState(134); ((ProgramContext)_localctx).value = match(DIGIT);
		...
		try {
			...
			do {
				...
				case 1:
					...
					setState(161);
					_la = _input.LA(1);
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__67) | (1L << T__66) | (1L << T__65) | (1L << T__64) | (1L << T__62) | (1L << T__61) | (1L << T__60) | (1L << T__59) | (1L << T__58) | (1L << T__57) | (1L << T__56) | (1L << T__55) | (1L << T__54) | (1L << T__52) | (1L << T__51) | (1L << T__50) | (1L << T__49) | (1L << T__48) | (1L << T__46) | (1L << T__45) | (1L << T__44) | (1L << T__43) | (1L << T__42) | (1L << T__41) | (1L << T__38) | (1L << T__37) | (1L << T__36) | (1L << T__34) | (1L << T__32) | (1L << T__31) | (1L << T__30) | (1L << T__29) | (1L << T__28) | (1L << T__27) | (1L << T__26) | (1L << T__24) | (1L << T__23) | (1L << T__21) | (1L << T__20) | (1L << T__18) | (1L << T__17) | (1L << T__16) | (1L << T__15) | (1L << T__14) | (1L << T__13) | (1L << T__12) | (1L << T__10) | (1L << T__9) | (1L << T__8))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (T__5 - 65)) | (1L << (T__4 - 65)) | (1L << (T__2 - 65)) | (1L << (T__0 - 65)) | (1L << (LETTER - 65)) | (1L << (DIGIT - 65)) | (1L << (SYMBOL - 65)) | (1L << (LWSYNC - 65)) | (1L << (SYNC - 65)) | (1L << (ISYNC - 65)))) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					consume();
					}
	...
	public final LocationContext location() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(173); ((LocationContext)_localctx).l = match(LETTER);
			setState(177);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==LETTER || _la==DIGIT) {
	...
	public final LocationX86Context locationX86() throws RecognitionException {
		...
		try {
			...
			setState(183); ((LocationX86Context)_localctx).l = location();
			setState(184); match(T__50);
	...
	public final RegisterPowerContext registerPower() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__67) | (1L << T__64) | (1L << T__62) | (1L << T__56) | (1L << T__46) | (1L << T__44) | (1L << T__42) | (1L << T__38) | (1L << T__31) | (1L << T__29) | (1L << T__27) | (1L << T__17) | (1L << T__13))) != 0) || _la==T__5 || _la==T__2) ) {
	...
	public final RegisterX86Context registerX86() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__54) | (1L << T__51) | (1L << T__21) | (1L << T__15))) != 0)) ) {
	...
	public final ThreadsContext threads() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(193); ((ThreadsContext)_localctx).mainThread = word();
			...
			do {
				...
				case 1:
					{
					{
					setState(207); ((ThreadsContext)_localctx).t1 = inst(thread.toString());
					...
					while (_la==T__16) {
						...
						case ISYNC:
							{
							setState(211); ((ThreadsContext)_localctx).t2 = inst(thread.toString());
							}
							break;
						case WS:
							{
	...
	public final InstContext inst(String mainThread) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(231); ((InstContext)_localctx).t1 = localX86(mainThread);
			...
			case 3:
				...
				{
				setState(234); ((InstContext)_localctx).t2 = loadX86(mainThread);
			...
			case 4:
				...
				{
				setState(237); ((InstContext)_localctx).t3 = storeX86(mainThread);
			...
			case 5:
				...
				{
				setState(240); ((InstContext)_localctx).t4 = mfence();
			...
			case 6:
				...
				{
				setState(243); ((InstContext)_localctx).t5 = localPower(mainThread);
			...
			case 7:
				...
				{
				setState(246); ((InstContext)_localctx).t6 = loadPower(mainThread);
			...
			case 8:
				...
				{
				setState(249); ((InstContext)_localctx).t7 = storePower(mainThread);
			...
			case 9:
				...
				{
				setState(252); ((InstContext)_localctx).t8 = isync();
			...
			case 10:
				...
				{
				setState(255); ((InstContext)_localctx).t9 = sync();
			...
			case 11:
				...
				{
				setState(258); ((InstContext)_localctx).t10 = lwsync();
			...
			case 12:
				...
				{
				setState(261); ((InstContext)_localctx).t11 = xor(mainThread);
			...
			case 13:
				...
				{
				setState(264); ((InstContext)_localctx).t12 = addi(mainThread);
			...
			case 14:
				...
				{
				setState(267); ((InstContext)_localctx).t13 = mr(mainThread);
			...
			case 15:
				...
				{
				setState(270); ((InstContext)_localctx).t14 = cmpw(mainThread);
	...
	public final LocalX86Context localX86(String mainThread) throws RecognitionException {
		...
		try {
			...
			setState(283); ((LocalX86Context)_localctx).r = registerX86();
			setState(284); match(T__39);
			setState(285); ((LocalX86Context)_localctx).d = match(DIGIT);
	...
	public final LocalPowerContext localPower(String mainThread) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(288); match(T__49);
			setState(289); ((LocalPowerContext)_localctx).r = registerPower();
			setState(290); match(T__57);
			setState(291); ((LocalPowerContext)_localctx).d = match(DIGIT);
	...
	public final XorContext xor(String mainThread) throws RecognitionException {
		...
		try {
			...
			setState(295); ((XorContext)_localctx).r1 = registerPower();
			setState(296); match(T__57);
			setState(297); ((XorContext)_localctx).r2 = registerPower();
			setState(298); match(T__57);
			setState(299); ((XorContext)_localctx).r3 = registerPower();
	...
	public final AddiContext addi(String mainThread) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(302); match(T__63);
			setState(303); ((AddiContext)_localctx).r1 = registerPower();
			setState(304); match(T__57);
			setState(305); ((AddiContext)_localctx).r2 = registerPower();
			setState(306); match(T__57);
			setState(307); ((AddiContext)_localctx).d = match(DIGIT);
	...
	public final MrContext mr(String mainThread) throws RecognitionException {
		...
		try {
			...
			setState(311); ((MrContext)_localctx).r1 = registerPower();
			setState(312); match(T__57);
			setState(313); ((MrContext)_localctx).r2 = registerPower();
	...
	public final LoadX86Context loadX86(String mainThread) throws RecognitionException {
		...
		try {
			...
			setState(317); ((LoadX86Context)_localctx).r = registerX86();
			setState(318); match(T__57);
			setState(319); ((LoadX86Context)_localctx).l = locationX86();
	...
	public final LoadPowerContext loadPower(String mainThread) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(322); match(T__6);
			setState(323); ((LoadPowerContext)_localctx).r = registerPower();
			setState(324); match(T__10);
			setState(325);
			_la = _input.LA(1);
			...
			consume();
			setState(326); ((LoadPowerContext)_localctx).rl = registerPower();
			setState(330);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T