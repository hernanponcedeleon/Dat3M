	...
	private static BoolExpr satPowerPPO(Set<Event> events, Context ctx) throws Z3Exception {
		...
		for(Event e1 : events) {
			for(Event e2 : events) {
    	        ...
    	        enc = ctx.mkAnd(enc, ctx.mkEq(edge("ii",e1,e2, ctx), ctx.mkOr(ctx.mkAnd(edge("ii0",e1,e2, ctx), ctx.mkGt(intCount("ii",e1,e2, ctx), intCount("ii0",e1,e2, ctx))),
				...
				enc = ctx.mkAnd(enc, ctx.mkEq(edge("ic",e1,e2, ctx), ctx.mkOr(ctx.mkAnd(edge("ic0",e1,e2, ctx), ctx.mkGt(intCount("ic",e1,e2, ctx), intCount("ic0",e1,e2, ctx))),
				...
				enc = ctx.mkAnd(enc, ctx.mkEq(edge("ci",e1,e2, ctx), ctx.mkOr(ctx.mkAnd(edge("ci0",e1,e2, ctx), ctx.mkGt(intCount("ci",e1,e2, ctx), intCount("ci0",e1,e2, ctx))),
				...
				enc = ctx.mkAnd(enc, ctx.mkEq(edge("cc",e1,e2, ctx), ctx.mkOr(ctx.mkAnd(edge("cc0",e1,e2, ctx), ctx.mkGt(intCount("cc",e1,e2, ctx), intCount("cc0",e1,e2, ctx))),
