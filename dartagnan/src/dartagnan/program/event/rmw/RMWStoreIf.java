...
public class RMWStoreIf extends RMWStore {
    ...
    public RMWStoreIf(Load loadEvent, Location loc, ExprInterface cmp, ExprInterface val, String atomic, boolean strong) {
        super(loadEvent, loc, val, atomic);
        if(!(cmp instanceof AExpr) || !(val instanceof AExpr)){
            // TODO: Implementation
            throw new RuntimeException("RMWStoreIf is not implemented for BExpr arguments");
        }
        this.cmp = cmp;
    ...
    public Pair<BoolExpr, MapSSA> encodeDF(MapSSA map, Context ctx) throws Z3Exception {
        ...
        Expr z3Cmp = encodeValue(map, ctx, cmpReg, (AExpr)cmp);
