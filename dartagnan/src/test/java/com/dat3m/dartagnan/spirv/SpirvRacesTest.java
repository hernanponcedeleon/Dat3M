...
public class SpirvRacesTest {
    ...
    public static Iterable<Object[]> data() throws IOException {
        return Arrays.asList(new Object[][]{
                ...
                {"gpu-verify-auto/benign_race_tests/fail/writeafterread_addition/writeafterread_addition.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/divergence/race_and_divergence/race_and_divergence.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/benign_race_tests/fail/writewritearray_adversarial/writewritearray_adversarial.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/bitnot/bitnot.spv.dis", 1, PASS},
                // {"gpu-verify-auto/bitxor/bitxor.spv.dis", 1, PASS},
                // {"gpu-verify-auto/sourcelocation_tests/races/fail/write_write/elem_width_16/elem_width_16.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/transitiveclosuresimplified/transitiveclosuresimplified.spv.dis", 1, PASS},
                {"gpu-verify-auto/multidimarrays/test5/test5.spv.dis", 1, FAIL},
                {"gpu-verify-auto/test_mod_invariants/local_direct/local_direct.spv.dis", 1, UNKNOWN},
                // {"gpu-verify-auto/warpsync/broken_shuffle/broken_shuffle.spv.dis", 1, FAIL},
                {"gpu-verify-auto/array_bounds_tests/realign_simple_fail/realign_simple_fail.spv.dis", 1, PASS},
                {"gpu-verify-auto/null_pointers/null_pointer_assignment_unequal/null_pointer_assignment_unequal.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/warpsync/shuffle/shuffle.spv.dis", 1, PASS},
                {"gpu-verify-auto/report_global_id/test2/test2.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/pow2/64bit_relational/64bit_relational.spv.dis", 1, PASS},
                {"gpu-verify-auto/null_pointers/null_pointer_assignment_equal/null_pointer_assignment_equal.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/vectortests/vectorswizzle/vectorswizzle.spv.dis", 1, PASS},
                {"gpu-verify-auto/pointertests/test_copy_between_memory_spaces/test_copy_between_memory_spaces.spv.dis", 1, FAIL},
                {"gpu-verify-auto/barrier_intervals/test4/test4.spv.dis", 1, UNKNOWN},
                ...
                // {"gpu-verify-auto/inter_group_and_barrier_flag_tests/fail/sync_within_group_wrong_flag/sync_within_group_wrong_flag.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/atomics/atomic_read_race/atomic_read_race.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/async_work_group_copy/fail/test13/test13.spv.dis", 1, FAIL},
                {"gpu-verify-auto/test_2d_global_index_inference/test_2d_global_index_inference.spv.dis", 1, PASS},
                ...
                // {"gpu-verify-auto/misc/fail/2d_array_race/2d_array_race.spv.dis", 1, FAIL},
                {"gpu-verify-auto/no_log/pass/pass.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/inter_group_and_barrier_flag_tests/fail/missing_global_barrier_flag/missing_global_barrier_flag.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/multiplelocals2/multiplelocals2.spv.dis", 1, PASS},
                // {"gpu-verify-auto/misc/pass/misc3/misc3.spv.dis", 1, PASS},
                {"gpu-verify-auto/benign_race_tests/fail/writezero_nobenign/writezero_nobenign.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/benign_race_tests/pass/writeinloop/writeinloop.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/barrier_intervals/test3/test3.spv.dis", 1, PASS},
                ...
                {"gpu-verify-auto/benign_race_tests/pass/writezero/writezero.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/null_pointers/null_pointer_greater/null_pointer_greater.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/inter_group_and_barrier_flag_tests/fail/bad_write_then_read/bad_write_then_read.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/atomics/definitions_long/definitions_long.spv.dis", 1, PASS},
                // {"gpu-verify-auto/multidimarrays/test2/test2.spv.dis", 1, PASS},
                {"gpu-verify-auto/sourcelocation_tests/races/pass/read_read/read_read.spv.dis", 1, PASS},
                {"gpu-verify-auto/divergence/race_no_divergence/race_no_divergence.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/array_bounds_tests/array_in_array/array_in_array.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/benign_race_tests/pass/writeafterread/writeafterread.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/null_statement/null_statement.spv.dis", 1, PASS},
                // {"gpu-verify-auto/test_line_number_problem/test_line_number_problem.spv.dis", 1, FAIL},
                {"gpu-verify-auto/inter_group_and_barrier_flag_tests/fail/missing_local_barrier_flag/missing_local_barrier_flag.spv.dis", 1, FAIL},
                {"gpu-verify-auto/misc/pass/misc13/misc13.spv.dis", 1, PASS},
                {"gpu-verify-auto/inter_group_and_barrier_flag_tests/fail/no_barrier_flags/no_barrier_flags.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/inter_group_and_barrier_flag_tests/pass/pass_due_to_intra_group_flag/pass_due_to_intra_group_flag.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/atomics/pointers/pointers.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/benign_race_tests/fail/writetiddiv64_offbyone/writetiddiv64_offbyone.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/conditional_int_test/conditional_int_test.spv.dis", 1, PASS},
                {"gpu-verify-auto/inter_group_and_barrier_flag_tests/pass/local_id_benign_write_write/local_id_benign_write_write.spv.dis", 1, FAIL},
                {"gpu-verify-auto/test_for_benign_read_write_bug/test_for_benign_read_write_bug.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/misc/fail/miscfail1/miscfail1.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/atomics/forloop/forloop.spv.dis", 1, FAIL},
                {"gpu-verify-auto/inter_group_and_barrier_flag_tests/fail/sync/sync.spv.dis", 1, FAIL},
                {"gpu-verify-auto/array_bounds_tests/array_in_array_param/array_in_array_param.spv.dis", 1, FAIL},
                {"gpu-verify-auto/skeletonbinomialoptions/skeletonbinomialoptions.spv.dis", 1, UNKNOWN},
                // {"gpu-verify-auto/return_tests/multiloop_return/multiloop_return.spv.dis", 1, PASS},
                // {"gpu-verify-auto/alignment/race_location/race_location.spv.dis", 1, FAIL},
                ...
                // {"gpu-verify-auto/inter_group_and_barrier_flag_tests/fail/bad_read_then_write/bad_read_then_write.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/misc/pass/misc12/misc12.spv.dis", 1, UNKNOWN},
                ...
                // {"gpu-verify-auto/misc/fail/miscfail10/miscfail10.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/misc/fail/miscfail3/miscfail3.spv.dis", 1, FAIL},
                // {"gpu-verify-auto/simpleprocedurecall/simpleprocedurecall.spv.dis", 1, PASS},
                {"gpu-verify-auto/misc/fail/4d_array_of_structs_race/4d_array_of_structs_race.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/benign_race_tests/fail/writeafterread_otherval/writeafterread_otherval.spv.dis", 1, FAIL},
                ...
                {"gpu-verify-auto/inter_group_and_barrier_flag_tests/fail/local_id/local_id.spv.dis", 1, FAIL},
        });
    }
