package com.dat3m.dartagnan.spirv.mm;
...
import static com.dat3m.dartagnan.Dartagnan.generateResultSummary;
...
public class SpirvAssertionsTest {
    ...
    public SpirvAssertionsTest(String file, int bound, Result expected) {
        this.programPath = getTestResourcePath("spirv/mm/" + file);
        this.bound = bound;
    ...
    public static Iterable<Object[]> data() throws IOException {
        return Arrays.asList(new Object[][]{
                {"mp-[diff-wg]-[sb-sb]_WdvRx-WdvRelSwg_RdvAcqSwg-RdvRx.spv.dis", 1, FAIL},
                {"mp-[diff-wg]-[sb-sb]_WdvRelSun-WdvRelSwg_RdvAcqSwg-RdvAcqSun.spv.dis", 1, FAIL},
                {"mp-[diff-wg]-[sb-sb]_WdvRelSwg-WdvRelSwg_RdvAcqSwg-RdvAcqSwg.spv.dis", 1, PASS},
                {"mp-[diff-wg]-[sb-sb]_WdvRelSunSav-WdvRelSwg_RdvAcqSwg-RdvAcqSunSvis.spv.dis", 1, PASS},
        });
    }
    ...
    public void testAllSolvers() throws Exception {
        ...
        try (SolverContext ctx = mkCtx(); ProverWithTracker prover = mkProver(ctx)) {
            ...
            if (s.hasModel()) {
                ...
                generateResultSummary(task, prover, s);
            }
