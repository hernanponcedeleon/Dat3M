...
public class VisitorOpsMemoryTest {
    ...
    public void testVariable() {
        ...
        for (int i = 0; i < 4; i++) {
            ScopedPointer pointer = (ScopedPointer) builder.getExpression(variables[i]);
    ...
    private void doTestInitializedVariable(String input) {
        ...
        ScopedPointer v1 = (ScopedPointer) builder.getExpression("%v1");
        assertNotNull(v1);
        ...
        ScopedPointer v2 = (ScopedPointer) builder.getExpression("%v2");
        assertNotNull(v2);
        ...
        ScopedPointer v3 = (ScopedPointer) builder.getExpression("%v3");
        assertNotNull(v3);
        ...
        ScopedPointer v4 = (ScopedPointer) builder.getExpression("%v4");
        assertNotNull(v4);
    ...
    public void testRuntimeArrayFromConstant() {
        ...
        // then
        ScopedPointer v = (ScopedPointer) builder.getExpression("%v");
        assertNotNull(v);
