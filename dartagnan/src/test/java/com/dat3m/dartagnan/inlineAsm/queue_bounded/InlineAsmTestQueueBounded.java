...
public class InlineAsmTestQueueBounded {
    ...
    public InlineAsmTestQueueBounded(String file, int bound, Result expected) {
        this.programPath = getTestResourcePath("inlineasm/queue_bounded/" + file + ".ll");
        this.bound = bound;
