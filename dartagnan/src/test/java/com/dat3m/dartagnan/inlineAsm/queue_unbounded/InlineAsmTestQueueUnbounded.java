package com.dat3m.dartagnan.inlineAsm.queue_unbounded;
...
public class InlineAsmTestQueueUnbounded {
    ...
    public InlineAsmTestQueueUnbounded(String file, int bound, Result expected) {
        this.programPath = getTestResourcePath("inlineasm/queue_unbounded/" + file + ".ll");
        this.bound = bound;
