...
public class MutableEventGraphTest {
    ...
    private static Function<Map<Event, Set<Event>>, MutableEventGraph> getConstructor(Class<?> cls) {
    ...
    public void testAddEmpty() {
        ...
        Event e1 = new Skip();
        Event e2 = new Skip();
        MutableEventGraph eventGraph = getConstructor(cls).apply(Map.of());
    ...
    public void testAddAllDisjoint() {
        ...
        // when
        MutableEventGraph first = getConstructor(cls).apply(Map.of(
                e1, Set.of(e2),
                e2, Set.of(e3),
                e3, Set.of(e1)
        ));
        MutableEventGraph second = getConstructor(cls).apply(Map.of(
                e1, Set.of(e3),
                e3, Set.of(e3)
        ));
