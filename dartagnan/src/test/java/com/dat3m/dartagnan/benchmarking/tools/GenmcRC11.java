...
public class GenmcRC11 extends AbstractExternalTool {

    public GenmcRC11(String name, Result expected) {
        super(name, expected);
    }
	...
	protected Provider<List<String>> getToolOptionsProvider() {
		return Provider.fromSupplier(() -> Arrays.asList("-rc11", "-unroll=2"));
	}
