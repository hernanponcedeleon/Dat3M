; ModuleID = '/home/ponce/git/Dat3M/output/IRIW-acq-sc.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/rc11/IRIW-acq-sc.c"
...
@.str = private unnamed_addr constant [40 x i8] c"!(a == 1 && c == 0 && b == 1 && d == 0)\00", align 1
@.str.1 = private unnamed_addr constant [52 x i8] c"/home/ponce/git/Dat3M/benchmarks/rc11/IRIW-acq-sc.c\00", align 1
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !40 {
  ...
  store atomic i32 1, i32* @x seq_cst, align 4, !dbg !46
  ret i8* null, !dbg !47
}
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !48 {
  ...
  %2 = load atomic i32, i32* @x acquire, align 4, !dbg !51
  call void @llvm.dbg.value(metadata i32 %2, metadata !52, metadata !DIExpression()), !dbg !50
  %3 = load atomic i32, i32* @y seq_cst, align 4, !dbg !53
  call void @llvm.dbg.value(metadata i32 %3, metadata !54, metadata !DIExpression()), !dbg !50
  fence seq_cst, !dbg !55
  store i32 %2, i32* @a, align 4, !dbg !56
  store i32 %3, i32* @c, align 4, !dbg !57
  ret i8* null, !dbg !58
}
...
define dso_local i8* @thread_3(i8* noundef %0) #0 !dbg !59 {
  ...
  %2 = load atomic i32, i32* @y acquire, align 4, !dbg !62
  call void @llvm.dbg.value(metadata i32 %2, metadata !63, metadata !DIExpression()), !dbg !61
  %3 = load atomic i32, i32* @x seq_cst, align 4, !dbg !64
  call void @llvm.dbg.value(metadata i32 %3, metadata !65, metadata !DIExpression()), !dbg !61
  fence seq_cst, !dbg !66
  store i32 %2, i32* @b, align 4, !dbg !67
  store i32 %3, i32* @d, align 4, !dbg !68
  ret i8* null, !dbg !69
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @thread_4(i8* noundef %0) #0 !dbg !70 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !71, metadata !DIExpression()), !dbg !72
  store atomic i32 1, i32* @y seq_cst, align 4, !dbg !73
  ret i8* null, !dbg !74
}
...
25:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([40 x i8], [40 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([52 x i8], [52 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !98
  unreachable, !dbg !98
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/rc11/IRIW-acq-sc.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "54abaf32369468f2fd8361a4ddc1d118")
!4 = !{!5}
...
!20 = !DIFile(filename: "benchmarks/rc11/IRIW-acq-sc.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "54abaf32369468f2fd8361a4ddc1d118")
...
!53 = !DILocation(line: 19, column: 11, scope: !48)
!54 = !DILocalVariable(name: "r1", scope: !48, file: !20, line: 19, type: !23)
!55 = !DILocation(line: 20, column: 2, scope: !48)
!56 = !DILocation(line: 21, column: 4, scope: !48)
!57 = !DILocation(line: 22, column: 4, scope: !48)
!58 = !DILocation(line: 23, column: 2, scope: !48)
...
!62 = !DILocation(line: 28, column: 11, scope: !59)
!63 = !DILocalVariable(name: "r0", scope: !59, file: !20, line: 28, type: !23)
!64 = !DILocation(line: 29, column: 11, scope: !59)
!65 = !DILocalVariable(name: "r1", scope: !59, file: !20, line: 29, type: !23)
!66 = !DILocation(line: 30, column: 2, scope: !59)
!67 = !DILocation(line: 31, column: 4, scope: !59)
!68 = !DILocation(line: 32, column: 4, scope: !59)
!69 = !DILocation(line: 33, column: 2, scope: !59)
!70 = distinct !DISubprogram(name: "thread_4", scope: !20, file: !20, line: 36, type: !41, scopeLine: 37, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !43)
!71 = !DILocalVariable(name: "unused", arg: 1, scope: !70, file: !20, line: 36, type: !16)
!72 = !DILocation(line: 0, scope: !70)
!73 = !DILocation(line: 38, column: 2, scope: !70)
!74 = !DILocation(line: 39, column: 2, scope: !70)
!75 = distinct !DISubprogram(name: "main", scope: !20, file: !20, line: 43, type: !76, scopeLine: 44, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !43)
!76 = !DISubroutineType(types: !77)
!77 = !{!23}
!78 = !DILocalVariable(name: "t1", scope: !75, file: !20, line: 45, type: !79)
...
!83 = !DILocation(line: 47, column: 2, scope: !75)
!84 = !DILocalVariable(name: "t2", scope: !75, file: !20, line: 45, type: !79)
!85 = !DILocation(line: 48, column: 2, scope: !75)
!86 = !DILocalVariable(name: "t3", scope: !75, file: !20, line: 45, type: !79)
!87 = !DILocation(line: 49, column: 2, scope: !75)
!88 = !DILocalVariable(name: "t4", scope: !75, file: !20, line: 45, type: !79)
!89 = !DILocation(line: 50, column: 2, scope: !75)
!90 = !DILocation(line: 52, column: 15, scope: !75)
!91 = !DILocation(line: 52, column: 2, scope: !75)
!92 = !DILocation(line: 53, column: 15, scope: !75)
!93 = !DILocation(line: 53, column: 2, scope: !75)
!94 = !DILocation(line: 54, column: 15, scope: !75)
!95 = !DILocation(line: 54, column: 2, scope: !75)
!96 = !DILocation(line: 55, column: 15, scope: !75)
!97 = !DILocation(line: 55, column: 2, scope: !75)
!98 = !DILocation(line: 57, column: 2, scope: !99)
!99 = distinct !DILexicalBlock(scope: !100, file: !20, line: 57, column: 2)
!100 = distinct !DILexicalBlock(scope: !75, file: !20, line: 57, column: 2)
!101 = !DILocation(line: 59, column: 2, scope: !75)
