...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/LB-opt.bpl /home/ponce/git/Dat3M/output/LB-opt.ll
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/LB.c", 15, 6} true;
  assume {:verifier.code 0} true;
...
axiom (__llvm_atomic32_load == $sub.ref(0, 10354));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 11386));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/LB.c", 24, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
