...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/2+2W-opt.bpl /home/ponce/git/Dat3M/output/2+2W-opt.ll
...
axiom (.str.1 == $sub.ref(0, 6225));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 7260));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 8292));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 14, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(y, 2, 5);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 14, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(y, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 16, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 24, 6} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 26, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
