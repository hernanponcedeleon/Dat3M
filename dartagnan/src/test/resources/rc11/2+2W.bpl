...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/2+2W.bpl /Users/ponce/git/Dat3M/benchmarks/rc11/2+2W.c
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 12, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 5);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(y, 2, 5);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 14, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(y, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 16, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i3);
  call {:cexpr "a"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 17, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 22, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(y, 1, 5);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(x, 2, 5);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 24, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(x, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 25, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 26, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i3);
  call {:cexpr "b"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 27, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 34, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 35, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 37, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 38, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 40, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 40, 2} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "benchmarks/rc11/2+2W.c", 42, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
