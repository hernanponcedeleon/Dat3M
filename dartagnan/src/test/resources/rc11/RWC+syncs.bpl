...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/RWC+syncs-opt.bpl /home/ponce/git/Dat3M/output/RWC+syncs-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38231));
...
axiom (.str.1 == $sub.ref(0, 7268));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 8303));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 9335));
...
axiom (llvm.dbg.value == $sub.ref(0, 10367));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 11399));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 12431));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/RWC+syncs.c", 20, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/rc11/RWC+syncs.c", 22, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__llvm_atomic32_load == $sub.ref(0, 13463));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 14495));
procedure  __llvm_atomic_fence($i0: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 15527));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/RWC+syncs.c", 31, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
  ...
  call $i1 := __llvm_atomic32_load(x, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/RWC+syncs.c", 33, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__SMACK_dummy == $sub.ref(0, 23783));
...
axiom (__SMACK_and32 == $sub.ref(0, 24815));
...
axiom (__SMACK_and64 == $sub.ref(0, 25847));
...
axiom (__SMACK_and16 == $sub.ref(0, 26879));
...
axiom (__SMACK_and8 == $sub.ref(0, 27911));
...
axiom (__SMACK_or32 == $sub.ref(0, 28943));
...
axiom (__SMACK_or64 == $sub.ref(0, 29975));
...
axiom (__SMACK_or16 == $sub.ref(0, 31007));
...
axiom (__SMACK_or8 == $sub.ref(0, 32039));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 33071));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 34103));
...
axiom (__SMACK_decls == $sub.ref(0, 35135));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 36167));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 37199));
...
axiom (__SMACK_static_init == $sub.ref(0, 38231));
