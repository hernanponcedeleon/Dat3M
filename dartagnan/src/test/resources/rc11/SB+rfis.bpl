...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/SB+rfis-opt.bpl /home/ponce/git/Dat3M/output/SB+rfis-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38235));
...
axiom (.str.1 == $sub.ref(0, 8304));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 9339));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 10371));
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 13, 6} true;
  ...
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 16, 6} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 24, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 24, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 42, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 42, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 42, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__SMACK_dummy == $sub.ref(0, 23787));
...
axiom (__SMACK_and32 == $sub.ref(0, 24819));
...
axiom (__SMACK_and64 == $sub.ref(0, 25851));
...
axiom (__SMACK_and16 == $sub.ref(0, 26883));
...
axiom (__SMACK_and8 == $sub.ref(0, 27915));
...
axiom (__SMACK_or32 == $sub.ref(0, 28947));
...
axiom (__SMACK_or64 == $sub.ref(0, 29979));
...
axiom (__SMACK_or16 == $sub.ref(0, 31011));
...
axiom (__SMACK_or8 == $sub.ref(0, 32043));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 33075));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 34107));
...
axiom (__SMACK_decls == $sub.ref(0, 35139));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 36171));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 37203));
...
axiom (__SMACK_static_init == $sub.ref(0, 38235));
