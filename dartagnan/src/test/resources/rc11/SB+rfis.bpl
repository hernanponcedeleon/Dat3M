...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/SB+rfis.bpl /Users/ponce/git/Dat3M/benchmarks/rc11/SB+rfis.c
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 12, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 3);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(x, 5);
  call {:cexpr "r0"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 14, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(y, 5);
  call {:cexpr "r1"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 16, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i2);
  call {:cexpr "a"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i3);
  call {:cexpr "b"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 18, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 23, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(y, 1, 3);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 24, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(y, 5);
  call {:cexpr "r0"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 25, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(x, 5);
  call {:cexpr "r1"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 26, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 27, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i2);
  call {:cexpr "c"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 28, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, d, $i3);
  call {:cexpr "d"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 29, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 36, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 39, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 39, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 40, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 42, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 42, 2} true;
...
$bb10:
  ...
  goto $bb4;
$bb11:
  assume {:sourceloc "benchmarks/rc11/SB+rfis.c", 44, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
