...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/LB+deps-opt.bpl /home/ponce/git/Dat3M/output/LB+deps-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 36159));
...
axiom (.str == $sub.ref(0, 5156));
const {:allocSize 48} {:count 48} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 6228));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 7263));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 8295));
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/rc11/LB+deps.c", 17, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/rc11/LB+deps.c", 28, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__SMACK_dummy == $sub.ref(0, 21711));
...
axiom (__SMACK_and32 == $sub.ref(0, 22743));
...
axiom (__SMACK_and64 == $sub.ref(0, 23775));
...
axiom (__SMACK_and16 == $sub.ref(0, 24807));
...
axiom (__SMACK_and8 == $sub.ref(0, 25839));
...
axiom (__SMACK_or32 == $sub.ref(0, 26871));
...
axiom (__SMACK_or64 == $sub.ref(0, 27903));
...
axiom (__SMACK_or16 == $sub.ref(0, 28935));
...
axiom (__SMACK_or8 == $sub.ref(0, 29967));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 30999));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 32031));
...
axiom (__SMACK_decls == $sub.ref(0, 33063));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 34095));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 35127));
...
axiom (__SMACK_static_init == $sub.ref(0, 36159));
