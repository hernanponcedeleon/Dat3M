; ModuleID = '/home/ponce/git/Dat3M/output/Z6.U.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/rc11/Z6.U.c"
...
@.str = private unnamed_addr constant [30 x i8] c"!(a == 0 && b == 1 && c == 3)\00", align 1
@.str.1 = private unnamed_addr constant [45 x i8] c"/home/ponce/git/Dat3M/benchmarks/rc11/Z6.U.c\00", align 1
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !38 {
  ...
  store atomic i32 1, i32* @x seq_cst, align 4, !dbg !44
  store atomic i32 1, i32* @y release, align 4, !dbg !45
  ret i8* null, !dbg !46
}
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !47 {
  ...
  %2 = atomicrmw add i32* @y, i32 1 seq_cst, align 4, !dbg !50
  ...
  call void @llvm.dbg.value(metadata i32 %3, metadata !53, metadata !DIExpression()), !dbg !49
  fence seq_cst, !dbg !54
  store i32 %2, i32* @b, align 4, !dbg !55
  store i32 %3, i32* @c, align 4, !dbg !56
  ret i8* null, !dbg !57
}
...
define dso_local i8* @thread_3(i8* noundef %0) #0 !dbg !58 {
  ...
  store atomic i32 3, i32* @y seq_cst, align 4, !dbg !61
  ...
  store i32 %2, i32* @a, align 4, !dbg !65
  ret i8* null, !dbg !66
}
...
define dso_local i32 @main() #0 !dbg !67 {
  ...
  %14 = icmp eq i32 %13, 0, !dbg !86
  %15 = load i32, i32* @b, align 4, !dbg !86
  %16 = icmp eq i32 %15, 1, !dbg !86
  %or.cond = select i1 %14, i1 %16, i1 false, !dbg !86
  %17 = load i32, i32* @c, align 4, !dbg !86
  %18 = icmp eq i32 %17, 3, !dbg !86
  %or.cond3 = select i1 %or.cond, i1 %18, i1 false, !dbg !86
  br i1 %or.cond3, label %19, label %20, !dbg !86

19:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 noundef 48, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !86
  unreachable, !dbg !86
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/rc11/Z6.U.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "8eba1547608679042747d216fb61bf98")
!4 = !{!5}
...
!20 = !DIFile(filename: "benchmarks/rc11/Z6.U.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "8eba1547608679042747d216fb61bf98")
...
!52 = !DILocation(line: 20, column: 11, scope: !47)
!53 = !DILocalVariable(name: "r1", scope: !47, file: !20, line: 20, type: !23)
!54 = !DILocation(line: 21, column: 2, scope: !47)
!55 = !DILocation(line: 22, column: 4, scope: !47)
!56 = !DILocation(line: 23, column: 4, scope: !47)
!57 = !DILocation(line: 24, column: 2, scope: !47)
