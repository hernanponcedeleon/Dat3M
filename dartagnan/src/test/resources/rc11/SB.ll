; ModuleID = '/home/ponce/git/Dat3M/output/SB.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/rc11/SB.c"
...
@.str.1 = private unnamed_addr constant [43 x i8] c"/home/ponce/git/Dat3M/benchmarks/rc11/SB.c\00", align 1
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !36 {
  ...
  %2 = load atomic i32, i32* @y seq_cst, align 4, !dbg !43
  call void @llvm.dbg.value(metadata i32 %2, metadata !44, metadata !DIExpression()), !dbg !41
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !48 {
  ...
  store atomic i32 1, i32* @y seq_cst, align 4, !dbg !51
  %2 = load atomic i32, i32* @x seq_cst, align 4, !dbg !52
...
define dso_local i32 @main() #0 !dbg !57 {
  ...
  %10 = icmp eq i32 %9, 0, !dbg !72
  %11 = load i32, i32* @b, align 4, !dbg !72
  %12 = icmp eq i32 %11, 0, !dbg !72
  %or.cond = select i1 %10, i1 %12, i1 false, !dbg !72
  br i1 %or.cond, label %13, label %14, !dbg !72

13:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 noundef 38, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !72
  unreachable, !dbg !72
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/rc11/SB.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "11f8b9b5f2f54acbe660f1905c55af74")
!4 = !{!5}
...
!20 = !DIFile(filename: "benchmarks/rc11/SB.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "11f8b9b5f2f54acbe660f1905c55af74")
...
!43 = !DILocation(line: 13, column: 11, scope: !36)
!44 = !DILocalVariable(name: "r0", scope: !36, file: !20, line: 13, type: !23)
...
!51 = !DILocation(line: 21, column: 2, scope: !48)
!52 = !DILocation(line: 22, column: 11, scope: !48)
!53 = !DILocalVariable(name: "r0", scope: !48, file: !20, line: 22, type: !23)
