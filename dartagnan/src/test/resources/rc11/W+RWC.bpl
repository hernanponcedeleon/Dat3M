...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/W+RWC-opt.bpl /home/ponce/git/Dat3M/output/W+RWC-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39255));
...
axiom (.str.1 == $sub.ref(0, 8292));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 9327));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 10359));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(z, 1, 3);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 14, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
...
axiom (llvm.dbg.value == $sub.ref(0, 11391));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 12423));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 13455));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 19, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(z, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 21, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 23, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__llvm_atomic32_load == $sub.ref(0, 14487));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 15519));
procedure  __llvm_atomic_fence($i0: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 16551));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 32, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
  ...
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 34, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__SMACK_dummy == $sub.ref(0, 24807));
...
axiom (__SMACK_and32 == $sub.ref(0, 25839));
...
axiom (__SMACK_and64 == $sub.ref(0, 26871));
...
axiom (__SMACK_and16 == $sub.ref(0, 27903));
...
axiom (__SMACK_and8 == $sub.ref(0, 28935));
...
axiom (__SMACK_or32 == $sub.ref(0, 29967));
...
axiom (__SMACK_or64 == $sub.ref(0, 30999));
...
axiom (__SMACK_or16 == $sub.ref(0, 32031));
...
axiom (__SMACK_or8 == $sub.ref(0, 33063));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 34095));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 35127));
...
axiom (__SMACK_decls == $sub.ref(0, 36159));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37191));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38223));
...
axiom (__SMACK_static_init == $sub.ref(0, 39255));
