...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/W+RWC.bpl /Users/ponce/git/Dat3M/benchmarks/rc11/W+RWC.c
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 12, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 0);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(z, 1, 3);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 14, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 19, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 19, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(z, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 20, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 21, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(y, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 23, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 24, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i3);
  call {:cexpr "b"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 25, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 30, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 30, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(y, 1, 0);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 31, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 32, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(x, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 33, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 34, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i3);
  call {:cexpr "c"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 35, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 42, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 43, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 44, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread_3, $0.ref);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 46, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 46, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 47, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 47, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 48, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 48, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 50, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 50, 2} true;
...
$bb8:
  ...
  goto $bb4;
$bb9:
  assume {:sourceloc "benchmarks/rc11/W+RWC.c", 52, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
