...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/Z6.U-opt.bpl /home/ponce/git/Dat3M/output/Z6.U-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39258));
...
axiom (.str.1 == $sub.ref(0, 7263));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 8298));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 9330));
...
axiom (llvm.dbg.value == $sub.ref(0, 10362));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 11394));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 12426));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/Z6.U.c", 19, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_rmw(y, 1, 5, 1);
  ...
  assume {:sourceloc "benchmarks/rc11/Z6.U.c", 22, 6} true;
  assume {:verifier.code 0} true;
...
axiom (__SMACK_dummy == $sub.ref(0, 24810));
...
axiom (__SMACK_and32 == $sub.ref(0, 25842));
...
axiom (__SMACK_and64 == $sub.ref(0, 26874));
...
axiom (__SMACK_and16 == $sub.ref(0, 27906));
...
axiom (__SMACK_and8 == $sub.ref(0, 28938));
...
axiom (__SMACK_or32 == $sub.ref(0, 29970));
...
axiom (__SMACK_or64 == $sub.ref(0, 31002));
...
axiom (__SMACK_or16 == $sub.ref(0, 32034));
...
axiom (__SMACK_or8 == $sub.ref(0, 33066));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 34098));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 35130));
...
axiom (__SMACK_decls == $sub.ref(0, 36162));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37194));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38226));
...
axiom (__SMACK_static_init == $sub.ref(0, 39258));
