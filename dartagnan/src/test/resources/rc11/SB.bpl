...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/SB-opt.bpl /home/ponce/git/Dat3M/output/SB-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 36154));
...
const {:allocSize 43} {:count 43} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 6223));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 7258));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 8290));
procedure  thread_1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/SB.c", 13, 6} true;
  ...
  assume {:sourceloc "benchmarks/rc11/SB.c", 15, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/SB.c", 24, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__SMACK_dummy == $sub.ref(0, 21706));
...
axiom (__SMACK_and32 == $sub.ref(0, 22738));
...
axiom (__SMACK_and64 == $sub.ref(0, 23770));
...
axiom (__SMACK_and16 == $sub.ref(0, 24802));
...
axiom (__SMACK_and8 == $sub.ref(0, 25834));
...
axiom (__SMACK_or32 == $sub.ref(0, 26866));
...
axiom (__SMACK_or64 == $sub.ref(0, 27898));
...
axiom (__SMACK_or16 == $sub.ref(0, 28930));
...
axiom (__SMACK_or8 == $sub.ref(0, 29962));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 30994));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 32026));
...
axiom (__SMACK_decls == $sub.ref(0, 33058));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 34090));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 35122));
...
axiom (__SMACK_static_init == $sub.ref(0, 36154));
