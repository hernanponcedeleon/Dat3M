...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/IRIW-acq-sc-opt.bpl /home/ponce/git/Dat3M/output/IRIW-acq-sc-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 40303));
...
axiom (.str.1 == $sub.ref(0, 8308));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 9343));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 10375));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(x, 1, 5);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 13, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
...
axiom (llvm.dbg.value == $sub.ref(0, 11407));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 12439));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 13471));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load(y, 5);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 21, 6} true;
  assume {:verifier.code 0} true;
...
axiom (__llvm_atomic32_load == $sub.ref(0, 14503));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 15535));
procedure  __llvm_atomic_fence($i0: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 16567));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load(x, 5);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 31, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
const thread_4: ref;
axiom (thread_4 == $sub.ref(0, 17599));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 39, 2} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(y, 1, 5);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 39, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 57, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 57, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 57, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__SMACK_dummy == $sub.ref(0, 25855));
...
axiom (__SMACK_and32 == $sub.ref(0, 26887));
...
axiom (__SMACK_and64 == $sub.ref(0, 27919));
...
axiom (__SMACK_and16 == $sub.ref(0, 28951));
...
axiom (__SMACK_and8 == $sub.ref(0, 29983));
...
axiom (__SMACK_or32 == $sub.ref(0, 31015));
...
axiom (__SMACK_or64 == $sub.ref(0, 32047));
...
axiom (__SMACK_or16 == $sub.ref(0, 33079));
...
axiom (__SMACK_or8 == $sub.ref(0, 34111));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 35143));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 36175));
...
axiom (__SMACK_decls == $sub.ref(0, 37207));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 38239));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 39271));
...
axiom (__SMACK_static_init == $sub.ref(0, 40303));
