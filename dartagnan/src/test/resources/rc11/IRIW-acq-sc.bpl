...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/IRIW-acq-sc.bpl /Users/ponce/git/Dat3M/benchmarks/rc11/IRIW-acq-sc.c
  ...
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 12, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 5);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 13, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (atomic_store_explicit == $sub.ref(0, 9264));
procedure  atomic_store_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 10296));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 18, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 18, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(x, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 19, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(y, 5);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 20, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 21, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 22, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i2);
  call {:cexpr "c"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 23, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (atomic_load_explicit == $sub.ref(0, 11328));
procedure  atomic_load_explicit.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const atomic_thread_fence: ref;
axiom (atomic_thread_fence == $sub.ref(0, 12360));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 28, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 28, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(y, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 29, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(x, 5);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 30, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 31, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i1);
  call {:cexpr "b"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 32, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, d, $i2);
  call {:cexpr "d"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 33, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 38, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(y, 1, 5);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 39, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 47, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 48, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 49, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread_3, $0.ref);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 50, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, thread_4, $0.ref);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 52, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 52, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 53, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 53, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 54, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 54, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 55, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 55, 2} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 57, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 57, 2} true;
...
$bb10:
  ...
  goto $bb4;
$bb11:
  assume {:sourceloc "benchmarks/rc11/IRIW-acq-sc.c", 59, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
