...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/WWmerge-opt.bpl /home/ponce/git/Dat3M/output/WWmerge-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38229));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 15, 6} true;
  assume {:verifier.code 0} true;
...
axiom (__llvm_atomic32_load == $sub.ref(0, 11397));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 12429));
procedure  __llvm_atomic_fence($i0: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 13461));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(x, 2, 5);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 24, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
...
axiom (__llvm_atomic32_store == $sub.ref(0, 14493));
  ...
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 30, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 30, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(x, 5);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 32, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 48, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 48, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 48, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__SMACK_dummy == $sub.ref(0, 23781));
...
axiom (__SMACK_and32 == $sub.ref(0, 24813));
...
axiom (__SMACK_and64 == $sub.ref(0, 25845));
...
axiom (__SMACK_and16 == $sub.ref(0, 26877));
...
axiom (__SMACK_and8 == $sub.ref(0, 27909));
...
axiom (__SMACK_or32 == $sub.ref(0, 28941));
...
axiom (__SMACK_or64 == $sub.ref(0, 29973));
...
axiom (__SMACK_or16 == $sub.ref(0, 31005));
...
axiom (__SMACK_or8 == $sub.ref(0, 32037));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 33069));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 34101));
...
axiom (__SMACK_decls == $sub.ref(0, 35133));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 36165));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 37197));
...
axiom (__SMACK_static_init == $sub.ref(0, 38229));
