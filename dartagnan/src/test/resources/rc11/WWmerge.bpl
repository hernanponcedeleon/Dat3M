...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/WWmerge.bpl /Users/ponce/git/Dat3M/benchmarks/rc11/WWmerge.c
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 12, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(x, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(y, 5);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 15, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 16, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i2);
  call {:cexpr "b"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 17, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 22, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 5);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(x, 2, 5);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 24, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (atomic_store_explicit == $sub.ref(0, 11332));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 29, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 29, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(y, 1, 5);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 30, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(x, 5);
  call {:cexpr "r0"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 31, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 32, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i2);
  call {:cexpr "c"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 33, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 40, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 41, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 42, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread_3, $0.ref);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 44, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 44, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 45, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 45, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 46, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 46, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 48, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 48, 2} true;
...
$bb8:
  ...
  goto $bb4;
$bb9:
  assume {:sourceloc "benchmarks/rc11/WWmerge.c", 50, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
