; ModuleID = '/home/ponce/git/Dat3M/output/SB-asm-lwsync+sync.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/c/miscellaneous/SB-asm-lwsync+sync.c"
...
@.str.1 = private unnamed_addr constant [70 x i8] c"/home/ponce/git/Dat3M/benchmarks/c/miscellaneous/SB-asm-lwsync+sync.c\00", align 1
...
define dso_local i8* @thread_1(i8* %0) #0 !dbg !20 {
  ...
  call void asm sideeffect "lwsync", "~{memory},~{dirflag},~{fpsr},~{flags}"() #5, !dbg !26, !srcloc !27
...
define dso_local i8* @thread_2(i8* %0) #0 !dbg !31 {
  ...
  call void asm sideeffect "sync", "~{memory},~{dirflag},~{fpsr},~{flags}"() #5, !dbg !35, !srcloc !36
...
13:                                               ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([70 x i8], [70 x i8]* @.str.1, i64 0, i64 0), i32 34, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !56
  unreachable, !dbg !56
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/c/miscellaneous/SB-asm-lwsync+sync.c", directory: "/home/ponce/git/Dat3M")
!4 = !{}
!5 = !{!6}
...
!10 = !DIFile(filename: "benchmarks/c/miscellaneous/SB-asm-lwsync+sync.c", directory: "/home/ponce/git/Dat3M")
