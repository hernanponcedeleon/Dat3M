...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /Users/thomashaas/IdeaProjects/WeakMemory/Dat3M/output/propagatableSideEffects-opt.bpl /Users/thomashaas/IdeaProjects/WeakMemory/Dat3M/output/propagatableSideEffects-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24773));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/c/miscellaneous/propagatableSideEffects.c", 13, 2} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/c/miscellaneous/propagatableSideEffects.c", 13, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  call {:cexpr "cnt"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/c/miscellaneous/propagatableSideEffects.c", 13, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, bound);
  assume {:sourceloc "benchmarks/c/miscellaneous/propagatableSideEffects.c", 13, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, $i2);
  assume {:sourceloc "benchmarks/c/miscellaneous/propagatableSideEffects.c", 13, 2} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/c/miscellaneous/propagatableSideEffects.c", 14, 2} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_rtn == $sub.ref(0, 7229));
procedure  __assert_rtn($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 8261));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 9293));
...
axiom (__SMACK_dummy == $sub.ref(0, 10325));
...
axiom (__SMACK_and32 == $sub.ref(0, 11357));
...
axiom (__SMACK_and64 == $sub.ref(0, 12389));
...
axiom (__SMACK_and16 == $sub.ref(0, 13421));
...
axiom (__SMACK_and8 == $sub.ref(0, 14453));
...
axiom (__SMACK_or32 == $sub.ref(0, 15485));
...
axiom (__SMACK_or64 == $sub.ref(0, 16517));
...
axiom (__SMACK_or16 == $sub.ref(0, 17549));
...
axiom (__SMACK_or8 == $sub.ref(0, 18581));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19613));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 20645));
...
axiom (__SMACK_decls == $sub.ref(0, 21677));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 22709));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 23741));
...
axiom (__SMACK_static_init == $sub.ref(0, 24773));
