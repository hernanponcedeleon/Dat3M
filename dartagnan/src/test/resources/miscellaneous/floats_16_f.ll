...
@.str.4 = private unnamed_addr constant [45 x i8] c"signbit(fmax(d, d2)) == signbit(fmax(d2, d))\00", align 1
...
49:                                               ; preds = %47
  %50 = load double, double* %3, align 8, !dbg !45
  %51 = load double, double* %4, align 8, !dbg !45
  %52 = call double @llvm.maxnum.f64(double %50, double %51), !dbg !45
  %53 = bitcast double %52 to i64, !dbg !45
  %54 = icmp slt i64 %53, 0, !dbg !45
  %55 = zext i1 %54 to i32, !dbg !45
  %56 = load double, double* %4, align 8, !dbg !45
  %57 = load double, double* %3, align 8, !dbg !45
  %58 = call double @llvm.maxnum.f64(double %56, double %57), !dbg !45
  %59 = bitcast double %58 to i64, !dbg !45
  %60 = icmp slt i64 %59, 0, !dbg !45
  %61 = zext i1 %60 to i32, !dbg !45
  %62 = icmp eq i32 %55, %61, !dbg !45
  br i1 %62, label %63, label %64, !dbg !48

63:                                               ; preds = %49
  br label %65, !dbg !48

64:                                               ; preds = %49
  call void @__assert_fail(i8* noundef getelementptr inbounds ([45 x i8], [45 x i8]* @.str.4, i64 0, i64 0), i8* noundef getelementptr inbounds ([54 x i8], [54 x i8]* @.str.1, i64 0, i64 0), i32 noundef 170, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #4, !dbg !45
  unreachable, !dbg !45
...
!45 = !DILocation(line: 170, column: 9, scope: !46)
!46 = distinct !DILexicalBlock(scope: !47, file: !11, line: 170, column: 9)
!47 = distinct !DILexicalBlock(scope: !35, file: !11, line: 170, column: 9)
!48 = !DILocation(line: 170, column: 9, scope: !47)
!49 = !DILocation(line: 172, column: 5, scope: !35)
!50 = !DILocation(line: 179, column: 5, scope: !10)
