...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /Users/thomashaas/IdeaProjects/Dat3M/output/thread_inlining_complex-opt.bpl /Users/thomashaas/IdeaProjects/Dat3M/output/thread_inlining_complex-opt.ll
...
{
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 17, 1} true;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 21, 4} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 22, 4} true;
  assume {:verifier.code 0} true;
  $r := $p2;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 27, 19} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 27, 19} true;
  assume {:verifier.code 0} true;
  call $p1 := threadCreator();
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 28, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := __pthread_join($p1, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 29, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 34, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 35, 18} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 35, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := __pthread_join($p2, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 37, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := assert_.i32($i6);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining_complex.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__llvm_atomic32_load == $sub.ref(0, 11348));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const assert_: ref;
axiom (assert_ == $sub.ref(0, 12380));
procedure  assert_.i32(p.0: i32)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 13412));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 14444));
...
axiom (__SMACK_dummy == $sub.ref(0, 15476));
...
axiom (__SMACK_and32 == $sub.ref(0, 16508));
...
axiom (__SMACK_and64 == $sub.ref(0, 17540));
...
axiom (__SMACK_and16 == $sub.ref(0, 18572));
...
axiom (__SMACK_and8 == $sub.ref(0, 19604));
...
axiom (__SMACK_or32 == $sub.ref(0, 20636));
...
axiom (__SMACK_or64 == $sub.ref(0, 21668));
...
axiom (__SMACK_or16 == $sub.ref(0, 22700));
...
axiom (__SMACK_or8 == $sub.ref(0, 23732));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 24764));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 25796));
