  ...
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 18, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 18, 4} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_rmw(data, 1, 5, 1);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 24, 17} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 25, 25} true;
  assume {:verifier.code 1} true;
  $i2 := $sle.i32(0, $i1);
  assume {:verifier.code 1} true;
  $i3 := $slt.i32($i1, 5);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 25, 34} true;
  assume {:verifier.code 1} true;
  $i4 := (if ($i2 == 1) then $i3 else 0);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 25, 34} true;
  assume {:verifier.code 1} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 25, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i5);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 27, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_loop_bound(6);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 28, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $sgt.i32($i1, 0);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 28, 10} true;
  assume {:verifier.code 0} true;
  $i7 := (if ($i6 == 1) then $i1 else 0);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 28, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i32.i64($i7);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 28, 10} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i10 := $ne.i64($i9, $i8);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 28, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 29, 25} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref($i9, 8));
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 29, 9} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($p11, $0.ref, worker, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 28, 33} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i64($i9, 1);
...
$bb3:
  assume !(($i10 == 1));
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 32, 17} true;
  assume {:verifier.code 0} true;
  call $i14 := __llvm_atomic32_load(data, 5);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 32, 17} true;
  assume {:verifier.code 0} true;
  $i15 := $ne.i32($i14, 4);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 32, 17} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i32($i15);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 32, 5} true;
  assume {:verifier.code 0} true;
  call $i17 := assert_.i32($i16);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_loop.c", 33, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
