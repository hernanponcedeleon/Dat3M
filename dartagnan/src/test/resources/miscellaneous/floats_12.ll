...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  %9 = fcmp oeq double %8, 0x10000000000000, !dbg !27
...
17:                                               ; preds = %10
  call void @__assert_fail(i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([54 x i8], [54 x i8]* @.str.1, i64 0, i64 0), i32 noundef 128, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #4, !dbg !34
  unreachable, !dbg !34
...
!24 = !DILocation(line: 126, column: 14, scope: !25)
!25 = distinct !DILexicalBlock(scope: !10, file: !11, line: 126, column: 9)
!26 = !DILocation(line: 126, column: 9, scope: !25)
!27 = !DILocation(line: 126, column: 17, scope: !25)
!28 = !DILocation(line: 126, column: 9, scope: !10)
!29 = !DILocalVariable(name: "x", scope: !30, file: !11, line: 127, type: !21)
!30 = distinct !DILexicalBlock(scope: !25, file: !11, line: 126, column: 29)
!31 = !DILocation(line: 127, column: 16, scope: !30)
!32 = !DILocation(line: 127, column: 20, scope: !30)
!33 = !DILocation(line: 127, column: 22, scope: !30)
!34 = !DILocation(line: 128, column: 9, scope: !35)
!35 = distinct !DILexicalBlock(scope: !36, file: !11, line: 128, column: 9)
!36 = distinct !DILexicalBlock(scope: !30, file: !11, line: 128, column: 9)
!37 = !DILocation(line: 128, column: 9, scope: !36)
!38 = !DILocation(line: 129, column: 5, scope: !30)
