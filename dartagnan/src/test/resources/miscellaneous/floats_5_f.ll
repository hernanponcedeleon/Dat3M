...
22:                                               ; preds = %18
  call void @__assert_fail(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([54 x i8], [54 x i8]* @.str.1, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #4, !dbg !38
  unreachable, !dbg !38
...
!38 = !DILocation(line: 58, column: 9, scope: !39)
!39 = distinct !DILexicalBlock(scope: !40, file: !11, line: 58, column: 9)
!40 = distinct !DILexicalBlock(scope: !30, file: !11, line: 58, column: 9)
!41 = !DILocation(line: 58, column: 9, scope: !40)
!42 = !DILocation(line: 60, column: 5, scope: !30)
