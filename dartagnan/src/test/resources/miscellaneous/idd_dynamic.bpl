...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /Users/thomashaas/IdeaProjects/WeakMemory/Dat3M/output/idd_dynamic-opt.bpl /Users/thomashaas/IdeaProjects/WeakMemory/Dat3M/output/idd_dynamic-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 34051));
...
const {:allocSize 9} {:count 9} __func__.thread_1: ref;
axiom (__func__.thread_1 == $sub.ref(0, 4117));
const {:allocSize 14} .str: ref;
axiom (.str == $sub.ref(0, 5155));
const {:allocSize 8} {:count 8} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 6187));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 7219));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 13, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 13, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(x, 0);
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 14, 10} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load(y, 0);
  call {:cexpr "s"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i1, 0);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 16, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $i2;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 18, 8} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(z, 4, 0);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $i4 := 42;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 21, 2} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(x, $i4, 0);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 21, 2} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i2, 42);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 21, 2} true;
...
$bb4:
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 21, 2} true;
  assume {:verifier.code 0} true;
  call __assert_rtn(__func__.thread_1, .str, 21, .str.1);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 21, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb5:
  assume !(($i6 == 1));
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 22, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (__llvm_atomic32_load == $sub.ref(0, 9283));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 10315));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const __assert_rtn: ref;
axiom (__assert_rtn == $sub.ref(0, 11347));
procedure  __assert_rtn($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 12379));
procedure  thread_2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 27, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 27, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(x, 0);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 29, 2} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(y, $i1, 0);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 29, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 36, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 39, 15} true;
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 39, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := __pthread_join($p4, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 40, 15} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := __pthread_join($p6, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/idd_dynamic.c", 42, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 14443));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 15475));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __pthread_join: ref;
axiom (__pthread_join == $sub.ref(0, 16507));
...
axiom (__SMACK_and32 == $sub.ref(0, 20635));
...
axiom (__SMACK_and64 == $sub.ref(0, 21667));
...
axiom (__SMACK_and16 == $sub.ref(0, 22699));
...
axiom (__SMACK_and8 == $sub.ref(0, 23731));
...
axiom (__SMACK_or32 == $sub.ref(0, 24763));
...
axiom (__SMACK_or64 == $sub.ref(0, 25795));
...
axiom (__SMACK_or16 == $sub.ref(0, 26827));
...
axiom (__SMACK_or8 == $sub.ref(0, 27859));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 28891));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 29923));
...
axiom (__SMACK_decls == $sub.ref(0, 30955));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 31987));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 33019));
...
axiom (__SMACK_static_init == $sub.ref(0, 34051));
