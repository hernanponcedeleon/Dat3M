...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  br i1 %11, label %37, label %12, !dbg !29
...
12:                                               ; preds = %0
  ...
  br i1 %20, label %37, label %21, !dbg !31
...
31:                                               ; preds = %29
  %32 = load double, double* %6, align 8, !dbg !46
  %33 = fcmp une double %32, 0.000000e+00, !dbg !46
  br i1 %33, label %34, label %35, !dbg !49

34:                                               ; preds = %31
  br label %36, !dbg !49

35:                                               ; preds = %31
  call void @__assert_fail(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([54 x i8], [54 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #5, !dbg !46
  unreachable, !dbg !46
...
!47 = distinct !DILexicalBlock(scope: !48, file: !11, line: 67, column: 9)
!48 = distinct !DILexicalBlock(scope: !33, file: !11, line: 67, column: 9)
!49 = !DILocation(line: 67, column: 9, scope: !48)
!50 = !DILocation(line: 69, column: 5, scope: !33)
!51 = !DILocation(line: 179, column: 5, scope: !10)
