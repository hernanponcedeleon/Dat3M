; ModuleID = '/home/ponce/git/Dat3M/output/SB-RMW.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/c/miscellaneous/SB-RMW.c"
...
@.str.1 = private unnamed_addr constant [58 x i8] c"/home/ponce/git/Dat3M/benchmarks/c/miscellaneous/SB-RMW.c\00", align 1
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !36 {
  ...
  %2 = atomicrmw add i32* @x, i32 1 seq_cst, align 4, !dbg !42
  %3 = load atomic i32, i32* @y seq_cst, align 4, !dbg !43
  store i32 %3, i32* @a, align 4, !dbg !44
  ret i8* null, !dbg !45
}
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !46 {
  ...
  %2 = atomicrmw add i32* @y, i32 1 seq_cst, align 4, !dbg !49
  %3 = load atomic i32, i32* @x seq_cst, align 4, !dbg !50
...
define dso_local i32 @main() #0 !dbg !53 {
  ...
  %11 = load i32, i32* @b, align 4, !dbg !68
  %12 = icmp eq i32 %11, 0, !dbg !68
  %or.cond = select i1 %10, i1 %12, i1 false, !dbg !68
  br i1 %or.cond, label %13, label %14, !dbg !68

13:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([58 x i8], [58 x i8]* @.str.1, i64 0, i64 0), i32 noundef 33, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !68
  unreachable, !dbg !68
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/c/miscellaneous/SB-RMW.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "9706ce6f40dcabe50cf4381629150252")
!4 = !{!5}
...
!20 = !DIFile(filename: "benchmarks/c/miscellaneous/SB-RMW.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "9706ce6f40dcabe50cf4381629150252")
...
!25 = distinct !DIGlobalVariable(name: "a", scope: !2, file: !20, line: 7, type: !23, isLocal: false, isDefinition: true)
!26 = !DIGlobalVariableExpression(var: !27, expr: !DIExpression())
!27 = distinct !DIGlobalVariable(name: "b", scope: !2, file: !20, line: 7, type: !23, isLocal: false, isDefinition: true)
...
!36 = distinct !DISubprogram(name: "thread_1", scope: !20, file: !20, line: 9, type: !37, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !39)
!37 = !DISubroutineType(types: !38)
!38 = !{!16, !16}
!39 = !{}
!40 = !DILocalVariable(name: "unused", arg: 1, scope: !36, file: !20, line: 9, type: !16)
!41 = !DILocation(line: 0, scope: !36)
!42 = !DILocation(line: 11, column: 5, scope: !36)
!43 = !DILocation(line: 12, column: 9, scope: !36)
!44 = !DILocation(line: 12, column: 7, scope: !36)
!45 = !DILocation(line: 13, column: 2, scope: !36)
!46 = distinct !DISubprogram(name: "thread_2", scope: !20, file: !20, line: 16, type: !37, scopeLine: 17, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !39)
...
!51 = !DILocation(line: 19, column: 7, scope: !46)
!52 = !DILocation(line: 20, column: 2, scope: !46)
!53 = distinct !DISubprogram(name: "main", scope: !20, file: !20, line: 23, type: !54, scopeLine: 24, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !39)
!54 = !DISubroutineType(types: !55)
!55 = !{!23}
!56 = !DILocalVariable(name: "t1", scope: !53, file: !20, line: 25, type: !57)
...
!61 = !DILocation(line: 27, column: 2, scope: !53)
!62 = !DILocalVariable(name: "t2", scope: !53, file: !20, line: 25, type: !57)
!63 = !DILocation(line: 28, column: 2, scope: !53)
!64 = !DILocation(line: 30, column: 15, scope: !53)
!65 = !DILocation(line: 30, column: 2, scope: !53)
!66 = !DILocation(line: 31, column: 15, scope: !53)
!67 = !DILocation(line: 31, column: 2, scope: !53)
!68 = !DILocation(line: 33, column: 2, scope: !69)
!69 = distinct !DILexicalBlock(scope: !70, file: !20, line: 33, column: 2)
!70 = distinct !DILexicalBlock(scope: !53, file: !20, line: 33, column: 2)
