...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /Users/thomashaas/IdeaProjects/Dat3M/output/nondet_loop-opt.bpl /Users/thomashaas/IdeaProjects/Dat3M/output/nondet_loop-opt.ll
...
axiom (__func__.main == $sub.ref(0, 1029));
const {:allocSize 14} .str: ref;
axiom (.str == $sub.ref(0, 2067));
const {:allocSize 2} {:count 2} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 3093));
const main: ref;
axiom (main == $sub.ref(0, 4125));
