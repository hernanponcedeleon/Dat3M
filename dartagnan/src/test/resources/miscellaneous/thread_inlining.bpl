...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /Users/thomashaas/IdeaProjects/Dat3M/output/thread_inlining-opt.bpl /Users/thomashaas/IdeaProjects/Dat3M/output/thread_inlining-opt.ll
...
{
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 17, 1} true;
...
procedure  threadCreator($p0: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 20, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 20, 4} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($p0, $0.ref, thread2, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 6188));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const thread1: ref;
axiom (thread1 == $sub.ref(0, 7220));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 26, 5} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call threadCreator($p1);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 27, 18} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := __pthread_join($p2, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 8252));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 33, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 34, 18} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 34, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := __pthread_join($p2, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 36, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 36, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := assert_.i32($i6);
  assume {:sourceloc "benchmarks/c/miscellaneous/thread_inlining.c", 37, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
