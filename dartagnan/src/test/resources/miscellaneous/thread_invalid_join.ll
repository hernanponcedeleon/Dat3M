; ModuleID = '/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/miscellaneous/thread_invalid_join.c'
source_filename = "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/miscellaneous/thread_invalid_join.c"
...
define i8* @thread1(i8* noundef %0) #0 !dbg !15 {
  ...
  %3 = call %struct._opaque_pthread_t* @pthread_self(), !dbg !22
  %4 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* noundef %3, i8** noundef null), !dbg !23
  ret i8* null, !dbg !24
}
...
define i32 @main() #0 !dbg !25 {
  ...
  call void @llvm.dbg.declare(metadata %struct._opaque_pthread_t** %2, metadata !29, metadata !DIExpression()), !dbg !54
  call void @llvm.dbg.declare(metadata %struct._opaque_pthread_t** %3, metadata !55, metadata !DIExpression()), !dbg !56
  %4 = call i32 @pthread_create(%struct._opaque_pthread_t** noundef %2, %struct._opaque_pthread_attr_t* noundef null, i8* (i8*)* noundef @thread1, i8* noundef null), !dbg !57
  %5 = load %struct._opaque_pthread_t*, %struct._opaque_pthread_t** %2, align 8, !dbg !58
  %6 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* noundef %5, i8** noundef null), !dbg !59
  %7 = load %struct._opaque_pthread_t*, %struct._opaque_pthread_t** %3, align 8, !dbg !60
  %8 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* noundef %7, i8** noundef null), !dbg !61
  ret i32 0, !dbg !62
}
...
!1 = !DIFile(filename: "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/miscellaneous/thread_invalid_join.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
!2 = !{!3}
...
!15 = distinct !DISubprogram(name: "thread1", scope: !16, file: !16, line: 11, type: !17, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !19)
!16 = !DIFile(filename: "benchmarks/miscellaneous/thread_invalid_join.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
!17 = !DISubroutineType(types: !18)
!18 = !{!3, !3}
!19 = !{}
!20 = !DILocalVariable(name: "arg", arg: 1, scope: !15, file: !16, line: 11, type: !3)
!21 = !DILocation(line: 11, column: 21, scope: !15)
!22 = !DILocation(line: 13, column: 18, scope: !15)
!23 = !DILocation(line: 13, column: 5, scope: !15)
!24 = !DILocation(line: 14, column: 5, scope: !15)
!25 = distinct !DISubprogram(name: "main", scope: !16, file: !16, line: 17, type: !26, scopeLine: 18, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !19)
!26 = !DISubroutineType(types: !27)
!27 = !{!28}
!28 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!29 = !DILocalVariable(name: "t1", scope: !25, file: !16, line: 19, type: !30)
...
!54 = !DILocation(line: 19, column: 15, scope: !25)
!55 = !DILocalVariable(name: "t2", scope: !25, file: !16, line: 19, type: !30)
!56 = !DILocation(line: 19, column: 19, scope: !25)
!57 = !DILocation(line: 21, column: 5, scope: !25)
!58 = !DILocation(line: 23, column: 18, scope: !25)
!59 = !DILocation(line: 23, column: 5, scope: !25)
!60 = !DILocation(line: 24, column: 18, scope: !25)
!61 = !DILocation(line: 24, column: 5, scope: !25)
!62 = !DILocation(line: 25, column: 5, scope: !25)
