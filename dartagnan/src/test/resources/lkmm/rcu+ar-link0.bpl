...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -bpl /Users/ponce/git/Dat3M/output/rcu+ar-link0.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/rcu+ar-link0.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 47420));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 39, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_WRITE_ONCE.ref.i32(x, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 40, 8} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_READ_ONCE.ref(y);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 40, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 42, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 47, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 47, 6} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(x);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 47, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 47, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 48, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 49, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 54, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 54, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(s);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 54, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_s, $i1);
  call {:cexpr "r_s"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 55, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_store.ref.i32.i32(w, 1, 3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 57, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 59, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 64, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 64, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(a);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 64, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 71, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 71, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(b);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 71, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 73, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 78, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 78, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(c);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 78, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 81, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 93, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 94, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 95, 2} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 96, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 97, 2} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p4, $0.ref, P4, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 98, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p5, $0.ref, P5, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 100, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 100, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 101, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 101, 2} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 102, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 102, 2} true;
  assume {:verifier.code 0} true;
  call $i17 := pthread_join($i16, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 103, 15} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 103, 2} true;
  assume {:verifier.code 0} true;
  call $i19 := pthread_join($i18, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 104, 15} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, $p4);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 104, 2} true;
  assume {:verifier.code 0} true;
  call $i21 := pthread_join($i20, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 105, 15} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, $p5);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 105, 2} true;
  assume {:verifier.code 0} true;
  call $i23 := pthread_join($i22, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 107, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 107, 2} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, r_y);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 107, 2} true;
  assume {:verifier.code 0} true;
  $i25 := $eq.i32($i24, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 107, 2} true;
...
$bb12:
  ...
  goto $bb4;
$bb13:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 109, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.dbg.value == $sub.ref(0, 46388));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 47420));
