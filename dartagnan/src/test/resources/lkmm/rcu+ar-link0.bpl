...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/cna-verification/include -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include/smack -DNTHREADS=3 -DREACQUIRE=1 -DALGORITHM=3 -bpl /Users/ponce/git/Dat3M/output/rcu+ar-link0.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/rcu+ar-link0.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 48452));
...
axiom (y == $sub.ref(0, 2056));
const {:allocSize 4} r_y: ref;
axiom (r_y == $sub.ref(0, 3084));
const {:allocSize 4} s: ref;
axiom (s == $sub.ref(0, 4112));
const {:allocSize 4} r_s: ref;
axiom (r_s == $sub.ref(0, 5140));
const {:allocSize 4} w: ref;
axiom (w == $sub.ref(0, 6168));
const {:allocSize 4} z: ref;
axiom (z == $sub.ref(0, 7196));
const {:allocSize 4} a: ref;
axiom (a == $sub.ref(0, 8224));
const {:allocSize 4} r_a: ref;
axiom (r_a == $sub.ref(0, 9252));
const {:allocSize 4} b: ref;
axiom (b == $sub.ref(0, 10280));
const {:allocSize 4} r_b: ref;
axiom (r_b == $sub.ref(0, 11308));
const {:allocSize 4} c: ref;
axiom (c == $sub.ref(0, 12336));
const {:allocSize 4} r_c: ref;
axiom (r_c == $sub.ref(0, 13364));
const P0: ref;
axiom (P0 == $sub.ref(0, 14396));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 37, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_FENCE.i32(9);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_WRITE_ONCE.ref.i32(x, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 39, 8} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_READ_ONCE.ref(y);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 39, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_y, $i3);
  call {:cexpr "r_y"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_FENCE.i32(10);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 41, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 46, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 46, 6} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(x);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 46, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 46, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 47, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_WRITE_ONCE.ref.i32(s, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 47, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 48, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 53, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 53, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(s);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 53, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_s, $i1);
  call {:cexpr "r_s"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 54, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_store.ref.i32.i32(w, 1, 3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 56, 10} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_READ_ONCE.ref(z);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 57, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 57, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := __LKMM_WRITE_ONCE.ref.i32(a, $i4);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 58, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (__LKMM_store == $sub.ref(0, 21620));
procedure  __LKMM_store.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const P3: ref;
axiom (P3 == $sub.ref(0, 22652));
procedure  P3($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 63, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 63, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(a);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 63, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_a, $i1);
  call {:cexpr "r_a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 64, 2} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, r_a);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 64, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_WRITE_ONCE.ref.i32(b, $i2);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 65, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 70, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 70, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(b);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 70, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_b, $i1);
  call {:cexpr "r_b"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 71, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_store.ref.i32.i32(c, 1, 3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 72, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 77, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 77, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(c);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 77, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_c, $i1);
  call {:cexpr "r_c"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 78, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_FENCE.i32(11);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 79, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_WRITE_ONCE.ref.i32(y, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 80, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 87, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 87, 6} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, P0, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 87, 6} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 87, 6} true;
...
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 88, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 88, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i7 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 89, 6} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 89, 6} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 89, 6} true;
...
$bb3:
  assume ($i9 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 90, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 90, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i9 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 91, 6} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 91, 6} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 91, 6} true;
...
$bb5:
  assume ($i11 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 92, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 92, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i11 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 93, 6} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 93, 6} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 93, 6} true;
...
$bb7:
  assume ($i13 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 94, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 94, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i13 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 95, 6} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_create($p4, $0.ref, P4, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 95, 6} true;
  assume {:verifier.code 0} true;
  $i15 := $ne.i32($i14, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 95, 6} true;
...
$bb9:
  assume ($i15 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 96, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 96, 3} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i15 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 97, 6} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_create($p5, $0.ref, P5, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 97, 6} true;
  assume {:verifier.code 0} true;
  $i17 := $ne.i32($i16, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 97, 6} true;
...
$bb11:
  assume ($i17 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 98, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 98, 3} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i17 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 100, 19} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 100, 6} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i20 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 101, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 101, 3} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i20 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 102, 19} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 102, 6} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 103, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 103, 3} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume !(($i23 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 104, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 104, 6} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i26 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 105, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 105, 3} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume !(($i26 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 106, 19} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 106, 6} true;
  assume {:verifier.code 0} true;
  call $i28 := pthread_join($i27, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 106, 6} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.i32($i28, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 106, 6} true;
...
$bb19:
  assume ($i29 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 107, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 107, 3} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i29 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 108, 19} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i32($M.0, $p4);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 108, 6} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i32 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 109, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 109, 3} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i32 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 110, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i32($M.0, $p5);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 110, 6} true;
  assume {:verifier.code 0} true;
  call $i34 := pthread_join($i33, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 110, 6} true;
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i34, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 110, 6} true;
...
$bb23:
  assume ($i35 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 111, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 111, 3} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume !(($i35 == 1));
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 113, 2} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb25:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 113, 2} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i32($M.0, r_y);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 113, 2} true;
  assume {:verifier.code 0} true;
  $i37 := $eq.i32($i36, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 113, 2} true;
...
$bb36:
  ...
  goto $bb28;
$bb37:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 115, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 26780));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 27812));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 28844));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 29876));
...
axiom (__SMACK_dummy == $sub.ref(0, 30908));
...
axiom (__VERIFIER_assert == $sub.ref(0, 31940));
...
axiom (__SMACK_and32 == $sub.ref(0, 32972));
...
axiom (__SMACK_and64 == $sub.ref(0, 34004));
...
axiom (__SMACK_and16 == $sub.ref(0, 35036));
...
axiom (__SMACK_and8 == $sub.ref(0, 36068));
...
axiom (__SMACK_or32 == $sub.ref(0, 37100));
...
axiom (__SMACK_or64 == $sub.ref(0, 38132));
...
axiom (__SMACK_or16 == $sub.ref(0, 39164));
...
axiom (__SMACK_or8 == $sub.ref(0, 40196));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 41228));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 42260));
...
axiom (__SMACK_decls == $sub.ref(0, 43292));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 44324));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 45356));
...
axiom (llvm.dbg.value == $sub.ref(0, 47420));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 48452));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, r_y, 0);
  call {:cexpr "r_y"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, r_s, 0);
  call {:cexpr "r_s"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, r_a, 0);
  call {:cexpr "r_a"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, r_b, 0);
  call {:cexpr "r_b"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, r_c, 0);
  call {:cexpr "r_c"} boogie_si_record_i32(0);
  $exn := false;
  return;
}
