...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/rcu+ar-link0.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/rcu+ar-link0.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 46388));
...
axiom (__LKMM_STORE == $sub.ref(0, 17492));
procedure  __LKMM_STORE($p0: ref, $i1: i32, $i2: i32);
const __LKMM_LOAD: ref;
axiom (__LKMM_LOAD == $sub.ref(0, 18524));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 91, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 92, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 98, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 98, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 99, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link0.c", 99, 2} true;
  assume {:verifier.code 0} true;
...
axiom (pthread_create == $sub.ref(0, 25748));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 26780));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 27812));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 28844));
...
axiom (__SMACK_dummy == $sub.ref(0, 29876));
...
axiom (__VERIFIER_assert == $sub.ref(0, 30908));
...
axiom (__SMACK_and32 == $sub.ref(0, 31940));
...
axiom (__SMACK_and64 == $sub.ref(0, 32972));
...
axiom (__SMACK_and16 == $sub.ref(0, 34004));
...
axiom (__SMACK_and8 == $sub.ref(0, 35036));
...
axiom (__SMACK_or32 == $sub.ref(0, 36068));
...
axiom (__SMACK_or64 == $sub.ref(0, 37100));
...
axiom (__SMACK_or16 == $sub.ref(0, 38132));
...
axiom (__SMACK_or8 == $sub.ref(0, 39164));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 40196));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 41228));
...
axiom (__SMACK_decls == $sub.ref(0, 42260));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 43292));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 44324));
...
axiom (llvm.dbg.value == $sub.ref(0, 45356));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 46388));
