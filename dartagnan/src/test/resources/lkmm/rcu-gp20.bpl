  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 15, 2} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 17, 8} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_READ_ONCE.ref(y);
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 17, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 19, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 27, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 39, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 42, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 42, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 43, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "benchmarks/lkmm/rcu-gp20.c", 47, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
