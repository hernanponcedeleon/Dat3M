...
@.str = private unnamed_addr constant [11 x i8] c"rcu-gp20.c\00", align 1, !dbg !38
@.str.1 = private unnamed_addr constant [24 x i8] c"!(r_x == 0 && r_y == 1)\00", align 1, !dbg !43
...
define dso_local ptr @P0(ptr noundef %0) #0 !dbg !62 {
  ...
  store i32 %4, ptr @r_x, align 4, !dbg !70
  %5 = call i64 @__LKMM_load(ptr noundef @y, i64 noundef 4, i32 noundef 1), !dbg !71
  %6 = trunc i64 %5 to i32, !dbg !71
  store i32 %6, ptr @r_y, align 4, !dbg !72
  call void @__LKMM_fence(i32 noundef 8), !dbg !73
  ret ptr null, !dbg !74
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local ptr @P1(ptr noundef %0) #0 !dbg !75 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  ...
  call void @__LKMM_fence(i32 noundef 9), !dbg !79
  call void @__LKMM_store(ptr noundef @y, i64 noundef 4, i64 noundef 1, i32 noundef 1), !dbg !80
  ret ptr null, !dbg !81
}
...
!40 = !DICompositeType(tag: DW_TAG_array_type, baseType: !35, size: 88, elements: !41)
!41 = !{!42}
...
!49 = distinct !DIGlobalVariable(name: "y", scope: !2, file: !3, line: 8, type: !24, isLocal: false, isDefinition: true)
!50 = !DIGlobalVariableExpression(var: !51, expr: !DIExpression())
!51 = distinct !DIGlobalVariable(name: "r_x", scope: !2, file: !3, line: 10, type: !24, isLocal: false, isDefinition: true)
!52 = !DIGlobalVariableExpression(var: !53, expr: !DIExpression())
!53 = distinct !DIGlobalVariable(name: "r_y", scope: !2, file: !3, line: 11, type: !24, isLocal: false, isDefinition: true)
...
!64 = !{!25, !25}
!65 = !{}
!66 = !DILocalVariable(name: "unused", arg: 1, scope: !62, file: !3, line: 13, type: !25)
!67 = !DILocation(line: 13, column: 16, scope: !62)
!68 = !DILocation(line: 15, column: 2, scope: !62)
!69 = !DILocation(line: 16, column: 8, scope: !62)
!70 = !DILocation(line: 16, column: 6, scope: !62)
!71 = !DILocation(line: 17, column: 8, scope: !62)
!72 = !DILocation(line: 17, column: 6, scope: !62)
!73 = !DILocation(line: 18, column: 2, scope: !62)
!74 = !DILocation(line: 19, column: 2, scope: !62)
!75 = distinct !DISubprogram(name: "P1", scope: !3, file: !3, line: 22, type: !63, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !65)
!76 = !DILocalVariable(name: "unused", arg: 1, scope: !75, file: !3, line: 22, type: !25)
!77 = !DILocation(line: 22, column: 16, scope: !75)
!78 = !DILocation(line: 24, column: 2, scope: !75)
!79 = !DILocation(line: 25, column: 2, scope: !75)
!80 = !DILocation(line: 26, column: 2, scope: !75)
!81 = !DILocation(line: 27, column: 2, scope: !75)
...
!92 = !{!93, !94, !104}
!93 = !DIDerivedType(tag: DW_TAG_member, name: "__sig", scope: !91, file: !89, line: 104, baseType: !29, size: 64)
...
!101 = !{null, !25}
!102 = !DIDerivedType(tag: DW_TAG_member, name: "__arg", scope: !96, file: !89, line: 59, baseType: !25, size: 64, offset: 64)
...
!108 = !DILocation(line: 35, column: 12, scope: !82)
!109 = !DILocalVariable(name: "t2", scope: !82, file: !3, line: 35, type: !86)
!110 = !DILocation(line: 35, column: 16, scope: !82)
