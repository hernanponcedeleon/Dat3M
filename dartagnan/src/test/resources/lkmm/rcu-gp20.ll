...
define ptr @P0(ptr noundef %0) #0 !dbg !59 {
  ...
  store i32 %4, ptr @r_x, align 4, !dbg !67
  %5 = call i64 @__LKMM_load(ptr noundef @y, i64 noundef 4, i32 noundef 1), !dbg !68
  %6 = trunc i64 %5 to i32, !dbg !68
  store i32 %6, ptr @r_y, align 4, !dbg !69
  call void @__LKMM_fence(i32 noundef 8), !dbg !70
  ret ptr null, !dbg !71
}
...
; Function Attrs: noinline nounwind ssp uwtable(sync)
define ptr @P1(ptr noundef %0) #0 !dbg !72 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  ...
  call void @__LKMM_fence(i32 noundef 9), !dbg !76
  call void @__LKMM_store(ptr noundef @y, i64 noundef 4, i64 noundef 1, i32 noundef 1), !dbg !77
  ret ptr null, !dbg !78
}
...
!61 = !{!25, !25}
!62 = !{}
!63 = !DILocalVariable(name: "unused", arg: 1, scope: !59, file: !3, line: 13, type: !25)
!64 = !DILocation(line: 13, column: 16, scope: !59)
!65 = !DILocation(line: 15, column: 2, scope: !59)
!66 = !DILocation(line: 16, column: 8, scope: !59)
!67 = !DILocation(line: 16, column: 6, scope: !59)
!68 = !DILocation(line: 17, column: 8, scope: !59)
!69 = !DILocation(line: 17, column: 6, scope: !59)
!70 = !DILocation(line: 18, column: 2, scope: !59)
!71 = !DILocation(line: 19, column: 2, scope: !59)
!72 = distinct !DISubprogram(name: "P1", scope: !3, file: !3, line: 22, type: !60, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !62)
!73 = !DILocalVariable(name: "unused", arg: 1, scope: !72, file: !3, line: 22, type: !25)
!74 = !DILocation(line: 22, column: 16, scope: !72)
!75 = !DILocation(line: 24, column: 2, scope: !72)
!76 = !DILocation(line: 25, column: 2, scope: !72)
!77 = !DILocation(line: 26, column: 2, scope: !72)
!78 = !DILocation(line: 27, column: 2, scope: !72)
...
!99 = !{null, !25}
!100 = !DIDerivedType(tag: DW_TAG_member, name: "__arg", scope: !94, file: !86, line: 59, baseType: !25, size: 64, offset: 64)
...
!108 = !DILocation(line: 35, column: 16, scope: !79)
