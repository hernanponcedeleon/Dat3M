...
define dso_local i8* @P0(i8* noundef %0) #0 !dbg !42 {
  ...
  %2 = call i32 @__LKMM_LOAD(i32* noundef nonnull @x, i32 noundef 1) #5, !dbg !49
  store i32 %2, i32* @r_x, align 4, !dbg !50
  %3 = call i32 @__LKMM_LOAD(i32* noundef nonnull @y, i32 noundef 1) #5, !dbg !51
...
define dso_local i8* @P1(i8* noundef %0) #0 !dbg !55 {
  ...
  call void @__LKMM_STORE(i32* noundef nonnull @x, i32 noundef 1, i32 noundef 1) #5, !dbg !58
  call void @__LKMM_FENCE(i32 noundef 9) #5, !dbg !59
  call void @__LKMM_STORE(i32* noundef nonnull @y, i32 noundef 1, i32 noundef 1) #5, !dbg !60
  ret i8* null, !dbg !61
}
