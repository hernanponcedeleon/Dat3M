...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/C-atomic-op-return-simple-02-2.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/C-atomic-op-return-simple-02-2.c
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/C-atomic-op-return-simple-02-2.c", 17, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_ATOMIC_OP_RETURN(x, 1, 0, 0);
...
procedure  __LKMM_ATOMIC_OP_RETURN($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const __LKMM_LOAD: ref;
axiom (__LKMM_LOAD == $sub.ref(0, 10296));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/C-atomic-op-return-simple-02-2.c", 23, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_ATOMIC_OP_RETURN(y, 1, 0, 0);
