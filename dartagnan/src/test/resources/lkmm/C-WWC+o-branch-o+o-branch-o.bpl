...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/C-WWC+o-branch-o+o-branch-o.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/C-WWC+o-branch-o+o-branch-o.c
...
axiom (__LKMM_LOAD == $sub.ref(0, 9264));
procedure  __LKMM_LOAD($p0: ref, $i1: i32)
  returns ($r: i32);
const __LKMM_STORE: ref;
axiom (__LKMM_STORE == $sub.ref(0, 10296));
