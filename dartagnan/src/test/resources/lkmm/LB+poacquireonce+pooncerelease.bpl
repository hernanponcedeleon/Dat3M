...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/LB+poacquireonce+pooncerelease.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/LB+poacquireonce+pooncerelease.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 33008));
...
axiom (__LKMM_LOAD == $sub.ref(0, 7208));
...
axiom (pthread_create == $sub.ref(0, 11336));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 12368));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 13400));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 14432));
...
axiom (__SMACK_dummy == $sub.ref(0, 15464));
...
axiom (__VERIFIER_assert == $sub.ref(0, 16496));
...
axiom (__SMACK_and32 == $sub.ref(0, 17528));
...
axiom (__SMACK_and64 == $sub.ref(0, 18560));
...
axiom (__SMACK_and16 == $sub.ref(0, 19592));
...
axiom (__SMACK_and8 == $sub.ref(0, 20624));
...
axiom (__SMACK_or32 == $sub.ref(0, 21656));
...
axiom (__SMACK_or64 == $sub.ref(0, 22688));
...
axiom (__SMACK_or16 == $sub.ref(0, 23720));
...
axiom (__SMACK_or8 == $sub.ref(0, 24752));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 25784));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 26816));
...
axiom (__SMACK_decls == $sub.ref(0, 27848));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 28880));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 29912));
...
axiom (llvm.dbg.value == $sub.ref(0, 31976));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 33008));
