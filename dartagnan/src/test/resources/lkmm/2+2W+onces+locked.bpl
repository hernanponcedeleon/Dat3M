...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -bpl /Users/ponce/git/Dat3M/output/2+2W+onces+locked.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/2+2W+onces+locked.c
...
const {:allocSize 4} lock_x: ref;
axiom (lock_x == $sub.ref(0, 1028));
const {:allocSize 4} x: ref;
axiom (x == $sub.ref(0, 2056));
const {:allocSize 4} lock_y: ref;
axiom (lock_y == $sub.ref(0, 3084));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 11, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_spin_lock.ref(lock_x);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_WRITE_ONCE.ref.i32(x, 2);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_spin_unlock.ref(lock_x);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_spin_lock.ref(lock_y);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := __LKMM_WRITE_ONCE.ref.i32(y, 1);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := __LKMM_spin_unlock.ref(lock_y);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 17, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const __LKMM_spin_lock: ref;
axiom (__LKMM_spin_lock == $sub.ref(0, 7208));
procedure  __LKMM_spin_lock.ref(p.0: ref)
  returns ($r: i32);
const __LKMM_WRITE_ONCE: ref;
axiom (__LKMM_WRITE_ONCE == $sub.ref(0, 8240));
procedure  __LKMM_WRITE_ONCE.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const __LKMM_spin_unlock: ref;
axiom (__LKMM_spin_unlock == $sub.ref(0, 9272));
procedure  __LKMM_spin_unlock.ref(p.0: ref)
  returns ($r: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 10304));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 22, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_spin_lock.ref(lock_y);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_WRITE_ONCE.ref.i32(y, 2);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 24, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_spin_unlock.ref(lock_y);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 25, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_spin_lock.ref(lock_x);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 26, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := __LKMM_WRITE_ONCE.ref.i32(x, 1);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 27, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := __LKMM_spin_unlock.ref(lock_x);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 28, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 35, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 36, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 38, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 39, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 39, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 41, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 41, 2} true;
  assume {:verifier.code 0} true;
  call $i8 := __LKMM_READ_ONCE.ref(x);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 41, 2} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 2);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 41, 2} true;
...
$bb2:
  ...
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 41, 2} true;
  assume {:verifier.code 0} true;
  call $i10 := __LKMM_READ_ONCE.ref(y);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 41, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, 2);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 41, 2} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 43, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__LKMM_READ_ONCE == $sub.ref(0, 14432));
