...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/2+2W+onces+locked.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/2+2W+onces+locked.c
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_SPIN_LOCK(lock_x);
  ...
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_SPIN_UNLOCK(lock_x);
  assume {:sourceloc "benchmarks/lkmm/2+2W+onces+locked.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_SPIN_LOCK(lock_y);
  ...
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_SPIN_UNLOCK(lock_y);
...
procedure  __LKMM_SPIN_LOCK($p0: ref)
  returns ($r: i32);
...
procedure  __LKMM_SPIN_UNLOCK($p0: ref)
  returns ($r: i32);
const thread_2: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_SPIN_UNLOCK(lock_x);
...
axiom (__LKMM_LOAD == $sub.ref(0, 14432));
