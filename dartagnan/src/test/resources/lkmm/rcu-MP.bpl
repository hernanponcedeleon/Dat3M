  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 12, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_WRITE_ONCE.ref.i32(x, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_FENCE.i32(11);
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_WRITE_ONCE.ref.i32(y, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 15, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (__LKMM_FENCE == $sub.ref(0, 6184));
procedure  __LKMM_FENCE.i32(p.0: i32)
  returns ($r: i32);
const P1: ref;
axiom (P1 == $sub.ref(0, 7216));
procedure  P1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 20, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 20, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_FENCE.i32(9);
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 21, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_READ_ONCE.ref(y);
  call {:cexpr "r_y"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 22, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_READ_ONCE.ref(x);
  call {:cexpr "r_x"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_FENCE.i32(10);
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 24, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 24, 5} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 25, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 37, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 40, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 10312));
