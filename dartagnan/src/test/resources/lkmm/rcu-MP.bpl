...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/rcu-MP.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/rcu-MP.c
...
axiom (__LKMM_LOAD == $sub.ref(0, 8248));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 36, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu-MP.c", 39, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
