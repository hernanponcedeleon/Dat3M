...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/C-PaulEMcKenney-MP+o-r+ai-mb-o.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/C-PaulEMcKenney-MP+o-r+ai-mb-o.c
...
procedure  __LKMM_XCHG($p0: ref, $i1: i32, $i2: i32)
  returns ($r: i32);
const thread_2: ref;
...
axiom (__LKMM_LOAD == $sub.ref(0, 12368));
