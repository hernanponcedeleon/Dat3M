; ModuleID = '/home/ponce/git/Dat3M/output/rcu.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/lkmm/rcu.c"
...
@.str = private unnamed_addr constant [24 x i8] c"!(r_x == 1 && r_y == 0)\00", align 1
...
define dso_local i32 @main() #0 !dbg !62 {
  ...
  %12 = icmp eq i32 %11, 0, !dbg !77
  %or.cond = select i1 %10, i1 %12, i1 false, !dbg !77
  br i1 %or.cond, label %13, label %14, !dbg !77

13:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([44 x i8], [44 x i8]* @.str.1, i64 0, i64 0), i32 noundef 43, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !77
  unreachable, !dbg !77
...
!28 = !DIFile(filename: "benchmarks/lkmm/rcu.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "dad53a6fc905d03af1a936e703cc6339")
...
!52 = !DILocation(line: 19, column: 2, scope: !42)
!53 = distinct !DISubprogram(name: "P1", scope: !28, file: !28, line: 22, type: !43, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !45)
!54 = !DILocalVariable(name: "unused", arg: 1, scope: !53, file: !28, line: 22, type: !24)
!55 = !DILocation(line: 0, scope: !53)
!56 = !DILocation(line: 24, column: 8, scope: !53)
!57 = !DILocation(line: 24, column: 6, scope: !53)
!58 = !DILocation(line: 25, column: 2, scope: !53)
!59 = !DILocation(line: 26, column: 8, scope: !53)
!60 = !DILocation(line: 26, column: 6, scope: !53)
