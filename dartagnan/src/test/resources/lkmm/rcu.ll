...
@.str = private unnamed_addr constant [6 x i8] c"rcu.c\00", align 1, !dbg !37
@.str.1 = private unnamed_addr constant [24 x i8] c"!(r_x == 1 && r_y == 0)\00", align 1, !dbg !42
...
define dso_local ptr @P0(ptr noundef %0) #0 !dbg !61 {
  ...
  call void @__LKMM_store(ptr noundef @x, i64 noundef 4, i64 noundef 1, i32 noundef 0), !dbg !68
  call void @__LKMM_store(ptr noundef @y, i64 noundef 4, i64 noundef 1, i32 noundef 0), !dbg !69
  call void @__LKMM_fence(i32 noundef 7), !dbg !70
  ret ptr null, !dbg !71
}
...
define dso_local ptr @P1(ptr noundef %0) #0 !dbg !72 {
  ...
  store i32 %4, ptr @r_x, align 4, !dbg !76
  call void @__LKMM_fence(i32 noundef 8), !dbg !77
  %5 = call i64 @__LKMM_load(ptr noundef @y, i64 noundef 4, i32 noundef 0), !dbg !78
  %6 = trunc i64 %5 to i32, !dbg !78
  store i32 %6, ptr @r_y, align 4, !dbg !79
  ret ptr null, !dbg !80
}
...
!39 = !DICompositeType(tag: DW_TAG_array_type, baseType: !34, size: 48, elements: !40)
!40 = !{!41}
...
!50 = distinct !DIGlobalVariable(name: "r_x", scope: !2, file: !3, line: 10, type: !28, isLocal: false, isDefinition: true)
!51 = !DIGlobalVariableExpression(var: !52, expr: !DIExpression())
!52 = distinct !DIGlobalVariable(name: "r_y", scope: !2, file: !3, line: 11, type: !28, isLocal: false, isDefinition: true)
...
!63 = !{!27, !27}
!64 = !{}
!65 = !DILocalVariable(name: "unused", arg: 1, scope: !61, file: !3, line: 13, type: !27)
!66 = !DILocation(line: 13, column: 16, scope: !61)
!67 = !DILocation(line: 15, column: 2, scope: !61)
!68 = !DILocation(line: 16, column: 2, scope: !61)
!69 = !DILocation(line: 17, column: 2, scope: !61)
!70 = !DILocation(line: 18, column: 2, scope: !61)
!71 = !DILocation(line: 19, column: 2, scope: !61)
!72 = distinct !DISubprogram(name: "P1", scope: !3, file: !3, line: 22, type: !62, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!73 = !DILocalVariable(name: "unused", arg: 1, scope: !72, file: !3, line: 22, type: !27)
!74 = !DILocation(line: 22, column: 16, scope: !72)
!75 = !DILocation(line: 24, column: 8, scope: !72)
!76 = !DILocation(line: 24, column: 6, scope: !72)
!77 = !DILocation(line: 25, column: 2, scope: !72)
!78 = !DILocation(line: 26, column: 8, scope: !72)
!79 = !DILocation(line: 26, column: 6, scope: !72)
!80 = !DILocation(line: 27, column: 2, scope: !72)
...
!107 = !DILocation(line: 35, column: 15, scope: !81)
!108 = !DILocalVariable(name: "t2", scope: !81, file: !3, line: 35, type: !85)
!109 = !DILocation(line: 35, column: 19, scope: !81)
