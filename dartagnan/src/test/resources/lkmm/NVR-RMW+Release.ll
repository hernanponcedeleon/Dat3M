...
4:                                                ; preds = %1
  ...
  call void @__LKMM_STORE(i8* noundef bitcast (%struct.atomic_t* @y to i8*), i32 noundef 3, i32 noundef 3) #5, !dbg !63
  br label %12, !dbg !64
...
6:                                                ; preds = %1
  %7 = call i32 @__LKMM_LOAD(i8* noundef bitcast (%struct.atomic_t* @y to i8*), i32 noundef 2) #5, !dbg !67
