...
@.str = private unnamed_addr constant [23 x i8] c"CoWR+poonceonce+Once.c\00", align 1, !dbg !37
@.str.1 = private unnamed_addr constant [32 x i8] c"!(READ_ONCE(x) == 1 && r0 == 2)\00", align 1, !dbg !42
...
define dso_local ptr @thread_1(ptr noundef %0) #0 !dbg !57 {
  ...
  %3 = call i64 @__LKMM_load(ptr noundef @x, i64 noundef 4, i32 noundef 0), !dbg !64
  %4 = trunc i64 %3 to i32, !dbg !64
  store i32 %4, ptr @r0, align 4, !dbg !65
  ret ptr null, !dbg !66
}
...
!39 = !DICompositeType(tag: DW_TAG_array_type, baseType: !34, size: 184, elements: !40)
!40 = !{!41}
...
!48 = distinct !DIGlobalVariable(name: "r0", scope: !2, file: !3, line: 7, type: !27, isLocal: false, isDefinition: true)
...
!63 = !DILocation(line: 11, column: 2, scope: !57)
!64 = !DILocation(line: 12, column: 7, scope: !57)
!65 = !DILocation(line: 12, column: 5, scope: !57)
...
!82 = !{!83, !84, !94}
!83 = !DIDerivedType(tag: DW_TAG_member, name: "__sig", scope: !81, file: !79, line: 104, baseType: !26, size: 64)
