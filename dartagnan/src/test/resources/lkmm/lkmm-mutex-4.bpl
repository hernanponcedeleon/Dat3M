  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 94, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 94, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 96, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock(mutex);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 97, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 97, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 98, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 99, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 99, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 100, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 100, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 101, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock(mutex);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 102, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  mutex_lock($p0: ref)
{
  ...
  var $i7: i1;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 59, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 60, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 62, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 69, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 64, 9} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 64, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := __LKMM_cmpxchg.ref.ref.i32.i32.i32($p4, $p1, 2, 0, 0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 65, 9} true;
  assume {:verifier.code 0} true;
  call __futex_wait($p0, 2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 66, 13} true;
  assume {:verifier.code 0} true;
  call $i6 := mutex_lock_try_acquire($p0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 66, 13} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 66, 13} true;
...
$bb5:
  assume ($i7 == 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 67, 13} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb6:
  assume !(($i7 == 1));
...
procedure  mutex_unlock($p0: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 79, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 79, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 80, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 82, 5} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 82, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_store.ref.i32.i32($p3, 0, 3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 83, 5} true;
  assume {:verifier.code 0} true;
  call __futex_wake($p0, 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 84, 1} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 84, 1} true;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 73, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 74, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 74, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_cmpxchg.ref.ref.i32.i32.i32($p2, $p1, 0, 3, 3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 74, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (__LKMM_store == $sub.ref(0, 10304));
...
procedure  __futex_wake($p0: ref, $i1: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__futex_wake:arg:v"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_atomic_fetch_op.ref.i32.i32.i32(sig, 1, 3, 0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __LKMM_atomic_fetch_op: ref;
axiom (__LKMM_atomic_fetch_op == $sub.ref(0, 12368));
procedure  __LKMM_atomic_fetch_op.ref.i32.i32.i32(p.0: ref, p.1: i32, p.2: i32, p.3: i32)
  returns ($r: i32);
const __LKMM_cmpxchg: ref;
axiom (__LKMM_cmpxchg == $sub.ref(0, 13400));
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 47, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 48, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 48, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_cmpxchg.ref.ref.i32.i32.i32($p2, $p1, 1, 2, 2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
procedure  __futex_wait($p0: ref, $i1: i32)
{
  ...
  var $i7: i1;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__futex_wait:arg:v"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_load.ref.i32(sig, 2);
  call {:cexpr "s"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_load.ref.i32($p3, 2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 15, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, $i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 16, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call $i6 := __LKMM_load.ref.i32(sig, 2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 18, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, $i2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 18, 5} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 53, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 54, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 54, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_cmpxchg.ref.ref.i32.i32.i32($p2, $p1, 2, 2, 2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 54, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (__LKMM_load == $sub.ref(0, 17528));
procedure  __LKMM_load.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 111, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 112, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 113, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 114, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 116, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 116, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 117, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 117, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 118, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 118, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 119, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 121, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 121, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex-4.c", 123, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
