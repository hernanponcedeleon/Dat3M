...
@.str = private unnamed_addr constant [17 x i8] c"LB+poonceonces.c\00", align 1, !dbg !36
...
!38 = !DICompositeType(tag: DW_TAG_array_type, baseType: !33, size: 136, elements: !39)
!39 = !{!40}
