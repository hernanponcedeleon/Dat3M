; ModuleID = '/home/ponce/git/Dat3M/output/LB+poonceonces.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/lkmm/LB+poonceonces.c"
...
@.str.1 = private unnamed_addr constant [55 x i8] c"/home/ponce/git/Dat3M/benchmarks/lkmm/LB+poonceonces.c\00", align 1
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !42 {
  ...
  %2 = call i32 @__LKMM_LOAD(i32* noundef nonnull @x, i32 noundef 1) #5, !dbg !48
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !52 {
  ...
  %2 = call i32 @__LKMM_LOAD(i32* noundef nonnull @y, i32 noundef 1) #5, !dbg !55
  store i32 %2, i32* @r1, align 4, !dbg !56
  call void @__LKMM_STORE(i32* noundef nonnull @x, i32 noundef 1, i32 noundef 1) #5, !dbg !57
  ret i8* null, !dbg !58
}
...
13:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i64 0, i64 0), i32 noundef 35, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !74
  unreachable, !dbg !74
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/lkmm/LB+poonceonces.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "596b7c853e97a0391e55914691d22b8f")
!4 = !{!5}
...
!28 = !DIFile(filename: "benchmarks/lkmm/LB+poonceonces.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "596b7c853e97a0391e55914691d22b8f")
