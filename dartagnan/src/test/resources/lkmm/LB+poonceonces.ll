...
@.str = private unnamed_addr constant [17 x i8] c"LB+poonceonces.c\00", align 1, !dbg !38
...
!40 = !DICompositeType(tag: DW_TAG_array_type, baseType: !35, size: 136, elements: !41)
!41 = !{!42}
