; ModuleID = '/home/ponce/git/Dat3M/output/qspinlock.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/lkmm/qspinlock.c"
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !57 {
  ...
  %2 = call i32 @__LKMM_ATOMIC_FETCH_OP(i32* noundef getelementptr inbounds (%struct.atomic_t, %struct.atomic_t* @y, i64 0, i32 0), i32 noundef 2, i32 noundef 0, i32 noundef 3) #5, !dbg !60
  ret i8* null, !dbg !61
}
...
7:                                                ; preds = %4
  call void @__assert_fail(i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str.1, i64 0, i64 0), i32 noundef 26, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.thread_3, i64 0, i64 0)) #6, !dbg !71
  unreachable, !dbg !71
