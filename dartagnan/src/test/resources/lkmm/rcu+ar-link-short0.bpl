...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/rcu+ar-link-short0.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/rcu+ar-link-short0.c
...
axiom (__LKMM_STORE == $sub.ref(0, 11328));
...
axiom (__LKMM_LOAD == $sub.ref(0, 13392));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 59, 2} true;
  assume {:verifier.code 0} true;
  call __LKMM_STORE($add.ref($add.ref(w, $mul.ref(0, 8)), $mul.ref(1, 4)), 2, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 72, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 73, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 77, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 77, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 78, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 78, 2} true;
  assume {:verifier.code 0} true;
