...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38160));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 40, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 45, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 45, 6} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(x);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 45, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 45, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 46, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 47, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 53, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, r_s);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 53, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 53, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_w, $i5);
  call {:cexpr "r_w"} boogie_si_record_i32($i5);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 54, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 60, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_FENCE.i32(11);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 61, 8} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_READ_ONCE.ref(y);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 61, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_y, $i3);
  call {:cexpr "r_y"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 74, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 75, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 76, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 77, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 79, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 79, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 80, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 80, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 81, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 81, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 82, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 82, 2} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 84, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 84, 2} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, r_y);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 84, 2} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i16, 0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link-short0.c", 84, 2} true;
...
axiom (llvm.dbg.value == $sub.ref(0, 37128));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 38160));
