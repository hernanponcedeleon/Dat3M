; ModuleID = '/home/ponce/git/Dat3M/output/CoRW+poonce+Once.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/lkmm/CoRW+poonce+Once.c"
...
@.str = private unnamed_addr constant [32 x i8] c"!(READ_ONCE(x) == 2 && r0 == 2)\00", align 1
...
13:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([57 x i8], [57 x i8]* @.str.1, i64 0, i64 0), i32 noundef 32, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !68
  unreachable, !dbg !68
...
!28 = !DIFile(filename: "benchmarks/lkmm/CoRW+poonce+Once.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "7ba65203ffa8596e0a368dd8dfc16793")
...
!44 = !DILocation(line: 11, column: 7, scope: !38)
!45 = !DILocation(line: 11, column: 5, scope: !38)
!46 = !DILocation(line: 12, column: 2, scope: !38)
