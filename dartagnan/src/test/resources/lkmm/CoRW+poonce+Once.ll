...
@.str = private unnamed_addr constant [19 x i8] c"CoRW+poonce+Once.c\00", align 1, !dbg !36
@.str.1 = private unnamed_addr constant [32 x i8] c"!(READ_ONCE(x) == 2 && r0 == 2)\00", align 1, !dbg !41
...
define ptr @thread_1(ptr noundef %0) #0 !dbg !55 {
  ...
  %3 = call i64 @__LKMM_load(ptr noundef @x, i64 noundef 4, i32 noundef 1), !dbg !61
  %4 = trunc i64 %3 to i32, !dbg !61
  store i32 %4, ptr @r0, align 4, !dbg !62
...
!47 = distinct !DIGlobalVariable(name: "r0", scope: !2, file: !3, line: 7, type: !24, isLocal: false, isDefinition: true)
...
!61 = !DILocation(line: 11, column: 7, scope: !55)
!62 = !DILocation(line: 11, column: 5, scope: !55)
!63 = !DILocation(line: 12, column: 2, scope: !55)
