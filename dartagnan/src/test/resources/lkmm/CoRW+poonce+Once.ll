...
@.str = private unnamed_addr constant [19 x i8] c"CoRW+poonce+Once.c\00", align 1, !dbg !38
@.str.1 = private unnamed_addr constant [32 x i8] c"!(READ_ONCE(x) == 2 && r0 == 2)\00", align 1, !dbg !43
...
define dso_local ptr @thread_1(ptr noundef %0) #0 !dbg !58 {
  ...
  %3 = call i64 @__LKMM_load(ptr noundef @x, i64 noundef 4, i32 noundef 1), !dbg !64
...
!49 = distinct !DIGlobalVariable(name: "r0", scope: !2, file: !3, line: 7, type: !24, isLocal: false, isDefinition: true)
...
!64 = !DILocation(line: 11, column: 7, scope: !58)
!65 = !DILocation(line: 11, column: 5, scope: !58)
!66 = !DILocation(line: 12, column: 2, scope: !58)
...
!83 = !{!84, !85, !95}
!84 = !DIDerivedType(tag: DW_TAG_member, name: "__sig", scope: !82, file: !80, line: 104, baseType: !28, size: 64)
