...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !50 {
  ...
  %2 = call i32 @__LKMM_LOAD(i8* noundef bitcast (%struct.atomic_t* @x to i8*), i32 noundef 1) #5, !dbg !56
...
5:                                                ; preds = %1
  call void @__LKMM_STORE(i8* noundef bitcast (%struct.atomic_t* @y to i8*), i32 noundef 1, i32 noundef 1) #5, !dbg !61
  br label %6, !dbg !64
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !66 {
  ...
  %2 = call i32 @__LKMM_LOAD(i8* noundef bitcast (%struct.atomic_t* @y to i8*), i32 noundef 1) #5, !dbg !69
...
5:                                                ; preds = %1
  call void @__LKMM_STORE(i8* noundef bitcast (%struct.atomic_t* @x to i8*), i32 noundef 1, i32 noundef 1) #5, !dbg !74
  br label %6, !dbg !77
...
define dso_local i8* @thread_3(i8* noundef %0) #0 !dbg !79 {
  ...
  call void @__LKMM_STORE(i8* noundef bitcast (%struct.atomic_t* @x to i8*), i32 noundef 2, i32 noundef 1) #5, !dbg !82
  ret i8* null, !dbg !83
}
...
17:                                               ; preds = %0
  %18 = call i32 @__LKMM_LOAD(i8* noundef bitcast (%struct.atomic_t* @x to i8*), i32 noundef 1) #5, !dbg !103
  %19 = icmp eq i32 %18, 2, !dbg !103
  br i1 %19, label %20, label %21, !dbg !106

20:                                               ; preds = %17
  call void @__assert_fail(i8* noundef getelementptr inbounds ([47 x i8], [47 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([68 x i8], [68 x i8]* @.str.1, i64 0, i64 0), i32 noundef 53, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !103
  unreachable, !dbg !103
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/lkmm/C-WWC+o-branch-o+o-branch-o.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "c3eaf7aa28720acf6f1b88f61df956b8")
!4 = !{!5}
...
!28 = !DIFile(filename: "benchmarks/lkmm/C-WWC+o-branch-o+o-branch-o.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "c3eaf7aa28720acf6f1b88f61df956b8")
...
!65 = !DILocation(line: 22, column: 5, scope: !50)
!66 = distinct !DISubprogram(name: "thread_2", scope: !28, file: !28, line: 25, type: !51, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !53)
!67 = !DILocalVariable(name: "unused", arg: 1, scope: !66, file: !28, line: 25, type: !24)
!68 = !DILocation(line: 0, scope: !66)
!69 = !DILocation(line: 27, column: 9, scope: !66)
!70 = !DILocation(line: 27, column: 7, scope: !66)
!71 = !DILocation(line: 28, column: 15, scope: !66)
!72 = !DILocation(line: 28, column: 7, scope: !66)
!73 = !DILocation(line: 29, column: 6, scope: !66)
!74 = !DILocation(line: 30, column: 3, scope: !75)
!75 = distinct !DILexicalBlock(scope: !76, file: !28, line: 29, column: 12)
!76 = distinct !DILexicalBlock(scope: !66, file: !28, line: 29, column: 6)
!77 = !DILocation(line: 31, column: 2, scope: !75)
!78 = !DILocation(line: 32, column: 5, scope: !66)
!79 = distinct !DISubprogram(name: "thread_3", scope: !28, file: !28, line: 35, type: !51, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !53)
!80 = !DILocalVariable(name: "unused", arg: 1, scope: !79, file: !28, line: 35, type: !24)
!81 = !DILocation(line: 0, scope: !79)
!82 = !DILocation(line: 37, column: 2, scope: !79)
!83 = !DILocation(line: 38, column: 5, scope: !79)
!84 = distinct !DISubprogram(name: "main", scope: !28, file: !28, line: 41, type: !85, scopeLine: 42, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !53)
!85 = !DISubroutineType(types: !86)
!86 = !{!33}
!87 = !DILocalVariable(name: "t1", scope: !84, file: !28, line: 43, type: !88)
...
!92 = !DILocation(line: 45, column: 2, scope: !84)
!93 = !DILocalVariable(name: "t2", scope: !84, file: !28, line: 43, type: !88)
!94 = !DILocation(line: 46, column: 2, scope: !84)
!95 = !DILocalVariable(name: "t3", scope: !84, file: !28, line: 43, type: !88)
!96 = !DILocation(line: 47, column: 2, scope: !84)
!97 = !DILocation(line: 49, column: 15, scope: !84)
!98 = !DILocation(line: 49, column: 2, scope: !84)
!99 = !DILocation(line: 50, column: 15, scope: !84)
!100 = !DILocation(line: 50, column: 2, scope: !84)
!101 = !DILocation(line: 51, column: 15, scope: !84)
!102 = !DILocation(line: 51, column: 2, scope: !84)
!103 = !DILocation(line: 53, column: 2, scope: !104)
!104 = distinct !DILexicalBlock(scope: !105, file: !28, line: 53, column: 2)
!105 = distinct !DILexicalBlock(scope: !84, file: !28, line: 53, column: 2)
!106 = !DILocation(line: 53, column: 2, scope: !105)
!107 = !DILocation(line: 55, column: 2, scope: !84)
