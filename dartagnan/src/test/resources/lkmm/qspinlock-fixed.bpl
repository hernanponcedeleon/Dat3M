...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/qspinlock-fixed.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/qspinlock-fixed.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 33016));
...
axiom (__LKMM_STORE == $sub.ref(0, 5152));
procedure  __LKMM_STORE($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 6184));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/qspinlock-fixed.c", 18, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_ATOMIC_FETCH_OP(y, 2, 3, 3);
...
axiom (__LKMM_ATOMIC_FETCH_OP == $sub.ref(0, 7216));
procedure  __LKMM_ATOMIC_FETCH_OP($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 8248));
...
axiom (__LKMM_LOAD == $sub.ref(0, 9280));
procedure  __LKMM_LOAD($p0: ref, $i1: i32)
  returns ($r: i32);
const __LKMM_FENCE: ref;
axiom (__LKMM_FENCE == $sub.ref(0, 10312));
...
axiom (__SMACK_dummy == $sub.ref(0, 16504));
...
axiom (__VERIFIER_assert == $sub.ref(0, 17536));
...
axiom (__SMACK_and32 == $sub.ref(0, 18568));
...
axiom (__SMACK_and64 == $sub.ref(0, 19600));
...
axiom (__SMACK_and16 == $sub.ref(0, 20632));
...
axiom (__SMACK_and8 == $sub.ref(0, 21664));
...
axiom (__SMACK_or32 == $sub.ref(0, 22696));
...
axiom (__SMACK_or64 == $sub.ref(0, 23728));
...
axiom (__SMACK_or16 == $sub.ref(0, 24760));
...
axiom (__SMACK_or8 == $sub.ref(0, 25792));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 26824));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 27856));
...
axiom (__SMACK_decls == $sub.ref(0, 28888));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 29920));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 30952));
...
axiom (llvm.dbg.value == $sub.ref(0, 31984));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 33016));
