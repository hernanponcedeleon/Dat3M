...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !59 {
  ...
  call void @__LKMM_STORE(i32* noundef nonnull @y, i32 noundef 1, i32 noundef 1) #4, !dbg !62
  %2 = call i32 @__LKMM_LOAD(i32* noundef getelementptr inbounds (%struct.atomic_t, %struct.atomic_t* @x, i64 0, i32 0), i32 noundef 1) #4, !dbg !63
  ...
  call void @__LKMM_STORE(i32* noundef nonnull @z, i32 noundef 1, i32 noundef 1) #4, !dbg !68
  ret i8* undef, !dbg !69
}
...
define dso_local i8* @thread_3(i8* noundef %0) #0 !dbg !70 {
  ...
  call void @__LKMM_STORE(i32* noundef nonnull @z, i32 noundef 2, i32 noundef 1) #4, !dbg !73
  %2 = call i32 @__LKMM_LOAD(i32* noundef getelementptr inbounds (%struct.atomic_t, %struct.atomic_t* @x, i64 0, i32 0), i32 noundef 1) #4, !dbg !74
  ...
  call void @__LKMM_STORE(i32* noundef nonnull @y, i32 noundef 0, i32 noundef 1) #4, !dbg !77
...
4:                                                ; preds = %7, %1
  %5 = call i32 @__LKMM_LOAD(i32* noundef nonnull @y, i32 noundef 1) #4, !dbg !81
  %6 = icmp eq i32 %5, 1, !dbg !82
  br i1 %6, label %7, label %.critedge, !dbg !83

7:                                                ; preds = %4
  %8 = call i32 @__LKMM_LOAD(i32* noundef nonnull @z, i32 noundef 1) #4, !dbg !84
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/lkmm/qspinlock-liveness.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "7596acf1a0aabf2df09c127a5865be78")
!4 = !{!5, !23}
...
!34 = !DIFile(filename: "benchmarks/lkmm/qspinlock-liveness.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "7596acf1a0aabf2df09c127a5865be78")
...
!58 = !DILocation(line: 13, column: 1, scope: !50)
!59 = distinct !DISubprogram(name: "thread_2", scope: !34, file: !34, line: 15, type: !51, scopeLine: 16, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !53)
!60 = !DILocalVariable(name: "unused", arg: 1, scope: !59, file: !34, line: 15, type: !30)
!61 = !DILocation(line: 0, scope: !59)
!62 = !DILocation(line: 18, column: 5, scope: !59)
!63 = !DILocation(line: 20, column: 14, scope: !59)
!64 = !DILocalVariable(name: "r0", scope: !59, file: !34, line: 20, type: !35)
!65 = !DILocation(line: 22, column: 5, scope: !59)
!66 = !DILocation(line: 24, column: 14, scope: !59)
!67 = !DILocalVariable(name: "r1", scope: !59, file: !34, line: 24, type: !35)
!68 = !DILocation(line: 26, column: 5, scope: !59)
!69 = !DILocation(line: 27, column: 1, scope: !59)
!70 = distinct !DISubprogram(name: "thread_3", scope: !34, file: !34, line: 29, type: !51, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !53)
!71 = !DILocalVariable(name: "unused", arg: 1, scope: !70, file: !34, line: 29, type: !30)
!72 = !DILocation(line: 0, scope: !70)
!73 = !DILocation(line: 32, column: 5, scope: !70)
!74 = !DILocation(line: 34, column: 14, scope: !70)
!75 = !DILocalVariable(name: "r0", scope: !70, file: !34, line: 34, type: !35)
!76 = !DILocation(line: 36, column: 5, scope: !70)
!77 = !DILocation(line: 38, column: 5, scope: !70)
!78 = !DILocation(line: 40, column: 14, scope: !70)
!79 = !DILocalVariable(name: "r1", scope: !70, file: !34, line: 40, type: !35)
!80 = !DILocation(line: 42, column: 5, scope: !70)
!81 = !DILocation(line: 42, column: 11, scope: !70)
!82 = !DILocation(line: 42, column: 24, scope: !70)
!83 = !DILocation(line: 42, column: 29, scope: !70)
!84 = !DILocation(line: 42, column: 33, scope: !70)
!85 = !DILocation(line: 42, column: 46, scope: !70)
!86 = distinct !{!86, !80, !87, !88}
!87 = !DILocation(line: 42, column: 54, scope: !70)
!88 = !{!"llvm.loop.mustprogress"}
!89 = !DILocation(line: 43, column: 1, scope: !70)
!90 = distinct !DISubprogram(name: "main", scope: !34, file: !34, line: 45, type: !91, scopeLine: 46, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !53)
!91 = !DISubroutineType(types: !92)
!92 = !{!35}
!93 = !DILocalVariable(name: "t1", scope: !90, file: !34, line: 47, type: !94)
...
!98 = !DILocation(line: 49, column: 2, scope: !90)
!99 = !DILocalVariable(name: "t2", scope: !90, file: !34, line: 47, type: !94)
!100 = !DILocation(line: 50, column: 2, scope: !90)
!101 = !DILocalVariable(name: "t3", scope: !90, file: !34, line: 47, type: !94)
!102 = !DILocation(line: 51, column: 2, scope: !90)
!103 = !DILocation(line: 53, column: 2, scope: !90)
