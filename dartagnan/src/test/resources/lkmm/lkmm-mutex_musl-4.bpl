  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 91, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 91, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 93, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock(mutex);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 94, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 94, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 95, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 96, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 96, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 97, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 97, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 98, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock(mutex);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 99, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb2:
  ...
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 73, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
...
procedure  mutex_unlock($p0: ref)
{
  ...
  var $p9: ref;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 77, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 77, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 77, 15} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_xchg.ref.i32.i32($p2, 0, 3);
  call {:cexpr "old"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 78, 9} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  $p5 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 78, 9} true;
  assume {:verifier.code 0} true;
  call $i6 := __LKMM_READ_ONCE.ref($p5);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 78, 34} true;
  assume {:verifier.code 0} true;
  $i7 := $sgt.i32($i6, 0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 78, 38} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 79, 26} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 79, 9} true;
  assume {:verifier.code 0} true;
  call __futex_wake($p9, 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 79, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 78, 45} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i3, 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 78, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 80, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __LKMM_xchg: ref;
axiom (__LKMM_xchg == $sub.ref(0, 9276));
procedure  __LKMM_xchg.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const __LKMM_READ_ONCE: ref;
axiom (__LKMM_READ_ONCE == $sub.ref(0, 10308));
...
procedure  __futex_wake($p0: ref, $i1: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__futex_wake:arg:v"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_atomic_fetch_op.ref.i32.i32.i32(sig, 1, 3, 0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __LKMM_atomic_fetch_op: ref;
axiom (__LKMM_atomic_fetch_op == $sub.ref(0, 12372));
...
procedure  __futex_wait($p0: ref, $i1: i32)
{
  ...
  var $i7: i1;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 14, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_load.ref.i32($p3, 2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 15, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, $i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 16, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call $i6 := __LKMM_load.ref.i32(sig, 2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 18, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, $i2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
axiom (__LKMM_load == $sub.ref(0, 17532));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 107, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 109, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 110, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 111, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 112, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 114, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 114, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 115, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 115, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 116, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 116, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 117, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 117, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 119, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 119, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 121, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure  mutex_init($p0: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 44, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 44, 5} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 45, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  $p5 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 45, 5} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-mutex_musl-4.c", 46, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
axiom (__LKMM_WRITE_ONCE == $sub.ref(0, 22692));
