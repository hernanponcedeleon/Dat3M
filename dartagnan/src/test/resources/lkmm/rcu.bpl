...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -bpl /Users/ponce/git/Dat3M/output/rcu.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/rcu.c
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 19, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 24, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 24, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(x);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 24, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_x, $i1);
  call {:cexpr "r_x"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 25, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_FENCE.i32(11);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 26, 8} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_READ_ONCE.ref(y);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r_y, $i3);
  call {:cexpr "r_y"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 27, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 39, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 42, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 42, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 43, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 43, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 45, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 45, 2} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "benchmarks/lkmm/rcu.c", 47, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
