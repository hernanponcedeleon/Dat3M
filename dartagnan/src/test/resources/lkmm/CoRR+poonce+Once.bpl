...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/CoRR+poonce+Once.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/CoRR+poonce+Once.c
...
axiom (__LKMM_STORE == $sub.ref(0, 6180));
...
axiom (__LKMM_LOAD == $sub.ref(0, 8244));
