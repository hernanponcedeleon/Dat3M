...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/include/smack -I/home/ponce/git/Dat3M/include/clang -I/home/ponce/git/Dat3M/include -I/home/ponce/git/cna-verification/include -DALGORITHM=1 -DFIX1 -DFIX2 -DFIX3 -DFIX4 -DFIX5 -bpl /home/ponce/git/Dat3M/output/qspinlock-liveness.bpl /home/ponce/git/Dat3M/benchmarks/lkmm/qspinlock-liveness.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 33012));
...
axiom (z == $sub.ref(0, 3084));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 4116));
procedure  thread_1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 12, 14} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 12, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_ATOMIC_FETCH_OP(x, 2, 4, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (__LKMM_ATOMIC_FETCH_OP == $sub.ref(0, 6180));
procedure  __LKMM_ATOMIC_FETCH_OP($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 7212));
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 18, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 18, 5} true;
  assume {:verifier.code 0} true;
  call __LKMM_STORE(y, 1, 1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 20, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_LOAD(x, 1);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call __LKMM_FENCE(5);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 24, 14} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_CMPXCHG(x, $i1, 42, 0, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call __LKMM_STORE(z, 1, 1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (__LKMM_LOAD == $sub.ref(0, 9276));
procedure  __LKMM_LOAD($p0: ref, $i1: i32)
  returns ($r: i32);
const __LKMM_FENCE: ref;
axiom (__LKMM_FENCE == $sub.ref(0, 10308));
...
procedure  __LKMM_CMPXCHG($p0: ref, $i1: i32, $i2: i32, $i3: i32, $i4: i32)
  returns ($r: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 12372));
  ...
  returns ($r: ref)
{
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 32, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 32, 5} true;
  assume {:verifier.code 0} true;
  call __LKMM_STORE(z, 2, 1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 34, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_LOAD(x, 1);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 36, 5} true;
  assume {:verifier.code 0} true;
  call __LKMM_FENCE(5);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 38, 5} true;
  assume {:verifier.code 0} true;
  call __LKMM_STORE(y, 0, 1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 40, 14} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_CMPXCHG(x, $i1, 24, 0, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 42, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 42, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_LOAD(y, 1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 42, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 42, 29} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 42, 33} true;
  assume {:verifier.code 0} true;
  call $i6 := __LKMM_LOAD(z, 1);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 42, 46} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 2);
  assume {:verifier.code 0} true;
  $i5 := $i7;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 42, 5} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 43, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 49, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 50, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 51, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread_3, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/qspinlock-liveness.c", 53, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 14436));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 15468));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 16500));
...
axiom (__SMACK_dummy == $sub.ref(0, 17532));
...
axiom (__SMACK_and32 == $sub.ref(0, 18564));
...
axiom (__SMACK_and64 == $sub.ref(0, 19596));
...
axiom (__SMACK_and16 == $sub.ref(0, 20628));
...
axiom (__SMACK_and8 == $sub.ref(0, 21660));
...
axiom (__SMACK_or32 == $sub.ref(0, 22692));
...
axiom (__SMACK_or64 == $sub.ref(0, 23724));
...
axiom (__SMACK_or16 == $sub.ref(0, 24756));
...
axiom (__SMACK_or8 == $sub.ref(0, 25788));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 26820));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 27852));
...
axiom (__SMACK_decls == $sub.ref(0, 28884));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 29916));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 30948));
...
axiom (llvm.dbg.value == $sub.ref(0, 31980));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 33012));
