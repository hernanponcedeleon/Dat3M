...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/cna-verification/include -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include/smack -DNTHREADS=3 -DREACQUIRE=1 -DALGORITHM=3 -bpl /Users/ponce/git/Dat3M/output/LB+fencembonceonce+ctrlonceonce.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 13, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 13, 7} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(x);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r0, $i1);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 14, 6} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, r0);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 14, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := __LKMM_WRITE_ONCE.ref.i32(y, 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 16, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 21, 7} true;
  assume {:verifier.code 0} true;
  call $i1 := __LKMM_READ_ONCE.ref(y);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r1, $i1);
  call {:cexpr "r1"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_FENCE.i32(6);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_WRITE_ONCE.ref.i32(x, 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 24, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (__LKMM_FENCE == $sub.ref(0, 10304));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 31, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 32, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 32, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 33, 6} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 34, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 36, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 36, 6} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 38, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 38, 6} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 39, 3} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 39, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 41, 2} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 41, 2} true;
...
$bb14:
  ...
  goto $bb12;
$bb15:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 43, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
