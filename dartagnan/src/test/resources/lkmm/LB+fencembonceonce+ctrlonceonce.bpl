...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -bpl /Users/ponce/git/Dat3M/output/LB+fencembonceonce+ctrlonceonce.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 13, 2} true;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 21, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 21, 2} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 31, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 32, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 34, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 34, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 35, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 35, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call $i8 := __LKMM_READ_ONCE.ref(r0);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 2} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 2} true;
...
$bb2:
  ...
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call $i10 := __LKMM_READ_ONCE.ref(r1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, 1);
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 37, 2} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "benchmarks/lkmm/LB+fencembonceonce+ctrlonceonce.c", 39, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
