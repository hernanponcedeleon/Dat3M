...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 19, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := __LKMM_WRITE_ONCE.ref.i32(x, 2);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 20, 7} true;
  assume {:verifier.code 0} true;
  call $i3 := __LKMM_READ_ONCE.ref(y);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 20, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 22, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 30, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 35, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 35, 10} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 37, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r2, $i1);
  call {:cexpr "r2"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 38, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 40, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 48, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 63, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 65, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 65, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 66, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 66, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 67, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 67, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 68, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 68, 2} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 70, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 70, 2} true;
...
$bb10:
  ...
  goto $bb4;
$bb11:
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 72, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
