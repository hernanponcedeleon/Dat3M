...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/rcu+ar-link20.bpl /Users/ponce/git/Dat3M/benchmarks/lkmm/rcu+ar-link20.c
...
axiom (__LKMM_LOAD == $sub.ref(0, 11328));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 58, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 63, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 63, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/rcu+ar-link20.c", 64, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
