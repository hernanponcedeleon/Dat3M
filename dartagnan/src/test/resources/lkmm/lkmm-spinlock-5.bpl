  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 67, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 67, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 69, 5} true;
  assume {:verifier.code 0} true;
  call spinlock_acquire(lock);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 70, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 70, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 71, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 72, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 72, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 73, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 73, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call spinlock_release(lock);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 75, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  spinlock_acquire($p0: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 43, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 43, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 44, 9} true;
  assume {:verifier.code 0} true;
  call await_for_lock($p0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 45, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 45, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := try_get_lock($p0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 45, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 45, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 46, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  spinlock_release($p0: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 56, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 56, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 57, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  await_for_lock($p0: ref)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 30, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 30, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  $p2 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 30, 12} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 30, 34} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 30, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 84, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 85, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 86, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 87, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 88, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 89, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p4, $0.ref, thread_n, $i2p.i64.ref(4));
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 91, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 92, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 92, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 93, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 93, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 94, 18} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 94, 5} true;
  assume {:verifier.code 0} true;
  call $i17 := pthread_join($i16, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 95, 18} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i32($M.0, $p4);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 95, 5} true;
  assume {:verifier.code 0} true;
  call $i19 := pthread_join($i18, $0.ref);
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 97, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 97, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 99, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure  spinlock_init($p0: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 25, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  ...
  assume {:sourceloc "benchmarks/lkmm/lkmm-spinlock-5.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
