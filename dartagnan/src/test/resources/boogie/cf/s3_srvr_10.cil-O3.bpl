...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding bit-vector --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I/root/git/Dat3M/include/ -bpl /root/git/Dat3M/output/s3_srvr_10.cil-O3.bpl /root/git/Dat3M/output/s3_srvr_10.cil_tmp.c
...
{
$bb0:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 3, 22} true;
  ...
  returns ($r: bv32)
{
  ...
  var $i25: bv32;
$bb0:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 13, 26} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 14, 25} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 18, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 21, 16} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 24, 18} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 26, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 27, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 28, 24} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 29, 26} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 30, 41} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 31, 31} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 32, 48} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 33, 36} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 34, 41} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 38, 32} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 41, 47} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 43, 13} true;
  assume {:verifier.code 1} true;
  call $i17 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i17);
  call {:cexpr "buf"} boogie_si_record_bv32($i17);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 46, 23} true;
  assume {:verifier.code 1} true;
  call $i18 := __VERIFIER_nondet_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long"} boogie_si_record_bv64($i18);
  call {:cexpr "tmp"} boogie_si_record_bv64($i18);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 54, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 55, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 61, 18} true;
  assume {:verifier.code 1} true;
  call $i21 := __VERIFIER_nondet_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long"} boogie_si_record_bv64($i21);
  call {:cexpr "tmp___8"} boogie_si_record_bv64($i21);
  call {:cexpr "ssl3_accept:arg:s__state"} boogie_si_record_bv32($i0);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 89, 7} true;
  assume {:verifier.code 0} true;
  $i22 := $or.bv32($i11, $i1);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 89, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.bv32($i22, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 102, 15} true;
  assume {:verifier.code 0} true;
  $i24 := $eq.bv32($i6, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 102, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.bv32(0bv32, 1bv32);
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 633, 1} true;
  assume {:verifier.code 0} true;
  $r := $i25;
  $exn := false;
  return;
$bb3:
  assume !(($i24 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 89, 24} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.bv32($i1, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i27 := $ne.bv32($i9, 0bv32);
  assume {:verifier.code 0} true;
  $i28 := $ne.bv32($i8, $sub.bv32(0bv32, 4bv32));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i29 := $and.bv1($i28, $i27);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.bv32($i4, 0bv32);
  assume {:verifier.code 0} true;
  $i31 := (if ($i30 == 1bv1) then 8512bv32 else 8656bv32);
  assume {:verifier.code 0} true;
  $i32 := (if ($i30 == 1bv1) then 3bv32 else 8640bv32);
  assume {:verifier.code 0} true;
  $i33 := (if ($i30 == 1bv1) then 8656bv32 else 3bv32);
  assume {:verifier.code 0} true;
  $i34 := $slt.bv64($i21, 1bv64);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i35 := $eq.bv32($i5, 0bv32);
  assume {:verifier.code 0} true;
  $i36 := $ugt.bv32($i8, 4294967293bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i37 := $or.bv1($i29, $i36);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 106, 3} true;
  assume {:verifier.code 0} true;
  $i38, $i39, $i40, $i41, $i42, $i43 := $u0, $i0, 0bv32, $u0, $i0, 0bv32;
...
$bb28:
  ...
  goto $bb18;
$bb29:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 124, 19} true;
  assume {:verifier.code 0} true;
  $i54 := $and.bv32($i44, 4294967294bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 124, 19} true;
  assume {:verifier.code 0} true;
  $i55 := $eq.bv32($i54, 8480bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 124, 19} true;
  assume {:verifier.code 0} true;
...
$bb30:
  assume ($i55 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 263, 83} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 264, 85} true;
  assume {:verifier.code 0} true;
  $i134 := $slt.bv32($i133, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 264, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $i133, $i43, 8448bv32, 8482bv32;
...
$bb33:
  assume ($i56 == 1bv1);
  assume {:verifier.code 0} true;
  $i61 := $add.bv32($i44, 4294958832bv32);
  assume {:verifier.code 0} true;
  $i62 := $ule.bv32($i61, 2bv32);
  assume {:verifier.code 0} true;
...
$bb34:
  assume !(($i56 == 1bv1));
  assume {:verifier.code 0} true;
  $i57 := $eq.bv32($i44, 8482bv32);
  assume {:verifier.code 0} true;
  $i58, $i59, $i60 := $i43, 3bv32, $i41;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 604, 13} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i62 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 278, 83} true;
  assume {:verifier.code 1} true;
  call $i63 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i63);
  call {:cexpr "ret"} boogie_si_record_bv32($i63);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 282, 85} true;
  assume {:verifier.code 0} true;
  $i64 := $slt.bv32($i63, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 282, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $i63;
...
$bb42:
  assume !(($i64 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 279, 91} true;
  assume {:verifier.code 0} true;
  $i65 := $eq.bv32($i43, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 279, 81} true;
  assume {:verifier.code 0} true;
  $i66 := (if ($i65 == 1bv1) then 1bv32 else $i43);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i66);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 595, 17} true;
  assume {:verifier.code 0} true;
  $i67 := $eq.bv32($i44, 8464bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 595, 11} true;
  assume {:verifier.code 0} true;
  $i68 := $and.bv1($i23, $i67);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 595, 11} true;
  assume {:verifier.code 0} true;
  $i58, $i59, $i60 := $i66, 8496bv32, $i41;
...
$bb44:
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 630, 11} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:verifier.code 0} true;
  assume false;
$bb45:
  ...
  goto $bb36;
$bb46:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 142, 31} true;
  assume {:verifier.code 0} true;
  $i69 := $add.bv32($i54, 4294958800bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 142, 31} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  assume true;
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 358, 95} true;
  assume {:verifier.code 1} true;
  call $i84 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i84);
  call {:cexpr "ret"} boogie_si_record_bv32($i84);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 359, 97} true;
  assume {:verifier.code 0} true;
  $i85 := $slt.bv32($i84, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 359, 93} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $i84, $i43, 8544bv32, $i41;
  assume {:branchcond $i85} true;
  goto $bb68, $bb69;
$bb51:
  assume !(($i74 == 1bv1));
  assume {:verifier.code 0} true;
  $i75 := $slt.bv32($i72, 4bv32);
  assume {:verifier.code 0} true;
...
$bb52:
  assume ($i75 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 381, 81} true;
  assume {:verifier.code 0} true;
  $i78 := 8560bv32;
...
$bb54:
  assume ($i76 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 423, 83} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 424, 85} true;
  assume {:verifier.code 0} true;
  $i81 := $slt.bv32($i80, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 424, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $i80, $i43, 8448bv32, 8576bv32;
...
$bb60:
  assume ($i79 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 291, 83} true;
  assume {:verifier.code 1} true;
  call $i86 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i86);
  call {:cexpr "ret"} boogie_si_record_bv32($i86);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 295, 85} true;
  assume {:verifier.code 0} true;
  $i87 := $slt.bv32($i86, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 295, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $i86;
...
$bb65:
  assume !(($i37 == 1bv1));
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 405, 89} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 406, 91} true;
  assume {:verifier.code 0} true;
  $i83 := $slt.bv32($i82, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 406, 87} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $i82, $i43, 8448bv32, 8576bv32;
...
$bb71:
  assume !(($i87 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 292, 91} true;
  assume {:verifier.code 0} true;
  $i88 := $eq.bv32($i43, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 292, 81} true;
  assume {:verifier.code 0} true;
  $i89 := (if ($i88 == 1bv1) then 2bv32 else $i43);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i89);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 304, 77} true;
  assume {:verifier.code 0} true;
  $i58, $i59, $i60 := $i89, $i31, $i41;
  goto $bb36;
$bb72:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 172, 60} true;
  assume {:verifier.code 0} true;
  $i90 := $eq.bv32($i44, 8448bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 172, 51} true;
  assume {:verifier.code 0} true;
...
$bb73:
  assume ($i90 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 433, 84} true;
  assume {:verifier.code 1} true;
  call $i130 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i130);
  call {:cexpr "num1"} boogie_si_record_bv32($i130);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 434, 86} true;
  assume {:verifier.code 0} true;
  $i131 := $sgt.bv32($i130, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 434, 81} true;
  assume {:verifier.code 0} true;
  $i132 := $and.bv1($i34, $i131);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 434, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $sub.bv32(0bv32, 1bv32), $i43, $i41, $i41;
  assume {:branchcond $i132} true;
  goto $bb123, $bb124;
$bb74:
  assume !(($i90 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 175, 53} true;
  assume {:verifier.code 0} true;
  $i91 := $add.bv32($i54, 4294958720bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 175, 53} true;
  assume {:verifier.code 0} true;
  $i92 := $lshr.bv32($i91, 4bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 175, 53} true;
  assume {:verifier.code 0} true;
  $i93 := $shl.bv32($i91, 28bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 175, 53} true;
  assume {:verifier.code 0} true;
  $i94 := $or.bv32($i92, $i93);
  assume {:verifier.code 0} true;
...
$bb78:
  assume ($i96 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 482, 83} true;
  assume {:verifier.code 1} true;
  call $i117 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i117);
  call {:cexpr "ret"} boogie_si_record_bv32($i117);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 486, 85} true;
  assume {:verifier.code 0} true;
  $i118 := $slt.bv32($i117, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 486, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $i117;
...
$bb80:
  assume ($i97 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 499, 87} true;
  assume {:verifier.code 1} true;
  call $i109 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i109);
  call {:cexpr "tmp___9"} boogie_si_record_bv32($i109);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 500, 83} true;
  assume {:verifier.code 0} true;
  $i110 := $eq.bv32($i109, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 500, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.bv32(0bv32, 1bv32);
...
$bb82:
  assume ($i98 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 521, 83} true;
  assume {:verifier.code 1} true;
...
$bb87:
  assume ($i100 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 464, 83} true;
  assume {:verifier.code 1} true;
  call $i123 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i123);
  call {:cexpr "ret"} boogie_si_record_bv32($i123);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 465, 85} true;
  assume {:verifier.code 0} true;
  $i124 := $slt.bv32($i123, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 465, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $i123, $i43, 8608bv32, $i41;
  assume {:branchcond $i124} true;
  goto $bb115, $bb116;
$bb88:
  assume !(($i100 == 1bv1));
  assume {:verifier.code 0} true;
  $i101 := $eq.bv32($i94, 2bv32);
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i101 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 473, 83} true;
  assume {:verifier.code 1} true;
  call $i121 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i121);
  call {:cexpr "ret"} boogie_si_record_bv32($i121);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 474, 85} true;
  assume {:verifier.code 0} true;
  $i122 := $slt.bv32($i121, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 474, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $i121, $i43, 8640bv32, $i41;
...
$bb91:
  assume ($i102 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 447, 83} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 448, 85} true;
  assume {:verifier.code 0} true;
  $i126 := $slt.bv32($i125, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 448, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $i125;
...
$bb100:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 529, 85} true;
  assume {:verifier.code 0} true;
  $i108 := $slt.bv32($i103, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 529, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $i103, $i107, 8448bv32, $i32;
...
$bb106:
  assume !(($i110 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 504, 83} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 508, 85} true;
  assume {:verifier.code 0} true;
  $i112 := $slt.bv32($i111, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 508, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $i111;
...
$bb108:
  assume !(($i112 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 505, 91} true;
  assume {:verifier.code 0} true;
  $i113 := $eq.bv32($i43, 2bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 505, 81} true;
  assume {:verifier.code 0} true;
  $i114 := (if ($i113 == 1bv1) then 3bv32 else $i43);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i114);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 513, 88} true;
  assume {:verifier.code 1} true;
  call $i115 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i115);
  call {:cexpr "tmp___10"} boogie_si_record_bv32($i115);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 514, 83} true;
  assume {:verifier.code 0} true;
  $i116 := $eq.bv32($i115, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 514, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $sub.bv32(0bv32, 1bv32), $i114, 8672bv32, $i41;
...
$bb112:
  assume !(($i118 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 483, 91} true;
  assume {:verifier.code 0} true;
  $i119 := $eq.bv32($i43, 3bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 483, 81} true;
  assume {:verifier.code 0} true;
  $i120 := (if ($i119 == 1bv1) then 4bv32 else $i43);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i120);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 495, 77} true;
  assume {:verifier.code 0} true;
  $i58, $i59, $i60 := $i120, $i33, $i41;
  goto $bb36;
$bb113:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 474, 81} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume !(($i126 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 451, 85} true;
  assume {:verifier.code 0} true;
  $i127 := $eq.bv32($i125, 2bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 451, 81} true;
  assume {:verifier.code 0} true;
  $i58, $i59, $i60 := $i43, 8466bv32, $i41;
...
$bb120:
  assume !(($i127 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 454, 85} true;
  assume {:verifier.code 1} true;
  call $i128 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i128);
  call {:cexpr "ret"} boogie_si_record_bv32($i128);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 455, 87} true;
  assume {:verifier.code 0} true;
  $i129 := $slt.bv32($i128, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 455, 83} true;
  assume {:verifier.code 0} true;
  $i25, $i58, $i59, $i60 := $i128, $i43, 8592bv32, $i41;
...
$bb128:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 106, 3} true;
  assume {:verifier.code 0} true;
  $i41, $i42, $i43 := $i60, $i59, $i58;
  goto $bb7;
$bb129:
  assume !(($i35 == 1bv1));
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 605, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 606, 19} true;
  assume {:verifier.code 0} true;
  $i136 := $slt.bv32($i135, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 606, 15} true;
  assume {:verifier.code 0} true;
  $i25 := $i135;
...
$bb153:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 124, 19} true;
  assume {:verifier.code 0} true;
  $i147 := $and.bv32($i137, 4294967294bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 124, 19} true;
  assume {:verifier.code 0} true;
  $i148 := $eq.bv32($i147, 8480bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 124, 19} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 264, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $i183, $i40, 8448bv32, 8482bv32;
...
$bb157:
  assume ($i149 == 1bv1);
  assume {:verifier.code 0} true;
  $i154 := $add.bv32($i137, 4294958832bv32);
  assume {:verifier.code 0} true;
  $i155 := $ule.bv32($i154, 2bv32);
  assume {:verifier.code 0} true;
...
$bb158:
  assume !(($i149 == 1bv1));
  assume {:verifier.code 0} true;
  $i150 := $eq.bv32($i137, 8482bv32);
  assume {:verifier.code 0} true;
  $i151, $i152, $i153 := $i40, 3bv32, $i38;
...
$bb163:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i185);
  call {:cexpr "ret"} boogie_si_record_bv32($i185);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 282, 85} true;
  assume {:verifier.code 0} true;
  $i186 := $slt.bv32($i185, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 282, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $i185;
...
$bb165:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 142, 31} true;
  assume {:verifier.code 0} true;
  $i156 := $add.bv32($i147, 4294958800bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 142, 31} true;
  assume {:verifier.code 0} true;
  $i157 := $lshr.bv32($i156, 4bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 142, 31} true;
  assume {:verifier.code 0} true;
  $i158 := $shl.bv32($i156, 28bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 142, 31} true;
  assume {:verifier.code 0} true;
  $i159 := $or.bv32($i157, $i158);
  assume {:verifier.code 0} true;
  goto $bb166;
$bb166:
  assume {:verifier.code 0} true;
  $i160 := $slt.bv32($i159, 2bv32);
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 359, 97} true;
  assume {:verifier.code 0} true;
  $i192 := $slt.bv32($i191, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 359, 93} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $i191, $i40, 8544bv32, $i38;
  assume {:branchcond $i192} true;
  goto $bb209, $bb210;
$bb170:
  assume !(($i161 == 1bv1));
  assume {:verifier.code 0} true;
  $i162 := $slt.bv32($i159, 4bv32);
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i195);
  call {:cexpr "ret"} boogie_si_record_bv32($i195);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 424, 85} true;
  assume {:verifier.code 0} true;
  $i196 := $slt.bv32($i195, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 424, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $i195, $i40, 8448bv32, 8576bv32;
...
$bb179:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i187);
  call {:cexpr "ret"} boogie_si_record_bv32($i187);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 295, 85} true;
  assume {:verifier.code 0} true;
  $i188 := $slt.bv32($i187, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 295, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $i187;
...
$bb182:
  ...
  call {:cexpr "num1"} boogie_si_record_bv32($i197);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 434, 86} true;
  assume {:verifier.code 0} true;
  $i198 := $sgt.bv32($i197, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 434, 81} true;
  assume {:verifier.code 0} true;
  $i199 := $and.bv1($i34, $i198);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 434, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $sub.bv32(0bv32, 1bv32), $i40, $i38, $i38;
...
$bb183:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 175, 53} true;
  assume {:verifier.code 0} true;
  $i168 := $add.bv32($i147, 4294958720bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 175, 53} true;
  assume {:verifier.code 0} true;
  $i169 := $lshr.bv32($i168, 4bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 175, 53} true;
  assume {:verifier.code 0} true;
  $i170 := $shl.bv32($i168, 28bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 175, 53} true;
  assume {:verifier.code 0} true;
  $i171 := $or.bv32($i169, $i170);
  assume {:verifier.code 0} true;
  goto $bb184;
$bb184:
  assume {:verifier.code 0} true;
  $i172 := $slt.bv32($i171, 4bv32);
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i209);
  call {:cexpr "ret"} boogie_si_record_bv32($i209);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 486, 85} true;
  assume {:verifier.code 0} true;
  $i210 := $slt.bv32($i209, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 486, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $i209;
...
$bb189:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 499, 87} true;
  assume {:verifier.code 1} true;
  call $i213 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i213);
  call {:cexpr "tmp___9"} boogie_si_record_bv32($i213);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 500, 83} true;
  assume {:verifier.code 0} true;
  $i214 := $eq.bv32($i213, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 500, 81} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.bv32(0bv32, 1bv32);
...
$bb196:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i205);
  call {:cexpr "ret"} boogie_si_record_bv32($i205);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 465, 85} true;
  assume {:verifier.code 0} true;
  $i206 := $slt.bv32($i205, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 465, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $i205, $i40, 8608bv32, $i38;
  assume {:branchcond $i206} true;
  goto $bb225, $bb226;
$bb197:
  assume !(($i177 == 1bv1));
  assume {:verifier.code 0} true;
  $i178 := $eq.bv32($i171, 2bv32);
  assume {:verifier.code 0} true;
...
$bb198:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i207);
  call {:cexpr "ret"} boogie_si_record_bv32($i207);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 474, 85} true;
  assume {:verifier.code 0} true;
  $i208 := $slt.bv32($i207, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 474, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $i207, $i40, 8640bv32, $i38;
...
$bb202:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 211, 86} true;
  assume {:verifier.code 0} true;
  $i181 := $eq.bv32($i180, 3bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 211, 77} true;
  assume {:verifier.code 0} true;
  $i182 := (if ($i181 == 1bv1) then 1bv32 else 4294967295bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 211, 77} true;
  assume {:verifier.code 0} true;
  $r := $i182;
  $exn := false;
...
$bb206:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 279, 91} true;
  assume {:verifier.code 0} true;
  $i227 := $eq.bv32($i40, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 279, 81} true;
  assume {:verifier.code 0} true;
  $i228 := (if ($i227 == 1bv1) then 1bv32 else $i40);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 595, 11} true;
  assume {:verifier.code 0} true;
  $i151, $i152, $i153 := $i228, 8496bv32, $i38;
  goto $bb160;
$bb207:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 295, 81} true;
  assume {:verifier.code 0} true;
...
$bb208:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 292, 91} true;
  assume {:verifier.code 0} true;
  $i189 := $eq.bv32($i40, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 292, 81} true;
  assume {:verifier.code 0} true;
  $i190 := (if ($i189 == 1bv1) then 2bv32 else $i40);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i190);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 304, 77} true;
  assume {:verifier.code 0} true;
  $i151, $i152, $i153 := $i190, $i31, $i38;
  goto $bb160;
$bb209:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 359, 93} true;
  assume {:verifier.code 0} true;
...
$bb212:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 406, 87} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $i193, $i40, 8448bv32, 8576bv32;
...
$bb220:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 451, 85} true;
  assume {:verifier.code 0} true;
  $i202 := $eq.bv32($i200, 2bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 451, 81} true;
  assume {:verifier.code 0} true;
  $i151, $i152, $i153 := $i40, 8466bv32, $i38;
...
$bb222:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i203);
  call {:cexpr "ret"} boogie_si_record_bv32($i203);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 455, 87} true;
  assume {:verifier.code 0} true;
  $i204 := $slt.bv32($i203, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 455, 83} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $i203, $i40, 8592bv32, $i38;
...
$bb230:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 483, 91} true;
  assume {:verifier.code 0} true;
  $i211 := $eq.bv32($i40, 3bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 483, 81} true;
  assume {:verifier.code 0} true;
  $i212 := (if ($i211 == 1bv1) then 4bv32 else $i40);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i212);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 495, 77} true;
  assume {:verifier.code 0} true;
  $i151, $i152, $i153 := $i212, $i33, $i38;
  goto $bb160;
$bb231:
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 500, 81} true;
  assume {:verifier.code 0} true;
...
$bb234:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 505, 91} true;
  assume {:verifier.code 0} true;
  $i217 := $eq.bv32($i40, 2bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 505, 81} true;
  assume {:verifier.code 0} true;
  $i218 := (if ($i217 == 1bv1) then 3bv32 else $i40);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i218);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 513, 88} true;
  assume {:verifier.code 1} true;
  call $i219 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i219);
  call {:cexpr "tmp___10"} boogie_si_record_bv32($i219);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 514, 83} true;
  assume {:verifier.code 0} true;
  $i220 := $eq.bv32($i219, 0bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 514, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $sub.bv32(0bv32, 1bv32), $i218, 8672bv32, $i38;
...
$bb244:
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 529, 85} true;
  assume {:verifier.code 0} true;
  $i226 := $slt.bv32($i221, 1bv32);
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 529, 81} true;
  assume {:verifier.code 0} true;
  $i25, $i151, $i152, $i153 := $i221, $i225, 8448bv32, $i32;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 642, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/s3_srvr_10.cil_tmp.c", 644, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
