...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding bit-vector --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I/root/git/Dat3M/include/ -bpl /root/git/Dat3M/output/test_locks_10-O3.bpl /root/git/Dat3M/output/test_locks_10_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/test_locks_10_tmp.c", 8, 14} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 11, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 14, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 17, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 26, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 29, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 32, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 35, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/test_locks_10_tmp.c", 41, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/test_locks_10_tmp.c", 42, 16} true;
  assume {:verifier.code 0} true;
  call $i10 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i10);
  call {:cexpr "cond"} boogie_si_record_bv32($i10);
  assume {:sourceloc "output/test_locks_10_tmp.c", 43, 18} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i11 == 1bv1);
  assume true;
  assume {:sourceloc "output/test_locks_10_tmp.c", 162, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
