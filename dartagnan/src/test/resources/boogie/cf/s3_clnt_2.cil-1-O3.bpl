...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding bit-vector --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I/root/git/Dat3M/include/ -bpl /root/git/Dat3M/output/s3_clnt_2.cil-1-O3.bpl /root/git/Dat3M/output/s3_clnt_2.cil-1_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 27872));
...
axiom (reach_error == $sub.ref(0, 4136));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 3, 22} true;
...
axiom (__assert_fail == $sub.ref(0, 5168));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: bv32, $p3: ref);
const ssl3_connect: ref;
axiom (ssl3_connect == $sub.ref(0, 6200));
procedure  ssl3_connect($i0: bv32)
  returns ($r: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  ...
  var $i141: bv32;
$bb0:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 13, 26} true;
  assume {:verifier.code 1} true;
  call {:cexpr "ssl3_connect:arg:initial_state"} boogie_si_record_bv32($i0);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 13, 26} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 14, 25} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 18, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 21, 17} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i4);
  call {:cexpr "s__bbio"} boogie_si_record_bv32($i4);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 22, 17} true;
  assume {:verifier.code 1} true;
  call $i5 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i5);
  call {:cexpr "s__wbio"} boogie_si_record_bv32($i5);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 23, 16} true;
  assume {:verifier.code 1} true;
  call $i6 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i6);
  call {:cexpr "s__hit"} boogie_si_record_bv32($i6);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 26, 18} true;
  assume {:verifier.code 1} true;
  call $i7 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i7);
  call {:cexpr "s__debug"} boogie_si_record_bv32($i7);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 28, 31} true;
  assume {:verifier.code 1} true;
  call $i8 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i8);
  call {:cexpr "s__ctx__info_callback"} boogie_si_record_bv32($i8);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 29, 49} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i9);
  call {:cexpr "s__ctx__stats__sess_connect_renegotiate"} boogie_si_record_bv32($i9);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 30, 37} true;
  assume {:verifier.code 1} true;
  call $i10 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i10);
  call {:cexpr "s__ctx__stats__sess_connect"} boogie_si_record_bv32($i10);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 31, 33} true;
  assume {:verifier.code 1} true;
  call $i11 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i11);
  call {:cexpr "s__ctx__stats__sess_hit"} boogie_si_record_bv32($i11);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 32, 42} true;
  assume {:verifier.code 1} true;
  call $i12 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i12);
  call {:cexpr "s__ctx__stats__sess_connect_good"} boogie_si_record_bv32($i12);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 36, 30} true;
  assume {:verifier.code 1} true;
  call $i13 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i13);
  call {:cexpr "s__s3__tmp__cert_req"} boogie_si_record_bv32($i13);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 37, 37} true;
  assume {:verifier.code 1} true;
  call $i14 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i14);
  call {:cexpr "s__s3__tmp__new_compression"} boogie_si_record_bv32($i14);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 38, 35} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 39, 32} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 40, 44} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 42, 41} true;
  assume {:verifier.code 1} true;
  call $i18 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i18);
  call {:cexpr "s__s3__tmp__new_compression__id"} boogie_si_record_bv32($i18);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 55, 17} true;
  assume {:verifier.code 1} true;
  call $i19 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i19);
  call {:cexpr "tmp___1"} boogie_si_record_bv32($i19);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 56, 17} true;
  assume {:verifier.code 1} true;
  call $i20 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i20);
  call {:cexpr "tmp___2"} boogie_si_record_bv32($i20);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 57, 17} true;
  assume {:verifier.code 1} true;
  call $i21 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i21);
  call {:cexpr "tmp___3"} boogie_si_record_bv32($i21);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 58, 17} true;
  assume {:verifier.code 1} true;
  call $i22 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i22);
  call {:cexpr "tmp___4"} boogie_si_record_bv32($i22);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 59, 17} true;
  assume {:verifier.code 1} true;
  call $i23 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i23);
  call {:cexpr "tmp___5"} boogie_si_record_bv32($i23);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 60, 17} true;
  assume {:verifier.code 1} true;
  call $i24 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i24);
  call {:cexpr "tmp___6"} boogie_si_record_bv32($i24);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 61, 17} true;
  assume {:verifier.code 1} true;
  call $i25 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i25);
  call {:cexpr "tmp___7"} boogie_si_record_bv32($i25);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 62, 17} true;
  assume {:verifier.code 1} true;
  call $i26 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i26);
  call {:cexpr "tmp___8"} boogie_si_record_bv32($i26);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 63, 17} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "ssl3_connect:arg:s__state"} boogie_si_record_bv32($i0);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 81, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.bv32($i3, 66048bv32);
  assume {:verifier.code 0} true;
  $i30 := $eq.bv32($i22, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i31 := $or.bv1($i29, $i30);
  assume {:verifier.code 0} true;
  $i32 := $eq.bv32($i23, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i33 := $or.bv1($i31, $i32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i34 := $eq.bv32($i13, 0bv32);
  assume {:verifier.code 0} true;
  $i35 := (if ($i34 == 1bv1) then 4480bv32 else 4464bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i36 := $eq.bv32($i24, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i37 := $eq.bv32($i17, 256bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i38 := $eq.bv32($i6, 0bv32);
  assume {:verifier.code 0} true;
  $i39 := (if ($i38 == 1bv1) then 4400bv32 else 4560bv32);
  assume {:verifier.code 0} true;
  $i40 := (if ($i38 == 1bv1) then 3bv32 else 4512bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i41 := $eq.bv32($i25, 0bv32);
  assume {:verifier.code 0} true;
  $i42 := $eq.bv32($i26, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i43 := $or.bv1($i41, $i42);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i44 := $eq.bv32($i13, 1bv32);
  assume {:verifier.code 0} true;
  $i45 := (if ($i44 == 1bv1) then 4496bv32 else 4512bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i46 := $slt.bv32($i27, 1bv32);
  assume {:verifier.code 0} true;
  $i47 := $eq.bv32($i7, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 100, 3} true;
  assume {:verifier.code 0} true;
  $i48, $i49, $i50, $i51, $i52, $i53, $i54, $i55, $i56, $i57 := $u0, $u0, $u0, 0bv32, $i0, $u0, $u0, $u0, 0bv32, $i0;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 80, 13} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume true;
...
$bb8:
  assume ($i59 == 1bv1);
  assume {:verifier.code 0} true;
  $i64 := $eq.bv32($i52, 12292bv32);
  assume {:verifier.code 0} true;
  $i62 := $sub.bv32(0bv32, 1bv32);
  assume {:branchcond $i64} true;
  goto $bb18, $bb19;
$bb9:
  assume !(($i59 == 1bv1));
  assume {:verifier.code 0} true;
  $i60 := $slt.bv32($i52, 20480bv32);
  assume {:verifier.code 0} true;
...
$bb13:
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 549, 3} true;
  assume {:verifier.code 0} true;
  $i141 := $i62;
  goto $bb112;
$bb14:
...
$bb25:
  ...
  goto $bb15;
$bb26:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i68 := $and.bv32($i52, 4294967294bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i69 := $add.bv32($i68, 4294962928bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i70 := $lshr.bv32($i69, 4bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i71 := $shl.bv32($i69, 28bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i72 := $or.bv32($i70, $i71);
  assume {:verifier.code 0} true;
...
$bb30:
  assume ($i74 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 305, 79} true;
  assume {:verifier.code 1} true;
  call $i91 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i91);
  call {:cexpr "ret"} boogie_si_record_bv32($i91);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 309, 81} true;
  assume {:verifier.code 0} true;
  $i92 := $slt.bv32($i91, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 309, 77} true;
  assume {:verifier.code 0} true;
  $i62 := $i91;
...
$bb32:
  assume ($i75 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 321, 79} true;
  assume {:verifier.code 1} true;
  call $i88 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i88);
  call {:cexpr "ret"} boogie_si_record_bv32($i88);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 322, 87} true;
  assume {:verifier.code 0} true;
  $i89 := $eq.bv32($i51, 4bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 322, 77} true;
  assume {:verifier.code 0} true;
...
$bb34:
  assume ($i76 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 333, 79} true;
  assume {:verifier.code 1} true;
  call $i80 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i80);
  call {:cexpr "ret"} boogie_si_record_bv32($i80);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 334, 81} true;
  assume {:verifier.code 0} true;
  $i81 := $slt.bv32($i80, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 334, 77} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $i80, 0bv32, $i48, $i49, $i50, $i51, $i35;
...
$bb39:
  assume ($i78 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 270, 79} true;
  assume {:verifier.code 1} true;
  call $i99 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i99);
  call {:cexpr "ret"} boogie_si_record_bv32($i99);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 274, 81} true;
  assume {:verifier.code 0} true;
  $i100 := $slt.bv32($i99, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 274, 77} true;
  assume {:verifier.code 0} true;
  $i62 := $i99;
...
$bb40:
  assume !(($i78 == 1bv1));
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 288, 77} true;
  assume {:verifier.code 0} true;
  $i82, $i83, $i84, $i85, $i86, $i87 := 1bv32, $i48, $i49, $i50, $i51, 4416bv32;
  assume {:branchcond $i37} true;
  goto $bb55, $bb56;
$bb41:
  assume ($i79 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 251, 79} true;
  assume {:verifier.code 1} true;
  call $i103 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i103);
  call {:cexpr "ret"} boogie_si_record_bv32($i103);
  assume {:verifier.code 0} true;
  goto $bb61;
$bb42:
  assume {:verifier.code 0} true;
...
$bb45:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 522, 9} true;
  assume {:verifier.code 0} true;
  $i145 := $or.bv32($i82, $i15);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 522, 9} true;
  assume {:verifier.code 0} true;
  $i146 := $ne.bv32($i145, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 522, 9} true;
  assume {:verifier.code 0} true;
  $i147 := $or.bv1($i47, $i146);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 522, 9} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 550, 11} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:verifier.code 0} true;
  assume false;
$bb48:
  assume !(($i89 == 1bv1));
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 325, 81} true;
  assume {:verifier.code 0} true;
  $i90 := $slt.bv32($i88, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 325, 77} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $i88, 0bv32, $i48, $i49, $i50, $i51, 4448bv32;
...
$bb52:
  assume !(($i92 == 1bv1));
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 306, 87} true;
  assume {:verifier.code 0} true;
  $i93 := $eq.bv32($i51, 3bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 306, 77} true;
  assume {:verifier.code 0} true;
  $i94 := (if ($i93 == 1bv1) then 4bv32 else $i51);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i94);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 314, 77} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $sub.bv32(0bv32, 1bv32), 0bv32, $i48, $i49, $i50, $i94, 4432bv32;
...
$bb55:
  assume ($i37 == 1bv1);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 291, 81} true;
  assume {:verifier.code 1} true;
  call $i95 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i95);
  call {:cexpr "ret"} boogie_si_record_bv32($i95);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 292, 89} true;
  assume {:verifier.code 0} true;
  $i96 := $eq.bv32($i51, 2bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 292, 79} true;
  assume {:verifier.code 0} true;
  $i97 := (if ($i96 == 1bv1) then 3bv32 else $i51);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i97);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 295, 83} true;
  assume {:verifier.code 0} true;
  $i98 := $slt.bv32($i95, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 295, 79} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $i95, 0bv32, $i48, $i49, $i50, $i97, 4416bv32;
...
$bb60:
  assume !(($i100 == 1bv1));
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 271, 87} true;
  assume {:verifier.code 0} true;
  $i101 := $eq.bv32($i51, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 271, 77} true;
  assume {:verifier.code 0} true;
  $i102 := (if ($i101 == 1bv1) then 2bv32 else $i51);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i102);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 283, 73} true;
  assume {:verifier.code 0} true;
  $i82, $i83, $i84, $i85, $i86, $i87 := 0bv32, $i48, $i49, $i50, $i102, $i39;
  goto $bb45;
$bb61:
  assume {:verifier.code 0} true;
  $i104 := $slt.bv32($i51, 4bv32);
  assume {:verifier.code 0} true;
...
$bb63:
  assume !(($i104 == 1bv1));
  assume {:verifier.code 0} true;
  $i105 := $eq.bv32($i51, 4bv32);
  assume {:verifier.code 0} true;
  assume {:branchcond $i105} true;
  goto $bb64, $bb65;
$bb64:
  assume ($i105 == 1bv1);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 257, 75} true;
  assume {:verifier.code 0} true;
  $i107 := 5bv32;
  goto $bb68;
$bb65:
...
$bb68:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 259, 81} true;
  assume {:verifier.code 0} true;
  $i108 := $slt.bv32($i103, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 259, 77} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $i103, 0bv32, $i48, $i49, $i50, $i107, 4384bv32;
...
$bb72:
  ...
  goto $bb45;
$bb73:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 154, 43} true;
  assume {:verifier.code 0} true;
  $i109 := $and.bv32($i52, 4294967292bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 154, 43} true;
  assume {:verifier.code 0} true;
  $i110 := $eq.bv32($i109, 4464bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 154, 43} true;
  assume {:verifier.code 0} true;
...
$bb74:
  assume ($i110 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 348, 79} true;
  assume {:verifier.code 1} true;
  call $i143 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i143);
  call {:cexpr "ret"} boogie_si_record_bv32($i143);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 349, 81} true;
  assume {:verifier.code 0} true;
  $i144 := $slt.bv32($i143, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 349, 77} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $i143, 0bv32, $i48, $i49, $i50, $i51, 4480bv32;
  assume {:branchcond $i144} true;
  goto $bb118, $bb119;
$bb75:
  assume !(($i110 == 1bv1));
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
  $i111 := $add.bv32($i68, 4294962816bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
  $i112 := $lshr.bv32($i111, 4bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
  $i113 := $shl.bv32($i111, 28bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
  $i114 := $or.bv32($i112, $i113);
  assume {:verifier.code 0} true;
  goto $bb76;
$bb76:
  assume {:verifier.code 0} true;
  $i115 := $slt.bv32($i114, 2bv32);
  assume {:verifier.code 0} true;
...
$bb79:
  assume ($i116 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 382, 79} true;
  assume {:verifier.code 1} true;
  call $i131 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i131);
  call {:cexpr "ret"} boogie_si_record_bv32($i131);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 383, 81} true;
  assume {:verifier.code 0} true;
  $i132 := $slt.bv32($i131, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 383, 77} true;
  assume {:verifier.code 0} true;
  $i133 := $or.bv1($i132, $i43);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 383, 77} true;
  assume {:verifier.code 0} true;
  $i82, $i83, $i84, $i85, $i86, $i87 := 0bv32, $i48, $i49, $i50, $i51, 4528bv32;
  assume {:branchcond $i133} true;
  goto $bb98, $bb99;
$bb80:
  assume !(($i116 == 1bv1));
  assume {:verifier.code 0} true;
  $i117 := $slt.bv32($i114, 5bv32);
  assume {:verifier.code 0} true;
...
$bb83:
  assume ($i118 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 432, 79} true;
  assume {:verifier.code 1} true;
  call $i122 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i122);
  call {:cexpr "ret"} boogie_si_record_bv32($i122);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 433, 81} true;
  assume {:verifier.code 0} true;
  $i123 := $slt.bv32($i122, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 433, 77} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $i122, 0bv32, $i48, $i49, $i50, $i51, $i40;
...
$bb86:
  assume ($i119 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 405, 79} true;
  assume {:verifier.code 1} true;
  call $i124 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i124);
  call {:cexpr "ret"} boogie_si_record_bv32($i124);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 406, 81} true;
  assume {:verifier.code 0} true;
  $i125 := $slt.bv32($i124, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 406, 77} true;
  assume {:verifier.code 0} true;
  $i62 := $i124;
...
$bb89:
  assume !(($i120 == 1bv1));
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 372, 79} true;
  assume {:verifier.code 1} true;
  call $i134 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i134);
  call {:cexpr "ret"} boogie_si_record_bv32($i134);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 373, 81} true;
  assume {:verifier.code 0} true;
  $i135 := $slt.bv32($i134, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 373, 77} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $i134, 0bv32, $i48, $i49, $i50, $i51, 4512bv32;
  assume {:branchcond $i135} true;
  goto $bb100, $bb101;
$bb90:
  assume ($i121 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 357, 79} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 358, 81} true;
  assume {:verifier.code 0} true;
  $i137 := $slt.bv32($i136, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 358, 77} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $i136, 0bv32, $i48, $i49, $i50, $i51, $i45;
...
$bb95:
  assume !(($i125 == 1bv1));
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 411, 99} true;
  assume {:verifier.code 0} true;
  $i126 := $add.bv32($i50, 5bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 413, 77} true;
  assume {:verifier.code 0} true;
  $i82, $i83, $i84, $i85, $i86, $i87 := 0bv32, $i48, 4560bv32, $i126, $i51, 4352bv32;
...
$bb97:
  assume !(($i38 == 1bv1));
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 417, 91} true;
  assume {:verifier.code 0} true;
  $i127 := $eq.bv32($i126, 2bv32);
  assume {:verifier.code 0} true;
  $i128 := $add.bv32($i50, 9bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 417, 79} true;
  assume {:verifier.code 0} true;
  $i129 := (if ($i127 == 1bv1) then 2bv32 else $i128);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 417, 79} true;
  assume {:verifier.code 0} true;
  $i130 := (if ($i127 == 1bv1) then 4352bv32 else 3bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 417, 79} true;
  assume {:verifier.code 0} true;
  $i82, $i83, $i84, $i85, $i86, $i87 := 0bv32, $i48, 3bv32, $i129, $i51, $i130;
  goto $bb45;
$bb98:
  assume ($i133 == 1bv1);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 383, 77} true;
  assume {:verifier.code 0} true;
  $i241 := (if ($i132 == 1bv1) then $i131 else 4294967295bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 549, 3} true;
  assume {:verifier.code 0} true;
  $i141 := $i241;
  goto $bb112;
...
$bb108:
  assume ($i139 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 446, 89} true;
  assume {:verifier.code 0} true;
  $i142 := $sgt.bv32($i48, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 446, 77} true;
  assume {:verifier.code 0} true;
  $i82, $i83, $i84, $i85, $i86, $i87 := 0bv32, $i48, $i49, $i50, $i51, $i49;
...
$bb114:
  assume ($i142 == 1bv1);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 451, 79} true;
  assume {:verifier.code 0} true;
  $i62, $i82, $i83, $i84, $i85, $i86, $i87 := $sub.bv32(0bv32, 1bv32), 0bv32, $i27, $i49, $i50, $i51, $i49;
...
$bb121:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i48, $i49, $i50, $i51, $i52 := $i83, $i84, $i85, $i86, $i87;
  goto $bb2;
$bb122:
  assume !(($i147 == 1bv1));
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 525, 17} true;
  assume {:verifier.code 1} true;
  call $i148 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i148);
  call {:cexpr "ret"} boogie_si_record_bv32($i148);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 526, 19} true;
  assume {:verifier.code 0} true;
  $i149 := $slt.bv32($i148, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 526, 15} true;
  assume {:verifier.code 0} true;
  $i62 := $i148;
...
$bb128:
  assume ($i151 == 1bv1);
  assume {:verifier.code 0} true;
  $i161 := $eq.bv32($i57, 12292bv32);
  assume {:verifier.code 0} true;
  $i154, $i155, $i156, $i157, $i158, $i159 := 0bv32, $i53, $i54, $i55, $i56, 4368bv32;
  assume {:branchcond $i161} true;
  goto $bb138, $bb139;
$bb129:
  assume !(($i151 == 1bv1));
  assume {:verifier.code 0} true;
  $i152 := $slt.bv32($i57, 20480bv32);
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 522, 9} true;
  assume {:verifier.code 0} true;
  $i236 := $or.bv32($i154, $i15);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 522, 9} true;
  assume {:verifier.code 0} true;
  $i237 := $ne.bv32($i236, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 522, 9} true;
  assume {:verifier.code 0} true;
  $i238 := $or.bv1($i47, $i237);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 522, 9} true;
  assume {:verifier.code 0} true;
...
$bb146:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i165 := $and.bv32($i57, 4294967294bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i166 := $add.bv32($i165, 4294962928bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i167 := $lshr.bv32($i166, 4bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i168 := $shl.bv32($i166, 28bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i169 := $or.bv32($i167, $i168);
  assume {:verifier.code 0} true;
  goto $bb147;
$bb147:
  assume {:verifier.code 0} true;
  $i170 := $slt.bv32($i169, 3bv32);
  assume {:verifier.code 0} true;
...
$bb150:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 305, 79} true;
  assume {:verifier.code 1} true;
  call $i208 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i208);
  call {:cexpr "ret"} boogie_si_record_bv32($i208);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 309, 81} true;
  assume {:verifier.code 0} true;
  $i209 := $slt.bv32($i208, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 309, 77} true;
  assume {:verifier.code 0} true;
  $i199 := $i208;
...
$bb152:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 321, 79} true;
  assume {:verifier.code 1} true;
  call $i212 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i212);
  call {:cexpr "ret"} boogie_si_record_bv32($i212);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 322, 87} true;
  assume {:verifier.code 0} true;
  $i213 := $eq.bv32($i56, 4bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 322, 77} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 333, 79} true;
  assume {:verifier.code 1} true;
  call $i215 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i215);
  call {:cexpr "ret"} boogie_si_record_bv32($i215);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 334, 81} true;
  assume {:verifier.code 0} true;
  $i216 := $slt.bv32($i215, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 334, 77} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $i215, 0bv32, $i53, $i54, $i55, $i56, $i35;
...
$bb160:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 288, 77} true;
  assume {:verifier.code 0} true;
  $i154, $i155, $i156, $i157, $i158, $i159 := 1bv32, $i53, $i54, $i55, $i56, 4416bv32;
  assume {:branchcond $i37} true;
  goto $bb206, $bb207;
$bb161:
  assume ($i176 == 1bv1);
...
$bb163:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 154, 43} true;
  assume {:verifier.code 0} true;
  $i177 := $and.bv32($i57, 4294967292bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 154, 43} true;
  assume {:verifier.code 0} true;
  $i178 := $eq.bv32($i177, 4464bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 154, 43} true;
  assume {:verifier.code 0} true;
...
$bb164:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 348, 79} true;
  assume {:verifier.code 1} true;
  call $i217 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i217);
  call {:cexpr "ret"} boogie_si_record_bv32($i217);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 349, 81} true;
  assume {:verifier.code 0} true;
  $i218 := $slt.bv32($i217, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 349, 77} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $i217, 0bv32, $i53, $i54, $i55, $i56, 4480bv32;
...
$bb165:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
  $i179 := $add.bv32($i165, 4294962816bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
  $i180 := $lshr.bv32($i179, 4bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
  $i181 := $shl.bv32($i179, 28bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
  $i182 := $or.bv32($i180, $i181);
  assume {:verifier.code 0} true;
  goto $bb166;
$bb166:
  assume {:verifier.code 0} true;
  $i183 := $slt.bv32($i182, 2bv32);
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i223);
  call {:cexpr "ret"} boogie_si_record_bv32($i223);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 383, 81} true;
  assume {:verifier.code 0} true;
  $i224 := $slt.bv32($i223, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 383, 77} true;
  assume {:verifier.code 0} true;
  $i225 := $or.bv1($i224, $i43);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 383, 77} true;
  assume {:verifier.code 0} true;
  $i154, $i155, $i156, $i157, $i158, $i159 := 0bv32, $i53, $i54, $i55, $i56, 4528bv32;
  assume {:branchcond $i225} true;
  goto $bb226, $bb227;
$bb170:
  assume !(($i184 == 1bv1));
  assume {:verifier.code 0} true;
  $i185 := $slt.bv32($i182, 5bv32);
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 432, 79} true;
  assume {:verifier.code 1} true;
  call $i233 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i233);
  call {:cexpr "ret"} boogie_si_record_bv32($i233);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 433, 81} true;
  assume {:verifier.code 0} true;
  $i234 := $slt.bv32($i233, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 433, 77} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $i233, 0bv32, $i53, $i54, $i55, $i56, $i40;
...
$bb176:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 405, 79} true;
  assume {:verifier.code 1} true;
  call $i226 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i226);
  call {:cexpr "ret"} boogie_si_record_bv32($i226);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 406, 81} true;
  assume {:verifier.code 0} true;
  $i227 := $slt.bv32($i226, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 406, 77} true;
  assume {:verifier.code 0} true;
  $i199 := $i226;
...
$bb179:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 372, 79} true;
  assume {:verifier.code 1} true;
  call $i221 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i221);
  call {:cexpr "ret"} boogie_si_record_bv32($i221);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 373, 81} true;
  assume {:verifier.code 0} true;
  $i222 := $slt.bv32($i221, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 373, 77} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $i221, 0bv32, $i53, $i54, $i55, $i56, 4512bv32;
...
$bb180:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i219);
  call {:cexpr "ret"} boogie_si_record_bv32($i219);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 358, 81} true;
  assume {:verifier.code 0} true;
  $i220 := $slt.bv32($i219, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 358, 77} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $i219, 0bv32, $i53, $i54, $i55, $i56, $i45;
...
$bb186:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 446, 89} true;
  assume {:verifier.code 0} true;
  $i235 := $sgt.bv32($i53, 0bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 446, 77} true;
  assume {:verifier.code 0} true;
  $i154, $i155, $i156, $i157, $i158, $i159 := 0bv32, $i53, $i54, $i55, $i56, $i54;
...
$bb198:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 259, 81} true;
  assume {:verifier.code 0} true;
  $i198 := $slt.bv32($i193, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 259, 77} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $i193, 0bv32, $i53, $i54, $i55, $i197, 4384bv32;
...
$bb205:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 271, 87} true;
  assume {:verifier.code 0} true;
  $i202 := $eq.bv32($i56, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 271, 77} true;
  assume {:verifier.code 0} true;
  $i203 := (if ($i202 == 1bv1) then 2bv32 else $i56);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i203);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 283, 73} true;
  assume {:verifier.code 0} true;
  $i154, $i155, $i156, $i157, $i158, $i159 := 0bv32, $i53, $i54, $i55, $i203, $i39;
  goto $bb133;
$bb206:
  assume ($i37 == 1bv1);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 291, 81} true;
  assume {:verifier.code 1} true;
  call $i204 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i204);
  call {:cexpr "ret"} boogie_si_record_bv32($i204);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 292, 89} true;
  assume {:verifier.code 0} true;
  $i205 := $eq.bv32($i56, 2bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 292, 79} true;
  assume {:verifier.code 0} true;
  $i206 := (if ($i205 == 1bv1) then 3bv32 else $i56);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i206);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 295, 83} true;
  assume {:verifier.code 0} true;
  $i207 := $slt.bv32($i204, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 295, 79} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $i204, 0bv32, $i53, $i54, $i55, $i206, 4416bv32;
...
$bb211:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 306, 87} true;
  assume {:verifier.code 0} true;
  $i210 := $eq.bv32($i56, 3bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 306, 77} true;
  assume {:verifier.code 0} true;
  $i211 := (if ($i210 == 1bv1) then 4bv32 else $i56);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i211);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 314, 77} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $sub.bv32(0bv32, 1bv32), 0bv32, $i53, $i54, $i55, $i211, 4432bv32;
  assume {:branchcond $i36} true;
  goto $bb212, $bb213;
$bb212:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 314, 77} true;
...
$bb215:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 325, 81} true;
  assume {:verifier.code 0} true;
  $i214 := $slt.bv32($i212, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 325, 77} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $i212, 0bv32, $i53, $i54, $i55, $i56, 4448bv32;
...
$bb226:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 383, 77} true;
  assume {:verifier.code 0} true;
  $i242 := (if ($i224 == 1bv1) then $i223 else 4294967295bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 549, 3} true;
  assume {:verifier.code 0} true;
  $i141 := $i242;
  goto $bb112;
...
$bb229:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 411, 99} true;
  assume {:verifier.code 0} true;
  $i228 := $add.bv32($i55, 5bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 413, 77} true;
  assume {:verifier.code 0} true;
  $i154, $i155, $i156, $i157, $i158, $i159 := 0bv32, $i53, 4560bv32, $i228, $i56, 4352bv32;
  assume {:branchcond $i38} true;
  goto $bb230, $bb231;
$bb230:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 413, 77} true;
...
$bb231:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 417, 91} true;
  assume {:verifier.code 0} true;
  $i229 := $eq.bv32($i228, 2bv32);
  assume {:verifier.code 0} true;
  $i230 := $add.bv32($i55, 9bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 417, 79} true;
  assume {:verifier.code 0} true;
  $i231 := (if ($i229 == 1bv1) then 2bv32 else $i230);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 417, 79} true;
  assume {:verifier.code 0} true;
  $i232 := (if ($i229 == 1bv1) then 4352bv32 else 3bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 417, 79} true;
  assume {:verifier.code 0} true;
  $i154, $i155, $i156, $i157, $i158, $i159 := 0bv32, $i53, 3bv32, $i231, $i56, $i232;
  goto $bb133;
$bb232:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 433, 77} true;
  assume {:verifier.code 0} true;
...
$bb234:
  ...
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 451, 79} true;
  assume {:verifier.code 0} true;
  $i199, $i154, $i155, $i156, $i157, $i158, $i159 := $sub.bv32(0bv32, 1bv32), 0bv32, $i27, $i54, $i55, $i56, $i54;
  assume {:branchcond $i46} true;
  goto $bb236, $bb237;
$bb235:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 446, 77} true;
...
$bb239:
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i53, $i54, $i55, $i56, $i57 := $i155, $i156, $i157, $i158, $i159;
  goto $bb4;
$bb240:
  assume !(($i238 == 1bv1));
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 525, 17} true;
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i239);
  call {:cexpr "ret"} boogie_si_record_bv32($i239);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 526, 19} true;
  assume {:verifier.code 0} true;
  $i240 := $slt.bv32($i239, 1bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 526, 15} true;
  assume {:verifier.code 0} true;
  $i199 := $i239;
...
axiom (llvm.dbg.value == $sub.ref(0, 7232));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const llvm.dbg.label: ref;
axiom (llvm.dbg.label == $sub.ref(0, 8264));
procedure  llvm.dbg.label($p0: ref);
const main: ref;
axiom (main == $sub.ref(0, 9296));
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 560, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 560, 3} true;
  assume {:verifier.code 0} true;
  call $i0 := ssl3_connect(12292bv32);
  assume {:sourceloc "output/s3_clnt_2.cil-1_tmp.c", 562, 3} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 10328));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 11360));
...
axiom (__SMACK_dummy == $sub.ref(0, 12392));
...
axiom (__SMACK_and32 == $sub.ref(0, 13424));
...
axiom (__SMACK_and64 == $sub.ref(0, 14456));
...
axiom (__SMACK_and16 == $sub.ref(0, 15488));
...
axiom (__SMACK_and8 == $sub.ref(0, 16520));
...
axiom (__SMACK_or32 == $sub.ref(0, 17552));
...
axiom (__SMACK_or64 == $sub.ref(0, 18584));
...
axiom (__SMACK_or16 == $sub.ref(0, 19616));
...
axiom (__SMACK_or8 == $sub.ref(0, 20648));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 21680));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 22712));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 23744));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 24776));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 25808));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 26840));
...
axiom (__SMACK_static_init == $sub.ref(0, 27872));
