...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding bit-vector --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I/root/git/Dat3M/include/ -bpl /root/git/Dat3M/output/s3_srvr_2.cil-2-O3.bpl /root/git/Dat3M/output/s3_srvr_2.cil-2_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 29936));
...
{
$bb0:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 3, 22} true;
...
axiom (ssl3_accept == $sub.ref(0, 6200));
  ...
  returns ($r: bv32)
{
  ...
  var $i31: bv32;
$bb0:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 13, 26} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 14, 25} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 18, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 21, 16} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 24, 18} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 26, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 27, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 28, 24} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 29, 26} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 30, 41} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 31, 31} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 32, 48} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 33, 36} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 34, 41} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 36, 35} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 38, 32} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 39, 44} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 41, 47} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 48, 15} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 54, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 55, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 56, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 57, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 58, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 59, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 61, 18} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 62, 17} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 63, 18} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 77, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 96, 15} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.bv32($i6, 0bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 96, 7} true;
  assume {:verifier.code 0} true;
  $i31 := $sub.bv32(0bv32, 1bv32);
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 612, 1} true;
  assume {:verifier.code 0} true;
  $r := $i31;
  $exn := false;
  return;
$bb3:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i32 := $eq.bv32($i8, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i33 := $eq.bv32($i9, 0bv32);
  assume {:verifier.code 0} true;
  $i34 := $eq.bv32($i8, $sub.bv32(0bv32, 4bv32));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i35 := $or.bv1($i34, $i33);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i36 := $ne.bv32($i17, $sub.bv32(0bv32, 256bv32));
  assume {:verifier.code 0} true;
  $i37 := $eq.bv32($i8, $sub.bv32(0bv32, 2bv32));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i38 := $and.bv1($i37, $i36);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i39 := $ne.bv32($i7, $sub.bv32(0bv32, 2097152bv32));
  assume {:verifier.code 0} true;
  $i40 := $ne.bv32($i17, $sub.bv32(0bv32, 30bv32));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i41 := $or.bv1($i39, $i40);
  assume {:verifier.code 0} true;
  $i42 := $eq.bv32($i10, 0bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i43 := $or.bv1($i42, $i41);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i44 := $shl.bv32($i25, 3bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i45 := $eq.bv32($i17, $sub.bv32(0bv32, 256bv32));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i46 := $eq.bv32($i4, 0bv32);
  assume {:verifier.code 0} true;
  $i47 := (if ($i46 == 1bv1) then 8512bv32 else 8656bv32);
  assume {:verifier.code 0} true;
  $i48 := (if ($i46 == 1bv1) then 3bv32 else 8640bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i49 := $eq.bv32($i27, 0bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i50 := $eq.bv32($i28, 0bv32);
  assume {:verifier.code 0} true;
  $i51 := (if ($i46 == 1bv1) then 8656bv32 else 3bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i52 := $slt.bv64($i26, 1bv64);
  assume {:verifier.code 0} true;
  $i53 := $eq.bv32($i5, 0bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 100, 3} true;
  assume {:verifier.code 0} true;
  $i54, $i55, $i56, $i57, $i58, $i59, $i60, $i61 := $i19, $u0, 0bv32, $i0, $i19, $u0, 0bv32, $i0;
...
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 48, 8} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 76, 13} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume true;
...
$bb27:
  ...
  goto $bb17;
$bb28:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i71 := $and.bv32($i57, 4294967294bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.bv32($i71, 8480bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i72 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 259, 83} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 260, 85} true;
  assume {:verifier.code 0} true;
  $i146 := $slt.bv32($i145, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 260, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i145, 0bv32, $i54, 8482bv32, $i56, 8448bv32;
...
$bb32:
  assume ($i73 == 1bv1);
  assume {:verifier.code 0} true;
  $i80 := $add.bv32($i57, 4294958832bv32);
  assume {:verifier.code 0} true;
  $i81 := $ule.bv32($i80, 2bv32);
  assume {:verifier.code 0} true;
...
$bb33:
  assume !(($i73 == 1bv1));
  assume {:verifier.code 0} true;
  $i74 := $eq.bv32($i57, 8482bv32);
  assume {:verifier.code 0} true;
  $i75, $i76, $i77, $i78, $i79 := 0bv32, $i54, $i55, $i56, 3bv32;
...
$bb35:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 581, 9} true;
  assume {:verifier.code 0} true;
  $i147 := $or.bv32($i75, $i15);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 581, 9} true;
  assume {:verifier.code 0} true;
  $i148 := $ne.bv32($i147, 0bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 581, 9} true;
  assume {:verifier.code 0} true;
  $i149 := $or.bv1($i53, $i148);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 581, 9} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i81 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 274, 83} true;
  assume {:verifier.code 1} true;
  call $i82 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i82);
  call {:cexpr "ret"} boogie_si_record_bv32($i82);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 275, 91} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.bv32($i56, 0bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 275, 81} true;
  assume {:verifier.code 0} true;
  $i84 := (if ($i83 == 1bv1) then 1bv32 else $i56);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i84);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 278, 85} true;
  assume {:verifier.code 0} true;
  $i85 := $slt.bv32($i82, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 278, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i82, 0bv32, $i54, $i55, $i84, 8496bv32;
...
$bb41:
  ...
  goto $bb35;
$bb42:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 136, 31} true;
  assume {:verifier.code 0} true;
  $i86 := $add.bv32($i71, 4294958800bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 136, 31} true;
  assume {:verifier.code 0} true;
  $i87 := $lshr.bv32($i86, 4bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 136, 31} true;
  assume {:verifier.code 0} true;
  $i88 := $shl.bv32($i86, 28bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 136, 31} true;
  assume {:verifier.code 0} true;
  $i89 := $or.bv32($i87, $i88);
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i91 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 332, 81} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume !(($i91 == 1bv1));
  assume {:verifier.code 0} true;
  $i92 := $slt.bv32($i89, 4bv32);
  assume {:verifier.code 0} true;
  $i75, $i76, $i77, $i78, $i79 := 1bv32, $i54, $i55, $i56, 8560bv32;
...
$bb50:
  assume ($i93 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 422, 83} true;
  assume {:verifier.code 1} true;
  call $i96 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i96);
  call {:cexpr "ret"} boogie_si_record_bv32($i96);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 423, 85} true;
  assume {:verifier.code 0} true;
  $i97 := $slt.bv32($i96, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 423, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i96, 0bv32, $i54, 8576bv32, $i56, 8448bv32;
...
$bb54:
  assume !(($i94 == 1bv1));
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 309, 81} true;
  assume {:verifier.code 0} true;
  $i75, $i76, $i77, $i78, $i79 := 1bv32, $i54, $i55, $i56, 8528bv32;
  assume {:branchcond $i45} true;
  goto $bb75, $bb76;
$bb55:
  assume ($i95 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 287, 83} true;
  assume {:verifier.code 1} true;
  call $i107 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i107);
  call {:cexpr "ret"} boogie_si_record_bv32($i107);
  assume {:verifier.code 0} true;
  goto $bb79;
$bb56:
  assume {:verifier.code 0} true;
...
$bb60:
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 357, 95} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 358, 97} true;
  assume {:verifier.code 0} true;
  $i104 := $slt.bv32($i103, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 358, 93} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i103, 0bv32, $i54, $i55, $i56, 8544bv32;
...
$bb62:
  assume {:verifier.code 0} true;
  $i98 := $slt.bv32($i18, $sub.bv32(0bv32, 2bv32));
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i98 == 1bv1);
  assume {:verifier.code 0} true;
  $i100 := $eq.bv32($i18, $sub.bv32(0bv32, 4bv32));
  assume {:verifier.code 0} true;
...
$bb64:
  assume !(($i98 == 1bv1));
  assume {:verifier.code 0} true;
  $i99 := $eq.bv32($i18, $sub.bv32(0bv32, 2bv32));
  assume {:verifier.code 0} true;
  $i75, $i76, $i77, $i78, $i79 := 1bv32, $i54, $i55, $i56, 8544bv32;
...
$bb70:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 355, 103} true;
  assume {:verifier.code 0} true;
  $i102 := $sgt.bv32($i44, $i101);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 355, 91} true;
  assume {:verifier.code 0} true;
  $i75, $i76, $i77, $i78, $i79 := 1bv32, $i54, $i55, $i56, 8544bv32;
...
$bb75:
  assume ($i45 == 1bv1);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 312, 85} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 313, 87} true;
  assume {:verifier.code 0} true;
  $i106 := $slt.bv32($i105, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 313, 83} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i105, 0bv32, $i54, $i55, $i56, 8528bv32;
...
$bb81:
  assume !(($i108 == 1bv1));
  assume {:verifier.code 0} true;
  $i109 := $eq.bv32($i56, 3bv32);
  assume {:verifier.code 0} true;
  assume {:branchcond $i109} true;
  goto $bb82, $bb83;
$bb82:
  assume ($i109 == 1bv1);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 293, 79} true;
  assume {:verifier.code 0} true;
  $i111 := 4bv32;
  goto $bb86;
$bb83:
...
$bb86:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 295, 85} true;
  assume {:verifier.code 0} true;
  $i112 := $slt.bv32($i107, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 295, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i107, 0bv32, $i54, $i55, $i111, $i47;
...
$bb90:
  ...
  goto $bb35;
$bb91:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 166, 60} true;
  assume {:verifier.code 0} true;
  $i113 := $eq.bv32($i57, 8448bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 166, 51} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i113 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 431, 86} true;
  assume {:verifier.code 0} true;
  $i144 := $sgt.bv64($i54, 0bv64);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 431, 81} true;
  assume {:verifier.code 0} true;
  $i75, $i76, $i77, $i78, $i79 := 0bv32, $i54, $i55, $i56, $i55;
  assume {:branchcond $i144} true;
  goto $bb135, $bb136;
$bb93:
  assume !(($i113 == 1bv1));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 169, 53} true;
  assume {:verifier.code 0} true;
  $i114 := $add.bv32($i71, 4294958720bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 169, 53} true;
  assume {:verifier.code 0} true;
  $i115 := $lshr.bv32($i114, 4bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 169, 53} true;
  assume {:verifier.code 0} true;
  $i116 := $shl.bv32($i114, 28bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 169, 53} true;
  assume {:verifier.code 0} true;
  $i117 := $or.bv32($i115, $i116);
  assume {:verifier.code 0} true;
  goto $bb94;
$bb94:
  assume {:verifier.code 0} true;
  $i118 := $slt.bv32($i117, 4bv32);
  assume {:verifier.code 0} true;
...
$bb97:
  assume ($i119 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 479, 83} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 480, 85} true;
  assume {:verifier.code 0} true;
  $i134 := $slt.bv32($i133, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 480, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i133, 0bv32, $i54, $i55, $i56, $i51;
  assume {:branchcond $i134} true;
  goto $bb123, $bb124;
$bb98:
  assume !(($i119 == 1bv1));
  assume {:verifier.code 0} true;
  $i120 := $slt.bv32($i117, 6bv32);
  assume {:verifier.code 0} true;
...
$bb99:
  assume ($i120 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 493, 81} true;
  assume {:verifier.code 0} true;
  $i31 := $sub.bv32(0bv32, 1bv32);
...
$bb101:
  assume ($i121 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 513, 83} true;
  assume {:verifier.code 1} true;
  call $i126 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i126);
  call {:cexpr "ret"} boogie_si_record_bv32($i126);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 514, 91} true;
  assume {:verifier.code 0} true;
  $i127 := $eq.bv32($i56, 3bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 514, 81} true;
  assume {:verifier.code 0} true;
...
$bb106:
  assume ($i123 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 461, 83} true;
  assume {:verifier.code 1} true;
  call $i137 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i137);
  call {:cexpr "ret"} boogie_si_record_bv32($i137);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 462, 85} true;
  assume {:verifier.code 0} true;
  $i138 := $slt.bv32($i137, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 462, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i137, 0bv32, $i54, $i55, $i56, 8608bv32;
  assume {:branchcond $i138} true;
  goto $bb127, $bb128;
$bb107:
  assume !(($i123 == 1bv1));
  assume {:verifier.code 0} true;
  $i124 := $eq.bv32($i117, 2bv32);
  assume {:verifier.code 0} true;
...
$bb108:
  assume ($i124 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 470, 83} true;
  assume {:verifier.code 1} true;
  call $i135 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i135);
  call {:cexpr "ret"} boogie_si_record_bv32($i135);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 471, 85} true;
  assume {:verifier.code 0} true;
  $i136 := $slt.bv32($i135, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 471, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i135, 0bv32, $i54, $i55, $i56, 8640bv32;
...
$bb110:
  assume ($i125 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 444, 83} true;
  assume {:verifier.code 1} true;
  call $i139 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i139);
  call {:cexpr "ret"} boogie_si_record_bv32($i139);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 445, 85} true;
  assume {:verifier.code 0} true;
  $i140 := $slt.bv32($i139, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 445, 81} true;
  assume {:verifier.code 0} true;
  $i31 := $i139;
...
$bb113:
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 609, 11} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:verifier.code 0} true;
  assume false;
$bb114:
  assume !(($i127 == 1bv1));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 517, 85} true;
  assume {:verifier.code 0} true;
  $i128 := $slt.bv32($i126, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 517, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i126, 0bv32, $i54, $i48, $i56, 8448bv32;
...
$bb118:
  assume !(($i49 == 1bv1));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 497, 83} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 501, 85} true;
  assume {:verifier.code 0} true;
  $i130 := $slt.bv32($i129, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 501, 81} true;
  assume {:verifier.code 0} true;
  $i31 := $i129;
...
$bb120:
  assume !(($i130 == 1bv1));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 498, 91} true;
  assume {:verifier.code 0} true;
  $i131 := $eq.bv32($i56, 2bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 498, 81} true;
  assume {:verifier.code 0} true;
  $i132 := (if ($i131 == 1bv1) then 3bv32 else $i56);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i132);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 506, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $sub.bv32(0bv32, 1bv32), 0bv32, $i54, $i55, $i132, 8672bv32;
...
$bb130:
  assume !(($i140 == 1bv1));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 448, 85} true;
  assume {:verifier.code 0} true;
  $i141 := $eq.bv32($i139, 2bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 448, 81} true;
  assume {:verifier.code 0} true;
  $i75, $i76, $i77, $i78, $i79 := 0bv32, $i54, $i55, $i56, 8466bv32;
...
$bb132:
  assume !(($i141 == 1bv1));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 451, 85} true;
  assume {:verifier.code 1} true;
  call $i142 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i142);
  call {:cexpr "ret"} boogie_si_record_bv32($i142);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 452, 87} true;
  assume {:verifier.code 0} true;
  $i143 := $slt.bv32($i142, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 452, 83} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $i142, 0bv32, $i54, $i55, $i56, 8592bv32;
...
$bb135:
  assume ($i144 == 1bv1);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 434, 83} true;
  assume {:verifier.code 0} true;
  $i31, $i75, $i76, $i77, $i78, $i79 := $sub.bv32(0bv32, 1bv32), 0bv32, $i26, $i55, $i56, $i55;
...
$bb142:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i54, $i55, $i56, $i57 := $i76, $i77, $i78, $i79;
  goto $bb5;
$bb143:
  assume !(($i149 == 1bv1));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 584, 17} true;
  assume {:verifier.code 1} true;
  call $i150 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i150);
  call {:cexpr "ret"} boogie_si_record_bv32($i150);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 585, 19} true;
  assume {:verifier.code 0} true;
  $i151 := $slt.bv32($i150, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 585, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $i150;
...
$bb166:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i161 := $and.bv32($i61, 4294967294bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
  $i162 := $eq.bv32($i161, 8480bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 118, 19} true;
  assume {:verifier.code 0} true;
...
$bb167:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 259, 83} true;
  assume {:verifier.code 1} true;
  call $i198 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i198);
  call {:cexpr "ret"} boogie_si_record_bv32($i198);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 260, 85} true;
  assume {:verifier.code 0} true;
  $i199 := $slt.bv32($i198, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 260, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i198, 0bv32, $i58, 8482bv32, $i60, 8448bv32;
...
$bb170:
  assume ($i163 == 1bv1);
  assume {:verifier.code 0} true;
  $i170 := $add.bv32($i61, 4294958832bv32);
  assume {:verifier.code 0} true;
  $i171 := $ule.bv32($i170, 2bv32);
  assume {:verifier.code 0} true;
...
$bb171:
  assume !(($i163 == 1bv1));
  assume {:verifier.code 0} true;
  $i164 := $eq.bv32($i61, 8482bv32);
  assume {:verifier.code 0} true;
  $i165, $i166, $i167, $i168, $i169 := 0bv32, $i58, $i59, $i60, 3bv32;
...
$bb173:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 581, 9} true;
  assume {:verifier.code 0} true;
  $i242 := $or.bv32($i165, $i15);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 581, 9} true;
  assume {:verifier.code 0} true;
  $i243 := $ne.bv32($i242, 0bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 581, 9} true;
  assume {:verifier.code 0} true;
  $i244 := $or.bv1($i53, $i243);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 581, 9} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 275, 91} true;
  assume {:verifier.code 0} true;
  $i201 := $eq.bv32($i60, 0bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 275, 81} true;
  assume {:verifier.code 0} true;
  $i202 := (if ($i201 == 1bv1) then 1bv32 else $i60);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i202);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 278, 85} true;
  assume {:verifier.code 0} true;
  $i203 := $slt.bv32($i200, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 278, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i200, 0bv32, $i58, $i59, $i202, 8496bv32;
...
$bb178:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 136, 31} true;
  assume {:verifier.code 0} true;
  $i172 := $add.bv32($i161, 4294958800bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 136, 31} true;
  assume {:verifier.code 0} true;
  $i173 := $lshr.bv32($i172, 4bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 136, 31} true;
  assume {:verifier.code 0} true;
  $i174 := $shl.bv32($i172, 28bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 136, 31} true;
  assume {:verifier.code 0} true;
  $i175 := $or.bv32($i173, $i174);
  assume {:verifier.code 0} true;
  goto $bb179;
$bb179:
  assume {:verifier.code 0} true;
  $i176 := $slt.bv32($i175, 2bv32);
  assume {:verifier.code 0} true;
...
$bb184:
  assume ($i178 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 381, 83} true;
  assume {:verifier.code 0} true;
  $i165, $i166, $i167, $i168, $i169 := 1bv32, $i58, $i59, $i60, 8560bv32;
  assume {:branchcond $i35} true;
  goto $bb251, $bb252;
$bb185:
  assume !(($i178 == 1bv1));
  assume {:verifier.code 0} true;
  $i179 := $eq.bv32($i175, 4bv32);
  assume {:verifier.code 0} true;
...
$bb186:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 423, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i221, 0bv32, $i58, 8576bv32, $i60, 8448bv32;
...
$bb190:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 309, 81} true;
  assume {:verifier.code 0} true;
  $i165, $i166, $i167, $i168, $i169 := 1bv32, $i58, $i59, $i60, 8528bv32;
  assume {:branchcond $i45} true;
  goto $bb231, $bb232;
$bb191:
  assume ($i181 == 1bv1);
...
$bb194:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 431, 86} true;
  assume {:verifier.code 0} true;
  $i223 := $sgt.bv64($i58, 0bv64);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 431, 81} true;
  assume {:verifier.code 0} true;
  $i165, $i166, $i167, $i168, $i169 := 0bv32, $i58, $i59, $i60, $i59;
...
$bb195:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 169, 53} true;
  assume {:verifier.code 0} true;
  $i183 := $add.bv32($i161, 4294958720bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 169, 53} true;
  assume {:verifier.code 0} true;
  $i184 := $lshr.bv32($i183, 4bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 169, 53} true;
  assume {:verifier.code 0} true;
  $i185 := $shl.bv32($i183, 28bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 169, 53} true;
  assume {:verifier.code 0} true;
  $i186 := $or.bv32($i184, $i185);
  assume {:verifier.code 0} true;
  goto $bb196;
$bb196:
  assume {:verifier.code 0} true;
  $i187 := $slt.bv32($i186, 4bv32);
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 480, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i233, 0bv32, $i58, $i59, $i60, $i51;
  assume {:branchcond $i234} true;
  goto $bb273, $bb274;
$bb200:
  assume !(($i188 == 1bv1));
  assume {:verifier.code 0} true;
  $i189 := $slt.bv32($i186, 6bv32);
  assume {:verifier.code 0} true;
...
$bb208:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i229);
  call {:cexpr "ret"} boogie_si_record_bv32($i229);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 462, 85} true;
  assume {:verifier.code 0} true;
  $i230 := $slt.bv32($i229, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 462, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i229, 0bv32, $i58, $i59, $i60, 8608bv32;
  assume {:branchcond $i230} true;
  goto $bb269, $bb270;
$bb209:
  assume !(($i192 == 1bv1));
  assume {:verifier.code 0} true;
  $i193 := $eq.bv32($i186, 2bv32);
  assume {:verifier.code 0} true;
...
$bb210:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i231);
  call {:cexpr "ret"} boogie_si_record_bv32($i231);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 471, 85} true;
  assume {:verifier.code 0} true;
  $i232 := $slt.bv32($i231, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 471, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i231, 0bv32, $i58, $i59, $i60, 8640bv32;
...
$bb212:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i224);
  call {:cexpr "ret"} boogie_si_record_bv32($i224);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 445, 85} true;
  assume {:verifier.code 0} true;
  $i225 := $slt.bv32($i224, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 445, 81} true;
  assume {:verifier.code 0} true;
  $i31 := $i224;
...
$bb214:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 205, 86} true;
  assume {:verifier.code 0} true;
  $i196 := $eq.bv32($i195, 3bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 205, 77} true;
  assume {:verifier.code 0} true;
  $i197 := (if ($i196 == 1bv1) then 1bv32 else 4294967295bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 205, 77} true;
  assume {:verifier.code 0} true;
  $r := $i197;
  $exn := false;
...
$bb226:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 295, 85} true;
  assume {:verifier.code 0} true;
  $i209 := $slt.bv32($i204, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 295, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i204, 0bv32, $i58, $i59, $i208, $i47;
...
$bb231:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 313, 87} true;
  assume {:verifier.code 0} true;
  $i211 := $slt.bv32($i210, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 313, 83} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i210, 0bv32, $i58, $i59, $i60, 8528bv32;
...
$bb236:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 358, 93} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i217, 0bv32, $i58, $i59, $i60, 8544bv32;
...
$bb238:
  assume {:verifier.code 0} true;
  $i212 := $slt.bv32($i18, $sub.bv32(0bv32, 2bv32));
  assume {:verifier.code 0} true;
...
$bb239:
  assume ($i212 == 1bv1);
  assume {:verifier.code 0} true;
  $i214 := $eq.bv32($i18, $sub.bv32(0bv32, 4bv32));
  assume {:verifier.code 0} true;
...
$bb240:
  assume !(($i212 == 1bv1));
  assume {:verifier.code 0} true;
  $i213 := $eq.bv32($i18, $sub.bv32(0bv32, 2bv32));
  assume {:verifier.code 0} true;
  $i165, $i166, $i167, $i168, $i169 := 1bv32, $i58, $i59, $i60, 8544bv32;
...
$bb251:
  assume ($i35 == 1bv1);
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 393, 85} true;
  assume {:verifier.code 0} true;
  $i165, $i166, $i167, $i168, $i169 := 1bv32, $i58, $i59, $i60, 8560bv32;
...
$bb254:
  assume !(($i38 == 1bv1));
  assume true;
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 404, 89} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 405, 91} true;
  assume {:verifier.code 0} true;
  $i220 := $slt.bv32($i219, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 405, 87} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i219, 0bv32, $i58, 8576bv32, $i60, 8448bv32;
...
$bb259:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 434, 83} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $sub.bv32(0bv32, 1bv32), 0bv32, $i26, $i59, $i60, $i59;
  assume {:branchcond $i52} true;
  goto $bb261, $bb262;
$bb260:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 431, 81} true;
...
$bb264:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 448, 85} true;
  assume {:verifier.code 0} true;
  $i226 := $eq.bv32($i224, 2bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 448, 81} true;
  assume {:verifier.code 0} true;
  $i165, $i166, $i167, $i168, $i169 := 0bv32, $i58, $i59, $i60, 8466bv32;
...
$bb266:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 452, 87} true;
  assume {:verifier.code 0} true;
  $i228 := $slt.bv32($i227, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 452, 83} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i227, 0bv32, $i58, $i59, $i60, 8592bv32;
...
$bb276:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i235);
  call {:cexpr "ret"} boogie_si_record_bv32($i235);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 501, 85} true;
  assume {:verifier.code 0} true;
  $i236 := $slt.bv32($i235, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 501, 81} true;
  assume {:verifier.code 0} true;
  $i31 := $i235;
...
$bb278:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 498, 91} true;
  assume {:verifier.code 0} true;
  $i237 := $eq.bv32($i60, 2bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 498, 81} true;
  assume {:verifier.code 0} true;
  $i238 := (if ($i237 == 1bv1) then 3bv32 else $i60);
  call {:cexpr "blastFlag"} boogie_si_record_bv32($i238);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 506, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $sub.bv32(0bv32, 1bv32), 0bv32, $i58, $i59, $i238, 8672bv32;
  assume {:branchcond $i50} true;
  goto $bb279, $bb280;
$bb279:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 506, 81} true;
...
$bb282:
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 517, 85} true;
  assume {:verifier.code 0} true;
  $i241 := $slt.bv32($i239, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 517, 81} true;
  assume {:verifier.code 0} true;
  $i31, $i165, $i166, $i167, $i168, $i169 := $i239, 0bv32, $i58, $i48, $i60, 8448bv32;
...
$bb286:
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i58, $i59, $i60, $i61 := $i166, $i167, $i168, $i169;
  goto $bb7;
$bb287:
  assume !(($i244 == 1bv1));
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 584, 17} true;
  assume {:verifier.code 1} true;
  call $i245 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i245);
  call {:cexpr "ret"} boogie_si_record_bv32($i245);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 585, 19} true;
  assume {:verifier.code 0} true;
  $i246 := $slt.bv32($i245, 1bv32);
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 585, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $i245;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 620, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/s3_srvr_2.cil-2_tmp.c", 622, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_long == $sub.ref(0, 24776));
...
axiom (__SMACK_nondet_long == $sub.ref(0, 25808));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 26840));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 27872));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 28904));
...
axiom (__SMACK_static_init == $sub.ref(0, 29936));
