...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/stateful01-1-O0.bpl /Users/ponce/git/Dat3M/./output/stateful01-1_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/stateful01-1_tmp.c", 2, 44} true;
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "./output/stateful01-1_tmp.c", 678, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stateful01-1_tmp.c", 678, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(ma);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 679, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/stateful01-1_tmp.c", 680, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(ma);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 681, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_lock(ma);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 682, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/stateful01-1_tmp.c", 683, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(ma);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 684, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "./output/stateful01-1_tmp.c", 688, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stateful01-1_tmp.c", 688, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(ma);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 689, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, data1);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 689, 8} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $store.i32($M.0, data1, $i3);
  call {:cexpr "data1"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 690, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(ma);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 691, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_lock(ma);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, data2);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $store.i32($M.0, data2, $i7);
  call {:cexpr "data2"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 693, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(ma);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 694, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/stateful01-1_tmp.c", 699, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/stateful01-1_tmp.c", 700, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_init(mb, $0.ref);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 701, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, data1, 10);
  call {:cexpr "data1"} boogie_si_record_i32(10);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 702, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, data2, 10);
  call {:cexpr "data2"} boogie_si_record_i32(10);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 703, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread1, $0.ref);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 704, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 705, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 705, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 706, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 706, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 707, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, data1);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 707, 12} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, 16);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 707, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 707, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, data2);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 707, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 5);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 707, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/stateful01-1_tmp.c", 712, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "./output/stateful01-1_tmp.c", 708, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "./output/stateful01-1_tmp.c", 707, 7} true;
  ...
  goto $bb3;
$bb6:
  assume {:sourceloc "./output/stateful01-1_tmp.c", 709, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/stateful01-1_tmp.c", 709, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/stateful01-1_tmp.c", 709, 27} true;
  assume {:verifier.code 0} true;
