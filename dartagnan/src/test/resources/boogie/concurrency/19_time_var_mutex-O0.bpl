...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/19_time_var_mutex-O0.bpl /Users/ponce/git/Dat3M/./output/19_time_var_mutex_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 56743));
...
axiom (.str.1 == $sub.ref(0, 6178));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 7210));
const {:count 3} .str.1.1: ref;
axiom (.str.1.1 == $sub.ref(0, 8237));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 9275));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 10303));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 11335));
...
axiom (llvm.dbg.declare == $sub.ref(0, 12367));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 13399));
procedure  abort();
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 14431));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
axiom (__VERIFIER_atomic_acquire == $sub.ref(0, 15463));
procedure  __VERIFIER_atomic_acquire($p0: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 680, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 680, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, $p0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 680, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 680, 24} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 680, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 681, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 682, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_release: ref;
axiom (__VERIFIER_atomic_release == $sub.ref(0, 16495));
procedure  __VERIFIER_atomic_release($p0: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 685, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 685, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, $p0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 685, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 685, 24} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 685, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 686, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 687, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const thr1: ref;
axiom (thr1 == $sub.ref(0, 17527));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 695, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 695, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire(m_inode);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 696, 6} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, inode);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 696, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 696, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 697, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire(m_busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 698, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, busy, 1);
  call {:cexpr "busy"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 699, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release(m_busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 700, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, inode, 1);
  call {:cexpr "inode"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 701, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 696, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 702, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, block, 1);
  call {:cexpr "block"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 703, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, block);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 703, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 703, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 704, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release(m_inode);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 705, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 703, 23} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 703, 33} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 703, 47} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 703, 47} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 709, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 709, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire(m_busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 710, 6} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 710, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 710, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 711, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, block, 0);
  call {:cexpr "block"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 712, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, block);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 712, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 712, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb4, $bb5;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 714, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release(m_busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 715, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 713, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 712, 25} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 712, 35} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 712, 49} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 712, 49} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 720, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 721, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := thr2($0.ref);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 722, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 20623));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 21655));
...
axiom (__SMACK_code == $sub.ref(0, 22687));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 23719));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 24751));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 25783));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 26815));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 27847));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 28879));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 29911));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 30943));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 31975));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 33007));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 34039));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 35071));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 36103));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 37135));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 38167));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 39199));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 40231));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 41263));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 42295));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 43327));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 44359));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 45391));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 46423));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 47455));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 48487));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 49519));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 50551));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 51583));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 52615));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 53647));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 54679));
...
axiom (llvm.dbg.value == $sub.ref(0, 55711));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 56743));
