...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/cna-verification/include -I/Users/ponce/git/Dat3M/include/clang -I/Users/ponce/git/Dat3M/include/smack -DNTHREADS=3 -DREACQUIRE=1 -DALGORITHM=2 -bpl /Users/ponce/git/Dat3M/output/threadLocal.bpl /Users/ponce/git/Dat3M/threadLocal.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24764));
...
const {:treadLocal} {:allocSize 4} myindex: ref;
axiom (myindex == $sub.ref(0, 1028));
const thread_n: ref;
axiom (thread_n == $sub.ref(0, 2060));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "threadLocal.c", 12, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "threadLocal.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, myindex);
  assume {:sourceloc "threadLocal.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "threadLocal.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, myindex, $i2);
  call {:cexpr "myindex"} boogie_si_record_i32($i2);
  assume {:sourceloc "threadLocal.c", 13, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "threadLocal.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, myindex);
  assume {:sourceloc "threadLocal.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 1);
  assume {:sourceloc "threadLocal.c", 13, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "threadLocal.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 3092));
...
$bb0:
  call $initialize();
  assume {:sourceloc "threadLocal.c", 21, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "threadLocal.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "threadLocal.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "threadLocal.c", 24, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 5156));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 6188));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 7220));
...
axiom (__SMACK_dummy == $sub.ref(0, 8252));
...
axiom (__VERIFIER_assert == $sub.ref(0, 9284));
...
axiom (__SMACK_and32 == $sub.ref(0, 10316));
...
axiom (__SMACK_and64 == $sub.ref(0, 11348));
...
axiom (__SMACK_and16 == $sub.ref(0, 12380));
...
axiom (__SMACK_and8 == $sub.ref(0, 13412));
...
axiom (__SMACK_or32 == $sub.ref(0, 14444));
...
axiom (__SMACK_or64 == $sub.ref(0, 15476));
...
axiom (__SMACK_or16 == $sub.ref(0, 16508));
...
axiom (__SMACK_or8 == $sub.ref(0, 17540));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18572));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 19604));
...
axiom (__SMACK_decls == $sub.ref(0, 20636));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 21668));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 22700));
...
axiom (llvm.dbg.value == $sub.ref(0, 23732));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 24764));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, myindex, 0);
  call {:cexpr "myindex"} boogie_si_record_i32(0);
  $exn := false;
  return;
}
