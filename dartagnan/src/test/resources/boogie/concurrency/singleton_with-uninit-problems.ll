; ModuleID = '/home/ponce/git/Dat3M/output/singleton_with-uninit-problems.ll'
source_filename = "/home/ponce/git/Dat3M/../sv-benchmarks/c/pthread/singleton_with-uninit-problems.i"
...
@.str.1 = private unnamed_addr constant [33 x i8] c"singleton_with-uninit-problems.c\00", align 1
@__PRETTY_FUNCTION__.reach_error = private unnamed_addr constant [19 x i8] c"void reach_error()\00", align 1
@v = dso_local global i8* null, align 8, !dbg !0

; Function Attrs: noinline nounwind uwtable
define dso_local void @reach_error() #0 !dbg !16 {
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0), i32 noundef 3, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @__PRETTY_FUNCTION__.reach_error, i64 0, i64 0)) #6, !dbg !20
  unreachable, !dbg !20
}
...
define dso_local i32 @main() #0 !dbg !90 {
  ...
  %7 = and i8 %6, -2, !dbg !99
  %8 = icmp eq i8 %7, 88, !dbg !99
  %9 = zext i1 %8 to i32, !dbg !99
  call void @__VERIFIER_assert(i32 noundef %9), !dbg !100
  ret i32 0, !dbg !101
}
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/../sv-benchmarks/c/pthread/singleton_with-uninit-problems.i", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "6418c7b1e3f2975f175856136294c296")
!4 = !{!0}
!5 = !DIFile(filename: "../sv-benchmarks/c/pthread/singleton_with-uninit-problems.i", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "6418c7b1e3f2975f175856136294c296")
...
!99 = !DILocation(line: 1164, column: 33, scope: !90)
