...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 7, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 7, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 8, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 8, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 8, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 8, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 100, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 100, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 101, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 2;
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 102, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 103, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 104, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 105, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 106, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 106, 23} true;
  assume {:verifier.code 0} true;
  $M.2 := $i1;
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 107, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 108, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 109, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 110, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 111, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 111, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 111, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 112, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 113, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 120, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 120, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 121, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 122, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 123, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 124, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 125, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 126, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 126, 23} true;
  assume {:verifier.code 0} true;
  $M.4 := $i1;
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 127, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 128, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 129, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 130, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 131, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 131, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 131, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 132, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 133, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 140, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 140, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 141, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 142, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 143, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 144, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 145, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 146, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 146, 23} true;
  assume {:verifier.code 0} true;
  $M.5 := $i1;
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 147, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 148, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 149, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 150, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 151, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 151, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 151, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 152, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 153, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 182, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 184, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 186, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 187, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 188, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $M.3;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 188, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 188, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 188, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 189, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 190, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $M.6;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 190, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 190, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 191, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 192, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 193, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 23} true;
  assume {:verifier.code 0} true;
  $i12 := $M.0;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 30} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 33} true;
  assume {:verifier.code 0} true;
  $i15 := $M.2;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 53} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i15, 0);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 58} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 21} true;
  assume {:verifier.code 0} true;
  $i21 := $xor.i1($i14, 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 19} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i1.i8($i21);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 197, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 200, 21} true;
  assume {:verifier.code 1} true;
  $i23 := $M.7;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 200, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i25 := $zext.i1.i32($i24);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 200, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i25);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 201, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 61} true;
  assume {:verifier.code 0} true;
  $i17 := $M.4;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 81} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 0);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 86} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb6:
  assume ($i18 == 1);
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 89} true;
  assume {:verifier.code 0} true;
  $i19 := $M.5;
  assume {:sourceloc "./output/safe035_tso.opt_tmp.c", 196, 109} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 1);
  assume {:verifier.code 0} true;
  $i14 := $i20;
