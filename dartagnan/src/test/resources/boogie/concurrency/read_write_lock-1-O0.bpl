...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/read_write_lock-1-O0.bpl /Users/ponce/git/Dat3M/./output/read_write_lock-1_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 57779));
...
procedure  __VERIFIER_atomic_take_write_lock()
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 680, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 680, 23} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, w);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 680, 24} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 680, 28} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 680, 31} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, r);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 680, 32} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:verifier.code 0} true;
  $i2 := $i4;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 680, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 681, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, w, 1);
  call {:cexpr "w"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 682, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  __VERIFIER_atomic_take_read_lock()
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 684, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 684, 23} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, w);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 684, 24} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 684, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 684, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 685, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, r);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 685, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 685, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r, $i4);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 686, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  __VERIFIER_atomic_release_read_lock()
{
  ...
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 688, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 688, 7} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, r);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 688, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $sub.i32($i0, 1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 688, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r, $i1);
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 689, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
{
$bb0:
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 691, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 691, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_take_write_lock();
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 692, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 3);
  call {:cexpr "x"} boogie_si_record_i32(3);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 693, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, w, 0);
  call {:cexpr "w"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 694, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 698, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 698, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_take_read_lock();
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 699, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  call {:cexpr "l"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 700, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i1);
  call {:cexpr "y"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 701, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, y);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 701, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, x);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 701, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i2, $i3);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 701, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 702, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release_read_lock();
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 703, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 701, 26} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 701, 40} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 701, 40} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 707, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 708, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, reader, $0.ref);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 709, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, writer, $0.ref);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 710, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, reader, $0.ref);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 711, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 711, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 712, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 712, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 713, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i64($M.0, $p2);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 713, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 714, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 714, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "./output/read_write_lock-1_tmp.c", 715, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_join == $sub.ref(0, 21659));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 54683));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 55715));
...
axiom (llvm.dbg.value == $sub.ref(0, 56747));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 57779));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, w, 0);
  call {:cexpr "w"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, r, 0);
