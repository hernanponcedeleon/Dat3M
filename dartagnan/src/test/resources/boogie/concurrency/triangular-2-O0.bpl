...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/triangular-2-O0.bpl /Users/ponce/git/Dat3M/./output/triangular-2_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/triangular-2_tmp.c", 675, 44} true;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/triangular-2_tmp.c", 678, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-2_tmp.c", 678, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-2_tmp.c", 678, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/triangular-2_tmp.c", 678, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/triangular-2_tmp.c", 679, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-2_tmp.c", 680, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, j);
  assume {:sourceloc "./output/triangular-2_tmp.c", 680, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/triangular-2_tmp.c", 680, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, i, $i4);
  call {:cexpr "i"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/triangular-2_tmp.c", 681, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-2_tmp.c", 682, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/triangular-2_tmp.c", 683, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/triangular-2_tmp.c", 678, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/triangular-2_tmp.c", 684, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/triangular-2_tmp.c", 686, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-2_tmp.c", 686, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/triangular-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-2_tmp.c", 686, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/triangular-2_tmp.c", 686, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/triangular-2_tmp.c", 687, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-2_tmp.c", 688, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, i);
  assume {:sourceloc "./output/triangular-2_tmp.c", 688, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/triangular-2_tmp.c", 688, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, j, $i4);
  call {:cexpr "j"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/triangular-2_tmp.c", 689, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-2_tmp.c", 690, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/triangular-2_tmp.c", 691, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "./output/triangular-2_tmp.c", 691, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb4:
  assume {:sourceloc "./output/triangular-2_tmp.c", 686, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
  call {:cexpr "k"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/triangular-2_tmp.c", 686, 3} true;
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/triangular-2_tmp.c", 692, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/triangular-2_tmp.c", 695, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-2_tmp.c", 696, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p3, $0.ref, t2, $0.ref);
  assume {:sourceloc "./output/triangular-2_tmp.c", 697, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-2_tmp.c", 698, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, i);
  assume {:sourceloc "./output/triangular-2_tmp.c", 698, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sge.i32($i6, 16);
  assume {:sourceloc "./output/triangular-2_tmp.c", 698, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-2_tmp.c", 699, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-2_tmp.c", 700, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-2_tmp.c", 701, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, j);
  assume {:sourceloc "./output/triangular-2_tmp.c", 701, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $sge.i32($i9, 16);
  assume {:sourceloc "./output/triangular-2_tmp.c", 701, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-2_tmp.c", 702, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-2_tmp.c", 703, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/triangular-2_tmp.c", 703, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/triangular-2_tmp.c", 703, 23} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/triangular-2_tmp.c", 703, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/triangular-2_tmp.c", 703, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/triangular-2_tmp.c", 706, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "./output/triangular-2_tmp.c", 704, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/triangular-2_tmp.c", 704, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/triangular-2_tmp.c", 704, 27} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  $M.0 := $store.i32($M.0, i, 3);
  call {:cexpr "i"} boogie_si_record_i32(3);
  $M.0 := $store.i32($M.0, j, 6);
