...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/qrcu-2-O0.bpl /Users/ponce/git/Dat3M/./output/qrcu-2_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 69151));
...
const mutex: ref;
axiom (mutex == $sub.ref(0, 6196));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 7234));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 8266));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 9293));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 10331));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 11359));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 12391));
...
axiom (llvm.dbg.declare == $sub.ref(0, 13423));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 14455));
procedure  abort();
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 15487));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qrcu-2_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
axiom (__VERIFIER_atomic_use1 == $sub.ref(0, 16519));
procedure  __VERIFIER_atomic_use1($i0: i32)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 684, 29} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_atomic_use1:arg:myidx"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 684, 29} true;
  assume {:verifier.code 0} true;
  $i1 := $sle.i32($i0, 0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 684, 34} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 684, 37} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, ctr1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 684, 41} true;
  assume {:verifier.code 0} true;
  $i4 := $sgt.i32($i3, 0);
  assume {:verifier.code 0} true;
  $i2 := $i4;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 684, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 685, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, ctr1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 685, 7} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i6, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 685, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, ctr1, $i7);
  call {:cexpr "ctr1"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 686, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_use2: ref;
axiom (__VERIFIER_atomic_use2 == $sub.ref(0, 17551));
procedure  __VERIFIER_atomic_use2($i0: i32)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 688, 29} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_atomic_use2:arg:myidx"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 688, 29} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i32($i0, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 688, 34} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 688, 37} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, ctr2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 688, 41} true;
  assume {:verifier.code 0} true;
  $i4 := $sgt.i32($i3, 0);
  assume {:verifier.code 0} true;
  $i2 := $i4;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 688, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 689, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, ctr2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 689, 7} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i6, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 689, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, ctr2, $i7);
  call {:cexpr "ctr2"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 690, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_use_done: ref;
axiom (__VERIFIER_atomic_use_done == $sub.ref(0, 18583));
procedure  __VERIFIER_atomic_use_done($i0: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 692, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_atomic_use_done:arg:myidx"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 692, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $sle.i32($i0, 0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 692, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 692, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, ctr1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 692, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, $sub.i32(0, 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 692, 25} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, ctr1, $i3);
  call {:cexpr "ctr1"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 692, 29} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 693, 14} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, ctr2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 693, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4, $sub.i32(0, 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 693, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, ctr2, $i5);
  call {:cexpr "ctr2"} boogie_si_record_i32($i5);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 694, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_take_snapshot: ref;
axiom (__VERIFIER_atomic_take_snapshot == $sub.ref(0, 19615));
procedure  __VERIFIER_atomic_take_snapshot($i0: i32, $i1: i32)
{
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 698, 1} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_atomic_check_progress1 == $sub.ref(0, 20647));
procedure  __VERIFIER_atomic_check_progress1($i0: i32)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 700, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 701, 38} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i0, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 701, 43} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
...
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 704, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume ($i3 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 701, 46} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, readerprogress1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 701, 62} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, 1);
  assume {:verifier.code 0} true;
  $i4 := $i6;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 701, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i7);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 702, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 702, 23} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/qrcu-2_tmp.c", 702, 37} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/qrcu-2_tmp.c", 702, 37} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_atomic_check_progress2 == $sub.ref(0, 21679));
procedure  __VERIFIER_atomic_check_progress2($i0: i32)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 707, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 708, 38} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i0, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 708, 43} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i3} true;
  goto $bb3, $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 711, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume ($i3 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 708, 46} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, readerprogress2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 708, 62} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, 1);
  assume {:verifier.code 0} true;
  $i4 := $i6;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 708, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i7);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 709, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 709, 23} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/qrcu-2_tmp.c", 709, 37} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/qrcu-2_tmp.c", 709, 37} true;
  assume {:verifier.code 0} true;
...
axiom (qrcu_reader1 == $sub.ref(0, 22711));
  ...
  returns ($r: ref)
{
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 715, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qrcu-2_tmp.c", 715, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 716, 13} true;
  assume {:verifier.code 1} true;
  $i1 := $load.i32($M.0, idx);
  call {:cexpr "myidx"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 717, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 718, 7} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_use1($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 719, 7} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 721, 11} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb5, $bb6;
$bb4:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 727, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, readerprogress1, 1);
  call {:cexpr "readerprogress1"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 728, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, readerprogress1, 2);
  call {:cexpr "readerprogress1"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 729, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_use_done($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 730, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 722, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_use2($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 723, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb6:
  assume !(($i5 == 1));
...
axiom (qrcu_reader2 == $sub.ref(0, 23743));
  ...
  returns ($r: ref)
{
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 734, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qrcu-2_tmp.c", 734, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 735, 13} true;
  assume {:verifier.code 1} true;
  $i1 := $load.i32($M.0, idx);
  call {:cexpr "myidx"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 736, 9} true;
  assume {:verifier.code 0} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 736, 9} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 737, 7} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_use1($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 738, 7} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 740, 11} true;
  assume {:verifier.code 0} true;
  call $i4 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 740, 11} true;
  ...
  goto $bb5, $bb6;
$bb4:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 746, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, readerprogress2, 1);
  call {:cexpr "readerprogress2"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 747, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, readerprogress2, 2);
  call {:cexpr "readerprogress2"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 748, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_use_done($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 741, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_use2($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 742, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb6:
  assume !(($i5 == 1));
...
axiom (qrcu_updater == $sub.ref(0, 24775));
  ...
  returns ($r: ref)
{
  ...
  var $i41: i32;
$bb0:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qrcu-2_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_int();
  ...
  assume {:sourceloc "./output/qrcu-2_tmp.c", 753, 58} true;
  assume {:verifier.code 0} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  call {:cexpr "readerstart2"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 755, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_take_snapshot($i1, $i2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 756, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 756, 40} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, ctr1);
  call {:cexpr "sum"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 756, 58} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, ctr2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 756, 56} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i5, $i6);
  call {:cexpr "sum"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 756, 64} true;
  assume {:verifier.code 0} true;
  $i8 := $i7;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 756, 79} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, ctr2);
  call {:cexpr "sum"} boogie_si_record_i32($i9);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 756, 97} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, ctr1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 756, 95} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i9, $i10);
...
$bb3:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $sle.i32($i8, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i12 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 23} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i14 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 56} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, ctr1);
  call {:cexpr "sum"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 74} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, ctr2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 72} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32($i15, $i16);
  call {:cexpr "sum"} boogie_si_record_i32($i17);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 80} true;
  assume {:verifier.code 0} true;
  $i18 := $i17;
  goto $bb8;
$bb7:
  assume !(($i14 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 95} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, ctr2);
  call {:cexpr "sum"} boogie_si_record_i32($i19);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 113} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, ctr1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 111} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i19, $i20);
...
$bb8:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qrcu-2_tmp.c", 757, 122} true;
  assume {:verifier.code 0} true;
  $i22 := $i18;
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qrcu-2_tmp.c", 759, 11} true;
  assume {:verifier.code 0} true;
  $i23 := $sgt.i32($i22, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 759, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 760, 5} true;
  assume {:verifier.code 0} true;
  call $i24 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 9} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i32($M.0, idx);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 13} true;
  assume {:verifier.code 0} true;
  $i26 := $sle.i32($i25, 0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 9} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i26 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 25} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, ctr2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 25} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i27, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 25} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, ctr2, $i28);
  call {:cexpr "ctr2"} boogie_si_record_i32($i28);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 33} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, idx, 1);
  call {:cexpr "idx"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 42} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i32($M.0, ctr1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 42} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i32($i29, $sub.i32(0, 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 42} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, ctr1, $i30);
  call {:cexpr "ctr1"} boogie_si_record_i32($i30);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 761, 46} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  assume !(($i26 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 762, 16} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, ctr1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 762, 16} true;
  assume {:verifier.code 0} true;
  $i32 := $add.i32($i31, 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 762, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, ctr1, $i32);
  call {:cexpr "ctr1"} boogie_si_record_i32($i32);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 762, 24} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, idx, 0);
  call {:cexpr "idx"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 762, 33} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i32($M.0, ctr2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 762, 33} true;
  assume {:verifier.code 0} true;
  $i34 := $add.i32($i33, $sub.i32(0, 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 762, 33} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, ctr2, $i34);
  call {:cexpr "ctr2"} boogie_si_record_i32($i34);
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 763, 9} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, idx);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 763, 13} true;
  assume {:verifier.code 0} true;
  $i36 := $sle.i32($i35, 0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 763, 9} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i36 == 1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 763, 21} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i36 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 764, 12} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb17:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 763, 28} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i32($M.0, ctr1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 763, 33} true;
  assume {:verifier.code 0} true;
  $i38 := $sgt.i32($i37, 0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 763, 21} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume !(($i38 == 1));
  assume {:sourceloc "./output/qrcu-2_tmp.c", 763, 39} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 765, 5} true;
  assume {:verifier.code 0} true;
  call $i41 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb21:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 764, 19} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i32($M.0, ctr2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 764, 24} true;
  assume {:verifier.code 0} true;
  $i40 := $sgt.i32($i39, 0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 764, 12} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb20;
$bb24:
  assume {:sourceloc "./output/qrcu-2_tmp.c", 767, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_check_progress1($i1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 768, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_check_progress2($i2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (pthread_mutex_lock == $sub.ref(0, 25807));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 26839));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 27871));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/qrcu-2_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/qrcu-2_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, qrcu_reader1, $0.ref);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, qrcu_reader2, $0.ref);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, qrcu_updater, $0.ref);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 777, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 778, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_join($i9, $0.ref);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 779, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i64($M.0, $p2);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_join($i11, $0.ref);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_mutex_destroy(mutex);
  assume {:sourceloc "./output/qrcu-2_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 34063));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 35095));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 36127));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 37159));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 38191));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 39223));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 40255));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 41287));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 42319));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 43351));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 44383));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 45415));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 46447));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 47479));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 48511));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 49543));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 50575));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 51607));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 52639));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 53671));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 54703));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 55735));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 56767));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 57799));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 58831));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 59863));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 60895));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 61927));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 62959));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 63991));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 65023));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 66055));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 67087));
...
axiom (llvm.dbg.value == $sub.ref(0, 68119));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 69151));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, idx, 0);
  call {:cexpr "idx"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, ctr1, 1);
  call {:cexpr "ctr1"} boogie_si_record_i32(1);
  $M.0 := $store.i32($M.0, ctr2, 0);
  call {:cexpr "ctr2"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, readerprogress1, 0);
  call {:cexpr "readerprogress1"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, readerprogress2, 0);
  call {:cexpr "readerprogress2"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, mutex, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(mutex, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(mutex, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(mutex, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(mutex, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(mutex, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
