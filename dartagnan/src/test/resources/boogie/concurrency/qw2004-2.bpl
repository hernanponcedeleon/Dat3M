...
const stoppingFlag: ref;
axiom (stoppingFlag == $sub.ref(0, 1028));
const pendingIo: ref;
axiom (pendingIo == $sub.ref(0, 2056));
const stoppingEvent: ref;
axiom (stoppingEvent == $sub.ref(0, 3084));
const stopped: ref;
axiom (stopped == $sub.ref(0, 4112));
...
const BCSP_IoIncrement: ref;
axiom (BCSP_IoIncrement == $sub.ref(0, 10307));
procedure BCSP_IoIncrement()
  returns ($r: i32)
{
  var $i0: i32;
  var $i1: i1;
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 14, 9} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 15, 2} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, 1);
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/qw2004-2_tmp.c", 17, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 17, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 17, 12} true;
  assume {:verifier.code 0} true;
  $M.1 := $i4;
  call {:cexpr "pendingIo"} boogie_si_record_i32($i4);
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb3;
}
const dec: ref;
axiom (dec == $sub.ref(0, 11339));
procedure dec()
  returns ($r: i32)
{
  var $i0: i32;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 23, 5} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 23, 5} true;
  assume {:verifier.code 1} true;
  call $i0 := __VERIFIER_atomic_begin();
  call {:cexpr "smack:ext:__VERIFIER_atomic_begin"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.1 := $i2;
  call {:cexpr "pendingIo"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  call {:cexpr "tmp"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 26, 5} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_atomic_end();
  call {:cexpr "smack:ext:__VERIFIER_atomic_end"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 12371));
procedure __VERIFIER_atomic_begin()
  returns ($r: i32);
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 13403));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const __VERIFIER_atomic_end: ref;
axiom (__VERIFIER_atomic_end == $sub.ref(0, 14435));
procedure __VERIFIER_atomic_end()
  returns ($r: i32);
const BCSP_IoDecrement: ref;
axiom (BCSP_IoDecrement == $sub.ref(0, 15467));
procedure BCSP_IoDecrement()
{
  var $i0: i32;
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 32, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 32, 15} true;
  assume {:verifier.code 0} true;
  call $i0 := dec();
  call {:cexpr "pending"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 33, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 34, 16} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "stoppingEvent"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 35, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 33, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const BCSP_PnpAdd: ref;
axiom (BCSP_PnpAdd == $sub.ref(0, 16499));
procedure BCSP_PnpAdd($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 40, 14} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 40, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := BCSP_IoIncrement();
  call {:cexpr "status"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 41, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 41, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 42, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $M.3;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 42, 20} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 42, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 42, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := __VERIFIER_assert.i32($i6);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 43, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 41, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 44, 5} true;
  assume {:verifier.code 0} true;
  call BCSP_IoDecrement();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 45, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (__VERIFIER_assert == $sub.ref(0, 17531));
procedure __VERIFIER_assert.i32(p.0: i32)
  returns ($r: i32);
const BCSP_PnpStop: ref;
axiom (BCSP_PnpStop == $sub.ref(0, 18563));
procedure BCSP_PnpStop($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 49, 18} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 49, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "stoppingFlag"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 50, 5} true;
  assume {:verifier.code 0} true;
  call BCSP_IoDecrement();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 51, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 51, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := assume_abort_if_not.i32($i1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 52, 13} true;
  assume {:verifier.code 0} true;
  $M.3 := 1;
  call {:cexpr "stopped"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 53, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (assume_abort_if_not == $sub.ref(0, 19595));
procedure assume_abort_if_not.i32(p.0: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 20627));
procedure main()
  returns ($r: i32)
{
  var $p0: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 58, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "pendingIo"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 59, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := 0;
  call {:cexpr "stoppingFlag"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 60, 19} true;
  assume {:verifier.code 0} true;
  $M.2 := 0;
  call {:cexpr "stoppingEvent"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 61, 13} true;
  assume {:verifier.code 0} true;
  $M.3 := 0;
  call {:cexpr "stopped"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 62, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($p0, $0.ref, BCSP_PnpStop, $0.ref);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 63, 5} true;
  assume {:verifier.code 0} true;
  call $p2 := BCSP_PnpAdd($0.ref);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 21659));
...
$bb0:
  ...
  call {:cexpr "stoppingFlag"} boogie_si_record_i32(0);
  $M.1 := 0;
  call {:cexpr "pendingIo"} boogie_si_record_i32(0);
  $M.2 := 0;
  call {:cexpr "stoppingEvent"} boogie_si_record_i32(0);
  $M.3 := 0;
  call {:cexpr "stopped"} boogie_si_record_i32(0);
