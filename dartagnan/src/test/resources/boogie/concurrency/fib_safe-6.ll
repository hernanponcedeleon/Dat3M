; ModuleID = '/home/ponce/git/Dat3M/output/fib_safe-6.ll'
source_filename = "/home/ponce/git/Dat3M/../sv-benchmarks/c/pthread/fib_safe-6.i"
...
@.str.1 = private unnamed_addr constant [11 x i8] c"fib_safe.h\00", align 1
...
define dso_local void @reach_error() #0 !dbg !31 {
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i32 noundef 13, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @__PRETTY_FUNCTION__.reach_error, i64 0, i64 0)) #6, !dbg !35
  unreachable, !dbg !35
}
...
2:                                                ; preds = %4, %1
  ...
  %3 = icmp slt i32 %storemerge, 6, !dbg !61
...
2:                                                ; preds = %4, %1
  ...
  %3 = icmp slt i32 %storemerge, 6, !dbg !83
...
1:                                                ; preds = %3, %0
  ...
  %2 = icmp ult i32 %storemerge, 14, !dbg !104
...
define dso_local i32 @main(i32 noundef %0, i8** noundef %1) #0 !dbg !120 {
  ...
  %9 = icmp sle i32 %8, %7, !dbg !145
  %10 = load i32, i32* @j, align 4, !dbg !146
  %11 = icmp sle i32 %10, %7, !dbg !146
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/../sv-benchmarks/c/pthread/fib_safe-6.i", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "c03fe5c24f4546d29e1378ea75577e1d")
!4 = !{!5}
...
!9 = !DIFile(filename: "../sv-benchmarks/c/pthread/fib_safe-6.i", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "c03fe5c24f4546d29e1378ea75577e1d")
...
!146 = !DILocation(line: 724, column: 36, scope: !120)
