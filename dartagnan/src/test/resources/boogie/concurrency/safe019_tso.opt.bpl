...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 7, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 7, 91} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 7, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 7, 68} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 102, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 102, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 103, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 103, 23} true;
  assume {:verifier.code 0} true;
  $M.1 := $i1;
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 104, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 105, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 106, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $M.2;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 106, 23} true;
  assume {:verifier.code 0} true;
  $M.3 := $i2;
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 107, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 111, 22} true;
  assume {:verifier.code 0} true;
  $i3 := $M.4;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 111, 39} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 111, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := $i4;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 112, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 120, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 120, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 121, 5} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 122, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 126, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.4;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 126, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 126, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 127, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 135, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 135, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 136, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 136, 23} true;
  assume {:verifier.code 0} true;
  $M.5 := $i1;
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 137, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 138, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 139, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 140, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 144, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.4;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 144, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 144, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 145, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 153, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 153, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 154, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 2;
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 155, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 159, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.4;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 159, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 159, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 160, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 190, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 192, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 194, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 196, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 197, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 198, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $M.4;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 198, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 198, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 198, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 199, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 200, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $M.6;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 200, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $M.0;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 25} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, 2);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 30} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 33} true;
  assume {:verifier.code 0} true;
  $i17 := $M.1;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 53} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 2);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 58} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i1($i16, 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 207, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 210, 21} true;
  assume {:verifier.code 1} true;
  $i25 := $M.7;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 210, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i27 := $zext.i1.i32($i26);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 210, 3} true;
  assume {:verifier.code 1} true;
...
$bb4:
  assume ($i18 == 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 61} true;
  assume {:verifier.code 0} true;
  $i19 := $M.3;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 81} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 0);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 86} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb6:
  assume ($i20 == 1);
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 89} true;
  assume {:verifier.code 0} true;
  $i21 := $M.5;
  assume {:sourceloc "./output/safe019_tso.opt_tmp.c", 206, 109} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, 1);
  assume {:verifier.code 0} true;
  $i16 := $i22;
