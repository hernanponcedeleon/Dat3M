...
{
$bb0:
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 7, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 7, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 8, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 8, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 8, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 8, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 109, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 109, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 110, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 110, 23} true;
  assume {:verifier.code 0} true;
  $M.1 := $i1;
  ...
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 112, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 113, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $M.2;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 113, 23} true;
  assume {:verifier.code 0} true;
  $M.3 := $i2;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 117, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 118, 22} true;
  assume {:verifier.code 0} true;
  $i3 := $M.4;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 118, 39} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 118, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := $i4;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 120, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 127, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 127, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 128, 5} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 132, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 133, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.4;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 133, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 133, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := $i2;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 135, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 142, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 142, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 143, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 143, 23} true;
  assume {:verifier.code 0} true;
  $M.5 := $i1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 145, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 146, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 146, 23} true;
  assume {:verifier.code 0} true;
  $M.6 := $i2;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 150, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 151, 22} true;
  assume {:verifier.code 0} true;
  $i3 := $M.4;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 151, 39} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 151, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := $i4;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i4);
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 153, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 160, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 160, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 161, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 165, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 166, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.4;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 166, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 166, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 168, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 197, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 199, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 201, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 204, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 205, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $M.4;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 205, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 205, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 205, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 207, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $M.7;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 207, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 210, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $M.1;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 43} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 48} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 51} true;
  assume {:verifier.code 0} true;
  $i17 := $M.3;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 71} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 0);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 76} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i1($i16, 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 214, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 217, 21} true;
  assume {:verifier.code 1} true;
  $i25 := $M.8;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 217, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 218, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i18 == 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 79} true;
  assume {:verifier.code 0} true;
  $i19 := $M.5;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 99} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 104} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb6:
  assume ($i20 == 1);
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 107} true;
  assume {:verifier.code 0} true;
  $i21 := $M.6;
  assume {:sourceloc "./output/safe027_tso.opt_tmp.c", 213, 127} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, 0);
  assume {:verifier.code 0} true;
  $i16 := $i22;
