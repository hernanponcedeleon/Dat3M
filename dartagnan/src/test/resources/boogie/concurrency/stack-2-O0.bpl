...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/stack-2-O0.bpl /Users/ponce/git/Dat3M/./output/stack-2_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 69189));
...
axiom (arr == $sub.ref(0, 6234));
const {:count 14} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 7272));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 8304));
const {:count 3} .str.1.7: ref;
axiom (.str.1.7 == $sub.ref(0, 9331));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 10369));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 11397));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 12429));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 2, 44} true;
...
axiom (assume_abort_if_not == $sub.ref(0, 13461));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/stack-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/stack-2_tmp.c", 5, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 5, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/stack-2_tmp.c", 5, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 14493));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 15525));
procedure  abort();
const error: ref;
axiom (error == $sub.ref(0, 16557));
procedure  error()
{
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 922, 1} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 922, 1} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/stack-2_tmp.c", 923, 11} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/stack-2_tmp.c", 923, 25} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/stack-2_tmp.c", 923, 25} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
  assume {:sourceloc "./output/stack-2_tmp.c", 925, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const inc_top: ref;
axiom (inc_top == $sub.ref(0, 17589));
procedure  inc_top()
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 928, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 928, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, top);
  ...
  assume {:sourceloc "./output/stack-2_tmp.c", 929, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const dec_top: ref;
axiom (dec_top == $sub.ref(0, 18621));
procedure  dec_top()
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 932, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 932, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, top);
  ...
  $M.0 := $store.i32($M.0, top, $i1);
  call {:cexpr "top"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/stack-2_tmp.c", 933, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const get_top: ref;
axiom (get_top == $sub.ref(0, 19653));
procedure  get_top()
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 936, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 936, 10} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, top);
  assume {:sourceloc "./output/stack-2_tmp.c", 936, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 944, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "push:arg:x"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/stack-2_tmp.c", 944, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, top);
  assume {:sourceloc "./output/stack-2_tmp.c", 944, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 5);
  assume {:sourceloc "./output/stack-2_tmp.c", 944, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 946, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := printf.ref(.str);
  assume {:sourceloc "./output/stack-2_tmp.c", 947, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(0, 1);
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 951, 11} true;
  assume {:verifier.code 0} true;
  call $i6 := get_top();
  assume {:sourceloc "./output/stack-2_tmp.c", 951, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "./output/stack-2_tmp.c", 951, 5} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0, $mul.ref($i7, 4));
  assume {:sourceloc "./output/stack-2_tmp.c", 951, 22} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p8, $i1);
  assume {:sourceloc "./output/stack-2_tmp.c", 952, 5} true;
  assume {:verifier.code 0} true;
  call inc_top();
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 955, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/stack-2_tmp.c", 954, 3} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
}
const printf: ref;
axiom (printf == $sub.ref(0, 21717));
procedure  printf.ref($p0: ref)
  returns ($r: i32);
const pop: ref;
axiom (pop == $sub.ref(0, 22749));
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 958, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 958, 7} true;
  assume {:verifier.code 0} true;
  call $i1 := get_top();
  assume {:sourceloc "./output/stack-2_tmp.c", 958, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/stack-2_tmp.c", 958, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 960, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := printf.ref(.str.1);
  assume {:sourceloc "./output/stack-2_tmp.c", 961, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, 2);
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 965, 5} true;
  assume {:verifier.code 0} true;
  call dec_top();
  assume {:sourceloc "./output/stack-2_tmp.c", 966, 18} true;
  assume {:verifier.code 0} true;
  call $i5 := get_top();
  assume {:sourceloc "./output/stack-2_tmp.c", 966, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "./output/stack-2_tmp.c", 966, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "./output/stack-2_tmp.c", 966, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i8;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/stack-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 969, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i10: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 974, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 974, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/stack-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 974, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/stack-2_tmp.c", 974, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 976, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "./output/stack-2_tmp.c", 977, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/stack-2_tmp.c", 978, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4, 5);
  assume {:sourceloc "./output/stack-2_tmp.c", 978, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/stack-2_tmp.c", 978, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i6);
  assume {:sourceloc "./output/stack-2_tmp.c", 979, 9} true;
  assume {:verifier.code 0} true;
  call $i7 := push(arr, $i4);
  assume {:sourceloc "./output/stack-2_tmp.c", 979, 22} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 984, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i8 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 980, 7} true;
  assume {:verifier.code 0} true;
  call error();
  assume {:sourceloc "./output/stack-2_tmp.c", 980, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/stack-2_tmp.c", 981, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, flag, 1);
  call {:cexpr "flag"} boogie_si_record_i8(1);
  assume {:sourceloc "./output/stack-2_tmp.c", 982, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_mutex_unlock(m);
  assume {:sourceloc "./output/stack-2_tmp.c", 983, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/stack-2_tmp.c", 974, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i1, 1);
...
axiom (pthread_mutex_lock == $sub.ref(0, 24813));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 25845));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const t2: ref;
axiom (t2 == $sub.ref(0, 26877));
procedure  t2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 989, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 989, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/stack-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 989, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/stack-2_tmp.c", 989, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 991, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "./output/stack-2_tmp.c", 992, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i8($M.0, flag);
  assume {:sourceloc "./output/stack-2_tmp.c", 992, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 999, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 994, 13} true;
  assume {:verifier.code 0} true;
  call $i6 := pop(arr);
  assume {:sourceloc "./output/stack-2_tmp.c", 994, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, $sub.i32(0, 2));
  assume {:sourceloc "./output/stack-2_tmp.c", 994, 11} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/stack-2_tmp.c", 997, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(m);
  assume {:sourceloc "./output/stack-2_tmp.c", 998, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb7:
  assume {:sourceloc "./output/stack-2_tmp.c", 994, 11} true;
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/stack-2_tmp.c", 996, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb9:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 995, 9} true;
  assume {:verifier.code 0} true;
  call error();
  assume {:sourceloc "./output/stack-2_tmp.c", 995, 9} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb10:
  assume {:sourceloc "./output/stack-2_tmp.c", 989, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i1, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/stack-2_tmp.c", 1004, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/stack-2_tmp.c", 1005, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "./output/stack-2_tmp.c", 1006, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, t2, $0.ref);
  assume {:sourceloc "./output/stack-2_tmp.c", 1007, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/stack-2_tmp.c", 1007, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_join($i5, $0.ref);
  assume {:sourceloc "./output/stack-2_tmp.c", 1008, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/stack-2_tmp.c", 1008, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "./output/stack-2_tmp.c", 1009, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 33069));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 34101));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 35133));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 36165));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 37197));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 38229));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 39261));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 40293));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 41325));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 42357));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 43389));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 44421));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 45453));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 46485));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 47517));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 48549));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 49581));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 50613));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 51645));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 52677));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 53709));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 54741));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 55773));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 56805));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 57837));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 58869));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 59901));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 60933));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 61965));
...
axiom (__SMACK_decls == $sub.ref(0, 62997));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 64029));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 65061));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 66093));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 67125));
...
axiom (llvm.dbg.value == $sub.ref(0, 68157));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 69189));
