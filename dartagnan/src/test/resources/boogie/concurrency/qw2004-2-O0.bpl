...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/qw2004-2-O0.bpl /Users/ponce/git/Dat3M/./output/qw2004-2_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 673, 44} true;
...
axiom (assume_abort_if_not == $sub.ref(0, 11339));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 676, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 676, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 676, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 677, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/qw2004-2_tmp.c", 676, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 676, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 12371));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 13403));
procedure  abort();
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 14435));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 679, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 679, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 679, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 682, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/qw2004-2_tmp.c", 679, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 680, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 680, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 680, 27} true;
  assume {:verifier.code 0} true;
...
axiom (BCSP_IoIncrement == $sub.ref(0, 15467));
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 692, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 692, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, stoppingFlag);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 692, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 692, 9} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 693, 2} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, 1);
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/qw2004-2_tmp.c", 695, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, pendingIo);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 695, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 695, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pendingIo, $i4);
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 698, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 697, 5} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb3;
}
const dec: ref;
axiom (dec == $sub.ref(0, 16499));
procedure  dec()
  returns ($r: i32)
{
  var $i0: i32;
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 700, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 700, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 701, 14} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, pendingIo);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 701, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, $sub.i32(0, 1));
  assume {:sourceloc "./output/qw2004-2_tmp.c", 701, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pendingIo, $i1);
  call {:cexpr "pendingIo"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 702, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, pendingIo);
  call {:cexpr "tmp"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 703, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 704, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
axiom (BCSP_IoDecrement == $sub.ref(0, 17531));
procedure  BCSP_IoDecrement()
{
  var $i0: i32;
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 708, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 708, 15} true;
  assume {:verifier.code 0} true;
  call $i0 := dec();
  call {:cexpr "pending"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 709, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 709, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 710, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, stoppingEvent, 1);
  call {:cexpr "stoppingEvent"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 711, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 709, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 712, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const BCSP_PnpAdd: ref;
axiom (BCSP_PnpAdd == $sub.ref(0, 18563));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 715, 14} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 715, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := BCSP_IoIncrement();
  call {:cexpr "status"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 716, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 716, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 717, 21} true;
  assume {:verifier.code 1} true;
  $i3 := $load.i32($M.0, stopped);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 717, 20} true;
  assume {:verifier.code 1} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 717, 20} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: ./output/qw2004-2_tmp.c:717:20: warning: over-approximating bitwise operation xor;
  $i5 := $xor.i1($i4, 1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 717, 20} true;
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 717, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i6);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 718, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 716, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 719, 5} true;
  assume {:verifier.code 0} true;
  call BCSP_IoDecrement();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 720, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (BCSP_PnpStop == $sub.ref(0, 19595));
procedure  BCSP_PnpStop($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/qw2004-2_tmp.c", 723, 18} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/qw2004-2_tmp.c", 723, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, stoppingFlag, 1);
  call {:cexpr "stoppingFlag"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 724, 5} true;
  assume {:verifier.code 0} true;
  call BCSP_IoDecrement();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 725, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, stoppingEvent);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 725, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 726, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, stopped, 1);
  call {:cexpr "stopped"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 727, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/qw2004-2_tmp.c", 731, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/qw2004-2_tmp.c", 731, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pendingIo, 1);
  call {:cexpr "pendingIo"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 732, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, stoppingFlag, 0);
  call {:cexpr "stoppingFlag"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 733, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, stoppingEvent, 0);
  call {:cexpr "stoppingEvent"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 734, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, stopped, 0);
  call {:cexpr "stopped"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 735, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($p0, $0.ref, BCSP_PnpStop, $0.ref);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 736, 5} true;
  assume {:verifier.code 0} true;
  call $p2 := BCSP_PnpAdd($0.ref);
  assume {:sourceloc "./output/qw2004-2_tmp.c", 737, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb0:
  $M.0 := $store.i32($M.0, stoppingFlag, 0);
  call {:cexpr "stoppingFlag"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, pendingIo, 0);
  call {:cexpr "pendingIo"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, stoppingEvent, 0);
  call {:cexpr "stoppingEvent"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, stopped, 0);
  call {:cexpr "stopped"} boogie_si_record_i32(0);
  $M.0 := $store.ref($M.0, env_value_str, .str.1.5);
