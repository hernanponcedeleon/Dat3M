...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 7, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 7, 91} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 7, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 7, 68} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 105, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 105, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 106, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 106, 23} true;
  assume {:verifier.code 0} true;
  $M.1 := $i1;
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 107, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 108, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 109, 5} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 110, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 111, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 112, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 113, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 114, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 114, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 114, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 115, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 116, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 123, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 123, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 124, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 124, 23} true;
  assume {:verifier.code 0} true;
  $M.4 := $i1;
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 125, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 126, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 127, 5} true;
  assume {:verifier.code 0} true;
  $M.5 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 128, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 129, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 130, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 131, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 132, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 132, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 132, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 133, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 134, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 141, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 141, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 142, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.5;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 142, 23} true;
  assume {:verifier.code 0} true;
  $M.6 := $i1;
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 143, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 144, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 145, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 146, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 147, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 148, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 149, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 150, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 150, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 150, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 151, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 152, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 181, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 183, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 185, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 186, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 187, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $M.3;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 187, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 187, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 187, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 188, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 189, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $M.7;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 189, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 189, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 190, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 191, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 192, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 23} true;
  assume {:verifier.code 0} true;
  $i12 := $M.1;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 43} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 48} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 51} true;
  assume {:verifier.code 0} true;
  $i15 := $M.4;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 71} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i15, 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 76} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 21} true;
  assume {:verifier.code 0} true;
  $i19 := $xor.i1($i14, 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 196, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 199, 21} true;
  assume {:verifier.code 1} true;
  $i21 := $M.8;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 199, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 199, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i23);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 200, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 79} true;
  assume {:verifier.code 0} true;
  $i17 := $M.6;
  assume {:sourceloc "./output/thin001_tso.oepc_tmp.c", 195, 99} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 1);
  assume {:verifier.code 0} true;
  $i14 := $i18;
