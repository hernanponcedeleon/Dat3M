...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/race-3_1-container_of-global-O0.bpl /Users/ponce/git/Dat3M/./output/race-3_1-container_of-global_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 61923));
...
axiom (.str.1 == $sub.ref(0, 4134));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 5166));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 6193));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 7231));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 8259));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 9291));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1681, 44} true;
...
axiom (ldv_assert == $sub.ref(0, 10323));
procedure  ldv_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ldv_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1683, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1683, 88} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1683, 52} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1683, 62} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 11355));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 12387));
procedure  abort();
const my_callback: ref;
axiom (my_callback == $sub.ref(0, 13419));
  ...
  returns ($r: ref)
{
  ...
  var $i16: i32;
$bb0:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1699, 66} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1699, 66} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, my_dev);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1699, 95} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1699, 110} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($add.ref($0.ref, $mul.ref(0, 40)), $mul.ref(32, 1)))), 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1699, 75} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1700, 29} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1700, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_lock($p5);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1701, 8} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p8 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1701, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p8, 1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1702, 25} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p10 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1702, 32} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, $p10);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1702, 34} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i11, 1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1702, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p14 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1702, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p14, $i12);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1703, 31} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1703, 2} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_mutex_unlock($p15);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1704, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i22: i32;
$bb0:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1707, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1707, 28} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1707, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_init($p1, $0.ref);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1708, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p4 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1708, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1709, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p6 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1709, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p6, 0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1710, 19} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p8 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1710, 26} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p8);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1710, 27} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1710, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1710, 2} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i11);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1711, 19} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p13 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1711, 26} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p13);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1711, 27} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, 0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1711, 27} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i32($i15);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1711, 2} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i16);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1712, 12} true;
  ...
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1713, 5} true;
  assume {:verifier.code 0} true;
  $i18 := $ne.i32($i17, 0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1713, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i18 == 1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1714, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i18 == 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1715, 18} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1715, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, my_dev, $p19);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1716, 2} true;
  assume {:verifier.code 0} true;
  call $i20 := pthread_create(t1, $0.ref, my_callback, $0.ref);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1717, 2} true;
  assume {:verifier.code 0} true;
  call $i21 := pthread_create(t2, $0.ref, my_callback, $0.ref);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1718, 2} true;
  assume {:verifier.code 0} true;
  $i22 := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1720, 31} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1720, 2} true;
  assume {:verifier.code 0} true;
  call $i24 := pthread_mutex_destroy($p23);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1721, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i32(0, 1);
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1722, 1} true;
  assume {:verifier.code 0} true;
  $r := $i22;
  $exn := false;
  return;
...
procedure  my_drv_disconnect($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1725, 15} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, t1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1725, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $p1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1726, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i64($M.0, t2);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1726, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $p1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1727, 31} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1727, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_destroy($p6);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1728, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 21675));
procedure  pthread_join($i0: i64, $p1: ref)
  returns ($r: i32);
const my_drv_init: ref;
axiom (my_drv_init == $sub.ref(0, 22707));
procedure  my_drv_init()
  returns ($r: i32)
{
$bb0:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1730, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1730, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
...
axiom (my_drv_cleanup == $sub.ref(0, 23739));
procedure  my_drv_cleanup()
{
$bb0:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1733, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1733, 2} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1736, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1737, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1737, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume true;
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1740, 15} true;
  assume {:verifier.code 0} true;
  call $i3 := my_drv_probe($p0);
  call {:cexpr "probe_ret"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1741, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1741, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1752, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1742, 4} true;
  assume {:verifier.code 0} true;
  call my_drv_disconnect($p0);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1743, 20} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p6 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1743, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1743, 28} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, 1);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1743, 28} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1743, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i9);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1744, 20} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p11 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1744, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p11);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1744, 28} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1744, 28} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1744, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i14);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1745, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1741, 6} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1746, 3} true;
  assume {:verifier.code 0} true;
  call my_drv_cleanup();
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1747, 8} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p16 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1747, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p16, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1748, 8} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p18 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1748, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p18, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1749, 19} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p20 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1749, 26} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, $p20);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1749, 27} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1749, 27} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1749, 3} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i23);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1750, 19} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p25 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1750, 26} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, $p25);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1750, 27} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.i32($i26, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1750, 27} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i1.i32($i27);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1750, 3} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i28);
  assume {:sourceloc "./output/race-3_1-container_of-global_tmp.c", 1751, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 25803));
...
axiom (__SMACK_code == $sub.ref(0, 26835));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 27867));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 28899));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 29931));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 30963));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 31995));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 33027));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 34059));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 35091));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 36123));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 37155));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 38187));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 39219));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 40251));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 41283));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 42315));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 43347));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 44379));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 45411));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 46443));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 47475));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 48507));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 49539));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 50571));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 51603));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 52635));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 53667));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 54699));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 55731));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 56763));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 57795));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 58827));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 59859));
...
axiom (llvm.dbg.value == $sub.ref(0, 60891));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 61923));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.ref($M.0, my_dev, $0.ref);
