...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/stack-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/stack-2_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/stack-2_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 23, 1} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 23, 1} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/stack-2_tmp.c", 24, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume false;
$bb2:
  assume {:sourceloc "./output/stack-2_tmp.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure inc_top()
{
  ...
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 30, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 30, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  ...
  assume {:sourceloc "./output/stack-2_tmp.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure dec_top()
{
  ...
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 35, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  ...
  $M.0 := $i1;
  call {:cexpr "top"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/stack-2_tmp.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 40, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 40, 10} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "./output/stack-2_tmp.c", 40, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 50, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "push:arg:x"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/stack-2_tmp.c", 50, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "./output/stack-2_tmp.c", 50, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 5);
  assume {:sourceloc "./output/stack-2_tmp.c", 50, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 52, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := printf.ref(.str);
  assume {:sourceloc "./output/stack-2_tmp.c", 53, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(0, 1);
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 57, 11} true;
  assume {:verifier.code 0} true;
  call $i6 := get_top();
  assume {:sourceloc "./output/stack-2_tmp.c", 57, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "./output/stack-2_tmp.c", 57, 5} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0, $mul.ref($i7, 4));
  assume {:sourceloc "./output/stack-2_tmp.c", 57, 22} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p8, $i1);
  assume {:sourceloc "./output/stack-2_tmp.c", 58, 5} true;
  assume {:verifier.code 0} true;
  call inc_top();
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/stack-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 61, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/stack-2_tmp.c", 60, 3} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
}
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 65, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 65, 7} true;
  assume {:verifier.code 0} true;
  call $i1 := get_top();
  assume {:sourceloc "./output/stack-2_tmp.c", 65, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/stack-2_tmp.c", 65, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 67, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := printf.ref(.str.1);
  assume {:sourceloc "./output/stack-2_tmp.c", 68, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, 2);
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 72, 5} true;
  assume {:verifier.code 0} true;
  call dec_top();
  assume {:sourceloc "./output/stack-2_tmp.c", 73, 18} true;
  assume {:verifier.code 0} true;
  call $i5 := get_top();
  assume {:sourceloc "./output/stack-2_tmp.c", 73, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "./output/stack-2_tmp.c", 73, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.1, $p7);
  assume {:sourceloc "./output/stack-2_tmp.c", 73, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i8;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/stack-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 76, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i10: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 83, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 83, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/stack-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 83, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/stack-2_tmp.c", 83, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 85, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "./output/stack-2_tmp.c", 86, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/stack-2_tmp.c", 87, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4, 5);
  assume {:sourceloc "./output/stack-2_tmp.c", 87, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/stack-2_tmp.c", 87, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i6);
  assume {:sourceloc "./output/stack-2_tmp.c", 88, 9} true;
  assume {:verifier.code 0} true;
  call $i7 := push(arr, $i4);
  assume {:sourceloc "./output/stack-2_tmp.c", 88, 22} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 93, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i8 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 89, 7} true;
  assume {:verifier.code 0} true;
  call error();
  assume {:sourceloc "./output/stack-2_tmp.c", 89, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/stack-2_tmp.c", 90, 9} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "flag"} boogie_si_record_i8(1);
  assume {:sourceloc "./output/stack-2_tmp.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_mutex_unlock(m);
  assume {:sourceloc "./output/stack-2_tmp.c", 92, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/stack-2_tmp.c", 83, 21} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i1, 1);
  ...
  returns ($r: ref)
{
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "./output/stack-2_tmp.c", 100, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 100, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/stack-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stack-2_tmp.c", 100, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/stack-2_tmp.c", 100, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 102, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "./output/stack-2_tmp.c", 103, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.2;
  assume {:sourceloc "./output/stack-2_tmp.c", 103, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 110, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/stack-2_tmp.c", 105, 13} true;
  assume {:verifier.code 0} true;
  call $i6 := pop(arr);
  assume {:sourceloc "./output/stack-2_tmp.c", 105, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, $sub.i32(0, 2));
  assume {:sourceloc "./output/stack-2_tmp.c", 105, 11} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/stack-2_tmp.c", 108, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(m);
  assume {:sourceloc "./output/stack-2_tmp.c", 109, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb7:
  assume {:sourceloc "./output/stack-2_tmp.c", 105, 11} true;
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/stack-2_tmp.c", 107, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb9:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/stack-2_tmp.c", 106, 9} true;
  assume {:verifier.code 0} true;
  call error();
  assume {:sourceloc "./output/stack-2_tmp.c", 106, 9} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb10:
  assume {:sourceloc "./output/stack-2_tmp.c", 100, 21} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i1, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/stack-2_tmp.c", 118, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/stack-2_tmp.c", 120, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "./output/stack-2_tmp.c", 121, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, t2, $0.ref);
  assume {:sourceloc "./output/stack-2_tmp.c", 123, 16} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.3, $p0);
  assume {:sourceloc "./output/stack-2_tmp.c", 123, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := __pthread_join($p5, $0.ref);
  assume {:sourceloc "./output/stack-2_tmp.c", 124, 16} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.3, $p1);
  assume {:sourceloc "./output/stack-2_tmp.c", 124, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := __pthread_join($p7, $0.ref);
  assume {:sourceloc "./output/stack-2_tmp.c", 126, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb0:
  ...
  $M.3 := $store.i64($M.3, m, 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(0, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(1, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(2, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(3, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(4, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(5, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(6, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(7, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(8, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(9, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(10, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(11, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(12, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(13, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(14, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(15, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(16, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(17, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(18, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(19, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(20, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(21, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(22, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(23, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(24, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(25, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(26, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(27, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(28, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(29, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(30, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(31, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(32, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(33, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(34, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(35, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(36, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(37, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(38, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(39, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(40, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(41, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(42, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(43, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(44, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(45, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(46, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(47, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(48, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(49, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(50, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(51, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(52, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(53, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(54, 1)), 0);
  $M.3 := $store.i8($M.3, $add.ref($add.ref($add.ref(m, $mul.ref(0, 64)), $mul.ref(8, 1)), $mul.ref(55, 1)), 0);
  $M.0 := 0;
