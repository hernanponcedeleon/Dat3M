...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 56749));
...
axiom (assume_abort_if_not == $sub.ref(0, 7213));
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/gcd-2_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/gcd-2_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
const abort: ref;
axiom (abort == $sub.ref(0, 9277));
procedure abort();
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 10309));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 84, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 84, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 84, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 87, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/gcd-2_tmp.c", 84, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/gcd-2_tmp.c", 85, 12} true;
...
axiom (__VERIFIER_atomic_dec_a == $sub.ref(0, 11341));
procedure __VERIFIER_atomic_dec_a()
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 96, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 96, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 96, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 96, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.i32($i0, $i1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 96, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 97, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.1;
  ...
  assume {:sourceloc "./output/gcd-2_tmp.c", 97, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/gcd-2_tmp.c", 96, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/gcd-2_tmp.c", 98, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_dec_b: ref;
axiom (__VERIFIER_atomic_dec_b == $sub.ref(0, 12373));
procedure __VERIFIER_atomic_dec_b()
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 102, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 102, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 102, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 102, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.i32($i0, $i1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 102, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 103, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.0;
  ...
  assume {:sourceloc "./output/gcd-2_tmp.c", 103, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/gcd-2_tmp.c", 102, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/gcd-2_tmp.c", 104, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const dec_a: ref;
axiom (dec_a == $sub.ref(0, 13405));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 110, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 110, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/gcd-2_tmp.c", 110, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 110, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 110, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i1, $i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 110, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 112, 5} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/gcd-2_tmp.c", 115, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 122, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 122, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/gcd-2_tmp.c", 122, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 122, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 122, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i1, $i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 122, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 124, 5} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/gcd-2_tmp.c", 127, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i10: i32;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 132, 4} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 137, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/gcd-2_tmp.c", 140, 16} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.2, $p2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 140, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/gcd-2_tmp.c", 143, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 143, 3} true;
  assume {:verifier.code 0} true;
  $r := $i10;
  $exn := false;
  return;
...
procedure check_gcd($i0: i32, $i1: i32, $i2: i32)
{
  ...
  var $i19: i32;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 148, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/gcd-2_tmp.c", 149, 34} true;
  assume {:verifier.code 0} true;
  $i4 := $ugt.i32($i3, 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 149, 34} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/gcd-2_tmp.c", 149, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/gcd-2_tmp.c", 150, 27} true;
  assume {:verifier.code 0} true;
  $i6 := $urem.i32($i0, $i3);
  assume {:sourceloc "./output/gcd-2_tmp.c", 150, 39} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 150, 39} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/gcd-2_tmp.c", 153, 25} true;
  assume {:verifier.code 1} true;
  $i12 := $urem.i32($i0, $i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 153, 29} true;
  assume {:verifier.code 1} true;
  $i13 := $eq.i32($i12, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 153, 29} true;
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "./output/gcd-2_tmp.c", 153, 3} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/gcd-2_tmp.c", 156, 24} true;
  assume {:verifier.code 1} true;
  $i18 := $uge.i32($i2, $i3);
  assume {:sourceloc "./output/gcd-2_tmp.c", 156, 24} true;
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "./output/gcd-2_tmp.c", 156, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i19);
  assume {:sourceloc "./output/gcd-2_tmp.c", 157, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 19597));
procedure main()
  returns ($r: i32)
{
  var $i0: i32;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/gcd-2_tmp.c", 162, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/gcd-2_tmp.c", 165, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.i32($i0, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 165, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 165, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/gcd-2_tmp.c", 167, 25} true;
  assume {:verifier.code 0} true;
  call $i6 := start($i0, $i1);
...
axiom (__VERIFIER_assume == $sub.ref(0, 20629));
...
axiom (__SMACK_code == $sub.ref(0, 21661));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 22693));
...
axiom (__VERIFIER_error == $sub.ref(0, 23725));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 24757));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 25789));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 26821));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 27853));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 28885));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 29917));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 30949));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 31981));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 33013));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 34045));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 35077));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 36109));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 37141));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 38173));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 39205));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 40237));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 41269));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 42301));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 43333));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 44365));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 45397));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 46429));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 47461));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 48493));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 49525));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 50557));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 51589));
...
axiom (__SMACK_decls == $sub.ref(0, 52621));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 53653));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 54685));
...
axiom (llvm.dbg.value == $sub.ref(0, 55717));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 56749));
