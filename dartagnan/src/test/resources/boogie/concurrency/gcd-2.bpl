...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 57787));
...
const a: ref;
axiom (a == $sub.ref(0, 1028));
const b: ref;
axiom (b == $sub.ref(0, 2056));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 3094));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 4126));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 5153));
const {:count 14} .str.14: ref;
axiom (.str.14 == $sub.ref(0, 6191));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 7219));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 8251));
procedure reach_error()
{
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 2, 44} true;
...
axiom (assume_abort_if_not == $sub.ref(0, 9283));
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 5, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/gcd-2_tmp.c", 5, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/gcd-2_tmp.c", 5, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 10315));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 11347));
procedure abort();
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 12379));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 85, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 85, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 85, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 88, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/gcd-2_tmp.c", 85, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/gcd-2_tmp.c", 86, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/gcd-2_tmp.c", 86, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/gcd-2_tmp.c", 86, 27} true;
  assume {:verifier.code 0} true;
...
const __VERIFIER_atomic_dec_a: ref;
axiom (__VERIFIER_atomic_dec_a == $sub.ref(0, 13411));
procedure __VERIFIER_atomic_dec_a()
{
  var $i0: i32;
  var $i1: i32;
  var $i2: i1;
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 97, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 97, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 97, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 97, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.i32($i0, $i1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 97, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 98, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 98, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 98, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i3, $i4);
  assume {:sourceloc "./output/gcd-2_tmp.c", 98, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $i5;
  call {:cexpr "a"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/gcd-2_tmp.c", 98, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/gcd-2_tmp.c", 97, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/gcd-2_tmp.c", 99, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_dec_b: ref;
axiom (__VERIFIER_atomic_dec_b == $sub.ref(0, 14443));
procedure __VERIFIER_atomic_dec_b()
{
  var $i0: i32;
  var $i1: i32;
  var $i2: i1;
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 103, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 103, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 103, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 103, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.i32($i0, $i1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 103, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 104, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 104, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 104, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i3, $i4);
  assume {:sourceloc "./output/gcd-2_tmp.c", 104, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $i5;
  call {:cexpr "b"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/gcd-2_tmp.c", 104, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/gcd-2_tmp.c", 103, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/gcd-2_tmp.c", 105, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const dec_a: ref;
axiom (dec_a == $sub.ref(0, 15475));
procedure dec_a($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i32;
  var $i3: i1;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 111, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 111, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/gcd-2_tmp.c", 111, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 111, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 111, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i1, $i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 111, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 113, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_dec_a();
  assume {:sourceloc "./output/gcd-2_tmp.c", 111, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/gcd-2_tmp.c", 116, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const dec_b: ref;
axiom (dec_b == $sub.ref(0, 16507));
procedure dec_b($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i32;
  var $i3: i1;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 123, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 123, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/gcd-2_tmp.c", 123, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 123, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $M.1;
  assume {:sourceloc "./output/gcd-2_tmp.c", 123, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i1, $i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 123, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 125, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_dec_b();
  assume {:sourceloc "./output/gcd-2_tmp.c", 123, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/gcd-2_tmp.c", 128, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const start: ref;
axiom (start == $sub.ref(0, 17539));
procedure start($i0: i32, $i1: i32)
  returns ($r: i32)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i10: i32;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 133, 4} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(8, $zext.i32.i64(1)));
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(8, $zext.i32.i64(1)));
  call {:cexpr "start:arg:a_in"} boogie_si_record_i32($i0);
  call {:cexpr "start:arg:b_in"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 133, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $i0;
  call {:cexpr "a"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 134, 4} true;
  assume {:verifier.code 0} true;
  $M.1 := $i1;
  call {:cexpr "b"} boogie_si_record_i32($i1);
  assume true;
  assume true;
  assume {:sourceloc "./output/gcd-2_tmp.c", 138, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p2, $0.ref, dec_a, $0.ref);
  assume {:sourceloc "./output/gcd-2_tmp.c", 139, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p3, $0.ref, dec_b, $0.ref);
  assume {:sourceloc "./output/gcd-2_tmp.c", 141, 16} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.2, $p2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 141, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := __pthread_join($p6, $0.ref);
  assume {:sourceloc "./output/gcd-2_tmp.c", 142, 16} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.2, $p3);
  assume {:sourceloc "./output/gcd-2_tmp.c", 142, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := __pthread_join($p8, $0.ref);
  assume {:sourceloc "./output/gcd-2_tmp.c", 144, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $M.0;
  assume {:sourceloc "./output/gcd-2_tmp.c", 144, 3} true;
  assume {:verifier.code 0} true;
  $r := $i10;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 18571));
procedure pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __pthread_join: ref;
axiom (__pthread_join == $sub.ref(0, 19603));
procedure __pthread_join($p0: ref, $p1: ref)
  returns ($r: i32);
const check_gcd: ref;
axiom (check_gcd == $sub.ref(0, 20635));
procedure check_gcd($i0: i32, $i1: i32, $i2: i32)
{
  var $i3: i32;
  var $i4: i1;
  var $i5: i32;
  ...
  var $i19: i32;
$bb0:
  assume {:sourceloc "./output/gcd-2_tmp.c", 149, 24} true;
  assume {:verifier.code 0} true;
  call {:cexpr "check_gcd:arg:a_in"} boogie_si_record_i32($i0);
  call {:cexpr "check_gcd:arg:b_in"} boogie_si_record_i32($i1);
  call {:cexpr "check_gcd:arg:gcd"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 149, 24} true;
  assume {:verifier.code 0} true;
  call $i3 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i3);
  call {:cexpr "guessed_gcd"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/gcd-2_tmp.c", 150, 34} true;
  assume {:verifier.code 0} true;
  $i4 := $ugt.i32($i3, 1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 150, 34} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/gcd-2_tmp.c", 150, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/gcd-2_tmp.c", 151, 27} true;
  assume {:verifier.code 0} true;
  $i6 := $urem.i32($i0, $i3);
  assume {:sourceloc "./output/gcd-2_tmp.c", 151, 39} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 151, 39} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "./output/gcd-2_tmp.c", 151, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i8);
  assume {:sourceloc "./output/gcd-2_tmp.c", 152, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i1, $i3);
  assume {:sourceloc "./output/gcd-2_tmp.c", 152, 39} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 152, 39} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/gcd-2_tmp.c", 152, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "./output/gcd-2_tmp.c", 154, 25} true;
  assume {:verifier.code 1} true;
  $i12 := $urem.i32($i0, $i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 154, 29} true;
  assume {:verifier.code 1} true;
  $i13 := $eq.i32($i12, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 154, 29} true;
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "./output/gcd-2_tmp.c", 154, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i14);
  assume {:sourceloc "./output/gcd-2_tmp.c", 155, 25} true;
  assume {:verifier.code 1} true;
  $i15 := $urem.i32($i1, $i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 155, 29} true;
  assume {:verifier.code 1} true;
  $i16 := $eq.i32($i15, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 155, 29} true;
  assume {:verifier.code 1} true;
  $i17 := $zext.i1.i32($i16);
  assume {:sourceloc "./output/gcd-2_tmp.c", 155, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i17);
  assume {:sourceloc "./output/gcd-2_tmp.c", 157, 24} true;
  assume {:verifier.code 1} true;
  $i18 := $uge.i32($i2, $i3);
  assume {:sourceloc "./output/gcd-2_tmp.c", 157, 24} true;
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "./output/gcd-2_tmp.c", 157, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i19);
  assume {:sourceloc "./output/gcd-2_tmp.c", 158, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 21667));
procedure main()
  returns ($r: i32)
{
  var $i0: i32;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/gcd-2_tmp.c", 163, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/gcd-2_tmp.c", 163, 17} true;
  assume {:verifier.code 0} true;
  call $i0 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i0);
  call {:cexpr "a_in"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 164, 17} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i1);
  call {:cexpr "b_in"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 166, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.i32($i0, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 166, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/gcd-2_tmp.c", 166, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/gcd-2_tmp.c", 167, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $ugt.i32($i1, 0);
  assume {:sourceloc "./output/gcd-2_tmp.c", 167, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/gcd-2_tmp.c", 167, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/gcd-2_tmp.c", 168, 25} true;
  assume {:verifier.code 0} true;
  call $i6 := start($i0, $i1);
  assume {:sourceloc "./output/gcd-2_tmp.c", 168, 3} true;
  assume {:verifier.code 0} true;
  call check_gcd($i0, $i1, $i6);
  assume {:sourceloc "./output/gcd-2_tmp.c", 169, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 22699));
...
axiom (__SMACK_code == $sub.ref(0, 23731));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 24763));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 25795));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 26827));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 27859));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 28891));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 29923));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 30955));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 31987));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 33019));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 34051));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 35083));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 36115));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 37147));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 38179));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 39211));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 40243));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 41275));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 42307));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 43339));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 44371));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 45403));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 46435));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 47467));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 48499));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 49531));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 50563));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 51595));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 52627));
...
axiom (__SMACK_decls == $sub.ref(0, 53659));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 54691));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 55723));
...
axiom (llvm.dbg.value == $sub.ref(0, 56755));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 57787));
