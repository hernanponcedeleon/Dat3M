...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/race-2_2-container_of-O0.bpl /Users/ponce/git/Dat3M/./output/race-2_2-container_of_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 58827));
...
{
$bb0:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1681, 44} true;
...
procedure  ldv_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ldv_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1683, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1683, 88} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1683, 52} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1683, 62} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $p12: ref;
$bb0:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1697, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1697, 23} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1699, 92} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1699, 107} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($add.ref($0.ref, $mul.ref(0, 40)), $mul.ref(32, 1)))), 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1699, 72} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1700, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p6 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1700, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p6, 1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1701, 25} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p8 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1701, 32} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p8);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1701, 34} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i9, 1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1701, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p12 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1701, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p12, $i10);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1702, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (my_drv_probe == $sub.ref(0, 13419));
  ...
  returns ($r: i32)
{
  ...
  var $i14: i32;
$bb0:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1705, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1705, 28} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1706, 28} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1706, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_init($p2, $0.ref);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1707, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p5 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1707, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, 0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1708, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p7 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1708, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p7, 0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1709, 12} true;
  ...
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1710, 5} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1710, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i9 == 1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1711, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1712, 48} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1712, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create(t1, $0.ref, my_callback, $p10);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1713, 48} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1713, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_create(t2, $0.ref, my_callback, $p12);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1714, 2} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1716, 31} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1716, 2} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_mutex_destroy($p15);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1717, 2} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i32(0, 1);
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1718, 1} true;
  assume {:verifier.code 0} true;
  $r := $i14;
  $exn := false;
  return;
...
procedure  my_drv_disconnect($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1721, 15} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, t1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1721, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $p1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1722, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i64($M.0, t2);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1722, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $p1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1723, 31} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1723, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_destroy($p6);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1724, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 18579));
procedure  pthread_join($i0: i64, $p1: ref)
  returns ($r: i32);
const my_drv_init: ref;
axiom (my_drv_init == $sub.ref(0, 19611));
procedure  my_drv_init()
  returns ($r: i32)
{
$bb0:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1726, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1726, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
...
axiom (my_drv_cleanup == $sub.ref(0, 20643));
procedure  my_drv_cleanup()
{
$bb0:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1729, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1729, 2} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1732, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1733, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1733, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume true;
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1736, 15} true;
  assume {:verifier.code 0} true;
  call $i3 := my_drv_probe($p0);
  call {:cexpr "probe_ret"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1737, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1737, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1748, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1738, 4} true;
  assume {:verifier.code 0} true;
  call my_drv_disconnect($p0);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1739, 20} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p6 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1739, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1739, 28} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, 1);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1739, 28} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1739, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i9);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1740, 20} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p11 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1740, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p11);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1740, 28} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1740, 28} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1740, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i14);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1741, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1737, 6} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1742, 3} true;
  assume {:verifier.code 0} true;
  call my_drv_cleanup();
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1743, 8} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p16 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1743, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p16, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1744, 8} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p18 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1744, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p18, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1745, 19} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p20 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1745, 26} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, $p20);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1745, 27} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1745, 27} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1745, 3} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i23);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1746, 19} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p25 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1746, 26} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, $p25);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1746, 27} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.i32($i26, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1746, 27} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i1.i32($i27);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1746, 3} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i28);
  assume {:sourceloc "./output/race-2_2-container_of_tmp.c", 1747, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 22707));
...
axiom (__SMACK_code == $sub.ref(0, 23739));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 24771));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 25803));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 26835));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 27867));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 28899));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 29931));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 30963));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 31995));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 33027));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 34059));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 35091));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 36123));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 37155));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 38187));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 39219));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 40251));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 41283));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 42315));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 43347));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 44379));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 45411));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 46443));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 47475));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 48507));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 49539));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 50571));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 51603));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 52635));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 53667));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 54699));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 55731));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 56763));
...
axiom (llvm.dbg.value == $sub.ref(0, 57795));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 58827));
