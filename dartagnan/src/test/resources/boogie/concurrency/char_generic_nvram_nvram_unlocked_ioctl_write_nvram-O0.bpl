...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram-O0.bpl /Users/ponce/git/Dat3M/./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 108591));
...
const default_alloc_size: ref;
axiom (default_alloc_size == $sub.ref(0, 1028));
const nvram_fops: ref;
axiom (nvram_fops == $sub.ref(0, 2252));
const nvram_mutex: ref;
axiom (nvram_mutex == $sub.ref(0, 3284));
const nvram_len: ref;
axiom (nvram_len == $sub.ref(0, 4316));
const _whoop_init: ref;
axiom (_whoop_init == $sub.ref(0, 5348));
const .str: ref;
axiom (.str == $sub.ref(0, 6414));
const {:count 4} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 7442));
const nvram_dev: ref;
axiom (nvram_dev == $sub.ref(0, 8490));
const {:count 6} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 9520));
const _whoop_exit: ref;
axiom (_whoop_exit == $sub.ref(0, 10552));
const whoop_file_0: ref;
axiom (whoop_file_0 == $sub.ref(0, 11584));
const whoop_buf: ref;
axiom (whoop_buf == $sub.ref(0, 12616));
const whoop_int: ref;
axiom (whoop_int == $sub.ref(0, 13644));
const whoop_loff_t: ref;
axiom (whoop_loff_t == $sub.ref(0, 14676));
const whoop_file_1: ref;
axiom (whoop_file_1 == $sub.ref(0, 15708));
const whoop_file_2: ref;
axiom (whoop_file_2 == $sub.ref(0, 16740));
const whoop_file_3: ref;
axiom (whoop_file_3 == $sub.ref(0, 17772));
const whoop_inode_0: ref;
axiom (whoop_inode_0 == $sub.ref(0, 18804));
const whoop_inode_1: ref;
axiom (whoop_inode_1 == $sub.ref(0, 19836));
const whoop_inode_2: ref;
axiom (whoop_inode_2 == $sub.ref(0, 20868));
const whoop_inode_3: ref;
axiom (whoop_inode_3 == $sub.ref(0, 21900));
const whoop_inode_4: ref;
axiom (whoop_inode_4 == $sub.ref(0, 22932));
const whoop_file_4: ref;
axiom (whoop_file_4 == $sub.ref(0, 23964));
const whoop_pci_dev: ref;
axiom (whoop_pci_dev == $sub.ref(0, 24996));
const whoop_platform_device: ref;
axiom (whoop_platform_device == $sub.ref(0, 26028));
const whoop_vm_area_struct: ref;
axiom (whoop_vm_area_struct == $sub.ref(0, 27060));
const whoop_cx_dev: ref;
axiom (whoop_cx_dev == $sub.ref(0, 28092));
const whoop_poll_table: ref;
axiom (whoop_poll_table == $sub.ref(0, 29124));
const jiffies: ref;
axiom (jiffies == $sub.ref(0, 30156));
const {:count 14} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 31194));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 32226));
const {:count 3} .str.1.26: ref;
axiom (.str.1.26 == $sub.ref(0, 33253));
const {:count 14} .str.27: ref;
axiom (.str.27 == $sub.ref(0, 34291));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 35319));
const nvram_llseek: ref;
axiom (nvram_llseek == $sub.ref(0, 36351));
procedure  nvram_llseek($p0: ref, $i1: i64, $i2: i32)
  returns ($r: i64)
{
  var $i3: i1;
  var $i4: i1;
  ...
  var $i14: i64;
$bb0:
  call {:cexpr "nvram_llseek:arg:offset"} boogie_si_record_i64($i1);
  call {:cexpr "nvram_llseek:arg:origin"} boogie_si_record_i32($i2);
...
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6685, 19} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 56)), $mul.ref(32, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6685, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.0, $p8);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6685, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i64($i1, $i9);
  call {:cexpr "offset"} boogie_si_record_i64($i10);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6686, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $i10;
  goto $bb11;
$bb5:
...
$bb6:
  assume ($i5 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6688, 13} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i64($M.0, nvram_len);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6688, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i64($i1, $i11);
  call {:cexpr "offset"} boogie_si_record_i64($i12);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6689, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $i12;
  goto $bb11;
$bb7:
...
$bb9:
  assume ($i6 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6683, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $i1;
  goto $bb11;
$bb10:
...
$bb11:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6693, 13} true;
  assume {:verifier.code 0} true;
  $i13 := $slt.i64($i7, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6693, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb13, $bb14;
$bb12:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6692, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i64(0, 1);
  goto $bb11;
$bb13:
  assume ($i13 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6694, 3} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i64(0, 22);
  goto $bb15;
$bb14:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6695, 8} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 56)), $mul.ref(32, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6695, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p15, $i7);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6696, 26} true;
  assume {:verifier.code 1} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 56)), $mul.ref(32, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6696, 26} true;
  assume {:verifier.code 1} true;
  $i17 := $load.i64($M.0, $p16);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6696, 32} true;
  assume {:verifier.code 1} true;
  $i18 := $eq.i64($i17, $i7);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6696, 32} true;
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6696, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i19);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6697, 15} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p0, $mul.ref(0, 56)), $mul.ref(32, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6697, 15} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i64($M.0, $p20);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6697, 2} true;
  assume {:verifier.code 0} true;
  $i14 := $i21;
  goto $bb15;
$bb15:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6698, 1} true;
  assume {:verifier.code 0} true;
  $r := $i14;
  $exn := false;
  return;
}
const read_nvram: ref;
axiom (read_nvram == $sub.ref(0, 37383));
procedure  read_nvram($p0: ref, $p1: ref, $i2: i32, $p3: ref)
  returns ($r: i64)
{
  var $i4: i64;
  var $i5: i32;
  ...
  var $i7: i64;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6704, 25} true;
  assume {:verifier.code 0} true;
  call {:cexpr "read_nvram:arg:count"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6704, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6704, 7} true;
  assume {:verifier.code 0} true;
  call $i5 := access_ok(1, $p1, $i4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6704, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6704, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6706, 6} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6706, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.0, nvram_len);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6706, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $sge.i64($i8, $i9);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6706, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6705, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i64(0, 14);
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6714, 1} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
$bb4:
  assume ($i10 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6707, 3} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  goto $bb3;
$bb5:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 7} true;
  assume {:verifier.code 0} true;
  $i13, $i14, $p15 := $i2, $i12, $p1;
  goto $bb6;
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  ...
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 24} true;
  assume {:verifier.code 0} true;
  $i16 := $ugt.i32($i13, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 28} true;
  assume {:verifier.code 0} true;
  $i17 := 0;
...
$bb7:
  assume ($i16 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 31} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i32.i64($i14);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 35} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i64($M.0, nvram_len);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 33} true;
  assume {:verifier.code 0} true;
  $i20 := $slt.i64($i18, $i19);
  assume {:verifier.code 0} true;
  $i17 := $i20;
...
$bb9:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i17 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6709, 18} true;
  assume {:verifier.code 0} true;
  call $i21 := nvram_read_byte($i14);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6709, 18} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i8.i32($i21);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6709, 7} true;
  assume {:verifier.code 0} true;
  call $i23 := __put_user($i22, $p15);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6709, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i23, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6709, 7} true;
...
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6711, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i32.i64($i14);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6711, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p3, $i28);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6712, 20} true;
  assume {:verifier.code 1} true;
  $i29 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6712, 29} true;
  assume {:verifier.code 1} true;
  $i30 := $zext.i32.i64($i14);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6712, 26} true;
  assume {:verifier.code 1} true;
  $i31 := $eq.i64($i29, $i30);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6712, 26} true;
  assume {:verifier.code 1} true;
  $i32 := $zext.i1.i32($i31);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6712, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i32);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6713, 11} true;
  assume {:verifier.code 0} true;
  $i33 := $p2i.ref.i64($p15);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6713, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i35 := $sub.i64($i33, $i34);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6713, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $i35;
  goto $bb3;
$bb12:
  assume ($i24 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6710, 4} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i64(0, 14);
  goto $bb3;
$bb13:
  assume !(($i24 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6709, 39} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 46} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i14, 1);
  call {:cexpr "i"} boogie_si_record_i32($i25);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 51} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p15, $mul.ref(1, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 56} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i13, $sub.i32(0, 1));
  call {:cexpr "count"} boogie_si_record_i32($i27);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6708, 2} true;
  assume {:verifier.code 0} true;
  $i13, $i14, $p15 := $i27, $i25, $p26;
  goto $bb6;
}
const write_nvram: ref;
axiom (write_nvram == $sub.ref(0, 38415));
procedure  write_nvram($p0: ref, $p1: ref, $i2: i32, $p3: ref)
  returns ($r: i64)
{
  var $i4: i8;
  var $i5: i64;
  ...
  var $i8: i64;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6720, 11} true;
  assume {:verifier.code 1} true;
  call {:cexpr "write_nvram:arg:count"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6720, 11} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_i8($i4);
  call {:cexpr "c"} boogie_si_record_i8($i4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6721, 25} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i32.i64($i2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6721, 7} true;
  assume {:verifier.code 0} true;
  call $i6 := access_ok(0, $p1, $i5);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6721, 7} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6721, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6723, 6} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6723, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i64($M.0, nvram_len);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6723, 12} true;
  assume {:verifier.code 0} true;
  $i11 := $sge.i64($i9, $i10);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6723, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6722, 3} true;
  assume {:verifier.code 0} true;
  $i8 := $sub.i64(0, 14);
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6733, 1} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $exn := false;
  return;
$bb4:
  assume ($i11 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6724, 3} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  goto $bb3;
$bb5:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 7} true;
  assume {:verifier.code 0} true;
  $i14, $i15, $p16 := $i2, $i13, $p1;
  goto $bb6;
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  ...
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 24} true;
  assume {:verifier.code 0} true;
  $i17 := $ugt.i32($i14, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 28} true;
  assume {:verifier.code 0} true;
  $i18 := 0;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 31} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i32.i64($i15);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 35} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i64($M.0, nvram_len);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 33} true;
  assume {:verifier.code 0} true;
  $i21 := $slt.i64($i19, $i20);
  assume {:verifier.code 0} true;
  $i18 := $i21;
...
$bb9:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i18 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6726, 18} true;
  assume {:verifier.code 0} true;
  $i22 := $sext.i8.i32($i4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6726, 7} true;
  assume {:verifier.code 0} true;
  call $i23 := __get_user($i22, $p16);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6726, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i23, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6726, 7} true;
...
$bb11:
  assume !(($i18 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6730, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i32.i64($i15);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6730, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p3, $i28);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6731, 20} true;
  assume {:verifier.code 1} true;
  $i29 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6731, 29} true;
  assume {:verifier.code 1} true;
  $i30 := $zext.i32.i64($i15);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6731, 26} true;
  assume {:verifier.code 1} true;
  $i31 := $eq.i64($i29, $i30);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6731, 26} true;
  assume {:verifier.code 1} true;
  $i32 := $zext.i1.i32($i31);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6731, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i32);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6732, 11} true;
  assume {:verifier.code 0} true;
  $i33 := $p2i.ref.i64($p16);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6732, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i35 := $sub.i64($i33, $i34);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6732, 2} true;
  assume {:verifier.code 0} true;
  $i8 := $i35;
  goto $bb3;
$bb12:
  assume ($i24 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6727, 4} true;
  assume {:verifier.code 0} true;
  $i8 := $sub.i64(0, 14);
  goto $bb3;
$bb13:
  assume !(($i24 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6728, 3} true;
  assume {:verifier.code 0} true;
  call nvram_write_byte($i4, $i15);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6729, 2} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 46} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i15, 1);
  call {:cexpr "i"} boogie_si_record_i32($i25);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 51} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p16, $mul.ref(1, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 56} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i14, $sub.i32(0, 1));
  call {:cexpr "count"} boogie_si_record_i32($i27);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6725, 2} true;
  assume {:verifier.code 0} true;
  $i14, $i15, $p16 := $i27, $i25, $p26;
  goto $bb6;
}
const nvram_unlocked_ioctl: ref;
axiom (nvram_unlocked_ioctl == $sub.ref(0, 39447));
procedure  nvram_unlocked_ioctl($p0: ref, $i1: i32, $i2: i64)
  returns ($r: i64)
{
  var $i3: i32;
  var $i4: i64;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6748, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "nvram_unlocked_ioctl:arg:cmd"} boogie_si_record_i32($i1);
  call {:cexpr "nvram_unlocked_ioctl:arg:arg"} boogie_si_record_i64($i2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6748, 2} true;
  assume {:verifier.code 0} true;
  call mutex_lock(nvram_mutex);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6749, 8} true;
  assume {:verifier.code 0} true;
  call $i3 := nvram_ioctl($p0, $i1, $i2);
  call {:cexpr "ret"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6750, 2} true;
  assume {:verifier.code 0} true;
  call mutex_unlock(nvram_mutex);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6751, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6751, 2} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 40479));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const mutex_lock: ref;
axiom (mutex_lock == $sub.ref(0, 41511));
procedure  mutex_lock($p0: ref)
{
  ...
  var $p5: ref;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 432, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 432, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 433, 29} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 433, 29} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 433, 36} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 433, 36} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 433, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 434, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 434, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 435, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 436, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const nvram_ioctl: ref;
axiom (nvram_ioctl == $sub.ref(0, 42543));
procedure  nvram_ioctl($p0: ref, $i1: i32, $i2: i64)
  returns ($r: i32)
{
  var $i3: i1;
  var $i4: i32;
$bb0:
  call {:cexpr "nvram_ioctl:arg:cmd"} boogie_si_record_i32($i1);
  call {:cexpr "nvram_ioctl:arg:arg"} boogie_si_record_i64($i2);
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6738, 3} true;
  assume {:verifier.code 0} true;
  call nvram_sync();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6739, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  ...
  goto $bb5;
$bb4:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6743, 2} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb6;
$bb5:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6741, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, 22);
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6744, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
axiom (mutex_unlock == $sub.ref(0, 43575));
procedure  mutex_unlock($p0: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 450, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 450, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 451, 9} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 451, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 452, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 453, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const nvram_sync: ref;
axiom (nvram_sync == $sub.ref(0, 44607));
procedure  nvram_sync()
{
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6627, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6627, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
axiom (assume_abort_if_not == $sub.ref(0, 45639));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 160, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 160, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 160, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 161, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 160, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 160, 14} true;
  assume {:verifier.code 0} true;
...
const abort: ref;
axiom (abort == $sub.ref(0, 46671));
procedure  abort();
const access_ok: ref;
axiom (access_ok == $sub.ref(0, 47703));
procedure  access_ok($i0: i32, $p1: ref, $i2: i64)
  returns ($r: i32)
{
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6538, 10} true;
  assume {:verifier.code 1} true;
  call {:cexpr "access_ok:arg:arg0"} boogie_si_record_i32($i0);
  call {:cexpr "access_ok:arg:arg2"} boogie_si_record_i64($i2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6538, 10} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6538, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
}
const __get_user: ref;
axiom (__get_user == $sub.ref(0, 48735));
procedure  __get_user($i0: i32, $p1: ref)
  returns ($r: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6522, 10} true;
  assume {:verifier.code 1} true;
  call {:cexpr "__get_user:arg:arg0"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6522, 10} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6522, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
}
const nvram_write_byte: ref;
axiom (nvram_write_byte == $sub.ref(0, 49767));
procedure  nvram_write_byte($i0: i8, $i1: i32)
{
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6630, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "nvram_write_byte:arg:arg0"} boogie_si_record_i8($i0);
  call {:cexpr "nvram_write_byte:arg:arg1"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6630, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
...
axiom (__VERIFIER_assert == $sub.ref(0, 50799));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 163, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 163, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 163, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 166, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 163, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 164, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 164, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 164, 27} true;
  assume {:verifier.code 0} true;
...
axiom (reach_error == $sub.ref(0, 51831));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 157, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 157, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
const nvram_read_byte: ref;
axiom (nvram_read_byte == $sub.ref(0, 52863));
procedure  nvram_read_byte($i0: i32)
  returns ($r: i8)
{
  var $i1: i8;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6624, 10} true;
  assume {:verifier.code 1} true;
  call {:cexpr "nvram_read_byte:arg:arg0"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6624, 10} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_uchar();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uchar"} boogie_si_record_i8($i1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6624, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
}
const __put_user: ref;
axiom (__put_user == $sub.ref(0, 53895));
procedure  __put_user($i0: i32, $p1: ref)
  returns ($r: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6530, 10} true;
  assume {:verifier.code 1} true;
  call {:cexpr "__put_user:arg:arg0"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6530, 10} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6530, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
}
const nvram_init: ref;
axiom (nvram_init == $sub.ref(0, 54927));
procedure  nvram_init()
  returns ($r: i32)
{
  var $i0: i32;
  var $i1: i32;
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6768, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6768, 2} true;
  assume {:verifier.code 0} true;
  call $i0 := printk.ref.ref(.str, .str.1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6770, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := misc_register(nvram_dev);
  call {:cexpr "ret"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6771, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6771, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6772, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6773, 14} true;
  assume {:verifier.code 0} true;
  call $i3 := nvram_get_size();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6773, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, nvram_len, $i3);
  call {:cexpr "nvram_len"} boogie_si_record_i64($i3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6774, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i64($M.0, nvram_len);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6774, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i64($i4, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6774, 6} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6777, 2} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6775, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, nvram_len, 8192);
  call {:cexpr "nvram_len"} boogie_si_record_i64(8192);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6775, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6774, 6} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6774, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const printk: ref;
axiom (printk == $sub.ref(0, 55959));
procedure  printk.ref.ref($p0: ref, p.1: ref)
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6638, 10} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6638, 10} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6638, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
axiom (misc_register == $sub.ref(0, 56991));
procedure  misc_register($p0: ref)
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6612, 10} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6612, 10} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6612, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
}
const nvram_get_size: ref;
axiom (nvram_get_size == $sub.ref(0, 58023));
procedure  nvram_get_size()
  returns ($r: i64)
{
  var $i0: i64;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6620, 10} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6620, 10} true;
  assume {:verifier.code 1} true;
  call $i0 := __VERIFIER_nondet_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long"} boogie_si_record_i64($i0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6620, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
}
const nvram_cleanup: ref;
axiom (nvram_cleanup == $sub.ref(0, 59055));
procedure  nvram_cleanup()
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6781, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6781, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := misc_deregister(nvram_dev);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6782, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const misc_deregister: ref;
axiom (misc_deregister == $sub.ref(0, 60087));
procedure  misc_deregister($p0: ref)
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6608, 10} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6608, 10} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6608, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
const malloc: ref;
axiom (malloc == $sub.ref(0, 61119));
procedure  malloc($i0: i32)
  returns ($r: ref)
{
  call $r := $malloc($zext.i32.i64($i0));
}
const whoop_wrapper_write_nvram: ref;
axiom (whoop_wrapper_write_nvram == $sub.ref(0, 62151));
procedure  whoop_wrapper_write_nvram($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
  ...
  var $i5: i64;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6805, 14} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6805, 14} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, whoop_file_0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6805, 28} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, whoop_buf);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6805, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, whoop_int);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6805, 50} true;
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.0, whoop_loff_t);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6805, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := write_nvram($p1, $p2, $i3, $p4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6806, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
}
const whoop_wrapper_nvram_unlocked_ioctl: ref;
axiom (whoop_wrapper_nvram_unlocked_ioctl == $sub.ref(0, 63183));
procedure  whoop_wrapper_nvram_unlocked_ioctl($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $i2: i32;
  ...
  var $i5: i64;
$bb0:
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6815, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6815, 23} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, whoop_file_2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6815, 37} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, whoop_int);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6815, 48} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, whoop_int);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6815, 48} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6815, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := nvram_unlocked_ioctl($p1, $i2, $i4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6816, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6830, 35} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $p2 := malloc(280);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6830, 18} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6830, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_inode_0, $p2);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6831, 33} true;
  assume {:verifier.code 0} true;
  call $p4 := malloc(56);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6831, 17} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6831, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_file_0, $p4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6832, 35} true;
  assume {:verifier.code 0} true;
  call $p6 := malloc(280);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6832, 18} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p6);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6832, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_inode_1, $p6);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6833, 33} true;
  assume {:verifier.code 0} true;
  call $p8 := malloc(56);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6833, 17} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p8);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6833, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_file_1, $p8);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6834, 35} true;
  assume {:verifier.code 0} true;
  call $p10 := malloc(280);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6834, 18} true;
  assume {:verifier.code 0} true;
  $p11 := $bitcast.ref.ref($p10);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6834, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_inode_2, $p10);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6835, 33} true;
  assume {:verifier.code 0} true;
  call $p12 := malloc(56);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6835, 17} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6835, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_file_2, $p12);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6836, 35} true;
  assume {:verifier.code 0} true;
  call $p14 := malloc(280);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6836, 18} true;
  assume {:verifier.code 0} true;
  $p15 := $bitcast.ref.ref($p14);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6836, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_inode_3, $p14);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6837, 33} true;
  assume {:verifier.code 0} true;
  call $p16 := malloc(56);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6837, 17} true;
  assume {:verifier.code 0} true;
  $p17 := $bitcast.ref.ref($p16);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6837, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_file_3, $p16);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6838, 35} true;
  assume {:verifier.code 0} true;
  call $p18 := malloc(280);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6838, 18} true;
  assume {:verifier.code 0} true;
  $p19 := $bitcast.ref.ref($p18);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6838, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_inode_4, $p18);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6839, 33} true;
  assume {:verifier.code 0} true;
  call $p20 := malloc(56);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6839, 17} true;
  assume {:verifier.code 0} true;
  $p21 := $bitcast.ref.ref($p20);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6839, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_file_4, $p20);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6840, 37} true;
  assume {:verifier.code 0} true;
  call $p22 := malloc(520);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6840, 18} true;
  assume {:verifier.code 0} true;
  $p23 := $bitcast.ref.ref($p22);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6840, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_pci_dev, $p22);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6841, 23} true;
  assume {:verifier.code 0} true;
  call $p24 := malloc(1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6841, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_buf, $p24);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6842, 53} true;
  assume {:verifier.code 0} true;
  call $p25 := malloc(176);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6842, 26} true;
  assume {:verifier.code 0} true;
  $p26 := $bitcast.ref.ref($p25);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6842, 24} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_platform_device, $p25);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6843, 51} true;
  assume {:verifier.code 0} true;
  call $p27 := malloc(32);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6843, 25} true;
  assume {:verifier.code 0} true;
  $p28 := $bitcast.ref.ref($p27);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6843, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_vm_area_struct, $p27);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6844, 35} true;
  assume {:verifier.code 0} true;
  call $p29 := malloc(160);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6844, 17} true;
  assume {:verifier.code 0} true;
  $p30 := $bitcast.ref.ref($p29);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6844, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_cx_dev, $p29);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6845, 36} true;
  assume {:verifier.code 0} true;
  call $p31 := malloc(4);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6845, 21} true;
  assume {:verifier.code 0} true;
  $p32 := $bitcast.ref.ref($p31);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6845, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_poll_table, $p31);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6846, 28} true;
  assume {:verifier.code 0} true;
  call $p33 := malloc(8);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6846, 17} true;
  assume {:verifier.code 0} true;
  $p34 := $bitcast.ref.ref($p33);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6846, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, whoop_loff_t, $p33);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6847, 14} true;
  assume {:verifier.code 1} true;
  call $i35 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i35);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6847, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, whoop_int, $i35);
  call {:cexpr "whoop_int"} boogie_si_record_i32($i35);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6848, 22} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i32($M.0, whoop_int);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6848, 32} true;
  assume {:verifier.code 0} true;
  $i37 := $sge.i32($i36, 0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6848, 32} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i32($i37);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6848, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i38);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6849, 27} true;
  assume {:verifier.code 0} true;
  $p39 := $load.ref($M.0, _whoop_init);
  call $i40 := devirtbounce($p39);
  call {:cexpr "_whoop_init_result"} boogie_si_record_i32($i40);
  assume true;
  assume true;
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6852, 2} true;
  assume {:verifier.code 0} true;
  call $i41 := pthread_create($p0, $0.ref, whoop_wrapper_write_nvram, $0.ref);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6853, 2} true;
  assume {:verifier.code 0} true;
  call $i42 := pthread_create($p1, $0.ref, whoop_wrapper_nvram_unlocked_ioctl, $0.ref);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6854, 15} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, $p0);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6854, 2} true;
  assume {:verifier.code 0} true;
  call $i44 := pthread_join($i43, $0.ref);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6855, 15} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i32($M.0, $p1);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6855, 2} true;
  assume {:verifier.code 0} true;
  call $i46 := pthread_join($i45, $0.ref);
  assume {:sourceloc "./output/char_generic_nvram_nvram_unlocked_ioctl_write_nvram_tmp.c", 6856, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 68343));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 69375));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 70407));
...
axiom (__VERIFIER_nondet_char == $sub.ref(0, 71439));
  ...
  returns ($r: i8)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 67, 12} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 67, 12} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 68, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $sext.i8.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 68, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, $sub.i32(0, 128));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 68, 36} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 68, 39} true;
  assume {:verifier.code 1} true;
  $i4 := $sext.i8.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 68, 41} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 127);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 69, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_char == $sub.ref(0, 72471));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 73503));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __VERIFIER_nondet_unsigned_char: ref;
axiom (__VERIFIER_nondet_unsigned_char == $sub.ref(0, 74535));
  ...
  returns ($r: i8)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 79, 21} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 79, 21} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i8($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 80, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i8.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 80, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 80, 28} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 80, 31} true;
  assume {:verifier.code 1} true;
  $i4 := $zext.i8.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 80, 33} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 255);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i6);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 81, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 75567));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 76599));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 77631));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 78663));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 79695));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 80727));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 81759));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 82791));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 83823));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 84855));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 85887));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __VERIFIER_nondet_long: ref;
axiom (__VERIFIER_nondet_long == $sub.ref(0, 86919));
...
axiom (__SMACK_nondet_long == $sub.ref(0, 87951));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 88983));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 90015));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 91047));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 92079));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 93111));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 94143));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 95175));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 96207));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 97239));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 98271));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 99303));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_uchar: ref;
axiom (__VERIFIER_nondet_uchar == $sub.ref(0, 100335));
procedure  __VERIFIER_nondet_uchar()
  returns ($r: i8)
{
  var $i0: i8;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 237, 21} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 237, 21} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i8($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 238, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_decls == $sub.ref(0, 101367));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 102399));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 103431));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 104463));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 105495));
...
axiom (llvm.dbg.value == $sub.ref(0, 106527));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 107559));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, default_alloc_size, 4);
  call {:cexpr "default_alloc_size"} boogie_si_record_i32(4);
  $M.0 := $store.ref($M.0, nvram_fops, $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(8, 1)), nvram_llseek);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(16, 1)), read_nvram);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(24, 1)), write_nvram);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(32, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(40, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(48, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(56, 1)), nvram_unlocked_ioctl);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(64, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(72, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(80, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(88, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(96, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(104, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(112, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(120, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(128, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(136, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(144, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(152, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(160, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(168, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(176, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(184, 1)), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_fops, $mul.ref(0, 200)), $mul.ref(192, 1)), $0.ref);
  $M.0 := $store.i32($M.0, nvram_mutex, 1);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(nvram_mutex, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i64($M.0, nvram_len, 0);
  call {:cexpr "nvram_len"} boogie_si_record_i64(0);
  $M.0 := $store.ref($M.0, _whoop_init, nvram_init);
  $M.0 := $store.i32($M.0, nvram_dev, 144);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_dev, $mul.ref(0, 24)), $mul.ref(8, 1)), .str.2);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(nvram_dev, $mul.ref(0, 24)), $mul.ref(16, 1)), nvram_fops);
  $M.0 := $store.ref($M.0, _whoop_exit, nvram_cleanup);
  $M.0 := $store.ref($M.0, whoop_file_0, $0.ref);
  $M.0 := $store.ref($M.0, whoop_buf, $0.ref);
  $M.0 := $store.i32($M.0, whoop_int, 0);
  call {:cexpr "whoop_int"} boogie_si_record_i32(0);
  $M.0 := $store.ref($M.0, whoop_loff_t, $0.ref);
  $M.0 := $store.ref($M.0, whoop_file_1, $0.ref);
  $M.0 := $store.ref($M.0, whoop_file_2, $0.ref);
  $M.0 := $store.ref($M.0, whoop_file_3, $0.ref);
  $M.0 := $store.ref($M.0, whoop_inode_0, $0.ref);
  $M.0 := $store.ref($M.0, whoop_inode_1, $0.ref);
  $M.0 := $store.ref($M.0, whoop_inode_2, $0.ref);
  $M.0 := $store.ref($M.0, whoop_inode_3, $0.ref);
  $M.0 := $store.ref($M.0, whoop_inode_4, $0.ref);
  $M.0 := $store.ref($M.0, whoop_file_4, $0.ref);
  $M.0 := $store.ref($M.0, whoop_pci_dev, $0.ref);
  $M.0 := $store.ref($M.0, whoop_platform_device, $0.ref);
  $M.0 := $store.ref($M.0, whoop_vm_area_struct, $0.ref);
  $M.0 := $store.ref($M.0, whoop_cx_dev, $0.ref);
  $M.0 := $store.ref($M.0, whoop_poll_table, $0.ref);
  $M.0 := $store.i64($M.0, jiffies, 0);
  call {:cexpr "jiffies"} boogie_si_record_i64(0);
  $M.0 := $store.ref($M.0, env_value_str, .str.1.26);
...
axiom (devirtbounce == $sub.ref(0, 108591));
