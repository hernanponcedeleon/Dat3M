...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/45_monabsex1_vs-O0.bpl /Users/ponce/git/Dat3M/./output/45_monabsex1_vs_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 3, 44} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 678, 10} true;
  ...
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 680, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, s, 4);
  call {:cexpr "s"} boogie_si_record_i32(4);
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 681, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, s);
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 681, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 4);
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 681, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 682, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 681, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 681, 28} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 681, 42} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 681, 42} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 686, 7} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 686, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, s, $i3);
  call {:cexpr "s"} boogie_si_record_i32($i3);
  assume true;
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 689, 1} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 691, 1} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 693, 1} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thr1, $0.ref);
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 694, 8} true;
  assume {:verifier.code 0} true;
  $i7 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 694, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $slt.i32($i7, 3);
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 694, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 694, 32} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 695, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/45_monabsex1_vs_tmp.c", 694, 26} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i7, 1);
...
axiom (pthread_create == $sub.ref(0, 12383));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 13415));
...
axiom (__SMACK_code == $sub.ref(0, 14447));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 15479));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 16511));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 17543));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 18575));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 19607));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 20639));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 21671));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 22703));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 23735));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 24767));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 25799));
