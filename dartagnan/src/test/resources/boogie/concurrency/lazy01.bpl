...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 51649));
...
const data: ref;
axiom (data == $sub.ref(0, 1028));
const mutex: ref;
axiom (mutex == $sub.ref(0, 2116));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 3148));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 4175));
const {:count 14} .str.14: ref;
axiom (.str.14 == $sub.ref(0, 5213));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 6241));
const thread1: ref;
axiom (thread1 == $sub.ref(0, 7273));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/lazy01_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lazy01_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "./output/lazy01_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $i3;
  call {:cexpr "data"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/lazy01_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 8305));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_mutex_lock: ref;
axiom (pthread_mutex_lock == $sub.ref(0, 9337));
procedure pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 10369));
procedure pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const thread2: ref;
axiom (thread2 == $sub.ref(0, 11401));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/lazy01_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lazy01_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "./output/lazy01_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $i3;
  call {:cexpr "data"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/lazy01_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/lazy01_tmp.c", 29, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lazy01_tmp.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 30, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "./output/lazy01_tmp.c", 30, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $sge.i32($i2, 3);
  assume {:sourceloc "./output/lazy01_tmp.c", 30, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/lazy01_tmp.c", 30, 17} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/lazy01_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume {:sourceloc "./output/lazy01_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/lazy01_tmp.c", 41, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume true;
  assume {:sourceloc "./output/lazy01_tmp.c", 45, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread1, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 46, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 47, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread3, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 49, 16} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.1, $p0);
  assume {:sourceloc "./output/lazy01_tmp.c", 49, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := __pthread_join($p7, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 50, 16} true;
  assume {:verifier.code 0} true;
  $p9 := $load.ref($M.1, $p1);
  assume {:sourceloc "./output/lazy01_tmp.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := __pthread_join($p9, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 51, 16} true;
  assume {:verifier.code 0} true;
  $p11 := $load.ref($M.1, $p2);
  assume {:sourceloc "./output/lazy01_tmp.c", 51, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := __pthread_join($p11, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 53, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__pthread_join == $sub.ref(0, 16561));
procedure __pthread_join($p0: ref, $p1: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 17593));
...
axiom (__SMACK_code == $sub.ref(0, 18625));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 19657));
...
axiom (__VERIFIER_error == $sub.ref(0, 20689));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 21721));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 22753));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 23785));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 24817));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 25849));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 26881));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 27913));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 28945));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 29977));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 31009));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 32041));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 33073));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 34105));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 35137));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 36169));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 37201));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 38233));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 39265));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 40297));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 41329));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 42361));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 43393));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 44425));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 45457));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 46489));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 47521));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 48553));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 49585));
...
axiom (llvm.dbg.value == $sub.ref(0, 50617));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 51649));
procedure __SMACK_static_init()
{
$bb0:
  $M.0 := 0;
  call {:cexpr "data"} boogie_si_record_i32(0);
