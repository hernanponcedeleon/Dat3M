...
{
$bb0:
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 7, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 7, 20} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 8, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 8, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 8, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 8, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 121, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 121, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 122, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 122, 23} true;
  assume {:verifier.code 0} true;
  $M.1 := $i1;
  ...
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 124, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 125, 5} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 129, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 130, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 130, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 130, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 132, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 139, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 139, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 140, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 140, 23} true;
  assume {:verifier.code 0} true;
  $M.4 := $i1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 142, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 143, 5} true;
  assume {:verifier.code 0} true;
  $M.5 := 1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 147, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 148, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 148, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 148, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 150, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 157, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 157, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 158, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.5;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 158, 23} true;
  assume {:verifier.code 0} true;
  $M.6 := $i1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 160, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 161, 5} true;
  assume {:verifier.code 0} true;
  $M.7 := 1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 165, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 166, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 166, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 166, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 168, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 175, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 175, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 176, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.7;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 176, 23} true;
  assume {:verifier.code 0} true;
  $M.8 := $i1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 178, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 179, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 183, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 184, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 184, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 184, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 186, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 215, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 217, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 219, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 222, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 223, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $M.3;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 223, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 223, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 223, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 225, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $M.9;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 225, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 228, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $M.1;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 43} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 48} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 51} true;
  assume {:verifier.code 0} true;
  $i17 := $M.4;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 71} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 76} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i1($i16, 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 232, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 235, 21} true;
  assume {:verifier.code 1} true;
  $i25 := $M.10;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 235, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 236, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i18 == 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 79} true;
  assume {:verifier.code 0} true;
  $i19 := $M.6;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 99} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 104} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb6:
  assume ($i20 == 1);
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 107} true;
  assume {:verifier.code 0} true;
  $i21 := $M.8;
  assume {:sourceloc "./output/thin002_pso.opt_tmp.c", 231, 127} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, 1);
  assume {:verifier.code 0} true;
  $i16 := $i22;
