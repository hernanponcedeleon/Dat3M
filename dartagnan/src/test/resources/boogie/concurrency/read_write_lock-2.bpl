...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54683));
...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 6, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 6, 20} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
procedure __VERIFIER_atomic_take_write_lock()
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 22, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 22, 23} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 22, 24} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 22, 28} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 22, 31} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 22, 32} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:verifier.code 0} true;
  $i2 := $i4;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 22, 28} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "w"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure __VERIFIER_atomic_take_read_lock()
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 27, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 27, 23} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 27, 24} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 27, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 28, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 28, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := $i4;
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 29, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const writer: ref;
axiom (writer == $sub.ref(0, 16499));
procedure writer($p0: ref)
  returns ($r: ref)
{
$bb0:
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 32, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 32, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_take_write_lock();
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $M.2 := 3;
  call {:cexpr "x"} boogie_si_record_i32(3);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 34, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 0;
  call {:cexpr "w"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 40, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 40, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_take_read_lock();
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 41, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  call {:cexpr "l"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 42, 5} true;
  assume {:verifier.code 0} true;
  $M.3 := $i1;
  call {:cexpr "y"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 43, 3} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 44, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $M.1;
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 44, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32($i5, 1);
  call {:cexpr "l"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 45, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := $i6;
  call {:cexpr "r"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 46, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 51, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 52, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, reader, $0.ref);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 53, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, writer, $0.ref);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 54, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, reader, $0.ref);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 55, 16} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.4, $p0);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 55, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := __pthread_join($p8, $0.ref);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 56, 16} true;
  assume {:verifier.code 0} true;
  $p10 := $load.ref($M.4, $p1);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 56, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := __pthread_join($p10, $0.ref);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 57, 16} true;
  assume {:verifier.code 0} true;
  $p12 := $load.ref($M.4, $p2);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 57, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := __pthread_join($p12, $0.ref);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 58, 16} true;
  assume {:verifier.code 0} true;
  $p14 := $load.ref($M.4, $p3);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 58, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := __pthread_join($p14, $0.ref);
  assume {:sourceloc "./output/read_write_lock-2_tmp.c", 59, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 22691));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 23723));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 24755));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 25787));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 26819));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 27851));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 28883));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 29915));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 30947));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 31979));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 33011));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 34043));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 35075));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 36107));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 37139));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 38171));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 39203));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 40235));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 41267));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 42299));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 43331));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 44363));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 45395));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 46427));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 47459));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 48491));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 49523));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 50555));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 51587));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 52619));
...
axiom (llvm.dbg.value == $sub.ref(0, 53651));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54683));
