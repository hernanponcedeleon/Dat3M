...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 7, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 7, 91} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 7, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 7, 68} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 93, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 93, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 94, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 95, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 96, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 97, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 98, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 102, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 102, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 102, 20} true;
  assume {:verifier.code 0} true;
  $M.2 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 103, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 111, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 111, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 112, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := 2;
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 113, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 117, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 117, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 117, 20} true;
  assume {:verifier.code 0} true;
  $M.2 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 118, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 126, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 126, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 127, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 127, 23} true;
  assume {:verifier.code 0} true;
  $M.3 := $i1;
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 128, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 129, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 130, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 130, 23} true;
  assume {:verifier.code 0} true;
  $M.4 := $i2;
  call {:cexpr "__unbuffered_p2_EBX"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 131, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 135, 22} true;
  assume {:verifier.code 0} true;
  $i3 := $M.2;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 135, 39} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 135, 20} true;
  assume {:verifier.code 0} true;
  $M.2 := $i4;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 136, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 166, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 168, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 170, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 171, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 172, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $M.2;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 172, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 172, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 172, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 173, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 174, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $M.5;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 174, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 23} true;
  assume {:verifier.code 0} true;
  $i12 := $M.1;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 30} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 33} true;
  assume {:verifier.code 0} true;
  $i15 := $M.3;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 53} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i15, 2);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 58} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 21} true;
  assume {:verifier.code 0} true;
  $i19 := $xor.i1($i14, 1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 181, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 184, 21} true;
  assume {:verifier.code 1} true;
  $i21 := $M.6;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 184, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 184, 3} true;
  assume {:verifier.code 1} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 61} true;
  assume {:verifier.code 0} true;
  $i17 := $M.4;
  assume {:sourceloc "./output/safe026_tso.opt_tmp.c", 180, 81} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 0);
  assume {:verifier.code 0} true;
  $i14 := $i18;
