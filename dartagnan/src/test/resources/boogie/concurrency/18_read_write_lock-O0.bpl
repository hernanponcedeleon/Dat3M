...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/18_read_write_lock-O0.bpl /Users/ponce/git/Dat3M/./output/18_read_write_lock_tmp.c
...
procedure  __VERIFIER_atomic_w()
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 681, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 681, 25} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, w);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 681, 26} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 681, 26} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 681, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 682, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, r);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 682, 26} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 682, 26} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 682, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 683, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, w, 1);
  call {:cexpr "w"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 684, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
{
$bb0:
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 686, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 686, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_w();
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 687, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 3);
  call {:cexpr "x"} boogie_si_record_i32(3);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 688, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, w, 0);
  call {:cexpr "w"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 689, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  __VERIFIER_atomic_r()
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 693, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 693, 25} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, w);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 693, 26} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 693, 26} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 693, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 694, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, r);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 694, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 694, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r, $i4);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 695, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 697, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 697, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_r();
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 698, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 698, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i1);
  call {:cexpr "y"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 699, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, y);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 699, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, x);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 699, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i2, $i3);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 699, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 700, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, r);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 700, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32($i5, 1);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 700, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, r, $i6);
  call {:cexpr "r"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 701, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 699, 19} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 699, 29} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 699, 43} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 699, 43} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 706, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 707, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := thr2($0.ref);
  assume {:sourceloc "./output/18_read_write_lock_tmp.c", 708, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 52619));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 53651));
