...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/time_var_mutex-O0.bpl /Users/ponce/git/Dat3M/./output/time_var_mutex_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 59895));
...
const m_inode: ref;
axiom (m_inode == $sub.ref(0, 1056));
const inode: ref;
axiom (inode == $sub.ref(0, 2084));
const m_busy: ref;
axiom (m_busy == $sub.ref(0, 3140));
const busy: ref;
axiom (busy == $sub.ref(0, 4168));
const block: ref;
axiom (block == $sub.ref(0, 5196));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 6234));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 7266));
const {:count 3} .str.1.1: ref;
axiom (.str.1.1 == $sub.ref(0, 8293));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 9331));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 10359));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 11391));
...
axiom (llvm.dbg.declare == $sub.ref(0, 12423));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 13455));
procedure  abort();
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 14487));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
const allocator: ref;
axiom (allocator == $sub.ref(0, 15519));
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 684, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 684, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(m_inode);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 685, 6} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, inode);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 685, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 685, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 686, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_lock(m_busy);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 687, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, busy, 1);
  call {:cexpr "busy"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 688, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_unlock(m_busy);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 689, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, inode, 1);
  call {:cexpr "inode"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 690, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 685, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 691, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, block, 1);
  call {:cexpr "block"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 692, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, block);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 692, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 692, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i7 == 1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 693, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(m_inode);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 694, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 692, 30} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 692, 44} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 692, 44} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 697, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 697, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(m_busy);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 698, 6} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, busy);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 698, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 698, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 699, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, block, 0);
  call {:cexpr "block"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 700, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, block);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 700, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 700, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 702, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_unlock(m_busy);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 703, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 701, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !(($i5 == 1));
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 700, 32} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 700, 46} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 700, 46} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 707, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, inode);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 707, 32} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, busy);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 707, 29} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i2, $i3);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 707, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 707, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 708, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_init(m_inode, $0.ref);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 709, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_init(m_busy, $0.ref);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 710, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p0, $0.ref, allocator, $0.ref);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 711, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p1, $0.ref, de_allocator, $0.ref);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 712, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 712, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 713, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 713, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 714, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_mutex_destroy(m_inode);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 715, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_mutex_destroy(m_busy);
  assume {:sourceloc "./output/time_var_mutex_tmp.c", 716, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 25839));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 26871));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 27903));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 28935));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 29967));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 30999));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 32031));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 33063));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 34095));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 35127));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 36159));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 37191));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 38223));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 39255));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 40287));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 41319));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 42351));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 43383));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 44415));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 45447));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 46479));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 47511));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 48543));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 49575));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 50607));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 51639));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 52671));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 53703));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 54735));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 55767));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 56799));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 57831));
...
axiom (llvm.dbg.value == $sub.ref(0, 58863));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 59895));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, m_inode, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_inode, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_inode, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_inode, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_inode, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(m_inode, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, inode, 0);
  call {:cexpr "inode"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, m_busy, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_busy, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_busy, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_busy, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_busy, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(m_busy, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, busy, 0);
