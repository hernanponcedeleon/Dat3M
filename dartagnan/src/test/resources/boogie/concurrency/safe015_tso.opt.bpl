...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 7, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 7, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 8, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 8, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 8, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 8, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 94, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 94, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 95, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 2;
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 96, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 97, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 98, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 99, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 100, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 100, 23} true;
  assume {:verifier.code 0} true;
  $M.2 := $i1;
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 101, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 102, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 103, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 104, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 105, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 105, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 105, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 106, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 107, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 114, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 114, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 115, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 116, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 117, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 118, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := 2;
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 119, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 120, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 121, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 122, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 123, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.3;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 123, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 123, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 124, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 125, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 132, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 132, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 133, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 133, 23} true;
  assume {:verifier.code 0} true;
  $M.4 := $i1;
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 134, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 135, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 136, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 137, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 138, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 139, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 140, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 141, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 141, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 141, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 142, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 143, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 172, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 174, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 176, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 177, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 178, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $M.3;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 178, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 178, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 178, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 179, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 180, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $M.5;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 180, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 180, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 181, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 182, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 183, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 23} true;
  assume {:verifier.code 0} true;
  $i12 := $M.1;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 30} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 33} true;
  assume {:verifier.code 0} true;
  $i15 := $M.0;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 35} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i15, 2);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 40} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 21} true;
  assume {:verifier.code 0} true;
  $i21 := $xor.i1($i14, 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 19} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i1.i8($i21);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 187, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 190, 21} true;
  assume {:verifier.code 1} true;
  $i23 := $M.6;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 190, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i25 := $zext.i1.i32($i24);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 190, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i25);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 191, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 43} true;
  assume {:verifier.code 0} true;
  $i17 := $M.2;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 63} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 0);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 68} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb6:
  assume ($i18 == 1);
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 71} true;
  assume {:verifier.code 0} true;
  $i19 := $M.4;
  assume {:sourceloc "./output/safe015_tso.opt_tmp.c", 186, 91} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 2);
  assume {:verifier.code 0} true;
  $i14 := $i20;
