  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 14, 8} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 14, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 15, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 16, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 16, 7} true;
  assume {:verifier.code 0} true;
  $M.1 := $i4;
  call {:cexpr "i"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 17, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 14, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 23, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 23, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 24, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 25, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 25, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $i4;
  call {:cexpr "j"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 26, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 23, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
  call {:cexpr "k"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 23, 3} true;
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 29, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 37, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 38, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $M.1;
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 38, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sgt.i32($i6, 26);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 38, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 39, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 41, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 42, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $M.0;
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 42, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $sgt.i32($i9, 26);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 42, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 43, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 45, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 45, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 45, 23} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 45, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 45, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 49, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "./output/triangular-longer-1_tmp.c", 46, 12} true;
  assume {:verifier.code 0} true;
