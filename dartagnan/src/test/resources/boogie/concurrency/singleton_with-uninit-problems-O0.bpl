...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/singleton_with-uninit-problems-O0.bpl /Users/ponce/git/Dat3M/./output/singleton_with-uninit-problems_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54699));
...
{
$bb0:
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 2, 44} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1089, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1089, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1089, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1089, 95} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1089, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1089, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1089, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1089, 83} true;
  assume {:verifier.code 0} true;
...
procedure  abort();
const thread1: ref;
axiom (thread1 == $sub.ref(0, 11355));
procedure  thread1($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1093, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1093, 7} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(1);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1093, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, v, $p1);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1094, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1098, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1098, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, v);
  ...
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1098, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 88);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1099, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1103, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1103, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, v);
  ...
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(0, 1));
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1103, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 89);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1104, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const thread0: ref;
axiom (thread0 == $sub.ref(0, 15483));
procedure  thread0($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
  ...
  var $i20: i32;
$bb0:
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1109, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1109, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p1, $0.ref, thread1, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1110, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1110, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1111, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p2, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1112, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p3, $0.ref, thread3, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1113, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p4, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1114, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($p5, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1115, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.0, $p2);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1115, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_join($i13, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1116, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1116, 3} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_join($i15, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1117, 16} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i64($M.0, $p4);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1117, 3} true;
  assume {:verifier.code 0} true;
  call $i18 := pthread_join($i17, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1118, 16} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i64($M.0, $p5);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1118, 3} true;
  assume {:verifier.code 0} true;
  call $i20 := pthread_join($i19, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1119, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (pthread_join == $sub.ref(0, 17547));
procedure  pthread_join($i0: i64, $p1: ref)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 18579));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1124, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1124, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($p0, $0.ref, thread0, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1125, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1125, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $0.ref);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 21} true;
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.0, v);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $sext.i8.i32($i6);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, 88);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 33} true;
  assume {:verifier.code 0} true;
  $i9 := 1;
...
$bb2:
  ...
  assume {:verifier.code 1} true;
  $i15 := $zext.i1.i32($i9);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i15);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1127, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb3:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 36} true;
  assume {:verifier.code 1} true;
  $p10 := $load.ref($M.0, v);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 36} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i13 := $sext.i8.i32($i12);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 41} true;
  assume {:verifier.code 1} true;
  $i14 := $eq.i32($i13, 89);
  assume {:sourceloc "./output/singleton_with-uninit-problems_tmp.c", 1126, 33} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_assume == $sub.ref(0, 19611));
...
axiom (__SMACK_code == $sub.ref(0, 20643));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 21675));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 22707));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 23739));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 24771));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 25803));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 26835));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 27867));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 28899));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 29931));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 30963));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 31995));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 33027));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 34059));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 35091));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 36123));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 37155));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 38187));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 39219));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 40251));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 41283));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 42315));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 43347));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 44379));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 45411));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 46443));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 47475));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 48507));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 49539));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 50571));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 51603));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 52635));
...
axiom (llvm.dbg.value == $sub.ref(0, 53667));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54699));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.ref($M.0, v, $0.ref);
