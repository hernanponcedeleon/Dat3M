...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/stateful01-2-O0.bpl /Users/ponce/git/Dat3M/./output/stateful01-2_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 56803));
...
const ma: ref;
axiom (ma == $sub.ref(0, 1056));
const data1: ref;
axiom (data1 == $sub.ref(0, 2084));
const data2: ref;
axiom (data2 == $sub.ref(0, 3112));
const mb: ref;
axiom (mb == $sub.ref(0, 4168));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 5206));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 6238));
const {:count 3} .str.1.1: ref;
axiom (.str.1.1 == $sub.ref(0, 7265));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 8303));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 9331));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 10363));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/stateful01-2_tmp.c", 2, 44} true;
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "./output/stateful01-2_tmp.c", 678, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stateful01-2_tmp.c", 678, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(ma);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 679, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, data1);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 679, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 679, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, data1, $i3);
  call {:cexpr "data1"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 680, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(ma);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 681, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_lock(ma);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 682, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, data2);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 682, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i6, 1);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 682, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, data2, $i7);
  call {:cexpr "data2"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 683, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(ma);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 684, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 12427));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_mutex_lock: ref;
axiom (pthread_mutex_lock == $sub.ref(0, 13459));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 14491));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const thread2: ref;
axiom (thread2 == $sub.ref(0, 15523));
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "./output/stateful01-2_tmp.c", 688, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/stateful01-2_tmp.c", 688, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(ma);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 689, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, data1);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 689, 8} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $store.i32($M.0, data1, $i3);
  call {:cexpr "data1"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 690, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(ma);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 691, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_lock(ma);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, data2);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $store.i32($M.0, data2, $i7);
  call {:cexpr "data2"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 693, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(ma);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 694, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/stateful01-2_tmp.c", 699, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/stateful01-2_tmp.c", 700, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_init(mb, $0.ref);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 701, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, data1, 10);
  call {:cexpr "data1"} boogie_si_record_i32(10);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 702, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, data2, 10);
  call {:cexpr "data2"} boogie_si_record_i32(10);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 703, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread1, $0.ref);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 704, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 705, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 705, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 706, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 706, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 707, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, data1);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 707, 12} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 16);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 707, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 707, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, data2);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 707, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 5);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 707, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/stateful01-2_tmp.c", 712, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "./output/stateful01-2_tmp.c", 708, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "./output/stateful01-2_tmp.c", 707, 7} true;
  ...
  goto $bb3;
$bb6:
  assume {:sourceloc "./output/stateful01-2_tmp.c", 709, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/stateful01-2_tmp.c", 709, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/stateful01-2_tmp.c", 709, 27} true;
  assume {:verifier.code 0} true;
...
axiom (__SMACK_code == $sub.ref(0, 22747));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 23779));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 24811));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 25843));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 26875));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 27907));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 28939));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 29971));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 31003));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 32035));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 33067));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 34099));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 35131));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 36163));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 37195));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 38227));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 39259));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 40291));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 41323));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 42355));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 43387));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 44419));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 45451));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 46483));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 47515));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 48547));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 49579));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 50611));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 51643));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 52675));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 53707));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 54739));
...
axiom (llvm.dbg.value == $sub.ref(0, 55771));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 56803));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, ma, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(ma, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(ma, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(ma, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(ma, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(ma, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, data1, 0);
  call {:cexpr "data1"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, data2, 0);
  call {:cexpr "data2"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, mb, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(mb, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(mb, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(mb, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(mb, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(mb, $mul.ref(0, 32)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
