...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/test-easy8.wvr-O0.bpl /Users/ponce/git/Dat3M/output/test-easy8.wvr_tmp.c
...
const b: ref;
axiom (b == $sub.ref(0, 1025));
const c: ref;
axiom (c == $sub.ref(0, 2050));
const .str: ref;
axiom (.str == $sub.ref(0, 3076));
const {:count 17} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4117));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 5160));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 6192));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 21, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 21, 22} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 21, __PRETTY_FUNCTION__.reach_error);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 21, 22} true;
  assume {:verifier.code 0} true;
  assume false;
}
const __assert_fail: ref;
axiom (__assert_fail == $sub.ref(0, 7224));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 8256));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 35, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 35, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 35, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 35, 14} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 41, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 41, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 42, 24} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i8($M.0, b);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 42, 24} true;
  assume {:verifier.code 0} true;
  $i1 := $trunc.i8.i1($i0);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 42, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i1($i1, 1);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 42, 23} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 43, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, c, 0);
  call {:cexpr "c"} boogie_si_record_i8(0);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 44, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 46, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const thread2: ref;
axiom (thread2 == $sub.ref(0, 11352));
procedure  thread2()
  returns ($r: ref)
{
$bb0:
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 50, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 50, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, b, 1);
  call {:cexpr "b"} boogie_si_record_i8(1);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 52, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, c, 1);
  call {:cexpr "c"} boogie_si_record_i8(1);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 53, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 55, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 61, 7} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 61, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 61, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, b, $i3);
  call {:cexpr "b"} boogie_si_record_i8($i3);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 62, 7} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 62, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 62, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, c, $i5);
  call {:cexpr "c"} boogie_si_record_i8($i5);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 65, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, thread1, $0.ref);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 66, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, thread2, $0.ref);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 67, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i64($M.0, $p0);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 67, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 68, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i64($M.0, $p1);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 68, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 70, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, c);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 70, 24} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 70, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $xor.i1($i13, 1);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 70, 23} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i1.i32($i14);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 70, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i15);
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 71, 3} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/test-easy8.wvr_tmp.c", 73, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 13416));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 14448));
procedure  pthread_join($i0: i64, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 15480));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 16512));
...
axiom (__SMACK_dummy == $sub.ref(0, 17544));
...
axiom (__SMACK_and32 == $sub.ref(0, 18576));
...
axiom (__SMACK_and64 == $sub.ref(0, 19608));
...
axiom (__SMACK_and16 == $sub.ref(0, 20640));
...
axiom (__SMACK_and8 == $sub.ref(0, 21672));
...
axiom (__SMACK_or32 == $sub.ref(0, 22704));
...
axiom (__SMACK_or64 == $sub.ref(0, 23736));
...
axiom (__SMACK_or16 == $sub.ref(0, 24768));
...
axiom (__SMACK_or8 == $sub.ref(0, 25800));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 26832));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 27864));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 28896));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 29928));
  ...
  returns ($r: i1)
{
  ...
  var $i11: i1;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1577, 20} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1577, 20} true;
  assume {:verifier.code 1} true;
  call $i0 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1577, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1577, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  call {:cexpr "x"} boogie_si_record_i8($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 28} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  assume {:branchcond $i5} true;
  goto $bb1, $bb3;
...
$bb2:
  ...
  assume {:verifier.code 1} true;
  $i10 := $zext.i1.i32($i6);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i10);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1579, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1579, 3} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $exn := false;
  return;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 31} true;
  assume {:verifier.code 1} true;
  $i7 := $trunc.i8.i1($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 31} true;
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 33} true;
  assume {:verifier.code 1} true;
  $i9 := $eq.i32($i8, 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1578, 28} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 34056));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 35088));
