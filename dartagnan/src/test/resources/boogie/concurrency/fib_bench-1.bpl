...
{
$bb0:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 2, 20} true;
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 18, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 18, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 19, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 20, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 20, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $M.1;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 20, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 21, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 18, 25} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 31, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 31, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 31, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 31, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 32, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 33, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 33, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $M.0;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 33, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 34, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb4:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 31, 25} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  call {:cexpr "k"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 31, 3} true;
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 37, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 44, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 45, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p3, $0.ref, t2, $0.ref);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 47, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 48, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $M.1;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 48, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sgt.i32($i6, 144);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 48, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 49, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 51, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 52, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $M.0;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 52, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $sgt.i32($i9, 144);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 52, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 53, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 55, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 55, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 55, 23} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 55, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 55, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 59, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 56, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 56, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 56, 27} true;
  assume {:verifier.code 0} true;
