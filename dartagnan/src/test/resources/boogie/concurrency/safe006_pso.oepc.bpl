...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 7, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 7, 91} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 7, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 7, 68} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 90, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 90, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 91, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 91, 23} true;
  assume {:verifier.code 0} true;
  $M.1 := $i1;
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 92, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 93, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 94, 5} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 95, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 99, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 99, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 99, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 100, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 108, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 108, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 109, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 109, 23} true;
  assume {:verifier.code 0} true;
  $M.4 := $i1;
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 110, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 111, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 112, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 113, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 117, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 117, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 117, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 118, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 148, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 150, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 151, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 152, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $M.3;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 152, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 152, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 152, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 153, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 154, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $M.5;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 154, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 160, 23} true;
  assume {:verifier.code 0} true;
  $i10 := $M.1;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 160, 43} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, 1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 160, 48} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 160, 51} true;
  assume {:verifier.code 0} true;
  $i13 := $M.4;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 160, 71} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i32($i13, 1);
  assume {:verifier.code 0} true;
  $i12 := $i14;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 160, 21} true;
  assume {:verifier.code 0} true;
  $i15 := $xor.i1($i12, 1);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 160, 19} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i8($i15);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 160, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 161, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 164, 21} true;
  assume {:verifier.code 1} true;
  $i17 := $M.6;
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 164, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "./output/safe006_pso.oepc_tmp.c", 164, 3} true;
  assume {:verifier.code 1} true;
