...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/race-2_3-container_of-O0.bpl /Users/ponce/git/Dat3M/./output/race-2_3-container_of_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1681, 44} true;
...
procedure  ldv_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ldv_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1683, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1683, 88} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1683, 52} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1683, 62} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i16: i32;
$bb0:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1697, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1697, 23} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1699, 92} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1699, 107} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($add.ref($0.ref, $mul.ref(0, 40)), $mul.ref(32, 1)))), 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1699, 72} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1700, 29} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1700, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_lock($p5);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1701, 8} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p8 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1701, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p8, 1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1702, 25} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p10 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1702, 32} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, $p10);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1702, 34} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i11, 1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1702, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p14 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1702, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p14, $i12);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1703, 31} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p4, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1703, 2} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_mutex_unlock($p15);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1704, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i28: i32;
$bb0:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1707, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1707, 28} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1708, 28} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1708, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_init($p2, $0.ref);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1709, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p5 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1709, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, 0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1710, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p7 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1710, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p7, 0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1711, 12} true;
  ...
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1712, 5} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1712, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i9 == 1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1713, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1714, 48} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1714, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create(t1, $0.ref, my_callback, $p10);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1715, 48} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1715, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_create(t2, $0.ref, my_callback, $p12);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1716, 8} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p15 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1716, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p15, 3);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1717, 8} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p17 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1717, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p17, 3);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1718, 19} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p19 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1718, 26} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, $p19);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1718, 27} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.i32($i20, 3);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1718, 27} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i1.i32($i21);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1718, 2} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i22);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1719, 19} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p24 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1719, 26} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i32($M.0, $p24);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1719, 27} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.i32($i25, 3);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1719, 27} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i1.i32($i26);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1719, 2} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i27);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1720, 2} true;
  assume {:verifier.code 0} true;
  $i28 := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1722, 31} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1722, 2} true;
  assume {:verifier.code 0} true;
  call $i30 := pthread_mutex_destroy($p29);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1723, 2} true;
  assume {:verifier.code 0} true;
  $i28 := $sub.i32(0, 1);
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1724, 1} true;
  assume {:verifier.code 0} true;
  $r := $i28;
  $exn := false;
  return;
...
procedure  my_drv_disconnect($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1727, 15} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, t1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1727, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $p1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1728, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i64($M.0, t2);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1728, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $p1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1729, 31} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1729, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_destroy($p6);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1730, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
{
$bb0:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1732, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1732, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
...
{
$bb0:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1735, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1735, 2} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1738, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1739, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1739, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume true;
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1742, 15} true;
  assume {:verifier.code 0} true;
  call $i3 := my_drv_probe($p0);
  call {:cexpr "probe_ret"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1743, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1743, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1754, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1744, 4} true;
  assume {:verifier.code 0} true;
  call my_drv_disconnect($p0);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1745, 20} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p6 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1745, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1745, 28} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, 1);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1745, 28} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1745, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i9);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1746, 20} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p11 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1746, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p11);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1746, 28} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1746, 28} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1746, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i14);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1747, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1743, 6} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1748, 3} true;
  assume {:verifier.code 0} true;
  call my_drv_cleanup();
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1749, 8} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p16 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1749, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p16, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1750, 8} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p18 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1750, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p18, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1751, 19} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p20 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1751, 26} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, $p20);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1751, 27} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1751, 27} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1751, 3} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i23);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1752, 19} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  $p25 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1)), $mul.ref(4, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1752, 26} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, $p25);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1752, 27} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.i32($i26, $sub.i32(0, 1));
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1752, 27} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i1.i32($i27);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1752, 3} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i28);
  assume {:sourceloc "./output/race-2_3-container_of_tmp.c", 1753, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
