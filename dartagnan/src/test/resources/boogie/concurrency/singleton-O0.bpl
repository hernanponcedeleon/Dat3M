...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/singleton-O0.bpl /Users/ponce/git/Dat3M/./output/singleton_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/singleton_tmp.c", 2, 44} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/singleton_tmp.c", 1089, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/singleton_tmp.c", 1089, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/singleton_tmp.c", 1089, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/singleton_tmp.c", 1089, 95} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/singleton_tmp.c", 1089, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/singleton_tmp.c", 1089, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/singleton_tmp.c", 1089, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/singleton_tmp.c", 1089, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "./output/singleton_tmp.c", 1093, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/singleton_tmp.c", 1093, 7} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(1);
  assume {:sourceloc "./output/singleton_tmp.c", 1093, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, v, $p1);
  assume {:sourceloc "./output/singleton_tmp.c", 1094, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "./output/singleton_tmp.c", 1098, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/singleton_tmp.c", 1098, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, v);
  ...
  assume {:sourceloc "./output/singleton_tmp.c", 1098, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 88);
  assume {:sourceloc "./output/singleton_tmp.c", 1099, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "./output/singleton_tmp.c", 1103, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/singleton_tmp.c", 1103, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, v);
  ...
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(0, 1));
  assume {:sourceloc "./output/singleton_tmp.c", 1103, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 89);
  assume {:sourceloc "./output/singleton_tmp.c", 1104, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i20: i32;
$bb0:
  assume {:sourceloc "./output/singleton_tmp.c", 1109, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/singleton_tmp.c", 1110, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/singleton_tmp.c", 1110, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1111, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p2, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1112, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p3, $0.ref, thread3, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1113, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p4, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1114, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($p5, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1115, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.0, $p2);
  assume {:sourceloc "./output/singleton_tmp.c", 1115, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_join($i13, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1116, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i64($M.0, $p3);
  assume {:sourceloc "./output/singleton_tmp.c", 1116, 3} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_join($i15, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1117, 16} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i64($M.0, $p4);
  assume {:sourceloc "./output/singleton_tmp.c", 1117, 3} true;
  assume {:verifier.code 0} true;
  call $i18 := pthread_join($i17, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1118, 16} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i64($M.0, $p5);
  assume {:sourceloc "./output/singleton_tmp.c", 1118, 3} true;
  assume {:verifier.code 0} true;
  call $i20 := pthread_join($i19, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1119, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/singleton_tmp.c", 1124, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/singleton_tmp.c", 1125, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/singleton_tmp.c", 1125, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $0.ref);
  assume {:sourceloc "./output/singleton_tmp.c", 1126, 21} true;
  ...
  assume {:verifier.code 1} true;
  $i7 := $sext.i8.i32($i6);
  assume {:sourceloc "./output/singleton_tmp.c", 1126, 26} true;
  assume {:verifier.code 1} true;
  $i8 := $eq.i32($i7, 88);
  assume {:sourceloc "./output/singleton_tmp.c", 1126, 26} true;
  assume {:verifier.code 1} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/singleton_tmp.c", 1126, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i9);
  assume {:sourceloc "./output/singleton_tmp.c", 1127, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
