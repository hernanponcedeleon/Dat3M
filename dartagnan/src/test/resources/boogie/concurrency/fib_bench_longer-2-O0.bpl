...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/fib_bench_longer-2-O0.bpl /Users/ponce/git/Dat3M/./output/fib_bench_longer-2_tmp.c
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 681, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 681, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 681, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 6);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 681, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 682, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 683, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, j);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 683, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, i);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 683, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 683, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, i, $i5);
  call {:cexpr "i"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 684, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 685, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 686, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 681, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 687, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (pthread_exit == $sub.ref(0, 11347));
procedure  pthread_exit($p0: ref);
const t2: ref;
axiom (t2 == $sub.ref(0, 12379));
procedure  t2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 692, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 6);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 692, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 693, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 694, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, i);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 694, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, j);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 694, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 694, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, j, $i5);
  call {:cexpr "j"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 695, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 696, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 697, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 697, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb4:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 692, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  call {:cexpr "k"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 692, 3} true;
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 698, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 703, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 704, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p3, $0.ref, t2, $0.ref);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 705, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 706, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, i);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 706, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sge.i32($i6, 377);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 706, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 707, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 708, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 709, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, j);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 709, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $sge.i32($i9, 377);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 709, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 710, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 711, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 711, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 711, 23} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 711, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 711, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 714, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 712, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 712, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/fib_bench_longer-2_tmp.c", 712, 27} true;
  assume {:verifier.code 0} true;
...
axiom (pthread_create == $sub.ref(0, 14443));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const abort: ref;
axiom (abort == $sub.ref(0, 15475));
procedure  abort();
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 16507));
...
axiom (__SMACK_code == $sub.ref(0, 17539));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 18571));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19603));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 20635));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 21667));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 22699));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 23731));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 24763));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 25795));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 26827));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 27859));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 28891));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 29923));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 30955));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 31987));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 33019));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 34051));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 35083));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 36115));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 37147));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 38179));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 39211));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 40243));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 41275));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 42307));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 43339));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 44371));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 45403));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 46435));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 47467));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 48499));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 49531));
...
{
$bb0:
  $M.0 := $store.i32($M.0, i, 1);
  call {:cexpr "i"} boogie_si_record_i32(1);
  $M.0 := $store.i32($M.0, j, 1);
