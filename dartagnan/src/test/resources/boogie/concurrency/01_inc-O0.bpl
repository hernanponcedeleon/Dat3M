...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/01_inc-O0.bpl /Users/ponce/git/Dat3M/./output/01_inc_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 52627));
...
const m: ref;
axiom (m == $sub.ref(0, 1028));
const value: ref;
axiom (value == $sub.ref(0, 2056));
...
axiom (assume_abort_if_not == $sub.ref(0, 8251));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/01_inc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/01_inc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/01_inc_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/01_inc_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/01_inc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/01_inc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 9283));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 10315));
procedure  abort();
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 11347));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/01_inc_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/01_inc_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
axiom (__VERIFIER_atomic_acquire == $sub.ref(0, 12379));
procedure  __VERIFIER_atomic_acquire()
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/01_inc_tmp.c", 681, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/01_inc_tmp.c", 681, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, m);
  assume {:sourceloc "./output/01_inc_tmp.c", 681, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/01_inc_tmp.c", 681, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/01_inc_tmp.c", 681, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "./output/01_inc_tmp.c", 682, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, m, 1);
  call {:cexpr "m"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/01_inc_tmp.c", 683, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_release: ref;
axiom (__VERIFIER_atomic_release == $sub.ref(0, 13411));
procedure  __VERIFIER_atomic_release()
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/01_inc_tmp.c", 686, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/01_inc_tmp.c", 686, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, m);
  assume {:sourceloc "./output/01_inc_tmp.c", 686, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 1);
  assume {:sourceloc "./output/01_inc_tmp.c", 686, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/01_inc_tmp.c", 686, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "./output/01_inc_tmp.c", 687, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, m, 0);
  call {:cexpr "m"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/01_inc_tmp.c", 688, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const thr1: ref;
axiom (thr1 == $sub.ref(0, 14443));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "./output/01_inc_tmp.c", 691, 2} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/01_inc_tmp.c", 691, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire();
  assume {:sourceloc "./output/01_inc_tmp.c", 692, 5} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, value);
  assume {:sourceloc "./output/01_inc_tmp.c", 692, 11} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/01_inc_tmp.c", 693, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "./output/01_inc_tmp.c", 694, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/01_inc_tmp.c", 696, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, value);
  call {:cexpr "v"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/01_inc_tmp.c", 697, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/01_inc_tmp.c", 697, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, value, $i4);
  call {:cexpr "value"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/01_inc_tmp.c", 698, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "./output/01_inc_tmp.c", 699, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, value);
  assume {:sourceloc "./output/01_inc_tmp.c", 699, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $ugt.i32($i5, $i3);
  assume {:sourceloc "./output/01_inc_tmp.c", 699, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "./output/01_inc_tmp.c", 702, 1} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "./output/01_inc_tmp.c", 700, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/01_inc_tmp.c", 699, 22} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/01_inc_tmp.c", 699, 32} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/01_inc_tmp.c", 699, 46} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/01_inc_tmp.c", 699, 46} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/01_inc_tmp.c", 706, 1} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/01_inc_tmp.c", 708, 1} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "./output/01_inc_tmp.c", 710, 1} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thr1, $0.ref);
  assume {:sourceloc "./output/01_inc_tmp.c", 711, 7} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/01_inc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/01_inc_tmp.c", 711, 20} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 3);
  assume {:sourceloc "./output/01_inc_tmp.c", 711, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "./output/01_inc_tmp.c", 711, 31} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/01_inc_tmp.c", 712, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/01_inc_tmp.c", 711, 25} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i6, 1);
...
axiom (__VERIFIER_assume == $sub.ref(0, 17539));
...
axiom (__SMACK_code == $sub.ref(0, 18571));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 19603));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 20635));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 21667));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 22699));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 23731));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 24763));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 25795));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 26827));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 27859));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 28891));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 29923));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 30955));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 31987));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 33019));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 34051));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 35083));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 36115));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 37147));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 38179));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 39211));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 40243));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 41275));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 42307));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 43339));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 44371));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 45403));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 46435));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 47467));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 48499));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 49531));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 50563));
...
axiom (llvm.dbg.value == $sub.ref(0, 51595));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 52627));
