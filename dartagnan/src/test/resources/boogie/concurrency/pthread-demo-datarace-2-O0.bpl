...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/include/smack -I/home/ponce/git/Dat3M/include/clang  -bpl /home/ponce/git/Dat3M/output/pthread-demo-datarace-2.bpl /home/ponce/git/Dat3M/../benchmarks/pthread-demo-datarace-2.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 36570));
...
const {:allocSize 4} myglobal: ref;
axiom (myglobal == $sub.ref(0, 1028));
const {:allocSize 32} .str: ref;
axiom (.str == $sub.ref(0, 2084));
const {:allocSize 79} {:count 79} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 3187));
const {:allocSize 57} {:count 57} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 4268));
const {:allocSize 27} {:count 27} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 5319));
const {:allocSize 83} {:count 83} .str.4: ref;
axiom (.str.4 == $sub.ref(0, 6426));
const {:allocSize 79} {:count 79} .str.5: ref;
axiom (.str.5 == $sub.ref(0, 7529));
const {:allocSize 57} {:count 57} .str.6: ref;
axiom (.str.6 == $sub.ref(0, 8610));
const {:allocSize 104} {:count 104} .str.7: ref;
axiom (.str.7 == $sub.ref(0, 9738));
const thread_function_datarace: ref;
axiom (thread_function_datarace == $sub.ref(0, 10770));
procedure  thread_function_datarace($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 35, 11} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 35, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 20);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 35, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 37, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, myglobal);
  call {:cexpr "j"} boogie_si_record_i32($i3);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 38, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  call {:cexpr "j"} boogie_si_record_i32($i4);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 39, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := printf.ref(.str);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 41, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, myglobal, $i4);
  call {:cexpr "myglobal"} boogie_si_record_i32($i4);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 42, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 43, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 35, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
...
axiom (llvm.dbg.declare == $sub.ref(0, 11802));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const printf: ref;
axiom (printf == $sub.ref(0, 12834));
procedure  printf.ref($p0: ref)
  returns ($r: i32);
procedure  printf.ref.i32($p0: ref, p.1: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 13866));
...
$bb0:
  call $initialize();
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 51, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 51, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($p0, $0.ref, thread_function_datarace, $0.ref);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 51, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 51, 10} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 53, 7} true;
  assume {:verifier.code 0} true;
  call exit($sub.i32(0, 1));
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 53, 7} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 56, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := printf.ref(.str.1);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 57, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := printf.ref(.str.2);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 58, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := printf.ref(.str.3);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 59, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := printf.ref(.str.1);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 60, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := printf.ref(.str.4);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 61, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := printf.ref(.str.5);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 63, 11} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  goto $bb3;
$bb3:
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 63, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $slt.i32($i9, 20);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 63, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i10 == 1);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 65, 18} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, myglobal);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 65, 26} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i11, 1);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 65, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, myglobal, $i12);
  call {:cexpr "myglobal"} boogie_si_record_i32($i12);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 67, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume !(($i10 == 1));
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 69, 25} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p0);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 69, 10} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb7, $bb8;
$bb6:
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 63, 23} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i9, 1);
...
$bb7:
  assume ($i16 == 1);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 71, 7} true;
  assume {:verifier.code 0} true;
  call exit($sub.i32(0, 1));
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 71, 7} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i16 == 1));
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 73, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 73, 5} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i32($M.0, myglobal);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 73, 5} true;
  assume {:verifier.code 0} true;
  $i18 := $ne.i32($i17, 40);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 73, 5} true;
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 74, 73} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, myglobal);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call $i20 := printf.ref.i32(.str.6, $i19);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 75, 5} true;
  assume {:verifier.code 0} true;
  call $i21 := printf.ref(.str.7);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 77, 5} true;
  assume {:verifier.code 0} true;
  call exit(0);
  assume {:sourceloc "../benchmarks/pthread-demo-datarace-2.c", 77, 5} true;
  assume {:verifier.code 0} true;
...
axiom (pthread_create == $sub.ref(0, 14898));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 15930));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 16962));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 17994));
...
axiom (__SMACK_dummy == $sub.ref(0, 19026));
...
axiom (__VERIFIER_assert == $sub.ref(0, 20058));
...
axiom (__SMACK_and32 == $sub.ref(0, 21090));
...
axiom (__SMACK_and64 == $sub.ref(0, 22122));
...
axiom (__SMACK_and16 == $sub.ref(0, 23154));
...
axiom (__SMACK_and8 == $sub.ref(0, 24186));
...
axiom (__SMACK_or32 == $sub.ref(0, 25218));
...
axiom (__SMACK_or64 == $sub.ref(0, 26250));
...
axiom (__SMACK_or16 == $sub.ref(0, 27282));
...
axiom (__SMACK_or8 == $sub.ref(0, 28314));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 29346));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 30378));
...
axiom (__SMACK_decls == $sub.ref(0, 31410));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 32442));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 33474));
...
axiom (llvm.dbg.value == $sub.ref(0, 35538));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 36570));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, myglobal, 0);
  call {:cexpr "myglobal"} boogie_si_record_i32(0);
  $exn := false;
  return;
}
