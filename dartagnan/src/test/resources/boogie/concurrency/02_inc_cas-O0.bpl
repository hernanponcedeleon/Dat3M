...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/02_inc_cas-O0.bpl /Users/ponce/git/Dat3M/./output/02_inc_cas_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 49535));
...
axiom (.str.1.1 == $sub.ref(0, 4125));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 5163));
...
{
$bb0:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 2, 44} true;
...
axiom (__VERIFIER_atomic_CAS == $sub.ref(0, 8255));
procedure  __VERIFIER_atomic_CAS($p0: ref, $i1: i32, $i2: i32, $p3: ref)
{
  var $i4: i32;
  var $i5: i1;
$bb0:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 680, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 680, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, $i1);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 680, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 682, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, $i2);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 682, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 1);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 683, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 686, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 0);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 688, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 9287));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const thr1: ref;
axiom (thr1 == $sub.ref(0, 10319));
  ...
  returns ($r: ref)
{
  ...
  var $i8: i1;
$bb0:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 692, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 693, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, value);
  call {:cexpr "v"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 694, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, $sub.i32(0, 1));
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 694, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 695, 4} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 697, 10} true;
  assume {:verifier.code 1} true;
  $i4 := $add.i32($i2, 1);
  call {:cexpr "vn"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 698, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_CAS(value, $i2, $i4, $p1);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 699, 2} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 703, 1} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb5:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 700, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p1);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 700, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, 0);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 699, 2} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 701, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, value);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 701, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i32($i7, $i2);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 701, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i8 == 1);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 702, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb9:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 701, 21} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 701, 31} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 701, 45} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 701, 45} true;
  assume {:verifier.code 0} true;
...
const abort: ref;
axiom (abort == $sub.ref(0, 11351));
procedure  abort();
const main: ref;
axiom (main == $sub.ref(0, 12383));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 707, 1} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 709, 1} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 711, 1} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thr1, $0.ref);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 712, 7} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 712, 20} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 3);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 712, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 712, 31} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 713, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/02_inc_cas_tmp.c", 712, 25} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i6, 1);
...
axiom (pthread_create == $sub.ref(0, 13415));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 14447));
...
axiom (__SMACK_code == $sub.ref(0, 15479));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 16511));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17543));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 18575));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 19607));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 20639));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 21671));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 22703));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 23735));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 24767));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 25799));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 26831));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 27863));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 28895));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 29927));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 30959));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 31991));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 33023));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 34055));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 35087));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 36119));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 37151));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 38183));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 39215));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 40247));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 41279));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 42311));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 46439));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 47471));
...
axiom (llvm.dbg.value == $sub.ref(0, 48503));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 49535));
