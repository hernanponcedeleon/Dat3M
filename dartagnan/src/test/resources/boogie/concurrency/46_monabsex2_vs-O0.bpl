...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/46_monabsex2_vs-O0.bpl /Users/ponce/git/Dat3M/./output/46_monabsex2_vs_tmp.c
...
const s: ref;
axiom (s == $sub.ref(0, 1025));
const l: ref;
axiom (l == $sub.ref(0, 2050));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 3088));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 4120));
const {:count 3} .str.1.1: ref;
axiom (.str.1.1 == $sub.ref(0, 5147));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 6185));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 7213));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 8245));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 2, 44} true;
  ...
  returns ($r: ref)
{
  ...
  var $i8: i8;
$bb0:
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, l);
  ...
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, s);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i8.i1($i3);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 679, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, s);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 679, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 679, 9} true;
  assume {:verifier.code 0} true;
  $i7 := 1;
...
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 19} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 29} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 43} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 678, 43} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 679, 5} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 679, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, s, $i8);
  call {:cexpr "s"} boogie_si_record_i8($i8);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 680, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, l, 1);
  call {:cexpr "l"} boogie_si_record_i8(1);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 681, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 10309));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 11341));
procedure  abort();
const main: ref;
axiom (main == $sub.ref(0, 12373));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 687, 1} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 689, 1} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 691, 1} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thr1, $0.ref);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 692, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 3);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 692, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 692, 32} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 693, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/46_monabsex2_vs_tmp.c", 692, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i6, 1);
...
axiom (pthread_create == $sub.ref(0, 13405));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 14437));
...
axiom (__SMACK_code == $sub.ref(0, 15469));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 16501));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17533));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 18565));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 19597));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 20629));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 21661));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 22693));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 23725));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 24757));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 25789));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 26821));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 27853));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 28885));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 29917));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 30949));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 31981));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 33013));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 34045));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 35077));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 36109));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 37141));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 38173));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 39205));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 40237));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 41269));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 42301));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 43333));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 44365));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 45397));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 46429));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 47461));
...
{
$bb0:
  $M.0 := $store.i8($M.0, s, 0);
  call {:cexpr "s"} boogie_si_record_i8(0);
  $M.0 := $store.i8($M.0, l, 0);
  call {:cexpr "l"} boogie_si_record_i8(0);
