...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 7, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 7, 91} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 7, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 7, 68} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 93, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 93, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 94, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 2;
  call {:cexpr "z"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 95, 3} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 99, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 99, 23} true;
  assume {:verifier.code 0} true;
  $M.2 := $i1;
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 100, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 104, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 104, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 104, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 105, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 113, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 113, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 114, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 115, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 116, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 117, 5} true;
  assume {:verifier.code 0} true;
  $M.4 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 118, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 122, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.3;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 122, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 122, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 123, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 131, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 131, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 132, 5} true;
  assume {:verifier.code 0} true;
  $M.4 := 2;
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 133, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 134, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 135, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 136, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 140, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.3;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 140, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 140, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 141, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 171, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 173, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 175, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 176, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 177, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $M.3;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 177, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 177, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 177, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 178, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 179, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $M.5;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 179, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 23} true;
  assume {:verifier.code 0} true;
  $i12 := $M.4;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 30} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 33} true;
  assume {:verifier.code 0} true;
  $i15 := $M.0;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 35} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i15, 2);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 40} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 21} true;
  assume {:verifier.code 0} true;
  $i19 := $xor.i1($i14, 1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 186, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 189, 21} true;
  assume {:verifier.code 1} true;
  $i21 := $M.6;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 189, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 189, 3} true;
  assume {:verifier.code 1} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 43} true;
  assume {:verifier.code 0} true;
  $i17 := $M.2;
  assume {:sourceloc "./output/safe031_tso.opt_tmp.c", 185, 63} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 0);
  assume {:verifier.code 0} true;
  $i14 := $i18;
