...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/14_spin2003-O0.bpl /Users/ponce/git/Dat3M/./output/14_spin2003_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/14_spin2003_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/14_spin2003_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/14_spin2003_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "./output/14_spin2003_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/14_spin2003_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
procedure  __VERIFIER_atomic_acquire()
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/14_spin2003_tmp.c", 681, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/14_spin2003_tmp.c", 681, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, m);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 681, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 681, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 681, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 682, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, m, 1);
  call {:cexpr "m"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 683, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  __VERIFIER_atomic_release()
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/14_spin2003_tmp.c", 686, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/14_spin2003_tmp.c", 686, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, m);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 686, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 686, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 686, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 687, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, m, 0);
  call {:cexpr "m"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 688, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "./output/14_spin2003_tmp.c", 690, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/14_spin2003_tmp.c", 690, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire();
  assume {:sourceloc "./output/14_spin2003_tmp.c", 691, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 0);
  call {:cexpr "x"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 692, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 693, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 693, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 693, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 694, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "./output/14_spin2003_tmp.c", 695, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/14_spin2003_tmp.c", 693, 17} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/14_spin2003_tmp.c", 693, 27} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/14_spin2003_tmp.c", 693, 41} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/14_spin2003_tmp.c", 693, 41} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/14_spin2003_tmp.c", 701, 1} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/14_spin2003_tmp.c", 703, 1} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "./output/14_spin2003_tmp.c", 705, 1} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thr1, $0.ref);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 706, 8} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/14_spin2003_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/14_spin2003_tmp.c", 706, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 3);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 706, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "./output/14_spin2003_tmp.c", 706, 32} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/14_spin2003_tmp.c", 707, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/14_spin2003_tmp.c", 706, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i6, 1);
