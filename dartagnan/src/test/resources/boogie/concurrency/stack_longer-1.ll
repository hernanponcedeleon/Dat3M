; ModuleID = '/home/ponce/git/Dat3M/output/stack_longer-1.ll'
source_filename = "/home/ponce/git/Dat3M/../sv-benchmarks/c/pthread/stack_longer-1.i"
...
@.str.1 = private unnamed_addr constant [17 x i8] c"stack_longer-1.c\00", align 1
...
@arr = internal global [400 x i32] zeroinitializer, align 16, !dbg !7
...
define dso_local void @reach_error() #0 !dbg !61 {
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i32 noundef 3, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @__PRETTY_FUNCTION__.reach_error, i64 0, i64 0)) #8, !dbg !65
  unreachable, !dbg !65
}
...
2:                                                ; preds = %11, %1
  ...
  call void @llvm.dbg.value(metadata i32 %.0, metadata !146, metadata !DIExpression()), !dbg !145
  %exitcond.not = icmp eq i32 %.0, 400, !dbg !150
...
3:                                                ; preds = %2
  ...
  %6 = icmp ult i32 %5, 400, !dbg !157
  %7 = zext i1 %6 to i32, !dbg !157
  call void @assume_abort_if_not(i32 noundef %7), !dbg !158
  %8 = call i32 @push(i32* noundef getelementptr inbounds ([400 x i32], [400 x i32]* @arr, i64 0, i64 0), i32 noundef %5), !dbg !159
...
2:                                                ; preds = %10, %1
  ...
  call void @llvm.dbg.value(metadata i32 %.0, metadata !175, metadata !DIExpression()), !dbg !174
  %exitcond.not = icmp eq i32 %.0, 400, !dbg !179
...
7:                                                ; preds = %3
  %8 = call i32 @pop(i32* noundef getelementptr inbounds ([400 x i32], [400 x i32]* @arr, i64 0, i64 0)), !dbg !187
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/../sv-benchmarks/c/pthread/stack_longer-1.i", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "87231e2c0e3c6a87222a09c571dfb262")
!4 = !{!5}
...
!9 = !DIFile(filename: "../sv-benchmarks/c/pthread/stack_longer-1.i", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "87231e2c0e3c6a87222a09c571dfb262")
!10 = !DICompositeType(tag: DW_TAG_array_type, baseType: !11, size: 12800, elements: !12)
!11 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!12 = !{!13}
!13 = !DISubrange(count: 400)
...
!80 = !DILabel(scope: !79, name: "ERROR", file: !9, line: 940)
!81 = !DILocation(line: 940, column: 3, scope: !79)
!82 = !DILocation(line: 940, column: 11, scope: !83)
!83 = distinct !DILexicalBlock(scope: !79, file: !9, line: 940, column: 10)
!84 = !DILocation(line: 940, column: 25, scope: !83)
!85 = distinct !DISubprogram(name: "inc_top", scope: !9, file: !9, line: 942, type: !62, scopeLine: 943, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!86 = !DILocation(line: 944, column: 6, scope: !85)
!87 = !DILocation(line: 945, column: 1, scope: !85)
!88 = distinct !DISubprogram(name: "dec_top", scope: !9, file: !9, line: 946, type: !62, scopeLine: 947, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!89 = !DILocation(line: 948, column: 6, scope: !88)
!90 = !DILocation(line: 949, column: 1, scope: !88)
!91 = distinct !DISubprogram(name: "get_top", scope: !9, file: !9, line: 950, type: !92, scopeLine: 951, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!92 = !DISubroutineType(types: !93)
!93 = !{!23}
!94 = !DILocation(line: 952, column: 10, scope: !91)
!95 = !DILocation(line: 952, column: 3, scope: !91)
!96 = distinct !DISubprogram(name: "stack_empty", scope: !9, file: !9, line: 954, type: !92, scopeLine: 955, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!97 = !DILocation(line: 956, column: 11, scope: !96)
!98 = !DILocation(line: 956, column: 14, scope: !96)
!99 = !DILocation(line: 956, column: 10, scope: !96)
!100 = !DILocation(line: 956, column: 3, scope: !96)
!101 = distinct !DISubprogram(name: "push", scope: !9, file: !9, line: 958, type: !102, scopeLine: 959, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!102 = !DISubroutineType(types: !103)
!103 = !{!23, !104, !23}
!104 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 64)
!105 = !DILocalVariable(name: "stack", arg: 1, scope: !101, file: !9, line: 958, type: !104)
!106 = !DILocation(line: 0, scope: !101)
!107 = !DILocalVariable(name: "x", arg: 2, scope: !101, file: !9, line: 958, type: !23)
!108 = !DILocation(line: 960, column: 7, scope: !109)
!109 = distinct !DILexicalBlock(scope: !101, file: !9, line: 960, column: 7)
!110 = !DILocation(line: 960, column: 10, scope: !109)
!111 = !DILocation(line: 960, column: 7, scope: !101)
!112 = !DILocation(line: 962, column: 5, scope: !113)
!113 = distinct !DILexicalBlock(scope: !109, file: !9, line: 961, column: 3)
!114 = !DILocation(line: 963, column: 5, scope: !113)
!115 = !DILocation(line: 967, column: 11, scope: !116)
!116 = distinct !DILexicalBlock(scope: !109, file: !9, line: 966, column: 3)
!117 = !DILocation(line: 967, column: 5, scope: !116)
!118 = !DILocation(line: 967, column: 22, scope: !116)
!119 = !DILocation(line: 968, column: 5, scope: !116)
!120 = !DILocation(line: 970, column: 3, scope: !101)
!121 = !DILocation(line: 971, column: 1, scope: !101)
!122 = distinct !DISubprogram(name: "pop", scope: !9, file: !9, line: 972, type: !123, scopeLine: 973, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!123 = !DISubroutineType(types: !124)
!124 = !{!23, !104}
!125 = !DILocalVariable(name: "stack", arg: 1, scope: !122, file: !9, line: 972, type: !104)
!126 = !DILocation(line: 0, scope: !122)
!127 = !DILocation(line: 974, column: 7, scope: !128)
!128 = distinct !DILexicalBlock(scope: !122, file: !9, line: 974, column: 7)
!129 = !DILocation(line: 974, column: 16, scope: !128)
!130 = !DILocation(line: 974, column: 7, scope: !122)
!131 = !DILocation(line: 976, column: 5, scope: !132)
!132 = distinct !DILexicalBlock(scope: !128, file: !9, line: 975, column: 3)
!133 = !DILocation(line: 977, column: 5, scope: !132)
!134 = !DILocation(line: 981, column: 5, scope: !135)
!135 = distinct !DILexicalBlock(scope: !128, file: !9, line: 980, column: 3)
!136 = !DILocation(line: 982, column: 18, scope: !135)
!137 = !DILocation(line: 982, column: 12, scope: !135)
!138 = !DILocation(line: 982, column: 5, scope: !135)
!139 = !DILocation(line: 0, scope: !128)
!140 = !DILocation(line: 985, column: 1, scope: !122)
!141 = distinct !DISubprogram(name: "t1", scope: !9, file: !9, line: 986, type: !142, scopeLine: 987, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!142 = !DISubroutineType(types: !143)
!143 = !{!5, !5}
!144 = !DILocalVariable(name: "arg", arg: 1, scope: !141, file: !9, line: 986, type: !5)
!145 = !DILocation(line: 0, scope: !141)
!146 = !DILocalVariable(name: "i", scope: !141, file: !9, line: 988, type: !23)
!147 = !DILocation(line: 990, column: 7, scope: !148)
!148 = distinct !DILexicalBlock(scope: !141, file: !9, line: 990, column: 3)
!149 = !DILocation(line: 0, scope: !148)
!150 = !DILocation(line: 990, column: 13, scope: !151)
!151 = distinct !DILexicalBlock(scope: !148, file: !9, line: 990, column: 3)
!152 = !DILocation(line: 990, column: 3, scope: !148)
!153 = !DILocation(line: 992, column: 5, scope: !154)
!154 = distinct !DILexicalBlock(scope: !151, file: !9, line: 991, column: 3)
!155 = !DILocation(line: 993, column: 11, scope: !154)
!156 = !DILocalVariable(name: "tmp", scope: !141, file: !9, line: 989, type: !11)
!157 = !DILocation(line: 994, column: 29, scope: !154)
!158 = !DILocation(line: 994, column: 5, scope: !154)
!159 = !DILocation(line: 995, column: 9, scope: !160)
!160 = distinct !DILexicalBlock(scope: !154, file: !9, line: 995, column: 9)
!161 = !DILocation(line: 995, column: 22, scope: !160)
!162 = !DILocation(line: 995, column: 9, scope: !154)
!163 = !DILocation(line: 996, column: 7, scope: !160)
!164 = !DILocation(line: 997, column: 9, scope: !154)
!165 = !DILocation(line: 998, column: 5, scope: !154)
!166 = !DILocation(line: 990, column: 22, scope: !151)
!167 = !DILocation(line: 990, column: 3, scope: !151)
!168 = distinct !{!168, !152, !169, !170}
!169 = !DILocation(line: 999, column: 3, scope: !148)
!170 = !{!"llvm.loop.mustprogress"}
!171 = !DILocation(line: 1000, column: 3, scope: !141)
!172 = distinct !DISubprogram(name: "t2", scope: !9, file: !9, line: 1002, type: !142, scopeLine: 1003, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!173 = !DILocalVariable(name: "arg", arg: 1, scope: !172, file: !9, line: 1002, type: !5)
!174 = !DILocation(line: 0, scope: !172)
!175 = !DILocalVariable(name: "i", scope: !172, file: !9, line: 1004, type: !23)
!176 = !DILocation(line: 1005, column: 7, scope: !177)
!177 = distinct !DILexicalBlock(scope: !172, file: !9, line: 1005, column: 3)
!178 = !DILocation(line: 0, scope: !177)
!179 = !DILocation(line: 1005, column: 13, scope: !180)
!180 = distinct !DILexicalBlock(scope: !177, file: !9, line: 1005, column: 3)
!181 = !DILocation(line: 1005, column: 3, scope: !177)
!182 = !DILocation(line: 1007, column: 5, scope: !183)
!183 = distinct !DILexicalBlock(scope: !180, file: !9, line: 1006, column: 3)
!184 = !DILocation(line: 1008, column: 9, scope: !185)
!185 = distinct !DILexicalBlock(scope: !183, file: !9, line: 1008, column: 9)
!186 = !DILocation(line: 1008, column: 9, scope: !183)
!187 = !DILocation(line: 1010, column: 13, scope: !188)
!188 = distinct !DILexicalBlock(scope: !189, file: !9, line: 1010, column: 11)
!189 = distinct !DILexicalBlock(scope: !185, file: !9, line: 1009, column: 5)
!190 = !DILocation(line: 1010, column: 21, scope: !188)
!191 = !DILocation(line: 1010, column: 11, scope: !189)
!192 = !DILocation(line: 1011, column: 9, scope: !188)
!193 = !DILocation(line: 1013, column: 5, scope: !183)
!194 = !DILocation(line: 1005, column: 22, scope: !180)
!195 = !DILocation(line: 1005, column: 3, scope: !180)
!196 = distinct !{!196, !181, !197, !170}
!197 = !DILocation(line: 1014, column: 3, scope: !177)
!198 = !DILocation(line: 1015, column: 3, scope: !172)
!199 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 1017, type: !92, scopeLine: 1018, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !64)
!200 = !DILocation(line: 1020, column: 3, scope: !199)
!201 = !DILocalVariable(name: "id1", scope: !199, file: !9, line: 1019, type: !202)
...
!205 = !DILocation(line: 1021, column: 3, scope: !199)
!206 = !DILocalVariable(name: "id2", scope: !199, file: !9, line: 1019, type: !202)
!207 = !DILocation(line: 1022, column: 3, scope: !199)
!208 = !DILocation(line: 1023, column: 16, scope: !199)
!209 = !DILocation(line: 1023, column: 3, scope: !199)
!210 = !DILocation(line: 1024, column: 16, scope: !199)
!211 = !DILocation(line: 1024, column: 3, scope: !199)
!212 = !DILocation(line: 1025, column: 3, scope: !199)
