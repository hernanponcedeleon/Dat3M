...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 58787));
...
axiom (env_value_str == $sub.ref(0, 8222));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 9249));
const {:count 14} .str.14: ref;
axiom (.str.14 == $sub.ref(0, 10287));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 11315));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 12347));
...
axiom (llvm.dbg.declare == $sub.ref(0, 13379));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 14411));
procedure abort();
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 15443));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 7, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 7, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 7, 91} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 7, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 7, 68} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 96, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 96, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 97, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 97, 23} true;
  assume {:verifier.code 0} true;
  $M.1 := $i1;
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 98, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 99, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 100, 5} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 101, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 105, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 105, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 105, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 106, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 17507));
procedure __VERIFIER_atomic_begin();
const __VERIFIER_atomic_end: ref;
axiom (__VERIFIER_atomic_end == $sub.ref(0, 18539));
procedure __VERIFIER_atomic_end();
const P1: ref;
axiom (P1 == $sub.ref(0, 19571));
procedure P1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 114, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 114, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 115, 5} true;
  assume {:verifier.code 0} true;
  $M.2 := 2;
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 116, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 120, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.3;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 120, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 120, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 121, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 129, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 129, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 130, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 130, 23} true;
  assume {:verifier.code 0} true;
  $M.4 := $i1;
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 131, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 132, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 133, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 134, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 138, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 138, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 138, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 139, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 147, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 147, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 148, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 2;
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 149, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 153, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.3;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 153, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 153, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i2;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 154, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 184, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 186, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 188, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 190, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 191, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 192, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $M.3;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 192, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 192, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 192, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 193, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 194, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $M.5;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 194, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $M.2;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 25} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, 2);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 30} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 33} true;
  assume {:verifier.code 0} true;
  $i17 := $M.0;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 35} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 2);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 40} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i1($i16, 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 201, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 204, 21} true;
  assume {:verifier.code 1} true;
  $i25 := $M.6;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 204, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i27 := $zext.i1.i32($i26);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 204, 3} true;
  assume {:verifier.code 1} true;
...
$bb4:
  assume ($i18 == 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 43} true;
  assume {:verifier.code 0} true;
  $i19 := $M.1;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 63} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 2);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 68} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb6:
  assume ($i20 == 1);
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 71} true;
  assume {:verifier.code 0} true;
  $i21 := $M.4;
  assume {:sourceloc "./output/safe016_pso.oepc_tmp.c", 200, 91} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, 2);
  assume {:verifier.code 0} true;
  $i16 := $i22;
...
axiom (pthread_create == $sub.ref(0, 23699));
procedure pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 24731));
...
axiom (__SMACK_code == $sub.ref(0, 25763));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 26795));
...
axiom (__VERIFIER_error == $sub.ref(0, 27827));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 28859));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 29891));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 30923));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 31955));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 32987));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 34019));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 35051));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 36083));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 37115));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 38147));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 39179));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 40211));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 41243));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 42275));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 43307));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 44339));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 45371));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 46403));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 47435));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 48467));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 49499));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 50531));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 51563));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 52595));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 53627));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 54659));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 55691));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 56723));
...
axiom (llvm.dbg.value == $sub.ref(0, 57755));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 58787));
