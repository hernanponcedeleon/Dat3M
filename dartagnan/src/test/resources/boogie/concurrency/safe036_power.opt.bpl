...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 7, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 7, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 8, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 8, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 8, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 8, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 8, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 91, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 91, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 92, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 93, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 94, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 95, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 96, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 97, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 97, 23} true;
  assume {:verifier.code 0} true;
  $M.2 := $i1;
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 98, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 99, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 100, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 101, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 102, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 102, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 102, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 103, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 104, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 111, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 111, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 112, 5} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 113, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 114, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 115, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 116, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 117, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 117, 23} true;
  assume {:verifier.code 0} true;
  $M.4 := $i1;
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 118, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 119, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 120, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 121, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 122, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $M.3;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 122, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 122, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := $i3;
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 123, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 124, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 153, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 155, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 156, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 157, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $M.3;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 157, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 157, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 157, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 158, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 159, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $M.5;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 159, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 159, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 160, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 161, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 162, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 165, 23} true;
  assume {:verifier.code 0} true;
  $i10 := $M.2;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 165, 43} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, 0);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 165, 48} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 165, 51} true;
  assume {:verifier.code 0} true;
  $i13 := $M.4;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 165, 71} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i32($i13, 0);
  assume {:verifier.code 0} true;
  $i12 := $i14;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 165, 21} true;
  assume {:verifier.code 0} true;
  $i15 := $xor.i1($i12, 1);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 165, 19} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i8($i15);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 165, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 166, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 169, 21} true;
  assume {:verifier.code 1} true;
  $i17 := $M.6;
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 169, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 169, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i19);
  assume {:sourceloc "./output/safe036_power.opt_tmp.c", 170, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
