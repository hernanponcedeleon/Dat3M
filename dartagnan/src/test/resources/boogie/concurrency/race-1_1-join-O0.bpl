...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/race-1_1-join-O0.bpl /Users/ponce/git/Dat3M/./output/race-1_1-join_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1681, 44} true;
...
procedure  ldv_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ldv_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1683, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1683, 88} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1683, 52} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1683, 62} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1688, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1688, 4} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1689, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 6);
  call {:cexpr "pdev"} boogie_si_record_i32(6);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1690, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, pdev);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1690, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 6);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1690, 19} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1690, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i4);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1691, 4} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1692, 4} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1695, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1695, 4} true;
  assume {:verifier.code 0} true;
  call $i0 := pthread_mutex_init(mutex, $0.ref);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1696, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 1);
  call {:cexpr "pdev"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1697, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, pdev);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1697, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1697, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1697, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i3);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1698, 7} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1699, 7} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create(t1, $0.ref, thread1, $0.ref);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1700, 7} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1702, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 3);
  call {:cexpr "pdev"} boogie_si_record_i32(3);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1703, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, pdev);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1703, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 3);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1703, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i32($i9);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1703, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i10);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1704, 4} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_mutex_destroy(mutex);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1705, 4} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32(0, 1);
  goto $bb3;
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1706, 1} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
...
procedure  module_exit()
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1709, 17} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i1 := $load.i64($M.0, t1);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1709, 4} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_join($i1, $p0);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1710, 4} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_destroy(mutex);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1711, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 5);
  call {:cexpr "pdev"} boogie_si_record_i32(5);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1712, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, pdev);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1712, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 5);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1712, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1712, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i6);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1713, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1715, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1715, 8} true;
  assume {:verifier.code 0} true;
  call $i0 := module_init();
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1715, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1715, 8} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1715, 26} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1716, 5} true;
  assume {:verifier.code 0} true;
  call module_exit();
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1716, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-1_1-join_tmp.c", 1718, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
