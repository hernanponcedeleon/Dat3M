...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/stack-1-O0.bpl /Users/ponce/git/Dat3M/output/stack-1_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 72280));
...
const .str: ref;
axiom (.str == $sub.ref(0, 3107));
const {:count 10} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4141));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 5184));
const top: ref;
axiom (top == $sub.ref(0, 6212));
const {:count 16} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 7252));
const {:count 17} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 8293));
const {:count 5} arr: ref;
axiom (arr == $sub.ref(0, 9337));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 10369));
const {:count 3} .str.1.10: ref;
axiom (.str.1.10 == $sub.ref(0, 11396));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 12424));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 13456));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 20, 83} true;
...
axiom (__assert_fail == $sub.ref(0, 14488));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 15520));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 23, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/stack-1_tmp.c", 23, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/stack-1_tmp.c", 23, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/stack-1_tmp.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/stack-1_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/stack-1_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 16552));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const error: ref;
axiom (error == $sub.ref(0, 17584));
procedure  error()
{
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 940, 1} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 940, 1} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume true;
  assume {:sourceloc "output/stack-1_tmp.c", 941, 11} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/stack-1_tmp.c", 941, 25} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/stack-1_tmp.c", 941, 25} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 18616));
procedure  llvm.dbg.label($p0: ref);
const inc_top: ref;
axiom (inc_top == $sub.ref(0, 19648));
procedure  inc_top()
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 946, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 946, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, top);
  ...
  assume {:sourceloc "output/stack-1_tmp.c", 947, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const dec_top: ref;
axiom (dec_top == $sub.ref(0, 20680));
procedure  dec_top()
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 950, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 950, 6} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, top);
  ...
  $M.0 := $store.i32($M.0, top, $i1);
  call {:cexpr "top"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/stack-1_tmp.c", 951, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const get_top: ref;
axiom (get_top == $sub.ref(0, 21712));
procedure  get_top()
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 954, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 954, 10} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, top);
  assume {:sourceloc "output/stack-1_tmp.c", 954, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 962, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "push:arg:x"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/stack-1_tmp.c", 962, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, top);
  assume {:sourceloc "output/stack-1_tmp.c", 962, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 5);
  assume {:sourceloc "output/stack-1_tmp.c", 962, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/stack-1_tmp.c", 964, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := printf.ref(.str.2);
  assume {:sourceloc "output/stack-1_tmp.c", 965, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(0, 1);
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "output/stack-1_tmp.c", 969, 11} true;
  assume {:verifier.code 0} true;
  call $i6 := get_top();
  assume {:sourceloc "output/stack-1_tmp.c", 969, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "output/stack-1_tmp.c", 969, 5} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0, $mul.ref($i7, 4));
  assume {:sourceloc "output/stack-1_tmp.c", 969, 22} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p8, $i1);
  assume {:sourceloc "output/stack-1_tmp.c", 970, 5} true;
  assume {:verifier.code 0} true;
  call inc_top();
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 973, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "output/stack-1_tmp.c", 972, 3} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
}
const printf: ref;
axiom (printf == $sub.ref(0, 23776));
procedure  printf.ref($p0: ref)
  returns ($r: i32);
const pop: ref;
axiom (pop == $sub.ref(0, 24808));
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 976, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 976, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, top);
  assume {:sourceloc "output/stack-1_tmp.c", 976, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "output/stack-1_tmp.c", 976, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/stack-1_tmp.c", 978, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := printf.ref(.str.3);
  assume {:sourceloc "output/stack-1_tmp.c", 979, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, 2);
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "output/stack-1_tmp.c", 983, 5} true;
  assume {:verifier.code 0} true;
  call dec_top();
  assume {:sourceloc "output/stack-1_tmp.c", 984, 18} true;
  assume {:verifier.code 0} true;
  call $i5 := get_top();
  assume {:sourceloc "output/stack-1_tmp.c", 984, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "output/stack-1_tmp.c", 984, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "output/stack-1_tmp.c", 984, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i8;
  goto $bb3;
$bb3:
  assume {:sourceloc "output/stack-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 987, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i10: i32;
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 992, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 992, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "output/stack-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 992, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "output/stack-1_tmp.c", 992, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "output/stack-1_tmp.c", 994, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "output/stack-1_tmp.c", 995, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/stack-1_tmp.c", 996, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4, 5);
  assume {:sourceloc "output/stack-1_tmp.c", 996, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "output/stack-1_tmp.c", 996, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i6);
  assume {:sourceloc "output/stack-1_tmp.c", 997, 10} true;
  assume {:verifier.code 0} true;
  call $i7 := push(arr, $i4);
  assume {:sourceloc "output/stack-1_tmp.c", 997, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, $sub.i32(0, 1));
  assume {:sourceloc "output/stack-1_tmp.c", 997, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb4, $bb5;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "output/stack-1_tmp.c", 1001, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i8 == 1);
  assume {:sourceloc "output/stack-1_tmp.c", 998, 7} true;
  assume {:verifier.code 0} true;
  call error();
  assume {:sourceloc "output/stack-1_tmp.c", 998, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/stack-1_tmp.c", 999, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_mutex_unlock(m);
  assume {:sourceloc "output/stack-1_tmp.c", 1000, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "output/stack-1_tmp.c", 992, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i1, 1);
...
axiom (pthread_mutex_lock == $sub.ref(0, 26872));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 27904));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const t2: ref;
axiom (t2 == $sub.ref(0, 28936));
procedure  t2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "output/stack-1_tmp.c", 1006, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 1006, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "output/stack-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/stack-1_tmp.c", 1006, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "output/stack-1_tmp.c", 1006, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "output/stack-1_tmp.c", 1008, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "output/stack-1_tmp.c", 1009, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, top);
  assume {:sourceloc "output/stack-1_tmp.c", 1009, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $sgt.i32($i4, 0);
  assume {:sourceloc "output/stack-1_tmp.c", 1009, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "output/stack-1_tmp.c", 1016, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/stack-1_tmp.c", 1011, 12} true;
  assume {:verifier.code 0} true;
  call $i6 := pop(arr);
  assume {:sourceloc "output/stack-1_tmp.c", 1011, 20} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, $sub.i32(0, 2));
  assume {:sourceloc "output/stack-1_tmp.c", 1011, 11} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/stack-1_tmp.c", 1014, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(m);
  assume {:sourceloc "output/stack-1_tmp.c", 1015, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb7:
  assume ($i7 == 1);
  assume {:sourceloc "output/stack-1_tmp.c", 1012, 9} true;
  assume {:verifier.code 0} true;
  call error();
  assume {:sourceloc "output/stack-1_tmp.c", 1012, 9} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/stack-1_tmp.c", 1013, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb10:
  assume {:sourceloc "output/stack-1_tmp.c", 1006, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i1, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/stack-1_tmp.c", 1021, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/stack-1_tmp.c", 1022, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "output/stack-1_tmp.c", 1023, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, t2, $0.ref);
  assume {:sourceloc "output/stack-1_tmp.c", 1024, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i64($M.0, $p0);
  assume {:sourceloc "output/stack-1_tmp.c", 1024, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_join($i5, $0.ref);
  assume {:sourceloc "output/stack-1_tmp.c", 1025, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "output/stack-1_tmp.c", 1025, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "output/stack-1_tmp.c", 1026, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 35128));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 36160));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 37192));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 38224));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 39256));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 40288));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 41320));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 42352));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 43384));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 44416));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 45448));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 46480));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 47512));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 48544));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 49576));
  ...
  returns ($r: i32)
{
  ...
  var $i11: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 125, 20} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 125, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 126, 22} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 127, 22} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 128, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 128, 30} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 128, 37} true;
  assume {:verifier.code 0} true;
  $i5 := $uge.i32($i2, 4294967295);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 128, 49} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i7 := $zext.i1.i32($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 128, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i7);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 129, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $uge.i32($i0, $i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 129, 30} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  assume {:branchcond $i8} true;
  goto $bb6, $bb7;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 128, 56} true;
  assume {:verifier.code 1} true;
...
$bb6:
  assume ($i8 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 129, 35} true;
  assume {:verifier.code 1} true;
  $i10 := $ule.i32($i0, $i2);
  assume {:verifier.code 0} true;
  $i9 := $i10;
...
$bb8:
  ...
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i9);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 129, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i11);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 130, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 50608));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 51640));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 52672));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 53704));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 54736));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 55768));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 56800));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 57832));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 58864));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 59896));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 60928));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 61960));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 62992));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 64024));
procedure  __VERIFIER_nondet_uint()
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 236, 20} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 236, 20} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 237, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_decls == $sub.ref(0, 65056));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 66088));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 67120));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 68152));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 69184));
...
axiom (llvm.dbg.value == $sub.ref(0, 71248));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 72280));
...
$bb0:
  ...
  $M.0 := $store.i32($M.0, $add.ref($add.ref(arr, $mul.ref(0, 20)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(arr, $mul.ref(0, 20)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(arr, $mul.ref(0, 20)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(arr, $mul.ref(0, 20)), $mul.ref(4, 4)), 0);
