...
define dso_local i8* @thread1(i8* noundef %0) #0 !dbg !58 {
  ...
  %2 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* noundef nonnull @mutex) #8, !dbg !64
  %3 = load i32, i32* @data, align 4, !dbg !65
  %4 = add nsw i32 %3, 1, !dbg !65
  store i32 %4, i32* @data, align 4, !dbg !65
  %5 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* noundef nonnull @mutex) #8, !dbg !66
  ret i8* null, !dbg !67
}
...
define dso_local i8* @thread2(i8* noundef %0) #0 !dbg !68 {
  ...
  %2 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* noundef nonnull @mutex) #8, !dbg !71
  %3 = load i32, i32* @data, align 4, !dbg !72
  %4 = add nsw i32 %3, 2, !dbg !72
  store i32 %4, i32* @data, align 4, !dbg !72
  %5 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* noundef nonnull @mutex) #8, !dbg !73
  ret i8* null, !dbg !74
}
...
define dso_local i8* @thread3(i8* noundef %0) #0 !dbg !75 {
  ...
  %2 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* noundef nonnull @mutex) #8, !dbg !78
  %3 = load i32, i32* @data, align 4, !dbg !79
  %4 = icmp sgt i32 %3, 2, !dbg !81
...
6:                                                ; preds = %1
  %7 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* noundef nonnull @mutex) #8, !dbg !89
  ret i8* null, !dbg !90
}
...
define dso_local i32 @main() #0 !dbg !91 {
  ...
  %4 = call i32 @pthread_mutex_init(%union.pthread_mutex_t* noundef nonnull @mutex, %union.pthread_mutexattr_t* noundef null) #10, !dbg !94
  call void @llvm.dbg.value(metadata i64* %1, metadata !95, metadata !DIExpression(DW_OP_deref)), !dbg !98
  %5 = call i32 @pthread_create(i64* noundef nonnull %1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef nonnull @thread1, i8* noundef null) #8, !dbg !99
  call void @llvm.dbg.value(metadata i64* %2, metadata !100, metadata !DIExpression(DW_OP_deref)), !dbg !98
  %6 = call i32 @pthread_create(i64* noundef nonnull %2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef nonnull @thread2, i8* noundef null) #8, !dbg !101
  call void @llvm.dbg.value(metadata i64* %3, metadata !102, metadata !DIExpression(DW_OP_deref)), !dbg !98
  %7 = call i32 @pthread_create(i64* noundef nonnull %3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef nonnull @thread3, i8* noundef null) #8, !dbg !103
  %8 = load i64, i64* %1, align 8, !dbg !104
  call void @llvm.dbg.value(metadata i64 %8, metadata !95, metadata !DIExpression()), !dbg !98
  %9 = call i32 @pthread_join(i64 noundef %8, i8** noundef null) #8, !dbg !105
  %10 = load i64, i64* %2, align 8, !dbg !106
  call void @llvm.dbg.value(metadata i64 %10, metadata !100, metadata !DIExpression()), !dbg !98
  %11 = call i32 @pthread_join(i64 noundef %10, i8** noundef null) #8, !dbg !107
  %12 = load i64, i64* %3, align 8, !dbg !108
  call void @llvm.dbg.value(metadata i64 %12, metadata !102, metadata !DIExpression()), !dbg !98
  %13 = call i32 @pthread_join(i64 noundef %12, i8** noundef null) #8, !dbg !109
  ret i32 0, !dbg !110
}
...
!99 = !DILocation(line: 732, column: 3, scope: !91)
!100 = !DILocalVariable(name: "t2", scope: !91, file: !7, line: 731, type: !96)
!101 = !DILocation(line: 733, column: 3, scope: !91)
!102 = !DILocalVariable(name: "t3", scope: !91, file: !7, line: 731, type: !96)
!103 = !DILocation(line: 734, column: 3, scope: !91)
!104 = !DILocation(line: 735, column: 16, scope: !91)
!105 = !DILocation(line: 735, column: 3, scope: !91)
!106 = !DILocation(line: 736, column: 16, scope: !91)
!107 = !DILocation(line: 736, column: 3, scope: !91)
!108 = !DILocation(line: 737, column: 16, scope: !91)
!109 = !DILocation(line: 737, column: 3, scope: !91)
!110 = !DILocation(line: 738, column: 3, scope: !91)
