; ModuleID = '/home/ponce/git/Dat3M/output/race-2_3-container_of.ll'
source_filename = "/home/ponce/git/Dat3M/../sv-benchmarks/c/ldv-races/race-2_3-container_of.i"
...
@.str.1 = private unnamed_addr constant [24 x i8] c"race-2_3-container_of.c\00", align 1
...
define dso_local i32 @my_drv_probe(%struct.my_data* noundef %0) #0 !dbg !119 {
  ...
  br i1 %.not, label %7, label %18, !dbg !135
...
7:                                                ; preds = %1
  ...
  call void @__VERIFIER_atomic_begin() #7, !dbg !140
  store i32 3, i32* %4, align 8, !dbg !141
  call void @__VERIFIER_atomic_end() #7, !dbg !142
  call void @__VERIFIER_atomic_begin() #7, !dbg !143
  store i32 3, i32* %5, align 4, !dbg !144
  call void @__VERIFIER_atomic_end() #7, !dbg !145
  call void @__VERIFIER_atomic_begin() #7, !dbg !146
  %12 = load i32, i32* %4, align 8, !dbg !147
  %13 = icmp eq i32 %12, 3, !dbg !148
  %14 = zext i1 %13 to i32, !dbg !148
  call void @ldv_assert(i32 noundef %14), !dbg !149
  call void @__VERIFIER_atomic_end() #7, !dbg !150
  call void @__VERIFIER_atomic_begin() #7, !dbg !151
  %15 = load i32, i32* %5, align 4, !dbg !152
  %16 = icmp eq i32 %15, 3, !dbg !153
  %17 = zext i1 %16 to i32, !dbg !153
  call void @ldv_assert(i32 noundef %17), !dbg !154
  call void @__VERIFIER_atomic_end() #7, !dbg !155
  br label %20, !dbg !156

18:                                               ; preds = %1
  call void @llvm.dbg.label(metadata !157), !dbg !158
  %19 = call i32 @pthread_mutex_destroy(%union.pthread_mutex_t* noundef %2) #8, !dbg !159
  br label %20, !dbg !160

20:                                               ; preds = %18, %7
  %.0 = phi i32 [ -1, %18 ], [ 0, %7 ], !dbg !123
  ret i32 %.0, !dbg !161
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @my_drv_disconnect(%struct.my_data* noundef %0) #0 !dbg !162 {
  %2 = alloca i8*, align 8
  call void @llvm.dbg.value(metadata %struct.my_data* %0, metadata !165, metadata !DIExpression()), !dbg !166
  %3 = load i64, i64* @t1, align 8, !dbg !167
  call void @llvm.dbg.value(metadata i8** %2, metadata !168, metadata !DIExpression(DW_OP_deref)), !dbg !166
  %4 = call i32 @pthread_join(i64 noundef %3, i8** noundef nonnull %2) #7, !dbg !169
  %5 = load i64, i64* @t2, align 8, !dbg !170
  %6 = call i32 @pthread_join(i64 noundef %5, i8** noundef nonnull %2) #7, !dbg !171
  %7 = getelementptr inbounds %struct.my_data, %struct.my_data* %0, i64 0, i32 0, !dbg !172
  %8 = call i32 @pthread_mutex_destroy(%union.pthread_mutex_t* noundef %7) #8, !dbg !173
  ret void, !dbg !174
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @my_drv_init() #0 !dbg !175 {
  ret i32 0, !dbg !178
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @my_drv_cleanup() #0 !dbg !179 {
  ret void, !dbg !180
}
...
define dso_local i32 @main() #0 !dbg !181 {
  ...
  %2 = call i32 @my_drv_init(), !dbg !182
  call void @llvm.dbg.value(metadata i32 %2, metadata !183, metadata !DIExpression()), !dbg !184
  %3 = icmp eq i32 %2, 0, !dbg !185
  br i1 %3, label %4, label %22, !dbg !187

4:                                                ; preds = %0
  call void @llvm.dbg.declare(metadata %struct.my_data* %1, metadata !188, metadata !DIExpression()), !dbg !190
  %5 = call i32 @my_drv_probe(%struct.my_data* noundef nonnull %1), !dbg !191
  call void @llvm.dbg.value(metadata i32 %5, metadata !192, metadata !DIExpression()), !dbg !193
  %6 = icmp eq i32 %5, 0, !dbg !194
  br i1 %6, label %7, label %16, !dbg !196

7:                                                ; preds = %4
  call void @my_drv_disconnect(%struct.my_data* noundef nonnull %1), !dbg !197
  %8 = getelementptr inbounds %struct.my_data, %struct.my_data* %1, i64 0, i32 2, i32 0, !dbg !199
  %9 = load i32, i32* %8, align 8, !dbg !199
  %10 = icmp eq i32 %9, 1, !dbg !200
  %11 = zext i1 %10 to i32, !dbg !200
  call void @ldv_assert(i32 noundef %11), !dbg !201
  %12 = getelementptr inbounds %struct.my_data, %struct.my_data* %1, i64 0, i32 2, i32 1, !dbg !202
  %13 = load i32, i32* %12, align 4, !dbg !202
  %14 = icmp eq i32 %13, 2, !dbg !203
  %15 = zext i1 %14 to i32, !dbg !203
  call void @ldv_assert(i32 noundef %15), !dbg !204
  br label %16, !dbg !205

16:                                               ; preds = %7, %4
  call void @my_drv_cleanup(), !dbg !206
  %17 = getelementptr inbounds %struct.my_data, %struct.my_data* %1, i64 0, i32 2, i32 0, !dbg !207
  store i32 -1, i32* %17, align 8, !dbg !208
  %18 = getelementptr inbounds %struct.my_data, %struct.my_data* %1, i64 0, i32 2, i32 1, !dbg !209
  store i32 -1, i32* %18, align 4, !dbg !210
  call void @ldv_assert(i32 noundef 1), !dbg !211
  %19 = load i32, i32* %18, align 4, !dbg !212
  %20 = icmp eq i32 %19, -1, !dbg !213
  %21 = zext i1 %20 to i32, !dbg !213
  call void @ldv_assert(i32 noundef %21), !dbg !214
  br label %22, !dbg !215
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/../sv-benchmarks/c/ldv-races/race-2_3-container_of.i", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "08ea369c307d67e8167cd2cf9158d024")
!4 = !{!5, !9, !54, !55, !56}
!5 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !6, size: 64)
!6 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "device", file: !7, line: 1677, elements: !8)
!7 = !DIFile(filename: "../sv-benchmarks/c/ldv-races/race-2_3-container_of.i", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "08ea369c307d67e8167cd2cf9158d024")
!8 = !{}
...
!140 = !DILocation(line: 1715, column: 5, scope: !119)
!141 = !DILocation(line: 1716, column: 21, scope: !119)
!142 = !DILocation(line: 1717, column: 6, scope: !119)
!143 = !DILocation(line: 1718, column: 6, scope: !119)
!144 = !DILocation(line: 1719, column: 21, scope: !119)
!145 = !DILocation(line: 1720, column: 6, scope: !119)
!146 = !DILocation(line: 1721, column: 6, scope: !119)
!147 = !DILocation(line: 1722, column: 30, scope: !119)
!148 = !DILocation(line: 1722, column: 31, scope: !119)
!149 = !DILocation(line: 1722, column: 6, scope: !119)
!150 = !DILocation(line: 1723, column: 6, scope: !119)
!151 = !DILocation(line: 1724, column: 6, scope: !119)
!152 = !DILocation(line: 1725, column: 30, scope: !119)
!153 = !DILocation(line: 1725, column: 31, scope: !119)
!154 = !DILocation(line: 1725, column: 6, scope: !119)
!155 = !DILocation(line: 1726, column: 6, scope: !119)
!156 = !DILocation(line: 1727, column: 5, scope: !119)
!157 = !DILabel(scope: !119, name: "exit", file: !7, line: 1728)
!158 = !DILocation(line: 1728, column: 1, scope: !119)
!159 = !DILocation(line: 1729, column: 2, scope: !119)
!160 = !DILocation(line: 1730, column: 2, scope: !119)
!161 = !DILocation(line: 1731, column: 1, scope: !119)
!162 = distinct !DISubprogram(name: "my_drv_disconnect", scope: !7, file: !7, line: 1732, type: !163, scopeLine: 1732, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!163 = !DISubroutineType(types: !164)
!164 = !{null, !9}
!165 = !DILocalVariable(name: "data", arg: 1, scope: !162, file: !7, line: 1732, type: !9)
!166 = !DILocation(line: 0, scope: !162)
!167 = !DILocation(line: 1734, column: 15, scope: !162)
!168 = !DILocalVariable(name: "status", scope: !162, file: !7, line: 1733, type: !56)
!169 = !DILocation(line: 1734, column: 2, scope: !162)
!170 = !DILocation(line: 1735, column: 15, scope: !162)
!171 = !DILocation(line: 1735, column: 2, scope: !162)
!172 = !DILocation(line: 1736, column: 31, scope: !162)
!173 = !DILocation(line: 1736, column: 2, scope: !162)
!174 = !DILocation(line: 1737, column: 1, scope: !162)
!175 = distinct !DISubprogram(name: "my_drv_init", scope: !7, file: !7, line: 1738, type: !176, scopeLine: 1738, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!176 = !DISubroutineType(types: !177)
!177 = !{!20}
!178 = !DILocation(line: 1739, column: 2, scope: !175)
!179 = distinct !DISubprogram(name: "my_drv_cleanup", scope: !7, file: !7, line: 1741, type: !70, scopeLine: 1741, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!180 = !DILocation(line: 1742, column: 2, scope: !179)
!181 = distinct !DISubprogram(name: "main", scope: !7, file: !7, line: 1744, type: !176, scopeLine: 1744, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!182 = !DILocation(line: 1745, column: 12, scope: !181)
!183 = !DILocalVariable(name: "ret", scope: !181, file: !7, line: 1745, type: !20)
!184 = !DILocation(line: 0, scope: !181)
!185 = !DILocation(line: 1746, column: 8, scope: !186)
!186 = distinct !DILexicalBlock(scope: !181, file: !7, line: 1746, column: 5)
!187 = !DILocation(line: 1746, column: 5, scope: !181)
!188 = !DILocalVariable(name: "data", scope: !189, file: !7, line: 1748, type: !10)
!189 = distinct !DILexicalBlock(scope: !186, file: !7, line: 1746, column: 13)
!190 = !DILocation(line: 1748, column: 18, scope: !189)
!191 = !DILocation(line: 1749, column: 15, scope: !189)
!192 = !DILocalVariable(name: "probe_ret", scope: !189, file: !7, line: 1747, type: !20)
!193 = !DILocation(line: 0, scope: !189)
!194 = !DILocation(line: 1750, column: 15, scope: !195)
!195 = distinct !DILexicalBlock(scope: !189, file: !7, line: 1750, column: 6)
!196 = !DILocation(line: 1750, column: 6, scope: !189)
!197 = !DILocation(line: 1751, column: 4, scope: !198)
!198 = distinct !DILexicalBlock(scope: !195, file: !7, line: 1750, column: 20)
!199 = !DILocation(line: 1752, column: 27, scope: !198)
!200 = !DILocation(line: 1752, column: 28, scope: !198)
!201 = !DILocation(line: 1752, column: 4, scope: !198)
!202 = !DILocation(line: 1753, column: 27, scope: !198)
!203 = !DILocation(line: 1753, column: 28, scope: !198)
!204 = !DILocation(line: 1753, column: 4, scope: !198)
!205 = !DILocation(line: 1754, column: 3, scope: !198)
!206 = !DILocation(line: 1755, column: 3, scope: !189)
!207 = !DILocation(line: 1756, column: 15, scope: !189)
!208 = !DILocation(line: 1756, column: 17, scope: !189)
!209 = !DILocation(line: 1757, column: 15, scope: !189)
!210 = !DILocation(line: 1757, column: 17, scope: !189)
!211 = !DILocation(line: 1758, column: 3, scope: !189)
!212 = !DILocation(line: 1759, column: 26, scope: !189)
!213 = !DILocation(line: 1759, column: 27, scope: !189)
!214 = !DILocation(line: 1759, column: 3, scope: !189)
!215 = !DILocation(line: 1760, column: 2, scope: !189)
!216 = !DILocation(line: 1761, column: 2, scope: !181)
