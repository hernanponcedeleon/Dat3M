...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/40_barrier_vf-O0.bpl /Users/ponce/git/Dat3M/./output/40_barrier_vf_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54681));
...
const MTX: ref;
axiom (MTX == $sub.ref(0, 2053));
const COND: ref;
axiom (COND == $sub.ref(0, 3078));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4116));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 5148));
const {:count 3} .str.1.1: ref;
axiom (.str.1.1 == $sub.ref(0, 6175));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 7213));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 8241));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 9273));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 10305));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 11337));
procedure  abort();
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 12369));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 6, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
axiom (__VERIFIER_atomic_acquire == $sub.ref(0, 13401));
procedure  __VERIFIER_atomic_acquire()
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 683, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 683, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i8($M.0, MTX);
  ...
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 683, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 683, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 683, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i4);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 684, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, MTX, 1);
  call {:cexpr "MTX"} boogie_si_record_i8(1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 685, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_release: ref;
axiom (__VERIFIER_atomic_release == $sub.ref(0, 14433));
procedure  __VERIFIER_atomic_release()
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 688, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 688, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i8($M.0, MTX);
  ...
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 688, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 688, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 688, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i4);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 689, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, MTX, 0);
  call {:cexpr "MTX"} boogie_si_record_i8(0);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 690, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const Barrier2: ref;
axiom (Barrier2 == $sub.ref(0, 15465));
procedure  Barrier2()
{
  var $i0: i32;
  var $i1: i32;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 692, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 692, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire();
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 693, 8} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, count);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 693, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 693, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, count, $i1);
  call {:cexpr "count"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 694, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, count);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 694, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 3);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 694, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 695, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, COND, 1);
  call {:cexpr "COND"} boogie_si_record_i8(1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 696, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, count, 0);
  call {:cexpr "count"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 696, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 698, 7} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 698, 56} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i8($M.0, COND);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 698, 56} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 698, 36} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i6);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 698, 68} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, COND, 0);
  call {:cexpr "COND"} boogie_si_record_i8(0);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 698, 73} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 699, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 699, 32} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const thr1: ref;
axiom (thr1 == $sub.ref(0, 16497));
procedure  thr1($p0: ref)
  returns ($r: ref)
{
$bb0:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 701, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 701, 3} true;
  assume {:verifier.code 0} true;
  call Barrier2();
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 702, 14} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 702, 24} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 702, 38} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 702, 38} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 704, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 708, 1} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 710, 1} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 712, 1} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thr1, $0.ref);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 713, 7} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 713, 20} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 3);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 713, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 713, 31} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 714, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/40_barrier_vf_tmp.c", 713, 25} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i6, 1);
...
axiom (__VERIFIER_assume == $sub.ref(0, 19593));
...
axiom (__SMACK_code == $sub.ref(0, 20625));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 22689));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 23721));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 24753));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 25785));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 26817));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 27849));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 28881));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 29913));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 30945));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 31977));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 33009));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 34041));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 35073));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 36105));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 37137));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 38169));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 39201));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 40233));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 41265));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 42297));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 43329));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 44361));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 45393));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 46425));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 47457));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 48489));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 49521));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 50553));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 51585));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 52617));
...
axiom (llvm.dbg.value == $sub.ref(0, 53649));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54681));
