...
{
$bb0:
  assume {:sourceloc "./output/triangular-2_tmp.c", 7, 20} true;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/triangular-2_tmp.c", 15, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-2_tmp.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/triangular-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-2_tmp.c", 15, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/triangular-2_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/triangular-2_tmp.c", 16, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-2_tmp.c", 17, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "./output/triangular-2_tmp.c", 17, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/triangular-2_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $M.1 := $i4;
  call {:cexpr "i"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/triangular-2_tmp.c", 18, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-2_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/triangular-2_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/triangular-2_tmp.c", 15, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/triangular-2_tmp.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./output/triangular-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/triangular-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/triangular-2_tmp.c", 24, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/triangular-2_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/triangular-2_tmp.c", 25, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-2_tmp.c", 26, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/triangular-2_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "./output/triangular-2_tmp.c", 26, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $i4;
  call {:cexpr "j"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/triangular-2_tmp.c", 27, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-2_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/triangular-2_tmp.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "./output/triangular-2_tmp.c", 29, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb4:
  assume {:sourceloc "./output/triangular-2_tmp.c", 24, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
  call {:cexpr "k"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/triangular-2_tmp.c", 24, 3} true;
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/triangular-2_tmp.c", 30, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/triangular-2_tmp.c", 35, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-2_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p3, $0.ref, t2, $0.ref);
  assume {:sourceloc "./output/triangular-2_tmp.c", 38, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-2_tmp.c", 39, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $M.1;
  assume {:sourceloc "./output/triangular-2_tmp.c", 39, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sge.i32($i6, 16);
  assume {:sourceloc "./output/triangular-2_tmp.c", 39, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-2_tmp.c", 40, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-2_tmp.c", 42, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/triangular-2_tmp.c", 43, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $M.0;
  assume {:sourceloc "./output/triangular-2_tmp.c", 43, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $sge.i32($i9, 16);
  assume {:sourceloc "./output/triangular-2_tmp.c", 43, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/triangular-2_tmp.c", 44, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/triangular-2_tmp.c", 46, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/triangular-2_tmp.c", 46, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/triangular-2_tmp.c", 46, 23} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/triangular-2_tmp.c", 46, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/triangular-2_tmp.c", 46, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/triangular-2_tmp.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "./output/triangular-2_tmp.c", 47, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/triangular-2_tmp.c", 47, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/triangular-2_tmp.c", 47, 27} true;
  assume {:verifier.code 0} true;
