...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/lazy01-O0.bpl /Users/ponce/git/Dat3M/./output/lazy01_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 55751));
...
const mutex: ref;
axiom (mutex == $sub.ref(0, 2084));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 3122));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 4154));
const {:count 3} .str.1.1: ref;
axiom (.str.1.1 == $sub.ref(0, 5181));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 6219));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 7247));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 8279));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/lazy01_tmp.c", 2, 44} true;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/lazy01_tmp.c", 688, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lazy01_tmp.c", 688, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 689, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, data);
  assume {:sourceloc "./output/lazy01_tmp.c", 689, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "./output/lazy01_tmp.c", 689, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, data, $i3);
  call {:cexpr "data"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/lazy01_tmp.c", 690, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 691, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 10343));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_mutex_lock: ref;
axiom (pthread_mutex_lock == $sub.ref(0, 11375));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 12407));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const thread2: ref;
axiom (thread2 == $sub.ref(0, 13439));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/lazy01_tmp.c", 695, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lazy01_tmp.c", 695, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 696, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, data);
  assume {:sourceloc "./output/lazy01_tmp.c", 696, 7} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $store.i32($M.0, data, $i3);
  call {:cexpr "data"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/lazy01_tmp.c", 697, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 698, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./output/lazy01_tmp.c", 702, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lazy01_tmp.c", 702, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 703, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, data);
  assume {:sourceloc "./output/lazy01_tmp.c", 703, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $sge.i32($i2, 3);
  assume {:sourceloc "./output/lazy01_tmp.c", 703, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/lazy01_tmp.c", 703, 17} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/lazy01_tmp.c", 707, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/lazy01_tmp.c", 708, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume {:sourceloc "./output/lazy01_tmp.c", 704, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/lazy01_tmp.c", 704, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/lazy01_tmp.c", 704, 27} true;
  assume {:verifier.code 0} true;
...
const abort: ref;
axiom (abort == $sub.ref(0, 15503));
procedure  abort();
const main: ref;
axiom (main == $sub.ref(0, 16535));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/lazy01_tmp.c", 712, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume true;
  assume {:sourceloc "./output/lazy01_tmp.c", 714, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread1, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 715, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread2, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 716, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread3, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 717, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p0);
  assume {:sourceloc "./output/lazy01_tmp.c", 717, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 718, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.0, $p1);
  assume {:sourceloc "./output/lazy01_tmp.c", 718, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_join($i9, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 719, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i64($M.0, $p2);
  assume {:sourceloc "./output/lazy01_tmp.c", 719, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_join($i11, $0.ref);
  assume {:sourceloc "./output/lazy01_tmp.c", 720, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_join == $sub.ref(0, 19631));
procedure  pthread_join($i0: i64, $p1: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 20663));
...
axiom (__SMACK_code == $sub.ref(0, 21695));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 22727));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 23759));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 24791));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 25823));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 26855));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 27887));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 28919));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 29951));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 30983));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 32015));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 33047));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 34079));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 35111));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 36143));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 37175));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 38207));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 39239));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 40271));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 41303));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 42335));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 43367));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 44399));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 45431));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 46463));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 47495));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 48527));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 49559));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 50591));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 51623));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 52655));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 53687));
...
axiom (llvm.dbg.value == $sub.ref(0, 54719));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 55751));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, data, 0);
