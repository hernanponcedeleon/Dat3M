...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/fib_bench-1-O0.bpl /Users/ponce/git/Dat3M/./output/fib_bench-1_tmp.c
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 681, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 681, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 681, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 681, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 682, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 683, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, j);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 683, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, i);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 683, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 684, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 685, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 686, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 681, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 687, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 692, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 692, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 692, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 693, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 694, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, i);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 694, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, j);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 694, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 695, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 696, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 697, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 697, 3} true;
  assume {:verifier.code 0} true;
  assume false;
$bb4:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 692, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  call {:cexpr "k"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 692, 3} true;
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 698, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 703, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 704, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p3, $0.ref, t2, $0.ref);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 705, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 706, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, i);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 706, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sgt.i32($i6, 144);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 706, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 707, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 708, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 709, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, j);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 709, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $sgt.i32($i9, 144);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 709, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 710, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 711, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 711, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 711, 23} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 711, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 711, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 714, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 712, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 712, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/fib_bench-1_tmp.c", 712, 27} true;
  assume {:verifier.code 0} true;
