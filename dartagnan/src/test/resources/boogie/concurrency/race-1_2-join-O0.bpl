...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/race-1_2-join-O0.bpl /Users/ponce/git/Dat3M/./output/race-1_2-join_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 59879));
...
const mutex: ref;
axiom (mutex == $sub.ref(0, 1056));
const pdev: ref;
axiom (pdev == $sub.ref(0, 2084));
const t1: ref;
axiom (t1 == $sub.ref(0, 3116));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4154));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 5186));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 6213));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 7251));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 8279));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 9311));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1681, 44} true;
...
axiom (ldv_assert == $sub.ref(0, 10343));
procedure  ldv_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ldv_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1683, 40} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1683, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1683, 88} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1683, 52} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1683, 62} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1683, 76} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 11375));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 12407));
procedure  abort();
const thread1: ref;
axiom (thread1 == $sub.ref(0, 13439));
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1688, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1688, 4} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1689, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 6);
  call {:cexpr "pdev"} boogie_si_record_i32(6);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1690, 4} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1691, 4} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i10: i32;
$bb0:
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1694, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1694, 4} true;
  assume {:verifier.code 0} true;
  call $i0 := pthread_mutex_init(mutex, $0.ref);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1695, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 1);
  call {:cexpr "pdev"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1696, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, pdev);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1696, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1696, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1696, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i3);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1697, 7} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1698, 7} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create(t1, $0.ref, thread1, $0.ref);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1699, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 2);
  call {:cexpr "pdev"} boogie_si_record_i32(2);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1700, 18} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, pdev);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1700, 22} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, 2);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1700, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1700, 7} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i9);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1701, 7} true;
  assume {:verifier.code 0} true;
  $i10 := 0;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1703, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 3);
  call {:cexpr "pdev"} boogie_si_record_i32(3);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1704, 15} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, pdev);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1704, 19} true;
  assume {:verifier.code 0} true;
  $i12 := $eq.i32($i11, 3);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1704, 19} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1704, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i13);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1705, 4} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_mutex_destroy(mutex);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1706, 4} true;
  assume {:verifier.code 0} true;
  $i10 := $sub.i32(0, 1);
  goto $bb3;
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1707, 1} true;
  assume {:verifier.code 0} true;
  $r := $i10;
  $exn := false;
  return;
...
procedure  module_exit()
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1710, 17} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i1 := $load.i64($M.0, t1);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1710, 4} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_join($i1, $p0);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1711, 4} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_destroy(mutex);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1712, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, pdev, 5);
  call {:cexpr "pdev"} boogie_si_record_i32(5);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1713, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, pdev);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1713, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 5);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1713, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1713, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i6);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1714, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 21695));
procedure  pthread_join($i0: i64, $p1: ref)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 22727));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1716, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1716, 8} true;
  assume {:verifier.code 0} true;
  call $i0 := module_init();
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1716, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1716, 8} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1716, 26} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1717, 5} true;
  assume {:verifier.code 0} true;
  call module_exit();
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1717, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-1_2-join_tmp.c", 1719, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 23759));
...
axiom (__SMACK_code == $sub.ref(0, 24791));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 25823));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 26855));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 27887));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 28919));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 29951));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 30983));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 32015));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 33047));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 34079));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 35111));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 36143));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 37175));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 38207));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 39239));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 40271));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 41303));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 42335));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 43367));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 44399));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 45431));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 46463));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 47495));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 48527));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 49559));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 50591));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 51623));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 52655));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 53687));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 54719));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 55751));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 56783));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 57815));
...
axiom (llvm.dbg.value == $sub.ref(0, 58847));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 59879));
