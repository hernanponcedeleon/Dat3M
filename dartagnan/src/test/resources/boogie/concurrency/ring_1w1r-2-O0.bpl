...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/ring_1w1r-2.bpl /Users/ponce/git/Dat3M/../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c
...
{
$bb0:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/svc.h", 6, 22} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/svc.h", 6, 33} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const ring_enqueue: ref;
axiom (ring_enqueue == $sub.ref(0, 2064));
procedure  ring_enqueue($p0: ref, $i1: i64)
{
  var $p2: ref;
  var $i3: i64;
  var $i4: i64;
  ...
  var $p17: ref;
$bb0:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ring_enqueue:arg:x"} boogie_si_record_i64($i1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 17} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(40, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i64($M.0, $p2);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i64($i3, 1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $srem.i64($i4, 4);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 42} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(0, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 42} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p6);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 36} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i64($i5, $i7);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 23, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i8 == 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 24, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(8, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 24, 14} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(40, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 24, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i64($M.0, $p10);
  $p12 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(8, 1)), $mul.ref($i11, 8));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 24, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p12, $i1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 25, 21} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(40, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 25, 21} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i64($M.0, $p13);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 25, 28} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i64($i14, 1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 25, 33} true;
  assume {:verifier.code 0} true;
  $i16 := $srem.i64($i15, 4);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 25, 8} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(40, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 25, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p17, $i16);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 26, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
const ring_dequeue: ref;
axiom (ring_dequeue == $sub.ref(0, 4128));
procedure  ring_dequeue($p0: ref)
  returns ($r: i64)
{
  var $p1: ref;
  var $p2: ref;
  ...
  var $p10: ref;
$bb0:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 29, 17} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 29, 17} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(8, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 29, 23} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(0, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 29, 23} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i64($M.0, $p2);
  $p4 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(8, 1)), $mul.ref($i3, 8));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 29, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i64($M.0, $p4);
  call {:cexpr "x"} boogie_si_record_i64($i5);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 30, 21} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(0, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 30, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p6);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 30, 28} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i64($i7, 1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 30, 33} true;
  assume {:verifier.code 0} true;
  $i9 := $srem.i64($i8, 4);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 30, 8} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(0, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 30, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p10, $i9);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 31, 5} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
}
const ring_empty: ref;
axiom (ring_empty == $sub.ref(0, 5160));
procedure  ring_empty($p0: ref)
  returns ($r: i1)
{
  var $p1: ref;
  var $i2: i64;
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 35, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 35, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, $p1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 35, 28} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(40, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 35, 28} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i64($M.0, $p3);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 35, 22} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i64($i2, $i4);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 35, 5} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
const ring_init: ref;
axiom (ring_init == $sub.ref(0, 6192));
procedure  ring_init($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
$bb0:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 39, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 39, 20} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(40, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 39, 27} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p1, 0);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 39, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 48)), $mul.ref(0, 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 39, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p2, 0);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 40, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const reader_fn: ref;
axiom (reader_fn == $sub.ref(0, 7224));
procedure  reader_fn($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $i2: i64;
  ...
  var $i11: i1;
$bb0:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 43, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 43, 15} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 45, 5} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 45, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i64($i3, 8);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 45, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 46, 14} true;
  assume {:verifier.code 0} true;
  call $i5 := ring_empty($p1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 46, 14} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 53, 5} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i64($i2, 8);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 53, 5} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 47, 13} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := $i2, $i3;
  goto $bb1;
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 48, 15} true;
  assume {:verifier.code 0} true;
  call $i6 := ring_dequeue($p1);
  call {:cexpr "val"} boogie_si_record_i64($i6);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 49, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i64($i2, 1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 49, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 51, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i64($i3, 1);
  call {:cexpr "i"} boogie_si_record_i64($i9);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 45, 5} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := $i6, $i9;
  goto $bb1;
...
$bb10:
  ...
  goto $bb11;
$bb11:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 54, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := ring_empty($p1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 54, 5} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb14;
$bb14:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 55, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const writer_fn: ref;
axiom (writer_fn == $sub.ref(0, 8256));
procedure  writer_fn($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $i2: i64;
  ...
  var $i5: i64;
$bb0:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 60, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 60, 15} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 61, 11} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 61, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i64($i2, 8);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 61, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 63, 28} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i64($i2, 1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 63, 9} true;
  assume {:verifier.code 0} true;
  call ring_enqueue($p1, $i4);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 65, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 66, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 61, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i64($i2, 1);
  call {:cexpr "i"} boogie_si_record_i64($i5);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring.h", 61, 5} true;
  assume {:verifier.code 0} true;
  $i2 := $i5;
  goto $bb1;
...
$bb0:
  call $initialize();
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 10, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(48, $zext.i32.i64(1)));
  assume true;
  assume true;
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 10, 5} true;
  assume {:verifier.code 0} true;
  call ring_init($p1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 11, 48} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 11, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, reader_fn, $p2);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 12, 16} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 12, 5} true;
  assume {:verifier.code 0} true;
  call $p5 := writer_fn($p4);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 13, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 13, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "../sv-benchmarks/c/pthread-divine/ring_1w1r-2.c", 14, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_join == $sub.ref(0, 11352));
...
axiom (__VERIFIER_assert == $sub.ref(0, 15480));
...
axiom (llvm.dbg.value == $sub.ref(0, 29928));
