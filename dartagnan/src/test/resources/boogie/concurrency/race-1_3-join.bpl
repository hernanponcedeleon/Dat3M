...
procedure ldv_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 8, 40} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ldv_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 8, 40} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 8, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 8, 83} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 8, 52} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 8, 61} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 15, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 15, 4} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(mutex);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := 6;
  call {:cexpr "pdev"} boogie_si_record_i32(6);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 17, 4} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_unlock(mutex);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 18, 4} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 22, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 22, 4} true;
  assume {:verifier.code 0} true;
  call $i0 := pthread_mutex_init(mutex, $0.ref);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 24, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "pdev"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 25, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i3);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 26, 7} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 28, 7} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create(t1, $0.ref, thread1, $0.ref);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 32, 7} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := 3;
  call {:cexpr "pdev"} boogie_si_record_i32(3);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $M.0;
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 36, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 3);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 36, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i32($i9);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 36, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i10);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 37, 4} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_mutex_destroy(mutex);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 38, 4} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32(0, 1);
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 39, 1} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
...
procedure module_exit()
{
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 44, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := 4;
  call {:cexpr "pdev"} boogie_si_record_i32(4);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 45, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 45, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 4);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 45, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 45, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i3);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 46, 17} true;
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.1, t1);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 46, 4} true;
  assume {:verifier.code 0} true;
  call $i5 := __pthread_join($p4, $p0);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 47, 4} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_destroy(mutex);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 49, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := 5;
  call {:cexpr "pdev"} boogie_si_record_i32(5);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 50, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $M.0;
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 50, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, 5);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 50, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 50, 4} true;
  assume {:verifier.code 0} true;
  call ldv_assert($i9);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 51, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 54, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 54, 8} true;
  assume {:verifier.code 0} true;
  call $i0 := module_init();
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 54, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 54, 8} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 54, 26} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 55, 5} true;
  assume {:verifier.code 0} true;
  call module_exit();
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 55, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/race-1_3-join_tmp.c", 57, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
