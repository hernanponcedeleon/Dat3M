  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 17, 8} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 17, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 17, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 18, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 19, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 19, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $M.1;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 19, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 20, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 17, 25} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 23, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 30, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 30, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 30, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 31, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 32, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 32, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $M.0;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 32, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 33, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  ...
  assume false;
$bb4:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 30, 25} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  call {:cexpr "k"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 30, 3} true;
  ...
  goto $bb1;
$bb5:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 43, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 46, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 47, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $M.1;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 47, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sge.i32($i6, 144);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 47, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 48, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 50, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 51, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $M.0;
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 51, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $sge.i32($i9, 144);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 51, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 52, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 54, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 54, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 54, 23} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 54, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 54, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 58, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "./output/fib_bench-2_tmp.c", 55, 12} true;
  assume {:verifier.code 0} true;
