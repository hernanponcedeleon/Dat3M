...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 53641));
...
const m_inode: ref;
axiom (m_inode == $sub.ref(0, 1028));
const m_busy: ref;
axiom (m_busy == $sub.ref(0, 2056));
const inode: ref;
axiom (inode == $sub.ref(0, 3084));
const busy: ref;
axiom (busy == $sub.ref(0, 4112));
const block: ref;
axiom (block == $sub.ref(0, 5140));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 6172));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 7199));
const {:count 14} .str.14: ref;
axiom (.str.14 == $sub.ref(0, 8237));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 9265));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 10297));
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 11329));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 12361));
procedure abort();
const __VERIFIER_atomic_acquire: ref;
axiom (__VERIFIER_atomic_acquire == $sub.ref(0, 13393));
procedure __VERIFIER_atomic_acquire($p0: ref)
{
  var $i1: i32;
  var $i2: i1;
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 14, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 14, 2} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, $p0);
  ...
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_release: ref;
axiom (__VERIFIER_atomic_release == $sub.ref(0, 14425));
procedure __VERIFIER_atomic_release($p0: ref)
{
  var $i1: i32;
  var $i2: i1;
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 20, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 20, 2} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, $p0);
  ...
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 22, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const thr1: ref;
axiom (thr1 == $sub.ref(0, 15457));
procedure thr1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 32, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 32, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire(m_inode);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 33, 6} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 33, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 33, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 34, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire(m_busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 35, 10} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "busy"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 36, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release(m_busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 37, 11} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "inode"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 38, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 33, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 39, 9} true;
  assume {:verifier.code 0} true;
  $M.3 := 1;
  call {:cexpr "block"} boogie_si_record_i32(1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 40, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $M.3;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 40, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 41, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release(m_inode);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const thr2: ref;
axiom (thr2 == $sub.ref(0, 16489));
procedure thr2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 48, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 48, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire(m_busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 49, 6} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 49, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 49, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 50, 11} true;
  assume {:verifier.code 0} true;
  $M.3 := 0;
  call {:cexpr "block"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $M.3;
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 51, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 53, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release(m_busy);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 55, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 52, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !(($i4 == 1));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 62, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 62, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($p0, $0.ref, thr1, $0.ref);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 63, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := thr2($0.ref);
  assume {:sourceloc "./output/19_time_var_mutex_tmp.c", 65, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 18553));
procedure pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 19585));
...
axiom (__SMACK_code == $sub.ref(0, 20617));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 21649));
...
axiom (__VERIFIER_error == $sub.ref(0, 22681));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 23713));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 24745));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 25777));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 26809));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 27841));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 28873));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 29905));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 30937));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 31969));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 33001));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 34033));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 35065));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 36097));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 37129));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 38161));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 39193));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 40225));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 41257));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 42289));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 43321));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 44353));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 45385));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 46417));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 47449));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 48481));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 49513));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 50545));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 51577));
...
axiom (llvm.dbg.value == $sub.ref(0, 52609));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 53641));
procedure __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, m_inode, 0);
  call {:cexpr "m_inode"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, m_busy, 0);
  call {:cexpr "m_busy"} boogie_si_record_i32(0);
  $M.1 := 0;
