...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/jm2006.c.i.v+cfa-reducer-O3.bpl /Users/ponce/git/Dat3M/./output/jm2006.c.i.v+cfa-reducer_tmp.c
...
const __return_72: ref;
axiom (__return_72 == $sub.ref(0, 2056));
...
axiom (llvm.dbg.value == $sub.ref(0, 8251));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 16, 12} true;
  ...
  call {:cexpr "main__i"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 17, 12} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i1);
  call {:cexpr "main__j"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 18, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.bv32($i0, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 18, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 24, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $sgt.bv32($i1, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
$bb2:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bv32($M.0, __return_main);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 20, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 69, 2} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1bv1);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 43, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.bv32($i1, $i0);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 43, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb6, $bb7;
$bb5:
  assume !(($i5 == 1bv1));
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 26, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bv32($M.0, __return_main);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 26, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i7;
  goto $bb3;
$bb6:
  assume ($i6 == 1bv1);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 57, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, __return_72, 0bv32);
  call {:cexpr "__return_72"} boogie_si_record_bv32(0bv32);
  assume {:verifier.code 0} true;
  $i4 := 0bv32;
  goto $bb3;
$bb7:
  assume !(($i6 == 1bv1));
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 64, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bv32($M.0, __return_main);
  assume {:sourceloc "./output/jm2006.c.i.v+cfa-reducer_tmp.c", 64, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i8;
  goto $bb3;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 10315));
...
axiom (__SMACK_code == $sub.ref(0, 11347));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 12379));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 13411));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 14443));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 15475));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 16507));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 17539));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 18571));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 19603));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 20635));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 21667));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 22699));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 23731));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 24763));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 25795));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 26827));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 27859));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 28891));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 29923));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 30955));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 31987));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 33019));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 34051));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 35083));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 36115));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 37147));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 38179));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 39211));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 40243));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 41275));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 42307));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 43339));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 44371));
