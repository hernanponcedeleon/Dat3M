...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sum04-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum04-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sum04-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sum04-2_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sum04-2_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum04-2_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum04-2_tmp.c", 13, 7} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/sum04-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum04-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum04-2_tmp.c", 13, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $sle.i32($i0, 8);
  assume {:sourceloc "./output/sum04-2_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sum04-2_tmp.c", 14, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i1, 2);
  call {:cexpr "sn"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/sum04-2_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sum04-2_tmp.c", 16, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i1, 16);
  assume {:sourceloc "./output/sum04-2_tmp.c", 16, 32} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  assume {:branchcond $i5} true;
  goto $bb5, $bb7;
$bb4:
  assume {:sourceloc "./output/sum04-2_tmp.c", 13, 22} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i0, 1);
...
$bb6:
  ...
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i6);
  assume {:sourceloc "./output/sum04-2_tmp.c", 16, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i8);
  assume {:sourceloc "./output/sum04-2_tmp.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb7:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/sum04-2_tmp.c", 16, 38} true;
  assume {:verifier.code 1} true;
  $i7 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/sum04-2_tmp.c", 16, 32} true;
  assume {:verifier.code 0} true;
