...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/vnew2_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/vnew2_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/vnew2_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/vnew2_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/vnew2_tmp.c", 7, 16} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/vnew2_tmp.c", 8, 12} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/vnew2_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/vnew2_tmp.c", 16, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/vnew2_tmp.c", 17, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/vnew2_tmp.c", 17, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5 := 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/vnew2_tmp.c", 17, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/vnew2_tmp.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  ...
  assume {:sourceloc "./output/vnew2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vnew2_tmp.c", 19, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i4, $i0);
  assume {:sourceloc "./output/vnew2_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i4, 3);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/vnew2_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i5, 3);
...
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/vnew2_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $ugt.i32($i0, 0);
  assume {:sourceloc "./output/vnew2_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb7, $bb8;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 24} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i4, $i5);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 28} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 32} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i5, $i3);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 36} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb12:
  ...
  assume {:verifier.code 1} true;
  $i18 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 4} true;
  assume {:verifier.code 1} true;
...
$bb13:
  assume ($i13 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 43} true;
  assume {:verifier.code 1} true;
  $i14 := $M.0;
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 47} true;
  assume {:verifier.code 1} true;
  $i15 := $add.i32($i14, 2);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 41} true;
  assume {:verifier.code 1} true;
  $i16 := $urem.i32($i4, $i15);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 36} true;
  assume {:verifier.code 1} true;
