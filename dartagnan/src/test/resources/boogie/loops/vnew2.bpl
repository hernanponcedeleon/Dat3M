...
{
$bb0:
  assume {:sourceloc "./output/vnew2_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/vnew2_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/vnew2_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/vnew2_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/vnew2_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/vnew2_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/vnew2_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/vnew2_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/vnew2_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/vnew2_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/vnew2_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/vnew2_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5 := 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/vnew2_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/vnew2_tmp.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/vnew2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vnew2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vnew2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vnew2_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i4, $i0);
  assume {:sourceloc "./output/vnew2_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i4, 3);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/vnew2_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i5, 3);
  call {:cexpr "j"} boogie_si_record_i32($i8);
  assume {:sourceloc "./output/vnew2_tmp.c", 23, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i3, 3);
...
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $ugt.i32($i0, 0);
  assume {:sourceloc "./output/vnew2_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb7, $bb8;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 24} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i4, $i5);
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 28} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/vnew2_tmp.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 32} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i5, $i3);
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 36} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb12:
  ...
  assume {:verifier.code 1} true;
  $i18 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 4} true;
  assume {:verifier.code 1} true;
...
$bb13:
  assume ($i13 == 1);
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 43} true;
  assume {:verifier.code 1} true;
  $i14 := $M.0;
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 47} true;
  assume {:verifier.code 1} true;
  $i15 := $add.i32($i14, 2);
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 41} true;
  assume {:verifier.code 1} true;
  $i16 := $urem.i32($i4, $i15);
  assume {:sourceloc "./output/vnew2_tmp.c", 26, 36} true;
  assume {:verifier.code 1} true;
