...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/id_trans_tmp.c", 25, 10} true;
  ...
  call {:cexpr "nlen"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/id_trans_tmp.c", 26, 17} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i1);
  call {:cexpr "idBitLength"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/id_trans_tmp.c", 27, 21} true;
  assume {:verifier.code 0} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  call {:cexpr "material_length"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/id_trans_tmp.c", 28, 34} true;
  assume {:verifier.code 0} true;
  $i3 := $sdiv.i32($i1, 32);
  assume {:sourceloc "./output/id_trans_tmp.c", 28, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i0, $i3);
  assume {:sourceloc "./output/id_trans_tmp.c", 28, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "./output/id_trans_tmp.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb4;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/id_trans_tmp.c", 28, 42} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/id_trans_tmp.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/id_trans_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/id_trans_tmp.c", 30, 32} true;
  assume {:verifier.code 0} true;
  $i6 := $sdiv.i32($i1, 8);
  assume {:sourceloc "./output/id_trans_tmp.c", 30, 18} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i5, $i6);
  assume {:sourceloc "./output/id_trans_tmp.c", 30, 37} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
...
$bb5:
  assume ($i7 == 1);
  assume {:sourceloc "./output/id_trans_tmp.c", 30, 43} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.i32($i5, $i2);
  assume {:verifier.code 0} true;
  $i8 := $i9;
...
$bb7:
  assume {:sourceloc "./output/id_trans_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/id_trans_tmp.c", 30, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i8 == 1);
  assume {:sourceloc "./output/id_trans_tmp.c", 31, 26} true;
  assume {:verifier.code 0} true;
  $i10 := $sle.i32(0, $i5);
  assume {:sourceloc "./output/id_trans_tmp.c", 31, 26} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/id_trans_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  call $i12 := __VERIFIER_assert.i32($i11);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i12);
  assume {:sourceloc "./output/id_trans_tmp.c", 32, 26} true;
  assume {:verifier.code 0} true;
  $i13 := $slt.i32($i5, $i2);
  assume {:sourceloc "./output/id_trans_tmp.c", 32, 26} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "./output/id_trans_tmp.c", 32, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := __VERIFIER_assert.i32($i14);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/id_trans_tmp.c", 33, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $sdiv.i32($i5, 4);
  assume {:sourceloc "./output/id_trans_tmp.c", 33, 26} true;
  assume {:verifier.code 0} true;
  $i17 := $sle.i32(0, $i16);
  assume {:sourceloc "./output/id_trans_tmp.c", 33, 26} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i1.i32($i17);
  assume {:sourceloc "./output/id_trans_tmp.c", 33, 5} true;
  assume {:verifier.code 0} true;
  call $i19 := __VERIFIER_assert.i32($i18);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i19);
  assume {:sourceloc "./output/id_trans_tmp.c", 34, 25} true;
  assume {:verifier.code 0} true;
  $i20 := $sdiv.i32($i5, 4);
  assume {:sourceloc "./output/id_trans_tmp.c", 34, 28} true;
  assume {:verifier.code 0} true;
  $i21 := $slt.i32($i20, $i0);
  assume {:sourceloc "./output/id_trans_tmp.c", 34, 28} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i1.i32($i21);
  assume {:sourceloc "./output/id_trans_tmp.c", 34, 5} true;
  assume {:verifier.code 0} true;
  call $i23 := __VERIFIER_assert.i32($i22);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i23);
  assume {:sourceloc "./output/id_trans_tmp.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/id_trans_tmp.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb10:
  assume {:sourceloc "./output/id_trans_tmp.c", 30, 64} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i5, 1);
