...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/even-O3.bpl /Users/ponce/git/Dat3M/./output/even_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/even_tmp.c", 12, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/even_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i1 == 1bv1);
  assume {:sourceloc "./output/even_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
