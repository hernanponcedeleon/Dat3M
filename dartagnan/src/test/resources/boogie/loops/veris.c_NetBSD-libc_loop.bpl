...
{
$bb0:
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: i32)
{
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 19, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 19, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $p0;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 19, 23} true;
  assume {:verifier.code 0} true;
  $i3 := $ule.ref($p2, $p1);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 21, 26} true;
  assume {:verifier.code 1} true;
  $p4 := $M.0;
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 21, 24} true;
  assume {:verifier.code 1} true;
  $i5 := $ule.ref($p2, $p4);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 21, 24} true;
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 21, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i6);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p2, 1);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 19, 36} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 32, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 34, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 34, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $p8;
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 36, 10} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 4));
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := glob2($p9, $p4);
  assume {:sourceloc "./output/veris.c_NetBSD-libc_loop_tmp.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
