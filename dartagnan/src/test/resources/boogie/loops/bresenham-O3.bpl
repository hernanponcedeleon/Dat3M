...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/bresenham-O3.bpl /Users/ponce/git/Dat3M/./output/bresenham_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/bresenham_tmp.c", 6, 44} true;
...
$bb0:
  ...
  assume {:sourceloc "./output/bresenham_tmp.c", 24, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/bresenham_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $shl.bv32($i1, 1bv32);
  assume {:sourceloc "./output/bresenham_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.bv32($i2, $i0);
  call {:cexpr "v"} boogie_si_record_bv32($i3);
  assume {:sourceloc "./output/bresenham_tmp.c", 30, 31} true;
  assume {:verifier.code 0} true;
  $i4 := $mul.bv32($i0, $sub.bv32(0bv32, 2bv32));
  assume {:verifier.code 0} true;
  $i5 := $sub.bv32($i1, $i0);
  assume {:verifier.code 0} true;
  $i6 := $shl.bv32($i5, 1bv32);
  assume {:sourceloc "./output/bresenham_tmp.c", 31, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.bv32($i0, 0bv32);
  assume {:sourceloc "./output/bresenham_tmp.c", 31, 13} true;
  assume {:verifier.code 0} true;
  $i8, $i9, $i10, $i11, $i12, $i13, $i14 := 0bv32, 0bv32, 0bv32, $i3, $i3, 0bv32, 0bv32;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  $i29 := $mul.bv32($i10, $i9);
  assume {:sourceloc "./output/bresenham_tmp.c", 43, 37} true;
  assume {:verifier.code 0} true;
  $i30 := $sub.bv32($i3, $i11);
  assume {:sourceloc "./output/bresenham_tmp.c", 43, 41} true;
  assume {:verifier.code 0} true;
  $i31 := $add.bv32($i30, $i8);
  assume {:sourceloc "./output/bresenham_tmp.c", 43, 47} true;
  assume {:verifier.code 0} true;
  $i32 := $add.bv32($i31, $i29);
  assume {:sourceloc "./output/bresenham_tmp.c", 43, 54} true;
  assume {:verifier.code 0} true;
  $i33 := $shl.bv32($i9, 1bv32);
  assume {:sourceloc "./output/bresenham_tmp.c", 43, 57} true;
  assume {:verifier.code 0} true;
  $i34 := $sub.bv32(0bv32, $i33);
  assume {:sourceloc "./output/bresenham_tmp.c", 43, 57} true;
  assume {:verifier.code 0} true;
  $i35 := $eq.bv32($i32, $i34);
  assume {:sourceloc "./output/bresenham_tmp.c", 13, 9} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/bresenham_tmp.c", 35, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.bv32($i12, 0bv32);
  assume {:sourceloc "./output/bresenham_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  $i17 := (if ($i16 == 1bv1) then $i2 else $i6);
  assume {:sourceloc "./output/bresenham_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  $i18 := $xor.bv1($i16, 1bv1);
  assume {:sourceloc "./output/bresenham_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.bv1.bv32($i18);
  assume {:sourceloc "./output/bresenham_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  $i20 := $add.bv32($i14, $i19);
  assume {:sourceloc "./output/bresenham_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i21 := $add.bv32($i17, $i12);
  assume {:sourceloc "./output/bresenham_tmp.c", 41, 10} true;
  assume {:verifier.code 0} true;
  $i22 := $add.bv32($i13, 1bv32);
  assume {:sourceloc "./output/bresenham_tmp.c", 30, 23} true;
  assume {:verifier.code 0} true;
  $i23 := $mul.bv32($i22, $i2);
  assume {:verifier.code 0} true;
  $i24 := $mul.bv32($i4, $i20);
  assume {:sourceloc "./output/bresenham_tmp.c", 30, 34} true;
  assume {:verifier.code 0} true;
  $i25 := $add.bv32($i3, $i23);
  assume {:sourceloc "./output/bresenham_tmp.c", 30, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $add.bv32($i25, $i24);
  assume {:sourceloc "./output/bresenham_tmp.c", 30, 48} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.bv32($i26, $i21);
  assume {:sourceloc "./output/bresenham_tmp.c", 13, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i27 == 1bv1));
  assume {:sourceloc "./output/bresenham_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/bresenham_tmp.c", 15, 24} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/bresenham_tmp.c", 15, 24} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i15 == 1bv1);
  assume {:verifier.code 0} true;
  $i12, $i13, $i14 := $i21, $i22, $i20;
  goto $bb4;
$bb8:
  assume !(($i15 == 1bv1));
  assume {:sourceloc "./output/bresenham_tmp.c", 31, 13} true;
  assume {:verifier.code 0} true;
  $i28 := $mul.bv32($i22, $sub.bv32(0bv32, 2bv32));
  assume {:sourceloc "./output/bresenham_tmp.c", 31, 13} true;
  assume {:verifier.code 0} true;
  $i8, $i9, $i10, $i11 := $i23, $i20, $i28, $i21;
  goto $bb2;
$bb9:
  assume ($i35 == 1bv1);
  assume {:sourceloc "./output/bresenham_tmp.c", 45, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
