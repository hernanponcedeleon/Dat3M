...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt5_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt5_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/sumt5_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 7, 16} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/sumt5_tmp.c", 8, 12} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/sumt5_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt5_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt5_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt5_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8 := 0, 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt5_tmp.c", 35, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt5_tmp.c", 16, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 16, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 15, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 19, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $ult.i32($i5, $i0);
  assume {:sourceloc "./output/sumt5_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i9 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $urem.i32($i5, 5);
  assume {:sourceloc "./output/sumt5_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 33, 23} true;
  assume {:verifier.code 1} true;
  $i38 := $add.i32($i8, $i6);
  assume {:sourceloc "./output/sumt5_tmp.c", 33, 25} true;
  assume {:verifier.code 1} true;
  $i39 := $add.i32($i38, $i7);
  assume {:sourceloc "./output/sumt5_tmp.c", 33, 27} true;
  assume {:verifier.code 1} true;
  $i40 := $add.i32($i39, $i3);
  assume {:sourceloc "./output/sumt5_tmp.c", 33, 30} true;
  assume {:verifier.code 1} true;
  $i41 := $add.i32($i40, $i4);
  assume {:sourceloc "./output/sumt5_tmp.c", 33, 35} true;
  assume {:verifier.code 1} true;
  $i42 := $eq.i32($i41, $i5);
  assume {:sourceloc "./output/sumt5_tmp.c", 33, 35} true;
  assume {:verifier.code 1} true;
  $i43 := $zext.i1.i32($i42);
  assume {:sourceloc "./output/sumt5_tmp.c", 33, 3} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i18 := $urem.i32($i5, 4);
  assume {:sourceloc "./output/sumt5_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.i32($i18, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 23, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i4, 1);
  call {:cexpr "v3"} boogie_si_record_i32($i12);
  assume {:sourceloc "./output/sumt5_tmp.c", 22, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:sourceloc "./output/sumt5_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 31, 10} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i32($i5, 1);
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i25 := $urem.i32($i5, 3);
  assume {:sourceloc "./output/sumt5_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i26 := $ne.i32($i25, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 25, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i19 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i32($i3, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i20);
  assume {:sourceloc "./output/sumt5_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $urem.i32($i5, 2);
  assume {:sourceloc "./output/sumt5_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  assume {:sourceloc "./output/sumt5_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i32 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 30, 11} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i7, 1);
...
$bb17:
  assume !(($i32 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 28, 10} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i6, 1);
  call {:cexpr "j"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/sumt5_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $i34, $i35 := $i33, $i7;
  goto $bb18;
$bb18:
