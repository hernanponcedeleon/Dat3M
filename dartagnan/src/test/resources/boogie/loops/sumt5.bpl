...
{
$bb0:
  assume {:sourceloc "./output/sumt5_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt5_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt5_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt5_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sumt5_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sumt5_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt5_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt5_tmp.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt5_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/sumt5_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8 := 0, 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 19, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt5_tmp.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt5_tmp.c", 17, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 17, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $ult.i32($i5, $i0);
  assume {:sourceloc "./output/sumt5_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i9 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $urem.i32($i5, 5);
  assume {:sourceloc "./output/sumt5_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 34, 23} true;
  assume {:verifier.code 1} true;
  $i38 := $add.i32($i8, $i6);
  assume {:sourceloc "./output/sumt5_tmp.c", 34, 25} true;
  assume {:verifier.code 1} true;
  $i39 := $add.i32($i38, $i7);
  assume {:sourceloc "./output/sumt5_tmp.c", 34, 27} true;
  assume {:verifier.code 1} true;
  $i40 := $add.i32($i39, $i3);
  assume {:sourceloc "./output/sumt5_tmp.c", 34, 30} true;
  assume {:verifier.code 1} true;
  $i41 := $add.i32($i40, $i4);
  assume {:sourceloc "./output/sumt5_tmp.c", 34, 35} true;
  assume {:verifier.code 1} true;
  $i42 := $eq.i32($i41, $i5);
  assume {:sourceloc "./output/sumt5_tmp.c", 34, 35} true;
  assume {:verifier.code 1} true;
  $i43 := $zext.i1.i32($i42);
  assume {:sourceloc "./output/sumt5_tmp.c", 34, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i43);
  assume {:sourceloc "./output/sumt5_tmp.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i18 := $urem.i32($i5, 4);
  assume {:sourceloc "./output/sumt5_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.i32($i18, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 24, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i4, 1);
  call {:cexpr "v3"} boogie_si_record_i32($i12);
  assume {:sourceloc "./output/sumt5_tmp.c", 23, 6} true;
  assume {:verifier.code 0} true;
  $i13, $i14, $i15, $i16, $i17 := $i3, $i12, $i6, $i7, $i8;
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/sumt5_tmp.c", 17, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt5_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt5_tmp.c", 32, 10} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i32($i5, 1);
  call {:cexpr "l"} boogie_si_record_i32($i37);
  assume {:sourceloc "./output/sumt5_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8 := $i13, $i14, $i37, $i15, $i16, $i17;
  goto $bb4;
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i25 := $urem.i32($i5, 3);
  assume {:sourceloc "./output/sumt5_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i26 := $ne.i32($i25, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 26, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i19 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i32($i3, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i20);
  assume {:sourceloc "./output/sumt5_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $i21, $i22, $i23, $i24 := $i20, $i6, $i7, $i8;
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/sumt5_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i13, $i14, $i15, $i16, $i17 := $i21, $i4, $i22, $i23, $i24;
  goto $bb9;
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $urem.i32($i5, 2);
  assume {:sourceloc "./output/sumt5_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i32 := $ne.i32($i31, 0);
  assume {:sourceloc "./output/sumt5_tmp.c", 28, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i32} true;
  goto $bb16, $bb17;
$bb14:
  assume !(($i26 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 27, 12} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i8, 1);
  call {:cexpr "i"} boogie_si_record_i32($i27);
  assume {:sourceloc "./output/sumt5_tmp.c", 27, 6} true;
  assume {:verifier.code 0} true;
  $i28, $i29, $i30 := $i6, $i7, $i27;
  goto $bb15;
$bb15:
  assume {:sourceloc "./output/sumt5_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i21, $i22, $i23, $i24 := $i3, $i28, $i29, $i30;
  goto $bb12;
$bb16:
  assume ($i32 == 1);
  assume {:sourceloc "./output/sumt5_tmp.c", 31, 11} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i7, 1);
...
$bb17:
  assume !(($i32 == 1));
  assume {:sourceloc "./output/sumt5_tmp.c", 29, 10} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i6, 1);
  call {:cexpr "j"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/sumt5_tmp.c", 29, 5} true;
  assume {:verifier.code 0} true;
  $i34, $i35 := $i33, $i7;
  goto $bb18;
$bb18:
