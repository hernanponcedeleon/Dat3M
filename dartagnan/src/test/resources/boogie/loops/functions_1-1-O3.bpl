...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/functions_1-1-O3.bpl /Users/ponce/git/Dat3M/./output/functions_1-1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/functions_1-1_tmp.c", 23, 1} true;
