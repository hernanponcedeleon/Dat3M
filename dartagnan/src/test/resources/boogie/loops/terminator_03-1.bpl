...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 13, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i1, 0);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 16, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 18, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i0;
  goto $bb4;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 13, 7} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 23, 22} true;
  assume {:verifier.code 0} true;
  $i7 := $sle.i32($i1, 0);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 23, 26} true;
  assume {:verifier.code 0} true;
  $i8 := 1;
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, 100);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i4, $i1);
...
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb7:
...
$bb8:
  ...
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb9:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 23, 31} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.i32($i1, 0);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 23, 34} true;
  assume {:verifier.code 0} true;
  $i10 := 0;
...
$bb10:
  assume ($i9 == 1);
  assume {:sourceloc "./output/terminator_03-1_tmp.c", 23, 38} true;
  assume {:verifier.code 1} true;
  $i11 := $sge.i32($i3, 100);
  assume {:verifier.code 0} true;
  $i10 := $i11;
