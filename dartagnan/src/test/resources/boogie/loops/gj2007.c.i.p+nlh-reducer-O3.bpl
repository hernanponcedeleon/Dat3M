...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/gj2007.c.i.p+nlh-reducer-O3.bpl /Users/ponce/git/Dat3M/./output/gj2007.c.i.p+nlh-reducer_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 44371));
...
const __return_1121: ref;
axiom (__return_1121 == $sub.ref(0, 1028));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/gj2007.c.i.p+nlh-reducer_tmp.c", 448, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/gj2007.c.i.p+nlh-reducer_tmp.c", 448, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, __return_1121, 0bv32);
  call {:cexpr "__return_1121"} boogie_si_record_bv32(0bv32);
  assume {:sourceloc "./output/gj2007.c.i.p+nlh-reducer_tmp.c", 1257, 2} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
axiom (__SMACK_decls == $sub.ref(0, 39211));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 40243));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 41275));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 42307));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 43339));
...
axiom (__SMACK_static_init == $sub.ref(0, 44371));
