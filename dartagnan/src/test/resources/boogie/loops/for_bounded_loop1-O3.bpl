...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/for_bounded_loop1-O3.bpl /Users/ponce/git/Dat3M/./output/for_bounded_loop1_tmp.c
...
$bb2:
  ...
  call {:cexpr "y"} boogie_si_record_bv32($i5);
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i3 := $add.bv32($i2, 1bv32);
  call {:cexpr "i"} boogie_si_record_bv32($i3);
