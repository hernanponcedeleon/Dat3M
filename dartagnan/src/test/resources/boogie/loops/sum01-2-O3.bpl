...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum01-2-O3.bpl /Users/ponce/git/Dat3M/./output/sum01-2_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum01-2_tmp.c", 13, 12} true;
  ...
  assume {:sourceloc "./output/sum01-2_tmp.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
