...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/simple_3-2-O3.bpl /Users/ponce/git/Dat3M/./output/simple_3-2_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/simple_3-2_tmp.c", 14, 22} true;
  assume {:verifier.code 1} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/simple_3-2_tmp.c", 14, 22} true;
  assume {:verifier.code 1} true;
  call $i0 := __VERIFIER_nondet_ushort();
  call {:cexpr "smack:ext:__VERIFIER_nondet_ushort"} boogie_si_record_bv16($i0);
  call {:cexpr "N"} boogie_si_record_bv16($i0);
  assume {:sourceloc "./output/simple_3-2_tmp.c", 21, 1} true;
...
axiom (__VERIFIER_nondet_ushort == $sub.ref(0, 37155));
...
$bb0:
  ...
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_short"} boogie_si_record_bv16($i0);
  call {:cexpr "x"} boogie_si_record_bv16($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 258, 29} true;
  assume {:verifier.code 1} true;
  assume true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 38, 3} true;
