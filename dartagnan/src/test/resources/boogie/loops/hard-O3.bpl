...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/hard-O3.bpl /Users/ponce/git/Dat3M/./output/hard_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/hard_tmp.c", 7, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/hard_tmp.c", 24, 9} true;
  ...
  call {:cexpr "A"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/hard_tmp.c", 25, 9} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i1);
  call {:cexpr "B"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/hard_tmp.c", 26, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.bv32($i1, 1bv32);
  assume {:sourceloc "./output/hard_tmp.c", 11, 6} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := 1bv32, $i1;
...
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/hard_tmp.c", 11, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/hard_tmp.c", 11, 14} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/hard_tmp.c", 37, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.bv32($i0, $i4);
  assume {:sourceloc "./output/hard_tmp.c", 37, 13} true;
  assume {:verifier.code 0} true;
  $i6, $i7, $i8, $i9 := 0bv32, $i3, $i4, $i0;
  assume {:branchcond $i5} true;
  goto $bb5, $bb7;
$bb4:
  assume !(($i13 == 1bv1));
  assume {:sourceloc "./output/hard_tmp.c", 16, 10} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/hard_tmp.c", 16, 24} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/hard_tmp.c", 16, 24} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/hard_tmp.c", 45, 33} true;
  assume {:verifier.code 0} true;
  $i14 := $mul.bv32($i7, $i1);
  assume {:sourceloc "./output/hard_tmp.c", 45, 29} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.bv32($i8, $i14);
  assume {:sourceloc "./output/hard_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb10, $bb11;
$bb7:
  assume !(($i5 == 1bv1));
  assume {:sourceloc "./output/hard_tmp.c", 39, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $shl.bv32($i4, 1bv32);
  assume {:sourceloc "./output/hard_tmp.c", 40, 15} true;
  assume {:verifier.code 0} true;
  $i11 := $shl.bv32($i3, 1bv32);
  call {:cexpr "p"} boogie_si_record_bv32($i11);
  assume {:sourceloc "./output/hard_tmp.c", 36, 34} true;
  assume {:verifier.code 0} true;
  $i12 := $mul.bv32($i11, $i1);
  assume {:sourceloc "./output/hard_tmp.c", 36, 29} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.bv32($i10, $i12);
  assume {:sourceloc "./output/hard_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i15 == 1bv1);
  assume {:sourceloc "./output/hard_tmp.c", 47, 17} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.bv32($i7, 1bv32);
  assume {:sourceloc "./output/hard_tmp.c", 47, 13} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i16 == 1bv1);
  assume {:sourceloc "./output/hard_tmp.c", 57, 29} true;
  assume {:verifier.code 0} true;
  $i27 := $mul.bv32($i6, $i8);
  assume {:sourceloc "./output/hard_tmp.c", 57, 32} true;
  assume {:verifier.code 0} true;
  $i28 := $add.bv32($i27, $i9);
  assume {:sourceloc "./output/hard_tmp.c", 57, 25} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.bv32($i0, $i28);
  assume {:sourceloc "./output/hard_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume !(($i16 == 1bv1));
  assume {:sourceloc "./output/hard_tmp.c", 49, 15} true;
  assume {:verifier.code 0} true;
  $i17 := $sdiv.bv32($i8, 2bv32);
  assume {:sourceloc "./output/hard_tmp.c", 50, 15} true;
  assume {:verifier.code 0} true;
  $i18 := $sdiv.bv32($i7, 2bv32);
  assume {:sourceloc "./output/hard_tmp.c", 51, 15} true;
  assume {:verifier.code 0} true;
  $i19 := $slt.bv32($i9, $i17);
  assume {:sourceloc "./output/hard_tmp.c", 51, 13} true;
  assume {:verifier.code 0} true;
  $i20 := (if ($i19 == 1bv1) then 0bv32 else $i17);
  assume {:sourceloc "./output/hard_tmp.c", 51, 13} true;
  assume {:verifier.code 0} true;
  $i21 := $sub.bv32($i9, $i20);
  assume {:sourceloc "./output/hard_tmp.c", 51, 13} true;
  assume {:verifier.code 0} true;
  $i22 := (if ($i19 == 1bv1) then 0bv32 else $i18);
  assume {:sourceloc "./output/hard_tmp.c", 51, 13} true;
  assume {:verifier.code 0} true;
  $i23 := $add.bv32($i22, $i6);
  call {:cexpr "q"} boogie_si_record_bv32($i23);
  assume {:sourceloc "./output/hard_tmp.c", 44, 33} true;
  assume {:verifier.code 0} true;
  $i24 := $mul.bv32($i23, $i1);
  assume {:sourceloc "./output/hard_tmp.c", 44, 36} true;
  assume {:verifier.code 0} true;
  $i25 := $add.bv32($i24, $i21);
  assume {:sourceloc "./output/hard_tmp.c", 44, 29} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.bv32($i0, $i25);
  assume {:sourceloc "./output/hard_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume ($i26 == 1bv1);
  assume {:verifier.code 0} true;
  $i6, $i7, $i8, $i9 := $i23, $i18, $i17, $i21;
  goto $bb6;
$bb15:
  assume ($i29 == 1bv1);
  assume {:sourceloc "./output/hard_tmp.c", 58, 25} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.bv32($i1, $i8);
  assume {:sourceloc "./output/hard_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i30 == 1bv1);
  assume {:sourceloc "./output/hard_tmp.c", 59, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
