...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/aiob_4.c.v+nlh-reducer-O3.bpl /Users/ponce/git/Dat3M/./output/aiob_4.c.v+nlh-reducer_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 47460));
...
const .str: ref;
axiom (.str == $sub.ref(0, 3087));
const {:count 2} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4113));
const {:count 14} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 5151));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 6183));
const {:count 3} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 7210));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 8248));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 9276));
const main: ref;
axiom (main == $sub.ref(0, 10308));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/aiob_4.c.v+nlh-reducer_tmp.c", 159, 22} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/aiob_4.c.v+nlh-reducer_tmp.c", 159, 22} true;
  assume {:verifier.code 0} true;
  call $p0 := fopen(.str, .str.1);
  assume {:sourceloc "./output/aiob_4.c.v+nlh-reducer_tmp.c", 160, 24} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.ref($p0, $0.ref);
  assume {:sourceloc "./output/aiob_4.c.v+nlh-reducer_tmp.c", 160, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/aiob_4.c.v+nlh-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bytes.bv32($M.0, __return_main);
  assume {:sourceloc "./output/aiob_4.c.v+nlh-reducer_tmp.c", 2016, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1bv1));
  assume {:sourceloc "./output/aiob_4.c.v+nlh-reducer_tmp.c", 1241, 13} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.value == $sub.ref(0, 11340));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const fopen: ref;
axiom (fopen == $sub.ref(0, 12372));
...
axiom (__SMACK_dummy == $sub.ref(0, 15468));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 16500));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 17532));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 18564));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 19596));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 20628));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 21660));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 22692));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 23724));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 24756));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 25788));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 26820));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 27852));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 28884));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 29916));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 30948));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 31980));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 33012));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 34044));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 35076));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 36108));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 37140));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 38172));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 39204));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 40236));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 41268));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 42300));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 43332));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 44364));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 45396));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 46428));
...
axiom (__SMACK_static_init == $sub.ref(0, 47460));
