...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/string-2-O3.bpl /Users/ponce/git/Dat3M/./output/string-2_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/string-2_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/string-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(5, $bv2int.64($zext.bv32.bv64(1bv32))));
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(5, $bv2int.64($zext.bv32.bv64(1bv32))));
  assume {:sourceloc "./output/string-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref(0, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/string-2_tmp.c:21:3: warning: unsoundly ignoring unmodeled operation llvm.lifetime.start.p0i8;
  call llvm.lifetime.start.p0i8(5bv64, $p2);
  assume true;
  assume {:sourceloc "./output/string-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p1, $mul.ref(0, 5)), $mul.ref(0, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/string-2_tmp.c:21:3: warning: unsoundly ignoring unmodeled operation llvm.lifetime.start.p0i8;
  call llvm.lifetime.start.p0i8(5bv64, $p3);
  assume true;
  assume {:sourceloc "./output/string-2_tmp.c", 26, 17} true;
  assume {:verifier.code 0} true;
  call $i4 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i4);
  assume {:sourceloc "./output/string-2_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p2, $i4);
  assume {:sourceloc "./output/string-2_tmp.c", 26, 17} true;
  assume {:verifier.code 0} true;
  call $i5 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i5);
  assume {:sourceloc "./output/string-2_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref(1, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/string-2_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref(2, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/string-2_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref(3, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/string-2_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref(4, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p12, $i11);
  assume {:sourceloc "./output/string-2_tmp.c", 27, 23} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.bv8($i11, 0bv8);
  assume {:sourceloc "./output/string-2_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1bv1);
  assume {:sourceloc "./output/string-2_tmp.c", 30, 17} true;
  assume {:verifier.code 0} true;
  call $i14 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i14);
  assume {:sourceloc "./output/string-2_tmp.c", 30, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p3, $i14);
  assume {:sourceloc "./output/string-2_tmp.c", 30, 17} true;
  assume {:verifier.code 0} true;
  call $i15 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i15);
  assume {:sourceloc "./output/string-2_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p1, $mul.ref(0, 5)), $mul.ref(1, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 30, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/string-2_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p1, $mul.ref(0, 5)), $mul.ref(3, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 30, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p20, $i19);
  assume {:sourceloc "./output/string-2_tmp.c", 30, 17} true;
  assume {:verifier.code 0} true;
  call $i21 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i21);
  assume {:sourceloc "./output/string-2_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p1, $mul.ref(0, 5)), $mul.ref(4, 1));
  assume {:sourceloc "./output/string-2_tmp.c", 30, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p22, $i21);
  assume {:sourceloc "./output/string-2_tmp.c", 31, 23} true;
  assume {:verifier.code 0} true;
  $i23 := $eq.bv8($i21, 0bv8);
  assume {:sourceloc "./output/string-2_tmp.c", 31, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/string-2_tmp.c", 64, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/string-2_tmp.c:64:1: warning: unsoundly ignoring unmodeled operation llvm.lifetime.end.p0i8;
  call llvm.lifetime.end.p0i8(5bv64, $p3);
  assume {:sourceloc "./output/string-2_tmp.c", 64, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/string-2_tmp.c:64:1: warning: unsoundly ignoring unmodeled operation llvm.lifetime.end.p0i8;
  call llvm.lifetime.end.p0i8(5bv64, $p2);
  assume {:sourceloc "./output/string-2_tmp.c", 64, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
...
$bb4:
  assume ($i23 == 1bv1);
  assume {:sourceloc "./output/string-2_tmp.c", 34, 23} true;
  assume {:verifier.code 0} true;
  $i24 := $eq.bv8($i4, 0bv8);
  assume {:sourceloc "./output/string-2_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $i25, $i26 := 0bv64, 1bv64;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/string-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/string-2_tmp.c", 22, 13} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.bv64.bv32($i25);
  call {:cexpr "nc_A"} boogie_si_record_bv32($i31);
  assume {:sourceloc "./output/string-2_tmp.c", 38, 23} true;
  assume {:verifier.code 0} true;
  $i32 := $eq.bv8($i14, 0bv8);
  assume {:sourceloc "./output/string-2_tmp.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $i33, $i34 := 0bv64, 1bv64;
...
$bb9:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref($bv2int.64($i26), 1));
  assume {:sourceloc "./output/string-2_tmp.c", 34, 9} true;
  assume {:verifier.code 0} true;
  $i28 := $load.bv8($M.0, $p27);
  assume {:sourceloc "./output/string-2_tmp.c", 34, 23} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.bv8($i28, 0bv8);
  assume {:sourceloc "./output/string-2_tmp.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i30 := $add.bv64($i26, 1bv64);
  assume {:sourceloc "./output/string-2_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $i25 := $i26;
...
$bb13:
  assume {:sourceloc "./output/string-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/string-2_tmp.c", 22, 19} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.bv64.bv32($i33);
  call {:cexpr "nc_B"} boogie_si_record_bv32($i39);
  assume {:sourceloc "./output/string-2_tmp.c", 41, 14} true;
  assume {:verifier.code 0} true;
  $i40 := $ult.bv32($i39, $i31);
  assume {:sourceloc "./output/string-2_tmp.c", 41, 7} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p1, $mul.ref(0, 5)), $mul.ref($bv2int.64($i34), 1));
  assume {:sourceloc "./output/string-2_tmp.c", 38, 9} true;
  assume {:verifier.code 0} true;
  $i36 := $load.bv8($M.0, $p35);
  assume {:sourceloc "./output/string-2_tmp.c", 38, 23} true;
  assume {:verifier.code 0} true;
  $i37 := $eq.bv8($i36, 0bv8);
  assume {:sourceloc "./output/string-2_tmp.c", 39, 9} true;
  assume {:verifier.code 0} true;
  $i38 := $add.bv64($i34, 1bv64);
  assume {:sourceloc "./output/string-2_tmp.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $i33 := $i34;
...
$bb19:
  assume !(($i40 == 1bv1));
  assume {:sourceloc "./output/string-2_tmp.c", 45, 11} true;
  assume {:verifier.code 0} true;
  $i41 := $ne.bv32($i31, 0bv32);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 23} true;
  assume {:verifier.code 0} true;
  $i42 := $ne.bv32($i39, 0bv32);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 18} true;
  assume {:verifier.code 0} true;
  $i43 := $and.bv1($i41, $i42);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 18} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume ($i43 == 1bv1);
  assume {:sourceloc "./output/string-2_tmp.c", 47, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $eq.bv8($i4, $i14);
  assume {:sourceloc "./output/string-2_tmp.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.bv1.bv32($i46);
  call {:cexpr "j"} boogie_si_record_bv32($i47);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 11} true;
  assume {:verifier.code 0} true;
  $i48 := $sgt.bv32($i31, 1bv32);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 23} true;
  assume {:verifier.code 0} true;
  $i49 := $slt.bv32($i47, $i39);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $and.bv1($i48, $i49);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 18} true;
  assume {:verifier.code 0} true;
  $i51, $i52, $i44, $i45 := 1bv32, $i47, 1bv32, $i47;
...
$bb22:
  ...
  assume {:sourceloc "./output/string-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/string-2_tmp.c", 59, 13} true;
  assume {:verifier.code 0} true;
  $i69 := $sge.bv32($i45, $i39);
  assume {:sourceloc "./output/string-2_tmp.c", 59, 13} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.bv1.bv32($i69);
  assume {:sourceloc "./output/string-2_tmp.c", 59, 21} true;
  assume {:verifier.code 0} true;
  $i71 := $shl.bv32($i70, $i44);
  call {:cexpr "found"} boogie_si_record_bv32($i71);
  assume {:sourceloc "./output/string-2_tmp.c", 61, 32} true;
  assume {:verifier.code 0} true;
  $i72 := $ugt.bv32($i71, 1bv32);
  assume {:sourceloc "./output/string-2_tmp.c", 9, 7} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i53 := $sext.bv32.bv64($i51);
  assume {:verifier.code 0} true;
  $p54 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref($bv2int.64($i53), 1));
  assume {:sourceloc "./output/string-2_tmp.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i55 := $load.bv8($M.0, $p54);
  assume {:verifier.code 0} true;
  $i56 := $sext.bv32.bv64($i52);
  assume {:verifier.code 0} true;
  $p57 := $add.ref($add.ref($p1, $mul.ref(0, 5)), $mul.ref($bv2int.64($i56), 1));
  assume {:sourceloc "./output/string-2_tmp.c", 47, 23} true;
  assume {:verifier.code 0} true;
  $i58 := $load.bv8($M.0, $p57);
  assume {:sourceloc "./output/string-2_tmp.c", 47, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $eq.bv8($i55, $i58);
  assume {:sourceloc "./output/string-2_tmp.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i60 := $add.bv32($i52, 1bv32);
  assume {:verifier.code 0} true;
  $i61 := $sub.bv32(0bv32, $i52);
  assume {:sourceloc "./output/string-2_tmp.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i62 := (if ($i59 == 1bv1) then 0bv32 else $i61);
  assume {:sourceloc "./output/string-2_tmp.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i63 := (if ($i59 == 1bv1) then $i60 else 0bv32);
  assume {:sourceloc "./output/string-2_tmp.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i64 := $add.bv32($i51, 1bv32);
  assume {:sourceloc "./output/string-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i65 := $add.bv32($i64, $i62);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 11} true;
  assume {:verifier.code 0} true;
  $i66 := $slt.bv32($i65, $i31);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 23} true;
  assume {:verifier.code 0} true;
  $i67 := $slt.bv32($i63, $i39);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 18} true;
  assume {:verifier.code 0} true;
  $i68 := $and.bv1($i66, $i67);
  assume {:sourceloc "./output/string-2_tmp.c", 45, 18} true;
...
$bb28:
  assume ($i72 == 1bv1);
  assume {:sourceloc "./output/string-2_tmp.c", 10, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/string-2_tmp.c", 10, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/string-2_tmp.c", 10, 27} true;
  assume {:verifier.code 0} true;
