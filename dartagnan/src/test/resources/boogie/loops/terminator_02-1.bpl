...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := $i0, $i2;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 16, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 18, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i3, 100);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 18, 15} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32(100, $i4);
  assume {:verifier.code 0} true;
  $i6 := $i7;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 20, 15} true;
  assume {:verifier.code 0} true;
  call $i8 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i8);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i8($i8);
  call {:cexpr "tmp"} boogie_si_record_i8($i9);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 21, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 32, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert(0);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 23, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i3, 1);
  call {:cexpr "x"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 24, 4} true;
  assume {:verifier.code 0} true;
  $i12, $i13 := $i11, $i4;
  goto $bb9;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i3, $sub.i32(0, 1));
  call {:cexpr "x"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 28, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i4, $sub.i32(0, 1));
  call {:cexpr "z"} boogie_si_record_i32($i15);
  assume {:verifier.code 0} true;
  $i12, $i13 := $i14, $i15;
  goto $bb9;
$bb9:
...
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 38181));
