...
{
$bb0:
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 17, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := $i0, $i2;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 19, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i3, 100);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 19, 15} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 19, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32(100, $i4);
  assume {:verifier.code 0} true;
  $i6 := $i7;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 21, 15} true;
  assume {:verifier.code 0} true;
  call $i8 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i8);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i8($i8);
  call {:cexpr "tmp"} boogie_si_record_i8($i9);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 33, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert(0);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i3, 1);
  call {:cexpr "x"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 25, 4} true;
  assume {:verifier.code 0} true;
  $i12, $i13 := $i11, $i4;
  goto $bb9;
$bb8:
  ...
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 29, 7} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 40251));
