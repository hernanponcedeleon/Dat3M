...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/eq2-O3.bpl /Users/ponce/git/Dat3M/./output/eq2_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/eq2_tmp.c", 11, 20} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/eq2_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
