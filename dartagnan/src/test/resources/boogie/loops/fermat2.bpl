...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/fermat2_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/fermat2_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/fermat2_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/fermat2_tmp.c", 8, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/fermat2_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/fermat2_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/fermat2_tmp.c", 10, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/fermat2_tmp.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/fermat2_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/fermat2_tmp.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/fermat2_tmp.c", 10, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/fermat2_tmp.c", 12, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/fermat2_tmp.c", 20, 9} true;
  ...
  assume {:sourceloc "./output/fermat2_tmp.c", 21, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/fermat2_tmp.c", 23, 28} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32($i3, 1);
  assume {:sourceloc "./output/fermat2_tmp.c", 23, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i3, 1);
  assume {:sourceloc "./output/fermat2_tmp.c", 23, 33} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i4, $i5);
  assume {:sourceloc "./output/fermat2_tmp.c", 23, 43} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, $i1);
  assume {:sourceloc "./output/fermat2_tmp.c", 23, 43} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "./output/fermat2_tmp.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i8);
  assume {:sourceloc "./output/fermat2_tmp.c", 25, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $srem.i32($i1, 2);
  assume {:sourceloc "./output/fermat2_tmp.c", 25, 31} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 1);
  assume {:sourceloc "./output/fermat2_tmp.c", 25, 31} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/fermat2_tmp.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "./output/fermat2_tmp.c", 27, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $mul.i32(2, $i3);
  assume {:sourceloc "./output/fermat2_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i12, 1);
  call {:cexpr "u"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/fermat2_tmp.c", 29, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $mul.i32($i3, $i3);
  assume {:sourceloc "./output/fermat2_tmp.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.i32($i14, $i1);
  call {:cexpr "r"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/fermat2_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i16, $i17, $i18 := $i13, 1, $i15;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/fermat2_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 31} true;
  assume {:verifier.code 1} true;
  $i19 := $add.i32($i1, $i18);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 28} true;
  assume {:verifier.code 1} true;
  $i20 := $mul.i32(4, $i19);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 39} true;
  assume {:verifier.code 1} true;
  $i21 := $mul.i32($i16, $i16);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 45} true;
  assume {:verifier.code 1} true;
  $i22 := $mul.i32($i17, $i17);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 42} true;
  assume {:verifier.code 1} true;
  $i23 := $sub.i32($i21, $i22);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 51} true;
  assume {:verifier.code 1} true;
  $i24 := $mul.i32(2, $i16);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 48} true;
  assume {:verifier.code 1} true;
  $i25 := $sub.i32($i23, $i24);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 57} true;
  assume {:verifier.code 1} true;
  $i26 := $mul.i32(2, $i17);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 54} true;
  assume {:verifier.code 1} true;
  $i27 := $add.i32($i25, $i26);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 35} true;
  assume {:verifier.code 1} true;
  $i28 := $eq.i32($i20, $i27);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 35} true;
  assume {:verifier.code 1} true;
  $i29 := $zext.i1.i32($i28);
  assume {:sourceloc "./output/fermat2_tmp.c", 32, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i29);
  assume {:sourceloc "./output/fermat2_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i30 := $ne.i32($i18, 0);
  assume {:sourceloc "./output/fermat2_tmp.c", 33, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i30 == 1);
  assume {:sourceloc "./output/fermat2_tmp.c", 35, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $sgt.i32($i18, 0);
  assume {:sourceloc "./output/fermat2_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb5, $bb6;
$bb3:
  assume !(($i30 == 1));
  assume {:sourceloc "./output/fermat2_tmp.c", 33, 24} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 24} true;
  assume {:verifier.code 1} true;
  $i39 := $mul.i32(4, $i1);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 31} true;
  assume {:verifier.code 1} true;
  $i40 := $mul.i32($i16, $i16);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 37} true;
  assume {:verifier.code 1} true;
  $i41 := $mul.i32($i17, $i17);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 34} true;
  assume {:verifier.code 1} true;
  $i42 := $sub.i32($i40, $i41);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 44} true;
  assume {:verifier.code 1} true;
  $i43 := $mul.i32(2, $i16);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 41} true;
  assume {:verifier.code 1} true;
  $i44 := $sub.i32($i42, $i43);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 50} true;
  assume {:verifier.code 1} true;
  $i45 := $mul.i32(2, $i17);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 47} true;
  assume {:verifier.code 1} true;
  $i46 := $add.i32($i44, $i45);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 27} true;
  assume {:verifier.code 1} true;
  $i47 := $eq.i32($i39, $i46);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 27} true;
  assume {:verifier.code 1} true;
  $i48 := $zext.i1.i32($i47);
  assume {:sourceloc "./output/fermat2_tmp.c", 45, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i48);
  assume {:sourceloc "./output/fermat2_tmp.c", 46, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb5:
  assume ($i31 == 1);
  assume {:sourceloc "./output/fermat2_tmp.c", 36, 19} true;
  assume {:verifier.code 0} true;
  $i32 := $sub.i32($i18, $i17);
  call {:cexpr "r"} boogie_si_record_i32($i32);
  assume {:sourceloc "./output/fermat2_tmp.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i17, 2);
  call {:cexpr "v"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/fermat2_tmp.c", 38, 9} true;
  assume {:verifier.code 0} true;
  $i34, $i35, $i36 := $i16, $i33, $i32;
  goto $bb7;
$bb6:
  assume !(($i31 == 1));
  assume {:sourceloc "./output/fermat2_tmp.c", 39, 19} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i32($i18, $i16);
  call {:cexpr "r"} boogie_si_record_i32($i37);
  assume {:sourceloc "./output/fermat2_tmp.c", 40, 19} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i32($i16, 2);
  call {:cexpr "u"} boogie_si_record_i32($i38);
  assume {:verifier.code 0} true;
  $i34, $i35, $i36 := $i38, $i17, $i37;
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/fermat2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
