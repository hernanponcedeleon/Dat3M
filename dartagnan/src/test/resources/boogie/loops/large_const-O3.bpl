...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/large_const-O3.bpl /Users/ponce/git/Dat3M/./output/large_const_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/large_const_tmp.c", 2, 44} true;
...
$bb0:
  ...
  call {:cexpr "n"} boogie_si_record_bv32($i2);
  assume {:sourceloc "./output/large_const_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $add.bv32($i2, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/large_const_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $ugt.bv32($i3, 8bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/large_const_tmp.c", 42, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb3:
  assume !(($i4 == 1bv1));
  assume {:verifier.code 0} true;
  $i5 := $slt.bv32($i2, 2bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i6, $i7 := 0bv32, 0bv32;
...
$bb5:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/large_const_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $i8 := $add.bv32($i7, 1bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 26, 9} true;
  assume {:verifier.code 0} true;
  call $i9 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i9);
  call {:cexpr "v"} boogie_si_record_bv32($i9);
  assume {:sourceloc "./output/large_const_tmp.c", 27, 13} true;
  assume {:verifier.code 0} true;
  $i10 := $sgt.bv32($i9, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/large_const_tmp.c", 27, 18} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  call {:cexpr "v"} boogie_si_record_bv32($i20);
  assume {:sourceloc "./output/large_const_tmp.c", 42, 1} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb7:
  assume ($i10 == 1bv1);
  assume {:sourceloc "./output/large_const_tmp.c", 28, 9} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.bv32($i9, 1bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 28, 9} true;
  assume {:verifier.code 0} true;
  $i12 := (if ($i11 == 1bv1) then 2000bv32 else 10000bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 28, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.bv32($i9, 0bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 28, 9} true;
  assume {:verifier.code 0} true;
  $i14 := (if ($i13 == 1bv1) then 4000bv32 else $i12);
  assume {:sourceloc "./output/large_const_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i15 := $add.bv32($i6, $i14);
  call {:cexpr "k"} boogie_si_record_bv32($i15);
  assume {:sourceloc "./output/large_const_tmp.c", 24, 12} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.bv32($i8, $i2);
  assume {:sourceloc "./output/large_const_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i16 == 1bv1));
  assume {:sourceloc "./output/large_const_tmp.c", 36, 12} true;
  assume {:verifier.code 0} true;
  $i17 := $sgt.bv32($i2, 0bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $i18, $i19 := 0bv32, $i15;
...
$bb12:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/large_const_tmp.c", 37, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $slt.bv32($i19, 1bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume ($i21 == 1bv1);
  assume {:sourceloc "./output/large_const_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/large_const_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/large_const_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume !(($i21 == 1bv1));
  assume {:sourceloc "./output/large_const_tmp.c", 38, 6} true;
  assume {:verifier.code 0} true;
  $i22 := $add.bv32($i18, 1bv32);
  assume {:sourceloc "./output/large_const_tmp.c", 39, 6} true;
  assume {:verifier.code 0} true;
  $i23 := $add.bv32($i19, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/large_const_tmp.c", 36, 12} true;
  assume {:verifier.code 0} true;
  $i24 := $slt.bv32($i22, $i2);
  assume {:sourceloc "./output/large_const_tmp.c", 36, 3} true;
