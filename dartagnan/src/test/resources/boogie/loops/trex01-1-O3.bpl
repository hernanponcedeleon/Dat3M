...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/trex01-1-O3.bpl /Users/ponce/git/Dat3M/./output/trex01-1_tmp.c
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "f:arg:d"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/trex01-1_tmp.c", 14, 11} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "y"} boogie_si_record_bv32($i2);
  ...
  call {:cexpr "k"} boogie_si_record_bv32($i3);
  assume {:sourceloc "./output/trex01-1_tmp.c", 15, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.bv32($i3, 1073741824bv32);
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  $i7 := $shl.bv32($i5, 1bv32);
  call {:cexpr "z"} boogie_si_record_bv32($i7);
...
$bb10:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i14);
...
$bb12:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i16);
  assume {:sourceloc "./output/trex01-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.bv1.bv32($i16);
  call {:cexpr "y"} boogie_si_record_bv32($i17);
...
$bb13:
  ...
  assume {:verifier.code 0} true;
  $i20 := $sub.bv32($i13, $i0);
  call {:cexpr "y"} boogie_si_record_bv32($i20);
  assume {:verifier.code 0} true;
  $i18, $i19 := $i20, $i12;
  goto $bb14;
$bb14:
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $i21 := $sgt.bv32($i19, 0bv32);
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i22 := $sgt.bv32($i18, 0bv32);
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i23 := $and.bv1($i22, $i21);
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 3} true;
