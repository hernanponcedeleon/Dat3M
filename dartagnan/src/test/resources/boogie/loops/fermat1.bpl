...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 44373));
...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/fermat1_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/fermat1_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/fermat1_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/fermat1_tmp.c", 8, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/fermat1_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/fermat1_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/fermat1_tmp.c", 10, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/fermat1_tmp.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/fermat1_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/fermat1_tmp.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/fermat1_tmp.c", 10, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/fermat1_tmp.c", 12, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/fermat1_tmp.c", 20, 9} true;
  assume {:verifier.code 1} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/fermat1_tmp.c", 20, 9} true;
  assume {:verifier.code 1} true;
  call $f0 := __VERIFIER_nondet_double();
  call {:cexpr "smack:ext:__VERIFIER_nondet_double"} boogie_si_record_float($f0);
  assume {:sourceloc "./output/fermat1_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $fp2si.float.i32($f0);
  call {:cexpr "A"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/fermat1_tmp.c", 21, 9} true;
  assume {:verifier.code 1} true;
  call $f2 := __VERIFIER_nondet_double();
  call {:cexpr "smack:ext:__VERIFIER_nondet_double"} boogie_si_record_float($f2);
  assume {:sourceloc "./output/fermat1_tmp.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $fp2si.float.i32($f2);
  call {:cexpr "R"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/fermat1_tmp.c", 22, 28} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32($i3, 1);
  assume {:sourceloc "./output/fermat1_tmp.c", 22, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i3, 1);
  assume {:sourceloc "./output/fermat1_tmp.c", 22, 33} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i4, $i5);
  assume {:sourceloc "./output/fermat1_tmp.c", 22, 43} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, $i1);
  assume {:sourceloc "./output/fermat1_tmp.c", 22, 43} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "./output/fermat1_tmp.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i8);
  assume {:sourceloc "./output/fermat1_tmp.c", 24, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $srem.i32($i1, 2);
  assume {:sourceloc "./output/fermat1_tmp.c", 24, 31} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 1);
  assume {:sourceloc "./output/fermat1_tmp.c", 24, 31} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/fermat1_tmp.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "./output/fermat1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $mul.i32(2, $i3);
  assume {:sourceloc "./output/fermat1_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i12, 1);
  call {:cexpr "u"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/fermat1_tmp.c", 28, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $mul.i32($i3, $i3);
  assume {:sourceloc "./output/fermat1_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.i32($i14, $i1);
  call {:cexpr "r"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/fermat1_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i16, $i17, $i18 := $i13, 1, $i15;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/fermat1_tmp.c", 26, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat1_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat1_tmp.c", 28, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 31} true;
  assume {:verifier.code 1} true;
  $i19 := $add.i32($i1, $i18);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 28} true;
  assume {:verifier.code 1} true;
  $i20 := $mul.i32(4, $i19);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 39} true;
  assume {:verifier.code 1} true;
  $i21 := $mul.i32($i16, $i16);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 45} true;
  assume {:verifier.code 1} true;
  $i22 := $mul.i32($i17, $i17);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 42} true;
  assume {:verifier.code 1} true;
  $i23 := $sub.i32($i21, $i22);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 51} true;
  assume {:verifier.code 1} true;
  $i24 := $mul.i32(2, $i16);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 48} true;
  assume {:verifier.code 1} true;
  $i25 := $sub.i32($i23, $i24);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 57} true;
  assume {:verifier.code 1} true;
  $i26 := $mul.i32(2, $i17);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 54} true;
  assume {:verifier.code 1} true;
  $i27 := $add.i32($i25, $i26);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 35} true;
  assume {:verifier.code 1} true;
  $i28 := $eq.i32($i20, $i27);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 35} true;
  assume {:verifier.code 1} true;
  $i29 := $zext.i1.i32($i28);
  assume {:sourceloc "./output/fermat1_tmp.c", 32, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i29);
  assume {:sourceloc "./output/fermat1_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i30 := $ne.i32($i18, 0);
  assume {:sourceloc "./output/fermat1_tmp.c", 33, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i30 == 1);
  assume {:sourceloc "./output/fermat1_tmp.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $i31, $i32 := $i17, $i18;
  goto $bb5;
$bb3:
  assume !(($i30 == 1));
  assume {:sourceloc "./output/fermat1_tmp.c", 34, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 24} true;
  assume {:verifier.code 1} true;
  $i63 := $mul.i32(4, $i1);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 31} true;
  assume {:verifier.code 1} true;
  $i64 := $mul.i32($i16, $i16);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 37} true;
  assume {:verifier.code 1} true;
  $i65 := $mul.i32($i17, $i17);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 34} true;
  assume {:verifier.code 1} true;
  $i66 := $sub.i32($i64, $i65);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 44} true;
  assume {:verifier.code 1} true;
  $i67 := $mul.i32(2, $i16);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 41} true;
  assume {:verifier.code 1} true;
  $i68 := $sub.i32($i66, $i67);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 50} true;
  assume {:verifier.code 1} true;
  $i69 := $mul.i32(2, $i17);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 47} true;
  assume {:verifier.code 1} true;
  $i70 := $add.i32($i68, $i69);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 27} true;
  assume {:verifier.code 1} true;
  $i71 := $eq.i32($i63, $i70);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 27} true;
  assume {:verifier.code 1} true;
  $i72 := $zext.i1.i32($i71);
  assume {:sourceloc "./output/fermat1_tmp.c", 53, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i72);
  assume {:sourceloc "./output/fermat1_tmp.c", 54, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb5:
  assume {:sourceloc "./output/fermat1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 28} true;
  assume {:verifier.code 1} true;
  $i33 := $add.i32($i1, $i32);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 25} true;
  assume {:verifier.code 1} true;
  $i34 := $mul.i32(4, $i33);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 36} true;
  assume {:verifier.code 1} true;
  $i35 := $mul.i32($i16, $i16);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 42} true;
  assume {:verifier.code 1} true;
  $i36 := $mul.i32($i31, $i31);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 39} true;
  assume {:verifier.code 1} true;
  $i37 := $sub.i32($i35, $i36);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 48} true;
  assume {:verifier.code 1} true;
  $i38 := $mul.i32(2, $i16);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 45} true;
  assume {:verifier.code 1} true;
  $i39 := $sub.i32($i37, $i38);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 54} true;
  assume {:verifier.code 1} true;
  $i40 := $mul.i32(2, $i31);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 51} true;
  assume {:verifier.code 1} true;
  $i41 := $add.i32($i39, $i40);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 32} true;
  assume {:verifier.code 1} true;
  $i42 := $eq.i32($i34, $i41);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 32} true;
  assume {:verifier.code 1} true;
  $i43 := $zext.i1.i32($i42);
  assume {:sourceloc "./output/fermat1_tmp.c", 37, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i43);
  assume {:sourceloc "./output/fermat1_tmp.c", 38, 21} true;
  assume {:verifier.code 0} true;
  $i44 := $sgt.i32($i32, 0);
  assume {:sourceloc "./output/fermat1_tmp.c", 38, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i44} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i44 == 1);
  assume {:sourceloc "./output/fermat1_tmp.c", 40, 19} true;
  assume {:verifier.code 0} true;
  $i45 := $sub.i32($i32, $i31);
  call {:cexpr "r"} boogie_si_record_i32($i45);
  assume {:sourceloc "./output/fermat1_tmp.c", 41, 19} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i32($i31, 2);
  call {:cexpr "v"} boogie_si_record_i32($i46);
  assume {:sourceloc "./output/fermat1_tmp.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $i31, $i32 := $i46, $i45;
  goto $bb5;
$bb7:
  assume !(($i44 == 1));
  assume {:sourceloc "./output/fermat1_tmp.c", 39, 17} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/fermat1_tmp.c", 44, 9} true;
  assume {:verifier.code 0} true;
  $i47, $i48 := $i16, $i32;
  goto $bb9;
$bb9:
  ...
  assume {:sourceloc "./output/fermat1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 28} true;
  assume {:verifier.code 1} true;
  $i49 := $add.i32($i1, $i48);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 25} true;
  assume {:verifier.code 1} true;
  $i50 := $mul.i32(4, $i49);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 36} true;
  assume {:verifier.code 1} true;
  $i51 := $mul.i32($i47, $i47);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 42} true;
  assume {:verifier.code 1} true;
  $i52 := $mul.i32($i31, $i31);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 39} true;
  assume {:verifier.code 1} true;
  $i53 := $sub.i32($i51, $i52);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 48} true;
  assume {:verifier.code 1} true;
  $i54 := $mul.i32(2, $i47);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 45} true;
  assume {:verifier.code 1} true;
  $i55 := $sub.i32($i53, $i54);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 54} true;
  assume {:verifier.code 1} true;
  $i56 := $mul.i32(2, $i31);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 51} true;
  assume {:verifier.code 1} true;
  $i57 := $add.i32($i55, $i56);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 32} true;
  assume {:verifier.code 1} true;
  $i58 := $eq.i32($i50, $i57);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 32} true;
  assume {:verifier.code 1} true;
  $i59 := $zext.i1.i32($i58);
  assume {:sourceloc "./output/fermat1_tmp.c", 45, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i59);
  assume {:sourceloc "./output/fermat1_tmp.c", 46, 21} true;
  assume {:verifier.code 0} true;
  $i60 := $slt.i32($i48, 0);
  assume {:sourceloc "./output/fermat1_tmp.c", 46, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i60 == 1);
  assume {:sourceloc "./output/fermat1_tmp.c", 48, 19} true;
  assume {:verifier.code 0} true;
  $i61 := $add.i32($i48, $i47);
  call {:cexpr "r"} boogie_si_record_i32($i61);
  assume {:sourceloc "./output/fermat1_tmp.c", 49, 19} true;
  assume {:verifier.code 0} true;
  $i62 := $add.i32($i47, 2);
...
$bb11:
  assume !(($i60 == 1));
  assume {:sourceloc "./output/fermat1_tmp.c", 47, 17} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/fermat1_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i16, $i17, $i18 := $i47, $i31, $i48;
  goto $bb1;
}
const __VERIFIER_nondet_double: ref;
axiom (__VERIFIER_nondet_double == $sub.ref(0, 9285));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 26829));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 27861));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 28893));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 29925));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 30957));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 31989));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 33021));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 34053));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 35085));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 36117));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 37149));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 38181));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 39213));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 40245));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 41277));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 42309));
...
axiom (llvm.dbg.value == $sub.ref(0, 43341));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 44373));
...
procedure boogie_si_record_float(x: float);
