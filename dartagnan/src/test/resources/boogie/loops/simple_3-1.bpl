...
{
$bb0:
  assume {:sourceloc "./output/simple_3-1_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/simple_3-1_tmp.c", 6, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/simple_3-1_tmp.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/simple_3-1_tmp.c", 6, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/simple_3-1_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/simple_3-1_tmp.c", 6, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/simple_3-1_tmp.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/simple_3-1_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/simple_3-1_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/simple_3-1_tmp.c", 14, 22} true;
  ...
  assume {:sourceloc "./output/simple_3-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_3-1_tmp.c", 16, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i16.i32($i0);
  assume {:sourceloc "./output/simple_3-1_tmp.c", 16, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.i32($i1, $i2);
  assume {:sourceloc "./output/simple_3-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/simple_3-1_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i1, 2);
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/simple_3-1_tmp.c", 20, 23} true;
  assume {:verifier.code 1} true;
  $i5 := $urem.i32($i1, 2);
  assume {:sourceloc "./output/simple_3-1_tmp.c", 20, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i5);
  assume {:sourceloc "./output/simple_3-1_tmp.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_unsigned_short == $sub.ref(0, 20643));
...
axiom (__VERIFIER_nondet_ushort == $sub.ref(0, 40251));
