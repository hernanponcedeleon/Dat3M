...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/egcd2-O3.bpl /Users/ponce/git/Dat3M/./output/egcd2_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/egcd2_tmp.c", 3, 44} true;
...
$bb0:
  ...
  assume {:sourceloc "./output/egcd2_tmp.c", 21, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/egcd2_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/egcd2_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/egcd2_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/egcd2_tmp.c", 23, 27} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  $i15 := $mul.bv32($i5, $i1);
  assume {:verifier.code 0} true;
  $i16 := $add.bv32($i15, $i14);
  assume {:verifier.code 0} true;
  $i17 := $sub.bv32($i16, $i9);
  assume {:verifier.code 0} true;
  $i18 := $mul.bv32($i17, $i1);
  assume {:verifier.code 0} true;
  $i19 := $sub.bv32($i18, $i16);
  assume {:verifier.code 0} true;
  $i20 := $sub.bv32(0bv32, $i9);
  assume {:verifier.code 0} true;
  $i21 := $eq.bv32($i19, $i20);
  assume {:sourceloc "./output/egcd2_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i13 == 1bv1));
  assume {:sourceloc "./output/egcd2_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/egcd2_tmp.c", 12, 24} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/egcd2_tmp.c", 12, 24} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1bv1);
  assume {:sourceloc "./output/egcd2_tmp.c", 44, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $slt.bv32($i4, $i9);
  assume {:sourceloc "./output/egcd2_tmp.c", 44, 17} true;
  assume {:verifier.code 0} true;
  $i24, $i25, $i26, $i27 := 0bv32, $i4, $i4, 0bv32;
...
$bb13:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd2_tmp.c", 56, 22} true;
  assume {:verifier.code 0} true;
  $i31 := $mul.bv32($i24, $i7);
  assume {:sourceloc "./output/egcd2_tmp.c", 56, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $sub.bv32($i8, $i31);
  assume {:sourceloc "./output/egcd2_tmp.c", 59, 22} true;
  assume {:verifier.code 0} true;
  $i33 := $mul.bv32($i24, $i5);
  assume {:sourceloc "./output/egcd2_tmp.c", 59, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $sub.bv32($i6, $i33);
  assume {:sourceloc "./output/egcd2_tmp.c", 34, 17} true;
  assume {:verifier.code 0} true;
  $i35 := $eq.bv32($i25, 0bv32);
...
$bb15:
  ...
  assume {:verifier.code 0} true;
  $i28 := $sub.bv32($i26, $i9);
  assume {:sourceloc "./output/egcd2_tmp.c", 47, 19} true;
  assume {:verifier.code 0} true;
  $i29 := $add.bv32($i27, 1bv32);
  call {:cexpr "k"} boogie_si_record_bv32($i29);
  assume {:sourceloc "./output/egcd2_tmp.c", 44, 21} true;
  assume {:verifier.code 0} true;
  $i30 := $slt.bv32($i28, $i9);
  assume {:sourceloc "./output/egcd2_tmp.c", 44, 17} true;
...
$bb19:
  assume !(($i35 == 1bv1));
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7, $i8, $i9 := $i9, $i34, $i5, $i32, $i7, $i25;
  goto $bb5;
$bb20:
  assume ($i39 == 1bv1);
  assume {:sourceloc "./output/egcd2_tmp.c", 65, 5} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $exn := false;
  return;
