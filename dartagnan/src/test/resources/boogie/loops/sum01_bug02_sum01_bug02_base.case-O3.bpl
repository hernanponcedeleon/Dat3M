...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum01_bug02_sum01_bug02_base.case-O3.bpl /Users/ponce/git/Dat3M/./output/sum01_bug02_sum01_bug02_base.case_tmp.c
...
$bb5:
  ...
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.bv32($i3, 0bv32);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i19, $i20, $i21, $i22 := $i5, $i6, $i7, $i3;
...
$bb13:
  ...
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i23 := $add.bv32($i20, 2bv32);
  call {:cexpr "sn"} boogie_si_record_bv32($i23);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $eq.bv32($i21, 4bv32);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $i25 := (if ($i24 == 1bv1) then $sub.bv32(0bv32, 10bv32) else $i23);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i26 := $add.bv32($i21, 1bv32);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $add.bv32($i22, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
