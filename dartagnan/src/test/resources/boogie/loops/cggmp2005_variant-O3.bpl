...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/cggmp2005_variant-O3.bpl /Users/ponce/git/Dat3M/./output/cggmp2005_variant_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/cggmp2005_variant_tmp.c", 17, 11} true;
  ...
  call {:cexpr "mid"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/cggmp2005_variant_tmp.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
