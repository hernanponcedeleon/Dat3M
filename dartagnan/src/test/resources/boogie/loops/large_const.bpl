...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/large_const_tmp.c", 10, 7} true;
  ...
  call {:cexpr "n"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/large_const_tmp.c", 11, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $sle.i32(0, $i2);
  assume {:sourceloc "./output/large_const_tmp.c", 11, 16} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/large_const_tmp.c", 11, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i2, 10);
  assume {:sourceloc "./output/large_const_tmp.c", 11, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/large_const_tmp.c", 11, 28} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/large_const_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i5, $i6 := 0, 0;
  goto $bb7;
$bb5:
  ...
  goto $bb3;
$bb6:
  assume {:sourceloc "./output/large_const_tmp.c", 35, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb7:
  assume {:sourceloc "./output/large_const_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/large_const_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/large_const_tmp.c", 15, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i5, $i2);
  assume {:sourceloc "./output/large_const_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i7 == 1);
  assume {:sourceloc "./output/large_const_tmp.c", 16, 6} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i5, 1);
  call {:cexpr "i"} boogie_si_record_i32($i8);
  assume {:sourceloc "./output/large_const_tmp.c", 17, 9} true;
  assume {:verifier.code 0} true;
  call $i9 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i9);
  call {:cexpr "v"} boogie_si_record_i32($i9);
  assume {:sourceloc "./output/large_const_tmp.c", 18, 13} true;
  assume {:verifier.code 0} true;
  $i10 := $sle.i32(0, $i9);
  assume {:sourceloc "./output/large_const_tmp.c", 18, 18} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb10, $bb11;
$bb9:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/large_const_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $i19, $i20 := $i6, 0;
  goto $bb21;
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "./output/large_const_tmp.c", 18, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $slt.i32($i2, 2);
  assume {:sourceloc "./output/large_const_tmp.c", 18, 9} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/large_const_tmp.c", 18, 29} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb13:
  assume ($i11 == 1);
  assume {:sourceloc "./output/large_const_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $eq.i32($i9, 0);
  assume {:sourceloc "./output/large_const_tmp.c", 19, 9} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i12 == 1);
  assume {:sourceloc "./output/large_const_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i6, 4000);
  call {:cexpr "k"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/large_const_tmp.c", 20, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $i13;
  goto $bb17;
$bb16:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/large_const_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i9, 1);
  assume {:sourceloc "./output/large_const_tmp.c", 21, 14} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i15 == 1);
  assume {:sourceloc "./output/large_const_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i6, 2000);
  call {:cexpr "k"} boogie_si_record_i32($i16);
  assume {:sourceloc "./output/large_const_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i17 := $i16;
  goto $bb20;
$bb19:
  assume !(($i15 == 1));
  assume {:sourceloc "./output/large_const_tmp.c", 24, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i6, 10000);
  call {:cexpr "k"} boogie_si_record_i32($i18);
  assume {:verifier.code 0} true;
  $i17 := $i18;
  goto $bb20;
$bb20:
...
$bb21:
  ...
  assume {:sourceloc "./output/large_const_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/large_const_tmp.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $i21 := $slt.i32($i20, $i2);
  assume {:sourceloc "./output/large_const_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i21 == 1);
  assume {:sourceloc "./output/large_const_tmp.c", 29, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $sgt.i32($i19, 0);
  assume {:sourceloc "./output/large_const_tmp.c", 29, 25} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/large_const_tmp.c", 29, 5} true;
  assume {:verifier.code 0} true;
  call $i24 := __VERIFIER_assert.i32($i23);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/large_const_tmp.c", 30, 6} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i20, 1);
  call {:cexpr "j"} boogie_si_record_i32($i25);
  assume {:sourceloc "./output/large_const_tmp.c", 31, 6} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i32($i19, $sub.i32(0, 1));
  call {:cexpr "k"} boogie_si_record_i32($i26);
  assume {:sourceloc "./output/large_const_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $i19, $i20 := $i26, $i25;
  goto $bb21;
$bb23:
  assume !(($i21 == 1));
  assume {:sourceloc "./output/large_const_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
}
