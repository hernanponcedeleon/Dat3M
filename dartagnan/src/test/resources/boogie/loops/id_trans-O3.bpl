...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/id_trans-O3.bpl /Users/ponce/git/Dat3M/./output/id_trans_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/id_trans_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/id_trans_tmp.c", 17, 10} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "nlen"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/id_trans_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i1);
  call {:cexpr "idBitLength"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/id_trans_tmp.c", 19, 21} true;
  assume {:verifier.code 0} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i2);
  call {:cexpr "material_length"} boogie_si_record_bv32($i2);
  assume {:sourceloc "./output/id_trans_tmp.c", 20, 32} true;
  assume {:verifier.code 0} true;
  $i3 := $sdiv.bv32($i1, 32bv32);
  assume {:sourceloc "./output/id_trans_tmp.c", 20, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.bv32($i0, $i3);
  assume {:sourceloc "./output/id_trans_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1bv1);
  assume {:sourceloc "./output/id_trans_tmp.c", 21, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $sdiv.bv32($i1, 8bv32);
  assume {:sourceloc "./output/id_trans_tmp.c", 21, 18} true;
  assume {:verifier.code 0} true;
  $i6 := $sgt.bv32($i1, 7bv32);
  assume {:sourceloc "./output/id_trans_tmp.c", 21, 43} true;
  assume {:verifier.code 0} true;
  $i7 := $sgt.bv32($i2, 0bv32);
  assume {:sourceloc "./output/id_trans_tmp.c", 21, 37} true;
  assume {:verifier.code 0} true;
  $i8 := $and.bv1($i6, $i7);
  assume {:sourceloc "./output/id_trans_tmp.c", 21, 37} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/id_trans_tmp.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
$bb5:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/id_trans_tmp.c", 24, 30} true;
  assume {:verifier.code 0} true;
  $i14 := $lshr.bv32($i9, 2bv32);
  assume {:sourceloc "./output/id_trans_tmp.c", 25, 28} true;
  assume {:verifier.code 0} true;
  $i15 := $slt.bv32($i14, $i0);
  assume {:sourceloc "./output/id_trans_tmp.c", 21, 64} true;
  assume {:verifier.code 0} true;
  $i11 := $add.bv32($i9, 1bv32);
  call {:cexpr "j"} boogie_si_record_bv32($i11);
  assume {:sourceloc "./output/id_trans_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i15 == 1bv1));
  assume {:sourceloc "./output/id_trans_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/id_trans_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/id_trans_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
