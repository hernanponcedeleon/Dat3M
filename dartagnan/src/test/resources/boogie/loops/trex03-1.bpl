...
{
$bb0:
  assume {:sourceloc "./output/trex03-1_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/trex03-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/trex03-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/trex03-1_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/trex03-1_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/trex03-1_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex03-1_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/trex03-1_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/trex03-1_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/trex03-1_tmp.c", 16, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex03-1_tmp.c", 16, 48} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex03-1_tmp.c", 16, 77} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex03-1_tmp.c", 16, 74} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex03-1_tmp.c", 16, 45} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex03-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex03-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $ugt.i32($i10, 0);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
...
$bb2:
  assume ($i12 == 1);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 19} true;
  assume {:verifier.code 0} true;
  $i14 := $ugt.i32($i9, 0);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 22} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
...
$bb5:
  assume ($i14 == 1);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 27} true;
  assume {:verifier.code 0} true;
  $i15 := $ugt.i32($i8, 0);
  assume {:verifier.code 0} true;
  $i13 := $i15;
...
$bb7:
  assume ($i13 == 1);
  assume {:sourceloc "./output/trex03-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i7);
  assume {:sourceloc "./output/trex03-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/trex03-1_tmp.c", 29, 23} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.i32($i10, 0);
  assume {:sourceloc "./output/trex03-1_tmp.c", 29, 27} true;
  assume {:verifier.code 0} true;
  $i31 := 0;
...
$bb9:
  ...
  assume {:sourceloc "./output/trex03-1_tmp.c", 22, 13} true;
  assume {:verifier.code 0} true;
  $i18, $i19, $i20 := $i8, $i9, $i17;
  goto $bb11;
$bb10:
  assume !(($i16 == 1));
  assume {:sourceloc "./output/trex03-1_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i11);
  assume {:sourceloc "./output/trex03-1_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i21 == 1);
  assume {:sourceloc "./output/trex03-1_tmp.c", 23, 23} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i32($i9, 1);
  call {:cexpr "x2"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/trex03-1_tmp.c", 23, 18} true;
  assume {:verifier.code 0} true;
  $i23, $i24 := $i8, $i22;
  goto $bb14;
$bb13:
  assume !(($i21 == 1));
  assume {:sourceloc "./output/trex03-1_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.i32($i8, 1);
...
$bb15:
  assume ($i30 == 1);
  assume {:sourceloc "./output/trex03-1_tmp.c", 29, 32} true;
  assume {:verifier.code 0} true;
  $i32 := $eq.i32($i9, 0);
  assume {:sourceloc "./output/trex03-1_tmp.c", 29, 36} true;
  assume {:verifier.code 0} true;
  $i31 := 0;
...
$bb17:
  ...
  assume {:sourceloc "./output/trex03-1_tmp.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb18:
  assume ($i32 == 1);
  assume {:sourceloc "./output/trex03-1_tmp.c", 29, 41} true;
  assume {:verifier.code 1} true;
  $i33 := $eq.i32($i8, 0);
  assume {:verifier.code 0} true;
  $i31 := $i33;
...
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 26835));
...
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 41283));
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 42315));
