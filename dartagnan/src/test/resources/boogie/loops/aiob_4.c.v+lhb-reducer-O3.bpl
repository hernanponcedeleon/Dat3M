...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/aiob_4.c.v+lhb-reducer-O3.bpl /Users/ponce/git/Dat3M/./output/aiob_4.c.v+lhb-reducer_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 53644));
...
const Id_MCDC_93: ref;
axiom (Id_MCDC_93 == $sub.ref(0, 1028));
const __return_main: ref;
axiom (__return_main == $sub.ref(0, 2056));
const __tmp_1075_0: ref;
axiom (__tmp_1075_0 == $sub.ref(0, 3084));
const __tmp_1075_1: ref;
axiom (__tmp_1075_1 == $sub.ref(0, 4112));
const __tmp_1075_2: ref;
axiom (__tmp_1075_2 == $sub.ref(0, 5144));
const .str: ref;
axiom (.str == $sub.ref(0, 6175));
const {:count 2} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 7201));
const {:count 14} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 8239));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 9271));
const {:count 3} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 10298));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 11336));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 12364));
const main: ref;
axiom (main == $sub.ref(0, 13396));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 162, 22} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(504, $bv2int.64($zext.bv32.bv64(1bv32))));
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 162, 22} true;
  assume {:verifier.code 0} true;
  call $p1 := fopen(.str, .str.1);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 163, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.ref($p1, $0.ref);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 163, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 165, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bytes.bv32($M.0, __return_main);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 165, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  goto $bb3;
$bb2:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 175, 2} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p0);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 175, 2} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/aiob_4.c.v+lhb-reducer_tmp.c:175:2: warning: unsoundly ignoring unmodeled operation llvm.lifetime.start.p0i8;
  call llvm.lifetime.start.p0i8(504bv64, $p5);
  assume true;
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 438, 35} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 504)), $mul.ref(40, 12)), $mul.ref(0, 4));
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, __tmp_1075_0, 40bv32);
  call {:cexpr "__tmp_1075_0"} boogie_si_record_bv32(40bv32);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, __tmp_1075_1, 1bv32);
  call {:cexpr "__tmp_1075_1"} boogie_si_record_bv32(1bv32);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, __tmp_1075_2, $p6);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 419, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, Id_MCDC_93, 41bv32);
  call {:cexpr "Id_MCDC_93"} boogie_si_record_bv32(41bv32);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bytes.bv32($M.0, __return_main);
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 633, 2} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/aiob_4.c.v+lhb-reducer_tmp.c:633:2: warning: unsoundly ignoring unmodeled operation llvm.lifetime.end.p0i8;
  call llvm.lifetime.end.p0i8(504bv64, $p5);
  assume {:verifier.code 0} true;
  $i4 := $i7;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/aiob_4.c.v+lhb-reducer_tmp.c", 635, 2} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
axiom (llvm.dbg.value == $sub.ref(0, 14428));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const fopen: ref;
axiom (fopen == $sub.ref(0, 15460));
procedure  fopen($p0: ref, $p1: ref)
  returns ($r: ref);
const llvm.lifetime.start.p0i8: ref;
axiom (llvm.lifetime.start.p0i8 == $sub.ref(0, 16492));
procedure  llvm.lifetime.start.p0i8($i0: bv64, $p1: ref);
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 17524));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.lifetime.end.p0i8: ref;
axiom (llvm.lifetime.end.p0i8 == $sub.ref(0, 18556));
procedure  llvm.lifetime.end.p0i8($i0: bv64, $p1: ref);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 19588));
...
axiom (__SMACK_code == $sub.ref(0, 20620));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 21652));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 22684));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 23716));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 24748));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 25780));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 26812));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 27844));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 28876));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 29908));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 30940));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 31972));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 33004));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 34036));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 35068));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 36100));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 37132));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 38164));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 39196));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 40228));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 41260));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 42292));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 43324));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 44356));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 45388));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 46420));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 47452));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 48484));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 49516));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 50548));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 51580));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 52612));
...
axiom (__SMACK_static_init == $sub.ref(0, 53644));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bytes.bv32($M.0, Id_MCDC_93, 0bv32);
  call {:cexpr "Id_MCDC_93"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bytes.bv32($M.0, __return_main, 0bv32);
  call {:cexpr "__return_main"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bytes.bv32($M.0, __tmp_1075_0, 0bv32);
  call {:cexpr "__tmp_1075_0"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bytes.bv32($M.0, __tmp_1075_1, 0bv32);
  call {:cexpr "__tmp_1075_1"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bytes.ref($M.0, __tmp_1075_2, $0.ref);
