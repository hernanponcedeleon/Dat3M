...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/matrix-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/matrix-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/matrix-1_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/matrix-1_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/matrix-1_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/matrix-1_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/matrix-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(4, $i3));
  assume true;
  assume {:sourceloc "./output/matrix-1_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  call $i5 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i5);
  call {:cexpr "maior"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/matrix-1_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  $i6, $i7 := 0, $i5;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/matrix-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-1_tmp.c", 18, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-1_tmp.c", 19, 12} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i32($i6, 1);
  assume {:sourceloc "./output/matrix-1_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "./output/matrix-1_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $i9, $i10 := 0, $i7;
  goto $bb4;
$bb3:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/matrix-1_tmp.c", 28, 21} true;
  assume {:verifier.code 1} true;
  $i37 := $mul.i64(0, $i1);
  assume {:sourceloc "./output/matrix-1_tmp.c", 28, 21} true;
  assume {:verifier.code 1} true;
  $p38 := $add.ref($p4, $mul.ref($i37, 4));
  assume {:sourceloc "./output/matrix-1_tmp.c", 28, 21} true;
  assume {:verifier.code 1} true;
  $p39 := $add.ref($p4, $mul.ref($i37, 4));
  assume {:sourceloc "./output/matrix-1_tmp.c", 28, 21} true;
  assume {:verifier.code 1} true;
  $i40 := $load.i32($M.1, $p39);
  assume {:sourceloc "./output/matrix-1_tmp.c", 28, 33} true;
  assume {:verifier.code 1} true;
  $i41 := $sle.i32($i40, $i7);
  assume {:sourceloc "./output/matrix-1_tmp.c", 28, 33} true;
  assume {:verifier.code 1} true;
  $i42 := $zext.i1.i32($i41);
  assume {:sourceloc "./output/matrix-1_tmp.c", 28, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i42);
  assume {:sourceloc "./output/matrix-1_tmp.c", 31, 1} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  assume {:sourceloc "./output/matrix-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-1_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i32($i9, 1);
  assume {:sourceloc "./output/matrix-1_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i11 == 1);
  assume {:sourceloc "./output/matrix-1_tmp.c", 22, 23} true;
  assume {:verifier.code 0} true;
  call $i12 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i12);
  assume {:sourceloc "./output/matrix-1_tmp.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i32.i64($i6);
  assume {:sourceloc "./output/matrix-1_tmp.c", 22, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-1_tmp.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p4, $mul.ref($i17, 4));
  assume {:sourceloc "./output/matrix-1_tmp.c", 22, 21} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p18, $i12);
  assume {:sourceloc "./output/matrix-1_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i32.i64($i6);
  assume {:sourceloc "./output/matrix-1_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-1_tmp.c", 24, 23} true;
  assume {:verifier.code 0} true;
  $i26 := $sge.i32($i25, $i10);
  assume {:sourceloc "./output/matrix-1_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/matrix-1_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb7:
  assume ($i26 == 1);
  assume {:sourceloc "./output/matrix-1_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i32.i64($i6);
  assume {:sourceloc "./output/matrix-1_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-1_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p4, $mul.ref($i32, 4));
  assume {:sourceloc "./output/matrix-1_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i32($M.1, $p33);
  call {:cexpr "maior"} boogie_si_record_i32($i34);
  assume {:sourceloc "./output/matrix-1_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
  $i27 := $i34;
  goto $bb9;
$bb8:
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/matrix-1_tmp.c", 20, 22} true;
  assume {:verifier.code 0} true;
  $i35 := $add.i32($i9, 1);
  ...
  goto $bb4;
$bb11:
  assume {:sourceloc "./output/matrix-1_tmp.c", 19, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i6, 1);
  call {:cexpr "j"} boogie_si_record_i32($i36);
  assume {:sourceloc "./output/matrix-1_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i6, $i7 := $i36, $i10;
  goto $bb1;
