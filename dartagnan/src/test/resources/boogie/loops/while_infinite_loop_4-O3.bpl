...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/while_infinite_loop_4-O3.bpl /Users/ponce/git/Dat3M/./output/while_infinite_loop_4_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/while_infinite_loop_4_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/while_infinite_loop_4_tmp.c", 16, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/while_infinite_loop_4_tmp.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, x, 1bv32);
  call {:cexpr "x"} boogie_si_record_bv32(1bv32);
  assume {:sourceloc "./output/while_infinite_loop_4_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/while_infinite_loop_4_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/while_infinite_loop_4_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
