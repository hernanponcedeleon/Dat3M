...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/mod3_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/mod3_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/mod3_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/mod3_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/mod3_tmp.c", 8, 10} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/mod3_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mod3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mod3_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/mod3_tmp.c", 17, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $urem.i32($i0, 3);
  assume {:sourceloc "./output/mod3_tmp.c", 17, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 1);
  assume {:sourceloc "./output/mod3_tmp.c", 17, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/mod3_tmp.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i19 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/mod3_tmp.c", 30, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb13, $bb14;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/mod3_tmp.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i0, 2);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/mod3_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := $i6, 0;
  goto $bb6;
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/mod3_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i0, 3);
  assume {:sourceloc "./output/mod3_tmp.c", 20, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 2);
  assume {:sourceloc "./output/mod3_tmp.c", 20, 10} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/mod3_tmp.c", 21, 4} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i0, 1);
  call {:cexpr "x"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/mod3_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i12, $i13 := $i11, 0;
  goto $bb9;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/mod3_tmp.c", 23, 5} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i15 == 1);
  assume {:sourceloc "./output/mod3_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i0, 4);
  call {:cexpr "x"} boogie_si_record_i32($i16);
  assume {:sourceloc "./output/mod3_tmp.c", 24, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $i16;
  goto $bb12;
$bb11:
  assume !(($i15 == 1));
  assume {:sourceloc "./output/mod3_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i0, 5);
...
$bb13:
  assume ($i19 == 1);
  assume {:sourceloc "./output/mod3_tmp.c", 31, 25} true;
  assume {:verifier.code 1} true;
  $i20 := $urem.i32($i0, 3);
  assume {:sourceloc "./output/mod3_tmp.c", 31, 29} true;
  assume {:verifier.code 1} true;
  $i21 := $eq.i32($i20, 0);
  assume {:sourceloc "./output/mod3_tmp.c", 31, 29} true;
  assume {:verifier.code 1} true;
  $i22 := $zext.i1.i32($i21);
  assume {:sourceloc "./output/mod3_tmp.c", 31, 5} true;
  assume {:verifier.code 1} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "./output/mod3_tmp.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
