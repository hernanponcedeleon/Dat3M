...
{
$bb0:
  assume {:sourceloc "./output/cggmp2005_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/cggmp2005_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/cggmp2005_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/cggmp2005_tmp.c", 9, 15} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/cggmp2005_tmp.c", 9, 29} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/cggmp2005_tmp.c", 9, 29} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/cggmp2005_tmp.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "./output/cggmp2005_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/cggmp2005_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, $i0);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 19, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, 2);
  call {:cexpr "i"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 20, 16} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/cggmp2005_tmp.c", 22, 25} true;
  assume {:verifier.code 1} true;
  $i5 := $eq.i32($i1, 6);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 22, 25} true;
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 22, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i6);
  assume {:sourceloc "./output/cggmp2005_tmp.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
