...
axiom (__return_107 == $sub.ref(0, 2056));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 10, 2} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 13, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 14, 33} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 14, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 52, 14} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 52, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb11, $bb12;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 16, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $urem.i32($i1, 3);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 16, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 18, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 2);
  call {:cexpr "main__x"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 19, 2} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := 0, $i6;
  goto $bb6;
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i1, 3);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 25, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 2);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 21, 2} true;
  assume {:verifier.code 0} true;
  $i0, $i1 := $i7, $i8;
  goto $bb1;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 27, 20} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i1, 1);
  call {:cexpr "main__x"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 29, 2} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := 0, $i11;
  goto $bb6;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 34, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 35, 33} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 35, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb9, $bb10;
$bb9:
  assume ($i13 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 43, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i1, 5);
  call {:cexpr "main__x"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := 1, $i15;
  goto $bb6;
$bb10:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 37, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i1, 4);
  call {:cexpr "main__x"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 39, 2} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := 1, $i14;
  goto $bb6;
$bb11:
  assume ($i16 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 56, 21} true;
  assume {:verifier.code 0} true;
  $i17 := $urem.i32($i1, 3);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 56, 26} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 56, 26} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 59, 30} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 59, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb13, $bb14;
$bb12:
  assume !(($i16 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 73, 9} true;
  assume {:verifier.code 0} true;
  $i24 := $M.0;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 73, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $i24;
  goto $bb15;
$bb13:
  assume ($i20 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 61, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 62, 9} true;
  assume {:verifier.code 0} true;
  $i21 := $M.0;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $i21;
  goto $bb15;
$bb14:
  assume !(($i20 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 66, 16} true;
  assume {:verifier.code 0} true;
  $M.1 := 0;
  call {:cexpr "__return_107"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 67, 9} true;
  assume {:verifier.code 0} true;
  $i23 := $M.1;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $i23;
  goto $bb15;
$bb15:
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 76, 2} true;
  assume {:verifier.code 0} true;
  $r := $i22;
  $exn := false;
  return;
