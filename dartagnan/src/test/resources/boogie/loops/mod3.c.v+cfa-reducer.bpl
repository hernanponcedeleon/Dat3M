...
const __return_107: ref;
axiom (__return_107 == $sub.ref(0, 1028));
...
{
$bb0:
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 3, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 11, 2} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 14, 29} true;
  assume {:verifier.code 0} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  call {:cexpr "main____CPAchecker_TMP_0"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 15, 33} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 15, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 53, 14} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i0, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 53, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb11, $bb12;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 17, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $urem.i32($i1, 3);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 17, 20} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 19, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 2);
  call {:cexpr "main__x"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 20, 2} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := 0, $i6;
  goto $bb6;
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i1, 3);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 26, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 2);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 22, 2} true;
  assume {:verifier.code 0} true;
  $i0, $i1 := $i7, $i8;
  goto $bb1;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 28, 20} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i1, 1);
  call {:cexpr "main__x"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 30, 2} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := 0, $i11;
  goto $bb6;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 35, 29} true;
  assume {:verifier.code 0} true;
  call $i12 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i12);
  call {:cexpr "main____CPAchecker_TMP_1"} boogie_si_record_i32($i12);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 36, 33} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 36, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb9, $bb10;
$bb9:
  assume ($i13 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 44, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i1, 5);
  call {:cexpr "main__x"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 46, 2} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := 1, $i15;
  goto $bb6;
$bb10:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 38, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i1, 4);
  call {:cexpr "main__x"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 40, 2} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := 1, $i14;
  goto $bb6;
$bb11:
  assume ($i16 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 57, 21} true;
  assume {:verifier.code 0} true;
  $i17 := $urem.i32($i1, 3);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 57, 26} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 57, 26} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i1.i32($i18);
  call {:cexpr "__tmp_1"} boogie_si_record_i32($i19);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 60, 30} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 60, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb13, $bb14;
$bb12:
  assume !(($i16 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 74, 9} true;
  assume {:verifier.code 0} true;
  $i23 := $M.1;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 74, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $i23;
  goto $bb15;
$bb13:
  assume ($i20 == 1);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 62, 3} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 62, 17} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 62, 17} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i20 == 1));
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 67, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := 0;
  call {:cexpr "__return_107"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 68, 9} true;
  assume {:verifier.code 0} true;
  $i21 := $M.0;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 68, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $i21;
  goto $bb15;
$bb15:
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mod3.c.v+cfa-reducer_tmp.c", 77, 2} true;
  assume {:verifier.code 0} true;
  $r := $i22;
  $exn := false;
  return;
