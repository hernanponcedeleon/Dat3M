...
{
$bb0:
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 15, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i0, 6);
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 16, 6} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, 1);
  call {:cexpr "x"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $i4 := $mul.i32($i1, 2);
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 20, 23} true;
  assume {:verifier.code 1} true;
  $i5 := $urem.i32($i1, 3);
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 20, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i5);
  assume {:sourceloc "./output/underapprox_1-2_tmp.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
