...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/NetBSD_loop-O3.bpl /Users/ponce/git/Dat3M/./output/NetBSD_loop_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 22, 16} true;
  ...
  call {:cexpr "MAXPATHLEN"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 34, 7} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
