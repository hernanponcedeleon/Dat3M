...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/bubble_sort-2-O3.bpl /Users/ponce/git/Dat3M/./output/bubble_sort-2_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 50579));
...
$bb3:
  ...
  call {:cexpr "tmp___0"} boogie_si_record_bv32($i21);
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  $p23 := $load.bytes.ref($M.0, gl_list);
...
$bb8:
  ...
  call {:cexpr "__cil_tmp9"} boogie_si_record_bv32($i30);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 779, 21} true;
  assume {:verifier.code 0} true;
  $i31 := $eq.bv32($i30, $p2i.ref.bv32(gl_list));
...
$bb10:
  ...
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p32, $mul.ref($sub.ref(0, 4), 1));
  ...
  call {:cexpr "tmp"} boogie_si_record_bv32($i35);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 751, 16} true;
  assume {:verifier.code 0} true;
  $p36 := $bitcast.ref.ref($p28);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 752, 27} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p36, $mul.ref($sub.ref(0, 4), 1));
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 754, 11} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "tmp___0"} boogie_si_record_bv32($i39);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 790, 14} true;
  assume {:verifier.code 0} true;
  $i40 := $sgt.bv32($i35, $i39);
...
$bb11:
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, $p51, $p28);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 588, 16} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref($p28, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 588, 16} true;
  assume {:verifier.code 0} true;
  $p53 := $load.bytes.ref($M.0, $p52);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 562, 16} true;
  assume {:verifier.code 0} true;
  $i54 := $p2i.ref.bv64($p53);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 563, 27} true;
  assume {:verifier.code 0} true;
  $i55 := $add.bv64($i54, 4bv64);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 564, 5} true;
  assume {:verifier.code 0} true;
  $i56 := $and.bv64($i55, 4294967295bv64);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 564, 5} true;
  assume {:verifier.code 0} true;
  $p57 := $i2p.bv64.ref($i56);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 564, 38} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, $p57, $p26);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 565, 31} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, $p41, $p53);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 568, 38} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, $p46, $p28);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 569, 32} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, $p52, $p26);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  $p24, $i25 := $p26, 1bv1;
  goto $bb7;
...
$bb14:
  ...
  assume {:verifier.code 0} true;
  $p58 := $load.bytes.ref($M.0, gl_list);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 709, 18} true;
  assume {:verifier.code 0} true;
  $i59 := $p2i.ref.bv64($p58);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 709, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.bv64.bv32($i59);
  call {:cexpr "__cil_tmp3"} boogie_si_record_bv32($i60);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 711, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $eq.bv32($i60, $p2i.ref.bv32(gl_list));
...
$bb18:
  ...
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 718, 42} true;
  assume {:verifier.code 0} true;
  $i64 := $load.bytes.bv64($M.0, $p63);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 718, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv64($M.0, gl_list, $i64);
  ...
  assume {:verifier.code 0} true;
  $p66 := $add.ref($p65, $mul.ref($sub.ref(0, 4), 1));
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 728, 5} true;
  assume {:verifier.code 0} true;
  call free_($p66);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 707, 12} true;
  assume {:verifier.code 0} true;
  $p67 := $load.bytes.ref($M.0, gl_list);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 709, 18} true;
  assume {:verifier.code 0} true;
  $i68 := $p2i.ref.bv64($p67);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 709, 18} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.bv64.bv32($i68);
  call {:cexpr "__cil_tmp3"} boogie_si_record_bv32($i69);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 711, 20} true;
  assume {:verifier.code 0} true;
  $i70 := $eq.bv32($i69, $p2i.ref.bv32(gl_list));
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 711, 9} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.value == $sub.ref(0, 9299));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const malloc: ref;
axiom (malloc == $sub.ref(0, 10331));
procedure  malloc($i0: bv32)
  returns ($r: ref)
{
  call $r := $malloc($bv2int.64($zext.bv32.bv64($i0)));
}
const abort: ref;
axiom (abort == $sub.ref(0, 11363));
procedure  abort();
const inspect: ref;
axiom (inspect == $sub.ref(0, 12395));
procedure  inspect()
{
  var $i0: bv64;
  var $i1: bv32;
...
$bb0:
  ...
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 186, 18} true;
  assume {:verifier.code 0} true;
  $i0 := $load.bytes.bv64($M.0, gl_list);
  ...
  assume {:verifier.code 0} true;
  $i2 := $eq.bv32($i1, $p2i.ref.bv32(gl_list));
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  $i3 := $load.bytes.bv64($M.0, $i2p.bv32.ref($add.bv32($p2i.ref.bv32(gl_list), 4bv32)));
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 208, 19} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.bv64.bv32($i3);
  call {:cexpr "__cil_tmp11"} boogie_si_record_bv32($i4);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 209, 31} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.bv32($i4, $p2i.ref.bv32(gl_list));
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  $p6 := $load.bytes.ref($M.0, $i2p.bv32.ref($add.bv32($p2i.ref.bv32(gl_list), 4bv32)));
...
$bb8:
  ...
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 264, 19} true;
  assume {:verifier.code 0} true;
  $i17 := $load.bytes.bv64($M.0, $p16);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 265, 19} true;
  assume {:verifier.code 0} true;
  $i18 := $trunc.bv64.bv32($i17);
  call {:cexpr "__cil_tmp24"} boogie_si_record_bv32($i18);
...
$bb10:
  ...
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p20, $mul.ref($sub.ref(0, 4), 1));
...
$bb13:
  ...
  assume {:verifier.code 0} true;
  $i37 := $add.bv64($i22, 4bv64);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 355, 19} true;
  assume {:verifier.code 0} true;
  $i38 := $and.bv64($i37, 4294967295bv64);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 356, 19} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.bv64.bv32($i37);
  call {:cexpr "__cil_tmp56"} boogie_si_record_bv32($i39);
...
$bb21:
  ...
  call {:cexpr "__cil_tmp102"} boogie_si_record_bv32($i56);
...
$bb24:
  ...
  assume {:verifier.code 0} true;
  $i61 := $p2i.ref.bv64($p60);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 512, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.bv64.bv32($i61);
  call {:cexpr "__cil_tmp106"} boogie_si_record_bv32($i62);
...
$bb26:
  ...
  assume {:verifier.code 0} true;
  $p64 := $bitcast.ref.ref($p60);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 538, 33} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($p64, $mul.ref($sub.ref(0, 4), 1));
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 540, 20} true;
  assume {:verifier.code 0} true;
  $i66 := $p2i.ref.bv64($p65);
  call {:cexpr "__cil_tmp120"} boogie_si_record_bv64($i66);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 540, 20} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.bv64.bv32($i66);
  call {:cexpr "__cil_tmp121"} boogie_si_record_bv32($i67);
...
$bb28:
  assume ($i68 == 1bv1);
  assume {:sourceloc "./output/bubble_sort-2_tmp.c", 555, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb29:
...
axiom (__VERIFIER_assume == $sub.ref(0, 15491));
...
axiom (__SMACK_code == $sub.ref(0, 16523));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 17555));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18587));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 19619));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 20651));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 21683));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 22715));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 23747));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 24779));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 25811));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 26843));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 27875));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 28907));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 29939));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 30971));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 32003));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 33035));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 34067));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 35099));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 36131));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 37163));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 38195));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 39227));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 40259));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 41291));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 42323));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 43355));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 44387));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 45419));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 46451));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 47483));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 48515));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 49547));
...
axiom (__SMACK_static_init == $sub.ref(0, 50579));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bytes.ref($M.0, gl_list, gl_list);
  $M.0 := $store.bytes.ref($M.0, $add.ref($add.ref(gl_list, $mul.ref(0, 16)), $mul.ref(8, 1)), gl_list);
