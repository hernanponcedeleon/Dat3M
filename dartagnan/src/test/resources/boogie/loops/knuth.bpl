...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 45405));
...
axiom (assume_abort_if_not == $sub.ref(0, 5157));
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/knuth_tmp.c", 9, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/knuth_tmp.c", 9, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/knuth_tmp.c", 9, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 10, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/knuth_tmp.c", 9, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/knuth_tmp.c", 9, 14} true;
  assume {:verifier.code 0} true;
...
const abort: ref;
axiom (abort == $sub.ref(0, 6189));
procedure abort();
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 7221));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/knuth_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/knuth_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/knuth_tmp.c", 12, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/knuth_tmp.c", 12, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/knuth_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/knuth_tmp.c", 24, 9} true;
  ...
  assume {:sourceloc "./output/knuth_tmp.c", 25, 9} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_unsigned_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_int"} boogie_si_record_i32($i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/knuth_tmp.c", 26, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i0, 536870911);
  assume {:sourceloc "./output/knuth_tmp.c", 26, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/knuth_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/knuth_tmp.c", 27, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $ugt.i32($i1, 2);
  assume {:sourceloc "./output/knuth_tmp.c", 27, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/knuth_tmp.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/knuth_tmp.c", 30, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $urem.i32($i0, $i1);
  call {:cexpr "r"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/knuth_tmp.c", 32, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32($i1, 2);
  assume {:sourceloc "./output/knuth_tmp.c", 32, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $urem.i32($i0, $i7);
  call {:cexpr "k"} boogie_si_record_i32($i8);
  assume {:sourceloc "./output/knuth_tmp.c", 33, 21} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i1, 2);
  assume {:sourceloc "./output/knuth_tmp.c", 33, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $udiv.i32($i0, $i9);
  assume {:sourceloc "./output/knuth_tmp.c", 33, 30} true;
  assume {:verifier.code 0} true;
  $i11 := $udiv.i32($i0, $i1);
  assume {:sourceloc "./output/knuth_tmp.c", 33, 26} true;
  assume {:verifier.code 0} true;
  $i12 := $sub.i32($i10, $i11);
  assume {:sourceloc "./output/knuth_tmp.c", 33, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $mul.i32(4, $i12);
  call {:cexpr "q"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/knuth_tmp.c", 34, 14} true;
  assume {:verifier.code 0} true;
  $f14 := $ui2fp.i32.float($i0);
  assume {:sourceloc "./output/knuth_tmp.c", 34, 9} true;
  assume {:verifier.code 0} true;
  call $f15 := llvm.sqrt.f64($f14);
  assume {:sourceloc "./output/knuth_tmp.c", 34, 9} true;
  assume {:verifier.code 0} true;
  $i16 := $fp2ui.float.i32($f15);
  call {:cexpr "s"} boogie_si_record_i32($i16);
  assume {:sourceloc "./output/knuth_tmp.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i17, $i18, $i19, $i20, $i21 := $i8, $i6, $i13, $i1, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/knuth_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/knuth_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/knuth_tmp.c", 0, 0} true;
  ...
  assume {:sourceloc "./output/knuth_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/knuth_tmp.c", 37, 29} true;
  assume {:verifier.code 1} true;
  $i22 := $mul.i32($i20, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 33} true;
  assume {:verifier.code 1} true;
  $i23 := $mul.i32($i22, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 41} true;
  assume {:verifier.code 1} true;
  $i24 := $mul.i32(2, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 45} true;
  assume {:verifier.code 1} true;
  $i25 := $mul.i32($i24, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 37} true;
  assume {:verifier.code 1} true;
  $i26 := $sub.i32($i23, $i25);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 53} true;
  assume {:verifier.code 1} true;
  $i27 := $mul.i32(4, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 57} true;
  assume {:verifier.code 1} true;
  $i28 := $mul.i32($i27, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 49} true;
  assume {:verifier.code 1} true;
  $i29 := $sub.i32($i26, $i28);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 65} true;
  assume {:verifier.code 1} true;
  $i30 := $mul.i32(4, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 69} true;
  assume {:verifier.code 1} true;
  $i31 := $mul.i32($i30, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 61} true;
  assume {:verifier.code 1} true;
  $i32 := $add.i32($i29, $i31);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 77} true;
  assume {:verifier.code 1} true;
  $i33 := $mul.i32(8, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 73} true;
  assume {:verifier.code 1} true;
  $i34 := $add.i32($i32, $i33);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 86} true;
  assume {:verifier.code 1} true;
  $i35 := $mul.i32(8, $i0);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 81} true;
  assume {:verifier.code 1} true;
  $i36 := $eq.i32($i34, $i35);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 81} true;
  assume {:verifier.code 1} true;
  $i37 := $zext.i1.i32($i36);
  assume {:sourceloc "./output/knuth_tmp.c", 37, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i37);
  assume {:sourceloc "./output/knuth_tmp.c", 38, 29} true;
  assume {:verifier.code 1} true;
  $i38 := $mul.i32($i17, $i21);
  assume {:sourceloc "./output/knuth_tmp.c", 38, 38} true;
  assume {:verifier.code 1} true;
  $i39 := $mul.i32($i21, $i21);
  assume {:sourceloc "./output/knuth_tmp.c", 38, 33} true;
  assume {:verifier.code 1} true;
  $i40 := $eq.i32($i38, $i39);
  assume {:sourceloc "./output/knuth_tmp.c", 38, 33} true;
  assume {:verifier.code 1} true;
  $i41 := $zext.i1.i32($i40);
  assume {:sourceloc "./output/knuth_tmp.c", 38, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i41);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 29} true;
  assume {:verifier.code 1} true;
  $i42 := $mul.i32($i20, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 33} true;
  assume {:verifier.code 1} true;
  $i43 := $mul.i32($i42, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 41} true;
  assume {:verifier.code 1} true;
  $i44 := $mul.i32(2, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 45} true;
  assume {:verifier.code 1} true;
  $i45 := $mul.i32($i44, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 37} true;
  assume {:verifier.code 1} true;
  $i46 := $sub.i32($i43, $i45);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 53} true;
  assume {:verifier.code 1} true;
  $i47 := $mul.i32(4, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 57} true;
  assume {:verifier.code 1} true;
  $i48 := $mul.i32($i47, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 49} true;
  assume {:verifier.code 1} true;
  $i49 := $sub.i32($i46, $i48);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 65} true;
  assume {:verifier.code 1} true;
  $i50 := $mul.i32(4, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 69} true;
  assume {:verifier.code 1} true;
  $i51 := $mul.i32($i50, $i21);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 61} true;
  assume {:verifier.code 1} true;
  $i52 := $add.i32($i49, $i51);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 77} true;
  assume {:verifier.code 1} true;
  $i53 := $mul.i32(4, $i1);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 81} true;
  assume {:verifier.code 1} true;
  $i54 := $mul.i32($i53, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 73} true;
  assume {:verifier.code 1} true;
  $i55 := $add.i32($i52, $i54);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 89} true;
  assume {:verifier.code 1} true;
  $i56 := $mul.i32(4, $i1);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 93} true;
  assume {:verifier.code 1} true;
  $i57 := $mul.i32($i56, $i21);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 85} true;
  assume {:verifier.code 1} true;
  $i58 := $sub.i32($i55, $i57);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 101} true;
  assume {:verifier.code 1} true;
  $i59 := $mul.i32(8, $i0);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 97} true;
  assume {:verifier.code 1} true;
  $i60 := $sub.i32($i58, $i59);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 109} true;
  assume {:verifier.code 1} true;
  $i61 := $mul.i32(8, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 105} true;
  assume {:verifier.code 1} true;
  $i62 := $add.i32($i60, $i61);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 113} true;
  assume {:verifier.code 1} true;
  $i63 := $eq.i32($i62, 0);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 113} true;
  assume {:verifier.code 1} true;
  $i64 := $zext.i1.i32($i63);
  assume {:sourceloc "./output/knuth_tmp.c", 39, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i64);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 29} true;
  assume {:verifier.code 1} true;
  $i65 := $mul.i32($i20, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 37} true;
  assume {:verifier.code 1} true;
  $i66 := $mul.i32($i20, $i21);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 33} true;
  assume {:verifier.code 1} true;
  $i67 := $sub.i32($i65, $i66);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 45} true;
  assume {:verifier.code 1} true;
  $i68 := $mul.i32($i1, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 41} true;
  assume {:verifier.code 1} true;
  $i69 := $sub.i32($i67, $i68);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 53} true;
  assume {:verifier.code 1} true;
  $i70 := $mul.i32($i1, $i21);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 49} true;
  assume {:verifier.code 1} true;
  $i71 := $add.i32($i69, $i70);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 57} true;
  assume {:verifier.code 1} true;
  $i72 := $eq.i32($i71, 0);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 57} true;
  assume {:verifier.code 1} true;
  $i73 := $zext.i1.i32($i72);
  assume {:sourceloc "./output/knuth_tmp.c", 40, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i73);
  assume {:sourceloc "./output/knuth_tmp.c", 42, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $uge.i32($i16, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 42, 24} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i74} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i74 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 42, 30} true;
  assume {:verifier.code 0} true;
  $i75 := $ne.i32($i18, 0);
  assume {:sourceloc "./output/knuth_tmp.c", 42, 13} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/knuth_tmp.c", 42, 38} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb5:
  assume ($i75 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 44, 15} true;
  assume {:verifier.code 0} true;
  $i76 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 44, 20} true;
  assume {:verifier.code 0} true;
  $i77 := $add.i32($i76, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 44, 24} true;
  assume {:verifier.code 0} true;
  $i78 := $ult.i32($i77, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 44, 13} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "./output/knuth_tmp.c", 71, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb8:
  assume ($i78 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 46, 19} true;
  assume {:verifier.code 0} true;
  $i79 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 46, 23} true;
  assume {:verifier.code 0} true;
  $i80 := $sub.i32($i79, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 46, 27} true;
  assume {:verifier.code 0} true;
  $i81 := $add.i32($i80, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 46, 31} true;
  assume {:verifier.code 0} true;
  $i82 := $add.i32($i81, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 46, 35} true;
  assume {:verifier.code 0} true;
  $i83 := $add.i32($i82, 2);
  call {:cexpr "r"} boogie_si_record_i32($i83);
  assume {:sourceloc "./output/knuth_tmp.c", 48, 19} true;
  assume {:verifier.code 0} true;
  $i84 := $add.i32($i19, 4);
  call {:cexpr "q"} boogie_si_record_i32($i84);
  assume {:sourceloc "./output/knuth_tmp.c", 49, 19} true;
  assume {:verifier.code 0} true;
  $i85 := $add.i32($i20, 2);
  call {:cexpr "d"} boogie_si_record_i32($i85);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 9} true;
  assume {:verifier.code 0} true;
  $i86, $i87, $i88 := $i83, $i84, $i85;
  goto $bb10;
$bb9:
  assume !(($i78 == 1));
  assume {:sourceloc "./output/knuth_tmp.c", 50, 23} true;
  assume {:verifier.code 0} true;
  $i89 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 28} true;
  assume {:verifier.code 0} true;
  $i90 := $add.i32($i89, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 32} true;
  assume {:verifier.code 0} true;
  $i91 := $uge.i32($i90, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 38} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  assume {:sourceloc "./output/knuth_tmp.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i17, $i18, $i19, $i20, $i21 := $i18, $i86, $i87, $i88, $i18;
  goto $bb1;
$bb11:
  assume ($i91 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 44} true;
  assume {:verifier.code 0} true;
  $i92 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 48} true;
  assume {:verifier.code 0} true;
  $i93 := $add.i32($i92, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 56} true;
  assume {:verifier.code 0} true;
  $i94 := $add.i32($i20, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 60} true;
  assume {:verifier.code 0} true;
  $i95 := $add.i32($i94, 2);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 52} true;
  assume {:verifier.code 0} true;
  $i96 := $ult.i32($i93, $i95);
  assume {:sourceloc "./output/knuth_tmp.c", 50, 20} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "./output/knuth_tmp.c", 55, 23} true;
  assume {:verifier.code 0} true;
  $i104 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 28} true;
  assume {:verifier.code 0} true;
  $i105 := $add.i32($i104, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 32} true;
  assume {:verifier.code 0} true;
  $i106 := $uge.i32($i105, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 38} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i106} true;
  goto $bb17, $bb18;
$bb14:
  assume ($i96 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 52, 19} true;
  assume {:verifier.code 0} true;
  $i97 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 52, 23} true;
  assume {:verifier.code 0} true;
  $i98 := $sub.i32($i97, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 52, 27} true;
  assume {:verifier.code 0} true;
  $i99 := $add.i32($i98, $i19);
  call {:cexpr "r"} boogie_si_record_i32($i99);
  assume {:sourceloc "./output/knuth_tmp.c", 54, 19} true;
  assume {:verifier.code 0} true;
  $i100 := $add.i32($i20, 2);
  call {:cexpr "d"} boogie_si_record_i32($i100);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 9} true;
  assume {:verifier.code 0} true;
  $i101, $i102, $i103 := $i99, $i19, $i100;
  goto $bb16;
$bb15:
  assume {:sourceloc "./output/knuth_tmp.c", 50, 20} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i86, $i87, $i88 := $i101, $i102, $i103;
  goto $bb10;
$bb17:
  assume ($i106 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 44} true;
  assume {:verifier.code 0} true;
  $i107 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 48} true;
  assume {:verifier.code 0} true;
  $i108 := $add.i32($i107, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 57} true;
  assume {:verifier.code 0} true;
  $i109 := $add.i32($i20, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 61} true;
  assume {:verifier.code 0} true;
  $i110 := $add.i32($i109, 2);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 52} true;
  assume {:verifier.code 0} true;
  $i111 := $uge.i32($i108, $i110);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb19;
$bb19:
  assume {:sourceloc "./output/knuth_tmp.c", 63, 19} true;
  assume {:verifier.code 0} true;
  $i128 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 63, 23} true;
  assume {:verifier.code 0} true;
  $i129 := $sub.i32($i128, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 63, 27} true;
  assume {:verifier.code 0} true;
  $i130 := $add.i32($i129, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 63, 35} true;
  assume {:verifier.code 0} true;
  $i131 := $mul.i32(2, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 63, 31} true;
  assume {:verifier.code 0} true;
  $i132 := $sub.i32($i130, $i131);
  assume {:sourceloc "./output/knuth_tmp.c", 63, 39} true;
  assume {:verifier.code 0} true;
  $i133 := $sub.i32($i132, 4);
  call {:cexpr "r"} boogie_si_record_i32($i133);
  assume {:sourceloc "./output/knuth_tmp.c", 65, 19} true;
  assume {:verifier.code 0} true;
  $i134 := $sub.i32($i19, 8);
  call {:cexpr "q"} boogie_si_record_i32($i134);
  assume {:sourceloc "./output/knuth_tmp.c", 66, 19} true;
  assume {:verifier.code 0} true;
  $i135 := $add.i32($i20, 2);
  call {:cexpr "d"} boogie_si_record_i32($i135);
  assume {:verifier.code 0} true;
  $i125, $i126, $i127 := $i133, $i134, $i135;
  goto $bb24;
$bb20:
  assume ($i111 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 72} true;
  assume {:verifier.code 0} true;
  $i112 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 76} true;
  assume {:verifier.code 0} true;
  $i113 := $add.i32($i112, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 84} true;
  assume {:verifier.code 0} true;
  $i114 := $mul.i32(2, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 88} true;
  assume {:verifier.code 0} true;
  $i115 := $add.i32($i114, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 92} true;
  assume {:verifier.code 0} true;
  $i116 := $add.i32($i115, 4);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 80} true;
  assume {:verifier.code 0} true;
  $i117 := $ult.i32($i113, $i116);
  assume {:sourceloc "./output/knuth_tmp.c", 55, 20} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i117 == 1);
  assume {:sourceloc "./output/knuth_tmp.c", 57, 19} true;
  assume {:verifier.code 0} true;
  $i118 := $mul.i32(2, $i18);
  assume {:sourceloc "./output/knuth_tmp.c", 57, 23} true;
  assume {:verifier.code 0} true;
  $i119 := $sub.i32($i118, $i17);
  assume {:sourceloc "./output/knuth_tmp.c", 57, 27} true;
  assume {:verifier.code 0} true;
  $i120 := $add.i32($i119, $i19);
  assume {:sourceloc "./output/knuth_tmp.c", 57, 31} true;
  assume {:verifier.code 0} true;
  $i121 := $sub.i32($i120, $i20);
  assume {:sourceloc "./output/knuth_tmp.c", 57, 35} true;
  assume {:verifier.code 0} true;
  $i122 := $sub.i32($i121, 2);
  call {:cexpr "r"} boogie_si_record_i32($i122);
  assume {:sourceloc "./output/knuth_tmp.c", 59, 19} true;
  assume {:verifier.code 0} true;
  $i123 := $sub.i32($i19, 4);
  call {:cexpr "q"} boogie_si_record_i32($i123);
  assume {:sourceloc "./output/knuth_tmp.c", 60, 19} true;
  assume {:verifier.code 0} true;
  $i124 := $add.i32($i20, 2);
  call {:cexpr "d"} boogie_si_record_i32($i124);
  assume {:sourceloc "./output/knuth_tmp.c", 61, 9} true;
  assume {:verifier.code 0} true;
  $i125, $i126, $i127 := $i122, $i123, $i124;
  goto $bb24;
$bb23:
  assume {:sourceloc "./output/knuth_tmp.c", 55, 20} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i101, $i102, $i103 := $i125, $i126, $i127;
  goto $bb16;
}
const llvm.sqrt.f64: ref;
axiom (llvm.sqrt.f64 == $sub.ref(0, 9285));
procedure llvm.sqrt.f64($f0: float)
  returns ($r: float);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 10317));
...
axiom (__SMACK_code == $sub.ref(0, 11349));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 12381));
...
axiom (__VERIFIER_error == $sub.ref(0, 13413));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 14445));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 15477));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 16509));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 17541));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 18573));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 19605));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 20637));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 21669));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 22701));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 23733));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 24765));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 25797));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 26829));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 27861));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 28893));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 29925));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 30957));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 31989));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 33021));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 34053));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 35085));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 36117));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 37149));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 38181));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 39213));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 40245));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 41277));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 42309));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 43341));
...
axiom (llvm.dbg.value == $sub.ref(0, 44373));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 45405));
