...
{
$bb0:
  assume {:sourceloc "./output/phases_2-2_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/phases_2-2_tmp.c", 10, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 10, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 10, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/phases_2-2_tmp.c", 10, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/phases_2-2_tmp.c", 11, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/phases_2-2_tmp.c", 11, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/phases_2-2_tmp.c", 11, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/phases_2-2_tmp.c", 18, 20} true;
  ...
  assume {:sourceloc "./output/phases_2-2_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $ugt.i32($i0, 0);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 20, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i2 := 1;
  goto $bb4;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/phases_2-2_tmp.c", 20, 17} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/phases_2-2_tmp.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/phases_2-2_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.i32($i2, $i0);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i3 == 1);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $udiv.i32($i0, $i2);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 23, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i2, $i4);
...
$bb6:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/phases_2-2_tmp.c", 30, 23} true;
  assume {:verifier.code 1} true;
  $i9 := $eq.i32($i2, $i0);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 30, 23} true;
  assume {:verifier.code 1} true;
  $i10 := $zext.i1.i32($i9);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 30, 3} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume ($i5 == 1);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 24, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i2, $i2);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/phases_2-2_tmp.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $i6;
  goto $bb9;
$bb8:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/phases_2-2_tmp.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i2, 1);
