...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/nested5-1-O3.bpl /Users/ponce/git/Dat3M/./output/nested5-1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/nested5-1_tmp.c", 18, 3} true;
...
$bb1:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/nested5-1_tmp.c", 18, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $add.bv32($i0, 5bv32);
  call {:cexpr "w"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/nested5-1_tmp.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i1, 268435455bv32);
  assume {:sourceloc "./output/nested5-1_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/nested5-1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
