...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/bresenham_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/bresenham_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/bresenham_tmp.c", 12, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/bresenham_tmp.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/bresenham_tmp.c", 12, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/bresenham_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/bresenham_tmp.c", 22, 9} true;
  ...
  assume {:sourceloc "./output/bresenham_tmp.c", 23, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/bresenham_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.i32(2, $i1);
  assume {:sourceloc "./output/bresenham_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32($i2, $i0);
  call {:cexpr "v"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/bresenham_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6 := $i3, 0, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/bresenham_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/bresenham_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/bresenham_tmp.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 21} true;
  assume {:verifier.code 1} true;
  $i7 := $mul.i32(2, $i1);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 23} true;
  assume {:verifier.code 1} true;
  $i8 := $mul.i32($i7, $i5);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 29} true;
  assume {:verifier.code 1} true;
  $i9 := $mul.i32(2, $i0);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 31} true;
  assume {:verifier.code 1} true;
  $i10 := $mul.i32($i9, $i6);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 26} true;
  assume {:verifier.code 1} true;
  $i11 := $sub.i32($i8, $i10);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 34} true;
  assume {:verifier.code 1} true;
  $i12 := $sub.i32($i11, $i0);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 41} true;
  assume {:verifier.code 1} true;
  $i13 := $mul.i32(2, $i1);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 38} true;
  assume {:verifier.code 1} true;
  $i14 := $add.i32($i12, $i13);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 44} true;
  assume {:verifier.code 1} true;
  $i15 := $sub.i32($i14, $i4);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 48} true;
  assume {:verifier.code 1} true;
  $i16 := $eq.i32($i15, 0);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 48} true;
  assume {:verifier.code 1} true;
  $i17 := $zext.i1.i32($i16);
  assume {:sourceloc "./output/bresenham_tmp.c", 29, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i17);
  assume {:sourceloc "./output/bresenham_tmp.c", 30, 17} true;
  assume {:verifier.code 0} true;
  $i18 := $sle.i32($i5, $i0);
  assume {:sourceloc "./output/bresenham_tmp.c", 30, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i18 == 1);
  assume {:sourceloc "./output/bresenham_tmp.c", 34, 15} true;
  assume {:verifier.code 0} true;
  $i19 := $slt.i32($i4, 0);
  assume {:sourceloc "./output/bresenham_tmp.c", 34, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb5, $bb6;
$bb3:
  assume !(($i18 == 1));
  assume {:sourceloc "./output/bresenham_tmp.c", 31, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 24} true;
  assume {:verifier.code 1} true;
  $i29 := $mul.i32(2, $i1);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 26} true;
  assume {:verifier.code 1} true;
  $i30 := $mul.i32($i29, $i5);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 32} true;
  assume {:verifier.code 1} true;
  $i31 := $mul.i32(2, $i5);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 34} true;
  assume {:verifier.code 1} true;
  $i32 := $mul.i32($i31, $i6);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 29} true;
  assume {:verifier.code 1} true;
  $i33 := $sub.i32($i30, $i32);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 37} true;
  assume {:verifier.code 1} true;
  $i34 := $sub.i32($i33, $i0);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 44} true;
  assume {:verifier.code 1} true;
  $i35 := $mul.i32(2, $i1);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 41} true;
  assume {:verifier.code 1} true;
  $i36 := $add.i32($i34, $i35);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 47} true;
  assume {:verifier.code 1} true;
  $i37 := $sub.i32($i36, $i4);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 54} true;
  assume {:verifier.code 1} true;
  $i38 := $mul.i32(2, $i6);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 51} true;
  assume {:verifier.code 1} true;
  $i39 := $add.i32($i37, $i38);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 57} true;
  assume {:verifier.code 1} true;
  $i40 := $eq.i32($i39, 0);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 57} true;
  assume {:verifier.code 1} true;
  $i41 := $zext.i1.i32($i40);
  assume {:sourceloc "./output/bresenham_tmp.c", 42, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i41);
  assume {:sourceloc "./output/bresenham_tmp.c", 44, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb5:
  assume ($i19 == 1);
  assume {:sourceloc "./output/bresenham_tmp.c", 35, 23} true;
  assume {:verifier.code 0} true;
  $i20 := $mul.i32(2, $i1);
  assume {:sourceloc "./output/bresenham_tmp.c", 35, 19} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i4, $i20);
  call {:cexpr "v"} boogie_si_record_i32($i21);
  assume {:sourceloc "./output/bresenham_tmp.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $i22, $i23 := $i21, $i6;
  goto $bb7;
$bb6:
  assume !(($i19 == 1));
  assume {:sourceloc "./output/bresenham_tmp.c", 37, 28} true;
  assume {:verifier.code 0} true;
  $i24 := $sub.i32($i1, $i0);
  assume {:sourceloc "./output/bresenham_tmp.c", 37, 23} true;
  assume {:verifier.code 0} true;
  $i25 := $mul.i32(2, $i24);
  assume {:sourceloc "./output/bresenham_tmp.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i32($i4, $i25);
  call {:cexpr "v"} boogie_si_record_i32($i26);
  assume {:sourceloc "./output/bresenham_tmp.c", 38, 14} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i6, 1);
...
$bb7:
  ...
  assume {:sourceloc "./output/bresenham_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/bresenham_tmp.c", 40, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i5, 1);
  call {:cexpr "x"} boogie_si_record_i32($i28);
  assume {:sourceloc "./output/bresenham_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6 := $i22, $i28, $i23;
  goto $bb1;
}
