...
{
$bb0:
  assume {:sourceloc "./output/sumt8_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt8_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt8_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt8_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sumt8_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sumt8_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt8_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt8_tmp.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt8_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/sumt8_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9, $i10, $i11 := 0, 0, 0, 0, 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 19, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt8_tmp.c", 42, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 40} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i12 := $ult.i32($i8, $i0);
  assume {:sourceloc "./output/sumt8_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i12 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $urem.i32($i8, 8);
  assume {:sourceloc "./output/sumt8_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i13, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 41, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i14 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i24 := $urem.i32($i8, 7);
  assume {:sourceloc "./output/sumt8_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.i32($i24, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 24, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i14 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i3, 1);
  call {:cexpr "v5"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/sumt8_tmp.c", 23, 6} true;
  assume {:verifier.code 0} true;
  $i16, $i17, $i18, $i19, $i20, $i21, $i22, $i23 := $i15, $i4, $i5, $i6, $i7, $i9, $i10, $i11;
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/sumt8_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 10} true;
  assume {:verifier.code 0} true;
  $i70 := $add.i32($i8, 1);
  call {:cexpr "l"} boogie_si_record_i32($i70);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 25} true;
  assume {:verifier.code 1} true;
  $i71 := $add.i32($i23, $i21);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 27} true;
  assume {:verifier.code 1} true;
  $i72 := $add.i32($i71, $i22);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 29} true;
  assume {:verifier.code 1} true;
  $i73 := $add.i32($i72, $i20);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 32} true;
  assume {:verifier.code 1} true;
  $i74 := $add.i32($i73, $i19);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 35} true;
  assume {:verifier.code 1} true;
  $i75 := $add.i32($i74, $i18);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 38} true;
  assume {:verifier.code 1} true;
  $i76 := $add.i32($i75, $i17);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 41} true;
  assume {:verifier.code 1} true;
  $i77 := $add.i32($i76, $i16);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 46} true;
  assume {:verifier.code 1} true;
  $i78 := $eq.i32($i77, $i70);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 46} true;
  assume {:verifier.code 1} true;
  $i79 := $zext.i1.i32($i78);
  assume {:sourceloc "./output/sumt8_tmp.c", 39, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i79);
  assume {:sourceloc "./output/sumt8_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9, $i10, $i11 := $i16, $i17, $i18, $i19, $i20, $i70, $i21, $i22, $i23;
  goto $bb4;
$bb10:
  assume ($i25 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i34 := $urem.i32($i8, 6);
  assume {:sourceloc "./output/sumt8_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i34, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 26, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i35} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i25 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i32($i7, 1);
  call {:cexpr "v1"} boogie_si_record_i32($i26);
  assume {:sourceloc "./output/sumt8_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $i27, $i28, $i29, $i30, $i31, $i32, $i33 := $i4, $i5, $i6, $i26, $i9, $i10, $i11;
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i16, $i17, $i18, $i19, $i20, $i21, $i22, $i23 := $i3, $i27, $i28, $i29, $i30, $i31, $i32, $i33;
  goto $bb9;
$bb13:
  assume ($i35 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i43 := $urem.i32($i8, 5);
  assume {:sourceloc "./output/sumt8_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i43, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 28, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i44} true;
  goto $bb16, $bb17;
$bb14:
  assume !(($i35 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 27, 14} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i6, 1);
  call {:cexpr "v2"} boogie_si_record_i32($i36);
  assume {:sourceloc "./output/sumt8_tmp.c", 27, 6} true;
  assume {:verifier.code 0} true;
  $i37, $i38, $i39, $i40, $i41, $i42 := $i4, $i5, $i36, $i9, $i10, $i11;
  goto $bb15;
$bb15:
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i27, $i28, $i29, $i30, $i31, $i32, $i33 := $i37, $i38, $i39, $i7, $i40, $i41, $i42;
  goto $bb12;
$bb16:
  assume ($i44 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 30, 15} true;
  assume {:verifier.code 0} true;
  $i51 := $urem.i32($i8, 4);
  assume {:sourceloc "./output/sumt8_tmp.c", 30, 15} true;
  assume {:verifier.code 0} true;
  $i52 := $ne.i32($i51, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 30, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb19, $bb20;
$bb17:
  assume !(($i44 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 29, 14} true;
  assume {:verifier.code 0} true;
  $i45 := $add.i32($i5, 1);
  call {:cexpr "v3"} boogie_si_record_i32($i45);
  assume {:sourceloc "./output/sumt8_tmp.c", 29, 6} true;
  assume {:verifier.code 0} true;
  $i46, $i47, $i48, $i49, $i50 := $i4, $i45, $i9, $i10, $i11;
  goto $bb18;
$bb18:
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i37, $i38, $i39, $i40, $i41, $i42 := $i46, $i47, $i6, $i48, $i49, $i50;
  goto $bb15;
$bb19:
  assume ($i52 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 32, 15} true;
  assume {:verifier.code 0} true;
  $i58 := $urem.i32($i8, 3);
  assume {:sourceloc "./output/sumt8_tmp.c", 32, 15} true;
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i58, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 32, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i59} true;
  goto $bb22, $bb23;
$bb20:
  assume !(($i52 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 31, 14} true;
  assume {:verifier.code 0} true;
  $i53 := $add.i32($i4, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i53);
  assume {:sourceloc "./output/sumt8_tmp.c", 31, 6} true;
  assume {:verifier.code 0} true;
  $i54, $i55, $i56, $i57 := $i53, $i9, $i10, $i11;
  goto $bb21;
$bb21:
  assume {:sourceloc "./output/sumt8_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i46, $i47, $i48, $i49, $i50 := $i54, $i5, $i55, $i56, $i57;
  goto $bb18;
$bb22:
  assume ($i59 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 34, 15} true;
  assume {:verifier.code 0} true;
  $i64 := $urem.i32($i8, 2);
  assume {:sourceloc "./output/sumt8_tmp.c", 34, 15} true;
  assume {:verifier.code 0} true;
  $i65 := $ne.i32($i64, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 34, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i65} true;
  goto $bb25, $bb26;
$bb23:
  assume !(($i59 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 33, 12} true;
  assume {:verifier.code 0} true;
  $i60 := $add.i32($i11, 1);
  call {:cexpr "i"} boogie_si_record_i32($i60);
  assume {:sourceloc "./output/sumt8_tmp.c", 33, 6} true;
  assume {:verifier.code 0} true;
  $i61, $i62, $i63 := $i9, $i10, $i60;
  goto $bb24;
$bb24:
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i54, $i55, $i56, $i57 := $i4, $i61, $i62, $i63;
  goto $bb21;
$bb25:
  assume ($i65 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 37, 11} true;
  assume {:verifier.code 0} true;
  $i69 := $add.i32($i10, 1);
...
$bb26:
  assume !(($i65 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 35, 10} true;
  assume {:verifier.code 0} true;
  $i66 := $add.i32($i9, 1);
  call {:cexpr "j"} boogie_si_record_i32($i66);
  assume {:sourceloc "./output/sumt8_tmp.c", 35, 5} true;
  assume {:verifier.code 0} true;
  $i67, $i68 := $i66, $i10;
  goto $bb27;
$bb27:
