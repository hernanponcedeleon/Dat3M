...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt8_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt8_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/sumt8_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 7, 16} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/sumt8_tmp.c", 8, 12} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/sumt8_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt8_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt8_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt8_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9, $i10, $i11 := 0, 0, 0, 0, 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt8_tmp.c", 41, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 40} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 16, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 15, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 19, 12} true;
  assume {:verifier.code 0} true;
  $i12 := $ult.i32($i8, $i0);
  assume {:sourceloc "./output/sumt8_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i12 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $urem.i32($i8, 8);
  assume {:sourceloc "./output/sumt8_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i13, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i14 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i24 := $urem.i32($i8, 7);
  assume {:sourceloc "./output/sumt8_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.i32($i24, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 23, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i14 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i3, 1);
  call {:cexpr "v5"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/sumt8_tmp.c", 22, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:sourceloc "./output/sumt8_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt8_tmp.c", 37, 10} true;
  assume {:verifier.code 0} true;
  $i70 := $add.i32($i8, 1);
  call {:cexpr "l"} boogie_si_record_i32($i70);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 25} true;
  assume {:verifier.code 1} true;
  $i71 := $add.i32($i23, $i21);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 27} true;
  assume {:verifier.code 1} true;
  $i72 := $add.i32($i71, $i22);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 29} true;
  assume {:verifier.code 1} true;
  $i73 := $add.i32($i72, $i20);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 32} true;
  assume {:verifier.code 1} true;
  $i74 := $add.i32($i73, $i19);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 35} true;
  assume {:verifier.code 1} true;
  $i75 := $add.i32($i74, $i18);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 38} true;
  assume {:verifier.code 1} true;
  $i76 := $add.i32($i75, $i17);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 41} true;
  assume {:verifier.code 1} true;
  $i77 := $add.i32($i76, $i16);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 46} true;
  assume {:verifier.code 1} true;
  $i78 := $eq.i32($i77, $i70);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 46} true;
  assume {:verifier.code 1} true;
  $i79 := $zext.i1.i32($i78);
  assume {:sourceloc "./output/sumt8_tmp.c", 38, 5} true;
  assume {:verifier.code 1} true;
...
$bb10:
  assume ($i25 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i34 := $urem.i32($i8, 6);
  assume {:sourceloc "./output/sumt8_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i34, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 25, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i35} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i25 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i32($i7, 1);
  call {:cexpr "v1"} boogie_si_record_i32($i26);
  assume {:sourceloc "./output/sumt8_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i35 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i43 := $urem.i32($i8, 5);
  assume {:sourceloc "./output/sumt8_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i43, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 27, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i44} true;
  goto $bb16, $bb17;
$bb14:
  assume !(($i35 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 26, 14} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i6, 1);
  call {:cexpr "v2"} boogie_si_record_i32($i36);
  assume {:sourceloc "./output/sumt8_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i44 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $i51 := $urem.i32($i8, 4);
  assume {:sourceloc "./output/sumt8_tmp.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $i52 := $ne.i32($i51, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 29, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb19, $bb20;
$bb17:
  assume !(($i44 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 28, 14} true;
  assume {:verifier.code 0} true;
  $i45 := $add.i32($i5, 1);
  call {:cexpr "v3"} boogie_si_record_i32($i45);
  assume {:sourceloc "./output/sumt8_tmp.c", 28, 6} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i52 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 31, 15} true;
  assume {:verifier.code 0} true;
  $i58 := $urem.i32($i8, 3);
  assume {:sourceloc "./output/sumt8_tmp.c", 31, 15} true;
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i58, 0);
  assume {:sourceloc "./output/sumt8_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i59} true;
  goto $bb22, $bb23;
$bb20:
  assume !(($i52 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 30, 14} true;
  assume {:verifier.code 0} true;
  $i53 := $add.i32($i4, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i53);
  assume {:sourceloc "./output/sumt8_tmp.c", 30, 6} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i59 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 33, 15} true;
  assume {:verifier.code 0} true;
  $i64 := $urem.i32($i8, 2);
  assume {:sourceloc "./output/sumt8_tmp.c", 33, 15} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  assume {:sourceloc "./output/sumt8_tmp.c", 32, 6} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i65 == 1);
  assume {:sourceloc "./output/sumt8_tmp.c", 36, 11} true;
  assume {:verifier.code 0} true;
  $i69 := $add.i32($i10, 1);
...
$bb26:
  assume !(($i65 == 1));
  assume {:sourceloc "./output/sumt8_tmp.c", 34, 10} true;
  assume {:verifier.code 0} true;
  $i66 := $add.i32($i9, 1);
  call {:cexpr "j"} boogie_si_record_i32($i66);
  assume {:sourceloc "./output/sumt8_tmp.c", 34, 5} true;
  assume {:verifier.code 0} true;
  $i67, $i68 := $i66, $i10;
  goto $bb27;
$bb27:
