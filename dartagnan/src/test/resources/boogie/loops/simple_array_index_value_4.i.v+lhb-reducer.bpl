...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 46425));
...
const __tmp_155_0: ref;
axiom (__tmp_155_0 == $sub.ref(0, 2056));
const __return_136: ref;
axiom (__return_136 == $sub.ref(0, 3084));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 4116));
const {:count 3} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 5143));
const {:count 14} .str.14: ref;
axiom (.str.14 == $sub.ref(0, 6181));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 7209));
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 8241));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const main: ref;
axiom (main == $sub.ref(0, 9273));
procedure main()
  returns ($r: i32)
{
  var $p0: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(400000, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i1);
  call {:cexpr "main__index1"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 19, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i1, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 19, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 21, 17} true;
  assume {:verifier.code 0} true;
  call $i3 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i3);
  call {:cexpr "main__index2"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 22, 19} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.i32($i3, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 22, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb3, $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 192, 9} true;
  assume {:verifier.code 0} true;
  $i64 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 192, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i64;
  goto $bb14;
$bb3:
  assume ($i4 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 24, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i1, $i3);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb4:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 187, 9} true;
  assume {:verifier.code 0} true;
  $i63 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 187, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i63;
  goto $bb14;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 27, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i1, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 27, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 154, 27} true;
  assume {:verifier.code 0} true;
  $i49 := $eq.i32(0, 0);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 154, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb38, $bb39;
$bb7:
  assume ($i6 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 29, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $ult.i32($i3, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 29, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb9, $bb10;
$bb8:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 149, 2} true;
  assume {:verifier.code 0} true;
  goto $bb37;
$bb9:
  assume ($i7 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 31, 2} true;
  assume {:verifier.code 0} true;
  $i8 := 1;
  goto $bb11;
$bb10:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 141, 2} true;
  assume {:verifier.code 0} true;
  goto $bb37;
$bb11:
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 38, 30} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 0);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 38, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb12, $bb13;
$bb12:
  assume ($i9 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 41, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 41, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i10;
  goto $bb14;
$bb13:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 45, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $i8;
  call {:cexpr "__tmp_155_0"} boogie_si_record_i32($i8);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $i12, $i13 := $i3, $i1;
  goto $bb15;
$bb14:
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 194, 2} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $exn := false;
  return;
$bb15:
  ...
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 48, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i32.i64($i13);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 48, 7} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i14, 4));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 48, 7} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.2, $p15);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 48, 38} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64($i12);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 48, 38} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i17, 4));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 48, 38} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.2, $p18);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 48, 34} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i16, $i19);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 48, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i20 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 51, 30} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i13, 1);
  call {:cexpr "main__index1"} boogie_si_record_i32($i21);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 53, 30} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i32($i12, 1);
  call {:cexpr "main__index2"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 55, 19} true;
  assume {:verifier.code 0} true;
  $i23 := $ult.i32($i21, $i22);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 55, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb18, $bb19;
$bb17:
  assume !(($i20 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 135, 9} true;
  assume {:verifier.code 0} true;
  $i48 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 135, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i48;
  goto $bb14;
$bb18:
  assume ($i23 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 58, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $ult.i32($i21, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 58, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb20, $bb21;
$bb19:
  assume !(($i23 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 95, 27} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.i32(1, 0);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 95, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb28, $bb29;
$bb20:
  assume ($i24 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 60, 19} true;
  assume {:verifier.code 0} true;
  $i25 := $ult.i32($i22, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 60, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb22, $bb23;
$bb21:
  assume !(($i24 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 90, 2} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb22:
  assume ($i25 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $i26 := 1;
  goto $bb24;
$bb23:
  assume !(($i25 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 82, 2} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb24:
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 69, 30} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.i32($i26, 0);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 69, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb25, $bb26;
$bb25:
  assume ($i27 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 71, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 72, 9} true;
  assume {:verifier.code 0} true;
  $i28 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 72, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i28;
  goto $bb14;
$bb26:
  assume !(($i27 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 76, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $i26;
  call {:cexpr "__tmp_155_0"} boogie_si_record_i32($i26);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 77, 2} true;
  assume {:verifier.code 0} true;
  $i12, $i13 := $i22, $i21;
  goto $bb15;
$bb27:
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 85, 2} true;
  assume {:verifier.code 0} true;
  $i26 := 0;
  goto $bb24;
$bb28:
  assume ($i29 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 129, 2} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb29:
  assume !(($i29 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 96, 2} true;
  assume {:verifier.code 0} true;
  $i30, $i31 := $i22, $i21;
  goto $bb30;
$bb30:
  ...
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 98, 19} true;
  assume {:verifier.code 0} true;
  $i32 := $ult.i32($i30, $i31);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 98, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i32} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i32 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 102, 13} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i32.i64($i31);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 102, 13} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i33, 4));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 102, 13} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.2, $p34);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 102, 44} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i32.i64($i30);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 102, 44} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i36, 4));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 102, 44} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i32($M.2, $p37);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 102, 40} true;
  assume {:verifier.code 0} true;
  $i39 := $eq.i32($i35, $i38);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 102, 40} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i1.i32($i39);
  call {:cexpr "__tmp_3"} boogie_si_record_i32($i40);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 105, 30} true;
  assume {:verifier.code 0} true;
  $i41 := $eq.i32($i40, 0);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 105, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i41} true;
  goto $bb33, $bb34;
$bb32:
  assume !(($i32 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 122, 2} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb33:
  assume ($i41 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 107, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 108, 9} true;
  assume {:verifier.code 0} true;
  $i42 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 108, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i42;
  goto $bb14;
$bb34:
  assume !(($i41 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 111, 2} true;
  assume {:verifier.code 0} true;
  $i43, $i44 := $i30, $i31;
  goto $bb35;
$bb35:
  ...
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 114, 30} true;
  assume {:verifier.code 0} true;
  $i45 := $add.i32($i43, 1);
  call {:cexpr "main__index2"} boogie_si_record_i32($i45);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 116, 30} true;
  assume {:verifier.code 0} true;
  $i46 := $sub.i32($i44, 1);
  call {:cexpr "main__index1"} boogie_si_record_i32($i46);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 117, 2} true;
  assume {:verifier.code 0} true;
  $i30, $i31 := $i45, $i46;
  goto $bb30;
$bb36:
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 124, 9} true;
  assume {:verifier.code 0} true;
  $i47 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 124, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i47;
  goto $bb14;
$bb37:
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 144, 2} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  goto $bb11;
$bb38:
  assume ($i49 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 181, 9} true;
  assume {:verifier.code 0} true;
  $i62 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 181, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i62;
  goto $bb14;
$bb39:
  assume !(($i49 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 156, 19} true;
  assume {:verifier.code 0} true;
  $i50 := $ult.i32($i3, $i1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 156, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i50 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 160, 13} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.i32.i64($i1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 160, 13} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i51, 4));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 160, 13} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i32($M.2, $p52);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 160, 44} true;
  assume {:verifier.code 0} true;
  $i54 := $zext.i32.i64($i3);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 160, 44} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i54, 4));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 160, 44} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i32($M.2, $p55);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 160, 40} true;
  assume {:verifier.code 0} true;
  $i57 := $eq.i32($i53, $i56);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 160, 40} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i32($i57);
  call {:cexpr "__tmp_4"} boogie_si_record_i32($i58);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 163, 30} true;
  assume {:verifier.code 0} true;
  $i59 := $eq.i32($i58, 0);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 163, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i59} true;
  goto $bb42, $bb43;
$bb41:
  assume !(($i50 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 176, 9} true;
  assume {:verifier.code 0} true;
  $i61 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 176, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i61;
  goto $bb14;
$bb42:
  assume ($i59 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 165, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 166, 9} true;
  assume {:verifier.code 0} true;
  $i60 := $M.0;
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 166, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i60;
  goto $bb14;
$bb43:
  assume !(($i59 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4.i.v+lhb-reducer_tmp.c", 170, 2} true;
  assume {:verifier.code 0} true;
  $i43, $i44 := $i3, $i1;
  goto $bb35;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 10305));
...
axiom (__SMACK_code == $sub.ref(0, 11337));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 12369));
...
axiom (__VERIFIER_error == $sub.ref(0, 13401));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 14433));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 15465));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 16497));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 17529));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 18561));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 19593));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 20625));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 21657));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 22689));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 23721));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 24753));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 25785));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 26817));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 27849));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 28881));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 29913));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 30945));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 31977));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 33009));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 34041));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 35073));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 36105));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 37137));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 38169));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 39201));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 40233));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 41265));
...
axiom (__SMACK_decls == $sub.ref(0, 42297));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 43329));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 44361));
...
axiom (llvm.dbg.value == $sub.ref(0, 45393));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 46425));
...
$bb0:
  ...
  $M.1 := 0;
  call {:cexpr "__tmp_155_0"} boogie_si_record_i32(0);
  $M.3 := 0;
  call {:cexpr "__return_136"} boogie_si_record_i32(0);
  $M.4 := .str.1.5;
  $M.5 := 0;
