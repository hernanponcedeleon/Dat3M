...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/count_by_1_variant-O3.bpl /Users/ponce/git/Dat3M/./output/count_by_1_variant_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/count_by_1_variant_tmp.c", 16, 5} true;
...
$bb1:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/count_by_1_variant_tmp.c", 16, 32} true;
  assume {:verifier.code 0} true;
  $i1 := $add.bv32($i0, 25bv32);
  call {:cexpr "i"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/count_by_1_variant_tmp.c", 16, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.bv32($i1, 1000000bv32);
  assume {:sourceloc "./output/count_by_1_variant_tmp.c", 16, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/count_by_1_variant_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
