...
{
$bb0:
  assume {:sourceloc "./output/deep-nested_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 29} true;
  assume {:verifier.code 0} true;
  $i1 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i0, $i1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 24, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i3, $i4);
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 9} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
  goto $bb7;
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 22, 2} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb7:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i32($i6, $i7);
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 4} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i8 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  goto $bb10;
$bb9:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb30;
$bb10:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 32} true;
  assume {:verifier.code 0} true;
  $i10 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 19} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i32($i9, $i10);
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 5} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 20, 4} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb13:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 33} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $ult.i32($i12, $i13);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb14, $bb15;
$bb14:
  assume ($i14 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i0, $i3);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb16, $bb17;
$bb15:
  assume !(($i14 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb16:
  assume ($i15 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 26} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i3, $i6);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 32} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "./output/deep-nested_tmp.c", 18, 6} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb19:
  assume ($i16 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 38} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i6, $i9);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 44} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i17 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 50} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i9, $i12);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 56} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume ($i18 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 77} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i32($sub.i32(0, 1), 2);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 62} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i12, $i19);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 11} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i20 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/deep-nested_tmp.c", 16, 23} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/deep-nested_tmp.c", 16, 23} true;
  assume {:verifier.code 0} true;
...
$bb27:
  ...
  goto $bb13;
$bb28:
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 37} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i9, 1);
  ...
  goto $bb10;
$bb29:
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 36} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i6, 1);
  ...
  goto $bb7;
$bb30:
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 35} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i3, 1);
  ...
  goto $bb4;
$bb31:
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 34} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i0, 1);
