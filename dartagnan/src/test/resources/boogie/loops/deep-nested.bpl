...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 40245));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/deep-nested_tmp.c", 9, 7} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 9, 29} true;
  assume {:verifier.code 0} true;
  $i1 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 9, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i0, $i1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 9, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 8} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 23, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 30} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i3, $i4);
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
  goto $bb7;
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 21, 2} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb7:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i32($i6, $i7);
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 4} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i8 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  goto $bb10;
$bb9:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb30;
$bb10:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 32} true;
  assume {:verifier.code 0} true;
  $i10 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 19} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i32($i9, $i10);
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb11, $bb12;
$bb11:
  assume ($i11 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 11} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
  goto $bb13;
$bb12:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 19, 4} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb13:
  assume {:sourceloc "./output/deep-nested_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 33} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i32($sub.i32(0, 1), 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $ult.i32($i12, $i13);
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb14, $bb15;
$bb14:
  assume ($i14 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i0, $i3);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 20} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb16, $bb17;
$bb15:
  assume !(($i14 == 1));
  assume {:sourceloc "./output/deep-nested_tmp.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb16:
  assume ($i15 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 26} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i3, $i6);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 32} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "./output/deep-nested_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb19:
  assume ($i16 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 38} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i6, $i9);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 44} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i17 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 50} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i9, $i12);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 56} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume ($i18 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 77} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i32($sub.i32(0, 1), 2);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 62} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i12, $i19);
  assume {:sourceloc "./output/deep-nested_tmp.c", 14, 11} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i20 == 1);
  assume {:sourceloc "./output/deep-nested_tmp.c", 15, 8} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb18;
$bb27:
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 38} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i12, 1);
  call {:cexpr "e"} boogie_si_record_i32($i21);
  assume {:sourceloc "./output/deep-nested_tmp.c", 13, 6} true;
  assume {:verifier.code 0} true;
  $i12 := $i21;
  goto $bb13;
$bb28:
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 37} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i9, 1);
  call {:cexpr "d"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/deep-nested_tmp.c", 12, 5} true;
  assume {:verifier.code 0} true;
  $i9 := $i22;
  goto $bb10;
$bb29:
  assume {:sourceloc "./output/deep-nested_tmp.c", 11, 36} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i6, 1);
  ...
  goto $bb7;
$bb30:
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 35} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i3, 1);
  call {:cexpr "b"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/deep-nested_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i24;
  goto $bb4;
$bb31:
  assume {:sourceloc "./output/deep-nested_tmp.c", 9, 34} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i0, 1);
  call {:cexpr "a"} boogie_si_record_i32($i25);
  assume {:sourceloc "./output/deep-nested_tmp.c", 9, 2} true;
  assume {:verifier.code 0} true;
  $i0 := $i25;
  goto $bb1;
...
axiom (__SMACK_nondet_int == $sub.ref(0, 19605));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 20637));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 21669));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 22701));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 23733));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 24765));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 25797));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 26829));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 27861));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 28893));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 29925));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 30957));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 31989));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 33021));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 34053));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 35085));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 36117));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37149));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38181));
...
axiom (llvm.dbg.value == $sub.ref(0, 39213));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 40245));
