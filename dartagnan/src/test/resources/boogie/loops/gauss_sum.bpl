...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/gauss_sum_tmp.c", 5, 9} true;
  ...
  assume {:sourceloc "./output/gauss_sum_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $sle.i32(1, $i0);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 6, 18} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 6, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sle.i32($i0, 1000);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 6, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/gauss_sum_tmp.c", 6, 33} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb4:
  assume ($i2 == 1);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 8, 9} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := 0, 1;
  goto $bb7;
$bb5:
  ...
  goto $bb3;
$bb6:
  assume {:sourceloc "./output/gauss_sum_tmp.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb7:
  assume {:sourceloc "./output/gauss_sum_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gauss_sum_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/gauss_sum_tmp.c", 8, 18} true;
  assume {:verifier.code 0} true;
  $i5 := $sle.i32($i4, $i0);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 8, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i5 == 1);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 9, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i3, $i4);
  call {:cexpr "sum"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 10, 5} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/gauss_sum_tmp.c", 11, 24} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32(2, $i3);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 11, 36} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i0, 1);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 11, 33} true;
  assume {:verifier.code 0} true;
  $i10 := $mul.i32($i0, $i9);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 11, 29} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i8, $i10);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 11, 29} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 11, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := __VERIFIER_assert.i32($i12);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/gauss_sum_tmp.c", 12, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb10:
  assume {:sourceloc "./output/gauss_sum_tmp.c", 8, 25} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i4, 1);
