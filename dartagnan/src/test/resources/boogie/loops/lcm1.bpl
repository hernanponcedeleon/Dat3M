...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/lcm1_tmp.c", 10, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/lcm1_tmp.c", 10, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/lcm1_tmp.c", 10, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/lcm1_tmp.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/lcm1_tmp.c", 10, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/lcm1_tmp.c", 10, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/lcm1_tmp.c", 13, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/lcm1_tmp.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/lcm1_tmp.c", 13, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/lcm1_tmp.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/lcm1_tmp.c", 13, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/lcm1_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/lcm1_tmp.c", 23, 9} true;
  ...
  assume {:sourceloc "./output/lcm1_tmp.c", 24, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/lcm1_tmp.c", 25, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $uge.i32($i0, 1);
  assume {:sourceloc "./output/lcm1_tmp.c", 25, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/lcm1_tmp.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/lcm1_tmp.c", 26, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $uge.i32($i1, 1);
  assume {:sourceloc "./output/lcm1_tmp.c", 26, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/lcm1_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/lcm1_tmp.c", 28, 27} true;
  assume {:verifier.code 0} true;
  $i6 := $ule.i32($i0, 65535);
  assume {:sourceloc "./output/lcm1_tmp.c", 28, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i32($i6);
  assume {:sourceloc "./output/lcm1_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i7);
  assume {:sourceloc "./output/lcm1_tmp.c", 29, 27} true;
  assume {:verifier.code 0} true;
  $i8 := $ule.i32($i1, 65535);
  assume {:sourceloc "./output/lcm1_tmp.c", 29, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/lcm1_tmp.c", 29, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "./output/lcm1_tmp.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i10, $i11, $i12, $i13 := $i0, $i1, $i1, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/lcm1_tmp.c", 31, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lcm1_tmp.c", 32, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lcm1_tmp.c", 33, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lcm1_tmp.c", 34, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lcm1_tmp.c", 37, 28} true;
  assume {:verifier.code 1} true;
  $i14 := $mul.i32($i10, $i12);
  assume {:sourceloc "./output/lcm1_tmp.c", 37, 34} true;
  assume {:verifier.code 1} true;
  $i15 := $mul.i32($i11, $i13);
  assume {:sourceloc "./output/lcm1_tmp.c", 37, 31} true;
  assume {:verifier.code 1} true;
  $i16 := $add.i32($i14, $i15);
  assume {:sourceloc "./output/lcm1_tmp.c", 37, 41} true;
  assume {:verifier.code 1} true;
  $i17 := $mul.i32($i0, $i1);
  assume {:sourceloc "./output/lcm1_tmp.c", 37, 37} true;
  assume {:verifier.code 1} true;
  $i18 := $eq.i32($i16, $i17);
  assume {:sourceloc "./output/lcm1_tmp.c", 37, 37} true;
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "./output/lcm1_tmp.c", 37, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i19);
  assume {:sourceloc "./output/lcm1_tmp.c", 38, 17} true;
  assume {:verifier.code 0} true;
  $i20 := $ne.i32($i10, $i11);
  assume {:sourceloc "./output/lcm1_tmp.c", 38, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i20 == 1);
  assume {:sourceloc "./output/lcm1_tmp.c", 41, 9} true;
  assume {:verifier.code 0} true;
  $i21, $i22 := $i10, $i13;
  goto $bb5;
$bb3:
  assume !(($i20 == 1));
  assume {:sourceloc "./output/lcm1_tmp.c", 39, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/lcm1_tmp.c", 58, 24} true;
  assume {:verifier.code 1} true;
  $i43 := $mul.i32($i12, $i11);
  assume {:sourceloc "./output/lcm1_tmp.c", 58, 30} true;
  assume {:verifier.code 1} true;
  $i44 := $mul.i32($i13, $i11);
  assume {:sourceloc "./output/lcm1_tmp.c", 58, 27} true;
  assume {:verifier.code 1} true;
  $i45 := $add.i32($i43, $i44);
  assume {:sourceloc "./output/lcm1_tmp.c", 58, 37} true;
  assume {:verifier.code 1} true;
  $i46 := $mul.i32($i0, $i1);
  assume {:sourceloc "./output/lcm1_tmp.c", 58, 33} true;
  assume {:verifier.code 1} true;
  $i47 := $eq.i32($i45, $i46);
  assume {:sourceloc "./output/lcm1_tmp.c", 58, 33} true;
  assume {:verifier.code 1} true;
  $i48 := $zext.i1.i32($i47);
  assume {:sourceloc "./output/lcm1_tmp.c", 58, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i48);
  assume {:sourceloc "./output/lcm1_tmp.c", 59, 25} true;
  assume {:verifier.code 1} true;
  $i49 := $eq.i32($i10, $i11);
  assume {:sourceloc "./output/lcm1_tmp.c", 59, 25} true;
  assume {:verifier.code 1} true;
  $i50 := $zext.i1.i32($i49);
  assume {:sourceloc "./output/lcm1_tmp.c", 59, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i50);
  assume {:sourceloc "./output/lcm1_tmp.c", 63, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb5:
  assume {:sourceloc "./output/lcm1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lcm1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lcm1_tmp.c", 42, 25} true;
  assume {:verifier.code 1} true;
  $i23 := $mul.i32($i21, $i12);
  assume {:sourceloc "./output/lcm1_tmp.c", 42, 31} true;
  assume {:verifier.code 1} true;
  $i24 := $mul.i32($i11, $i22);
  assume {:sourceloc "./output/lcm1_tmp.c", 42, 28} true;
  assume {:verifier.code 1} true;
  $i25 := $add.i32($i23, $i24);
  assume {:sourceloc "./output/lcm1_tmp.c", 42, 38} true;
  assume {:verifier.code 1} true;
  $i26 := $mul.i32($i0, $i1);
  assume {:sourceloc "./output/lcm1_tmp.c", 42, 34} true;
  assume {:verifier.code 1} true;
  $i27 := $eq.i32($i25, $i26);
  assume {:sourceloc "./output/lcm1_tmp.c", 42, 34} true;
  assume {:verifier.code 1} true;
  $i28 := $zext.i1.i32($i27);
  assume {:sourceloc "./output/lcm1_tmp.c", 42, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i28);
  assume {:sourceloc "./output/lcm1_tmp.c", 43, 21} true;
  assume {:verifier.code 0} true;
  $i29 := $ugt.i32($i21, $i11);
  assume {:sourceloc "./output/lcm1_tmp.c", 43, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i29 == 1);
  assume {:sourceloc "./output/lcm1_tmp.c", 45, 19} true;
  assume {:verifier.code 0} true;
  $i30 := $sub.i32($i21, $i11);
  call {:cexpr "x"} boogie_si_record_i32($i30);
  assume {:sourceloc "./output/lcm1_tmp.c", 46, 19} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i32($i22, $i12);
...
$bb7:
  assume !(($i29 == 1));
  assume {:sourceloc "./output/lcm1_tmp.c", 44, 17} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/lcm1_tmp.c", 49, 9} true;
  assume {:verifier.code 0} true;
  $i32, $i33 := $i11, $i12;
  goto $bb9;
$bb9:
  ...
  assume {:sourceloc "./output/lcm1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/lcm1_tmp.c", 50, 25} true;
  assume {:verifier.code 1} true;
  $i34 := $mul.i32($i21, $i33);
  assume {:sourceloc "./output/lcm1_tmp.c", 50, 31} true;
  assume {:verifier.code 1} true;
  $i35 := $mul.i32($i32, $i22);
  assume {:sourceloc "./output/lcm1_tmp.c", 50, 28} true;
  assume {:verifier.code 1} true;
  $i36 := $add.i32($i34, $i35);
  assume {:sourceloc "./output/lcm1_tmp.c", 50, 38} true;
  assume {:verifier.code 1} true;
  $i37 := $mul.i32($i0, $i1);
  assume {:sourceloc "./output/lcm1_tmp.c", 50, 34} true;
  assume {:verifier.code 1} true;
  $i38 := $eq.i32($i36, $i37);
  assume {:sourceloc "./output/lcm1_tmp.c", 50, 34} true;
  assume {:verifier.code 1} true;
  $i39 := $zext.i1.i32($i38);
  assume {:sourceloc "./output/lcm1_tmp.c", 50, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i39);
  assume {:sourceloc "./output/lcm1_tmp.c", 51, 21} true;
  assume {:verifier.code 0} true;
  $i40 := $ult.i32($i21, $i32);
  assume {:sourceloc "./output/lcm1_tmp.c", 51, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i40 == 1);
  assume {:sourceloc "./output/lcm1_tmp.c", 53, 19} true;
  assume {:verifier.code 0} true;
  $i41 := $sub.i32($i32, $i21);
  call {:cexpr "y"} boogie_si_record_i32($i41);
  assume {:sourceloc "./output/lcm1_tmp.c", 54, 19} true;
  assume {:verifier.code 0} true;
  $i42 := $add.i32($i33, $i22);
...
$bb11:
  assume !(($i40 == 1));
  assume {:sourceloc "./output/lcm1_tmp.c", 52, 17} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/lcm1_tmp.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i10, $i11, $i12, $i13 := $i21, $i32, $i33, $i22;
  goto $bb1;
}
...
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 23733));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 24765));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 25797));
