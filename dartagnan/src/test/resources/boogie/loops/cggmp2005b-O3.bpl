...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/cggmp2005b-O3.bpl /Users/ponce/git/Dat3M/./output/cggmp2005b_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $i0, $i1 := $sub.bv32(0bv32, 100bv32), 0bv32;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 20, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $or.bv32($i1, 1bv32);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 21, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i0;
  goto $bb5;
$bb2:
  assume !(($i5 == 1bv1));
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.bv32($i3, 101bv32);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb4:
  ...
  goto $bb7;
$bb5:
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.bv32($i4, 20bv32);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $add.bv32($i4, $i3);
...
$bb7:
  ...
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.bv32($i8, 20bv32);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $add.bv32($i8, $i7);
  call {:cexpr "j"} boogie_si_record_bv32($i10);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 21, 2} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $slt.bv32($i12, 20bv32);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i14 := $add.bv32($i12, $i11);
  call {:cexpr "j"} boogie_si_record_bv32($i14);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 21, 2} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $slt.bv32($i16, 20bv32);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $add.bv32($i16, $i15);
  call {:cexpr "j"} boogie_si_record_bv32($i18);
  assume {:sourceloc "./output/cggmp2005b_tmp.c", 21, 2} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 40251));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 41283));
