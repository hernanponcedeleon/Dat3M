...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 17541));
...
axiom (.str.1 == $sub.ref(0, 2059));
const .str: ref;
axiom (.str == $sub.ref(0, 3097));
...
{
$bb0:
  assume {:sourceloc "./lib/smack.c", 14, 32} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_error == $sub.ref(0, 8253));
procedure __VERIFIER_error()
{
$bb0:
  assume {:sourceloc "./lib/smack.c", 16, 30} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./lib/smack.c", 16, 30} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
axiom (__SMACK_check_overflow == $sub.ref(0, 9285));
procedure __SMACK_check_overflow($i0: i32)
{
$bb0:
  assume {:sourceloc "./lib/smack.c", 18, 40} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 10317));
procedure __VERIFIER_nondet_int()
  returns ($r: i32)
{
$bb0:
  assume {:sourceloc "./lib/smack.c", 36, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./lib/smack.c", 36, 34} true;
  assume {:verifier.code 0} true;
  $r := $u0;
...
{
$bb0:
  assume {:sourceloc "./lib/smack.c", 80, 29} true;
  assume {:verifier.code 0} true;
...
axiom (__SMACK_decls == $sub.ref(0, 12381));
const __SMACK_check_memory_leak: ref;
axiom (__SMACK_check_memory_leak == $sub.ref(0, 13413));
procedure __SMACK_check_memory_leak()
{
$bb0:
  assume {:sourceloc "./lib/smack.c", 84, 39} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./lib/smack.c", 84, 39} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 14445));
procedure __SMACK_init_func_memory_model()
{
$bb0:
  assume {:sourceloc "./lib/smack.c", 86, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./lib/smack.c", 86, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
...
axiom (__SMACK_code == $sub.ref(0, 15477));
procedure __SMACK_code($p0: ref);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 16509));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 17541));
