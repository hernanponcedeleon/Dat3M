...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 43341));
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 12, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 13, 7} true;
  assume {:verifier.code 0} true;
  $i1, $i2 := 1, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 13, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $sle.i32($i1, $i0);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i2, 2);
  call {:cexpr "sn"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i1, 4);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $i4;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 17, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($i0, 2);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 17, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i2, $i8);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 17, 29} true;
  assume {:verifier.code 0} true;
  $i10 := 1;
...
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 15, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32(0, 10);
  goto $bb6;
$bb5:
...
$bb6:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 13, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
...
$bb9:
  ...
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 17, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i12);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb10:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 17, 35} true;
  assume {:verifier.code 1} true;
  $i11 := $eq.i32($i2, 0);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 17, 29} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 23733));
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 38181));
...
axiom (__SMACK_decls == $sub.ref(0, 39213));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 40245));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 41277));
...
axiom (llvm.dbg.value == $sub.ref(0, 42309));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 43341));
