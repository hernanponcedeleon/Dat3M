...
{
$bb0:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 13, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 7} true;
  assume {:verifier.code 0} true;
  $i1, $i2 := 1, 0;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i3 := $sle.i32($i1, $i0);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i2, 2);
  call {:cexpr "sn"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i1, 4);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $i4;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 18, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($i0, 2);
...
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 16, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32(0, 10);
  goto $bb6;
$bb5:
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
...
$bb9:
  ...
  assume {:sourceloc "./output/sum01_bug02_sum01_bug02_base.case_tmp.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 25803));
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 40251));
