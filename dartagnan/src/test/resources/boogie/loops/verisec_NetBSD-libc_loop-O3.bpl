...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/verisec_NetBSD-libc_loop-O3.bpl /Users/ponce/git/Dat3M/./output/verisec_NetBSD-libc_loop_tmp.c
...
axiom (llvm.dbg.value == $sub.ref(0, 8259));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 30, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 30, 3} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/verisec_NetBSD-libc_loop_tmp.c:30:3: warning: unsoundly ignoring unmodeled operation llvm.lifetime.start.p0i8;
  call llvm.lifetime.start.p0i8(8bv64, $p1);
  assume true;
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 32, 17} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 4));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 32, 43} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(7, 4));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 34, 52} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(1, 4));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 34, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, tmp, $p4);
...
$bb4:
  assume ($i8 == 1bv1);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 39, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/verisec_NetBSD-libc_loop_tmp.c:39:1: warning: unsoundly ignoring unmodeled operation llvm.lifetime.end.p0i8;
  call llvm.lifetime.end.p0i8(8bv64, $p1);
...
axiom (llvm.lifetime.start.p0i8 == $sub.ref(0, 11355));
procedure  llvm.lifetime.start.p0i8($i0: bv64, $p1: ref);
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 12387));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.lifetime.end.p0i8: ref;
axiom (llvm.lifetime.end.p0i8 == $sub.ref(0, 13419));
procedure  llvm.lifetime.end.p0i8($i0: bv64, $p1: ref);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 14451));
...
axiom (__SMACK_code == $sub.ref(0, 15483));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 16515));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17547));
...
{
$bb0:
  $M.0 := $store.bytes.ref($M.0, tmp, $0.ref);
