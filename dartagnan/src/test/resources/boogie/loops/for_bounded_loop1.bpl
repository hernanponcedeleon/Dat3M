...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 9, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 18, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 19, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 0);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
...
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 19, 15} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 30, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  ...
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 20, 13} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, $i0);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32($i3, $i2);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 23, 24} true;
  assume {:verifier.code 1} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 23, 24} true;
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 23, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i8);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 24, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 25, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
...
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 29, 22} true;
  assume {:verifier.code 1} true;
  $i15 := $eq.i32($i3, 0);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 29, 22} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i6, $i9);
  call {:cexpr "x"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 27, 24} true;
  assume {:verifier.code 1} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 27, 24} true;
  assume {:verifier.code 1} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 27, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i13);
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 25, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb9:
  assume {:sourceloc "./output/for_bounded_loop1_tmp.c", 20, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i4, 1);
