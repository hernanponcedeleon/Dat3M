...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/simple_vardep_1-O3.bpl /Users/ponce/git/Dat3M/./output/simple_vardep_1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/simple_vardep_1_tmp.c", 20, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/simple_vardep_1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_vardep_1_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $ult.bv32($i0, 268435401bv32);
  assume {:sourceloc "./output/simple_vardep_1_tmp.c", 23, 11} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i1 == 1bv1));
  assume {:sourceloc "./output/simple_vardep_1_tmp.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
