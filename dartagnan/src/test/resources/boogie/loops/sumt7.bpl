...
{
$bb0:
  assume {:sourceloc "./output/sumt7_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt7_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt7_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt7_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sumt7_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sumt7_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt7_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt7_tmp.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt7_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/sumt7_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9, $i10 := 0, 0, 0, 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 19, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt7_tmp.c", 40, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt7_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 17, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 17, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 17, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i32($i7, $i0);
  assume {:sourceloc "./output/sumt7_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i11 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $urem.i32($i7, 7);
  assume {:sourceloc "./output/sumt7_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i13 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i22 := $urem.i32($i7, 6);
  assume {:sourceloc "./output/sumt7_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i22, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 24, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i6, 1);
  call {:cexpr "v1"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/sumt7_tmp.c", 23, 6} true;
  assume {:verifier.code 0} true;
  $i15, $i16, $i17, $i18, $i19, $i20, $i21 := $i3, $i4, $i5, $i14, $i8, $i9, $i10;
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/sumt7_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt7_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 10} true;
  assume {:verifier.code 0} true;
  $i58 := $add.i32($i7, 1);
  call {:cexpr "l"} boogie_si_record_i32($i58);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 25} true;
  assume {:verifier.code 1} true;
  $i59 := $add.i32($i21, $i19);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 27} true;
  assume {:verifier.code 1} true;
  $i60 := $add.i32($i59, $i20);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 29} true;
  assume {:verifier.code 1} true;
  $i61 := $add.i32($i60, $i18);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 32} true;
  assume {:verifier.code 1} true;
  $i62 := $add.i32($i61, $i17);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 35} true;
  assume {:verifier.code 1} true;
  $i63 := $add.i32($i62, $i16);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 38} true;
  assume {:verifier.code 1} true;
  $i64 := $add.i32($i63, $i15);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 43} true;
  assume {:verifier.code 1} true;
  $i65 := $eq.i32($i64, $i58);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 43} true;
  assume {:verifier.code 1} true;
  $i66 := $zext.i1.i32($i65);
  assume {:sourceloc "./output/sumt7_tmp.c", 37, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i66);
  assume {:sourceloc "./output/sumt7_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9, $i10 := $i15, $i16, $i17, $i18, $i58, $i19, $i20, $i21;
  goto $bb4;
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $urem.i32($i7, 5);
  assume {:sourceloc "./output/sumt7_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i32 := $ne.i32($i31, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 26, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i32} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i23 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i5, 1);
  call {:cexpr "v2"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/sumt7_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $i25, $i26, $i27, $i28, $i29, $i30 := $i3, $i4, $i24, $i8, $i9, $i10;
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/sumt7_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i15, $i16, $i17, $i18, $i19, $i20, $i21 := $i25, $i26, $i27, $i6, $i28, $i29, $i30;
  goto $bb9;
$bb13:
  assume ($i32 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i39 := $urem.i32($i7, 4);
  assume {:sourceloc "./output/sumt7_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i40 := $ne.i32($i39, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 28, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb16, $bb17;
$bb14:
  assume !(($i32 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 27, 14} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i4, 1);
  call {:cexpr "v3"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/sumt7_tmp.c", 27, 6} true;
  assume {:verifier.code 0} true;
  $i34, $i35, $i36, $i37, $i38 := $i3, $i33, $i8, $i9, $i10;
  goto $bb15;
$bb15:
  assume {:sourceloc "./output/sumt7_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i25, $i26, $i27, $i28, $i29, $i30 := $i34, $i35, $i5, $i36, $i37, $i38;
  goto $bb12;
$bb16:
  assume ($i40 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 30, 15} true;
  assume {:verifier.code 0} true;
  $i46 := $urem.i32($i7, 3);
  assume {:sourceloc "./output/sumt7_tmp.c", 30, 15} true;
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i46, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 30, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  goto $bb19, $bb20;
$bb17:
  assume !(($i40 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 29, 14} true;
  assume {:verifier.code 0} true;
  $i41 := $add.i32($i3, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i41);
  assume {:sourceloc "./output/sumt7_tmp.c", 29, 6} true;
  assume {:verifier.code 0} true;
  $i42, $i43, $i44, $i45 := $i41, $i8, $i9, $i10;
  goto $bb18;
$bb18:
  assume {:sourceloc "./output/sumt7_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i34, $i35, $i36, $i37, $i38 := $i42, $i4, $i43, $i44, $i45;
  goto $bb15;
$bb19:
  assume ($i47 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 32, 15} true;
  assume {:verifier.code 0} true;
  $i52 := $urem.i32($i7, 2);
  assume {:sourceloc "./output/sumt7_tmp.c", 32, 15} true;
  assume {:verifier.code 0} true;
  $i53 := $ne.i32($i52, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 32, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i53} true;
  goto $bb22, $bb23;
$bb20:
  assume !(($i47 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i48 := $add.i32($i10, 1);
  call {:cexpr "i"} boogie_si_record_i32($i48);
  assume {:sourceloc "./output/sumt7_tmp.c", 31, 6} true;
  assume {:verifier.code 0} true;
  $i49, $i50, $i51 := $i8, $i9, $i48;
  goto $bb21;
$bb21:
  assume {:sourceloc "./output/sumt7_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i42, $i43, $i44, $i45 := $i3, $i49, $i50, $i51;
  goto $bb18;
$bb22:
  assume ($i53 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 35, 11} true;
  assume {:verifier.code 0} true;
  $i57 := $add.i32($i9, 1);
  call {:cexpr "k"} boogie_si_record_i32($i57);
  assume {:verifier.code 0} true;
  $i55, $i56 := $i8, $i57;
  goto $bb24;
$bb23:
  assume !(($i53 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 33, 10} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i32($i8, 1);
  call {:cexpr "j"} boogie_si_record_i32($i54);
  assume {:sourceloc "./output/sumt7_tmp.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $i55, $i56 := $i54, $i9;
  goto $bb24;
$bb24:
