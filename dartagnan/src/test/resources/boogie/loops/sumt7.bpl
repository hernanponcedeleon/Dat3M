...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt7_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt7_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/sumt7_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 7, 16} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/sumt7_tmp.c", 8, 12} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/sumt7_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt7_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt7_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt7_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9, $i10 := 0, 0, 0, 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt7_tmp.c", 39, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt7_tmp.c", 16, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 16, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 16, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 15, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 19, 12} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i32($i7, $i0);
  assume {:sourceloc "./output/sumt7_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i11 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $urem.i32($i7, 7);
  assume {:sourceloc "./output/sumt7_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 38, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i13 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i22 := $urem.i32($i7, 6);
  assume {:sourceloc "./output/sumt7_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i22, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 23, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i6, 1);
  call {:cexpr "v1"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/sumt7_tmp.c", 22, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:sourceloc "./output/sumt7_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt7_tmp.c", 35, 10} true;
  assume {:verifier.code 0} true;
  $i58 := $add.i32($i7, 1);
  call {:cexpr "l"} boogie_si_record_i32($i58);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 25} true;
  assume {:verifier.code 1} true;
  $i59 := $add.i32($i21, $i19);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 27} true;
  assume {:verifier.code 1} true;
  $i60 := $add.i32($i59, $i20);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 29} true;
  assume {:verifier.code 1} true;
  $i61 := $add.i32($i60, $i18);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 32} true;
  assume {:verifier.code 1} true;
  $i62 := $add.i32($i61, $i17);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 35} true;
  assume {:verifier.code 1} true;
  $i63 := $add.i32($i62, $i16);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 38} true;
  assume {:verifier.code 1} true;
  $i64 := $add.i32($i63, $i15);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 43} true;
  assume {:verifier.code 1} true;
  $i65 := $eq.i32($i64, $i58);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 43} true;
  assume {:verifier.code 1} true;
  $i66 := $zext.i1.i32($i65);
  assume {:sourceloc "./output/sumt7_tmp.c", 36, 5} true;
  assume {:verifier.code 1} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $urem.i32($i7, 5);
  assume {:sourceloc "./output/sumt7_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i32 := $ne.i32($i31, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 25, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i32} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i23 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i5, 1);
  call {:cexpr "v2"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/sumt7_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i32 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i39 := $urem.i32($i7, 4);
  assume {:sourceloc "./output/sumt7_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i40 := $ne.i32($i39, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 27, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb16, $bb17;
$bb14:
  assume !(($i32 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 26, 14} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i4, 1);
  call {:cexpr "v3"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/sumt7_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i40 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $i46 := $urem.i32($i7, 3);
  assume {:sourceloc "./output/sumt7_tmp.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i46, 0);
  assume {:sourceloc "./output/sumt7_tmp.c", 29, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  goto $bb19, $bb20;
$bb17:
  assume !(($i40 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 28, 14} true;
  assume {:verifier.code 0} true;
  $i41 := $add.i32($i3, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i41);
  assume {:sourceloc "./output/sumt7_tmp.c", 28, 6} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i47 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 31, 15} true;
  assume {:verifier.code 0} true;
  $i52 := $urem.i32($i7, 2);
  assume {:sourceloc "./output/sumt7_tmp.c", 31, 15} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  assume {:sourceloc "./output/sumt7_tmp.c", 30, 6} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i53 == 1);
  assume {:sourceloc "./output/sumt7_tmp.c", 34, 11} true;
  assume {:verifier.code 0} true;
  $i57 := $add.i32($i9, 1);
...
$bb23:
  assume !(($i53 == 1));
  assume {:sourceloc "./output/sumt7_tmp.c", 32, 10} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i32($i8, 1);
  call {:cexpr "j"} boogie_si_record_i32($i54);
  assume {:sourceloc "./output/sumt7_tmp.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $i55, $i56 := $i54, $i9;
  goto $bb24;
$bb24:
