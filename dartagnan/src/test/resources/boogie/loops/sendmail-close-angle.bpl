...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 11, 15} true;
  ...
  call {:cexpr "inlen"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 12, 19} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i1);
  call {:cexpr "bufferlen"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 16, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i1, 1);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 16, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 16, 25} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 17, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $sgt.i32($i0, 0);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb5, $bb6;
$bb4:
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb6:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 17, 22} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb7:
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 18, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i1, $i0);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 18, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 18, 30} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb10:
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 22, 22} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i1, 2);
  call {:cexpr "buflim"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i6, $i7 := 0, 0;
  goto $bb11;
$bb11:
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 24, 10} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i9 == 1);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 26, 13} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i7, $i5);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 26, 9} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb14;
$bb14:
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 37, 24} true;
  assume {:verifier.code 0} true;
  $i25 := $sle.i32(0, $i7);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 37, 24} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i32($i25);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call $i27 := __VERIFIER_assert.i32($i26);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i27);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 38, 26} true;
  assume {:verifier.code 0} true;
  $i28 := $slt.i32($i7, $i1);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 38, 26} true;
  assume {:verifier.code 0} true;
  $i29 := $zext.i1.i32($i28);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 38, 5} true;
  assume {:verifier.code 0} true;
  call $i30 := __VERIFIER_assert.i32($i29);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i30);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i32($i7, 1);
  call {:cexpr "buf"} boogie_si_record_i32($i31);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 42, 22} true;
  assume {:verifier.code 0} true;
  $i32 := $sle.i32(0, $i31);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 42, 22} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i1.i32($i32);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $i34 := __VERIFIER_assert.i32($i33);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i34);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 43, 24} true;
  assume {:verifier.code 0} true;
  $i35 := $slt.i32($i31, $i1);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 43, 24} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i32($i35);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $i37 := __VERIFIER_assert.i32($i36);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i37);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 45, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb15:
  assume ($i10 == 1);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb16:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 28, 24} true;
  assume {:verifier.code 0} true;
  $i11 := $sle.i32(0, $i7);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 28, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := __VERIFIER_assert.i32($i12);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 29, 26} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.i32($i7, $i1);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 29, 26} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i1.i32($i14);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 29, 5} true;
  assume {:verifier.code 0} true;
  call $i16 := __VERIFIER_assert.i32($i15);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i16);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32($i7, 1);
  call {:cexpr "buf"} boogie_si_record_i32($i17);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb17:
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 32, 7} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i6, 1);
  call {:cexpr "in"} boogie_si_record_i32($i18);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 33, 24} true;
  assume {:verifier.code 0} true;
  $i19 := $sle.i32(0, $i18);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 33, 24} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i32($i19);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 33, 5} true;
  assume {:verifier.code 0} true;
  call $i21 := __VERIFIER_assert.i32($i20);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i21);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 34, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $slt.i32($i18, $i0);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 34, 25} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/sendmail-close-angle_tmp.c", 34, 5} true;
  assume {:verifier.code 0} true;
