...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/phases_2-1-O3.bpl /Users/ponce/git/Dat3M/./output/phases_2-1_tmp.c
...
$bb11:
  ...
  assume {:sourceloc "./output/phases_2-1_tmp.c", 23, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $add.bv32($i5, 1bv32);
  assume {:sourceloc "./output/phases_2-1_tmp.c", 23, 9} true;
  assume {:verifier.code 0} true;
  $i10 := (if ($i7 == 1bv1) then $i8 else $i9);
