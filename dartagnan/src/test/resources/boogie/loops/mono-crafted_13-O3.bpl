...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/mono-crafted_13-O3.bpl /Users/ponce/git/Dat3M/./output/mono-crafted_13_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 8, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 8, 2} true;
  assume {:verifier.code 0} true;
  $i0, $i1 := 0bv32, 50000bv32;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 9, 7} true;
  assume {:verifier.code 0} true;
  $i9 := $ult.bv32($i0, 50000bv32);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 9, 6} true;
  assume {:verifier.code 0} true;
  $i10 := $add.bv32($i1, 2bv32);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 9, 6} true;
  assume {:verifier.code 0} true;
  $i3 := (if ($i9 == 1bv1) then $i1 else $i10);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 9, 6} true;
  assume {:verifier.code 0} true;
  $i11 := (if ($i9 == 1bv1) then 1bv32 else 2bv32);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 9, 6} true;
  assume {:verifier.code 0} true;
  $i6 := $add.bv32($i11, $i0);
  call {:cexpr "x"} boogie_si_record_bv32($i6);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 8, 9} true;
  assume {:verifier.code 0} true;
  $i12 := $ult.bv32($i6, 1000000bv32);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 8, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i12 == 1bv1));
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.bv32($i3, 0bv32);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 16, 2} true;
  assume {:verifier.code 0} true;
  $i4 := (if ($i2 == 1bv1) then $i3 else 0bv32);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 16, 2} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.bv32($i6, $i4);
  call {:cexpr "x"} boogie_si_record_bv32($i5);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 20, 24} true;
  assume {:verifier.code 0} true;
  $i7 := $and.bv32($i5, 1bv32);
  call {:cexpr "cond"} boogie_si_record_bv32($i7);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 3, 40} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.bv32($i7, 0bv32);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 3, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb3, $bb4;
$bb3:
  assume ($i8 == 1bv1);
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 21, 2} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb4:
  assume !(($i8 == 1bv1));
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 3, 58} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 3, 72} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/mono-crafted_13_tmp.c", 3, 72} true;
  assume {:verifier.code 0} true;
