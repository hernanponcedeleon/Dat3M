...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/array-2-O3.bpl /Users/ponce/git/Dat3M/./output/array-2_tmp.c
...
$bb0:
  ...
  call {:cexpr "menor"} boogie_si_record_bv32($i0);
