...
{
$bb0:
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 6, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 6, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 6, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 13, 20} true;
  ...
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 14, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  call {:cexpr "y"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := $i0, $i1;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 16, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.i32($i2, 1024);
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 18, 6} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i3, 1);
...
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 21, 23} true;
  assume {:verifier.code 1} true;
  $i7 := $eq.i32($i2, $i3);
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 21, 23} true;
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 21, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i8);
  assume {:sourceloc "./output/multivar_1-2_tmp.c", 22, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
