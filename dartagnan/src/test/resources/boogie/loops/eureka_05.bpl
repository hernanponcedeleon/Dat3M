...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 45413));
...
const {:count 5} array: ref;
axiom (array == $sub.ref(0, 2072));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 3104));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 4131));
const {:count 14} .str.14: ref;
axiom (.str.14 == $sub.ref(0, 5169));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 6197));
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 7229));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/eureka_05_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/eureka_05_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/eureka_05_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/eureka_05_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/eureka_05_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 8261));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const SelectionSort: ref;
axiom (SelectionSort == $sub.ref(0, 9293));
procedure SelectionSort()
{
  ...
  var $i27: i32;
$bb0:
  assume {:sourceloc "./output/eureka_05_tmp.c", 19, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 19, 9} true;
  assume {:verifier.code 0} true;
  $i0 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/eureka_05_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 19, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/eureka_05_tmp.c", 19, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i0, $i1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 19, 4} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 21, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, 1);
  call {:cexpr "i"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/eureka_05_tmp.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $i4, $i5 := $i3, $i0;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/eureka_05_tmp.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  ...
  assume {:sourceloc "./output/eureka_05_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 21, 28} true;
  assume {:verifier.code 0} true;
  $i6 := $M.0;
  assume {:sourceloc "./output/eureka_05_tmp.c", 21, 26} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i4, $i6);
  assume {:sourceloc "./output/eureka_05_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i7 == 1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i4);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($i8, 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.1, $p9);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i32.i64($i5);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($i11, 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.1, $p12);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.i32($i10, $i13);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i17 := $sext.i32.i64($i0);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($i17, 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.1, $p18);
  call {:cexpr "temp"} boogie_si_record_i32($i19);
  assume {:sourceloc "./output/eureka_05_tmp.c", 24, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $sext.i32.i64($i5);
  assume {:sourceloc "./output/eureka_05_tmp.c", 24, 19} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($i20, 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 24, 19} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.1, $p21);
  assume {:sourceloc "./output/eureka_05_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $sext.i32.i64($i0);
  assume {:sourceloc "./output/eureka_05_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($i23, 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 24, 17} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p24, $i22);
  assume {:sourceloc "./output/eureka_05_tmp.c", 25, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $sext.i32.i64($i5);
  assume {:sourceloc "./output/eureka_05_tmp.c", 25, 7} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($i25, 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 25, 17} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p26, $i19);
  assume {:sourceloc "./output/eureka_05_tmp.c", 26, 4} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb7:
  assume ($i14 == 1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 36} true;
  assume {:verifier.code 0} true;
  $i15 := $i4;
  goto $bb9;
$bb8:
...
$bb9:
  assume {:sourceloc "./output/eureka_05_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 33} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/eureka_05_tmp.c", 21, 32} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i4, 1);
  ...
  goto $bb4;
$bb11:
  assume {:sourceloc "./output/eureka_05_tmp.c", 19, 27} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i0, 1);
  call {:cexpr "lh"} boogie_si_record_i32($i27);
  assume {:sourceloc "./output/eureka_05_tmp.c", 19, 4} true;
  assume {:verifier.code 0} true;
  $i0 := $i27;
  goto $bb1;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/eureka_05_tmp.c", 33, 6} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(20, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 33, 6} true;
  assume {:verifier.code 0} true;
  $i1 := 4;
...
$bb1:
  assume {:sourceloc "./output/eureka_05_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 0);
  assume {:sourceloc "./output/eureka_05_tmp.c", 33, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 20)), $mul.ref($i3, 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 34, 11} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p4, $i1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/eureka_05_tmp.c", 36, 2} true;
  assume {:verifier.code 0} true;
  call SelectionSort();
  assume {:sourceloc "./output/eureka_05_tmp.c", 38, 6} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "./output/eureka_05_tmp.c", 33, 23} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume {:sourceloc "./output/eureka_05_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 38, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 5);
  assume {:sourceloc "./output/eureka_05_tmp.c", 38, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i7 == 1);
  assume {:sourceloc "./output/eureka_05_tmp.c", 39, 21} true;
  assume {:verifier.code 1} true;
  $i8 := $sext.i32.i64($i6);
  assume {:sourceloc "./output/eureka_05_tmp.c", 39, 21} true;
  assume {:verifier.code 1} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 20)), $mul.ref($i8, 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 39, 21} true;
  assume {:verifier.code 1} true;
  $i10 := $load.i32($M.2, $p9);
  assume {:sourceloc "./output/eureka_05_tmp.c", 39, 29} true;
  assume {:verifier.code 1} true;
  $i11 := $eq.i32($i10, $i6);
  assume {:sourceloc "./output/eureka_05_tmp.c", 39, 29} true;
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "./output/eureka_05_tmp.c", 39, 3} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/eureka_05_tmp.c", 41, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb8:
  assume {:sourceloc "./output/eureka_05_tmp.c", 38, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i6, 1);
...
axiom (__VERIFIER_assume == $sub.ref(0, 11357));
...
axiom (__SMACK_code == $sub.ref(0, 12389));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 13421));
...
axiom (__VERIFIER_error == $sub.ref(0, 14453));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 15485));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 16517));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 17549));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 18581));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 19613));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 20645));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 21677));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 22709));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 23741));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 24773));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 25805));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 26837));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 27869));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 28901));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 29933));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 30965));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 31997));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 33029));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 34061));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 35093));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 36125));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 37157));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 38189));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 39221));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 40253));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 41285));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 42317));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 43349));
...
axiom (llvm.dbg.value == $sub.ref(0, 44381));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 45413));
procedure __SMACK_static_init()
{
$bb0:
  $M.0 := 5;
  call {:cexpr "n"} boogie_si_record_i32(5);
  $M.1 := $store.i32($M.1, array, 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref(1, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref(2, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref(3, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref(4, 4)), 0);
  $M.3 := .str.1.3;
  $M.4 := 0;
