...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/for_infinite_loop_1-O3.bpl /Users/ponce/git/Dat3M/./output/for_infinite_loop_1_tmp.c
