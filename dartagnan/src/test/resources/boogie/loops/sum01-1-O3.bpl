...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum01-1-O3.bpl /Users/ponce/git/Dat3M/./output/sum01-1_tmp.c
...
$bb5:
  ...
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.bv32($i3, 0bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i28, $i29, $i30, $i31 := $i5, $i6, $i7, $i3;
...
$bb7:
  ...
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $ult.bv32($i10, 10bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i13 := $add.bv32($i9, 2bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i14 := (if ($i12 == 1bv1) then $i13 else $i9);
  call {:cexpr "sn"} boogie_si_record_bv32($i14);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i15 := $ult.bv32($i10, 9bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i16 := $add.bv32($i14, 2bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i17 := (if ($i15 == 1bv1) then $i16 else $i14);
  call {:cexpr "sn"} boogie_si_record_bv32($i17);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i18 := $ult.bv32($i10, 8bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i19 := $add.bv32($i17, 2bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i20 := (if ($i18 == 1bv1) then $i19 else $i17);
  call {:cexpr "sn"} boogie_si_record_bv32($i20);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i21 := $ult.bv32($i10, 7bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i22 := $add.bv32($i20, 2bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i23 := (if ($i21 == 1bv1) then $i22 else $i20);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $add.bv32($i10, 4bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i25 := $add.bv32($i11, $sub.bv32(0bv32, 4bv32));
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.bv32($i25, 0bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i5, $i6, $i7 := $i23, $i23, $i24;
...
$bb13:
  ...
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i32 := $ult.bv32($i30, 10bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i33 := $add.bv32($i29, 2bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i34 := (if ($i32 == 1bv1) then $i33 else $i29);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i35 := $add.bv32($i30, 1bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i36 := $add.bv32($i31, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i37 := $eq.bv32($i36, 0bv32);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i28 := $i34;
