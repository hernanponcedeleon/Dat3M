...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/gcnr2008-O3.bpl /Users/ponce/git/Dat3M/./output/gcnr2008_tmp.c
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i2, $i3, $i4, $i5 := 0bv32, 0bv32, 0bv32, 0bv32;
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  $i22 := $sub.bv32(0bv32, $i4);
  assume {:sourceloc "./output/gcnr2008_tmp.c", 26, 22} true;
  assume {:verifier.code 0} true;
  $i23 := (if ($i21 == 1bv1) then $i4 else $i22);
  assume {:sourceloc "./output/gcnr2008_tmp.c", 26, 22} true;
  assume {:verifier.code 0} true;
  $i10, $i11 := $i5, $i23;
  goto $bb7;
