...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/veris.c_sendmail_tTflag_arr_one_loop-O3.bpl /Users/ponce/git/Dat3M/./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(11, $bv2int.64($zext.bv32.bv64(1bv32))));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(0, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c:13:3: warning: unsoundly ignoring unmodeled operation llvm.lifetime.start.p0i8;
  call llvm.lifetime.start.p0i8(11bv64, $p1);
  assume true;
  ...
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(1, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(2, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(3, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(4, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(5, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(6, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(7, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(8, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  $i25 := $add.bv64($i24, 1bv64);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref($bv2int.64($i25), 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $i27 := $load.bv8($M.0, $p26);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 21} true;
  assume {:verifier.code 0} true;
  $i28 := $add.bv8($i27, $sub.bv8(0bv8, 48bv8));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 21} true;
  assume {:verifier.code 0} true;
  $i29 := $ult.bv8($i28, 10bv8);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 38, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c:38:1: warning: unsoundly ignoring unmodeled operation llvm.lifetime.end.p0i8;
  call llvm.lifetime.end.p0i8(11bv64, $p1);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
