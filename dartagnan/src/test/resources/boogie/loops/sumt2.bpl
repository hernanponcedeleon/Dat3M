...
{
$bb0:
  assume {:sourceloc "./output/sumt2_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt2_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt2_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt2_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sumt2_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt2_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt2_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sumt2_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sumt2_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt2_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt2_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt2_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/sumt2_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5 := 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt2_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt2_tmp.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt2_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt2_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i5, $i0);
  assume {:sourceloc "./output/sumt2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./output/sumt2_tmp.c", 24, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $urem.i32($i5, 2);
  assume {:sourceloc "./output/sumt2_tmp.c", 24, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, 0);
  assume {:sourceloc "./output/sumt2_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/sumt2_tmp.c", 30, 23} true;
  assume {:verifier.code 1} true;
  $i14 := $add.i32($i4, $i3);
  assume {:sourceloc "./output/sumt2_tmp.c", 30, 27} true;
  assume {:verifier.code 1} true;
  $i15 := $eq.i32($i14, $i5);
  assume {:sourceloc "./output/sumt2_tmp.c", 30, 27} true;
  assume {:verifier.code 1} true;
  $i16 := $zext.i1.i32($i15);
  assume {:sourceloc "./output/sumt2_tmp.c", 30, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i16);
  assume {:sourceloc "./output/sumt2_tmp.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "./output/sumt2_tmp.c", 27, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i3, 1);
...
$bb8:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/sumt2_tmp.c", 25, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i4, 1);
  call {:cexpr "i"} boogie_si_record_i32($i9);
  assume {:sourceloc "./output/sumt2_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $i10, $i11 := $i3, $i9;
  goto $bb9;
$bb9:
  ...
  assume {:sourceloc "./output/sumt2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt2_tmp.c", 28, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i5, 1);
  call {:cexpr "l"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/sumt2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5 := $i10, $i11, $i13;
  goto $bb4;
}
