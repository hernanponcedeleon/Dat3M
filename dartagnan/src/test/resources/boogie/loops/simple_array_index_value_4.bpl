...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 46437));
...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 8, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 9, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 8, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 8, 14} true;
  assume {:verifier.code 0} true;
...
const abort: ref;
axiom (abort == $sub.ref(0, 7221));
procedure abort();
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 8253));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 12, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 12, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 13, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 27, 13} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "index1"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 28, 30} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i1, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 28, 30} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 29, 13} true;
  assume {:verifier.code 0} true;
  call $i4 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i4);
  call {:cexpr "index2"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 30, 30} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 30, 30} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i6);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $i7, $i8, $i9 := $i4, $i1, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 32, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i32($i8, $i7);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 32, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 33, 31} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i32($i8, 100000);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 33, 39} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb3:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 40, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.i32($i9, 0);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 40, 7} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i11 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 33, 50} true;
  assume {:verifier.code 1} true;
  $i13 := $ult.i32($i7, 100000);
  assume {:verifier.code 0} true;
  $i12 := $i13;
  goto $bb6;
$bb5:
...
$bb6:
  ...
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 33, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i14);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 25} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 25} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i15, 4));
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 25} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i32($M.0, $p16);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 42} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i32.i64($i7);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 42} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i18, 4));
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 42} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, $p19);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 39} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.i32($i17, $i20);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 39} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i1.i32($i21);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 34, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i22);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 35, 11} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i8, 1);
  call {:cexpr "index1"} boogie_si_record_i32($i23);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 36, 11} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i7, $sub.i32(0, 1));
  call {:cexpr "index2"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $i7, $i8, $i9 := $i24, $i23, 1;
  goto $bb1;
$bb7:
  assume ($i25 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 41, 5} true;
  assume {:verifier.code 0} true;
  $i26, $i27 := $i7, $i8;
  goto $bb10;
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 48, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb10:
  ...
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 41, 19} true;
  assume {:verifier.code 0} true;
  $i28 := $ult.i32($i26, $i27);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 41, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i28 == 1);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 25} true;
  assume {:verifier.code 1} true;
  $i29 := $zext.i32.i64($i27);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 25} true;
  assume {:verifier.code 1} true;
  $p30 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i29, 4));
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 25} true;
  assume {:verifier.code 1} true;
  $i31 := $load.i32($M.0, $p30);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 42} true;
  assume {:verifier.code 1} true;
  $i32 := $zext.i32.i64($i26);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 42} true;
  assume {:verifier.code 1} true;
  $p33 := $add.ref($add.ref($p0, $mul.ref(0, 400000)), $mul.ref($i32, 4));
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 42} true;
  assume {:verifier.code 1} true;
  $i34 := $load.i32($M.0, $p33);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 39} true;
  assume {:verifier.code 1} true;
  $i35 := $eq.i32($i31, $i34);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 39} true;
  assume {:verifier.code 1} true;
  $i36 := $zext.i1.i32($i35);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 42, 7} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i36);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 43, 13} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i32($i26, 1);
  call {:cexpr "index2"} boogie_si_record_i32($i37);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 44, 13} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i32($i27, $sub.i32(0, 1));
  call {:cexpr "index1"} boogie_si_record_i32($i38);
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 41, 5} true;
  assume {:verifier.code 0} true;
  $i26, $i27 := $i37, $i38;
  goto $bb10;
$bb12:
  assume !(($i28 == 1));
  assume {:sourceloc "./output/simple_array_index_value_4_tmp.c", 46, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
}
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 41277));
...
axiom (__SMACK_decls == $sub.ref(0, 42309));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 43341));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 44373));
...
axiom (llvm.dbg.value == $sub.ref(0, 45405));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 46437));
