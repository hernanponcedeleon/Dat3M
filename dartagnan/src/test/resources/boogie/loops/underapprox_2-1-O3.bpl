...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/underapprox_2-1-O3.bpl /Users/ponce/git/Dat3M/./output/underapprox_2-1_tmp.c
