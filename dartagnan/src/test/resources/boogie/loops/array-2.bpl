...
{
$bb0:
  assume {:sourceloc "./output/array-2_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/array-2_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/array-2_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/array-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/array-2_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/array-2_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/array-2_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/array-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/array-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/array-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/array-2_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/array-2_tmp.c", 20, 7} true;
  assume {:verifier.code 0} true;
  $i4, $i5 := 0, $i3;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "./output/array-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/array-2_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i4, 1);
  assume {:sourceloc "./output/array-2_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "./output/array-2_tmp.c", 21, 19} true;
  assume {:verifier.code 0} true;
  call $i7 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/array-2_tmp.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i32.i64($i4);
  assume {:sourceloc "./output/array-2_tmp.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p2, $mul.ref($i8, 4));
  assume {:sourceloc "./output/array-2_tmp.c", 21, 17} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/array-2_tmp.c", 27, 23} true;
  assume {:verifier.code 1} true;
  $p19 := $add.ref($p2, $mul.ref(0, 4));
  assume {:sourceloc "./output/array-2_tmp.c", 27, 23} true;
  assume {:verifier.code 1} true;
  $i20 := $load.i32($M.1, $p19);
  assume {:sourceloc "./output/array-2_tmp.c", 27, 31} true;
  assume {:verifier.code 1} true;
  $i21 := $sgt.i32($i20, $i5);
  assume {:sourceloc "./output/array-2_tmp.c", 27, 31} true;
  assume {:verifier.code 1} true;
  $i22 := $zext.i1.i32($i21);
  assume {:sourceloc "./output/array-2_tmp.c", 27, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i22);
  assume {:sourceloc "./output/array-2_tmp.c", 30, 1} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "./output/array-2_tmp.c", 24, 19} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i32.i64($i4);
  assume {:sourceloc "./output/array-2_tmp.c", 24, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/array-2_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $i17;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:sourceloc "./output/array-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/array-2_tmp.c", 25, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
