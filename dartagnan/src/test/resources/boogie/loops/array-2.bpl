...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/array_1-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/array_1-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/array_1-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/array_1-2_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/array_1-2_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/array_1-2_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/array_1-2_tmp.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(8192, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "./output/array_1-2_tmp.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/array_1-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/array_1-2_tmp.c", 14, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 1024);
  assume {:sourceloc "./output/array_1-2_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/array_1-2_tmp.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "./output/array_1-2_tmp.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8192)), $mul.ref($i3, 4));
  assume {:sourceloc "./output/array_1-2_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, $i1);
  assume {:sourceloc "./output/array_1-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/array_1-2_tmp.c", 18, 21} true;
  assume {:verifier.code 1} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 8192)), $mul.ref(1023, 4));
  assume {:sourceloc "./output/array_1-2_tmp.c", 18, 21} true;
  assume {:verifier.code 1} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "./output/array_1-2_tmp.c", 18, 29} true;
  assume {:verifier.code 1} true;
  $i8 := $eq.i32($i7, 1023);
  assume {:sourceloc "./output/array_1-2_tmp.c", 18, 29} true;
  assume {:verifier.code 1} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/array_1-2_tmp.c", 18, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i9);
  assume {:sourceloc "./output/array_1-2_tmp.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/array_1-2_tmp.c", 14, 26} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
