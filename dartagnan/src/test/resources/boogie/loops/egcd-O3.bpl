...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/egcd-O3.bpl /Users/ponce/git/Dat3M/./output/egcd_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/egcd_tmp.c", 3, 44} true;
...
$bb0:
  ...
  assume {:sourceloc "./output/egcd_tmp.c", 21, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $slt.bv32($i0, 1bv32);
  assume {:sourceloc "./output/egcd_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/egcd_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/egcd_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/egcd_tmp.c", 23, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.bv32($i1, 1bv32);
  assume {:sourceloc "./output/egcd_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7, $i8, $i9, $i10, $i11 := 0bv32, 1bv32, $i0, $i1, 1bv32, 0bv32, 0bv32, 1bv32;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i14 := $add.bv32($i12, $i13);
  assume {:sourceloc "./output/egcd_tmp.c", 34, 29} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.bv32($i6, $i14);
  assume {:sourceloc "./output/egcd_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i37 == 1bv1));
  assume {:sourceloc "./output/egcd_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/egcd_tmp.c", 12, 24} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/egcd_tmp.c", 12, 24} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i15 == 1bv1);
  assume {:sourceloc "./output/egcd_tmp.c", 35, 34} true;
  assume {:verifier.code 0} true;
  $i16 := $mul.bv32($i10, $i0);
  assume {:sourceloc "./output/egcd_tmp.c", 35, 42} true;
  assume {:verifier.code 0} true;
  $i17 := $mul.bv32($i8, $i1);
  assume {:sourceloc "./output/egcd_tmp.c", 35, 38} true;
  assume {:verifier.code 0} true;
  $i18 := $add.bv32($i17, $i16);
  assume {:sourceloc "./output/egcd_tmp.c", 35, 29} true;
  assume {:verifier.code 0} true;
  $i19 := $eq.bv32($i18, $i7);
  assume {:sourceloc "./output/egcd_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume ($i19 == 1bv1);
  assume {:sourceloc "./output/egcd_tmp.c", 37, 17} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.bv32($i6, $i7);
...
$bb11:
  ...
  assume {:verifier.code 0} true;
  $i39 := $eq.bv32($i38, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/egcd_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i20 == 1bv1));
  assume {:sourceloc "./output/egcd_tmp.c", 40, 15} true;
  assume {:verifier.code 0} true;
  $i21 := $sgt.bv32($i6, $i7);
  assume {:sourceloc "./output/egcd_tmp.c", 40, 13} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  assume {:verifier.code 0} true;
  $i23 := $sub.bv32($i11, $i10);
  call {:cexpr "p"} boogie_si_record_bv32($i23);
  assume {:sourceloc "./output/egcd_tmp.c", 43, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $sub.bv32($i9, $i8);
  call {:cexpr "r"} boogie_si_record_bv32($i24);
  assume {:sourceloc "./output/egcd_tmp.c", 44, 9} true;
  assume {:verifier.code 0} true;
  $i25, $i26, $i27, $i28, $i29, $i30 := $i23, $i10, $i24, $i8, $i7, $i22;
  goto $bb15;
$bb14:
  assume !(($i21 == 1bv1));
  ...
  assume {:verifier.code 0} true;
  $i32 := $sub.bv32($i10, $i11);
  call {:cexpr "q"} boogie_si_record_bv32($i32);
  assume {:sourceloc "./output/egcd_tmp.c", 47, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $sub.bv32($i8, $i9);
  call {:cexpr "s"} boogie_si_record_bv32($i33);
  assume {:verifier.code 0} true;
  $i25, $i26, $i27, $i28, $i29, $i30 := $i11, $i32, $i9, $i33, $i31, $i6;
  goto $bb15;
$bb15:
...
$bb16:
  assume ($i37 == 1bv1);
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7, $i8, $i9, $i10, $i11 := $i35, $i34, $i30, $i29, $i28, $i27, $i26, $i25;
  goto $bb5;
$bb17:
  assume ($i39 == 1bv1);
  assume {:sourceloc "./output/egcd_tmp.c", 55, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
