...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/diamond_2-2-O3.bpl /Users/ponce/git/Dat3M/./output/diamond_2-2_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 14, 20} true;
  ...
  call {:cexpr "y"} boogie_si_record_bv32($i0);
  assume {:verifier.code 0} true;
  $i1 := $and.bv32($i0, 1bv32);
  assume {:verifier.code 0} true;
  $i2 := $eq.bv32($i1, 0bv32);
  assume {:verifier.code 0} true;
  $i3 := (if ($i2 == 1bv1) then 4bv32 else $sub.bv32(0bv32, 1bv32));
  assume {:verifier.code 0} true;
  $i4 := (if ($i2 == 1bv1) then 12bv32 else $sub.bv32(0bv32, 4bv32));
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i5, $i6 := 0bv32, 0bv32;
...
$bb2:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $add.bv32($i3, $i5);
  call {:cexpr "x"} boogie_si_record_bv32($i7);
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 26, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $add.bv32($i7, 4bv32);
  call {:cexpr "x"} boogie_si_record_bv32($i8);
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 44, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $add.bv32($i4, $i8);
  call {:cexpr "x"} boogie_si_record_bv32($i9);
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 16, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.bv32($i9, 99bv32);
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i11 := $i9;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 48, 29} true;
  assume {:verifier.code 0} true;
  $i15 := $xor.bv32($i11, $i0);
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 48, 29} true;
  assume {:verifier.code 0} true;
  $i16 := $and.bv32($i15, 1bv32);
  call {:cexpr "cond"} boogie_si_record_bv32($i16);
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.bv32($i16, 0bv32);
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 6, 7} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i17 == 1bv1);
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 49, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb11:
  assume !(($i17 == 1bv1));
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/diamond_2-2_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
