...
{
$bb0:
  assume {:sourceloc "./output/loopv1_tmp.c", 6, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/loopv1_tmp.c", 12, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/loopv1_tmp.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/loopv1_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/loopv1_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/loopv1_tmp.c", 12, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/loopv1_tmp.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/loopv1_tmp.c", 13, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/loopv1_tmp.c", 13, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/loopv1_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/loopv1_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/loopv1_tmp.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $sle.i32($i0, $i1);
  assume {:sourceloc "./output/loopv1_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/loopv1_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/loopv1_tmp.c", 22, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/loopv1_tmp.c", 33, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/loopv1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/loopv1_tmp.c", 24, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, $i0);
  assume {:sourceloc "./output/loopv1_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i4 == 1);
  assume {:sourceloc "./output/loopv1_tmp.c", 26, 8} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/loopv1_tmp.c", 31, 24} true;
  assume {:verifier.code 1} true;
  $i10 := $srem.i32($i3, 3);
  assume {:sourceloc "./output/loopv1_tmp.c", 31, 28} true;
  assume {:verifier.code 1} true;
  $i11 := $eq.i32($i10, 0);
  assume {:sourceloc "./output/loopv1_tmp.c", 31, 28} true;
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "./output/loopv1_tmp.c", 31, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i12);
  assume {:sourceloc "./output/loopv1_tmp.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i6 == 1);
  assume {:sourceloc "./output/loopv1_tmp.c", 27, 13} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i3, 6);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/loopv1_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $i7;
  goto $bb9;
$bb8:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/loopv1_tmp.c", 29, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i3, 3);
...
$bb0:
  $M.0 := 50000001;
  call {:cexpr "SIZE"} boogie_si_record_i32(50000001);
  $M.1 := .str.1.3;
  $M.2 := 0;
