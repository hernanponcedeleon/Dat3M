...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/loopv1_tmp.c", 11, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/loopv1_tmp.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/loopv1_tmp.c", 11, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/loopv1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/loopv1_tmp.c", 11, 16} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/loopv1_tmp.c", 12, 12} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/loopv1_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/loopv1_tmp.c", 20, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/loopv1_tmp.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/loopv1_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $sle.i32($i0, $i1);
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/loopv1_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/loopv1_tmp.c", 21, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/loopv1_tmp.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/loopv1_tmp.c", 23, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, $i0);
  assume {:sourceloc "./output/loopv1_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i4 == 1);
  assume {:sourceloc "./output/loopv1_tmp.c", 25, 8} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/loopv1_tmp.c", 30, 24} true;
  assume {:verifier.code 1} true;
  $i10 := $srem.i32($i3, 3);
  assume {:sourceloc "./output/loopv1_tmp.c", 30, 28} true;
  assume {:verifier.code 1} true;
  $i11 := $eq.i32($i10, 0);
  assume {:sourceloc "./output/loopv1_tmp.c", 30, 28} true;
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "./output/loopv1_tmp.c", 30, 3} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume ($i6 == 1);
  assume {:sourceloc "./output/loopv1_tmp.c", 26, 13} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i3, 6);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/loopv1_tmp.c", 26, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $i7;
  goto $bb9;
$bb8:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/loopv1_tmp.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i3, 3);
