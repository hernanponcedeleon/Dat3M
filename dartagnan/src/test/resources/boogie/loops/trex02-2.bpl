...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 45401));
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/trex02-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/trex02-2_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/trex02-2_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex02-2_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
const foo: ref;
axiom (foo == $sub.ref(0, 7217));
procedure foo()
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/trex02-2_tmp.c", 16, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex02-2_tmp.c", 16, 4} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  ...
  assume {:sourceloc "./output/trex02-2_tmp.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/trex02-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex02-2_tmp.c", 20, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $i0;
  call {:cexpr "x"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/trex02-2_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/trex02-2_tmp.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i1, 0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/trex02-2_tmp.c", 22, 15} true;
  assume {:verifier.code 0} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "./output/trex02-2_tmp.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  call {:cexpr "c"} boogie_si_record_i8($i4);
  assume {:sourceloc "./output/trex02-2_tmp.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $trunc.i8.i1($i4);
  assume {:sourceloc "./output/trex02-2_tmp.c", 23, 8} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/trex02-2_tmp.c", 26, 21} true;
  assume {:verifier.code 1} true;
  $i6 := $M.0;
  assume {:sourceloc "./output/trex02-2_tmp.c", 26, 22} true;
  assume {:verifier.code 1} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 26, 22} true;
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "./output/trex02-2_tmp.c", 26, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i8);
  assume {:sourceloc "./output/trex02-2_tmp.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/trex02-2_tmp.c", 24, 10} true;
  assume {:verifier.code 0} true;
  call foo();
  assume {:verifier.code 0} true;
  goto $bb6;
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 26825));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 27857));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 28889));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 29921));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 30953));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 31985));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 33017));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 34049));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 35081));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 36113));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 37145));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 38177));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 39209));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 40241));
...
axiom (__SMACK_decls == $sub.ref(0, 41273));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 42305));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 43337));
...
axiom (llvm.dbg.value == $sub.ref(0, 44369));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 45401));
