...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 47471));
...
{
$bb0:
  assume {:sourceloc "./output/trex02-2_tmp.c", 2, 44} true;
...
axiom (__VERIFIER_assert == $sub.ref(0, 8255));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/trex02-2_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/trex02-2_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/trex02-2_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex02-2_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/trex02-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/trex02-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
const abort: ref;
axiom (abort == $sub.ref(0, 9287));
procedure abort();
const foo: ref;
axiom (foo == $sub.ref(0, 10319));
procedure foo()
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "./output/trex02-2_tmp.c", 17, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex02-2_tmp.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  ...
  assume {:sourceloc "./output/trex02-2_tmp.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 11351));
procedure main()
  returns ($r: i32)
{
  var $i0: i32;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/trex02-2_tmp.c", 21, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex02-2_tmp.c", 21, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $i0;
  call {:cexpr "x"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/trex02-2_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/trex02-2_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i1, 0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/trex02-2_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "./output/trex02-2_tmp.c", 23, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  call {:cexpr "c"} boogie_si_record_i8($i4);
  assume {:sourceloc "./output/trex02-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $trunc.i8.i1($i4);
  assume {:sourceloc "./output/trex02-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/trex02-2_tmp.c", 27, 21} true;
  assume {:verifier.code 1} true;
  $i6 := $M.0;
  assume {:sourceloc "./output/trex02-2_tmp.c", 27, 22} true;
  assume {:verifier.code 1} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "./output/trex02-2_tmp.c", 27, 22} true;
  assume {:verifier.code 1} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "./output/trex02-2_tmp.c", 27, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i8);
  assume {:sourceloc "./output/trex02-2_tmp.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/trex02-2_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
  call foo();
  assume {:sourceloc "./output/trex02-2_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/trex02-2_tmp.c", 25, 10} true;
  assume {:verifier.code 0} true;
  call foo();
  assume {:verifier.code 0} true;
  goto $bb6;
...
axiom (__VERIFIER_assume == $sub.ref(0, 12383));
...
axiom (__SMACK_code == $sub.ref(0, 13415));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 14447));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 15479));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 16511));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 17543));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 18575));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 19607));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 20639));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 21671));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 22703));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 23735));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 24767));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 25799));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 26831));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 27863));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 28895));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 29927));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 30959));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 31991));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 33023));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 34055));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 35087));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 36119));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 37151));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 38183));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 39215));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 40247));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 41279));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 42311));
...
axiom (__SMACK_decls == $sub.ref(0, 43343));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 44375));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 45407));
...
axiom (llvm.dbg.value == $sub.ref(0, 46439));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 47471));
