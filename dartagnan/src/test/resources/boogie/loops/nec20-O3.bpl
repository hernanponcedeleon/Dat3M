...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/nec20-O3.bpl /Users/ponce/git/Dat3M/./output/nec20_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/nec20_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/nec20_tmp.c", 14, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/nec20_tmp.c", 14, 12} true;
  assume {:verifier.code 0} true;
  call $i0 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i0);
  assume {:sourceloc "./output/nec20_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_bv32($i1);
  call {:cexpr "j"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/nec20_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.bv32($i1, 10000bv32);
  assume {:sourceloc "./output/nec20_tmp.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $i3 := 0bv32;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/nec20_tmp.c", 45, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb3:
  assume !(($i2 == 1bv1));
  assume {:verifier.code 0} true;
  $i4 := (if ($i0 == 1bv1) then 0bv32 else 2046bv32);
  call {:cexpr "n"} boogie_si_record_bv32($i4);
  assume {:sourceloc "./output/nec20_tmp.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $add.bv32($i1, $i4);
  assume {:sourceloc "./output/nec20_tmp.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $add.bv32($i5, 2bv32);
  call {:cexpr "j"} boogie_si_record_bv32($i6);
  assume {:sourceloc "./output/nec20_tmp.c", 35, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $ugt.bv32($i6, 1024bv32);
  assume {:sourceloc "./output/nec20_tmp.c", 6, 7} true;
  assume {:verifier.code 0} true;
  $i3 := 1bv32;
...
$bb4:
  assume ($i7 == 1bv1);
  assume {:sourceloc "./output/nec20_tmp.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/nec20_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/nec20_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 40247));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 45407));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 46439));
...
{
$bb0:
  $M.0 := $store.bv32($M.0, b, 0bv32);
  call {:cexpr "b"} boogie_si_record_bv32(0bv32);
...
procedure  boogie_si_record_bv1(x: bv1);
