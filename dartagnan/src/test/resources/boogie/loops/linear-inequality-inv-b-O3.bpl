...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/linear-inequality-inv-b-O3.bpl /Users/ponce/git/Dat3M/./output/linear-inequality-inv-b_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 1, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 4, 21} true;
  assume {:verifier.code 1} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 4, 21} true;
  assume {:verifier.code 1} true;
  call $i0 := __VERIFIER_nondet_uchar();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uchar"} boogie_si_record_bv8($i0);
  call {:cexpr "n"} boogie_si_record_bv8($i0);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.bv8.bv32($i0);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 5, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.bv8($i0, 0bv8);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5 := 0bv32, 0bv32, 0bv32;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 12, 9} true;
  assume {:verifier.code 1} true;
  call $i6 := __VERIFIER_nondet_uchar();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uchar"} boogie_si_record_bv8($i6);
  call {:cexpr "v"} boogie_si_record_bv8($i6);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.bv8.bv32($i6);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 13, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $add.bv32($i5, $i7);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $i9 := $add.bv32($i4, 1bv32);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $and.bv32($i8, 255bv32);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 11, 12} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.bv32($i9, $i1);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i11 == 1bv1);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $i12 := $ult.bv32($i10, $i7);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 16, 7} true;
  assume {:verifier.code 0} true;
  $i3 := 0bv32;
...
$bb7:
  assume ($i12 == 1bv1);
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 17, 5} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/linear-inequality-inv-b_tmp.c", 18, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 1bv32;
  goto $bb2;
$bb8:
...
axiom (__VERIFIER_nondet_uchar == $sub.ref(0, 38187));
...
$bb0:
  ...
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_char"} boogie_si_record_bv8($i0);
