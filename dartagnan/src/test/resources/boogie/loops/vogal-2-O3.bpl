...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/vogal-2-O3.bpl /Users/ponce/git/Dat3M/./output/vogal-2_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 48507));
...
{
$bb0:
  assume {:sourceloc "./output/vogal-2_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/vogal-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(10, $bv2int.64($zext.bv32.bv64(1bv32))));
  assume {:sourceloc "./output/vogal-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(0, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/vogal-2_tmp.c:16:3: warning: unsoundly ignoring unmodeled operation llvm.lifetime.start.p0i8;
  call llvm.lifetime.start.p0i8(10bv64, $p1);
  assume true;
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i2 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i2);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p1, $i2);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i3 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i3);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(1, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p4, $i3);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i5 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i5);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(2, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p6, $i5);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i7 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i7);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(3, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p8, $i7);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i9 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i9);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(4, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p10, $i9);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i11 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i11);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(5, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p12, $i11);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i13 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i13);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(6, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p14, $i13);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i15 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i15);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(7, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p16, $i15);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i17 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i17);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(8, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p18, $i17);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 25} true;
  assume {:verifier.code 0} true;
  call $i19 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i19);
  assume {:sourceloc "./output/vogal-2_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(9, 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 22, 24} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, $p20, 0bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 25, 35} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.bv8($i2, 0bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i22, $i23 := 0bv32, 1bv32;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/vogal-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vogal-2_tmp.c", 25, 9} true;
  assume {:verifier.code 0} true;
  $i29 := $zext.bv32.bv64($i22);
  assume {:sourceloc "./output/vogal-2_tmp.c", 29, 12} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.bv32($i22, 0bv32);
  assume {:sourceloc "./output/vogal-2_tmp.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $i31, $i32, $i33, $i34 := 0bv32, $i2, 0bv64, 0bv32;
...
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.bv32.bv64($i23);
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref($bv2int.64($i24), 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 25, 9} true;
  assume {:verifier.code 0} true;
  $i26 := $load.bv8($M.0, $p25);
  assume {:sourceloc "./output/vogal-2_tmp.c", 25, 35} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.bv8($i26, 0bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i28 := $add.bv32($i23, 1bv32);
  call {:cexpr "n_caracter"} boogie_si_record_bv32($i28);
  assume {:sourceloc "./output/vogal-2_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i22 := $i23;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/vogal-2_tmp.c", 28, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vogal-2_tmp.c", 36, 26} true;
  assume {:verifier.code 0} true;
  $i63 := $eq.bv8($i2, 0bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $i64, $i65, $i66, $i67 := 0bv32, $i2, 0bv32, 0bv32;
...
$bb10:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 30} true;
  assume {:verifier.code 0} true;
  $i35 := $eq.bv8($i32, 97bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.bv1.bv32($i35);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i37 := $add.bv32($i34, $i36);
  call {:cexpr "cont"} boogie_si_record_bv32($i37);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 30} true;
  assume {:verifier.code 0} true;
  $i38 := $eq.bv8($i32, 65bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i39 := $zext.bv1.bv32($i38);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i40 := $add.bv32($i37, $i39);
  call {:cexpr "cont"} boogie_si_record_bv32($i40);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 30} true;
  assume {:verifier.code 0} true;
  $i41 := $eq.bv8($i32, 101bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i42 := $zext.bv1.bv32($i41);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i43 := $add.bv32($i40, $i42);
  call {:cexpr "cont"} boogie_si_record_bv32($i43);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 30} true;
  assume {:verifier.code 0} true;
  $i44 := $eq.bv8($i32, 69bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i45 := $zext.bv1.bv32($i44);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i46 := $add.bv32($i43, $i45);
  call {:cexpr "cont"} boogie_si_record_bv32($i46);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 30} true;
  assume {:verifier.code 0} true;
  $i47 := $eq.bv8($i32, 105bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.bv1.bv32($i47);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i49 := $add.bv32($i46, $i48);
  call {:cexpr "cont"} boogie_si_record_bv32($i49);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 30} true;
  assume {:verifier.code 0} true;
  $i50 := $eq.bv8($i32, 73bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.bv1.bv32($i50);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i52 := $add.bv32($i49, $i51);
  call {:cexpr "cont"} boogie_si_record_bv32($i52);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 30} true;
  assume {:verifier.code 0} true;
  $i53 := $eq.bv8($i32, 111bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i54 := $zext.bv1.bv32($i53);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i55 := $add.bv32($i52, $i54);
  call {:cexpr "cont"} boogie_si_record_bv32($i55);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 30} true;
  assume {:verifier.code 0} true;
  $i56 := $eq.bv8($i32, 79bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i57 := $zext.bv1.bv32($i56);
  assume {:sourceloc "./output/vogal-2_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $i58 := $add.bv32($i55, $i57);
  call {:cexpr "cont"} boogie_si_record_bv32($i58);
  assume {:sourceloc "./output/vogal-2_tmp.c", 29, 25} true;
  assume {:verifier.code 0} true;
  $i59 := $add.bv64($i33, 1bv64);
  assume {:sourceloc "./output/vogal-2_tmp.c", 29, 12} true;
  assume {:verifier.code 0} true;
  $i60 := $eq.bv64($i59, $i29);
  assume {:sourceloc "./output/vogal-2_tmp.c", 29, 3} true;
...
$bb12:
  assume !(($i60 == 1bv1));
  assume {:verifier.code 0} true;
  $p61 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref($bv2int.64($i59), 1));
  assume {:verifier.code 0} true;
  $i62 := $load.bv8($M.0, $p61);
  assume {:sourceloc "./output/vogal-2_tmp.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $i32, $i33, $i34 := $i62, $i59, $i58;
  goto $bb10;
$bb13:
  assume {:sourceloc "./output/vogal-2_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb14;
$bb14:
  assume {:sourceloc "./output/vogal-2_tmp.c", 35, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vogal-2_tmp.c", 45, 29} true;
  assume {:verifier.code 0} true;
  $i103 := $eq.bv32($i64, $i31);
  assume {:sourceloc "./output/vogal-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i68 := $eq.bv8($i65, 97bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.bv1.bv32($i68);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i70 := $add.bv32($i66, $i69);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i70);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i71 := $eq.bv8($i65, 65bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.bv1.bv32($i71);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i73 := $add.bv32($i70, $i72);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i73);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i74 := $eq.bv8($i65, 101bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i75 := $zext.bv1.bv32($i74);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i76 := $add.bv32($i73, $i75);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i76);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.bv8($i65, 69bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i78 := $zext.bv1.bv32($i77);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i79 := $add.bv32($i76, $i78);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i79);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i80 := $eq.bv8($i65, 105bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.bv1.bv32($i80);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i82 := $add.bv32($i79, $i81);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i82);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.bv8($i65, 73bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i84 := $zext.bv1.bv32($i83);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i85 := $add.bv32($i82, $i84);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i85);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i86 := $eq.bv8($i65, 111bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i87 := $zext.bv1.bv32($i86);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i88 := $add.bv32($i85, $i87);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i88);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i89 := $eq.bv8($i65, 79bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i90 := $zext.bv1.bv32($i89);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i91 := $add.bv32($i88, $i90);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i91);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i92 := $eq.bv8($i65, 117bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i93 := $zext.bv1.bv32($i92);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i94 := $add.bv32($i91, $i93);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i94);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 30} true;
  assume {:verifier.code 0} true;
  $i95 := $eq.bv8($i65, 85bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i96 := $zext.bv1.bv32($i95);
  assume {:sourceloc "./output/vogal-2_tmp.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i97 := $add.bv32($i94, $i96);
  call {:cexpr "cont_aux"} boogie_si_record_bv32($i97);
  assume {:sourceloc "./output/vogal-2_tmp.c", 43, 6} true;
  assume {:verifier.code 0} true;
  $i98 := $add.bv32($i67, 1bv32);
  assume {:sourceloc "./output/vogal-2_tmp.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $i99 := $zext.bv32.bv64($i98);
  assume {:sourceloc "./output/vogal-2_tmp.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref($bv2int.64($i99), 1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $i101 := $load.bv8($M.0, $p100);
  assume {:sourceloc "./output/vogal-2_tmp.c", 36, 26} true;
  assume {:verifier.code 0} true;
  $i102 := $eq.bv8($i101, 0bv8);
  assume {:sourceloc "./output/vogal-2_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $i64 := $i97;
...
$bb18:
  assume !(($i102 == 1bv1));
  assume {:verifier.code 0} true;
  $i65, $i66, $i67 := $i101, $i97, $i98;
  goto $bb16;
$bb19:
  assume ($i103 == 1bv1);
  assume {:sourceloc "./output/vogal-2_tmp.c", 48, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/vogal-2_tmp.c:48:1: warning: unsoundly ignoring unmodeled operation llvm.lifetime.end.p0i8;
  call llvm.lifetime.end.p0i8(10bv64, $p1);
  assume {:sourceloc "./output/vogal-2_tmp.c", 47, 3} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb20:
  assume !(($i103 == 1bv1));
  assume {:sourceloc "./output/vogal-2_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/vogal-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/vogal-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.lifetime.start.p0i8 == $sub.ref(0, 10323));
...
axiom (llvm.lifetime.end.p0i8 == $sub.ref(0, 12387));
...
$bb0:
  ...
  call {:cexpr "smack:ext:__SMACK_nondet_char"} boogie_si_record_bv8($i0);
  call {:cexpr "x"} boogie_si_record_bv8($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 258, 29} true;
  assume {:verifier.code 1} true;
  assume true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 38, 3} true;
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 46443));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 47475));
...
axiom (__SMACK_static_init == $sub.ref(0, 48507));
