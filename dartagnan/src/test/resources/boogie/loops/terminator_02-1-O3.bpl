...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/terminator_02-1-O3.bpl /Users/ponce/git/Dat3M/./output/terminator_02-1_tmp.c
...
$bb2:
  ...
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.bv1.bv32($i9);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i11 := $add.bv32($i7, $i10);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i12 := (if ($i8 == 1bv1) then 1bv32 else $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $add.bv32($i12, $i6);
  ...
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 19, 10} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.bv32($i13, 100bv32);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 19, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $sgt.bv32($i11, 100bv32);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 19, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $and.bv1($i15, $i14);
  assume {:sourceloc "./output/terminator_02-1_tmp.c", 19, 3} true;
