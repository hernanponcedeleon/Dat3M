...
{
$bb0:
  assume {:sourceloc "./output/sum03-1_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sum03-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum03-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sum03-1_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sum03-1_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sum03-1_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum03-1_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sum03-1_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sum03-1_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum03-1_tmp.c", 15, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum03-1_tmp.c", 15, 51} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum03-1_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0, 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "./output/sum03-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum03-1_tmp.c", 19, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.i32($i3, 10);
  assume {:sourceloc "./output/sum03-1_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $i2;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./output/sum03-1_tmp.c", 20, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i2, 2);
  call {:cexpr "sn"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/sum03-1_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $i6;
  goto $bb4;
$bb3:
...
$bb4:
  assume {:sourceloc "./output/sum03-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum03-1_tmp.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i3, 1);
  call {:cexpr "x"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/sum03-1_tmp.c", 23, 30} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($i7, 2);
  assume {:sourceloc "./output/sum03-1_tmp.c", 23, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i5, $i8);
  assume {:sourceloc "./output/sum03-1_tmp.c", 23, 33} true;
  assume {:verifier.code 0} true;
  $i10 := 1;
...
$bb6:
  ...
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/sum03-1_tmp.c", 23, 7} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sum03-1_tmp.c", 23, 39} true;
  assume {:verifier.code 1} true;
  $i11 := $eq.i32($i5, 0);
  assume {:sourceloc "./output/sum03-1_tmp.c", 23, 33} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "./output/sum03-1_tmp.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
