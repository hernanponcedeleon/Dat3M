...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sum03-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum03-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sum03-1_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sum03-1_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sum03-1_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum03-1_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum03-1_tmp.c", 14, 22} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "loop1"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum03-1_tmp.c", 14, 51} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i1);
  call {:cexpr "n1"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/sum03-1_tmp.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/sum03-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum03-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum03-1_tmp.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.i32($i3, 10);
  assume {:sourceloc "./output/sum03-1_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $i2;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./output/sum03-1_tmp.c", 19, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i2, 2);
  call {:cexpr "sn"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/sum03-1_tmp.c", 20, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $i6;
  goto $bb4;
$bb3:
...
$bb4:
  assume {:sourceloc "./output/sum03-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum03-1_tmp.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i3, 1);
  call {:cexpr "x"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/sum03-1_tmp.c", 22, 30} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($i7, 2);
  assume {:sourceloc "./output/sum03-1_tmp.c", 22, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i5, $i8);
  assume {:sourceloc "./output/sum03-1_tmp.c", 22, 33} true;
  assume {:verifier.code 0} true;
  $i10 := 1;
...
$bb6:
  ...
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/sum03-1_tmp.c", 22, 7} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sum03-1_tmp.c", 22, 39} true;
  assume {:verifier.code 1} true;
  $i11 := $eq.i32($i5, 0);
  assume {:sourceloc "./output/sum03-1_tmp.c", 22, 33} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "./output/sum03-1_tmp.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
