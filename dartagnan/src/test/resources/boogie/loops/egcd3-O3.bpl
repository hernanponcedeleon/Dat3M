...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/egcd3-O3.bpl /Users/ponce/git/Dat3M/./output/egcd3_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/egcd3_tmp.c", 3, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/egcd3_tmp.c", 20, 9} true;
  ...
  assume {:sourceloc "./output/egcd3_tmp.c", 21, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/egcd3_tmp.c", 22, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.bv32($i0, 1bv32);
  assume {:sourceloc "./output/egcd3_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/egcd3_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/egcd3_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/egcd3_tmp.c", 23, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.bv32($i1, 1bv32);
  assume {:sourceloc "./output/egcd3_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7, $i8, $i9 := $i0, 1bv32, 0bv32, 0bv32, 1bv32, $i1;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd3_tmp.c", 40, 21} true;
  assume {:verifier.code 0} true;
  $i10 := $slt.bv32($i4, $i9);
  assume {:sourceloc "./output/egcd3_tmp.c", 40, 17} true;
  assume {:verifier.code 0} true;
  $i11, $i12 := $i4, 0bv32;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/egcd3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd3_tmp.c", 66, 22} true;
  assume {:verifier.code 0} true;
  $i36 := $mul.bv32($i12, $i7);
  assume {:sourceloc "./output/egcd3_tmp.c", 66, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $sub.bv32($i8, $i36);
  assume {:sourceloc "./output/egcd3_tmp.c", 69, 22} true;
  assume {:verifier.code 0} true;
  $i38 := $mul.bv32($i12, $i5);
  assume {:sourceloc "./output/egcd3_tmp.c", 69, 18} true;
  assume {:verifier.code 0} true;
  $i39 := $sub.bv32($i6, $i38);
  assume {:sourceloc "./output/egcd3_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i40 := $eq.bv32($i11, 0bv32);
  assume {:sourceloc "./output/egcd3_tmp.c", 33, 13} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i16 == 1bv1));
  assume {:sourceloc "./output/egcd3_tmp.c", 12, 10} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/egcd3_tmp.c", 12, 24} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/egcd3_tmp.c", 12, 24} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  $i23 := $mul.bv32($i21, $i9);
  assume {:verifier.code 0} true;
  $i24 := $add.bv32($i23, $i22);
  assume {:verifier.code 0} true;
  $i25 := $eq.bv32($i4, $i24);
  assume {:sourceloc "./output/egcd3_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
  $i26, $i27 := 1bv32, $i9;
...
$bb15:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd3_tmp.c", 52, 30} true;
  assume {:verifier.code 0} true;
  $i28 := $shl.bv32($i27, 1bv32);
  assume {:sourceloc "./output/egcd3_tmp.c", 52, 25} true;
  assume {:verifier.code 0} true;
  $i29 := $slt.bv32($i22, $i28);
  assume {:sourceloc "./output/egcd3_tmp.c", 52, 21} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i29 == 1bv1);
  assume {:sourceloc "./output/egcd3_tmp.c", 57, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $sub.bv32($i22, $i27);
  assume {:sourceloc "./output/egcd3_tmp.c", 58, 19} true;
  assume {:verifier.code 0} true;
  $i34 := $add.bv32($i26, $i21);
  call {:cexpr "k"} boogie_si_record_bv32($i34);
  assume {:sourceloc "./output/egcd3_tmp.c", 40, 21} true;
  assume {:verifier.code 0} true;
  $i35 := $slt.bv32($i33, $i9);
  assume {:sourceloc "./output/egcd3_tmp.c", 40, 17} true;
...
$bb18:
  assume !(($i29 == 1bv1));
  assume {:sourceloc "./output/egcd3_tmp.c", 54, 23} true;
  assume {:verifier.code 0} true;
  $i30 := $shl.bv32($i26, 1bv32);
  assume {:sourceloc "./output/egcd3_tmp.c", 50, 42} true;
  assume {:verifier.code 0} true;
  $i31 := $mul.bv32($i30, $i9);
  assume {:sourceloc "./output/egcd3_tmp.c", 50, 37} true;
  assume {:verifier.code 0} true;
  $i32 := $eq.bv32($i28, $i31);
  assume {:sourceloc "./output/egcd3_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume ($i40 == 1bv1);
  assume {:sourceloc "./output/egcd3_tmp.c", 71, 27} true;
  assume {:verifier.code 0} true;
  $i41 := $sub.bv32($i7, $i37);
  assume {:sourceloc "./output/egcd3_tmp.c", 71, 27} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i44 := $mul.bv32($i43, $i1);
  assume {:sourceloc "./output/egcd3_tmp.c", 71, 39} true;
  assume {:verifier.code 0} true;
  $i45 := $add.bv32($i44, $i42);
  assume {:sourceloc "./output/egcd3_tmp.c", 71, 46} true;
  assume {:verifier.code 0} true;
  $i46 := $eq.bv32($i45, $i9);
  assume {:sourceloc "./output/egcd3_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume !(($i40 == 1bv1));
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7, $i8, $i9 := $i9, $i39, $i5, $i37, $i7, $i11;
  goto $bb5;
$bb25:
  assume ($i46 == 1bv1);
  assume {:sourceloc "./output/egcd3_tmp.c", 72, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
