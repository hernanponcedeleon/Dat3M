...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/count_by_2-O3.bpl /Users/ponce/git/Dat3M/./output/count_by_2_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/count_by_2_tmp.c", 18, 5} true;
