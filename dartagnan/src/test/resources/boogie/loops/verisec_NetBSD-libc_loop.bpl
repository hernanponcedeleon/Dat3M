...
const tmp: ref;
axiom (tmp == $sub.ref(0, 1032));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 2064));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 3091));
const {:count 14} .str.14: ref;
axiom (.str.14 == $sub.ref(0, 4129));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 5157));
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 7221));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const glob2: ref;
axiom (glob2 == $sub.ref(0, 8253));
procedure glob2($p0: ref, $p1: ref)
  returns ($r: i32)
{
  var $p2: ref;
  var $i3: i1;
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 18, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 18, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $p0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 18, 23} true;
  assume {:verifier.code 0} true;
  $i3 := $ule.ref($p2, $p1);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 20, 26} true;
  assume {:verifier.code 1} true;
  $p4 := $M.0;
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 20, 24} true;
  assume {:verifier.code 1} true;
  $i5 := $ule.ref($p2, $p4);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 20, 24} true;
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i6);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p2, 1);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 18, 36} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p2, $mul.ref(1, 4));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $p7;
  goto $bb1;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 31, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 31, 17} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 4));
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(8, 4));
  $i3 := $add.i64(8, $sub.i64(0, 1));
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref($i3, 4));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 4));
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(2, 4));
  $i7 := $add.i64(2, $sub.i64(0, 1));
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref($i7, 4));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 33, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $p8;
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 35, 10} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 4));
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := glob2($p9, $p4);
  assume {:sourceloc "./output/verisec_NetBSD-libc_loop_tmp.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
