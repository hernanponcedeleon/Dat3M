...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/prod4br_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/prod4br_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 7, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 8, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/prod4br_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/prod4br_tmp.c", 7, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/prod4br_tmp.c", 10, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/prod4br_tmp.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 10, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/prod4br_tmp.c", 10, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/prod4br_tmp.c", 12, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/prod4br_tmp.c", 21, 9} true;
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 22, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 23, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 23, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/prod4br_tmp.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/prod4br_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7 := $i0, $i1, 1, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/prod4br_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prod4br_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prod4br_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prod4br_tmp.c", 28, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prod4br_tmp.c", 31, 33} true;
  assume {:verifier.code 1} true;
  $i8 := $mul.i32($i4, $i5);
  assume {:sourceloc "./output/prod4br_tmp.c", 31, 37} true;
  assume {:verifier.code 1} true;
  $i9 := $mul.i32($i8, $i6);
  assume {:sourceloc "./output/prod4br_tmp.c", 31, 29} true;
  assume {:verifier.code 1} true;
  $i10 := $add.i32($i7, $i9);
  assume {:sourceloc "./output/prod4br_tmp.c", 31, 46} true;
  assume {:verifier.code 1} true;
  $i11 := $mul.i32($i0, $i1);
  assume {:sourceloc "./output/prod4br_tmp.c", 31, 41} true;
  assume {:verifier.code 1} true;
  $i12 := $eq.i32($i10, $i11);
  assume {:sourceloc "./output/prod4br_tmp.c", 31, 41} true;
  assume {:verifier.code 1} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/prod4br_tmp.c", 31, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i13);
  assume {:sourceloc "./output/prod4br_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i4, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 33, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i14 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 33, 27} true;
  assume {:verifier.code 0} true;
  $i15 := $ne.i32($i5, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 33, 13} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/prod4br_tmp.c", 34, 13} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb5:
  assume ($i15 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $srem.i32($i4, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 36, 19} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i16, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 36, 24} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "./output/prod4br_tmp.c", 53, 30} true;
  assume {:verifier.code 1} true;
  $i53 := $mul.i32($i0, $i1);
  assume {:sourceloc "./output/prod4br_tmp.c", 53, 25} true;
  assume {:verifier.code 1} true;
  $i54 := $eq.i32($i7, $i53);
  assume {:sourceloc "./output/prod4br_tmp.c", 53, 25} true;
  assume {:verifier.code 1} true;
  $i55 := $zext.i1.i32($i54);
  assume {:sourceloc "./output/prod4br_tmp.c", 53, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i55);
  assume {:sourceloc "./output/prod4br_tmp.c", 54, 25} true;
  assume {:verifier.code 1} true;
  $i56 := $mul.i32($i4, $i5);
  assume {:sourceloc "./output/prod4br_tmp.c", 54, 29} true;
  assume {:verifier.code 1} true;
  $i57 := $eq.i32($i56, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 54, 29} true;
  assume {:verifier.code 1} true;
  $i58 := $zext.i1.i32($i57);
  assume {:sourceloc "./output/prod4br_tmp.c", 54, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i58);
  assume {:sourceloc "./output/prod4br_tmp.c", 55, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb8:
  assume ($i17 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 36, 29} true;
  assume {:verifier.code 0} true;
  $i18 := $srem.i32($i5, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 36, 33} true;
  assume {:verifier.code 0} true;
  $i19 := $eq.i32($i18, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 36, 13} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 22} true;
  assume {:verifier.code 0} true;
  $i27 := $srem.i32($i4, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 26} true;
  assume {:verifier.code 0} true;
  $i28 := $eq.i32($i27, 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 31} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb14, $bb15;
$bb11:
  assume ($i19 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $sdiv.i32($i4, 2);
  call {:cexpr "a"} boogie_si_record_i32($i20);
  assume {:sourceloc "./output/prod4br_tmp.c", 38, 19} true;
  assume {:verifier.code 0} true;
  $i21 := $sdiv.i32($i5, 2);
  call {:cexpr "b"} boogie_si_record_i32($i21);
  assume {:sourceloc "./output/prod4br_tmp.c", 39, 19} true;
  assume {:verifier.code 0} true;
  $i22 := $mul.i32(4, $i6);
  call {:cexpr "p"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 9} true;
  assume {:verifier.code 0} true;
  $i23, $i24, $i25, $i26 := $i20, $i21, $i22, $i7;
  goto $bb13;
$bb12:
  assume {:sourceloc "./output/prod4br_tmp.c", 36, 13} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7 := $i23, $i24, $i25, $i26;
  goto $bb1;
$bb14:
  assume ($i28 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 36} true;
  assume {:verifier.code 0} true;
  $i29 := $srem.i32($i5, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 40} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.i32($i29, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 20} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 22} true;
  assume {:verifier.code 0} true;
  $i37 := $srem.i32($i4, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 26} true;
  assume {:verifier.code 0} true;
  $i38 := $eq.i32($i37, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 31} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb20, $bb21;
$bb17:
  assume ($i30 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 41, 19} true;
  assume {:verifier.code 0} true;
  $i31 := $sub.i32($i4, 1);
  call {:cexpr "a"} boogie_si_record_i32($i31);
  assume {:sourceloc "./output/prod4br_tmp.c", 42, 23} true;
  assume {:verifier.code 0} true;
  $i32 := $mul.i32($i5, $i6);
  assume {:sourceloc "./output/prod4br_tmp.c", 42, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i7, $i32);
  call {:cexpr "q"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 9} true;
  assume {:verifier.code 0} true;
  $i34, $i35, $i36 := $i31, $i5, $i33;
  goto $bb19;
$bb18:
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 20} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i23, $i24, $i25, $i26 := $i34, $i35, $i6, $i36;
  goto $bb13;
$bb20:
  assume ($i38 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 36} true;
  assume {:verifier.code 0} true;
  $i39 := $srem.i32($i5, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 40} true;
  assume {:verifier.code 0} true;
  $i40 := $eq.i32($i39, 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 20} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  goto $bb22;
$bb22:
  assume {:sourceloc "./output/prod4br_tmp.c", 47, 19} true;
  assume {:verifier.code 0} true;
  $i47 := $sub.i32($i4, 1);
  call {:cexpr "a"} boogie_si_record_i32($i47);
  assume {:sourceloc "./output/prod4br_tmp.c", 48, 19} true;
  assume {:verifier.code 0} true;
  $i48 := $sub.i32($i5, 1);
  call {:cexpr "b"} boogie_si_record_i32($i48);
  assume {:sourceloc "./output/prod4br_tmp.c", 49, 24} true;
  assume {:verifier.code 0} true;
  $i49 := $add.i32($i47, $i48);
  assume {:sourceloc "./output/prod4br_tmp.c", 49, 28} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i32($i49, 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 49, 33} true;
  assume {:verifier.code 0} true;
  $i51 := $mul.i32($i50, $i6);
  assume {:sourceloc "./output/prod4br_tmp.c", 49, 19} true;
  assume {:verifier.code 0} true;
  $i52 := $add.i32($i7, $i51);
  call {:cexpr "q"} boogie_si_record_i32($i52);
  assume {:verifier.code 0} true;
  $i44, $i45, $i46 := $i47, $i48, $i52;
  goto $bb25;
$bb23:
  assume ($i40 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 44, 19} true;
  assume {:verifier.code 0} true;
  $i41 := $sub.i32($i5, 1);
  call {:cexpr "b"} boogie_si_record_i32($i41);
  assume {:sourceloc "./output/prod4br_tmp.c", 45, 23} true;
  assume {:verifier.code 0} true;
  $i42 := $mul.i32($i4, $i6);
  assume {:sourceloc "./output/prod4br_tmp.c", 45, 19} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i32($i7, $i42);
  call {:cexpr "q"} boogie_si_record_i32($i43);
  assume {:sourceloc "./output/prod4br_tmp.c", 46, 9} true;
  assume {:verifier.code 0} true;
  $i44, $i45, $i46 := $i4, $i41, $i43;
  goto $bb25;
$bb24:
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 20} true;
  assume {:verifier.code 0} true;
...
axiom (__SMACK_code == $sub.ref(0, 10317));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 11349));
...
axiom (__VERIFIER_error == $sub.ref(0, 12381));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 13413));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 14445));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 15477));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 16509));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 17541));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 18573));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 19605));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 20637));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 21669));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 22701));
