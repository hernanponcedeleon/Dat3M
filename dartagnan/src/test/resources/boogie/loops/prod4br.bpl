...
{
$bb0:
  assume {:sourceloc "./output/prod4br_tmp.c", 4, 44} true;
...
axiom (assume_abort_if_not == $sub.ref(0, 7227));
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/prod4br_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/prod4br_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 8, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 9, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/prod4br_tmp.c", 8, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/prod4br_tmp.c", 8, 14} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_assert == $sub.ref(0, 9291));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/prod4br_tmp.c", 11, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/prod4br_tmp.c", 11, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 11, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/prod4br_tmp.c", 11, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/prod4br_tmp.c", 13, 10} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/prod4br_tmp.c", 13, 24} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/prod4br_tmp.c", 13, 24} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 23, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 24, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 24, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/prod4br_tmp.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/prod4br_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prod4br_tmp.c", 29, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prod4br_tmp.c", 32, 33} true;
  assume {:verifier.code 1} true;
  $i8 := $mul.i32($i4, $i5);
  assume {:sourceloc "./output/prod4br_tmp.c", 32, 37} true;
  assume {:verifier.code 1} true;
  $i9 := $mul.i32($i8, $i6);
  assume {:sourceloc "./output/prod4br_tmp.c", 32, 29} true;
  assume {:verifier.code 1} true;
  $i10 := $add.i32($i7, $i9);
  assume {:sourceloc "./output/prod4br_tmp.c", 32, 46} true;
  assume {:verifier.code 1} true;
  $i11 := $mul.i32($i0, $i1);
  assume {:sourceloc "./output/prod4br_tmp.c", 32, 41} true;
  assume {:verifier.code 1} true;
  $i12 := $eq.i32($i10, $i11);
  assume {:sourceloc "./output/prod4br_tmp.c", 32, 41} true;
  assume {:verifier.code 1} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/prod4br_tmp.c", 32, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i13);
  assume {:sourceloc "./output/prod4br_tmp.c", 34, 17} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i4, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 34, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i14 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 34, 27} true;
  assume {:verifier.code 0} true;
  $i15 := $ne.i32($i5, 0);
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/prod4br_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb5:
  assume ($i15 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 37, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $srem.i32($i4, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i16, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 37, 24} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "./output/prod4br_tmp.c", 54, 30} true;
  assume {:verifier.code 1} true;
  $i53 := $mul.i32($i0, $i1);
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 55, 25} true;
  assume {:verifier.code 1} true;
  $i56 := $mul.i32($i4, $i5);
  assume {:sourceloc "./output/prod4br_tmp.c", 55, 29} true;
  assume {:verifier.code 1} true;
  $i57 := $eq.i32($i56, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 55, 29} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 56, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb8:
  assume ($i17 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 37, 29} true;
  assume {:verifier.code 0} true;
  $i18 := $srem.i32($i5, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 37, 33} true;
  assume {:verifier.code 0} true;
  $i19 := $eq.i32($i18, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 37, 13} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/prod4br_tmp.c", 41, 22} true;
  assume {:verifier.code 0} true;
  $i27 := $srem.i32($i4, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 41, 26} true;
  assume {:verifier.code 0} true;
  $i28 := $eq.i32($i27, 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 41, 31} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 40, 19} true;
  assume {:verifier.code 0} true;
  $i22 := $mul.i32(4, $i6);
  call {:cexpr "p"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/prod4br_tmp.c", 41, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume ($i28 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 41, 36} true;
  assume {:verifier.code 0} true;
  $i29 := $srem.i32($i5, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 41, 40} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.i32($i29, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 41, 20} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "./output/prod4br_tmp.c", 44, 22} true;
  assume {:verifier.code 0} true;
  $i37 := $srem.i32($i4, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 44, 26} true;
  assume {:verifier.code 0} true;
  $i38 := $eq.i32($i37, 0);
  assume {:sourceloc "./output/prod4br_tmp.c", 44, 31} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 23} true;
  assume {:verifier.code 0} true;
  $i32 := $mul.i32($i5, $i6);
  assume {:sourceloc "./output/prod4br_tmp.c", 43, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i7, $i32);
  call {:cexpr "q"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/prod4br_tmp.c", 44, 9} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume ($i38 == 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 44, 36} true;
  assume {:verifier.code 0} true;
  $i39 := $srem.i32($i5, 2);
  assume {:sourceloc "./output/prod4br_tmp.c", 44, 40} true;
  assume {:verifier.code 0} true;
  $i40 := $eq.i32($i39, 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 44, 20} true;
  assume {:verifier.code 0} true;
...
$bb22:
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 50, 24} true;
  assume {:verifier.code 0} true;
  $i49 := $add.i32($i47, $i48);
  assume {:sourceloc "./output/prod4br_tmp.c", 50, 28} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i32($i49, 1);
  assume {:sourceloc "./output/prod4br_tmp.c", 50, 33} true;
  assume {:verifier.code 0} true;
  $i51 := $mul.i32($i50, $i6);
  assume {:sourceloc "./output/prod4br_tmp.c", 50, 19} true;
  assume {:verifier.code 0} true;
  $i52 := $add.i32($i7, $i51);
...
$bb23:
  ...
  assume {:sourceloc "./output/prod4br_tmp.c", 46, 23} true;
  assume {:verifier.code 0} true;
  $i42 := $mul.i32($i4, $i6);
  assume {:sourceloc "./output/prod4br_tmp.c", 46, 19} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i32($i7, $i42);
  call {:cexpr "q"} boogie_si_record_i32($i43);
  assume {:sourceloc "./output/prod4br_tmp.c", 47, 9} true;
  assume {:verifier.code 0} true;
...
axiom (__SMACK_check_overflow == $sub.ref(0, 14451));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 15483));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 16515));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 17547));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 18579));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 19611));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 20643));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 21675));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 22707));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 23739));
