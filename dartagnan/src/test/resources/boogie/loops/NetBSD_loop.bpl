...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 17, 16} true;
  ...
  call {:cexpr "MAXPATHLEN"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 0);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 18, 35} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i0, 2147483647);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 18, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 18, 55} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb4:
  assume ($i2 == 1);
...
$bb5:
  ...
  goto $bb3;
$bb6:
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 21, 41} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, 1);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 21, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32(0, $i3);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 21, 46} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i4, 1);
  call {:cexpr "bound_off"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 27, 8} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
  goto $bb8;
$bb7:
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 35, 8} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb8:
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 28, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $sle.i32($i6, $i5);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 27, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb9, $bb10;
$bb9:
  assume ($i7 == 1);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 31, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $sle.i32(0, $i6);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 31, 26} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  call $i10 := __VERIFIER_assert.i32($i9);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i10);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 32, 49} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i0, 1);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 32, 36} true;
  assume {:verifier.code 0} true;
  $i12 := $slt.i32($i6, $i11);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 32, 36} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 32, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := __VERIFIER_assert.i32($i13);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume !(($i7 == 1));
  ...
  goto $bb7;
$bb11:
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 29, 18} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i6, 1);
  call {:cexpr "glob2_p_off"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/NetBSD_loop_tmp.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $i15;
  goto $bb8;
