...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 7, 16} true;
  ...
  call {:cexpr "tagbuf_len"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 8, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i32($i0, 1);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 8, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 8, 29} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, $sub.i32(0, 1));
  call {:cexpr "tagbuf_len"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 68, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb5:
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 15, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i4 == 1);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 16, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $sle.i32(0, $i3);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 16, 27} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 16, 7} true;
  assume {:verifier.code 0} true;
  call $i7 := __VERIFIER_assert.i32($i6);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 17, 27} true;
  assume {:verifier.code 0} true;
  $i8 := $sle.i32($i3, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 17, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  call $i10 := __VERIFIER_assert.i32($i9);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i10);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb7:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 21, 9} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i12 == 1);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 24, 26} true;
  assume {:verifier.code 0} true;
  $i13 := $sle.i32(0, $i3);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 24, 26} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
  call $i15 := __VERIFIER_assert.i32($i14);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i15);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 25, 26} true;
  assume {:verifier.code 0} true;
  $i16 := $sle.i32($i3, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 25, 26} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i32($i16);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  call $i18 := __VERIFIER_assert.i32($i17);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i18);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i3, 1);
  ...
  goto $bb5;
$bb10:
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 29, 24} true;
  assume {:verifier.code 0} true;
  $i20 := $sle.i32(0, $i3);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 29, 24} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i1.i32($i20);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 29, 4} true;
  assume {:verifier.code 0} true;
  call $i22 := __VERIFIER_assert.i32($i21);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 30, 24} true;
  assume {:verifier.code 0} true;
  $i23 := $sle.i32($i3, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 30, 24} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i32($i23);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 30, 4} true;
  assume {:verifier.code 0} true;
  call $i25 := __VERIFIER_assert.i32($i24);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i25);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 31, 4} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i32($i3, 1);
  call {:cexpr "t"} boogie_si_record_i32($i26);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $i26;
  goto $bb11;
$bb11:
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 35, 11} true;
  assume {:verifier.code 0} true;
  $i28 := $eq.i32($i27, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 35, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb12, $bb13;
$bb12:
  assume ($i28 == 1);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 36, 27} true;
  assume {:verifier.code 0} true;
  $i29 := $sle.i32(0, $i27);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 36, 27} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i1.i32($i29);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 36, 7} true;
  assume {:verifier.code 0} true;
  call $i31 := __VERIFIER_assert.i32($i30);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i31);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 37, 27} true;
  assume {:verifier.code 0} true;
  $i32 := $sle.i32($i27, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 37, 27} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i1.i32($i32);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 37, 7} true;
  assume {:verifier.code 0} true;
  call $i34 := __VERIFIER_assert.i32($i33);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i34);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 38, 7} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb13:
  assume !(($i28 == 1));
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 41, 9} true;
  assume {:verifier.code 0} true;
  call $i35 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i35);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 41, 9} true;
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i35, 0);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 41, 9} true;
...
$bb14:
  assume ($i36 == 1);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 42, 12} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume !(($i36 == 1));
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 53, 15} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i38 == 1);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 43, 23} true;
  assume {:verifier.code 0} true;
  $i40 := $sle.i32(0, $i27);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 43, 23} true;
  assume {:verifier.code 0} true;
  $i41 := $zext.i1.i32($i40);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $i42 := __VERIFIER_assert.i32($i41);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i42);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 44, 22} true;
  assume {:verifier.code 0} true;
  $i43 := $sle.i32($i27, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 44, 22} true;
  assume {:verifier.code 0} true;
  $i44 := $zext.i1.i32($i43);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 44, 2} true;
  assume {:verifier.code 0} true;
  call $i45 := __VERIFIER_assert.i32($i44);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i45);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 45, 10} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i32($i27, 1);
  call {:cexpr "t"} boogie_si_record_i32($i46);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 46, 15} true;
  assume {:verifier.code 0} true;
  $i47 := $eq.i32($i46, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 46, 13} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 52, 5} true;
  assume {:verifier.code 0} true;
  $i54 := $i39;
  goto $bb21;
$bb19:
  assume ($i47 == 1);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 47, 24} true;
  assume {:verifier.code 0} true;
  $i48 := $sle.i32(0, $i46);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 47, 24} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i1.i32($i48);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 47, 4} true;
  assume {:verifier.code 0} true;
  call $i50 := __VERIFIER_assert.i32($i49);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i50);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 48, 24} true;
  assume {:verifier.code 0} true;
  $i51 := $sle.i32($i46, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 48, 24} true;
  assume {:verifier.code 0} true;
  $i52 := $zext.i1.i32($i51);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 48, 4} true;
  assume {:verifier.code 0} true;
  call $i53 := __VERIFIER_assert.i32($i52);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i53);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 49, 11} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb20:
  assume !(($i47 == 1));
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 51, 7} true;
  assume {:verifier.code 0} true;
  $i39 := $i46;
  goto $bb18;
$bb21:
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 58, 25} true;
  assume {:verifier.code 0} true;
  $i57 := $sle.i32(0, $i54);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 58, 25} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i32($i57);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 58, 5} true;
  assume {:verifier.code 0} true;
  call $i59 := __VERIFIER_assert.i32($i58);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i59);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 59, 25} true;
  assume {:verifier.code 0} true;
  $i60 := $sle.i32($i54, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 59, 25} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i32($i60);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 59, 5} true;
  assume {:verifier.code 0} true;
  call $i62 := __VERIFIER_assert.i32($i61);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i62);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 60, 6} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i54, 1);
  call {:cexpr "t"} boogie_si_record_i32($i63);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $i63;
  goto $bb11;
$bb22:
  assume ($i56 == 1);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 54, 7} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb23:
  assume !(($i56 == 1));
  ...
  goto $bb21;
$bb24:
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 64, 23} true;
  assume {:verifier.code 0} true;
  $i64 := $sle.i32(0, $i27);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 64, 23} true;
  assume {:verifier.code 0} true;
  $i65 := $zext.i1.i32($i64);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 64, 3} true;
  assume {:verifier.code 0} true;
  call $i66 := __VERIFIER_assert.i32($i65);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i66);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 65, 23} true;
  assume {:verifier.code 0} true;
  $i67 := $sle.i32($i27, $i2);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 65, 23} true;
  assume {:verifier.code 0} true;
  $i68 := $zext.i1.i32($i67);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 65, 3} true;
  assume {:verifier.code 0} true;
  call $i69 := __VERIFIER_assert.i32($i68);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i69);
  assume {:sourceloc "./output/apache-get-tag_tmp.c", 65, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
}
