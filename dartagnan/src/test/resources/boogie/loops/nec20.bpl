...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 47465));
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/nec20_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/nec20_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/nec20_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/nec20_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/nec20_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/nec20_tmp.c", 6, 12} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 7217));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const main: ref;
axiom (main == $sub.ref(0, 8249));
procedure main()
  returns ($r: i32)
{
  var $p0: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/nec20_tmp.c", 13, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(4100, $zext.i32.i64(1)));
  assume {:sourceloc "./output/nec20_tmp.c", 13, 12} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "./output/nec20_tmp.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  call {:cexpr "k"} boogie_si_record_i8($i2);
  assume true;
  assume {:sourceloc "./output/nec20_tmp.c", 17, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "./output/nec20_tmp.c", 17, 8} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./output/nec20_tmp.c", 19, 4} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/nec20_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/nec20_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
  call $i5 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i5);
  call {:cexpr "j"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/nec20_tmp.c", 25, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $ugt.i32($i5, 10000);
  assume {:sourceloc "./output/nec20_tmp.c", 25, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "./output/nec20_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  goto $bb6;
$bb5:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/nec20_tmp.c", 28, 4} true;
  assume {:verifier.code 0} true;
  $i8, $i9 := 0, $i5;
  goto $bb7;
$bb6:
  assume {:sourceloc "./output/nec20_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/nec20_tmp.c", 44, 1} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
$bb7:
  ...
  assume {:sourceloc "./output/nec20_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/nec20_tmp.c", 28, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $ule.i32($i8, $i4);
  assume {:sourceloc "./output/nec20_tmp.c", 28, 4} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i10 == 1);
  assume {:sourceloc "./output/nec20_tmp.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i8, 1);
  call {:cexpr "i"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/nec20_tmp.c", 30, 12} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i9, 2);
  call {:cexpr "j"} boogie_si_record_i32($i12);
  assume {:sourceloc "./output/nec20_tmp.c", 28, 4} true;
  assume {:verifier.code 0} true;
  $i8, $i9 := $i11, $i12;
  goto $bb7;
$bb9:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/nec20_tmp.c", 33, 4} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/nec20_tmp.c", 33, 4} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 4100)), $mul.ref($i13, 4));
  assume {:sourceloc "./output/nec20_tmp.c", 33, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p14, 0);
  assume {:sourceloc "./output/nec20_tmp.c", 34, 23} true;
  assume {:verifier.code 1} true;
  $i15 := $ult.i32($i9, 1025);
  assume {:sourceloc "./output/nec20_tmp.c", 34, 23} true;
  assume {:verifier.code 1} true;
  $i16 := $zext.i1.i32($i15);
  assume {:sourceloc "./output/nec20_tmp.c", 34, 4} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i16);
  assume {:sourceloc "./output/nec20_tmp.c", 35, 4} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64($i9);
  assume {:sourceloc "./output/nec20_tmp.c", 35, 4} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p0, $mul.ref(0, 4100)), $mul.ref($i17, 4));
  assume {:sourceloc "./output/nec20_tmp.c", 35, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p18, 0);
  assume {:sourceloc "./output/nec20_tmp.c", 36, 6} true;
  assume {:verifier.code 0} true;
  $i19 := $M.1;
  assume {:sourceloc "./output/nec20_tmp.c", 36, 4} true;
  assume {:verifier.code 0} true;
  $i20 := $sext.i32.i64($i19);
  assume {:sourceloc "./output/nec20_tmp.c", 36, 4} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p0, $mul.ref(0, 4100)), $mul.ref($i20, 4));
  assume {:sourceloc "./output/nec20_tmp.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p21, 0);
  assume {:sourceloc "./output/nec20_tmp.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $i22 := $M.1;
  assume {:sourceloc "./output/nec20_tmp.c", 37, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $sge.i32($i22, 0);
  assume {:sourceloc "./output/nec20_tmp.c", 37, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "./output/nec20_tmp.c", 37, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $M.1;
  assume {:sourceloc "./output/nec20_tmp.c", 37, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $slt.i32($i24, 1023);
  assume {:sourceloc "./output/nec20_tmp.c", 37, 8} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/nec20_tmp.c", 40, 9} true;
  assume {:verifier.code 0} true;
  $i29 := $M.1;
  assume {:sourceloc "./output/nec20_tmp.c", 40, 10} true;
  assume {:verifier.code 0} true;
  $i30 := $srem.i32($i29, 1023);
  assume {:sourceloc "./output/nec20_tmp.c", 40, 7} true;
  assume {:verifier.code 0} true;
  $i31 := $sext.i32.i64($i30);
  assume {:sourceloc "./output/nec20_tmp.c", 40, 7} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p0, $mul.ref(0, 4100)), $mul.ref($i31, 4));
  assume {:sourceloc "./output/nec20_tmp.c", 40, 17} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i25 == 1);
  assume {:sourceloc "./output/nec20_tmp.c", 38, 9} true;
  assume {:verifier.code 0} true;
  $i26 := $M.1;
  assume {:sourceloc "./output/nec20_tmp.c", 38, 7} true;
  assume {:verifier.code 0} true;
  $i27 := $sext.i32.i64($i26);
  assume {:sourceloc "./output/nec20_tmp.c", 38, 7} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p0, $mul.ref(0, 4100)), $mul.ref($i27, 4));
  assume {:sourceloc "./output/nec20_tmp.c", 38, 11} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb12;
$bb15:
  assume {:sourceloc "./output/nec20_tmp.c", 42, 4} true;
  assume {:verifier.code 0} true;
  $i7 := 1;
  goto $bb6;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 9281));
...
axiom (__SMACK_code == $sub.ref(0, 10313));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 11345));
...
axiom (__VERIFIER_error == $sub.ref(0, 12377));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 13409));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 14441));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 15473));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 16505));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 17537));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 18569));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 19601));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 20633));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 21665));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 22697));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 23729));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 24761));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 25793));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 26825));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 27857));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 28889));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 29921));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 30953));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 31985));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 33017));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 34049));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 35081));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 36113));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 37145));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 38177));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 39209));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 40241));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 41273));
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 42305));
...
axiom (__SMACK_decls == $sub.ref(0, 43337));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 44369));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 45401));
...
axiom (llvm.dbg.value == $sub.ref(0, 46433));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 47465));
