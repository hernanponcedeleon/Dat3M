...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/bubble_sort-1-O3.bpl /Users/ponce/git/Dat3M/./output/bubble_sort-1_tmp.c
...
axiom (llvm.dbg.value == $sub.ref(0, 6195));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const q1: ref;
axiom (q1 == $sub.ref(0, 7227));
procedure  q1($i0: bv32, $p1: ref)
{
  var $i2: bv1;
  var $i3: bv32;
  var $i4: bv64;
...
$bb0:
  ...
  call {:cexpr "q1:arg:argc"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 55, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.bv32($i0, 2bv32);
...
$bb3:
  ...
  call {:cexpr "N"} boogie_si_record_bv32($i3);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 59, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv32.bv64($i3);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 59, 2} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/bubble_sort-1_tmp.c:59:2: warning: over-approximating unmodeled operation llvm.stacksave;
  call $p5 := llvm.stacksave();
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 59, 2} true;
  assume {:verifier.code 0} true;
  call $p6 := $alloc($mul.ref(4, $bv2int.64($i4)));
  assume true;
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $sgt.bv32($i3, 0bv32);
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  $i8 := $add.bv64($i4, $sub.bv64(0bv64, 1bv64));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $i9 := $and.bv64($i4, 7bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.bv64($i8, 7bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $i11 := 0bv64;
...
$bb6:
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 86, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/bubble_sort-1_tmp.c:86:1: warning: unsoundly ignoring unmodeled operation llvm.stackrestore;
...
$bb10:
  ...
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p6, $mul.ref($bv2int.64($i13), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.bv64.bv32($i13);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p24, $i25);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $or.bv64($i13, 1bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p6, $mul.ref($bv2int.64($i26), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.bv64.bv32($i26);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p27, $i28);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i29 := $or.bv64($i13, 2bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p6, $mul.ref($bv2int.64($i29), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.bv64.bv32($i29);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p30, $i31);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i32 := $or.bv64($i13, 3bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p6, $mul.ref($bv2int.64($i32), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.bv64.bv32($i32);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p33, $i34);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $or.bv64($i13, 4bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p6, $mul.ref($bv2int.64($i35), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.bv64.bv32($i35);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p36, $i37);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $or.bv64($i13, 5bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($p6, $mul.ref($bv2int.64($i38), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.bv64.bv32($i38);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p39, $i40);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i41 := $or.bv64($i13, 6bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($p6, $mul.ref($bv2int.64($i41), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i43 := $trunc.bv64.bv32($i41);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p42, $i43);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i44 := $or.bv64($i13, 7bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p6, $mul.ref($bv2int.64($i44), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.bv64.bv32($i44);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p45, $i46);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $add.bv64($i13, 8bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 4} true;
  assume {:verifier.code 0} true;
  $i48 := $add.bv64($i14, $sub.bv64(0bv64, 8bv64));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 4} true;
  assume {:verifier.code 0} true;
  $i49 := $eq.bv64($i48, 0bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 4} true;
  assume {:verifier.code 0} true;
  $i11 := $i47;
...
$bb14:
  ...
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 25} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p6, $mul.ref($bv2int.64($i16), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.bv64.bv32($i16);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p18, $i19);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 20} true;
  assume {:verifier.code 0} true;
  $i20 := $add.bv64($i16, 1bv64);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 4} true;
  assume {:verifier.code 0} true;
  $i21 := $add.bv64($i17, $sub.bv64(0bv64, 1bv64));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 73, 4} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $p71 := $add.ref($p6, $mul.ref($bv2int.64($i67), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i72 := $load.bv32($M.0, $p71);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 24, 23} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($p6, $mul.ref($bv2int.64($i66), 4));
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 24, 23} true;
  assume {:verifier.code 0} true;
  $i74 := $load.bv32($M.0, $p73);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 24, 21} true;
  assume {:verifier.code 0} true;
  $i75 := $sgt.bv32($i72, $i74);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.stacksave == $sub.ref(0, 8259));
...
procedure {:entrypoint} main($i0: bv32, $p1: ref)
  returns ($r: bv32)
{
$bb0:
  call $initialize();
  ...
  call {:cexpr "smack:arg:main:$i0"} boogie_si_record_bv32($i0);
  call {:cexpr "smack:arg:main:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "main:arg:argc"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/bubble_sort-1_tmp.c", 90, 2} true;
  assume {:verifier.code 0} true;
  call q1($i0, $u0);
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 45411));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 46443));
