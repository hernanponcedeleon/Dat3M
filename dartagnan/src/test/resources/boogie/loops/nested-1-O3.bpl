...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/nested-1-O3.bpl /Users/ponce/git/Dat3M/./output/nested-1_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/nested-1_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/nested-1_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/nested-1_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i1);
  call {:cexpr "m"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/nested-1_tmp.c", 19, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $add.bv32($i0, $sub.bv32(0bv32, 10bv32));
  assume {:sourceloc "./output/nested-1_tmp.c", 19, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv32($i2, 9991bv32);
  assume {:sourceloc "./output/nested-1_tmp.c", 20, 19} true;
  assume {:verifier.code 0} true;
  $i4 := $add.bv32($i1, $sub.bv32(0bv32, 10bv32));
  assume {:sourceloc "./output/nested-1_tmp.c", 20, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.bv32($i4, 9991bv32);
  assume {:sourceloc "./output/nested-1_tmp.c", 19, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $and.bv1($i3, $i5);
  assume {:sourceloc "./output/nested-1_tmp.c", 22, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.bv32($i1, $i0);
  assume {:sourceloc "./output/nested-1_tmp.c", 26, 25} true;
  assume {:verifier.code 0} true;
  $i8 := $slt.bv32($i7, 100bv32);
  assume {:sourceloc "./output/nested-1_tmp.c", 19, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $and.bv1($i6, $i8);
  assume {:sourceloc "./output/nested-1_tmp.c", 19, 19} true;
...
$bb1:
  assume ($i9 == 1bv1);
  assume {:sourceloc "./output/nested-1_tmp.c", 9, 11} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/nested-1_tmp.c", 9, 25} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/nested-1_tmp.c", 9, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i9 == 1bv1));
  assume {:sourceloc "./output/nested-1_tmp.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
