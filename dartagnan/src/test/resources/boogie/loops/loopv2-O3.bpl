...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/loopv2-O3.bpl /Users/ponce/git/Dat3M/./output/loopv2_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/loopv2_tmp.c", 18, 7} true;
  ...
  assume {:sourceloc "./output/loopv2_tmp.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, SIZE);
  assume {:sourceloc "./output/loopv2_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.bv32($i0, $i1);
  assume {:sourceloc "./output/loopv2_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/loopv2_tmp.c", 33, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/loopv2_tmp.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
