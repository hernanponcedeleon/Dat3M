...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum03-1-O3.bpl /Users/ponce/git/Dat3M/./output/sum03-1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum03-1_tmp.c", 12, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum03-1_tmp.c", 12, 51} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum03-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0bv32, 0bv32;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "./output/sum03-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum03-1_tmp.c", 15, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.bv32($i3, 10bv32);
  assume {:sourceloc "./output/sum03-1_tmp.c", 16, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $add.bv32($i2, 2bv32);
  assume {:sourceloc "./output/sum03-1_tmp.c", 15, 11} true;
  assume {:verifier.code 0} true;
  $i6 := (if ($i4 == 1bv1) then $i5 else $i2);
  call {:cexpr "sn"} boogie_si_record_bv32($i6);
  assume {:sourceloc "./output/sum03-1_tmp.c", 18, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $add.bv32($i3, 1bv32);
  call {:cexpr "x"} boogie_si_record_bv32($i7);
  assume {:sourceloc "./output/sum03-1_tmp.c", 19, 30} true;
  assume {:verifier.code 0} true;
  $i8 := $shl.bv32($i7, 1bv32);
  assume {:sourceloc "./output/sum03-1_tmp.c", 19, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.bv32($i6, $i8);
  assume {:sourceloc "./output/sum03-1_tmp.c", 19, 35} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.bv32($i6, 0bv32);
...
$bb2:
  assume ($i11 == 1bv1);
  assume {:sourceloc "./output/sum03-1_tmp.c", 5, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sum03-1_tmp.c", 5, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sum03-1_tmp.c", 5, 27} true;
  assume {:verifier.code 0} true;
