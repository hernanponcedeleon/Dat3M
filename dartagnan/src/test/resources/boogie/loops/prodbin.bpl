...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/prodbin_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/prodbin_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/prodbin_tmp.c", 8, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/prodbin_tmp.c", 9, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/prodbin_tmp.c", 8, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/prodbin_tmp.c", 8, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/prodbin_tmp.c", 11, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/prodbin_tmp.c", 11, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/prodbin_tmp.c", 11, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/prodbin_tmp.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/prodbin_tmp.c", 11, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/prodbin_tmp.c", 13, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/prodbin_tmp.c", 22, 9} true;
  ...
  assume {:sourceloc "./output/prodbin_tmp.c", 23, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/prodbin_tmp.c", 24, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $sge.i32($i3, 1);
  assume {:sourceloc "./output/prodbin_tmp.c", 24, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/prodbin_tmp.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/prodbin_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $i6, $i7, $i8 := $i1, $i3, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/prodbin_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prodbin_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prodbin_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prodbin_tmp.c", 31, 33} true;
  assume {:verifier.code 1} true;
  $i9 := $mul.i32($i6, $i7);
  assume {:sourceloc "./output/prodbin_tmp.c", 31, 29} true;
  assume {:verifier.code 1} true;
  $i10 := $add.i32($i8, $i9);
  assume {:sourceloc "./output/prodbin_tmp.c", 31, 42} true;
  assume {:verifier.code 1} true;
  $i11 := $mul.i32($i1, $i3);
  assume {:sourceloc "./output/prodbin_tmp.c", 31, 37} true;
  assume {:verifier.code 1} true;
  $i12 := $eq.i32($i10, $i11);
  assume {:sourceloc "./output/prodbin_tmp.c", 31, 37} true;
  assume {:verifier.code 1} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "./output/prodbin_tmp.c", 31, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i13);
  assume {:sourceloc "./output/prodbin_tmp.c", 32, 17} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i7, 0);
  assume {:sourceloc "./output/prodbin_tmp.c", 32, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i14 == 1);
  assume {:sourceloc "./output/prodbin_tmp.c", 35, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $srem.i32($i7, 2);
  assume {:sourceloc "./output/prodbin_tmp.c", 35, 19} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i15, 1);
  assume {:sourceloc "./output/prodbin_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  $i17, $i18 := $i7, $i8;
...
$bb3:
  assume !(($i14 == 1));
  assume {:sourceloc "./output/prodbin_tmp.c", 33, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/prodbin_tmp.c", 42, 30} true;
  assume {:verifier.code 1} true;
  $i23 := $mul.i32($i1, $i3);
  assume {:sourceloc "./output/prodbin_tmp.c", 42, 25} true;
  assume {:verifier.code 1} true;
  $i24 := $eq.i32($i8, $i23);
  assume {:sourceloc "./output/prodbin_tmp.c", 42, 25} true;
  assume {:verifier.code 1} true;
  $i25 := $zext.i1.i32($i24);
  assume {:sourceloc "./output/prodbin_tmp.c", 42, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i25);
  assume {:sourceloc "./output/prodbin_tmp.c", 44, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb5:
  assume ($i16 == 1);
  assume {:sourceloc "./output/prodbin_tmp.c", 36, 19} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i8, $i6);
  call {:cexpr "z"} boogie_si_record_i32($i19);
  assume {:sourceloc "./output/prodbin_tmp.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $sub.i32($i7, 1);
  call {:cexpr "y"} boogie_si_record_i32($i20);
  assume {:sourceloc "./output/prodbin_tmp.c", 38, 9} true;
  assume {:verifier.code 0} true;
  $i17, $i18 := $i20, $i19;
  goto $bb7;
$bb6:
...
$bb7:
  ...
  assume {:sourceloc "./output/prodbin_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/prodbin_tmp.c", 39, 15} true;
  assume {:verifier.code 0} true;
  $i21 := $mul.i32(2, $i6);
  call {:cexpr "x"} boogie_si_record_i32($i21);
  assume {:sourceloc "./output/prodbin_tmp.c", 40, 15} true;
  assume {:verifier.code 0} true;
  $i22 := $sdiv.i32($i17, 2);
  call {:cexpr "y"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/prodbin_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $i6, $i7, $i8 := $i21, $i22, $i18;
  goto $bb1;
}
