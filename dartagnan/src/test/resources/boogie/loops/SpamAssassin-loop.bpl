...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 10, 15} true;
  ...
  call {:cexpr "bufsize"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 11, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 11, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 11, 22} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 12, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 13, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32($i0, 4);
  call {:cexpr "limit"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 51, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 16, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 16, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, $i2);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 16, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 17, 14} true;
  assume {:verifier.code 0} true;
  $i6, $i7 := $i4, 0;
  goto $bb7;
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 50, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 17, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $slt.i32($i6, $i2);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 17, 29} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
...
$bb8:
  assume ($i8 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 17, 34} true;
  assume {:verifier.code 0} true;
  $i10 := $slt.i32($i7, $i3);
  assume {:verifier.code 0} true;
  $i9 := $i10;
...
$bb10:
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 17, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb11, $bb12;
$bb11:
  assume ($i9 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 18, 19} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i6, 1);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 18, 23} true;
  assume {:verifier.code 0} true;
  $i12 := $slt.i32($i11, $i2);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i12 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 19, 36} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i6, 1);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 19, 38} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.i32($i13, $i2);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 19, 38} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i1.i32($i14);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 19, 17} true;
  assume {:verifier.code 0} true;
  call $i16 := __VERIFIER_assert.i32($i15);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i16);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 20, 36} true;
  assume {:verifier.code 0} true;
  $i17 := $sle.i32(0, $i6);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 20, 36} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i1.i32($i17);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 20, 17} true;
  assume {:verifier.code 0} true;
  call $i19 := __VERIFIER_assert.i32($i18);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i19);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 21, 21} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 39, 20} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb15:
  assume ($i21 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 21, 47} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i21 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 22, 36} true;
  assume {:verifier.code 0} true;
  $i22 := $slt.i32($i6, $i2);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 22, 36} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 22, 17} true;
  assume {:verifier.code 0} true;
  call $i24 := __VERIFIER_assert.i32($i23);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 23, 36} true;
  assume {:verifier.code 0} true;
  $i25 := $sle.i32(0, $i6);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 23, 36} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i32($i25);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 23, 17} true;
  assume {:verifier.code 0} true;
  call $i27 := __VERIFIER_assert.i32($i26);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i27);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 24, 36} true;
  assume {:verifier.code 0} true;
  $i28 := $slt.i32($i7, $i0);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 24, 36} true;
  assume {:verifier.code 0} true;
  $i29 := $zext.i1.i32($i28);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 24, 17} true;
  assume {:verifier.code 0} true;
  call $i30 := __VERIFIER_assert.i32($i29);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i30);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 25, 36} true;
  assume {:verifier.code 0} true;
  $i31 := $sle.i32(0, $i7);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 25, 36} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i32($i31);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 25, 17} true;
  assume {:verifier.code 0} true;
  call $i33 := __VERIFIER_assert.i32($i32);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 27, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $add.i32($i7, 1);
  call {:cexpr "j"} boogie_si_record_i32($i34);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 28, 18} true;
  assume {:verifier.code 0} true;
  $i35 := $add.i32($i6, 1);
  call {:cexpr "i"} boogie_si_record_i32($i35);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 29, 36} true;
  assume {:verifier.code 0} true;
  $i36 := $slt.i32($i35, $i2);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 29, 36} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i32($i36);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 29, 17} true;
  assume {:verifier.code 0} true;
  call $i38 := __VERIFIER_assert.i32($i37);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i38);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 30, 36} true;
  assume {:verifier.code 0} true;
  $i39 := $sle.i32(0, $i35);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 30, 36} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i1.i32($i39);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 30, 17} true;
  assume {:verifier.code 0} true;
  call $i41 := __VERIFIER_assert.i32($i40);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i41);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 31, 36} true;
  assume {:verifier.code 0} true;
  $i42 := $slt.i32($i34, $i0);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 31, 36} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i1.i32($i42);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 31, 17} true;
  assume {:verifier.code 0} true;
  call $i44 := __VERIFIER_assert.i32($i43);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i44);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 32, 36} true;
  assume {:verifier.code 0} true;
  $i45 := $sle.i32(0, $i34);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 32, 36} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i32($i45);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 32, 17} true;
  assume {:verifier.code 0} true;
  call $i47 := __VERIFIER_assert.i32($i46);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i47);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 34, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $add.i32($i34, 1);
  call {:cexpr "j"} boogie_si_record_i32($i48);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 35, 18} true;
  assume {:verifier.code 0} true;
  $i49 := $add.i32($i35, 1);
  call {:cexpr "i"} boogie_si_record_i32($i49);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 36, 36} true;
  assume {:verifier.code 0} true;
  $i50 := $slt.i32($i48, $i0);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 36, 36} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.i1.i32($i50);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 36, 17} true;
  assume {:verifier.code 0} true;
  call $i52 := __VERIFIER_assert.i32($i51);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i52);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 37, 36} true;
  assume {:verifier.code 0} true;
  $i53 := $sle.i32(0, $i48);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 37, 36} true;
  assume {:verifier.code 0} true;
  $i54 := $zext.i1.i32($i53);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 37, 17} true;
  assume {:verifier.code 0} true;
  call $i55 := __VERIFIER_assert.i32($i54);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i55);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 38, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $add.i32($i48, 1);
  call {:cexpr "j"} boogie_si_record_i32($i56);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 39, 13} true;
  assume {:verifier.code 0} true;
  $i57, $i58 := $i49, $i56;
  goto $bb18;
$bb17:
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 41, 36} true;
  assume {:verifier.code 0} true;
  $i59 := $slt.i32($i6, $i2);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 41, 36} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i32($i59);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 41, 17} true;
  assume {:verifier.code 0} true;
  call $i61 := __VERIFIER_assert.i32($i60);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i61);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 42, 36} true;
  assume {:verifier.code 0} true;
  $i62 := $sle.i32(0, $i6);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 42, 36} true;
  assume {:verifier.code 0} true;
  $i63 := $zext.i1.i32($i62);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 42, 17} true;
  assume {:verifier.code 0} true;
  call $i64 := __VERIFIER_assert.i32($i63);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i64);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 43, 36} true;
  assume {:verifier.code 0} true;
  $i65 := $slt.i32($i7, $i0);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 43, 36} true;
  assume {:verifier.code 0} true;
  $i66 := $zext.i1.i32($i65);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 43, 17} true;
  assume {:verifier.code 0} true;
  call $i67 := __VERIFIER_assert.i32($i66);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i67);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 44, 36} true;
  assume {:verifier.code 0} true;
  $i68 := $sle.i32(0, $i7);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 44, 36} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i1.i32($i68);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 44, 17} true;
  assume {:verifier.code 0} true;
  call $i70 := __VERIFIER_assert.i32($i69);
  call {:cexpr "smack:ext:__VERIFIER_assert"} boogie_si_record_i32($i70);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 45, 18} true;
  assume {:verifier.code 0} true;
  $i71 := $add.i32($i7, 1);
  call {:cexpr "j"} boogie_si_record_i32($i71);
  assume {:sourceloc "./output/SpamAssassin-loop_tmp.c", 46, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $add.i32($i6, 1);
