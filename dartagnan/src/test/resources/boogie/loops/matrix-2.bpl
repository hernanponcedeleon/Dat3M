...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/matrix-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/matrix-2_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/matrix-2_tmp.c", 14, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 17, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 20, 7} true;
  assume {:verifier.code 0} true;
  $i8, $i9 := 0, $i7;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 19, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i32($i8, $i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i11, $i12 := 0, $i9;
  goto $bb4;
$bb3:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 29, 7} true;
  assume {:verifier.code 0} true;
  $i39 := 0;
  goto $bb12;
$bb4:
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $ult.i32($i11, $i0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 21, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i13 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 23, 23} true;
  assume {:verifier.code 0} true;
  call $i14 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/matrix-2_tmp.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/matrix-2_tmp.c", 23, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 23, 21} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p20, $i14);
  assume {:sourceloc "./output/matrix-2_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/matrix-2_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 25, 23} true;
  assume {:verifier.code 0} true;
  $i28 := $sgt.i32($i27, $i12);
  assume {:sourceloc "./output/matrix-2_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb7:
  assume ($i28 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 19} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 19} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/matrix-2_tmp.c", 21, 22} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i32($i11, 1);
  ...
  goto $bb4;
$bb11:
  assume {:sourceloc "./output/matrix-2_tmp.c", 20, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i32($i8, 1);
...
$bb12:
  assume {:sourceloc "./output/matrix-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 29, 12} true;
  assume {:verifier.code 0} true;
  $i40 := $ult.i32($i39, $i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 29, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb13, $bb14;
$bb13:
  assume ($i40 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 30, 9} true;
  assume {:verifier.code 0} true;
  $i41 := 0;
  goto $bb15;
$bb14:
  assume !(($i40 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 1} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume {:sourceloc "./output/matrix-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 30, 14} true;
  assume {:verifier.code 0} true;
  $i42 := $ult.i32($i41, $i0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i42 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 25} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 37} true;
  assume {:verifier.code 1} true;
  $i50 := $slt.i32($i49, $i9);
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 37} true;
  assume {:verifier.code 1} true;
  $i51 := $zext.i1.i32($i50);
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 7} true;
  assume {:verifier.code 1} true;
...
$bb17:
  assume !(($i42 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 43} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume {:sourceloc "./output/matrix-2_tmp.c", 30, 22} true;
  assume {:verifier.code 0} true;
  $i52 := $add.i32($i41, 1);
  ...
  goto $bb15;
$bb19:
  assume {:sourceloc "./output/matrix-2_tmp.c", 29, 20} true;
  assume {:verifier.code 0} true;
  $i53 := $add.i32($i39, 1);
