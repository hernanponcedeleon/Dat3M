...
{
$bb0:
  assume {:sourceloc "./output/matrix-2_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/matrix-2_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/matrix-2_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/matrix-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/matrix-2_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/matrix-2_tmp.c", 15, 22} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "N_LIN"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 16, 22} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i1);
  call {:cexpr "N_COL"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call $p6 := $alloc($mul.ref(4, $i5));
  assume true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  call $i7 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i7);
  call {:cexpr "maior"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/matrix-2_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i8, $i9 := 0, $i7;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/matrix-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i32($i8, $i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i11, $i12 := 0, $i9;
  goto $bb4;
$bb3:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 30, 7} true;
  assume {:verifier.code 0} true;
  $i39 := 0;
  goto $bb12;
$bb4:
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $ult.i32($i11, $i0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 22, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i13 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 24, 23} true;
  assume {:verifier.code 0} true;
  call $i14 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/matrix-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/matrix-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p6, $mul.ref($i16, 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i32.i64($i11);
  $i19 := $add.i64($i16, $i18);
  assume {:sourceloc "./output/matrix-2_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p6, $mul.ref($i19, 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 24, 21} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p20, $i14);
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p6, $mul.ref($i22, 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i32.i64($i11);
  $i25 := $add.i64($i22, $i24);
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p6, $mul.ref($i25, 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.1, $p26);
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 23} true;
  assume {:verifier.code 0} true;
  $i28 := $sgt.i32($i27, $i12);
  assume {:sourceloc "./output/matrix-2_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb7:
  assume ($i28 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 27, 19} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/matrix-2_tmp.c", 27, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 27, 19} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p6, $mul.ref($i31, 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 27, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i32.i64($i11);
  $i34 := $add.i64($i31, $i33);
  assume {:sourceloc "./output/matrix-2_tmp.c", 27, 19} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p6, $mul.ref($i34, 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 27, 19} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i32($M.1, $p35);
  call {:cexpr "maior"} boogie_si_record_i32($i36);
  assume {:sourceloc "./output/matrix-2_tmp.c", 27, 11} true;
  assume {:verifier.code 0} true;
  $i29 := $i36;
  goto $bb9;
$bb8:
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/matrix-2_tmp.c", 22, 22} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i32($i11, 1);
  call {:cexpr "k"} boogie_si_record_i32($i37);
  assume {:sourceloc "./output/matrix-2_tmp.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $i11, $i12 := $i37, $i29;
  goto $bb4;
$bb11:
  assume {:sourceloc "./output/matrix-2_tmp.c", 21, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i32($i8, 1);
...
$bb12:
  assume {:sourceloc "./output/matrix-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 30, 12} true;
  assume {:verifier.code 0} true;
  $i40 := $ult.i32($i39, $i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 30, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb13, $bb14;
$bb13:
  assume ($i40 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 9} true;
  assume {:verifier.code 0} true;
  $i41 := 0;
  goto $bb15;
$bb14:
  assume !(($i40 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 33, 1} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume {:sourceloc "./output/matrix-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 14} true;
  assume {:verifier.code 0} true;
  $i42 := $ult.i32($i41, $i0);
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i42 == 1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 25} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 25} true;
  assume {:verifier.code 1} true;
  $p45 := $add.ref($p6, $mul.ref($i44, 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 25} true;
  assume {:verifier.code 1} true;
  $i46 := $zext.i32.i64($i41);
  $i47 := $add.i64($i44, $i46);
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 25} true;
  assume {:verifier.code 1} true;
  $p48 := $add.ref($p6, $mul.ref($i47, 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 25} true;
  assume {:verifier.code 1} true;
  $i49 := $load.i32($M.1, $p48);
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 37} true;
  assume {:verifier.code 1} true;
  $i50 := $slt.i32($i49, $i9);
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 37} true;
  assume {:verifier.code 1} true;
  $i51 := $zext.i1.i32($i50);
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 7} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i51);
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 7} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb17:
  assume !(($i42 == 1));
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 43} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 22} true;
  assume {:verifier.code 0} true;
  $i52 := $add.i32($i41, 1);
  call {:cexpr "k"} boogie_si_record_i32($i52);
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i41 := $i52;
  goto $bb15;
$bb19:
  assume {:sourceloc "./output/matrix-2_tmp.c", 30, 20} true;
  assume {:verifier.code 0} true;
  $i53 := $add.i32($i39, 1);
