...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/aiob_3-O3.bpl /Users/ponce/git/Dat3M/./output/aiob_3_tmp.c
...
procedure  Id_MCDC_95($p0: ref)
{
  ...
  var $i41: bv32;
$bb0:
  assume {:sourceloc "./output/aiob_3_tmp.c", 145, 82} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/aiob_3_tmp.c", 145, 82} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, Id_MCDC_99, 0bv32);
  call {:cexpr "Id_MCDC_99"} boogie_si_record_bv32(0bv32);
  assume {:sourceloc "./output/aiob_3_tmp.c", 129, 11} true;
  ...
  assume {:sourceloc "./output/aiob_3_tmp.c", 148, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/aiob_3_tmp.c", 173, 1} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/aiob_3_tmp.c", 173, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/aiob_3_tmp.c:173:1: warning: unsoundly ignoring unmodeled operation llvm.lifetime.start.p0i8;
  call llvm.lifetime.start.p0i8(328bv64, $p1);
  assume {:sourceloc "./output/aiob_3_tmp.c", 176, 15} true;
  assume {:verifier.code 0} true;
  call $p2 := fopen(.str.1, .str.2);
  assume {:sourceloc "./output/aiob_3_tmp.c", 177, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.ref($p2, $0.ref);
  assume {:sourceloc "./output/aiob_3_tmp.c", 177, 4} true;
  assume {:verifier.code 0} true;
  $i4 := 1bv32;
...
$bb2:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/aiob_3_tmp.c", 183, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/aiob_3_tmp.c:183:1: warning: unsoundly ignoring unmodeled operation llvm.lifetime.end.p0i8;
...
$bb3:
  assume !(($i3 == 1bv1));
  assume {:sourceloc "./output/aiob_3_tmp.c", 182, 1} true;
  assume {:verifier.code 0} true;
  call Id_MCDC_95($p0);
  assume {:sourceloc "./output/aiob_3_tmp.c", 183, 1} true;
  assume {:verifier.code 0} true;
