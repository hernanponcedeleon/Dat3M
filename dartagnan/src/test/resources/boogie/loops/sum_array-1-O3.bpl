...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum_array-1-O3.bpl /Users/ponce/git/Dat3M/./output/sum_array-1_tmp.c
...
$bb0:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_bv32($i0);
  call {:cexpr "M"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.bv32.bv64($i0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(4, $bv2int.64($i1)));
  assume true;
  assume {:sourceloc "./output/sum_array-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(4, $bv2int.64($i1)));
  assume true;
  assume {:sourceloc "./output/sum_array-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(4, $bv2int.64($i1)));
  assume true;
...
$bb12:
  ...
  assume {:verifier.code 0} true;
  $i12 := $add.bv64($i1, $sub.bv64(0bv64, 1bv64));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $and.bv64($i1, 3bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $ult.bv64($i12, 3bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i15 := 0bv64;
...
$bb16:
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p2, $mul.ref($bv2int.64($i17), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i37 := $load.bv32($M.0, $p36);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p3, $mul.ref($bv2int.64($i17), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $i39 := $load.bv32($M.0, $p38);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i40 := $add.bv32($i39, $i37);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p4, $mul.ref($bv2int.64($i17), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p41, $i40);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 16} true;
  assume {:verifier.code 0} true;
  $i42 := $or.bv64($i17, 1bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($p2, $mul.ref($bv2int.64($i42), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i44 := $load.bv32($M.0, $p43);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p3, $mul.ref($bv2int.64($i42), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $i46 := $load.bv32($M.0, $p45);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i47 := $add.bv32($i46, $i44);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($p4, $mul.ref($bv2int.64($i42), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p48, $i47);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 16} true;
  assume {:verifier.code 0} true;
  $i49 := $or.bv64($i17, 2bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $p50 := $add.ref($p2, $mul.ref($bv2int.64($i49), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i51 := $load.bv32($M.0, $p50);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($p3, $mul.ref($bv2int.64($i49), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $i53 := $load.bv32($M.0, $p52);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i54 := $add.bv32($i53, $i51);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($p4, $mul.ref($bv2int.64($i49), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p55, $i54);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 16} true;
  assume {:verifier.code 0} true;
  $i56 := $or.bv64($i17, 3bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($p2, $mul.ref($bv2int.64($i56), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i58 := $load.bv32($M.0, $p57);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($p3, $mul.ref($bv2int.64($i56), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $i60 := $load.bv32($M.0, $p59);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i61 := $add.bv32($i60, $i58);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $p62 := $add.ref($p4, $mul.ref($bv2int.64($i56), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p62, $i61);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 16} true;
  assume {:verifier.code 0} true;
  $i63 := $add.bv64($i17, 4bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i64 := $add.bv64($i18, $sub.bv64(0bv64, 4bv64));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i65 := $eq.bv64($i64, 0bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i15 := $i63;
...
$bb21:
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p2, $mul.ref($bv2int.64($i24), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i27 := $load.bv32($M.0, $p26);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($p3, $mul.ref($bv2int.64($i24), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $i29 := $load.bv32($M.0, $p28);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i30 := $add.bv32($i29, $i27);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($p4, $mul.ref($bv2int.64($i24), 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p31, $i30);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 16} true;
  assume {:verifier.code 0} true;
  $i32 := $add.bv64($i24, 1bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i33 := $add.bv64($i25, $sub.bv64(0bv64, 1bv64));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i34 := $eq.bv64($i33, 0bv64);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 41283));
