...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/jm2006-O3.bpl /Users/ponce/git/Dat3M/./output/jm2006_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/jm2006_tmp.c", 16, 9} true;
  ...
  assume {:sourceloc "./output/jm2006_tmp.c", 17, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/jm2006_tmp.c", 29, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
