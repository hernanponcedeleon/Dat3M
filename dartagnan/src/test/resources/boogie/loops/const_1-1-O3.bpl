...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/const_1-1-O3.bpl /Users/ponce/git/Dat3M/./output/const_1-1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/const_1-1_tmp.c", 15, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/const_1-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/const_1-1_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $i1 := $add.bv32($i0, 1bv32);
  call {:cexpr "y"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/const_1-1_tmp.c", 15, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.bv32($i1, 1025bv32);
  assume {:sourceloc "./output/const_1-1_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/const_1-1_tmp.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
