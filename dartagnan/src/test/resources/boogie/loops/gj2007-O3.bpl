...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/gj2007-O3.bpl /Users/ponce/git/Dat3M/./output/gj2007_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/gj2007_tmp.c", 26, 5} true;
