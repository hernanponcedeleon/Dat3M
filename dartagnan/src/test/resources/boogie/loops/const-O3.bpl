...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/const-O3.bpl /Users/ponce/git/Dat3M/./output/const_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/const_tmp.c", 12, 10} true;
  ...
  assume {:sourceloc "./output/const_tmp.c", 12, 3} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/const_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/const_tmp.c", 16, 9} true;
  assume {:verifier.code 1} true;
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 37155));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 41283));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 42315));
