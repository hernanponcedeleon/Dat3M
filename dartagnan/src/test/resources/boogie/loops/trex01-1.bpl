...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/trex01-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/trex01-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/trex01-1_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex01-1_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
procedure f($i0: i32)
{
  ...
  var $i25: i32;
$bb0:
  assume {:sourceloc "./output/trex01-1_tmp.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "f:arg:d"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/trex01-1_tmp.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i1);
  call {:cexpr "x"} boogie_si_record_i32($i1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 13, 40} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 13, 69} true;
  assume {:verifier.code 0} true;
  call $i3 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i3);
  call {:cexpr "k"} boogie_si_record_i32($i3);
  assume {:sourceloc "./output/trex01-1_tmp.c", 14, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $sle.i32($i3, 1073741823);
  assume {:sourceloc "./output/trex01-1_tmp.c", 14, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 14, 24} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 15, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex01-1_tmp.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/trex01-1_tmp.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i5 := 1;
  goto $bb5;
$bb5:
  assume {:sourceloc "./output/trex01-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex01-1_tmp.c", 17, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $slt.i32($i5, $i3);
  assume {:sourceloc "./output/trex01-1_tmp.c", 17, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i6 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 17, 25} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i32(2, $i5);
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 18, 22} true;
  assume {:verifier.code 1} true;
  $i8 := $sge.i32($i5, 2);
  assume {:sourceloc "./output/trex01-1_tmp.c", 18, 22} true;
  assume {:verifier.code 1} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/trex01-1_tmp.c", 18, 3} true;
  assume {:verifier.code 1} true;
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/trex01-1_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i10, $i11, $i12 := $i2, $i1, $i5;
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/trex01-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex01-1_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i13 := $sgt.i32($i11, 0);
  assume {:sourceloc "./output/trex01-1_tmp.c", 20, 16} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb10:
  assume ($i13 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 20, 21} true;
  assume {:verifier.code 0} true;
  $i15 := $sgt.i32($i10, 0);
  assume {:verifier.code 0} true;
  $i14 := $i15;
...
$bb13:
  assume ($i14 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 15} true;
  assume {:verifier.code 0} true;
  call $i16 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i16);
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  call {:cexpr "c"} boogie_si_record_i8($i17);
  assume {:sourceloc "./output/trex01-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $trunc.i8.i1($i17);
  assume {:sourceloc "./output/trex01-1_tmp.c", 22, 9} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i18 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i18 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 28, 13} true;
  assume {:verifier.code 0} true;
  $i26 := $sub.i32($i10, $i0);
  call {:cexpr "y"} boogie_si_record_i32($i26);
  assume {:verifier.code 0} true;
  $i23, $i24, $i25 := $i26, $i11, $i12;
  goto $bb18;
$bb17:
  assume {:sourceloc "./output/trex01-1_tmp.c", 24, 13} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i32($i11, $i0);
  call {:cexpr "x"} boogie_si_record_i32($i19);
  assume {:sourceloc "./output/trex01-1_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
  call $i20 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i20);
  assume {:sourceloc "./output/trex01-1_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i1.i32($i20);
  call {:cexpr "y"} boogie_si_record_i32($i21);
  assume {:sourceloc "./output/trex01-1_tmp.c", 26, 13} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i32($i12, 1);
  call {:cexpr "z"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/trex01-1_tmp.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $i23, $i24, $i25 := $i21, $i19, $i22;
  goto $bb18;
$bb18:
  assume {:sourceloc "./output/trex01-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/trex01-1_tmp.c", 34, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 34, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i1.i8($i0);
  call {:cexpr "c"} boogie_si_record_i8($i1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 35, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 36, 5} true;
  assume {:verifier.code 0} true;
  call f(1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 38, 5} true;
  assume {:verifier.code 0} true;
  call f(2);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex01-1_tmp.c", 41, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 9285));
...
axiom (__VERIFIER_error == $sub.ref(0, 11349));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 12381));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 13413));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 14445));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 15477));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 16509));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 17541));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 18573));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 19605));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 20637));
