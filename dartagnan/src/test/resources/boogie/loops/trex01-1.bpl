...
{
$bb0:
  assume {:sourceloc "./output/trex01-1_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/trex01-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/trex01-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/trex01-1_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex01-1_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/trex01-1_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/trex01-1_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 14, 40} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 14, 69} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 15, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $sle.i32($i3, 1073741823);
  assume {:sourceloc "./output/trex01-1_tmp.c", 15, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 15, 24} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 16, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex01-1_tmp.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex01-1_tmp.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $slt.i32($i5, $i3);
  assume {:sourceloc "./output/trex01-1_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i6 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 18, 25} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i32(2, $i5);
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 19, 22} true;
  assume {:verifier.code 1} true;
  $i8 := $sge.i32($i5, 2);
  assume {:sourceloc "./output/trex01-1_tmp.c", 19, 22} true;
  assume {:verifier.code 1} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "./output/trex01-1_tmp.c", 19, 3} true;
  assume {:verifier.code 1} true;
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $i13 := $sgt.i32($i11, 0);
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb10:
  assume ($i13 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 21, 21} true;
  assume {:verifier.code 0} true;
  $i15 := $sgt.i32($i10, 0);
  assume {:verifier.code 0} true;
  $i14 := $i15;
...
$bb13:
  assume ($i14 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 22, 15} true;
  assume {:verifier.code 0} true;
  call $i16 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i16);
  assume {:sourceloc "./output/trex01-1_tmp.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  call {:cexpr "c"} boogie_si_record_i8($i17);
  assume {:sourceloc "./output/trex01-1_tmp.c", 23, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $trunc.i8.i1($i17);
  assume {:sourceloc "./output/trex01-1_tmp.c", 23, 9} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i18 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 23, 12} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i18 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 29, 13} true;
  assume {:verifier.code 0} true;
  $i26 := $sub.i32($i10, $i0);
  ...
  goto $bb18;
$bb17:
  assume {:sourceloc "./output/trex01-1_tmp.c", 25, 13} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i32($i11, $i0);
  call {:cexpr "x"} boogie_si_record_i32($i19);
  assume {:sourceloc "./output/trex01-1_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 27, 13} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i32($i12, 1);
  call {:cexpr "z"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/trex01-1_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/trex01-1_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/trex01-1_tmp.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i1.i8($i0);
  call {:cexpr "c"} boogie_si_record_i8($i1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 36, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 36, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call f(1);
  assume {:sourceloc "./output/trex01-1_tmp.c", 38, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/trex01-1_tmp.c", 39, 5} true;
  assume {:verifier.code 0} true;
  call f(2);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex01-1_tmp.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
