...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 11, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 13, 4} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i32.i64($i0);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 13, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $i4 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 14, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4, $i0);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 14, 4} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i4);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i4, 1);
  call {:cexpr "i"} boogie_si_record_i32($i9);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $i9;
  goto $bb4;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $i28 := 1;
  goto $bb11;
$bb4:
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 17, 15} true;
  assume {:verifier.code 0} true;
  $i11 := $sge.i32($i10, 0);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 17, 20} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb5:
  assume ($i11 == 1);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 17, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 17, 28} true;
  assume {:verifier.code 0} true;
  $i16 := $sgt.i32($i15, $i8);
  assume {:verifier.code 0} true;
  $i12 := $i16;
...
$bb8:
  assume ($i12 == 1);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 18, 19} true;
  assume {:verifier.code 0} true;
  $i17 := $sext.i32.i64($i10);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 18, 19} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p3, $mul.ref($i17, 4));
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 18, 19} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.1, $p18);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 18, 13} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i32($i10, 1);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 18, 10} true;
  assume {:verifier.code 0} true;
  $i21 := $sext.i32.i64($i20);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 18, 10} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p3, $mul.ref($i21, 4));
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p22, $i19);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 19, 16} true;
  assume {:verifier.code 0} true;
  $i23 := $sub.i32($i10, 1);
...
$bb9:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i10, 1);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $sext.i32.i64($i24);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p3, $mul.ref($i25, 4));
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p26, $i8);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 14, 21} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i4, 1);
  call {:cexpr "j"} boogie_si_record_i32($i27);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 14, 4} true;
  assume {:verifier.code 0} true;
  $i4 := $i27;
  goto $bb1;
$bb11:
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 23, 13} true;
  assume {:verifier.code 0} true;
  $i29 := $ult.i32($i28, $i0);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb12, $bb13;
$bb12:
  assume ($i29 == 1);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 26} true;
  assume {:verifier.code 1} true;
  $i30 := $sub.i32($i28, 1);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 23} true;
  assume {:verifier.code 1} true;
  $i31 := $sext.i32.i64($i30);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 23} true;
  assume {:verifier.code 1} true;
  $p32 := $add.ref($p3, $mul.ref($i31, 4));
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 23} true;
  assume {:verifier.code 1} true;
  $i33 := $load.i32($M.1, $p32);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 31} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 29} true;
  assume {:verifier.code 1} true;
  $i37 := $sle.i32($i33, $i36);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 29} true;
  assume {:verifier.code 1} true;
  $i38 := $zext.i1.i32($i37);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i38);
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 24, 5} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  assume !(($i29 == 1));
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 26, 1} true;
  assume {:verifier.code 0} true;
  ...
  return;
$bb14:
  assume {:sourceloc "./output/insertion_sort-2_tmp.c", 23, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $add.i32($i28, 1);
