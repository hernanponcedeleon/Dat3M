...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/array_3-1-O3.bpl /Users/ponce/git/Dat3M/./output/array_3-1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/array_3-1_tmp.c", 14, 3} true;
...
$bb1:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/array_3-1_tmp.c", 15, 12} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/array_3-1_tmp.c", 14, 26} true;
  assume {:verifier.code 0} true;
  $i2 := $add.bv64($i0, 1bv64);
  assume {:sourceloc "./output/array_3-1_tmp.c", 14, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.bv64($i2, 1024bv64);
  assume {:sourceloc "./output/array_3-1_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1bv1);
  assume {:sourceloc "./output/array_3-1_tmp.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
