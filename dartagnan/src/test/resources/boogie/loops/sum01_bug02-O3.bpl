...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum01_bug02-O3.bpl /Users/ponce/git/Dat3M/./output/sum01_bug02_tmp.c
...
$bb3:
  ...
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, 3bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.bv32($i2, 3bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i5, $i6, $i7, $i8 := $u0, 0bv32, 1bv32, 10bv32;
...
$bb5:
  ...
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i36 := $eq.bv32($i3, 0bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i37, $i38, $i39, $i40, $i41 := $i5, $i6, $i7, $i8, $i3;
...
$bb6:
  ...
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i10, $i11, $i12, $i13 := 0bv32, 1bv32, 10bv32, $i9;
  goto $bb7;
$bb7:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.bv32($i11, $i12);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i15 := $add.bv32($i10, 2bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i16 := (if ($i14 == 1bv1) then $i15 else $i10);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $i17 := $add.bv32($i12, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i18 := $add.bv32($i11, 1bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i19 := $slt.bv32($i18, $i17);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i20 := $add.bv32($i16, 2bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i21 := (if ($i19 == 1bv1) then $i20 else $i16);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $i22 := $add.bv32($i12, $sub.bv32(0bv32, 2bv32));
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i23 := $add.bv32($i11, 2bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $slt.bv32($i23, $i22);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i25 := $add.bv32($i21, 2bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i26 := (if ($i24 == 1bv1) then $i25 else $i21);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $i27 := $add.bv32($i12, $sub.bv32(0bv32, 3bv32));
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i28 := $add.bv32($i11, 3bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i29 := $slt.bv32($i28, $i27);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i30 := $add.bv32($i26, 2bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i31 := (if ($i29 == 1bv1) then $i30 else $i26);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $i32 := $add.bv32($i12, $sub.bv32(0bv32, 4bv32));
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $add.bv32($i11, 4bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i34 := $add.bv32($i13, $sub.bv32(0bv32, 4bv32));
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i35 := $eq.bv32($i34, 0bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i5, $i6, $i7, $i8 := $i31, $i31, $i33, $i32;
...
$bb9:
  assume !(($i35 == 1bv1));
  assume {:verifier.code 0} true;
  $i10, $i11, $i12, $i13 := $i31, $i33, $i32, $i34;
  goto $bb7;
$bb10:
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i42 := $slt.bv32($i39, $i40);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i43 := $add.bv32($i38, 2bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i44 := (if ($i42 == 1bv1) then $i43 else $i38);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $i45 := $add.bv32($i40, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $i46 := $add.bv32($i39, 1bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i47 := $add.bv32($i41, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i48 := $eq.bv32($i47, 0bv32);
  assume {:sourceloc "./output/sum01_bug02_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i37 := $i44;
...
$bb15:
  assume !(($i48 == 1bv1));
  assume {:verifier.code 0} true;
  $i38, $i39, $i40, $i41 := $i44, $i46, $i45, $i47;
  goto $bb13;
$bb16:
  assume ($i52 == 1bv1);
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 39219));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 43347));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 44379));
