...
axiom (llvm.dbg.declare == $sub.ref(0, 5157));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 6189));
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 12, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 12, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 13, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(40000, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 27, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $uge.i32($i2, 10000);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 28, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 29, 7} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i2);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 40000)), $mul.ref($i4, 4));
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 31, 18} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb4:
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 35, 25} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i1, 10000);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 35, 32} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 35, 35} true;
  assume {:verifier.code 1} true;
  $i8 := $zext.i32.i64($i1);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 35, 35} true;
  assume {:verifier.code 1} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 40000)), $mul.ref($i8, 4));
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 35, 35} true;
  assume {:verifier.code 1} true;
  $i10 := $load.i32($M.0, $p9);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 35, 46} true;
  assume {:verifier.code 1} true;
  $i11 := $eq.i32($i10, $i1);
  assume {:verifier.code 0} true;
  $i7 := $i11;
...
$bb7:
  ...
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i7);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 35, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i12);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 39213));
