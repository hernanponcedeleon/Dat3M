...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 6189));
procedure llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const r_strncpy: ref;
axiom (r_strncpy == $sub.ref(0, 7221));
procedure r_strncpy($p0: ref, $p1: ref, $i2: i32)
  returns ($r: ref)
{
  var $p3: ref;
$bb0:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 69, 64} true;
  assume {:verifier.code 0} true;
  call {:cexpr "r_strncpy:arg:n"} boogie_si_record_i32($i2);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 69, 64} true;
  assume {:verifier.code 0} true;
  call $p3 := strncpy($p0, $p1, $i2);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 69, 57} true;
  assume {:verifier.code 0} true;
  $r := $p3;
  $exn := false;
  return;
...
const strncpy: ref;
axiom (strncpy == $sub.ref(0, 8253));
procedure strncpy($p0: ref, $p1: ref, $i2: i32)
  returns ($r: ref);
const main: ref;
axiom (main == $sub.ref(0, 9285));
procedure main()
  returns ($r: i32)
{
  var $p0: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 188, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(9, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 188, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 9)), $mul.ref(8, 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 188, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p1, 0);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 190, 26} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 9)), $mul.ref(0, 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 190, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := parse_expression_list($p2);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 191, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const parse_expression_list: ref;
axiom (parse_expression_list == $sub.ref(0, 10317));
procedure parse_expression_list($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $i2: i1;
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 143, 8} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $ne.ref($p0, $0.ref);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 143, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 145, 3} true;
  assume {:verifier.code 0} true;
  $i4, $i5 := $sub.i32(0, 1), 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 143, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0, 1);
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 182, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  ...
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 148, 6} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i4, 1);
  call {:cexpr "i"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 149, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 149, 12} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i11 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $i5;
  goto $bb8;
$bb7:
...
$bb8:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i16 := $sext.i8.i32($i15);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 26} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i16, 32);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 34} true;
  assume {:verifier.code 0} true;
  $i18 := 1;
...
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 38} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i22 := $sext.i8.i32($i21);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 49} true;
  assume {:verifier.code 0} true;
  $i23 := $eq.i32($i22, 9);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 34} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i18 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 64} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i12, 1);
  call {:cexpr "start"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 153, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $i24;
  goto $bb8;
$bb13:
  assume !(($i18 == 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 156, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i28 := $sext.i8.i32($i27);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 156, 22} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.i32($i28, 34);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 156, 11} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume ($i29 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 156, 35} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i32($i12, 1);
  call {:cexpr "start"} boogie_si_record_i32($i31);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 156, 30} true;
  assume {:verifier.code 0} true;
  $i30 := $i31;
  goto $bb16;
$bb15:
...
$bb16:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 159, 12} true;
  assume {:verifier.code 0} true;
  $i32 := $sub.i32($i6, 1);
  call {:cexpr "j"} boogie_si_record_i32($i32);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 7} true;
  assume {:verifier.code 0} true;
  $i33 := $i32;
  goto $bb17;
$bb17:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 17} true;
  assume {:verifier.code 0} true;
  $i34 := $slt.i32(0, $i33);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 22} true;
  assume {:verifier.code 0} true;
  $i35 := 0;
...
$bb18:
  assume ($i34 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 27} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i39 := $sext.i8.i32($i38);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 34} true;
  assume {:verifier.code 0} true;
  $i40 := $eq.i32($i39, 32);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 42} true;
  assume {:verifier.code 0} true;
  $i41 := 1;
...
$bb23:
  assume !(($i40 == 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 46} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i45 := $sext.i8.i32($i44);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 53} true;
  assume {:verifier.code 0} true;
  $i46 := $eq.i32($i45, 9);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 42} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i35 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 162, 65} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i32($i33, $sub.i32(0, 1));
...
$bb25:
  assume !(($i35 == 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 163, 14} true;
  assume {:verifier.code 0} true;
  $i48 := $slt.i32(0, $i33);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 163, 19} true;
  assume {:verifier.code 0} true;
  $i49 := $i33;
...
$bb26:
  assume ($i48 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 163, 23} true;
  assume {:verifier.code 0} true;
  $i50 := $sext.i32.i64($i33);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 163, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i53 := $sext.i8.i32($i52);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 163, 30} true;
  assume {:verifier.code 0} true;
  $i54 := $eq.i32($i53, 34);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 163, 11} true;
  assume {:verifier.code 0} true;
  $i49 := $i33;
...
$bb28:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 166, 16} true;
  assume {:verifier.code 0} true;
  $i56 := $sle.i32($i30, $i49);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 166, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i56} true;
  goto $bb31, $bb32;
$bb29:
  assume ($i54 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 163, 40} true;
  assume {:verifier.code 0} true;
  $i55 := $add.i32($i33, $sub.i32(0, 1));
  call {:cexpr "j"} boogie_si_record_i32($i55);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 163, 39} true;
  assume {:verifier.code 0} true;
  $i49 := $i55;
  goto $bb28;
$bb30:
...
$bb31:
  assume ($i56 == 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 169, 19} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($add.ref($p1, $mul.ref(0, 2)), $mul.ref(0, 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 169, 28} true;
  assume {:verifier.code 0} true;
  $i58 := $sext.i32.i64($i30);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 169, 28} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($p0, $mul.ref($i58, 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 169, 37} true;
  assume {:verifier.code 0} true;
  $i60 := $sub.i32($i49, $i30);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 169, 43} true;
  assume {:verifier.code 0} true;
  $i61 := $add.i32($i60, 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 169, 9} true;
  assume {:verifier.code 0} true;
  call $p62 := r_strncpy($p57, $p59, $i61);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 170, 29} true;
  assume {:verifier.code 1} true;
  $i63 := $sub.i32($i49, $i30);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 170, 37} true;
  assume {:verifier.code 1} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 170, 41} true;
  assume {:verifier.code 1} true;
  $i65 := $slt.i32($i64, 2);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 170, 41} true;
  assume {:verifier.code 1} true;
  $i66 := $zext.i1.i32($i65);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 170, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i66);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 171, 15} true;
  assume {:verifier.code 0} true;
  $i67 := $sub.i32($i49, $i30);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 171, 21} true;
  assume {:verifier.code 0} true;
  $i68 := $add.i32($i67, 1);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 171, 9} true;
  assume {:verifier.code 0} true;
  $i69 := $sext.i32.i64($i68);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 171, 9} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p1, $mul.ref(0, 2)), $mul.ref($i69, 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 171, 25} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p70, 0);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 172, 7} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb32:
  assume !(($i56 == 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 174, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0, 1);
  goto $bb3;
$bb33:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 177, 16} true;
  assume {:verifier.code 0} true;
  $i71 := $add.i32($i6, 1);
  call {:cexpr "start"} boogie_si_record_i32($i71);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 178, 5} true;
  assume {:verifier.code 0} true;
  $i72 := $i71;
  goto $bb34;
$bb34:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 179, 3} true;
  assume {:verifier.code 0} true;
  goto $bb35;
$bb35:
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 179, 12} true;
  assume {:verifier.code 0} true;
  $i73 := $sext.i32.i64($i6);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 179, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i76 := $sext.i8.i32($i75);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 179, 19} true;
  assume {:verifier.code 0} true;
  $i77 := $ne.i32($i76, 0);
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 179, 3} true;
  assume {:verifier.code 0} true;
...
$bb37:
  assume !(($i77 == 1));
  assume {:sourceloc "./output/verisec_OpenSER_cases1_stripFullBoth_arr_tmp.c", 181, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 11349));
...
axiom (__SMACK_code == $sub.ref(0, 12381));
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
procedure __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 13413));
...
axiom (__VERIFIER_error == $sub.ref(0, 14445));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 15477));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 16509));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 17541));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 18573));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 19605));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 20637));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 21669));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 22701));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 23733));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 24765));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 25797));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 26829));
