...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/matrix-2-O3.bpl /Users/ponce/git/Dat3M/./output/matrix-2_tmp.c
...
$bb0:
  ...
  call {:cexpr "N_LIN"} boogie_si_record_bv32($i0);
  ...
  call {:cexpr "N_COL"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.bv32.bv64($i1);
  assume {:sourceloc "./output/matrix-2_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/matrix-2_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call $p5 := $alloc($mul.ref(4, $bv2int.64($i4)));
  assume true;
  ...
  call {:cexpr "maior"} boogie_si_record_bv32($i6);
...
$bb4:
  ...
  $i12 := $mul.bv64($i10, $i3);
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p5, $mul.ref($bv2int.64($i12), 4));
...
$bb12:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.bv32.bv64($i27);
  assume {:verifier.code 0} true;
  $i29 := $mul.bv64($i28, $i3);
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p5, $mul.ref($bv2int.64($i29), 4));
...
$bb13:
  ...
  assume {:verifier.code 0} true;
  $i34 := $zext.bv32.bv64($i31);
  $i35 := $add.bv64($i29, $i34);
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 25} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p5, $mul.ref($bv2int.64($i35), 4));
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 25} true;
  assume {:verifier.code 0} true;
  $i37 := $load.bv32($M.0, $p36);
  assume {:sourceloc "./output/matrix-2_tmp.c", 32, 37} true;
  assume {:verifier.code 0} true;
  $i38 := $slt.bv32($i37, $i20);
  assume {:sourceloc "./output/matrix-2_tmp.c", 31, 22} true;
  assume {:verifier.code 0} true;
  $i33 := $add.bv32($i31, 1bv32);
  call {:cexpr "k"} boogie_si_record_bv32($i33);
...
$bb16:
  ...
  assume {:verifier.code 0} true;
  $i39 := $add.bv32($i27, 1bv32);
  call {:cexpr "j"} boogie_si_record_bv32($i39);
