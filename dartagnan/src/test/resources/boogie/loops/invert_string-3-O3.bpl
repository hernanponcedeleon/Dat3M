...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/invert_string-3-O3.bpl /Users/ponce/git/Dat3M/./output/invert_string-3_tmp.c
...
$bb0:
  ...
  assume {:sourceloc "./output/invert_string-3_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  call $i0 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i0);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i1);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_nondet_char == $sub.ref(0, 12387));
