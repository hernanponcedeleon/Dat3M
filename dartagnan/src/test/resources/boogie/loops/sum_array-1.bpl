...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 47469));
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 6, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum_array-1_tmp.c", 14, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i32.i64($i0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/sum_array-1_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum_array-1_tmp.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $ult.i32($i8, $i0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i32.i64($i8);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p3, $mul.ref($i11, 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 19, 10} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 18, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i8, 1);
...
$bb5:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum_array-1_tmp.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $ult.i32($i14, $i0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64($i14);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p5, $mul.ref($i17, 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i15 == 1));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $i20 := 0;
  goto $bb9;
$bb8:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i14, 1);
...
$bb9:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum_array-1_tmp.c", 24, 12} true;
  assume {:verifier.code 0} true;
  $i21 := $ult.i32($i20, $i0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i24, $i27);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $i29 := $zext.i32.i64($i20);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p7, $mul.ref($i29, 4));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 25, 10} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume !(($i21 == 1));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  $i32 := 0;
  goto $bb13;
$bb12:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 24, 16} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i32($i20, 1);
...
$bb13:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum_array-1_tmp.c", 27, 12} true;
  assume {:verifier.code 0} true;
  $i33 := $ult.i32($i32, $i0);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 27, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i33} true;
  goto $bb14, $bb15;
$bb14:
  assume ($i33 == 1);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 28, 24} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 28, 30} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 28, 35} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/sum_array-1_tmp.c", 28, 34} true;
  assume {:verifier.code 1} true;
  $i43 := $sub.i32($i39, $i42);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 28, 28} true;
  assume {:verifier.code 1} true;
  $i44 := $eq.i32($i36, $i43);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 28, 28} true;
  assume {:verifier.code 1} true;
  $i45 := $zext.i1.i32($i44);
  assume {:sourceloc "./output/sum_array-1_tmp.c", 28, 6} true;
  assume {:verifier.code 1} true;
...
$bb15:
  assume !(($i33 == 1));
  assume {:sourceloc "./output/sum_array-1_tmp.c", 29, 1} true;
  assume {:verifier.code 0} true;
  ...
  return;
$bb16:
  assume {:sourceloc "./output/sum_array-1_tmp.c", 27, 16} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i32($i32, 1);
...
axiom (llvm.stacksave == $sub.ref(0, 8253));
procedure llvm.stacksave()
  returns ($r: ref);
const llvm.stackrestore: ref;
axiom (llvm.stackrestore == $sub.ref(0, 9285));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 23733));
...
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 27861));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 28893));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 29925));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 30957));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 31989));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 33021));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 34053));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 35085));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 36117));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 37149));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 38181));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 39213));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 40245));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 41277));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 42309));
...
axiom (__SMACK_decls == $sub.ref(0, 43341));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 44373));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 45405));
...
axiom (llvm.dbg.value == $sub.ref(0, 46437));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 47469));
