...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/ps3-O3.bpl /Users/ponce/git/Dat3M/./output/ps3_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/ps3_tmp.c", 18, 9} true;
  ...
  assume {:sourceloc "./output/ps3_tmp.c", 9, 9} true;
  assume {:verifier.code 0} true;
  $i1 := 0bv32;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/ps3_tmp.c", 27, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.bv32($i1, $i0);
  assume {:sourceloc "./output/ps3_tmp.c", 30, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $add.bv32($i1, 1bv32);
  call {:cexpr "c"} boogie_si_record_bv32($i3);
  assume {:sourceloc "./output/ps3_tmp.c", 27, 13} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/ps3_tmp.c", 35, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
