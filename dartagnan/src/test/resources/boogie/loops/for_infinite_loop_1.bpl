...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 9, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 19, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 20, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
...
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 20, 15} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 1} true;
  goto $bb5, $bb6;
$bb5:
  assume (1 == 1);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 23, 24} true;
  assume {:verifier.code 1} true;
  $i3 := $eq.i32(0, 0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 23, 24} true;
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 23, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i4);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !((1 == 1));
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 25, 22} true;
  assume {:verifier.code 1} true;
  $i6 := $eq.i32(0, 0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 25, 22} true;
  assume {:verifier.code 1} true;
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i2, 1);
