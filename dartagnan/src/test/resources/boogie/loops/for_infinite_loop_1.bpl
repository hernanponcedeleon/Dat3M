...
{
$bb0:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 9, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 9, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 9, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 10, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 10, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 10, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb4;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 21, 15} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 1} true;
  goto $bb5, $bb6;
$bb5:
  assume (1 == 1);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 24, 24} true;
  assume {:verifier.code 1} true;
  $i3 := $eq.i32(0, 0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 24, 24} true;
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 24, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i4);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !((1 == 1));
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 26, 22} true;
  assume {:verifier.code 1} true;
  $i6 := $eq.i32(0, 0);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 26, 22} true;
  assume {:verifier.code 1} true;
  $i7 := $zext.i1.i32($i6);
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 26, 3} true;
  assume {:verifier.code 1} true;
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "./output/for_infinite_loop_1_tmp.c", 22, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i2, 1);
