...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/count_up_down-1-O3.bpl /Users/ponce/git/Dat3M/./output/count_up_down-1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/count_up_down-1_tmp.c", 14, 20} true;
  ...
  assume {:sourceloc "./output/count_up_down-1_tmp.c", 22, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
