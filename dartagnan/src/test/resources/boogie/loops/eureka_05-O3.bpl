...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/eureka_05-O3.bpl /Users/ponce/git/Dat3M/./output/eureka_05_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 44387));
...
axiom (.str.1 == $sub.ref(0, 3110));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 4142));
const {:count 3} .str.1.1: ref;
axiom (.str.1.1 == $sub.ref(0, 5169));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 6207));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 7235));
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 8267));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const main: ref;
axiom (main == $sub.ref(0, 9299));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/eureka_05_tmp.c", 20, 22} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/eureka_05_tmp.c", 20, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.bv32($M.0, n);
  assume {:sourceloc "./output/eureka_05_tmp.c", 20, 20} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.bv32($i0, 0bv32);
  assume {:sourceloc "./output/eureka_05_tmp.c", 20, 4} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i3 := $zext.bv32.bv64($i0);
  assume {:sourceloc "./output/eureka_05_tmp.c", 20, 4} true;
  assume {:verifier.code 0} true;
  $i4 := $add.bv64($i3, $sub.bv64(0bv64, 2bv64));
  assume {:sourceloc "./output/eureka_05_tmp.c", 20, 4} true;
  assume {:verifier.code 0} true;
  $i5, $i6 := 0bv64, 1bv64;
  goto $bb4;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/eureka_05_tmp.c", 42, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $add.bv64($i5, 1bv64);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $slt.bv64($i7, $i2);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.bv64.bv32($i5);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $i9;
...
$bb7:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/eureka_05_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $p50 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($bv2int.64($i5), 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $i51 := $load.bv32($M.0, $p50);
  call {:cexpr "temp"} boogie_si_record_bv32($i51);
  assume {:sourceloc "./output/eureka_05_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  $i52 := $sext.bv32.bv64($i10);
  assume {:sourceloc "./output/eureka_05_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  $p53 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($bv2int.64($i52), 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 25, 19} true;
  assume {:verifier.code 0} true;
  $i54 := $load.bv32($M.0, $p53);
  assume {:sourceloc "./output/eureka_05_tmp.c", 25, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p50, $i54);
  assume {:sourceloc "./output/eureka_05_tmp.c", 26, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p53, $i51);
  assume {:sourceloc "./output/eureka_05_tmp.c", 20, 4} true;
  assume {:verifier.code 0} true;
  $i55 := $add.bv64($i6, 1bv64);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 26} true;
  assume {:verifier.code 0} true;
  $i56 := $eq.bv64($i7, $i2);
  assume {:sourceloc "./output/eureka_05_tmp.c", 20, 4} true;
...
$bb10:
  ...
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($bv2int.64($i6), 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i19 := $load.bv32($M.0, $p18);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $i20 := $shl.bv64($i5, 32bv64);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $ashr.bv64($i20, 32bv64);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($bv2int.64($i21), 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $i23 := $load.bv32($M.0, $p22);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 23} true;
  assume {:verifier.code 0} true;
  $i24 := $slt.bv32($i19, $i23);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.bv64.bv32($i6);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i26 := (if ($i24 == 1bv1) then $i25 else $i9);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 32} true;
  assume {:verifier.code 0} true;
  $i27 := $add.bv64($i6, 1bv64);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i15, $i16, $i17 := $i26, $i27, $i26;
  goto $bb9;
$bb11:
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($bv2int.64($i29), 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i32 := $load.bv32($M.0, $p31);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $i33 := $sext.bv32.bv64($i30);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($bv2int.64($i33), 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $i35 := $load.bv32($M.0, $p34);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 23} true;
  assume {:verifier.code 0} true;
  $i36 := $slt.bv32($i32, $i35);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.bv64.bv32($i29);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i38 := (if ($i36 == 1bv1) then $i37 else $i30);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 32} true;
  assume {:verifier.code 0} true;
  $i39 := $add.bv64($i29, 1bv64);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($bv2int.64($i39), 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i41 := $load.bv32($M.0, $p40);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $i42 := $sext.bv32.bv64($i38);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref($bv2int.64($i42), 4));
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 25} true;
  assume {:verifier.code 0} true;
  $i44 := $load.bv32($M.0, $p43);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 23} true;
  assume {:verifier.code 0} true;
  $i45 := $slt.bv32($i41, $i44);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.bv64.bv32($i39);
  assume {:sourceloc "./output/eureka_05_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i47 := (if ($i45 == 1bv1) then $i46 else $i38);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 32} true;
  assume {:verifier.code 0} true;
  $i48 := $add.bv64($i29, 2bv64);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 26} true;
  assume {:verifier.code 0} true;
  $i49 := $eq.bv64($i48, $i3);
  assume {:sourceloc "./output/eureka_05_tmp.c", 22, 7} true;
...
axiom (__VERIFIER_assume == $sub.ref(0, 10331));
...
axiom (__SMACK_code == $sub.ref(0, 11363));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 12395));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 13427));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 14459));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 15491));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 16523));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 17555));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 18587));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 19619));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 20651));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 21683));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 22715));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 23747));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 24779));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 25811));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 26843));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 27875));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 28907));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 29939));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 30971));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 32003));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 33035));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 34067));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 35099));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 36131));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 37163));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 38195));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 39227));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 40259));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 41291));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 42323));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 43355));
...
axiom (__SMACK_static_init == $sub.ref(0, 44387));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bv32($M.0, n, 5bv32);
  call {:cexpr "n"} boogie_si_record_bv32(5bv32);
  $M.0 := $store.bv32($M.0, array, 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref(1, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref(2, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref(3, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(array, $mul.ref(0, 20)), $mul.ref(4, 4)), 0bv32);
  $M.0 := $store.bytes.ref($M.0, env_value_str, .str.1.1);
