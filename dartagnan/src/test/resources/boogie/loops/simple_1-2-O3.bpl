...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/simple_1-2-O3.bpl /Users/ponce/git/Dat3M/./output/simple_1-2_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/simple_1-2_tmp.c", 19, 1} true;
