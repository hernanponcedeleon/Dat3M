...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/gj2007.c.i.p+lhb-reducer-O3.bpl /Users/ponce/git/Dat3M/./output/gj2007.c.i.p+lhb-reducer_tmp.c
...
const __return_720: ref;
axiom (__return_720 == $sub.ref(0, 1028));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/gj2007.c.i.p+lhb-reducer_tmp.c", 100, 16} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/gj2007.c.i.p+lhb-reducer_tmp.c", 100, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, __return_720, 0bv32);
  call {:cexpr "__return_720"} boogie_si_record_bv32(0bv32);
  assume {:sourceloc "./output/gj2007.c.i.p+lhb-reducer_tmp.c", 213, 2} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
