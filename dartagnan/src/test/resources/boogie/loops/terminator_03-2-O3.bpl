...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/terminator_03-2-O3.bpl /Users/ponce/git/Dat3M/./output/terminator_03-2_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/terminator_03-2_tmp.c", 16, 11} true;
  ...
  assume {:sourceloc "./output/terminator_03-2_tmp.c", 17, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/terminator_03-2_tmp.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
