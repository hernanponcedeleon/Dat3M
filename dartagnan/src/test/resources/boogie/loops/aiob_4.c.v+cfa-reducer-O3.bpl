...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/aiob_4.c.v+cfa-reducer-O3.bpl /Users/ponce/git/Dat3M/./output/aiob_4.c.v+cfa-reducer_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/aiob_4.c.v+cfa-reducer_tmp.c", 159, 22} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/aiob_4.c.v+cfa-reducer_tmp.c", 159, 22} true;
  assume {:verifier.code 0} true;
  call $p0 := fopen(.str, .str.1);
  assume {:sourceloc "./output/aiob_4.c.v+cfa-reducer_tmp.c", 160, 24} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.ref($p0, $0.ref);
  assume {:verifier.code 0} true;
  $i2 := $load.bytes.bv32($M.0, __return_main);
  assume {:sourceloc "./output/aiob_4.c.v+cfa-reducer_tmp.c", 160, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/aiob_4.c.v+cfa-reducer_tmp.c", 224, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1bv1));
  assume {:sourceloc "./output/aiob_4.c.v+cfa-reducer_tmp.c", 176, 13} true;
  assume {:verifier.code 0} true;
