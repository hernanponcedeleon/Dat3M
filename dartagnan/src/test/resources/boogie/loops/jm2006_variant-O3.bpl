...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/jm2006_variant-O3.bpl /Users/ponce/git/Dat3M/./output/jm2006_variant_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 16, 9} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "i"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 17, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 18, 18} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, 1000001bv32);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 19, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $sgt.bv32($i1, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 18, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $and.bv1($i2, $i3);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 18, 18} true;
...
$bb1:
  assume ($i4 == 1bv1);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 23, 13} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.bv32($i0, 0bv32);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $i6, $i7 := $i1, 0bv32;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 28, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.bv32($i0, $i1);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 29, 29} true;
  assume {:verifier.code 0} true;
  $i12 := $eq.bv32($i6, $i7);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 28, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $or.bv1($i11, $i12);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 28, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i5 == 1bv1));
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $shl.bv32($i0, 1bv32);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.bv32($i1, $i8);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 28, 11} true;
  assume {:verifier.code 0} true;
  $i10 := $sub.bv32(0bv32, $i0);
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 28, 11} true;
  assume {:verifier.code 0} true;
  $i6, $i7 := $i9, $i10;
  goto $bb5;
...
$bb8:
  assume !(($i13 == 1bv1));
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 9, 15} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 9, 29} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/jm2006_variant_tmp.c", 9, 29} true;
  assume {:verifier.code 0} true;
