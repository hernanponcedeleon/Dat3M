...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/egcd2_tmp.c", 6, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/egcd2_tmp.c", 6, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/egcd2_tmp.c", 6, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/egcd2_tmp.c", 7, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/egcd2_tmp.c", 6, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/egcd2_tmp.c", 6, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/egcd2_tmp.c", 9, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/egcd2_tmp.c", 9, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/egcd2_tmp.c", 9, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/egcd2_tmp.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/egcd2_tmp.c", 9, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/egcd2_tmp.c", 11, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/egcd2_tmp.c", 19, 9} true;
  ...
  assume {:sourceloc "./output/egcd2_tmp.c", 20, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/egcd2_tmp.c", 21, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i0, 1);
  assume {:sourceloc "./output/egcd2_tmp.c", 21, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/egcd2_tmp.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/egcd2_tmp.c", 22, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $sge.i32($i1, 1);
  assume {:sourceloc "./output/egcd2_tmp.c", 22, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/egcd2_tmp.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/egcd2_tmp.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $i6, $i7, $i8, $i9, $i10, $i11 := 0, 0, 1, $i1, $i0, 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/egcd2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd2_tmp.c", 0, 0} true;
  ...
  assume {:sourceloc "./output/egcd2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd2_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i9, 0);
  assume {:sourceloc "./output/egcd2_tmp.c", 33, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i12 == 1);
  assume {:sourceloc "./output/egcd2_tmp.c", 38, 9} true;
  assume {:verifier.code 0} true;
  $i13, $i14 := $i10, 0;
  goto $bb5;
$bb3:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/egcd2_tmp.c", 34, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/egcd2_tmp.c", 62, 24} true;
  assume {:verifier.code 1} true;
  $i50 := $mul.i32($i7, $i0);
  assume {:sourceloc "./output/egcd2_tmp.c", 62, 30} true;
  assume {:verifier.code 1} true;
  $i51 := $mul.i32($i11, $i1);
  assume {:sourceloc "./output/egcd2_tmp.c", 62, 27} true;
  assume {:verifier.code 1} true;
  $i52 := $add.i32($i50, $i51);
  assume {:sourceloc "./output/egcd2_tmp.c", 62, 33} true;
  assume {:verifier.code 1} true;
  $i53 := $eq.i32($i52, 0);
  assume {:sourceloc "./output/egcd2_tmp.c", 62, 33} true;
  assume {:verifier.code 1} true;
  $i54 := $zext.i1.i32($i53);
  assume {:sourceloc "./output/egcd2_tmp.c", 62, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i54);
  assume {:sourceloc "./output/egcd2_tmp.c", 63, 24} true;
  assume {:verifier.code 1} true;
  $i55 := $mul.i32($i8, $i0);
  assume {:sourceloc "./output/egcd2_tmp.c", 63, 30} true;
  assume {:verifier.code 1} true;
  $i56 := $mul.i32($i6, $i1);
  assume {:sourceloc "./output/egcd2_tmp.c", 63, 27} true;
  assume {:verifier.code 1} true;
  $i57 := $add.i32($i55, $i56);
  assume {:sourceloc "./output/egcd2_tmp.c", 63, 33} true;
  assume {:verifier.code 1} true;
  $i58 := $eq.i32($i57, $i10);
  assume {:sourceloc "./output/egcd2_tmp.c", 63, 33} true;
  assume {:verifier.code 1} true;
  $i59 := $zext.i1.i32($i58);
  assume {:sourceloc "./output/egcd2_tmp.c", 63, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i59);
  assume {:sourceloc "./output/egcd2_tmp.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $r := $i10;
  $exn := false;
  return;
$bb5:
  ...
  assume {:sourceloc "./output/egcd2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/egcd2_tmp.c", 39, 38} true;
  assume {:verifier.code 1} true;
  $i15 := $mul.i32($i14, $i9);
  assume {:sourceloc "./output/egcd2_tmp.c", 39, 42} true;
  assume {:verifier.code 1} true;
  $i16 := $add.i32($i15, $i13);
  assume {:sourceloc "./output/egcd2_tmp.c", 39, 33} true;
  assume {:verifier.code 1} true;
  $i17 := $eq.i32($i10, $i16);
  assume {:sourceloc "./output/egcd2_tmp.c", 39, 33} true;
  assume {:verifier.code 1} true;
  $i18 := $zext.i1.i32($i17);
  assume {:sourceloc "./output/egcd2_tmp.c", 39, 13} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i18);
  assume {:sourceloc "./output/egcd2_tmp.c", 40, 37} true;
  assume {:verifier.code 1} true;
  $i19 := $mul.i32($i1, $i6);
  assume {:sourceloc "./output/egcd2_tmp.c", 40, 43} true;
  assume {:verifier.code 1} true;
  $i20 := $mul.i32($i0, $i8);
  assume {:sourceloc "./output/egcd2_tmp.c", 40, 40} true;
  assume {:verifier.code 1} true;
  $i21 := $add.i32($i19, $i20);
  assume {:sourceloc "./output/egcd2_tmp.c", 40, 33} true;
  assume {:verifier.code 1} true;
  $i22 := $eq.i32($i10, $i21);
  assume {:sourceloc "./output/egcd2_tmp.c", 40, 33} true;
  assume {:verifier.code 1} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "./output/egcd2_tmp.c", 40, 13} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i23);
  assume {:sourceloc "./output/egcd2_tmp.c", 41, 38} true;
  assume {:verifier.code 1} true;
  $i24 := $mul.i32($i0, $i7);
  assume {:sourceloc "./output/egcd2_tmp.c", 41, 46} true;
  assume {:verifier.code 1} true;
  $i25 := $mul.i32($i1, $i11);
  assume {:sourceloc "./output/egcd2_tmp.c", 41, 42} true;
  assume {:verifier.code 1} true;
  $i26 := $add.i32($i24, $i25);
  assume {:sourceloc "./output/egcd2_tmp.c", 41, 33} true;
  assume {:verifier.code 1} true;
  $i27 := $eq.i32($i9, $i26);
  assume {:sourceloc "./output/egcd2_tmp.c", 41, 33} true;
  assume {:verifier.code 1} true;
  $i28 := $zext.i1.i32($i27);
  assume {:sourceloc "./output/egcd2_tmp.c", 41, 13} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i28);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 25} true;
  assume {:verifier.code 1} true;
  $i29 := $mul.i32($i7, $i0);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 27} true;
  assume {:verifier.code 1} true;
  $i30 := $mul.i32($i29, $i1);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 33} true;
  assume {:verifier.code 1} true;
  $i31 := $mul.i32($i11, $i1);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 35} true;
  assume {:verifier.code 1} true;
  $i32 := $mul.i32($i31, $i1);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 30} true;
  assume {:verifier.code 1} true;
  $i33 := $add.i32($i30, $i32);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 41} true;
  assume {:verifier.code 1} true;
  $i34 := $mul.i32($i7, $i0);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 38} true;
  assume {:verifier.code 1} true;
  $i35 := $sub.i32($i33, $i34);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 47} true;
  assume {:verifier.code 1} true;
  $i36 := $mul.i32($i9, $i1);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 44} true;
  assume {:verifier.code 1} true;
  $i37 := $sub.i32($i35, $i36);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 53} true;
  assume {:verifier.code 1} true;
  $i38 := $mul.i32($i11, $i1);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 50} true;
  assume {:verifier.code 1} true;
  $i39 := $sub.i32($i37, $i38);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 56} true;
  assume {:verifier.code 1} true;
  $i40 := $add.i32($i39, $i9);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 60} true;
  assume {:verifier.code 1} true;
  $i41 := $eq.i32($i40, 0);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 60} true;
  assume {:verifier.code 1} true;
  $i42 := $zext.i1.i32($i41);
  assume {:sourceloc "./output/egcd2_tmp.c", 42, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i42);
  assume {:sourceloc "./output/egcd2_tmp.c", 43, 21} true;
  assume {:verifier.code 0} true;
  $i43 := $sge.i32($i13, $i9);
  assume {:sourceloc "./output/egcd2_tmp.c", 43, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i43} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i43 == 1);
  assume {:sourceloc "./output/egcd2_tmp.c", 45, 19} true;
  assume {:verifier.code 0} true;
  $i44 := $sub.i32($i13, $i9);
  call {:cexpr "c"} boogie_si_record_i32($i44);
  assume {:sourceloc "./output/egcd2_tmp.c", 46, 19} true;
  assume {:verifier.code 0} true;
  $i45 := $add.i32($i14, 1);
  call {:cexpr "k"} boogie_si_record_i32($i45);
  assume {:sourceloc "./output/egcd2_tmp.c", 38, 9} true;
  assume {:verifier.code 0} true;
  $i13, $i14 := $i44, $i45;
  goto $bb5;
$bb7:
  assume !(($i43 == 1));
  assume {:sourceloc "./output/egcd2_tmp.c", 44, 17} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/egcd2_tmp.c", 55, 22} true;
  assume {:verifier.code 0} true;
  $i46 := $mul.i32($i7, $i14);
  assume {:sourceloc "./output/egcd2_tmp.c", 55, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $sub.i32($i8, $i46);
  call {:cexpr "q"} boogie_si_record_i32($i47);
  assume {:sourceloc "./output/egcd2_tmp.c", 58, 22} true;
  assume {:verifier.code 0} true;
  $i48 := $mul.i32($i11, $i14);
  assume {:sourceloc "./output/egcd2_tmp.c", 58, 18} true;
  assume {:verifier.code 0} true;
  $i49 := $sub.i32($i6, $i48);
  call {:cexpr "s"} boogie_si_record_i32($i49);
  assume {:sourceloc "./output/egcd2_tmp.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $i6, $i7, $i8, $i9, $i10, $i11 := $i11, $i47, $i7, $i13, $i9, $i49;
  goto $bb1;
}
