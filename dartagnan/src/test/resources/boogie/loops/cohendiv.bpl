...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/cohendiv_tmp.c", 10, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/cohendiv_tmp.c", 10, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/cohendiv_tmp.c", 10, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/cohendiv_tmp.c", 10, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/cohendiv_tmp.c", 10, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/cohendiv_tmp.c", 13, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/cohendiv_tmp.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/cohendiv_tmp.c", 13, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/cohendiv_tmp.c", 13, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/cohendiv_tmp.c", 15, 2} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/cohendiv_tmp.c", 23, 9} true;
  ...
  assume {:sourceloc "./output/cohendiv_tmp.c", 24, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/cohendiv_tmp.c", 26, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 26, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/cohendiv_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/cohendiv_tmp.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7 := 0, $i0, 0, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/cohendiv_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/cohendiv_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/cohendiv_tmp.c", 0, 0} true;
  ...
  assume {:sourceloc "./output/cohendiv_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "./output/cohendiv_tmp.c", 34, 26} true;
  assume {:verifier.code 1} true;
  $i8 := $mul.i32($i1, $i6);
  assume {:sourceloc "./output/cohendiv_tmp.c", 34, 22} true;
  assume {:verifier.code 1} true;
  $i9 := $eq.i32($i7, $i8);
  assume {:sourceloc "./output/cohendiv_tmp.c", 34, 22} true;
  assume {:verifier.code 1} true;
  $i10 := $zext.i1.i32($i9);
  assume {:sourceloc "./output/cohendiv_tmp.c", 34, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i10);
  assume {:sourceloc "./output/cohendiv_tmp.c", 35, 26} true;
  assume {:verifier.code 1} true;
  $i11 := $mul.i32($i4, $i1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 35, 29} true;
  assume {:verifier.code 1} true;
  $i12 := $add.i32($i11, $i5);
  assume {:sourceloc "./output/cohendiv_tmp.c", 35, 22} true;
  assume {:verifier.code 1} true;
  $i13 := $eq.i32($i0, $i12);
  assume {:sourceloc "./output/cohendiv_tmp.c", 35, 22} true;
  assume {:verifier.code 1} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "./output/cohendiv_tmp.c", 35, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i14);
  assume {:sourceloc "./output/cohendiv_tmp.c", 37, 10} true;
  assume {:verifier.code 0} true;
  $i15 := $sge.i32($i5, $i1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 37, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i15 == 1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 42, 2} true;
  assume {:verifier.code 0} true;
  $i16, $i17 := 1, $i1;
  goto $bb5;
$bb3:
  assume !(($i15 == 1));
  assume {:sourceloc "./output/cohendiv_tmp.c", 38, 6} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/cohendiv_tmp.c", 59, 29} true;
  assume {:verifier.code 1} true;
  $i37 := $mul.i32($i4, $i1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 59, 32} true;
  assume {:verifier.code 1} true;
  $i38 := $add.i32($i37, $i5);
  assume {:sourceloc "./output/cohendiv_tmp.c", 59, 25} true;
  assume {:verifier.code 1} true;
  $i39 := $eq.i32($i0, $i38);
  assume {:sourceloc "./output/cohendiv_tmp.c", 59, 25} true;
  assume {:verifier.code 1} true;
  $i40 := $zext.i1.i32($i39);
  assume {:sourceloc "./output/cohendiv_tmp.c", 59, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i40);
  assume {:sourceloc "./output/cohendiv_tmp.c", 60, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb5:
  ...
  assume {:sourceloc "./output/cohendiv_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/cohendiv_tmp.c", 43, 30} true;
  assume {:verifier.code 1} true;
  $i18 := $mul.i32($i1, $i16);
  assume {:sourceloc "./output/cohendiv_tmp.c", 43, 26} true;
  assume {:verifier.code 1} true;
  $i19 := $eq.i32($i17, $i18);
  assume {:sourceloc "./output/cohendiv_tmp.c", 43, 26} true;
  assume {:verifier.code 1} true;
  $i20 := $zext.i1.i32($i19);
  assume {:sourceloc "./output/cohendiv_tmp.c", 43, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i20);
  assume {:sourceloc "./output/cohendiv_tmp.c", 44, 30} true;
  assume {:verifier.code 1} true;
  $i21 := $mul.i32($i4, $i1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 44, 33} true;
  assume {:verifier.code 1} true;
  $i22 := $add.i32($i21, $i5);
  assume {:sourceloc "./output/cohendiv_tmp.c", 44, 26} true;
  assume {:verifier.code 1} true;
  $i23 := $eq.i32($i0, $i22);
  assume {:sourceloc "./output/cohendiv_tmp.c", 44, 26} true;
  assume {:verifier.code 1} true;
  $i24 := $zext.i1.i32($i23);
  assume {:sourceloc "./output/cohendiv_tmp.c", 44, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i24);
  assume {:sourceloc "./output/cohendiv_tmp.c", 45, 26} true;
  assume {:verifier.code 1} true;
  $i25 := $sge.i32($i5, 0);
  assume {:sourceloc "./output/cohendiv_tmp.c", 45, 26} true;
  assume {:verifier.code 1} true;
  $i26 := $zext.i1.i32($i25);
  assume {:sourceloc "./output/cohendiv_tmp.c", 45, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i26);
  assume {:sourceloc "./output/cohendiv_tmp.c", 47, 19} true;
  assume {:verifier.code 0} true;
  $i27 := $mul.i32(2, $i17);
  assume {:sourceloc "./output/cohendiv_tmp.c", 47, 14} true;
  assume {:verifier.code 0} true;
  $i28 := $sge.i32($i5, $i27);
  assume {:sourceloc "./output/cohendiv_tmp.c", 47, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i28 == 1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 50, 31} true;
  assume {:verifier.code 1} true;
  $i29 := $mul.i32(2, $i1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 50, 35} true;
  assume {:verifier.code 1} true;
  $i30 := $mul.i32($i29, $i16);
  assume {:sourceloc "./output/cohendiv_tmp.c", 50, 26} true;
  assume {:verifier.code 1} true;
  $i31 := $sge.i32($i5, $i30);
  assume {:sourceloc "./output/cohendiv_tmp.c", 50, 26} true;
  assume {:verifier.code 1} true;
  $i32 := $zext.i1.i32($i31);
  assume {:sourceloc "./output/cohendiv_tmp.c", 50, 6} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i32);
  assume {:sourceloc "./output/cohendiv_tmp.c", 52, 12} true;
  assume {:verifier.code 0} true;
  $i33 := $mul.i32(2, $i16);
  call {:cexpr "a"} boogie_si_record_i32($i33);
  assume {:sourceloc "./output/cohendiv_tmp.c", 53, 12} true;
  assume {:verifier.code 0} true;
  $i34 := $mul.i32(2, $i17);
  call {:cexpr "b"} boogie_si_record_i32($i34);
  assume {:sourceloc "./output/cohendiv_tmp.c", 42, 2} true;
  assume {:verifier.code 0} true;
  $i16, $i17 := $i33, $i34;
  goto $bb5;
$bb7:
  assume !(($i28 == 1));
  assume {:sourceloc "./output/cohendiv_tmp.c", 48, 3} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/cohendiv_tmp.c", 55, 8} true;
  assume {:verifier.code 0} true;
  $i35 := $sub.i32($i5, $i17);
  call {:cexpr "r"} boogie_si_record_i32($i35);
  assume {:sourceloc "./output/cohendiv_tmp.c", 56, 8} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i4, $i16);
  call {:cexpr "q"} boogie_si_record_i32($i36);
  assume {:sourceloc "./output/cohendiv_tmp.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6, $i7 := $i36, $i35, $i16, $i17;
  goto $bb1;
}
