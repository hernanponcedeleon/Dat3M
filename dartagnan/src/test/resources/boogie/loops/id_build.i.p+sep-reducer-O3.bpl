...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/id_build.i.p+sep-reducer-O3.bpl /Users/ponce/git/Dat3M/./output/id_build.i.p+sep-reducer_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 47467));
...
const __return_1135: ref;
axiom (__return_1135 == $sub.ref(0, 2056));
...
{
$bb0:
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 3, 44} true;
...
axiom (llvm.dbg.value == $sub.ref(0, 9283));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 10315));
procedure  abort();
const main: ref;
axiom (main == $sub.ref(0, 11347));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 17, 15} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "main__nlen"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.bv32($i0, 0bv32);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 21, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1bv1);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 540, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.bv32($i0, 1bv32);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 540, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb3, $bb4;
$bb2:
  assume !(($i1 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2721, 9} true;
  assume {:verifier.code 0} true;
  $i23 := $load.bv32($M.0, __return_main);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2721, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i23;
  goto $bb21;
$bb3:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2643, 9} true;
  assume {:verifier.code 0} true;
  $i22 := $load.bv32($M.0, __return_main);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2643, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i22;
  goto $bb21;
$bb4:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 1059, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sgt.bv32($i0, 2bv32);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 1059, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i3 == 1bv1);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 1578, 14} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.bv32($i0, 3bv32);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 1578, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i3 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2565, 9} true;
  assume {:verifier.code 0} true;
  $i21 := $load.bv32($M.0, __return_main);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2565, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i21;
  goto $bb21;
$bb7:
  assume ($i4 == 1bv1);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2487, 9} true;
  assume {:verifier.code 0} true;
  $i20 := $load.bv32($M.0, __return_main);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2487, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i20;
  goto $bb21;
$bb8:
  assume !(($i4 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2097, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $sgt.bv32($i0, 4bv32);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2097, 6} true;
  assume {:verifier.code 0} true;
  $i6, $i7 := 7bv32, 4bv32;
...
$bb9:
  assume !(($i15 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2002, 3} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2002, 17} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2002, 17} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  goto $bb11;
$bb11:
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2300, 20} true;
  assume {:verifier.code 0} true;
  $i8 := $add.bv32($i6, 1bv32);
  call {:cexpr "main__j"} boogie_si_record_bv32($i8);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2300, 2} true;
  assume {:verifier.code 0} true;
  $i9, $i10 := $i8, $i7;
  goto $bb13;
$bb12:
  assume !(($i5 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2409, 9} true;
  assume {:verifier.code 0} true;
  $i19 := $load.bv32($M.0, __return_main);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2409, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i19;
  goto $bb21;
$bb13:
  ...
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2302, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $slt.bv32($i9, 8bv32);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2302, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb14, $bb15;
$bb14:
  assume ($i11 == 1bv1);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2306, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $sgt.bv32($i0, $i10);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2309, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb16, $bb17;
$bb15:
  assume !(($i11 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2322, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $add.bv32($i10, 1bv32);
  call {:cexpr "main__i"} boogie_si_record_bv32($i16);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2323, 14} true;
  assume {:verifier.code 0} true;
  $i17 := $slt.bv32($i16, $i0);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2323, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb19, $bb20;
$bb16:
  assume ($i12 == 1bv1);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 1997, 32} true;
  assume {:verifier.code 0} true;
  $i13 := $xor.bv32($i10, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 1997, 32} true;
  assume {:verifier.code 0} true;
  $i14 := $add.bv32($i0, $i13);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 1997, 43} true;
  assume {:verifier.code 0} true;
  $i15 := $slt.bv32($i14, $i0);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2000, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb18, $bb9;
$bb17:
  assume !(($i12 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2311, 3} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2311, 17} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2311, 17} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i17 == 1bv1));
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2330, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, __return_1135, 0bv32);
  call {:cexpr "__return_1135"} boogie_si_record_bv32(0bv32);
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2331, 2} true;
  assume {:verifier.code 0} true;
  $i18 := 0bv32;
  goto $bb21;
$bb21:
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/id_build.i.p+sep-reducer_tmp.c", 2723, 2} true;
  assume {:verifier.code 0} true;
  $r := $i18;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 12379));
...
axiom (__SMACK_code == $sub.ref(0, 13411));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 14443));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 15475));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 16507));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 17539));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 18571));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 19603));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 20635));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 21667));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 22699));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 23731));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 24763));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 25795));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 26827));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 27859));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 28891));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 29923));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 30955));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 31987));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 33019));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 34051));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 35083));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 36115));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 37147));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 38179));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 39211));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 40243));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 41275));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 42307));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 43339));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 44371));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 45403));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 46435));
...
axiom (__SMACK_static_init == $sub.ref(0, 47467));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bv32($M.0, __return_main, 0bv32);
  call {:cexpr "__return_main"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bv32($M.0, __return_1135, 0bv32);
  call {:cexpr "__return_1135"} boogie_si_record_bv32(0bv32);
