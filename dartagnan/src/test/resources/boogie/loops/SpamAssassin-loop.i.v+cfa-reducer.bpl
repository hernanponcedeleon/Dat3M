...
const __return_334: ref;
axiom (__return_334 == $sub.ref(0, 2056));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 17, 18} true;
  ...
  call {:cexpr "main__bufsize"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 18, 20} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 18, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 20, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  call $i4 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i4);
  call {:cexpr "main__len"} boogie_si_record_i32($i4);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 25, 34} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i0, 4);
  call {:cexpr "main__limit"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 26, 2} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 311, 2} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 28, 14} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, $i4);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 28, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i7 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 30, 2} true;
  assume {:verifier.code 0} true;
  $i8, $i9 := $i6, 0;
  goto $bb7;
$bb6:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 307, 16} true;
  assume {:verifier.code 0} true;
  $M.1 := 0;
  call {:cexpr "__return_334"} boogie_si_record_i32(0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 308, 9} true;
  assume {:verifier.code 0} true;
  $i90 := $M.1;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 308, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i90;
  goto $bb3;
$bb7:
  ...
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 32, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $slt.i32($i8, $i4);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 32, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i10 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 34, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $slt.i32($i9, $i5);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 34, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb10, $bb11;
$bb9:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 302, 2} true;
  assume {:verifier.code 0} true;
  goto $bb50;
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i8, 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 36, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $slt.i32($i12, $i4);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 36, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb12, $bb13;
$bb11:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 295, 2} true;
  assume {:verifier.code 0} true;
  goto $bb50;
$bb12:
  assume ($i13 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 40, 21} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i8, 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 40, 26} true;
  assume {:verifier.code 0} true;
  $i15 := $slt.i32($i14, $i4);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 40, 26} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i32($i15);
  call {:cexpr "__tmp_1"} boogie_si_record_i32($i16);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 43, 30} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i16, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 43, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb14, $bb15;
$bb13:
  assume !(($i13 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 291, 2} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb14:
  assume ($i17 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 45, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 46, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 46, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i18;
  goto $bb3;
$bb15:
  assume !(($i17 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 52, 14} true;
  assume {:verifier.code 0} true;
  $i19 := $sle.i32(0, $i8);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 52, 14} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i32($i19);
  call {:cexpr "__tmp_2"} boogie_si_record_i32($i20);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 55, 30} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.i32($i20, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 55, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i21 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 57, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 58, 9} true;
  assume {:verifier.code 0} true;
  $i22 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 58, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i22;
  goto $bb3;
$bb17:
  assume !(($i21 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 63, 29} true;
  assume {:verifier.code 0} true;
  call $i23 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i23);
  call {:cexpr "main____CPAchecker_TMP_0"} boogie_si_record_i32($i23);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 64, 33} true;
  assume {:verifier.code 0} true;
  $i24 := $eq.i32($i23, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 64, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb18, $bb19;
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 134, 20} true;
  assume {:verifier.code 0} true;
  $i45 := $slt.i32($i8, $i4);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 134, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i32($i45);
  call {:cexpr "__tmp_7"} boogie_si_record_i32($i46);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 137, 30} true;
  assume {:verifier.code 0} true;
  $i47 := $eq.i32($i46, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 137, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  goto $bb30, $bb31;
$bb19:
  assume !(($i24 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 65, 2} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 69, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $slt.i32($i8, $i4);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 69, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i32($i25);
  call {:cexpr "__tmp_3"} boogie_si_record_i32($i26);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 72, 30} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.i32($i26, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 72, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb21, $bb22;
$bb21:
  assume ($i27 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 74, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 75, 9} true;
  assume {:verifier.code 0} true;
  $i28 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 75, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i28;
  goto $bb3;
$bb22:
  assume !(($i27 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 81, 14} true;
  assume {:verifier.code 0} true;
  $i29 := $sle.i32(0, $i8);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 81, 14} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i1.i32($i29);
  call {:cexpr "__tmp_4"} boogie_si_record_i32($i30);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 84, 30} true;
  assume {:verifier.code 0} true;
  $i31 := $eq.i32($i30, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 84, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb23, $bb24;
$bb23:
  assume ($i31 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 86, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 87, 9} true;
  assume {:verifier.code 0} true;
  $i32 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 87, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i32;
  goto $bb3;
$bb24:
  assume !(($i31 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 93, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $slt.i32($i9, $i0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 93, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 96, 30} true;
  assume {:verifier.code 0} true;
  $i35 := $eq.i32($i34, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 96, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i35} true;
  goto $bb25, $bb26;
$bb25:
  assume ($i35 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 98, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 99, 9} true;
  assume {:verifier.code 0} true;
  $i36 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 99, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i36;
  goto $bb3;
$bb26:
  assume !(($i35 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 105, 14} true;
  assume {:verifier.code 0} true;
  $i37 := $sle.i32(0, $i9);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 105, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 108, 30} true;
  assume {:verifier.code 0} true;
  $i39 := $eq.i32($i38, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 108, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb27, $bb28;
$bb27:
  assume ($i39 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 110, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 111, 9} true;
  assume {:verifier.code 0} true;
  $i40 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 111, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i40;
  goto $bb3;
$bb28:
  assume !(($i39 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 116, 20} true;
  assume {:verifier.code 0} true;
  $i41 := $add.i32($i9, 1);
  call {:cexpr "main__j"} boogie_si_record_i32($i41);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 118, 20} true;
  assume {:verifier.code 0} true;
  $i42 := $add.i32($i8, 1);
  call {:cexpr "main__i"} boogie_si_record_i32($i42);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 118, 2} true;
  assume {:verifier.code 0} true;
  $i43, $i44 := $i42, $i41;
  goto $bb29;
$bb29:
  ...
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 120, 2} true;
  assume {:verifier.code 0} true;
  $i8, $i9 := $i43, $i44;
  goto $bb7;
$bb30:
  assume ($i47 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 139, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 140, 9} true;
  assume {:verifier.code 0} true;
  $i48 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 140, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i48;
  goto $bb3;
$bb31:
  assume !(($i47 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 146, 14} true;
  assume {:verifier.code 0} true;
  $i49 := $sle.i32(0, $i8);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 146, 14} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i32($i49);
  call {:cexpr "__tmp_8"} boogie_si_record_i32($i50);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 149, 30} true;
  assume {:verifier.code 0} true;
  $i51 := $eq.i32($i50, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 149, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  goto $bb32, $bb33;
$bb32:
  assume ($i51 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 151, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 152, 9} true;
  assume {:verifier.code 0} true;
  $i52 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 152, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i52;
  goto $bb3;
$bb33:
  assume !(($i51 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 158, 20} true;
  assume {:verifier.code 0} true;
  $i53 := $slt.i32($i9, $i0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 158, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 161, 30} true;
  assume {:verifier.code 0} true;
  $i55 := $eq.i32($i54, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 161, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i55} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i55 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 163, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 164, 9} true;
  assume {:verifier.code 0} true;
  $i56 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 164, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i56;
  goto $bb3;
$bb35:
  assume !(($i55 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 170, 15} true;
  assume {:verifier.code 0} true;
  $i57 := $sle.i32(0, $i9);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 170, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 173, 30} true;
  assume {:verifier.code 0} true;
  $i59 := $eq.i32($i58, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 173, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i59} true;
  goto $bb36, $bb37;
$bb36:
  assume ($i59 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 175, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 176, 9} true;
  assume {:verifier.code 0} true;
  $i60 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 176, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i60;
  goto $bb3;
$bb37:
  assume !(($i59 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 181, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $add.i32($i9, 1);
  call {:cexpr "main__j"} boogie_si_record_i32($i61);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 183, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $add.i32($i8, 1);
  call {:cexpr "main__i"} boogie_si_record_i32($i62);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 186, 21} true;
  assume {:verifier.code 0} true;
  $i63 := $slt.i32($i62, $i4);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 186, 21} true;
  assume {:verifier.code 0} true;
  $i64 := $zext.i1.i32($i63);
  call {:cexpr "__tmp_11"} boogie_si_record_i32($i64);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 189, 30} true;
  assume {:verifier.code 0} true;
  $i65 := $eq.i32($i64, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 189, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i65} true;
  goto $bb38, $bb39;
$bb38:
  assume ($i65 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 191, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 192, 9} true;
  assume {:verifier.code 0} true;
  $i66 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 192, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i66;
  goto $bb3;
$bb39:
  assume !(($i65 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 198, 15} true;
  assume {:verifier.code 0} true;
  $i67 := $sle.i32(0, $i62);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 198, 15} true;
  assume {:verifier.code 0} true;
  $i68 := $zext.i1.i32($i67);
  call {:cexpr "__tmp_12"} boogie_si_record_i32($i68);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 201, 30} true;
  assume {:verifier.code 0} true;
  $i69 := $eq.i32($i68, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 201, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i69 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 203, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 204, 9} true;
  assume {:verifier.code 0} true;
  $i70 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 204, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i70;
  goto $bb3;
$bb41:
  assume !(($i69 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 210, 21} true;
  assume {:verifier.code 0} true;
  $i71 := $slt.i32($i61, $i0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 210, 21} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i32($i71);
  call {:cexpr "__tmp_13"} boogie_si_record_i32($i72);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 213, 30} true;
  assume {:verifier.code 0} true;
  $i73 := $eq.i32($i72, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 213, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb42, $bb43;
$bb42:
  assume ($i73 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 215, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 216, 9} true;
  assume {:verifier.code 0} true;
  $i74 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 216, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i74;
  goto $bb3;
$bb43:
  assume !(($i73 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 222, 15} true;
  assume {:verifier.code 0} true;
  $i75 := $sle.i32(0, $i61);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 222, 15} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i32($i75);
  call {:cexpr "__tmp_14"} boogie_si_record_i32($i76);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 225, 30} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 225, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb44, $bb45;
$bb44:
  assume ($i77 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 227, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 228, 9} true;
  assume {:verifier.code 0} true;
  $i78 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i78;
  goto $bb3;
$bb45:
  assume !(($i77 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 233, 20} true;
  assume {:verifier.code 0} true;
  $i79 := $add.i32($i61, 1);
  call {:cexpr "main__j"} boogie_si_record_i32($i79);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 235, 20} true;
  assume {:verifier.code 0} true;
  $i80 := $add.i32($i62, 1);
  call {:cexpr "main__i"} boogie_si_record_i32($i80);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 238, 21} true;
  assume {:verifier.code 0} true;
  $i81 := $slt.i32($i79, $i0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 238, 21} true;
  assume {:verifier.code 0} true;
  $i82 := $zext.i1.i32($i81);
  call {:cexpr "__tmp_15"} boogie_si_record_i32($i82);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 241, 30} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.i32($i82, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 241, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i83} true;
  goto $bb46, $bb47;
$bb46:
  assume ($i83 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 243, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 244, 9} true;
  assume {:verifier.code 0} true;
  $i84 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 244, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i84;
  goto $bb3;
$bb47:
  assume !(($i83 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 250, 15} true;
  assume {:verifier.code 0} true;
  $i85 := $sle.i32(0, $i79);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 250, 15} true;
  assume {:verifier.code 0} true;
  $i86 := $zext.i1.i32($i85);
  call {:cexpr "__tmp_16"} boogie_si_record_i32($i86);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 253, 30} true;
  assume {:verifier.code 0} true;
  $i87 := $eq.i32($i86, 0);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 253, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb48, $bb49;
$bb48:
  assume ($i87 == 1);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 255, 2} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 256, 9} true;
  assume {:verifier.code 0} true;
  $i88 := $M.0;
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 256, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i88;
  goto $bb3;
$bb49:
  assume !(($i87 == 1));
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 261, 20} true;
  assume {:verifier.code 0} true;
  $i89 := $add.i32($i79, 1);
  call {:cexpr "main__j"} boogie_si_record_i32($i89);
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 262, 2} true;
  assume {:verifier.code 0} true;
  $i43, $i44 := $i80, $i89;
  goto $bb29;
$bb50:
  assume {:sourceloc "./output/SpamAssassin-loop.i.v+cfa-reducer_tmp.c", 297, 2} true;
  assume {:verifier.code 0} true;
  $i6 := $i8;
  goto $bb4;
}
