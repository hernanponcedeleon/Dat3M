...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/divbin2_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/divbin2_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/divbin2_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/divbin2_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/divbin2_tmp.c", 15, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/divbin2_tmp.c", 17, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/divbin2_tmp.c", 25, 9} true;
  ...
  assume {:sourceloc "./output/divbin2_tmp.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $i1 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/divbin2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/divbin2_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $uge.i32($i0, $i1);
  assume {:sourceloc "./output/divbin2_tmp.c", 33, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/divbin2_tmp.c", 34, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $mul.i32(2, $i1);
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/divbin2_tmp.c", 33, 24} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/divbin2_tmp.c", 37, 5} true;
  assume {:verifier.code 0} true;
  $i4, $i5, $i6 := 0, $i0, $i1;
  goto $bb5;
$bb5:
  ...
  assume {:sourceloc "./output/divbin2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/divbin2_tmp.c", 38, 34} true;
  assume {:verifier.code 1} true;
  $i7 := $mul.i32($i4, $i6);
  assume {:sourceloc "./output/divbin2_tmp.c", 38, 38} true;
  assume {:verifier.code 1} true;
  $i8 := $add.i32($i7, $i5);
  assume {:sourceloc "./output/divbin2_tmp.c", 38, 29} true;
  assume {:verifier.code 1} true;
  $i9 := $eq.i32($i0, $i8);
  assume {:sourceloc "./output/divbin2_tmp.c", 38, 29} true;
  assume {:verifier.code 1} true;
  $i10 := $zext.i1.i32($i9);
  assume {:sourceloc "./output/divbin2_tmp.c", 38, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i10);
  assume {:sourceloc "./output/divbin2_tmp.c", 39, 17} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i6, 1);
  assume {:sourceloc "./output/divbin2_tmp.c", 39, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i11 == 1);
  assume {:sourceloc "./output/divbin2_tmp.c", 41, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $mul.i32(2, $i4);
  call {:cexpr "q"} boogie_si_record_i32($i12);
  assume {:sourceloc "./output/divbin2_tmp.c", 42, 15} true;
  assume {:verifier.code 0} true;
  $i13 := $udiv.i32($i6, 2);
  call {:cexpr "b"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/divbin2_tmp.c", 43, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $uge.i32($i5, $i13);
  assume {:sourceloc "./output/divbin2_tmp.c", 43, 13} true;
  assume {:verifier.code 0} true;
  $i15, $i16 := $i12, $i5;
...
$bb7:
  assume !(($i11 == 1));
  assume {:sourceloc "./output/divbin2_tmp.c", 39, 24} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/divbin2_tmp.c", 49, 30} true;
  assume {:verifier.code 1} true;
  $i19 := $mul.i32($i4, $i6);
  assume {:sourceloc "./output/divbin2_tmp.c", 49, 34} true;
  assume {:verifier.code 1} true;
  $i20 := $add.i32($i19, $i5);
  assume {:sourceloc "./output/divbin2_tmp.c", 49, 25} true;
  assume {:verifier.code 1} true;
  $i21 := $eq.i32($i0, $i20);
  assume {:sourceloc "./output/divbin2_tmp.c", 49, 25} true;
  assume {:verifier.code 1} true;
  $i22 := $zext.i1.i32($i21);
  assume {:sourceloc "./output/divbin2_tmp.c", 49, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i22);
  assume {:sourceloc "./output/divbin2_tmp.c", 50, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb9:
  assume ($i14 == 1);
  assume {:sourceloc "./output/divbin2_tmp.c", 44, 19} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32($i12, 1);
  call {:cexpr "q"} boogie_si_record_i32($i17);
  assume {:sourceloc "./output/divbin2_tmp.c", 45, 19} true;
  assume {:verifier.code 0} true;
  $i18 := $sub.i32($i5, $i13);
  call {:cexpr "r"} boogie_si_record_i32($i18);
  assume {:sourceloc "./output/divbin2_tmp.c", 46, 9} true;
  assume {:verifier.code 0} true;
  $i15, $i16 := $i17, $i18;
  goto $bb11;
$bb10:
