...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 11, 22} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "SIZE"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 13, 4} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i32.i64($i0);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 13, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $i4 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 14, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4, $i0);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 14, 4} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i4);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.1, $p7);
  call {:cexpr "key"} boogie_si_record_i32($i8);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i4, 1);
  call {:cexpr "i"} boogie_si_record_i32($i9);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $i9;
  goto $bb4;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i29 := 1;
  goto $bb14;
$bb4:
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 17, 15} true;
  assume {:verifier.code 0} true;
  $i11 := $sge.i32($i10, 0);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 17, 20} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb5:
  assume ($i11 == 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 17, 24} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.i32.i64($i10);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 17, 24} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p3, $mul.ref($i13, 4));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 17, 24} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.1, $p14);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 17, 28} true;
  assume {:verifier.code 0} true;
  $i16 := $sgt.i32($i15, $i8);
  assume {:verifier.code 0} true;
  $i12 := $i16;
...
$bb8:
  assume ($i12 == 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 18, 15} true;
  assume {:verifier.code 0} true;
  $i17 := $slt.i32($i10, 2);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb10, $bb11;
$bb9:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i10, 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i26 := $sext.i32.i64($i25);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p3, $mul.ref($i26, 4));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p27, $i8);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb10:
  assume ($i17 == 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 19, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 19, 13} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i10, 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 19, 10} true;
  assume {:verifier.code 0} true;
  $i22 := $sext.i32.i64($i21);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 19, 10} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p3, $mul.ref($i22, 4));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 19, 17} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 20, 16} true;
  assume {:verifier.code 0} true;
  $i24 := $sub.i32($i10, 1);
  ...
  goto $bb4;
$bb13:
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 14, 21} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i4, 1);
  call {:cexpr "j"} boogie_si_record_i32($i28);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 14, 4} true;
  assume {:verifier.code 0} true;
  $i4 := $i28;
  goto $bb1;
$bb14:
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 24, 13} true;
  assume {:verifier.code 0} true;
  $i30 := $ult.i32($i29, $i0);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i30 == 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 26} true;
  assume {:verifier.code 1} true;
  $i31 := $sub.i32($i29, 1);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 23} true;
  assume {:verifier.code 1} true;
  $i32 := $sext.i32.i64($i31);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 23} true;
  assume {:verifier.code 1} true;
  $p33 := $add.ref($p3, $mul.ref($i32, 4));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 23} true;
  assume {:verifier.code 1} true;
  $i34 := $load.i32($M.1, $p33);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 31} true;
  assume {:verifier.code 1} true;
  $i35 := $sext.i32.i64($i29);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 31} true;
  assume {:verifier.code 1} true;
  $p36 := $add.ref($p3, $mul.ref($i35, 4));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 31} true;
  assume {:verifier.code 1} true;
  $i37 := $load.i32($M.1, $p36);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 29} true;
  assume {:verifier.code 1} true;
  $i38 := $sle.i32($i34, $i37);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 29} true;
  assume {:verifier.code 1} true;
  $i39 := $zext.i1.i32($i38);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 25, 5} true;
  assume {:verifier.code 1} true;
...
$bb16:
  assume !(($i30 == 1));
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 27, 1} true;
  assume {:verifier.code 0} true;
  ...
  return;
$bb17:
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 24, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $add.i32($i29, 1);
  call {:cexpr "k"} boogie_si_record_i32($i40);
  assume {:sourceloc "./output/insertion_sort-1_tmp.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i29 := $i40;
  goto $bb14;
