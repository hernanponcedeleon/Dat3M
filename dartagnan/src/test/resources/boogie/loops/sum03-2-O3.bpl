...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum03-2-O3.bpl /Users/ponce/git/Dat3M/./output/sum03-2_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum03-2_tmp.c", 12, 22} true;
  ...
  call {:cexpr "loop1"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/sum03-2_tmp.c", 12, 51} true;
  assume {:verifier.code 0} true;
  call $i1 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_bv32($i1);
  call {:cexpr "n1"} boogie_si_record_bv32($i1);
  assume {:sourceloc "./output/sum03-2_tmp.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/sum03-2_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  goto $bb1;
}
