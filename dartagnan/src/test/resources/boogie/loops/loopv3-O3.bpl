...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/loopv3-O3.bpl /Users/ponce/git/Dat3M/./output/loopv3_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 44375));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/loopv3_tmp.c", 22, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/loopv3_tmp.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $i0 := $load.bv32($M.0, SIZE);
  assume {:sourceloc "./output/loopv3_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.bv32($i0, 0bv32);
  assume {:sourceloc "./output/loopv3_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i2 := 0bv32;
...
$bb2:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/loopv3_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/loopv3_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i5 := (if ($i4 == 1bv1) then 4bv32 else 8bv32);
  assume {:sourceloc "./output/loopv3_tmp.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $add.bv32($i5, $i2);
  call {:cexpr "i"} boogie_si_record_bv32($i6);
  assume {:sourceloc "./output/loopv3_tmp.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bv32($M.0, SIZE);
  assume {:sourceloc "./output/loopv3_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $slt.bv32($i6, $i7);
  assume {:sourceloc "./output/loopv3_tmp.c", 22, 3} true;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/loopv3_tmp.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
axiom (__SMACK_decls == $sub.ref(0, 39215));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 40247));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 41279));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 42311));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 43343));
...
axiom (__SMACK_static_init == $sub.ref(0, 44375));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bv32($M.0, SIZE, 50000001bv32);
  call {:cexpr "SIZE"} boogie_si_record_bv32(50000001bv32);
