...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum_natnum-O3.bpl /Users/ponce/git/Dat3M/./output/sum_natnum_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/sum_natnum_tmp.c", 6, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i0 := $load.bv32($M.0, SIZE);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.bv32($i0, 0bv32);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i2 := 0bv64;
...
$bb1:
  ...
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $add.bv32($i0, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv32.bv64($i3);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $shl.bv64($i4, 1bv64);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv32.bv64($i3);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $add.bv32($i0, $sub.bv32(0bv32, 2bv32));
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $lshr.bv64($i9, 1bv64);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i11 := $add.bv64($i5, $i10);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i12 := $add.bv64($i11, 1bv64);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 26, 42} true;
  assume {:verifier.code 0} true;
  $i2 := $i12;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum_natnum_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum_natnum_tmp.c", 26, 42} true;
  assume {:verifier.code 0} true;
  $i13 := $add.bv32($i0, 1bv32);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 26, 36} true;
  assume {:verifier.code 0} true;
  $i14 := $mul.bv32($i13, $i0);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 26, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $sdiv.bv32($i14, 2bv32);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 26, 29} true;
  assume {:verifier.code 0} true;
  $i16 := $sext.bv32.bv64($i15);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 26, 26} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.bv64($i2, $i16);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i17 == 1bv1);
  assume {:sourceloc "./output/sum_natnum_tmp.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb5:
  assume !(($i17 == 1bv1));
  assume {:sourceloc "./output/sum_natnum_tmp.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sum_natnum_tmp.c", 13, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sum_natnum_tmp.c", 13, 27} true;
  assume {:verifier.code 0} true;
...
axiom (__SMACK_decls == $sub.ref(0, 40247));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 41279));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 42311));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 43343));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 44375));
...
{
$bb0:
  $M.0 := $store.bv32($M.0, SIZE, 40000bv32);
  call {:cexpr "SIZE"} boogie_si_record_bv32(40000bv32);
