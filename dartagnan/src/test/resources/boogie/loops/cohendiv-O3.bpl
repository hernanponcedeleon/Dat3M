...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/cohendiv-O3.bpl /Users/ponce/git/Dat3M/./output/cohendiv_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/cohendiv_tmp.c", 7, 44} true;
...
$bb0:
  ...
  assume {:sourceloc "./output/cohendiv_tmp.c", 25, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/cohendiv_tmp.c", 27, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.bv32($i1, 1bv32);
  assume {:sourceloc "./output/cohendiv_tmp.c", 11, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 11, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/cohendiv_tmp.c", 11, 14} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i2 == 1bv1));
  assume {:verifier.code 0} true;
  $i3 := $shl.bv32($i1, 1bv32);
  assume {:sourceloc "./output/cohendiv_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $i4, $i5 := $i0, 0bv32;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/cohendiv_tmp.c", 36, 26} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.bv32($i5, $i1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 36, 29} true;
  assume {:verifier.code 0} true;
  $i7 := $add.bv32($i6, $i4);
  assume {:sourceloc "./output/cohendiv_tmp.c", 36, 22} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.bv32($i0, $i7);
  assume {:sourceloc "./output/cohendiv_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i23 == 1bv1));
  assume {:sourceloc "./output/cohendiv_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/cohendiv_tmp.c", 16, 17} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/cohendiv_tmp.c", 16, 17} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1bv1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 38, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.bv32($i4, $i1);
...
$bb7:
  assume ($i9 == 1bv1);
  assume {:sourceloc "./output/cohendiv_tmp.c", 61, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
$bb11:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/cohendiv_tmp.c", 48, 19} true;
  assume {:verifier.code 0} true;
  $i13 := $shl.bv32($i11, 1bv32);
  assume {:sourceloc "./output/cohendiv_tmp.c", 48, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.bv32($i4, $i13);
  assume {:sourceloc "./output/cohendiv_tmp.c", 48, 10} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  assume {:verifier.code 0} true;
  $i20 := $sub.bv32($i4, $i11);
  assume {:sourceloc "./output/cohendiv_tmp.c", 57, 8} true;
  assume {:verifier.code 0} true;
  $i21 := $add.bv32($i12, $i5);
...
$bb14:
  assume !(($i14 == 1bv1));
  assume {:sourceloc "./output/cohendiv_tmp.c", 51, 35} true;
  assume {:verifier.code 0} true;
  $i15 := $mul.bv32($i3, $i12);
  assume {:sourceloc "./output/cohendiv_tmp.c", 51, 26} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.bv32($i4, $i15);
  assume {:sourceloc "./output/cohendiv_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
