...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt3_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt3_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt3_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/sumt3_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 7, 16} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/sumt3_tmp.c", 8, 12} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/sumt3_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt3_tmp.c", 16, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt3_tmp.c", 17, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt3_tmp.c", 17, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6 := 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 17, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt3_tmp.c", 34, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 18, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $ult.i32($i6, $i0);
  assume {:sourceloc "./output/sumt3_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i7 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 24, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $urem.i32($i6, 3);
  assume {:sourceloc "./output/sumt3_tmp.c", 24, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/sumt3_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 32, 23} true;
  assume {:verifier.code 1} true;
  $i21 := $add.i32($i5, $i3);
  assume {:sourceloc "./output/sumt3_tmp.c", 32, 25} true;
  assume {:verifier.code 1} true;
  $i22 := $add.i32($i21, $i4);
  assume {:sourceloc "./output/sumt3_tmp.c", 32, 29} true;
  assume {:verifier.code 1} true;
  $i23 := $eq.i32($i22, $i6);
  assume {:sourceloc "./output/sumt3_tmp.c", 32, 29} true;
  assume {:verifier.code 1} true;
  $i24 := $zext.i1.i32($i23);
  assume {:sourceloc "./output/sumt3_tmp.c", 32, 3} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $urem.i32($i6, 2);
  assume {:sourceloc "./output/sumt3_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 25, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i5, 1);
  call {:cexpr "i"} boogie_si_record_i32($i10);
  assume {:sourceloc "./output/sumt3_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:sourceloc "./output/sumt3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 30, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i32($i6, 1);
...
$bb10:
  assume ($i15 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 29, 11} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i4, 1);
...
$bb11:
  assume !(($i15 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 27, 10} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i3, 1);
  call {:cexpr "j"} boogie_si_record_i32($i16);
  assume {:sourceloc "./output/sumt3_tmp.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $i17, $i18 := $i16, $i4;
  goto $bb12;
$bb12:
