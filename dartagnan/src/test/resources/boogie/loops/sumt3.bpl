...
{
$bb0:
  assume {:sourceloc "./output/sumt3_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt3_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt3_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt3_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt3_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sumt3_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sumt3_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt3_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt3_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt3_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/sumt3_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6 := 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt3_tmp.c", 35, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt3_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 23, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $ult.i32($i6, $i0);
  assume {:sourceloc "./output/sumt3_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i7 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 25, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $urem.i32($i6, 3);
  assume {:sourceloc "./output/sumt3_tmp.c", 25, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/sumt3_tmp.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 33, 23} true;
  assume {:verifier.code 1} true;
  $i21 := $add.i32($i5, $i3);
  assume {:sourceloc "./output/sumt3_tmp.c", 33, 25} true;
  assume {:verifier.code 1} true;
  $i22 := $add.i32($i21, $i4);
  assume {:sourceloc "./output/sumt3_tmp.c", 33, 29} true;
  assume {:verifier.code 1} true;
  $i23 := $eq.i32($i22, $i6);
  assume {:sourceloc "./output/sumt3_tmp.c", 33, 29} true;
  assume {:verifier.code 1} true;
  $i24 := $zext.i1.i32($i23);
  assume {:sourceloc "./output/sumt3_tmp.c", 33, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i24);
  assume {:sourceloc "./output/sumt3_tmp.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $urem.i32($i6, 2);
  assume {:sourceloc "./output/sumt3_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $ne.i32($i14, 0);
  assume {:sourceloc "./output/sumt3_tmp.c", 27, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 26, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i5, 1);
  call {:cexpr "i"} boogie_si_record_i32($i10);
  assume {:sourceloc "./output/sumt3_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
  $i11, $i12, $i13 := $i3, $i4, $i10;
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/sumt3_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt3_tmp.c", 31, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i32($i6, 1);
  call {:cexpr "l"} boogie_si_record_i32($i20);
  assume {:sourceloc "./output/sumt3_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6 := $i11, $i12, $i13, $i20;
  goto $bb4;
$bb10:
  assume ($i15 == 1);
  assume {:sourceloc "./output/sumt3_tmp.c", 30, 11} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i4, 1);
  call {:cexpr "k"} boogie_si_record_i32($i19);
  assume {:verifier.code 0} true;
  $i17, $i18 := $i3, $i19;
  goto $bb12;
$bb11:
  assume !(($i15 == 1));
  assume {:sourceloc "./output/sumt3_tmp.c", 28, 10} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i3, 1);
  call {:cexpr "j"} boogie_si_record_i32($i16);
  assume {:sourceloc "./output/sumt3_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $i17, $i18 := $i16, $i4;
  goto $bb12;
$bb12:
