...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/hhk2008-O3.bpl /Users/ponce/git/Dat3M/./output/hhk2008_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/hhk2008_tmp.c", 15, 13} true;
  ...
  assume {:sourceloc "./output/hhk2008_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/hhk2008_tmp.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
