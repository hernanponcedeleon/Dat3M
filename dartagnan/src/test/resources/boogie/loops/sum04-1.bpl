...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sum04-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum04-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sum04-1_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sum04-1_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sum04-1_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum04-1_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum04-1_tmp.c", 13, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "./output/sum04-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum04-1_tmp.c", 13, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $sle.i32($i0, 8);
  assume {:sourceloc "./output/sum04-1_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sum04-1_tmp.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, 4);
  assume {:sourceloc "./output/sum04-1_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $i1;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sum04-1_tmp.c", 17, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i1, 16);
  assume {:sourceloc "./output/sum04-1_tmp.c", 17, 32} true;
  assume {:verifier.code 0} true;
  $i8 := 1;
...
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "./output/sum04-1_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 2);
  call {:cexpr "sn"} boogie_si_record_i32($i5);
  assume {:sourceloc "./output/sum04-1_tmp.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i5;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:sourceloc "./output/sum04-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum04-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/sum04-1_tmp.c", 13, 22} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i0, 1);
...
$bb9:
  ...
  assume {:sourceloc "./output/sum04-1_tmp.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb10:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/sum04-1_tmp.c", 17, 38} true;
  assume {:verifier.code 1} true;
  $i9 := $eq.i32($i1, 0);
  assume {:sourceloc "./output/sum04-1_tmp.c", 17, 32} true;
  assume {:verifier.code 0} true;
