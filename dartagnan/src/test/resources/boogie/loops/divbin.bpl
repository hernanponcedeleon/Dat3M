...
procedure assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/divbin_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/divbin_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/divbin_tmp.c", 12, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/divbin_tmp.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/divbin_tmp.c", 12, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/divbin_tmp.c", 12, 14} true;
  assume {:verifier.code 0} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/divbin_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/divbin_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/divbin_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/divbin_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/divbin_tmp.c", 15, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/divbin_tmp.c", 17, 9} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/divbin_tmp.c", 25, 9} true;
  ...
  assume {:sourceloc "./output/divbin_tmp.c", 26, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/divbin_tmp.c", 27, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i1, 2147483647);
  assume {:sourceloc "./output/divbin_tmp.c", 27, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "./output/divbin_tmp.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i3);
  assume {:sourceloc "./output/divbin_tmp.c", 28, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $uge.i32($i1, 1);
  assume {:sourceloc "./output/divbin_tmp.c", 28, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "./output/divbin_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i5);
  assume {:sourceloc "./output/divbin_tmp.c", 34, 5} true;
  assume {:verifier.code 0} true;
  $i6 := $i1;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/divbin_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/divbin_tmp.c", 35, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $uge.i32($i0, $i6);
  assume {:sourceloc "./output/divbin_tmp.c", 35, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "./output/divbin_tmp.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32(2, $i6);
...
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "./output/divbin_tmp.c", 35, 24} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/divbin_tmp.c", 39, 5} true;
  assume {:verifier.code 0} true;
  $i9, $i10, $i11 := 0, $i0, $i6;
  goto $bb5;
$bb5:
  ...
  assume {:sourceloc "./output/divbin_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/divbin_tmp.c", 40, 34} true;
  assume {:verifier.code 1} true;
  $i12 := $mul.i32($i9, $i11);
  assume {:sourceloc "./output/divbin_tmp.c", 40, 38} true;
  assume {:verifier.code 1} true;
  $i13 := $add.i32($i12, $i10);
  assume {:sourceloc "./output/divbin_tmp.c", 40, 29} true;
  assume {:verifier.code 1} true;
  $i14 := $eq.i32($i0, $i13);
  assume {:sourceloc "./output/divbin_tmp.c", 40, 29} true;
  assume {:verifier.code 1} true;
  $i15 := $zext.i1.i32($i14);
  assume {:sourceloc "./output/divbin_tmp.c", 40, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i15);
  assume {:sourceloc "./output/divbin_tmp.c", 41, 17} true;
  assume {:verifier.code 0} true;
  $i16 := $ne.i32($i11, $i1);
  assume {:sourceloc "./output/divbin_tmp.c", 41, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i16 == 1);
  assume {:sourceloc "./output/divbin_tmp.c", 43, 15} true;
  assume {:verifier.code 0} true;
  $i17 := $mul.i32(2, $i9);
  call {:cexpr "q"} boogie_si_record_i32($i17);
  assume {:sourceloc "./output/divbin_tmp.c", 44, 15} true;
  assume {:verifier.code 0} true;
  $i18 := $udiv.i32($i11, 2);
  call {:cexpr "b"} boogie_si_record_i32($i18);
  assume {:sourceloc "./output/divbin_tmp.c", 45, 15} true;
  assume {:verifier.code 0} true;
  $i19 := $uge.i32($i10, $i18);
  assume {:sourceloc "./output/divbin_tmp.c", 45, 13} true;
  assume {:verifier.code 0} true;
  $i20, $i21 := $i17, $i10;
...
$bb7:
  assume !(($i16 == 1));
  assume {:sourceloc "./output/divbin_tmp.c", 41, 24} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "./output/divbin_tmp.c", 51, 30} true;
  assume {:verifier.code 1} true;
  $i24 := $mul.i32($i9, $i11);
  assume {:sourceloc "./output/divbin_tmp.c", 51, 34} true;
  assume {:verifier.code 1} true;
  $i25 := $add.i32($i24, $i10);
  assume {:sourceloc "./output/divbin_tmp.c", 51, 25} true;
  assume {:verifier.code 1} true;
  $i26 := $eq.i32($i0, $i25);
  assume {:sourceloc "./output/divbin_tmp.c", 51, 25} true;
  assume {:verifier.code 1} true;
  $i27 := $zext.i1.i32($i26);
  assume {:sourceloc "./output/divbin_tmp.c", 51, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i27);
  assume {:sourceloc "./output/divbin_tmp.c", 52, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb9:
  assume ($i19 == 1);
  assume {:sourceloc "./output/divbin_tmp.c", 46, 19} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i17, 1);
  call {:cexpr "q"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/divbin_tmp.c", 47, 19} true;
  assume {:verifier.code 0} true;
  $i23 := $sub.i32($i10, $i18);
  call {:cexpr "r"} boogie_si_record_i32($i23);
  assume {:sourceloc "./output/divbin_tmp.c", 48, 9} true;
  assume {:verifier.code 0} true;
  $i20, $i21 := $i22, $i23;
  goto $bb11;
$bb10:
