...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/mannadiv-O3.bpl /Users/ponce/git/Dat3M/./output/mannadiv_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/mannadiv_tmp.c", 8, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/mannadiv_tmp.c", 24, 10} true;
  ...
  assume {:sourceloc "./output/mannadiv_tmp.c", 25, 10} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "./output/mannadiv_tmp.c", 12, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.bv32($i0, 0bv32);
  assume {:sourceloc "./output/mannadiv_tmp.c", 12, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/mannadiv_tmp.c", 12, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/mannadiv_tmp.c", 12, 14} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/mannadiv_tmp.c", 28, 28} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.bv32($i1, 0bv32);
  assume {:sourceloc "./output/mannadiv_tmp.c", 12, 6} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i3 == 1bv1));
  assume {:sourceloc "./output/mannadiv_tmp.c", 37, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.bv32($i0, 0bv32);
  assume {:sourceloc "./output/mannadiv_tmp.c", 37, 13} true;
  assume {:verifier.code 0} true;
  $i5, $i6, $i7, $i8 := 0bv32, 0bv32, 0bv32, $i0;
...
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mannadiv_tmp.c", 48, 34} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.bv32($i5, $i0);
  assume {:sourceloc "./output/mannadiv_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/mannadiv_tmp.c", 39, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $add.bv32($i7, 1bv32);
  assume {:sourceloc "./output/mannadiv_tmp.c", 39, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.bv32($i12, $i1);
  assume {:sourceloc "./output/mannadiv_tmp.c", 39, 13} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.bv1.bv32($i13);
  assume {:sourceloc "./output/mannadiv_tmp.c", 39, 13} true;
  assume {:verifier.code 0} true;
  $i15 := $add.bv32($i6, $i14);
  assume {:sourceloc "./output/mannadiv_tmp.c", 39, 13} true;
  assume {:verifier.code 0} true;
  $i16 := (if ($i13 == 1bv1) then 0bv32 else $i12);
  assume {:sourceloc "./output/mannadiv_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i10 := $add.bv32($i8, $sub.bv32(0bv32, 1bv32));
  call {:cexpr "y3"} boogie_si_record_bv32($i10);
  assume {:sourceloc "./output/mannadiv_tmp.c", 35, 29} true;
  assume {:verifier.code 0} true;
  $i17 := $mul.bv32($i15, $i1);
  assume {:sourceloc "./output/mannadiv_tmp.c", 35, 33} true;
  assume {:verifier.code 0} true;
  $i11 := $add.bv32($i17, $i16);
  assume {:sourceloc "./output/mannadiv_tmp.c", 35, 38} true;
  assume {:verifier.code 0} true;
  $i18 := $add.bv32($i11, $i10);
  assume {:sourceloc "./output/mannadiv_tmp.c", 35, 43} true;
  assume {:verifier.code 0} true;
  $i19 := $eq.bv32($i18, $i0);
  assume {:sourceloc "./output/mannadiv_tmp.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume !(($i19 == 1bv1));
  assume {:sourceloc "./output/mannadiv_tmp.c", 17, 10} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/mannadiv_tmp.c", 17, 24} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/mannadiv_tmp.c", 17, 24} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i9 == 1bv1));
  assume {:verifier.code 0} true;
  $i6, $i7, $i8 := $i15, $i16, $i10;
  goto $bb8;
$bb13:
  assume ($i20 == 1bv1);
  assume {:sourceloc "./output/mannadiv_tmp.c", 49, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
