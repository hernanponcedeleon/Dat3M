...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/trex02-2-O3.bpl /Users/ponce/git/Dat3M/./output/trex02-2_tmp.c
...
$bb0:
  ...
  assume {:sourceloc "./output/trex02-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, x, $i0);
...
$bb2:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i3);
  assume {:sourceloc "./output/trex02-2_tmp.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, x);
  assume {:sourceloc "./output/trex02-2_tmp.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $i5 := $add.bv32($i4, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/trex02-2_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, x, $i5);
  call {:cexpr "x"} boogie_si_record_bv32($i5);
  assume {:sourceloc "./output/trex02-2_tmp.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $sgt.bv32($i5, 0bv32);
  assume {:sourceloc "./output/trex02-2_tmp.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $i5;
...
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 41279));
...
{
$bb0:
  $M.0 := $store.bv32($M.0, x, 0bv32);
  call {:cexpr "x"} boogie_si_record_bv32(0bv32);
