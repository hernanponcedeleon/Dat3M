...
{
$bb0:
  assume {:sourceloc "./output/iftelse_tmp.c", 3, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/iftelse_tmp.c", 9, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/iftelse_tmp.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/iftelse_tmp.c", 9, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/iftelse_tmp.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/iftelse_tmp.c", 9, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/iftelse_tmp.c", 10, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/iftelse_tmp.c", 10, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/iftelse_tmp.c", 10, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/iftelse_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/iftelse_tmp.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/iftelse_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/iftelse_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/iftelse_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5 := 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/iftelse_tmp.c", 19, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/iftelse_tmp.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/iftelse_tmp.c", 20, 13} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/iftelse_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/iftelse_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/iftelse_tmp.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i4, $i0);
  assume {:sourceloc "./output/iftelse_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./output/iftelse_tmp.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i4, 3);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "./output/iftelse_tmp.c", 23, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $urem.i32($i7, 2);
  assume {:sourceloc "./output/iftelse_tmp.c", 23, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "./output/iftelse_tmp.c", 23, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/iftelse_tmp.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "./output/iftelse_tmp.c", 24, 11} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i5, 3);
  call {:cexpr "j"} boogie_si_record_i32($i10);
  assume {:sourceloc "./output/iftelse_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
  $i11, $i12 := $i3, $i10;
  goto $bb9;
$bb8:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/iftelse_tmp.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i3, 3);
...
$bb9:
  ...
  assume {:sourceloc "./output/iftelse_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/iftelse_tmp.c", 27, 9} true;
  assume {:verifier.code 0} true;
  $i14 := $ugt.i32($i0, 0);
  assume {:sourceloc "./output/iftelse_tmp.c", 27, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i14 == 1);
  assume {:sourceloc "./output/iftelse_tmp.c", 28, 25} true;
  assume {:verifier.code 1} true;
  $i15 := $udiv.i32($i7, 2);
  assume {:sourceloc "./output/iftelse_tmp.c", 28, 27} true;
  assume {:verifier.code 1} true;
  $i16 := $ule.i32($i15, $i12);
  assume {:sourceloc "./output/iftelse_tmp.c", 28, 27} true;
  assume {:verifier.code 1} true;
  $i17 := $zext.i1.i32($i16);
  assume {:sourceloc "./output/iftelse_tmp.c", 28, 4} true;
  assume {:verifier.code 1} true;
