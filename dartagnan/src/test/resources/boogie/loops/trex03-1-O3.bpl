...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/trex03-1-O3.bpl /Users/ponce/git/Dat3M/./output/trex03-1_tmp.c
...
$bb0:
  ...
  call {:cexpr "x1"} boogie_si_record_bv32($i0);
  ...
  call {:cexpr "x2"} boogie_si_record_bv32($i1);
  ...
  call {:cexpr "x3"} boogie_si_record_bv32($i2);
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i4);
  ...
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
  $i10, $i11, $i12, $i13, $i14, $i15, $i16, $i17 := $i4, $i3, $i0, $i1, $i2, $i2, $i1, $i0;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i18 := $add.bv32($i12, $sub.bv32(0bv32, 1bv32));
  call {:cexpr "x1"} boogie_si_record_bv32($i18);
  assume {:sourceloc "./output/trex03-1_tmp.c", 22, 13} true;
  assume {:verifier.code 0} true;
  $i19, $i20, $i21 := $i14, $i13, $i18;
  goto $bb7;
$bb6:
  assume !(($i11 == 1bv1));
...
$bb7:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i24);
  assume {:sourceloc "./output/trex03-1_tmp.c", 26, 8} true;
  assume {:verifier.code 0} true;
  call $i25 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i25);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $ne.bv32($i21, 0bv32);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 19} true;
  assume {:verifier.code 0} true;
  $i27 := $ne.bv32($i20, 0bv32);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
  $i28 := $and.bv1($i27, $i26);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 27} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.bv32($i19, 0bv32);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
  $i30 := $and.bv1($i29, $i28);
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
  $i15, $i16, $i17 := $i19, $i20, $i21;
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  $i22 := $add.bv32($i13, $sub.bv32(0bv32, 1bv32));
  call {:cexpr "x2"} boogie_si_record_bv32($i22);
  assume {:sourceloc "./output/trex03-1_tmp.c", 23, 18} true;
  assume {:verifier.code 0} true;
  $i19, $i20, $i21 := $i14, $i22, $i12;
  goto $bb7;
$bb9:
  assume !(($i10 == 1bv1));
  assume {:sourceloc "./output/trex03-1_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i23 := $add.bv32($i14, $sub.bv32(0bv32, 1bv32));
  call {:cexpr "x3"} boogie_si_record_bv32($i23);
  assume {:verifier.code 0} true;
  $i19, $i20, $i21 := $i23, $i13, $i12;
  goto $bb7;
$bb10:
  assume ($i30 == 1bv1);
  assume {:verifier.code 0} true;
  $i10, $i11, $i12, $i13, $i14 := $i25, $i24, $i21, $i20, $i19;
  goto $bb2;
$bb11:
  assume {:sourceloc "./output/trex03-1_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i33 == 1bv1);
  assume {:sourceloc "./output/trex03-1_tmp.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 39219));
