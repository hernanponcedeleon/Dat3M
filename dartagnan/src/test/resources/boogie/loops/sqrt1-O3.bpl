...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sqrt1-O3.bpl /Users/ponce/git/Dat3M/./output/sqrt1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sqrt1_tmp.c", 21, 9} true;
  ...
  assume {:sourceloc "./output/sqrt1_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.bv32($i0, 1bv32);
  assume {:sourceloc "./output/sqrt1_tmp.c", 33, 13} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 1bv32, 1bv32;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/sqrt1_tmp.c", 45, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sqrt1_tmp.c", 37, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $add.bv32($i3, 2bv32);
  assume {:sourceloc "./output/sqrt1_tmp.c", 38, 15} true;
  assume {:verifier.code 0} true;
  $i5 := $add.bv32($i4, $i2);
  assume {:sourceloc "./output/sqrt1_tmp.c", 33, 17} true;
  assume {:verifier.code 0} true;
