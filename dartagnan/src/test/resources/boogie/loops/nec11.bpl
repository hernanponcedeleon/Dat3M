...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/nec11_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/nec11_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/nec11_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/nec11_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/nec11_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/nec11_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/nec11_tmp.c", 15, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/nec11_tmp.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  call {:cexpr "c"} boogie_si_record_i8($i2);
  assume {:sourceloc "./output/nec11_tmp.c", 19, 4} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/nec11_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/nec11_tmp.c", 19, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i8.i1($i2);
  assume {:sourceloc "./output/nec11_tmp.c", 19, 4} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./output/nec11_tmp.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i3, 4);
  assume {:sourceloc "./output/nec11_tmp.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $i3;
...
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./output/nec11_tmp.c", 28, 25} true;
  assume {:verifier.code 1} true;
  $i10 := $eq.i32($i3, 5);
  assume {:sourceloc "./output/nec11_tmp.c", 28, 25} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/nec11_tmp.c", 28, 4} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "./output/nec11_tmp.c", 29, 4} true;
  assume {:verifier.code 0} true;
  $r := 1;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "./output/nec11_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:sourceloc "./output/nec11_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/nec11_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "./output/nec11_tmp.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 20)), $mul.ref($i7, 4));
  assume {:sourceloc "./output/nec11_tmp.c", 24, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p8, 0);
  assume {:sourceloc "./output/nec11_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i6, 1);
