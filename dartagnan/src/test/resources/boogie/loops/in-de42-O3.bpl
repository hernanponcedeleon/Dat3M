...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/in-de42-O3.bpl /Users/ponce/git/Dat3M/./output/in-de42_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/in-de42_tmp.c", 13, 20} true;
  ...
  assume {:sourceloc "./output/in-de42_tmp.c", 41, 3} true;
