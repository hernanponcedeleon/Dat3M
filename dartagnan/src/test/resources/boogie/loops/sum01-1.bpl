...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sum01-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sum01-1_tmp.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sum01-1_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sum01-1_tmp.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sum01-1_tmp.c", 4, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sum01-1_tmp.c", 5, 12} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum01-1_tmp.c", 12, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum01-1_tmp.c", 13, 7} true;
  assume {:verifier.code 0} true;
  $i1, $i2 := 1, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/sum01-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum01-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum01-1_tmp.c", 13, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $sle.i32($i1, $i0);
  assume {:sourceloc "./output/sum01-1_tmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i1, 10);
  assume {:sourceloc "./output/sum01-1_tmp.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $i2;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./output/sum01-1_tmp.c", 17, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($i0, 2);
  assume {:sourceloc "./output/sum01-1_tmp.c", 17, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i2, $i8);
  assume {:sourceloc "./output/sum01-1_tmp.c", 17, 29} true;
  assume {:verifier.code 0} true;
  $i10 := 1;
...
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i2, 2);
  call {:cexpr "sn"} boogie_si_record_i32($i6);
  assume {:sourceloc "./output/sum01-1_tmp.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $i6;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:sourceloc "./output/sum01-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sum01-1_tmp.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/sum01-1_tmp.c", 13, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
...
$bb9:
  ...
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i10);
  assume {:sourceloc "./output/sum01-1_tmp.c", 17, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i12);
  assume {:sourceloc "./output/sum01-1_tmp.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb10:
  assume !(($i9 == 1));
  assume {:sourceloc "./output/sum01-1_tmp.c", 17, 35} true;
  assume {:verifier.code 1} true;
  $i11 := $eq.i32($i2, 0);
  assume {:sourceloc "./output/sum01-1_tmp.c", 17, 29} true;
  assume {:verifier.code 0} true;
