...
{
$bb0:
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 6, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 6, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 6, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 7, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 19, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(11, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 19, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 19, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i1, 10);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 13} true;
  assume {:verifier.code 0} true;
  call $i3 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_i8($i3);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i1);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref($i4, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 20, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p5, $i3);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref(10, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 23, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p7, 0);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64(0);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref($i8, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 27, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, $p9);
  call {:cexpr "c"} boogie_si_record_i8($i10);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $i11, $i12, $i13 := $i10, 0, 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 19, 24} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
...
$bb5:
  ...
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i8.i32($i11);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $sle.i32(48, $i14);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 21} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb6:
  assume ($i15 == 1);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 25} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i8.i32($i11);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 27} true;
  assume {:verifier.code 0} true;
  $i18 := $sle.i32($i17, 57);
  assume {:verifier.code 0} true;
  $i16 := $i18;
...
$bb9:
  assume ($i16 == 1);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 30, 9} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i8.i32($i11);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 30, 11} true;
  assume {:verifier.code 0} true;
  $i20 := $sub.i32($i19, 48);
  call {:cexpr "j"} boogie_si_record_i32($i20);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 31, 11} true;
  assume {:verifier.code 0} true;
  $i21 := $mul.i32($i12, 10);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 31, 17} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i21, $i20);
  call {:cexpr "i"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 32, 11} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i13, 1);
  call {:cexpr "idx_in"} boogie_si_record_i32($i23);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $i24 := $sext.i32.i64($i23);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p0, $mul.ref(0, 11)), $mul.ref($i24, 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, $p25);
  call {:cexpr "c"} boogie_si_record_i8($i26);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $i11, $i12, $i13 := $i26, $i22, $i23;
  goto $bb5;
$bb10:
  assume !(($i16 == 1));
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 36, 24} true;
  assume {:verifier.code 1} true;
  $i27 := $uge.i32($i12, 0);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 36, 24} true;
  assume {:verifier.code 1} true;
  $i28 := $zext.i1.i32($i27);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 36, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i28);
  assume {:sourceloc "./output/veris.c_sendmail_tTflag_arr_one_loop_tmp.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_char == $sub.ref(0, 15483));
