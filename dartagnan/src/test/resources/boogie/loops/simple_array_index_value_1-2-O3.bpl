...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/simple_array_index_value_1-2-O3.bpl /Users/ponce/git/Dat3M/./output/simple_array_index_value_1-2_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 8, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 30, 13} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "index"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 31, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $ugt.bv32($i0, 9999bv32);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 31, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1bv1);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 16, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 16, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 16, 27} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  call {:cexpr "index"} boogie_si_record_bv32($i2);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 31, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $ugt.bv32($i2, 9999bv32);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 31, 9} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i3 == 1bv1);
  assume {:sourceloc "./output/simple_array_index_value_1-2_tmp.c", 41, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
