...
{
$bb0:
  assume {:sourceloc "./output/invert_string-3_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/invert_string-3_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/invert_string-3_tmp.c", 5, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/invert_string-3_tmp.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/invert_string-3_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/invert_string-3_tmp.c", 6, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/invert_string-3_tmp.c", 14, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/invert_string-3_tmp.c", 14, 5} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(1, $i3));
  assume true;
  assume {:sourceloc "./output/invert_string-3_tmp.c", 17, 10} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "./output/invert_string-3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/invert_string-3_tmp.c", 17, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i5, 5);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 17, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 18, 17} true;
  assume {:verifier.code 0} true;
  call $i7 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_i8($i7);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i5);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p2, $mul.ref($i8, 1));
  assume {:sourceloc "./output/invert_string-3_tmp.c", 18, 16} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p9, $i7);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 19, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i6 == 1));
  assume {:sourceloc "./output/invert_string-3_tmp.c", 21, 13} true;
  assume {:verifier.code 0} true;
  $i11 := $sub.i32(5, 1);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i32.i64($i11);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p2, $mul.ref($i12, 1));
  assume {:sourceloc "./output/invert_string-3_tmp.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p13, 0);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 25, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i32(5, 1);
  call {:cexpr "i"} boogie_si_record_i32($i14);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 25, 10} true;
  assume {:verifier.code 0} true;
  $i15, $i16 := $i14, 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "./output/invert_string-3_tmp.c", 17, 23} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i5, 1);
...
$bb5:
  ...
  assume {:sourceloc "./output/invert_string-3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/invert_string-3_tmp.c", 25, 25} true;
  assume {:verifier.code 0} true;
  $i17 := $sge.i32($i15, 0);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 25, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i17 == 1);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 26, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.1, $p19);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 26, 9} true;
  assume {:verifier.code 0} true;
  $i21 := $sext.i32.i64($i16);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 26, 9} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p4, $mul.ref($i21, 1));
  assume {:sourceloc "./output/invert_string-3_tmp.c", 26, 17} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i8($M.2, $p22, $i20);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 27, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i16, 1);
  call {:cexpr "j"} boogie_si_record_i32($i23);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !(($i17 == 1));
  assume {:sourceloc "./output/invert_string-3_tmp.c", 30, 12} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.i32(5, 1);
  call {:cexpr "j"} boogie_si_record_i32($i25);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 31, 10} true;
  assume {:verifier.code 0} true;
  $i26, $i27 := 0, $i25;
  goto $bb9;
$bb8:
  assume {:sourceloc "./output/invert_string-3_tmp.c", 25, 32} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i15, $sub.i32(0, 1));
...
$bb9:
  ...
  assume {:sourceloc "./output/invert_string-3_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/invert_string-3_tmp.c", 31, 16} true;
  assume {:verifier.code 0} true;
  $i28 := $ult.i32($i26, 5);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i28 == 1);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 32, 25} true;
  ...
  assume {:verifier.code 1} true;
  $i32 := $sext.i8.i32($i31);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 32, 36} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i36 := $sext.i8.i32($i35);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 32, 33} true;
  assume {:verifier.code 1} true;
  $i37 := $eq.i32($i32, $i36);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 32, 33} true;
  assume {:verifier.code 1} true;
  $i38 := $zext.i1.i32($i37);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 32, 7} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i38);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 33, 8} true;
  assume {:verifier.code 0} true;
  $i39 := $add.i32($i27, $sub.i32(0, 1));
  call {:cexpr "j"} boogie_si_record_i32($i39);
  assume {:sourceloc "./output/invert_string-3_tmp.c", 34, 5} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !(($i28 == 1));
  assume {:sourceloc "./output/invert_string-3_tmp.c", 35, 1} true;
  assume {:verifier.code 0} true;
  ...
  return;
$bb12:
  assume {:sourceloc "./output/invert_string-3_tmp.c", 31, 23} true;
  assume {:verifier.code 0} true;
  $i40 := $add.i32($i26, 1);
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 29931));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 30963));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 31995));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 33027));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 34059));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 35091));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 36123));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 37155));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 38187));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 39219));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 40251));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 41283));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 42315));
