...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/sum_by_3-O3.bpl /Users/ponce/git/Dat3M/./output/sum_by_3_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/sum_by_3_tmp.c", 2, 44} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sum_by_3_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sum_by_3_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, SIZE);
  assume {:sourceloc "./output/sum_by_3_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.bv32($i0, $i1);
  assume {:sourceloc "./output/sum_by_3_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/sum_by_3_tmp.c", 33, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb3:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "./output/sum_by_3_tmp.c", 31, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $mul.bv32($i0, 3bv32);
  assume {:sourceloc "./output/sum_by_3_tmp.c", 31, 28} true;
  assume {:verifier.code 0} true;
  $i4 := $udiv.bv32($i3, 3bv32);
  assume {:sourceloc "./output/sum_by_3_tmp.c", 31, 31} true;
  assume {:verifier.code 0} true;
  $i5 := $ugt.bv32($i4, $i1);
  assume {:sourceloc "./output/sum_by_3_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i5 == 1bv1);
  assume {:sourceloc "./output/sum_by_3_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sum_by_3_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sum_by_3_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
