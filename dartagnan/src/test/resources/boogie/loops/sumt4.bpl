...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt4_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt4_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt4_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/sumt4_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 7, 16} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/sumt4_tmp.c", 8, 12} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/sumt4_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt4_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt4_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt4_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7 := 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt4_tmp.c", 33, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt4_tmp.c", 16, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 15, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 19, 12} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i32($i4, $i0);
  assume {:sourceloc "./output/sumt4_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i4, 4);
  assume {:sourceloc "./output/sumt4_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
  assume {:sourceloc "./output/sumt4_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 31, 23} true;
  assume {:verifier.code 1} true;
  $i29 := $add.i32($i7, $i5);
  assume {:sourceloc "./output/sumt4_tmp.c", 31, 25} true;
  assume {:verifier.code 1} true;
  $i30 := $add.i32($i29, $i6);
  assume {:sourceloc "./output/sumt4_tmp.c", 31, 27} true;
  assume {:verifier.code 1} true;
  $i31 := $add.i32($i30, $i3);
  assume {:sourceloc "./output/sumt4_tmp.c", 31, 32} true;
  assume {:verifier.code 1} true;
  $i32 := $eq.i32($i31, $i4);
  assume {:sourceloc "./output/sumt4_tmp.c", 31, 32} true;
  assume {:verifier.code 1} true;
  $i33 := $zext.i1.i32($i32);
  assume {:sourceloc "./output/sumt4_tmp.c", 31, 3} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $urem.i32($i4, 3);
  assume {:sourceloc "./output/sumt4_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i17 := $ne.i32($i16, 0);
  assume {:sourceloc "./output/sumt4_tmp.c", 23, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i3, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/sumt4_tmp.c", 22, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:sourceloc "./output/sumt4_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 29, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i4, 1);
...
$bb10:
  assume ($i17 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i22 := $urem.i32($i4, 2);
  assume {:sourceloc "./output/sumt4_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  assume {:sourceloc "./output/sumt4_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i23 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 28, 11} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i6, 1);
...
$bb14:
  assume !(($i23 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i5, 1);
  call {:cexpr "j"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/sumt4_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $i25, $i26 := $i24, $i6;
  goto $bb15;
$bb15:
