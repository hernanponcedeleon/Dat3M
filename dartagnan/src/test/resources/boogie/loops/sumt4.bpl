...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 46439));
...
{
$bb0:
  assume {:sourceloc "./output/sumt4_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt4_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt4_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt4_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt4_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sumt4_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sumt4_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt4_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt4_tmp.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt4_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/sumt4_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7 := 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 19, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt4_tmp.c", 34, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt4_tmp.c", 17, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i32($i4, $i0);
  assume {:sourceloc "./output/sumt4_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i4, 4);
  assume {:sourceloc "./output/sumt4_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
  assume {:sourceloc "./output/sumt4_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 32, 23} true;
  assume {:verifier.code 1} true;
  $i29 := $add.i32($i7, $i5);
  assume {:sourceloc "./output/sumt4_tmp.c", 32, 25} true;
  assume {:verifier.code 1} true;
  $i30 := $add.i32($i29, $i6);
  assume {:sourceloc "./output/sumt4_tmp.c", 32, 27} true;
  assume {:verifier.code 1} true;
  $i31 := $add.i32($i30, $i3);
  assume {:sourceloc "./output/sumt4_tmp.c", 32, 32} true;
  assume {:verifier.code 1} true;
  $i32 := $eq.i32($i31, $i4);
  assume {:sourceloc "./output/sumt4_tmp.c", 32, 32} true;
  assume {:verifier.code 1} true;
  $i33 := $zext.i1.i32($i32);
  assume {:sourceloc "./output/sumt4_tmp.c", 32, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i33);
  assume {:sourceloc "./output/sumt4_tmp.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $urem.i32($i4, 3);
  assume {:sourceloc "./output/sumt4_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i17 := $ne.i32($i16, 0);
  assume {:sourceloc "./output/sumt4_tmp.c", 24, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i3, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i11);
  assume {:sourceloc "./output/sumt4_tmp.c", 23, 6} true;
  assume {:verifier.code 0} true;
  $i12, $i13, $i14, $i15 := $i11, $i5, $i6, $i7;
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/sumt4_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt4_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt4_tmp.c", 30, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i4, 1);
  call {:cexpr "l"} boogie_si_record_i32($i28);
  assume {:sourceloc "./output/sumt4_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7 := $i12, $i28, $i13, $i14, $i15;
  goto $bb4;
$bb10:
  assume ($i17 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i22 := $urem.i32($i4, 2);
  assume {:sourceloc "./output/sumt4_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i22, 0);
  assume {:sourceloc "./output/sumt4_tmp.c", 26, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 25, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i7, 1);
  call {:cexpr "i"} boogie_si_record_i32($i18);
  assume {:sourceloc "./output/sumt4_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $i19, $i20, $i21 := $i5, $i6, $i18;
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/sumt4_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i12, $i13, $i14, $i15 := $i3, $i19, $i20, $i21;
  goto $bb9;
$bb13:
  assume ($i23 == 1);
  assume {:sourceloc "./output/sumt4_tmp.c", 29, 11} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i6, 1);
  call {:cexpr "k"} boogie_si_record_i32($i27);
  assume {:verifier.code 0} true;
  $i25, $i26 := $i5, $i27;
  goto $bb15;
$bb14:
  assume !(($i23 == 1));
  assume {:sourceloc "./output/sumt4_tmp.c", 27, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i5, 1);
  call {:cexpr "j"} boogie_si_record_i32($i24);
  assume {:sourceloc "./output/sumt4_tmp.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $i25, $i26 := $i24, $i6;
  goto $bb15;
$bb15:
...
axiom (__SMACK_nondet_int == $sub.ref(0, 23735));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 24767));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 25799));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 26831));
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 41279));
...
axiom (__SMACK_decls == $sub.ref(0, 42311));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 43343));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 44375));
...
axiom (llvm.dbg.value == $sub.ref(0, 45407));
procedure llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 46439));
