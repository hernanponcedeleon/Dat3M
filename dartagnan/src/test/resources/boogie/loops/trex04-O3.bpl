...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/trex04-O3.bpl /Users/ponce/git/Dat3M/./output/trex04_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/trex04_tmp.c", 29, 11} true;
  ...
  assume {:sourceloc "./output/trex04_tmp.c", 30, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $add.bv32($i0, 1000000bv32);
  assume {:sourceloc "./output/trex04_tmp.c", 30, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i1, 2000001bv32);
  assume {:sourceloc "./output/trex04_tmp.c", 30, 22} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "./output/trex04_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i3);
  assume {:sourceloc "./output/trex04_tmp.c", 31, 41} true;
  assume {:verifier.code 0} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i4);
  assume {:sourceloc "./output/trex04_tmp.c", 33, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $xor.bv1($i3, 1bv1);
  assume {:sourceloc "./output/trex04_tmp.c", 33, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv1.bv32($i5);
  call {:cexpr "d"} boogie_si_record_bv32($i6);
  assume {:sourceloc "./output/trex04_tmp.c", 34, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/trex04_tmp.c", 47, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1bv1);
  assume {:sourceloc "./output/trex04_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  call $i7 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i7);
  assume {:sourceloc "./output/trex04_tmp.c", 20, 41} true;
  assume {:verifier.code 0} true;
  call $i8 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i8);
  assume {:sourceloc "./output/trex04_tmp.c", 34, 11} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "./output/trex04_tmp.c", 34, 7} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./output/trex04_tmp.c", 36, 6} true;
  assume {:verifier.code 0} true;
  call $i9 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i9);
  assume {:sourceloc "./output/trex04_tmp.c", 36, 35} true;
  assume {:verifier.code 0} true;
  call $i10 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i10);
  assume {:sourceloc "./output/trex04_tmp.c", 38, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  assume {:sourceloc "./output/trex04_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  call $i11 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i11);
  assume {:sourceloc "./output/trex04_tmp.c", 20, 41} true;
  assume {:verifier.code 0} true;
  call $i12 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_bv1($i12);
  assume {:sourceloc "./output/trex04_tmp.c", 38, 11} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume {:sourceloc "./output/trex04_tmp.c", 38, 7} true;
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/trex04_tmp.c", 39, 17} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.bv1.bv32($i3);
  assume {:sourceloc "./output/trex04_tmp.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $i14 := (if ($i10 == 1bv1) then $i13 else $i6);
  call {:cexpr "d"} boogie_si_record_bv32($i14);
  assume {:sourceloc "./output/trex04_tmp.c", 41, 3} true;
  assume {:verifier.code 0} true;
  $i15 := $i0;
  goto $bb10;
$bb10:
  assume {:sourceloc "./output/trex04_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/trex04_tmp.c", 41, 10} true;
  assume {:verifier.code 0} true;
  $i16 := $sgt.bv32($i15, 0bv32);
  assume {:sourceloc "./output/trex04_tmp.c", 43, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $sub.bv32($i15, $i14);
...
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 38187));
