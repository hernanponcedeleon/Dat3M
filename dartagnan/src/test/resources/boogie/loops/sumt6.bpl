...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt6_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt6_tmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 7, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/sumt6_tmp.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 7, 16} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/sumt6_tmp.c", 8, 12} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "./output/sumt6_tmp.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt6_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt6_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt6_tmp.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9 := 0, 0, 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 18, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt6_tmp.c", 37, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 16, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 16, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 15, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 19, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i32($i6, $i0);
  assume {:sourceloc "./output/sumt6_tmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i10 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $urem.i32($i6, 6);
  assume {:sourceloc "./output/sumt6_tmp.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 35, 23} true;
  assume {:verifier.code 1} true;
  $i48 := $add.i32($i9, $i7);
  assume {:sourceloc "./output/sumt6_tmp.c", 35, 25} true;
  assume {:verifier.code 1} true;
  $i49 := $add.i32($i48, $i8);
  assume {:sourceloc "./output/sumt6_tmp.c", 35, 27} true;
  assume {:verifier.code 1} true;
  $i50 := $add.i32($i49, $i3);
  assume {:sourceloc "./output/sumt6_tmp.c", 35, 30} true;
  assume {:verifier.code 1} true;
  $i51 := $add.i32($i50, $i4);
  assume {:sourceloc "./output/sumt6_tmp.c", 35, 33} true;
  assume {:verifier.code 1} true;
  $i52 := $add.i32($i51, $i5);
  assume {:sourceloc "./output/sumt6_tmp.c", 35, 38} true;
  assume {:verifier.code 1} true;
  $i53 := $eq.i32($i52, $i6);
  assume {:sourceloc "./output/sumt6_tmp.c", 35, 38} true;
  assume {:verifier.code 1} true;
  $i54 := $zext.i1.i32($i53);
  assume {:sourceloc "./output/sumt6_tmp.c", 35, 3} true;
  assume {:verifier.code 1} true;
...
$bb7:
  assume ($i12 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i20 := $urem.i32($i6, 5);
  assume {:sourceloc "./output/sumt6_tmp.c", 23, 15} true;
  assume {:verifier.code 0} true;
  $i21 := $ne.i32($i20, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 23, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i5, 1);
  call {:cexpr "v2"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/sumt6_tmp.c", 22, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:sourceloc "./output/sumt6_tmp.c", 15, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 33, 10} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i32($i6, 1);
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i28 := $urem.i32($i6, 4);
  assume {:sourceloc "./output/sumt6_tmp.c", 25, 15} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.i32($i28, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 25, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i21 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i4, 1);
  call {:cexpr "v3"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/sumt6_tmp.c", 24, 6} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i29 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i35 := $urem.i32($i6, 3);
  assume {:sourceloc "./output/sumt6_tmp.c", 27, 15} true;
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i35, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 27, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb16, $bb17;
$bb14:
  assume !(($i29 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 26, 14} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i32($i3, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i30);
  assume {:sourceloc "./output/sumt6_tmp.c", 26, 6} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i36 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $i41 := $urem.i32($i6, 2);
  assume {:sourceloc "./output/sumt6_tmp.c", 29, 15} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  assume {:sourceloc "./output/sumt6_tmp.c", 28, 6} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i42 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 32, 11} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i32($i8, 1);
...
$bb20:
  assume !(($i42 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 30, 10} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i32($i7, 1);
  call {:cexpr "j"} boogie_si_record_i32($i43);
  assume {:sourceloc "./output/sumt6_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $i44, $i45 := $i43, $i8;
  goto $bb21;
$bb21:
