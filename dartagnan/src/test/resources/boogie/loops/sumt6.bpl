...
{
$bb0:
  assume {:sourceloc "./output/sumt6_tmp.c", 2, 44} true;
...
procedure __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "./output/sumt6_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "./output/sumt6_tmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 8, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt6_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/sumt6_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/sumt6_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/sumt6_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt6_tmp.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "./output/sumt6_tmp.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ule.i32($i0, $i1);
  assume {:sourceloc "./output/sumt6_tmp.c", 19, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9 := 0, 0, 0, 0, 0, 0, 0;
  goto $bb4;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 19, 21} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/sumt6_tmp.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./output/sumt6_tmp.c", 17, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 17, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 17, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 20, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i32($i6, $i0);
  assume {:sourceloc "./output/sumt6_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i10 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $urem.i32($i6, 6);
  assume {:sourceloc "./output/sumt6_tmp.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 22, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb7, $bb8;
$bb6:
  assume !(($i10 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 36, 23} true;
  assume {:verifier.code 1} true;
  $i48 := $add.i32($i9, $i7);
  assume {:sourceloc "./output/sumt6_tmp.c", 36, 25} true;
  assume {:verifier.code 1} true;
  $i49 := $add.i32($i48, $i8);
  assume {:sourceloc "./output/sumt6_tmp.c", 36, 27} true;
  assume {:verifier.code 1} true;
  $i50 := $add.i32($i49, $i3);
  assume {:sourceloc "./output/sumt6_tmp.c", 36, 30} true;
  assume {:verifier.code 1} true;
  $i51 := $add.i32($i50, $i4);
  assume {:sourceloc "./output/sumt6_tmp.c", 36, 33} true;
  assume {:verifier.code 1} true;
  $i52 := $add.i32($i51, $i5);
  assume {:sourceloc "./output/sumt6_tmp.c", 36, 38} true;
  assume {:verifier.code 1} true;
  $i53 := $eq.i32($i52, $i6);
  assume {:sourceloc "./output/sumt6_tmp.c", 36, 38} true;
  assume {:verifier.code 1} true;
  $i54 := $zext.i1.i32($i53);
  assume {:sourceloc "./output/sumt6_tmp.c", 36, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i54);
  assume {:sourceloc "./output/sumt6_tmp.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i12 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i20 := $urem.i32($i6, 5);
  assume {:sourceloc "./output/sumt6_tmp.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $i21 := $ne.i32($i20, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 24, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb10, $bb11;
$bb8:
  assume !(($i12 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i5, 1);
  call {:cexpr "v2"} boogie_si_record_i32($i13);
  assume {:sourceloc "./output/sumt6_tmp.c", 23, 6} true;
  assume {:verifier.code 0} true;
  $i14, $i15, $i16, $i17, $i18, $i19 := $i3, $i4, $i13, $i7, $i8, $i9;
  goto $bb9;
$bb9:
  assume {:sourceloc "./output/sumt6_tmp.c", 17, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/sumt6_tmp.c", 16, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/sumt6_tmp.c", 34, 10} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i32($i6, 1);
  call {:cexpr "l"} boogie_si_record_i32($i47);
  assume {:sourceloc "./output/sumt6_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4, $i5, $i6, $i7, $i8, $i9 := $i14, $i15, $i16, $i47, $i17, $i18, $i19;
  goto $bb4;
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i28 := $urem.i32($i6, 4);
  assume {:sourceloc "./output/sumt6_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.i32($i28, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 26, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb13, $bb14;
$bb11:
  assume !(($i21 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i4, 1);
  call {:cexpr "v3"} boogie_si_record_i32($i22);
  assume {:sourceloc "./output/sumt6_tmp.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $i23, $i24, $i25, $i26, $i27 := $i3, $i22, $i7, $i8, $i9;
  goto $bb12;
$bb12:
  assume {:sourceloc "./output/sumt6_tmp.c", 17, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i14, $i15, $i16, $i17, $i18, $i19 := $i23, $i24, $i5, $i25, $i26, $i27;
  goto $bb9;
$bb13:
  assume ($i29 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i35 := $urem.i32($i6, 3);
  assume {:sourceloc "./output/sumt6_tmp.c", 28, 15} true;
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i35, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 28, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb16, $bb17;
$bb14:
  assume !(($i29 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 27, 14} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i32($i3, 1);
  call {:cexpr "v4"} boogie_si_record_i32($i30);
  assume {:sourceloc "./output/sumt6_tmp.c", 27, 6} true;
  assume {:verifier.code 0} true;
  $i31, $i32, $i33, $i34 := $i30, $i7, $i8, $i9;
  goto $bb15;
$bb15:
  assume {:sourceloc "./output/sumt6_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i23, $i24, $i25, $i26, $i27 := $i31, $i4, $i32, $i33, $i34;
  goto $bb12;
$bb16:
  assume ($i36 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 30, 15} true;
  assume {:verifier.code 0} true;
  $i41 := $urem.i32($i6, 2);
  assume {:sourceloc "./output/sumt6_tmp.c", 30, 15} true;
  assume {:verifier.code 0} true;
  $i42 := $ne.i32($i41, 0);
  assume {:sourceloc "./output/sumt6_tmp.c", 30, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb19, $bb20;
$bb17:
  assume !(($i36 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 29, 12} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i32($i9, 1);
  call {:cexpr "i"} boogie_si_record_i32($i37);
  assume {:sourceloc "./output/sumt6_tmp.c", 29, 6} true;
  assume {:verifier.code 0} true;
  $i38, $i39, $i40 := $i7, $i8, $i37;
  goto $bb18;
$bb18:
  assume {:sourceloc "./output/sumt6_tmp.c", 16, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i31, $i32, $i33, $i34 := $i3, $i38, $i39, $i40;
  goto $bb15;
$bb19:
  assume ($i42 == 1);
  assume {:sourceloc "./output/sumt6_tmp.c", 33, 11} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i32($i8, 1);
  call {:cexpr "k"} boogie_si_record_i32($i46);
  assume {:verifier.code 0} true;
  $i44, $i45 := $i7, $i46;
  goto $bb21;
$bb20:
  assume !(($i42 == 1));
  assume {:sourceloc "./output/sumt6_tmp.c", 31, 10} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i32($i7, 1);
  call {:cexpr "j"} boogie_si_record_i32($i43);
  assume {:sourceloc "./output/sumt6_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i44, $i45 := $i43, $i8;
  goto $bb21;
$bb21:
