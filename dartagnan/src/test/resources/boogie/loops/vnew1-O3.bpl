...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/vnew1-O3.bpl /Users/ponce/git/Dat3M/./output/vnew1_tmp.c
...
{
$bb0:
  assume {:sourceloc "./output/vnew1_tmp.c", 2, 44} true;
...
axiom (llvm.dbg.value == $sub.ref(0, 8255));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/vnew1_tmp.c", 17, 7} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "n"} boogie_si_record_bv32($i0);
  assume {:sourceloc "./output/vnew1_tmp.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, SIZE);
  assume {:sourceloc "./output/vnew1_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $add.bv32($i0, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/vnew1_tmp.c", 18, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv32($i2, $i1);
  assume {:sourceloc "./output/vnew1_tmp.c", 18, 7} true;
...
$bb2:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vnew1_tmp.c", 22, 6} true;
  assume {:verifier.code 0} true;
  $i10 := $add.bv32($i4, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/vnew1_tmp.c", 23, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $add.bv32($i5, 3bv32);
  assume {:sourceloc "./output/vnew1_tmp.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $i12 := $ult.bv32($i11, $i0);
  assume {:sourceloc "./output/vnew1_tmp.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/vnew1_tmp.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
$bb5:
  assume !(($i12 == 1bv1));
  assume {:sourceloc "./output/vnew1_tmp.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $udiv.bv32($i0, 3bv32);
  assume {:sourceloc "./output/vnew1_tmp.c", 26, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $ugt.bv32($i0, 2bv32);
  assume {:sourceloc "./output/vnew1_tmp.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $i8, $i9 := 0bv32, $i10;
...
$bb7:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/vnew1_tmp.c", 27, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.bv32($i9, 0bv32);
  assume {:sourceloc "./output/vnew1_tmp.c", 8, 7} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i13 == 1bv1);
  assume {:sourceloc "./output/vnew1_tmp.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "./output/vnew1_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "./output/vnew1_tmp.c", 9, 27} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume !(($i13 == 1bv1));
  assume {:sourceloc "./output/vnew1_tmp.c", 28, 6} true;
  assume {:verifier.code 0} true;
  $i14 := $add.bv32($i9, $sub.bv32(0bv32, 1bv32));
  assume {:sourceloc "./output/vnew1_tmp.c", 29, 6} true;
  assume {:verifier.code 0} true;
  $i15 := $add.bv32($i8, 1bv32);
  call {:cexpr "j"} boogie_si_record_bv32($i15);
  assume {:sourceloc "./output/vnew1_tmp.c", 26, 12} true;
  assume {:verifier.code 0} true;
  $i16 := $ult.bv32($i15, $i6);
  assume {:sourceloc "./output/vnew1_tmp.c", 26, 3} true;
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 26831));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 27863));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 28895));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 29927));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 30959));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 31991));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 33023));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 34055));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 35087));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 36119));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 37151));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 38183));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 39215));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 40247));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 44375));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 45407));
...
{
$bb0:
  $M.0 := $store.bv32($M.0, SIZE, 20000001bv32);
  call {:cexpr "SIZE"} boogie_si_record_bv32(20000001bv32);
