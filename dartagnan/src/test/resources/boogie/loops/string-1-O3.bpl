...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/string-1-O3.bpl /Users/ponce/git/Dat3M/./output/string-1_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/string-1_tmp.c", 20, 3} true;
  ...
  assume {:sourceloc "./output/string-1_tmp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/string-1_tmp.c:20:3: warning: unsoundly ignoring unmodeled operation llvm.lifetime.start.p0i8;
  ...
  assume true;
  assume {:sourceloc "./output/string-1_tmp.c", 24, 17} true;
  assume {:verifier.code 0} true;
  call $i4 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i4);
  assume {:sourceloc "./output/string-1_tmp.c", 24, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/string-1_tmp.c", 24, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/string-1_tmp.c", 25, 23} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.bv8($i11, 0bv8);
  assume {:sourceloc "./output/string-1_tmp.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1bv1);
  assume {:sourceloc "./output/string-1_tmp.c", 28, 17} true;
  assume {:verifier.code 0} true;
  call $i14 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_bv8($i14);
  assume {:sourceloc "./output/string-1_tmp.c", 28, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/string-1_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./output/string-1_tmp.c", 29, 23} true;
  assume {:verifier.code 0} true;
  $i23 := $eq.bv8($i21, 0bv8);
  assume {:sourceloc "./output/string-1_tmp.c", 29, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./output/string-1_tmp.c", 62, 1} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: ./output/string-1_tmp.c:62:1: warning: unsoundly ignoring unmodeled operation llvm.lifetime.end.p0i8;
...
$bb4:
  assume ($i23 == 1bv1);
  assume {:sourceloc "./output/string-1_tmp.c", 32, 23} true;
  assume {:verifier.code 0} true;
  $i24 := $eq.bv8($i4, 0bv8);
  assume {:sourceloc "./output/string-1_tmp.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $i25, $i26 := 0bv64, 1bv64;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "./output/string-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/string-1_tmp.c", 21, 13} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.bv64.bv32($i25);
  call {:cexpr "nc_A"} boogie_si_record_bv32($i31);
  assume {:sourceloc "./output/string-1_tmp.c", 36, 23} true;
  assume {:verifier.code 0} true;
  $i32 := $eq.bv8($i14, 0bv8);
  assume {:sourceloc "./output/string-1_tmp.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $i33, $i34 := 0bv64, 1bv64;
...
$bb9:
  ...
  assume {:sourceloc "./output/string-1_tmp.c", 32, 9} true;
  assume {:verifier.code 0} true;
  $i28 := $load.bv8($M.0, $p27);
  assume {:sourceloc "./output/string-1_tmp.c", 32, 23} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.bv8($i28, 0bv8);
  assume {:sourceloc "./output/string-1_tmp.c", 33, 9} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume {:sourceloc "./output/string-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/string-1_tmp.c", 21, 19} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.bv64.bv32($i33);
  call {:cexpr "nc_B"} boogie_si_record_bv32($i39);
  assume {:sourceloc "./output/string-1_tmp.c", 39, 14} true;
  assume {:verifier.code 0} true;
  $i40 := $ult.bv32($i39, $i31);
  assume {:sourceloc "./output/string-1_tmp.c", 39, 7} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  assume {:sourceloc "./output/string-1_tmp.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $i36 := $load.bv8($M.0, $p35);
  assume {:sourceloc "./output/string-1_tmp.c", 36, 23} true;
  assume {:verifier.code 0} true;
  $i37 := $eq.bv8($i36, 0bv8);
  assume {:sourceloc "./output/string-1_tmp.c", 37, 9} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume !(($i40 == 1bv1));
  assume {:sourceloc "./output/string-1_tmp.c", 43, 11} true;
  assume {:verifier.code 0} true;
  $i41 := $ne.bv32($i31, 0bv32);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 23} true;
  assume {:verifier.code 0} true;
  $i42 := $ne.bv32($i39, 0bv32);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 18} true;
  assume {:verifier.code 0} true;
  $i43 := $and.bv1($i41, $i42);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 18} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume ($i43 == 1bv1);
  assume {:sourceloc "./output/string-1_tmp.c", 45, 20} true;
  assume {:verifier.code 0} true;
  $i44 := $eq.bv8($i4, $i14);
  assume {:sourceloc "./output/string-1_tmp.c", 45, 8} true;
  assume {:verifier.code 0} true;
  $i45 := $zext.bv1.bv32($i44);
  call {:cexpr "j"} boogie_si_record_bv32($i45);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 11} true;
  assume {:verifier.code 0} true;
  $i46 := $sgt.bv32($i31, 1bv32);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 23} true;
  assume {:verifier.code 0} true;
  $i47 := $slt.bv32($i45, $i39);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $and.bv1($i46, $i47);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 18} true;
...
$bb23:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i51 := $sext.bv32.bv64($i49);
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref($bv2int.64($i51), 1));
  assume {:sourceloc "./output/string-1_tmp.c", 45, 8} true;
  assume {:verifier.code 0} true;
  $i53 := $load.bv8($M.0, $p52);
  assume {:verifier.code 0} true;
  $i54 := $sext.bv32.bv64($i50);
  assume {:verifier.code 0} true;
  $p55 := $add.ref($add.ref($p1, $mul.ref(0, 5)), $mul.ref($bv2int.64($i54), 1));
  assume {:sourceloc "./output/string-1_tmp.c", 45, 23} true;
  assume {:verifier.code 0} true;
  $i56 := $load.bv8($M.0, $p55);
  assume {:sourceloc "./output/string-1_tmp.c", 45, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $eq.bv8($i53, $i56);
  assume {:sourceloc "./output/string-1_tmp.c", 45, 8} true;
  assume {:verifier.code 0} true;
  $i58 := $add.bv32($i50, 1bv32);
  assume {:verifier.code 0} true;
  $i59 := $sub.bv32(0bv32, $i50);
  assume {:sourceloc "./output/string-1_tmp.c", 45, 8} true;
  assume {:verifier.code 0} true;
  $i60 := (if ($i57 == 1bv1) then 0bv32 else $i59);
  assume {:sourceloc "./output/string-1_tmp.c", 45, 8} true;
  assume {:verifier.code 0} true;
  $i61 := (if ($i57 == 1bv1) then $i58 else 0bv32);
  assume {:sourceloc "./output/string-1_tmp.c", 45, 8} true;
  assume {:verifier.code 0} true;
  $i62 := $add.bv32($i49, 1bv32);
  assume {:sourceloc "./output/string-1_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i63 := $add.bv32($i62, $i60);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 11} true;
  assume {:verifier.code 0} true;
  $i64 := $slt.bv32($i63, $i31);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 23} true;
  assume {:verifier.code 0} true;
  $i65 := $slt.bv32($i61, $i39);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 18} true;
  assume {:verifier.code 0} true;
  $i66 := $and.bv1($i64, $i65);
  assume {:sourceloc "./output/string-1_tmp.c", 43, 18} true;
...
axiom (llvm.lifetime.start.p0i8 == $sub.ref(0, 8259));
...
axiom (llvm.lifetime.end.p0i8 == $sub.ref(0, 10323));
