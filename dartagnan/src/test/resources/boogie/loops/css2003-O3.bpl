...
// via /usr/local/bin/smack -q -t --no-memory-splitting --bit-precise --clang-options=-DCUSTOM_VERIFIER_ASSERT -O3 -fno-vectorize -fno-slp-vectorize -I./include/ -bpl ./output/css2003-O3.bpl /Users/ponce/git/Dat3M/./output/css2003_tmp.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./output/css2003_tmp.c", 18, 9} true;
  ...
  assume {:sourceloc "./output/css2003_tmp.c", 19, 18} true;
  assume {:verifier.code 0} true;
  $i1 := $ult.bv32($i0, 2bv32);
  assume {:sourceloc "./output/css2003_tmp.c", 19, 18} true;
  assume {:verifier.code 0} true;
  $i2 := 1bv32;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./output/css2003_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./output/css2003_tmp.c", 20, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv32($i2, 999976bv32);
  assume {:sourceloc "./output/css2003_tmp.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $add.bv32($i2, 25bv32);
  call {:cexpr "i"} boogie_si_record_bv32($i4);
  assume {:sourceloc "./output/css2003_tmp.c", 20, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "./output/css2003_tmp.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
