...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/06-symbeq_09-tricky_address4-O0.bpl /Users/ponce/git/Dat3M/output/06-symbeq_09-tricky_address4_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 31352));
...
const {:allocSize 400} {:count 10} a: ref;
axiom (a == $sub.ref(0, 1424));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 2456));
...
axiom (llvm.dbg.declare == $sub.ref(0, 3488));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const t_fun: ref;
axiom (t_fun == $sub.ref(0, 4520));
procedure  t_fun($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i1;
...
$bb3:
  ...
  $i6 := $sext.i32.i64($i1);
  $p7 := $add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i6, 40));
  $p8 := $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i6, 40)), $mul.ref(8, 1));
  call $i9 := pthread_mutex_lock($p8);
  $i10 := $add.i32($i1, 1);
  $i11 := $sext.i32.i64($i10);
  $p12 := $add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i11, 40));
  $p13 := $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i11, 40)), $mul.ref(0, 1));
  $i14 := $load.i32($M.0, $p13);
  $i15 := $add.i32($i14, 1);
  $M.0 := $store.i32($M.0, $p13, $i15);
  $p16 := $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i6, 40)), $mul.ref(8, 1));
  call $i17 := pthread_mutex_unlock($p16);
  $r := $0.ref;
  $exn := false;
  return;
}
const pthread_mutex_lock: ref;
axiom (pthread_mutex_lock == $sub.ref(0, 5552));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 6584));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 7616));
...
$bb2:
  assume ($i2 == 1);
  $i3 := $sext.i32.i64($i1);
  $p4 := $add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i3, 40));
  $p5 := $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i3, 40)), $mul.ref(8, 1));
  call $i6 := pthread_mutex_init($p5, $0.ref);
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
...
$bb7:
  $i12 := $zext.i1.i32($i10);
  call assume_abort_if_not($i12);
  call $i13 := pthread_create($p0, $0.ref, t_fun, $0.ref);
  $i14 := $sext.i32.i64($i8);
  $p15 := $add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i14, 40));
  $p16 := $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i14, 40)), $mul.ref(8, 1));
  call $i17 := pthread_mutex_lock($p16);
  $i18 := $sext.i32.i64($i8);
  $p19 := $add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i18, 40));
  $p20 := $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i18, 40)), $mul.ref(0, 1));
  $i21 := $load.i32($M.0, $p20);
  $i22 := $add.i32($i21, 1);
  $M.0 := $store.i32($M.0, $p20, $i22);
  $i23 := $sext.i32.i64($i8);
  $p24 := $add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i23, 40));
  $p25 := $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref($i23, 40)), $mul.ref(8, 1));
  call $i26 := pthread_mutex_unlock($p25);
  $r := 0;
  $exn := false;
  return;
}
const pthread_mutex_init: ref;
axiom (pthread_mutex_init == $sub.ref(0, 8648));
procedure  pthread_mutex_init($p0: ref, $p1: ref)
  returns ($r: i32);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 9680));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 10712));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 11744));
...
axiom (__SMACK_dummy == $sub.ref(0, 12776));
...
axiom (__SMACK_and32 == $sub.ref(0, 13808));
...
axiom (__SMACK_and64 == $sub.ref(0, 14840));
...
axiom (__SMACK_and16 == $sub.ref(0, 15872));
...
axiom (__SMACK_and8 == $sub.ref(0, 16904));
...
axiom (__SMACK_or32 == $sub.ref(0, 17936));
...
axiom (__SMACK_or64 == $sub.ref(0, 18968));
...
axiom (__SMACK_or16 == $sub.ref(0, 20000));
...
axiom (__SMACK_or8 == $sub.ref(0, 21032));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 22064));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 23096));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 24128));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 25160));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 26192));
type $mop;
const $MOP: $mop;
var $exn: bool;
var $exnv: int;
...
axiom (__SMACK_top_decl == $sub.ref(0, 27224));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 28256));
...
axiom (llvm.dbg.value == $sub.ref(0, 30320));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 31352));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, a, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(0, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(0, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(0, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(0, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(0, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(0, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(1, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(1, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(1, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(1, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(1, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(1, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(1, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(2, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(2, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(2, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(2, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(2, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(2, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(2, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(3, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(3, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(3, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(3, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(3, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(3, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(3, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(4, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(4, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(4, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(4, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(4, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(4, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(4, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(5, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(5, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(5, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(5, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(5, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(5, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(5, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(6, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(6, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(6, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(6, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(6, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(6, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(6, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(7, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(7, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(7, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(7, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(7, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(7, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(7, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(8, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(8, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(8, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(8, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(8, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(8, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(8, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(9, 40)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(9, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(9, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(9, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(9, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(9, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(16, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref($add.ref($add.ref($add.ref($add.ref($add.ref(a, $mul.ref(0, 400)), $mul.ref(9, 40)), $mul.ref(8, 1)), $mul.ref(0, 1)), $mul.ref(24, 1)), $mul.ref(0, 1)), $mul.ref(0, 1)), $0.ref);
  $exn := false;
  return;
}
