...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/05-lval_ls_09-idxsense_rc-O0.bpl /Users/ponce/git/Dat3M/output/05-lval_ls_09-idxsense_rc_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 28208));
...
axiom (pthread_mutex_lock == $sub.ref(0, 5504));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 6536));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 7568));
...
$bb3:
  assume !(($i2 == 1));
  call $i7 := pthread_create($p0, $0.ref, t_fun, $0.ref);
  call $i8 := pthread_mutex_lock($add.ref($add.ref(m, $mul.ref(0, 320)), $mul.ref(3, 32)));
  $i9 := $load.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)));
  $i10 := $add.i32($i9, 1);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)), $i10);
  call $i11 := pthread_mutex_unlock($add.ref($add.ref(m, $mul.ref(0, 320)), $mul.ref(3, 32)));
  $r := 0;
  $exn := false;
  return;
$bb4:
...
axiom (pthread_mutex_init == $sub.ref(0, 8600));
procedure  pthread_mutex_init($p0: ref, $p1: ref)
  returns ($r: i32);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 9632));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 10664));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 11696));
...
axiom (__SMACK_dummy == $sub.ref(0, 12728));
...
axiom (__SMACK_and32 == $sub.ref(0, 13760));
...
axiom (__SMACK_and64 == $sub.ref(0, 14792));
...
axiom (__SMACK_and16 == $sub.ref(0, 15824));
...
axiom (__SMACK_and8 == $sub.ref(0, 16856));
...
axiom (__SMACK_or32 == $sub.ref(0, 17888));
...
axiom (__SMACK_or64 == $sub.ref(0, 18920));
...
axiom (__SMACK_or16 == $sub.ref(0, 19952));
...
axiom (__SMACK_or8 == $sub.ref(0, 20984));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 22016));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 23048));
...
axiom (__SMACK_decls == $sub.ref(0, 24080));
type $mop;
const $MOP: $mop;
var $exn: bool;
var $exnv: int;
...
axiom (__SMACK_top_decl == $sub.ref(0, 25112));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 26144));
...
axiom (llvm.dbg.value == $sub.ref(0, 27176));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 28208));
