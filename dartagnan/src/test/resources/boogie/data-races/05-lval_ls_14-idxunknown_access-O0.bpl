...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/05-lval_ls_14-idxunknown_access-O0.bpl /Users/ponce/git/Dat3M/output/05-lval_ls_14-idxunknown_access_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 27896));
...
axiom (data == $sub.ref(0, 1064));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 2096));
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  $i1 := $load.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)));
  $i2 := $add.i32($i1, 1);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)), $i2);
  $r := $0.ref;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 5192));
...
$bb3:
  ...
  call $i6 := pthread_create($p0, $0.ref, t_fun, $0.ref);
  $i7 := $sext.i32.i64($i1);
  $p8 := $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref($i7, 4));
  $i9 := $load.i32($M.0, $p8);
  $i10 := $add.i32($i9, 1);
...
axiom (pthread_create == $sub.ref(0, 6224));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 7256));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 8288));
...
axiom (__SMACK_dummy == $sub.ref(0, 9320));
...
axiom (__SMACK_and32 == $sub.ref(0, 10352));
...
axiom (__SMACK_and64 == $sub.ref(0, 11384));
...
axiom (__SMACK_and16 == $sub.ref(0, 12416));
...
axiom (__SMACK_and8 == $sub.ref(0, 13448));
...
axiom (__SMACK_or32 == $sub.ref(0, 14480));
...
axiom (__SMACK_or64 == $sub.ref(0, 15512));
...
axiom (__SMACK_or16 == $sub.ref(0, 16544));
...
axiom (__SMACK_or8 == $sub.ref(0, 17576));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18608));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 19640));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 20672));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 21704));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 22736));
type $mop;
const $MOP: $mop;
var $exn: bool;
var $exnv: int;
...
axiom (__SMACK_top_decl == $sub.ref(0, 23768));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 24800));
