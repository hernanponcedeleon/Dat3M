...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/singleton-b-O0.bpl /Users/ponce/git/Dat3M/output/singleton-b_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 36129));
...
{
$bb0:
  assume {:sourceloc "output/singleton-b_tmp.c", 20, 83} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/singleton-b_tmp.c", 1107, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/singleton-b_tmp.c", 1107, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/singleton-b_tmp.c", 1107, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/singleton-b_tmp.c", 1107, 95} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/singleton-b_tmp.c", 1107, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/singleton-b_tmp.c", 1107, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/singleton-b_tmp.c", 1107, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/singleton-b_tmp.c", 1107, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "output/singleton-b_tmp.c", 1111, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/singleton-b_tmp.c", 1111, 7} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(1);
  assume {:sourceloc "output/singleton-b_tmp.c", 1111, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, v, $p1);
  assume {:sourceloc "output/singleton-b_tmp.c", 1112, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "output/singleton-b_tmp.c", 1116, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/singleton-b_tmp.c", 1116, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, v);
  ...
  assume {:sourceloc "output/singleton-b_tmp.c", 1116, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 88);
  assume {:sourceloc "output/singleton-b_tmp.c", 1117, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "output/singleton-b_tmp.c", 1121, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/singleton-b_tmp.c", 1121, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, v);
  ...
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(0, 1));
  assume {:sourceloc "output/singleton-b_tmp.c", 1121, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 89);
  assume {:sourceloc "output/singleton-b_tmp.c", 1122, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i20: i32;
$bb0:
  assume {:sourceloc "output/singleton-b_tmp.c", 1127, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/singleton-b_tmp.c", 1128, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "output/singleton-b_tmp.c", 1128, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1129, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p2, $0.ref, thread2, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1130, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p3, $0.ref, thread3, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1131, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p4, $0.ref, thread2, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1132, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($p5, $0.ref, thread2, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1133, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.0, $p2);
  assume {:sourceloc "output/singleton-b_tmp.c", 1133, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_join($i13, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1134, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i64($M.0, $p3);
  assume {:sourceloc "output/singleton-b_tmp.c", 1134, 3} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_join($i15, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1135, 16} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i64($M.0, $p4);
  assume {:sourceloc "output/singleton-b_tmp.c", 1135, 3} true;
  assume {:verifier.code 0} true;
  call $i18 := pthread_join($i17, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1136, 16} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i64($M.0, $p5);
  assume {:sourceloc "output/singleton-b_tmp.c", 1136, 3} true;
  assume {:verifier.code 0} true;
  call $i20 := pthread_join($i19, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1137, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/singleton-b_tmp.c", 1142, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/singleton-b_tmp.c", 1143, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, $p0);
  assume {:sourceloc "output/singleton-b_tmp.c", 1143, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $0.ref);
  assume {:sourceloc "output/singleton-b_tmp.c", 1144, 21} true;
  ...
  assume {:verifier.code 1} true;
  $i7 := $sext.i8.i32($i6);
  assume {:sourceloc "output/singleton-b_tmp.c", 1144, 26} true;
  assume {:verifier.code 1} true;
  $i8 := $eq.i32($i7, 88);
  assume {:sourceloc "output/singleton-b_tmp.c", 1144, 26} true;
  assume {:verifier.code 1} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/singleton-b_tmp.c", 1144, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i9);
  assume {:sourceloc "output/singleton-b_tmp.c", 1145, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.dbg.value == $sub.ref(0, 35097));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 36129));
