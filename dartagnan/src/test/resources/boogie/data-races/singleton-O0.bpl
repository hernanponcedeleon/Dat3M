...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/singleton-O0.bpl /Users/ponce/git/Dat3M/output/singleton_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38193));
...
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 4137));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 5169));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/singleton_tmp.c", 20, 83} true;
...
axiom (__VERIFIER_assert == $sub.ref(0, 7233));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/singleton_tmp.c", 1123, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/singleton_tmp.c", 1123, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/singleton_tmp.c", 1123, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/singleton_tmp.c", 1123, 95} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/singleton_tmp.c", 1123, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/singleton_tmp.c", 1123, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/singleton_tmp.c", 1123, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/singleton_tmp.c", 1123, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 8265));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.dbg.label: ref;
axiom (llvm.dbg.label == $sub.ref(0, 9297));
procedure  llvm.dbg.label($p0: ref);
const thread1: ref;
axiom (thread1 == $sub.ref(0, 10329));
procedure  thread1($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "output/singleton_tmp.c", 1127, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/singleton_tmp.c", 1127, 7} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(1);
  assume {:sourceloc "output/singleton_tmp.c", 1127, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, v, $p1);
  assume {:sourceloc "output/singleton_tmp.c", 1128, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "output/singleton_tmp.c", 1132, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/singleton_tmp.c", 1132, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/singleton_tmp.c", 1133, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, v);
  assume {:sourceloc "output/singleton_tmp.c", 1133, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(0, 1));
  assume {:sourceloc "output/singleton_tmp.c", 1133, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 88);
  assume {:sourceloc "output/singleton_tmp.c", 1134, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/singleton_tmp.c", 1135, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "output/singleton_tmp.c", 1139, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/singleton_tmp.c", 1139, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/singleton_tmp.c", 1140, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $load.ref($M.0, v);
  assume {:sourceloc "output/singleton_tmp.c", 1140, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(0, 1));
  assume {:sourceloc "output/singleton_tmp.c", 1140, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 89);
  assume {:sourceloc "output/singleton_tmp.c", 1141, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/singleton_tmp.c", 1142, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i20: i32;
$bb0:
  assume {:sourceloc "output/singleton_tmp.c", 1147, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/singleton_tmp.c", 1148, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "output/singleton_tmp.c", 1148, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1149, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p2, $0.ref, thread2, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1150, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p3, $0.ref, thread3, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1151, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p4, $0.ref, thread2, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1152, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($p5, $0.ref, thread2, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1153, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.0, $p2);
  assume {:sourceloc "output/singleton_tmp.c", 1153, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_join($i13, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1154, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i64($M.0, $p3);
  assume {:sourceloc "output/singleton_tmp.c", 1154, 3} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_join($i15, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1155, 16} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i64($M.0, $p4);
  assume {:sourceloc "output/singleton_tmp.c", 1155, 3} true;
  assume {:verifier.code 0} true;
  call $i18 := pthread_join($i17, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1156, 16} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i64($M.0, $p5);
  assume {:sourceloc "output/singleton_tmp.c", 1156, 3} true;
  assume {:verifier.code 0} true;
  call $i20 := pthread_join($i19, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1157, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/singleton_tmp.c", 1162, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/singleton_tmp.c", 1163, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, $p0);
  assume {:sourceloc "output/singleton_tmp.c", 1163, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $0.ref);
  assume {:sourceloc "output/singleton_tmp.c", 1164, 21} true;
  assume {:verifier.code 1} true;
  $p4 := $load.ref($M.0, v);
  assume {:sourceloc "output/singleton_tmp.c", 1164, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i7 := $sext.i8.i32($i6);
  assume {:sourceloc "output/singleton_tmp.c", 1164, 26} true;
  assume {:verifier.code 1} true;
  $i8 := $eq.i32($i7, 88);
  assume {:sourceloc "output/singleton_tmp.c", 1164, 26} true;
  assume {:verifier.code 1} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/singleton_tmp.c", 1164, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i9);
  assume {:sourceloc "output/singleton_tmp.c", 1165, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 18585));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 19617));
...
axiom (__SMACK_dummy == $sub.ref(0, 20649));
...
axiom (__SMACK_and32 == $sub.ref(0, 21681));
...
axiom (__SMACK_and64 == $sub.ref(0, 22713));
...
axiom (__SMACK_and16 == $sub.ref(0, 23745));
...
axiom (__SMACK_and8 == $sub.ref(0, 24777));
...
axiom (__SMACK_or32 == $sub.ref(0, 25809));
...
axiom (__SMACK_or64 == $sub.ref(0, 26841));
...
axiom (__SMACK_or16 == $sub.ref(0, 27873));
...
axiom (__SMACK_or8 == $sub.ref(0, 28905));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 29937));
...
axiom (__SMACK_decls == $sub.ref(0, 30969));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 32001));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 33033));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 34065));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 35097));
...
axiom (llvm.dbg.value == $sub.ref(0, 37161));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 38193));
