...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/05-lval_ls_05-glob_idx_rc-O0.bpl /Users/ponce/git/Dat3M/output/05-lval_ls_05-glob_idx_rc_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 23768));
...
$bb0:
  ...
  call $i1 := pthread_create($p0, $0.ref, t_fun, $0.ref);
...
axiom (pthread_create == $sub.ref(0, 5192));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 6224));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 7256));
...
axiom (__SMACK_dummy == $sub.ref(0, 8288));
...
axiom (__SMACK_and32 == $sub.ref(0, 9320));
...
axiom (__SMACK_and64 == $sub.ref(0, 10352));
...
axiom (__SMACK_and16 == $sub.ref(0, 11384));
...
axiom (__SMACK_and8 == $sub.ref(0, 12416));
...
axiom (__SMACK_or32 == $sub.ref(0, 13448));
...
axiom (__SMACK_or64 == $sub.ref(0, 14480));
...
axiom (__SMACK_or16 == $sub.ref(0, 15512));
...
axiom (__SMACK_or8 == $sub.ref(0, 16544));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17576));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 18608));
...
axiom (__SMACK_decls == $sub.ref(0, 19640));
type $mop;
const $MOP: $mop;
var $exn: bool;
var $exnv: int;
...
axiom (__SMACK_top_decl == $sub.ref(0, 20672));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21704));
...
axiom (llvm.dbg.value == $sub.ref(0, 22736));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 23768));
