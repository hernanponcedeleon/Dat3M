...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/05-lval_ls_08-glob_fld_2_rc-O0.bpl /Users/ponce/git/Dat3M/output/05-lval_ls_08-glob_fld_2_rc_tmp.c
...
const {:allocSize 8} data: ref;
axiom (data == $sub.ref(0, 1032));
const t_fun: ref;
axiom (t_fun == $sub.ref(0, 2064));
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  $i1 := $load.i32($M.0, data);
  $i2 := $add.i32($i1, 1);
  $M.0 := $store.i32($M.0, data, $i2);
  $r := $0.ref;
  $exn := false;
  return;
}
...
$bb0:
  ...
  call $i2 := pthread_create($p0, $0.ref, t_fun, $0.ref);
  call $i3 := pthread_create($p1, $0.ref, t_fun, $0.ref);
  $i4 := $load.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 8)), $mul.ref(4, 1)));
  $i5 := $add.i32($i4, 1);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 8)), $mul.ref(4, 1)), $i5);
  $r := 0;
  $exn := false;
  return;
}
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 5160));
...
axiom (llvm.dbg.value == $sub.ref(0, 22704));
...
$bb0:
  ...
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  $exn := false;
  return;
}
