...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/05-lval_ls_13-idxunknown_lock-O0.bpl /Users/ponce/git/Dat3M/output/05-lval_ls_13-idxunknown_lock_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 32336));
...
const {:allocSize 320} {:count 10} m: ref;
axiom (m == $sub.ref(0, 1344));
const {:allocSize 40} {:count 10} data: ref;
axiom (data == $sub.ref(0, 2408));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 3440));
...
axiom (llvm.dbg.declare == $sub.ref(0, 4472));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const t_fun: ref;
axiom (t_fun == $sub.ref(0, 5504));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  call $i1 := pthread_mutex_lock($add.ref($add.ref(m, $mul.ref(0, 320)), $mul.ref(4, 32)));
  $i2 := $load.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)));
  $i3 := $add.i32($i2, 1);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)), $i3);
  call $i4 := pthread_mutex_unlock($add.ref($add.ref(m, $mul.ref(0, 320)), $mul.ref(4, 32)));
  $r := $0.ref;
  $exn := false;
  return;
}
const pthread_mutex_lock: ref;
axiom (pthread_mutex_lock == $sub.ref(0, 6536));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 7568));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 8600));
...
$bb2:
  assume ($i2 == 1);
  $i3 := $sext.i32.i64($i1);
  $p4 := $add.ref($add.ref(m, $mul.ref(0, 320)), $mul.ref($i3, 32));
  call $i5 := pthread_mutex_init($p4, $0.ref);
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
...
$bb7:
  ...
  call $i12 := pthread_create($p0, $0.ref, t_fun, $0.ref);
  $i13 := $sext.i32.i64($i7);
  $p14 := $add.ref($add.ref(m, $mul.ref(0, 320)), $mul.ref($i13, 32));
  call $i15 := pthread_mutex_lock($p14);
  $i16 := $load.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)));
  $i17 := $add.i32($i16, 1);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)), $i17);
  $i18 := $sext.i32.i64($i7);
  $p19 := $add.ref($add.ref(m, $mul.ref(0, 320)), $mul.ref($i18, 32));
  call $i20 := pthread_mutex_unlock($p19);
  $r := 0;
  $exn := false;
  return;
}
const pthread_mutex_init: ref;
axiom (pthread_mutex_init == $sub.ref(0, 9632));
procedure  pthread_mutex_init($p0: ref, $p1: ref)
  returns ($r: i32);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 10664));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 11696));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 12728));
...
axiom (__SMACK_dummy == $sub.ref(0, 13760));
...
axiom (__SMACK_and32 == $sub.ref(0, 14792));
...
axiom (__SMACK_and64 == $sub.ref(0, 15824));
...
axiom (__SMACK_and16 == $sub.ref(0, 16856));
...
axiom (__SMACK_and8 == $sub.ref(0, 17888));
...
axiom (__SMACK_or32 == $sub.ref(0, 18920));
...
axiom (__SMACK_or64 == $sub.ref(0, 19952));
...
axiom (__SMACK_or16 == $sub.ref(0, 20984));
...
axiom (__SMACK_or8 == $sub.ref(0, 22016));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 23048));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 24080));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 25112));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 26144));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 27176));
type $mop;
const $MOP: $mop;
var $exn: bool;
var $exnv: int;
...
axiom (__SMACK_top_decl == $sub.ref(0, 28208));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 29240));
...
axiom (llvm.dbg.value == $sub.ref(0, 31304));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 32336));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, data, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(4, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(5, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(6, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(7, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(8, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(data, $mul.ref(0, 40)), $mul.ref(9, 4)), 0);
  $exn := false;
  return;
}
