...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.9-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.9-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39259));
...
const {:allocSize 30} .str: ref;
axiom (.str == $sub.ref(0, 7222));
const {:allocSize 50} {:count 50} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 8296));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 9331));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 10363));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(y, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 14, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 14, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load(z, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 16, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (llvm.dbg.value == $sub.ref(0, 11395));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_load: ref;
axiom (__llvm_atomic32_load == $sub.ref(0, 12427));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 13459));
procedure  __llvm_atomic_fence($i0: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 14491));
...
axiom (__llvm_atomic32_store == $sub.ref(0, 15523));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 16555));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 31, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(x, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(y, 1, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 34, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 36, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 52, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 52, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/imm/paper-E3.9.c", 52, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__VERIFIER_assume == $sub.ref(0, 23779));
...
axiom (__SMACK_dummy == $sub.ref(0, 24811));
...
axiom (__SMACK_and32 == $sub.ref(0, 25843));
...
axiom (__SMACK_and64 == $sub.ref(0, 26875));
...
axiom (__SMACK_and16 == $sub.ref(0, 27907));
...
axiom (__SMACK_and8 == $sub.ref(0, 28939));
...
axiom (__SMACK_or32 == $sub.ref(0, 29971));
...
axiom (__SMACK_or64 == $sub.ref(0, 31003));
...
axiom (__SMACK_or16 == $sub.ref(0, 32035));
...
axiom (__SMACK_or8 == $sub.ref(0, 33067));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 34099));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 35131));
...
axiom (__SMACK_decls == $sub.ref(0, 36163));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37195));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38227));
...
axiom (__SMACK_static_init == $sub.ref(0, 39259));
