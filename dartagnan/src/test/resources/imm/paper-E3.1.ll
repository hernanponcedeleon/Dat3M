; ModuleID = '/home/ponce/git/Dat3M/output/paper-E3.1.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/imm/paper-E3.1.c"
...
@.str = private unnamed_addr constant [20 x i8] c"!(a == 1 && b == 0)\00", align 1
@.str.1 = private unnamed_addr constant [50 x i8] c"/home/ponce/git/Dat3M/benchmarks/imm/paper-E3.1.c\00", align 1
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !36 {
  ...
  store atomic i32 1, i32* @x monotonic, align 4, !dbg !42
  store atomic i32 1, i32* @y release, align 4, !dbg !43
  ret i8* null, !dbg !44
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !45 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !46, metadata !DIExpression()), !dbg !47
  %2 = load atomic i32, i32* @y acquire, align 4, !dbg !48
  call void @llvm.dbg.value(metadata i32 %2, metadata !49, metadata !DIExpression()), !dbg !47
  %3 = load atomic i32, i32* @x monotonic, align 4, !dbg !50
  call void @llvm.dbg.value(metadata i32 %3, metadata !51, metadata !DIExpression()), !dbg !47
...
define dso_local i32 @main() #0 !dbg !56 {
  ...
  %9 = load i32, i32* @a, align 4, !dbg !71
  %10 = icmp eq i32 %9, 1, !dbg !71
  %11 = load i32, i32* @b, align 4, !dbg !71
  %12 = icmp eq i32 %11, 0, !dbg !71
  %or.cond = select i1 %10, i1 %12, i1 false, !dbg !71
  br i1 %or.cond, label %13, label %14, !dbg !71

13:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str.1, i64 0, i64 0), i32 noundef 37, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !71
  unreachable, !dbg !71
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/imm/paper-E3.1.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "80598f115bce143cef342baa72f47229")
!4 = !{!5}
...
!20 = !DIFile(filename: "benchmarks/imm/paper-E3.1.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "80598f115bce143cef342baa72f47229")
...
!44 = !DILocation(line: 14, column: 2, scope: !36)
!45 = distinct !DISubprogram(name: "thread_2", scope: !20, file: !20, line: 17, type: !37, scopeLine: 18, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !39)
!46 = !DILocalVariable(name: "unused", arg: 1, scope: !45, file: !20, line: 17, type: !16)
!47 = !DILocation(line: 0, scope: !45)
!48 = !DILocation(line: 19, column: 11, scope: !45)
!49 = !DILocalVariable(name: "r0", scope: !45, file: !20, line: 19, type: !23)
!50 = !DILocation(line: 20, column: 11, scope: !45)
!51 = !DILocalVariable(name: "r1", scope: !45, file: !20, line: 20, type: !23)
!52 = !DILocation(line: 21, column: 2, scope: !45)
!53 = !DILocation(line: 22, column: 4, scope: !45)
!54 = !DILocation(line: 23, column: 4, scope: !45)
!55 = !DILocation(line: 24, column: 2, scope: !45)
!56 = distinct !DISubprogram(name: "main", scope: !20, file: !20, line: 27, type: !57, scopeLine: 28, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !39)
!57 = !DISubroutineType(types: !58)
!58 = !{!23}
!59 = !DILocalVariable(name: "t1", scope: !56, file: !20, line: 29, type: !60)
...
!64 = !DILocation(line: 31, column: 2, scope: !56)
!65 = !DILocalVariable(name: "t2", scope: !56, file: !20, line: 29, type: !60)
!66 = !DILocation(line: 32, column: 2, scope: !56)
!67 = !DILocation(line: 34, column: 15, scope: !56)
!68 = !DILocation(line: 34, column: 2, scope: !56)
!69 = !DILocation(line: 35, column: 15, scope: !56)
!70 = !DILocation(line: 35, column: 2, scope: !56)
!71 = !DILocation(line: 37, column: 2, scope: !72)
!72 = distinct !DILexicalBlock(scope: !73, file: !20, line: 37, column: 2)
!73 = distinct !DILexicalBlock(scope: !56, file: !20, line: 37, column: 2)
!74 = !DILocation(line: 39, column: 2, scope: !56)
