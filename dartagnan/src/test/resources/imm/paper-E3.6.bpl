...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.6-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.6-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38227));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 14, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(z, $i2, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 17, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(x, $i1, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 28, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (llvm.dbg.declare == $sub.ref(0, 17587));
...
axiom (__assert_fail == $sub.ref(0, 20683));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 21715));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 22747));
...
axiom (__SMACK_and32 == $sub.ref(0, 24811));
...
axiom (__SMACK_and64 == $sub.ref(0, 25843));
...
axiom (__SMACK_and16 == $sub.ref(0, 26875));
...
axiom (__SMACK_and8 == $sub.ref(0, 27907));
...
axiom (__SMACK_or32 == $sub.ref(0, 28939));
...
axiom (__SMACK_or64 == $sub.ref(0, 29971));
...
axiom (__SMACK_or16 == $sub.ref(0, 31003));
...
axiom (__SMACK_or8 == $sub.ref(0, 32035));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 33067));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 34099));
...
axiom (__SMACK_decls == $sub.ref(0, 35131));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 36163));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 37195));
...
axiom (__SMACK_static_init == $sub.ref(0, 38227));
