...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/paper-E3.6.bpl /Users/ponce/git/Dat3M/benchmarks/imm/paper-E3.6.c
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 12, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(x, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(y, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 14, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(y, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_store_explicit.ref.i32.i32(z, $i3, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 18, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i1);
  call {:cexpr "b"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 19, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 25, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 25, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(z, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 26, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(x, $i1, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 27, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 28, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i1);
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 29, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 36, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 39, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 39, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 40, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 42, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 42, 2} true;
...
$bb8:
  ...
  goto $bb4;
$bb9:
  assume {:sourceloc "benchmarks/imm/paper-E3.6.c", 44, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
