; ModuleID = '/home/ponce/git/Dat3M/output/paper-E3.2.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/imm/paper-E3.2.c"
...
@.str = private unnamed_addr constant [20 x i8] c"!(a == 0 && b == 1)\00", align 1
@.str.1 = private unnamed_addr constant [50 x i8] c"/home/ponce/git/Dat3M/benchmarks/imm/paper-E3.2.c\00", align 1
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !36 {
  ...
  %2 = atomicrmw add i32* @x, i32 1 monotonic, align 4, !dbg !42
  call void @llvm.dbg.value(metadata i32 %2, metadata !43, metadata !DIExpression()), !dbg !41
  fence seq_cst, !dbg !44
  store i32 %2, i32* @a, align 4, !dbg !45
  ret i8* null, !dbg !46
}
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !47 {
  ...
  store atomic i32 2, i32* @x monotonic, align 4, !dbg !50
  %2 = load atomic i32, i32* @x monotonic, align 4, !dbg !51
  call void @llvm.dbg.value(metadata i32 %2, metadata !52, metadata !DIExpression()), !dbg !49
  fence seq_cst, !dbg !53
  store i32 %2, i32* @b, align 4, !dbg !54
  ret i8* null, !dbg !55
}
...
define dso_local i32 @main() #0 !dbg !56 {
  ...
  %12 = icmp eq i32 %11, 1, !dbg !71
  %or.cond = select i1 %10, i1 %12, i1 false, !dbg !71
  br i1 %or.cond, label %13, label %14, !dbg !71

13:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str.1, i64 0, i64 0), i32 noundef 38, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !71
  unreachable, !dbg !71
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/imm/paper-E3.2.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "d86619d83d0f391587e7156a5b638f9c")
!4 = !{!5}
...
!20 = !DIFile(filename: "benchmarks/imm/paper-E3.2.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "d86619d83d0f391587e7156a5b638f9c")
...
!45 = !DILocation(line: 14, column: 4, scope: !36)
!46 = !DILocation(line: 15, column: 2, scope: !36)
!47 = distinct !DISubprogram(name: "thread_2", scope: !20, file: !20, line: 19, type: !37, scopeLine: 20, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !39)
!48 = !DILocalVariable(name: "unused", arg: 1, scope: !47, file: !20, line: 19, type: !16)
!49 = !DILocation(line: 0, scope: !47)
!50 = !DILocation(line: 21, column: 2, scope: !47)
!51 = !DILocation(line: 22, column: 11, scope: !47)
!52 = !DILocalVariable(name: "r0", scope: !47, file: !20, line: 22, type: !23)
!53 = !DILocation(line: 23, column: 2, scope: !47)
!54 = !DILocation(line: 24, column: 4, scope: !47)
!55 = !DILocation(line: 25, column: 2, scope: !47)
!56 = distinct !DISubprogram(name: "main", scope: !20, file: !20, line: 28, type: !57, scopeLine: 29, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !39)
!57 = !DISubroutineType(types: !58)
!58 = !{!23}
!59 = !DILocalVariable(name: "t1", scope: !56, file: !20, line: 30, type: !60)
...
!64 = !DILocation(line: 32, column: 2, scope: !56)
!65 = !DILocalVariable(name: "t2", scope: !56, file: !20, line: 30, type: !60)
!66 = !DILocation(line: 33, column: 2, scope: !56)
!67 = !DILocation(line: 35, column: 15, scope: !56)
!68 = !DILocation(line: 35, column: 2, scope: !56)
!69 = !DILocation(line: 36, column: 15, scope: !56)
!70 = !DILocation(line: 36, column: 2, scope: !56)
!71 = !DILocation(line: 38, column: 2, scope: !72)
!72 = distinct !DILexicalBlock(scope: !73, file: !20, line: 38, column: 2)
!73 = distinct !DILexicalBlock(scope: !56, file: !20, line: 38, column: 2)
!74 = !DILocation(line: 40, column: 2, scope: !56)
