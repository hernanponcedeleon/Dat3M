...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.4-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.4-opt.ll
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.4.c", 15, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.4.c", 24, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
