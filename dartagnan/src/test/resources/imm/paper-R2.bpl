...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-R2-opt.bpl /home/ponce/git/Dat3M/output/paper-R2-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39261));
...
axiom (.str.1 == $sub.ref(0, 7266));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 8301));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 9333));
...
axiom (llvm.dbg.value == $sub.ref(0, 10365));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 11397));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 12429));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-R2.c", 19, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_rmw(x, 1, 4, 1);
  ...
  assume {:sourceloc "benchmarks/imm/paper-R2.c", 22, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-R2.c", 32, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__llvm_atomic32_load == $sub.ref(0, 16557));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 17589));
...
axiom (__SMACK_dummy == $sub.ref(0, 24813));
...
axiom (__SMACK_and32 == $sub.ref(0, 25845));
...
axiom (__SMACK_and64 == $sub.ref(0, 26877));
...
axiom (__SMACK_and16 == $sub.ref(0, 27909));
...
axiom (__SMACK_and8 == $sub.ref(0, 28941));
...
axiom (__SMACK_or32 == $sub.ref(0, 29973));
...
axiom (__SMACK_or64 == $sub.ref(0, 31005));
...
axiom (__SMACK_or16 == $sub.ref(0, 32037));
...
axiom (__SMACK_or8 == $sub.ref(0, 33069));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 34101));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 35133));
...
axiom (__SMACK_decls == $sub.ref(0, 36165));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37197));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38229));
...
axiom (__SMACK_static_init == $sub.ref(0, 39261));
