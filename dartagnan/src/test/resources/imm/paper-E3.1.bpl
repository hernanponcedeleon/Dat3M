...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.1-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.1-opt.ll
...
axiom (__llvm_atomic32_store == $sub.ref(0, 10361));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 11393));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load(x, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-E3.1.c", 22, 6} true;
  assume {:verifier.code 0} true;
...
axiom (__llvm_atomic32_load == $sub.ref(0, 12425));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 13457));
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.1.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 37, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/imm/paper-E3.1.c", 37, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
