...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.8-alt-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.8-alt-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 40305));
...
const {:allocSize 40} .str: ref;
axiom (.str == $sub.ref(0, 7232));
const {:allocSize 54} {:count 54} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 8310));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 9345));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 10377));
...
axiom (llvm.dbg.value == $sub.ref(0, 11409));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_load: ref;
axiom (__llvm_atomic32_load == $sub.ref(0, 12441));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 13473));
procedure  __llvm_atomic_fence($i0: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 14505));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(x, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 23, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
...
axiom (__llvm_atomic32_store == $sub.ref(0, 15537));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 16569));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 29, 2} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(y, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 29, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
...
const thread_4: ref;
axiom (thread_4 == $sub.ref(0, 17601));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 34, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(y, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 35, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load(x, 2);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 37, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 56, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 56, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 56, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__SMACK_dummy == $sub.ref(0, 25857));
...
axiom (__SMACK_and32 == $sub.ref(0, 26889));
...
axiom (__SMACK_and64 == $sub.ref(0, 27921));
...
axiom (__SMACK_and16 == $sub.ref(0, 28953));
...
axiom (__SMACK_and8 == $sub.ref(0, 29985));
...
axiom (__SMACK_or32 == $sub.ref(0, 31017));
...
axiom (__SMACK_or64 == $sub.ref(0, 32049));
...
axiom (__SMACK_or16 == $sub.ref(0, 33081));
...
axiom (__SMACK_or8 == $sub.ref(0, 34113));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 35145));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 36177));
...
axiom (__SMACK_decls == $sub.ref(0, 37209));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 38241));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 39273));
...
axiom (__SMACK_static_init == $sub.ref(0, 40305));
