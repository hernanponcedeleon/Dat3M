...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/paper-E3.8-alt.bpl /Users/ponce/git/Dat3M/benchmarks/imm/paper-E3.8-alt.c
...
axiom (b == $sub.ref(0, 4112));
const {:allocSize 4} c: ref;
axiom (c == $sub.ref(0, 5140));
const {:allocSize 4} d: ref;
axiom (d == $sub.ref(0, 6168));
const thread_1: ref;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 12, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(x, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(y, 2);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 15, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 16, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i2);
  call {:cexpr "b"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 17, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 22, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 23, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (atomic_store_explicit == $sub.ref(0, 12360));
procedure  atomic_store_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 13392));
procedure  thread_3($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 28, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 28, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(y, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 29, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const thread_4: ref;
axiom (thread_4 == $sub.ref(0, 14424));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 34, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 34, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(y, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 35, 11} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(x, 2);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 36, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 37, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i1);
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 38, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, d, $i2);
  call {:cexpr "d"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 39, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 46, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 46, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread_1, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 47, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 48, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread_3, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 49, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, thread_4, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 51, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 51, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 52, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 52, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 53, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 53, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 54, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 54, 2} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 56, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 56, 2} true;
...
$bb10:
  ...
  goto $bb4;
$bb11:
  assume {:sourceloc "benchmarks/imm/paper-E3.8-alt.c", 58, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb0:
  ...
  $M.0 := $store.i32($M.0, c, 0);
  call {:cexpr "c"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, d, 0);
