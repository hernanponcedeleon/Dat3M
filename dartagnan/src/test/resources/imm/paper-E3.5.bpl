...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/paper-E3.5.bpl /Users/ponce/git/Dat3M/benchmarks/imm/paper-E3.5.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 34036));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 12, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(x, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 13, 34} true;
  assume {:verifier.code 0} true;
  $i2 := $sext.i32.i64($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 13, 34} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref(y, $mul.ref($i2, 4));
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_load_explicit.ref.i32($p3, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_store_explicit.ref.i32.i32(y, 1, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 16, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i4);
  call {:cexpr "b"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 18, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (atomic_store_explicit == $sub.ref(0, 9268));
...
procedure  atomic_thread_fence.i32(p.0: i32)
  returns ($r: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 11332));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 23, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 23, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(y, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 24, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(x, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 25, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 26, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i1);
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 27, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 34, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 35, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 37, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 38, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 40, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 40, 2} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 42, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 13396));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 14428));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 15460));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 16492));
...
axiom (__SMACK_dummy == $sub.ref(0, 17524));
...
axiom (__VERIFIER_assert == $sub.ref(0, 18556));
...
axiom (__SMACK_and32 == $sub.ref(0, 19588));
...
axiom (__SMACK_and64 == $sub.ref(0, 20620));
...
axiom (__SMACK_and16 == $sub.ref(0, 21652));
...
axiom (__SMACK_and8 == $sub.ref(0, 22684));
...
axiom (__SMACK_or32 == $sub.ref(0, 23716));
...
axiom (__SMACK_or64 == $sub.ref(0, 24748));
...
axiom (__SMACK_or16 == $sub.ref(0, 25780));
...
axiom (__SMACK_or8 == $sub.ref(0, 26812));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 27844));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 28876));
...
axiom (__SMACK_decls == $sub.ref(0, 29908));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 30940));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 31972));
...
axiom (llvm.dbg.value == $sub.ref(0, 33004));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 34036));
