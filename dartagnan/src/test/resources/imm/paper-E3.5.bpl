...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.5-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.5-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 37189));
...
const {:allocSize 20} .str: ref;
axiom (.str == $sub.ref(0, 6184));
const {:allocSize 50} {:count 50} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 7258));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 8293));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 9325));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 16, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.5.c", 26, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__SMACK_dummy == $sub.ref(0, 22741));
...
axiom (__SMACK_and32 == $sub.ref(0, 23773));
...
axiom (__SMACK_and64 == $sub.ref(0, 24805));
...
axiom (__SMACK_and16 == $sub.ref(0, 25837));
...
axiom (__SMACK_and8 == $sub.ref(0, 26869));
...
axiom (__SMACK_or32 == $sub.ref(0, 27901));
...
axiom (__SMACK_or64 == $sub.ref(0, 28933));
...
axiom (__SMACK_or16 == $sub.ref(0, 29965));
...
axiom (__SMACK_or8 == $sub.ref(0, 30997));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 32029));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 33061));
...
axiom (__SMACK_decls == $sub.ref(0, 34093));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 35125));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 36157));
...
axiom (__SMACK_static_init == $sub.ref(0, 37189));
