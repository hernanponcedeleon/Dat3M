...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/paper-E3.8.bpl /Users/ponce/git/Dat3M/benchmarks/imm/paper-E3.8.c
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 12, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(x, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 14, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(y, 2);
  call {:cexpr "r1"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 16, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i3);
  call {:cexpr "b"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 18, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 23, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 24, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 29, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 29, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(y, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 30, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 35, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 35, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(y, 2);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 36, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 37, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(x, 2);
  call {:cexpr "r1"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 39, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i1);
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 40, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, d, $i3);
  call {:cexpr "d"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 41, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 48, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 49, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 50, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread_3, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 51, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, thread_4, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 53, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 53, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 54, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 54, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 55, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 55, 2} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 56, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p3);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 56, 2} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 58, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 58, 2} true;
...
$bb10:
  ...
  goto $bb4;
$bb11:
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 60, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
