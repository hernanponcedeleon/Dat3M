...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.8-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.8-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 40301));
...
axiom (.str.1 == $sub.ref(0, 8306));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 9341));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 10373));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 14, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 16, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (llvm.dbg.value == $sub.ref(0, 11405));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_load: ref;
axiom (__llvm_atomic32_load == $sub.ref(0, 12437));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 13469));
procedure  __llvm_atomic_fence($i0: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 14501));
...
axiom (__llvm_atomic32_store == $sub.ref(0, 15533));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_3: ref;
axiom (thread_3 == $sub.ref(0, 16565));
...
const thread_4: ref;
axiom (thread_4 == $sub.ref(0, 17597));
...
$bb0:
  ...
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 37, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
  ...
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 39, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 58, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 58, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/imm/paper-E3.8.c", 58, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__SMACK_dummy == $sub.ref(0, 25853));
...
axiom (__SMACK_and32 == $sub.ref(0, 26885));
...
axiom (__SMACK_and64 == $sub.ref(0, 27917));
...
axiom (__SMACK_and16 == $sub.ref(0, 28949));
...
axiom (__SMACK_and8 == $sub.ref(0, 29981));
...
axiom (__SMACK_or32 == $sub.ref(0, 31013));
...
axiom (__SMACK_or64 == $sub.ref(0, 32045));
...
axiom (__SMACK_or16 == $sub.ref(0, 33077));
...
axiom (__SMACK_or8 == $sub.ref(0, 34109));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 35141));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 36173));
...
axiom (__SMACK_decls == $sub.ref(0, 37205));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 38237));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 39269));
...
axiom (__SMACK_static_init == $sub.ref(0, 40301));
