...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.3-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.3-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 36161));
...
axiom (.str.1 == $sub.ref(0, 6230));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 7265));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 8297));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 15, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 24, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 38, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 38, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__SMACK_dummy == $sub.ref(0, 21713));
...
axiom (__SMACK_and32 == $sub.ref(0, 22745));
...
axiom (__SMACK_and64 == $sub.ref(0, 23777));
...
axiom (__SMACK_and16 == $sub.ref(0, 24809));
...
axiom (__SMACK_and8 == $sub.ref(0, 25841));
...
axiom (__SMACK_or32 == $sub.ref(0, 26873));
...
axiom (__SMACK_or64 == $sub.ref(0, 27905));
...
axiom (__SMACK_or16 == $sub.ref(0, 28937));
...
axiom (__SMACK_or8 == $sub.ref(0, 29969));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 31001));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 32033));
...
axiom (__SMACK_decls == $sub.ref(0, 33065));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 34097));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 35129));
...
axiom (__SMACK_static_init == $sub.ref(0, 36161));
