...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/paper-E3.3.bpl /Users/ponce/git/Dat3M/benchmarks/imm/paper-E3.3.c
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 12, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(x, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(y, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 15, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i1);
  call {:cexpr "a"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 16, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 21, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 21, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(y, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(x, 1, 3);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 24, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, $i1);
  call {:cexpr "b"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 25, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 32, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 33, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 35, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 35, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 36, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 38, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 38, 2} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "benchmarks/imm/paper-E3.3.c", 40, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
