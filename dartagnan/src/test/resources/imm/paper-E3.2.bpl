...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.2-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.2-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 36165));
...
axiom (.str == $sub.ref(0, 4128));
const {:allocSize 50} {:count 50} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 5202));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 6237));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 7269));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.2.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_rmw(x, 1, 0, 1);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.2.c", 14, 6} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.value == $sub.ref(0, 8301));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_rmw: ref;
axiom (__llvm_atomic32_rmw == $sub.ref(0, 9333));
procedure  __llvm_atomic32_rmw($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 10365));
procedure  __llvm_atomic_fence($i0: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 11397));
procedure  thread_2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.2.c", 22, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.2.c", 22, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(x, 2, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.2.c", 22, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(x, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.2.c", 24, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__SMACK_dummy == $sub.ref(0, 21717));
...
axiom (__SMACK_and32 == $sub.ref(0, 22749));
...
axiom (__SMACK_and64 == $sub.ref(0, 23781));
...
axiom (__SMACK_and16 == $sub.ref(0, 24813));
...
axiom (__SMACK_and8 == $sub.ref(0, 25845));
...
axiom (__SMACK_or32 == $sub.ref(0, 26877));
...
axiom (__SMACK_or64 == $sub.ref(0, 27909));
...
axiom (__SMACK_or16 == $sub.ref(0, 28941));
...
axiom (__SMACK_or8 == $sub.ref(0, 29973));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 31005));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 32037));
...
axiom (__SMACK_decls == $sub.ref(0, 33069));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 34101));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 35133));
...
axiom (__SMACK_static_init == $sub.ref(0, 36165));
