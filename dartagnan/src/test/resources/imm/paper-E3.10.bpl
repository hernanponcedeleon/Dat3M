...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.10-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.10-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39260));
...
axiom (.str.1 == $sub.ref(0, 8297));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 9332));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 10364));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.10.c", 15, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_rmw(x, 1, 3, 1);
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.10.c", 25, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__llvm_atomic32_rmw == $sub.ref(0, 16556));
procedure  __llvm_atomic32_rmw($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 17588));
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.10.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 40, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/imm/paper-E3.10.c", 40, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__SMACK_dummy == $sub.ref(0, 24812));
...
axiom (__SMACK_and32 == $sub.ref(0, 25844));
...
axiom (__SMACK_and64 == $sub.ref(0, 26876));
...
axiom (__SMACK_and16 == $sub.ref(0, 27908));
...
axiom (__SMACK_and8 == $sub.ref(0, 28940));
...
axiom (__SMACK_or32 == $sub.ref(0, 29972));
...
axiom (__SMACK_or64 == $sub.ref(0, 31004));
...
axiom (__SMACK_or16 == $sub.ref(0, 32036));
...
axiom (__SMACK_or8 == $sub.ref(0, 33068));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 34100));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 35132));
...
axiom (__SMACK_decls == $sub.ref(0, 36164));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37196));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38228));
...
axiom (__SMACK_static_init == $sub.ref(0, 39260));
