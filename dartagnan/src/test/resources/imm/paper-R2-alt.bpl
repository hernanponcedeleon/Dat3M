...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-R2-alt-opt.bpl /home/ponce/git/Dat3M/output/paper-R2-alt-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39265));
...
axiom (.str == $sub.ref(0, 6194));
const {:allocSize 52} {:count 52} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 7270));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 8305));
const thread_1: ref;
axiom (thread_1 == $sub.ref(0, 9337));
...
axiom (llvm.dbg.value == $sub.ref(0, 10369));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 11401));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 12433));
procedure  thread_2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-R2-alt.c", 20, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-R2-alt.c", 20, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_rmw(x, 1, 2, 1);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-R2-alt.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(x, 3, 0);
  assume {:sourceloc "benchmarks/imm/paper-R2-alt.c", 23, 6} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load(y, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/imm/paper-R2-alt.c", 33, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
axiom (__llvm_atomic32_load == $sub.ref(0, 16561));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 17593));
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/imm/paper-R2-alt.c", 50, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 50, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/imm/paper-R2-alt.c", 50, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
...
axiom (__SMACK_dummy == $sub.ref(0, 24817));
...
axiom (__SMACK_and32 == $sub.ref(0, 25849));
...
axiom (__SMACK_and64 == $sub.ref(0, 26881));
...
axiom (__SMACK_and16 == $sub.ref(0, 27913));
...
axiom (__SMACK_and8 == $sub.ref(0, 28945));
...
axiom (__SMACK_or32 == $sub.ref(0, 29977));
...
axiom (__SMACK_or64 == $sub.ref(0, 31009));
...
axiom (__SMACK_or16 == $sub.ref(0, 32041));
...
axiom (__SMACK_or8 == $sub.ref(0, 33073));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 34105));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 35137));
...
axiom (__SMACK_decls == $sub.ref(0, 36169));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37201));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38233));
...
axiom (__SMACK_static_init == $sub.ref(0, 39265));
