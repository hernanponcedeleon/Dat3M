...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/paper-E3.7-opt.bpl /home/ponce/git/Dat3M/output/paper-E3.7-opt.ll
...
axiom (__llvm_atomic32_store == $sub.ref(0, 12427));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 13459));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 18, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := __llvm_atomic32_load(z, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 19, 30} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32($i1, 1);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 20, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(x, $i2, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 20, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := __llvm_atomic32_load(x, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(y, $i3, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 23, 6} true;
  assume {:verifier.code 0} true;
...
axiom (__llvm_atomic32_load == $sub.ref(0, 14491));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic_fence: ref;
axiom (__llvm_atomic_fence == $sub.ref(0, 15523));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(z, $i1, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 33, 6} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic_fence(5);
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 49, 2} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 49, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 49, 2} true;
  assume {:verifier.code 0} true;
  assume false;
$bb2:
