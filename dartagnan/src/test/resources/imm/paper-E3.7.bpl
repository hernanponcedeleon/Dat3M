...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/paper-E3.7.bpl /Users/ponce/git/Dat3M/benchmarks/imm/paper-E3.7.c
  ...
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 12, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_store_explicit.ref.i32.i32(x, 1, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 13, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 18, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 18, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(z, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 19, 30} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32($i1, 1);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 19, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_store_explicit.ref.i32.i32(x, $i2, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 20, 11} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_load_explicit.ref.i32(x, 0);
  call {:cexpr "r1"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 21, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_store_explicit.ref.i32.i32(y, $i4, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 23, 4} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 30, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 30, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(y, 0);
  call {:cexpr "r0"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 31, 2} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32(z, $i1, 0);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 32, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_thread_fence.i32(5);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 33, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, c, $i1);
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 34, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 41, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 42, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_2, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 43, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread_3, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 45, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 45, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 46, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 46, 2} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 47, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 47, 2} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 49, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 49, 2} true;
...
$bb8:
  ...
  goto $bb4;
$bb9:
  assume {:sourceloc "benchmarks/imm/paper-E3.7.c", 51, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
