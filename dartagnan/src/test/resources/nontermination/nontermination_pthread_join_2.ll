; ModuleID = 'nontermination_pthread_join_2.c'
source_filename = "nontermination_pthread_join_2.c"
...
4:                                                ; preds = %8, %1
  %5 = load atomic i32, i32* @x acquire, align 4
...
define dso_local i8* @thread1(i8* noundef %0) #0 {
  ...
  store atomic i32 %4, i32* @x release, align 4
  ret i8* null
}
