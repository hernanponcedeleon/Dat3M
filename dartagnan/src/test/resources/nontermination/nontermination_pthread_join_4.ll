; ModuleID = 'nontermination_pthread_join_4.c'
source_filename = "nontermination_pthread_join_4.c"
...
define dso_local i8* @thread(i8* noundef %0) #0 {
  %2 = alloca i8*, align 8
...
define dso_local i32 @main() #0 {
  ...
  %4 = call i32 @pthread_create(i64* noundef %2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thread, i8* noundef null) #3
