...
define i8* @handler(i8* noundef %0) #0 !dbg !79 {
  ...
  call void @__LKMM_FENCE(i32 noundef 13), !dbg !112
...
define i8* @run(i8* noundef %0) #0 !dbg !115 {
  ...
  call void @__LKMM_FENCE(i32 noundef 13), !dbg !147
...
!33 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier_dec_barrier.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
