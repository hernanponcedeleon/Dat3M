; ModuleID = '/home/ponce/git/Dat3M/output/lkmm_with_barrier_inc_split.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/interrupts/lkmm_with_barrier_inc_split.c"
...
13:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([74 x i8], [74 x i8]* @.str.1, i64 0, i64 0), i32 noundef 23, i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @__PRETTY_FUNCTION__.handler, i64 0, i64 0)) #5, !dbg !71
  unreachable, !dbg !71
...
define dso_local i8* @run(i8* noundef %0) #0 !dbg !76 {
  ...
  %7 = add nsw i32 %6, 1, !dbg !87
  store i32 %7, i32* @cnt, align 4, !dbg !88
...
15:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([74 x i8], [74 x i8]* @.str.1, i64 0, i64 0), i32 noundef 39, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @__PRETTY_FUNCTION__.run, i64 0, i64 0)) #5, !dbg !94
  unreachable, !dbg !94

16:                                               ; preds = %1
  %17 = load i64, i64* @h, align 8, !dbg !98
  %18 = call i32 @pthread_join(i64 noundef %17, i8** noundef null), !dbg !99
  ret i8* null, !dbg !100
}
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/interrupts/lkmm_with_barrier_inc_split.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "8c92938bab9d8b13dd5a318d815981d9")
!4 = !{!5}
...
!31 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier_inc_split.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "8c92938bab9d8b13dd5a318d815981d9")
...
!84 = !DILocation(line: 34, column: 13, scope: !76)
!85 = !DILocalVariable(name: "i", scope: !76, file: !31, line: 34, type: !37)
!86 = !DILocation(line: 35, column: 5, scope: !76)
!87 = !DILocation(line: 36, column: 12, scope: !76)
!88 = !DILocation(line: 36, column: 9, scope: !76)
!89 = !DILocation(line: 37, column: 5, scope: !76)
!90 = !DILocation(line: 37, column: 11, scope: !76)
!91 = !DILocation(line: 37, column: 13, scope: !76)
!92 = !DILocation(line: 38, column: 11, scope: !76)
!93 = !DILocation(line: 38, column: 13, scope: !76)
!94 = !DILocation(line: 39, column: 5, scope: !95)
!95 = distinct !DILexicalBlock(scope: !96, file: !31, line: 39, column: 5)
!96 = distinct !DILexicalBlock(scope: !76, file: !31, line: 39, column: 5)
!97 = !DILocation(line: 39, column: 5, scope: !96)
!98 = !DILocation(line: 41, column: 18, scope: !76)
!99 = !DILocation(line: 41, column: 5, scope: !76)
!100 = !DILocation(line: 43, column: 5, scope: !76)
!101 = distinct !DISubprogram(name: "main", scope: !31, file: !31, line: 46, type: !102, scopeLine: 47, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !57)
!102 = !DISubroutineType(types: !103)
!103 = !{!37}
!104 = !DILocalVariable(name: "t", scope: !101, file: !31, line: 48, type: !43)
!105 = !DILocation(line: 48, column: 15, scope: !101)
!106 = !DILocation(line: 49, column: 5, scope: !101)
