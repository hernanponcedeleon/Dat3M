; ModuleID = 'benchmarks/interrupts/c11_with_barrier_dec_barrier.c'
source_filename = "benchmarks/interrupts/c11_with_barrier_dec_barrier.c"
...
define ptr @handler(ptr noundef %0) #0 !dbg !55 {
  ...
  call void @__VERIFIER_make_cb(), !dbg !88
  %32 = load i32, ptr @cnt, align 4, !dbg !89
  %33 = add nsw i32 %32, -1, !dbg !89
  store i32 %33, ptr @cnt, align 4, !dbg !89
  ret ptr null, !dbg !90
}
...
define ptr @run(ptr noundef %0) #0 !dbg !91 {
  ...
  store ptr %0, ptr %2, align 8
    ...
    #dbg_declare(ptr %3, !94, !DIExpression(), !96)
  call void @__VERIFIER_make_interrupt_handler(), !dbg !96
  %7 = call i32 @pthread_create(ptr noundef %3, ptr noundef null, ptr noundef @handler, ptr noundef null), !dbg !96
  %8 = load ptr, ptr %3, align 8, !dbg !96
  store ptr %8, ptr %4, align 8, !dbg !96
  %9 = load ptr, ptr %4, align 8, !dbg !96
    #dbg_declare(ptr %5, !97, !DIExpression(), !98)
  %10 = load ptr, ptr %2, align 8, !dbg !99
  %11 = ptrtoint ptr %10 to i64, !dbg !100
  %12 = trunc i64 %11 to i32, !dbg !101
  store i32 %12, ptr %5, align 4, !dbg !98
  ...
  call void @__VERIFIER_make_cb(), !dbg !105
  ...
  call void @__VERIFIER_make_cb(), !dbg !124
  %37 = load i32, ptr @cnt, align 4, !dbg !125
  %38 = add nsw i32 %37, -1, !dbg !125
  store i32 %38, ptr @cnt, align 4, !dbg !125
...
define i32 @main() #0 !dbg !127 {
  ...
  store i32 0, ptr %1, align 4
    #dbg_declare(ptr %2, !130, !DIExpression(), !131)
...
!3 = !DIFile(filename: "benchmarks/interrupts/c11_with_barrier_dec_barrier.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "06e27475578266783f74b15f1c6b57b1")
!4 = !{!5, !10}
...
!89 = !DILocation(line: 26, column: 8, scope: !55)
!90 = !DILocation(line: 28, column: 5, scope: !55)
!91 = distinct !DISubprogram(name: "run", scope: !3, file: !3, line: 31, type: !56, scopeLine: 32, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !58)
!92 = !DILocalVariable(name: "arg", arg: 1, scope: !91, file: !3, line: 31, type: !10)
!93 = !DILocation(line: 31, column: 17, scope: !91)
!94 = !DILocalVariable(name: "h", scope: !95, file: !3, line: 33, type: !25)
!95 = distinct !DILexicalBlock(scope: !91, file: !3, line: 33, column: 5)
!96 = !DILocation(line: 33, column: 5, scope: !95)
!97 = !DILocalVariable(name: "tindex", scope: !91, file: !3, line: 35, type: !19)
!98 = !DILocation(line: 35, column: 9, scope: !91)
!99 = !DILocation(line: 35, column: 30, scope: !91)
!100 = !DILocation(line: 35, column: 19, scope: !91)
!101 = !DILocation(line: 35, column: 18, scope: !91)
!102 = !DILocalVariable(name: "i", scope: !91, file: !3, line: 36, type: !19)
!103 = !DILocation(line: 36, column: 9, scope: !91)
!104 = !DILocation(line: 36, column: 16, scope: !91)
!105 = !DILocation(line: 37, column: 5, scope: !91)
!106 = !DILocation(line: 38, column: 15, scope: !91)
!107 = !DILocation(line: 38, column: 8, scope: !91)
!108 = !DILocation(line: 38, column: 5, scope: !91)
!109 = !DILocation(line: 38, column: 11, scope: !91)
!110 = !DILocation(line: 38, column: 13, scope: !91)
!111 = !DILocation(line: 39, column: 15, scope: !91)
!112 = !DILocation(line: 39, column: 8, scope: !91)
!113 = !DILocation(line: 39, column: 5, scope: !91)
!114 = !DILocation(line: 39, column: 11, scope: !91)
!115 = !DILocation(line: 39, column: 13, scope: !91)
!116 = !DILocation(line: 40, column: 26, scope: !91)
!117 = !DILocation(line: 40, column: 23, scope: !91)
!118 = !DILocation(line: 40, column: 29, scope: !91)
!119 = !DILocation(line: 40, column: 37, scope: !91)
!120 = !DILocation(line: 40, column: 34, scope: !91)
!121 = !DILocation(line: 40, column: 40, scope: !91)
!122 = !DILocation(line: 40, column: 31, scope: !91)
!123 = !DILocation(line: 40, column: 5, scope: !91)
!124 = !DILocation(line: 42, column: 5, scope: !91)
!125 = !DILocation(line: 43, column: 8, scope: !91)
!126 = !DILocation(line: 45, column: 5, scope: !91)
!127 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 48, type: !128, scopeLine: 49, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !58)
!128 = !DISubroutineType(types: !129)
!129 = !{!19}
!130 = !DILocalVariable(name: "t", scope: !127, file: !3, line: 50, type: !25)
