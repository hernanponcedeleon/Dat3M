; ModuleID = '/home/ponce/git/Dat3M/output/lkmm_detour.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/interrupts/lkmm_detour.c"
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !55 {
  ...
  call void @__LKMM_STORE(i8* noundef bitcast (i32* @x to i8*), i32 noundef 1, i32 noundef 1), !dbg !60
  %4 = call i32 @__LKMM_LOAD(i8* noundef bitcast (i32* @y to i8*), i32 noundef 1), !dbg !61
  store i32 %4, i32* @a, align 4, !dbg !62
  %5 = load i64, i64* @h, align 8, !dbg !63
  %6 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !64
  ret i8* null, !dbg !65
}
...
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !66 {
  ...
  %2 = call i32 @__LKMM_LOAD(i8* noundef bitcast (i32* @x to i8*), i32 noundef 1), !dbg !69
  store i32 %2, i32* @b, align 4, !dbg !70
  call void @__LKMM_STORE(i8* noundef bitcast (i32* @y to i8*), i32 noundef 2, i32 noundef 3), !dbg !71
  ret i8* null, !dbg !72
}
...
define dso_local i32 @main() #0 !dbg !73 {
  ...
  call void @llvm.dbg.declare(metadata i64* %1, metadata !76, metadata !DIExpression()), !dbg !77
  call void @llvm.dbg.declare(metadata i64* %2, metadata !78, metadata !DIExpression()), !dbg !79
  %3 = call i32 @pthread_create(i64* noundef %1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thread_1, i8* noundef null) #5, !dbg !80
  %4 = call i32 @pthread_create(i64* noundef %2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thread_2, i8* noundef null) #5, !dbg !81
  %5 = load i64, i64* %1, align 8, !dbg !82
  %6 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !83
  %7 = load i64, i64* %2, align 8, !dbg !84
  %8 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !85
  %9 = load i32, i32* @b, align 4, !dbg !86
  %10 = icmp eq i32 %9, 1, !dbg !86
  %11 = load i32, i32* @a, align 4, !dbg !86
  %12 = icmp eq i32 %11, 3, !dbg !86
  %or.cond = select i1 %10, i1 %12, i1 false, !dbg !86
  %13 = load i32, i32* @y, align 4, !dbg !86
  %14 = icmp eq i32 %13, 3, !dbg !86
  %or.cond3 = select i1 %or.cond, i1 %14, i1 false, !dbg !86
  br i1 %or.cond3, label %15, label %16, !dbg !86

15:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([58 x i8], [58 x i8]* @.str.1, i64 0, i64 0), i32 noundef 45, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !86
  unreachable, !dbg !86
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/interrupts/lkmm_detour.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "9a23fa35c5735fb3738a52445b121186")
!4 = !{!5}
...
!28 = !DIFile(filename: "benchmarks/interrupts/lkmm_detour.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "9a23fa35c5735fb3738a52445b121186")
...
!62 = !DILocation(line: 22, column: 7, scope: !55)
!63 = !DILocation(line: 24, column: 18, scope: !55)
!64 = !DILocation(line: 24, column: 5, scope: !55)
!65 = !DILocation(line: 26, column: 5, scope: !55)
!66 = distinct !DISubprogram(name: "thread_2", scope: !28, file: !28, line: 29, type: !48, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !50)
!67 = !DILocalVariable(name: "arg", arg: 1, scope: !66, file: !28, line: 29, type: !24)
!68 = !DILocation(line: 0, scope: !66)
!69 = !DILocation(line: 31, column: 9, scope: !66)
!70 = !DILocation(line: 31, column: 7, scope: !66)
!71 = !DILocation(line: 32, column: 5, scope: !66)
!72 = !DILocation(line: 33, column: 5, scope: !66)
!73 = distinct !DISubprogram(name: "main", scope: !28, file: !28, line: 36, type: !74, scopeLine: 37, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !50)
!74 = !DISubroutineType(types: !75)
!75 = !{!29}
!76 = !DILocalVariable(name: "t1", scope: !73, file: !28, line: 38, type: !36)
!77 = !DILocation(line: 38, column: 15, scope: !73)
!78 = !DILocalVariable(name: "t2", scope: !73, file: !28, line: 38, type: !36)
!79 = !DILocation(line: 38, column: 19, scope: !73)
!80 = !DILocation(line: 40, column: 5, scope: !73)
!81 = !DILocation(line: 41, column: 5, scope: !73)
!82 = !DILocation(line: 42, column: 18, scope: !73)
!83 = !DILocation(line: 42, column: 5, scope: !73)
!84 = !DILocation(line: 43, column: 18, scope: !73)
!85 = !DILocation(line: 43, column: 5, scope: !73)
!86 = !DILocation(line: 45, column: 5, scope: !87)
!87 = distinct !DILexicalBlock(scope: !88, file: !28, line: 45, column: 5)
!88 = distinct !DILexicalBlock(scope: !73, file: !28, line: 45, column: 5)
!89 = !DILocation(line: 47, column: 5, scope: !73)
