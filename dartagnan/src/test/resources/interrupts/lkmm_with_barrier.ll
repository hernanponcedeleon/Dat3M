...
define i8* @run(i8* noundef %0) #0 !dbg !113 {
  ...
  %10 = add nsw i32 %9, 1, !dbg !125
  store i32 %10, i32* @cnt, align 4, !dbg !125
  store i32 %9, i32* %4, align 4, !dbg !124
  call void @__LKMM_FENCE(i32 noundef 13), !dbg !126
  %11 = load i32, i32* %3, align 4, !dbg !127
  %12 = load i32, i32* %4, align 4, !dbg !128
  %13 = sext i32 %12 to i64, !dbg !129
  %14 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %13, !dbg !129
  %15 = getelementptr inbounds %struct.A, %struct.A* %14, i32 0, i32 0, !dbg !130
  store volatile i32 %11, i32* %15, align 4, !dbg !131
  %16 = load i32, i32* %3, align 4, !dbg !132
  %17 = load i32, i32* %4, align 4, !dbg !133
  %18 = sext i32 %17 to i64, !dbg !134
  %19 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %18, !dbg !134
  %20 = getelementptr inbounds %struct.A, %struct.A* %19, i32 0, i32 1, !dbg !135
  store volatile i32 %16, i32* %20, align 4, !dbg !136
  %21 = load i32, i32* %4, align 4, !dbg !137
  %22 = sext i32 %21 to i64, !dbg !138
  %23 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %22, !dbg !138
  %24 = getelementptr inbounds %struct.A, %struct.A* %23, i32 0, i32 0, !dbg !139
  %25 = load volatile i32, i32* %24, align 4, !dbg !139
  %26 = load i32, i32* %4, align 4, !dbg !140
  %27 = sext i32 %26 to i64, !dbg !141
  %28 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %27, !dbg !141
  %29 = getelementptr inbounds %struct.A, %struct.A* %28, i32 0, i32 1, !dbg !142
  %30 = load volatile i32, i32* %29, align 4, !dbg !142
  %31 = icmp eq i32 %25, %30, !dbg !143
  %32 = zext i1 %31 to i32, !dbg !143
  call void @__VERIFIER_assert(i32 noundef %32), !dbg !144
  %33 = load %struct._opaque_pthread_t*, %struct._opaque_pthread_t** @h, align 8, !dbg !145
  %34 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* noundef %33, i8** noundef null), !dbg !146
  ret i8* null, !dbg !147
}
...
; Function Attrs: noinline nounwind ssp uwtable
define i32 @main() #0 !dbg !148 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._opaque_pthread_t*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._opaque_pthread_t** %2, metadata !151, metadata !DIExpression()), !dbg !152
  %3 = call i32 @pthread_create(%struct._opaque_pthread_t** noundef %2, %struct._opaque_pthread_attr_t* noundef null, i8* (i8*)* noundef @run, i8* noundef inttoptr (i64 1 to i8*)), !dbg !153
  ret i32 0, !dbg !154
}
...
!33 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
...
!125 = !DILocation(line: 34, column: 16, scope: !113)
!126 = !DILocation(line: 35, column: 5, scope: !113)
!127 = !DILocation(line: 36, column: 15, scope: !113)
!128 = !DILocation(line: 36, column: 8, scope: !113)
!129 = !DILocation(line: 36, column: 5, scope: !113)
!130 = !DILocation(line: 36, column: 11, scope: !113)
!131 = !DILocation(line: 36, column: 13, scope: !113)
!132 = !DILocation(line: 37, column: 15, scope: !113)
!133 = !DILocation(line: 37, column: 8, scope: !113)
!134 = !DILocation(line: 37, column: 5, scope: !113)
!135 = !DILocation(line: 37, column: 11, scope: !113)
!136 = !DILocation(line: 37, column: 13, scope: !113)
!137 = !DILocation(line: 38, column: 26, scope: !113)
!138 = !DILocation(line: 38, column: 23, scope: !113)
!139 = !DILocation(line: 38, column: 29, scope: !113)
!140 = !DILocation(line: 38, column: 37, scope: !113)
!141 = !DILocation(line: 38, column: 34, scope: !113)
!142 = !DILocation(line: 38, column: 40, scope: !113)
!143 = !DILocation(line: 38, column: 31, scope: !113)
!144 = !DILocation(line: 38, column: 5, scope: !113)
!145 = !DILocation(line: 40, column: 18, scope: !113)
!146 = !DILocation(line: 40, column: 5, scope: !113)
!147 = !DILocation(line: 42, column: 5, scope: !113)
!148 = distinct !DISubprogram(name: "main", scope: !33, file: !33, line: 45, type: !149, scopeLine: 46, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !82)
!149 = !DISubroutineType(types: !150)
!150 = !{!39}
!151 = !DILocalVariable(name: "t", scope: !148, file: !33, line: 47, type: !45)
!152 = !DILocation(line: 47, column: 15, scope: !148)
!153 = !DILocation(line: 48, column: 5, scope: !148)
