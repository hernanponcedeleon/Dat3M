; ModuleID = 'benchmarks/interrupts/lkmm_with_barrier.c'
source_filename = "benchmarks/interrupts/lkmm_with_barrier.c"
...
define ptr @run(ptr noundef %0) #0 !dbg !108 {
  ...
  store ptr %0, ptr %2, align 8
    ...
    #dbg_declare(ptr %3, !111, !DIExpression(), !113)
  call void @__VERIFIER_make_interrupt_handler(), !dbg !113
  %7 = call i32 @pthread_create(ptr noundef %3, ptr noundef null, ptr noundef @handler, ptr noundef null), !dbg !113
  %8 = load ptr, ptr %3, align 8, !dbg !113
  store ptr %8, ptr %4, align 8, !dbg !113
  %9 = load ptr, ptr %4, align 8, !dbg !113
    #dbg_declare(ptr %5, !114, !DIExpression(), !115)
  %10 = load ptr, ptr %2, align 8, !dbg !116
  %11 = ptrtoint ptr %10 to i64, !dbg !117
  %12 = trunc i64 %11 to i32, !dbg !118
  store i32 %12, ptr %5, align 4, !dbg !115
    #dbg_declare(ptr %6, !119, !DIExpression(), !120)
  %13 = load i32, ptr @cnt, align 4, !dbg !121
  %14 = add nsw i32 %13, 1, !dbg !121
  store i32 %14, ptr @cnt, align 4, !dbg !121
  store i32 %13, ptr %6, align 4, !dbg !120
  call void @__LKMM_FENCE(i32 noundef 13), !dbg !122
  %15 = load i32, ptr %5, align 4, !dbg !123
  %16 = load i32, ptr %6, align 4, !dbg !124
  %17 = sext i32 %16 to i64, !dbg !125
  %18 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %17, !dbg !125
  %19 = getelementptr inbounds %struct.A, ptr %18, i32 0, i32 0, !dbg !126
  store volatile i32 %15, ptr %19, align 4, !dbg !127
  %20 = load i32, ptr %5, align 4, !dbg !128
  %21 = load i32, ptr %6, align 4, !dbg !129
  %22 = sext i32 %21 to i64, !dbg !130
  %23 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %22, !dbg !130
  %24 = getelementptr inbounds %struct.A, ptr %23, i32 0, i32 1, !dbg !131
  store volatile i32 %20, ptr %24, align 4, !dbg !132
  %25 = load i32, ptr %6, align 4, !dbg !133
  %26 = sext i32 %25 to i64, !dbg !134
  %27 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %26, !dbg !134
  %28 = getelementptr inbounds %struct.A, ptr %27, i32 0, i32 0, !dbg !135
  %29 = load volatile i32, ptr %28, align 4, !dbg !135
  %30 = load i32, ptr %6, align 4, !dbg !136
  %31 = sext i32 %30 to i64, !dbg !137
  %32 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %31, !dbg !137
  %33 = getelementptr inbounds %struct.A, ptr %32, i32 0, i32 1, !dbg !138
  %34 = load volatile i32, ptr %33, align 4, !dbg !138
  %35 = icmp eq i32 %29, %34, !dbg !139
  %36 = zext i1 %35 to i32, !dbg !139
  call void @__VERIFIER_assert(i32 noundef %36), !dbg !140
...
define i32 @main() #0 !dbg !142 {
  ...
  %3 = call i32 @pthread_create(ptr noundef %2, ptr noundef null, ptr noundef @run, ptr noundef inttoptr (i64 1 to ptr)), !dbg !147
  ret i32 0, !dbg !148
}
...
!3 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "5251a305d7eb80830e6936c251c06255")
!4 = !{!5}
...
!108 = distinct !DISubprogram(name: "run", scope: !3, file: !3, line: 28, type: !75, scopeLine: 29, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !77)
!109 = !DILocalVariable(name: "arg", arg: 1, scope: !108, file: !3, line: 28, type: !29)
!110 = !DILocation(line: 28, column: 17, scope: !108)
!111 = !DILocalVariable(name: "h", scope: !112, file: !3, line: 30, type: !44)
!112 = distinct !DILexicalBlock(scope: !108, file: !3, line: 30, column: 5)
!113 = !DILocation(line: 30, column: 5, scope: !112)
!114 = !DILocalVariable(name: "tindex", scope: !108, file: !3, line: 32, type: !38)
!115 = !DILocation(line: 32, column: 9, scope: !108)
!116 = !DILocation(line: 32, column: 30, scope: !108)
!117 = !DILocation(line: 32, column: 19, scope: !108)
!118 = !DILocation(line: 32, column: 18, scope: !108)
!119 = !DILocalVariable(name: "i", scope: !108, file: !3, line: 33, type: !38)
!120 = !DILocation(line: 33, column: 9, scope: !108)
!121 = !DILocation(line: 33, column: 16, scope: !108)
!122 = !DILocation(line: 34, column: 5, scope: !108)
!123 = !DILocation(line: 35, column: 15, scope: !108)
!124 = !DILocation(line: 35, column: 8, scope: !108)
!125 = !DILocation(line: 35, column: 5, scope: !108)
!126 = !DILocation(line: 35, column: 11, scope: !108)
!127 = !DILocation(line: 35, column: 13, scope: !108)
!128 = !DILocation(line: 36, column: 15, scope: !108)
!129 = !DILocation(line: 36, column: 8, scope: !108)
!130 = !DILocation(line: 36, column: 5, scope: !108)
!131 = !DILocation(line: 36, column: 11, scope: !108)
!132 = !DILocation(line: 36, column: 13, scope: !108)
!133 = !DILocation(line: 37, column: 26, scope: !108)
!134 = !DILocation(line: 37, column: 23, scope: !108)
!135 = !DILocation(line: 37, column: 29, scope: !108)
!136 = !DILocation(line: 37, column: 37, scope: !108)
!137 = !DILocation(line: 37, column: 34, scope: !108)
!138 = !DILocation(line: 37, column: 40, scope: !108)
!139 = !DILocation(line: 37, column: 31, scope: !108)
!140 = !DILocation(line: 37, column: 5, scope: !108)
!141 = !DILocation(line: 39, column: 5, scope: !108)
!142 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 42, type: !143, scopeLine: 43, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !77)
!143 = !DISubroutineType(types: !144)
!144 = !{!38}
!145 = !DILocalVariable(name: "t", scope: !142, file: !3, line: 44, type: !44)
!146 = !DILocation(line: 44, column: 15, scope: !142)
!147 = !DILocation(line: 45, column: 5, scope: !142)
!148 = !DILocation(line: 47, column: 5, scope: !142)
