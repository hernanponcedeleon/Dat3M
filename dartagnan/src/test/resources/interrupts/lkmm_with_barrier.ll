; ModuleID = '/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/lkmm_with_barrier.c'
source_filename = "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/lkmm_with_barrier.c"
...
; Function Attrs: noinline nounwind ssp uwtable(sync)
define ptr @run(ptr noundef %0) #0 !dbg !108 {
  %2 = alloca ptr, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store ptr %0, ptr %2, align 8
  call void @llvm.dbg.declare(metadata ptr %2, metadata !109, metadata !DIExpression()), !dbg !110
  call void @__VERIFIER_make_interrupt_handler(), !dbg !111
  %5 = call i32 @pthread_create(ptr noundef @h, ptr noundef null, ptr noundef @handler, ptr noundef null), !dbg !112
  ...
  %8 = trunc i64 %7 to i32, !dbg !117
  store i32 %8, ptr %3, align 4, !dbg !114
  call void @llvm.dbg.declare(metadata ptr %4, metadata !118, metadata !DIExpression()), !dbg !119
  %9 = load i32, ptr @cnt, align 4, !dbg !120
  %10 = add nsw i32 %9, 1, !dbg !120
  store i32 %10, ptr @cnt, align 4, !dbg !120
  store i32 %9, ptr %4, align 4, !dbg !119
  call void @__LKMM_fence(i32 noundef 12), !dbg !121
  %11 = load i32, ptr %3, align 4, !dbg !122
  %12 = load i32, ptr %4, align 4, !dbg !123
  %13 = sext i32 %12 to i64, !dbg !124
  %14 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %13, !dbg !124
  %15 = getelementptr inbounds %struct.A, ptr %14, i32 0, i32 0, !dbg !125
  store volatile i32 %11, ptr %15, align 4, !dbg !126
  %16 = load i32, ptr %3, align 4, !dbg !127
  %17 = load i32, ptr %4, align 4, !dbg !128
  %18 = sext i32 %17 to i64, !dbg !129
  %19 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %18, !dbg !129
  %20 = getelementptr inbounds %struct.A, ptr %19, i32 0, i32 1, !dbg !130
  store volatile i32 %16, ptr %20, align 4, !dbg !131
  %21 = load i32, ptr %4, align 4, !dbg !132
  %22 = sext i32 %21 to i64, !dbg !133
  %23 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %22, !dbg !133
  %24 = getelementptr inbounds %struct.A, ptr %23, i32 0, i32 0, !dbg !134
  %25 = load volatile i32, ptr %24, align 4, !dbg !134
  %26 = load i32, ptr %4, align 4, !dbg !135
  %27 = sext i32 %26 to i64, !dbg !136
  %28 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %27, !dbg !136
  %29 = getelementptr inbounds %struct.A, ptr %28, i32 0, i32 1, !dbg !137
  %30 = load volatile i32, ptr %29, align 4, !dbg !137
  %31 = icmp eq i32 %25, %30, !dbg !138
  %32 = zext i1 %31 to i32, !dbg !138
  call void @__VERIFIER_assert(i32 noundef %32), !dbg !139
  %33 = load ptr, ptr @h, align 8, !dbg !140
  %34 = call i32 @"\01_pthread_join"(ptr noundef %33, ptr noundef null), !dbg !141
...
define i32 @main() #0 !dbg !143 {
  ...
  %3 = call i32 @pthread_create(ptr noundef %2, ptr noundef null, ptr noundef @run, ptr noundef inttoptr (i64 1 to ptr)), !dbg !148
  ret i32 0, !dbg !149
}
...
!3 = !DIFile(filename: "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/lkmm_with_barrier.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
!4 = !{!5}
...
!32 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
...
!108 = distinct !DISubprogram(name: "run", scope: !32, file: !32, line: 29, type: !75, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !77)
!109 = !DILocalVariable(name: "arg", arg: 1, scope: !108, file: !32, line: 29, type: !28)
!110 = !DILocation(line: 29, column: 17, scope: !108)
!111 = !DILocation(line: 31, column: 5, scope: !108)
!112 = !DILocation(line: 32, column: 5, scope: !108)
!113 = !DILocalVariable(name: "tindex", scope: !108, file: !32, line: 34, type: !38)
!114 = !DILocation(line: 34, column: 9, scope: !108)
!115 = !DILocation(line: 34, column: 30, scope: !108)
!116 = !DILocation(line: 34, column: 19, scope: !108)
!117 = !DILocation(line: 34, column: 18, scope: !108)
!118 = !DILocalVariable(name: "i", scope: !108, file: !32, line: 35, type: !38)
!119 = !DILocation(line: 35, column: 9, scope: !108)
!120 = !DILocation(line: 35, column: 16, scope: !108)
!121 = !DILocation(line: 36, column: 5, scope: !108)
!122 = !DILocation(line: 37, column: 15, scope: !108)
!123 = !DILocation(line: 37, column: 8, scope: !108)
!124 = !DILocation(line: 37, column: 5, scope: !108)
!125 = !DILocation(line: 37, column: 11, scope: !108)
!126 = !DILocation(line: 37, column: 13, scope: !108)
!127 = !DILocation(line: 38, column: 15, scope: !108)
!128 = !DILocation(line: 38, column: 8, scope: !108)
!129 = !DILocation(line: 38, column: 5, scope: !108)
!130 = !DILocation(line: 38, column: 11, scope: !108)
!131 = !DILocation(line: 38, column: 13, scope: !108)
!132 = !DILocation(line: 39, column: 26, scope: !108)
!133 = !DILocation(line: 39, column: 23, scope: !108)
!134 = !DILocation(line: 39, column: 29, scope: !108)
!135 = !DILocation(line: 39, column: 37, scope: !108)
!136 = !DILocation(line: 39, column: 34, scope: !108)
!137 = !DILocation(line: 39, column: 40, scope: !108)
!138 = !DILocation(line: 39, column: 31, scope: !108)
!139 = !DILocation(line: 39, column: 5, scope: !108)
!140 = !DILocation(line: 41, column: 18, scope: !108)
!141 = !DILocation(line: 41, column: 5, scope: !108)
!142 = !DILocation(line: 43, column: 5, scope: !108)
!143 = distinct !DISubprogram(name: "main", scope: !32, file: !32, line: 46, type: !144, scopeLine: 47, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !77)
!144 = !DISubroutineType(types: !145)
!145 = !{!38}
!146 = !DILocalVariable(name: "t", scope: !143, file: !32, line: 48, type: !44)
!147 = !DILocation(line: 48, column: 15, scope: !143)
!148 = !DILocation(line: 49, column: 5, scope: !143)
!149 = !DILocation(line: 51, column: 5, scope: !143)
