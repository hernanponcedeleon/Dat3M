; ModuleID = '/home/ponce/git/Dat3M/output/lkmm_with_barrier_dec_barrier.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/interrupts/lkmm_with_barrier_dec_barrier.c"
...
13:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([76 x i8], [76 x i8]* @.str.1, i64 0, i64 0), i32 noundef 23, i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @__PRETTY_FUNCTION__.handler, i64 0, i64 0)) #5, !dbg !71
  unreachable, !dbg !71

14:                                               ; preds = %1
  call void @__LKMM_FENCE(i32 noundef 13), !dbg !75
...
15:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([76 x i8], [76 x i8]* @.str.1, i64 0, i64 0), i32 noundef 41, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @__PRETTY_FUNCTION__.run, i64 0, i64 0)) #5, !dbg !94
  unreachable, !dbg !94

16:                                               ; preds = %1
  call void @__LKMM_FENCE(i32 noundef 13), !dbg !98
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/interrupts/lkmm_with_barrier_dec_barrier.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "c5b1ce20ef284672409facba64c3f36b")
!4 = !{!5}
...
!31 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier_dec_barrier.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "c5b1ce20ef284672409facba64c3f36b")
