; ModuleID = '/home/ponce/git/Dat3M/output/c11_with_barrier_dec.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/interrupts/c11_with_barrier_dec.c"
...
14:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([67 x i8], [67 x i8]* @.str.1, i64 0, i64 0), i32 noundef 23, i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @__PRETTY_FUNCTION__.handler, i64 0, i64 0)) #5, !dbg !52
  unreachable, !dbg !52

15:                                               ; preds = %1
  %16 = load i32, i32* @cnt, align 4, !dbg !56
  %17 = add nsw i32 %16, -1, !dbg !56
  store i32 %17, i32* @cnt, align 4, !dbg !56
  ret i8* null, !dbg !57
}
...
define dso_local i8* @run(i8* noundef %0) #0 !dbg !58 {
  ...
  %8 = call i32 (...) @__VERIFIER_make_cb(), !dbg !68
  %9 = sext i32 %6 to i64, !dbg !69
...
16:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([67 x i8], [67 x i8]* @.str.1, i64 0, i64 0), i32 noundef 40, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @__PRETTY_FUNCTION__.run, i64 0, i64 0)) #5, !dbg !74
  unreachable, !dbg !74

17:                                               ; preds = %1
  %18 = load i32, i32* @cnt, align 4, !dbg !78
  %19 = add nsw i32 %18, -1, !dbg !78
  store i32 %19, i32* @cnt, align 4, !dbg !78
  %20 = load i64, i64* @h, align 8, !dbg !79
  %21 = call i32 @pthread_join(i64 noundef %20, i8** noundef null), !dbg !80
  ret i8* null, !dbg !81
}
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/interrupts/c11_with_barrier_dec.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "01cdab0c15fef088117a503b28e07171")
!4 = !{!5, !8}
...
!12 = !DIFile(filename: "benchmarks/interrupts/c11_with_barrier_dec.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "01cdab0c15fef088117a503b28e07171")
...
!56 = !DILocation(line: 25, column: 8, scope: !35)
!57 = !DILocation(line: 27, column: 5, scope: !35)
!58 = distinct !DISubprogram(name: "run", scope: !12, file: !12, line: 30, type: !36, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !38)
!59 = !DILocalVariable(name: "arg", arg: 1, scope: !58, file: !12, line: 30, type: !8)
!60 = !DILocation(line: 0, scope: !58)
!61 = !DILocation(line: 32, column: 5, scope: !58)
!62 = !DILocation(line: 33, column: 5, scope: !58)
!63 = !DILocation(line: 35, column: 19, scope: !58)
!64 = !DILocation(line: 35, column: 18, scope: !58)
!65 = !DILocalVariable(name: "tindex", scope: !58, file: !12, line: 35, type: !18)
!66 = !DILocation(line: 36, column: 16, scope: !58)
!67 = !DILocalVariable(name: "i", scope: !58, file: !12, line: 36, type: !18)
!68 = !DILocation(line: 37, column: 5, scope: !58)
!69 = !DILocation(line: 38, column: 5, scope: !58)
!70 = !DILocation(line: 38, column: 11, scope: !58)
!71 = !DILocation(line: 38, column: 13, scope: !58)
!72 = !DILocation(line: 39, column: 11, scope: !58)
!73 = !DILocation(line: 39, column: 13, scope: !58)
!74 = !DILocation(line: 40, column: 5, scope: !75)
!75 = distinct !DILexicalBlock(scope: !76, file: !12, line: 40, column: 5)
!76 = distinct !DILexicalBlock(scope: !58, file: !12, line: 40, column: 5)
!77 = !DILocation(line: 40, column: 5, scope: !76)
!78 = !DILocation(line: 42, column: 8, scope: !58)
!79 = !DILocation(line: 44, column: 18, scope: !58)
!80 = !DILocation(line: 44, column: 5, scope: !58)
!81 = !DILocation(line: 46, column: 5, scope: !58)
!82 = distinct !DISubprogram(name: "main", scope: !12, file: !12, line: 49, type: !83, scopeLine: 50, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !38)
!83 = !DISubroutineType(types: !84)
!84 = !{!18}
!85 = !DILocalVariable(name: "t", scope: !82, file: !12, line: 51, type: !24)
!86 = !DILocation(line: 51, column: 15, scope: !82)
!87 = !DILocation(line: 52, column: 5, scope: !82)
!88 = !DILocation(line: 54, column: 5, scope: !82)
