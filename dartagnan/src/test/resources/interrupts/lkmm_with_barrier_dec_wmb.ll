; ModuleID = 'benchmarks/interrupts/lkmm_with_barrier_dec_wmb.c'
source_filename = "benchmarks/interrupts/lkmm_with_barrier_dec_wmb.c"
...
define ptr @handler(ptr noundef %0) #0 !dbg !74 {
  ...
  call void @__LKMM_FENCE(i32 noundef 5), !dbg !107
...
define ptr @run(ptr noundef %0) #0 !dbg !110 {
  ...
  call void @__LKMM_FENCE(i32 noundef 5), !dbg !143
...
!3 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier_dec_wmb.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "eb57d2e7bf18261d16a47e129339579a")
!4 = !{!5}
