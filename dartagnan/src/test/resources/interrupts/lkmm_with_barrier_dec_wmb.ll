...
define ptr @handler(ptr noundef %0) #0 !dbg !74 {
  ...
  call void @__LKMM_fence(i32 noundef 4), !dbg !107
...
define ptr @run(ptr noundef %0) #0 !dbg !110 {
  ...
  call void @__LKMM_fence(i32 noundef 4), !dbg !142
...
!32 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier_dec_wmb.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
