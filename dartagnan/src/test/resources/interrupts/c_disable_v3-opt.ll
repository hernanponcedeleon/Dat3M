; ModuleID = '/home/ponce/git/Dat3M/output/c_disable_v3.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/interrupts/c_disable_v3.c"
...
14:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([59 x i8], [59 x i8]* @.str.1, i64 0, i64 0), i32 noundef 23, i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @__PRETTY_FUNCTION__.handler, i64 0, i64 0)) #5, !dbg !52
  unreachable, !dbg !52

15:                                               ; preds = %1
  %16 = call i32 (...) @__VERIFIER_enable_irq(), !dbg !56
  ret i8* null, !dbg !57
}
...
define dso_local i8* @run(i8* noundef %0) #0 !dbg !58 {
  ...
  %13 = load volatile i32, i32* %11, align 8, !dbg !74
  %14 = load volatile i32, i32* %12, align 4, !dbg !74
  %15 = icmp eq i32 %13, %14, !dbg !74
  br i1 %15, label %17, label %16, !dbg !77

16:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([59 x i8], [59 x i8]* @.str.1, i64 0, i64 0), i32 noundef 39, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @__PRETTY_FUNCTION__.run, i64 0, i64 0)) #5, !dbg !74
  unreachable, !dbg !74

17:                                               ; preds = %1
  %18 = call i32 (...) @__VERIFIER_enable_irq(), !dbg !78
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/interrupts/c_disable_v3.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "efdf4f391aa1646fd03ac8aab3de9f77")
!4 = !{!5, !8}
...
!12 = !DIFile(filename: "benchmarks/interrupts/c_disable_v3.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "efdf4f391aa1646fd03ac8aab3de9f77")
...
!74 = !DILocation(line: 39, column: 5, scope: !75)
!75 = distinct !DILexicalBlock(scope: !76, file: !12, line: 39, column: 5)
!76 = distinct !DILexicalBlock(scope: !58, file: !12, line: 39, column: 5)
!77 = !DILocation(line: 39, column: 5, scope: !76)
