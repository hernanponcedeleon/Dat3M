; ModuleID = '/home/ponce/git/Dat3M/output/c_disable_v2.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/interrupts/c_disable_v2.c"
...
define dso_local i8* @handler(i8* noundef %0) #0 !dbg !35 {
  ...
  %11 = call i32 (...) @__VERIFIER_enable_irq(), !dbg !52
  %12 = load volatile i32, i32* %9, align 8, !dbg !53
  %13 = load volatile i32, i32* %10, align 4, !dbg !53
...
define dso_local i8* @run(i8* noundef %0) #0 !dbg !58 {
  ...
  %9 = sext i32 %7 to i64, !dbg !69
  %10 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %9, !dbg !69
  %11 = getelementptr inbounds %struct.A, %struct.A* %10, i32 0, i32 0, !dbg !70
  store volatile i32 %5, i32* %11, align 8, !dbg !71
  %12 = getelementptr inbounds %struct.A, %struct.A* %10, i32 0, i32 1, !dbg !72
  store volatile i32 %5, i32* %12, align 4, !dbg !73
  %13 = call i32 (...) @__VERIFIER_enable_irq(), !dbg !74
  %14 = load volatile i32, i32* %11, align 8, !dbg !75
  %15 = load volatile i32, i32* %12, align 4, !dbg !75
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/interrupts/c_disable_v2.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "375435b3f9569141140d541dcd1d5c85")
!4 = !{!5, !8}
...
!12 = !DIFile(filename: "benchmarks/interrupts/c_disable_v2.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "375435b3f9569141140d541dcd1d5c85")
...
!70 = !DILocation(line: 37, column: 11, scope: !58)
!71 = !DILocation(line: 37, column: 13, scope: !58)
!72 = !DILocation(line: 38, column: 11, scope: !58)
!73 = !DILocation(line: 38, column: 13, scope: !58)
