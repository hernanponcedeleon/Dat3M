; ModuleID = '/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_barrier_dec.c'
source_filename = "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_barrier_dec.c"
...
define i8* @handler(i8* noundef %0) #0 !dbg !60 {
  ...
  %32 = load i32, i32* @cnt, align 4, !dbg !93
  %33 = add nsw i32 %32, -1, !dbg !93
  store i32 %33, i32* @cnt, align 4, !dbg !93
  ret i8* null, !dbg !94
}
...
define i8* @run(i8* noundef %0) #0 !dbg !95 {
  ...
  %9 = load i32, i32* @cnt, align 4, !dbg !107
  %10 = add nsw i32 %9, 1, !dbg !107
  store i32 %10, i32* @cnt, align 4, !dbg !107
  store i32 %9, i32* %4, align 4, !dbg !106
  call void @__VERIFIER_make_cb(), !dbg !108
  ...
  %21 = load i32, i32* %4, align 4, !dbg !119
  %22 = sext i32 %21 to i64, !dbg !120
  %23 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %22, !dbg !120
  %24 = getelementptr inbounds %struct.A, %struct.A* %23, i32 0, i32 0, !dbg !121
  %25 = load volatile i32, i32* %24, align 4, !dbg !121
  %26 = load i32, i32* %4, align 4, !dbg !122
  %27 = sext i32 %26 to i64, !dbg !123
  %28 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %27, !dbg !123
  %29 = getelementptr inbounds %struct.A, %struct.A* %28, i32 0, i32 1, !dbg !124
  %30 = load volatile i32, i32* %29, align 4, !dbg !124
  %31 = icmp eq i32 %25, %30, !dbg !125
  %32 = zext i1 %31 to i32, !dbg !125
  call void @__VERIFIER_assert(i32 noundef %32), !dbg !126
  %33 = load i32, i32* @cnt, align 4, !dbg !127
  %34 = add nsw i32 %33, -1, !dbg !127
  store i32 %34, i32* @cnt, align 4, !dbg !127
  %35 = load %struct._opaque_pthread_t*, %struct._opaque_pthread_t** @h, align 8, !dbg !128
  %36 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* noundef %35, i8** noundef null), !dbg !129
  ret i8* null, !dbg !130
}
...
!3 = !DIFile(filename: "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_barrier_dec.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
!4 = !{!5, !10}
...
!14 = !DIFile(filename: "benchmarks/interrupts/c11_with_barrier_dec.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
...
!93 = !DILocation(line: 25, column: 8, scope: !60)
!94 = !DILocation(line: 27, column: 5, scope: !60)
!95 = distinct !DISubprogram(name: "run", scope: !14, file: !14, line: 30, type: !61, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !63)
!96 = !DILocalVariable(name: "arg", arg: 1, scope: !95, file: !14, line: 30, type: !10)
!97 = !DILocation(line: 30, column: 17, scope: !95)
!98 = !DILocation(line: 32, column: 5, scope: !95)
!99 = !DILocation(line: 33, column: 5, scope: !95)
!100 = !DILocalVariable(name: "tindex", scope: !95, file: !14, line: 35, type: !20)
!101 = !DILocation(line: 35, column: 9, scope: !95)
!102 = !DILocation(line: 35, column: 30, scope: !95)
!103 = !DILocation(line: 35, column: 19, scope: !95)
!104 = !DILocation(line: 35, column: 18, scope: !95)
!105 = !DILocalVariable(name: "i", scope: !95, file: !14, line: 36, type: !20)
!106 = !DILocation(line: 36, column: 9, scope: !95)
!107 = !DILocation(line: 36, column: 16, scope: !95)
!108 = !DILocation(line: 37, column: 5, scope: !95)
!109 = !DILocation(line: 38, column: 15, scope: !95)
!110 = !DILocation(line: 38, column: 8, scope: !95)
!111 = !DILocation(line: 38, column: 5, scope: !95)
!112 = !DILocation(line: 38, column: 11, scope: !95)
!113 = !DILocation(line: 38, column: 13, scope: !95)
!114 = !DILocation(line: 39, column: 15, scope: !95)
!115 = !DILocation(line: 39, column: 8, scope: !95)
!116 = !DILocation(line: 39, column: 5, scope: !95)
!117 = !DILocation(line: 39, column: 11, scope: !95)
!118 = !DILocation(line: 39, column: 13, scope: !95)
!119 = !DILocation(line: 40, column: 26, scope: !95)
!120 = !DILocation(line: 40, column: 23, scope: !95)
!121 = !DILocation(line: 40, column: 29, scope: !95)
!122 = !DILocation(line: 40, column: 37, scope: !95)
!123 = !DILocation(line: 40, column: 34, scope: !95)
!124 = !DILocation(line: 40, column: 40, scope: !95)
!125 = !DILocation(line: 40, column: 31, scope: !95)
!126 = !DILocation(line: 40, column: 5, scope: !95)
!127 = !DILocation(line: 42, column: 8, scope: !95)
!128 = !DILocation(line: 44, column: 18, scope: !95)
!129 = !DILocation(line: 44, column: 5, scope: !95)
!130 = !DILocation(line: 46, column: 5, scope: !95)
!131 = distinct !DISubprogram(name: "main", scope: !14, file: !14, line: 49, type: !132, scopeLine: 50, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !63)
!132 = !DISubroutineType(types: !133)
!133 = !{!20}
!134 = !DILocalVariable(name: "t", scope: !131, file: !14, line: 51, type: !26)
!135 = !DILocation(line: 51, column: 15, scope: !131)
!136 = !DILocation(line: 52, column: 5, scope: !131)
!137 = !DILocation(line: 54, column: 5, scope: !131)
