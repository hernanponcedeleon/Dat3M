; ModuleID = 'benchmarks/interrupts/lkmm_with_barrier_dec.c'
source_filename = "benchmarks/interrupts/lkmm_with_barrier_dec.c"
...
define ptr @run(ptr noundef %0) #0 !dbg !109 {
  ...
  store ptr %0, ptr %2, align 8
    ...
    #dbg_declare(ptr %3, !112, !DIExpression(), !114)
  call void @__VERIFIER_make_interrupt_handler(), !dbg !114
  %7 = call i32 @pthread_create(ptr noundef %3, ptr noundef null, ptr noundef @handler, ptr noundef null), !dbg !114
  %8 = load ptr, ptr %3, align 8, !dbg !114
  store ptr %8, ptr %4, align 8, !dbg !114
  %9 = load ptr, ptr %4, align 8, !dbg !114
    #dbg_declare(ptr %5, !115, !DIExpression(), !116)
  %10 = load ptr, ptr %2, align 8, !dbg !117
  %11 = ptrtoint ptr %10 to i64, !dbg !118
  %12 = trunc i64 %11 to i32, !dbg !119
  store i32 %12, ptr %5, align 4, !dbg !116
    #dbg_declare(ptr %6, !120, !DIExpression(), !121)
  %13 = load i32, ptr @cnt, align 4, !dbg !122
  %14 = add nsw i32 %13, 1, !dbg !122
  store i32 %14, ptr @cnt, align 4, !dbg !122
  store i32 %13, ptr %6, align 4, !dbg !121
  call void @__LKMM_FENCE(i32 noundef 13), !dbg !123
  %15 = load i32, ptr %5, align 4, !dbg !124
  %16 = load i32, ptr %6, align 4, !dbg !125
  %17 = sext i32 %16 to i64, !dbg !126
  %18 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %17, !dbg !126
  %19 = getelementptr inbounds %struct.A, ptr %18, i32 0, i32 0, !dbg !127
  store volatile i32 %15, ptr %19, align 4, !dbg !128
  %20 = load i32, ptr %5, align 4, !dbg !129
  %21 = load i32, ptr %6, align 4, !dbg !130
  %22 = sext i32 %21 to i64, !dbg !131
  %23 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %22, !dbg !131
  %24 = getelementptr inbounds %struct.A, ptr %23, i32 0, i32 1, !dbg !132
  store volatile i32 %20, ptr %24, align 4, !dbg !133
  %25 = load i32, ptr %6, align 4, !dbg !134
  %26 = sext i32 %25 to i64, !dbg !135
  %27 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %26, !dbg !135
  %28 = getelementptr inbounds %struct.A, ptr %27, i32 0, i32 0, !dbg !136
  %29 = load volatile i32, ptr %28, align 4, !dbg !136
  %30 = load i32, ptr %6, align 4, !dbg !137
  %31 = sext i32 %30 to i64, !dbg !138
  %32 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %31, !dbg !138
  %33 = getelementptr inbounds %struct.A, ptr %32, i32 0, i32 1, !dbg !139
  %34 = load volatile i32, ptr %33, align 4, !dbg !139
  %35 = icmp eq i32 %29, %34, !dbg !140
  %36 = zext i1 %35 to i32, !dbg !140
  call void @__VERIFIER_assert(i32 noundef %36), !dbg !141
  %37 = load i32, ptr @cnt, align 4, !dbg !142
  %38 = add nsw i32 %37, -1, !dbg !142
  store i32 %38, ptr @cnt, align 4, !dbg !142
...
define i32 @main() #0 !dbg !144 {
  ...
  %3 = call i32 @pthread_create(ptr noundef %2, ptr noundef null, ptr noundef @run, ptr noundef inttoptr (i64 1 to ptr)), !dbg !149
  ret i32 0, !dbg !150
}
...
!3 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier_dec.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "03d21949a85db2c1ecadf632dffc3a9d")
!4 = !{!5}
...
!107 = !DILocation(line: 25, column: 8, scope: !74)
!108 = !DILocation(line: 27, column: 5, scope: !74)
!109 = distinct !DISubprogram(name: "run", scope: !3, file: !3, line: 30, type: !75, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !77)
!110 = !DILocalVariable(name: "arg", arg: 1, scope: !109, file: !3, line: 30, type: !29)
!111 = !DILocation(line: 30, column: 17, scope: !109)
!112 = !DILocalVariable(name: "h", scope: !113, file: !3, line: 32, type: !44)
!113 = distinct !DILexicalBlock(scope: !109, file: !3, line: 32, column: 5)
!114 = !DILocation(line: 32, column: 5, scope: !113)
!115 = !DILocalVariable(name: "tindex", scope: !109, file: !3, line: 34, type: !38)
!116 = !DILocation(line: 34, column: 9, scope: !109)
!117 = !DILocation(line: 34, column: 30, scope: !109)
!118 = !DILocation(line: 34, column: 19, scope: !109)
!119 = !DILocation(line: 34, column: 18, scope: !109)
!120 = !DILocalVariable(name: "i", scope: !109, file: !3, line: 35, type: !38)
!121 = !DILocation(line: 35, column: 9, scope: !109)
!122 = !DILocation(line: 35, column: 16, scope: !109)
!123 = !DILocation(line: 36, column: 5, scope: !109)
!124 = !DILocation(line: 37, column: 15, scope: !109)
!125 = !DILocation(line: 37, column: 8, scope: !109)
!126 = !DILocation(line: 37, column: 5, scope: !109)
!127 = !DILocation(line: 37, column: 11, scope: !109)
!128 = !DILocation(line: 37, column: 13, scope: !109)
!129 = !DILocation(line: 38, column: 15, scope: !109)
!130 = !DILocation(line: 38, column: 8, scope: !109)
!131 = !DILocation(line: 38, column: 5, scope: !109)
!132 = !DILocation(line: 38, column: 11, scope: !109)
!133 = !DILocation(line: 38, column: 13, scope: !109)
!134 = !DILocation(line: 39, column: 26, scope: !109)
!135 = !DILocation(line: 39, column: 23, scope: !109)
!136 = !DILocation(line: 39, column: 29, scope: !109)
!137 = !DILocation(line: 39, column: 37, scope: !109)
!138 = !DILocation(line: 39, column: 34, scope: !109)
!139 = !DILocation(line: 39, column: 40, scope: !109)
!140 = !DILocation(line: 39, column: 31, scope: !109)
!141 = !DILocation(line: 39, column: 5, scope: !109)
!142 = !DILocation(line: 41, column: 8, scope: !109)
!143 = !DILocation(line: 43, column: 5, scope: !109)
!144 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 46, type: !145, scopeLine: 47, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !77)
!145 = !DISubroutineType(types: !146)
!146 = !{!38}
!147 = !DILocalVariable(name: "t", scope: !144, file: !3, line: 48, type: !44)
!148 = !DILocation(line: 48, column: 15, scope: !144)
!149 = !DILocation(line: 49, column: 5, scope: !144)
!150 = !DILocation(line: 51, column: 5, scope: !144)
