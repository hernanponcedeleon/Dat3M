...
define i8* @handler(i8* noundef %0) #0 !dbg !79 {
  ...
  %32 = load i32, i32* @cnt, align 4, !dbg !112
  %33 = add nsw i32 %32, -1, !dbg !112
  store i32 %33, i32* @cnt, align 4, !dbg !112
  ret i8* null, !dbg !113
}
...
; Function Attrs: noinline nounwind ssp uwtable
define i8* @run(i8* noundef %0) #0 !dbg !114 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i8* %0, i8** %2, align 8
  call void @llvm.dbg.declare(metadata i8** %2, metadata !115, metadata !DIExpression()), !dbg !116
  call void @__VERIFIER_make_interrupt_handler(), !dbg !117
  %5 = call i32 @pthread_create(%struct._opaque_pthread_t** noundef @h, %struct._opaque_pthread_attr_t* noundef null, i8* (i8*)* noundef @handler, i8* noundef null), !dbg !118
  call void @llvm.dbg.declare(metadata i32* %3, metadata !119, metadata !DIExpression()), !dbg !120
  %6 = load i8*, i8** %2, align 8, !dbg !121
  %7 = ptrtoint i8* %6 to i64, !dbg !122
  %8 = trunc i64 %7 to i32, !dbg !123
  store i32 %8, i32* %3, align 4, !dbg !120
  call void @llvm.dbg.declare(metadata i32* %4, metadata !124, metadata !DIExpression()), !dbg !125
  %9 = load i32, i32* @cnt, align 4, !dbg !126
  %10 = add nsw i32 %9, 1, !dbg !126
  store i32 %10, i32* @cnt, align 4, !dbg !126
  store i32 %9, i32* %4, align 4, !dbg !125
  call void @__LKMM_FENCE(i32 noundef 13), !dbg !127
  %11 = load i32, i32* %3, align 4, !dbg !128
  %12 = load i32, i32* %4, align 4, !dbg !129
  %13 = sext i32 %12 to i64, !dbg !130
  %14 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %13, !dbg !130
  %15 = getelementptr inbounds %struct.A, %struct.A* %14, i32 0, i32 0, !dbg !131
  store volatile i32 %11, i32* %15, align 4, !dbg !132
  %16 = load i32, i32* %3, align 4, !dbg !133
  %17 = load i32, i32* %4, align 4, !dbg !134
  %18 = sext i32 %17 to i64, !dbg !135
  %19 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %18, !dbg !135
  %20 = getelementptr inbounds %struct.A, %struct.A* %19, i32 0, i32 1, !dbg !136
  store volatile i32 %16, i32* %20, align 4, !dbg !137
  %21 = load i32, i32* %4, align 4, !dbg !138
  %22 = sext i32 %21 to i64, !dbg !139
  %23 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %22, !dbg !139
  %24 = getelementptr inbounds %struct.A, %struct.A* %23, i32 0, i32 0, !dbg !140
  %25 = load volatile i32, i32* %24, align 4, !dbg !140
  %26 = load i32, i32* %4, align 4, !dbg !141
  %27 = sext i32 %26 to i64, !dbg !142
  %28 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %27, !dbg !142
  %29 = getelementptr inbounds %struct.A, %struct.A* %28, i32 0, i32 1, !dbg !143
  %30 = load volatile i32, i32* %29, align 4, !dbg !143
  %31 = icmp eq i32 %25, %30, !dbg !144
  %32 = zext i1 %31 to i32, !dbg !144
  call void @__VERIFIER_assert(i32 noundef %32), !dbg !145
  %33 = load i32, i32* @cnt, align 4, !dbg !146
  %34 = add nsw i32 %33, -1, !dbg !146
  store i32 %34, i32* @cnt, align 4, !dbg !146
  %35 = load %struct._opaque_pthread_t*, %struct._opaque_pthread_t** @h, align 8, !dbg !147
  %36 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* noundef %35, i8** noundef null), !dbg !148
  ret i8* null, !dbg !149
}
...
; Function Attrs: noinline nounwind ssp uwtable
define i32 @main() #0 !dbg !150 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._opaque_pthread_t*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._opaque_pthread_t** %2, metadata !153, metadata !DIExpression()), !dbg !154
  %3 = call i32 @pthread_create(%struct._opaque_pthread_t** noundef %2, %struct._opaque_pthread_attr_t* noundef null, i8* (i8*)* noundef @run, i8* noundef inttoptr (i64 1 to i8*)), !dbg !155
  ret i32 0, !dbg !156
}
...
!33 = !DIFile(filename: "benchmarks/interrupts/lkmm_with_barrier_dec.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
...
!112 = !DILocation(line: 25, column: 8, scope: !79)
!113 = !DILocation(line: 27, column: 5, scope: !79)
!114 = distinct !DISubprogram(name: "run", scope: !33, file: !33, line: 30, type: !80, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !82)
!115 = !DILocalVariable(name: "arg", arg: 1, scope: !114, file: !33, line: 30, type: !29)
!116 = !DILocation(line: 30, column: 17, scope: !114)
!117 = !DILocation(line: 32, column: 5, scope: !114)
!118 = !DILocation(line: 33, column: 5, scope: !114)
!119 = !DILocalVariable(name: "tindex", scope: !114, file: !33, line: 35, type: !39)
!120 = !DILocation(line: 35, column: 9, scope: !114)
!121 = !DILocation(line: 35, column: 30, scope: !114)
!122 = !DILocation(line: 35, column: 19, scope: !114)
!123 = !DILocation(line: 35, column: 18, scope: !114)
!124 = !DILocalVariable(name: "i", scope: !114, file: !33, line: 36, type: !39)
!125 = !DILocation(line: 36, column: 9, scope: !114)
!126 = !DILocation(line: 36, column: 16, scope: !114)
!127 = !DILocation(line: 37, column: 5, scope: !114)
!128 = !DILocation(line: 38, column: 15, scope: !114)
!129 = !DILocation(line: 38, column: 8, scope: !114)
!130 = !DILocation(line: 38, column: 5, scope: !114)
!131 = !DILocation(line: 38, column: 11, scope: !114)
!132 = !DILocation(line: 38, column: 13, scope: !114)
!133 = !DILocation(line: 39, column: 15, scope: !114)
!134 = !DILocation(line: 39, column: 8, scope: !114)
!135 = !DILocation(line: 39, column: 5, scope: !114)
!136 = !DILocation(line: 39, column: 11, scope: !114)
!137 = !DILocation(line: 39, column: 13, scope: !114)
!138 = !DILocation(line: 40, column: 26, scope: !114)
!139 = !DILocation(line: 40, column: 23, scope: !114)
!140 = !DILocation(line: 40, column: 29, scope: !114)
!141 = !DILocation(line: 40, column: 37, scope: !114)
!142 = !DILocation(line: 40, column: 34, scope: !114)
!143 = !DILocation(line: 40, column: 40, scope: !114)
!144 = !DILocation(line: 40, column: 31, scope: !114)
!145 = !DILocation(line: 40, column: 5, scope: !114)
!146 = !DILocation(line: 42, column: 8, scope: !114)
!147 = !DILocation(line: 44, column: 18, scope: !114)
!148 = !DILocation(line: 44, column: 5, scope: !114)
!149 = !DILocation(line: 46, column: 5, scope: !114)
!150 = distinct !DISubprogram(name: "main", scope: !33, file: !33, line: 49, type: !151, scopeLine: 50, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !82)
!151 = !DISubroutineType(types: !152)
!152 = !{!39}
!153 = !DILocalVariable(name: "t", scope: !150, file: !33, line: 51, type: !45)
!154 = !DILocation(line: 51, column: 15, scope: !150)
!155 = !DILocation(line: 52, column: 5, scope: !150)
!156 = !DILocation(line: 54, column: 5, scope: !150)
