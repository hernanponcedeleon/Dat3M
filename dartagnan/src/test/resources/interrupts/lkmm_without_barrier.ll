...
define ptr @run(ptr noundef %0) #0 !dbg !89 {
  ...
  %4 = alloca i32, align 4
  store ptr %0, ptr %2, align 8
  call void @llvm.dbg.declare(metadata ptr %2, metadata !90, metadata !DIExpression()), !dbg !91
  call void @__VERIFIER_make_interrupt_handler(), !dbg !92
  %5 = call i32 @pthread_create(ptr noundef @h, ptr noundef null, ptr noundef @handler, ptr noundef null), !dbg !93
  call void @llvm.dbg.declare(metadata ptr %3, metadata !94, metadata !DIExpression()), !dbg !95
  %6 = load ptr, ptr %2, align 8, !dbg !96
  %7 = ptrtoint ptr %6 to i64, !dbg !97
  %8 = trunc i64 %7 to i32, !dbg !98
  store i32 %8, ptr %3, align 4, !dbg !95
  call void @llvm.dbg.declare(metadata ptr %4, metadata !99, metadata !DIExpression()), !dbg !100
  %9 = load i32, ptr @cnt, align 4, !dbg !101
  %10 = add nsw i32 %9, 1, !dbg !101
  store i32 %10, ptr @cnt, align 4, !dbg !101
  store i32 %9, ptr %4, align 4, !dbg !100
  %11 = load i32, ptr %3, align 4, !dbg !102
  %12 = load i32, ptr %4, align 4, !dbg !103
  %13 = sext i32 %12 to i64, !dbg !104
  %14 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %13, !dbg !104
  %15 = getelementptr inbounds %struct.A, ptr %14, i32 0, i32 0, !dbg !105
  store volatile i32 %11, ptr %15, align 4, !dbg !106
  %16 = load i32, ptr %3, align 4, !dbg !107
  %17 = load i32, ptr %4, align 4, !dbg !108
  %18 = sext i32 %17 to i64, !dbg !109
  %19 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %18, !dbg !109
  %20 = getelementptr inbounds %struct.A, ptr %19, i32 0, i32 1, !dbg !110
  store volatile i32 %16, ptr %20, align 4, !dbg !111
  %21 = load i32, ptr %4, align 4, !dbg !112
  %22 = sext i32 %21 to i64, !dbg !113
  %23 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %22, !dbg !113
  %24 = getelementptr inbounds %struct.A, ptr %23, i32 0, i32 0, !dbg !114
  %25 = load volatile i32, ptr %24, align 4, !dbg !114
  %26 = load i32, ptr %4, align 4, !dbg !115
  %27 = sext i32 %26 to i64, !dbg !116
  %28 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %27, !dbg !116
  %29 = getelementptr inbounds %struct.A, ptr %28, i32 0, i32 1, !dbg !117
  %30 = load volatile i32, ptr %29, align 4, !dbg !117
  %31 = icmp eq i32 %25, %30, !dbg !118
  %32 = zext i1 %31 to i32, !dbg !118
  call void @__VERIFIER_assert(i32 noundef %32), !dbg !119
  %33 = load ptr, ptr @h, align 8, !dbg !120
  %34 = call i32 @"\01_pthread_join"(ptr noundef %33, ptr noundef null), !dbg !121
...
define i32 @main() #0 !dbg !123 {
  ...
  %3 = call i32 @pthread_create(ptr noundef %2, ptr noundef null, ptr noundef @run, ptr noundef inttoptr (i64 1 to ptr)), !dbg !128
  ret i32 0, !dbg !129
}
...
!70 = !DILocation(line: 21, column: 15, scope: !56)
!71 = !DILocation(line: 21, column: 8, scope: !56)
!72 = !DILocation(line: 21, column: 5, scope: !56)
!73 = !DILocation(line: 21, column: 11, scope: !56)
!74 = !DILocation(line: 21, column: 13, scope: !56)
!75 = !DILocation(line: 22, column: 15, scope: !56)
!76 = !DILocation(line: 22, column: 8, scope: !56)
!77 = !DILocation(line: 22, column: 5, scope: !56)
!78 = !DILocation(line: 22, column: 11, scope: !56)
!79 = !DILocation(line: 22, column: 13, scope: !56)
!80 = !DILocation(line: 23, column: 26, scope: !56)
!81 = !DILocation(line: 23, column: 23, scope: !56)
!82 = !DILocation(line: 23, column: 29, scope: !56)
!83 = !DILocation(line: 23, column: 37, scope: !56)
!84 = !DILocation(line: 23, column: 34, scope: !56)
!85 = !DILocation(line: 23, column: 40, scope: !56)
!86 = !DILocation(line: 23, column: 31, scope: !56)
!87 = !DILocation(line: 23, column: 5, scope: !56)
!88 = !DILocation(line: 25, column: 5, scope: !56)
!89 = distinct !DISubprogram(name: "run", scope: !14, file: !14, line: 28, type: !57, scopeLine: 29, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !59)
!90 = !DILocalVariable(name: "arg", arg: 1, scope: !89, file: !14, line: 28, type: !10)
!91 = !DILocation(line: 28, column: 17, scope: !89)
!92 = !DILocation(line: 30, column: 5, scope: !89)
!93 = !DILocation(line: 31, column: 5, scope: !89)
!94 = !DILocalVariable(name: "tindex", scope: !89, file: !14, line: 33, type: !20)
!95 = !DILocation(line: 33, column: 9, scope: !89)
!96 = !DILocation(line: 33, column: 30, scope: !89)
!97 = !DILocation(line: 33, column: 19, scope: !89)
!98 = !DILocation(line: 33, column: 18, scope: !89)
!99 = !DILocalVariable(name: "i", scope: !89, file: !14, line: 34, type: !20)
!100 = !DILocation(line: 34, column: 9, scope: !89)
!101 = !DILocation(line: 34, column: 16, scope: !89)
!102 = !DILocation(line: 35, column: 15, scope: !89)
!103 = !DILocation(line: 35, column: 8, scope: !89)
!104 = !DILocation(line: 35, column: 5, scope: !89)
!105 = !DILocation(line: 35, column: 11, scope: !89)
!106 = !DILocation(line: 35, column: 13, scope: !89)
...
!112 = !DILocation(line: 37, column: 26, scope: !89)
!113 = !DILocation(line: 37, column: 23, scope: !89)
!114 = !DILocation(line: 37, column: 29, scope: !89)
!115 = !DILocation(line: 37, column: 37, scope: !89)
!116 = !DILocation(line: 37, column: 34, scope: !89)
!117 = !DILocation(line: 37, column: 40, scope: !89)
!118 = !DILocation(line: 37, column: 31, scope: !89)
!119 = !DILocation(line: 37, column: 5, scope: !89)
!120 = !DILocation(line: 39, column: 18, scope: !89)
!121 = !DILocation(line: 39, column: 5, scope: !89)
!122 = !DILocation(line: 41, column: 5, scope: !89)
!123 = distinct !DISubprogram(name: "main", scope: !14, file: !14, line: 44, type: !124, scopeLine: 45, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !59)
!124 = !DISubroutineType(types: !125)
!125 = !{!20}
!126 = !DILocalVariable(name: "t", scope: !123, file: !14, line: 46, type: !26)
!127 = !DILocation(line: 46, column: 15, scope: !123)
!128 = !DILocation(line: 47, column: 5, scope: !123)
!129 = !DILocation(line: 49, column: 5, scope: !123)
