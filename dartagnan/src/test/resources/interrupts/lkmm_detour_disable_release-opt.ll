; ModuleID = '/home/ponce/git/Dat3M/output/lkmm_detour_disable_release.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/interrupts/lkmm_detour_disable_release.c"
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !55 {
  ...
  call void @__LKMM_STORE(i8* noundef bitcast (i32* @x to i8*), i32 noundef 1, i32 noundef 3), !dbg !61
...
15:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([74 x i8], [74 x i8]* @.str.1, i64 0, i64 0), i32 noundef 47, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !88
  unreachable, !dbg !88
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/interrupts/lkmm_detour_disable_release.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "c7e127095926174bd3c7e8daf4e662c3")
!4 = !{!5}
...
!28 = !DIFile(filename: "benchmarks/interrupts/lkmm_detour_disable_release.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "c7e127095926174bd3c7e8daf4e662c3")
