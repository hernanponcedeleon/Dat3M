; ModuleID = '/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_barrier.c'
source_filename = "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_barrier.c"
...
define i8* @run(i8* noundef %0) #0 !dbg !94 {
  ...
  store i32 %10, i32* @cnt, align 4, !dbg !106
  store i32 %9, i32* %4, align 4, !dbg !105
  call void @__VERIFIER_make_cb(), !dbg !107
  %11 = load i32, i32* %3, align 4, !dbg !108
  %12 = load i32, i32* %4, align 4, !dbg !109
  %13 = sext i32 %12 to i64, !dbg !110
  %14 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %13, !dbg !110
  %15 = getelementptr inbounds %struct.A, %struct.A* %14, i32 0, i32 0, !dbg !111
  store volatile i32 %11, i32* %15, align 4, !dbg !112
  %16 = load i32, i32* %3, align 4, !dbg !113
  %17 = load i32, i32* %4, align 4, !dbg !114
  %18 = sext i32 %17 to i64, !dbg !115
  %19 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %18, !dbg !115
  %20 = getelementptr inbounds %struct.A, %struct.A* %19, i32 0, i32 1, !dbg !116
  store volatile i32 %16, i32* %20, align 4, !dbg !117
  %21 = load i32, i32* %4, align 4, !dbg !118
  %22 = sext i32 %21 to i64, !dbg !119
  %23 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %22, !dbg !119
  %24 = getelementptr inbounds %struct.A, %struct.A* %23, i32 0, i32 0, !dbg !120
  %25 = load volatile i32, i32* %24, align 4, !dbg !120
  %26 = load i32, i32* %4, align 4, !dbg !121
  %27 = sext i32 %26 to i64, !dbg !122
  %28 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %27, !dbg !122
  %29 = getelementptr inbounds %struct.A, %struct.A* %28, i32 0, i32 1, !dbg !123
  %30 = load volatile i32, i32* %29, align 4, !dbg !123
  %31 = icmp eq i32 %25, %30, !dbg !124
  %32 = zext i1 %31 to i32, !dbg !124
  call void @__VERIFIER_assert(i32 noundef %32), !dbg !125
  %33 = load %struct._opaque_pthread_t*, %struct._opaque_pthread_t** @h, align 8, !dbg !126
  %34 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* noundef %33, i8** noundef null), !dbg !127
  ret i8* null, !dbg !128
}
...
define i32 @main() #0 !dbg !129 {
  ...
  call void @llvm.dbg.declare(metadata %struct._opaque_pthread_t** %2, metadata !132, metadata !DIExpression()), !dbg !133
  %3 = call i32 @pthread_create(%struct._opaque_pthread_t** noundef %2, %struct._opaque_pthread_attr_t* noundef null, i8* (i8*)* noundef @run, i8* noundef inttoptr (i64 1 to i8*)), !dbg !134
  ret i32 0, !dbg !135
}
...
!3 = !DIFile(filename: "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_barrier.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
!4 = !{!5, !10}
...
!14 = !DIFile(filename: "benchmarks/interrupts/c11_with_barrier.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
...
!106 = !DILocation(line: 34, column: 16, scope: !94)
!107 = !DILocation(line: 35, column: 5, scope: !94)
!108 = !DILocation(line: 36, column: 15, scope: !94)
!109 = !DILocation(line: 36, column: 8, scope: !94)
!110 = !DILocation(line: 36, column: 5, scope: !94)
!111 = !DILocation(line: 36, column: 11, scope: !94)
!112 = !DILocation(line: 36, column: 13, scope: !94)
!113 = !DILocation(line: 37, column: 15, scope: !94)
!114 = !DILocation(line: 37, column: 8, scope: !94)
!115 = !DILocation(line: 37, column: 5, scope: !94)
!116 = !DILocation(line: 37, column: 11, scope: !94)
!117 = !DILocation(line: 37, column: 13, scope: !94)
!118 = !DILocation(line: 38, column: 26, scope: !94)
!119 = !DILocation(line: 38, column: 23, scope: !94)
!120 = !DILocation(line: 38, column: 29, scope: !94)
!121 = !DILocation(line: 38, column: 37, scope: !94)
!122 = !DILocation(line: 38, column: 34, scope: !94)
!123 = !DILocation(line: 38, column: 40, scope: !94)
!124 = !DILocation(line: 38, column: 31, scope: !94)
!125 = !DILocation(line: 38, column: 5, scope: !94)
!126 = !DILocation(line: 40, column: 18, scope: !94)
!127 = !DILocation(line: 40, column: 5, scope: !94)
!128 = !DILocation(line: 42, column: 5, scope: !94)
!129 = distinct !DISubprogram(name: "main", scope: !14, file: !14, line: 45, type: !130, scopeLine: 46, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !63)
!130 = !DISubroutineType(types: !131)
!131 = !{!20}
!132 = !DILocalVariable(name: "t", scope: !129, file: !14, line: 47, type: !26)
!133 = !DILocation(line: 47, column: 15, scope: !129)
!134 = !DILocation(line: 48, column: 5, scope: !129)
!135 = !DILocation(line: 50, column: 5, scope: !129)
