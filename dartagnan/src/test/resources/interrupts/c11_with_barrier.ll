; ModuleID = 'benchmarks/interrupts/c11_with_barrier.c'
source_filename = "benchmarks/interrupts/c11_with_barrier.c"
...
define ptr @run(ptr noundef %0) #0 !dbg !89 {
  ...
  store i32 %14, ptr @cnt, align 4, !dbg !102
  store i32 %13, ptr %6, align 4, !dbg !101
  call void @__VERIFIER_make_cb(), !dbg !103
  %15 = load i32, ptr %5, align 4, !dbg !104
  %16 = load i32, ptr %6, align 4, !dbg !105
  %17 = sext i32 %16 to i64, !dbg !106
  %18 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %17, !dbg !106
  %19 = getelementptr inbounds %struct.A, ptr %18, i32 0, i32 0, !dbg !107
  store volatile i32 %15, ptr %19, align 4, !dbg !108
  %20 = load i32, ptr %5, align 4, !dbg !109
  %21 = load i32, ptr %6, align 4, !dbg !110
  %22 = sext i32 %21 to i64, !dbg !111
  %23 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %22, !dbg !111
  %24 = getelementptr inbounds %struct.A, ptr %23, i32 0, i32 1, !dbg !112
  store volatile i32 %20, ptr %24, align 4, !dbg !113
  %25 = load i32, ptr %6, align 4, !dbg !114
  %26 = sext i32 %25 to i64, !dbg !115
  %27 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %26, !dbg !115
  %28 = getelementptr inbounds %struct.A, ptr %27, i32 0, i32 0, !dbg !116
  %29 = load volatile i32, ptr %28, align 4, !dbg !116
  %30 = load i32, ptr %6, align 4, !dbg !117
  %31 = sext i32 %30 to i64, !dbg !118
  %32 = getelementptr inbounds [10 x %struct.A], ptr @as, i64 0, i64 %31, !dbg !118
  %33 = getelementptr inbounds %struct.A, ptr %32, i32 0, i32 1, !dbg !119
  %34 = load volatile i32, ptr %33, align 4, !dbg !119
  %35 = icmp eq i32 %29, %34, !dbg !120
  %36 = zext i1 %35 to i32, !dbg !120
  call void @__VERIFIER_assert(i32 noundef %36), !dbg !121
...
!3 = !DIFile(filename: "benchmarks/interrupts/c11_with_barrier.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "9eacdef793c8aaecc443c95eb517373f")
!4 = !{!5, !10}
...
!102 = !DILocation(line: 33, column: 16, scope: !89)
!103 = !DILocation(line: 34, column: 5, scope: !89)
!104 = !DILocation(line: 35, column: 15, scope: !89)
!105 = !DILocation(line: 35, column: 8, scope: !89)
!106 = !DILocation(line: 35, column: 5, scope: !89)
!107 = !DILocation(line: 35, column: 11, scope: !89)
!108 = !DILocation(line: 35, column: 13, scope: !89)
!109 = !DILocation(line: 36, column: 15, scope: !89)
!110 = !DILocation(line: 36, column: 8, scope: !89)
!111 = !DILocation(line: 36, column: 5, scope: !89)
!112 = !DILocation(line: 36, column: 11, scope: !89)
!113 = !DILocation(line: 36, column: 13, scope: !89)
!114 = !DILocation(line: 37, column: 26, scope: !89)
!115 = !DILocation(line: 37, column: 23, scope: !89)
!116 = !DILocation(line: 37, column: 29, scope: !89)
!117 = !DILocation(line: 37, column: 37, scope: !89)
!118 = !DILocation(line: 37, column: 34, scope: !89)
!119 = !DILocation(line: 37, column: 40, scope: !89)
!120 = !DILocation(line: 37, column: 31, scope: !89)
!121 = !DILocation(line: 37, column: 5, scope: !89)
!122 = !DILocation(line: 39, column: 5, scope: !89)
!123 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 42, type: !124, scopeLine: 43, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !58)
!124 = !DISubroutineType(types: !125)
!125 = !{!19}
!126 = !DILocalVariable(name: "t", scope: !123, file: !3, line: 44, type: !25)
!127 = !DILocation(line: 44, column: 15, scope: !123)
!128 = !DILocation(line: 45, column: 5, scope: !123)
!129 = !DILocation(line: 47, column: 5, scope: !123)
