; ModuleID = 'benchmarks/interrupts/lkmm_detour_disable.c'
source_filename = "benchmarks/interrupts/lkmm_detour_disable.c"
...
define ptr @thread_1(ptr noundef %0) #0 !dbg !74 {
  ...
  call void @__LKMM_STORE(ptr noundef @x, i32 noundef 1, i32 noundef 1), !dbg !81
...
!3 = !DIFile(filename: "benchmarks/interrupts/lkmm_detour_disable.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "39e924cfd909c243838d8fecc0101917")
!4 = !{!5}
