; ModuleID = 'benchmarks/interrupts/lkmm_detour_disable_release.c'
source_filename = "benchmarks/interrupts/lkmm_detour_disable_release.c"
...
define ptr @thread_1(ptr noundef %0) #0 !dbg !74 {
  ...
  call void @__VERIFIER_disable_irq(), !dbg !80
  call void @__LKMM_STORE(ptr noundef @x, i32 noundef 1, i32 noundef 3), !dbg !81
  %8 = call i32 @__LKMM_LOAD(ptr noundef @y, i32 noundef 1), !dbg !82
  store i32 %8, ptr @a, align 4, !dbg !83
  call void @__VERIFIER_enable_irq(), !dbg !84
  ret ptr null, !dbg !85
}
...
; Function Attrs: noinline nounwind ssp uwtable(sync)
define ptr @thread_2(ptr noundef %0) #0 !dbg !86 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
    #dbg_declare(ptr %2, !87, !DIExpression(), !88)
  %3 = call i32 @__LKMM_LOAD(ptr noundef @x, i32 noundef 1), !dbg !89
  store i32 %3, ptr @b, align 4, !dbg !90
  call void @__LKMM_STORE(ptr noundef @y, i32 noundef 2, i32 noundef 3), !dbg !91
  ret ptr null, !dbg !92
}
...
!3 = !DIFile(filename: "benchmarks/interrupts/lkmm_detour_disable_release.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "763323d21adb8ae4b1109bde874d0a84")
!4 = !{!5}
...
!81 = !DILocation(line: 21, column: 5, scope: !74)
!82 = !DILocation(line: 22, column: 9, scope: !74)
!83 = !DILocation(line: 22, column: 7, scope: !74)
!84 = !DILocation(line: 23, column: 5, scope: !74)
!85 = !DILocation(line: 25, column: 5, scope: !74)
!86 = distinct !DISubprogram(name: "thread_2", scope: !3, file: !3, line: 28, type: !67, scopeLine: 29, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !69)
!87 = !DILocalVariable(name: "arg", arg: 1, scope: !86, file: !3, line: 28, type: !24)
!88 = !DILocation(line: 28, column: 22, scope: !86)
!89 = !DILocation(line: 30, column: 9, scope: !86)
!90 = !DILocation(line: 30, column: 7, scope: !86)
!91 = !DILocation(line: 31, column: 5, scope: !86)
!92 = !DILocation(line: 32, column: 5, scope: !86)
!93 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 35, type: !94, scopeLine: 36, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !69)
!94 = !DISubroutineType(types: !95)
!95 = !{!28}
!96 = !DILocalVariable(name: "t1", scope: !93, file: !3, line: 37, type: !35)
!97 = !DILocation(line: 37, column: 15, scope: !93)
!98 = !DILocalVariable(name: "t2", scope: !93, file: !3, line: 37, type: !35)
!99 = !DILocation(line: 37, column: 19, scope: !93)
!100 = !DILocation(line: 39, column: 5, scope: !93)
!101 = !DILocation(line: 40, column: 5, scope: !93)
!102 = !DILocation(line: 41, column: 18, scope: !93)
!103 = !DILocation(line: 41, column: 5, scope: !93)
!104 = !DILocation(line: 42, column: 18, scope: !93)
!105 = !DILocation(line: 42, column: 5, scope: !93)
!106 = !DILocation(line: 44, column: 25, scope: !93)
!107 = !DILocation(line: 44, column: 27, scope: !93)
!108 = !DILocation(line: 44, column: 32, scope: !93)
!109 = !DILocation(line: 44, column: 35, scope: !93)
!110 = !DILocation(line: 44, column: 37, scope: !93)
!111 = !DILocation(line: 44, column: 42, scope: !93)
!112 = !DILocation(line: 44, column: 45, scope: !93)
!113 = !DILocation(line: 44, column: 47, scope: !93)
!114 = !DILocation(line: 0, scope: !93)
!115 = !DILocation(line: 44, column: 23, scope: !93)
!116 = !DILocation(line: 44, column: 5, scope: !93)
!117 = !DILocation(line: 46, column: 5, scope: !93)
