...
define i8* @thread_1(i8* noundef %0) #0 !dbg !79 {
  ...
  call void @__LKMM_STORE(i8* noundef bitcast (i32* @x to i8*), i32 noundef 1, i32 noundef 3), !dbg !85
...
!28 = !DIFile(filename: "benchmarks/interrupts/lkmm_detour_disable_release.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
