; ModuleID = '/home/ponce/git/Dat3M/output/c11_detour_disable_release.ll'
source_filename = "/home/ponce/git/Dat3M/benchmarks/interrupts/c11_detour_disable_release.c"
...
@.str.1 = private unnamed_addr constant [73 x i8] c"/home/ponce/git/Dat3M/benchmarks/interrupts/c11_detour_disable_release.c\00", align 1
...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !49 {
  ...
  store atomic i32 1, i32* @x release, align 4, !dbg !55
...
16:                                               ; preds = %13
  call void @__assert_fail(i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([73 x i8], [73 x i8]* @.str.1, i64 0, i64 0), i32 noundef 48, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !82
  unreachable, !dbg !82
...
!3 = !DIFile(filename: "/home/ponce/git/Dat3M/benchmarks/interrupts/c11_detour_disable_release.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "6fe69578366da87ce31c64da4fa9b992")
!4 = !{!5}
...
!20 = !DIFile(filename: "benchmarks/interrupts/c11_detour_disable_release.c", directory: "/home/ponce/git/Dat3M", checksumkind: CSK_MD5, checksum: "6fe69578366da87ce31c64da4fa9b992")
