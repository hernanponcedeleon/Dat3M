; ModuleID = 'benchmarks/interrupts/c_disable_v2.c'
source_filename = "benchmarks/interrupts/c_disable_v2.c"
...
define ptr @handler(ptr noundef %0) #0 !dbg !55 {
  ...
  call void @__VERIFIER_enable_irq(), !dbg !80
...
define ptr @run(ptr noundef %0) #0 !dbg !90 {
  ...
  call void @__VERIFIER_enable_irq(), !dbg !115
...
!3 = !DIFile(filename: "benchmarks/interrupts/c_disable_v2.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "d3944a7fede31c5a287b38a9f373b59e")
!4 = !{!5, !10}
...
!115 = !DILocation(line: 38, column: 5, scope: !90)
