; ModuleID = '/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_disable_enable_as_barrier.c'
source_filename = "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_disable_enable_as_barrier.c"
...
define i8* @handler(i8* noundef %0) #0 !dbg !60 {
  ...
  call void @__VERIFIER_enable_irq(), !dbg !75
  %10 = load i32, i32* %3, align 4, !dbg !76
  %11 = load i32, i32* %4, align 4, !dbg !77
  %12 = sext i32 %11 to i64, !dbg !78
  %13 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %12, !dbg !78
  %14 = getelementptr inbounds %struct.A, %struct.A* %13, i32 0, i32 0, !dbg !79
  store volatile i32 %10, i32* %14, align 4, !dbg !80
  %15 = load i32, i32* %3, align 4, !dbg !81
  %16 = load i32, i32* %4, align 4, !dbg !82
  %17 = sext i32 %16 to i64, !dbg !83
  %18 = getelementptr inbounds [10 x %struct.A], [10 x %struct.A]* @as, i64 0, i64 %17, !dbg !83
  %19 = getelementptr inbounds %struct.A, %struct.A* %18, i32 0, i32 1, !dbg !84
  store volatile i32 %15, i32* %19, align 4, !dbg !85
...
define i8* @run(i8* noundef %0) #0 !dbg !95 {
  ...
  call void @__VERIFIER_disable_irq(), !dbg !108
  call void @__VERIFIER_enable_irq(), !dbg !109
...
!3 = !DIFile(filename: "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/interrupts/c11_with_disable_enable_as_barrier.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
!4 = !{!5, !10}
...
!14 = !DIFile(filename: "benchmarks/interrupts/c11_with_disable_enable_as_barrier.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
...
!75 = !DILocation(line: 21, column: 5, scope: !60)
!76 = !DILocation(line: 22, column: 15, scope: !60)
!77 = !DILocation(line: 22, column: 8, scope: !60)
!78 = !DILocation(line: 22, column: 5, scope: !60)
!79 = !DILocation(line: 22, column: 11, scope: !60)
!80 = !DILocation(line: 22, column: 13, scope: !60)
!81 = !DILocation(line: 23, column: 15, scope: !60)
!82 = !DILocation(line: 23, column: 8, scope: !60)
!83 = !DILocation(line: 23, column: 5, scope: !60)
!84 = !DILocation(line: 23, column: 11, scope: !60)
!85 = !DILocation(line: 23, column: 13, scope: !60)
...
!105 = !DILocalVariable(name: "i", scope: !95, file: !14, line: 35, type: !20)
!106 = !DILocation(line: 35, column: 9, scope: !95)
!107 = !DILocation(line: 35, column: 16, scope: !95)
!108 = !DILocation(line: 36, column: 5, scope: !95)
!109 = !DILocation(line: 37, column: 5, scope: !95)
!110 = !DILocation(line: 38, column: 15, scope: !95)
!111 = !DILocation(line: 38, column: 8, scope: !95)
!112 = !DILocation(line: 38, column: 5, scope: !95)
!113 = !DILocation(line: 38, column: 11, scope: !95)
!114 = !DILocation(line: 38, column: 13, scope: !95)
!115 = !DILocation(line: 39, column: 15, scope: !95)
!116 = !DILocation(line: 39, column: 8, scope: !95)
!117 = !DILocation(line: 39, column: 5, scope: !95)
!118 = !DILocation(line: 39, column: 11, scope: !95)
!119 = !DILocation(line: 39, column: 13, scope: !95)
