...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/02_inc_cas-O0.bpl /Users/ponce/git/Dat3M/output/02_inc_cas_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 52629));
...
axiom (__assert_fail == $sub.ref(0, 9285));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_atomic_CAS: ref;
axiom (__VERIFIER_atomic_CAS == $sub.ref(0, 10317));
procedure  __VERIFIER_atomic_CAS($p0: ref, $i1: i32, $i2: i32, $p3: ref)
{
  var $i4: i32;
  var $i5: i1;
$bb0:
  assume {:sourceloc "output/02_inc_cas_tmp.c", 706, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_atomic_CAS:arg:e"} boogie_si_record_i32($i1);
  call {:cexpr "__VERIFIER_atomic_CAS:arg:u"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 706, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 706, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, $i1);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 706, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 708, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, $i2);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 708, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 1);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 709, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "output/02_inc_cas_tmp.c", 712, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 0);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "output/02_inc_cas_tmp.c", 714, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 11349));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const thr1: ref;
axiom (thr1 == $sub.ref(0, 12381));
  ...
  returns ($r: ref)
{
  ...
  var $i8: i1;
$bb0:
  assume {:sourceloc "output/02_inc_cas_tmp.c", 718, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "output/02_inc_cas_tmp.c", 719, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/02_inc_cas_tmp.c", 720, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, value);
  call {:cexpr "v"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 721, 9} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/02_inc_cas_tmp.c", 722, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, $sub.i32(0, 1));
  assume {:sourceloc "output/02_inc_cas_tmp.c", 722, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 723, 4} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "output/02_inc_cas_tmp.c", 725, 10} true;
  assume {:verifier.code 1} true;
  $i4 := $add.i32($i2, 1);
  call {:cexpr "vn"} boogie_si_record_i32($i4);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 726, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_CAS(value, $i2, $i4, $p1);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 727, 2} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume {:sourceloc "output/02_inc_cas_tmp.c", 733, 1} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb5:
  assume {:sourceloc "output/02_inc_cas_tmp.c", 728, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p1);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 728, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, 0);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 727, 2} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "output/02_inc_cas_tmp.c", 729, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/02_inc_cas_tmp.c", 730, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, value);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 730, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i32($i7, $i2);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 730, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i8 == 1);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 731, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/02_inc_cas_tmp.c", 732, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb9:
  assume !(($i8 == 1));
  assume {:sourceloc "output/02_inc_cas_tmp.c", 730, 21} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume true;
  assume {:sourceloc "output/02_inc_cas_tmp.c", 730, 31} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/02_inc_cas_tmp.c", 730, 45} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/02_inc_cas_tmp.c", 730, 45} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 13413));
procedure  llvm.dbg.label($p0: ref);
const main: ref;
axiom (main == $sub.ref(0, 14445));
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/02_inc_cas_tmp.c", 736, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/02_inc_cas_tmp.c", 736, 60} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "output/02_inc_cas_tmp.c", 736, 106} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thr1, $0.ref);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 736, 145} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/02_inc_cas_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/02_inc_cas_tmp.c", 736, 158} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 3);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 736, 140} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "output/02_inc_cas_tmp.c", 736, 169} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "output/02_inc_cas_tmp.c", 737, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "output/02_inc_cas_tmp.c", 736, 163} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i6, 1);
...
axiom (pthread_create == $sub.ref(0, 15477));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 16509));
...
axiom (__SMACK_code == $sub.ref(0, 17541));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 18573));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 20637));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 21669));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 22701));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 23733));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 24765));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 25797));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 26829));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 27861));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 28893));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 29925));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 30957));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 31989));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 33021));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 34053));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 35085));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 36117));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 37149));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 38181));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 39213));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 40245));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 41277));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 42309));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 43341));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 44373));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 45405));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 46437));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 47469));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 48501));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 49533));
...
axiom (llvm.dbg.value == $sub.ref(0, 51597));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 52629));
