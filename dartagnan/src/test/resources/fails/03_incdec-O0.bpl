...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/03_incdec-O0.bpl /Users/ponce/git/Dat3M/output/03_incdec_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 60872));
...
const value: ref;
axiom (value == $sub.ref(0, 1028));
const m: ref;
axiom (m == $sub.ref(0, 2056));
const inc_flag: ref;
axiom (inc_flag == $sub.ref(0, 3084));
const dec_flag: ref;
axiom (dec_flag == $sub.ref(0, 4112));
const .str: ref;
axiom (.str == $sub.ref(0, 5138));
const {:count 12} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 6174));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 7217));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 8249));
const {:count 3} .str.1.8: ref;
axiom (.str.1.8 == $sub.ref(0, 9276));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 10304));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 11336));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/03_incdec_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/03_incdec_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/03_incdec_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/03_incdec_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 12368));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 13400));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/03_incdec_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 14432));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_atomic_acquire: ref;
axiom (__VERIFIER_atomic_acquire == $sub.ref(0, 15464));
procedure  __VERIFIER_atomic_acquire()
{
  var $i0: i32;
  var $i1: i1;
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/03_incdec_tmp.c", 692, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 692, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, m);
  assume {:sourceloc "output/03_incdec_tmp.c", 692, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "output/03_incdec_tmp.c", 692, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "output/03_incdec_tmp.c", 692, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "output/03_incdec_tmp.c", 693, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, m, 1);
  call {:cexpr "m"} boogie_si_record_i32(1);
  assume {:sourceloc "output/03_incdec_tmp.c", 694, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_release: ref;
axiom (__VERIFIER_atomic_release == $sub.ref(0, 16496));
procedure  __VERIFIER_atomic_release()
{
  var $i0: i32;
  var $i1: i1;
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/03_incdec_tmp.c", 697, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 697, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, m);
  assume {:sourceloc "output/03_incdec_tmp.c", 697, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 697, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "output/03_incdec_tmp.c", 697, 2} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i2);
  assume {:sourceloc "output/03_incdec_tmp.c", 698, 4} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, m, 0);
  call {:cexpr "m"} boogie_si_record_i32(0);
  assume {:sourceloc "output/03_incdec_tmp.c", 699, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const inc: ref;
axiom (inc == $sub.ref(0, 17528));
procedure  inc()
  returns ($r: i32)
{
  var $i0: i32;
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/03_incdec_tmp.c", 704, 2} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 704, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire();
  assume {:sourceloc "output/03_incdec_tmp.c", 705, 5} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, value);
  assume {:sourceloc "output/03_incdec_tmp.c", 705, 11} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 706, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "output/03_incdec_tmp.c", 707, 3} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 709, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, value);
  call {:cexpr "inc_v"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/03_incdec_tmp.c", 710, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, inc_flag, 1);
  call {:cexpr "inc_flag"} boogie_si_record_i32(1);
  assume {:sourceloc "output/03_incdec_tmp.c", 710, 31} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3, 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 710, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, value, $i4);
  call {:cexpr "value"} boogie_si_record_i32($i4);
  assume {:sourceloc "output/03_incdec_tmp.c", 711, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 4} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire();
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 39} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, dec_flag);
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 39} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 48} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb4, $bb6;
$bb3:
  assume {:sourceloc "output/03_incdec_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 715, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 113} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "output/03_incdec_tmp.c", 713, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i3, 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 713, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $i9;
  goto $bb3;
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 51} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, value);
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 57} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i32($i7, $i3);
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 37} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i8 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 67} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume true;
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 77} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 91} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/03_incdec_tmp.c", 712, 91} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 18560));
procedure  llvm.dbg.label($p0: ref);
const dec: ref;
axiom (dec == $sub.ref(0, 19592));
procedure  dec()
  returns ($r: i32)
{
  var $i0: i32;
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/03_incdec_tmp.c", 718, 2} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 718, 2} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire();
  assume {:sourceloc "output/03_incdec_tmp.c", 719, 5} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, value);
  assume {:sourceloc "output/03_incdec_tmp.c", 719, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "output/03_incdec_tmp.c", 719, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 720, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "output/03_incdec_tmp.c", 721, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, 1);
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 723, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, value);
  call {:cexpr "dec_v"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/03_incdec_tmp.c", 724, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, dec_flag, 1);
  call {:cexpr "dec_flag"} boogie_si_record_i32(1);
  assume {:sourceloc "output/03_incdec_tmp.c", 724, 31} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32($i3, 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 724, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, value, $i4);
  call {:cexpr "value"} boogie_si_record_i32($i4);
  assume {:sourceloc "output/03_incdec_tmp.c", 725, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 4} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_acquire();
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 39} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, inc_flag);
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 39} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 48} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb4, $bb6;
$bb3:
  assume {:sourceloc "output/03_incdec_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 729, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 113} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_atomic_release();
  assume {:sourceloc "output/03_incdec_tmp.c", 727, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i3, 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 727, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $i9;
  goto $bb3;
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 51} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, value);
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 57} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i32($i7, $i3);
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 37} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb7:
...
$bb8:
  assume !(($i8 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 67} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume true;
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 77} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 91} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/03_incdec_tmp.c", 726, 91} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "output/03_incdec_tmp.c", 731, 10} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 731, 10} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/03_incdec_tmp.c", 732, 5} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "output/03_incdec_tmp.c", 732, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 732, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := inc();
  assume {:sourceloc "output/03_incdec_tmp.c", 732, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 733, 8} true;
  assume {:verifier.code 0} true;
  call $i4 := dec();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "output/03_incdec_tmp.c", 734, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 14} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 60} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thr1, $0.ref);
  assume true;
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 106} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thr1, $0.ref);
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 145} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/03_incdec_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 158} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 3);
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 140} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 169} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "output/03_incdec_tmp.c", 739, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "output/03_incdec_tmp.c", 738, 163} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i6, 1);
...
axiom (pthread_create == $sub.ref(0, 22688));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 23720));
...
axiom (__SMACK_code == $sub.ref(0, 24752));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 25784));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 26816));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 27848));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 28880));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 29912));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 30944));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 31976));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 33008));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 34040));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 35072));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 36104));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 37136));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 38168));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 39200));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 40232));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 41264));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 42296));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 43328));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 44360));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 45392));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 46424));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 47456));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 48488));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 49520));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 50552));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 51584));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 52616));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 53648));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 54680));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 55712));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 56744));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 57776));
...
axiom (llvm.dbg.value == $sub.ref(0, 59840));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 60872));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, value, 0);
  call {:cexpr "value"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, m, 0);
  call {:cexpr "m"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, inc_flag, 0);
  call {:cexpr "inc_flag"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, dec_flag, 0);
  call {:cexpr "dec_flag"} boogie_si_record_i32(0);
  $M.0 := $store.ref($M.0, env_value_str, .str.1.8);
