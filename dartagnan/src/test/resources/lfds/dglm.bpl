...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/benchmarks/lfds -bpl /home/ponce/git/Dat3M/output/dglm-opt.bpl /home/ponce/git/Dat3M/output/dglm-opt.ll
...
$bb5:
  ...
  assume {:sourceloc "benchmarks/lfds/dglm.h", 41, 9} true;
  assume {:verifier.code 0} true;
  call $p19 := __llvm_atomic64_cmpxchg($p11, $i12, $i18, 4, 0);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 41, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  call $p22 := __llvm_atomic64_cmpxchg(Tail, $i5, $i12, 4, 0);
  assume {:verifier.code 0} true;
  goto $bb4;
$bb7:
  assume ($i20 == 1);
  ...
  assume {:verifier.code 0} true;
  call $p21 := __llvm_atomic64_cmpxchg(Tail, $i5, $i18, 4, 0);
...
$bb7:
  ...
  assume {:verifier.code 0} true;
  call $p16 := __llvm_atomic64_cmpxchg(Head, $i0, $i7, 4, 0);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 69, 21} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  assume {:verifier.code 0} true;
  call $p27 := __llvm_atomic64_cmpxchg(Tail, $i21, $i7, 4, 0);
