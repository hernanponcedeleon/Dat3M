...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/ -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/SafeStack-3-3-1.bpl /Users/ponce/git/Dat3M/benchmarks/lfds/SafeStack-3-3-1.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38192));
...
const {:allocSize 4} count: ref;
axiom (count == $sub.ref(0, 1028));
const {:allocSize 4} head: ref;
axiom (head == $sub.ref(0, 2056));
const {:allocSize 24} {:count 3} array: ref;
axiom (array == $sub.ref(0, 3104));
const init: ref;
axiom (init == $sub.ref(0, 4136));
procedure  init()
{
  var $i0: i32;
  var $i1: i32;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 20, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 20, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := atomic_init.ref.i32(count, 3);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_init.ref.i32(head, 0);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 23, 9} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($add.ref($add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref(0, 8)), $mul.ref(4, 1)), 1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 24, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_init.ref.i32($add.ref($add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref(1, 8)), $mul.ref(4, 1)), 2);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 25, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.i32($add.ref($add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref(2, 8)), $mul.ref(4, 1)), $sub.i32(0, 1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_init: ref;
axiom (atomic_init == $sub.ref(0, 5168));
procedure  atomic_init.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const pop: ref;
axiom (pop == $sub.ref(0, 6200));
procedure  pop()
  returns ($r: i32)
{
  var $p0: ref;
  ...
  var $i12: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 30, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 30, 16} true;
  assume {:verifier.code 0} true;
  call $i1 := atomic_load_explicit.ref.i32(count, 2);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 30, 67} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i1, 1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 30, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 31, 25} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32(head, 2);
  call {:cexpr "head1"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 32, 51} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 32, 51} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 32, 25} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_exchange_explicit.ref.i32.i32($p6, $sub.i32(0, 1), 5);
  call {:cexpr "next1"} boogie_si_record_i32($i7);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 34, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $sge.i32($i7, 0);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 34, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb4, $bb5;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 45, 9} true;
  assume {:verifier.code 0} true;
  $i12 := $sub.i32(0, 1);
  goto $bb9;
$bb4:
  assume ($i8 == 1);
  assume true;
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 35, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, $i3);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 36, 21} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32(head, $p0, $i7, 5, 5);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 36, 21} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 36, 21} true;
...
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 37, 21} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_fetch_sub_explicit.ref.i32.i32(count, 1, 5);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 38, 21} true;
  assume {:verifier.code 0} true;
  $i12 := $i3;
  goto $bb9;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 41, 47} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 41, 47} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i13, 8));
  $p15 := $add.ref($add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i13, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 41, 21} true;
  assume {:verifier.code 0} true;
  call $i16 := atomic_exchange_explicit.ref.i32.i32($p15, $i7, 5);
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 46, 5} true;
  assume {:verifier.code 0} true;
  $r := $i12;
  $exn := false;
  return;
$bb10:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 43, 13} true;
  assume {:verifier.code 0} true;
  goto $bb6;
}
const atomic_load_explicit: ref;
axiom (atomic_load_explicit == $sub.ref(0, 7232));
...
axiom (atomic_fetch_sub_explicit == $sub.ref(0, 11360));
procedure  atomic_fetch_sub_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const push: ref;
axiom (push == $sub.ref(0, 12392));
procedure  push($i0: i32)
{
  ...
  var $i10: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 50, 21} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 50, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, $i2);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 51, 9} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 52, 36} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i0);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 52, 36} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 52, 55} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 52, 13} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_store_explicit.ref.i32.i32($p5, $i6, 3);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 53, 9} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 53, 18} true;
  assume {:verifier.code 0} true;
  call $i8 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32(head, $p1, $i0, 5, 5);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 53, 124} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 0);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 53, 9} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i9 == 1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 54, 9} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_fetch_add_explicit.ref.i32.i32(count, 1, 5);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 55, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_store_explicit: ref;
axiom (atomic_store_explicit == $sub.ref(0, 13424));
procedure  atomic_store_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const atomic_fetch_add_explicit: ref;
axiom (atomic_fetch_add_explicit == $sub.ref(0, 14456));
procedure  atomic_fetch_add_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const thread3: ref;
axiom (thread3 == $sub.ref(0, 15488));
  ...
  returns ($r: ref)
{
  ...
  var $i25: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 59, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 59, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "idx"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 63, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 64, 16} true;
  assume {:verifier.code 0} true;
  call $i2 := pop();
  call {:cexpr "elem"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 65, 18} true;
  assume {:verifier.code 0} true;
  $i3 := $sge.i32($i2, 0);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 65, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 66, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  ...
  goto $bb1;
$bb4:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 70, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 70, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i2);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 70, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 70, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p7, $i4);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 71, 5} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 71, 5} true;
  ...
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 71, 5} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i8, 8));
  $p10 := $add.ref($add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i8, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 71, 5} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb7;
$bb9:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 72, 5} true;
  assume {:verifier.code 0} true;
  call push($i2);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 74, 5} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 75, 16} true;
  assume {:verifier.code 0} true;
  call $i14 := pop();
  call {:cexpr "elem"} boogie_si_record_i32($i14);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 76, 18} true;
  assume {:verifier.code 0} true;
  $i15 := $sge.i32($i14, 0);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 76, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb11, $bb12;
$bb11:
  assume ($i15 == 1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 77, 14} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !(($i15 == 1));
  ...
  goto $bb10;
$bb13:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 79, 25} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 79, 5} true;
  assume {:verifier.code 0} true;
  $i17 := $sext.i32.i64($i14);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 79, 5} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i17, 8));
  $p19 := $add.ref($add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i17, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 79, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p19, $i16);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 80, 5} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 80, 5} true;
  ...
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 80, 5} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i20, 8));
  $p22 := $add.ref($add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i20, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 80, 5} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb16;
$bb18:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 81, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 90, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 90, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 91, 16} true;
  assume {:verifier.code 0} true;
  call $i1 := pop();
  call {:cexpr "elem"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 92, 18} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 0);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 92, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 93, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  ...
  goto $bb1;
$bb4:
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 96, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 103, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call init();
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 105, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, thread3, $0.ref);
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 106, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread3, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 107, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread1, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/lfds/SafeStack-3-3-1.c", 109, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 18584));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 19616));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 20648));
...
axiom (__SMACK_dummy == $sub.ref(0, 21680));
...
axiom (__VERIFIER_assert == $sub.ref(0, 22712));
...
axiom (__SMACK_and32 == $sub.ref(0, 23744));
...
axiom (__SMACK_and64 == $sub.ref(0, 24776));
...
axiom (__SMACK_and16 == $sub.ref(0, 25808));
...
axiom (__SMACK_and8 == $sub.ref(0, 26840));
...
axiom (__SMACK_or32 == $sub.ref(0, 27872));
...
axiom (__SMACK_or64 == $sub.ref(0, 28904));
...
axiom (__SMACK_or16 == $sub.ref(0, 29936));
...
axiom (__SMACK_or8 == $sub.ref(0, 30968));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 32000));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 33032));
...
axiom (__SMACK_decls == $sub.ref(0, 34064));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 35096));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 36128));
...
axiom (llvm.dbg.value == $sub.ref(0, 37160));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 38192));
