...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/benchmarks/lfds -bpl /home/ponce/git/Dat3M/output/ms-opt.bpl /home/ponce/git/Dat3M/output/ms-opt.ll
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  call $p18 := __llvm_atomic64_cmpxchg(Tail, $i5, $i12, 4, 0);
...
$bb6:
  ...
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
  call $p20 := __llvm_atomic64_cmpxchg($p11, $i12, $i19, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  assume {:verifier.code 0} true;
  call $p22 := __llvm_atomic64_cmpxchg(Tail, $i5, $i19, 4, 0);
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  call $p20 := __llvm_atomic64_cmpxchg(Tail, $i5, $i12, 4, 0);
...
$bb9:
  ...
  assume {:verifier.code 0} true;
  call $p23 := __llvm_atomic64_cmpxchg(Head, $i0, $i12, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
