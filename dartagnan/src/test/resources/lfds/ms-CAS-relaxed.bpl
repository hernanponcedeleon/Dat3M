...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/benchmarks/lfds -DFAIL -bpl /home/ponce/git/Dat3M/output/ms-opt.bpl /home/ponce/git/Dat3M/output/ms-opt.ll
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  call $p18 := __llvm_atomic64_cmpxchg(Tail, $i5, $i12, 0, 0);
...
$bb6:
  ...
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
  call $p20 := __llvm_atomic64_cmpxchg($p11, $i12, $i19, 0, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
  $i21 := $extractvalue.i1($p20, 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  assume {:verifier.code 0} true;
  call $p22 := __llvm_atomic64_cmpxchg(Tail, $i5, $i19, 0, 0);
...
axiom (__llvm_atomic64_load == $sub.ref(0, 7224));
procedure  __llvm_atomic64_load($p0: ref, $i1: i32)
  returns ($r: i64);
const assert_: ref;
axiom (assert_ == $sub.ref(0, 8256));
procedure  assert_.i32(p.0: i32)
  returns ($r: i32);
const __llvm_atomic64_cmpxchg: ref;
axiom (__llvm_atomic64_cmpxchg == $sub.ref(0, 9288));
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  call $i14 := __llvm_atomic64_load(Head, 2);
  assume {:sourceloc "benchmarks/lfds/ms.h", 63, 15} true;
  assume {:verifier.code 0} true;
  $p15 := $i2p.i64.ref($i14);
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  call $p20 := __llvm_atomic64_cmpxchg(Tail, $i5, $i12, 0, 0);
...
$bb9:
  ...
  call {:cexpr "result"} boogie_si_record_i32($i22);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
  call $p23 := __llvm_atomic64_cmpxchg(Head, $i0, $i12, 0, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $extractvalue.i1($p23, 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
  $i18 := $i22;
...
axiom (llvm.dbg.declare == $sub.ref(0, 13416));
