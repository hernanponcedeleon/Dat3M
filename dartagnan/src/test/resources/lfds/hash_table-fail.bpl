...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/hash_table-opt.bpl /home/ponce/git/Dat3M/output/hash_table-opt.ll
...
{
$bb0:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 55, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 55, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, m_entries, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 56, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 55, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref(1, 8)), $mul.ref(0, 1)), 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 56, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref(1, 8)), $mul.ref(4, 1)), 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 58, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  set($i0: i32, $i1: i32)
{
  ...
  var $i21: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 62, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "set:arg:key"} boogie_si_record_i32($i0);
  call {:cexpr "set:arg:value"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 62, 5} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i0, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 62, 5} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 63, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i1, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 63, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 62, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 62, __PRETTY_FUNCTION__.set);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 62, 5} true;
  assume {:verifier.code 0} true;
  assume false;
$bb3:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 65, 25} true;
  assume {:verifier.code 0} true;
  call $i4 := integerHash($i0);
  call {:cexpr "idx"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 65, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb5;
$bb4:
  ...
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 63, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.2, .str.1, 63, __PRETTY_FUNCTION__.set);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 63, 5} true;
  assume {:verifier.code 0} true;
  assume false;
$bb5:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 67, 13} true;
  assume {:verifier.code 0} true;
  /* benchmarks/lfds/hash_table.h:67:13: SMACK warning: overapproximating bitwise operation and (can lead to false alarms); */
  $i6 := $and.i32($i5, 1);
  call {:cexpr "idx"} boogie_si_record_i32($i6);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 70, 52} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i32.i64($i6);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 70, 52} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref($i7, 8));
  $p9 := $add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref($i7, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 70, 30} true;
  assume {:verifier.code 0} true;
  call $i10 := __llvm_atomic32_load($p9, 0);
  call {:cexpr "probedKey"} boogie_si_record_i32($i10);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 71, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, $i0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 71, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i11 == 1);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 73, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i10, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 73, 17} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  $p20 := $add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref($i7, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 88, 9} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store($p20, $i1, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 88, 9} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 65, 47} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i6, 1);
  call {:cexpr "idx"} boogie_si_record_i32($i21);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 65, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $i21;
  goto $bb5;
$bb11:
  assume !(($i12 == 1));
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 78, 34} true;
  assume {:verifier.code 0} true;
  call $p13 := __llvm_atomic32_cmpxchg($p9, 0, $i0, 0, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 78, 34} true;
  assume {:verifier.code 0} true;
  $i14 := $extractvalue.i32($p13, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 78, 34} true;
  assume {:verifier.code 0} true;
  $i15 := $extractvalue.i1($p13, 1);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 78, 34} true;
  assume {:verifier.code 0} true;
  $i16 := (if ($i15 == 1) then 0 else $i14);
  call {:cexpr "expected"} boogie_si_record_i32($i16);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 80, 27} true;
  assume {:verifier.code 0} true;
  $i17 := $ne.i32($i16, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 80, 33} true;
  assume {:verifier.code 0} true;
  $i18 := $xor.i1($i17, 1);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 80, 33} true;
  assume {:verifier.code 0} true;
  $i19 := (if ($i18 == 1) then 1 else $i15);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 80, 33} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 50, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "integerHash:arg:h"} boogie_si_record_i32($i0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 50, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  ...
  returns ($r: i32)
{
  ...
  var $i12: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 94, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "get:arg:key"} boogie_si_record_i32($i0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 94, 5} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 94, 5} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 96, 25} true;
  assume {:verifier.code 0} true;
  call $i2 := integerHash($i0);
  call {:cexpr "idx"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 96, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  ...
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 94, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 94, __PRETTY_FUNCTION__.get);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 94, 5} true;
  assume {:verifier.code 0} true;
  assume false;
$bb3:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 98, 13} true;
  assume {:verifier.code 0} true;
  /* benchmarks/lfds/hash_table.h:98:13: SMACK warning: overapproximating bitwise operation and (can lead to false alarms); */
  $i4 := $and.i32($i3, 1);
  call {:cexpr "idx"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 100, 52} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i32.i64($i4);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 100, 52} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref($i5, 8));
  $p7 := $add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref($i5, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 100, 30} true;
  assume {:verifier.code 0} true;
  call $i8 := __llvm_atomic32_load($p7, 0);
  call {:cexpr "probedKey"} boogie_si_record_i32($i8);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 101, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, $i0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 101, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i9 == 1);
  $p10 := $add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref($i5, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 102, 20} true;
  assume {:verifier.code 0} true;
  call $i11 := __llvm_atomic32_load($p10, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 102, 13} true;
  assume {:verifier.code 0} true;
  $i12 := $i11;
  goto $bb6;
$bb5:
  assume !(($i9 == 1));
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 103, 23} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i8, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 103, 13} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb6:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 106, 1} true;
  assume {:verifier.code 0} true;
  $r := $i12;
  $exn := false;
  return;
...
$bb8:
  assume !(($i13 == 1));
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 96, 47} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i4, 1);
  call {:cexpr "idx"} boogie_si_record_i32($i14);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 96, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i14;
  goto $bb3;
}
  ...
  returns ($r: i32)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 113, 14} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 113, 14} true;
  assume {:verifier.code 0} true;
  call $i0 := __llvm_atomic32_load(m_entries, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 113, 78} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 114, 13} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 114, 17} true;
  assume {:verifier.code 0} true;
  call $i3 := __llvm_atomic32_load($add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 114, 83} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 113, 13} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 113, 14} true;
  assume {:verifier.code 0} true;
  call $i6 := __llvm_atomic32_load($add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref(1, 8)), $mul.ref(0, 1)), 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 113, 78} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 114, 13} true;
...
$bb4:
  ...
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 114, 17} true;
  assume {:verifier.code 0} true;
  call $i9 := __llvm_atomic32_load($add.ref($add.ref($add.ref(m_entries, $mul.ref(0, 16)), $mul.ref(1, 8)), $mul.ref(4, 1)), 0);
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 114, 83} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/hash_table.h", 117, 5} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/hash_table.c", 22, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/hash_table.c", 22, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
...
const thread_2: ref;
axiom (thread_2 == $sub.ref(0, 25980));
  ...
  returns ($r: ref)
{
  ...
  var $p8: ref;
$bb0:
  assume {:sourceloc "benchmarks/lfds/hash_table.c", 34, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/hash_table.c", 34, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
...
axiom (__llvm_atomic_fence == $sub.ref(0, 27012));
