...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include -DFAIL -bpl /Users/ponce/git/Dat3M/output/ms-3.bpl /Users/ponce/git/Dat3M/benchmarks/lfds/ms-3.c
...
procedure  init()
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 28, 15} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 29, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 29, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_init.ref.i32($p2, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 30, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.ref(Head, $p1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 31, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_init.ref.ref(Tail, $p1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  enqueue($i0: i32)
{
  ...
  var $i31: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 37, 12} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 38, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 38, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, $i0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 39, 21} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 39, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_init.ref.i32($p6, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 41, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 42, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p10 := $i2p.i64.ref($i9);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p1, $p10);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 43, 3} true;
...
$bb5:
  ...
  goto $bb4;
$bb6:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 44, 10} true;
  assume {:verifier.code 0} true;
  $p13 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 44, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p17 := $i2p.i64.ref($i16);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 44, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p2, $p17);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 46, 7} true;
  assume {:verifier.code 0} true;
  $p18 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 46, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p21 := $i2p.i64.ref($i20);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 46, 12} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.ref($p18, $p21);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 46, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i22 == 1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $p23 := $load.ref($M.0, $p2);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 47, 13} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i24 == 1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $p25 := $load.ref($M.0, $p2);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 48, 5} true;
  assume {:verifier.code 0} true;
  call $i26 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Tail, $p1, $p25, 0, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 49, 4} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !(($i24 == 1));
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 50, 9} true;
  assume {:verifier.code 0} true;
  $p27 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 50, 9} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb13, $bb14;
$bb12:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 55, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb13:
  assume ($i30 == 1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 51, 9} true;
  assume {:verifier.code 0} true;
  call $i31 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Tail, $p1, $p4, 0, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 52, 6} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume !(($i30 == 1));
  ...
  goto $bb12;
$bb15:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 57, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  ...
  var $i23: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 63, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 64, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p4 := $i2p.i64.ref($i3);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 64, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p0, $p4);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 65, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 65, 3} true;
...
$bb5:
  ...
  goto $bb4;
$bb6:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 66, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p9 := $i2p.i64.ref($i8);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 66, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p1, $p9);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 67, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 67, 3} true;
...
$bb10:
  ...
  goto $bb9;
$bb11:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 68, 10} true;
  assume {:verifier.code 0} true;
  $p12 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 68, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p16 := $i2p.i64.ref($i15);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 70, 7} true;
  assume {:verifier.code 0} true;
  $p17 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 70, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p20 := $i2p.i64.ref($i19);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 70, 12} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.ref($p17, $p20);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 70, 7} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i21 == 1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 71, 13} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.ref($p16, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 71, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb13:
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 73, 5} true;
  assume {:verifier.code 0} true;
  $i23 := $sub.i32(0, 1);
  goto $bb17;
$bb16:
  assume !(($i22 == 1));
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 75, 9} true;
  assume {:verifier.code 0} true;
  $p24 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 75, 17} true;
  assume {:verifier.code 0} true;
  $p25 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 75, 14} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.ref($p24, $p25);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 75, 9} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb18, $bb19;
$bb17:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 88, 2} true;
  assume {:verifier.code 0} true;
  $r := $i23;
  $exn := false;
  return;
$bb18:
  assume ($i26 == 1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 76, 6} true;
  assume {:verifier.code 0} true;
  call $i27 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Tail, $p1, $p16, 0, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 77, 5} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb19:
  assume !(($i26 == 1));
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 78, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 79, 10} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i31 == 1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 81, 25} true;
  assume {:verifier.code 0} true;
  $i23 := $i29;
  goto $bb17;
$bb22:
  ...
  goto $bb20;
$bb23:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 85, 3} true;
  assume {:verifier.code 0} true;
  goto $bb14;
}
const worker_1: ref;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 96, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 96, 2} true;
  assume {:verifier.code 0} true;
  call enqueue(42);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 97, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 98, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 98, 2} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 99, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 104, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 104, 2} true;
  assume {:verifier.code 0} true;
  call enqueue(41);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 105, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 106, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 106, 2} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 107, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 115, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call init();
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 117, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, worker_1, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 118, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, worker_2, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, worker_2, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 121, 18} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 121, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 122, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 122, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 123, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 123, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 125, 13} true;
  assume {:verifier.code 0} true;
  call $i12 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i12);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 126, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 126, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 128, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
