...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/ms-3.bpl /Users/ponce/git/Dat3M/benchmarks/lfds/ms-3.c
...
$bb10:
  ...
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 48, 5} true;
  assume {:verifier.code 0} true;
  call $i26 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Tail, $p1, $p25, 4, 0);
...
$bb11:
  ...
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 50, 9} true;
  assume {:verifier.code 0} true;
  call $i29 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32($p28, $p2, $p4, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 50, 9} true;
  assume {:verifier.code 0} true;
  $i30 := $ne.i32($i29, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 50, 9} true;
...
$bb13:
  ...
  assume {:verifier.code 0} true;
  call $i31 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Tail, $p1, $p4, 4, 0);
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  call $i27 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Tail, $p1, $p16, 4, 0);
...
$bb19:
  ...
  assume {:verifier.code 0} true;
  call $i30 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Head, $p0, $p16, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 79, 10} true;
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i30, 0);
  assume {:sourceloc "benchmarks/lfds/ms-3.c", 79, 10} true;
