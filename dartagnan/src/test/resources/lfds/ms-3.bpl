...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/ms-opt.bpl /home/ponce/git/Dat3M/output/ms-opt.ll
...
procedure  init()
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms.h", 21, 15} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms.h", 22, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 22, 2} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p2, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms.h", 23, 2} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, Head, $p0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 24, 2} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, Tail, $p0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  enqueue($i0: i32)
{
  ...
  var $i38: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms.h", 30, 12} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms.h", 31, 8} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p7, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 31, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p8, $i0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 32, 21} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p7, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 32, 2} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p9, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms.h", 34, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/ms.h", 35, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p12 := $i2p.i64.ref($i11);
  assume {:sourceloc "benchmarks/lfds/ms.h", 35, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p1, $p12);
  assume {:sourceloc "benchmarks/lfds/ms.h", 36, 15} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.ref($p12, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms.h", 36, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "benchmarks/lfds/ms.h", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := assert_.i32($i14);
  assume {:sourceloc "benchmarks/lfds/ms.h", 37, 38} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p12, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 37, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p20 := $i2p.i64.ref($i19);
  assume {:sourceloc "benchmarks/lfds/ms.h", 37, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p2, $p20);
  assume {:sourceloc "benchmarks/lfds/ms.h", 39, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p23 := $i2p.i64.ref($i22);
  assume {:sourceloc "benchmarks/lfds/ms.h", 39, 12} true;
  assume {:verifier.code 0} true;
  $i24 := $eq.ref($p12, $p23);
  assume {:sourceloc "benchmarks/lfds/ms.h", 39, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i24 == 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 40, 13} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.ref($p20, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms.h", 40, 8} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i25 == 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 41, 5} true;
  assume {:verifier.code 0} true;
  $p26 := $bitcast.ref.ref($p1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 41, 5} true;
  assume {:verifier.code 0} true;
  call $p27 := __llvm_atomic64_cmpxchg(Tail, $i11, $i19, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 41, 5} true;
  assume {:verifier.code 0} true;
  $i28 := $extractvalue.i64($p27, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 41, 5} true;
  assume {:verifier.code 0} true;
  $i29 := $extractvalue.i1($p27, 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 41, 5} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i25 == 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
  call $p32 := __llvm_atomic64_cmpxchg($p17, $i19, $i31, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "benchmarks/lfds/ms.h", 42, 4} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb9:
  assume !(($i29 == 1));
...
$bb12:
  ...
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p30, $i33);
  assume {:sourceloc "benchmarks/lfds/ms.h", 43, 9} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb13:
  assume ($i34 == 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 44, 9} true;
  assume {:verifier.code 0} true;
  $p35 := $bitcast.ref.ref($p1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 44, 9} true;
  assume {:verifier.code 0} true;
  call $p36 := __llvm_atomic64_cmpxchg(Tail, $i11, $i31, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 44, 9} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "benchmarks/lfds/ms.h", 50, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb17:
  ...
  returns ($r: i32)
{
  ...
  var $i28: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms.h", 56, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/ms.h", 57, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p8 := $i2p.i64.ref($i7);
  assume {:sourceloc "benchmarks/lfds/ms.h", 57, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p0, $p8);
  assume {:sourceloc "benchmarks/lfds/ms.h", 58, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.ref($p8, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms.h", 58, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i32($i9);
  assume {:sourceloc "benchmarks/lfds/ms.h", 58, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := assert_.i32($i10);
  assume {:sourceloc "benchmarks/lfds/ms.h", 59, 10} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p3);
  assume {:sourceloc "benchmarks/lfds/ms.h", 59, 10} true;
  assume {:verifier.code 0} true;
  call $i13 := __llvm_atomic64_load(Tail, 2);
  assume {:sourceloc "benchmarks/lfds/ms.h", 59, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p14 := $i2p.i64.ref($i13);
  assume {:sourceloc "benchmarks/lfds/ms.h", 59, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p1, $p14);
  assume {:sourceloc "benchmarks/lfds/ms.h", 60, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $ne.ref($p14, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms.h", 60, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i32($i15);
  assume {:sourceloc "benchmarks/lfds/ms.h", 60, 3} true;
  assume {:verifier.code 0} true;
  call $i17 := assert_.i32($i16);
  assume {:sourceloc "benchmarks/lfds/ms.h", 61, 38} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p8, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 61, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms.h", 61, 10} true;
  assume {:verifier.code 0} true;
  call $i21 := __llvm_atomic64_load($p19, 2);
  assume {:sourceloc "benchmarks/lfds/ms.h", 61, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p20, $i21);
  assume {:sourceloc "benchmarks/lfds/ms.h", 61, 10} true;
  assume {:verifier.code 0} true;
  $p22 := $i2p.i64.ref($i21);
  assume {:sourceloc "benchmarks/lfds/ms.h", 63, 15} true;
  assume {:verifier.code 0} true;
  $p23 := $bitcast.ref.ref($p5);
  assume {:sourceloc "benchmarks/lfds/ms.h", 63, 15} true;
  assume {:verifier.code 0} true;
  call $i24 := __llvm_atomic64_load(Head, 2);
  assume {:sourceloc "benchmarks/lfds/ms.h", 63, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p25 := $i2p.i64.ref($i24);
  assume {:sourceloc "benchmarks/lfds/ms.h", 63, 12} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.ref($p8, $p25);
  assume {:sourceloc "benchmarks/lfds/ms.h", 63, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i26 == 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 64, 13} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.ref($p22, $0.ref);
  assume {:sourceloc "benchmarks/lfds/ms.h", 64, 8} true;
  assume {:verifier.code 0} true;
  $i28 := $sub.i32(0, 1);
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/lfds/ms.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/ms.h", 81, 2} true;
  assume {:verifier.code 0} true;
  $r := $i28;
  $exn := false;
  return;
$bb7:
  assume !(($i27 == 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 68, 14} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.ref($p8, $p14);
  assume {:sourceloc "benchmarks/lfds/ms.h", 68, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i29 == 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 69, 6} true;
  assume {:verifier.code 0} true;
  $p30 := $bitcast.ref.ref($p1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 69, 6} true;
  assume {:verifier.code 0} true;
  call $p31 := __llvm_atomic64_cmpxchg(Tail, $i13, $i21, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 69, 6} true;
  assume {:verifier.code 0} true;
  $i32 := $extractvalue.i64($p31, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 69, 6} true;
  assume {:verifier.code 0} true;
  $i33 := $extractvalue.i1($p31, 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 69, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume !(($i29 == 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 71, 21} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p22, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/ms.h", 71, 21} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, $p34);
  call {:cexpr "result"} boogie_si_record_i32($i35);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
  $p36 := $bitcast.ref.ref($p0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
  call $p37 := __llvm_atomic64_cmpxchg(Head, $i7, $i21, 4, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
  $i38 := $extractvalue.i64($p37, 0);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
  $i39 := $extractvalue.i1($p37, 1);
  assume {:sourceloc "benchmarks/lfds/ms.h", 72, 10} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  goto $bb11;
$bb11:
  assume {:sourceloc "benchmarks/lfds/ms.h", 70, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb12:
  assume !(($i33 == 1));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/ms.c", 11, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/ms.c", 11, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/lfds/ms.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/lfds/ms.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call enqueue($i2);
  assume {:sourceloc "benchmarks/lfds/ms.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call $i3 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/lfds/ms.c", 16, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $sub.i32(0, 1));
  assume {:sourceloc "benchmarks/lfds/ms.c", 16, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "benchmarks/lfds/ms.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call $i6 := assert_.i32($i5);
  assume {:sourceloc "benchmarks/lfds/ms.c", 18, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lfds/ms.c", 25, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call init();
  assume {:sourceloc "benchmarks/lfds/ms.c", 28, 25} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 24)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/lfds/ms.c", 28, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms.c", 31, 22} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/ms.c", 31, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/ms.c", 33, 13} true;
  assume {:verifier.code 0} true;
  call $i13 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i13);
  assume {:sourceloc "benchmarks/lfds/ms.c", 34, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i32($i13, $sub.i32(0, 1));
  assume {:sourceloc "benchmarks/lfds/ms.c", 34, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i1.i32($i14);
  assume {:sourceloc "benchmarks/lfds/ms.c", 34, 5} true;
  assume {:verifier.code 0} true;
  call $i16 := assert_.i32($i15);
  assume {:sourceloc "benchmarks/lfds/ms.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
