...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/safe_stack-opt.bpl /home/ponce/git/Dat3M/output/safe_stack-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38266));
...
axiom (llvm.dbg.value == $sub.ref(0, 8338));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const pop: ref;
axiom (pop == $sub.ref(0, 9370));
procedure  pop()
  returns ($r: i32)
{
  var $i0: i32;
...
axiom (__llvm_atomic32_store == $sub.ref(0, 14530));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const thread3: ref;
axiom (thread3 == $sub.ref(0, 15562));
...
$bb3:
  ...
  assume {:sourceloc "benchmarks/lfds/safe_stack.c", 11, 5} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i6, 8));
  $p8 := $add.ref($add.ref($add.ref(array, $mul.ref(0, 24)), $mul.ref($i6, 8)), $mul.ref(0, 1));
...
axiom (__assert_fail == $sub.ref(0, 16594));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const thread1: ref;
axiom (thread1 == $sub.ref(0, 17626));
...
axiom (llvm.dbg.declare == $sub.ref(0, 19690));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 20722));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 21754));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 22786));
...
axiom (__SMACK_dummy == $sub.ref(0, 23818));
...
axiom (__SMACK_and32 == $sub.ref(0, 24850));
...
axiom (__SMACK_and64 == $sub.ref(0, 25882));
...
axiom (__SMACK_and16 == $sub.ref(0, 26914));
...
axiom (__SMACK_and8 == $sub.ref(0, 27946));
...
axiom (__SMACK_or32 == $sub.ref(0, 28978));
...
axiom (__SMACK_or64 == $sub.ref(0, 30010));
...
axiom (__SMACK_or16 == $sub.ref(0, 31042));
...
axiom (__SMACK_or8 == $sub.ref(0, 32074));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 33106));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 34138));
...
axiom (__SMACK_decls == $sub.ref(0, 35170));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 36202));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 37234));
...
axiom (__SMACK_static_init == $sub.ref(0, 38266));
