...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/  -bpl /Users/ponce/git/Dat3M/output/dglm-3.bpl /Users/ponce/git/Dat3M/benchmarks/lfds/dglm-3.c
...
procedure  init()
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 27, 15} true;
  ...
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 28, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 28, 2} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_init.ref.ref($p2, $0.ref);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 29, 2} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.ref(Head, $p1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 30, 2} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_init.ref.ref(Tail, $p1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  enqueue($i0: i32)
{
  ...
  var $i31: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 36, 12} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 37, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, $i0);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 38, 21} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 38, 2} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_init.ref.ref($p6, $0.ref);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 40, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 41, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p10 := $i2p.i64.ref($i9);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 41, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p1, $p10);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 42, 9} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 42, 9} true;
...
$bb5:
  ...
  goto $bb4;
$bb6:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 43, 10} true;
  assume {:verifier.code 0} true;
  $p13 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 43, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p17 := $i2p.i64.ref($i16);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 43, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p2, $p17);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 45, 13} true;
  assume {:verifier.code 0} true;
  $p18 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 45, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p21 := $i2p.i64.ref($i20);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 45, 18} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.ref($p18, $p21);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 45, 13} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i22 == 1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 46, 17} true;
  assume {:verifier.code 0} true;
  $p23 := $load.ref($M.0, $p2);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 46, 22} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i24 == 1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 47, 9} true;
  assume {:verifier.code 0} true;
  $p25 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 47, 9} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume !(($i24 == 1));
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 52, 5} true;
  assume {:verifier.code 0} true;
  $p30 := $load.ref($M.0, $p2);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 52, 5} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i28 == 1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 48, 9} true;
  assume {:verifier.code 0} true;
  call $i29 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Tail, $p1, $p4, 4, 0);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 49, 6} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  assume !(($i28 == 1));
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 51, 13} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 57, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb15:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 55, 9} true;
  assume {:verifier.code 0} true;
  goto $bb9;
}
  ...
  returns ($r: i32)
{
  ...
  var $i18: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 63, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 64, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p4 := $i2p.i64.ref($i3);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 64, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p0, $p4);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 65, 9} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 65, 9} true;
...
$bb5:
  ...
  goto $bb4;
$bb6:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 66, 10} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 66, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p11 := $i2p.i64.ref($i10);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 68, 7} true;
  assume {:verifier.code 0} true;
  $p12 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 68, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p15 := $i2p.i64.ref($i14);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 68, 12} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.ref($p12, $p15);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 68, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i16 == 1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 69, 13} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.ref($p11, $0.ref);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 69, 8} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i17 == 1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 71, 5} true;
  assume {:verifier.code 0} true;
  $i18 := $sub.i32(0, 1);
  goto $bb12;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 74, 32} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 75, 21} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 87, 2} true;
  assume {:verifier.code 0} true;
  $r := $i18;
  $exn := false;
  return;
$bb13:
  assume ($i22 == 1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 76, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p25 := $i2p.i64.ref($i24);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 76, 26} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p1, $p25);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 77, 21} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume !(($i22 == 1));
...
$bb18:
  ...
  goto $bb17;
$bb19:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 78, 25} true;
  assume {:verifier.code 0} true;
  $p28 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 78, 33} true;
  assume {:verifier.code 0} true;
  $p29 := $load.ref($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 78, 30} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.ref($p28, $p29);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 78, 25} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume ($i30 == 1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 79, 25} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  goto $bb22;
$bb22:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 81, 21} true;
  assume {:verifier.code 0} true;
  $i18 := $i20;
  goto $bb12;
$bb23:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 84, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
}
const worker_1: ref;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 97, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 97, 2} true;
  assume {:verifier.code 0} true;
  call enqueue(42);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 98, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := dequeue();
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 102, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 109, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 109, 2} true;
  assume {:verifier.code 0} true;
  call enqueue(41);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 110, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := dequeue();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 112, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 112, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 114, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 121, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call init();
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 123, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 125, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, worker_1, $0.ref);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 127, 18} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 127, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 128, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 128, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 129, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 129, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 131, 13} true;
  assume {:verifier.code 0} true;
  call $i12 := dequeue();
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 134, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
