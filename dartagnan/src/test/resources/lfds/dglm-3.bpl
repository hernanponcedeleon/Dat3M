...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include -bpl /Users/ponce/git/Dat3M/output/dglm-3.bpl /Users/ponce/git/Dat3M/benchmarks/lfds/dglm-3.c
...
$bb11:
  ...
  assume {:verifier.code 0} true;
  call $i21 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Head, $p0, $p11, 4, 0);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 78, 21} true;
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i21, 0);
  assume {:sourceloc "benchmarks/lfds/dglm-3.c", 78, 21} true;
...
$bb20:
  ...
  assume {:verifier.code 0} true;
  call $i31 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(Tail, $p1, $p11, 4, 0);
