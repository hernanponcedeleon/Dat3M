...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/  -bpl /Users/ponce/git/Dat3M/output/treiber-3-CAS-relaxed.bpl /Users/ponce/git/Dat3M/benchmarks/lfds/treiber-3-CAS-relaxed.c
...
const {:allocSize 8} TOP: ref;
axiom (TOP == $sub.ref(0, 1032));
const init: ref;
axiom (init == $sub.ref(0, 2064));
procedure  init()
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 25, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i0 := atomic_init.ref.ref(TOP, $0.ref);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_init: ref;
axiom (atomic_init == $sub.ref(0, 3096));
procedure  atomic_init.ref.ref(p.0: ref, p.1: ref)
  returns ($r: i32);
const push: ref;
axiom (push == $sub.ref(0, 4128));
procedure  push($i0: i32)
{
  ...
  var $i12: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 30, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 31, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 31, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, $i0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 33, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 34, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p7 := $i2p.i64.ref($i6);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 34, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p1, $p7);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 35, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 37, 13} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(TOP, $p1, $p3, 0, 0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 37, 13} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 37, 13} true;
...
$bb2:
  assume ($i12 == 1);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 38, 13} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i12 == 1));
  ...
  goto $bb1;
$bb4:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 41, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 46, 5} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 47, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p3 := $i2p.i64.ref($i2);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 47, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p0, $p3);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 48, 13} true;
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 48, 15} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.ref($p4, $0.ref);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 48, 13} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 49, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32(0, 1);
  goto $bb4;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 51, 17} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 51, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p11 := $i2p.i64.ref($i10);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 52, 17} true;
  assume {:verifier.code 0} true;
  call $i12 := atomic_compare_exchange_strong_explicit.ref.ref.ref.i32.i32(TOP, $p0, $p11, 0, 0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 52, 17} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 52, 17} true;
  ...
  goto $bb5, $bb6;
$bb4:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 59, 1} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
$bb5:
  assume ($i13 == 1);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 54, 17} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i13 == 1));
  ...
  goto $bb8;
$bb7:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 58, 12} true;
  assume {:verifier.code 0} true;
  $p14 := $load.ref($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 58, 15} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p14, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 58, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, $p15);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 58, 5} true;
  assume {:verifier.code 0} true;
  $i6 := $i16;
  goto $bb4;
$bb8:
  ...
  returns ($r: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 65, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 65, 2} true;
  assume {:verifier.code 0} true;
  call push(42);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 66, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := pop();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 67, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 67, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 68, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 73, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 73, 2} true;
  assume {:verifier.code 0} true;
  call push(41);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 74, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := pop();
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 75, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 75, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 76, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 83, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call init();
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 85, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, worker_1, $0.ref);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 86, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, worker_2, $0.ref);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 87, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, worker_2, $0.ref);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 89, 18} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 89, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 90, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 90, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 91, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 93, 13} true;
  assume {:verifier.code 0} true;
  call $i12 := pop();
  call {:cexpr "r"} boogie_si_record_i32($i12);
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 94, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 94, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/lfds/treiber-3-CAS-relaxed.c", 96, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
