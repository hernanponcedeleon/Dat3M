...
define dso_local i8* @owner(i8* noundef %0) #0 !dbg !212 {
  ...
  %12 = icmp ne i32 %11, -1, !dbg !224
  br i1 %12, label %13, label %20, !dbg !225

13:                                               ; preds = %1
  %14 = load i32, i32* %4, align 4, !dbg !226
  %15 = load i32, i32* %3, align 4, !dbg !226
  %16 = icmp eq i32 %14, %15, !dbg !226
  br i1 %16, label %17, label %18, !dbg !229

17:                                               ; preds = %13
  br label %19, !dbg !229

18:                                               ; preds = %13
  call void @__assert_fail(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 noundef 37, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @__PRETTY_FUNCTION__.owner, i64 0, i64 0)) #4, !dbg !226
  unreachable, !dbg !226
...
20:                                               ; preds = %19, %1
  call void @llvm.dbg.declare(metadata i32* %5, metadata !231, metadata !DIExpression()), !dbg !233
  store i32 0, i32* %5, align 4, !dbg !233
  br label %21, !dbg !234

21:                                               ; preds = %27, %20
  %22 = load i32, i32* %5, align 4, !dbg !235
  %23 = icmp sle i32 %22, 4, !dbg !237
  br i1 %23, label %24, label %30, !dbg !238

24:                                               ; preds = %21
  %25 = load i32, i32* %3, align 4, !dbg !239
  %26 = call i32 @try_push(%struct.Deque* noundef @deq, i32 noundef 10, i32 noundef %25), !dbg !240
  br label %27, !dbg !240

27:                                               ; preds = %24
  %28 = load i32, i32* %5, align 4, !dbg !241
  %29 = add nsw i32 %28, 1, !dbg !241
  store i32 %29, i32* %5, align 4, !dbg !241
  br label %21, !dbg !242, !llvm.loop !243

30:                                               ; preds = %21
  call void @llvm.dbg.declare(metadata i32* %6, metadata !246, metadata !DIExpression()), !dbg !248
  store i32 0, i32* %6, align 4, !dbg !248
  br label %31, !dbg !249

31:                                               ; preds = %39, %30
  %32 = load i32, i32* %6, align 4, !dbg !250
  %33 = icmp slt i32 %32, 4, !dbg !252
  br i1 %33, label %34, label %42, !dbg !253

34:                                               ; preds = %31
  %35 = load i32, i32* %6, align 4, !dbg !254
  %36 = sext i32 %35 to i64, !dbg !255
  %37 = getelementptr inbounds [4 x i64], [4 x i64]* @thiefs, i64 0, i64 %36, !dbg !255
  %38 = call i32 @pthread_create(i64* noundef %37, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thief, i8* noundef null) #5, !dbg !256
  br label %39, !dbg !256

39:                                               ; preds = %34
  %40 = load i32, i32* %6, align 4, !dbg !257
  %41 = add nsw i32 %40, 1, !dbg !257
  store i32 %41, i32* %6, align 4, !dbg !257
  br label %31, !dbg !258, !llvm.loop !259

42:                                               ; preds = %31
  %43 = call i32 @try_pop(%struct.Deque* noundef @deq, i32 noundef 10, i32* noundef %4), !dbg !261
  %44 = icmp sge i32 %43, 0, !dbg !261
  br i1 %44, label %45, label %46, !dbg !264

45:                                               ; preds = %42
  br label %47, !dbg !264

46:                                               ; preds = %42
  call void @__assert_fail(i8* noundef getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 noundef 46, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @__PRETTY_FUNCTION__.owner, i64 0, i64 0)) #4, !dbg !261
  unreachable, !dbg !261
...
define dso_local i32 @main() #0 !dbg !266 {
  ...
  call void @llvm.dbg.declare(metadata i64* %2, metadata !269, metadata !DIExpression()), !dbg !270
  %3 = call i32 @pthread_create(i64* noundef %2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @owner, i8* noundef null) #5, !dbg !271
  ret i32 0, !dbg !272
}
...
!222 = !DILocation(line: 36, column: 9, scope: !223)
!223 = distinct !DILexicalBlock(scope: !212, file: !20, line: 36, column: 9)
!224 = !DILocation(line: 36, column: 35, scope: !223)
!225 = !DILocation(line: 36, column: 9, scope: !212)
!226 = !DILocation(line: 37, column: 9, scope: !227)
!227 = distinct !DILexicalBlock(scope: !228, file: !20, line: 37, column: 9)
!228 = distinct !DILexicalBlock(scope: !223, file: !20, line: 37, column: 9)
!229 = !DILocation(line: 37, column: 9, scope: !228)
!230 = !DILocation(line: 37, column: 9, scope: !223)
!231 = !DILocalVariable(name: "i", scope: !232, file: !20, line: 39, type: !33)
!232 = distinct !DILexicalBlock(scope: !212, file: !20, line: 39, column: 5)
!233 = !DILocation(line: 39, column: 14, scope: !232)
!234 = !DILocation(line: 39, column: 10, scope: !232)
!235 = !DILocation(line: 39, column: 21, scope: !236)
!236 = distinct !DILexicalBlock(scope: !232, file: !20, line: 39, column: 5)
!237 = !DILocation(line: 39, column: 23, scope: !236)
!238 = !DILocation(line: 39, column: 5, scope: !232)
!239 = !DILocation(line: 40, column: 29, scope: !236)
!240 = !DILocation(line: 40, column: 9, scope: !236)
!241 = !DILocation(line: 39, column: 35, scope: !236)
!242 = !DILocation(line: 39, column: 5, scope: !236)
!243 = distinct !{!243, !238, !244, !245}
!244 = !DILocation(line: 40, column: 34, scope: !232)
!245 = !{!"llvm.loop.mustprogress"}
!246 = !DILocalVariable(name: "i", scope: !247, file: !20, line: 42, type: !33)
!247 = distinct !DILexicalBlock(scope: !212, file: !20, line: 42, column: 5)
!248 = !DILocation(line: 42, column: 14, scope: !247)
!249 = !DILocation(line: 42, column: 10, scope: !247)
!250 = !DILocation(line: 42, column: 21, scope: !251)
!251 = distinct !DILexicalBlock(scope: !247, file: !20, line: 42, column: 5)
!252 = !DILocation(line: 42, column: 23, scope: !251)
!253 = !DILocation(line: 42, column: 5, scope: !247)
!254 = !DILocation(line: 43, column: 32, scope: !251)
!255 = !DILocation(line: 43, column: 25, scope: !251)
!256 = !DILocation(line: 43, column: 9, scope: !251)
!257 = !DILocation(line: 42, column: 34, scope: !251)
!258 = !DILocation(line: 42, column: 5, scope: !251)
!259 = distinct !{!259, !253, !260, !245}
!260 = !DILocation(line: 43, column: 53, scope: !247)
!261 = !DILocation(line: 46, column: 5, scope: !262)
!262 = distinct !DILexicalBlock(scope: !263, file: !20, line: 46, column: 5)
!263 = distinct !DILexicalBlock(scope: !212, file: !20, line: 46, column: 5)
!264 = !DILocation(line: 46, column: 5, scope: !263)
!265 = !DILocation(line: 48, column: 5, scope: !212)
!266 = distinct !DISubprogram(name: "main", scope: !20, file: !20, line: 51, type: !267, scopeLine: 52, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !51)
!267 = !DISubroutineType(types: !268)
!268 = !{!33}
!269 = !DILocalVariable(name: "t0", scope: !266, file: !20, line: 53, type: !22)
!270 = !DILocation(line: 53, column: 12, scope: !266)
!271 = !DILocation(line: 55, column: 2, scope: !266)
