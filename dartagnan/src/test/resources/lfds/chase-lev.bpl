...
$bb1:
  ...
  assume {:verifier.code 0} true;
  call $i6 := try_push(deq, 10, 1);
  assume {:sourceloc "benchmarks/lfds/chase-lev.c", 40, 9} true;
  assume {:verifier.code 0} true;
  call $i7 := try_push(deq, 10, 1);
  assume {:sourceloc "benchmarks/lfds/chase-lev.c", 40, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $i11 := pthread_create(thiefs, $0.ref, thief, $0.ref);
  assume {:sourceloc "benchmarks/lfds/chase-lev.c", 43, 9} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($add.ref($add.ref(thiefs, $mul.ref(0, 32)), $mul.ref(1, 8)), $0.ref, thief, $0.ref);
  assume {:sourceloc "benchmarks/lfds/chase-lev.c", 43, 9} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_create($add.ref($add.ref(thiefs, $mul.ref(0, 32)), $mul.ref(2, 8)), $0.ref, thief, $0.ref);
  assume {:sourceloc "benchmarks/lfds/chase-lev.c", 43, 9} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_create($add.ref($add.ref(thiefs, $mul.ref(0, 32)), $mul.ref(3, 8)), $0.ref, thief, $0.ref);
