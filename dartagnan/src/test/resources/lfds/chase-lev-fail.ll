...
define dso_local i8* @owner(i8* noundef %0) #0 !dbg !148 {
  ...
  %4 = call i32 @try_push(%struct.Deque* noundef @deq, i32 noundef 10, i32 noundef 1), !dbg !154
  call void @llvm.dbg.declare(metadata i64* %3, metadata !155, metadata !DIExpression()), !dbg !156
  %5 = call i32 @pthread_create(i64* noundef %3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thief, i8* noundef null) #4, !dbg !157
  %6 = call i32 @try_pop(%struct.Deque* noundef @deq, i32 noundef 10, i32* noundef %2), !dbg !158
  %7 = load i32, i32* %2, align 4, !dbg !159
  %8 = icmp eq i32 %7, 1, !dbg !159
  br i1 %8, label %10, label %9, !dbg !162

9:                                                ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str.1, i64 0, i64 0), i32 noundef 37, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @__PRETTY_FUNCTION__.owner, i64 0, i64 0)) #5, !dbg !159
  unreachable, !dbg !159

10:                                               ; preds = %1
  call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !165
  call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !165
  %11 = call i32 @try_push(%struct.Deque* noundef @deq, i32 noundef 10, i32 noundef 1), !dbg !166
  call void @llvm.dbg.value(metadata i32 1, metadata !163, metadata !DIExpression()), !dbg !165
  call void @llvm.dbg.value(metadata i32 1, metadata !163, metadata !DIExpression()), !dbg !165
  %12 = call i32 @try_push(%struct.Deque* noundef @deq, i32 noundef 10, i32 noundef 1), !dbg !166
  call void @llvm.dbg.value(metadata i32 2, metadata !163, metadata !DIExpression()), !dbg !165
  call void @llvm.dbg.value(metadata i32 2, metadata !163, metadata !DIExpression()), !dbg !165
  %13 = call i32 @try_push(%struct.Deque* noundef @deq, i32 noundef 10, i32 noundef 1), !dbg !166
  call void @llvm.dbg.value(metadata i32 3, metadata !163, metadata !DIExpression()), !dbg !165
  call void @llvm.dbg.value(metadata i32 3, metadata !163, metadata !DIExpression()), !dbg !165
  %14 = call i32 @try_push(%struct.Deque* noundef @deq, i32 noundef 10, i32 noundef 1), !dbg !166
  call void @llvm.dbg.value(metadata i32 4, metadata !163, metadata !DIExpression()), !dbg !165
  call void @llvm.dbg.value(metadata i32 4, metadata !163, metadata !DIExpression()), !dbg !165
  %15 = call i32 @try_push(%struct.Deque* noundef @deq, i32 noundef 10, i32 noundef 1), !dbg !166
  call void @llvm.dbg.value(metadata i32 5, metadata !163, metadata !DIExpression()), !dbg !165
  call void @llvm.dbg.value(metadata i32 5, metadata !163, metadata !DIExpression()), !dbg !165
  call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !170
  call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !170
  %16 = call i32 @pthread_create(i64* noundef getelementptr inbounds ([4 x i64], [4 x i64]* @thiefs, i64 0, i64 0), %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thief, i8* noundef null) #4, !dbg !171
  call void @llvm.dbg.value(metadata i64 1, metadata !168, metadata !DIExpression()), !dbg !170
  call void @llvm.dbg.value(metadata i64 1, metadata !168, metadata !DIExpression()), !dbg !170
  %17 = call i32 @pthread_create(i64* noundef getelementptr inbounds ([4 x i64], [4 x i64]* @thiefs, i64 0, i64 1), %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thief, i8* noundef null) #4, !dbg !171
  call void @llvm.dbg.value(metadata i64 2, metadata !168, metadata !DIExpression()), !dbg !170
  call void @llvm.dbg.value(metadata i64 2, metadata !168, metadata !DIExpression()), !dbg !170
  %18 = call i32 @pthread_create(i64* noundef getelementptr inbounds ([4 x i64], [4 x i64]* @thiefs, i64 0, i64 2), %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thief, i8* noundef null) #4, !dbg !171
  call void @llvm.dbg.value(metadata i64 3, metadata !168, metadata !DIExpression()), !dbg !170
  call void @llvm.dbg.value(metadata i64 3, metadata !168, metadata !DIExpression()), !dbg !170
  %19 = call i32 @pthread_create(i64* noundef getelementptr inbounds ([4 x i64], [4 x i64]* @thiefs, i64 0, i64 3), %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thief, i8* noundef null) #4, !dbg !171
  call void @llvm.dbg.value(metadata i64 4, metadata !168, metadata !DIExpression()), !dbg !170
  call void @llvm.dbg.value(metadata i64 4, metadata !168, metadata !DIExpression()), !dbg !170
  %20 = call i32 @try_pop(%struct.Deque* noundef @deq, i32 noundef 10, i32* noundef %2), !dbg !173
  %21 = icmp sge i32 %20, 0, !dbg !173
  br i1 %21, label %23, label %22, !dbg !176

22:                                               ; preds = %10
  call void @__assert_fail(i8* noundef getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str.1, i64 0, i64 0), i32 noundef 46, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @__PRETTY_FUNCTION__.owner, i64 0, i64 0)) #5, !dbg !173
  unreachable, !dbg !173
...
define dso_local i32 @main() #0 !dbg !178 {
  ...
  call void @llvm.dbg.declare(metadata i64* %1, metadata !181, metadata !DIExpression()), !dbg !182
  %2 = call i32 @pthread_create(i64* noundef %1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @owner, i8* noundef null) #4, !dbg !183
  ret i32 0, !dbg !184
}
...
!155 = !DILocalVariable(name: "t", scope: !148, file: !20, line: 32, type: !22)
!156 = !DILocation(line: 32, column: 15, scope: !148)
!157 = !DILocation(line: 33, column: 5, scope: !148)
!158 = !DILocation(line: 36, column: 5, scope: !148)
!159 = !DILocation(line: 37, column: 5, scope: !160)
!160 = distinct !DILexicalBlock(scope: !161, file: !20, line: 37, column: 5)
!161 = distinct !DILexicalBlock(scope: !148, file: !20, line: 37, column: 5)
!162 = !DILocation(line: 37, column: 5, scope: !161)
!163 = !DILocalVariable(name: "i", scope: !164, file: !20, line: 39, type: !33)
!164 = distinct !DILexicalBlock(scope: !148, file: !20, line: 39, column: 5)
!165 = !DILocation(line: 0, scope: !164)
!166 = !DILocation(line: 40, column: 9, scope: !167)
!167 = distinct !DILexicalBlock(scope: !164, file: !20, line: 39, column: 5)
!168 = !DILocalVariable(name: "i", scope: !169, file: !20, line: 42, type: !33)
!169 = distinct !DILexicalBlock(scope: !148, file: !20, line: 42, column: 5)
!170 = !DILocation(line: 0, scope: !169)
!171 = !DILocation(line: 43, column: 9, scope: !172)
!172 = distinct !DILexicalBlock(scope: !169, file: !20, line: 42, column: 5)
!173 = !DILocation(line: 46, column: 5, scope: !174)
!174 = distinct !DILexicalBlock(scope: !175, file: !20, line: 46, column: 5)
!175 = distinct !DILexicalBlock(scope: !148, file: !20, line: 46, column: 5)
!176 = !DILocation(line: 46, column: 5, scope: !175)
!177 = !DILocation(line: 48, column: 5, scope: !148)
!178 = distinct !DISubprogram(name: "main", scope: !20, file: !20, line: 51, type: !179, scopeLine: 52, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !51)
!179 = !DISubroutineType(types: !180)
!180 = !{!33}
!181 = !DILocalVariable(name: "t0", scope: !178, file: !20, line: 53, type: !22)
!182 = !DILocation(line: 53, column: 12, scope: !178)
!183 = !DILocation(line: 55, column: 2, scope: !178)
!184 = !DILocation(line: 56, column: 5, scope: !178)
