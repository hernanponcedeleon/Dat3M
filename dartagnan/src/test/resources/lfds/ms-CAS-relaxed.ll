; ModuleID = '/home/ponce/git/Dat3M/output/ms.ll'
...
21:                                               ; preds = %19
  %22 = cmpxchg i64* bitcast (%struct.Node** @Tail to i64*), i64 %7, i64 %14 monotonic monotonic, align 8, !dbg !76
...
26:                                               ; preds = %19
  ...
  %28 = cmpxchg i64* %13, i64 %14, i64 %27 monotonic monotonic, align 8, !dbg !79
...
32:                                               ; preds = %26
  %33 = cmpxchg i64* bitcast (%struct.Node** @Tail to i64*), i64 %7, i64 %27 monotonic monotonic, align 8, !dbg !83
...
23:                                               ; preds = %21
  %24 = cmpxchg i64* bitcast (%struct.Node** @Tail to i64*), i64 %7, i64 %14 monotonic monotonic, align 8, !dbg !121
...
28:                                               ; preds = %21
  ...
  %31 = cmpxchg i64* bitcast (%struct.Node** @Head to i64*), i64 %2, i64 %14 monotonic monotonic, align 8, !dbg !127
