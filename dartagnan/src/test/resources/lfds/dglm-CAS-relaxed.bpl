...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/benchmarks/lfds -DFAIL -bpl /home/ponce/git/Dat3M/output/dglm-opt.bpl /home/ponce/git/Dat3M/output/dglm-opt.ll
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  call $i5 := __llvm_atomic64_load(Tail, 2);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 35, 10} true;
  assume {:verifier.code 0} true;
  $p6 := $i2p.i64.ref($i5);
  ...
  assume {:sourceloc "benchmarks/lfds/dglm.h", 37, 10} true;
  assume {:verifier.code 0} true;
  call $i12 := __llvm_atomic64_load($p11, 2);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 37, 10} true;
  assume {:verifier.code 0} true;
  $p13 := $i2p.i64.ref($i12);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 39, 21} true;
  assume {:verifier.code 0} true;
  call $i14 := __llvm_atomic64_load(Tail, 2);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 39, 21} true;
  assume {:verifier.code 0} true;
  $p15 := $i2p.i64.ref($i14);
...
$bb5:
  ...
  assume {:sourceloc "benchmarks/lfds/dglm.h", 41, 9} true;
  assume {:verifier.code 0} true;
  call $p19 := __llvm_atomic64_cmpxchg($p11, $i12, $i18, 0, 0);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 41, 9} true;
  assume {:verifier.code 0} true;
  $i20 := $extractvalue.i1($p19, 1);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 41, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  call $p22 := __llvm_atomic64_cmpxchg(Tail, $i5, $i12, 0, 0);
  assume {:verifier.code 0} true;
  goto $bb4;
$bb7:
  assume ($i20 == 1);
  ...
  assume {:verifier.code 0} true;
  call $p21 := __llvm_atomic64_cmpxchg(Tail, $i5, $i18, 0, 0);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  call $i0 := __llvm_atomic64_load(Head, 2);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 58, 10} true;
  assume {:verifier.code 0} true;
  $p1 := $i2p.i64.ref($i0);
  ...
  assume {:sourceloc "benchmarks/lfds/dglm.h", 60, 10} true;
  assume {:verifier.code 0} true;
  call $i7 := __llvm_atomic64_load($p6, 2);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 60, 10} true;
  assume {:verifier.code 0} true;
  $p8 := $i2p.i64.ref($i7);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 62, 15} true;
  assume {:verifier.code 0} true;
  call $i9 := __llvm_atomic64_load(Head, 2);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 62, 15} true;
  assume {:verifier.code 0} true;
  $p10 := $i2p.i64.ref($i9);
...
$bb7:
  ...
  assume {:verifier.code 0} true;
  call $p16 := __llvm_atomic64_cmpxchg(Head, $i0, $i7, 0, 0);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 69, 21} true;
  assume {:verifier.code 0} true;
  $i17 := $extractvalue.i64($p16, 0);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 69, 21} true;
  assume {:verifier.code 0} true;
  $i18 := $extractvalue.i1($p16, 1);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 69, 21} true;
  assume {:verifier.code 0} true;
  $p19 := $i2p.i64.ref($i17);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 69, 21} true;
  assume {:verifier.code 0} true;
  $p20 := (if ($i18 == 1) then $p1 else $p19);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 69, 21} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  call $i21 := __llvm_atomic64_load(Tail, 2);
  assume {:sourceloc "benchmarks/lfds/dglm.h", 70, 28} true;
  assume {:verifier.code 0} true;
  $p22 := $i2p.i64.ref($i21);
...
$bb10:
  ...
  assume {:verifier.code 0} true;
  call $p27 := __llvm_atomic64_cmpxchg(Tail, $i21, $i7, 0, 0);
...
axiom (__assert_fail == $sub.ref(0, 17603));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const main: ref;
axiom (main == $sub.ref(0, 18635));
...
axiom (llvm.dbg.declare == $sub.ref(0, 19667));
