...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !177 {
  ...
  fence release, !dbg !186
  %4 = add nsw i64 %2, 1, !dbg !187
  %5 = trunc i64 %4 to i32, !dbg !188
  call void @set(i32 noundef %5, i32 noundef 1), !dbg !189
  ret i8* null, !dbg !190
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @thread_2(i8* noundef %0) #0 !dbg !191 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !192, metadata !DIExpression()), !dbg !193
  %2 = ptrtoint i8* %0 to i64, !dbg !194
  call void @llvm.dbg.value(metadata i64 %2, metadata !195, metadata !DIExpression()), !dbg !193
  %3 = add nsw i64 %2, 1, !dbg !196
  %4 = trunc i64 %3 to i32, !dbg !197
  %5 = call i32 @get(i32 noundef %4), !dbg !198
  %6 = getelementptr inbounds [2 x i32], [2 x i32]* @read_flag, i64 0, i64 %2, !dbg !199
  store i32 %5, i32* %6, align 4, !dbg !200
  fence acquire, !dbg !201
  %7 = getelementptr inbounds [2 x i32], [2 x i32]* @data, i64 0, i64 %2, !dbg !202
  %8 = load atomic i32, i32* %7 monotonic, align 4, !dbg !203
  %9 = getelementptr inbounds [2 x i32], [2 x i32]* @read_data, i64 0, i64 %2, !dbg !204
  store i32 %8, i32* %9, align 4, !dbg !205
  ret i8* null, !dbg !206
}
...
define dso_local i32 @main() #0 !dbg !207 {
  ...
  call void @llvm.dbg.declare(metadata [4 x i64]* %1, metadata !210, metadata !DIExpression()), !dbg !216
  call void @init(), !dbg !217
  call void @llvm.dbg.value(metadata i32 0, metadata !218, metadata !DIExpression()), !dbg !220
  call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !220
  %2 = getelementptr inbounds [4 x i64], [4 x i64]* %1, i64 0, i64 0, !dbg !221
  %3 = call i32 @pthread_create(i64* noundef %2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thread_1, i8* noundef null) #6, !dbg !223
  call void @llvm.dbg.value(metadata i64 1, metadata !218, metadata !DIExpression()), !dbg !220
  call void @llvm.dbg.value(metadata i64 1, metadata !218, metadata !DIExpression()), !dbg !220
  %4 = getelementptr inbounds [4 x i64], [4 x i64]* %1, i64 0, i64 1, !dbg !221
  %5 = call i32 @pthread_create(i64* noundef %4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thread_1, i8* noundef inttoptr (i64 1 to i8*)) #6, !dbg !223
  call void @llvm.dbg.value(metadata i64 2, metadata !218, metadata !DIExpression()), !dbg !220
  call void @llvm.dbg.value(metadata i64 2, metadata !218, metadata !DIExpression()), !dbg !220
  call void @llvm.dbg.value(metadata i32 0, metadata !224, metadata !DIExpression()), !dbg !226
  call void @llvm.dbg.value(metadata i64 0, metadata !224, metadata !DIExpression()), !dbg !226
  %6 = getelementptr inbounds [4 x i64], [4 x i64]* %1, i64 0, i64 2, !dbg !227
  %7 = call i32 @pthread_create(i64* noundef %6, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thread_2, i8* noundef null) #6, !dbg !229
  call void @llvm.dbg.value(metadata i64 1, metadata !224, metadata !DIExpression()), !dbg !226
  call void @llvm.dbg.value(metadata i64 1, metadata !224, metadata !DIExpression()), !dbg !226
  %8 = getelementptr inbounds [4 x i64], [4 x i64]* %1, i64 0, i64 3, !dbg !227
  %9 = call i32 @pthread_create(i64* noundef %8, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thread_2, i8* noundef inttoptr (i64 1 to i8*)) #6, !dbg !229
  call void @llvm.dbg.value(metadata i64 2, metadata !224, metadata !DIExpression()), !dbg !226
  call void @llvm.dbg.value(metadata i64 2, metadata !224, metadata !DIExpression()), !dbg !226
  call void @llvm.dbg.value(metadata i32 0, metadata !230, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i64 0, metadata !230, metadata !DIExpression()), !dbg !232
  %10 = load i64, i64* %2, align 8, !dbg !233
  %11 = call i32 @pthread_join(i64 noundef %10, i8** noundef null), !dbg !235
  call void @llvm.dbg.value(metadata i64 1, metadata !230, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i64 1, metadata !230, metadata !DIExpression()), !dbg !232
  %12 = load i64, i64* %4, align 8, !dbg !233
  %13 = call i32 @pthread_join(i64 noundef %12, i8** noundef null), !dbg !235
  call void @llvm.dbg.value(metadata i64 2, metadata !230, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i64 2, metadata !230, metadata !DIExpression()), !dbg !232
  %14 = load i64, i64* %6, align 8, !dbg !233
  %15 = call i32 @pthread_join(i64 noundef %14, i8** noundef null), !dbg !235
  call void @llvm.dbg.value(metadata i64 3, metadata !230, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i64 3, metadata !230, metadata !DIExpression()), !dbg !232
  %16 = load i64, i64* %8, align 8, !dbg !233
  %17 = call i32 @pthread_join(i64 noundef %16, i8** noundef null), !dbg !235
  call void @llvm.dbg.value(metadata i64 4, metadata !230, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i64 4, metadata !230, metadata !DIExpression()), !dbg !232
  ...
  %18 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @read_flag, i64 0, i64 0), align 4, !dbg !239
  %19 = icmp eq i32 %18, 1, !dbg !239
  %20 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @read_data, i64 0, i64 0), align 4, !dbg !239
  %21 = icmp eq i32 %20, 0, !dbg !239
  %or.cond = select i1 %19, i1 %21, i1 false, !dbg !239
  br i1 %or.cond, label %22, label %23, !dbg !239

22:                                               ; preds = %23, %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([42 x i8], [42 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([51 x i8], [51 x i8]* @.str.4, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #5, !dbg !239
  unreachable, !dbg !239

23:                                               ; preds = %0
  call void @llvm.dbg.value(metadata i64 1, metadata !236, metadata !DIExpression()), !dbg !238
  call void @llvm.dbg.value(metadata i64 1, metadata !236, metadata !DIExpression()), !dbg !238
  %24 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @read_flag, i64 0, i64 1), align 4, !dbg !239
  %25 = icmp eq i32 %24, 1, !dbg !239
  %26 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @read_data, i64 0, i64 1), align 4, !dbg !239
  %27 = icmp eq i32 %26, 0, !dbg !239
  %or.cond19 = select i1 %25, i1 %27, i1 false, !dbg !239
  br i1 %or.cond19, label %22, label %28, !dbg !239

28:                                               ; preds = %23
  call void @llvm.dbg.value(metadata i64 2, metadata !236, metadata !DIExpression()), !dbg !238
  call void @llvm.dbg.value(metadata i64 2, metadata !236, metadata !DIExpression()), !dbg !238
  %29 = call i32 @count(), !dbg !243
  %30 = icmp eq i32 %29, 2, !dbg !243
  br i1 %30, label %32, label %31, !dbg !246

31:                                               ; preds = %28
  call void @__assert_fail(i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i64 0, i64 0), i8* noundef getelementptr inbounds ([51 x i8], [51 x i8]* @.str.4, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #5, !dbg !243
  unreachable, !dbg !243
...
!186 = !DILocation(line: 25, column: 5, scope: !177)
!187 = !DILocation(line: 28, column: 13, scope: !177)
!188 = !DILocation(line: 28, column: 9, scope: !177)
!189 = !DILocation(line: 28, column: 5, scope: !177)
!190 = !DILocation(line: 29, column: 5, scope: !177)
!191 = distinct !DISubprogram(name: "thread_2", scope: !26, file: !26, line: 32, type: !178, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !55)
!192 = !DILocalVariable(name: "arg", arg: 1, scope: !191, file: !26, line: 32, type: !19)
!193 = !DILocation(line: 0, scope: !191)
!194 = !DILocation(line: 34, column: 21, scope: !191)
!195 = !DILocalVariable(name: "idx", scope: !191, file: !26, line: 34, type: !16)
!196 = !DILocation(line: 36, column: 30, scope: !191)
!197 = !DILocation(line: 36, column: 26, scope: !191)
!198 = !DILocation(line: 36, column: 22, scope: !191)
!199 = !DILocation(line: 36, column: 5, scope: !191)
!200 = !DILocation(line: 36, column: 20, scope: !191)
!201 = !DILocation(line: 37, column: 5, scope: !191)
!202 = !DILocation(line: 38, column: 44, scope: !191)
!203 = !DILocation(line: 38, column: 22, scope: !191)
!204 = !DILocation(line: 38, column: 5, scope: !191)
!205 = !DILocation(line: 38, column: 20, scope: !191)
!206 = !DILocation(line: 39, column: 5, scope: !191)
!207 = distinct !DISubprogram(name: "main", scope: !26, file: !26, line: 42, type: !208, scopeLine: 43, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !55)
!208 = !DISubroutineType(types: !209)
!209 = !{!30}
!210 = !DILocalVariable(name: "t", scope: !207, file: !26, line: 44, type: !211)
!211 = !DICompositeType(tag: DW_TAG_array_type, baseType: !212, size: 256, elements: !214)
!212 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_t", file: !213, line: 27, baseType: !22)
!213 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/pthreadtypes.h", directory: "", checksumkind: CSK_MD5, checksum: "2d764266ce95ab26d4a4767c2ec78176")
!214 = !{!215}
!215 = !DISubrange(count: 4)
!216 = !DILocation(line: 44, column: 15, scope: !207)
!217 = !DILocation(line: 46, column: 5, scope: !207)
!218 = !DILocalVariable(name: "i", scope: !219, file: !26, line: 48, type: !30)
!219 = distinct !DILexicalBlock(scope: !207, file: !26, line: 48, column: 5)
!220 = !DILocation(line: 0, scope: !219)
!221 = !DILocation(line: 49, column: 25, scope: !222)
!222 = distinct !DILexicalBlock(scope: !219, file: !26, line: 48, column: 5)
!223 = !DILocation(line: 49, column: 9, scope: !222)
!224 = !DILocalVariable(name: "i", scope: !225, file: !26, line: 51, type: !30)
!225 = distinct !DILexicalBlock(scope: !207, file: !26, line: 51, column: 5)
!226 = !DILocation(line: 0, scope: !225)
!227 = !DILocation(line: 52, column: 25, scope: !228)
!228 = distinct !DILexicalBlock(scope: !225, file: !26, line: 51, column: 5)
!229 = !DILocation(line: 52, column: 9, scope: !228)
!230 = !DILocalVariable(name: "i", scope: !231, file: !26, line: 54, type: !30)
!231 = distinct !DILexicalBlock(scope: !207, file: !26, line: 54, column: 5)
!232 = !DILocation(line: 0, scope: !231)
!233 = !DILocation(line: 55, column: 22, scope: !234)
!234 = distinct !DILexicalBlock(scope: !231, file: !26, line: 54, column: 5)
!235 = !DILocation(line: 55, column: 9, scope: !234)
!236 = !DILocalVariable(name: "i", scope: !237, file: !26, line: 57, type: !30)
!237 = distinct !DILexicalBlock(scope: !207, file: !26, line: 57, column: 5)
!238 = !DILocation(line: 0, scope: !237)
!239 = !DILocation(line: 58, column: 9, scope: !240)
!240 = distinct !DILexicalBlock(scope: !241, file: !26, line: 58, column: 9)
!241 = distinct !DILexicalBlock(scope: !242, file: !26, line: 58, column: 9)
!242 = distinct !DILexicalBlock(scope: !237, file: !26, line: 57, column: 5)
!243 = !DILocation(line: 60, column: 5, scope: !244)
!244 = distinct !DILexicalBlock(scope: !245, file: !26, line: 60, column: 5)
!245 = distinct !DILexicalBlock(scope: !207, file: !26, line: 60, column: 5)
!246 = !DILocation(line: 60, column: 5, scope: !245)
!247 = !DILocation(line: 62, column: 5, scope: !207)
