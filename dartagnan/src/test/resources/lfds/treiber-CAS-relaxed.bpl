...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/benchmarks/lfds -DFAIL -bpl /home/ponce/git/Dat3M/output/treiber-opt.bpl /home/ponce/git/Dat3M/output/treiber-opt.ll
...
$bb1:
  ...
  call {:cexpr "n"} boogie_si_record_i64($i4);
  ...
  assume {:verifier.code 0} true;
  call __llvm_atomic64_store($p6, $i4, 0);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 33, 13} true;
  assume {:verifier.code 0} true;
  $i7 := $p2i.ref.i64($p2);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 33, 13} true;
  assume {:verifier.code 0} true;
  call $p8 := __llvm_atomic64_cmpxchg(TOP, $i4, $i7, 0, 0);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 33, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  call $i0 := __llvm_atomic64_load(TOP, 2);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 43, 13} true;
  assume {:verifier.code 0} true;
  $p1 := $i2p.i64.ref($i0);
...
$bb4:
  ...
  assume {:sourceloc "benchmarks/lfds/treiber.h", 47, 17} true;
  assume {:verifier.code 0} true;
  call $i6 := __llvm_atomic64_load($p5, 2);
  call {:cexpr "z"} boogie_si_record_i64($i6);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 48, 17} true;
  assume {:verifier.code 0} true;
  call $p7 := __llvm_atomic64_cmpxchg(TOP, $i0, $i6, 0, 0);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 48, 17} true;
  assume {:verifier.code 0} true;
  $i8 := $extractvalue.i64($p7, 0);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 48, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $extractvalue.i1($p7, 1);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 48, 17} true;
  assume {:verifier.code 0} true;
  $p10 := $i2p.i64.ref($i8);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 48, 17} true;
  assume {:verifier.code 0} true;
  $p11 := (if ($i9 == 1) then $p1 else $p10);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 48, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb5, $bb6;
...
axiom (__assert_fail == $sub.ref(0, 16574));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const main: ref;
axiom (main == $sub.ref(0, 17606));
...
axiom (llvm.dbg.declare == $sub.ref(0, 18638));
