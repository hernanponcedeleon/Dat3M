...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/benchmarks/lfds -bpl /home/ponce/git/Dat3M/output/treiber-opt.bpl /home/ponce/git/Dat3M/output/treiber-opt.ll
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/lfds/treiber.h", 33, 13} true;
  assume {:verifier.code 0} true;
  call $p8 := __llvm_atomic64_cmpxchg(TOP, $i4, $i7, 4, 0);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 33, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  call $p7 := __llvm_atomic64_cmpxchg(TOP, $i0, $i6, 4, 0);
  assume {:sourceloc "benchmarks/lfds/treiber.h", 48, 17} true;
  assume {:verifier.code 0} true;
