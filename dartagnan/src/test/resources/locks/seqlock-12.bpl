...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/seqlock-12-opt.bpl /home/ponce/git/Dat3M/output/seqlock-12-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54839));
...
axiom (lock == $sub.ref(0, 1032));
const {:allocSize 8} t6: ref;
axiom (t6 == $sub.ref(0, 2064));
const {:allocSize 8} t5: ref;
axiom (t5 == $sub.ref(0, 3096));
const {:allocSize 8} t4: ref;
axiom (t4 == $sub.ref(0, 4128));
const {:allocSize 8} t3: ref;
axiom (t3 == $sub.ref(0, 5160));
const {:allocSize 8} t2: ref;
axiom (t2 == $sub.ref(0, 6192));
const {:allocSize 8} t1: ref;
axiom (t1 == $sub.ref(0, 7224));
const {:allocSize 8} t7: ref;
axiom (t7 == $sub.ref(0, 8256));
const {:allocSize 8} t8: ref;
axiom (t8 == $sub.ref(0, 9288));
const {:allocSize 8} t9: ref;
axiom (t9 == $sub.ref(0, 10320));
const {:allocSize 8} t10: ref;
axiom (t10 == $sub.ref(0, 11352));
const {:allocSize 8} t11: ref;
axiom (t11 == $sub.ref(0, 12384));
const {:allocSize 8} t12: ref;
axiom (t12 == $sub.ref(0, 13416));
const {:allocSize 65} {:count 65} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 14505));
const {:allocSize 52} {:count 52} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 15581));
const {:allocSize 36} {:count 36} __PRETTY_FUNCTION__.write: ref;
axiom (__PRETTY_FUNCTION__.write == $sub.ref(0, 16641));
const {:allocSize 9} .str: ref;
axiom (.str == $sub.ref(0, 17674));
const {:allocSize 21} {:count 21} __PRETTY_FUNCTION__.reader: ref;
axiom (__PRETTY_FUNCTION__.reader == $sub.ref(0, 18719));
const writer6: ref;
axiom (writer6 == $sub.ref(0, 19751));
procedure  writer6($p0: ref)
  returns ($r: ref)
{
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 62, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 62, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 6);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 63, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const write: ref;
axiom (write == $sub.ref(0, 20783));
procedure  write($p0: ref, $i1: i32)
{
  var $p2: ref;
  var $i3: i32;
  var $i4: i32;
  ...
  var $i17: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "write:arg:new_data"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 37, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 39, 48} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 39, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := __llvm_atomic32_load($p2, 2);
  call {:cexpr "old_seq"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 40, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $srem.i32($i3, 2);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 40, 25} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 40, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 41, 13} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 44, 57} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 44, 80} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i3, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 44, 13} true;
  assume {:verifier.code 0} true;
  call $p8 := __llvm_atomic32_cmpxchg($p6, $i3, $i7, 0, 0);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 44, 13} true;
  assume {:verifier.code 0} true;
  $i9 := $extractvalue.i1($p8, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 44, 13} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 45, 13} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !(($i11 == 1));
  ...
  goto $bb1;
$bb9:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 49, 31} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 51, 5} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store($p12, $i1, 3);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 51, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := __llvm_atomic32_load($p13, 0);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, $i1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 51, 5} true;
...
$bb11:
  ...
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 51, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.2, .str.1, 51, __PRETTY_FUNCTION__.write);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 51, 5} true;
  assume {:verifier.code 0} true;
  assume false;
$bb12:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 53, 35} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 53, 5} true;
  assume {:verifier.code 0} true;
  call $i17 := __llvm_atomic32_rmw($p16, 1, 3, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 54, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __llvm_atomic32_load: ref;
axiom (__llvm_atomic32_load == $sub.ref(0, 21815));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic32_cmpxchg: ref;
axiom (__llvm_atomic32_cmpxchg == $sub.ref(0, 22847));
procedure  __llvm_atomic32_cmpxchg($p0: ref, $i1: i32, $i2: i32, $i3: i32, $i4: i32)
  returns ($r: ref);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 23879));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const __assert_fail: ref;
axiom (__assert_fail == $sub.ref(0, 24911));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __llvm_atomic32_rmw: ref;
axiom (__llvm_atomic32_rmw == $sub.ref(0, 25943));
procedure  __llvm_atomic32_rmw($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const writer5: ref;
axiom (writer5 == $sub.ref(0, 26975));
procedure  writer5($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 67, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 67, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 5);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 68, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create(t6, $0.ref, writer6, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 69, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 28007));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const writer4: ref;
axiom (writer4 == $sub.ref(0, 29039));
procedure  writer4($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 73, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 73, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 4);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create(t5, $0.ref, writer5, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 75, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const writer3: ref;
axiom (writer3 == $sub.ref(0, 30071));
procedure  writer3($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 79, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 79, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 3);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 80, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create(t4, $0.ref, writer4, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 81, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const writer2: ref;
axiom (writer2 == $sub.ref(0, 31103));
procedure  writer2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 85, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 85, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 2);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 86, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create(t3, $0.ref, writer3, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 87, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const writer1: ref;
axiom (writer1 == $sub.ref(0, 32135));
procedure  writer1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 91, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 92, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create(t2, $0.ref, writer2, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 93, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 97, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 97, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := read(lock);
  call {:cexpr "r1"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 98, 14} true;
  assume {:verifier.code 0} true;
  call $i2 := read(lock);
  call {:cexpr "r2"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 99, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sge.i32($i2, $i1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 99, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 99, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 99, __PRETTY_FUNCTION__.reader);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 99, 5} true;
  assume {:verifier.code 0} true;
  assume false;
$bb3:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 100, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const read: ref;
axiom (read == $sub.ref(0, 34199));
procedure  read($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $i2: i32;
  ...
  var $i9: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 22, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 23, 48} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 23, 23} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load($p1, 2);
  call {:cexpr "old_seq"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 24, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $srem.i32($i2, 2);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 24, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 24, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 25, 13} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 28, 44} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 28, 19} true;
  assume {:verifier.code 0} true;
  call $i6 := __llvm_atomic32_load($p5, 2);
  call {:cexpr "res"} boogie_si_record_i32($i6);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 29, 38} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 29, 13} true;
  assume {:verifier.code 0} true;
  call $i8 := __llvm_atomic32_load($p7, 0);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 29, 65} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, $i2);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 29, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i9 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 30, 13} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 105, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 105, 5} true;
  assume {:verifier.code 0} true;
  call seqlock_init(lock);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 107, 5} true;
  assume {:verifier.code 0} true;
  call $i0 := pthread_create(t1, $0.ref, writer1, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 108, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create(t7, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 109, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_create(t8, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 110, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create(t9, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 111, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create(t10, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 112, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create(t11, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 113, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create(t12, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 115, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const seqlock_init: ref;
axiom (seqlock_init == $sub.ref(0, 36263));
procedure  seqlock_init($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 16, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 16, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 17, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 0);
  assume {:sourceloc "benchmarks/locks/seqlock-12.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 37295));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 38327));
...
axiom (__SMACK_dummy == $sub.ref(0, 39359));
...
axiom (__SMACK_and32 == $sub.ref(0, 40391));
...
axiom (__SMACK_and64 == $sub.ref(0, 41423));
...
axiom (__SMACK_and16 == $sub.ref(0, 42455));
...
axiom (__SMACK_and8 == $sub.ref(0, 43487));
...
axiom (__SMACK_or32 == $sub.ref(0, 44519));
...
axiom (__SMACK_or64 == $sub.ref(0, 45551));
...
axiom (__SMACK_or16 == $sub.ref(0, 46583));
...
axiom (__SMACK_or8 == $sub.ref(0, 47615));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 48647));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 49679));
...
axiom (__SMACK_decls == $sub.ref(0, 50711));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 51743));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 52775));
...
axiom (llvm.dbg.value == $sub.ref(0, 53807));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54839));
