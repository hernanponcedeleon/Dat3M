...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/ticketlock-6.bpl /Users/ponce/git/Dat3M/benchmarks/locks/ticketlock-6.c
  ...
  returns ($r: ref)
{
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 69, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 69, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 71, 24} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, lock);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 71, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_acquire($p2);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 72, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 72, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i3);
  call {:cexpr "shared"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 73, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 74, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i4);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 74, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 75, 24} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.0, lock);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 75, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_release($p7);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 76, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 85, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 85, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, lock, $p6);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 86, 21} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.0, lock);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 86, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_init($p8);
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 88, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticketlock-6.c", 95, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
