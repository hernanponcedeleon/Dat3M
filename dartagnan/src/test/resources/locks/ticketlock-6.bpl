...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang/ -bpl /Users/ponce/git/Dat3M/output/ticketlock-6.bpl /Users/ponce/git/Dat3M/./benchmarks/locks/ticketlock-6.c
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 70, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 70, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 72, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_acquire(lock);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 73, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 73, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 74, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 75, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 75, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 76, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 76, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 77, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_release(lock);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 78, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  ticketlock_acquire($p0: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 42, 18} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 42, 18} true;
  assume {:verifier.code 0} true;
  call $i1 := get_next_ticket($p0);
  call {:cexpr "ticket"} boogie_si_record_i32($i1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 43, 5} true;
  assume {:verifier.code 0} true;
  call await_for_ticket($p0, $i1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 44, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  ticketlock_release($p0: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 58, 42} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 58, 42} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 58, 17} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32($p1, 0);
  call {:cexpr "owner"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 59, 31} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 59, 44} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i2, 1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 59, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_store_explicit.ref.i32.i32($p3, $i4, 3);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 60, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 31, 42} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 31, 42} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 31, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_fetch_add_explicit.ref.i32.i32($p1, 1, 0);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
procedure  await_for_ticket($p0: ref, $i1: i32)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 36, 5} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 36, 37} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 36, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32($p2, 2);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 36, 66} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $i1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 36, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 87, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 89, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 90, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 92, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 93, 5} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p4, $0.ref, thread_n, $i2p.i64.ref(4));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 94, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p5, $0.ref, thread_n, $i2p.i64.ref(5));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 96, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p0);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 96, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 97, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 97, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 98, 18} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, $p2);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 98, 5} true;
  assume {:verifier.code 0} true;
  call $i17 := pthread_join($i16, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 99, 18} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i32($M.0, $p3);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 99, 5} true;
  assume {:verifier.code 0} true;
  call $i19 := pthread_join($i18, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 100, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, $p4);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 100, 5} true;
  assume {:verifier.code 0} true;
  call $i21 := pthread_join($i20, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 101, 18} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, $p5);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 101, 5} true;
  assume {:verifier.code 0} true;
  call $i23 := pthread_join($i22, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 103, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 103, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 105, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure  ticketlock_init($p0: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 25, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 25, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 26, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.i32($p3, 0);
  assume {:sourceloc "./benchmarks/locks/ticketlock-6.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
