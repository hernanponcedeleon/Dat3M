...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/seqlock-opt.bpl /home/ponce/git/Dat3M/output/seqlock-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39311));
...
const {:allocSize 48} {:count 6} t: ref;
axiom (t == $sub.ref(0, 2104));
const {:allocSize 9} .str: ref;
axiom (.str == $sub.ref(0, 3137));
const {:allocSize 49} {:count 49} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4210));
const {:allocSize 21} {:count 21} __PRETTY_FUNCTION__.reader: ref;
axiom (__PRETTY_FUNCTION__.reader == $sub.ref(0, 5255));
const writer3: ref;
axiom (writer3 == $sub.ref(0, 6287));
procedure  writer3($p0: ref)
  returns ($r: ref)
{
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock.c", 15, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock.c", 15, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 3);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.value == $sub.ref(0, 7319));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const write: ref;
axiom (write == $sub.ref(0, 8351));
procedure  write($p0: ref, $i1: i32)
{
  ...
  var $i14: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock.h", 35, 5} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/seqlock.h", 37, 48} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock.h", 37, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := __llvm_atomic32_load($p2, 2);
  call {:cexpr "old_seq"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 38, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $srem.i32($i3, 2);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 38, 25} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 1);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 38, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/locks/seqlock.h", 42, 80} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i3, 1);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 42, 13} true;
  assume {:verifier.code 0} true;
  call $p7 := __llvm_atomic32_cmpxchg($p2, $i3, $i6, 0, 0);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 42, 13} true;
  assume {:verifier.code 0} true;
  $i8 := $extractvalue.i1($p7, 1);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 42, 13} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 47, 31} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock.h", 49, 34} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store($p9, $i1, 3);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 49, 12} true;
  assume {:verifier.code 0} true;
  call $i10 := __llvm_atomic32_load($p9, 0);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 49, 65} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, $i1);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 49, 65} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 49, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := assert_.i32($i12);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 51, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := __llvm_atomic32_rmw($p2, 1, 3, 1);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 52, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb6:
...
axiom (__llvm_atomic32_load == $sub.ref(0, 9383));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const __llvm_atomic32_cmpxchg: ref;
axiom (__llvm_atomic32_cmpxchg == $sub.ref(0, 10415));
procedure  __llvm_atomic32_cmpxchg($p0: ref, $i1: i32, $i2: i32, $i3: i32, $i4: i32)
  returns ($r: ref);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 11447));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const assert_: ref;
axiom (assert_ == $sub.ref(0, 12479));
procedure  assert_.i32(p.0: i32)
  returns ($r: i32);
const __llvm_atomic32_rmw: ref;
axiom (__llvm_atomic32_rmw == $sub.ref(0, 13511));
procedure  __llvm_atomic32_rmw($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const writer2: ref;
axiom (writer2 == $sub.ref(0, 14543));
procedure  writer2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock.c", 20, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock.c", 20, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 2);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($add.ref($add.ref(t, $mul.ref(0, 48)), $mul.ref(5, 8)), $0.ref, writer3, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 15575));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const writer1: ref;
axiom (writer1 == $sub.ref(0, 16607));
procedure  writer1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock.c", 26, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 1);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($add.ref($add.ref(t, $mul.ref(0, 48)), $mul.ref(4, 8)), $0.ref, writer2, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock.c", 32, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock.c", 32, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := read(lock);
  call {:cexpr "r1"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 33, 14} true;
  assume {:verifier.code 0} true;
  call $i2 := read(lock);
  call {:cexpr "r2"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 34, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sge.i32($i2, $i1);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 34, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 35, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/seqlock.c", 34, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 34, __PRETTY_FUNCTION__.reader);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 34, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
const read: ref;
axiom (read == $sub.ref(0, 18671));
  ...
  returns ($r: i32)
{
  ...
  var $i8: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock.h", 26, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock.h", 26, 44} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock.h", 20, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/seqlock.h", 21, 48} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock.h", 21, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := __llvm_atomic32_load($p2, 2);
  call {:cexpr "old_seq"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 22, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $srem.i32($i3, 2);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 22, 25} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 1);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 22, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb2, $bb4;
$bb2:
...
$bb4:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/locks/seqlock.h", 26, 19} true;
  assume {:verifier.code 0} true;
  call $i6 := __llvm_atomic32_load($p1, 2);
  call {:cexpr "res"} boogie_si_record_i32($i6);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 27, 13} true;
  assume {:verifier.code 0} true;
  call $i7 := __llvm_atomic32_load($p2, 0);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 27, 65} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, $i3);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 27, 13} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 28, 13} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
...
axiom (__assert_fail == $sub.ref(0, 19703));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const main: ref;
axiom (main == $sub.ref(0, 20735));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/seqlock.c", 40, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 40, 5} true;
  assume {:verifier.code 0} true;
  call seqlock_init(lock);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 43, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := pthread_create(t, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 43, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($add.ref($add.ref(t, $mul.ref(0, 48)), $mul.ref(1, 8)), $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 43, 9} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_create($add.ref($add.ref(t, $mul.ref(0, 48)), $mul.ref(2, 8)), $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 45, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($add.ref($add.ref(t, $mul.ref(0, 48)), $mul.ref(3, 8)), $0.ref, writer1, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (seqlock_init == $sub.ref(0, 21767));
procedure  seqlock_init($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock.h", 14, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock.h", 14, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock.h", 14, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 15, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock.h", 15, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 0);
  assume {:sourceloc "benchmarks/locks/seqlock.h", 16, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 22799));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 23831));
...
axiom (__SMACK_dummy == $sub.ref(0, 24863));
...
axiom (__SMACK_and32 == $sub.ref(0, 25895));
...
axiom (__SMACK_and64 == $sub.ref(0, 26927));
...
axiom (__SMACK_and16 == $sub.ref(0, 27959));
...
axiom (__SMACK_and8 == $sub.ref(0, 28991));
...
axiom (__SMACK_or32 == $sub.ref(0, 30023));
...
axiom (__SMACK_or64 == $sub.ref(0, 31055));
...
axiom (__SMACK_or16 == $sub.ref(0, 32087));
...
axiom (__SMACK_or8 == $sub.ref(0, 33119));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 34151));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 35183));
...
axiom (__SMACK_decls == $sub.ref(0, 36215));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37247));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38279));
...
axiom (__SMACK_static_init == $sub.ref(0, 39311));
