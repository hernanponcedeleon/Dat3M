...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/linuxrwlock-3-rel2rx.bpl /Users/ponce/git/Dat3M/benchmarks/locks/linuxrwlock-3-rel2rx.c
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 134, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 137, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 143, 16} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 151, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 2);
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 152, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $srem.i32($i1, 2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 152, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 152, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb4, $bb5;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 164, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 153, 13} true;
  assume {:verifier.code 0} true;
  call read_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 154, 21} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  call write_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 159, 24} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 173, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 175, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, threadW, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 177, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, threadR, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-rel2rx.c", 179, 5} true;
  assume {:verifier.code 0} true;
