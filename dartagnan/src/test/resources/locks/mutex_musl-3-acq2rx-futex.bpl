...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mutex_musl-3-acq2rx-futex.bpl /Users/ponce/git/Dat3M/benchmarks/locks/mutex_musl-3-acq2rx-futex.c
  ...
  returns ($r: ref)
{
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 99, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 99, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 101, 16} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 101, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock($p2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 102, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 102, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i3);
  call {:cexpr "shared"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 103, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 104, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i4);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 104, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 105, 18} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 105, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock($p7);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 106, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  mutex_lock($p0: ref)
{
  ...
  var $i16: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 67, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 68, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 69, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 71, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 82, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 71, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := mutex_lock_slowpath_check($p0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 71, 41} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 71, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 72, 9} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_thread_fence.i32(0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 73, 39} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 73, 9} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_fetch_add_explicit.ref.i32.i32($p8, 1, 0);
  assume true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 74, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 75, 58} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 75, 14} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p10, $p1, 2, 0, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 75, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 75, 13} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 79, 26} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 79, 9} true;
  assume {:verifier.code 0} true;
  call __futex_wait($p14, 2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 80, 39} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 80, 9} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume !(($i12 == 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 78, 13} true;
  assume {:verifier.code 0} true;
...
procedure  mutex_unlock($p0: ref)
{
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 86, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 86, 44} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 86, 15} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_exchange_explicit.ref.i32.i32($p1, 0, 3);
  call {:cexpr "old"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 87, 34} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 87, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_load_explicit.ref.i32($p3, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 87, 65} true;
  assume {:verifier.code 0} true;
  $i5 := $sgt.i32($i4, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 87, 69} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 88, 26} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 88, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 87, 76} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i2, 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 87, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 89, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  __futex_wake($p0: ref, $i1: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__futex_wake:arg:v"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_fetch_add_explicit.ref.i32.i32(sig, 1, 3);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 50, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 51, 56} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 51, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p2, $p1, 1, 2, 2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 58, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 59, 56} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 59, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p2, $p1, 1, 2, 2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 59, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
procedure  __futex_wait($p0: ref, $i1: i32)
{
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 14, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32($p0, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 15, 55} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 16, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_load_explicit.ref.i32(sig, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 18, 61} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, $i2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 114, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 114, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, mutex, $p3);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 115, 16} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 115, 5} true;
  assume {:verifier.code 0} true;
  call mutex_init($p5);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 117, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 118, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 121, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure  mutex_init($p0: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 44, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 44, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 44, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 45, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 45, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.i32($p3, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-acq2rx-futex.c", 46, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
