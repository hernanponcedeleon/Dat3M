...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/home/Dat3M/include/ -bpl /home/Dat3M/output/ticketlock-6-rel2rx-O0.bpl /home/Dat3M/output/ticketlock-6-rel2rx_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 36116));
...
axiom (llvm.dbg.declare == $sub.ref(0, 4124));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 5156));
procedure  __VERIFIER_assert($i0: i32);
const thread_n: ref;
axiom (thread_n == $sub.ref(0, 6188));
  ...
  returns ($r: ref)
{
  ...
  var $p8: ref;
$bb0:
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 69, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 69, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 71, 24} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, lock);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 71, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_acquire($p2);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 72, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i64.i32($i1);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 72, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i3);
  call {:cexpr "shared"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 73, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 74, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i4);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 74, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i64($i5, $i1);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 74, 14} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i32($i6);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i7);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 75, 24} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.0, lock);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 75, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_release($p8);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 76, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (ticketlock_acquire == $sub.ref(0, 7220));
procedure  ticketlock_acquire($p0: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 42, 18} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 42, 18} true;
  assume {:verifier.code 0} true;
  call $i1 := get_next_ticket($p0);
  call {:cexpr "ticket"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 43, 5} true;
  assume {:verifier.code 0} true;
  call await_for_ticket($p0, $i1);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 44, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const ticketlock_release: ref;
axiom (ticketlock_release == $sub.ref(0, 8252));
procedure  ticketlock_release($p0: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 58, 42} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 58, 42} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 58, 17} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32($p1, 0);
  call {:cexpr "owner"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 59, 31} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 59, 44} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i2, 1);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 59, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_store_explicit.ref.i32.i32($p3, $i4, 0);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 60, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_load_explicit: ref;
axiom (atomic_load_explicit == $sub.ref(0, 9284));
procedure  atomic_load_explicit.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const atomic_store_explicit: ref;
axiom (atomic_store_explicit == $sub.ref(0, 10316));
procedure  atomic_store_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const get_next_ticket: ref;
axiom (get_next_ticket == $sub.ref(0, 11348));
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 31, 42} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 31, 42} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 31, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_fetch_add_explicit.ref.i32.i32($p1, 1, 0);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
axiom (await_for_ticket == $sub.ref(0, 12380));
procedure  await_for_ticket($p0: ref, $i1: i32)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 36, 5} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 36, 37} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 36, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32($p2, 2);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 36, 66} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $i1);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 36, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_fetch_add_explicit: ref;
axiom (atomic_fetch_add_explicit == $sub.ref(0, 13412));
procedure  atomic_fetch_add_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 14444));
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 85, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 85, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, lock, $p6);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 86, 21} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.0, lock);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 86, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_init($p8);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 88, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 89, 5} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 90, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 92, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_create($p4, $0.ref, thread_n, $i2p.i64.ref(4));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 93, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_create($p5, $0.ref, thread_n, $i2p.i64.ref(5));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 95, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (ticketlock_init == $sub.ref(0, 16508));
procedure  ticketlock_init($p0: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 25, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 25, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 26, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.i32($p3, 0);
  assume {:sourceloc "output/ticketlock-6-rel2rx_tmp.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 17540));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const atomic_init: ref;
axiom (atomic_init == $sub.ref(0, 18572));
procedure  atomic_init.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 19604));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 20636));
...
axiom (__SMACK_dummy == $sub.ref(0, 21668));
...
axiom (__SMACK_and32 == $sub.ref(0, 22700));
...
axiom (__SMACK_and64 == $sub.ref(0, 23732));
...
axiom (__SMACK_and16 == $sub.ref(0, 24764));
...
axiom (__SMACK_and8 == $sub.ref(0, 25796));
...
axiom (__SMACK_or32 == $sub.ref(0, 26828));
...
axiom (__SMACK_or64 == $sub.ref(0, 27860));
...
axiom (__SMACK_or16 == $sub.ref(0, 28892));
...
axiom (__SMACK_or8 == $sub.ref(0, 29924));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 30956));
...
axiom (__SMACK_decls == $sub.ref(0, 31988));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 33020));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 34052));
...
axiom (llvm.dbg.value == $sub.ref(0, 35084));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 36116));
