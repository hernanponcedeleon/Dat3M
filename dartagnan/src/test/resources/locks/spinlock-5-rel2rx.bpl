...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang/ -bpl /Users/ponce/git/Dat3M/output/spinlock-5-rel2rx.bpl /Users/ponce/git/Dat3M/./benchmarks/locks/spinlock-5-rel2rx.c
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 69, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 69, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 71, 5} true;
  assume {:verifier.code 0} true;
  call spinlock_acquire(lock);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 72, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 72, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 73, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 74, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 74, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 75, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 75, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 76, 5} true;
  assume {:verifier.code 0} true;
  call spinlock_release(lock);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 77, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  spinlock_acquire($p0: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 45, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 45, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 46, 9} true;
  assume {:verifier.code 0} true;
  call await_for_lock($p0);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 47, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 47, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := try_get_lock($p0);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 47, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 47, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i3 == 1));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  spinlock_release($p0: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 58, 31} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 58, 31} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 58, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32($p1, 0, 0);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 59, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  await_for_lock($p0: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 30, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 30, 37} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 30, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32($p1, 0);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 30, 65} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 30, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 37, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 38, 56} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 38, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p2, $p1, 1, 2, 2);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 38, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 86, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 87, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 88, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 89, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 90, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p4, $0.ref, thread_n, $i2p.i64.ref(4));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 93, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p0);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 93, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 94, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p1);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 94, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 95, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p2);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 95, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 96, 18} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, $p3);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 96, 5} true;
  assume {:verifier.code 0} true;
  call $i17 := pthread_join($i16, $0.ref);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 97, 18} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i32($M.0, $p4);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 97, 5} true;
  assume {:verifier.code 0} true;
  call $i19 := pthread_join($i18, $0.ref);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 99, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 99, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 101, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure  spinlock_init($p0: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 25, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 25, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "./benchmarks/locks/spinlock-5-rel2rx.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
