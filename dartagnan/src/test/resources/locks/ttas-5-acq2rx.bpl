...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/ttas-5-acq2rx.bpl /Users/ponce/git/Dat3M/benchmarks/locks/ttas-5-acq2rx.c
  ...
  returns ($r: ref)
{
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 59, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 59, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 61, 5} true;
  assume {:verifier.code 0} true;
  call ttaslock_acquire(lock);
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 62, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 62, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 64, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 66, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (ttaslock_acquire == $sub.ref(0, 6177));
...
axiom (ttaslock_release == $sub.ref(0, 8241));
...
axiom (try_acquire == $sub.ref(0, 11337));
...
axiom (atomic_exchange_explicit == $sub.ref(0, 12369));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 75, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ttas-5-acq2rx.c", 78, 5} true;
  assume {:verifier.code 0} true;
...
axiom (ttaslock_init == $sub.ref(0, 15465));
