...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang/ -bpl /Users/ponce/git/Dat3M/output/ttas-5-acq2rx.bpl /Users/ponce/git/Dat3M/./benchmarks/locks/ttas-5-acq2rx.c
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 60, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 60, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 62, 5} true;
  assume {:verifier.code 0} true;
  call ttaslock_acquire(lock);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 63, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 63, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 64, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 65, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 65, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 66, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 66, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 67, 5} true;
  assume {:verifier.code 0} true;
  call ttaslock_release(lock);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 68, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const ttaslock_acquire: ref;
axiom (ttaslock_acquire == $sub.ref(0, 6180));
procedure  ttaslock_acquire($p0: ref)
{
  var $i1: i32;
  var $i2: i1;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 40, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 40, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 41, 9} true;
  assume {:verifier.code 0} true;
  call await_for_lock($p0);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 42, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := try_acquire($p0);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 42, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 42, 13} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 43, 13} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const ttaslock_release: ref;
axiom (ttaslock_release == $sub.ref(0, 7212));
procedure  ttaslock_release($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 49, 31} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 49, 31} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 49, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32($p1, 0, 3);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 50, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  await_for_lock($p0: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 28, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 28, 37} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 28, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32($p1, 0);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 28, 66} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 28, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const try_acquire: ref;
axiom (try_acquire == $sub.ref(0, 10308));
procedure  try_acquire($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $i2: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 35, 41} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 35, 41} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 35, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_exchange_explicit.ref.i32.i32($p1, 1, 0);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 35, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
axiom (atomic_exchange_explicit == $sub.ref(0, 11340));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 77, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 77, 5} true;
  assume {:verifier.code 0} true;
  call ttaslock_init(lock);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 79, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 80, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 81, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 82, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 83, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p4, $0.ref, thread_n, $i2p.i64.ref(4));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 85, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p0);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 85, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 86, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p1);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 86, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 87, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p2);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 87, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 88, 18} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, $p3);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 88, 5} true;
  assume {:verifier.code 0} true;
  call $i17 := pthread_join($i16, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 89, 18} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i32($M.0, $p4);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 89, 5} true;
  assume {:verifier.code 0} true;
  call $i19 := pthread_join($i18, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 91, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 91, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 93, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const ttaslock_init: ref;
axiom (ttaslock_init == $sub.ref(0, 14436));
procedure  ttaslock_init($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 23, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 23, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "./benchmarks/locks/ttas-5-acq2rx.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
