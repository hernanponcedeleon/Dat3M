...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mutex-3.bpl /Users/ponce/git/Dat3M/benchmarks/locks/mutex-3.c
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 101, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 101, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 103, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock(mutex);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 104, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 104, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 105, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 106, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 106, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i64($i4, $i1);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 106, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 106, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i6);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 107, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock(mutex);
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 108, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 117, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-3.c", 118, 5} true;
  assume {:verifier.code 0} true;
