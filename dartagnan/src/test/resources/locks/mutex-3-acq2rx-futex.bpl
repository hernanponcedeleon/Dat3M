...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mutex-3-acq2rx-futex.bpl /Users/ponce/git/Dat3M/benchmarks/locks/mutex-3-acq2rx-futex.c
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 101, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 101, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 103, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock(mutex);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 104, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 104, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 105, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 106, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 106, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i64($i4, $i1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 106, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 106, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i6);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 107, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock(mutex);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 108, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  mutex_lock($p0: ref)
{
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 63, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 64, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 66, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 75, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume true;
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 67, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 68, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p0, $p1, 2, 0, 0);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 71, 9} true;
  assume {:verifier.code 0} true;
  call __futex_wait($p0, 2);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 72, 13} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 73, 13} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb6:
  assume !(($i6 == 1));
...
procedure  mutex_unlock($p0: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 87, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 87, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 88, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 90, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_store_explicit.ref.i32.i32($p0, 0, 3);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call __futex_wake($p0, 1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 92, 1} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 92, 1} true;
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 79, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 80, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p0, $p1, 0, 3, 3);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 80, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
procedure  __futex_wake($p0: ref, $i1: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__futex_wake:arg:v"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_fetch_add_explicit.ref.i32.i32(sig, 1, 3);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 47, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 48, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p0, $p1, 1, 2, 2);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
procedure  __futex_wait($p0: ref, $i1: i32)
{
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 14, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32($p0, 0);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 15, 55} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $i1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 16, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_load_explicit.ref.i32(sig, 0);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 18, 61} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, $i2);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 18, 5} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 55, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 56, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p0, $p1, 2, 2, 2);
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 56, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 117, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 118, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/locks/mutex-3-acq2rx-futex.c", 121, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
