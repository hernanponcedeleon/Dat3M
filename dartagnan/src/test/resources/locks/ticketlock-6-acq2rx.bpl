...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/ticketlock-6-acq2rx-O0.bpl /Users/ponce/git/Dat3M/output/ticketlock-6-acq2rx_tmp.c
...
axiom (ticketlock_acquire == $sub.ref(0, 5156));
...
axiom (ticketlock_release == $sub.ref(0, 6188));
...
axiom (await_for_ticket == $sub.ref(0, 10316));
...
axiom (atomic_fetch_add_explicit == $sub.ref(0, 11348));
procedure  atomic_fetch_add_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 12380));
...
axiom (ticketlock_init == $sub.ref(0, 13412));
...
axiom (pthread_create == $sub.ref(0, 14444));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const atomic_init: ref;
axiom (atomic_init == $sub.ref(0, 15476));
procedure  atomic_init.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 16508));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 17540));
...
axiom (__SMACK_dummy == $sub.ref(0, 18572));
...
axiom (__VERIFIER_assert == $sub.ref(0, 19604));
...
axiom (__SMACK_and32 == $sub.ref(0, 20636));
...
axiom (__SMACK_and64 == $sub.ref(0, 21668));
...
axiom (__SMACK_and16 == $sub.ref(0, 22700));
...
axiom (__SMACK_and8 == $sub.ref(0, 23732));
...
axiom (__SMACK_or32 == $sub.ref(0, 24764));
...
axiom (__SMACK_or64 == $sub.ref(0, 25796));
...
axiom (__SMACK_or16 == $sub.ref(0, 26828));
...
axiom (__SMACK_or8 == $sub.ref(0, 27860));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 28892));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 29924));
