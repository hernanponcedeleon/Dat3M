...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang/ -bpl /Users/ponce/git/Dat3M/output/mutex_musl-4-rel2rx_unlock.bpl /Users/ponce/git/Dat3M/./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 42300));
...
const {:allocSize 8} mutex: ref;
axiom (mutex == $sub.ref(0, 2060));
const {:allocSize 4} shared: ref;
axiom (shared == $sub.ref(0, 3088));
const {:allocSize 4} sig: ref;
axiom (sig == $sub.ref(0, 4116));
const thread_n: ref;
axiom (thread_n == $sub.ref(0, 5148));
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 97, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 97, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 99, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock(mutex);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 100, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 100, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 101, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 102, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 102, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 103, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 103, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 104, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock(mutex);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 105, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 6180));
...
procedure  mutex_lock($p0: ref)
{
  ...
  var $i13: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 67, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 68, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 70, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 79, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 70, 12} true;
  assume {:verifier.code 0} true;
  call $i4 := mutex_lock_slowpath_check($p0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 70, 41} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 70, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 71, 39} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 71, 9} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_fetch_add_explicit.ref.i32.i32($p6, 1, 0);
  assume true;
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 72, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 73, 58} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 73, 14} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p8, $p1, 2, 0, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 73, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 73, 13} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 77, 39} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 77, 9} true;
  assume {:verifier.code 0} true;
  call $i13 := atomic_fetch_sub_explicit.ref.i32.i32($p12, 1, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 70, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb9:
  assume !(($i10 == 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 76, 26} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 76, 9} true;
  assume {:verifier.code 0} true;
  call __futex_wait($p11, 2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 76, 9} true;
  assume {:verifier.code 0} true;
  goto $bb8;
}
const mutex_unlock: ref;
axiom (mutex_unlock == $sub.ref(0, 8244));
procedure  mutex_unlock($p0: ref)
{
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 83, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 83, 44} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 83, 15} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_exchange_explicit.ref.i32.i32($p1, 0, 0);
  call {:cexpr "old"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 84, 34} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 84, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_load_explicit.ref.i32($p3, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 84, 65} true;
  assume {:verifier.code 0} true;
  $i5 := $sgt.i32($i4, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 84, 69} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb3;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 85, 26} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 85, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 84, 76} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i2, 1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 84, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 86, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_exchange_explicit: ref;
axiom (atomic_exchange_explicit == $sub.ref(0, 9276));
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 50, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 51, 56} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 51, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p2, $p1, 1, 2, 2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (mutex_lock_slowpath_check == $sub.ref(0, 14436));
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 58, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 59, 56} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 59, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p2, $p1, 1, 2, 2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 59, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (atomic_compare_exchange_strong_explicit == $sub.ref(0, 15468));
...
procedure  __futex_wait($p0: ref, $i1: i32)
{
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 14, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32($p0, 2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 15, 55} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $i1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 16, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_load_explicit.ref.i32(sig, 2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 18, 61} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, $i2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
axiom (atomic_fetch_sub_explicit == $sub.ref(0, 17532));
procedure  atomic_fetch_sub_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 18564));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 113, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 115, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 116, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 117, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 118, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 120, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 120, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 121, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 121, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 122, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 122, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 123, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, $p3);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 123, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 125, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 125, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 127, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (mutex_init == $sub.ref(0, 19596));
procedure  mutex_init($p0: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 44, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 44, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 44, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 45, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 45, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.i32($p3, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-4-rel2rx_unlock.c", 46, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 20628));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 21660));
procedure  pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const atomic_init: ref;
axiom (atomic_init == $sub.ref(0, 22692));
procedure  atomic_init.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 23724));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 24756));
...
axiom (__SMACK_dummy == $sub.ref(0, 25788));
...
axiom (__VERIFIER_assert == $sub.ref(0, 26820));
...
axiom (__SMACK_and32 == $sub.ref(0, 27852));
...
axiom (__SMACK_and64 == $sub.ref(0, 28884));
...
axiom (__SMACK_and16 == $sub.ref(0, 29916));
...
axiom (__SMACK_and8 == $sub.ref(0, 30948));
...
axiom (__SMACK_or32 == $sub.ref(0, 31980));
...
axiom (__SMACK_or64 == $sub.ref(0, 33012));
...
axiom (__SMACK_or16 == $sub.ref(0, 34044));
...
axiom (__SMACK_or8 == $sub.ref(0, 35076));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 36108));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 37140));
...
axiom (__SMACK_decls == $sub.ref(0, 38172));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 39204));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 40236));
...
axiom (llvm.dbg.value == $sub.ref(0, 41268));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 42300));
