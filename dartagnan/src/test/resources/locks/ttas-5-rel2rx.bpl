...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/home/Dat3M/include/ -bpl /home/Dat3M/output/ttas-5-rl2rx-O0.bpl /home/Dat3M/output/ttas-5-rl2rx_tmp.c
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 59, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 59, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 61, 5} true;
  assume {:verifier.code 0} true;
  call ttaslock_acquire(lock);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 62, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 62, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 64, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 64, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i64($i4, $i1);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 64, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 64, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i6);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 65, 5} true;
  assume {:verifier.code 0} true;
  call ttaslock_release(lock);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 66, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  ttaslock_acquire($p0: ref)
{
  ...
  var $i2: i1;
$bb0:
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 40, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 40, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 41, 9} true;
  assume {:verifier.code 0} true;
  call await_for_lock($p0);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 42, 14} true;
  assume {:verifier.code 0} true;
  call $i1 := try_acquire($p0);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 42, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 42, 13} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 43, 13} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  ttaslock_release($p0: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 49, 31} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 49, 31} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 49, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_store_explicit.ref.i32.i32($p1, 0, 0);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 50, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  await_for_lock($p0: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 28, 37} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 28, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32($p1, 0);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 28, 66} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 28, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 35, 41} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 35, 41} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 35, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_exchange_explicit.ref.i32.i32($p1, 1, 2);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 35, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 75, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 77, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 78, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 79, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 80, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 81, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p4, $0.ref, thread_n, $i2p.i64.ref(4));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 83, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure  ttaslock_init($p0: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 23, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 23, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "output/ttas-5-rl2rx_tmp.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
