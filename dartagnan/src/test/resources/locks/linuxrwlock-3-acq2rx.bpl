...
{
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 23, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 23, 5} true;
  assume {:verifier.code 0} true;
  call read_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 25, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 25, __PRETTY_FUNCTION__.threadR);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 25, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 33, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 33, 5} true;
  assume {:verifier.code 0} true;
  call write_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 34, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shareddata, 42);
  call {:cexpr "shareddata"} boogie_si_record_i32(42);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 35, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 1} true;
  goto $bb1, $bb2;
$bb1:
  assume (1 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 36, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, sum, $i2);
  call {:cexpr "sum"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call write_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 39, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 35, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.2, .str.1, 35, __PRETTY_FUNCTION__.threadW);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 35, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 44, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 44, 5} true;
  assume {:verifier.code 0} true;
  call read_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 46, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 1} true;
  goto $bb1, $bb2;
$bb1:
  ...
  assume {:verifier.code 0} true;
  call read_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 49, 5} true;
  assume {:verifier.code 0} true;
  call write_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 50, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shareddata, 42);
  call {:cexpr "shareddata"} boogie_si_record_i32(42);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 51, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 1} true;
  goto $bb3, $bb4;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 46, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 46, __PRETTY_FUNCTION__.threadRW);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 46, 5} true;
  assume {:verifier.code 0} true;
  assume false;
$bb3:
  assume (1 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 52, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 52, 8} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $store.i32($M.0, sum, $i2);
  call {:cexpr "sum"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 53, 5} true;
  assume {:verifier.code 0} true;
  call write_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 55, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 51, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.2, .str.1, 51, __PRETTY_FUNCTION__.threadRW);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 51, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 64, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 67, 25} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 67, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p3, $0.ref, threadR, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 69, 25} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 69, 9} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p5, $0.ref, threadW, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 71, 25} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p2, $mul.ref(0, 8)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 71, 9} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p7, $0.ref, threadRW, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 74, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.0, $p3);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 74, 9} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_join($i9, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 76, 22} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i64($M.0, $p5);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 76, 9} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_join($i11, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 78, 22} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.0, $p7);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 78, 9} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_join($i13, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 81, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i16 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 83, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 81, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.3, .str.1, 81, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 81, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
