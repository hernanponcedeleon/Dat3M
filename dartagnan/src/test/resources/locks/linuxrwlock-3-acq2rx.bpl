...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/linuxrwlock-3-acq2rx.bpl /Users/ponce/git/Dat3M/benchmarks/locks/linuxrwlock-3-acq2rx.c
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 133, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 133, 5} true;
  assume {:verifier.code 0} true;
  call read_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 134, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, shareddata);
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 135, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, shareddata);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 135, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i1, $i2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 135, 14} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 135, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i4);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 136, 5} true;
  assume {:verifier.code 0} true;
  call read_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 137, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 142, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 142, 5} true;
  assume {:verifier.code 0} true;
  call write_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 143, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shareddata, 42);
  call {:cexpr "shareddata"} boogie_si_record_i32(42);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 144, 18} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, shareddata);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 144, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32(42, $i1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 144, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call assert_($i3);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 145, 5} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i12: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 151, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 151, 10} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 151, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 151, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 152, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $srem.i32($i1, 2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 152, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 152, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb4, $bb5;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 164, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 153, 13} true;
  assume {:verifier.code 0} true;
  call read_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 154, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, shareddata);
  call {:cexpr "r"} boogie_si_record_i32($i5);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 155, 25} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, shareddata);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 155, 22} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i5, $i6);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 155, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call read_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 157, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume !(($i4 == 1));
  ...
  assume {:verifier.code 0} true;
  call write_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 159, 24} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shareddata, $i1);
  call {:cexpr "shareddata"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 160, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, shareddata);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 160, 31} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, $i1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 160, 31} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call assert_($i11);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 161, 13} true;
  assume {:verifier.code 0} true;
  call write_unlock(mylock);
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 163, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 151, 29} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i1, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 173, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 175, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, threadW, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 177, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, threadR, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3-acq2rx.c", 179, 5} true;
  assume {:verifier.code 0} true;
