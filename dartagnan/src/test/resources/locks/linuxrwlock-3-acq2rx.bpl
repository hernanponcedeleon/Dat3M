...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang/ -DACQ2RX -bpl /Users/ponce/git/Dat3M/output/linuxrwlock-3.bpl /Users/ponce/git/Dat3M/benchmarks/locks/linuxrwlock-3.c
  ...
  returns ($r: ref)
{
  ...
  var $i12: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 117, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 117, 10} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 117, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 2);
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 118, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $srem.i32($i1, 2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 118, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 131, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 119, 13} true;
  assume {:verifier.code 0} true;
  call read_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 120, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, shareddata);
  call {:cexpr "r"} boogie_si_record_i32($i5);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 121, 13} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 124, 13} true;
  assume {:verifier.code 0} true;
  call write_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 125, 24} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shareddata, $i1);
  call {:cexpr "shareddata"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 126, 13} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb6:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 121, 13} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 122, 13} true;
  assume {:verifier.code 0} true;
  call read_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 123, 9} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 130, 5} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb12:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 126, 13} true;
...
$bb15:
  ...
  goto $bb14;
$bb16:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 127, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 128, 13} true;
  assume {:verifier.code 0} true;
  call write_unlock(mylock);
  assume {:verifier.code 0} true;
  goto $bb11;
$bb17:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 117, 29} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i1, 1);
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 142, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 146, 18} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 146, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 147, 18} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 147, 5} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_join($i9, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 148, 18} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, $p2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 148, 5} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_join($i11, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 151, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 151, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/locks/linuxrwlock-3.c", 153, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
