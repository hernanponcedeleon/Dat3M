...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/ticket_awnsb_mutex-opt.bpl /home/ponce/git/Dat3M/output/ticket_awnsb_mutex-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 44477));
...
const {:allocSize 40} lock: ref;
axiom (lock == $sub.ref(0, 2092));
const {:allocSize 4} shared: ref;
axiom (shared == $sub.ref(0, 3120));
const {:treadLocal} {:allocSize 4} tlNode: ref;
axiom (tlNode == $sub.ref(0, 4148));
const {:allocSize 11} .str: ref;
axiom (.str == $sub.ref(0, 5183));
const {:allocSize 60} {:count 60} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 6267));
const {:allocSize 23} {:count 23} __PRETTY_FUNCTION__.thread_n: ref;
axiom (__PRETTY_FUNCTION__.thread_n == $sub.ref(0, 7314));
const {:allocSize 16} {:count 16} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 8354));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 9389));
const ticket_awnsb_mutex_init: ref;
axiom (ticket_awnsb_mutex_init == $sub.ref(0, 10421));
procedure  ticket_awnsb_mutex_init($p0: ref, $i1: i32)
{
  var $p2: ref;
  var $p3: ref;
  var $p4: ref;
  ...
  var $i18: i64;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 155, 24} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ticket_awnsb_mutex_init:arg:maxArrayWaiters"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 155, 24} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 155, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 156, 24} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(12, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 156, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 157, 11} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(24, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 157, 27} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, $i1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 158, 50} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 158, 71} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i64($i5, 8);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 158, 43} true;
  assume {:verifier.code 0} true;
  call $p7 := malloc($i6);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 158, 26} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p7);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 158, 26} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p8);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 158, 11} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 158, 24} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p10, $p7);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 159, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_loop_bound(4);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 10} true;
  assume {:verifier.code 0} true;
  $i11 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 31} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, $p4);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 23} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.i32.i64($i12);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.i64($i11, $i13);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i14 == 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 59} true;
  assume {:verifier.code 0} true;
  $p15 := $load.ref($M.0, $p10);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 53} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p15, $mul.ref($i11, 8));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 75} true;
  assume {:verifier.code 0} true;
  $p17 := $bitcast.ref.ref($p16);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 53} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic64_store($p17, 0, 5);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 160, 49} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i64($i11, 1);
...
$bb3:
  assume !(($i14 == 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 161, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 11453));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const malloc: ref;
axiom (malloc == $sub.ref(0, 12485));
...
axiom (__VERIFIER_loop_bound == $sub.ref(0, 13517));
procedure  __VERIFIER_loop_bound($i0: i32);
const __llvm_atomic64_store: ref;
axiom (__llvm_atomic64_store == $sub.ref(0, 14549));
procedure  __llvm_atomic64_store($p0: ref, $i1: i64, $i2: i32);
const __llvm_atomic32_store: ref;
axiom (__llvm_atomic32_store == $sub.ref(0, 15581));
procedure  __llvm_atomic32_store($p0: ref, $i1: i32, $i2: i32);
const ticket_awnsb_mutex_lock: ref;
axiom (ticket_awnsb_mutex_lock == $sub.ref(0, 16613));
procedure  ticket_awnsb_mutex_lock($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
  var $i3: i64;
  ...
  var $i44: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 181, 63} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 181, 63} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 181, 30} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_rmw($p1, 1, 0, 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 181, 30} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i2);
  call {:cexpr "ticket"} boogie_si_record_i64($i3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 185, 37} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(12, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 185, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := __llvm_atomic32_load($p4, 2);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 185, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 185, 67} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i64($i6, $i3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 185, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 213, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb3:
  assume !(($i7 == 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 187, 5} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i64($i3, $sub.i64(0, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 187, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 187, 12} true;
  assume {:verifier.code 0} true;
  call $i9 := __llvm_atomic32_load($p4, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 187, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i9);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 187, 79} true;
  assume {:verifier.code 0} true;
  $i11 := $sub.i64($i3, 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 187, 70} true;
  assume {:verifier.code 0} true;
  $i12 := $sge.i64($i10, $i11);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 187, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i12 == 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 188, 13} true;
  assume {:verifier.code 0} true;
  call $i13 := __llvm_atomic32_load($p4, 2);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 188, 13} true;
  assume {:verifier.code 0} true;
  $i14 := $sext.i32.i64($i13);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 188, 71} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i64($i14, $i3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 188, 13} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 19} true;
  assume {:verifier.code 0} true;
  call $i16 := __llvm_atomic32_load($p4, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 19} true;
  assume {:verifier.code 0} true;
  $i17 := $sext.i32.i64($i16);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 18} true;
  assume {:verifier.code 0} true;
  $i18 := $sub.i64($i3, $i17);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 87} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(24, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 87} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, $p19);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 102} true;
  assume {:verifier.code 0} true;
  $i21 := $sub.i32($i20, 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 80} true;
  assume {:verifier.code 0} true;
  $i22 := $sext.i32.i64($i21);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 77} true;
  assume {:verifier.code 0} true;
  $i23 := $sge.i64($i18, $i22);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 191, 5} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(24, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 28} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store(tlNode, 0, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 34} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 34} true;
  assume {:verifier.code 0} true;
  $p26 := $load.ref($M.0, $p25);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 68} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, $p24);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 62} true;
  assume {:verifier.code 0} true;
  $i28 := $sext.i32.i64($i27);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 60} true;
  assume {:verifier.code 0} true;
  $i29 := $srem.i64($i3, $i28);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 47} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 28} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p26, $mul.ref($i31, 8));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 197, 5} true;
  assume {:verifier.code 0} true;
  $p33 := $bitcast.ref.ref($p32);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 199, 31} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic64_store($p33, $p2i.ref.i64(tlNode), 3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 199, 9} true;
  assume {:verifier.code 0} true;
  call $i34 := __llvm_atomic32_load($p4, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 199, 9} true;
  assume {:verifier.code 0} true;
  $i35 := $sext.i32.i64($i34);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 199, 67} true;
  assume {:verifier.code 0} true;
  $i36 := $slt.i64($i35, $i8);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 199, 9} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 201, 17} true;
  assume {:verifier.code 0} true;
  call $i37 := __llvm_atomic32_load(tlNode, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 201, 16} true;
  assume {:verifier.code 0} true;
  $i38 := $ne.i32($i37, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 201, 16} true;
  assume {:verifier.code 0} true;
  $i39 := $xor.i1($i38, 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 201, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 205, 16} true;
  assume {:verifier.code 0} true;
  call $i40 := __llvm_atomic32_load($p4, 2);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 205, 16} true;
  assume {:verifier.code 0} true;
  $i41 := $sext.i32.i64($i40);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 205, 74} true;
  assume {:verifier.code 0} true;
  $i42 := $ne.i64($i41, $i3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 205, 9} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume !(($i39 == 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 203, 5} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store($p4, $i2, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 203, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb18:
  assume ($i42 == 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 206, 17} true;
  assume {:verifier.code 0} true;
  call $i43 := __llvm_atomic32_load(tlNode, 2);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 206, 17} true;
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i43, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 206, 17} true;
...
$bb20:
  assume ($i44 == 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 208, 17} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store($p4, $i2, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 208, 17} true;
  assume {:verifier.code 0} true;
...
axiom (__llvm_atomic32_rmw == $sub.ref(0, 17645));
procedure  __llvm_atomic32_rmw($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const __llvm_atomic32_load: ref;
axiom (__llvm_atomic32_load == $sub.ref(0, 18677));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const ticket_awnsb_mutex_unlock: ref;
axiom (ticket_awnsb_mutex_unlock == $sub.ref(0, 19709));
procedure  ticket_awnsb_mutex_unlock($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
  var $i3: i64;
  ...
  var $i28: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 224, 52} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 224, 52} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(12, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 224, 24} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load($p1, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 224, 24} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i2);
  call {:cexpr "ticket"} boogie_si_record_i64($i3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 34} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(32, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 34} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.0, $p4);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 68} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(24, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 68} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 62} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 60} true;
  assume {:verifier.code 0} true;
  $i9 := $srem.i64($i3, $i8);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 47} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i64.i32($i9);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 28} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i32.i64($i10);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 28} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p5, $mul.ref($i11, 8));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 226, 5} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 20} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic64_store($p13, 0, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 56} true;
  assume {:verifier.code 0} true;
  $p14 := $load.ref($M.0, $p4);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 82} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i64($i3, 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 94} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i32($M.0, $p6);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 88} true;
  assume {:verifier.code 0} true;
  $i17 := $sext.i32.i64($i16);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 86} true;
  assume {:verifier.code 0} true;
  $i18 := $srem.i64($i15, $i17);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 69} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i64.i32($i18);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 50} true;
  assume {:verifier.code 0} true;
  $i20 := $sext.i32.i64($i19);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 50} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p14, $mul.ref($i20, 8));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 28} true;
  assume {:verifier.code 0} true;
  $p22 := $bitcast.ref.ref($p21);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 28} true;
  assume {:verifier.code 0} true;
  call $i23 := __llvm_atomic64_load($p22, 2);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 28} true;
  assume {:verifier.code 0} true;
  $p24 := $i2p.i64.ref($i23);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 228, 28} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 229, 15} true;
  assume {:verifier.code 0} true;
  $i26 := $ne.ref($p25, $0.ref);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 229, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i26 == 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 231, 39} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p25, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 232, 5} true;
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store($p27, 1, 3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 232, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i26 == 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 233, 46} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i64.i32($i15);
  assume {:verifier.code 0} true;
  call __llvm_atomic32_store($p1, $i28, 3);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 235, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __llvm_atomic64_load: ref;
axiom (__llvm_atomic64_load == $sub.ref(0, 20741));
procedure  __llvm_atomic64_load($p0: ref, $i1: i32)
  returns ($r: i64);
const thread_n: ref;
axiom (thread_n == $sub.ref(0, 21773));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 15, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 15, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 17, 5} true;
  assume {:verifier.code 0} true;
  call ticket_awnsb_mutex_lock(lock);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i2);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 20, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 21, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, sum, $i6);
  call {:cexpr "sum"} boogie_si_record_i32($i6);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call ticket_awnsb_mutex_unlock(lock);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 20, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 20, __PRETTY_FUNCTION__.thread_n);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 20, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
const __assert_fail: ref;
axiom (__assert_fail == $sub.ref(0, 22805));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const main: ref;
axiom (main == $sub.ref(0, 23837));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 30, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 30, 5} true;
  assume {:verifier.code 0} true;
  call ticket_awnsb_mutex_init(lock, 3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 33, 25} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 24)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 33, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 36, 22} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 36, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 38, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i14 == 1);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.c", 40, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 24869));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 25901));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 26933));
procedure  pthread_join($i0: i64, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 27965));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 28997));
...
axiom (__SMACK_dummy == $sub.ref(0, 30029));
...
axiom (__SMACK_and32 == $sub.ref(0, 31061));
...
axiom (__SMACK_and64 == $sub.ref(0, 32093));
...
axiom (__SMACK_and16 == $sub.ref(0, 33125));
...
axiom (__SMACK_and8 == $sub.ref(0, 34157));
...
axiom (__SMACK_or32 == $sub.ref(0, 35189));
...
axiom (__SMACK_or64 == $sub.ref(0, 36221));
...
axiom (__SMACK_or16 == $sub.ref(0, 37253));
...
axiom (__SMACK_or8 == $sub.ref(0, 38285));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 39317));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 40349));
...
axiom (__SMACK_decls == $sub.ref(0, 41381));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 42413));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 43445));
...
axiom (__SMACK_static_init == $sub.ref(0, 44477));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, sum, 0);
  call {:cexpr "sum"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, lock, 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(4, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(4, 1)), $mul.ref(1, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(4, 1)), $mul.ref(2, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(4, 1)), $mul.ref(3, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(4, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(4, 1)), $mul.ref(5, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(4, 1)), $mul.ref(6, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(4, 1)), $mul.ref(7, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(12, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(16, 1)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(16, 1)), $mul.ref(1, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(16, 1)), $mul.ref(2, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(16, 1)), $mul.ref(3, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(16, 1)), $mul.ref(4, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(16, 1)), $mul.ref(5, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(16, 1)), $mul.ref(6, 1)), 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(16, 1)), $mul.ref(7, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(24, 1)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(lock, $mul.ref(0, 40)), $mul.ref(32, 1)), $0.ref);
  $exn := false;
  return;
}
