...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/pthread_mutex-opt.bpl /home/ponce/git/Dat3M/output/pthread_mutex-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 33120));
...
const {:allocSize 40} m: ref;
axiom (m == $sub.ref(0, 1064));
const {:allocSize 4} sum: ref;
axiom (sum == $sub.ref(0, 2092));
const {:allocSize 16} .str: ref;
axiom (.str == $sub.ref(0, 3132));
const {:allocSize 65} {:count 65} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 4221));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 5256));
const run: ref;
axiom (run == $sub.ref(0, 6288));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 15, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 15, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(m);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 16, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, sum, $i3);
  call {:cexpr "sum"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 17, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(m);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 18, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.value == $sub.ref(0, 7320));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const pthread_mutex_lock: ref;
axiom (pthread_mutex_lock == $sub.ref(0, 8352));
procedure  pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 9384));
procedure  pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 10416));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 25, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_init(m, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 28, 25} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 24)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 28, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p2, $0.ref, run, $0.ref);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 28, 25} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 24)), $mul.ref(1, 8));
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 28, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p4, $0.ref, run, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 28, 25} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 24)), $mul.ref(2, 8));
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 28, 9} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p6, $0.ref, run, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 31, 22} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i64($M.0, $p2);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 31, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, 3);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 33, 5} true;
...
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "benchmarks/c/miscellaneous/pthread_mutex.c", 35, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 18672));
...
axiom (__SMACK_and32 == $sub.ref(0, 19704));
...
axiom (__SMACK_and64 == $sub.ref(0, 20736));
...
axiom (__SMACK_and16 == $sub.ref(0, 21768));
...
axiom (__SMACK_and8 == $sub.ref(0, 22800));
...
axiom (__SMACK_or32 == $sub.ref(0, 23832));
...
axiom (__SMACK_or64 == $sub.ref(0, 24864));
...
axiom (__SMACK_or16 == $sub.ref(0, 25896));
...
axiom (__SMACK_or8 == $sub.ref(0, 26928));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 27960));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 28992));
...
axiom (__SMACK_decls == $sub.ref(0, 30024));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 31056));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 32088));
...
axiom (__SMACK_static_init == $sub.ref(0, 33120));
