...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/home/Dat3M/include/ -bpl /home/Dat3M/output/mutex_musl-4-O0.bpl /home/Dat3M/output/mutex_musl-4_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39208));
...
$bb0:
  ...
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_fetch_add_explicit.ref.i32.i32(signal, 1, 3);
...
$bb0:
  ...
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(signal, 2);
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  call $i5 := atomic_load_explicit.ref.i32(signal, 2);
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 18, 64} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, $i2);
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 116, 5} true;
  assume {:verifier.code 0} true;
...
axiom (pthread_create == $sub.ref(0, 21664));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 22696));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 23728));
...
axiom (__SMACK_dummy == $sub.ref(0, 24760));
...
axiom (__SMACK_and32 == $sub.ref(0, 25792));
...
axiom (__SMACK_and64 == $sub.ref(0, 26824));
...
axiom (__SMACK_and16 == $sub.ref(0, 27856));
...
axiom (__SMACK_and8 == $sub.ref(0, 28888));
...
axiom (__SMACK_or32 == $sub.ref(0, 29920));
...
axiom (__SMACK_or64 == $sub.ref(0, 30952));
...
axiom (__SMACK_or16 == $sub.ref(0, 31984));
...
axiom (__SMACK_or8 == $sub.ref(0, 33016));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 34048));
...
axiom (__SMACK_decls == $sub.ref(0, 35080));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 36112));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 37144));
...
axiom (llvm.dbg.value == $sub.ref(0, 38176));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 39208));
