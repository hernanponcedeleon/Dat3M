...
$bb3:
  ...
  return;
$bb4:
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 71, 13} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  call $i8 := atomic_thread_fence.i32(0);
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 73, 39} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 73, 9} true;
  assume {:verifier.code 0} true;
  call $i10 := atomic_fetch_add_explicit.ref.i32.i32($p9, 1, 0);
  assume true;
  ...
  assume {:verifier.code 0} true;
  call $i12 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p11, $p1, 2, 0, 0);
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 75, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
...
$bb8:
  ...
  assume {:verifier.code 0} true;
  call __futex_wait($p15, 2);
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 80, 39} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 80, 9} true;
  assume {:verifier.code 0} true;
  call $i17 := atomic_fetch_sub_explicit.ref.i32.i32($p16, 1, 0);
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 71, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb9:
  ...
  assume {:verifier.code 0} true;
  call $i14 := atomic_thread_fence.i32(0);
  assume {:sourceloc "output/mutex_musl-4_tmp.c", 78, 13} true;
  assume {:verifier.code 0} true;
  goto $bb8;
}
