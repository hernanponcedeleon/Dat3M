...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mutex-4-rel2rx-unlock.bpl /Users/ponce/git/Dat3M/benchmarks/locks/mutex-4-rel2rx-unlock.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38165));
...
const sig: ref;
axiom (sig == $sub.ref(0, 4109));
const thread_n: ref;
axiom (thread_n == $sub.ref(0, 5141));
  ...
  returns ($r: ref)
{
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 101, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 101, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 103, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock(mutex);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 104, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 104, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 105, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 106, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 106, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 107, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock(mutex);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 108, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 6173));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const mutex_lock: ref;
axiom (mutex_lock == $sub.ref(0, 7205));
procedure  mutex_lock($p0: ref)
{
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 63, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 64, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 66, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 75, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume true;
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 67, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 68, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p0, $p1, 2, 0, 0);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 71, 9} true;
  assume {:verifier.code 0} true;
  call __futex_wait($p0, 2);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 72, 13} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 73, 13} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb6:
  assume !(($i6 == 1));
...
axiom (__assert_fail == $sub.ref(0, 8237));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const mutex_unlock: ref;
axiom (mutex_unlock == $sub.ref(0, 9269));
procedure  mutex_unlock($p0: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 87, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 87, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 88, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 90, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_store_explicit.ref.i32.i32($p0, 0, 3);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call __futex_wake($p0, 1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 92, 1} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 92, 1} true;
...
axiom (mutex_unlock_fastpath == $sub.ref(0, 10301));
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 79, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 80, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p0, $p1, 0, 0, 0);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 80, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
axiom (mutex_lock_fastpath == $sub.ref(0, 15461));
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 47, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 48, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p0, $p1, 1, 2, 2);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
axiom (__futex_wait == $sub.ref(0, 16493));
procedure  __futex_wait($p0: ref, $i1: i32)
{
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 14, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32($p0, 2);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 15, 55} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $i1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 16, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_load_explicit.ref.i32(sig, 2);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 18, 61} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, $i2);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
axiom (mutex_lock_try_acquire == $sub.ref(0, 17525));
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 55, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 56, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p0, $p1, 2, 2, 2);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 56, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
axiom (atomic_load_explicit == $sub.ref(0, 18557));
procedure  atomic_load_explicit.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 19589));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 117, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 118, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 120, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, thread_n, $i2p.i64.ref(3));
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx-unlock.c", 123, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 20621));
...
axiom (__SMACK_dummy == $sub.ref(0, 23717));
...
axiom (__SMACK_and32 == $sub.ref(0, 24749));
...
axiom (__SMACK_and64 == $sub.ref(0, 25781));
...
axiom (__SMACK_and16 == $sub.ref(0, 26813));
...
axiom (__SMACK_and8 == $sub.ref(0, 27845));
...
axiom (__SMACK_or32 == $sub.ref(0, 28877));
...
axiom (__SMACK_or64 == $sub.ref(0, 29909));
...
axiom (__SMACK_or16 == $sub.ref(0, 30941));
...
axiom (__SMACK_or8 == $sub.ref(0, 31973));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 33005));
...
axiom (__SMACK_decls == $sub.ref(0, 34037));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 35069));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 36101));
...
axiom (llvm.dbg.value == $sub.ref(0, 37133));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 38165));
