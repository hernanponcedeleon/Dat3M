...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/home/ponce/git/Dat3M/include/smack -I/home/ponce/git/Dat3M/include/clang -I/home/ponce/git/Dat3M/include -I/home/ponce/git/cna-verification/include -DALGORITHM=2 -bpl /home/ponce/git/Dat3M/output/client-code.bpl /home/ponce/git/cna-verification/client-code.c
...
$bb17:
  assume !(($i13 == 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 268, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 268, 9} true;
  assume {:verifier.code 0} true;
  call $i17 := __LKMM_ATOMIC_FETCH_OP($p16, 256, 2, 3);
...
$bb23:
  assume !(($i21 == 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 204, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 204, 3} true;
  assume {:verifier.code 0} true;
  call __LKMM_ATOMIC_OP($p24, $sub.i32(0, 257), 2);
...
$bb24:
  ...
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 436, 3} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p28, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 436, 3} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 219, 5} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 219, 5} true;
  assume {:verifier.code 0} true;
  $p34 := $bitcast.ref.ref($p33);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 219, 5} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p34, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 219, 5} true;
  assume {:verifier.code 0} true;
  call __LKMM_ATOMIC_OP($p35, $sub.i32(0, 255), 0);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 445, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb27:
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 436, 3} true;
  assume {:verifier.code 0} true;
  call $i30 := __LKMM_LOAD($p29, 1);
  call {:cexpr "VAL"} boogie_si_record_i32($i30);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 436, 3} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i36 := $load.i32($M.0, tid);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 454, 9} true;
  assume {:verifier.code 0} true;
  call $p37 := get_node($i36);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 454, 9} true;
  assume {:verifier.code 0} true;
  $p38 := $bitcast.ref.ref($p37);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 455, 14} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($add.ref($p38, $mul.ref(0, 16)), $mul.ref(12, 1));
  ...
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, tid);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 456, 9} true;
  assume {:verifier.code 0} true;
  call $i43 := encode_tail($i42, $i40);
  call {:cexpr "tail"} boogie_si_record_i32($i43);
...
$bb35:
  ...
  assume {:verifier.code 0} true;
  call $p59 := grab_mcs_node($p38, $i40);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 486, 2} true;
  assume {:verifier.code 0} true;
  /* cna-verification/kernel/locking/qspinlock.c:486:2: SMACK warning: approximating inline asm call call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #4, !dbg !263, !srcloc !264, !verifier.code !128 (can lead to both false alarms and missed detections); */
  assume true;
  ...
  assume {:verifier.code 0} true;
  $p62 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 63, 12} true;
  assume {:verifier.code 0} true;
  $p63 := $bitcast.ref.ref($p62);
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 63, 12} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($add.ref($p63, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 63, 12} true;
  assume {:verifier.code 0} true;
  call $i65 := __LKMM_LOAD($p64, 1);
  call {:cexpr "val"} boogie_si_record_i32($i65);
...
$bb36:
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 63, 12} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 63, 12} true;
  assume {:verifier.code 0} true;
  $p46 := $bitcast.ref.ref($p45);
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 63, 12} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p46, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 63, 12} true;
  assume {:verifier.code 0} true;
  call $i48 := __LKMM_LOAD($p47, 1);
  call {:cexpr "val"} boogie_si_record_i32($i48);
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 65, 6} true;
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i48, 0);
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 65, 6} true;
...
$bb38:
  ...
  assume {:verifier.code 0} true;
  $p51 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 68, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 68, 9} true;
  assume {:verifier.code 0} true;
  call $i54 := __LKMM_CMPXCHG($p53, $i48, 1, 2, 2);
  call {:cexpr "r"} boogie_si_record_i32($i54);
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 68, 9} true;
  assume {:verifier.code 0} true;
  $i55 := $eq.i32($i54, $i48);
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 68, 9} true;
...
$bb47:
  ...
  assume {:verifier.code 0} true;
  $i132 := $load.i32($M.0, tid);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 614, 2} true;
  assume {:verifier.code 0} true;
  call $p133 := get_node($i132);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 614, 2} true;
  assume {:verifier.code 0} true;
  $p134 := $bitcast.ref.ref($p133);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 614, 2} true;
  assume {:verifier.code 0} true;
  $p135 := $add.ref($add.ref($p134, $mul.ref(0, 16)), $mul.ref(12, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 614, 2} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 68, 9} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p69, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 68, 9} true;
  assume {:verifier.code 0} true;
  call $i71 := __LKMM_CMPXCHG($p70, $i65, 1, 2, 2);
  call {:cexpr "r"} boogie_si_record_i32($i71);
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 68, 9} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.i32($i71, $i65);
  assume {:sourceloc "cna-verification/include/asm-generic/qspinlock.h", 68, 9} true;
...
$bb55:
  ...
  assume {:verifier.code 0} true;
  $p75 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 235, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 235, 22} true;
  assume {:verifier.code 0} true;
  call $i78 := __LKMM_LOAD($p77, 1);
  call {:cexpr "val"} boogie_si_record_i32($i78);
...
$bb56:
  ...
  $i81 := $or.i32($i80, $i43);
  call {:cexpr "new"} boogie_si_record_i32($i81);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 247, 15} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 247, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 247, 15} true;
  assume {:verifier.code 0} true;
  call $i85 := __LKMM_CMPXCHG($p84, $i79, $i81, 0, 0);
  call {:cexpr "old"} boogie_si_record_i32($i85);
...
$bb62:
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 528, 3} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($add.ref($p59, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 528, 3} true;
  assume {:verifier.code 0} true;
  goto $bb63;
$bb63:
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 528, 3} true;
  assume {:verifier.code 0} true;
  call $i95 := __LKMM_LOAD($p94, 1);
  call {:cexpr "VAL"} boogie_si_record_i32($i95);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 528, 3} true;
  assume {:verifier.code 0} true;
  $i96 := $ne.i32($i95, 0);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 528, 3} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $p97 := $add.ref($add.ref($p59, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 536, 10} true;
  assume {:verifier.code 0} true;
  $p98 := $bitcast.ref.ref($p97);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 536, 10} true;
  assume {:verifier.code 0} true;
  call $i99 := __LKMM_LOAD($p98, 1);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 536, 10} true;
  assume {:verifier.code 0} true;
...
$bb76:
  ...
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 565, 8} true;
  assume {:verifier.code 0} true;
  $p107 := $add.ref($add.ref($p106, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 565, 8} true;
  assume {:verifier.code 0} true;
  goto $bb78;
$bb77:
...
$bb78:
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 565, 8} true;
  assume {:verifier.code 0} true;
  call $i108 := __LKMM_LOAD($p107, 1);
  call {:cexpr "VAL"} boogie_si_record_i32($i108);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 565, 8} true;
  assume {:verifier.code 0} true;
...
$bb84:
  ...
  assume {:verifier.code 0} true;
  $p113 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 324, 9} true;
  assume {:verifier.code 0} true;
  $p114 := $bitcast.ref.ref($p113);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 324, 9} true;
  assume {:verifier.code 0} true;
  $p115 := $add.ref($add.ref($p114, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 324, 9} true;
  assume {:verifier.code 0} true;
  call $i116 := __LKMM_CMPXCHG($p115, $i104, 1, 0, 0);
  call {:cexpr "r"} boogie_si_record_i32($i116);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 324, 9} true;
  assume {:verifier.code 0} true;
  $i117 := $eq.i32($i116, $i104);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 324, 9} true;
  assume {:verifier.code 0} true;
...
$bb86:
  ...
  assume {:verifier.code 0} true;
  $p120 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 281, 2} true;
  assume {:verifier.code 0} true;
  $p121 := $bitcast.ref.ref($p120);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 281, 2} true;
  assume {:verifier.code 0} true;
  $p122 := $add.ref($add.ref($p121, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 281, 2} true;
  assume {:verifier.code 0} true;
  call __LKMM_ATOMIC_OP($p122, 1, 3);
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 604, 7} true;
  assume {:verifier.code 0} true;
  $i123 := $ne.ref($p89, $0.ref);
...
$bb93:
  ...
  assume {:verifier.code 0} true;
  $p131 := $add.ref($add.ref($p124, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 335, 2} true;
  assume {:verifier.code 0} true;
  call __LKMM_STORE($p131, 1, 3);
...
$bb94:
  ...
  assume {:verifier.code 0} true;
  $p125 := $add.ref($add.ref($p59, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "cna-verification/kernel/locking/qspinlock.c", 605, 10} true;
  assume {:verifier.code 0} true;
  goto $bb95;
$bb95:
...
axiom (encode_tail == $sub.ref(0, 14488));
...
axiom (decode_tail == $sub.ref(0, 17584));
...
axiom (__LKMM_STORE == $sub.ref(0, 18616));
