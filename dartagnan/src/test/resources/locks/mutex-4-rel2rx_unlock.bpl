...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mutex-4-rel2rx_unlock.bpl /Users/ponce/git/Dat3M/benchmarks/locks/mutex-4-rel2rx_unlock.c
...
const mutex: ref;
axiom (mutex == $sub.ref(0, 1028));
const shared: ref;
axiom (shared == $sub.ref(0, 2056));
const sig: ref;
axiom (sig == $sub.ref(0, 3084));
const assert_: ref;
axiom (assert_ == $sub.ref(0, 4116));
...
axiom (__VERIFIER_assert == $sub.ref(0, 6180));
procedure  __VERIFIER_assert($i0: i32);
const thread_n: ref;
axiom (thread_n == $sub.ref(0, 7212));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 101, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 101, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 103, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock(mutex);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 104, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 104, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 105, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 106, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 106, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i64($i4, $i1);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 106, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 106, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i6);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 107, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock(mutex);
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 108, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (mutex_lock == $sub.ref(0, 8244));
...
axiom (mutex_unlock == $sub.ref(0, 9276));
...
axiom (mutex_unlock_fastpath == $sub.ref(0, 10308));
...
axiom (mutex_lock_fastpath == $sub.ref(0, 15468));
...
axiom (mutex_lock_try_acquire == $sub.ref(0, 17532));
...
axiom (atomic_load_explicit == $sub.ref(0, 18564));
procedure  atomic_load_explicit.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 19596));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 117, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 118, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex-4-rel2rx_unlock.c", 123, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 21660));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 22692));
...
axiom (__SMACK_dummy == $sub.ref(0, 23724));
...
axiom (__SMACK_and32 == $sub.ref(0, 24756));
...
axiom (__SMACK_and64 == $sub.ref(0, 25788));
...
axiom (__SMACK_and16 == $sub.ref(0, 26820));
...
axiom (__SMACK_and8 == $sub.ref(0, 27852));
...
axiom (__SMACK_or32 == $sub.ref(0, 28884));
...
axiom (__SMACK_or64 == $sub.ref(0, 29916));
...
axiom (__SMACK_or16 == $sub.ref(0, 30948));
...
axiom (__SMACK_or8 == $sub.ref(0, 31980));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 33012));
