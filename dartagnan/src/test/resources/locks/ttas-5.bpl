...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/ttas-5.bpl /Users/ponce/git/Dat3M/benchmarks/locks/ttas-5.c
  ...
  returns ($r: ref)
{
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 59, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 59, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 61, 5} true;
  assume {:verifier.code 0} true;
  call ttaslock_acquire(lock);
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 62, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 62, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 64, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 66, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 75, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ttas-5.c", 78, 5} true;
  assume {:verifier.code 0} true;
