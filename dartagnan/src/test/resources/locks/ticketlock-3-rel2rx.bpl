...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/ticketlock-3-rel2rx.bpl /Users/ponce/git/Dat3M/benchmarks/locks/ticketlock-3-rel2rx.c
  ...
  returns ($r: ref)
{
  ...
  var $p8: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 69, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 69, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 71, 24} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, lock);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 71, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_acquire($p2);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 72, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 72, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i3);
  call {:cexpr "shared"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 73, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 74, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i4);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 74, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i64($i5, $i1);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 74, 14} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i32($i6);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i7);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 75, 24} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.0, lock);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 75, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_release($p8);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 76, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  ticketlock_acquire($p0: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 42, 18} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 42, 18} true;
  assume {:verifier.code 0} true;
  call $i1 := get_next_ticket($p0);
  call {:cexpr "ticket"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 43, 5} true;
  assume {:verifier.code 0} true;
  call await_for_ticket($p0, $i1);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 44, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure  ticketlock_release($p0: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 58, 42} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 58, 42} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 58, 17} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32($p1, 0);
  call {:cexpr "owner"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 59, 31} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 59, 44} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i2, 1);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 59, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_store_explicit.ref.i32.i32($p3, $i4, 0);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 60, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 31, 42} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 31, 42} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 31, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_fetch_add_explicit.ref.i32.i32($p1, 1, 0);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
procedure  await_for_ticket($p0: ref, $i1: i32)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 36, 5} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 36, 37} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 36, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32($p2, 2);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 36, 66} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $i1);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 36, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 85, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 85, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, lock, $p3);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 86, 21} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.0, lock);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 86, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_init($p5);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 88, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 89, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 90, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 92, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure  ticketlock_init($p0: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 25, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 25, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 26, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.i32($p3, 0);
  assume {:sourceloc "benchmarks/locks/ticketlock-3-rel2rx.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
