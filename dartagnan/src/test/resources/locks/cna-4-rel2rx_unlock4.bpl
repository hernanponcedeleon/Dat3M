...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/cna-4-rel2rx_unlock4-O0.bpl /Users/ponce/git/Dat3M/output/cna-4-rel2rx_unlock4_tmp.c
...
$bb20:
  ...
  call $i50 := atomic_store_explicit.ref.i32.i32($p49, 1, 3);
  goto $bb22;
$bb21:
  assume !(($i36 == 1));
  ...
  call $i56 := atomic_store_explicit.ref.i32.i32($p55, 1, 0);
  goto $bb22;
$bb22:
  goto $bb8;
}
