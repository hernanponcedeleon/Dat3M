...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang/ -bpl /Users/ponce/git/Dat3M/output/ticketlock-3.bpl /Users/ponce/git/Dat3M/./benchmarks/locks/ticketlock-3.c
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 70, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 70, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 72, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_acquire(lock);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 73, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 73, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 74, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 76, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 76, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 77, 5} true;
  assume {:verifier.code 0} true;
  call ticketlock_release(lock);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 78, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 87, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 93, 18} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 93, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 94, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p1);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 94, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 95, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p2);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 95, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 97, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 97, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/ticketlock-3.c", 99, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
