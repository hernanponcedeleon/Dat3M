...
define dso_local void @clh_mutex_lock(%struct.clh_mutex_t* noundef %0) #0 !dbg !87 {
  ...
  %9 = load atomic i32, i32* %8 acquire, align 4, !dbg !95
...
!94 = !DILocation(line: 140, column: 53, scope: !87)
!95 = !DILocation(line: 140, column: 25, scope: !87)
!96 = !DILocalVariable(name: "prev_islocked", scope: !87, file: !25, line: 140, type: !31)
