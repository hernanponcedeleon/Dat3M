...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mutex_musl-3-rel2rx_unlock.bpl /Users/ponce/git/Dat3M/benchmarks/locks/mutex_musl-3-rel2rx_unlock.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 42304));
...
const mutex: ref;
axiom (mutex == $sub.ref(0, 1032));
const shared: ref;
axiom (shared == $sub.ref(0, 2060));
const sig: ref;
axiom (sig == $sub.ref(0, 3088));
const assert_: ref;
axiom (assert_ == $sub.ref(0, 4120));
...
axiom (llvm.dbg.declare == $sub.ref(0, 5152));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 6184));
procedure  __VERIFIER_assert($i0: i32);
const thread_n: ref;
axiom (thread_n == $sub.ref(0, 7216));
  ...
  returns ($r: ref)
{
  ...
  var $p8: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 99, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 99, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 101, 16} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 101, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock($p2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 102, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 102, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i3);
  call {:cexpr "shared"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 103, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 104, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i4);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 104, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i64($i5, $i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 104, 14} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i32($i6);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 104, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i7);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 105, 18} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 105, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock($p8);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 106, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (mutex_lock == $sub.ref(0, 8248));
procedure  mutex_lock($p0: ref)
{
  ...
  var $i16: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 67, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 68, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 69, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_thread_fence.i32(0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 71, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 82, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 71, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := mutex_lock_slowpath_check($p0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 71, 41} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 71, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 72, 9} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_thread_fence.i32(0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 73, 39} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 73, 9} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_fetch_add_explicit.ref.i32.i32($p8, 1, 0);
  assume true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 74, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 75, 58} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 75, 14} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p10, $p1, 2, 0, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 75, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 75, 13} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 79, 26} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 79, 9} true;
  assume {:verifier.code 0} true;
  call __futex_wait($p14, 2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 80, 39} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 80, 9} true;
  assume {:verifier.code 0} true;
  call $i16 := atomic_fetch_sub_explicit.ref.i32.i32($p15, 1, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 71, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb9:
  assume !(($i12 == 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 78, 13} true;
  assume {:verifier.code 0} true;
  call $i13 := atomic_thread_fence.i32(0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 78, 13} true;
  assume {:verifier.code 0} true;
  goto $bb8;
}
const mutex_unlock: ref;
axiom (mutex_unlock == $sub.ref(0, 9280));
procedure  mutex_unlock($p0: ref)
{
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 86, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 86, 44} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 86, 15} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_exchange_explicit.ref.i32.i32($p1, 0, 0);
  call {:cexpr "old"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 87, 34} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 87, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_load_explicit.ref.i32($p3, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 87, 65} true;
  assume {:verifier.code 0} true;
  $i5 := $sgt.i32($i4, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 87, 69} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 88, 26} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 88, 9} true;
  assume {:verifier.code 0} true;
  call __futex_wake($p7, 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 88, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 87, 76} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i2, 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 87, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 89, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_exchange_explicit: ref;
axiom (atomic_exchange_explicit == $sub.ref(0, 10312));
procedure  atomic_exchange_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
...
procedure  atomic_load_explicit.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const __futex_wake: ref;
axiom (__futex_wake == $sub.ref(0, 12376));
procedure  __futex_wake($p0: ref, $i1: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__futex_wake:arg:v"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_fetch_add_explicit.ref.i32.i32(sig, 1, 3);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_fetch_add_explicit: ref;
axiom (atomic_fetch_add_explicit == $sub.ref(0, 13408));
procedure  atomic_fetch_add_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const mutex_lock_fastpath: ref;
axiom (mutex_lock_fastpath == $sub.ref(0, 14440));
procedure  mutex_lock_fastpath($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $p2: ref;
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 50, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 51, 56} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 51, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p2, $p1, 1, 2, 2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (atomic_thread_fence == $sub.ref(0, 15472));
procedure  atomic_thread_fence.i32(p.0: i32)
  returns ($r: i32);
const mutex_lock_slowpath_check: ref;
axiom (mutex_lock_slowpath_check == $sub.ref(0, 16504));
procedure  mutex_lock_slowpath_check($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $p2: ref;
  var $i3: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 58, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  assume true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 59, 56} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 59, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p2, $p1, 1, 2, 2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 59, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (atomic_compare_exchange_strong_explicit == $sub.ref(0, 17536));
...
axiom (__futex_wait == $sub.ref(0, 18568));
procedure  __futex_wait($p0: ref, $i1: i32)
{
  var $i2: i32;
  var $i3: i32;
  var $i4: i1;
  ...
  var $i6: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__futex_wait:arg:v"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_load_explicit.ref.i32(sig, 2);
  call {:cexpr "s"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := atomic_load_explicit.ref.i32($p0, 2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 15, 55} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, $i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 16, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := atomic_load_explicit.ref.i32(sig, 2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 18, 61} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, $i2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
axiom (atomic_fetch_sub_explicit == $sub.ref(0, 19600));
procedure  atomic_fetch_sub_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 20632));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 114, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 114, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, mutex, $p3);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 115, 16} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 115, 5} true;
  assume {:verifier.code 0} true;
  call mutex_init($p5);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 117, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 118, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 121, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const malloc: ref;
axiom (malloc == $sub.ref(0, 21664));
procedure  malloc($i0: i64)
  returns ($r: ref)
{
  call $r := $malloc($i0);
}
const mutex_init: ref;
axiom (mutex_init == $sub.ref(0, 22696));
procedure  mutex_init($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
  var $p3: ref;
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 44, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 44, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 44, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_init.ref.i32($p1, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 45, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 45, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_init.ref.i32($p3, 0);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 46, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 23728));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const atomic_init: ref;
axiom (atomic_init == $sub.ref(0, 24760));
procedure  atomic_init.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 25792));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 26824));
...
axiom (__SMACK_dummy == $sub.ref(0, 27856));
...
axiom (__SMACK_and32 == $sub.ref(0, 28888));
...
axiom (__SMACK_and64 == $sub.ref(0, 29920));
...
axiom (__SMACK_and16 == $sub.ref(0, 30952));
...
axiom (__SMACK_and8 == $sub.ref(0, 31984));
...
axiom (__SMACK_or32 == $sub.ref(0, 33016));
...
axiom (__SMACK_or64 == $sub.ref(0, 34048));
...
axiom (__SMACK_or16 == $sub.ref(0, 35080));
...
axiom (__SMACK_or8 == $sub.ref(0, 36112));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 37144));
...
axiom (__SMACK_decls == $sub.ref(0, 38176));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 39208));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 40240));
...
axiom (llvm.dbg.value == $sub.ref(0, 41272));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 42304));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.ref($M.0, mutex, $0.ref);
