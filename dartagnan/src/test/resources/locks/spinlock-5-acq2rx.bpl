...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/spinlock-5-acq2rx.bpl /Users/ponce/git/Dat3M/benchmarks/locks/spinlock-5-acq2rx.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 35080));
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 68, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 68, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 70, 5} true;
  assume {:verifier.code 0} true;
  call spinlock_acquire(lock);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 71, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 71, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 72, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 73, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 73, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i64($i4, $i1);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 73, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 73, 5} true;
  assume {:verifier.code 0} true;
  call assert_($i6);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call spinlock_release(lock);
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 75, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (spinlock_acquire == $sub.ref(0, 7216));
...
axiom (spinlock_release == $sub.ref(0, 8248));
...
axiom (await_for_lock == $sub.ref(0, 10312));
...
axiom (try_get_lock == $sub.ref(0, 11344));
...
axiom (atomic_compare_exchange_strong_explicit == $sub.ref(0, 12376));
...
axiom (atomic_load_explicit == $sub.ref(0, 13408));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 84, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/spinlock-5-acq2rx.c", 85, 5} true;
  assume {:verifier.code 0} true;
...
axiom (spinlock_init == $sub.ref(0, 15472));
...
axiom (__SMACK_and32 == $sub.ref(0, 21664));
...
axiom (__SMACK_and64 == $sub.ref(0, 22696));
...
axiom (__SMACK_and16 == $sub.ref(0, 23728));
...
axiom (__SMACK_and8 == $sub.ref(0, 24760));
...
axiom (__SMACK_or32 == $sub.ref(0, 25792));
...
axiom (__SMACK_or64 == $sub.ref(0, 26824));
...
axiom (__SMACK_or16 == $sub.ref(0, 27856));
...
axiom (__SMACK_or8 == $sub.ref(0, 28888));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 29920));
...
axiom (__SMACK_decls == $sub.ref(0, 30952));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 31984));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 33016));
...
axiom (llvm.dbg.value == $sub.ref(0, 34048));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 35080));
