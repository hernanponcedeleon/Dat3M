...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang/ -bpl /Users/ponce/git/Dat3M/output/mutex_musl-3-rel2rx_unlock.bpl /Users/ponce/git/Dat3M/./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 97, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 97, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 99, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock(mutex);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 100, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 100, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 101, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 102, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 102, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 103, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 103, 8} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 70, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 79, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 70, 12} true;
  assume {:verifier.code 0} true;
  call $i4 := mutex_lock_slowpath_check($p0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 70, 41} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 70, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 71, 39} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 71, 9} true;
  assume {:verifier.code 0} true;
  call $i7 := atomic_fetch_add_explicit.ref.i32.i32($p6, 1, 0);
  assume true;
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 72, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 73, 58} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 73, 14} true;
  assume {:verifier.code 0} true;
  call $i9 := atomic_compare_exchange_strong_explicit.ref.ref.i32.i32.i32($p8, $p1, 2, 0, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 73, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 73, 13} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 77, 39} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 77, 9} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume !(($i10 == 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 76, 26} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 76, 9} true;
  assume {:verifier.code 0} true;
...
procedure  mutex_unlock($p0: ref)
{
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 83, 44} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 83, 44} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 83, 15} true;
  assume {:verifier.code 0} true;
  call $i2 := atomic_exchange_explicit.ref.i32.i32($p1, 0, 0);
  call {:cexpr "old"} boogie_si_record_i32($i2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 84, 34} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 84, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := atomic_load_explicit.ref.i32($p3, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 84, 65} true;
  assume {:verifier.code 0} true;
  $i5 := $sgt.i32($i4, 0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 84, 69} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb3;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 85, 26} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 85, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 84, 76} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i2, 1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 84, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 86, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 113, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, thread_n, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 116, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, thread_n, $i2p.i64.ref(1));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 117, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, thread_n, $i2p.i64.ref(2));
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 119, 18} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 120, 18} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p1);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 120, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 121, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p2);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 121, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 123, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 123, 5} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, sum);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 123, 5} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 3);
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 123, 5} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "./benchmarks/locks/mutex_musl-3-rel2rx_unlock.c", 125, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
