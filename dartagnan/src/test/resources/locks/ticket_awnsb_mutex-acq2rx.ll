...
define dso_local void @ticket_awnsb_mutex_lock(%struct.ticket_awnsb_mutex_t* noundef %0) #0 !dbg !112 {
  ...
  %5 = load atomic i32, i32* %4 monotonic, align 4, !dbg !121
...
!119 = !DILocation(line: 183, column: 37, scope: !120)
!120 = distinct !DILexicalBlock(scope: !112, file: !20, line: 183, column: 9)
!121 = !DILocation(line: 183, column: 9, scope: !120)
!122 = !DILocation(line: 183, column: 67, scope: !120)
!123 = !DILocation(line: 183, column: 9, scope: !112)
