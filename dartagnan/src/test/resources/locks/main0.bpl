...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack  -bpl /Users/ponce/git/Dat3M/output/main0.bpl /Users/ponce/git/Dat3M/../genmc/tests/correct/data-structures/ms-queue/variants/main0.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54916));
...
const {:allocSize 4} readers: ref;
axiom (readers == $sub.ref(0, 1028));
const {:allocSize 4} writers: ref;
axiom (writers == $sub.ref(0, 2056));
const {:allocSize 4} rdwr: ref;
axiom (rdwr == $sub.ref(0, 3084));
const {:allocSize 4} tid: ref;
axiom (tid == $sub.ref(0, 4112));
const {:allocSize 128} {:count 32} input: ref;
axiom (input == $sub.ref(0, 5264));
const {:allocSize 128} {:count 32} output: ref;
axiom (output == $sub.ref(0, 6416));
const {:allocSize 32} {:count 32} succ: ref;
axiom (succ == $sub.ref(0, 7472));
const {:allocSize 272} myqueue: ref;
axiom (myqueue == $sub.ref(0, 8768));
const {:allocSize 128} {:count 32} param: ref;
axiom (param == $sub.ref(0, 9920));
const {:allocSize 128} {:count 32} threads: ref;
axiom (threads == $sub.ref(0, 11072));
const {:allocSize 512} {:count 32} free_lists: ref;
axiom (free_lists == $sub.ref(0, 12608));
const {:allocSize 8} queue: ref;
axiom (queue == $sub.ref(0, 13640));
const {:allocSize 4} num_threads: ref;
axiom (num_threads == $sub.ref(0, 14668));
const init_queue: ref;
axiom (init_queue == $sub.ref(0, 15700));
procedure  init_queue($p0: ref, $i1: i32)
{
  var $i2: i32;
  var $i3: i1;
  var $i4: i32;
  ...
  var $i32: i32;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 75, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "init_queue:arg:num_threads"} boogie_si_record_i32($i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 75, 7} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 75, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, $i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 75, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 76, 8} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 83, 18} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(0, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 83, 2} true;
  assume {:verifier.code 0} true;
  call $i26 := atomic_init.ref.i64($p25, 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 84, 18} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 84, 2} true;
  assume {:verifier.code 0} true;
  call $i28 := atomic_init.ref.i64($p27, 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 85, 18} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  $p30 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(1, 16));
  $p31 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(1, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 85, 2} true;
  assume {:verifier.code 0} true;
  call $i32 := atomic_init.ref.i64($p31, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 86, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 76, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, 2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 76, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 77, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i2, 4);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 77, 25} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32(2, $i6);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 77, 44} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i7, $i4);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 77, 4} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 77, 4} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i9, 16));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 77, 4} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i32.i64($i4);
  $p12 := $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i9, 16)), $mul.ref($i11, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 77, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p12, $i8);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 78, 20} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 78, 26} true;
  assume {:verifier.code 0} true;
  $i14 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 78, 26} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i14, 16));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 78, 26} true;
  assume {:verifier.code 0} true;
  $i16 := $sext.i32.i64($i4);
  $p17 := $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i14, 16)), $mul.ref($i16, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 78, 26} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i32($M.0, $p17);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 78, 17} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i32.i64($i18);
  $p20 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i19, 16));
  $p21 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i19, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 78, 4} true;
  assume {:verifier.code 0} true;
  call $i22 := atomic_init.ref.i64($p21, 1638);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 79, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 80, 2} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 76, 34} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i4, 1);
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 75, 32} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i2, 1);
...
axiom (llvm.dbg.declare == $sub.ref(0, 16732));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const atomic_init: ref;
axiom (atomic_init == $sub.ref(0, 17764));
procedure  atomic_init.ref.i64(p.0: ref, p.1: i64)
  returns ($r: i32);
const enqueue: ref;
axiom (enqueue == $sub.ref(0, 18796));
procedure  enqueue($p0: ref, $i1: i32)
{
  var $p2: ref;
  var $p3: ref;
  var $p4: ref;
  ...
  var $i90: i32;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 96, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "enqueue:arg:val"} boogie_si_record_i32($i1);
  assume true;
  assume true;
  assume true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 96, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := new_node();
  call {:cexpr "node"} boogie_si_record_i32($i5);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 97, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 97, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i32.i64($i5);
  $p8 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i7, 16));
  $p9 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i7, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 97, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p9, $i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 98, 33} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 98, 30} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i32.i64($i5);
  $p12 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i11, 16));
  $p13 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i11, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 98, 8} true;
  assume {:verifier.code 0} true;
  call $i14 := atomic_load_explicit.ref.i32($p13, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 98, 8} true;
  assume {:verifier.code 0} true;
  $i15 := $sext.i32.i64($i14);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 98, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p4, $i15);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 99, 2} true;
  assume {:verifier.code 0} true;
  call set_ptr($p4, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 100, 28} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 100, 25} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64($i5);
  $p18 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i17, 16));
  $p19 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i17, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 100, 46} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i64($M.0, $p4);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 100, 2} true;
  assume {:verifier.code 0} true;
  call $i21 := atomic_store_explicit.ref.i64.i32($p19, $i20, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 102, 2} true;
  assume {:verifier.code 0} true;
  $i22 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 102, 9} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i22, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 102, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i24 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 103, 35} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 103, 10} true;
  assume {:verifier.code 0} true;
  call $i26 := atomic_load_explicit.ref.i32($p25, 2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 103, 10} true;
  assume {:verifier.code 0} true;
  $i27 := $sext.i32.i64($i26);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 103, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p2, $i27);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 104, 35} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 104, 49} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 104, 41} true;
  assume {:verifier.code 0} true;
  call $i30 := get_ptr($i29);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 104, 32} true;
  assume {:verifier.code 0} true;
  $i31 := $zext.i32.i64($i30);
  $p32 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i31, 16));
  $p33 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i31, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 104, 10} true;
  assume {:verifier.code 0} true;
  call $i34 := atomic_load_explicit.ref.i32($p33, 2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 104, 10} true;
  assume {:verifier.code 0} true;
  $i35 := $sext.i32.i64($i34);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 104, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p3, $i35);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 105, 7} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 105, 40} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 105, 15} true;
  assume {:verifier.code 0} true;
  call $i38 := atomic_load_explicit.ref.i32($p37, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 105, 15} true;
  assume {:verifier.code 0} true;
  $i39 := $sext.i32.i64($i38);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 105, 12} true;
  assume {:verifier.code 0} true;
  $i40 := $eq.i64($i36, $i39);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 105, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i24 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 126, 46} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 128, 4} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 128, 4} true;
  assume {:verifier.code 0} true;
  call $i84 := get_count($i83);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 128, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 128, 4} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:128:4: SMACK warning: overapproximating bitwise operation shl (can lead to false alarms); */
  $i87 := $shl.i64($i86, 32);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 128, 4} true;
  assume {:verifier.code 0} true;
  $i88 := $zext.i32.i64($i5);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 128, 4} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:128:4: SMACK warning: overapproximating bitwise operation or (can lead to false alarms); */
  $i89 := $or.i64($i87, $i88);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 126, 2} true;
  assume {:verifier.code 0} true;
  call $i90 := atomic_compare_exchange_strong_explicit.ref.ref.i64.i32.i32($p82, $p2, $i89, 3, 3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 130, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume ($i40 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 108, 4} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb5:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 105, 7} true;
...
$bb10:
  ...
  goto $bb9;
$bb11:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 110, 16} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i64($M.0, $p3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 110, 8} true;
  assume {:verifier.code 0} true;
  call $i46 := get_ptr($i45);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 110, 22} true;
  assume {:verifier.code 0} true;
  $i47 := $eq.i32($i46, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 110, 8} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i47 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 111, 21} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i64($M.0, $p3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 111, 21} true;
  assume {:verifier.code 0} true;
  call $i50 := get_count($i49);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 111, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 111, 21} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:111:21: SMACK warning: overapproximating bitwise operation shl (can lead to false alarms); */
  $i53 := $shl.i64($i52, 32);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 111, 21} true;
  assume {:verifier.code 0} true;
  $i54 := $zext.i32.i64($i5);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 111, 21} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:111:21: SMACK warning: overapproximating bitwise operation or (can lead to false alarms); */
  $i55 := $or.i64($i53, $i54);
  call {:cexpr "value"} boogie_si_record_i64($i55);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 112, 59} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 112, 73} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 112, 65} true;
  assume {:verifier.code 0} true;
  call $i58 := get_ptr($i57);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 112, 56} true;
  assume {:verifier.code 0} true;
  $i59 := $zext.i32.i64($i58);
  $p60 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i59, 16));
  $p61 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i59, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 112, 15} true;
  assume {:verifier.code 0} true;
  call $i62 := atomic_compare_exchange_strong_explicit.ref.ref.i64.i32.i32($p61, $p3, $i55, 3, 3);
  call {:cexpr "success"} boogie_si_record_i32($i62);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 114, 4} true;
  assume {:verifier.code 0} true;
  $i48 := $i62;
  goto $bb14;
$bb13:
...
$bb14:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 115, 9} true;
  assume {:verifier.code 0} true;
  $i63 := $ne.i32($i48, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 115, 8} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 124, 3} true;
  assume {:verifier.code 0} true;
  $i41 := $i48;
  goto $bb6;
$bb17:
  assume !(($i63 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 116, 57} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 116, 71} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 116, 63} true;
  assume {:verifier.code 0} true;
  call $i66 := get_ptr($i65);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 116, 54} true;
  assume {:verifier.code 0} true;
  $i67 := $zext.i32.i64($i66);
  $p68 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i67, 16));
  $p69 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i67, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 116, 32} true;
  assume {:verifier.code 0} true;
  call $i70 := atomic_load_explicit.ref.i32($p69, 2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 116, 32} true;
  assume {:verifier.code 0} true;
  $i71 := $sext.i32.i64($i70);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 116, 24} true;
  assume {:verifier.code 0} true;
  call $i72 := get_ptr($i71);
  call {:cexpr "ptr"} boogie_si_record_i32($i72);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 117, 21} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 117, 21} true;
  assume {:verifier.code 0} true;
  call $i74 := get_count($i73);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 117, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 117, 21} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:117:21: SMACK warning: overapproximating bitwise operation shl (can lead to false alarms); */
  $i77 := $shl.i64($i76, 32);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 117, 21} true;
  assume {:verifier.code 0} true;
  $i78 := $zext.i32.i64($i72);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 117, 21} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:117:21: SMACK warning: overapproximating bitwise operation or (can lead to false alarms); */
  $i79 := $or.i64($i77, $i78);
  call {:cexpr "value"} boogie_si_record_i64($i79);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 119, 49} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call $i81 := atomic_compare_exchange_strong_explicit.ref.ref.i64.i32.i32($p80, $p2, $i79, 3, 3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 123, 4} true;
  assume {:verifier.code 0} true;
  goto $bb16;
}
const new_node: ref;
axiom (new_node == $sub.ref(0, 19828));
procedure  new_node()
  returns ($r: i32)
{
  var $i0: i32;
  ...
  var $i13: i32;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 33, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 33, 10} true;
  assume {:verifier.code 0} true;
  call $i0 := get_thread_num();
  call {:cexpr "t"} boogie_si_record_i32($i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 34, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 34, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 4);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 34, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 35, 23} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 35, 23} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i3, 16));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 35, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i1);
  $p6 := $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i3, 16)), $mul.ref($i5, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 35, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  call {:cexpr "node"} boogie_si_record_i32($i7);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 36, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 36, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 42, 2} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb4:
  assume ($i8 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 37, 4} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 37, 4} true;
  assume {:verifier.code 0} true;
  ...
  $i11 := $sext.i32.i64($i1);
  $p12 := $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i9, 16)), $mul.ref($i11, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 37, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p12, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 38, 4} true;
  assume {:verifier.code 0} true;
  $i13 := $i7;
  goto $bb6;
$bb5:
  assume !(($i8 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 40, 2} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 44, 1} true;
  assume {:verifier.code 0} true;
  $r := $i13;
  $exn := false;
  return;
$bb7:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 34, 33} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i1, 1);
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 43, 2} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
  goto $bb6;
}
const atomic_load_explicit: ref;
axiom (atomic_load_explicit == $sub.ref(0, 20860));
procedure  atomic_load_explicit.ref.i32(p.0: ref, p.1: i32)
  returns ($r: i32);
const set_ptr: ref;
axiom (set_ptr == $sub.ref(0, 21892));
procedure  set_ptr($p0: ref, $i1: i32)
{
  var $i2: i64;
  var $i3: i64;
  var $i4: i64;
  var $i5: i64;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 11, 66} true;
  assume {:verifier.code 0} true;
  call {:cexpr "set_ptr:arg:val"} boogie_si_record_i32($i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 11, 66} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, $p0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 11, 69} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h:11:69: SMACK warning: overapproximating bitwise operation and (can lead to false alarms); */
  $i3 := $and.i64($i2, 18446744069414584320);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 11, 84} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 11, 82} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h:11:82: SMACK warning: overapproximating bitwise operation or (can lead to false alarms); */
  $i5 := $or.i64($i3, $i4);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 11, 63} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p0, $i5);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 11, 89} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const atomic_store_explicit: ref;
axiom (atomic_store_explicit == $sub.ref(0, 22924));
procedure  atomic_store_explicit.ref.i64.i32(p.0: ref, p.1: i64, p.2: i32)
  returns ($r: i32);
const get_ptr: ref;
axiom (get_ptr == $sub.ref(0, 23956));
procedure  get_ptr($i0: i64)
  returns ($r: i32)
{
  var $i1: i64;
  var $i2: i32;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 13, 58} true;
  assume {:verifier.code 0} true;
  call {:cexpr "get_ptr:arg:p"} boogie_si_record_i64($i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 13, 58} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h:13:58: SMACK warning: overapproximating bitwise operation and (can lead to false alarms); */
  $i1 := $and.i64($i0, 4294967295);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 13, 56} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 13, 49} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
const get_count: ref;
axiom (get_count == $sub.ref(0, 24988));
procedure  get_count($i0: i64)
  returns ($r: i32)
{
  var $i1: i64;
  var $i2: i64;
  var $i3: i32;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 12, 61} true;
  assume {:verifier.code 0} true;
  call {:cexpr "get_count:arg:p"} boogie_si_record_i64($i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 12, 61} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h:12:61: SMACK warning: overapproximating bitwise operation and (can lead to false alarms); */
  $i1 := $and.i64($i0, 18446744069414584320);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 12, 75} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h:12:75: SMACK warning: overapproximating bitwise operation lshr (can lead to false alarms); */
  $i2 := $lshr.i64($i1, 32);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 12, 58} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i64.i32($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.h", 12, 51} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (atomic_compare_exchange_strong_explicit == $sub.ref(0, 26020));
procedure  atomic_compare_exchange_strong_explicit.ref.ref.i64.i32.i32(p.0: ref, p.1: ref, p.2: i64, p.3: i32, p.4: i32)
  returns ($r: i32);
const get_thread_num: ref;
axiom (get_thread_num == $sub.ref(0, 27052));
procedure  get_thread_num()
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 45, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 45, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, tid);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
const dequeue: ref;
axiom (dequeue == $sub.ref(0, 28084));
procedure  dequeue($p0: ref, $p1: ref)
  returns ($r: i1)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i36: i1;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 139, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(8, $zext.i32.i64(1)));
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 134, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 139, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 139, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 140, 35} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(0, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 140, 10} true;
  assume {:verifier.code 0} true;
  call $i8 := atomic_load_explicit.ref.i32($p7, 2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 140, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i8);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 140, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p2, $i9);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 141, 35} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 141, 10} true;
  assume {:verifier.code 0} true;
  call $i11 := atomic_load_explicit.ref.i32($p10, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 141, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $sext.i32.i64($i11);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 141, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p3, $i12);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 142, 35} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 142, 49} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 142, 41} true;
  assume {:verifier.code 0} true;
  call $i15 := get_ptr($i14);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 142, 32} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i32.i64($i15);
  $p17 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i16, 16));
  $p18 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i16, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 142, 10} true;
  assume {:verifier.code 0} true;
  call $i19 := atomic_load_explicit.ref.i32($p18, 2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 142, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $sext.i32.i64($i19);
  call {:cexpr "next"} boogie_si_record_i64($i20);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 143, 32} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(0, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 143, 7} true;
  assume {:verifier.code 0} true;
  call $i22 := atomic_load_explicit.ref.i32($p21, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $sext.i32.i64($i22);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 143, 50} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 143, 47} true;
  assume {:verifier.code 0} true;
  $i25 := $eq.i64($i23, $i24);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 143, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i6 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 169, 18} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 169, 10} true;
  assume {:verifier.code 0} true;
  call $i65 := get_ptr($i64);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 169, 2} true;
  assume {:verifier.code 0} true;
  call reclaim($i65);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 170, 2} true;
  assume {:verifier.code 0} true;
  $i36 := 1;
  goto $bb16;
$bb4:
  assume ($i25 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 144, 16} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 144, 8} true;
  assume {:verifier.code 0} true;
  call $i28 := get_ptr($i27);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 144, 33} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i64($M.0, $p3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 144, 25} true;
  assume {:verifier.code 0} true;
  call $i30 := get_ptr($i29);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 144, 22} true;
  assume {:verifier.code 0} true;
  $i31 := $eq.i32($i28, $i30);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 144, 8} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i31 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 147, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !(($i31 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 158, 18} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 158, 24} true;
  assume {:verifier.code 0} true;
  call $i49 := get_ptr($i20);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 158, 15} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i32.i64($i49);
  $p51 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i50, 16));
  $p52 := $add.ref($add.ref($add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref($i50, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 158, 39} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i32($M.0, $p52);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 158, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, $i53);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 159, 59} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(0, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 161, 7} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i64($M.0, $p2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 161, 7} true;
  assume {:verifier.code 0} true;
  call $i56 := get_count($i55);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 161, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 161, 7} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:161:7: SMACK warning: overapproximating bitwise operation shl (can lead to false alarms); */
  $i59 := $shl.i64($i58, 32);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 161, 7} true;
  assume {:verifier.code 0} true;
  call $i60 := get_ptr($i20);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 161, 7} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i32.i64($i60);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 161, 7} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:161:7: SMACK warning: overapproximating bitwise operation or (can lead to false alarms); */
  $i62 := $or.i64($i59, $i61);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 159, 15} true;
  assume {:verifier.code 0} true;
  call $i63 := atomic_compare_exchange_strong_explicit.ref.ref.i64.i32.i32($p54, $p2, $i62, 3, 3);
  call {:cexpr "success"} boogie_si_record_i32($i63);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 163, 5} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i63);
  assume {:verifier.code 0} true;
  $i47 := $i63;
  goto $bb17;
$bb9:
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 149, 9} true;
  assume {:verifier.code 0} true;
  call $i34 := get_ptr($i20);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 149, 23} true;
  assume {:verifier.code 0} true;
  $i35 := $eq.i32($i34, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 149, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume ($i35 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 150, 6} true;
  assume {:verifier.code 0} true;
  $i36 := 0;
  goto $bb16;
$bb15:
  assume !(($i35 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 152, 49} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p0, $mul.ref(0, 272)), $mul.ref(8, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 154, 7} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i64($M.0, $p3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 154, 7} true;
  assume {:verifier.code 0} true;
  call $i39 := get_count($i38);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 154, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 154, 7} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:154:7: SMACK warning: overapproximating bitwise operation shl (can lead to false alarms); */
  $i42 := $shl.i64($i41, 32);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 154, 7} true;
  assume {:verifier.code 0} true;
  call $i43 := get_ptr($i20);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 154, 7} true;
  assume {:verifier.code 0} true;
  $i44 := $zext.i32.i64($i43);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 154, 7} true;
  assume {:verifier.code 0} true;
  /* ../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c:154:7: SMACK warning: overapproximating bitwise operation or (can lead to false alarms); */
  $i45 := $or.i64($i42, $i44);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 152, 5} true;
  assume {:verifier.code 0} true;
  call $i46 := atomic_compare_exchange_strong_explicit.ref.ref.i64.i32.i32($p37, $p3, $i45, 3, 3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 157, 4} true;
  assume {:verifier.code 0} true;
  $i47 := $i4;
  goto $bb17;
$bb16:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 171, 1} true;
  assume {:verifier.code 0} true;
  $r := $i36;
  $exn := false;
  return;
$bb17:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 167, 3} true;
  assume {:verifier.code 0} true;
  $i26 := $i47;
  goto $bb6;
}
const reclaim: ref;
axiom (reclaim == $sub.ref(0, 29116));
procedure  reclaim($i0: i32)
{
  var $i1: i32;
  var $i2: i1;
  var $i3: i32;
  ...
  var $i15: i32;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 50, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "reclaim:arg:node"} boogie_si_record_i32($i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 50, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := get_thread_num();
  call {:cexpr "t"} boogie_si_record_i32($i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 53, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 53, 2} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 55, 7} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb6;
$bb6:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 55, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, 4);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 55, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb7, $bb8;
$bb7:
  assume ($i4 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 57, 22} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 57, 22} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i5, 16));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 57, 22} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i3);
  $p8 := $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i5, 16)), $mul.ref($i7, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 57, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p8);
  call {:cexpr "idx"} boogie_si_record_i32($i9);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 60, 11} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 60, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb9, $bb10;
$bb8:
  assume !(($i4 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 66, 2} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb9:
  assume ($i10 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 61, 4} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i32.i64($i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 61, 4} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i11, 16));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 61, 4} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.i32.i64($i3);
  $p14 := $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref($i11, 16)), $mul.ref($i13, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 61, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p14, $i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 62, 4} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume !(($i10 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 64, 2} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 67, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb12:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../my_queue.c", 55, 33} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i3, 1);
...
const set_thread_num: ref;
axiom (set_thread_num == $sub.ref(0, 30148));
procedure  set_thread_num($i0: i32)
{
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 40, 6} true;
  assume {:verifier.code 0} true;
  call {:cexpr "set_thread_num:arg:i"} boogie_si_record_i32($i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 40, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, tid, $i0);
  call {:cexpr "tid"} boogie_si_record_i32($i0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 41, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const threadW: ref;
axiom (threadW == $sub.ref(0, 31180));
  ...
  returns ($r: ref)
{
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 53, 14} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 53, 14} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 53, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  call {:cexpr "pid"} boogie_si_record_i32($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 55, 2} true;
  assume {:verifier.code 0} true;
  call set_thread_num($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 57, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $mul.i32($i2, 10);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 57, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 57, 2} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref($i4, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 57, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, $i3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 58, 10} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.0, queue);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 58, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 58, 17} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref($i7, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 58, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p8);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 58, 2} true;
  assume {:verifier.code 0} true;
  call enqueue($p6, $i9);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 61, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i9: i8;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 67, 14} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 67, 14} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 67, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  call {:cexpr "pid"} boogie_si_record_i32($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 69, 2} true;
  assume {:verifier.code 0} true;
  call set_thread_num($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 73, 22} true;
  assume {:verifier.code 0} true;
  $p3 := $load.ref($M.0, queue);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 73, 30} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(output, $mul.ref(0, 128)), $mul.ref($i4, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 73, 14} true;
  assume {:verifier.code 0} true;
  call $i6 := dequeue($p3, $p5);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 73, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 73, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(succ, $mul.ref(0, 32)), $mul.ref($i7, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 73, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i8($i6);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 73, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p8, $i9);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 75, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const threadRW: ref;
axiom (threadRW == $sub.ref(0, 33244));
  ...
  returns ($r: ref)
{
  ...
  var $i16: i8;
$bb0:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 81, 14} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 81, 14} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 81, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  call {:cexpr "pid"} boogie_si_record_i32($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 83, 2} true;
  assume {:verifier.code 0} true;
  call set_thread_num($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 85, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $mul.i32($i2, 10);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 85, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 85, 2} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref($i4, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 85, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, $i3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 86, 10} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.0, queue);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 86, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 86, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p8);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 86, 2} true;
  assume {:verifier.code 0} true;
  call enqueue($p6, $i9);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 87, 22} true;
  assume {:verifier.code 0} true;
  $p10 := $load.ref($M.0, queue);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 87, 30} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 87, 30} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref(output, $mul.ref(0, 128)), $mul.ref($i11, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 87, 14} true;
  assume {:verifier.code 0} true;
  call $i13 := dequeue($p10, $p12);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 87, 2} true;
  assume {:verifier.code 0} true;
  $i14 := $sext.i32.i64($i2);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 87, 2} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref(succ, $mul.ref(0, 32)), $mul.ref($i14, 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 87, 12} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i8($i13);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 87, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p15, $i16);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/../main.c", 89, 2} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 15, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, queue, myqueue);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 16, 16} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, readers);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, writers);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 16, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, $i1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 16, 36} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, rdwr);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 16, 34} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i2, $i3);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 16, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, num_threads, $i4);
  call {:cexpr "num_threads"} boogie_si_record_i32($i4);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 18, 13} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.0, queue);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 18, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, num_threads);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 18, 2} true;
  assume {:verifier.code 0} true;
  call init_queue($p5, $i6);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 19, 7} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 19, 22} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, num_threads);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 19, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.i32($i7, $i8);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 19, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i9 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i7);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref(param, $mul.ref(0, 128)), $mul.ref($i10, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 20, 12} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i9 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i13, $i14 := 0, 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 19, 36} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i7, 1);
...
$bb5:
  ...
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 21, 22} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, writers);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 21, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.i32($i13, $i15);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 21, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i16 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 22, 19} true;
  assume {:verifier.code 0} true;
  $i17 := $sext.i32.i64($i14);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 22, 19} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref(threads, $mul.ref(0, 128)), $mul.ref($i17, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 22, 47} true;
  assume {:verifier.code 0} true;
  $i19 := $sext.i32.i64($i14);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 22, 47} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref(param, $mul.ref(0, 128)), $mul.ref($i19, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 22, 46} true;
  assume {:verifier.code 0} true;
  $p21 := $bitcast.ref.ref($p20);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i22 := pthread_create($p18, $0.ref, threadW, $p21);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !(($i16 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 23, 7} true;
  assume {:verifier.code 0} true;
  $i25, $i26 := 0, $i14;
  goto $bb9;
$bb8:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 21, 32} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i13, 1);
  call {:cexpr "j"} boogie_si_record_i32($i23);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 21, 37} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i14, 1);
  call {:cexpr "i"} boogie_si_record_i32($i24);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 21, 2} true;
...
$bb9:
  ...
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 23, 22} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, readers);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 23, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $slt.i32($i25, $i27);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 23, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i28 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 24, 19} true;
  assume {:verifier.code 0} true;
  $i29 := $sext.i32.i64($i26);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 24, 19} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref(threads, $mul.ref(0, 128)), $mul.ref($i29, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 24, 47} true;
  assume {:verifier.code 0} true;
  $i31 := $sext.i32.i64($i26);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 24, 47} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref(param, $mul.ref(0, 128)), $mul.ref($i31, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 24, 46} true;
  assume {:verifier.code 0} true;
  $p33 := $bitcast.ref.ref($p32);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i34 := pthread_create($p30, $0.ref, threadR, $p33);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !(($i28 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 25, 7} true;
  assume {:verifier.code 0} true;
  $i37, $i38 := $i26, 0;
  goto $bb13;
$bb12:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 23, 32} true;
  assume {:verifier.code 0} true;
  $i35 := $add.i32($i25, 1);
  call {:cexpr "j"} boogie_si_record_i32($i35);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 23, 37} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i26, 1);
...
$bb13:
  ...
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 25, 22} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i32($M.0, rdwr);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 25, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $slt.i32($i38, $i39);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 25, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb14, $bb15;
$bb14:
  assume ($i40 == 1);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 26, 19} true;
  assume {:verifier.code 0} true;
  $i41 := $sext.i32.i64($i37);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 26, 19} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref(threads, $mul.ref(0, 128)), $mul.ref($i41, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 26, 48} true;
  assume {:verifier.code 0} true;
  $i43 := $sext.i32.i64($i37);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 26, 48} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($add.ref(param, $mul.ref(0, 128)), $mul.ref($i43, 4));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 26, 47} true;
  assume {:verifier.code 0} true;
  $p45 := $bitcast.ref.ref($p44);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i46 := pthread_create($p42, $0.ref, threadRW, $p45);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb15:
  assume !(($i40 == 1));
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 46, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb16:
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 25, 29} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i32($i38, 1);
  call {:cexpr "j"} boogie_si_record_i32($i47);
  assume {:sourceloc "../genmc/tests/correct/data-structures/ms-queue/variants/main0.c", 25, 34} true;
  assume {:verifier.code 0} true;
  $i48 := $add.i32($i37, 1);
...
axiom (pthread_create == $sub.ref(0, 35308));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 36340));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 37372));
...
axiom (__SMACK_dummy == $sub.ref(0, 38404));
...
axiom (__VERIFIER_assert == $sub.ref(0, 39436));
...
axiom (__SMACK_and32 == $sub.ref(0, 40468));
...
axiom (__SMACK_and64 == $sub.ref(0, 41500));
...
axiom (__SMACK_and16 == $sub.ref(0, 42532));
...
axiom (__SMACK_and8 == $sub.ref(0, 43564));
...
axiom (__SMACK_or32 == $sub.ref(0, 44596));
...
axiom (__SMACK_or64 == $sub.ref(0, 45628));
...
axiom (__SMACK_or16 == $sub.ref(0, 46660));
...
axiom (__SMACK_or8 == $sub.ref(0, 47692));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 48724));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 49756));
...
axiom (__SMACK_decls == $sub.ref(0, 50788));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 51820));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 52852));
...
axiom (llvm.dbg.value == $sub.ref(0, 53884));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54916));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, readers, 1);
  call {:cexpr "readers"} boogie_si_record_i32(1);
  $M.0 := $store.i32($M.0, writers, 1);
  call {:cexpr "writers"} boogie_si_record_i32(1);
  $M.0 := $store.i32($M.0, rdwr, 0);
  call {:cexpr "rdwr"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, tid, 0);
  call {:cexpr "tid"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, input, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(4, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(5, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(6, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(7, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(8, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(9, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(10, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(11, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(12, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(13, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(14, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(15, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(16, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(17, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(18, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(19, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(20, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(21, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(22, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(23, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(24, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(25, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(26, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(27, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(28, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(29, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(30, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(input, $mul.ref(0, 128)), $mul.ref(31, 4)), 0);
  $M.0 := $store.i64($M.0, myqueue, 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(0, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(0, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(1, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(1, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(2, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(2, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(3, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(3, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(4, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(4, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(5, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(5, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(6, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(6, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(7, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(7, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(8, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(8, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(9, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(9, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(10, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(10, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(11, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(11, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(12, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(12, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(13, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(13, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(14, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(14, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(15, 16)), $mul.ref(0, 1)), 0);
  $M.0 := $store.i64($M.0, $add.ref($add.ref($add.ref($add.ref(myqueue, $mul.ref(0, 272)), $mul.ref(16, 1)), $mul.ref(15, 16)), $mul.ref(8, 1)), 0);
  $M.0 := $store.i32($M.0, free_lists, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(0, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(0, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(0, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(1, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(1, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(1, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(1, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(2, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(2, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(2, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(2, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(3, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(3, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(3, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(3, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(4, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(4, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(4, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(4, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(5, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(5, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(5, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(5, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(6, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(6, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(6, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(6, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(7, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(7, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(7, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(7, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(8, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(8, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(8, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(8, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(9, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(9, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(9, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(9, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(10, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(10, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(10, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(10, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(11, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(11, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(11, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(11, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(12, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(12, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(12, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(12, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(13, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(13, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(13, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(13, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(14, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(14, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(14, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(14, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(15, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(15, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(15, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(15, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(16, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(16, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(16, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(16, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(17, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(17, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(17, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(17, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(18, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(18, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(18, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(18, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(19, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(19, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(19, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(19, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(20, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(20, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(20, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(20, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(21, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(21, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(21, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(21, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(22, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(22, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(22, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(22, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(23, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(23, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(23, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(23, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(24, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(24, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(24, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(24, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(25, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(25, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(25, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(25, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(26, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(26, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(26, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(26, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(27, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(27, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(27, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(27, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(28, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(28, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(28, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(28, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(29, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(29, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(29, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(29, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(30, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(30, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(30, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(30, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(31, 16)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(31, 16)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(31, 16)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(free_lists, $mul.ref(0, 512)), $mul.ref(31, 16)), $mul.ref(3, 4)), 0);
  $M.0 := $store.ref($M.0, queue, $0.ref);
  $M.0 := $store.i32($M.0, num_threads, 0);
  call {:cexpr "num_threads"} boogie_si_record_i32(0);
  $exn := false;
  return;
}
