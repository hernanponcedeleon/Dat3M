...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mutex_musl-4-acq2rx_lock-O0.bpl /Users/ponce/git/Dat3M/output/mutex_musl-4-acq2rx_lock_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 40240));
...
axiom (mutex_lock == $sub.ref(0, 6184));
...
axiom (mutex_unlock == $sub.ref(0, 7216));
...
axiom (mutex_lock_slowpath_check == $sub.ref(0, 13408));
...
axiom (atomic_compare_exchange_strong_explicit == $sub.ref(0, 14440));
...
axiom (__futex_wait == $sub.ref(0, 15472));
...
axiom (atomic_fetch_sub_explicit == $sub.ref(0, 16504));
procedure  atomic_fetch_sub_explicit.ref.i32.i32(p.0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
const main: ref;
axiom (main == $sub.ref(0, 17536));
...
axiom (mutex_init == $sub.ref(0, 18568));
...
axiom (atomic_init == $sub.ref(0, 20632));
...
axiom (__VERIFIER_assert == $sub.ref(0, 24760));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 35080));
...
axiom (__SMACK_decls == $sub.ref(0, 36112));
type $mop;
const $MOP: $mop;
var $exn: bool;
var $exnv: int;
...
axiom (__SMACK_top_decl == $sub.ref(0, 37144));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 38176));
...
axiom (llvm.dbg.value == $sub.ref(0, 39208));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 40240));
