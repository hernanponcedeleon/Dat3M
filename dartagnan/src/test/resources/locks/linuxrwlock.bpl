...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/linuxrwlock-opt.bpl /home/ponce/git/Dat3M/output/linuxrwlock-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 44493));
...
axiom (.str == $sub.ref(0, 4124));
const {:allocSize 53} {:count 53} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 5201));
const {:allocSize 22} {:count 22} __PRETTY_FUNCTION__.threadR: ref;
axiom (__PRETTY_FUNCTION__.threadR == $sub.ref(0, 6247));
const {:allocSize 17} {:count 17} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 7288));
const {:allocSize 22} {:count 22} __PRETTY_FUNCTION__.threadW: ref;
axiom (__PRETTY_FUNCTION__.threadW == $sub.ref(0, 8334));
const {:allocSize 23} {:count 23} __PRETTY_FUNCTION__.threadRW: ref;
axiom (__PRETTY_FUNCTION__.threadRW == $sub.ref(0, 9381));
const {:allocSize 29} {:count 29} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 10434));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 11469));
const threadR: ref;
axiom (threadR == $sub.ref(0, 12501));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 24, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call read_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 25, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, shareddata);
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 26, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call read_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 29, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 26, __PRETTY_FUNCTION__.threadR);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 26, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 13533));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const read_lock: ref;
axiom (read_lock == $sub.ref(0, 14565));
procedure  read_lock($p0: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 32, 53} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 32, 53} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 32, 22} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_rmw($p1, 1, 2, 2);
  call {:cexpr "priorvalue"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 33, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 33, 23} true;
  assume {:verifier.code 0} true;
  $i4 := $sle.i32($i3, 0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 33, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 34, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := __llvm_atomic32_rmw($p1, 1, 0, 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 35, 9} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 38, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 35, 16} true;
  assume {:verifier.code 0} true;
  call $i6 := __llvm_atomic32_load($p1, 0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 35, 70} true;
  assume {:verifier.code 0} true;
  $i7 := $sle.i32($i6, 0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 35, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i7 == 1));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 36, 22} true;
  assume {:verifier.code 0} true;
  call $i8 := __llvm_atomic32_rmw($p1, 1, 2, 2);
  call {:cexpr "priorvalue"} boogie_si_record_i32($i8);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 33, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i8;
  goto $bb1;
...
axiom (__assert_fail == $sub.ref(0, 15597));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const read_unlock: ref;
axiom (read_unlock == $sub.ref(0, 16629));
procedure  read_unlock($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 72, 36} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 72, 36} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 72, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_rmw($p1, 1, 3, 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 73, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __llvm_atomic32_rmw: ref;
axiom (__llvm_atomic32_rmw == $sub.ref(0, 17661));
procedure  __llvm_atomic32_rmw($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const __llvm_atomic32_load: ref;
axiom (__llvm_atomic32_load == $sub.ref(0, 18693));
procedure  __llvm_atomic32_load($p0: ref, $i1: i32)
  returns ($r: i32);
const threadW: ref;
axiom (threadW == $sub.ref(0, 19725));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 34, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 34, 5} true;
  assume {:verifier.code 0} true;
  call write_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 35, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shareddata, 42);
  call {:cexpr "shareddata"} boogie_si_record_i32(42);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, shareddata);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 36, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 37, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 38, 5} true;
  assume {:verifier.code 0} true;
  call write_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 40, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 36, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.2, .str.1, 36, __PRETTY_FUNCTION__.threadW);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 36, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
const write_lock: ref;
axiom (write_lock == $sub.ref(0, 20757));
procedure  write_lock($p0: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 42, 53} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 42, 53} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 42, 22} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_rmw($p1, 1048576, 2, 2);
  call {:cexpr "priorvalue"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 43, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 43, 23} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 44, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := __llvm_atomic32_rmw($p1, 1048576, 0, 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 45, 9} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 48, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 45, 16} true;
  assume {:verifier.code 0} true;
  call $i6 := __llvm_atomic32_load($p1, 0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 45, 70} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 1048576);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 45, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb5, $bb6;
...
$bb6:
  assume !(($i7 == 1));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 46, 22} true;
  assume {:verifier.code 0} true;
  call $i8 := __llvm_atomic32_rmw($p1, 1048576, 2, 2);
  call {:cexpr "priorvalue"} boogie_si_record_i32($i8);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 43, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i8;
...
axiom (write_unlock == $sub.ref(0, 21789));
procedure  write_unlock($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 77, 36} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 77, 36} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 77, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_rmw($p1, 1048576, 3, 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.h", 78, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const threadRW: ref;
axiom (threadRW == $sub.ref(0, 22821));
  ...
  returns ($r: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 45, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 45, 5} true;
  assume {:verifier.code 0} true;
  call read_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 46, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, shareddata);
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, shareddata);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 47, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 48, 5} true;
  assume {:verifier.code 0} true;
  call read_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 50, 5} true;
  assume {:verifier.code 0} true;
  call write_lock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 51, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shareddata, 42);
  call {:cexpr "shareddata"} boogie_si_record_i32(42);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 52, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 47, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 47, __PRETTY_FUNCTION__.threadRW);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 47, 5} true;
  assume {:verifier.code 0} true;
  assume false;
$bb3:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 53, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 53, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 54, 5} true;
  assume {:verifier.code 0} true;
  call write_unlock(mylock);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 56, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 52, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.2, .str.1, 52, __PRETTY_FUNCTION__.threadRW);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 52, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
const main: ref;
axiom (main == $sub.ref(0, 23853));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 65, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 65, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, mylock, 1048576);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 68, 25} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 68, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p3, $0.ref, threadR, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 70, 25} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 70, 9} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p5, $0.ref, threadW, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 72, 25} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p2, $mul.ref(0, 8)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 72, 9} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p7, $0.ref, threadRW, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 75, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.0, $p3);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 75, 9} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_join($i9, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 77, 22} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i64($M.0, $p5);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 77, 9} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_join($i11, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 79, 22} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.0, $p7);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 79, 9} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_join($i13, $0.ref);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 82, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 82, 5} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i15, 2);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 82, 5} true;
...
$bb1:
  assume ($i16 == 1);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 84, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 82, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str.3, .str.1, 82, __PRETTY_FUNCTION__.main);
  assume {:sourceloc "benchmarks/locks/linuxrwlock.c", 82, 5} true;
  assume {:verifier.code 0} true;
  assume false;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 24885));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 25917));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 26949));
procedure  pthread_join($i0: i64, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 27981));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 29013));
...
axiom (__SMACK_dummy == $sub.ref(0, 30045));
...
axiom (__SMACK_and32 == $sub.ref(0, 31077));
...
axiom (__SMACK_and64 == $sub.ref(0, 32109));
...
axiom (__SMACK_and16 == $sub.ref(0, 33141));
...
axiom (__SMACK_and8 == $sub.ref(0, 34173));
...
axiom (__SMACK_or32 == $sub.ref(0, 35205));
...
axiom (__SMACK_or64 == $sub.ref(0, 36237));
...
axiom (__SMACK_or16 == $sub.ref(0, 37269));
...
axiom (__SMACK_or8 == $sub.ref(0, 38301));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 39333));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 40365));
...
axiom (__SMACK_decls == $sub.ref(0, 41397));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 42429));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 43461));
...
axiom (__SMACK_static_init == $sub.ref(0, 44493));
