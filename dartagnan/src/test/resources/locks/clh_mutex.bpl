...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/clh_mutex-opt.bpl /home/ponce/git/Dat3M/output/clh_mutex-opt.ll
...
const {:allocSize 272} lock: ref;
axiom (lock == $sub.ref(0, 2324));
const {:allocSize 4} shared: ref;
axiom (shared == $sub.ref(0, 3352));
const {:allocSize 11} .str: ref;
axiom (.str == $sub.ref(0, 4387));
const {:allocSize 51} {:count 51} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 5462));
const {:allocSize 23} {:count 23} __PRETTY_FUNCTION__.thread_n: ref;
axiom (__PRETTY_FUNCTION__.thread_n == $sub.ref(0, 6509));
const {:allocSize 16} {:count 16} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 7549));
const {:allocSize 11} {:count 11} __PRETTY_FUNCTION__.main: ref;
axiom (__PRETTY_FUNCTION__.main == $sub.ref(0, 8584));
const clh_mutex_init: ref;
axiom (clh_mutex_init == $sub.ref(0, 9616));
procedure  clh_mutex_init($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
$bb0:
  ...
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 104, 31} true;
  assume {:verifier.code 0} true;
  call $p1 := clh_mutex_create_node(0);
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 105, 11} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.value == $sub.ref(0, 10648));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const clh_mutex_create_node: ref;
axiom (clh_mutex_create_node == $sub.ref(0, 11680));
procedure  clh_mutex_create_node($i0: i32)
  returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 90, 55} true;
  assume {:verifier.code 0} true;
  call {:cexpr "clh_mutex_create_node:arg:islocked"} boogie_si_record_i32($i0);
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 90, 55} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(4);
...
procedure  clh_mutex_lock($p0: ref)
{
  ...
  var $p14: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 132, 32} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 132, 32} true;
  assume {:verifier.code 0} true;
  call $p1 := clh_mutex_create_node(1);
  ...
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 133, 30} true;
  assume {:verifier.code 0} true;
  call $i5 := __llvm_atomic64_rmw($p3, $i4, 5, 0);
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 133, 30} true;
  assume {:verifier.code 0} true;
  $p6 := $i2p.i64.ref($i5);
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 140, 53} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p6, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/clh_mutex.h", 140, 25} true;
  assume {:verifier.code 0} true;
  call $i8 := __llvm_atomic32_load($p7, 2);
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 15, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 15, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 17, 5} true;
  assume {:verifier.code 0} true;
  call clh_mutex_lock(lock);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i2);
  call {:cexpr "shared"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i2);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 20, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, sum);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 21, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call clh_mutex_unlock(lock);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 30, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 30, 5} true;
  assume {:verifier.code 0} true;
  call clh_mutex_init(lock);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 33, 25} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 24)), $mul.ref(0, 8));
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 33, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 36, 22} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p1);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 36, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 38, 5} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i14 == 1);
  assume {:sourceloc "benchmarks/locks/clh_mutex.c", 40, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb0:
  ...
  $M.0 := $store.ref($M.0, lock, $0.ref);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(0, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(4, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(5, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(6, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(7, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(8, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(9, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(10, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(11, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(12, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(13, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(14, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(15, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(16, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(17, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(18, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(19, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(20, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(21, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(22, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(23, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(24, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(25, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(26, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(27, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(28, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(29, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(30, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(31, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(32, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(33, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(34, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(35, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(36, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(37, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(38, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(39, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(40, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(41, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(42, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(43, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(44, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(45, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(46, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(47, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(48, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(49, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(50, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(51, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(52, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(53, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(54, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(55, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(56, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(57, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(58, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(59, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(60, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(61, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(62, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(8, 1)), $mul.ref(63, 4)), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(lock, $mul.ref(0, 272)), $mul.ref(264, 1)), $0.ref);
  $exn := false;
  return;
}
