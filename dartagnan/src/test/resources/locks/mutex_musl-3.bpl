  ...
  returns ($r: ref)
{
  ...
  var $p8: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 96, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 96, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  call {:cexpr "index"} boogie_si_record_i64($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 98, 16} true;
  assume {:verifier.code 0} true;
  $p2 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 98, 5} true;
  assume {:verifier.code 0} true;
  call mutex_lock($p2);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 99, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i64.i32($i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 99, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, shared, $i3);
  call {:cexpr "shared"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 100, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, shared);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 101, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i4);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 101, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i64($i5, $i1);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 101, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call assert_($i7);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 102, 18} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 102, 5} true;
  assume {:verifier.code 0} true;
  call mutex_unlock($p8);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 103, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 111, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 111, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, mutex, $p3);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 112, 16} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.0, mutex);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 112, 5} true;
  assume {:verifier.code 0} true;
  call mutex_init($p5);
  assume {:sourceloc "benchmarks/locks/mutex_musl-3.c", 114, 5} true;
  assume {:verifier.code 0} true;
