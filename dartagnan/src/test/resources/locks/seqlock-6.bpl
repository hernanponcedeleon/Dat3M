...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options=-I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/smack -I/Users/ponce/git/Dat3M/include/clang -bpl /Users/ponce/git/Dat3M/output/seqlock-6.bpl /Users/ponce/git/Dat3M/benchmarks/locks/seqlock-6.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 36120));
...
const writer3: ref;
axiom (writer3 == $sub.ref(0, 2064));
procedure  writer3($p0: ref)
  returns ($r: ref)
{
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 61, 5} true;
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 39, 13} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 44, 72} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p2);
...
$bb6:
  ...
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 49, 5} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 76, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 80, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 80, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := read(lock);
  call {:cexpr "r1"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 81, 14} true;
  assume {:verifier.code 0} true;
  call $i2 := read(lock);
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 83, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, writer1, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 92, 5} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 93, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 94, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 96, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (seqlock_init == $sub.ref(0, 15480));
...
axiom (atomic_init == $sub.ref(0, 16512));
...
axiom (__VERIFIER_assert == $sub.ref(0, 20640));
...
axiom (llvm.dbg.value == $sub.ref(0, 35088));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 36120));
