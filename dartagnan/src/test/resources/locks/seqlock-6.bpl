...
// via /usr/local/bin/smack -q -t --no-memory-splitting --clang-options= -bpl /home/ponce/git/Dat3M/output/seqlock-6-opt.bpl /home/ponce/git/Dat3M/output/seqlock-6-opt.ll
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 45550));
...
axiom (t3 == $sub.ref(0, 2064));
const {:allocSize 8} t2: ref;
axiom (t2 == $sub.ref(0, 3096));
const {:allocSize 8} t1: ref;
axiom (t1 == $sub.ref(0, 4128));
const {:allocSize 8} t4: ref;
axiom (t4 == $sub.ref(0, 5160));
const {:allocSize 8} t5: ref;
axiom (t5 == $sub.ref(0, 6192));
const {:allocSize 8} t6: ref;
axiom (t6 == $sub.ref(0, 7224));
const {:allocSize 65} {:count 65} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 8313));
const {:allocSize 51} {:count 51} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 9388));
const {:allocSize 36} {:count 36} __PRETTY_FUNCTION__.write: ref;
axiom (__PRETTY_FUNCTION__.write == $sub.ref(0, 10448));
const {:allocSize 9} .str: ref;
axiom (.str == $sub.ref(0, 11481));
const {:allocSize 21} {:count 21} __PRETTY_FUNCTION__.reader: ref;
axiom (__PRETTY_FUNCTION__.reader == $sub.ref(0, 12526));
const writer3: ref;
axiom (writer3 == $sub.ref(0, 13558));
procedure  writer3($p0: ref)
  returns ($r: ref)
{
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 62, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 62, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 3);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 63, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
procedure  write($p0: ref, $i1: i32)
{
  ...
  var $i17: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 37, 5} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 39, 48} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 39, 23} true;
  assume {:verifier.code 0} true;
  call $i3 := __llvm_atomic32_load($p2, 2);
  call {:cexpr "old_seq"} boogie_si_record_i32($i3);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 40, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $srem.i32($i3, 2);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 40, 25} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 40, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 41, 13} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 44, 57} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 44, 80} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i3, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 44, 13} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i11 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 45, 13} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !(($i11 == 1));
  ...
  goto $bb1;
$bb9:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 49, 31} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 51, 5} true;
  assume {:verifier.code 0} true;
...
axiom (pthread_create == $sub.ref(0, 21814));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const writer1: ref;
axiom (writer1 == $sub.ref(0, 22846));
procedure  writer1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 73, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 73, 5} true;
  assume {:verifier.code 0} true;
  call write(lock, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create(t2, $0.ref, writer2, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 75, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 79, 11} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 79, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := read(lock);
  call {:cexpr "r1"} boogie_si_record_i32($i1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 80, 14} true;
  assume {:verifier.code 0} true;
  call $i2 := read(lock);
  call {:cexpr "r2"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 81, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sge.i32($i2, $i1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 81, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 81, 5} true;
  assume {:verifier.code 0} true;
  call __assert_fail(.str, .str.1, 81, __PRETTY_FUNCTION__.reader);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 81, 5} true;
  assume {:verifier.code 0} true;
  assume false;
$bb3:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 82, 5} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i9: i1;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 22, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 23, 48} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 23, 23} true;
  assume {:verifier.code 0} true;
  call $i2 := __llvm_atomic32_load($p1, 2);
  call {:cexpr "old_seq"} boogie_si_record_i32($i2);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 24, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $srem.i32($i2, 2);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 24, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 24, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 25, 13} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 28, 44} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 28, 19} true;
  assume {:verifier.code 0} true;
  call $i6 := __llvm_atomic32_load($p5, 2);
  call {:cexpr "res"} boogie_si_record_i32($i6);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 29, 38} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 29, 13} true;
  assume {:verifier.code 0} true;
  call $i8 := __llvm_atomic32_load($p7, 0);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 29, 65} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, $i2);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 29, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i9 == 1);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 30, 13} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 87, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 87, 5} true;
  assume {:verifier.code 0} true;
  call seqlock_init(lock);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 89, 5} true;
  assume {:verifier.code 0} true;
  call $i0 := pthread_create(t1, $0.ref, writer1, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 90, 5} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create(t4, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_create(t5, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 92, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create(t6, $0.ref, reader, $0.ref);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 94, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (seqlock_init == $sub.ref(0, 26974));
procedure  seqlock_init($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
$bb0:
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 16, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 16, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 17, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 0);
  assume {:sourceloc "benchmarks/locks/seqlock-6.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 28006));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 29038));
...
axiom (__SMACK_dummy == $sub.ref(0, 30070));
...
axiom (__SMACK_and32 == $sub.ref(0, 31102));
...
axiom (__SMACK_and64 == $sub.ref(0, 32134));
...
axiom (__SMACK_and16 == $sub.ref(0, 33166));
...
axiom (__SMACK_and8 == $sub.ref(0, 34198));
...
axiom (__SMACK_or32 == $sub.ref(0, 35230));
...
axiom (__SMACK_or64 == $sub.ref(0, 36262));
...
axiom (__SMACK_or16 == $sub.ref(0, 37294));
...
axiom (__SMACK_or8 == $sub.ref(0, 38326));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 39358));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 40390));
...
axiom (__SMACK_decls == $sub.ref(0, 41422));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 42454));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 43486));
...
axiom (llvm.dbg.value == $sub.ref(0, 44518));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 45550));
