...
$bb0:
  ...
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 183, 37} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(12, 1));
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 183, 9} true;
  assume {:verifier.code 0} true;
  call $i5 := __llvm_atomic32_load($p4, 0);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 183, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 183, 67} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i64($i6, $i3);
  assume {:sourceloc "benchmarks/locks/ticket_awnsb_mutex.h", 183, 9} true;
  assume {:verifier.code 0} true;
