...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/cna-4-rel2rx_unlock2-O0.bpl /Users/ponce/git/Dat3M/output/cna-4-rel2rx_unlock2_tmp.c
...
$bb18:
  ...
  call $i32 := atomic_load_explicit.ref.i32($p31, 0);
  call $i33 := atomic_store_explicit.ref.i32.i32($p30, $i32, 0);
  goto $bb8;
$bb19:
  assume !(($i29 == 1));
  goto $bb17;
