...
51:                                               ; preds = %50
  ...
  %53 = icmp ne i32 %52, 4
  br i1 %53, label %16, label %54, !llvm.loop !9
...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldr $0, $1 \0A\0A", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !10
...
define internal i32 @vatomic32_cmpxchg_rel(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call { i32, i32 } asm sideeffect "dmb ish \0A1:\0Aldrex $0, $4\0Acmp $0, $3\0Abne 2f\0Astrex $1, $2, $4\0Acmp $1, #0 \0Abne 1b\0A2:\0A \0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !18
...
define internal void @vatomic32_write_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "dmb ish \0Astr $0, $1\0A \0A", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !20
  ret void
}
...
define internal i32 @vatomic32_get_add_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %11 = call { i32, i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Aadd $1, $0, $3\0Astrex $2, $1, $4\0Acmp $2, #0\0Abne 1b\0A \0A", "=&r,=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %8, ptr elementtype(i32) %10) #4, !srcloc !22
...
define internal void @vatomic32_write(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %6 = load ptr, ptr %3, align 8
  %7 = getelementptr inbounds %struct.vatomic32_s, ptr %6, i32 0, i32 0
  call void asm sideeffect "dmb ish \0Astr $0, $1\0Admb ish \0A", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !23
  ret void
}
...
!8 = distinct !{!8, !7}
!9 = distinct !{!9, !7}
!10 = !{i64 1186732, i64 1186761}
!11 = distinct !{!11, !7}
!12 = distinct !{!12, !7}
!13 = distinct !{!13, !7}
!14 = distinct !{!14, !7}
!15 = distinct !{!15, !7}
!16 = !{i64 1185746, i64 1185775}
!17 = !{i64 1186239, i64 1186268}
!18 = !{i64 1204816, i64 1204838, i64 1204853, i64 1204885, i64 1204918, i64 1204937, i64 1204977, i64 1205005, i64 1205024, i64 1205039}
!19 = distinct !{!19, !7}
!20 = !{i64 1190586, i64 1190608, i64 1190635}
!21 = distinct !{!21, !7}
!22 = !{i64 1226703, i64 1226718, i64 1226733, i64 1226765, i64 1226804, i64 1226844, i64 1226871, i64 1226890}
!23 = !{i64 1190104, i64 1190126, i64 1190153}
