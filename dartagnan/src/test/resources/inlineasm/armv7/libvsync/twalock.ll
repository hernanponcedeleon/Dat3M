...
define internal i32 @vatomic32_read_acq(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldr $0, $1 \0Admb ish\0A", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !12
  store i32 %6, ptr %3, align 4
...
define internal i32 @vatomic32_cmpxchg_rlx(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call { i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Acmp $0, $3\0Abne 2f\0Astrex $1, $2, $4\0Acmp $1, #0 \0Abne 1b\0A2:\0A \0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !13
...
define internal i32 @vatomic32_get_add_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = load ptr, ptr %3, align 8
  %10 = getelementptr inbounds %struct.vatomic32_s, ptr %9, i32 0, i32 0
  %11 = call { i32, i32, i32 } asm sideeffect "dmb ish \0A1:\0Aldrex $0, $4\0Aadd $1, $0, $3\0Astrex $2, $1, $4\0Acmp $2, #0\0Abne 1b\0A \0A", "=&r,=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %8, ptr elementtype(i32) %10) #4, !srcloc !20
  %12 = extractvalue { i32, i32, i32 } %11, 0
  %13 = extractvalue { i32, i32, i32 } %11, 1
  %14 = extractvalue { i32, i32, i32 } %11, 2
  store i32 %12, ptr %5, align 4
...
!10 = distinct !{!10, !7}
!11 = distinct !{!11, !7}
!12 = !{i64 934177, i64 934206}
!13 = !{i64 953543, i64 953558, i64 953573, i64 953605, i64 953638, i64 953657, i64 953697, i64 953725, i64 953744, i64 953759}
!14 = distinct !{!14, !7}
!15 = distinct !{!15, !7}
!16 = !{i64 974641, i64 974656, i64 974671, i64 974703, i64 974742, i64 974782, i64 974809, i64 974828}
!17 = !{i64 934670, i64 934699}
!18 = distinct !{!18, !7}
!19 = !{i64 938524, i64 938546, i64 938573}
!20 = !{i64 970801, i64 970823, i64 970838, i64 970870, i64 970909, i64 970949, i64 970976, i64 970995}
