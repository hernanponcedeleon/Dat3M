...
define internal i32 @vatomic32_read_acq(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldar ${0:w}, $1", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #6, !srcloc !7
...
define internal i32 @vatomic32_cmpxchg_acq(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call { i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldaxr ${0:w}, $4\0Acmp ${0:w}, ${3:w}\0Ab.ne 2f\0Astxr  ${1:w}, ${2:w}, $4\0Acbnz ${1:w}, 1b\0A2:\0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #6, !srcloc !8
...
define internal void @vatomic32_write_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "stlr ${0:w}, $1", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #6, !srcloc !9
  ret void
}
...
define internal i32 @vatomic32_get_add_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %11 = call { i32, i32, i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:w}, $4\0Aadd ${1:w}, ${0:w}, ${3:w}\0Astlxr ${2:w}, ${1:w}, $4\0Acbnz ${2:w}, 1b\0A", "=&r,=&r,=&r,=&r,*Q,3,~{memory},~{cc}"(ptr elementtype(i32) %10, i32 %8) #6, !srcloc !10
...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %4 = load ptr, ptr %2, align 8
  %5 = getelementptr inbounds %struct.vatomic32_s, ptr %4, i32 0, i32 0
  %6 = call i32 asm sideeffect "ldr ${0:w}, $1", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #6, !srcloc !11
  store i32 %6, ptr %3, align 4
  %7 = load i32, ptr %3, align 4
  ret i32 %7
}
...
define internal i32 @vatomic32_await_neq_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = call i32 asm sideeffect "1:\0Aldr ${0:w}, $2\0Acmp ${0:w}, ${1:w}\0Ab.eq 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(i32 %6, ptr elementtype(i32) %8) #6, !srcloc !12
...
!7 = !{i64 1181616}
!8 = !{i64 1247017, i64 1247051, i64 1247066, i64 1247099, i64 1247133, i64 1247153, i64 1247195, i64 1247224}
!9 = !{i64 1186032}
!10 = !{i64 1275403, i64 1275437, i64 1275452, i64 1275484, i64 1275526, i64 1275568}
!11 = !{i64 1182118}
!12 = !{i64 1204724, i64 1204740, i64 1204770, i64 1204803}
!13 = distinct !{!13, !6}
!14 = distinct !{!14, !6}
