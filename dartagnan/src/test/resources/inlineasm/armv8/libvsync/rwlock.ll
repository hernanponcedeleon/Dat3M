; ModuleID = 'test/spinlock/rwlock.c'
source_filename = "test/spinlock/rwlock.c"
...
@lock = global %struct.rwlock_s { i32 1073741824, %struct.vatomic32_s zeroinitializer, %struct.semaphore_s { %struct.vatomic32_s { i32 1073741824 } } }, align 4
...
9:                                                ; preds = %8
  call void @rwlock_write_acquire(ptr noundef @lock)
  ret void
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal void @rwlock_write_acquire(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.rwlock_s, ptr %3, i32 0, i32 1
  %5 = call i32 @vatomic32_await_eq_set_rlx(ptr noundef %4, i32 noundef 0, i32 noundef 1)
  %6 = load ptr, ptr %2, align 8
  %7 = getelementptr inbounds %struct.rwlock_s, ptr %6, i32 0, i32 2
  %8 = load ptr, ptr %2, align 8
  %9 = getelementptr inbounds %struct.rwlock_s, ptr %8, i32 0, i32 0
  %10 = load i32, ptr %9, align 4
  call void @semaphore_acquire(ptr noundef %7, i32 noundef %10)
  ret void
}
...
9:                                                ; preds = %8
  call void @rwlock_write_release(ptr noundef @lock)
  ret void
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal void @rwlock_write_release(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.rwlock_s, ptr %3, i32 0, i32 1
  ...
  %6 = getelementptr inbounds %struct.rwlock_s, ptr %5, i32 0, i32 2
  %7 = load ptr, ptr %2, align 8
  %8 = getelementptr inbounds %struct.rwlock_s, ptr %7, i32 0, i32 0
  %9 = load i32, ptr %8, align 4
  call void @semaphore_release(ptr noundef %6, i32 noundef %9)
  ret void
}
...
9:                                                ; preds = %8
  call void @rwlock_read_acquire(ptr noundef @lock)
  ret void
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal void @rwlock_read_acquire(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.rwlock_s, ptr %3, i32 0, i32 1
  %5 = call i32 @vatomic32_await_eq_rlx(ptr noundef %4, i32 noundef 0)
  %6 = load ptr, ptr %2, align 8
  %7 = getelementptr inbounds %struct.rwlock_s, ptr %6, i32 0, i32 2
  call void @semaphore_acquire(ptr noundef %7, i32 noundef 1)
  ret void
}
...
9:                                                ; preds = %8
  call void @rwlock_read_release(ptr noundef @lock)
  ret void
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal void @rwlock_read_release(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.rwlock_s, ptr %3, i32 0, i32 2
  call void @semaphore_release(ptr noundef %4, i32 noundef 1)
  ret void
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal i32 @vatomic32_await_eq_set_rlx(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
...
11:                                               ; preds = %7
  ...
  %15 = call i32 @vatomic32_cmpxchg_rlx(ptr noundef %12, i32 noundef %13, i32 noundef %14)
...
define internal i32 @vatomic32_await_eq_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = call i32 asm sideeffect "1:\0Aldr ${0:w}, $2\0Acmp ${0:w}, ${1:w}\0Ab.ne 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(i32 %6, ptr elementtype(i32) %8) #4, !srcloc !10
...
define internal i32 @vatomic32_cmpxchg_rlx(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call { i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:w}, $4\0Acmp ${0:w}, ${3:w}\0Ab.ne 2f\0Astxr  ${1:w}, ${2:w}, $4\0Acbnz ${1:w}, 1b\0A2:\0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !11
...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldr ${0:w}, $1", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !14
  store i32 %6, ptr %3, align 4
  %7 = load i32, ptr %3, align 4
  ret i32 %7
}
...
define internal i32 @vatomic32_await_neq_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %7 = load ptr, ptr %3, align 8
  %8 = getelementptr inbounds %struct.vatomic32_s, ptr %7, i32 0, i32 0
  %9 = call i32 asm sideeffect "1:\0Aldr ${0:w}, $2\0Acmp ${0:w}, ${1:w}\0Ab.eq 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(i32 %6, ptr elementtype(i32) %8) #4, !srcloc !15
  store i32 %9, ptr %5, align 4
  %10 = load i32, ptr %5, align 4
  ret i32 %10
}
...
define internal i32 @vatomic32_cmpxchg_acq(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %11 = load ptr, ptr %4, align 8
  %12 = getelementptr inbounds %struct.vatomic32_s, ptr %11, i32 0, i32 0
  %13 = call { i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldaxr ${0:w}, $4\0Acmp ${0:w}, ${3:w}\0Ab.ne 2f\0Astxr  ${1:w}, ${2:w}, $4\0Acbnz ${1:w}, 1b\0A2:\0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !16
  %14 = extractvalue { i32, i32 } %13, 0
  %15 = extractvalue { i32, i32 } %13, 1
  store i32 %14, ptr %7, align 4
  store i32 %15, ptr %8, align 4
...
define internal void @vatomic32_write_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "str ${0:w}, $1", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !17
  ret void
}
...
define internal void @vatomic32_add_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %11 = call { i32, i32, i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:w}, $4\0Aadd ${1:w}, ${0:w}, ${3:w}\0Astlxr ${2:w}, ${1:w}, $4\0Acbnz ${2:w}, 1b\0A", "=&r,=&r,=&r,=&r,*Q,3,~{memory},~{cc}"(ptr elementtype(i32) %10, i32 %8) #4, !srcloc !18
...
!8 = distinct !{!8, !6}
!9 = distinct !{!9, !6}
!10 = !{i64 946073, i64 946089, i64 946119, i64 946152}
!11 = !{i64 991071, i64 991105, i64 991120, i64 991152, i64 991186, i64 991206, i64 991248, i64 991277}
!12 = distinct !{!12, !6}
!13 = distinct !{!13, !6}
!14 = !{i64 924620}
!15 = !{i64 947226, i64 947242, i64 947272, i64 947305}
!16 = !{i64 989519, i64 989553, i64 989568, i64 989601, i64 989635, i64 989655, i64 989697, i64 989726}
!17 = !{i64 929004}
!18 = !{i64 1044019, i64 1044053, i64 1044068, i64 1044100, i64 1044142, i64 1044184}
