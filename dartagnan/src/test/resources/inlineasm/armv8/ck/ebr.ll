...
define internal void @ck_pr_md_store_uint(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "str ${2:w}, [$1]", "=*m,r,r,~{memory}"(ptr elementtype(i32) %5, ptr %6, i32 %7) #5, !srcloc !6
  ret void
}
...
define internal i32 @ck_pr_md_load_uint(ptr noundef %0) #0 {
  ...
  %5 = call i64 asm sideeffect "ldr ${0:w}, [$1]\0A", "=r,r,~{memory}"(ptr %4) #5, !srcloc !7
...
define internal i32 @ck_pr_fas_uint(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = call { i32, i32 } asm sideeffect "1:ldxr ${0:w}, [$2]\0Astxr ${1:w}, ${3:w}, [$2]\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,r,~{memory},~{cc}"(ptr %7, i32 %8) #5, !srcloc !10
...
define internal void @ck_pr_dec_uint(ptr noundef %0) #0 {
  ...
  %5 = load ptr, ptr %2, align 8
  %6 = call { i32, i32 } asm sideeffect "1:ldxr ${0:w}, [$2]\0Asub ${0:w}, ${0:w}, #1\0Astxr ${1:w}, ${0:w}, [$2]\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,~{memory},~{cc}"(ptr %5) #5, !srcloc !11
...
define internal void @ck_pr_md_store_ptr(ptr noundef %0, ptr noundef %1) #0 {
  ...
  call void asm sideeffect "str $2, [$1]", "=*m,r,r,~{memory}"(ptr elementtype(ptr) %5, ptr %6, ptr %7) #5, !srcloc !12
  ret void
}
...
define internal void @ck_pr_inc_uint(ptr noundef %0) #0 {
  ...
  store i32 0, ptr %4, align 4
  %5 = load ptr, ptr %2, align 8
  %6 = call { i32, i32 } asm sideeffect "1:ldxr ${0:w}, [$2]\0Aadd ${0:w}, ${0:w}, #1\0Astxr ${1:w}, ${0:w}, [$2]\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,~{memory},~{cc}"(ptr %5) #5, !srcloc !16
  %7 = extractvalue { i32, i32 } %6, 0
  %8 = extractvalue { i32, i32 } %6, 1
  store i32 %7, ptr %3, align 4
  store i32 %8, ptr %4, align 4
...
define internal zeroext i1 @ck_pr_cas_uint_value(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #0 {
  ...
  %14 = call { i32, i32 } asm sideeffect "1:\0Aldxr ${0:w}, [$2]\0Acmp  ${0:w}, ${4:w}\0Ab.ne 2f\0Astxr ${1:w}, ${3:w}, [$2]\0Acbnz ${1:w}, 1b\0A2:", "=&r,=&r,r,r,r,~{memory},~{cc}"(ptr %11, i32 %12, i32 %13) #5, !srcloc !23
...
define internal zeroext i1 @ck_pr_cas_uint(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %12 = call { i32, i32 } asm sideeffect "1:ldxr ${0:w}, [$2]\0Acmp  ${0:w}, ${4:w}\0Ab.ne 2f\0Astxr ${1:w}, ${3:w}, [$2]\0Acbnz ${1:w}, 1b\0A2:", "=&r,=&r,r,r,r,~{memory},~{cc}"(ptr %9, i32 %10, i32 %11) #5, !srcloc !25
...
80:                                               ; preds = %73
  call void @__assert_rtn(ptr noundef @__func__.thread, ptr noundef @.str, i32 noundef 35, ptr noundef @.str.1) #6
  unreachable
...
define internal ptr @ck_pr_md_load_ptr(ptr noundef %0) #0 {
  ...
  store i64 0, ptr %3, align 8
  %4 = load ptr, ptr %2, align 8
  %5 = call i64 asm sideeffect "ldr $0, [$1]\0A", "=r,r,~{memory}"(ptr %4) #5, !srcloc !31
  store i64 %5, ptr %3, align 8
  %6 = load i64, ptr %3, align 8
...
define internal zeroext i1 @ck_pr_cas_ptr_value(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3) #0 {
  ...
  %14 = call { ptr, ptr } asm sideeffect "1:\0Aldxr $0, [$2]\0Acmp  $0, $4\0Ab.ne 2f\0Astxr ${1:w}, $3, [$2]\0Acbnz ${1:w}, 1b\0A2:", "=&r,=&r,r,r,r,~{memory},~{cc}"(ptr %11, ptr %12, ptr %13) #5, !srcloc !32
...
define internal void @ck_pr_add_uint(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %7 = load ptr, ptr %3, align 8
  %8 = load i32, ptr %4, align 4
  %9 = call { i32, i32 } asm sideeffect "1:ldxr ${0:w}, [$2]\0Aadd ${0:w}, ${0:w}, ${3:w}\0Astxr ${1:w}, ${0:w}, [$2]\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,r,~{memory},~{cc}"(ptr %7, i32 %8) #5, !srcloc !33
  %10 = extractvalue { i32, i32 } %9, 0
  %11 = extractvalue { i32, i32 } %9, 1
  store i32 %10, ptr %5, align 4
  store i32 %11, ptr %6, align 4
...
define internal void @ck_pr_sub_uint(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %7 = load ptr, ptr %3, align 8
  %8 = load i32, ptr %4, align 4
  %9 = call { i32, i32 } asm sideeffect "1:ldxr ${0:w}, [$2]\0Asub ${0:w}, ${0:w}, ${3:w}\0Astxr ${1:w}, ${0:w}, [$2]\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,r,~{memory},~{cc}"(ptr %7, i32 %8) #5, !srcloc !34
  %10 = extractvalue { i32, i32 } %9, 0
  %11 = extractvalue { i32, i32 } %9, 1
  store i32 %10, ptr %5, align 4
  store i32 %11, ptr %6, align 4
...
define internal ptr @ck_pr_fas_ptr(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %7 = load ptr, ptr %3, align 8
  %8 = load ptr, ptr %4, align 8
  %9 = call { ptr, ptr } asm sideeffect "1:ldxr $0, [$2]\0Astxr ${1:w}, $3, [$2]\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,r,~{memory},~{cc}"(ptr %7, ptr %8) #5, !srcloc !35
...
!10 = !{i64 2148819034, i64 2148819147, i64 2148819218}
!11 = !{i64 2148832247, i64 2148832836, i64 2148832409, i64 2148832481}
!12 = !{i64 2148771584}
!13 = distinct !{!13, !9}
!14 = distinct !{!14, !9}
!15 = distinct !{!15, !9}
!16 = !{i64 2148831385, i64 2148831974, i64 2148831547, i64 2148831619}
!17 = distinct !{!17, !9}
!18 = distinct !{!18, !9}
!19 = distinct !{!19, !9}
!20 = distinct !{!20, !9}
!21 = distinct !{!21, !9}
!22 = !{i64 1270902}
!23 = !{i64 2148798286, i64 2148798336, i64 2148798403, i64 2148798469, i64 2148798522, i64 2148798594, i64 2148798652}
!24 = distinct !{!24, !9}
!25 = !{i64 2148799292, i64 2148799407, i64 2148799473, i64 2148799526, i64 2148799598, i64 2148799656}
!26 = distinct !{!26, !9}
!27 = distinct !{!27, !9}
!28 = !{i64 2148767049}
!29 = !{i64 2148765159}
!30 = !{i64 2148765702}
!31 = !{i64 2148767923}
!32 = !{i64 2148789344, i64 2148789394, i64 2148789461, i64 2148789527, i64 2148789580, i64 2148789652, i64 2148789710}
!33 = !{i64 2148863555, i64 2148864241, i64 2148863741, i64 2148863813}
!34 = !{i64 2148865471, i64 2148866157, i64 2148865657, i64 2148865729}
!35 = !{i64 2148817367, i64 2148817480, i64 2148817551}
!36 = !{i64 2148766244}
!37 = !{i64 2148764326}
!38 = !{i64 2148766781}
