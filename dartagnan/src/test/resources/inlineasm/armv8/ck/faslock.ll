...
define internal void @ck_pr_md_store_uint(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "str ${2:w}, [$1]", "=*m,r,r,~{memory}"(ptr elementtype(i32) %5, ptr %6, i32 %7) #6, !srcloc !15
  ret void
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal void @ck_pr_fence_strict_unlock() #0 {
  call void asm sideeffect "dmb ish", "r,~{memory}"(i32 0) #6, !srcloc !16
  ret void
}
...
!9 = distinct !{!9, !7}
!10 = distinct !{!10, !7}
!11 = !{i64 2147804363, i64 2147804476, i64 2147804547}
!12 = !{i64 2147756704}
!13 = !{i64 260292}
!14 = !{i64 2147759190}
!15 = !{i64 2147762877}
