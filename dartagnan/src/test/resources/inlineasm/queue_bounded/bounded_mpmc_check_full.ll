...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %4 = load ptr, ptr %2, align 8
  %5 = getelementptr inbounds %struct.vatomic32_s, ptr %4, i32 0, i32 0
  %6 = call i32 asm sideeffect "ldr ${0:w}, $1", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #6, !srcloc !9
  store i32 %6, ptr %3, align 4
  %7 = load i32, ptr %3, align 4
  ret i32 %7
}
...
define internal i32 @vatomic32_cmpxchg_rel(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call { i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:w}, $4\0Acmp ${0:w}, ${3:w}\0Ab.ne 2f\0Astlxr  ${1:w}, ${2:w}, $4\0Acbnz ${1:w}, 1b\0A2:\0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #6, !srcloc !10
...
define internal i32 @vatomic32_await_eq_acq(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = call i32 asm sideeffect "1:\0Aldar ${0:w}, $2\0Acmp ${0:w}, ${1:w}\0Ab.ne 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(i32 %6, ptr elementtype(i32) %8) #6, !srcloc !11
...
define internal void @vatomic32_write_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "stlr ${0:w}, $1", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #6, !srcloc !12
  ret void
}
...
define internal void @vatomic32_write(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %6 = load ptr, ptr %3, align 8
  %7 = getelementptr inbounds %struct.vatomic32_s, ptr %6, i32 0, i32 0
  call void asm sideeffect "stlr ${0:w}, $1", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #6, !srcloc !13
  ret void
}
...
define internal i32 @vatomic32_await_eq_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %7 = load ptr, ptr %3, align 8
  %8 = getelementptr inbounds %struct.vatomic32_s, ptr %7, i32 0, i32 0
  %9 = call i32 asm sideeffect "1:\0Aldr ${0:w}, $2\0Acmp ${0:w}, ${1:w}\0Ab.ne 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(i32 %6, ptr elementtype(i32) %8) #6, !srcloc !16
  store i32 %9, ptr %5, align 4
  %10 = load i32, ptr %5, align 4
  ret i32 %10
}
...
!8 = !{i64 1184587}
!9 = !{i64 1185089}
!10 = !{i64 1250764, i64 1250798, i64 1250813, i64 1250845, i64 1250879, i64 1250899, i64 1250942, i64 1250971}
!11 = !{i64 1199625, i64 1199641, i64 1199672, i64 1199705}
!12 = !{i64 1189003}
!13 = !{i64 1188533}
!14 = distinct !{!14, !6}
!15 = distinct !{!15, !6}
!16 = !{i64 1206542, i64 1206558, i64 1206588, i64 1206621}
