...
define internal i32 @vatomic32_xchg_acq(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %10 = call { i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $3\0Astrex $1, $2, $3\0Acmp $1, #0 \0Abne 1b\0Admb ish \0A", "=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %7, ptr elementtype(i32) %9) #4, !srcloc !13
...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldr $0, $1 \0A\0A", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !14
...
define internal void @vatomic32_write_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "dmb ish \0Astr $0, $1\0A \0A", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !15
  ret void
}
...
!11 = distinct !{!11, !7}
!12 = distinct !{!12, !7}
!13 = !{i64 940347, i64 940362, i64 940377, i64 940409, i64 940449, i64 940477, i64 940496}
!14 = !{i64 931384, i64 931413}
!15 = !{i64 935238, i64 935260, i64 935287}
