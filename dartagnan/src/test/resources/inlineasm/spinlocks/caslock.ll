; ModuleID = 'test/spinlock/caslock.c'
source_filename = "test/spinlock/caslock.c"
...
@lock = global %struct.caslock_s zeroinitializer, align 4
...
6:                                                ; preds = %1
  %7 = call zeroext i1 @caslock_tryacquire(ptr noundef @lock)
  %8 = zext i1 %7 to i8
...
11:                                               ; preds = %1
  call void @caslock_acquire(ptr noundef @lock)
  br label %12
...
9:                                                ; preds = %8
  call void @caslock_release(ptr noundef @lock)
  ret void
}
...
define internal i32 @vatomic32_await_eq_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = call i32 asm sideeffect "1:\0Aldr ${0:w}, $2\0Acmp ${0:w}, ${1:w}\0Ab.ne 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(i32 %6, ptr elementtype(i32) %8) #4, !srcloc !13
...
define internal void @vatomic32_write_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "stlr ${0:w}, $1", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !14
  ret void
}
...
!9 = distinct !{!9, !6}
!10 = distinct !{!10, !6}
!11 = !{i64 995862, i64 995896, i64 995911, i64 995944, i64 995978, i64 995998, i64 996040, i64 996069}
!12 = distinct !{!12, !6}
!13 = !{i64 952416, i64 952432, i64 952462, i64 952495}
!14 = !{i64 934877}
