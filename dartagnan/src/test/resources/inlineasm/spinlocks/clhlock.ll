...
define internal void @vatomic32_write(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "stlr ${0:w}, $1", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !12
  ret void
}
...
define internal void @vatomicptr_write(ptr noundef %0, ptr noundef %1) #0 {
  ...
  call void asm sideeffect "stlr ${0:x}, $1", "r,*Q,~{memory}"(ptr %5, ptr elementtype(ptr) %7) #4, !srcloc !13
  ret void
}
...
define internal void @vatomic32_write_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %6 = load ptr, ptr %3, align 8
  %7 = getelementptr inbounds %struct.vatomic32_s, ptr %6, i32 0, i32 0
  call void asm sideeffect "str ${0:w}, $1", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !14
  ret void
}
...
define internal ptr @vatomicptr_xchg(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %10 = call { ptr, i32 } asm sideeffect "prfm pstl1strm, $3\0A1:\0Aldaxr ${0:x}, $3\0Astlxr  ${1:w}, ${2:x}, $3\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,*Q,~{memory}"(ptr %7, ptr elementtype(ptr) %9) #4, !srcloc !15
...
define internal void @vatomic32_write_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %6 = load ptr, ptr %3, align 8
  %7 = getelementptr inbounds %struct.vatomic32_s, ptr %6, i32 0, i32 0
  call void asm sideeffect "stlr ${0:w}, $1", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !17
  ret void
}
...
!13 = !{i64 939070}
!14 = !{i64 937223}
!15 = !{i64 994322, i64 994356, i64 994371, i64 994404, i64 994447}
!16 = !{i64 947375, i64 947391, i64 947422, i64 947455}
!17 = !{i64 936753}
