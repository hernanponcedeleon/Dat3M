; ModuleID = '/Users/thomashaas/IdeaProjects/Dat3M/output/progressHSA.ll'
source_filename = "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/progress/progressHSA.c"
...
define i8* @thread_1(i8* noundef %0) #0 !dbg !23 {
  ...
  store atomic i32 1, i32* @x seq_cst, align 4, !dbg !29
  ret i8* undef, !dbg !30
}
...
; Function Attrs: noinline nounwind ssp uwtable
define i8* @thread_2(i8* noundef %0) #0 !dbg !31 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !32, metadata !DIExpression()), !dbg !33
  br label %2, !dbg !34

2:                                                ; preds = %2, %1
  %3 = load atomic i32, i32* @x seq_cst, align 4, !dbg !35
  %4 = icmp ne i32 %3, 1, !dbg !36
  br i1 %4, label %2, label %5, !dbg !34, !llvm.loop !37
...
!3 = !DIFile(filename: "/Users/thomashaas/IdeaProjects/Dat3M/benchmarks/progress/progressHSA.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
!4 = !{!5}
!5 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!6 = !{!0}
!7 = !DIFile(filename: "benchmarks/progress/progressHSA.c", directory: "/Users/thomashaas/IdeaProjects/Dat3M")
...
!29 = !DILocation(line: 12, column: 7, scope: !23)
!30 = !DILocation(line: 13, column: 1, scope: !23)
!31 = distinct !DISubprogram(name: "thread_2", scope: !7, file: !7, line: 15, type: !24, scopeLine: 16, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !26)
!32 = !DILocalVariable(name: "unused", arg: 1, scope: !31, file: !7, line: 15, type: !5)
!33 = !DILocation(line: 0, scope: !31)
!34 = !DILocation(line: 17, column: 5, scope: !31)
!35 = !DILocation(line: 17, column: 12, scope: !31)
!36 = !DILocation(line: 17, column: 14, scope: !31)
!37 = distinct !{!37, !34, !38, !39}
!38 = !DILocation(line: 17, column: 19, scope: !31)
