...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe012_rmo.oepc-O0.bpl /Users/ponce/git/Dat3M/output/safe012_rmo.oepc_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 101920));
...
axiom (z$w_buff0_used == $sub.ref(0, 12324));
const z$r_buff0_thd1: ref;
axiom (z$r_buff0_thd1 == $sub.ref(0, 13349));
const z$w_buff1_used: ref;
axiom (z$w_buff1_used == $sub.ref(0, 14374));
const z$r_buff1_thd1: ref;
axiom (z$r_buff1_thd1 == $sub.ref(0, 15399));
const z$w_buff0: ref;
axiom (z$w_buff0 == $sub.ref(0, 16427));
const z$w_buff1: ref;
axiom (z$w_buff1 == $sub.ref(0, 17455));
...
axiom (z$r_buff0_thd3 == $sub.ref(0, 20537));
const z$r_buff1_thd3: ref;
axiom (z$r_buff1_thd3 == $sub.ref(0, 21562));
const main$tmp_guard0: ref;
axiom (main$tmp_guard0 == $sub.ref(0, 22587));
const z$r_buff0_thd0: ref;
axiom (z$r_buff0_thd0 == $sub.ref(0, 23612));
const z$r_buff1_thd0: ref;
axiom (z$r_buff1_thd0 == $sub.ref(0, 24637));
const weak$$choice1: ref;
axiom (weak$$choice1 == $sub.ref(0, 25662));
...
axiom (.str.1 == $sub.ref(0, 47222));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 48265));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 49297));
const {:count 3} .str.1.12: ref;
axiom (.str.1.12 == $sub.ref(0, 50324));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 51352));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 52384));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 53416));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 54448));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 55480));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 56512));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 57544));
procedure  llvm.dbg.label($p0: ref);
const P0: ref;
axiom (P0 == $sub.ref(0, 58576));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i1;
  ...
  var $i198: i32;
$bb0:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 763, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 763, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 763, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 764, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 764, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 764, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 765, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 765, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 765, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 765, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 766, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, z);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 766, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i8);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, z);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 84} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i8($M.0, z$r_buff1_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 84} true;
  assume {:verifier.code 0} true;
  $i18 := $trunc.i8.i1($i17);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 7} true;
...
$bb14:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i20);
  call {:cexpr "z"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 124} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 124} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 106} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 767, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i31);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 768, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i54);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 769, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 131} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i8($M.0, z$r_buff1_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 131} true;
  assume {:verifier.code 0} true;
  $i89 := $trunc.i8.i1($i88);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 54} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 184} true;
  assume {:verifier.code 0} true;
  $i96 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 184} true;
  assume {:verifier.code 0} true;
  $i97 := $trunc.i8.i1($i96);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 166} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 770, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 131} true;
  assume {:verifier.code 0} true;
  $i118 := $load.i8($M.0, z$r_buff1_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 184} true;
  assume {:verifier.code 0} true;
  $i127 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 771, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 36} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 18} true;
  assume {:verifier.code 0} true;
  $i161 := $zext.i1.i8($i160);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$r_buff0_thd1, $i161);
  call {:cexpr "z$r_buff0_thd1"} boogie_si_record_i8($i161);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 148} true;
  assume {:verifier.code 0} true;
  $i148 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 131} true;
  assume {:verifier.code 0} true;
  $i146 := $load.i8($M.0, z$r_buff1_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 184} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 772, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 36} true;
  assume {:verifier.code 0} true;
  $i164 := $load.i8($M.0, z$r_buff1_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  $i189 := $zext.i1.i8($i188);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$r_buff1_thd1, $i189);
  call {:cexpr "z$r_buff1_thd1"} boogie_si_record_i8($i189);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 774, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p0_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p0_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 775, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p0_EAX$read_delayed_var, z);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 776, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, z);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 776, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i190);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 777, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 148} true;
  assume {:verifier.code 0} true;
  $i178 := $load.i8($M.0, z$r_buff1_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 131} true;
  assume {:verifier.code 0} true;
  $i176 := $load.i8($M.0, z$r_buff1_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 184} true;
  assume {:verifier.code 0} true;
  $i185 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 773, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 777, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 777, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, z);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 777, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 777, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 777, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i194);
  call {:cexpr "z"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 778, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 781, 25} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 781, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EBX, $i196);
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i196);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 786, 22} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 786, 39} true;
  assume {:verifier.code 0} true;
  $i198 := $add.i32($i197, 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i198);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i198);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 787, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 793, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 796, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 797, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 801, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 801, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 801, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 808, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 808, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 811, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 813, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i7);
  call {:cexpr "z"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 815, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, z);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 814, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 815, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 815, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 817, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 817, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 817, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 820, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 821, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 821, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 821, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 839, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 842, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 843, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 843, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 843, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 845, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 846, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i17);
  call {:cexpr "z"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 848, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 848, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 848, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, z);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 847, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 848, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 848, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 848, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 848, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 849, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 850, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 850, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 850, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 850, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 850, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 850, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 850, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 851, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 852, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 853, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 854, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 854, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 854, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 855, 25} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 855, 61} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume !(($i76 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 855, 140} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume ($i78 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 855, 78} true;
  assume {:verifier.code 0} true;
  $p79 := $load.ref($M.0, __unbuffered_p0_EAX$read_delayed_var);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 855, 77} true;
  assume {:verifier.code 0} true;
...
$bb52:
  assume !(($i78 == 1));
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 855, 117} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 855, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 855, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i83);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i83);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 23} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 43} true;
  assume {:verifier.code 0} true;
  $i86 := $eq.i32($i85, 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 48} true;
  assume {:verifier.code 0} true;
  $i87 := 0;
...
$bb55:
  assume ($i86 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 51} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i32($M.0, __unbuffered_p0_EBX);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 71} true;
  assume {:verifier.code 0} true;
  $i89 := $eq.i32($i88, 0);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 76} true;
  assume {:verifier.code 0} true;
  $i87 := 0;
  assume {:branchcond $i89} true;
  goto $bb58, $bb59;
...
$bb57:
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe012_rmo.oepc_tmp.c:856:21: warning: over-approximating bitwise operation xor;
  $i92 := $xor.i1($i87, 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 19} true;
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i8($i92);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 857, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 858, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i96 := $zext.i1.i32($i95);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 858, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i96);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 859, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb58:
  assume ($i89 == 1);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 79} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/safe012_rmo.oepc_tmp.c", 856, 99} true;
  assume {:verifier.code 0} true;
  $i91 := $eq.i32($i90, 1);
  assume {:verifier.code 0} true;
  $i87 := $i91;
...
axiom (pthread_create == $sub.ref(0, 62704));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 63736));
...
axiom (__SMACK_code == $sub.ref(0, 64768));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 65800));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 66832));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 67864));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 68896));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 69928));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 70960));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 71992));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 73024));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 74056));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 75088));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 76120));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 77152));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 78184));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 79216));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 80248));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 81280));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 82312));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 83344));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 84376));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 85408));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 86440));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 87472));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 88504));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 89536));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 90568));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 91600));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 92632));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 93664));
...
axiom (__SMACK_decls == $sub.ref(0, 94696));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 95728));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 96760));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 97792));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 98824));
...
axiom (llvm.dbg.value == $sub.ref(0, 100888));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 101920));
