...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix018_pso.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix018_pso.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 752, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, 1);
  call {:cexpr "a"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 755, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 760, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 760, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 760, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 767, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 2);
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 770, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 770, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 775, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 775, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 775, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i197: i32;
$bb0:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 782, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 785, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 785, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 785, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 786, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 786, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 786, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 787, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 787, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 787, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 787, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 788, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 788, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i8);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i20);
  call {:cexpr "z"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 789, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i31);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 790, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i54);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 791, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 792, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 793, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 794, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 796, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 796, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i190);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 797, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 795, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 797, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 797, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 797, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 797, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 797, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i194);
  call {:cexpr "z"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 798, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 803, 22} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 803, 39} true;
  assume {:verifier.code 0} true;
  $i197 := $add.i32($i196, 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i197);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i197);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i285: i32;
$bb0:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 810, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 810, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i1);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 811, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, 1);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$w_buff0_used, 1);
  call {:cexpr "z$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 814, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 814, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 814, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 814, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 814, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix018_pso.opt_tmp.c:814:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 814, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 814, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 819, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 819, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 819, 18} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i8($i25);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 819, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 820, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$r_buff0_thd4, 1);
  call {:cexpr "z$r_buff0_thd4"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 823, 19} true;
  assume {:verifier.code 1} true;
  call $i27 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i27);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 823, 17} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i1.i8($i27);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 823, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 824, 19} true;
  assume {:verifier.code 1} true;
  call $i29 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i29);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 824, 17} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i1.i8($i29);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 824, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 825, 21} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 825, 21} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i8.i1($i31);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 825, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i1.i8($i32);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 825, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 826, 15} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 826, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i34);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i34);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 8} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 8} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i36 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 27} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 27} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 42} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 101} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 7} true;
  assume {:verifier.code 0} true;
  $i46 := $i45;
  goto $bb17;
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 65} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 65} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb12, $bb14;
$bb9:
  assume !(($i38 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 46} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 46} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 61} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 106} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 106} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb18, $bb19;
$bb14:
  assume !(($i42 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 84} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i46);
  call {:cexpr "z"} boogie_si_record_i32($i46);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 15} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 124} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 153} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 106} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i50 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 827, 141} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i55 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 31} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume !(($i55 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 45} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 45} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 60} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i57);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i57);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 15} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i59 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 64} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 64} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 79} true;
  assume {:verifier.code 0} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 138} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 44} true;
  assume {:verifier.code 0} true;
  $i69 := $i68;
  goto $bb40;
$bb30:
  ...
  goto $bb31;
$bb31:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 102} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 102} true;
  assume {:verifier.code 0} true;
  $i65 := $trunc.i8.i1($i64);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i65} true;
  goto $bb35, $bb37;
$bb32:
  assume !(($i61 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 83} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 83} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 98} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 151} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 151} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb41, $bb42;
$bb37:
  assume !(($i65 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 121} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 169} true;
  assume {:verifier.code 0} true;
...
$bb42:
  ...
  goto $bb43;
$bb43:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 198} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i73 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 828, 186} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i78 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 31} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume !(($i78 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 45} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 45} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 60} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i80);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i80);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 20} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 64} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 64} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 79} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  goto $bb52;
$bb52:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 138} true;
  assume {:verifier.code 0} true;
  $i91 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 44} true;
  assume {:verifier.code 0} true;
  $i92 := $i91;
  goto $bb63;
$bb53:
  ...
  goto $bb54;
$bb54:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 102} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 102} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb58, $bb60;
$bb55:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 83} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 83} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 98} true;
  assume {:verifier.code 0} true;
...
$bb58:
  ...
  goto $bb59;
$bb59:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 151} true;
  assume {:verifier.code 0} true;
  $i93 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 151} true;
  assume {:verifier.code 0} true;
  $i94 := $trunc.i8.i1($i93);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i94} true;
  goto $bb64, $bb65;
$bb60:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 121} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i94 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 169} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 198} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 829, 186} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i101 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 36} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume !(($i101 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 55} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 55} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 70} true;
  assume {:verifier.code 0} true;
...
$bb72:
  ...
  assume {:verifier.code 0} true;
  $i128 := $ne.i32($i105, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 20} true;
  assume {:verifier.code 0} true;
...
$bb73:
  assume ($i107 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 74} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 74} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 89} true;
  assume {:verifier.code 0} true;
...
$bb74:
  ...
  goto $bb75;
$bb75:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 54} true;
  assume {:verifier.code 0} true;
  $i119 := $i118;
  goto $bb86;
$bb76:
  ...
  goto $bb77;
$bb77:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 112} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 112} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i113} true;
  goto $bb81, $bb83;
$bb78:
  assume !(($i109 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 93} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 93} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i111} true;
  goto $bb79, $bb80;
$bb79:
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 166} true;
  assume {:verifier.code 0} true;
  $i120 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 166} true;
  assume {:verifier.code 0} true;
  $i121 := $trunc.i8.i1($i120);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i121} true;
  goto $bb87, $bb88;
$bb83:
  assume !(($i113 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 131} true;
  assume {:verifier.code 0} true;
...
$bb87:
  assume ($i121 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 184} true;
  assume {:verifier.code 0} true;
...
$bb88:
  ...
  goto $bb89;
$bb89:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 830, 212} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i131 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 36} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i131 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 55} true;
  assume {:verifier.code 0} true;
  $i136 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 55} true;
  assume {:verifier.code 0} true;
  $i137 := $trunc.i8.i1($i136);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 70} true;
  assume {:verifier.code 0} true;
...
$bb95:
  ...
  assume {:verifier.code 0} true;
  $i156 := $ne.i32($i135, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i137 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 74} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 74} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i139} true;
  goto $bb99, $bb101;
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 54} true;
  assume {:verifier.code 0} true;
  $i149 := $i148;
  goto $bb109;
$bb99:
  ...
  goto $bb100;
$bb100:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 112} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 112} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i143} true;
  goto $bb104, $bb106;
$bb101:
  assume !(($i139 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 93} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 93} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb102, $bb103;
$bb102:
...
$bb104:
  ...
  goto $bb105;
$bb105:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 166} true;
  assume {:verifier.code 0} true;
  $i150 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 166} true;
  assume {:verifier.code 0} true;
  $i151 := $trunc.i8.i1($i150);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 181} true;
  assume {:verifier.code 0} true;
  $i152 := 0;
...
$bb106:
  assume !(($i143 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 131} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i151 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 831, 184} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i159 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 36} true;
  assume {:verifier.code 0} true;
...
$bb114:
  assume !(($i159 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 55} true;
  assume {:verifier.code 0} true;
  $i164 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 55} true;
  assume {:verifier.code 0} true;
  $i165 := $trunc.i8.i1($i164);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 70} true;
  assume {:verifier.code 0} true;
...
$bb115:
  ...
  assume {:verifier.code 0} true;
  $i186 := $ne.i32($i163, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume ($i165 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 74} true;
  assume {:verifier.code 0} true;
  $i166 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 74} true;
  assume {:verifier.code 0} true;
  $i167 := $trunc.i8.i1($i166);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 89} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  goto $bb118;
$bb118:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 54} true;
  assume {:verifier.code 0} true;
  $i177 := $i176;
  goto $bb129;
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 112} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 112} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i171} true;
  goto $bb124, $bb126;
$bb121:
  assume !(($i167 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 93} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 93} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i169} true;
  goto $bb122, $bb123;
$bb122:
...
$bb124:
  ...
  goto $bb125;
$bb125:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 166} true;
  assume {:verifier.code 0} true;
  $i178 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 166} true;
  assume {:verifier.code 0} true;
  $i179 := $trunc.i8.i1($i178);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i179} true;
  goto $bb130, $bb131;
$bb126:
  assume !(($i171 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 131} true;
  assume {:verifier.code 0} true;
...
$bb130:
  assume ($i179 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 184} true;
  assume {:verifier.code 0} true;
...
$bb131:
  ...
  goto $bb132;
$bb132:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 832, 212} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i189 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 36} true;
  assume {:verifier.code 0} true;
...
$bb137:
  assume !(($i189 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i194 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i195 := $trunc.i8.i1($i194);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 70} true;
  assume {:verifier.code 0} true;
...
$bb138:
  ...
  assume {:verifier.code 0} true;
  $i214 := $ne.i32($i193, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 834, 25} true;
  assume {:verifier.code 0} true;
  $i216 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 834, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EAX, $i216);
  call {:cexpr "__unbuffered_p3_EAX"} boogie_si_record_i32($i216);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume ($i195 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 89} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  goto $bb141;
$bb141:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 54} true;
  assume {:verifier.code 0} true;
  $i207 := $i206;
  goto $bb152;
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i200 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i201 := $trunc.i8.i1($i200);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i201} true;
  goto $bb147, $bb149;
$bb144:
  assume !(($i197 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i198 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i199 := $trunc.i8.i1($i198);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 108} true;
  assume {:verifier.code 0} true;
...
$bb147:
  ...
  goto $bb148;
$bb148:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i209 := $trunc.i8.i1($i208);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 181} true;
  assume {:verifier.code 0} true;
  $i210 := 0;
...
$bb149:
  assume !(($i201 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 131} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i209 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 833, 184} true;
  assume {:verifier.code 0} true;
...
$bb156:
  assume ($i218 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 835, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  assume !(($i218 == 1));
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 835, 37} true;
  assume {:verifier.code 0} true;
  $i221 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 835, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i220);
  call {:cexpr "z"} boogie_si_record_i32($i220);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 836, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 839, 25} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 839, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EBX, $i222);
  call {:cexpr "__unbuffered_p3_EBX"} boogie_si_record_i32($i222);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i223 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i224 := $trunc.i8.i1($i223);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i224} true;
  goto $bb159, $bb160;
$bb159:
  assume ($i224 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 25} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  goto $bb161;
$bb161:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i229 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i230 := $trunc.i8.i1($i229);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i230} true;
  goto $bb165, $bb166;
$bb162:
  assume ($i226 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 42} true;
  assume {:verifier.code 0} true;
...
$bb164:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i228);
  call {:cexpr "z"} boogie_si_record_i32($i228);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i236 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i237 := $trunc.i8.i1($i236);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 843, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i237} true;
  goto $bb171, $bb172;
$bb165:
  assume ($i230 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 73} true;
  assume {:verifier.code 0} true;
...
$bb166:
  ...
  goto $bb167;
$bb167:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 102} true;
  assume {:verifier.code 0} true;
  $i235 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i232 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 842, 90} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume ($i237 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  goto $bb173;
$bb173:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 843, 66} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  assume {:verifier.code 0} true;
  $i244 := $ne.i32($i240, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i247} true;
  goto $bb177, $bb178;
$bb177:
  assume ($i247 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 53} true;
  assume {:verifier.code 0} true;
...
$bb178:
  ...
  goto $bb179;
$bb179:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i250 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i251 := $trunc.i8.i1($i250);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 71} true;
  assume {:verifier.code 0} true;
...
$bb183:
  assume ($i251 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 74} true;
  assume {:verifier.code 0} true;
...
$bb184:
  ...
  goto $bb185;
$bb185:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 102} true;
  assume {:verifier.code 0} true;
...
$bb188:
  ...
  assume {:verifier.code 0} true;
  $i258 := $ne.i32($i254, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i260 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i261 := $trunc.i8.i1($i260);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 845, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i261} true;
  goto $bb189, $bb190;
$bb189:
  assume ($i261 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 845, 38} true;
  assume {:verifier.code 0} true;
...
$bb190:
  ...
  goto $bb191;
$bb191:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 845, 66} true;
  assume {:verifier.code 0} true;
...
$bb194:
  ...
  assume {:verifier.code 0} true;
  $i268 := $ne.i32($i264, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i270 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i271 := $trunc.i8.i1($i270);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i271} true;
  goto $bb195, $bb196;
$bb195:
  assume ($i271 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i272 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i273 := $trunc.i8.i1($i272);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 53} true;
  assume {:verifier.code 0} true;
...
$bb196:
  ...
  goto $bb197;
$bb197:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 71} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i275 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 74} true;
  assume {:verifier.code 0} true;
...
$bb202:
  ...
  goto $bb203;
$bb203:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 102} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  assume {:verifier.code 0} true;
  $i282 := $ne.i32($i278, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 849, 22} true;
  assume {:verifier.code 0} true;
  $i284 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 849, 39} true;
  assume {:verifier.code 0} true;
  $i285 := $add.i32($i284, 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i285);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i285);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 850, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 865, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 871, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 872, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 873, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 873, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 873, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 873, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 874, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 875, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 875, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 876, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i19);
  call {:cexpr "z"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 878, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 877, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 878, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 878, 66} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 878, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 880, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 880, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 880, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 880, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 880, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 880, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 880, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 881, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 882, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 883, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 23} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 25} true;
  assume {:verifier.code 0} true;
  $i76 := $eq.i32($i75, 2);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 30} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb49:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 33} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 53} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 58} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb51:
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix018_pso.opt_tmp.c:884:21: warning: over-approximating bitwise operation xor;
  $i86 := $xor.i1($i77, 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 19} true;
  assume {:verifier.code 0} true;
  $i87 := $zext.i1.i8($i86);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 885, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 886, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i90 := $zext.i1.i32($i89);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 886, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i90);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 887, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 61} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 81} true;
  assume {:verifier.code 0} true;
  $i81 := $eq.i32($i80, 0);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 86} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
  assume {:branchcond $i81} true;
  goto $bb54, $bb55;
...
$bb54:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 89} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, __unbuffered_p3_EAX);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 109} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.i32($i82, 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 114} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
  assume {:branchcond $i83} true;
  goto $bb56, $bb57;
...
$bb56:
  assume ($i83 == 1);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 117} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_p3_EBX);
  assume {:sourceloc "output/mix018_pso.opt_tmp.c", 884, 137} true;
  assume {:verifier.code 0} true;
  $i85 := $eq.i32($i84, 0);
  assume {:verifier.code 0} true;
  $i77 := $i85;
