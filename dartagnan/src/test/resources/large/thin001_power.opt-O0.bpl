...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/thin001_power.opt-O0.bpl /Users/ponce/git/Dat3M/output/thin001_power.opt_tmp.c
...
const y$w_buff0: ref;
axiom (y$w_buff0 == $sub.ref(0, 8224));
const y$w_buff1: ref;
axiom (y$w_buff1 == $sub.ref(0, 9252));
const y$w_buff0_used: ref;
axiom (y$w_buff0_used == $sub.ref(0, 10277));
const y$w_buff1_used: ref;
axiom (y$w_buff1_used == $sub.ref(0, 11302));
const y$r_buff0_thd0: ref;
axiom (y$r_buff0_thd0 == $sub.ref(0, 12327));
const y$r_buff1_thd0: ref;
axiom (y$r_buff1_thd0 == $sub.ref(0, 13352));
const y$r_buff0_thd1: ref;
axiom (y$r_buff0_thd1 == $sub.ref(0, 14377));
const y$r_buff1_thd1: ref;
axiom (y$r_buff1_thd1 == $sub.ref(0, 15402));
const y$r_buff0_thd2: ref;
axiom (y$r_buff0_thd2 == $sub.ref(0, 16427));
const y$r_buff1_thd2: ref;
axiom (y$r_buff1_thd2 == $sub.ref(0, 17452));
const y$r_buff0_thd3: ref;
axiom (y$r_buff0_thd3 == $sub.ref(0, 18477));
const y$r_buff1_thd3: ref;
axiom (y$r_buff1_thd3 == $sub.ref(0, 19502));
...
axiom (y$flush_delayed == $sub.ref(0, 22577));
const y$mem_tmp: ref;
axiom (y$mem_tmp == $sub.ref(0, 23605));
const weak$$choice1: ref;
axiom (weak$$choice1 == $sub.ref(0, 24630));
const __unbuffered_p2_EAX$read_delayed: ref;
axiom (__unbuffered_p2_EAX$read_delayed == $sub.ref(0, 25655));
const __unbuffered_p2_EAX$read_delayed_var: ref;
axiom (__unbuffered_p2_EAX$read_delayed_var == $sub.ref(0, 26687));
const main$tmp_guard0: ref;
axiom (main$tmp_guard0 == $sub.ref(0, 27712));
const main$tmp_guard1: ref;
axiom (main$tmp_guard1 == $sub.ref(0, 28737));
const __unbuffered_p2_EAX$flush_delayed: ref;
axiom (__unbuffered_p2_EAX$flush_delayed == $sub.ref(0, 29762));
const __unbuffered_p2_EAX$mem_tmp: ref;
axiom (__unbuffered_p2_EAX$mem_tmp == $sub.ref(0, 30790));
const __unbuffered_p2_EAX$r_buff0_thd0: ref;
axiom (__unbuffered_p2_EAX$r_buff0_thd0 == $sub.ref(0, 31815));
const __unbuffered_p2_EAX$r_buff0_thd1: ref;
axiom (__unbuffered_p2_EAX$r_buff0_thd1 == $sub.ref(0, 32840));
const __unbuffered_p2_EAX$r_buff0_thd2: ref;
axiom (__unbuffered_p2_EAX$r_buff0_thd2 == $sub.ref(0, 33865));
const __unbuffered_p2_EAX$r_buff0_thd3: ref;
axiom (__unbuffered_p2_EAX$r_buff0_thd3 == $sub.ref(0, 34890));
const __unbuffered_p2_EAX$r_buff1_thd0: ref;
axiom (__unbuffered_p2_EAX$r_buff1_thd0 == $sub.ref(0, 35915));
const __unbuffered_p2_EAX$r_buff1_thd1: ref;
axiom (__unbuffered_p2_EAX$r_buff1_thd1 == $sub.ref(0, 36940));
const __unbuffered_p2_EAX$r_buff1_thd2: ref;
axiom (__unbuffered_p2_EAX$r_buff1_thd2 == $sub.ref(0, 37965));
const __unbuffered_p2_EAX$r_buff1_thd3: ref;
axiom (__unbuffered_p2_EAX$r_buff1_thd3 == $sub.ref(0, 38990));
const __unbuffered_p2_EAX$w_buff0: ref;
axiom (__unbuffered_p2_EAX$w_buff0 == $sub.ref(0, 40018));
const __unbuffered_p2_EAX$w_buff0_used: ref;
axiom (__unbuffered_p2_EAX$w_buff0_used == $sub.ref(0, 41043));
const __unbuffered_p2_EAX$w_buff1: ref;
axiom (__unbuffered_p2_EAX$w_buff1 == $sub.ref(0, 42071));
const __unbuffered_p2_EAX$w_buff1_used: ref;
axiom (__unbuffered_p2_EAX$w_buff1_used == $sub.ref(0, 43096));
const y$read_delayed: ref;
axiom (y$read_delayed == $sub.ref(0, 44121));
const y$read_delayed_var: ref;
axiom (y$read_delayed_var == $sub.ref(0, 45153));
const .str: ref;
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 762, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 762, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 765, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 770, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 770, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i87: i32;
$bb0:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 777, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 777, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 780, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 780, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i2);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 781, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 1);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i8.i1($i3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff1_used, $i5);
  call {:cexpr "y$w_buff1_used"} boogie_si_record_i8($i5);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 784, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 784, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 784, 38} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
...
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 784, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 784, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/thin001_power.opt_tmp.c:784:21: warning: over-approximating bitwise operation xor;
  $i11 := $xor.i1($i8, 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 784, 21} true;
  assume {:verifier.code 1} true;
  $i12 := $zext.i1.i32($i11);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i12);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 785, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 785, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 785, 18} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i1.i8($i14);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 785, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd0, $i15);
  call {:cexpr "y$r_buff1_thd0"} boogie_si_record_i8($i15);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 786, 18} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i1.i8($i17);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 786, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd1, $i18);
  call {:cexpr "y$r_buff1_thd1"} boogie_si_record_i8($i18);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i20 := $trunc.i8.i1($i19);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i1.i8($i20);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd2, $i21);
  call {:cexpr "y$r_buff1_thd2"} boogie_si_record_i8($i21);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd3, $i24);
  call {:cexpr "y$r_buff1_thd3"} boogie_si_record_i8($i24);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd2, 1);
  call {:cexpr "y$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 790, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 7} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i26 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i8.i1($i31);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i32} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i28 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 42} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 7} true;
  assume {:verifier.code 0} true;
  $i30 := $i29;
  goto $bb9;
...
$bb9:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i30);
  call {:cexpr "y"} boogie_si_record_i32($i30);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i32 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 73} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 73} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 55} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 102} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i34 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 90} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i36 := $i35;
  goto $bb15;
...
$bb16:
  assume ($i39 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 66} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 66} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i8.i1($i43);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 66} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, $i47);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8($i47);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i49 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i53 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 102} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 102} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 102} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff1_used, $i61);
  call {:cexpr "y$w_buff1_used"} boogie_si_record_i8($i61);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i63 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i65 := $trunc.i8.i1($i64);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 20} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 66} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 66} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 66} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i70 := $ne.i32($i66, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  $i71 := $zext.i1.i8($i70);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd2, $i71);
  call {:cexpr "y$r_buff0_thd2"} boogie_si_record_i8($i71);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i73 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 38} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 38} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 56} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 56} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i77 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 102} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 102} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 102} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i84 := $ne.i32($i80, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  $i85 := $zext.i1.i8($i84);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd2, $i85);
  call {:cexpr "y$r_buff1_thd2"} boogie_si_record_i8($i85);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 797, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 799, 22} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 799, 39} true;
  assume {:verifier.code 0} true;
  $i87 := $add.i32($i86, 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 799, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i87);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i87);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i375: i32;
$bb0:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 806, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 806, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 806, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 807, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 807, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 807, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 808, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 808, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 808, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 808, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 809, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 809, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i8);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 810, 19} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i9);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 810, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 810, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 30} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 45} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb4, $bb5;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i14);
  call {:cexpr "y"} boogie_si_record_i32($i14);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 15} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 48} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 78} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 78} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 93} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i18 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 65} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i22 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 97} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 97} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 112} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 216} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 216} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 231} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i24 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 115} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 115} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 130} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i26 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 134} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume !(($i28 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 152} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i30 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 168} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 152} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i30 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 173} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i34 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 189} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume !(($i34 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 201} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume ($i40 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 234} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 234} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 249} true;
  assume {:verifier.code 0} true;
...
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 331} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i42 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 252} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 252} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i8.i1($i43);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 267} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i44 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 271} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 271} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 216} true;
...
$bb34:
  assume !(($i46 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 289} true;
  assume {:verifier.code 0} true;
...
$bb35:
  assume ($i48 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 305} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i48 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 317} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i54 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 347} true;
  assume {:verifier.code 0} true;
...
$bb40:
  assume !(($i54 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 359} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 811, 331} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume ($i59 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 31} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume !(($i59 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 45} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 45} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 44} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb45, $bb46;
$bb44:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i61);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i61);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 15} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume ($i63 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 75} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 75} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i67} true;
  goto $bb48, $bb49;
$bb46:
  assume !(($i63 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 62} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume ($i67 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 93} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 93} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 75} true;
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 123} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 123} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb54, $bb55;
$bb51:
  assume ($i69 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 110} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume ($i73 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 142} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 142} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 157} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i75} true;
  goto $bb57, $bb58;
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 209} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 209} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 224} true;
  assume {:verifier.code 0} true;
...
$bb58:
  assume !(($i75 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 160} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 160} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb59, $bb60;
$bb59:
  assume ($i77 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 179} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 179} true;
  assume {:verifier.code 0} true;
  $i79 := $trunc.i8.i1($i78);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 123} true;
...
$bb62:
  assume !(($i79 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 196} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i83 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 227} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 227} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 242} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 293} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i85 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 245} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 245} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 260} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i87 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 264} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 264} true;
  assume {:verifier.code 0} true;
  $i89 := $trunc.i8.i1($i88);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 209} true;
...
$bb72:
  assume !(($i89 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 812, 281} true;
  assume {:verifier.code 0} true;
...
$bb74:
  assume ($i94 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 31} true;
  assume {:verifier.code 0} true;
...
$bb75:
  assume !(($i94 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 45} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 45} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 44} true;
  assume {:verifier.code 0} true;
...
$bb76:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i96);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i96);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
...
$bb77:
  assume ($i98 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 75} true;
  assume {:verifier.code 0} true;
  $i101 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 75} true;
  assume {:verifier.code 0} true;
  $i102 := $trunc.i8.i1($i101);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  goto $bb80, $bb81;
$bb78:
  assume !(($i98 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 62} true;
  assume {:verifier.code 0} true;
...
$bb80:
  assume ($i102 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 93} true;
  assume {:verifier.code 0} true;
  $i103 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 93} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 123} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 123} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i108} true;
  goto $bb86, $bb87;
$bb83:
  assume ($i104 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 110} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i108 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 142} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 142} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 157} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 209} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 209} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 224} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume !(($i110 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 160} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 160} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb91, $bb92;
$bb91:
  assume ($i112 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 179} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i114 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 196} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i118 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 227} true;
  assume {:verifier.code 0} true;
  $i119 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 227} true;
  assume {:verifier.code 0} true;
  $i120 := $trunc.i8.i1($i119);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 242} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 293} true;
  assume {:verifier.code 0} true;
...
$bb99:
  assume ($i120 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 245} true;
  assume {:verifier.code 0} true;
  $i121 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 245} true;
  assume {:verifier.code 0} true;
  $i122 := $trunc.i8.i1($i121);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 260} true;
  assume {:verifier.code 0} true;
...
$bb101:
  assume ($i122 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 264} true;
  assume {:verifier.code 0} true;
  $i123 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 264} true;
  assume {:verifier.code 0} true;
...
$bb104:
  assume !(($i124 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 813, 281} true;
  assume {:verifier.code 0} true;
...
$bb106:
  assume ($i129 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 36} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume !(($i129 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 55} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 54} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i133, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i135 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 90} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 90} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb112, $bb113;
$bb110:
  assume !(($i135 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 72} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i141 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 108} true;
  assume {:verifier.code 0} true;
...
$bb113:
  ...
  goto $bb114;
$bb114:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 137} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 137} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 152} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i146 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 156} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 156} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 171} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 245} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 245} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 260} true;
  assume {:verifier.code 0} true;
...
$bb122:
  assume !(($i148 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 174} true;
  assume {:verifier.code 0} true;
  $i149 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 174} true;
  assume {:verifier.code 0} true;
  $i150 := $trunc.i8.i1($i149);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i150} true;
  goto $bb123, $bb124;
$bb123:
  assume ($i150 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 193} true;
  assume {:verifier.code 0} true;
  $i151 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 193} true;
  assume {:verifier.code 0} true;
...
$bb126:
  assume !(($i152 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 210} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, weak$$choice0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 210} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 224} true;
  assume {:verifier.code 0} true;
  $i155 := 1;
...
$bb129:
  assume !(($i154 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 228} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, weak$$choice1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 228} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 227} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin001_power.opt_tmp.c:814:227: warning: over-approximating bitwise operation xor;
  $i158 := $xor.i1($i157, 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 224} true;
  assume {:verifier.code 0} true;
  $i155 := $i158;
...
$bb131:
  assume ($i162 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 263} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 263} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 278} true;
  assume {:verifier.code 0} true;
...
$bb132:
  ...
  goto $bb133;
$bb133:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 333} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume ($i164 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 281} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 281} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 296} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i166 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 300} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i168 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 814, 317} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i179 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 36} true;
  assume {:verifier.code 0} true;
...
$bb142:
  assume !(($i179 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 54} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i183, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
...
$bb144:
  assume ($i185 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 90} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 90} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb147, $bb148;
$bb145:
  assume !(($i185 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 72} true;
  assume {:verifier.code 0} true;
...
$bb147:
  assume ($i191 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 108} true;
  assume {:verifier.code 0} true;
  $i192 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 108} true;
  assume {:verifier.code 0} true;
...
$bb148:
  ...
  goto $bb149;
$bb149:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 137} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 137} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 152} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i196 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 156} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 156} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 171} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  goto $bb155;
$bb155:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 227} true;
  assume {:verifier.code 0} true;
  $i207 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 227} true;
  assume {:verifier.code 0} true;
  $i208 := $trunc.i8.i1($i207);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 242} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb157:
  assume !(($i198 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 174} true;
  assume {:verifier.code 0} true;
  $i199 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 174} true;
  assume {:verifier.code 0} true;
  $i200 := $trunc.i8.i1($i199);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i200} true;
  goto $bb158, $bb159;
$bb158:
  assume ($i200 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 193} true;
  assume {:verifier.code 0} true;
  $i201 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 193} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume !(($i202 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 210} true;
  assume {:verifier.code 0} true;
...
$bb163:
  assume ($i208 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 245} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 245} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 260} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb166:
  assume ($i211 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 263} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 263} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 278} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb168:
  assume ($i213 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 282} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 282} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 815, 281} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin001_power.opt_tmp.c:815:281: warning: over-approximating bitwise operation xor;
  $i216 := $xor.i1($i215, 1);
  assume {:verifier.code 0} true;
  $i209 := $i216;
  goto $bb165;
...
$bb170:
  assume ($i221 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 36} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume !(($i221 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 54} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i225, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  $i261 := $zext.i1.i8($i260);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd3, $i261);
  call {:cexpr "y$r_buff0_thd3"} boogie_si_record_i8($i261);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
...
$bb173:
  assume ($i227 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 90} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 90} true;
  assume {:verifier.code 0} true;
  $i233 := $trunc.i8.i1($i232);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i233} true;
  goto $bb176, $bb177;
$bb174:
  assume !(($i227 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 72} true;
  assume {:verifier.code 0} true;
...
$bb176:
  assume ($i233 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 108} true;
  assume {:verifier.code 0} true;
  $i234 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 108} true;
  assume {:verifier.code 0} true;
...
$bb177:
  ...
  goto $bb178;
$bb178:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 137} true;
  assume {:verifier.code 0} true;
  $i237 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 137} true;
  assume {:verifier.code 0} true;
  $i238 := $trunc.i8.i1($i237);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 152} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume ($i238 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 156} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 156} true;
  assume {:verifier.code 0} true;
  $i240 := $trunc.i8.i1($i239);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 171} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  goto $bb184;
$bb184:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 228} true;
  assume {:verifier.code 0} true;
  $i249 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 228} true;
  assume {:verifier.code 0} true;
  $i250 := $trunc.i8.i1($i249);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 243} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb186:
  assume !(($i240 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 174} true;
  assume {:verifier.code 0} true;
  $i241 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 174} true;
  assume {:verifier.code 0} true;
  $i242 := $trunc.i8.i1($i241);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i242} true;
  goto $bb187, $bb188;
$bb187:
  assume ($i242 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 193} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 193} true;
  assume {:verifier.code 0} true;
...
$bb190:
  assume !(($i244 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 210} true;
  assume {:verifier.code 0} true;
...
$bb192:
  assume ($i250 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 246} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 246} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 261} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb195:
  assume ($i253 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 264} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 264} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 279} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb197:
  assume ($i255 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 283} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 283} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 816, 282} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin001_power.opt_tmp.c:816:282: warning: over-approximating bitwise operation xor;
  $i258 := $xor.i1($i257, 1);
  assume {:verifier.code 0} true;
  $i251 := $i258;
  goto $bb194;
...
$bb199:
  assume ($i263 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 36} true;
  assume {:verifier.code 0} true;
  $i264 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 36} true;
  assume {:verifier.code 0} true;
...
$bb200:
  assume !(($i263 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 55} true;
  assume {:verifier.code 0} true;
  $i268 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 55} true;
  assume {:verifier.code 0} true;
  $i269 := $trunc.i8.i1($i268);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 54} true;
  assume {:verifier.code 0} true;
...
$bb201:
  ...
  assume {:verifier.code 0} true;
  $i305 := $ne.i32($i267, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  $i306 := $zext.i1.i8($i305);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd3, $i306);
  call {:cexpr "y$r_buff1_thd3"} boogie_si_record_i8($i306);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 818, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p2_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p2_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 819, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p2_EAX$read_delayed_var, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 820, 25} true;
  assume {:verifier.code 0} true;
  $i307 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 820, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i307);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i307);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 821, 7} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume ($i269 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 90} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 90} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i275} true;
  goto $bb205, $bb206;
$bb203:
  assume !(($i269 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 72} true;
  assume {:verifier.code 0} true;
  $i270 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 72} true;
  assume {:verifier.code 0} true;
...
$bb205:
  assume ($i275 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 108} true;
  assume {:verifier.code 0} true;
  $i276 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 108} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  goto $bb207;
$bb207:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 137} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 137} true;
  assume {:verifier.code 0} true;
  $i280 := $trunc.i8.i1($i279);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 152} true;
  assume {:verifier.code 0} true;
...
$bb211:
  assume ($i280 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 156} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 156} true;
  assume {:verifier.code 0} true;
  $i282 := $trunc.i8.i1($i281);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 171} true;
  assume {:verifier.code 0} true;
...
$bb212:
  ...
  goto $bb213;
$bb213:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 257} true;
  assume {:verifier.code 0} true;
  $i294 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 257} true;
  assume {:verifier.code 0} true;
  $i295 := $trunc.i8.i1($i294);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 272} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb215:
  assume !(($i282 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 174} true;
  assume {:verifier.code 0} true;
  $i283 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 174} true;
  assume {:verifier.code 0} true;
  $i284 := $trunc.i8.i1($i283);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i284} true;
  goto $bb216, $bb217;
$bb216:
  assume ($i284 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 193} true;
  assume {:verifier.code 0} true;
  $i285 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 193} true;
  assume {:verifier.code 0} true;
...
$bb219:
  assume !(($i286 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 211} true;
  assume {:verifier.code 0} true;
...
$bb220:
  assume ($i288 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 227} true;
  assume {:verifier.code 0} true;
...
$bb224:
  assume ($i295 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 275} true;
  assume {:verifier.code 0} true;
  $i297 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 275} true;
  assume {:verifier.code 0} true;
  $i298 := $trunc.i8.i1($i297);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 290} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb227:
  assume ($i298 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 293} true;
  assume {:verifier.code 0} true;
  $i299 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 293} true;
  assume {:verifier.code 0} true;
  $i300 := $trunc.i8.i1($i299);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 308} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb229:
  assume ($i300 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 312} true;
  assume {:verifier.code 0} true;
  $i301 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 312} true;
  assume {:verifier.code 0} true;
  $i302 := $trunc.i8.i1($i301);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 817, 311} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin001_power.opt_tmp.c:817:311: warning: over-approximating bitwise operation xor;
  $i303 := $xor.i1($i302, 1);
  assume {:verifier.code 0} true;
  $i296 := $i303;
  goto $bb226;
...
$bb231:
  assume ($i309 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 821, 25} true;
  assume {:verifier.code 0} true;
...
$bb232:
  assume !(($i309 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 821, 37} true;
  assume {:verifier.code 0} true;
  $i312 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 821, 7} true;
  assume {:verifier.code 0} true;
...
$bb233:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 821, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 821, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i311);
  call {:cexpr "y"} boogie_si_record_i32($i311);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 822, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 825, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 826, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 827, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 7} true;
  assume {:verifier.code 0} true;
  $i313 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 7} true;
  assume {:verifier.code 0} true;
  $i314 := $trunc.i8.i1($i313);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i314} true;
  goto $bb234, $bb235;
$bb234:
  assume ($i314 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 25} true;
  assume {:verifier.code 0} true;
  $i315 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 25} true;
  assume {:verifier.code 0} true;
...
$bb235:
  ...
  goto $bb236;
$bb236:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 55} true;
  assume {:verifier.code 0} true;
  $i319 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 55} true;
  assume {:verifier.code 0} true;
  $i320 := $trunc.i8.i1($i319);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i320} true;
  goto $bb240, $bb241;
$bb237:
  assume ($i316 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 42} true;
  assume {:verifier.code 0} true;
  $i317 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 7} true;
  assume {:verifier.code 0} true;
  $i318 := $i317;
  goto $bb239;
...
$bb239:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i318);
  call {:cexpr "y"} boogie_si_record_i32($i318);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 829, 20} true;
  assume {:verifier.code 0} true;
  $i326 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 829, 20} true;
  assume {:verifier.code 0} true;
  $i327 := $trunc.i8.i1($i326);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 829, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i327} true;
  goto $bb246, $bb247;
$bb240:
  assume ($i320 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 73} true;
  assume {:verifier.code 0} true;
  $i321 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 73} true;
  assume {:verifier.code 0} true;
...
$bb241:
  ...
  goto $bb242;
$bb242:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 102} true;
  assume {:verifier.code 0} true;
  $i325 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 55} true;
  assume {:verifier.code 0} true;
...
$bb243:
  assume ($i322 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 90} true;
  assume {:verifier.code 0} true;
  $i323 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 828, 55} true;
  assume {:verifier.code 0} true;
  $i324 := $i323;
  goto $bb245;
...
$bb246:
  assume ($i327 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 829, 38} true;
  assume {:verifier.code 0} true;
  $i328 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 829, 38} true;
  assume {:verifier.code 0} true;
...
$bb247:
  ...
  goto $bb248;
$bb248:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 829, 66} true;
  assume {:verifier.code 0} true;
...
$bb251:
  ...
  assume {:verifier.code 0} true;
  $i334 := $ne.i32($i330, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 829, 18} true;
  assume {:verifier.code 0} true;
  $i335 := $zext.i1.i8($i334);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 829, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, $i335);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8($i335);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 20} true;
  assume {:verifier.code 0} true;
  $i336 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 20} true;
  assume {:verifier.code 0} true;
  $i337 := $trunc.i8.i1($i336);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i337} true;
  goto $bb252, $bb253;
$bb252:
  assume ($i337 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 38} true;
  assume {:verifier.code 0} true;
  $i338 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 38} true;
  assume {:verifier.code 0} true;
  $i339 := $trunc.i8.i1($i338);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 53} true;
  assume {:verifier.code 0} true;
...
$bb253:
  ...
  goto $bb254;
$bb254:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 56} true;
  assume {:verifier.code 0} true;
  $i340 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 56} true;
  assume {:verifier.code 0} true;
  $i341 := $trunc.i8.i1($i340);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 71} true;
  assume {:verifier.code 0} true;
...
$bb258:
  assume ($i341 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 74} true;
  assume {:verifier.code 0} true;
  $i342 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 74} true;
  assume {:verifier.code 0} true;
...
$bb259:
  ...
  goto $bb260;
$bb260:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 102} true;
  assume {:verifier.code 0} true;
  $i345 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 102} true;
  assume {:verifier.code 0} true;
...
$bb263:
  ...
  assume {:verifier.code 0} true;
  $i348 := $ne.i32($i344, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 830, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 831, 20} true;
  assume {:verifier.code 0} true;
  $i350 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 831, 20} true;
  assume {:verifier.code 0} true;
  $i351 := $trunc.i8.i1($i350);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 831, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i351} true;
  goto $bb264, $bb265;
$bb264:
  assume ($i351 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 831, 38} true;
  assume {:verifier.code 0} true;
...
$bb265:
  ...
  goto $bb266;
$bb266:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 831, 66} true;
  assume {:verifier.code 0} true;
  $i355 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 831, 66} true;
  assume {:verifier.code 0} true;
...
$bb269:
  ...
  assume {:verifier.code 0} true;
  $i358 := $ne.i32($i354, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 831, 18} true;
  assume {:verifier.code 0} true;
  $i359 := $zext.i1.i8($i358);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 831, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd3, $i359);
  call {:cexpr "y$r_buff0_thd3"} boogie_si_record_i8($i359);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
  $i360 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
  $i361 := $trunc.i8.i1($i360);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i361} true;
  goto $bb270, $bb271;
$bb270:
  assume ($i361 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 38} true;
  assume {:verifier.code 0} true;
  $i362 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 38} true;
  assume {:verifier.code 0} true;
  $i363 := $trunc.i8.i1($i362);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 53} true;
  assume {:verifier.code 0} true;
...
$bb271:
  ...
  goto $bb272;
$bb272:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 56} true;
  assume {:verifier.code 0} true;
  $i364 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 56} true;
  assume {:verifier.code 0} true;
  $i365 := $trunc.i8.i1($i364);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 71} true;
  assume {:verifier.code 0} true;
...
$bb276:
  assume ($i365 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 74} true;
  assume {:verifier.code 0} true;
  $i366 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 74} true;
  assume {:verifier.code 0} true;
...
$bb277:
  ...
  goto $bb278;
$bb278:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
  $i369 := $load.i8($M.0, y$r_buff1_thd3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
...
$bb281:
  ...
  assume {:verifier.code 0} true;
  $i372 := $ne.i32($i368, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 18} true;
  assume {:verifier.code 0} true;
  $i373 := $zext.i1.i8($i372);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 832, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd3, $i373);
  call {:cexpr "y$r_buff1_thd3"} boogie_si_record_i8($i373);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 833, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 835, 22} true;
  assume {:verifier.code 0} true;
  $i374 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 835, 39} true;
  assume {:verifier.code 0} true;
  $i375 := $add.i32($i374, 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 835, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i375);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i375);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 836, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 853, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 855, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 856, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 857, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 857, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 857, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 857, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 858, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 859, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 859, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 860, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i17);
  call {:cexpr "y"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 862, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 862, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 862, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 861, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 862, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 862, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 862, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 862, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 863, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 864, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 864, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 864, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 864, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 864, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 864, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 864, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 865, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 866, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 868, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 868, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 868, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 869, 25} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume ($i76 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 869, 61} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume !(($i76 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 869, 140} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume ($i78 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 869, 78} true;
  assume {:verifier.code 0} true;
  $p79 := $load.ref($M.0, __unbuffered_p2_EAX$read_delayed_var);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 869, 77} true;
  assume {:verifier.code 0} true;
...
$bb52:
  assume !(($i78 == 1));
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 869, 117} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 869, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 869, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i83);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i83);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 23} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 43} true;
  assume {:verifier.code 0} true;
  $i86 := $eq.i32($i85, 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 48} true;
  assume {:verifier.code 0} true;
  $i87 := 0;
...
$bb55:
  assume ($i86 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 51} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 71} true;
  assume {:verifier.code 0} true;
  $i89 := $eq.i32($i88, 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 76} true;
  assume {:verifier.code 0} true;
  $i87 := 0;
  assume {:branchcond $i89} true;
  goto $bb58, $bb59;
...
$bb57:
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin001_power.opt_tmp.c:870:21: warning: over-approximating bitwise operation xor;
  $i92 := $xor.i1($i87, 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 19} true;
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i8($i92);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 871, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 872, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i96 := $zext.i1.i32($i95);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 872, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i96);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 873, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb58:
  assume ($i89 == 1);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 79} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/thin001_power.opt_tmp.c", 870, 99} true;
  assume {:verifier.code 0} true;
  $i91 := $eq.i32($i90, 1);
  assume {:verifier.code 0} true;
  $i87 := $i91;
