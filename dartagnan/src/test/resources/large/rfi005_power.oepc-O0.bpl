...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/rfi005_power.oepc-O0.bpl /Users/ponce/git/Dat3M/output/rfi005_power.oepc_tmp.c
...
axiom (y$read_delayed == $sub.ref(0, 23602));
const y$read_delayed_var: ref;
axiom (y$read_delayed_var == $sub.ref(0, 24634));
const .str: ref;
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i197: i32;
$bb0:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 740, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 740, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 741, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 743, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 746, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 746, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 746, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 747, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 747, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 747, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 748, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 748, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 748, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 748, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 749, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 749, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i8);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i20);
  call {:cexpr "y"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 750, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i31);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 751, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i54);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 752, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 753, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 754, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 755, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 757, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 757, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i190);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 758, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 756, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 758, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 758, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 758, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 758, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 758, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i194);
  call {:cexpr "y"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 759, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 764, 22} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 764, 39} true;
  assume {:verifier.code 0} true;
  $i197 := $add.i32($i196, 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 764, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i197);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i197);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i299: i32;
$bb0:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 770, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 770, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 771, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 771, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i1);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 772, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 1);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 774, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 775, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 775, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 775, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 775, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 775, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/rfi005_power.oepc_tmp.c:775:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 775, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 775, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 777, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 777, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 777, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 777, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 778, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 778, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 778, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 778, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd2, 1);
  call {:cexpr "y$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 782, 15} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 782, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i21);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 783, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 2);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 785, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 786, 23} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 786, 23} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 786, 38} true;
  assume {:verifier.code 0} true;
  $i27 := 0;
...
$bb4:
  assume ($i26 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 786, 41} true;
  assume {:verifier.code 1} true;
...
$bb6:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 786, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/rfi005_power.oepc_tmp.c:786:21: warning: over-approximating bitwise operation xor;
  $i30 := $xor.i1($i27, 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 786, 21} true;
  assume {:verifier.code 1} true;
  $i31 := $zext.i1.i32($i30);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 786, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i31);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i1.i8($i39);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd2, 1);
  call {:cexpr "y$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 793, 19} true;
  assume {:verifier.code 1} true;
  call $i41 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i41);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 793, 17} true;
  assume {:verifier.code 0} true;
  $i42 := $zext.i1.i8($i41);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 793, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 794, 19} true;
  assume {:verifier.code 1} true;
  call $i43 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i43);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 794, 17} true;
  assume {:verifier.code 0} true;
  $i44 := $zext.i1.i8($i43);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 794, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 795, 21} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 795, 21} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 795, 19} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 795, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 796, 15} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 796, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i48);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i48);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 8} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 8} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb7, $bb8;
$bb7:
  assume ($i50 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 27} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 27} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 42} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb10, $bb12;
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 101} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 7} true;
  assume {:verifier.code 0} true;
  $i60 := $i59;
  goto $bb20;
$bb10:
  ...
  goto $bb11;
$bb11:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 65} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 65} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i56} true;
  goto $bb15, $bb17;
$bb12:
  assume !(($i52 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 46} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 46} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 61} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 106} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 106} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb21, $bb22;
$bb17:
  assume !(($i56 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 84} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i60);
  call {:cexpr "y"} boogie_si_record_i32($i60);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 15} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i62 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 124} true;
  assume {:verifier.code 0} true;
...
$bb22:
  ...
  goto $bb23;
$bb23:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 153} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i64 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 797, 141} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i69 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 31} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume !(($i69 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 45} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 45} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 60} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i71);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i71);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 15} true;
  assume {:verifier.code 0} true;
...
$bb30:
  assume ($i73 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 64} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 64} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 79} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i75} true;
  goto $bb33, $bb35;
$bb31:
  ...
  goto $bb32;
$bb32:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 138} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 44} true;
  assume {:verifier.code 0} true;
  $i83 := $i82;
  goto $bb43;
$bb33:
  ...
  goto $bb34;
$bb34:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 102} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 102} true;
  assume {:verifier.code 0} true;
  $i79 := $trunc.i8.i1($i78);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i79} true;
  goto $bb38, $bb40;
$bb35:
  assume !(($i75 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 83} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 83} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 98} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 151} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 151} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i85} true;
  goto $bb44, $bb45;
$bb40:
  assume !(($i79 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 121} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i85 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 169} true;
  assume {:verifier.code 0} true;
...
$bb45:
  ...
  goto $bb46;
$bb46:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 198} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i87 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 798, 186} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume ($i92 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 31} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume !(($i92 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 45} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 45} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 60} true;
  assume {:verifier.code 0} true;
...
$bb52:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i94);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i94);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 20} true;
  assume {:verifier.code 0} true;
...
$bb53:
  assume ($i96 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 64} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 64} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 79} true;
  assume {:verifier.code 0} true;
...
$bb54:
  ...
  goto $bb55;
$bb55:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 138} true;
  assume {:verifier.code 0} true;
  $i105 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 44} true;
  assume {:verifier.code 0} true;
  $i106 := $i105;
  goto $bb66;
$bb56:
  ...
  goto $bb57;
$bb57:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 102} true;
  assume {:verifier.code 0} true;
  $i101 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 102} true;
  assume {:verifier.code 0} true;
  $i102 := $trunc.i8.i1($i101);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  goto $bb61, $bb63;
$bb58:
  assume !(($i98 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 83} true;
  assume {:verifier.code 0} true;
  $i99 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 83} true;
  assume {:verifier.code 0} true;
  $i100 := $trunc.i8.i1($i99);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 98} true;
  assume {:verifier.code 0} true;
...
$bb61:
  ...
  goto $bb62;
$bb62:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 151} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 151} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i108} true;
  goto $bb67, $bb68;
$bb63:
  assume !(($i102 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 121} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i108 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 169} true;
  assume {:verifier.code 0} true;
...
$bb68:
  ...
  goto $bb69;
$bb69:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 198} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i110 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 799, 186} true;
  assume {:verifier.code 0} true;
...
$bb73:
  assume ($i115 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 36} true;
  assume {:verifier.code 0} true;
...
$bb74:
  assume !(($i115 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 55} true;
  assume {:verifier.code 0} true;
  $i120 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 55} true;
  assume {:verifier.code 0} true;
  $i121 := $trunc.i8.i1($i120);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 70} true;
  assume {:verifier.code 0} true;
...
$bb75:
  ...
  assume {:verifier.code 0} true;
  $i142 := $ne.i32($i119, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 20} true;
  assume {:verifier.code 0} true;
...
$bb76:
  assume ($i121 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 74} true;
  assume {:verifier.code 0} true;
  $i122 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 74} true;
  assume {:verifier.code 0} true;
  $i123 := $trunc.i8.i1($i122);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 89} true;
  assume {:verifier.code 0} true;
...
$bb77:
  ...
  goto $bb78;
$bb78:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 54} true;
  assume {:verifier.code 0} true;
  $i133 := $i132;
  goto $bb89;
$bb79:
  ...
  goto $bb80;
$bb80:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 112} true;
  assume {:verifier.code 0} true;
  $i126 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 112} true;
  assume {:verifier.code 0} true;
  $i127 := $trunc.i8.i1($i126);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i127} true;
  goto $bb84, $bb86;
$bb81:
  assume !(($i123 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 93} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 93} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i125} true;
  goto $bb82, $bb83;
$bb82:
...
$bb84:
  ...
  goto $bb85;
$bb85:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 166} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 166} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i135} true;
  goto $bb90, $bb91;
$bb86:
  assume !(($i127 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 131} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i135 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 184} true;
  assume {:verifier.code 0} true;
...
$bb91:
  ...
  goto $bb92;
$bb92:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 800, 212} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i145 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 36} true;
  assume {:verifier.code 0} true;
...
$bb97:
  assume !(($i145 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i150 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i151 := $trunc.i8.i1($i150);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 70} true;
  assume {:verifier.code 0} true;
...
$bb98:
  ...
  assume {:verifier.code 0} true;
  $i170 := $ne.i32($i149, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
...
$bb99:
  assume ($i151 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 74} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 74} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb102, $bb104;
$bb100:
  ...
  goto $bb101;
$bb101:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 54} true;
  assume {:verifier.code 0} true;
  $i163 := $i162;
  goto $bb112;
$bb102:
  ...
  goto $bb103;
$bb103:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 112} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 112} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i157} true;
  goto $bb107, $bb109;
$bb104:
  assume !(($i153 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 93} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 93} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i155} true;
  goto $bb105, $bb106;
$bb105:
...
$bb107:
  ...
  goto $bb108;
$bb108:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 166} true;
  assume {:verifier.code 0} true;
  $i164 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 166} true;
  assume {:verifier.code 0} true;
  $i165 := $trunc.i8.i1($i164);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 181} true;
  assume {:verifier.code 0} true;
  $i166 := 0;
...
$bb109:
  assume !(($i157 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 131} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i165 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 801, 184} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume ($i173 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 36} true;
  assume {:verifier.code 0} true;
...
$bb117:
  assume !(($i173 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 55} true;
  assume {:verifier.code 0} true;
  $i178 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 55} true;
  assume {:verifier.code 0} true;
  $i179 := $trunc.i8.i1($i178);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 70} true;
  assume {:verifier.code 0} true;
...
$bb118:
  ...
  assume {:verifier.code 0} true;
  $i200 := $ne.i32($i177, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
...
$bb119:
  assume ($i179 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 74} true;
  assume {:verifier.code 0} true;
  $i180 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 74} true;
  assume {:verifier.code 0} true;
  $i181 := $trunc.i8.i1($i180);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 89} true;
  assume {:verifier.code 0} true;
...
$bb120:
  ...
  goto $bb121;
$bb121:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 54} true;
  assume {:verifier.code 0} true;
  $i191 := $i190;
  goto $bb132;
$bb122:
  ...
  goto $bb123;
$bb123:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 112} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 112} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i185} true;
  goto $bb127, $bb129;
$bb124:
  assume !(($i181 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 93} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 93} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i183} true;
  goto $bb125, $bb126;
$bb125:
...
$bb127:
  ...
  goto $bb128;
$bb128:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 166} true;
  assume {:verifier.code 0} true;
  $i192 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 166} true;
  assume {:verifier.code 0} true;
  $i193 := $trunc.i8.i1($i192);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i193} true;
  goto $bb133, $bb134;
$bb129:
  assume !(($i185 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 131} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i193 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 184} true;
  assume {:verifier.code 0} true;
...
$bb134:
  ...
  goto $bb135;
$bb135:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 802, 212} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume ($i203 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 36} true;
  assume {:verifier.code 0} true;
...
$bb140:
  assume !(($i203 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 55} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 55} true;
  assume {:verifier.code 0} true;
  $i209 := $trunc.i8.i1($i208);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 70} true;
  assume {:verifier.code 0} true;
...
$bb141:
  ...
  assume {:verifier.code 0} true;
  $i228 := $ne.i32($i207, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 804, 25} true;
  assume {:verifier.code 0} true;
  $i230 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 804, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i230);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i230);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 805, 7} true;
  assume {:verifier.code 0} true;
...
$bb142:
  assume ($i209 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 74} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 74} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 89} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  goto $bb144;
$bb144:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 54} true;
  assume {:verifier.code 0} true;
  $i221 := $i220;
  goto $bb155;
$bb145:
  ...
  goto $bb146;
$bb146:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 112} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 112} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i215} true;
  goto $bb150, $bb152;
$bb147:
  assume !(($i211 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 93} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 93} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 108} true;
  assume {:verifier.code 0} true;
...
$bb150:
  ...
  goto $bb151;
$bb151:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 166} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 166} true;
  assume {:verifier.code 0} true;
  $i223 := $trunc.i8.i1($i222);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 181} true;
  assume {:verifier.code 0} true;
  $i224 := 0;
...
$bb152:
  assume !(($i215 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 131} true;
  assume {:verifier.code 0} true;
...
$bb156:
  assume ($i223 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 803, 184} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume ($i232 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 805, 25} true;
  assume {:verifier.code 0} true;
...
$bb160:
  assume !(($i232 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 805, 37} true;
  assume {:verifier.code 0} true;
  $i235 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 805, 7} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 805, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 805, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i234);
  call {:cexpr "y"} boogie_si_record_i32($i234);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 806, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 809, 25} true;
  assume {:verifier.code 0} true;
  $i236 := $load.i32($M.0, x);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 809, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i236);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i236);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 7} true;
  assume {:verifier.code 0} true;
  $i237 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 7} true;
  assume {:verifier.code 0} true;
  $i238 := $trunc.i8.i1($i237);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i238} true;
  goto $bb162, $bb163;
$bb162:
  assume ($i238 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 25} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 25} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 55} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 55} true;
  assume {:verifier.code 0} true;
  $i244 := $trunc.i8.i1($i243);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i244} true;
  goto $bb168, $bb169;
$bb165:
  assume ($i240 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 42} true;
  assume {:verifier.code 0} true;
  $i241 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 7} true;
  assume {:verifier.code 0} true;
  $i242 := $i241;
  goto $bb167;
...
$bb167:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i242);
  call {:cexpr "y"} boogie_si_record_i32($i242);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $i250 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $i251 := $trunc.i8.i1($i250);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 813, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i251} true;
  goto $bb174, $bb175;
$bb168:
  assume ($i244 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 73} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 73} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 102} true;
  assume {:verifier.code 0} true;
  $i249 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 55} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume ($i246 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 90} true;
  assume {:verifier.code 0} true;
  $i247 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 812, 55} true;
  assume {:verifier.code 0} true;
  $i248 := $i247;
  goto $bb173;
...
$bb174:
  assume ($i251 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 813, 38} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 813, 66} true;
  assume {:verifier.code 0} true;
  $i255 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 813, 66} true;
  assume {:verifier.code 0} true;
...
$bb179:
  ...
  assume {:verifier.code 0} true;
  $i258 := $ne.i32($i254, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  $i259 := $zext.i1.i8($i258);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, $i259);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8($i259);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
  $i260 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
  $i261 := $trunc.i8.i1($i260);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i261} true;
  goto $bb180, $bb181;
$bb180:
  assume ($i261 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 38} true;
  assume {:verifier.code 0} true;
  $i262 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 38} true;
  assume {:verifier.code 0} true;
  $i263 := $trunc.i8.i1($i262);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 53} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 56} true;
  assume {:verifier.code 0} true;
  $i264 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 56} true;
  assume {:verifier.code 0} true;
  $i265 := $trunc.i8.i1($i264);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 71} true;
  assume {:verifier.code 0} true;
...
$bb186:
  assume ($i265 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 74} true;
  assume {:verifier.code 0} true;
  $i266 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 74} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 102} true;
  assume {:verifier.code 0} true;
  $i269 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 102} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i272 := $ne.i32($i268, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  $i273 := $zext.i1.i8($i272);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff1_used, $i273);
  call {:cexpr "y$w_buff1_used"} boogie_si_record_i8($i273);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 815, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i275} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i275 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 815, 38} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 815, 66} true;
  assume {:verifier.code 0} true;
...
$bb197:
  ...
  assume {:verifier.code 0} true;
  $i282 := $ne.i32($i278, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  $i283 := $zext.i1.i8($i282);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd2, $i283);
  call {:cexpr "y$r_buff0_thd2"} boogie_si_record_i8($i283);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $i284 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $i285 := $trunc.i8.i1($i284);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i285} true;
  goto $bb198, $bb199;
$bb198:
  assume ($i285 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 38} true;
  assume {:verifier.code 0} true;
  $i286 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 38} true;
  assume {:verifier.code 0} true;
  $i287 := $trunc.i8.i1($i286);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 53} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 56} true;
  assume {:verifier.code 0} true;
  $i288 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 56} true;
  assume {:verifier.code 0} true;
  $i289 := $trunc.i8.i1($i288);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 71} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume ($i289 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 74} true;
  assume {:verifier.code 0} true;
  $i290 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 74} true;
  assume {:verifier.code 0} true;
...
$bb205:
  ...
  goto $bb206;
$bb206:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 102} true;
  assume {:verifier.code 0} true;
  $i293 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 102} true;
  assume {:verifier.code 0} true;
...
$bb209:
  ...
  assume {:verifier.code 0} true;
  $i296 := $ne.i32($i292, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  $i297 := $zext.i1.i8($i296);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd2, $i297);
  call {:cexpr "y$r_buff1_thd2"} boogie_si_record_i8($i297);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 817, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 818, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 819, 22} true;
  assume {:verifier.code 0} true;
  $i298 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 819, 39} true;
  assume {:verifier.code 0} true;
  $i299 := $add.i32($i298, 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 819, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i299);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i299);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 820, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 835, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 839, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 839, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 839, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 841, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 842, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i15);
  call {:cexpr "y"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 844, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 843, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 844, 66} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 844, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 846, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 846, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 847, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 849, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 850, 19} true;
  assume {:verifier.code 1} true;
  call $i71 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i71);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 850, 17} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 850, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 851, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 851, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 851, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 852, 21} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 852, 21} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 852, 19} true;
  assume {:verifier.code 0} true;
  $i77 := $zext.i1.i8($i76);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 852, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 853, 15} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 853, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i78);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i78);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 8} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 8} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i80} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i80 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 27} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 27} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 42} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 101} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 7} true;
  assume {:verifier.code 0} true;
  $i90 := $i89;
  goto $bb62;
$bb52:
  ...
  goto $bb53;
$bb53:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 65} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 65} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i86} true;
  goto $bb57, $bb59;
$bb54:
  assume !(($i82 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 46} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 46} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 61} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb58;
$bb58:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 106} true;
  assume {:verifier.code 0} true;
  $i91 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 106} true;
  assume {:verifier.code 0} true;
  $i92 := $trunc.i8.i1($i91);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i92} true;
  goto $bb63, $bb64;
$bb59:
  assume !(($i86 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 84} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i90);
  call {:cexpr "y"} boogie_si_record_i32($i90);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 15} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i92 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 124} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb65;
$bb65:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 153} true;
  assume {:verifier.code 0} true;
...
$bb66:
  assume ($i94 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 854, 141} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i99 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 31} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume !(($i99 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 45} true;
  assume {:verifier.code 0} true;
  $i102 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 45} true;
  assume {:verifier.code 0} true;
  $i103 := $trunc.i8.i1($i102);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 60} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i101);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i101);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 15} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i103 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 64} true;
  assume {:verifier.code 0} true;
  $i104 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 64} true;
  assume {:verifier.code 0} true;
  $i105 := $trunc.i8.i1($i104);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 79} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i105} true;
  goto $bb75, $bb77;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 138} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 44} true;
  assume {:verifier.code 0} true;
  $i113 := $i112;
  goto $bb85;
$bb75:
  ...
  goto $bb76;
$bb76:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 102} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 102} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i109} true;
  goto $bb80, $bb82;
$bb77:
  assume !(($i105 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 83} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 83} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 98} true;
  assume {:verifier.code 0} true;
...
$bb80:
  ...
  goto $bb81;
$bb81:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 151} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 151} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i115} true;
  goto $bb86, $bb87;
$bb82:
  assume !(($i109 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 121} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i115 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 169} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 198} true;
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i117 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 855, 186} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i122 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 31} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume !(($i122 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 45} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 45} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 60} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i124);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i124);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 20} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 20} true;
  assume {:verifier.code 0} true;
...
$bb95:
  assume ($i126 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 64} true;
  assume {:verifier.code 0} true;
  $i127 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 64} true;
  assume {:verifier.code 0} true;
  $i128 := $trunc.i8.i1($i127);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 79} true;
  assume {:verifier.code 0} true;
...
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 138} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 44} true;
  assume {:verifier.code 0} true;
  $i136 := $i135;
  goto $bb108;
$bb98:
  ...
  goto $bb99;
$bb99:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 102} true;
  assume {:verifier.code 0} true;
  $i131 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 102} true;
  assume {:verifier.code 0} true;
  $i132 := $trunc.i8.i1($i131);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i132} true;
  goto $bb103, $bb105;
$bb100:
  assume !(($i128 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 83} true;
  assume {:verifier.code 0} true;
  $i129 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 83} true;
  assume {:verifier.code 0} true;
  $i130 := $trunc.i8.i1($i129);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 98} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb104;
$bb104:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 151} true;
  assume {:verifier.code 0} true;
  $i137 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 151} true;
  assume {:verifier.code 0} true;
  $i138 := $trunc.i8.i1($i137);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i138} true;
  goto $bb109, $bb110;
$bb105:
  assume !(($i132 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 121} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i138 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 169} true;
  assume {:verifier.code 0} true;
...
$bb110:
  ...
  goto $bb111;
$bb111:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 198} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i140 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 856, 186} true;
  assume {:verifier.code 0} true;
...
$bb115:
  assume ($i145 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 36} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume !(($i145 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 55} true;
  assume {:verifier.code 0} true;
  $i150 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 55} true;
  assume {:verifier.code 0} true;
  $i151 := $trunc.i8.i1($i150);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i151} true;
  goto $bb118, $bb119;
$bb117:
  ...
  assume {:verifier.code 0} true;
  $i172 := $ne.i32($i149, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 20} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i151 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 74} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 74} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb121, $bb123;
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i162 := $zext.i1.i32($i161);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 54} true;
  assume {:verifier.code 0} true;
  $i163 := $i162;
  goto $bb131;
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 112} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 112} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i157} true;
  goto $bb126, $bb128;
$bb123:
  assume !(($i153 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 93} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 93} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i155} true;
  goto $bb124, $bb125;
$bb124:
...
$bb126:
  ...
  goto $bb127;
$bb127:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 166} true;
  assume {:verifier.code 0} true;
  $i164 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 166} true;
  assume {:verifier.code 0} true;
  $i165 := $trunc.i8.i1($i164);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i165} true;
  goto $bb132, $bb133;
$bb128:
  assume !(($i157 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 131} true;
  assume {:verifier.code 0} true;
...
$bb132:
  assume ($i165 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 184} true;
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  goto $bb134;
$bb134:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 857, 212} true;
  assume {:verifier.code 0} true;
...
$bb138:
  assume ($i175 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 36} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i175 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 55} true;
  assume {:verifier.code 0} true;
  $i180 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 55} true;
  assume {:verifier.code 0} true;
  $i181 := $trunc.i8.i1($i180);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i181} true;
  goto $bb141, $bb142;
$bb140:
  ...
  assume {:verifier.code 0} true;
  $i200 := $ne.i32($i179, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 18} true;
  assume {:verifier.code 0} true;
  $i201 := $zext.i1.i8($i200);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 20} true;
  assume {:verifier.code 0} true;
  $i202 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 20} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i181 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 74} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 74} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i183} true;
  goto $bb144, $bb146;
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 54} true;
  assume {:verifier.code 0} true;
  $i193 := $i192;
  goto $bb154;
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 112} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 112} true;
  assume {:verifier.code 0} true;
  $i187 := $trunc.i8.i1($i186);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i187} true;
  goto $bb149, $bb151;
$bb146:
  assume !(($i183 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 93} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 93} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i185} true;
  goto $bb147, $bb148;
$bb147:
...
$bb149:
  ...
  goto $bb150;
$bb150:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 166} true;
  assume {:verifier.code 0} true;
  $i194 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 166} true;
  assume {:verifier.code 0} true;
  $i195 := $trunc.i8.i1($i194);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 181} true;
  assume {:verifier.code 0} true;
  $i196 := 0;
  assume {:branchcond $i195} true;
  goto $bb155, $bb156;
$bb151:
  assume !(($i187 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 131} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume ($i195 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 858, 184} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume ($i203 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 36} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume !(($i203 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 55} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 55} true;
  assume {:verifier.code 0} true;
  $i209 := $trunc.i8.i1($i208);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i209} true;
  goto $bb161, $bb162;
$bb160:
  ...
  assume {:verifier.code 0} true;
  $i230 := $ne.i32($i207, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 20} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume ($i209 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 74} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 74} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i211} true;
  goto $bb164, $bb166;
$bb162:
  ...
  goto $bb163;
$bb163:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i220 := $zext.i1.i32($i219);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 54} true;
  assume {:verifier.code 0} true;
  $i221 := $i220;
  goto $bb174;
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 112} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 112} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i215} true;
  goto $bb169, $bb171;
$bb166:
  assume !(($i211 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 93} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 93} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i213} true;
  goto $bb167, $bb168;
$bb167:
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 166} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 166} true;
  assume {:verifier.code 0} true;
  $i223 := $trunc.i8.i1($i222);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i223} true;
  goto $bb175, $bb176;
$bb171:
  assume !(($i215 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 131} true;
  assume {:verifier.code 0} true;
...
$bb175:
  assume ($i223 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 184} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  goto $bb177;
$bb177:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 859, 212} true;
  assume {:verifier.code 0} true;
...
$bb181:
  assume ($i233 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 36} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume !(($i233 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 55} true;
  assume {:verifier.code 0} true;
  $i238 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 55} true;
  assume {:verifier.code 0} true;
  $i239 := $trunc.i8.i1($i238);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 70} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  assume {:verifier.code 0} true;
  $i258 := $ne.i32($i237, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 18} true;
  assume {:verifier.code 0} true;
  $i259 := $zext.i1.i8($i258);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 23} true;
  assume {:verifier.code 0} true;
  $i260 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 25} true;
  assume {:verifier.code 0} true;
  $i261 := $eq.i32($i260, 2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 30} true;
  assume {:verifier.code 0} true;
  $i262 := 0;
  assume {:branchcond $i261} true;
  goto $bb201, $bb202;
$bb184:
  assume ($i239 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 74} true;
  assume {:verifier.code 0} true;
  $i240 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 74} true;
  assume {:verifier.code 0} true;
  $i241 := $trunc.i8.i1($i240);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 89} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  goto $bb186;
$bb186:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 54} true;
  assume {:verifier.code 0} true;
  $i251 := $i250;
  goto $bb197;
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 112} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 112} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i245} true;
  goto $bb192, $bb194;
$bb189:
  assume !(($i241 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 93} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 93} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 108} true;
  assume {:verifier.code 0} true;
...
$bb192:
  ...
  goto $bb193;
$bb193:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 166} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 166} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 181} true;
  assume {:verifier.code 0} true;
  $i254 := 0;
  assume {:branchcond $i253} true;
  goto $bb198, $bb199;
$bb194:
  assume !(($i245 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 131} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i253 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 860, 184} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i261 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 33} true;
  assume {:verifier.code 0} true;
  $i263 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 53} true;
  assume {:verifier.code 0} true;
  $i264 := $eq.i32($i263, 0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 58} true;
  assume {:verifier.code 0} true;
  $i262 := 0;
...
$bb203:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/rfi005_power.oepc_tmp.c:861:21: warning: over-approximating bitwise operation xor;
  $i269 := $xor.i1($i262, 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 862, 7} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume ($i264 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 61} true;
  assume {:verifier.code 0} true;
  $i265 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 81} true;
  assume {:verifier.code 0} true;
  $i266 := $eq.i32($i265, 2);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 86} true;
  assume {:verifier.code 0} true;
  $i262 := 0;
...
$bb206:
  assume ($i266 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 89} true;
  assume {:verifier.code 0} true;
  $i267 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 861, 109} true;
  assume {:verifier.code 0} true;
  $i268 := $eq.i32($i267, 0);
  assume {:verifier.code 0} true;
  $i262 := $i268;
...
$bb208:
  assume ($i272 == 1);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 862, 25} true;
  assume {:verifier.code 0} true;
...
$bb209:
  assume !(($i272 == 1));
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 862, 37} true;
  assume {:verifier.code 0} true;
  $i275 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 862, 7} true;
  assume {:verifier.code 0} true;
...
$bb210:
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 862, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 862, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i274);
  call {:cexpr "y"} boogie_si_record_i32($i274);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 863, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 864, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 865, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 865, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i278);
  assume {:sourceloc "output/rfi005_power.oepc_tmp.c", 866, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
