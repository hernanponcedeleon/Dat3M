...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix041_rmo.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix041_rmo.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 739, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 739, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 740, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 741, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 743, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i6);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 747, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 747, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 747, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 746, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 747, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 747, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 747, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 747, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 748, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 749, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 749, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 749, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 749, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 749, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 749, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 749, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 750, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 752, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 753, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 753, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 755, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i85: i32;
$bb0:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 760, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 760, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i1);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 761, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, 2);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 762, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 762, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 762, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 762, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 763, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$w_buff0_used, 1);
  call {:cexpr "x$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 764, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 764, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 764, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 764, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 764, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix041_rmo.opt_tmp.c:764:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 764, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 765, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 765, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 765, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 765, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 766, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 766, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 766, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 766, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$r_buff0_thd2, 1);
  call {:cexpr "x$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 770, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 771, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 774, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 774, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i21);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 777, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 777, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i22);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i22);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 55} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i28);
  call {:cexpr "x"} boogie_si_record_i32($i28);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 781, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i37} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 102} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i32 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 780, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i37 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 781, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 781, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i40, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $i45 := $zext.i1.i8($i44);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $trunc.i8.i1($i46);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 38} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb25, $bb27;
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 56} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  goto $bb28, $bb29;
$bb25:
...
$bb28:
  assume ($i51 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i58 := $ne.i32($i54, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $i59 := $zext.i1.i8($i58);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 783, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i61} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i61 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 783, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 783, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i68 := $ne.i32($i64, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i1.i8($i68);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 38} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 56} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i82 := $ne.i32($i78, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  $i83 := $zext.i1.i8($i82);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 787, 22} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 787, 39} true;
  assume {:verifier.code 0} true;
  $i85 := $add.i32($i84, 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i85);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i85);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 806, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 807, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 807, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 807, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 809, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i15);
  call {:cexpr "x"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 812, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 811, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 812, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 812, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 814, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 814, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 814, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 817, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 818, 19} true;
  assume {:verifier.code 1} true;
  call $i71 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i71);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 818, 17} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 818, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 819, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 819, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 819, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 820, 21} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 820, 21} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 820, 19} true;
  assume {:verifier.code 0} true;
  $i77 := $zext.i1.i8($i76);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 820, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 821, 15} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 821, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i78);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i78);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 8} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 8} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i80} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i80 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 27} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 27} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 42} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 101} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  $i90 := $i89;
  goto $bb62;
$bb52:
  ...
  goto $bb53;
$bb53:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 65} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 65} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i86} true;
  goto $bb57, $bb59;
$bb54:
  assume !(($i82 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 46} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 46} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 61} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb58;
$bb58:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 106} true;
  assume {:verifier.code 0} true;
  $i91 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 106} true;
  assume {:verifier.code 0} true;
  $i92 := $trunc.i8.i1($i91);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i92} true;
  goto $bb63, $bb64;
$bb59:
  assume !(($i86 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 84} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i90);
  call {:cexpr "x"} boogie_si_record_i32($i90);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 15} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i92 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 124} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb65;
$bb65:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 153} true;
  assume {:verifier.code 0} true;
...
$bb66:
  assume ($i94 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 822, 141} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i99 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 31} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume !(($i99 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 45} true;
  assume {:verifier.code 0} true;
  $i102 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 45} true;
  assume {:verifier.code 0} true;
  $i103 := $trunc.i8.i1($i102);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 60} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i101);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i101);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 15} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i103 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 64} true;
  assume {:verifier.code 0} true;
  $i104 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 64} true;
  assume {:verifier.code 0} true;
  $i105 := $trunc.i8.i1($i104);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 79} true;
  assume {:verifier.code 0} true;
...
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 138} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 44} true;
  assume {:verifier.code 0} true;
  $i113 := $i112;
  goto $bb85;
$bb75:
  ...
  goto $bb76;
$bb76:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 102} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 102} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i109} true;
  goto $bb80, $bb82;
$bb77:
  assume !(($i105 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 83} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 83} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 98} true;
  assume {:verifier.code 0} true;
...
$bb80:
  ...
  goto $bb81;
$bb81:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 151} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 151} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i115} true;
  goto $bb86, $bb87;
$bb82:
  assume !(($i109 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 121} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i115 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 169} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 198} true;
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i117 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 823, 186} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i122 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 31} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume !(($i122 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 45} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 45} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 60} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i124);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i124);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
...
$bb95:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 64} true;
  assume {:verifier.code 0} true;
  $i127 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 64} true;
  assume {:verifier.code 0} true;
  $i128 := $trunc.i8.i1($i127);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 79} true;
  assume {:verifier.code 0} true;
...
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 138} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 44} true;
  assume {:verifier.code 0} true;
  $i136 := $i135;
  goto $bb108;
$bb98:
  ...
  goto $bb99;
$bb99:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 102} true;
  assume {:verifier.code 0} true;
  $i131 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 102} true;
  assume {:verifier.code 0} true;
  $i132 := $trunc.i8.i1($i131);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i132} true;
  goto $bb103, $bb105;
$bb100:
  assume !(($i128 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 83} true;
  assume {:verifier.code 0} true;
  $i129 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 83} true;
  assume {:verifier.code 0} true;
  $i130 := $trunc.i8.i1($i129);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 98} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb104;
$bb104:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 151} true;
  assume {:verifier.code 0} true;
  $i137 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 151} true;
  assume {:verifier.code 0} true;
  $i138 := $trunc.i8.i1($i137);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i138} true;
  goto $bb109, $bb110;
$bb105:
  assume !(($i132 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 121} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i138 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 169} true;
  assume {:verifier.code 0} true;
...
$bb110:
  ...
  goto $bb111;
$bb111:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 198} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 824, 186} true;
  assume {:verifier.code 0} true;
...
$bb115:
  assume ($i145 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 36} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume !(($i145 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 55} true;
  assume {:verifier.code 0} true;
  $i150 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 55} true;
  assume {:verifier.code 0} true;
  $i151 := $trunc.i8.i1($i150);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 70} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  assume {:verifier.code 0} true;
  $i172 := $ne.i32($i149, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i151 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 74} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 74} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 89} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 54} true;
  assume {:verifier.code 0} true;
  $i163 := $i162;
  goto $bb131;
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 112} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 112} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i157} true;
  goto $bb126, $bb128;
$bb123:
  assume !(($i153 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 93} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 93} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 108} true;
  assume {:verifier.code 0} true;
...
$bb126:
  ...
  goto $bb127;
$bb127:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 166} true;
  assume {:verifier.code 0} true;
  $i164 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 166} true;
  assume {:verifier.code 0} true;
  $i165 := $trunc.i8.i1($i164);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i165} true;
  goto $bb132, $bb133;
$bb128:
  assume !(($i157 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 131} true;
  assume {:verifier.code 0} true;
...
$bb132:
  assume ($i165 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 184} true;
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  goto $bb134;
$bb134:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 825, 212} true;
  assume {:verifier.code 0} true;
...
$bb138:
  assume ($i175 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 36} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i175 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
  $i180 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
  $i181 := $trunc.i8.i1($i180);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 70} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  assume {:verifier.code 0} true;
  $i200 := $ne.i32($i179, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 20} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i181 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 74} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 74} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 89} true;
  assume {:verifier.code 0} true;
...
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 54} true;
  assume {:verifier.code 0} true;
  $i193 := $i192;
  goto $bb154;
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 112} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 112} true;
  assume {:verifier.code 0} true;
  $i187 := $trunc.i8.i1($i186);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i187} true;
  goto $bb149, $bb151;
$bb146:
  assume !(($i183 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 93} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 93} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 108} true;
  assume {:verifier.code 0} true;
...
$bb149:
  ...
  goto $bb150;
$bb150:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 166} true;
  assume {:verifier.code 0} true;
  $i194 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 166} true;
  assume {:verifier.code 0} true;
  $i195 := $trunc.i8.i1($i194);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 181} true;
  assume {:verifier.code 0} true;
  $i196 := 0;
...
$bb151:
  assume !(($i187 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 131} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume ($i195 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 826, 184} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume ($i203 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 36} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume !(($i203 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 55} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 55} true;
  assume {:verifier.code 0} true;
  $i209 := $trunc.i8.i1($i208);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 70} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  assume {:verifier.code 0} true;
  $i230 := $ne.i32($i207, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume ($i209 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 74} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 74} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 89} true;
  assume {:verifier.code 0} true;
...
$bb162:
  ...
  goto $bb163;
$bb163:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 54} true;
  assume {:verifier.code 0} true;
  $i221 := $i220;
  goto $bb174;
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 112} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 112} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i215} true;
  goto $bb169, $bb171;
$bb166:
  assume !(($i211 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 93} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 93} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 108} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 166} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 166} true;
  assume {:verifier.code 0} true;
  $i223 := $trunc.i8.i1($i222);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i223} true;
  goto $bb175, $bb176;
$bb171:
  assume !(($i215 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 131} true;
  assume {:verifier.code 0} true;
...
$bb175:
  assume ($i223 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 184} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  goto $bb177;
$bb177:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 827, 212} true;
  assume {:verifier.code 0} true;
...
$bb181:
  assume ($i233 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 36} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume !(($i233 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 55} true;
  assume {:verifier.code 0} true;
  $i238 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 55} true;
  assume {:verifier.code 0} true;
  $i239 := $trunc.i8.i1($i238);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 70} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  assume {:verifier.code 0} true;
  $i258 := $ne.i32($i237, 0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 23} true;
  assume {:verifier.code 0} true;
  $i260 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 25} true;
  assume {:verifier.code 0} true;
  $i261 := $eq.i32($i260, 2);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 30} true;
  assume {:verifier.code 0} true;
  $i262 := 0;
...
$bb184:
  assume ($i239 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 74} true;
  assume {:verifier.code 0} true;
  $i240 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 74} true;
  assume {:verifier.code 0} true;
  $i241 := $trunc.i8.i1($i240);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 89} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  goto $bb186;
$bb186:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 54} true;
  assume {:verifier.code 0} true;
  $i251 := $i250;
  goto $bb197;
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 112} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 112} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i245} true;
  goto $bb192, $bb194;
$bb189:
  assume !(($i241 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 93} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 93} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 108} true;
  assume {:verifier.code 0} true;
...
$bb192:
  ...
  goto $bb193;
$bb193:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 166} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 166} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 181} true;
  assume {:verifier.code 0} true;
  $i254 := 0;
...
$bb194:
  assume !(($i245 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 131} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i253 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 828, 184} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i261 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 33} true;
  assume {:verifier.code 0} true;
  $i263 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 53} true;
  assume {:verifier.code 0} true;
  $i264 := $eq.i32($i263, 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 58} true;
  assume {:verifier.code 0} true;
  $i262 := 0;
...
$bb203:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix041_rmo.opt_tmp.c:829:21: warning: over-approximating bitwise operation xor;
  $i267 := $xor.i1($i262, 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume ($i264 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 61} true;
  assume {:verifier.code 0} true;
  $i265 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 829, 81} true;
  assume {:verifier.code 0} true;
  $i266 := $eq.i32($i265, 0);
  assume {:verifier.code 0} true;
  $i262 := $i266;
...
$bb206:
  assume ($i270 == 1);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 830, 25} true;
  assume {:verifier.code 0} true;
...
$bb207:
  assume !(($i270 == 1));
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 830, 37} true;
  assume {:verifier.code 0} true;
  $i273 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
...
$bb208:
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 830, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i272);
  call {:cexpr "x"} boogie_si_record_i32($i272);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 831, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 833, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 833, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i276);
  assume {:sourceloc "output/mix041_rmo.opt_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
