...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/thin002_power.oepc-O0.bpl /Users/ponce/git/Dat3M/output/thin002_power.oepc_tmp.c
...
axiom (weak$$choice1 == $sub.ref(0, 14380));
const a$w_buff0_used: ref;
axiom (a$w_buff0_used == $sub.ref(0, 15405));
const a$r_buff0_thd1: ref;
axiom (a$r_buff0_thd1 == $sub.ref(0, 16430));
const a$w_buff0: ref;
axiom (a$w_buff0 == $sub.ref(0, 17458));
const a$r_buff1_thd1: ref;
axiom (a$r_buff1_thd1 == $sub.ref(0, 18483));
const a$w_buff1_used: ref;
axiom (a$w_buff1_used == $sub.ref(0, 19508));
const a$w_buff1: ref;
axiom (a$w_buff1 == $sub.ref(0, 20536));
const __unbuffered_p0_EAX$read_delayed: ref;
axiom (__unbuffered_p0_EAX$read_delayed == $sub.ref(0, 21561));
const __unbuffered_p0_EAX$read_delayed_var: ref;
axiom (__unbuffered_p0_EAX$read_delayed_var == $sub.ref(0, 22593));
const a$r_buff0_thd4: ref;
axiom (a$r_buff0_thd4 == $sub.ref(0, 23618));
const a$r_buff1_thd4: ref;
axiom (a$r_buff1_thd4 == $sub.ref(0, 24643));
const main$tmp_guard0: ref;
axiom (main$tmp_guard0 == $sub.ref(0, 25668));
const a$r_buff0_thd0: ref;
axiom (a$r_buff0_thd0 == $sub.ref(0, 26693));
const a$r_buff1_thd0: ref;
axiom (a$r_buff1_thd0 == $sub.ref(0, 27718));
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i314: i32;
$bb0:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 772, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 772, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 772, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 773, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 773, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 773, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 774, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 774, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 774, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 774, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 775, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 775, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$mem_tmp, $i8);
  call {:cexpr "a$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 776, 19} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i9);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 776, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 776, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 30} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 45} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb4, $bb5;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i14);
  call {:cexpr "a"} boogie_si_record_i32($i14);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 15} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 48} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 48} true;
  assume {:verifier.code 0} true;
  $i18 := $trunc.i8.i1($i17);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 30} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 78} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 78} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 93} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i18 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 65} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 30} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb9;
...
$bb10:
  assume ($i22 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 97} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 97} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 112} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 216} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 216} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 231} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i24 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 115} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 115} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 130} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i26 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 134} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 134} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 78} true;
...
$bb18:
  assume !(($i28 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 152} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i30 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 168} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 152} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i30 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 173} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i34 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 189} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 173} true;
  assume {:verifier.code 0} true;
  $i36 := $i35;
  goto $bb24;
$bb23:
  assume !(($i34 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 201} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume ($i40 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 234} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 234} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 249} true;
  assume {:verifier.code 0} true;
...
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 331} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i42 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 252} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 252} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i8.i1($i43);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 267} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i44 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 271} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 271} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 216} true;
...
$bb34:
  assume !(($i46 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 289} true;
  assume {:verifier.code 0} true;
...
$bb35:
  assume ($i48 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 305} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 289} true;
  assume {:verifier.code 0} true;
  $i50 := $i49;
  goto $bb37;
$bb36:
  assume !(($i48 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 317} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i54 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 347} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 331} true;
  assume {:verifier.code 0} true;
  $i56 := $i55;
  goto $bb41;
$bb40:
  assume !(($i54 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 359} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 777, 331} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume ($i59 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 31} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 15} true;
  assume {:verifier.code 0} true;
  $i61 := $i60;
  goto $bb44;
$bb43:
  assume !(($i59 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 45} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 45} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 44} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff0, $i61);
  call {:cexpr "a$w_buff0"} boogie_si_record_i32($i61);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 15} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume ($i63 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 75} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 75} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i67} true;
  goto $bb48, $bb49;
$bb46:
  assume !(($i63 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 62} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 44} true;
  assume {:verifier.code 0} true;
  $i65 := $i64;
  goto $bb47;
...
$bb48:
  assume ($i67 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 93} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 93} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 75} true;
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 123} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 123} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb54, $bb55;
$bb51:
  assume ($i69 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 110} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 75} true;
  assume {:verifier.code 0} true;
  $i71 := $i70;
  goto $bb53;
...
$bb54:
  assume ($i73 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 142} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 142} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 157} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 209} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 209} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 224} true;
  assume {:verifier.code 0} true;
...
$bb58:
  assume !(($i75 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 160} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 160} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb59, $bb60;
$bb59:
  assume ($i77 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 179} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 179} true;
  assume {:verifier.code 0} true;
  $i79 := $trunc.i8.i1($i78);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 123} true;
...
$bb62:
  assume !(($i79 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 196} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 123} true;
  assume {:verifier.code 0} true;
  $i81 := $i80;
  goto $bb63;
...
$bb64:
  assume ($i83 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 227} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 227} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 242} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 293} true;
  assume {:verifier.code 0} true;
  $i92 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 209} true;
  assume {:verifier.code 0} true;
  $i91 := $i92;
  goto $bb73;
$bb67:
  assume ($i85 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 245} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 245} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 260} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i87 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 264} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 264} true;
  assume {:verifier.code 0} true;
  $i89 := $trunc.i8.i1($i88);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 209} true;
...
$bb72:
  assume !(($i89 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 281} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 778, 209} true;
  assume {:verifier.code 0} true;
  $i91 := $i90;
  goto $bb73;
...
$bb74:
  assume ($i94 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 31} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 15} true;
  assume {:verifier.code 0} true;
  $i96 := $i95;
  goto $bb76;
$bb75:
  assume !(($i94 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 45} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 45} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 44} true;
  assume {:verifier.code 0} true;
...
$bb76:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff1, $i96);
  call {:cexpr "a$w_buff1"} boogie_si_record_i32($i96);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
...
$bb77:
  assume ($i98 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 75} true;
  assume {:verifier.code 0} true;
  $i101 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 75} true;
  assume {:verifier.code 0} true;
  $i102 := $trunc.i8.i1($i101);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  goto $bb80, $bb81;
$bb78:
  assume !(($i98 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 62} true;
  assume {:verifier.code 0} true;
  $i99 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 44} true;
  assume {:verifier.code 0} true;
  $i100 := $i99;
  goto $bb79;
...
$bb80:
  assume ($i102 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 93} true;
  assume {:verifier.code 0} true;
  $i103 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 93} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 123} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 123} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i108} true;
  goto $bb86, $bb87;
$bb83:
  assume ($i104 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 110} true;
  assume {:verifier.code 0} true;
  $i105 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 75} true;
  assume {:verifier.code 0} true;
  $i106 := $i105;
  goto $bb85;
...
$bb86:
  assume ($i108 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 142} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 142} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 157} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 209} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 209} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 224} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume !(($i110 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 160} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 160} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb91, $bb92;
$bb91:
  assume ($i112 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 179} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 179} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i114 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 196} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 123} true;
  assume {:verifier.code 0} true;
  $i116 := $i115;
  goto $bb95;
...
$bb96:
  assume ($i118 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 227} true;
  assume {:verifier.code 0} true;
  $i119 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 227} true;
  assume {:verifier.code 0} true;
  $i120 := $trunc.i8.i1($i119);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 242} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 293} true;
  assume {:verifier.code 0} true;
  $i127 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 209} true;
  assume {:verifier.code 0} true;
  $i126 := $i127;
  goto $bb105;
$bb99:
  assume ($i120 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 245} true;
  assume {:verifier.code 0} true;
  $i121 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 245} true;
  assume {:verifier.code 0} true;
  $i122 := $trunc.i8.i1($i121);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 260} true;
  assume {:verifier.code 0} true;
...
$bb101:
  assume ($i122 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 264} true;
  assume {:verifier.code 0} true;
  $i123 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 264} true;
  assume {:verifier.code 0} true;
...
$bb104:
  assume !(($i124 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 281} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 779, 209} true;
  assume {:verifier.code 0} true;
  $i126 := $i125;
  goto $bb105;
...
$bb106:
  assume ($i129 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 36} true;
  assume {:verifier.code 0} true;
  $i130 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 36} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume !(($i129 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 55} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 54} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i133, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  $i177 := $zext.i1.i8($i176);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff0_used, $i177);
  call {:cexpr "a$w_buff0_used"} boogie_si_record_i8($i177);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i135 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 90} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 90} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb112, $bb113;
$bb110:
  assume !(($i135 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 72} true;
  assume {:verifier.code 0} true;
  $i136 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 72} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i141 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 108} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 108} true;
  assume {:verifier.code 0} true;
...
$bb113:
  ...
  goto $bb114;
$bb114:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 137} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 137} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 152} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i146 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 156} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 156} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 171} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 245} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 245} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 260} true;
  assume {:verifier.code 0} true;
...
$bb122:
  assume !(($i148 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 174} true;
  assume {:verifier.code 0} true;
  $i149 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 174} true;
  assume {:verifier.code 0} true;
  $i150 := $trunc.i8.i1($i149);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i150} true;
  goto $bb123, $bb124;
$bb123:
  assume ($i150 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 193} true;
  assume {:verifier.code 0} true;
  $i151 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 193} true;
  assume {:verifier.code 0} true;
...
$bb126:
  assume !(($i152 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 210} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, weak$$choice0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 210} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 224} true;
  assume {:verifier.code 0} true;
  $i155 := 1;
...
$bb129:
  assume !(($i154 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 228} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, weak$$choice1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 228} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 227} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin002_power.oepc_tmp.c:780:227: warning: over-approximating bitwise operation xor;
  $i158 := $xor.i1($i157, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 224} true;
  assume {:verifier.code 0} true;
  $i155 := $i158;
...
$bb131:
  assume ($i162 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 263} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 263} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 278} true;
  assume {:verifier.code 0} true;
...
$bb132:
  ...
  goto $bb133;
$bb133:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 333} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume ($i164 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 281} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 281} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 296} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i166 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 300} true;
  assume {:verifier.code 0} true;
  $i167 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 300} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i168 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 780, 317} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i179 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 36} true;
  assume {:verifier.code 0} true;
  $i180 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 36} true;
  assume {:verifier.code 0} true;
...
$bb142:
  assume !(($i179 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 54} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i183, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $i219 := $zext.i1.i8($i218);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff1_used, $i219);
  call {:cexpr "a$w_buff1_used"} boogie_si_record_i8($i219);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
...
$bb144:
  assume ($i185 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 90} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 90} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb147, $bb148;
$bb145:
  assume !(($i185 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 72} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 72} true;
  assume {:verifier.code 0} true;
...
$bb147:
  assume ($i191 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 108} true;
  assume {:verifier.code 0} true;
  $i192 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 108} true;
  assume {:verifier.code 0} true;
...
$bb148:
  ...
  goto $bb149;
$bb149:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 137} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 137} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 152} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i196 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 156} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 156} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 171} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  goto $bb155;
$bb155:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 227} true;
  assume {:verifier.code 0} true;
  $i207 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 227} true;
  assume {:verifier.code 0} true;
  $i208 := $trunc.i8.i1($i207);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 242} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb157:
  assume !(($i198 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 174} true;
  assume {:verifier.code 0} true;
  $i199 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 174} true;
  assume {:verifier.code 0} true;
  $i200 := $trunc.i8.i1($i199);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i200} true;
  goto $bb158, $bb159;
$bb158:
  assume ($i200 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 193} true;
  assume {:verifier.code 0} true;
  $i201 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 193} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume !(($i202 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 210} true;
  assume {:verifier.code 0} true;
...
$bb163:
  assume ($i208 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 245} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 245} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 260} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 227} true;
  assume {:verifier.code 0} true;
...
$bb166:
  assume ($i211 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 263} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 263} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 278} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb168:
  assume ($i213 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 282} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 282} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 781, 281} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin002_power.oepc_tmp.c:781:281: warning: over-approximating bitwise operation xor;
  $i216 := $xor.i1($i215, 1);
  assume {:verifier.code 0} true;
  $i209 := $i216;
  goto $bb165;
...
$bb170:
  assume ($i221 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 36} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 36} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume !(($i221 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 54} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i225, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $i261 := $zext.i1.i8($i260);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff0_thd1, $i261);
  call {:cexpr "a$r_buff0_thd1"} boogie_si_record_i8($i261);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
...
$bb173:
  assume ($i227 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 90} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 90} true;
  assume {:verifier.code 0} true;
  $i233 := $trunc.i8.i1($i232);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i233} true;
  goto $bb176, $bb177;
$bb174:
  assume !(($i227 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 72} true;
  assume {:verifier.code 0} true;
  $i228 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 72} true;
  assume {:verifier.code 0} true;
...
$bb176:
  assume ($i233 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 108} true;
  assume {:verifier.code 0} true;
  $i234 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 108} true;
  assume {:verifier.code 0} true;
...
$bb177:
  ...
  goto $bb178;
$bb178:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 137} true;
  assume {:verifier.code 0} true;
  $i237 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 137} true;
  assume {:verifier.code 0} true;
  $i238 := $trunc.i8.i1($i237);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 152} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume ($i238 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 156} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 156} true;
  assume {:verifier.code 0} true;
  $i240 := $trunc.i8.i1($i239);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 171} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  goto $bb184;
$bb184:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 228} true;
  assume {:verifier.code 0} true;
  $i249 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 228} true;
  assume {:verifier.code 0} true;
  $i250 := $trunc.i8.i1($i249);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 243} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb186:
  assume !(($i240 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 174} true;
  assume {:verifier.code 0} true;
  $i241 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 174} true;
  assume {:verifier.code 0} true;
  $i242 := $trunc.i8.i1($i241);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i242} true;
  goto $bb187, $bb188;
$bb187:
  assume ($i242 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 193} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 193} true;
  assume {:verifier.code 0} true;
...
$bb190:
  assume !(($i244 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 210} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 210} true;
  assume {:verifier.code 0} true;
...
$bb192:
  assume ($i250 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 246} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 246} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 261} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb195:
  assume ($i253 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 264} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 264} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 279} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb197:
  assume ($i255 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 283} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 283} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 782, 282} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin002_power.oepc_tmp.c:782:282: warning: over-approximating bitwise operation xor;
  $i258 := $xor.i1($i257, 1);
  assume {:verifier.code 0} true;
  $i251 := $i258;
  goto $bb194;
...
$bb199:
  assume ($i263 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 36} true;
  assume {:verifier.code 0} true;
  $i264 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 36} true;
  assume {:verifier.code 0} true;
...
$bb200:
  assume !(($i263 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 55} true;
  assume {:verifier.code 0} true;
  $i268 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 55} true;
  assume {:verifier.code 0} true;
  $i269 := $trunc.i8.i1($i268);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 54} true;
  assume {:verifier.code 0} true;
...
$bb201:
  ...
  assume {:verifier.code 0} true;
  $i305 := $ne.i32($i267, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $i306 := $zext.i1.i8($i305);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff1_thd1, $i306);
  call {:cexpr "a$r_buff1_thd1"} boogie_si_record_i8($i306);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 784, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p0_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p0_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 785, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p0_EAX$read_delayed_var, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 786, 25} true;
  assume {:verifier.code 0} true;
  $i307 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 786, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i307);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i307);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 787, 7} true;
  assume {:verifier.code 0} true;
  $i308 := $load.i8($M.0, a$flush_delayed);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 787, 7} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume ($i269 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 90} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 90} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i275} true;
  goto $bb205, $bb206;
$bb203:
  assume !(($i269 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 72} true;
  assume {:verifier.code 0} true;
  $i270 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 72} true;
  assume {:verifier.code 0} true;
...
$bb205:
  assume ($i275 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 108} true;
  assume {:verifier.code 0} true;
  $i276 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 108} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  goto $bb207;
$bb207:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 137} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 137} true;
  assume {:verifier.code 0} true;
  $i280 := $trunc.i8.i1($i279);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 152} true;
  assume {:verifier.code 0} true;
...
$bb211:
  assume ($i280 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 156} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 156} true;
  assume {:verifier.code 0} true;
  $i282 := $trunc.i8.i1($i281);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 171} true;
  assume {:verifier.code 0} true;
...
$bb212:
  ...
  goto $bb213;
$bb213:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 257} true;
  assume {:verifier.code 0} true;
  $i294 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 257} true;
  assume {:verifier.code 0} true;
  $i295 := $trunc.i8.i1($i294);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 272} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb215:
  assume !(($i282 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 174} true;
  assume {:verifier.code 0} true;
  $i283 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 174} true;
  assume {:verifier.code 0} true;
  $i284 := $trunc.i8.i1($i283);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i284} true;
  goto $bb216, $bb217;
$bb216:
  assume ($i284 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 193} true;
  assume {:verifier.code 0} true;
  $i285 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 193} true;
  assume {:verifier.code 0} true;
...
$bb219:
  assume !(($i286 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 211} true;
  assume {:verifier.code 0} true;
...
$bb220:
  assume ($i288 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 227} true;
  assume {:verifier.code 0} true;
  $i289 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 227} true;
  assume {:verifier.code 0} true;
...
$bb224:
  assume ($i295 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 275} true;
  assume {:verifier.code 0} true;
  $i297 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 275} true;
  assume {:verifier.code 0} true;
  $i298 := $trunc.i8.i1($i297);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 290} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb227:
  assume ($i298 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 293} true;
  assume {:verifier.code 0} true;
  $i299 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 293} true;
  assume {:verifier.code 0} true;
  $i300 := $trunc.i8.i1($i299);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 308} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb229:
  assume ($i300 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 312} true;
  assume {:verifier.code 0} true;
  $i301 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 312} true;
  assume {:verifier.code 0} true;
  $i302 := $trunc.i8.i1($i301);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 783, 311} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin002_power.oepc_tmp.c:783:311: warning: over-approximating bitwise operation xor;
  $i303 := $xor.i1($i302, 1);
  assume {:verifier.code 0} true;
  $i296 := $i303;
  goto $bb226;
...
$bb231:
  assume ($i309 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 787, 25} true;
  assume {:verifier.code 0} true;
  $i310 := $load.i32($M.0, a$mem_tmp);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 787, 7} true;
  assume {:verifier.code 0} true;
  $i311 := $i310;
  goto $bb233;
$bb232:
  assume !(($i309 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 787, 37} true;
  assume {:verifier.code 0} true;
  $i312 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 787, 7} true;
  assume {:verifier.code 0} true;
...
$bb233:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 787, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 787, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i311);
  call {:cexpr "a"} boogie_si_record_i32($i311);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 788, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$flush_delayed, 0);
  call {:cexpr "a$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 790, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 791, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 793, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 796, 22} true;
  assume {:verifier.code 0} true;
  $i313 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 796, 39} true;
  assume {:verifier.code 0} true;
  $i314 := $add.i32($i313, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i314);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i314);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 797, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 803, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 803, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 806, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 811, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 811, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 811, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 813, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 817, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 817, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 818, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 818, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 820, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 821, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 825, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 826, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 826, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 827, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 828, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 833, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 833, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EAX, $i1);
  call {:cexpr "__unbuffered_p3_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 835, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 836, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, 1);
  call {:cexpr "a"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i7);
  call {:cexpr "a"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 840, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 839, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 840, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 841, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 842, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 842, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 842, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 842, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 842, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i54} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 846, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 846, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 862, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 864, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 866, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 868, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 870, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 870, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 870, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 870, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 871, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 872, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 872, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 873, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i19);
  call {:cexpr "a"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 875, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 874, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 875, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 875, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 877, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 877, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 877, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 879, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 880, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 881, 19} true;
  assume {:verifier.code 1} true;
  call $i75 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i75);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 881, 17} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i8($i75);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 881, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 882, 25} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume ($i78 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 882, 61} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume !(($i78 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 882, 140} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume ($i80 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 882, 78} true;
  assume {:verifier.code 0} true;
  $p81 := $load.ref($M.0, __unbuffered_p0_EAX$read_delayed_var);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 882, 77} true;
  assume {:verifier.code 0} true;
...
$bb52:
  assume !(($i80 == 1));
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 882, 117} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 882, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 882, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i85);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i85);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 23} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 43} true;
  assume {:verifier.code 0} true;
  $i88 := $eq.i32($i87, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 48} true;
  assume {:verifier.code 0} true;
  $i89 := 0;
...
$bb55:
  assume ($i88 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 51} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 71} true;
  assume {:verifier.code 0} true;
  $i91 := $eq.i32($i90, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 76} true;
  assume {:verifier.code 0} true;
  $i89 := 0;
...
$bb57:
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin002_power.oepc_tmp.c:883:21: warning: over-approximating bitwise operation xor;
  $i96 := $xor.i1($i89, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 19} true;
  assume {:verifier.code 0} true;
  $i97 := $zext.i1.i8($i96);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 884, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 885, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 885, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i100);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 886, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb58:
  assume ($i91 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 79} true;
  assume {:verifier.code 0} true;
  $i92 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 99} true;
  assume {:verifier.code 0} true;
  $i93 := $eq.i32($i92, 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 104} true;
  assume {:verifier.code 0} true;
  $i89 := 0;
...
$bb60:
  assume ($i93 == 1);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 107} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i32($M.0, __unbuffered_p3_EAX);
  assume {:sourceloc "output/thin002_power.oepc_tmp.c", 883, 127} true;
  assume {:verifier.code 0} true;
  $i95 := $eq.i32($i94, 1);
  assume {:verifier.code 0} true;
  $i89 := $i95;
