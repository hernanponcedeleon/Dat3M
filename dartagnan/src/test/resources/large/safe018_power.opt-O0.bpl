...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe018_power.opt-O0.bpl /Users/ponce/git/Dat3M/output/safe018_power.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i198: i32;
$bb0:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 761, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 761, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 764, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 764, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 764, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 765, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 765, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 765, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 766, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 766, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 766, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 766, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 767, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 767, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i9);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i21);
  call {:cexpr "x"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 768, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i32);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 769, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i55);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 770, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 771, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 772, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 773, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 775, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 775, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EBX, $i191);
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 776, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 774, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 776, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 776, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 776, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 776, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 776, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i195);
  call {:cexpr "x"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 777, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 782, 22} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 782, 39} true;
  assume {:verifier.code 0} true;
  $i198 := $add.i32($i197, 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i198);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i198);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i86: i32;
$bb0:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 789, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 789, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i1);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 790, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, 1);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 791, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 791, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 791, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 791, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$w_buff0_used, 1);
  call {:cexpr "x$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 793, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 793, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 793, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 793, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 793, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/safe018_power.opt_tmp.c:793:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 793, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 793, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$r_buff0_thd2, 1);
  call {:cexpr "x$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i8.i1($i30);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i27 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i29);
  call {:cexpr "x"} boogie_si_record_i32($i29);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 802, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i31 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 102} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 801, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i38 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 802, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 802, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 804, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i62 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 804, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 804, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i72 := $trunc.i8.i1($i71);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i72} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i72 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
  $i74 := $trunc.i8.i1($i73);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 56} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i76} true;
  goto $bb46, $bb47;
$bb43:
...
$bb46:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i83 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  $i84 := $zext.i1.i8($i83);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 806, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 808, 22} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 808, 39} true;
  assume {:verifier.code 0} true;
  $i86 := $add.i32($i85, 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i86);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i86);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i375: i32;
$bb0:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 815, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 815, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 815, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 816, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 816, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 816, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 817, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 817, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 817, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 817, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 818, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 818, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i8);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 819, 19} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i9);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 819, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 819, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 30} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 45} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb4, $bb5;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i14);
  call {:cexpr "x"} boogie_si_record_i32($i14);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 15} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 48} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 78} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 78} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 93} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i18 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 65} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 97} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 97} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 112} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 216} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 216} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 231} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb26, $bb27;
$bb13:
...
$bb14:
  assume !(($i24 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 115} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 115} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 130} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 134} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume !(($i28 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 152} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 168} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 152} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i30 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 173} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i34 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 189} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume !(($i34 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 201} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 234} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 234} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 249} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb29, $bb30;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 331} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i42 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 252} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 252} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i8.i1($i43);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 267} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i44 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 271} true;
  assume {:verifier.code 0} true;
...
$bb34:
  assume !(($i46 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 289} true;
  assume {:verifier.code 0} true;
...
$bb35:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 305} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i48 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 317} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 289} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i54 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 347} true;
  assume {:verifier.code 0} true;
...
$bb40:
  assume !(($i54 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 359} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 820, 331} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume ($i59 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 31} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume !(($i59 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 45} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 45} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 44} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb45, $bb46;
$bb44:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i61);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i61);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 15} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume ($i63 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 75} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 75} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i67} true;
  goto $bb48, $bb49;
$bb46:
  assume !(($i63 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 62} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume ($i67 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 93} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 123} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 123} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb54, $bb55;
$bb51:
  assume ($i69 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 110} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume ($i73 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 142} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 142} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 157} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 209} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 209} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 224} true;
  assume {:verifier.code 0} true;
...
$bb58:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 160} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 160} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb59, $bb60;
$bb59:
  assume ($i77 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 179} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume !(($i79 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 196} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i83 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 227} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 227} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 242} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 293} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i85 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 245} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 245} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 260} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i87 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 264} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume !(($i89 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 821, 281} true;
  assume {:verifier.code 0} true;
...
$bb74:
  assume ($i94 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 31} true;
  assume {:verifier.code 0} true;
...
$bb75:
  assume !(($i94 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 45} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 45} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 44} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i98} true;
  goto $bb77, $bb78;
$bb76:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i96);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i96);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 20} true;
  assume {:verifier.code 0} true;
...
$bb77:
  assume ($i98 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 75} true;
  assume {:verifier.code 0} true;
  $i101 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 75} true;
  assume {:verifier.code 0} true;
  $i102 := $trunc.i8.i1($i101);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  goto $bb80, $bb81;
$bb78:
  assume !(($i98 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 62} true;
  assume {:verifier.code 0} true;
...
$bb80:
  assume ($i102 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 93} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 123} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 123} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i108} true;
  goto $bb86, $bb87;
$bb83:
  assume ($i104 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 110} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i108 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 142} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 142} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 157} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 209} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 209} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 224} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb96, $bb97;
$bb89:
...
$bb90:
  assume !(($i110 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 160} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 160} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb91, $bb92;
$bb91:
  assume ($i112 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 179} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i114 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 196} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i118 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 227} true;
  assume {:verifier.code 0} true;
  $i119 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 227} true;
  assume {:verifier.code 0} true;
  $i120 := $trunc.i8.i1($i119);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 242} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i120} true;
  goto $bb99, $bb100;
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 293} true;
  assume {:verifier.code 0} true;
...
$bb99:
  assume ($i120 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 245} true;
  assume {:verifier.code 0} true;
  $i121 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 245} true;
  assume {:verifier.code 0} true;
  $i122 := $trunc.i8.i1($i121);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 260} true;
  assume {:verifier.code 0} true;
...
$bb101:
  assume ($i122 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 264} true;
  assume {:verifier.code 0} true;
...
$bb104:
  assume !(($i124 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 822, 281} true;
  assume {:verifier.code 0} true;
...
$bb106:
  assume ($i129 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 36} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume !(($i129 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 55} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 54} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i133, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 20} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i135 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 90} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 90} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb112, $bb113;
$bb110:
  assume !(($i135 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 72} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i141 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 108} true;
  assume {:verifier.code 0} true;
...
$bb113:
  ...
  goto $bb114;
$bb114:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 137} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 137} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 152} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb118, $bb119;
$bb115:
...
$bb118:
  assume ($i146 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 156} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 156} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 171} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i148} true;
  goto $bb121, $bb122;
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 245} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 245} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 260} true;
  assume {:verifier.code 0} true;
...
$bb122:
  assume !(($i148 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 174} true;
  assume {:verifier.code 0} true;
  $i149 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 174} true;
  assume {:verifier.code 0} true;
  $i150 := $trunc.i8.i1($i149);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i150} true;
  goto $bb123, $bb124;
$bb123:
  assume ($i150 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 193} true;
  assume {:verifier.code 0} true;
...
$bb126:
  assume !(($i152 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 210} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, weak$$choice0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 210} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 224} true;
  assume {:verifier.code 0} true;
  $i155 := 1;
  assume {:branchcond $i154} true;
  goto $bb127, $bb129;
...
$bb129:
  assume !(($i154 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 228} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, weak$$choice1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 228} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 227} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe018_power.opt_tmp.c:823:227: warning: over-approximating bitwise operation xor;
  $i158 := $xor.i1($i157, 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 224} true;
  assume {:verifier.code 0} true;
  $i155 := $i158;
...
$bb131:
  assume ($i162 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 263} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 263} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 278} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i164} true;
  goto $bb134, $bb135;
$bb132:
  ...
  goto $bb133;
$bb133:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 333} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume ($i164 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 281} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 281} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 296} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i166 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 300} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i168 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 823, 317} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i179 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 36} true;
  assume {:verifier.code 0} true;
...
$bb142:
  assume !(($i179 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 54} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i183, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
...
$bb144:
  assume ($i185 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 90} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 90} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb147, $bb148;
$bb145:
  assume !(($i185 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 72} true;
  assume {:verifier.code 0} true;
...
$bb147:
  assume ($i191 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 108} true;
  assume {:verifier.code 0} true;
...
$bb148:
  ...
  goto $bb149;
$bb149:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 137} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 137} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 152} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i196 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 156} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 156} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 171} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  goto $bb155;
$bb155:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 227} true;
  assume {:verifier.code 0} true;
  $i207 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 227} true;
  assume {:verifier.code 0} true;
  $i208 := $trunc.i8.i1($i207);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 242} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb157:
  assume !(($i198 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 174} true;
  assume {:verifier.code 0} true;
  $i199 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 174} true;
  assume {:verifier.code 0} true;
  $i200 := $trunc.i8.i1($i199);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i200} true;
  goto $bb158, $bb159;
$bb158:
  assume ($i200 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 193} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume !(($i202 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 210} true;
  assume {:verifier.code 0} true;
...
$bb163:
  assume ($i208 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 245} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 245} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 260} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb166:
  assume ($i211 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 263} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 263} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 278} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb168:
  assume ($i213 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 282} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 282} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 824, 281} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe018_power.opt_tmp.c:824:281: warning: over-approximating bitwise operation xor;
  $i216 := $xor.i1($i215, 1);
  assume {:verifier.code 0} true;
  $i209 := $i216;
  goto $bb165;
...
$bb170:
  assume ($i221 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 36} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume !(($i221 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 54} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i225, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
...
$bb173:
  assume ($i227 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 90} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 90} true;
  assume {:verifier.code 0} true;
  $i233 := $trunc.i8.i1($i232);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i233} true;
  goto $bb176, $bb177;
$bb174:
  assume !(($i227 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 72} true;
  assume {:verifier.code 0} true;
...
$bb176:
  assume ($i233 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 108} true;
  assume {:verifier.code 0} true;
...
$bb177:
  ...
  goto $bb178;
$bb178:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 137} true;
  assume {:verifier.code 0} true;
  $i237 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 137} true;
  assume {:verifier.code 0} true;
  $i238 := $trunc.i8.i1($i237);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 152} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume ($i238 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 156} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 156} true;
  assume {:verifier.code 0} true;
  $i240 := $trunc.i8.i1($i239);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 171} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  goto $bb184;
$bb184:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 228} true;
  assume {:verifier.code 0} true;
  $i249 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 228} true;
  assume {:verifier.code 0} true;
  $i250 := $trunc.i8.i1($i249);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 243} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb186:
  assume !(($i240 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 174} true;
  assume {:verifier.code 0} true;
  $i241 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 174} true;
  assume {:verifier.code 0} true;
  $i242 := $trunc.i8.i1($i241);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i242} true;
  goto $bb187, $bb188;
$bb187:
  assume ($i242 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 193} true;
  assume {:verifier.code 0} true;
...
$bb190:
  assume !(($i244 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 210} true;
  assume {:verifier.code 0} true;
...
$bb192:
  assume ($i250 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 246} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 246} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 261} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb195:
  assume ($i253 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 264} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 264} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 279} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb197:
  assume ($i255 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 283} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 283} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 825, 282} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe018_power.opt_tmp.c:825:282: warning: over-approximating bitwise operation xor;
  $i258 := $xor.i1($i257, 1);
  assume {:verifier.code 0} true;
  $i251 := $i258;
  goto $bb194;
...
$bb199:
  assume ($i263 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 36} true;
  assume {:verifier.code 0} true;
...
$bb200:
  assume !(($i263 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
  $i268 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
  $i269 := $trunc.i8.i1($i268);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 54} true;
  assume {:verifier.code 0} true;
...
$bb201:
  ...
  assume {:verifier.code 0} true;
  $i305 := $ne.i32($i267, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 827, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p2_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p2_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 828, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p2_EAX$read_delayed_var, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 829, 25} true;
  assume {:verifier.code 0} true;
  $i307 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 829, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i307);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i307);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume ($i269 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 90} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 90} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i275} true;
  goto $bb205, $bb206;
$bb203:
  assume !(($i269 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 72} true;
  assume {:verifier.code 0} true;
...
$bb205:
  assume ($i275 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 108} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  goto $bb207;
$bb207:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 137} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 137} true;
  assume {:verifier.code 0} true;
  $i280 := $trunc.i8.i1($i279);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 152} true;
  assume {:verifier.code 0} true;
...
$bb211:
  assume ($i280 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 156} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 156} true;
  assume {:verifier.code 0} true;
  $i282 := $trunc.i8.i1($i281);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 171} true;
  assume {:verifier.code 0} true;
...
$bb212:
  ...
  goto $bb213;
$bb213:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 257} true;
  assume {:verifier.code 0} true;
  $i294 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 257} true;
  assume {:verifier.code 0} true;
  $i295 := $trunc.i8.i1($i294);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 272} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb215:
  assume !(($i282 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 174} true;
  assume {:verifier.code 0} true;
  $i283 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 174} true;
  assume {:verifier.code 0} true;
  $i284 := $trunc.i8.i1($i283);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i284} true;
  goto $bb216, $bb217;
$bb216:
  assume ($i284 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 193} true;
  assume {:verifier.code 0} true;
...
$bb219:
  assume !(($i286 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 211} true;
  assume {:verifier.code 0} true;
...
$bb220:
  assume ($i288 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 227} true;
  assume {:verifier.code 0} true;
...
$bb224:
  assume ($i295 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 275} true;
  assume {:verifier.code 0} true;
  $i297 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 275} true;
  assume {:verifier.code 0} true;
  $i298 := $trunc.i8.i1($i297);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 290} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb227:
  assume ($i298 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 293} true;
  assume {:verifier.code 0} true;
  $i299 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 293} true;
  assume {:verifier.code 0} true;
  $i300 := $trunc.i8.i1($i299);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 308} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb229:
  assume ($i300 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 312} true;
  assume {:verifier.code 0} true;
  $i301 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 312} true;
  assume {:verifier.code 0} true;
  $i302 := $trunc.i8.i1($i301);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 826, 311} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe018_power.opt_tmp.c:826:311: warning: over-approximating bitwise operation xor;
  $i303 := $xor.i1($i302, 1);
  assume {:verifier.code 0} true;
  $i296 := $i303;
  goto $bb226;
...
$bb231:
  assume ($i309 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 830, 25} true;
  assume {:verifier.code 0} true;
...
$bb232:
  assume !(($i309 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 830, 37} true;
  assume {:verifier.code 0} true;
  $i312 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
...
$bb233:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 830, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i311);
  call {:cexpr "x"} boogie_si_record_i32($i311);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 831, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 833, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 834, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 835, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 836, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 7} true;
  assume {:verifier.code 0} true;
  $i313 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 7} true;
  assume {:verifier.code 0} true;
  $i314 := $trunc.i8.i1($i313);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i314} true;
  goto $bb234, $bb235;
$bb234:
  assume ($i314 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 25} true;
  assume {:verifier.code 0} true;
...
$bb235:
  ...
  goto $bb236;
$bb236:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 55} true;
  assume {:verifier.code 0} true;
  $i319 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 55} true;
  assume {:verifier.code 0} true;
  $i320 := $trunc.i8.i1($i319);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i320} true;
  goto $bb240, $bb241;
$bb237:
  assume ($i316 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 42} true;
  assume {:verifier.code 0} true;
...
$bb239:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i318);
  call {:cexpr "x"} boogie_si_record_i32($i318);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 838, 20} true;
  assume {:verifier.code 0} true;
  $i326 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 838, 20} true;
  assume {:verifier.code 0} true;
  $i327 := $trunc.i8.i1($i326);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 838, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i327} true;
  goto $bb246, $bb247;
$bb240:
  assume ($i320 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 73} true;
  assume {:verifier.code 0} true;
...
$bb241:
  ...
  goto $bb242;
$bb242:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 102} true;
  assume {:verifier.code 0} true;
  $i325 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 55} true;
  assume {:verifier.code 0} true;
...
$bb243:
  assume ($i322 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 837, 90} true;
  assume {:verifier.code 0} true;
...
$bb246:
  assume ($i327 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 838, 38} true;
  assume {:verifier.code 0} true;
...
$bb247:
  ...
  goto $bb248;
$bb248:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 838, 66} true;
  assume {:verifier.code 0} true;
...
$bb251:
  ...
  assume {:verifier.code 0} true;
  $i334 := $ne.i32($i330, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 838, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i336 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i337 := $trunc.i8.i1($i336);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i337} true;
  goto $bb252, $bb253;
$bb252:
  assume ($i337 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
  $i338 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
  $i339 := $trunc.i8.i1($i338);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 53} true;
  assume {:verifier.code 0} true;
...
$bb253:
  ...
  goto $bb254;
$bb254:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 56} true;
  assume {:verifier.code 0} true;
  $i340 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 56} true;
  assume {:verifier.code 0} true;
  $i341 := $trunc.i8.i1($i340);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 71} true;
  assume {:verifier.code 0} true;
...
$bb258:
  assume ($i341 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 74} true;
  assume {:verifier.code 0} true;
...
$bb259:
  ...
  goto $bb260;
$bb260:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 102} true;
  assume {:verifier.code 0} true;
...
$bb263:
  ...
  assume {:verifier.code 0} true;
  $i348 := $ne.i32($i344, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i350 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i351 := $trunc.i8.i1($i350);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 840, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i351} true;
  goto $bb264, $bb265;
$bb264:
  assume ($i351 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
...
$bb265:
  ...
  goto $bb266;
$bb266:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 840, 66} true;
  assume {:verifier.code 0} true;
...
$bb269:
  ...
  assume {:verifier.code 0} true;
  $i358 := $ne.i32($i354, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i360 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i361 := $trunc.i8.i1($i360);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i361} true;
  goto $bb270, $bb271;
$bb270:
  assume ($i361 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
  $i362 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
  $i363 := $trunc.i8.i1($i362);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 53} true;
  assume {:verifier.code 0} true;
...
$bb271:
  ...
  goto $bb272;
$bb272:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 56} true;
  assume {:verifier.code 0} true;
  $i364 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 56} true;
  assume {:verifier.code 0} true;
  $i365 := $trunc.i8.i1($i364);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 71} true;
  assume {:verifier.code 0} true;
...
$bb276:
  assume ($i365 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 74} true;
  assume {:verifier.code 0} true;
...
$bb277:
  ...
  goto $bb278;
$bb278:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 102} true;
  assume {:verifier.code 0} true;
...
$bb281:
  ...
  assume {:verifier.code 0} true;
  $i372 := $ne.i32($i368, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 841, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 842, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 843, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 844, 22} true;
  assume {:verifier.code 0} true;
  $i374 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 844, 39} true;
  assume {:verifier.code 0} true;
  $i375 := $add.i32($i374, 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i375);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i375);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 846, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 860, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 862, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 864, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 865, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 866, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 866, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 866, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 866, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 868, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 868, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i17);
  call {:cexpr "x"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 871, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 871, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 871, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 870, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 871, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 871, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 871, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 871, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 872, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 873, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 873, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 873, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 873, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 873, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 873, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 873, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 875, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 876, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 877, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 877, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 877, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 878, 25} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 878, 61} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume !(($i76 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 878, 140} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume ($i78 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 878, 78} true;
  assume {:verifier.code 0} true;
  $p79 := $load.ref($M.0, __unbuffered_p2_EAX$read_delayed_var);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 878, 77} true;
  assume {:verifier.code 0} true;
...
$bb52:
  assume !(($i78 == 1));
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 878, 117} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 878, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 878, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i83);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i83);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 23} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 43} true;
  assume {:verifier.code 0} true;
  $i86 := $eq.i32($i85, 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 48} true;
  assume {:verifier.code 0} true;
  $i87 := 0;
  assume {:branchcond $i86} true;
  goto $bb55, $bb56;
$bb55:
  assume ($i86 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 51} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i32($M.0, __unbuffered_p0_EBX);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 71} true;
  assume {:verifier.code 0} true;
  $i89 := $eq.i32($i88, 0);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 76} true;
  assume {:verifier.code 0} true;
  $i87 := 0;
  assume {:branchcond $i89} true;
  goto $bb58, $bb59;
...
$bb57:
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe018_power.opt_tmp.c:879:21: warning: over-approximating bitwise operation xor;
  $i92 := $xor.i1($i87, 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 19} true;
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i8($i92);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 880, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 881, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i96 := $zext.i1.i32($i95);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 881, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i96);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 882, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb58:
  assume ($i89 == 1);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 79} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/safe018_power.opt_tmp.c", 879, 99} true;
  assume {:verifier.code 0} true;
  $i91 := $eq.i32($i90, 1);
  assume {:verifier.code 0} true;
  $i87 := $i91;
