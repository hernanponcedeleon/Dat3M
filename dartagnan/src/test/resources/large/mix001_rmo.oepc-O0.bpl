...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix001_rmo.oepc-O0.bpl /Users/ponce/git/Dat3M/output/mix001_rmo.oepc_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i282: i32;
$bb0:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 752, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 752, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i1);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 753, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, 1);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 754, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 754, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$w_buff0_used, 1);
  call {:cexpr "z$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 756, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 756, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 756, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 756, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 756, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix001_rmo.oepc_tmp.c:756:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 756, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 756, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 759, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 759, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 760, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 760, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 760, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 760, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 761, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$r_buff0_thd1, 1);
  call {:cexpr "z$r_buff0_thd1"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 764, 19} true;
  assume {:verifier.code 1} true;
  call $i24 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i24);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 764, 17} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i1.i8($i24);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 764, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 765, 19} true;
  assume {:verifier.code 1} true;
  call $i26 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i26);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 765, 17} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i1.i8($i26);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 765, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 766, 21} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 766, 21} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 766, 19} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i1.i8($i29);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 766, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 767, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 767, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i31);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 8} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 8} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i33} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i33 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 27} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 27} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 42} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 101} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 7} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb17;
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 65} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 65} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb12, $bb14;
$bb9:
  assume !(($i35 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 46} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 46} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 61} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 106} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 106} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb18, $bb19;
$bb14:
  assume !(($i39 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 84} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i43);
  call {:cexpr "z"} boogie_si_record_i32($i43);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 15} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i45 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 124} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 153} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 768, 141} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 31} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume !(($i52 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 60} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i54);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 15} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i56 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 79} true;
  assume {:verifier.code 0} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb40;
$bb30:
  ...
  goto $bb31;
$bb31:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb35, $bb37;
$bb32:
  assume !(($i58 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 98} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb41, $bb42;
$bb37:
  assume !(($i62 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 121} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i68 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 169} true;
  assume {:verifier.code 0} true;
...
$bb42:
  ...
  goto $bb43;
$bb43:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 198} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i70 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 769, 186} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 31} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume !(($i75 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 45} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 45} true;
  assume {:verifier.code 0} true;
  $i79 := $trunc.i8.i1($i78);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 60} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i77);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i77);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 64} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 64} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 79} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  goto $bb52;
$bb52:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 138} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 44} true;
  assume {:verifier.code 0} true;
  $i89 := $i88;
  goto $bb63;
$bb53:
  ...
  goto $bb54;
$bb54:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 102} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 102} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i85} true;
  goto $bb58, $bb60;
$bb55:
  assume !(($i81 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 83} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 83} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 98} true;
  assume {:verifier.code 0} true;
...
$bb58:
  ...
  goto $bb59;
$bb59:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 151} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 151} true;
  assume {:verifier.code 0} true;
  $i91 := $trunc.i8.i1($i90);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i91} true;
  goto $bb64, $bb65;
$bb60:
  assume !(($i85 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 121} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i91 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 169} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 198} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i93 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 770, 186} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i98 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 36} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume !(($i98 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 55} true;
  assume {:verifier.code 0} true;
  $i103 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 55} true;
  assume {:verifier.code 0} true;
  $i104 := $trunc.i8.i1($i103);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 70} true;
  assume {:verifier.code 0} true;
...
$bb72:
  ...
  assume {:verifier.code 0} true;
  $i125 := $ne.i32($i102, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 20} true;
  assume {:verifier.code 0} true;
...
$bb73:
  assume ($i104 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 74} true;
  assume {:verifier.code 0} true;
  $i105 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 74} true;
  assume {:verifier.code 0} true;
  $i106 := $trunc.i8.i1($i105);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 89} true;
  assume {:verifier.code 0} true;
...
$bb74:
  ...
  goto $bb75;
$bb75:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 54} true;
  assume {:verifier.code 0} true;
  $i116 := $i115;
  goto $bb86;
$bb76:
  ...
  goto $bb77;
$bb77:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 112} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 112} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i110} true;
  goto $bb81, $bb83;
$bb78:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 93} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 93} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 108} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 166} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 166} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb87, $bb88;
$bb83:
  assume !(($i110 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 131} true;
  assume {:verifier.code 0} true;
...
$bb87:
  assume ($i118 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 184} true;
  assume {:verifier.code 0} true;
...
$bb88:
  ...
  goto $bb89;
$bb89:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 771, 212} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i128 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 36} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i128 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 55} true;
  assume {:verifier.code 0} true;
  $i133 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $trunc.i8.i1($i133);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 70} true;
  assume {:verifier.code 0} true;
...
$bb95:
  ...
  assume {:verifier.code 0} true;
  $i153 := $ne.i32($i132, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 74} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 74} true;
  assume {:verifier.code 0} true;
  $i136 := $trunc.i8.i1($i135);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 89} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 54} true;
  assume {:verifier.code 0} true;
  $i146 := $i145;
  goto $bb109;
$bb99:
  ...
  goto $bb100;
$bb100:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 112} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 112} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i140} true;
  goto $bb104, $bb106;
$bb101:
  assume !(($i136 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 93} true;
  assume {:verifier.code 0} true;
  $i137 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 93} true;
  assume {:verifier.code 0} true;
  $i138 := $trunc.i8.i1($i137);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 108} true;
  assume {:verifier.code 0} true;
...
$bb104:
  ...
  goto $bb105;
$bb105:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 166} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 166} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 181} true;
  assume {:verifier.code 0} true;
  $i149 := 0;
...
$bb106:
  assume !(($i140 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 131} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i148 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 772, 184} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i156 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 36} true;
  assume {:verifier.code 0} true;
...
$bb114:
  assume !(($i156 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 55} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 55} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 70} true;
  assume {:verifier.code 0} true;
...
$bb115:
  ...
  assume {:verifier.code 0} true;
  $i183 := $ne.i32($i160, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 20} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume ($i162 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 89} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  goto $bb118;
$bb118:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 54} true;
  assume {:verifier.code 0} true;
  $i174 := $i173;
  goto $bb129;
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
  $i167 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
  $i168 := $trunc.i8.i1($i167);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i168} true;
  goto $bb124, $bb126;
$bb121:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 108} true;
  assume {:verifier.code 0} true;
...
$bb124:
  ...
  goto $bb125;
$bb125:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb130, $bb131;
$bb126:
  assume !(($i168 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 131} true;
  assume {:verifier.code 0} true;
...
$bb130:
  assume ($i176 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 184} true;
  assume {:verifier.code 0} true;
...
$bb131:
  ...
  goto $bb132;
$bb132:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 773, 212} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i186 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 36} true;
  assume {:verifier.code 0} true;
...
$bb137:
  assume !(($i186 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 55} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 55} true;
  assume {:verifier.code 0} true;
  $i192 := $trunc.i8.i1($i191);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 70} true;
  assume {:verifier.code 0} true;
...
$bb138:
  ...
  assume {:verifier.code 0} true;
  $i211 := $ne.i32($i190, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 775, 25} true;
  assume {:verifier.code 0} true;
  $i213 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 775, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i213);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i213);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 776, 7} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume ($i192 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 74} true;
  assume {:verifier.code 0} true;
  $i193 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 74} true;
  assume {:verifier.code 0} true;
  $i194 := $trunc.i8.i1($i193);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 89} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  goto $bb141;
$bb141:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 54} true;
  assume {:verifier.code 0} true;
  $i204 := $i203;
  goto $bb152;
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 112} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 112} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i198} true;
  goto $bb147, $bb149;
$bb144:
  assume !(($i194 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 93} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 93} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 108} true;
  assume {:verifier.code 0} true;
...
$bb147:
  ...
  goto $bb148;
$bb148:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
  $i205 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
  $i206 := $trunc.i8.i1($i205);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 181} true;
  assume {:verifier.code 0} true;
  $i207 := 0;
...
$bb149:
  assume !(($i198 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 131} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i206 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 774, 184} true;
  assume {:verifier.code 0} true;
...
$bb156:
  assume ($i215 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 776, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  assume !(($i215 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 776, 37} true;
  assume {:verifier.code 0} true;
  $i218 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 776, 7} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 776, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 776, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i217);
  call {:cexpr "z"} boogie_si_record_i32($i217);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 777, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 780, 25} true;
  assume {:verifier.code 0} true;
  $i219 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 780, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EBX, $i219);
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i219);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 7} true;
  assume {:verifier.code 0} true;
  $i220 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 7} true;
  assume {:verifier.code 0} true;
  $i221 := $trunc.i8.i1($i220);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i221} true;
  goto $bb159, $bb160;
$bb159:
  assume ($i221 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 25} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  goto $bb161;
$bb161:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i227} true;
  goto $bb165, $bb166;
$bb162:
  assume ($i223 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 42} true;
  assume {:verifier.code 0} true;
...
$bb164:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i225);
  call {:cexpr "z"} boogie_si_record_i32($i225);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i233 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $trunc.i8.i1($i233);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 784, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i234} true;
  goto $bb171, $bb172;
$bb165:
  assume ($i227 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 73} true;
  assume {:verifier.code 0} true;
...
$bb166:
  ...
  goto $bb167;
$bb167:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 102} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 55} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i229 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 783, 90} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume ($i234 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 784, 38} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  goto $bb173;
$bb173:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 784, 66} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  assume {:verifier.code 0} true;
  $i241 := $ne.i32($i237, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 20} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $trunc.i8.i1($i243);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i244} true;
  goto $bb177, $bb178;
$bb177:
  assume ($i244 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 38} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $trunc.i8.i1($i245);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 53} true;
  assume {:verifier.code 0} true;
...
$bb178:
  ...
  goto $bb179;
$bb179:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 56} true;
  assume {:verifier.code 0} true;
  $i247 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $trunc.i8.i1($i247);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 71} true;
  assume {:verifier.code 0} true;
...
$bb183:
  assume ($i248 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 74} true;
  assume {:verifier.code 0} true;
...
$bb184:
  ...
  goto $bb185;
$bb185:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 102} true;
  assume {:verifier.code 0} true;
...
$bb188:
  ...
  assume {:verifier.code 0} true;
  $i255 := $ne.i32($i251, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 785, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i257 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i258 := $trunc.i8.i1($i257);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 786, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i258} true;
  goto $bb189, $bb190;
$bb189:
  assume ($i258 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 786, 38} true;
  assume {:verifier.code 0} true;
...
$bb190:
  ...
  goto $bb191;
$bb191:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 786, 66} true;
  assume {:verifier.code 0} true;
...
$bb194:
  ...
  assume {:verifier.code 0} true;
  $i265 := $ne.i32($i261, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 786, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i267 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i268 := $trunc.i8.i1($i267);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i268} true;
  goto $bb195, $bb196;
$bb195:
  assume ($i268 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 38} true;
  assume {:verifier.code 0} true;
  $i269 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 38} true;
  assume {:verifier.code 0} true;
  $i270 := $trunc.i8.i1($i269);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 53} true;
  assume {:verifier.code 0} true;
...
$bb196:
  ...
  goto $bb197;
$bb197:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 56} true;
  assume {:verifier.code 0} true;
  $i271 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 56} true;
  assume {:verifier.code 0} true;
  $i272 := $trunc.i8.i1($i271);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 71} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i272 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 74} true;
  assume {:verifier.code 0} true;
...
$bb202:
  ...
  goto $bb203;
$bb203:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 102} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  assume {:verifier.code 0} true;
  $i279 := $ne.i32($i275, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 790, 22} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 790, 39} true;
  assume {:verifier.code 0} true;
  $i282 := $add.i32($i281, 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i282);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i282);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i65: i32;
$bb0:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 796, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 796, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 797, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 800, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 800, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 803, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 803, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i2);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i8.i1($i3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i8);
  call {:cexpr "z"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 807, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 102} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i12 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 806, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 807, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i20, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i1.i8($i24);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i27 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 56} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i8.i1($i30);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i31 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i38 := $ne.i32($i34, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  $i39 := $zext.i1.i8($i38);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i41 := $trunc.i8.i1($i40);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 809, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i41} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i41 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 809, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 809, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i48 := $ne.i32($i44, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i1.i8($i48);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i51 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 38} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 56} true;
  assume {:verifier.code 0} true;
  $i55 := $trunc.i8.i1($i54);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i55 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i62 := $ne.i32($i58, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  $i63 := $zext.i1.i8($i62);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 813, 22} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 813, 39} true;
  assume {:verifier.code 0} true;
  $i65 := $add.i32($i64, 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i65);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i65);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 815, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i259: i32;
$bb0:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 820, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 823, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 823, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 825, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 826, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 826, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 826, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 827, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 827, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 827, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 828, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 828, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 828, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 828, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 829, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 829, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i9);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i21);
  call {:cexpr "z"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 830, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i32);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 831, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i57} true;
  goto $bb47, $bb48;
$bb46:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i55);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 832, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 833, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 36} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb93, $bb94;
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 834, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i140} true;
  goto $bb113, $bb114;
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i142} true;
  goto $bb116, $bb118;
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 835, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i170} true;
  goto $bb136, $bb137;
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 837, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 837, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EBX, $i191);
  call {:cexpr "__unbuffered_p2_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 836, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 838, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 838, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 838, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i195);
  call {:cexpr "z"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 839, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i198} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i198 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i204 := $trunc.i8.i1($i203);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i204} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i200 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i202);
  call {:cexpr "z"} boogie_si_record_i32($i202);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 843, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i211} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i204 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 102} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i206 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 842, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i211 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 843, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i214, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i221 := $trunc.i8.i1($i220);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i221} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i221 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i223 := $trunc.i8.i1($i222);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i223} true;
  goto $bb177, $bb179;
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i225 := $trunc.i8.i1($i224);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i225 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i232 := $ne.i32($i228, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i235 := $trunc.i8.i1($i234);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 845, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i235} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i235 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 845, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 845, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i242 := $ne.i32($i238, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i245} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i245 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i249 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i256 := $ne.i32($i252, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 849, 22} true;
  assume {:verifier.code 0} true;
  $i258 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 849, 39} true;
  assume {:verifier.code 0} true;
  $i259 := $add.i32($i258, 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i259);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i259);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 850, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 865, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 870, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 871, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 871, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 871, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 871, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 872, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 873, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 873, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 874, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i17);
  call {:cexpr "z"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 876, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 875, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 876, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 878, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 878, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 878, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 880, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 881, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 23} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 43} true;
  assume {:verifier.code 0} true;
  $i74 := $eq.i32($i73, 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 48} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
...
$bb49:
  assume ($i74 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 51} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p0_EBX);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 71} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 76} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
...
$bb51:
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix001_rmo.oepc_tmp.c:882:21: warning: over-approximating bitwise operation xor;
  $i86 := $xor.i1($i75, 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 19} true;
  assume {:verifier.code 0} true;
  $i87 := $zext.i1.i8($i86);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 883, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 884, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i90 := $zext.i1.i32($i89);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 884, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i90);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 885, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i77 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 79} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 99} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 104} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
  assume {:branchcond $i79} true;
  goto $bb54, $bb55;
...
$bb54:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 107} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 127} true;
  assume {:verifier.code 0} true;
  $i81 := $eq.i32($i80, 0);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 132} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
  assume {:branchcond $i81} true;
  goto $bb56, $bb57;
...
$bb56:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 135} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 155} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.i32($i82, 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 160} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
  assume {:branchcond $i83} true;
  goto $bb58, $bb59;
...
$bb58:
  assume ($i83 == 1);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 163} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_p2_EBX);
  assume {:sourceloc "output/mix001_rmo.oepc_tmp.c", 882, 183} true;
  assume {:verifier.code 0} true;
  $i85 := $eq.i32($i84, 0);
  assume {:verifier.code 0} true;
  $i75 := $i85;
