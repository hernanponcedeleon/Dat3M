...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/podwr001_power.opt-O0.bpl /Users/ponce/git/Dat3M/output/podwr001_power.opt_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 84481));
...
axiom (.str.1 == $sub.ref(0, 29783));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 30826));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 31858));
const {:count 3} .str.1.12: ref;
axiom (.str.1.12 == $sub.ref(0, 32885));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 33913));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 34945));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 35977));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 37009));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 38041));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 39073));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 40105));
procedure  llvm.dbg.label($p0: ref);
const P0: ref;
axiom (P0 == $sub.ref(0, 41137));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i87: i32;
$bb0:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 745, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 745, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i1);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 746, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, 1);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 747, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 747, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 747, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 747, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 748, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$w_buff0_used, 1);
  call {:cexpr "z$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 749, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 749, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 749, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 749, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 749, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/podwr001_power.opt_tmp.c:749:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 749, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 750, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 750, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 750, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 750, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 751, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 751, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$r_buff0_thd1, 1);
  call {:cexpr "z$r_buff0_thd1"} boogie_si_record_i8(1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 755, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 757, 25} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, x);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 757, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i24);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i24);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i26 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 55} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 55} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i8.i1($i31);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i32} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i28 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i30);
  call {:cexpr "z"} boogie_si_record_i32($i30);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 761, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 761, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 761, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i32 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 102} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i32($M.0, z);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i34 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 760, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i39 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 761, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 761, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 761, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 761, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i49 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i53 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 762, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 763, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 763, 20} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 763, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i63 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 763, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 763, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i70 := $ne.i32($i66, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 763, 18} true;
  assume {:verifier.code 0} true;
  $i71 := $zext.i1.i8($i70);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 763, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 20} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 20} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i73 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 38} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 38} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 56} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 56} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i77 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i84 := $ne.i32($i80, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 18} true;
  assume {:verifier.code 0} true;
  $i85 := $zext.i1.i8($i84);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 764, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 767, 22} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 767, 39} true;
  assume {:verifier.code 0} true;
  $i87 := $add.i32($i86, 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i87);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i87);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 774, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 777, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 777, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i7);
  call {:cexpr "z"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 781, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, z);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 780, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 781, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 781, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 783, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 783, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 783, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 787, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 787, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i258: i32;
$bb0:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 793, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 793, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 794, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 796, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 797, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 797, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 797, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 798, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 798, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 798, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 799, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 799, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 799, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 799, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 800, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, z);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 800, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i8);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, z);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i20);
  call {:cexpr "z"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 801, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i31);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 802, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i56} true;
  goto $bb47, $bb48;
$bb46:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i54);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 803, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 804, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 805, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 806, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 808, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, z);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 808, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i190);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 809, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 807, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 809, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 809, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, z);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 809, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 809, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 809, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i194);
  call {:cexpr "z"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 810, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 7} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i197} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i197 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 55} true;
  assume {:verifier.code 0} true;
  $i202 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $trunc.i8.i1($i202);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i203} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i199 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i201);
  call {:cexpr "z"} boogie_si_record_i32($i201);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $trunc.i8.i1($i209);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 814, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i210} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i203 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 102} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i32($M.0, z);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i205 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 813, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i210 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 814, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 814, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i217 := $ne.i32($i213, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i219 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $trunc.i8.i1($i219);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i220} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i220 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 38} true;
  assume {:verifier.code 0} true;
  $i221 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $trunc.i8.i1($i221);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 53} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 56} true;
  assume {:verifier.code 0} true;
  $i223 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $trunc.i8.i1($i223);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i224 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i231 := $ne.i32($i227, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $i233 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $trunc.i8.i1($i233);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 816, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i234} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i234 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 816, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 816, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i241 := $ne.i32($i237, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $trunc.i8.i1($i243);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i244} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i244 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 38} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $trunc.i8.i1($i245);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 56} true;
  assume {:verifier.code 0} true;
  $i247 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $trunc.i8.i1($i247);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i248 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i255 := $ne.i32($i251, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 818, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 820, 22} true;
  assume {:verifier.code 0} true;
  $i257 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 820, 39} true;
  assume {:verifier.code 0} true;
  $i258 := $add.i32($i257, 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 820, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i258);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i258);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 836, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 842, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 842, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 842, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 842, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 843, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 844, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i17);
  call {:cexpr "z"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 847, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 847, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 847, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, z);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 846, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 847, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 847, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 847, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 847, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 848, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 849, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 849, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 849, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 849, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 849, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 850, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 852, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 23} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 43} true;
  assume {:verifier.code 0} true;
  $i74 := $eq.i32($i73, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 48} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
...
$bb49:
  assume ($i74 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 51} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 71} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 0);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 76} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
  assume {:branchcond $i77} true;
  goto $bb52, $bb53;
...
$bb51:
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/podwr001_power.opt_tmp.c:853:21: warning: over-approximating bitwise operation xor;
  $i80 := $xor.i1($i75, 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 854, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 855, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i84 := $zext.i1.i32($i83);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 855, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i84);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 856, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i77 == 1);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 79} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/podwr001_power.opt_tmp.c", 853, 99} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 0);
  assume {:verifier.code 0} true;
  $i75 := $i79;
...
axiom (pthread_create == $sub.ref(0, 45265));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 46297));
...
axiom (__SMACK_code == $sub.ref(0, 47329));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 48361));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 49393));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 50425));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 51457));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 52489));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 53521));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 54553));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 55585));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 56617));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 57649));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 58681));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 59713));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 60745));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 61777));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 62809));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 63841));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 64873));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 65905));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 66937));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 67969));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 69001));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 70033));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 71065));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 72097));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 73129));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 74161));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 75193));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 76225));
...
axiom (__SMACK_decls == $sub.ref(0, 77257));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 78289));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 79321));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 80353));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 81385));
...
axiom (llvm.dbg.value == $sub.ref(0, 83449));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 84481));
