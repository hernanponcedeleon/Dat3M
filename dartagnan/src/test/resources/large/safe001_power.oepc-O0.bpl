...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe001_power.oepc-O0.bpl /Users/ponce/git/Dat3M/output/safe001_power.oepc_tmp.c
...
axiom (y$flush_delayed == $sub.ref(0, 8215));
const y$mem_tmp: ref;
axiom (y$mem_tmp == $sub.ref(0, 9243));
const weak$$choice1: ref;
axiom (weak$$choice1 == $sub.ref(0, 10268));
const y$w_buff0_used: ref;
axiom (y$w_buff0_used == $sub.ref(0, 11293));
const y$r_buff0_thd1: ref;
axiom (y$r_buff0_thd1 == $sub.ref(0, 12318));
const y$w_buff0: ref;
axiom (y$w_buff0 == $sub.ref(0, 13346));
const y$r_buff1_thd1: ref;
axiom (y$r_buff1_thd1 == $sub.ref(0, 14371));
const y$w_buff1_used: ref;
axiom (y$w_buff1_used == $sub.ref(0, 15396));
const y$w_buff1: ref;
axiom (y$w_buff1 == $sub.ref(0, 16424));
const __unbuffered_p0_EAX$read_delayed: ref;
axiom (__unbuffered_p0_EAX$read_delayed == $sub.ref(0, 17449));
const __unbuffered_p0_EAX$read_delayed_var: ref;
axiom (__unbuffered_p0_EAX$read_delayed_var == $sub.ref(0, 18481));
const y$r_buff0_thd2: ref;
axiom (y$r_buff0_thd2 == $sub.ref(0, 19506));
const y$r_buff1_thd2: ref;
axiom (y$r_buff1_thd2 == $sub.ref(0, 20531));
const y$r_buff0_thd3: ref;
axiom (y$r_buff0_thd3 == $sub.ref(0, 21556));
const y$r_buff1_thd3: ref;
axiom (y$r_buff1_thd3 == $sub.ref(0, 22581));
const main$tmp_guard0: ref;
axiom (main$tmp_guard0 == $sub.ref(0, 23606));
const y$r_buff0_thd0: ref;
axiom (y$r_buff0_thd0 == $sub.ref(0, 24631));
const y$r_buff1_thd0: ref;
axiom (y$r_buff1_thd0 == $sub.ref(0, 25656));
const main$tmp_guard1: ref;
axiom (main$tmp_guard1 == $sub.ref(0, 26681));
const __unbuffered_p0_EAX$flush_delayed: ref;
axiom (__unbuffered_p0_EAX$flush_delayed == $sub.ref(0, 27706));
const __unbuffered_p0_EAX$mem_tmp: ref;
axiom (__unbuffered_p0_EAX$mem_tmp == $sub.ref(0, 28734));
const __unbuffered_p0_EAX$r_buff0_thd0: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd0 == $sub.ref(0, 29759));
const __unbuffered_p0_EAX$r_buff0_thd1: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd1 == $sub.ref(0, 30784));
const __unbuffered_p0_EAX$r_buff0_thd2: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd2 == $sub.ref(0, 31809));
const __unbuffered_p0_EAX$r_buff0_thd3: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd3 == $sub.ref(0, 32834));
const __unbuffered_p0_EAX$r_buff1_thd0: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd0 == $sub.ref(0, 33859));
const __unbuffered_p0_EAX$r_buff1_thd1: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd1 == $sub.ref(0, 34884));
const __unbuffered_p0_EAX$r_buff1_thd2: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd2 == $sub.ref(0, 35909));
const __unbuffered_p0_EAX$r_buff1_thd3: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd3 == $sub.ref(0, 36934));
const __unbuffered_p0_EAX$w_buff0: ref;
axiom (__unbuffered_p0_EAX$w_buff0 == $sub.ref(0, 37962));
const __unbuffered_p0_EAX$w_buff0_used: ref;
axiom (__unbuffered_p0_EAX$w_buff0_used == $sub.ref(0, 38987));
const __unbuffered_p0_EAX$w_buff1: ref;
axiom (__unbuffered_p0_EAX$w_buff1 == $sub.ref(0, 40015));
const __unbuffered_p0_EAX$w_buff1_used: ref;
axiom (__unbuffered_p0_EAX$w_buff1_used == $sub.ref(0, 41040));
const y$read_delayed: ref;
axiom (y$read_delayed == $sub.ref(0, 42065));
const y$read_delayed_var: ref;
axiom (y$read_delayed_var == $sub.ref(0, 43097));
const .str: ref;
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i314: i32;
$bb0:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 759, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 759, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 759, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 760, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 760, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 760, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 761, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 761, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 761, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 761, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 762, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 762, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i8);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 763, 19} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i9);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 763, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 763, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 30} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 45} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb4, $bb5;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i14);
  call {:cexpr "y"} boogie_si_record_i32($i14);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 15} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 48} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 78} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 78} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 93} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i18 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 65} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 97} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 97} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 112} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 216} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 216} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 231} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i24 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 115} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 115} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 130} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 134} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume !(($i28 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 152} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 168} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 152} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i30 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 173} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i34 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 189} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume !(($i34 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 201} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 234} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 234} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 249} true;
  assume {:verifier.code 0} true;
...
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 331} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i42 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 252} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 252} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i8.i1($i43);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 267} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i44 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 271} true;
  assume {:verifier.code 0} true;
...
$bb34:
  assume !(($i46 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 289} true;
  assume {:verifier.code 0} true;
...
$bb35:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 305} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i48 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 317} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i54 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 347} true;
  assume {:verifier.code 0} true;
...
$bb40:
  assume !(($i54 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 359} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 764, 331} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume ($i59 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 31} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume !(($i59 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 45} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 45} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 44} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i61);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i61);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 15} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume ($i63 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 75} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 75} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i67} true;
  goto $bb48, $bb49;
$bb46:
  assume !(($i63 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 62} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume ($i67 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 93} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 123} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 123} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb54, $bb55;
$bb51:
  assume ($i69 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 110} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume ($i73 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 142} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 142} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 157} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 209} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 209} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 224} true;
  assume {:verifier.code 0} true;
...
$bb58:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 160} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 160} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb59, $bb60;
$bb59:
  assume ($i77 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 179} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume !(($i79 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 196} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i83 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 227} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 227} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 242} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 293} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i85 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 245} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 245} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 260} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i87 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 264} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume !(($i89 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 765, 281} true;
  assume {:verifier.code 0} true;
...
$bb74:
  assume ($i94 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 31} true;
  assume {:verifier.code 0} true;
...
$bb75:
  assume !(($i94 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 45} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 45} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 44} true;
  assume {:verifier.code 0} true;
...
$bb76:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i96);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i96);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
...
$bb77:
  assume ($i98 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 75} true;
  assume {:verifier.code 0} true;
  $i101 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 75} true;
  assume {:verifier.code 0} true;
  $i102 := $trunc.i8.i1($i101);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  goto $bb80, $bb81;
$bb78:
  assume !(($i98 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 62} true;
  assume {:verifier.code 0} true;
...
$bb80:
  assume ($i102 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 93} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 123} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 123} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i108} true;
  goto $bb86, $bb87;
$bb83:
  assume ($i104 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 110} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i108 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 142} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 142} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 157} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 209} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 209} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 224} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume !(($i110 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 160} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 160} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb91, $bb92;
$bb91:
  assume ($i112 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 179} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i114 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 196} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i118 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 227} true;
  assume {:verifier.code 0} true;
  $i119 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 227} true;
  assume {:verifier.code 0} true;
  $i120 := $trunc.i8.i1($i119);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 242} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 293} true;
  assume {:verifier.code 0} true;
...
$bb99:
  assume ($i120 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 245} true;
  assume {:verifier.code 0} true;
  $i121 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 245} true;
  assume {:verifier.code 0} true;
  $i122 := $trunc.i8.i1($i121);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 260} true;
  assume {:verifier.code 0} true;
...
$bb101:
  assume ($i122 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 264} true;
  assume {:verifier.code 0} true;
...
$bb104:
  assume !(($i124 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 766, 281} true;
  assume {:verifier.code 0} true;
...
$bb106:
  assume ($i129 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 36} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume !(($i129 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 55} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 54} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i133, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i135 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 90} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 90} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb112, $bb113;
$bb110:
  assume !(($i135 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 72} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i141 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 108} true;
  assume {:verifier.code 0} true;
...
$bb113:
  ...
  goto $bb114;
$bb114:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 137} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 137} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 152} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i146 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 156} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 156} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 171} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 245} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 245} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 260} true;
  assume {:verifier.code 0} true;
...
$bb122:
  assume !(($i148 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 174} true;
  assume {:verifier.code 0} true;
  $i149 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 174} true;
  assume {:verifier.code 0} true;
  $i150 := $trunc.i8.i1($i149);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i150} true;
  goto $bb123, $bb124;
$bb123:
  assume ($i150 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 193} true;
  assume {:verifier.code 0} true;
...
$bb126:
  assume !(($i152 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 210} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, weak$$choice0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 210} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 224} true;
  assume {:verifier.code 0} true;
  $i155 := 1;
...
$bb129:
  assume !(($i154 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 228} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, weak$$choice1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 228} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 227} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe001_power.oepc_tmp.c:767:227: warning: over-approximating bitwise operation xor;
  $i158 := $xor.i1($i157, 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 224} true;
  assume {:verifier.code 0} true;
  $i155 := $i158;
...
$bb131:
  assume ($i162 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 263} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 263} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 278} true;
  assume {:verifier.code 0} true;
...
$bb132:
  ...
  goto $bb133;
$bb133:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 333} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume ($i164 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 281} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 281} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 296} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i166 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 300} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i168 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 767, 317} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i179 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 36} true;
  assume {:verifier.code 0} true;
...
$bb142:
  assume !(($i179 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 54} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i183, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 20} true;
  assume {:verifier.code 0} true;
...
$bb144:
  assume ($i185 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 90} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 90} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb147, $bb148;
$bb145:
  assume !(($i185 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 72} true;
  assume {:verifier.code 0} true;
...
$bb147:
  assume ($i191 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 108} true;
  assume {:verifier.code 0} true;
...
$bb148:
  ...
  goto $bb149;
$bb149:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 137} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 137} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 152} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i196 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 156} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 156} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 171} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  goto $bb155;
$bb155:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 227} true;
  assume {:verifier.code 0} true;
  $i207 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 227} true;
  assume {:verifier.code 0} true;
  $i208 := $trunc.i8.i1($i207);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 242} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb157:
  assume !(($i198 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 174} true;
  assume {:verifier.code 0} true;
  $i199 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 174} true;
  assume {:verifier.code 0} true;
  $i200 := $trunc.i8.i1($i199);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i200} true;
  goto $bb158, $bb159;
$bb158:
  assume ($i200 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 193} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume !(($i202 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 210} true;
  assume {:verifier.code 0} true;
...
$bb163:
  assume ($i208 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 245} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 245} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 260} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 227} true;
  assume {:verifier.code 0} true;
...
$bb166:
  assume ($i211 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 263} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 263} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 278} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb168:
  assume ($i213 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 282} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 282} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 768, 281} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe001_power.oepc_tmp.c:768:281: warning: over-approximating bitwise operation xor;
  $i216 := $xor.i1($i215, 1);
  assume {:verifier.code 0} true;
  $i209 := $i216;
  goto $bb165;
...
$bb170:
  assume ($i221 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 36} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume !(($i221 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 54} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i225, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
...
$bb173:
  assume ($i227 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 90} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 90} true;
  assume {:verifier.code 0} true;
  $i233 := $trunc.i8.i1($i232);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i233} true;
  goto $bb176, $bb177;
$bb174:
  assume !(($i227 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 72} true;
  assume {:verifier.code 0} true;
...
$bb176:
  assume ($i233 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 108} true;
  assume {:verifier.code 0} true;
...
$bb177:
  ...
  goto $bb178;
$bb178:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 137} true;
  assume {:verifier.code 0} true;
  $i237 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 137} true;
  assume {:verifier.code 0} true;
  $i238 := $trunc.i8.i1($i237);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 152} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume ($i238 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 156} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 156} true;
  assume {:verifier.code 0} true;
  $i240 := $trunc.i8.i1($i239);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 171} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  goto $bb184;
$bb184:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 228} true;
  assume {:verifier.code 0} true;
  $i249 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 228} true;
  assume {:verifier.code 0} true;
  $i250 := $trunc.i8.i1($i249);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 243} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb186:
  assume !(($i240 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 174} true;
  assume {:verifier.code 0} true;
  $i241 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 174} true;
  assume {:verifier.code 0} true;
  $i242 := $trunc.i8.i1($i241);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i242} true;
  goto $bb187, $bb188;
$bb187:
  assume ($i242 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 193} true;
  assume {:verifier.code 0} true;
...
$bb190:
  assume !(($i244 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 210} true;
  assume {:verifier.code 0} true;
...
$bb192:
  assume ($i250 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 246} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 246} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 261} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb195:
  assume ($i253 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 264} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 264} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 279} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb197:
  assume ($i255 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 283} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 283} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 769, 282} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe001_power.oepc_tmp.c:769:282: warning: over-approximating bitwise operation xor;
  $i258 := $xor.i1($i257, 1);
  assume {:verifier.code 0} true;
  $i251 := $i258;
  goto $bb194;
...
$bb199:
  assume ($i263 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 36} true;
  assume {:verifier.code 0} true;
...
$bb200:
  assume !(($i263 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 55} true;
  assume {:verifier.code 0} true;
  $i268 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 55} true;
  assume {:verifier.code 0} true;
  $i269 := $trunc.i8.i1($i268);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 54} true;
  assume {:verifier.code 0} true;
...
$bb201:
  ...
  assume {:verifier.code 0} true;
  $i305 := $ne.i32($i267, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 771, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p0_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p0_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 772, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p0_EAX$read_delayed_var, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 773, 25} true;
  assume {:verifier.code 0} true;
  $i307 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 773, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i307);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i307);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 774, 7} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume ($i269 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 90} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 90} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i275} true;
  goto $bb205, $bb206;
$bb203:
  assume !(($i269 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 72} true;
  assume {:verifier.code 0} true;
...
$bb205:
  assume ($i275 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 108} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  goto $bb207;
$bb207:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 137} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 137} true;
  assume {:verifier.code 0} true;
  $i280 := $trunc.i8.i1($i279);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 152} true;
  assume {:verifier.code 0} true;
...
$bb211:
  assume ($i280 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 156} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 156} true;
  assume {:verifier.code 0} true;
  $i282 := $trunc.i8.i1($i281);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 171} true;
  assume {:verifier.code 0} true;
...
$bb212:
  ...
  goto $bb213;
$bb213:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 257} true;
  assume {:verifier.code 0} true;
  $i294 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 257} true;
  assume {:verifier.code 0} true;
  $i295 := $trunc.i8.i1($i294);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 272} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb215:
  assume !(($i282 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 174} true;
  assume {:verifier.code 0} true;
  $i283 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 174} true;
  assume {:verifier.code 0} true;
  $i284 := $trunc.i8.i1($i283);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i284} true;
  goto $bb216, $bb217;
$bb216:
  assume ($i284 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 193} true;
  assume {:verifier.code 0} true;
...
$bb219:
  assume !(($i286 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 211} true;
  assume {:verifier.code 0} true;
...
$bb220:
  assume ($i288 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 227} true;
  assume {:verifier.code 0} true;
...
$bb224:
  assume ($i295 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 275} true;
  assume {:verifier.code 0} true;
  $i297 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 275} true;
  assume {:verifier.code 0} true;
  $i298 := $trunc.i8.i1($i297);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 290} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb227:
  assume ($i298 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 293} true;
  assume {:verifier.code 0} true;
  $i299 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 293} true;
  assume {:verifier.code 0} true;
  $i300 := $trunc.i8.i1($i299);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 308} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb229:
  assume ($i300 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 312} true;
  assume {:verifier.code 0} true;
  $i301 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 312} true;
  assume {:verifier.code 0} true;
  $i302 := $trunc.i8.i1($i301);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 770, 311} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe001_power.oepc_tmp.c:770:311: warning: over-approximating bitwise operation xor;
  $i303 := $xor.i1($i302, 1);
  assume {:verifier.code 0} true;
  $i296 := $i303;
  goto $bb226;
...
$bb231:
  assume ($i309 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 774, 25} true;
  assume {:verifier.code 0} true;
...
$bb232:
  assume !(($i309 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 774, 37} true;
  assume {:verifier.code 0} true;
  $i312 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 774, 7} true;
  assume {:verifier.code 0} true;
...
$bb233:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 774, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 774, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i311);
  call {:cexpr "y"} boogie_si_record_i32($i311);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 775, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 778, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 783, 22} true;
  assume {:verifier.code 0} true;
  $i313 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 783, 39} true;
  assume {:verifier.code 0} true;
  $i314 := $add.i32($i313, 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i314);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i314);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 790, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 2);
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 793, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i6);
  call {:cexpr "y"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 797, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 796, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 797, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 797, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 799, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 799, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 799, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 799, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 799, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 799, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 799, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 800, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 803, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 803, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i258: i32;
$bb0:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 810, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 810, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 810, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, weak$$choice0, $i2);
  call {:cexpr "weak$$choice0"} boogie_si_record_i8($i2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 811, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 811, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 811, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, weak$$choice2, $i4);
  call {:cexpr "weak$$choice2"} boogie_si_record_i8($i4);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 812, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 812, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 812, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 812, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, $i7);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8($i7);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 813, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 813, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i8);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 42} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb4, $bb6;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i20);
  call {:cexpr "y"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 814, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i31);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 815, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i54);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 816, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i83} true;
  goto $bb73, $bb75;
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i85} true;
  goto $bb76, $bb77;
$bb76:
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 817, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 818, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb116, $bb118;
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i143} true;
  goto $bb119, $bb120;
$bb119:
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 819, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 821, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 821, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i190);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 820, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 822, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 822, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 822, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i194);
  call {:cexpr "y"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 823, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 825, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 826, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 2);
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 827, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 828, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 7} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i197} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i197 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 55} true;
  assume {:verifier.code 0} true;
  $i202 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $trunc.i8.i1($i202);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i203} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i199 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i201);
  call {:cexpr "y"} boogie_si_record_i32($i201);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 830, 20} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 830, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $trunc.i8.i1($i209);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 830, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i210} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i203 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 102} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i205 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 829, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i210 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 830, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 830, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i217 := $ne.i32($i213, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 830, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 20} true;
  assume {:verifier.code 0} true;
  $i219 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $trunc.i8.i1($i219);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i220} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i220 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 38} true;
  assume {:verifier.code 0} true;
  $i221 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $trunc.i8.i1($i221);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 53} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 56} true;
  assume {:verifier.code 0} true;
  $i223 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $trunc.i8.i1($i223);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i224 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i231 := $ne.i32($i227, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 831, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
  $i233 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $trunc.i8.i1($i233);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 832, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i234} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i234 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 832, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 832, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i241 := $ne.i32($i237, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 832, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $trunc.i8.i1($i243);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i244} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i244 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 38} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $trunc.i8.i1($i245);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 56} true;
  assume {:verifier.code 0} true;
  $i247 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $trunc.i8.i1($i247);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i248 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i255 := $ne.i32($i251, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 835, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 836, 22} true;
  assume {:verifier.code 0} true;
  $i257 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 836, 39} true;
  assume {:verifier.code 0} true;
  $i258 := $add.i32($i257, 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 836, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i258);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i258);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 852, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 854, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 856, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 857, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 858, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 858, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 858, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 858, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 859, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 860, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 860, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 861, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i17);
  call {:cexpr "y"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 863, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 863, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 863, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 862, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 863, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 863, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 863, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 863, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 864, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 865, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 865, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 865, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 865, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 865, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 865, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 865, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 866, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 868, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 869, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 869, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 869, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 870, 19} true;
  assume {:verifier.code 1} true;
  call $i75 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i75);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 870, 17} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i8($i75);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 870, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 871, 21} true;
  assume {:verifier.code 0} true;
  $i77 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 871, 21} true;
  assume {:verifier.code 0} true;
  $i78 := $trunc.i8.i1($i77);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 871, 19} true;
  assume {:verifier.code 0} true;
  $i79 := $zext.i1.i8($i78);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 871, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 872, 15} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 872, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i80);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i80);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 8} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 8} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i82} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i82 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 27} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 27} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 42} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 101} true;
  assume {:verifier.code 0} true;
  $i91 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 7} true;
  assume {:verifier.code 0} true;
  $i92 := $i91;
  goto $bb62;
$bb52:
  ...
  goto $bb53;
$bb53:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 65} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 65} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb57, $bb59;
$bb54:
  assume !(($i84 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 46} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 46} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 61} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb58;
$bb58:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 106} true;
  assume {:verifier.code 0} true;
  $i93 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 106} true;
  assume {:verifier.code 0} true;
  $i94 := $trunc.i8.i1($i93);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i94} true;
  goto $bb63, $bb64;
$bb59:
  assume !(($i88 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 84} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i92);
  call {:cexpr "y"} boogie_si_record_i32($i92);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 15} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i94 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 124} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb65;
$bb65:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 153} true;
  assume {:verifier.code 0} true;
  $i99 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 106} true;
  assume {:verifier.code 0} true;
...
$bb66:
  assume ($i96 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 873, 141} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i101 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 31} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume !(($i101 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 45} true;
  assume {:verifier.code 0} true;
  $i104 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 45} true;
  assume {:verifier.code 0} true;
  $i105 := $trunc.i8.i1($i104);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i105} true;
  goto $bb72, $bb73;
$bb71:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i103);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i103);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 15} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i105 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 64} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 64} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 79} true;
  assume {:verifier.code 0} true;
...
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 138} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 44} true;
  assume {:verifier.code 0} true;
  $i115 := $i114;
  goto $bb85;
$bb75:
  ...
  goto $bb76;
$bb76:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 102} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 102} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i111} true;
  goto $bb80, $bb82;
$bb77:
  assume !(($i107 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 83} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 83} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 98} true;
  assume {:verifier.code 0} true;
...
$bb80:
  ...
  goto $bb81;
$bb81:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 151} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 151} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb86, $bb87;
$bb82:
  assume !(($i111 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 121} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i117 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 169} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 198} true;
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i119 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 874, 186} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i124 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 31} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 15} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume !(($i124 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 45} true;
  assume {:verifier.code 0} true;
  $i127 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 45} true;
  assume {:verifier.code 0} true;
  $i128 := $trunc.i8.i1($i127);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 60} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i126);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i126);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
...
$bb95:
  assume ($i128 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 64} true;
  assume {:verifier.code 0} true;
  $i129 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 64} true;
  assume {:verifier.code 0} true;
  $i130 := $trunc.i8.i1($i129);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 79} true;
  assume {:verifier.code 0} true;
...
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 138} true;
  assume {:verifier.code 0} true;
  $i137 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 44} true;
  assume {:verifier.code 0} true;
  $i138 := $i137;
  goto $bb108;
$bb98:
  ...
  goto $bb99;
$bb99:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 102} true;
  assume {:verifier.code 0} true;
  $i133 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 102} true;
  assume {:verifier.code 0} true;
  $i134 := $trunc.i8.i1($i133);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i134} true;
  goto $bb103, $bb105;
$bb100:
  assume !(($i130 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 83} true;
  assume {:verifier.code 0} true;
  $i131 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 83} true;
  assume {:verifier.code 0} true;
  $i132 := $trunc.i8.i1($i131);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 98} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb104;
$bb104:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 151} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 151} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i140} true;
  goto $bb109, $bb110;
$bb105:
  assume !(($i134 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 121} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i140 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 169} true;
  assume {:verifier.code 0} true;
...
$bb110:
  ...
  goto $bb111;
$bb111:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 198} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i142 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 875, 186} true;
  assume {:verifier.code 0} true;
...
$bb115:
  assume ($i147 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 36} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume !(($i147 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 55} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 55} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb118, $bb119;
$bb117:
  ...
  assume {:verifier.code 0} true;
  $i174 := $ne.i32($i151, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i153 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 74} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 74} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i155} true;
  goto $bb121, $bb123;
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 54} true;
  assume {:verifier.code 0} true;
  $i165 := $i164;
  goto $bb131;
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 112} true;
  assume {:verifier.code 0} true;
  $i158 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 112} true;
  assume {:verifier.code 0} true;
  $i159 := $trunc.i8.i1($i158);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i159} true;
  goto $bb126, $bb128;
$bb123:
  assume !(($i155 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 93} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 93} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 108} true;
  assume {:verifier.code 0} true;
...
$bb126:
  ...
  goto $bb127;
$bb127:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 166} true;
  assume {:verifier.code 0} true;
  $i166 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 166} true;
  assume {:verifier.code 0} true;
  $i167 := $trunc.i8.i1($i166);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i167} true;
  goto $bb132, $bb133;
$bb128:
  assume !(($i159 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 131} true;
  assume {:verifier.code 0} true;
...
$bb132:
  assume ($i167 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 184} true;
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  goto $bb134;
$bb134:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 876, 212} true;
  assume {:verifier.code 0} true;
...
$bb138:
  assume ($i177 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 36} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i177 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i183} true;
  goto $bb141, $bb142;
$bb140:
  ...
  assume {:verifier.code 0} true;
  $i202 := $ne.i32($i181, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i183 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 74} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 74} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i185} true;
  goto $bb144, $bb146;
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 54} true;
  assume {:verifier.code 0} true;
  $i195 := $i194;
  goto $bb154;
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 112} true;
  assume {:verifier.code 0} true;
  $i188 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 112} true;
  assume {:verifier.code 0} true;
  $i189 := $trunc.i8.i1($i188);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i189} true;
  goto $bb149, $bb151;
$bb146:
  assume !(($i185 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 93} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 93} true;
  assume {:verifier.code 0} true;
  $i187 := $trunc.i8.i1($i186);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 108} true;
  assume {:verifier.code 0} true;
...
$bb149:
  ...
  goto $bb150;
$bb150:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 166} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 166} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 181} true;
  assume {:verifier.code 0} true;
  $i198 := 0;
  assume {:branchcond $i197} true;
  goto $bb155, $bb156;
$bb151:
  assume !(($i189 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 131} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume ($i197 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 877, 184} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume ($i205 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 36} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume !(($i205 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 55} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 55} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i211} true;
  goto $bb161, $bb162;
$bb160:
  ...
  assume {:verifier.code 0} true;
  $i232 := $ne.i32($i209, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume ($i211 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 74} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 74} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i213} true;
  goto $bb164, $bb166;
$bb162:
  ...
  goto $bb163;
$bb163:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 54} true;
  assume {:verifier.code 0} true;
  $i223 := $i222;
  goto $bb174;
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 112} true;
  assume {:verifier.code 0} true;
  $i216 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 112} true;
  assume {:verifier.code 0} true;
  $i217 := $trunc.i8.i1($i216);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i217} true;
  goto $bb169, $bb171;
$bb166:
  assume !(($i213 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 93} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 93} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 108} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 166} true;
  assume {:verifier.code 0} true;
  $i224 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 166} true;
  assume {:verifier.code 0} true;
  $i225 := $trunc.i8.i1($i224);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i225} true;
  goto $bb175, $bb176;
$bb171:
  assume !(($i217 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 131} true;
  assume {:verifier.code 0} true;
...
$bb175:
  assume ($i225 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 184} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  goto $bb177;
$bb177:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 878, 212} true;
  assume {:verifier.code 0} true;
...
$bb181:
  assume ($i235 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 36} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume !(($i235 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 55} true;
  assume {:verifier.code 0} true;
  $i240 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 55} true;
  assume {:verifier.code 0} true;
  $i241 := $trunc.i8.i1($i240);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 70} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i239, 0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  $i261 := $zext.i1.i8($i260);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 880, 19} true;
  assume {:verifier.code 1} true;
  call $i262 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i262);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 880, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 881, 25} true;
  assume {:verifier.code 0} true;
...
$bb184:
  assume ($i241 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 74} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 74} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 89} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  goto $bb186;
$bb186:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 54} true;
  assume {:verifier.code 0} true;
  $i253 := $i252;
  goto $bb197;
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 112} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 112} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i247} true;
  goto $bb192, $bb194;
$bb189:
  assume !(($i243 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 93} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 93} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 108} true;
  assume {:verifier.code 0} true;
...
$bb192:
  ...
  goto $bb193;
$bb193:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 166} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 166} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 181} true;
  assume {:verifier.code 0} true;
  $i256 := 0;
  assume {:branchcond $i255} true;
  goto $bb198, $bb199;
$bb194:
  assume !(($i247 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 131} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i255 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 879, 184} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i265 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 881, 61} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume !(($i265 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 881, 140} true;
  assume {:verifier.code 0} true;
...
$bb203:
  assume ($i267 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 881, 78} true;
  assume {:verifier.code 0} true;
  $p268 := $load.ref($M.0, __unbuffered_p0_EAX$read_delayed_var);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 881, 77} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume !(($i267 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 881, 117} true;
  assume {:verifier.code 0} true;
...
$bb206:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 881, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 881, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i272);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i272);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 23} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 25} true;
  assume {:verifier.code 0} true;
  $i275 := $eq.i32($i274, 2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 30} true;
  assume {:verifier.code 0} true;
  $i276 := 0;
  assume {:branchcond $i275} true;
  goto $bb207, $bb208;
$bb207:
  assume ($i275 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 33} true;
  assume {:verifier.code 0} true;
  $i277 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 35} true;
  assume {:verifier.code 0} true;
  $i278 := $eq.i32($i277, 2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 40} true;
  assume {:verifier.code 0} true;
  $i276 := 0;
...
$bb209:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe001_power.oepc_tmp.c:882:21: warning: over-approximating bitwise operation xor;
  $i283 := $xor.i1($i276, 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 883, 7} true;
  assume {:verifier.code 0} true;
...
$bb210:
  assume ($i278 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 43} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 63} true;
  assume {:verifier.code 0} true;
  $i280 := $eq.i32($i279, 2);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 68} true;
  assume {:verifier.code 0} true;
  $i276 := 0;
  assume {:branchcond $i280} true;
  goto $bb212, $bb213;
...
$bb212:
  assume ($i280 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 71} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 882, 91} true;
  assume {:verifier.code 0} true;
  $i282 := $eq.i32($i281, 1);
  assume {:verifier.code 0} true;
  $i276 := $i282;
...
$bb214:
  assume ($i286 == 1);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 883, 25} true;
  assume {:verifier.code 0} true;
...
$bb215:
  assume !(($i286 == 1));
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 883, 37} true;
  assume {:verifier.code 0} true;
  $i289 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 883, 7} true;
  assume {:verifier.code 0} true;
...
$bb216:
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 883, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 883, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i288);
  call {:cexpr "y"} boogie_si_record_i32($i288);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 884, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 885, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 886, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 886, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i292);
  assume {:sourceloc "output/safe001_power.oepc_tmp.c", 887, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
