...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix031_power.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix031_power.opt_tmp.c
...
axiom (y$read_delayed == $sub.ref(0, 26686));
const y$read_delayed_var: ref;
axiom (y$read_delayed_var == $sub.ref(0, 27718));
const .str: ref;
axiom (.str == $sub.ref(0, 28744));
const {:count 19} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 29787));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 30830));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 31862));
const {:count 3} .str.1.12: ref;
axiom (.str.1.12 == $sub.ref(0, 32889));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 33917));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 34949));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 35981));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 37013));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 38045));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 39077));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 40109));
procedure  llvm.dbg.label($p0: ref);
const P0: ref;
axiom (P0 == $sub.ref(0, 41141));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i198: i32;
$bb0:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 747, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, 1);
  call {:cexpr "a"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 750, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 752, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 753, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 753, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 755, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 756, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 756, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 756, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 757, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 757, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 757, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 758, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 758, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 758, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 758, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 759, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 759, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i9);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i21);
  call {:cexpr "y"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 760, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i32);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 761, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i55);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 762, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 763, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 764, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 765, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 767, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 767, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EBX, $i191);
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 768, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 766, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 768, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 768, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 768, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 768, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 768, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i195);
  call {:cexpr "y"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 769, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 770, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 774, 22} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 774, 39} true;
  assume {:verifier.code 0} true;
  $i198 := $add.i32($i197, 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 774, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i198);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i198);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i85: i32;
$bb0:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 781, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 781, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i1);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 782, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 1);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 785, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 785, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 785, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 785, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 785, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix031_power.opt_tmp.c:785:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 785, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 786, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 786, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd2, 1);
  call {:cexpr "y$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 790, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 792, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 793, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 795, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 795, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i21);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 796, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 797, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 798, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 798, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i22);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i22);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 25} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 25} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 7} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 42} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $i27;
  goto $bb9;
...
$bb9:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i28);
  call {:cexpr "y"} boogie_si_record_i32($i28);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 802, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i37} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 102} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i32 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 90} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i34 := $i33;
  goto $bb15;
...
$bb16:
  assume ($i37 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 802, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 802, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i40, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  $i45 := $zext.i1.i8($i44);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, $i45);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8($i45);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $trunc.i8.i1($i46);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 38} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 56} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i51 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 74} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 74} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 20} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i58 := $ne.i32($i54, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  $i59 := $zext.i1.i8($i58);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff1_used, $i59);
  call {:cexpr "y$w_buff1_used"} boogie_si_record_i8($i59);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i61} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i61 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 66} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 66} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 66} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i68 := $ne.i32($i64, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i1.i8($i68);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd2, $i69);
  call {:cexpr "y$r_buff0_thd2"} boogie_si_record_i8($i69);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 56} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 74} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 74} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 20} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 102} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, y$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 102} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 102} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i82 := $ne.i32($i78, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  $i83 := $zext.i1.i8($i82);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff1_thd2, $i83);
  call {:cexpr "y$r_buff1_thd2"} boogie_si_record_i8($i83);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 806, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 808, 22} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 808, 39} true;
  assume {:verifier.code 0} true;
  $i85 := $add.i32($i84, 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i85);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i85);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 826, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 827, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 828, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 828, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 828, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 828, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 829, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 830, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 831, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i15);
  call {:cexpr "y"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 833, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 832, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 833, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 833, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 834, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 835, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 835, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 835, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 835, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 835, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 835, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 835, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 836, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 23} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 43} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.i32($i71, 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 48} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
...
$bb49:
  assume ($i72 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 51} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i32($M.0, __unbuffered_p0_EBX);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 71} true;
  assume {:verifier.code 0} true;
  $i75 := $eq.i32($i74, 0);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 76} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i75} true;
  goto $bb52, $bb53;
...
$bb51:
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix031_power.opt_tmp.c:839:21: warning: over-approximating bitwise operation xor;
  $i80 := $xor.i1($i73, 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 841, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i84 := $zext.i1.i32($i83);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 841, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i84);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 842, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 79} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 99} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 104} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i77} true;
  goto $bb54, $bb55;
...
$bb54:
  assume ($i77 == 1);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 107} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/mix031_power.opt_tmp.c", 839, 127} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 0);
  assume {:verifier.code 0} true;
  $i73 := $i79;
