...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix029_pso.oepc-O0.bpl /Users/ponce/git/Dat3M/output/mix029_pso.oepc_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i90: i32;
$bb0:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 750, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 750, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff1, $i1);
  call {:cexpr "a$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 751, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff0, 1);
  call {:cexpr "a$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff0_used, 1);
  call {:cexpr "a$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 754, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 754, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 754, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 754, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 754, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix029_pso.oepc_tmp.c:754:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 754, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 754, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, a$r_buff0_thd3);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 759, 18} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i8($i25);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 759, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 760, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff0_thd1, 1);
  call {:cexpr "a$r_buff0_thd1"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 763, 25} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 763, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i27);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i27);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i35} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i31 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i33);
  call {:cexpr "a"} boogie_si_record_i32($i33);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 767, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i35 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i37 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 766, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 767, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 767, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i56 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i63 := $ne.i32($i59, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  $i64 := $zext.i1.i8($i63);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 769, 20} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 769, 20} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 769, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i66} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i66 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 769, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 769, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 769, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 769, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i76} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 38} true;
  assume {:verifier.code 0} true;
  $i77 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 38} true;
  assume {:verifier.code 0} true;
  $i78 := $trunc.i8.i1($i77);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 56} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 56} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i80 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i87 := $ne.i32($i83, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  $i88 := $zext.i1.i8($i87);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 773, 22} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 773, 39} true;
  assume {:verifier.code 0} true;
  $i90 := $add.i32($i89, 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i90);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i90);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 780, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 783, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i6);
  call {:cexpr "a"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 787, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 786, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 787, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 787, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 789, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 789, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 789, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 793, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 793, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 800, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 2);
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 803, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 42} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i6);
  call {:cexpr "a"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 807, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 90} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 807, 66} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 807, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff0_used, $i23);
  call {:cexpr "a$w_buff0_used"} boogie_si_record_i8($i23);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, a$r_buff0_thd3);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 102} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff1_used, $i37);
  call {:cexpr "a$w_buff1_used"} boogie_si_record_i8($i37);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 809, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 809, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 809, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, a$r_buff0_thd3);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i53} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 813, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 813, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 815, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i259: i32;
$bb0:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 820, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 2);
  call {:cexpr "z"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 823, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 823, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EAX, $i1);
  call {:cexpr "__unbuffered_p3_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 825, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 826, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 826, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 826, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 827, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 827, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 827, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 828, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 828, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 828, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 828, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 829, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 829, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$mem_tmp, $i9);
  call {:cexpr "a$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 61} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb7, $bb8;
$bb7:
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i21);
  call {:cexpr "a"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 124} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 830, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff0, $i32);
  call {:cexpr "a$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 831, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff1, $i55);
  call {:cexpr "a$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 832, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i82} true;
  goto $bb70, $bb71;
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 833, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 834, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 835, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 837, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 837, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EBX, $i191);
  call {:cexpr "__unbuffered_p3_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 836, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 838, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 838, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 838, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i195);
  call {:cexpr "a"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 839, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$flush_delayed, 0);
  call {:cexpr "a$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i198} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i198 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i204 := $trunc.i8.i1($i203);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i204} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i200 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i202);
  call {:cexpr "a"} boogie_si_record_i32($i202);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 843, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i211} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i204 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 102} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i206 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 842, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i211 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 843, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i214, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i221 := $trunc.i8.i1($i220);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i221} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i221 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i223 := $trunc.i8.i1($i222);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 53} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i225 := $trunc.i8.i1($i224);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i225 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i232 := $ne.i32($i228, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i235 := $trunc.i8.i1($i234);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 845, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i235} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i235 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 845, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 845, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i242 := $ne.i32($i238, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i245} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i245 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i249 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i256 := $ne.i32($i252, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 849, 22} true;
  assume {:verifier.code 0} true;
  $i258 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 849, 39} true;
  assume {:verifier.code 0} true;
  $i259 := $add.i32($i258, 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i259);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i259);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 850, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 865, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 871, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 872, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 873, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 873, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 873, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 873, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 874, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 875, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 875, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 876, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i19);
  call {:cexpr "a"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 878, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 877, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 878, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 878, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 880, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 880, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 880, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 880, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 880, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 880, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 880, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i66} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 881, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 882, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 883, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 23} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 25} true;
  assume {:verifier.code 0} true;
  $i76 := $eq.i32($i75, 2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 30} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
  assume {:branchcond $i76} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 33} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 35} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 40} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb51:
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix029_pso.oepc_tmp.c:884:21: warning: over-approximating bitwise operation xor;
  $i86 := $xor.i1($i77, 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 19} true;
  assume {:verifier.code 0} true;
  $i87 := $zext.i1.i8($i86);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 885, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 886, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i90 := $zext.i1.i32($i89);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 886, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i90);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 887, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 43} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 63} true;
  assume {:verifier.code 0} true;
  $i81 := $eq.i32($i80, 0);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 68} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb54:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 71} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, __unbuffered_p3_EAX);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 91} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.i32($i82, 2);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 96} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb56:
  assume ($i83 == 1);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 99} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_p3_EBX);
  assume {:sourceloc "output/mix029_pso.oepc_tmp.c", 884, 119} true;
  assume {:verifier.code 0} true;
  $i85 := $eq.i32($i84, 0);
  assume {:verifier.code 0} true;
  $i77 := $i85;
