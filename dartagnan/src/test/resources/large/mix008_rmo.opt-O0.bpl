...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix008_rmo.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix008_rmo.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 752, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, 1);
  call {:cexpr "a"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 755, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 760, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 760, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 760, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 767, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 2);
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 770, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 775, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 775, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 775, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i198: i32;
$bb0:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 782, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 2);
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 785, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 785, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 787, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 788, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 788, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 788, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 789, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 789, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 789, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 790, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 790, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 790, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 790, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 791, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 791, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i9);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i21);
  call {:cexpr "z"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 792, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i32);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 793, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i55);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 794, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 795, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 796, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 797, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 799, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 799, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EBX, $i191);
  call {:cexpr "__unbuffered_p2_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 800, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 798, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 800, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 800, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 800, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 800, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 800, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i195);
  call {:cexpr "z"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 801, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 806, 22} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 806, 39} true;
  assume {:verifier.code 0} true;
  $i198 := $add.i32($i197, 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i198);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i198);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i285: i32;
$bb0:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 813, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 813, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i1);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 814, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, 1);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$w_buff0_used, 1);
  call {:cexpr "z$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 817, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 817, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 817, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 817, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 817, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix008_rmo.opt_tmp.c:817:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 817, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 817, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 819, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 819, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 819, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 819, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 820, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 820, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 820, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 820, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 821, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 821, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 821, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 821, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 822, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 822, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 822, 18} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i8($i25);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 822, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 823, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$r_buff0_thd4, 1);
  call {:cexpr "z$r_buff0_thd4"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 825, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 826, 19} true;
  assume {:verifier.code 1} true;
  call $i27 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i27);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 826, 17} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i1.i8($i27);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 826, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 827, 19} true;
  assume {:verifier.code 1} true;
  call $i29 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i29);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 827, 17} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i1.i8($i29);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 827, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 828, 21} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 828, 21} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i8.i1($i31);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 828, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i1.i8($i32);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 828, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 829, 15} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 829, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i34);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i34);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 8} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 8} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i36 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 27} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 27} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 42} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb7, $bb9;
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 101} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
  $i46 := $i45;
  goto $bb17;
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 65} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 65} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb12, $bb14;
$bb9:
  assume !(($i38 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 46} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 46} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 61} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb10, $bb11;
$bb10:
...
$bb12:
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 106} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 106} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb18, $bb19;
$bb14:
  assume !(($i42 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 84} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i46);
  call {:cexpr "z"} boogie_si_record_i32($i46);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 15} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 124} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 153} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i50 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 141} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 830, 106} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i55 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 31} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume !(($i55 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 45} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 45} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i59} true;
  goto $bb27, $bb28;
$bb26:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i57);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i57);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 15} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i59 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 64} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 64} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 79} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i61} true;
  goto $bb30, $bb32;
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 138} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 44} true;
  assume {:verifier.code 0} true;
  $i69 := $i68;
  goto $bb40;
$bb30:
  ...
  goto $bb31;
$bb31:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 102} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 102} true;
  assume {:verifier.code 0} true;
  $i65 := $trunc.i8.i1($i64);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i65} true;
  goto $bb35, $bb37;
$bb32:
  assume !(($i61 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 83} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 83} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 98} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb33, $bb34;
$bb33:
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 151} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 151} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb41, $bb42;
$bb37:
  assume !(($i65 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 121} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 169} true;
  assume {:verifier.code 0} true;
...
$bb42:
  ...
  goto $bb43;
$bb43:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 198} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i73 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 831, 186} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i78 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 31} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume !(($i78 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 45} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 45} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i82} true;
  goto $bb50, $bb51;
$bb49:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i80);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i80);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 64} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 64} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 79} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i84} true;
  goto $bb53, $bb55;
$bb51:
  ...
  goto $bb52;
$bb52:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 138} true;
  assume {:verifier.code 0} true;
  $i91 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 44} true;
  assume {:verifier.code 0} true;
  $i92 := $i91;
  goto $bb63;
$bb53:
  ...
  goto $bb54;
$bb54:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 102} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb58, $bb60;
$bb55:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 83} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 83} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 98} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i86} true;
  goto $bb56, $bb57;
$bb56:
...
$bb58:
  ...
  goto $bb59;
$bb59:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 151} true;
  assume {:verifier.code 0} true;
  $i93 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 151} true;
  assume {:verifier.code 0} true;
  $i94 := $trunc.i8.i1($i93);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i94} true;
  goto $bb64, $bb65;
$bb60:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 121} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i94 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 169} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 198} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 832, 186} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i101 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 36} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume !(($i101 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 70} true;
  assume {:verifier.code 0} true;
...
$bb72:
  ...
  assume {:verifier.code 0} true;
  $i128 := $ne.i32($i105, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 20} true;
  assume {:verifier.code 0} true;
...
$bb73:
  assume ($i107 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 89} true;
  assume {:verifier.code 0} true;
...
$bb74:
  ...
  goto $bb75;
$bb75:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 54} true;
  assume {:verifier.code 0} true;
  $i119 := $i118;
  goto $bb86;
$bb76:
  ...
  goto $bb77;
$bb77:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i113} true;
  goto $bb81, $bb83;
$bb78:
  assume !(($i109 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 108} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i120 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i121 := $trunc.i8.i1($i120);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i121} true;
  goto $bb87, $bb88;
$bb83:
  assume !(($i113 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 131} true;
  assume {:verifier.code 0} true;
...
$bb87:
  assume ($i121 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 184} true;
  assume {:verifier.code 0} true;
...
$bb88:
  ...
  goto $bb89;
$bb89:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 212} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 833, 212} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i131 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 36} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i131 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 55} true;
  assume {:verifier.code 0} true;
  $i136 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 55} true;
  assume {:verifier.code 0} true;
  $i137 := $trunc.i8.i1($i136);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 70} true;
  assume {:verifier.code 0} true;
...
$bb95:
  ...
  assume {:verifier.code 0} true;
  $i156 := $ne.i32($i135, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 20} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i137 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 74} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 74} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 89} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 54} true;
  assume {:verifier.code 0} true;
  $i149 := $i148;
  goto $bb109;
$bb99:
  ...
  goto $bb100;
$bb100:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 112} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 112} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i143} true;
  goto $bb104, $bb106;
$bb101:
  assume !(($i139 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 93} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 93} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 108} true;
  assume {:verifier.code 0} true;
...
$bb104:
  ...
  goto $bb105;
$bb105:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 166} true;
  assume {:verifier.code 0} true;
  $i150 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 166} true;
  assume {:verifier.code 0} true;
  $i151 := $trunc.i8.i1($i150);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 181} true;
  assume {:verifier.code 0} true;
  $i152 := 0;
...
$bb106:
  assume !(($i143 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 131} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i151 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 834, 184} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i159 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 36} true;
  assume {:verifier.code 0} true;
...
$bb114:
  assume !(($i159 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
  $i164 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
  $i165 := $trunc.i8.i1($i164);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 70} true;
  assume {:verifier.code 0} true;
...
$bb115:
  ...
  assume {:verifier.code 0} true;
  $i186 := $ne.i32($i163, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 20} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume ($i165 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 74} true;
  assume {:verifier.code 0} true;
  $i166 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 74} true;
  assume {:verifier.code 0} true;
  $i167 := $trunc.i8.i1($i166);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 89} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  goto $bb118;
$bb118:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 54} true;
  assume {:verifier.code 0} true;
  $i177 := $i176;
  goto $bb129;
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 112} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 112} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i171} true;
  goto $bb124, $bb126;
$bb121:
  assume !(($i167 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 93} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 93} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 108} true;
  assume {:verifier.code 0} true;
...
$bb124:
  ...
  goto $bb125;
$bb125:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 166} true;
  assume {:verifier.code 0} true;
  $i178 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 166} true;
  assume {:verifier.code 0} true;
  $i179 := $trunc.i8.i1($i178);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i179} true;
  goto $bb130, $bb131;
$bb126:
  assume !(($i171 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 131} true;
  assume {:verifier.code 0} true;
...
$bb130:
  assume ($i179 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 184} true;
  assume {:verifier.code 0} true;
...
$bb131:
  ...
  goto $bb132;
$bb132:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 835, 212} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i189 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 36} true;
  assume {:verifier.code 0} true;
...
$bb137:
  assume !(($i189 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i194 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i195 := $trunc.i8.i1($i194);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 70} true;
  assume {:verifier.code 0} true;
...
$bb138:
  ...
  assume {:verifier.code 0} true;
  $i214 := $ne.i32($i193, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 837, 25} true;
  assume {:verifier.code 0} true;
  $i216 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 837, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EAX, $i216);
  call {:cexpr "__unbuffered_p3_EAX"} boogie_si_record_i32($i216);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume ($i195 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 74} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 74} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 89} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  goto $bb141;
$bb141:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 54} true;
  assume {:verifier.code 0} true;
  $i207 := $i206;
  goto $bb152;
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 112} true;
  assume {:verifier.code 0} true;
  $i200 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 112} true;
  assume {:verifier.code 0} true;
  $i201 := $trunc.i8.i1($i200);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i201} true;
  goto $bb147, $bb149;
$bb144:
  assume !(($i197 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 93} true;
  assume {:verifier.code 0} true;
  $i198 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 93} true;
  assume {:verifier.code 0} true;
  $i199 := $trunc.i8.i1($i198);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 108} true;
  assume {:verifier.code 0} true;
...
$bb147:
  ...
  goto $bb148;
$bb148:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 166} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 166} true;
  assume {:verifier.code 0} true;
  $i209 := $trunc.i8.i1($i208);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 181} true;
  assume {:verifier.code 0} true;
  $i210 := 0;
...
$bb149:
  assume !(($i201 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 131} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i209 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 836, 184} true;
  assume {:verifier.code 0} true;
...
$bb156:
  assume ($i218 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 838, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  assume !(($i218 == 1));
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 838, 37} true;
  assume {:verifier.code 0} true;
  $i221 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 838, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i220);
  call {:cexpr "z"} boogie_si_record_i32($i220);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 839, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 842, 25} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 842, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EBX, $i222);
  call {:cexpr "__unbuffered_p3_EBX"} boogie_si_record_i32($i222);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 843, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 7} true;
  assume {:verifier.code 0} true;
  $i223 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 7} true;
  assume {:verifier.code 0} true;
  $i224 := $trunc.i8.i1($i223);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i224} true;
  goto $bb159, $bb160;
$bb159:
  assume ($i224 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 25} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  goto $bb161;
$bb161:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 55} true;
  assume {:verifier.code 0} true;
  $i229 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 55} true;
  assume {:verifier.code 0} true;
  $i230 := $trunc.i8.i1($i229);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i230} true;
  goto $bb165, $bb166;
$bb162:
  assume ($i226 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 42} true;
  assume {:verifier.code 0} true;
...
$bb164:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i228);
  call {:cexpr "z"} boogie_si_record_i32($i228);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i236 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i237 := $trunc.i8.i1($i236);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 846, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i237} true;
  goto $bb171, $bb172;
$bb165:
  assume ($i230 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 73} true;
  assume {:verifier.code 0} true;
...
$bb166:
  ...
  goto $bb167;
$bb167:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 102} true;
  assume {:verifier.code 0} true;
  $i235 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 55} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i232 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 845, 90} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume ($i237 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  goto $bb173;
$bb173:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 846, 66} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  assume {:verifier.code 0} true;
  $i244 := $ne.i32($i240, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 20} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 20} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i247} true;
  goto $bb177, $bb178;
$bb177:
  assume ($i247 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 38} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 38} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 53} true;
  assume {:verifier.code 0} true;
...
$bb178:
  ...
  goto $bb179;
$bb179:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 56} true;
  assume {:verifier.code 0} true;
  $i250 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 56} true;
  assume {:verifier.code 0} true;
  $i251 := $trunc.i8.i1($i250);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 71} true;
  assume {:verifier.code 0} true;
...
$bb183:
  assume ($i251 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 74} true;
  assume {:verifier.code 0} true;
...
$bb184:
  ...
  goto $bb185;
$bb185:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 102} true;
  assume {:verifier.code 0} true;
...
$bb188:
  ...
  assume {:verifier.code 0} true;
  $i258 := $ne.i32($i254, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 847, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 848, 20} true;
  assume {:verifier.code 0} true;
  $i260 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 848, 20} true;
  assume {:verifier.code 0} true;
  $i261 := $trunc.i8.i1($i260);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 848, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i261} true;
  goto $bb189, $bb190;
$bb189:
  assume ($i261 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 848, 38} true;
  assume {:verifier.code 0} true;
...
$bb190:
  ...
  goto $bb191;
$bb191:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 848, 66} true;
  assume {:verifier.code 0} true;
...
$bb194:
  ...
  assume {:verifier.code 0} true;
  $i268 := $ne.i32($i264, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 848, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $i270 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $i271 := $trunc.i8.i1($i270);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i271} true;
  goto $bb195, $bb196;
$bb195:
  assume ($i271 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 38} true;
  assume {:verifier.code 0} true;
  $i272 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 38} true;
  assume {:verifier.code 0} true;
  $i273 := $trunc.i8.i1($i272);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 53} true;
  assume {:verifier.code 0} true;
...
$bb196:
  ...
  goto $bb197;
$bb197:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 56} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 56} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 71} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i275 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 74} true;
  assume {:verifier.code 0} true;
...
$bb202:
  ...
  goto $bb203;
$bb203:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 102} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  assume {:verifier.code 0} true;
  $i282 := $ne.i32($i278, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 849, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 850, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 852, 22} true;
  assume {:verifier.code 0} true;
  $i284 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 852, 39} true;
  assume {:verifier.code 0} true;
  $i285 := $add.i32($i284, 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 852, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i285);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i285);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 853, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 854, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 868, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 870, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 872, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 874, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 875, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 876, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 876, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 876, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 877, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 878, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 878, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 879, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i19);
  call {:cexpr "z"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 881, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 881, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 881, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 880, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 881, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 881, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 881, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 881, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 882, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 883, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 883, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 883, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 883, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 883, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 883, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 883, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 884, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 885, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 886, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 23} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 25} true;
  assume {:verifier.code 0} true;
  $i76 := $eq.i32($i75, 2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 30} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
  assume {:branchcond $i76} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 33} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 35} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 40} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb51:
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix008_rmo.opt_tmp.c:887:21: warning: over-approximating bitwise operation xor;
  $i88 := $xor.i1($i77, 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 19} true;
  assume {:verifier.code 0} true;
  $i89 := $zext.i1.i8($i88);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 888, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 889, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 889, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i92);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 890, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 43} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 63} true;
  assume {:verifier.code 0} true;
  $i81 := $eq.i32($i80, 2);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 68} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb54:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 71} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, __unbuffered_p2_EBX);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 91} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.i32($i82, 0);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 96} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb56:
  assume ($i83 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 99} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_p3_EAX);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 119} true;
  assume {:verifier.code 0} true;
  $i85 := $eq.i32($i84, 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 124} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb58:
  assume ($i85 == 1);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 127} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i32($M.0, __unbuffered_p3_EBX);
  assume {:sourceloc "output/mix008_rmo.opt_tmp.c", 887, 147} true;
  assume {:verifier.code 0} true;
  $i87 := $eq.i32($i86, 0);
  assume {:verifier.code 0} true;
  $i77 := $i87;
