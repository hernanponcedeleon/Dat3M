...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe006_tso.opt-O0.bpl /Users/ponce/git/Dat3M/output/safe006_tso.opt_tmp.c
...
{
$bb0:
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 721, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 721, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 722, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 722, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 723, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 724, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 725, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 726, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 727, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 728, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 729, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 730, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 730, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 730, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 731, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 732, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 736, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 736, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 737, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 737, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 738, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 739, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 740, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 741, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 743, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 745, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 745, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 745, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 747, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 765, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 765, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 765, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 765, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 767, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 770, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 771, 23} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 771, 43} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, 1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 771, 48} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
...
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 771, 51} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 771, 71} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i32($i13, 1);
  assume {:verifier.code 0} true;
  $i12 := $i14;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 771, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe006_tso.opt_tmp.c:771:21: warning: over-approximating bitwise operation xor;
  $i15 := $xor.i1($i12, 1);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 771, 19} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i8($i15);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 771, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 773, 21} true;
  ...
  assume {:verifier.code 1} true;
  $i19 := $zext.i1.i32($i18);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i19);
  assume {:sourceloc "output/safe006_tso.opt_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
