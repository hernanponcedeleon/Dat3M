...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix047_rmo.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix047_rmo.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 750, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, 1);
  call {:cexpr "b"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 752, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 753, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 755, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 758, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 758, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 765, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 2);
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 768, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 770, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 773, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 773, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 780, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 2);
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 783, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i6);
  call {:cexpr "z"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 787, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 786, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 787, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 787, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 789, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 789, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 789, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 793, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 793, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i91: i32;
$bb0:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 800, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 800, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i1);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 801, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, 2);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$w_buff0_used, 1);
  call {:cexpr "z$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 804, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 804, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 804, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 804, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 804, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix047_rmo.opt_tmp.c:804:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 804, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 804, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 806, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 806, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, z$r_buff0_thd3);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i8($i25);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$r_buff0_thd4, 1);
  call {:cexpr "z$r_buff0_thd4"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 813, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, 1);
  call {:cexpr "a"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 815, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 816, 25} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 816, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EAX, $i27);
  call {:cexpr "__unbuffered_p3_EAX"} boogie_si_record_i32($i27);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 817, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 818, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 819, 25} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i32($M.0, b);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 819, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EBX, $i28);
  call {:cexpr "__unbuffered_p3_EBX"} boogie_si_record_i32($i28);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 820, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 55} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 55} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i32 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i34);
  call {:cexpr "z"} boogie_si_record_i32($i34);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 823, 20} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 823, 20} true;
  assume {:verifier.code 0} true;
  $i43 := $trunc.i8.i1($i42);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 823, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i43} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i36 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 102} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 822, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i43 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 823, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 823, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i50 := $ne.i32($i46, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 823, 18} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.i1.i8($i50);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 823, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 20} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i53} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 38} true;
  assume {:verifier.code 0} true;
  $i54 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 38} true;
  assume {:verifier.code 0} true;
  $i55 := $trunc.i8.i1($i54);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i55} true;
  goto $bb25, $bb27;
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 56} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 56} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i64 := $ne.i32($i60, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 18} true;
  assume {:verifier.code 0} true;
  $i65 := $zext.i1.i8($i64);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 824, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 825, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i67} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i67 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 825, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 825, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i74 := $ne.i32($i70, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  $i75 := $zext.i1.i8($i74);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i77 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 38} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i8($M.0, z$r_buff0_thd4);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 38} true;
  assume {:verifier.code 0} true;
  $i79 := $trunc.i8.i1($i78);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 56} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 56} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i88 := $ne.i32($i84, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  $i89 := $zext.i1.i8($i88);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 827, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 828, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 829, 22} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 829, 39} true;
  assume {:verifier.code 0} true;
  $i91 := $add.i32($i90, 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 829, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i91);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i91);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 831, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 849, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 852, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 853, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 853, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 853, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 853, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 854, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 855, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 855, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 856, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i19);
  call {:cexpr "z"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 858, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 858, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 858, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 857, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 858, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 858, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 858, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 858, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 859, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 860, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 860, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 860, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 860, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 860, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 860, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 860, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 861, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 862, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 863, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 864, 19} true;
  assume {:verifier.code 1} true;
  call $i75 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i75);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 864, 17} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i8($i75);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 864, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 865, 19} true;
  assume {:verifier.code 1} true;
  call $i77 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i77);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 865, 17} true;
  assume {:verifier.code 0} true;
  $i78 := $zext.i1.i8($i77);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 865, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 866, 21} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 866, 21} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 866, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 866, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 867, 15} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 867, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i82);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i82);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 8} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 8} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i84} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i84 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 27} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 27} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 42} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 101} true;
  assume {:verifier.code 0} true;
  $i93 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 7} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb62;
$bb52:
  ...
  goto $bb53;
$bb53:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 65} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 65} true;
  assume {:verifier.code 0} true;
  $i90 := $trunc.i8.i1($i89);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i90} true;
  goto $bb57, $bb59;
$bb54:
  assume !(($i86 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 46} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 46} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 61} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb58;
$bb58:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 106} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 106} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb63, $bb64;
$bb59:
  assume !(($i90 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 84} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i94);
  call {:cexpr "z"} boogie_si_record_i32($i94);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 15} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 124} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb65;
$bb65:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 153} true;
  assume {:verifier.code 0} true;
...
$bb66:
  assume ($i98 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 868, 141} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i103 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 31} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume !(($i103 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 45} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 45} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 60} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i105);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i105);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 15} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i107 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 64} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 64} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 79} true;
  assume {:verifier.code 0} true;
...
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 138} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 44} true;
  assume {:verifier.code 0} true;
  $i117 := $i116;
  goto $bb85;
$bb75:
  ...
  goto $bb76;
$bb76:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 102} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 102} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i113} true;
  goto $bb80, $bb82;
$bb77:
  assume !(($i109 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 83} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 83} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 98} true;
  assume {:verifier.code 0} true;
...
$bb80:
  ...
  goto $bb81;
$bb81:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 151} true;
  assume {:verifier.code 0} true;
  $i118 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 151} true;
  assume {:verifier.code 0} true;
  $i119 := $trunc.i8.i1($i118);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i119} true;
  goto $bb86, $bb87;
$bb82:
  assume !(($i113 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 121} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i119 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 169} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 198} true;
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i121 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 869, 186} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 31} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume !(($i126 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 45} true;
  assume {:verifier.code 0} true;
  $i129 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 45} true;
  assume {:verifier.code 0} true;
  $i130 := $trunc.i8.i1($i129);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 60} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i128);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i128);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 20} true;
  assume {:verifier.code 0} true;
...
$bb95:
  assume ($i130 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 64} true;
  assume {:verifier.code 0} true;
  $i131 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 64} true;
  assume {:verifier.code 0} true;
  $i132 := $trunc.i8.i1($i131);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 79} true;
  assume {:verifier.code 0} true;
...
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 138} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 44} true;
  assume {:verifier.code 0} true;
  $i140 := $i139;
  goto $bb108;
$bb98:
  ...
  goto $bb99;
$bb99:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 102} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 102} true;
  assume {:verifier.code 0} true;
  $i136 := $trunc.i8.i1($i135);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i136} true;
  goto $bb103, $bb105;
$bb100:
  assume !(($i132 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 83} true;
  assume {:verifier.code 0} true;
  $i133 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 83} true;
  assume {:verifier.code 0} true;
  $i134 := $trunc.i8.i1($i133);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 98} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb104;
$bb104:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 151} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 151} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i142} true;
  goto $bb109, $bb110;
$bb105:
  assume !(($i136 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 121} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i142 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 169} true;
  assume {:verifier.code 0} true;
...
$bb110:
  ...
  goto $bb111;
$bb111:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 198} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i144 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 870, 186} true;
  assume {:verifier.code 0} true;
...
$bb115:
  assume ($i149 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 36} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume !(($i149 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 55} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 55} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 70} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i153, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 20} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i155 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 74} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 74} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 89} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 54} true;
  assume {:verifier.code 0} true;
  $i167 := $i166;
  goto $bb131;
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 112} true;
  assume {:verifier.code 0} true;
  $i160 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 112} true;
  assume {:verifier.code 0} true;
  $i161 := $trunc.i8.i1($i160);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i161} true;
  goto $bb126, $bb128;
$bb123:
  assume !(($i157 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 93} true;
  assume {:verifier.code 0} true;
  $i158 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 93} true;
  assume {:verifier.code 0} true;
  $i159 := $trunc.i8.i1($i158);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 108} true;
  assume {:verifier.code 0} true;
...
$bb126:
  ...
  goto $bb127;
$bb127:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 166} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 166} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i169} true;
  goto $bb132, $bb133;
$bb128:
  assume !(($i161 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 131} true;
  assume {:verifier.code 0} true;
...
$bb132:
  assume ($i169 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 184} true;
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  goto $bb134;
$bb134:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 871, 212} true;
  assume {:verifier.code 0} true;
...
$bb138:
  assume ($i179 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 36} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i179 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 70} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  assume {:verifier.code 0} true;
  $i204 := $ne.i32($i183, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 20} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i185 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 74} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 74} true;
  assume {:verifier.code 0} true;
  $i187 := $trunc.i8.i1($i186);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 89} true;
  assume {:verifier.code 0} true;
...
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 54} true;
  assume {:verifier.code 0} true;
  $i197 := $i196;
  goto $bb154;
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 112} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 112} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb149, $bb151;
$bb146:
  assume !(($i187 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 93} true;
  assume {:verifier.code 0} true;
  $i188 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 93} true;
  assume {:verifier.code 0} true;
  $i189 := $trunc.i8.i1($i188);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 108} true;
  assume {:verifier.code 0} true;
...
$bb149:
  ...
  goto $bb150;
$bb150:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 166} true;
  assume {:verifier.code 0} true;
  $i198 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 166} true;
  assume {:verifier.code 0} true;
  $i199 := $trunc.i8.i1($i198);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 181} true;
  assume {:verifier.code 0} true;
  $i200 := 0;
...
$bb151:
  assume !(($i191 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 131} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume ($i199 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 872, 184} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume ($i207 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 36} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume !(($i207 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 55} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 55} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 70} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  assume {:verifier.code 0} true;
  $i234 := $ne.i32($i211, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume ($i213 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 74} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 74} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 89} true;
  assume {:verifier.code 0} true;
...
$bb162:
  ...
  goto $bb163;
$bb163:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 54} true;
  assume {:verifier.code 0} true;
  $i225 := $i224;
  goto $bb174;
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 112} true;
  assume {:verifier.code 0} true;
  $i218 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 112} true;
  assume {:verifier.code 0} true;
  $i219 := $trunc.i8.i1($i218);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i219} true;
  goto $bb169, $bb171;
$bb166:
  assume !(($i215 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 93} true;
  assume {:verifier.code 0} true;
  $i216 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 93} true;
  assume {:verifier.code 0} true;
  $i217 := $trunc.i8.i1($i216);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 108} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 166} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 166} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i227} true;
  goto $bb175, $bb176;
$bb171:
  assume !(($i219 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 131} true;
  assume {:verifier.code 0} true;
...
$bb175:
  assume ($i227 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 184} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  goto $bb177;
$bb177:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 873, 212} true;
  assume {:verifier.code 0} true;
...
$bb181:
  assume ($i237 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 36} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume !(($i237 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 55} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 55} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 70} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  assume {:verifier.code 0} true;
  $i262 := $ne.i32($i241, 0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 23} true;
  assume {:verifier.code 0} true;
  $i264 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 25} true;
  assume {:verifier.code 0} true;
  $i265 := $eq.i32($i264, 2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 30} true;
  assume {:verifier.code 0} true;
  $i266 := 0;
...
$bb184:
  assume ($i243 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 74} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 74} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 89} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  goto $bb186;
$bb186:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 54} true;
  assume {:verifier.code 0} true;
  $i255 := $i254;
  goto $bb197;
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 112} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 112} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i249} true;
  goto $bb192, $bb194;
$bb189:
  assume !(($i245 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 93} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 93} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 108} true;
  assume {:verifier.code 0} true;
...
$bb192:
  ...
  goto $bb193;
$bb193:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 166} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 166} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 181} true;
  assume {:verifier.code 0} true;
  $i258 := 0;
...
$bb194:
  assume !(($i249 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 131} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i257 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 874, 184} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i265 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 33} true;
  assume {:verifier.code 0} true;
  $i267 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 35} true;
  assume {:verifier.code 0} true;
  $i268 := $eq.i32($i267, 2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 40} true;
  assume {:verifier.code 0} true;
  $i266 := 0;
...
$bb203:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix047_rmo.opt_tmp.c:875:21: warning: over-approximating bitwise operation xor;
  $i275 := $xor.i1($i266, 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 876, 7} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume ($i268 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 43} true;
  assume {:verifier.code 0} true;
  $i269 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 45} true;
  assume {:verifier.code 0} true;
  $i270 := $eq.i32($i269, 2);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 50} true;
  assume {:verifier.code 0} true;
  $i266 := 0;
...
$bb206:
  assume ($i270 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 53} true;
  assume {:verifier.code 0} true;
  $i271 := $load.i32($M.0, __unbuffered_p3_EAX);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 73} true;
  assume {:verifier.code 0} true;
  $i272 := $eq.i32($i271, 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 78} true;
  assume {:verifier.code 0} true;
  $i266 := 0;
...
$bb208:
  assume ($i272 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 81} true;
  assume {:verifier.code 0} true;
  $i273 := $load.i32($M.0, __unbuffered_p3_EBX);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 875, 101} true;
  assume {:verifier.code 0} true;
  $i274 := $eq.i32($i273, 0);
  assume {:verifier.code 0} true;
  $i266 := $i274;
...
$bb210:
  assume ($i278 == 1);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 876, 25} true;
  assume {:verifier.code 0} true;
...
$bb211:
  assume !(($i278 == 1));
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 876, 37} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 876, 7} true;
  assume {:verifier.code 0} true;
...
$bb212:
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 876, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 876, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i280);
  call {:cexpr "z"} boogie_si_record_i32($i280);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 877, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 878, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 879, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 879, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i284);
  assume {:sourceloc "output/mix047_rmo.opt_tmp.c", 880, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
