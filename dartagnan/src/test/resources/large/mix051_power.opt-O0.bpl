...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix051_power.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix051_power.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i89: i32;
$bb0:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 750, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 750, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff1, $i1);
  call {:cexpr "a$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 751, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff0, 1);
  call {:cexpr "a$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff0_used, 1);
  call {:cexpr "a$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 754, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 754, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 754, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 754, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 754, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix051_power.opt_tmp.c:754:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 754, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 754, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, a$r_buff0_thd3);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 759, 18} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i8($i25);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 759, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 760, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff0_thd1, 1);
  call {:cexpr "a$r_buff0_thd1"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 763, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i28 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i32);
  call {:cexpr "a"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i41 := $trunc.i8.i1($i40);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 767, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i41} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i36 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 766, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i41 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 767, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 767, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i48 := $ne.i32($i44, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i1.i8($i48);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i51 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i55 := $trunc.i8.i1($i54);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i55 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i62 := $ne.i32($i58, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  $i63 := $zext.i1.i8($i62);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 769, 20} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 769, 20} true;
  assume {:verifier.code 0} true;
  $i65 := $trunc.i8.i1($i64);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 769, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i65} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i65 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 769, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 769, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i72 := $ne.i32($i68, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 769, 18} true;
  assume {:verifier.code 0} true;
  $i73 := $zext.i1.i8($i72);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 769, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i75} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 38} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 38} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 56} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 56} true;
  assume {:verifier.code 0} true;
  $i79 := $trunc.i8.i1($i78);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i86 := $ne.i32($i82, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  $i87 := $zext.i1.i8($i86);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 773, 22} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 773, 39} true;
  assume {:verifier.code 0} true;
  $i89 := $add.i32($i88, 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i89);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i89);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 780, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 2);
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 783, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 783, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i7);
  call {:cexpr "a"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 787, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 786, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 787, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 787, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 789, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 789, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 789, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 793, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 793, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 800, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 803, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 803, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 42} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i7);
  call {:cexpr "a"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 807, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 90} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 806, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 807, 66} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 807, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff0_used, $i24);
  call {:cexpr "a$w_buff0_used"} boogie_si_record_i8($i24);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, a$r_buff0_thd3);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 102} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff1_used, $i38);
  call {:cexpr "a$w_buff1_used"} boogie_si_record_i8($i38);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 809, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 809, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 809, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, a$r_buff0_thd3);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i54} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 813, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 813, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 815, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i258: i32;
$bb0:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 820, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 823, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 823, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 823, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 824, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 824, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 824, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 825, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 825, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 825, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 825, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 826, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 826, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$mem_tmp, $i8);
  call {:cexpr "a$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i20);
  call {:cexpr "a"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 827, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff0, $i31);
  call {:cexpr "a$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 828, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i56} true;
  goto $bb47, $bb48;
$bb46:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff1, $i54);
  call {:cexpr "a$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 829, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i81} true;
  goto $bb70, $bb71;
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 830, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 831, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 832, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 834, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 834, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EAX, $i190);
  call {:cexpr "__unbuffered_p3_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 833, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 835, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 835, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 835, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i194);
  call {:cexpr "a"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 836, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$flush_delayed, 0);
  call {:cexpr "a$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i197} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i197 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
  $i202 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $trunc.i8.i1($i202);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i203} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i199 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i201);
  call {:cexpr "a"} boogie_si_record_i32($i201);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $trunc.i8.i1($i209);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 840, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i210} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i203 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 102} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i205 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 839, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i210 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 840, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i217 := $ne.i32($i213, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i219 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $trunc.i8.i1($i219);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i220} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i220 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
  $i221 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $trunc.i8.i1($i221);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 53} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 56} true;
  assume {:verifier.code 0} true;
  $i223 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $trunc.i8.i1($i223);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i224 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i231 := $ne.i32($i227, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 841, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
  $i233 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $trunc.i8.i1($i233);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 842, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i234} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i234 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 842, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 842, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i241 := $ne.i32($i237, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 842, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $trunc.i8.i1($i243);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i244} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i244 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, a$r_buff0_thd4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $trunc.i8.i1($i245);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 56} true;
  assume {:verifier.code 0} true;
  $i247 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $trunc.i8.i1($i247);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i248 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i255 := $ne.i32($i251, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 846, 22} true;
  assume {:verifier.code 0} true;
  $i257 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 846, 39} true;
  assume {:verifier.code 0} true;
  $i258 := $add.i32($i257, 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i258);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i258);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 862, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 864, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 866, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 868, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 870, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 870, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 870, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 870, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 871, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 872, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 872, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 873, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i19);
  call {:cexpr "a"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 875, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 874, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 875, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 875, 66} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 875, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 877, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 877, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 877, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 879, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 880, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 23} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 25} true;
  assume {:verifier.code 0} true;
  $i76 := $eq.i32($i75, 2);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 30} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
...
$bb49:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 33} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 53} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 58} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
  assume {:branchcond $i79} true;
  goto $bb52, $bb53;
...
$bb51:
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix051_power.opt_tmp.c:881:21: warning: over-approximating bitwise operation xor;
  $i84 := $xor.i1($i77, 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 19} true;
  assume {:verifier.code 0} true;
  $i85 := $zext.i1.i8($i84);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 882, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 883, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i88 := $zext.i1.i32($i87);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 883, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i88);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 884, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 61} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 81} true;
  assume {:verifier.code 0} true;
  $i81 := $eq.i32($i80, 0);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 86} true;
  assume {:verifier.code 0} true;
  $i77 := 0;
  assume {:branchcond $i81} true;
  goto $bb54, $bb55;
...
$bb54:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 89} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, __unbuffered_p3_EAX);
  assume {:sourceloc "output/mix051_power.opt_tmp.c", 881, 109} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.i32($i82, 0);
  assume {:verifier.code 0} true;
  $i77 := $i83;
