...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/thin002_pso.opt-O0.bpl /Users/ponce/git/Dat3M/output/thin002_pso.opt_tmp.c
...
{
$bb0:
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 731, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 731, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 732, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, a);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 732, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 733, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 734, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 735, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 736, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 737, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 738, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 739, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 740, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 740, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 740, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 741, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 747, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 747, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 750, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 752, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 755, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 755, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 762, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 762, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 765, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 770, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 770, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 777, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 777, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EAX, $i1);
  call {:cexpr "__unbuffered_p3_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 780, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, 1);
  call {:cexpr "a"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 785, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 785, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 785, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 787, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 809, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 809, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 809, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 809, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 811, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 813, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 43} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 48} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 51} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 71} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 76} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin002_pso.opt_tmp.c:815:21: warning: over-approximating bitwise operation xor;
  $i23 := $xor.i1($i16, 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 19} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 817, 21} true;
  ...
  assume {:verifier.code 1} true;
  $i27 := $zext.i1.i32($i26);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 817, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i27);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 818, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i18 == 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 79} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 99} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i19, 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 104} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
...
$bb6:
  assume ($i20 == 1);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 107} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, __unbuffered_p3_EAX);
  assume {:sourceloc "output/thin002_pso.opt_tmp.c", 815, 127} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, 1);
  assume {:verifier.code 0} true;
  $i16 := $i22;
