...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix048_tso.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix048_tso.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i84: i32;
$bb0:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 737, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 737, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 738, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 738, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i1);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 739, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 1);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 740, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 740, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 740, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 740, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 741, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 742, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 742, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 742, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 742, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 742, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix048_tso.opt_tmp.c:742:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 742, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 743, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 743, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 743, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 743, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 744, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 744, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 744, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 744, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 745, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 745, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 745, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 745, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 746, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd1, 1);
  call {:cexpr "y$r_buff0_thd1"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 747, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 749, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 749, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i21);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 750, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 7} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 55} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 55} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i27);
  call {:cexpr "y"} boogie_si_record_i32($i27);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 753, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 102} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i31 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 752, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i36 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 753, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 753, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i43 := $ne.i32($i39, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  $i44 := $zext.i1.i8($i43);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 20} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 38} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 38} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 56} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 56} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i50 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 755, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i60 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 755, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 755, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i67 := $ne.i32($i63, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  $i68 := $zext.i1.i8($i67);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
  $i69 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
  $i70 := $trunc.i8.i1($i69);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i70} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i70 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 38} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 38} true;
  assume {:verifier.code 0} true;
  $i72 := $trunc.i8.i1($i71);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 56} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 56} true;
  assume {:verifier.code 0} true;
  $i74 := $trunc.i8.i1($i73);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i74 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i81 := $ne.i32($i77, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  $i82 := $zext.i1.i8($i81);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 759, 22} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 759, 39} true;
  assume {:verifier.code 0} true;
  $i84 := $add.i32($i83, 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i84);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i84);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i258: i32;
$bb0:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 766, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 769, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 769, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 769, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 770, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 770, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 770, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 771, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 771, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 771, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 771, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 772, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 772, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i8);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i20);
  call {:cexpr "y"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 773, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i31);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 774, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i54);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 98} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb53, $bb54;
$bb53:
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 775, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 776, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 777, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 778, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 780, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 780, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i190);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 781, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 779, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 781, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 781, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 781, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 781, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 781, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i194);
  call {:cexpr "y"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 782, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 7} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i197} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i197 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 55} true;
  assume {:verifier.code 0} true;
  $i202 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $trunc.i8.i1($i202);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i203} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i199 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i201);
  call {:cexpr "y"} boogie_si_record_i32($i201);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $trunc.i8.i1($i209);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 786, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i210} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i203 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 102} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i205 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 785, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i210 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 786, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 786, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i217 := $ne.i32($i213, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 786, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i219 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $trunc.i8.i1($i219);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i220} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i220 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 38} true;
  assume {:verifier.code 0} true;
  $i221 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $trunc.i8.i1($i221);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 53} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 56} true;
  assume {:verifier.code 0} true;
  $i223 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $trunc.i8.i1($i223);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i224 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i231 := $ne.i32($i227, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i233 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $trunc.i8.i1($i233);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 788, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i234} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i234 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 788, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i241 := $ne.i32($i237, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $trunc.i8.i1($i243);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i244} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i244 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 38} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $trunc.i8.i1($i245);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 56} true;
  assume {:verifier.code 0} true;
  $i247 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $trunc.i8.i1($i247);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i248 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i255 := $ne.i32($i251, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 790, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 792, 22} true;
  assume {:verifier.code 0} true;
  $i257 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 792, 39} true;
  assume {:verifier.code 0} true;
  $i258 := $add.i32($i257, 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i258);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i258);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 793, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 812, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 812, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 812, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 812, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 813, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 814, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 815, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i15);
  call {:cexpr "y"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 817, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 816, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 817, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 817, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 819, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 819, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 819, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 819, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 819, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 819, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 819, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 820, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 823, 23} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 823, 43} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.i32($i71, 0);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 823, 48} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i72} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i72 == 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 823, 51} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 823, 71} true;
  assume {:verifier.code 0} true;
  $i75 := $eq.i32($i74, 0);
  assume {:verifier.code 0} true;
  $i73 := $i75;
...
$bb51:
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 823, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix048_tso.opt_tmp.c:823:21: warning: over-approximating bitwise operation xor;
  $i76 := $xor.i1($i73, 1);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 823, 19} true;
  assume {:verifier.code 0} true;
  $i77 := $zext.i1.i8($i76);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 823, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 825, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i80 := $zext.i1.i32($i79);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 825, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i80);
  assume {:sourceloc "output/mix048_tso.opt_tmp.c", 826, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
