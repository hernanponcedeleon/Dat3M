...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix006_power.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix006_power.opt_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 85507));
...
axiom (y$flush_delayed == $sub.ref(0, 11299));
const y$mem_tmp: ref;
axiom (y$mem_tmp == $sub.ref(0, 12327));
const y$w_buff0_used: ref;
axiom (y$w_buff0_used == $sub.ref(0, 13352));
const y$r_buff0_thd2: ref;
axiom (y$r_buff0_thd2 == $sub.ref(0, 14377));
const y$w_buff1_used: ref;
axiom (y$w_buff1_used == $sub.ref(0, 15402));
const y$r_buff1_thd2: ref;
axiom (y$r_buff1_thd2 == $sub.ref(0, 16427));
const y$w_buff0: ref;
axiom (y$w_buff0 == $sub.ref(0, 17455));
const y$w_buff1: ref;
axiom (y$w_buff1 == $sub.ref(0, 18483));
const y$r_buff0_thd0: ref;
axiom (y$r_buff0_thd0 == $sub.ref(0, 19508));
const y$r_buff1_thd0: ref;
axiom (y$r_buff1_thd0 == $sub.ref(0, 20533));
const y$r_buff0_thd1: ref;
axiom (y$r_buff0_thd1 == $sub.ref(0, 21558));
const y$r_buff1_thd1: ref;
axiom (y$r_buff1_thd1 == $sub.ref(0, 22583));
const y$r_buff0_thd3: ref;
axiom (y$r_buff0_thd3 == $sub.ref(0, 23608));
const y$r_buff1_thd3: ref;
axiom (y$r_buff1_thd3 == $sub.ref(0, 24633));
const main$tmp_guard0: ref;
axiom (main$tmp_guard0 == $sub.ref(0, 25658));
const main$tmp_guard1: ref;
axiom (main$tmp_guard1 == $sub.ref(0, 26683));
const y$read_delayed: ref;
axiom (y$read_delayed == $sub.ref(0, 27708));
const y$read_delayed_var: ref;
axiom (y$read_delayed_var == $sub.ref(0, 28740));
const .str: ref;
axiom (.str == $sub.ref(0, 29766));
const {:count 19} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 30809));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 31852));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 32884));
const {:count 3} .str.1.12: ref;
axiom (.str.1.12 == $sub.ref(0, 33911));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 34939));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 35971));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 37003));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 38035));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 39067));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 40099));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 41131));
procedure  llvm.dbg.label($p0: ref);
const P0: ref;
axiom (P0 == $sub.ref(0, 42163));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 747, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 750, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 751, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 752, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 755, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 755, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i198: i32;
$bb0:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 762, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 2);
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 765, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 765, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 768, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 768, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 768, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 769, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 769, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 769, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 770, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 770, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 770, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 770, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 771, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 771, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i9);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i21);
  call {:cexpr "y"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 772, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i32);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 773, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i55);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 774, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 775, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 776, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 777, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 779, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 779, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i191);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 778, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 780, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 780, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 780, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 780, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i195);
  call {:cexpr "y"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 781, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 786, 22} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 786, 39} true;
  assume {:verifier.code 0} true;
  $i198 := $add.i32($i197, 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i198);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i198);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 787, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i282: i32;
$bb0:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 793, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 793, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i1);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 794, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 1);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 797, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 797, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 797, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 797, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 797, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix006_power.opt_tmp.c:797:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 797, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 797, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 799, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 799, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 799, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 799, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 800, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 800, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 800, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 800, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 801, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 801, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 801, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 801, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd3, 1);
  call {:cexpr "y$r_buff0_thd3"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 805, 19} true;
  assume {:verifier.code 1} true;
  call $i24 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i24);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 805, 17} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i1.i8($i24);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 805, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 806, 19} true;
  assume {:verifier.code 1} true;
  call $i26 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i26);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 806, 17} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i1.i8($i26);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 806, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 807, 21} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 807, 21} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 807, 19} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i1.i8($i29);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 807, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 808, 15} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 808, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i31);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 8} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 8} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i33} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i33 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 27} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 27} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 42} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 101} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 7} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb17;
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 65} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 65} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb12, $bb14;
$bb9:
  assume !(($i35 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 46} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 46} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 61} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 106} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 106} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb18, $bb19;
$bb14:
  assume !(($i39 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 84} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i43);
  call {:cexpr "y"} boogie_si_record_i32($i43);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 15} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i45 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 124} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 153} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 809, 141} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 31} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume !(($i52 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 60} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i54);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 15} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i56 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 79} true;
  assume {:verifier.code 0} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb40;
$bb30:
  ...
  goto $bb31;
$bb31:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb35, $bb37;
$bb32:
  assume !(($i58 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 98} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb41, $bb42;
$bb37:
  assume !(($i62 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 121} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i68 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 169} true;
  assume {:verifier.code 0} true;
...
$bb42:
  ...
  goto $bb43;
$bb43:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 198} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i70 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 810, 186} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 31} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume !(($i75 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 45} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 45} true;
  assume {:verifier.code 0} true;
  $i79 := $trunc.i8.i1($i78);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 60} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i77);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i77);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 64} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 64} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 79} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  goto $bb52;
$bb52:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 138} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 44} true;
  assume {:verifier.code 0} true;
  $i89 := $i88;
  goto $bb63;
$bb53:
  ...
  goto $bb54;
$bb54:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 102} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 102} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i85} true;
  goto $bb58, $bb60;
$bb55:
  assume !(($i81 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 83} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 83} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 98} true;
  assume {:verifier.code 0} true;
...
$bb58:
  ...
  goto $bb59;
$bb59:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 151} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 151} true;
  assume {:verifier.code 0} true;
  $i91 := $trunc.i8.i1($i90);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i91} true;
  goto $bb64, $bb65;
$bb60:
  assume !(($i85 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 121} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i91 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 169} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 198} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i93 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 811, 186} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i98 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 36} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume !(($i98 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 55} true;
  assume {:verifier.code 0} true;
  $i103 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 55} true;
  assume {:verifier.code 0} true;
  $i104 := $trunc.i8.i1($i103);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 70} true;
  assume {:verifier.code 0} true;
...
$bb72:
  ...
  assume {:verifier.code 0} true;
  $i125 := $ne.i32($i102, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
...
$bb73:
  assume ($i104 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 74} true;
  assume {:verifier.code 0} true;
  $i105 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 74} true;
  assume {:verifier.code 0} true;
  $i106 := $trunc.i8.i1($i105);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i106} true;
  goto $bb76, $bb78;
$bb74:
  ...
  goto $bb75;
$bb75:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 54} true;
  assume {:verifier.code 0} true;
  $i116 := $i115;
  goto $bb86;
$bb76:
  ...
  goto $bb77;
$bb77:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 112} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 112} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i110} true;
  goto $bb81, $bb83;
$bb78:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 93} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 93} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 108} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 166} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 166} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb87, $bb88;
$bb83:
  assume !(($i110 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 131} true;
  assume {:verifier.code 0} true;
...
$bb87:
  assume ($i118 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 184} true;
  assume {:verifier.code 0} true;
...
$bb88:
  ...
  goto $bb89;
$bb89:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 812, 212} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i128 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 36} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i128 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 55} true;
  assume {:verifier.code 0} true;
  $i133 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $trunc.i8.i1($i133);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i134} true;
  goto $bb96, $bb97;
$bb95:
  ...
  assume {:verifier.code 0} true;
  $i153 := $ne.i32($i132, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 74} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 74} true;
  assume {:verifier.code 0} true;
  $i136 := $trunc.i8.i1($i135);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 89} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 148} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 54} true;
  assume {:verifier.code 0} true;
  $i146 := $i145;
  goto $bb109;
$bb99:
  ...
  goto $bb100;
$bb100:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 112} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 112} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i140} true;
  goto $bb104, $bb106;
$bb101:
  assume !(($i136 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 93} true;
  assume {:verifier.code 0} true;
  $i137 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 93} true;
  assume {:verifier.code 0} true;
  $i138 := $trunc.i8.i1($i137);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 108} true;
  assume {:verifier.code 0} true;
...
$bb104:
  ...
  goto $bb105;
$bb105:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 166} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 166} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 181} true;
  assume {:verifier.code 0} true;
  $i149 := 0;
  assume {:branchcond $i148} true;
  goto $bb110, $bb111;
$bb106:
  assume !(($i140 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 131} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i148 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 813, 184} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i156 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 36} true;
  assume {:verifier.code 0} true;
...
$bb114:
  assume !(($i156 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 55} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 55} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 70} true;
  assume {:verifier.code 0} true;
...
$bb115:
  ...
  assume {:verifier.code 0} true;
  $i183 := $ne.i32($i160, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume ($i162 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 74} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 74} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i164} true;
  goto $bb119, $bb121;
$bb117:
  ...
  goto $bb118;
$bb118:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 54} true;
  assume {:verifier.code 0} true;
  $i174 := $i173;
  goto $bb129;
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 112} true;
  assume {:verifier.code 0} true;
  $i167 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 112} true;
  assume {:verifier.code 0} true;
  $i168 := $trunc.i8.i1($i167);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i168} true;
  goto $bb124, $bb126;
$bb121:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 93} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 93} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 108} true;
  assume {:verifier.code 0} true;
...
$bb124:
  ...
  goto $bb125;
$bb125:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 166} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 166} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb130, $bb131;
$bb126:
  assume !(($i168 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 131} true;
  assume {:verifier.code 0} true;
...
$bb130:
  assume ($i176 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 184} true;
  assume {:verifier.code 0} true;
...
$bb131:
  ...
  goto $bb132;
$bb132:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 814, 212} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i186 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 36} true;
  assume {:verifier.code 0} true;
...
$bb137:
  assume !(($i186 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 55} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 55} true;
  assume {:verifier.code 0} true;
  $i192 := $trunc.i8.i1($i191);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 70} true;
  assume {:verifier.code 0} true;
...
$bb138:
  ...
  assume {:verifier.code 0} true;
  $i211 := $ne.i32($i190, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 816, 25} true;
  assume {:verifier.code 0} true;
  $i213 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 816, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i213);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i213);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 817, 7} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume ($i192 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 74} true;
  assume {:verifier.code 0} true;
  $i193 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 74} true;
  assume {:verifier.code 0} true;
  $i194 := $trunc.i8.i1($i193);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 89} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  goto $bb141;
$bb141:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 54} true;
  assume {:verifier.code 0} true;
  $i204 := $i203;
  goto $bb152;
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 112} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 112} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i198} true;
  goto $bb147, $bb149;
$bb144:
  assume !(($i194 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 93} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 93} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 108} true;
  assume {:verifier.code 0} true;
...
$bb147:
  ...
  goto $bb148;
$bb148:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 166} true;
  assume {:verifier.code 0} true;
  $i205 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 166} true;
  assume {:verifier.code 0} true;
  $i206 := $trunc.i8.i1($i205);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 181} true;
  assume {:verifier.code 0} true;
  $i207 := 0;
...
$bb149:
  assume !(($i198 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 131} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i206 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 815, 184} true;
  assume {:verifier.code 0} true;
...
$bb156:
  assume ($i215 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 817, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  assume !(($i215 == 1));
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 817, 37} true;
  assume {:verifier.code 0} true;
  $i218 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 817, 7} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 817, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 817, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i217);
  call {:cexpr "y"} boogie_si_record_i32($i217);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 818, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 820, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 821, 25} true;
  assume {:verifier.code 0} true;
  $i219 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 821, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EBX, $i219);
  call {:cexpr "__unbuffered_p2_EBX"} boogie_si_record_i32($i219);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 7} true;
  assume {:verifier.code 0} true;
  $i220 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 7} true;
  assume {:verifier.code 0} true;
  $i221 := $trunc.i8.i1($i220);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i221} true;
  goto $bb159, $bb160;
$bb159:
  assume ($i221 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 25} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  goto $bb161;
$bb161:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i227} true;
  goto $bb165, $bb166;
$bb162:
  assume ($i223 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 42} true;
  assume {:verifier.code 0} true;
...
$bb164:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i225);
  call {:cexpr "y"} boogie_si_record_i32($i225);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i233 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $trunc.i8.i1($i233);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 825, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i234} true;
  goto $bb171, $bb172;
$bb165:
  assume ($i227 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 73} true;
  assume {:verifier.code 0} true;
...
$bb166:
  ...
  goto $bb167;
$bb167:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 102} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i229 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 824, 90} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume ($i234 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 825, 38} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  goto $bb173;
$bb173:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 825, 66} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  assume {:verifier.code 0} true;
  $i241 := $ne.i32($i237, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $trunc.i8.i1($i243);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i244} true;
  goto $bb177, $bb178;
$bb177:
  assume ($i244 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 38} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $trunc.i8.i1($i245);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 53} true;
  assume {:verifier.code 0} true;
...
$bb178:
  ...
  goto $bb179;
$bb179:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 56} true;
  assume {:verifier.code 0} true;
  $i247 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $trunc.i8.i1($i247);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 71} true;
  assume {:verifier.code 0} true;
...
$bb183:
  assume ($i248 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 74} true;
  assume {:verifier.code 0} true;
...
$bb184:
  ...
  goto $bb185;
$bb185:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 102} true;
  assume {:verifier.code 0} true;
...
$bb188:
  ...
  assume {:verifier.code 0} true;
  $i255 := $ne.i32($i251, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 827, 20} true;
  assume {:verifier.code 0} true;
  $i257 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 827, 20} true;
  assume {:verifier.code 0} true;
  $i258 := $trunc.i8.i1($i257);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 827, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i258} true;
  goto $bb189, $bb190;
$bb189:
  assume ($i258 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 827, 38} true;
  assume {:verifier.code 0} true;
...
$bb190:
  ...
  goto $bb191;
$bb191:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 827, 66} true;
  assume {:verifier.code 0} true;
...
$bb194:
  ...
  assume {:verifier.code 0} true;
  $i265 := $ne.i32($i261, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 827, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
  $i267 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
  $i268 := $trunc.i8.i1($i267);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i268} true;
  goto $bb195, $bb196;
$bb195:
  assume ($i268 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 38} true;
  assume {:verifier.code 0} true;
  $i269 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 38} true;
  assume {:verifier.code 0} true;
  $i270 := $trunc.i8.i1($i269);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 53} true;
  assume {:verifier.code 0} true;
...
$bb196:
  ...
  goto $bb197;
$bb197:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 56} true;
  assume {:verifier.code 0} true;
  $i271 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 56} true;
  assume {:verifier.code 0} true;
  $i272 := $trunc.i8.i1($i271);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 71} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i272 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 74} true;
  assume {:verifier.code 0} true;
...
$bb202:
  ...
  goto $bb203;
$bb203:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 102} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  assume {:verifier.code 0} true;
  $i279 := $ne.i32($i275, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 828, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 829, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 831, 22} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 831, 39} true;
  assume {:verifier.code 0} true;
  $i282 := $add.i32($i281, 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 831, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i282);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i282);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 833, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 849, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 852, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 853, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 853, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 853, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 853, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 854, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 855, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 855, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 856, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i17);
  call {:cexpr "y"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 858, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 858, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 858, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 857, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 858, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 858, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 858, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 858, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 859, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 860, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 860, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 860, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 860, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 860, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 860, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 860, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 861, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 862, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 863, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 23} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 25} true;
  assume {:verifier.code 0} true;
  $i74 := $eq.i32($i73, 2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 30} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
...
$bb49:
  assume ($i74 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 33} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 53} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 2);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 58} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
...
$bb51:
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix006_power.opt_tmp.c:864:21: warning: over-approximating bitwise operation xor;
  $i84 := $xor.i1($i75, 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 19} true;
  assume {:verifier.code 0} true;
  $i85 := $zext.i1.i8($i84);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 865, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 866, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i88 := $zext.i1.i32($i87);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 866, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i88);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i77 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 61} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 81} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 0);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 86} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
  assume {:branchcond $i79} true;
  goto $bb54, $bb55;
...
$bb54:
  assume ($i79 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 89} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 109} true;
  assume {:verifier.code 0} true;
  $i81 := $eq.i32($i80, 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 114} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
  assume {:branchcond $i81} true;
  goto $bb56, $bb57;
...
$bb56:
  assume ($i81 == 1);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 117} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, __unbuffered_p2_EBX);
  assume {:sourceloc "output/mix006_power.opt_tmp.c", 864, 137} true;
  assume {:verifier.code 0} true;
  $i83 := $eq.i32($i82, 0);
  assume {:verifier.code 0} true;
  $i75 := $i83;
...
axiom (pthread_create == $sub.ref(0, 46291));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 47323));
...
axiom (__SMACK_code == $sub.ref(0, 48355));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 49387));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 50419));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 51451));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 52483));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 53515));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 54547));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 55579));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 56611));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 57643));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 58675));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 59707));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 60739));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 61771));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 62803));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 63835));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 64867));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 65899));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 66931));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 67963));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 68995));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 70027));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 71059));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 72091));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 73123));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 74155));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 75187));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 76219));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 77251));
...
axiom (__SMACK_decls == $sub.ref(0, 78283));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 79315));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 80347));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 81379));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 82411));
...
axiom (llvm.dbg.value == $sub.ref(0, 84475));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 85507));
