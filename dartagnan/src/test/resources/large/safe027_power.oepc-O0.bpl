...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe027_power.oepc-O0.bpl /Users/ponce/git/Dat3M/output/safe027_power.oepc_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 107054));
...
axiom (y$flush_delayed == $sub.ref(0, 10271));
const y$mem_tmp: ref;
axiom (y$mem_tmp == $sub.ref(0, 11299));
const weak$$choice1: ref;
axiom (weak$$choice1 == $sub.ref(0, 12324));
const y$w_buff0_used: ref;
axiom (y$w_buff0_used == $sub.ref(0, 13349));
const y$r_buff0_thd1: ref;
axiom (y$r_buff0_thd1 == $sub.ref(0, 14374));
const y$w_buff0: ref;
axiom (y$w_buff0 == $sub.ref(0, 15402));
const y$r_buff1_thd1: ref;
axiom (y$r_buff1_thd1 == $sub.ref(0, 16427));
const y$w_buff1_used: ref;
axiom (y$w_buff1_used == $sub.ref(0, 17452));
const y$w_buff1: ref;
axiom (y$w_buff1 == $sub.ref(0, 18480));
const __unbuffered_p0_EAX$read_delayed: ref;
axiom (__unbuffered_p0_EAX$read_delayed == $sub.ref(0, 19505));
const __unbuffered_p0_EAX$read_delayed_var: ref;
axiom (__unbuffered_p0_EAX$read_delayed_var == $sub.ref(0, 20537));
const y$r_buff0_thd3: ref;
axiom (y$r_buff0_thd3 == $sub.ref(0, 21562));
const y$r_buff1_thd3: ref;
axiom (y$r_buff1_thd3 == $sub.ref(0, 22587));
const y$r_buff0_thd4: ref;
axiom (y$r_buff0_thd4 == $sub.ref(0, 23612));
const y$r_buff1_thd4: ref;
axiom (y$r_buff1_thd4 == $sub.ref(0, 24637));
const main$tmp_guard0: ref;
axiom (main$tmp_guard0 == $sub.ref(0, 25662));
const y$r_buff0_thd0: ref;
axiom (y$r_buff0_thd0 == $sub.ref(0, 26687));
const y$r_buff1_thd0: ref;
axiom (y$r_buff1_thd0 == $sub.ref(0, 27712));
const main$tmp_guard1: ref;
axiom (main$tmp_guard1 == $sub.ref(0, 28737));
const __unbuffered_p0_EAX$flush_delayed: ref;
axiom (__unbuffered_p0_EAX$flush_delayed == $sub.ref(0, 29762));
const __unbuffered_p0_EAX$mem_tmp: ref;
axiom (__unbuffered_p0_EAX$mem_tmp == $sub.ref(0, 30790));
const __unbuffered_p0_EAX$r_buff0_thd0: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd0 == $sub.ref(0, 31815));
const __unbuffered_p0_EAX$r_buff0_thd1: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd1 == $sub.ref(0, 32840));
const __unbuffered_p0_EAX$r_buff0_thd2: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd2 == $sub.ref(0, 33865));
const __unbuffered_p0_EAX$r_buff0_thd3: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd3 == $sub.ref(0, 34890));
const __unbuffered_p0_EAX$r_buff0_thd4: ref;
axiom (__unbuffered_p0_EAX$r_buff0_thd4 == $sub.ref(0, 35915));
const __unbuffered_p0_EAX$r_buff1_thd0: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd0 == $sub.ref(0, 36940));
const __unbuffered_p0_EAX$r_buff1_thd1: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd1 == $sub.ref(0, 37965));
const __unbuffered_p0_EAX$r_buff1_thd2: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd2 == $sub.ref(0, 38990));
const __unbuffered_p0_EAX$r_buff1_thd3: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd3 == $sub.ref(0, 40015));
const __unbuffered_p0_EAX$r_buff1_thd4: ref;
axiom (__unbuffered_p0_EAX$r_buff1_thd4 == $sub.ref(0, 41040));
const __unbuffered_p0_EAX$w_buff0: ref;
axiom (__unbuffered_p0_EAX$w_buff0 == $sub.ref(0, 42068));
const __unbuffered_p0_EAX$w_buff0_used: ref;
axiom (__unbuffered_p0_EAX$w_buff0_used == $sub.ref(0, 43093));
const __unbuffered_p0_EAX$w_buff1: ref;
axiom (__unbuffered_p0_EAX$w_buff1 == $sub.ref(0, 44121));
const __unbuffered_p0_EAX$w_buff1_used: ref;
axiom (__unbuffered_p0_EAX$w_buff1_used == $sub.ref(0, 45146));
const y$r_buff0_thd2: ref;
axiom (y$r_buff0_thd2 == $sub.ref(0, 46171));
const y$r_buff1_thd2: ref;
axiom (y$r_buff1_thd2 == $sub.ref(0, 47196));
const y$read_delayed: ref;
axiom (y$read_delayed == $sub.ref(0, 48221));
const y$read_delayed_var: ref;
axiom (y$read_delayed_var == $sub.ref(0, 49253));
const .str: ref;
axiom (.str == $sub.ref(0, 50279));
const {:count 21} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 51324));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 52367));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 53399));
const {:count 3} .str.1.12: ref;
axiom (.str.1.12 == $sub.ref(0, 54426));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 55454));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 56486));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 57518));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 58550));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 59582));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 60614));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 61646));
procedure  llvm.dbg.label($p0: ref);
const P0: ref;
axiom (P0 == $sub.ref(0, 62678));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i1;
  ...
  var $i315: i32;
$bb0:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 768, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 768, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 768, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 769, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 769, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 769, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 770, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 770, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 770, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 770, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 771, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 771, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i8);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 772, 19} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i9);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 772, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 772, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 30} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 45} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb4, $bb5;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i14);
  call {:cexpr "y"} boogie_si_record_i32($i14);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 48} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 78} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 78} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i18 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 65} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 97} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 97} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 216} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 216} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 231} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i24 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 115} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 115} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 130} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 134} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume !(($i28 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 152} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 168} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 152} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i30 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 173} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i34 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 189} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume !(($i34 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 201} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 234} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 234} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 249} true;
  assume {:verifier.code 0} true;
...
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 331} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i42 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 252} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 252} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i8.i1($i43);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 267} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i44 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 271} true;
  assume {:verifier.code 0} true;
...
$bb34:
  assume !(($i46 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 289} true;
  assume {:verifier.code 0} true;
...
$bb35:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 305} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i48 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 317} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i54 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 347} true;
  assume {:verifier.code 0} true;
...
$bb40:
  assume !(($i54 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 359} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 773, 331} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume ($i59 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 31} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume !(($i59 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 45} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 45} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 44} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i61);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i61);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 15} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume ($i63 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 75} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 75} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i67} true;
  goto $bb48, $bb49;
$bb46:
  assume !(($i63 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 62} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume ($i67 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 93} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 123} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 123} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb54, $bb55;
$bb51:
  assume ($i69 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 110} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume ($i73 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 142} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 142} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 157} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 209} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 209} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 224} true;
  assume {:verifier.code 0} true;
...
$bb58:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 160} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 160} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb59, $bb60;
$bb59:
  assume ($i77 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 179} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume !(($i79 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 196} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i83 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 227} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 227} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 242} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 293} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i85 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 245} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 245} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 260} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i87 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 264} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume !(($i89 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 774, 281} true;
  assume {:verifier.code 0} true;
...
$bb74:
  assume ($i94 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 31} true;
  assume {:verifier.code 0} true;
...
$bb75:
  assume !(($i94 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 45} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 45} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 44} true;
  assume {:verifier.code 0} true;
...
$bb76:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i96);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i96);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
...
$bb77:
  assume ($i98 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 75} true;
  assume {:verifier.code 0} true;
  $i101 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 75} true;
  assume {:verifier.code 0} true;
  $i102 := $trunc.i8.i1($i101);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  goto $bb80, $bb81;
$bb78:
  assume !(($i98 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 62} true;
  assume {:verifier.code 0} true;
...
$bb80:
  assume ($i102 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 93} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 123} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 123} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i108} true;
  goto $bb86, $bb87;
$bb83:
  assume ($i104 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 110} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i108 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 142} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 142} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 157} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 209} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 209} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 224} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume !(($i110 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 160} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 160} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb91, $bb92;
$bb91:
  assume ($i112 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 179} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i114 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 196} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i118 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 227} true;
  assume {:verifier.code 0} true;
  $i119 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 227} true;
  assume {:verifier.code 0} true;
  $i120 := $trunc.i8.i1($i119);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 242} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 293} true;
  assume {:verifier.code 0} true;
...
$bb99:
  assume ($i120 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 245} true;
  assume {:verifier.code 0} true;
  $i121 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 245} true;
  assume {:verifier.code 0} true;
  $i122 := $trunc.i8.i1($i121);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 260} true;
  assume {:verifier.code 0} true;
...
$bb101:
  assume ($i122 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 264} true;
  assume {:verifier.code 0} true;
...
$bb104:
  assume !(($i124 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 775, 281} true;
  assume {:verifier.code 0} true;
...
$bb106:
  assume ($i129 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 36} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume !(($i129 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 55} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 54} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i133, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 20} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i135 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 90} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 90} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb112, $bb113;
$bb110:
  assume !(($i135 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 72} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i141 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 108} true;
  assume {:verifier.code 0} true;
...
$bb113:
  ...
  goto $bb114;
$bb114:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 137} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 137} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 152} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i146 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 156} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 156} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 171} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 245} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 245} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 260} true;
  assume {:verifier.code 0} true;
...
$bb122:
  assume !(($i148 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 174} true;
  assume {:verifier.code 0} true;
  $i149 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 174} true;
  assume {:verifier.code 0} true;
  $i150 := $trunc.i8.i1($i149);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i150} true;
  goto $bb123, $bb124;
$bb123:
  assume ($i150 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 193} true;
  assume {:verifier.code 0} true;
...
$bb126:
  assume !(($i152 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 210} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, weak$$choice0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 210} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 224} true;
  assume {:verifier.code 0} true;
  $i155 := 1;
...
$bb129:
  assume !(($i154 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 228} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, weak$$choice1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 228} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 227} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe027_power.oepc_tmp.c:776:227: warning: over-approximating bitwise operation xor;
  $i158 := $xor.i1($i157, 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 224} true;
  assume {:verifier.code 0} true;
  $i155 := $i158;
...
$bb131:
  assume ($i162 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 263} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 263} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 278} true;
  assume {:verifier.code 0} true;
...
$bb132:
  ...
  goto $bb133;
$bb133:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 333} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume ($i164 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 281} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 281} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 296} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i166 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 300} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i168 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 776, 317} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i179 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 36} true;
  assume {:verifier.code 0} true;
...
$bb142:
  assume !(($i179 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 54} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i183, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 20} true;
  assume {:verifier.code 0} true;
...
$bb144:
  assume ($i185 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 90} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 90} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb147, $bb148;
$bb145:
  assume !(($i185 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 72} true;
  assume {:verifier.code 0} true;
...
$bb147:
  assume ($i191 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 108} true;
  assume {:verifier.code 0} true;
...
$bb148:
  ...
  goto $bb149;
$bb149:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 137} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 137} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 152} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i196 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 156} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 156} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 171} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  goto $bb155;
$bb155:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 227} true;
  assume {:verifier.code 0} true;
  $i207 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 227} true;
  assume {:verifier.code 0} true;
  $i208 := $trunc.i8.i1($i207);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 242} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb157:
  assume !(($i198 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 174} true;
  assume {:verifier.code 0} true;
  $i199 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 174} true;
  assume {:verifier.code 0} true;
  $i200 := $trunc.i8.i1($i199);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i200} true;
  goto $bb158, $bb159;
$bb158:
  assume ($i200 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 193} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume !(($i202 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 210} true;
  assume {:verifier.code 0} true;
...
$bb163:
  assume ($i208 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 245} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 245} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 260} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 227} true;
  assume {:verifier.code 0} true;
...
$bb166:
  assume ($i211 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 263} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 263} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 278} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb168:
  assume ($i213 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 282} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 282} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 777, 281} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe027_power.oepc_tmp.c:777:281: warning: over-approximating bitwise operation xor;
  $i216 := $xor.i1($i215, 1);
  assume {:verifier.code 0} true;
  $i209 := $i216;
  goto $bb165;
...
$bb170:
  assume ($i221 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 36} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume !(($i221 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 54} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i225, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
...
$bb173:
  assume ($i227 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 90} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 90} true;
  assume {:verifier.code 0} true;
  $i233 := $trunc.i8.i1($i232);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i233} true;
  goto $bb176, $bb177;
$bb174:
  assume !(($i227 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 72} true;
  assume {:verifier.code 0} true;
...
$bb176:
  assume ($i233 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 108} true;
  assume {:verifier.code 0} true;
...
$bb177:
  ...
  goto $bb178;
$bb178:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 137} true;
  assume {:verifier.code 0} true;
  $i237 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 137} true;
  assume {:verifier.code 0} true;
  $i238 := $trunc.i8.i1($i237);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 152} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume ($i238 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 156} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 156} true;
  assume {:verifier.code 0} true;
  $i240 := $trunc.i8.i1($i239);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 171} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  goto $bb184;
$bb184:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 228} true;
  assume {:verifier.code 0} true;
  $i249 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 228} true;
  assume {:verifier.code 0} true;
  $i250 := $trunc.i8.i1($i249);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 243} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb186:
  assume !(($i240 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 174} true;
  assume {:verifier.code 0} true;
  $i241 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 174} true;
  assume {:verifier.code 0} true;
  $i242 := $trunc.i8.i1($i241);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i242} true;
  goto $bb187, $bb188;
$bb187:
  assume ($i242 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 193} true;
  assume {:verifier.code 0} true;
...
$bb190:
  assume !(($i244 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 210} true;
  assume {:verifier.code 0} true;
...
$bb192:
  assume ($i250 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 246} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 246} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 261} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb195:
  assume ($i253 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 264} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 264} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 279} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb197:
  assume ($i255 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 283} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 283} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 778, 282} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe027_power.oepc_tmp.c:778:282: warning: over-approximating bitwise operation xor;
  $i258 := $xor.i1($i257, 1);
  assume {:verifier.code 0} true;
  $i251 := $i258;
  goto $bb194;
...
$bb199:
  assume ($i263 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 36} true;
  assume {:verifier.code 0} true;
...
$bb200:
  assume !(($i263 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 55} true;
  assume {:verifier.code 0} true;
  $i268 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 55} true;
  assume {:verifier.code 0} true;
  $i269 := $trunc.i8.i1($i268);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 54} true;
  assume {:verifier.code 0} true;
...
$bb201:
  ...
  assume {:verifier.code 0} true;
  $i305 := $ne.i32($i267, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 780, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p0_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p0_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 781, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p0_EAX$read_delayed_var, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 782, 25} true;
  assume {:verifier.code 0} true;
  $i307 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 782, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i307);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i307);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 783, 7} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume ($i269 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 90} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 90} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i275} true;
  goto $bb205, $bb206;
$bb203:
  assume !(($i269 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 72} true;
  assume {:verifier.code 0} true;
...
$bb205:
  assume ($i275 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 108} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  goto $bb207;
$bb207:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 137} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 137} true;
  assume {:verifier.code 0} true;
  $i280 := $trunc.i8.i1($i279);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 152} true;
  assume {:verifier.code 0} true;
...
$bb211:
  assume ($i280 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 156} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 156} true;
  assume {:verifier.code 0} true;
  $i282 := $trunc.i8.i1($i281);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 171} true;
  assume {:verifier.code 0} true;
...
$bb212:
  ...
  goto $bb213;
$bb213:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 257} true;
  assume {:verifier.code 0} true;
  $i294 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 257} true;
  assume {:verifier.code 0} true;
  $i295 := $trunc.i8.i1($i294);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 272} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb215:
  assume !(($i282 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 174} true;
  assume {:verifier.code 0} true;
  $i283 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 174} true;
  assume {:verifier.code 0} true;
  $i284 := $trunc.i8.i1($i283);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i284} true;
  goto $bb216, $bb217;
$bb216:
  assume ($i284 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 193} true;
  assume {:verifier.code 0} true;
...
$bb219:
  assume !(($i286 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 211} true;
  assume {:verifier.code 0} true;
...
$bb220:
  assume ($i288 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 227} true;
  assume {:verifier.code 0} true;
...
$bb224:
  assume ($i295 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 275} true;
  assume {:verifier.code 0} true;
  $i297 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 275} true;
  assume {:verifier.code 0} true;
  $i298 := $trunc.i8.i1($i297);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 290} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb227:
  assume ($i298 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 293} true;
  assume {:verifier.code 0} true;
  $i299 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 293} true;
  assume {:verifier.code 0} true;
  $i300 := $trunc.i8.i1($i299);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 308} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb229:
  assume ($i300 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 312} true;
  assume {:verifier.code 0} true;
  $i301 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 312} true;
  assume {:verifier.code 0} true;
  $i302 := $trunc.i8.i1($i301);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 779, 311} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe027_power.oepc_tmp.c:779:311: warning: over-approximating bitwise operation xor;
  $i303 := $xor.i1($i302, 1);
  assume {:verifier.code 0} true;
  $i296 := $i303;
  goto $bb226;
...
$bb231:
  assume ($i309 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 783, 25} true;
  assume {:verifier.code 0} true;
...
$bb232:
  assume !(($i309 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 783, 37} true;
  assume {:verifier.code 0} true;
  $i312 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 783, 7} true;
  assume {:verifier.code 0} true;
...
$bb233:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 783, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 783, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i311);
  call {:cexpr "y"} boogie_si_record_i32($i311);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 784, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 787, 25} true;
  assume {:verifier.code 0} true;
  $i313 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 787, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EBX, $i313);
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i313);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 790, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 792, 22} true;
  assume {:verifier.code 0} true;
  $i314 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 792, 39} true;
  assume {:verifier.code 0} true;
  $i315 := $add.i32($i314, 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i315);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i315);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 793, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 799, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 804, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 804, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 806, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i198: i32;
$bb0:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 811, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 811, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 813, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 814, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 814, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 814, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 815, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 815, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 815, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 816, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 816, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 816, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 816, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 817, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 817, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i9);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i21);
  call {:cexpr "y"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 818, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb24, $bb25;
$bb23:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i32);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 198} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 151} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 819, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i55);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 79} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i59} true;
  goto $bb50, $bb52;
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 820, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 821, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb93, $bb94;
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 89} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i114} true;
  goto $bb96, $bb98;
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 148} true;
  assume {:verifier.code 0} true;
  $i121 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 822, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 823, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 825, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 825, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EBX, $i191);
  call {:cexpr "__unbuffered_p2_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 826, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 824, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 826, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 826, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 826, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 826, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 826, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i195);
  call {:cexpr "y"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 827, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 828, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 829, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 831, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 832, 22} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 832, 39} true;
  assume {:verifier.code 0} true;
  $i198 := $add.i32($i197, 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i198);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i198);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 833, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 839, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i6);
  call {:cexpr "y"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 843, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 842, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 843, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, y$r_buff0_thd4);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 845, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 845, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 845, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, y$r_buff0_thd4);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i53} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 849, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 849, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 849, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 850, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 851, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 865, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 871, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 872, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 873, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 873, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 873, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 873, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 874, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 875, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 875, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 876, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i19);
  call {:cexpr "y"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 878, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 878, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 877, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 878, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 878, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 878, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 879, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 880, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 880, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 880, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 880, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 880, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 880, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 880, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 881, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 882, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 883, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 884, 19} true;
  assume {:verifier.code 1} true;
  call $i75 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i75);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 884, 17} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i8($i75);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 884, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 885, 25} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume ($i78 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 885, 61} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume !(($i78 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 885, 140} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume ($i80 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 885, 78} true;
  assume {:verifier.code 0} true;
  $p81 := $load.ref($M.0, __unbuffered_p0_EAX$read_delayed_var);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 885, 77} true;
  assume {:verifier.code 0} true;
...
$bb52:
  assume !(($i80 == 1));
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 885, 117} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 885, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 885, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i85);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i85);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 23} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 43} true;
  assume {:verifier.code 0} true;
  $i88 := $eq.i32($i87, 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 48} true;
  assume {:verifier.code 0} true;
  $i89 := 0;
  assume {:branchcond $i88} true;
  goto $bb55, $bb56;
$bb55:
  assume ($i88 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 51} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i32($M.0, __unbuffered_p0_EBX);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 71} true;
  assume {:verifier.code 0} true;
  $i91 := $eq.i32($i90, 0);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 76} true;
  assume {:verifier.code 0} true;
  $i89 := 0;
...
$bb57:
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe027_power.oepc_tmp.c:886:21: warning: over-approximating bitwise operation xor;
  $i96 := $xor.i1($i89, 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 19} true;
  assume {:verifier.code 0} true;
  $i97 := $zext.i1.i8($i96);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 887, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 888, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 888, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i100);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 889, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb58:
  assume ($i91 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 79} true;
  assume {:verifier.code 0} true;
  $i92 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 99} true;
  assume {:verifier.code 0} true;
  $i93 := $eq.i32($i92, 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 104} true;
  assume {:verifier.code 0} true;
  $i89 := 0;
...
$bb60:
  assume ($i93 == 1);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 107} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i32($M.0, __unbuffered_p2_EBX);
  assume {:sourceloc "output/safe027_power.oepc_tmp.c", 886, 127} true;
  assume {:verifier.code 0} true;
  $i95 := $eq.i32($i94, 0);
  assume {:verifier.code 0} true;
  $i89 := $i95;
...
axiom (pthread_create == $sub.ref(0, 67838));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 68870));
...
axiom (__SMACK_code == $sub.ref(0, 69902));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 70934));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 71966));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 72998));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 74030));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 75062));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 76094));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 77126));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 78158));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 79190));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 80222));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 81254));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 82286));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 83318));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 84350));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 85382));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 86414));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 87446));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 88478));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 89510));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 90542));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 91574));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 92606));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 93638));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 94670));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 95702));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 96734));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 97766));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 98798));
...
axiom (__SMACK_decls == $sub.ref(0, 99830));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 100862));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 101894));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 102926));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 103958));
...
axiom (llvm.dbg.value == $sub.ref(0, 106022));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 107054));
