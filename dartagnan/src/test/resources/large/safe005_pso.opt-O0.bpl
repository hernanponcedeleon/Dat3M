...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe005_pso.opt-O0.bpl /Users/ponce/git/Dat3M/output/safe005_pso.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i197: i32;
$bb0:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 743, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 743, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 744, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 2);
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 747, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 749, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 749, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 749, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 750, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 750, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 750, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 751, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 751, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 751, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 751, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 752, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 752, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i8);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i20);
  call {:cexpr "x"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 753, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i31);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 754, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i54);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 755, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 756, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 757, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 758, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 760, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 760, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i190);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 761, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 759, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 761, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 761, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 761, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 761, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 761, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i194);
  call {:cexpr "x"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 762, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 767, 22} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 767, 39} true;
  assume {:verifier.code 0} true;
  $i197 := $add.i32($i196, 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i197);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i197);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i86: i32;
$bb0:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 774, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i1);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 775, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, 1);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 777, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$w_buff0_used, 1);
  call {:cexpr "x$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 778, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 778, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 778, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 778, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 778, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/safe005_pso.opt_tmp.c:778:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 778, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$r_buff0_thd2, 1);
  call {:cexpr "x$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 786, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 787, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 55} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i8.i1($i30);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i27 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i29);
  call {:cexpr "x"} boogie_si_record_i32($i29);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 790, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i31 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 102} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 789, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i38 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 790, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb28, $bb29;
$bb25:
...
$bb28:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 791, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 792, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i62 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 792, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 792, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i72 := $trunc.i8.i1($i71);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i72} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i72 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 38} true;
  assume {:verifier.code 0} true;
  $i74 := $trunc.i8.i1($i73);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 56} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i83 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  $i84 := $zext.i1.i8($i83);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 796, 22} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 796, 39} true;
  assume {:verifier.code 0} true;
  $i86 := $add.i32($i85, 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i86);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i86);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 797, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i65: i32;
$bb0:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 803, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 803, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 806, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 806, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EBX, $i2);
  call {:cexpr "__unbuffered_p2_EBX"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 7} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i8.i1($i3);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 55} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i8);
  call {:cexpr "x"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 810, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 102} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i12 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 809, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i17 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 810, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 810, 66} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 810, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i20, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i1.i8($i24);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i27 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 38} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 56} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i8.i1($i30);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i31 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i38 := $ne.i32($i34, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 18} true;
  assume {:verifier.code 0} true;
  $i39 := $zext.i1.i8($i38);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 811, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $i41 := $trunc.i8.i1($i40);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 812, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i41} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i41 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 812, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 812, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i48 := $ne.i32($i44, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i1.i8($i48);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i51 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 38} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 56} true;
  assume {:verifier.code 0} true;
  $i55 := $trunc.i8.i1($i54);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i55 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i62 := $ne.i32($i58, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  $i63 := $zext.i1.i8($i62);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 815, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 816, 22} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 816, 39} true;
  assume {:verifier.code 0} true;
  $i65 := $add.i32($i64, 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i65);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i65);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 817, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 818, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 836, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 838, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 838, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 838, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 838, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 839, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 840, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i17);
  call {:cexpr "x"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 843, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 842, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 843, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 844, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 845, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 845, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 845, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 845, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 846, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 23} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 25} true;
  assume {:verifier.code 0} true;
  $i74 := $eq.i32($i73, 2);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 30} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
  assume {:branchcond $i74} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i74 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 33} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 53} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 0);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 58} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
...
$bb51:
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe005_pso.opt_tmp.c:849:21: warning: over-approximating bitwise operation xor;
  $i82 := $xor.i1($i75, 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 19} true;
  assume {:verifier.code 0} true;
  $i83 := $zext.i1.i8($i82);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 850, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 851, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i86 := $zext.i1.i32($i85);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 851, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i86);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 852, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i77 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 61} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 81} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 86} true;
  assume {:verifier.code 0} true;
  $i75 := 0;
...
$bb54:
  assume ($i79 == 1);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 89} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, __unbuffered_p2_EBX);
  assume {:sourceloc "output/safe005_pso.opt_tmp.c", 849, 109} true;
  assume {:verifier.code 0} true;
  $i81 := $eq.i32($i80, 1);
  assume {:verifier.code 0} true;
  $i75 := $i81;
