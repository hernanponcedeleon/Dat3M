...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix000_rmo.opt-O0.bpl /Users/ponce/git/Dat3M/output/mix000_rmo.opt_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 81395));
...
axiom (.str.1 == $sub.ref(0, 27729));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 28772));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 29804));
const {:count 3} .str.1.12: ref;
axiom (.str.1.12 == $sub.ref(0, 30831));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 31859));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 32891));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 33923));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 34955));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 35987));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 37019));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 38051));
procedure  llvm.dbg.label($p0: ref);
const P0: ref;
axiom (P0 == $sub.ref(0, 39083));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i198: i32;
$bb0:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 743, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 746, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 746, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 747, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 749, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 749, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 749, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 750, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 750, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 750, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 751, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 751, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 751, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 751, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 752, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 752, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i9);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i21);
  call {:cexpr "x"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 753, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i32);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 754, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i55);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 755, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 756, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 757, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 758, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 760, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 760, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EBX, $i191);
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 761, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 759, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 761, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 761, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 761, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 761, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 761, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i195);
  call {:cexpr "x"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 762, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 767, 22} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 767, 39} true;
  assume {:verifier.code 0} true;
  $i198 := $add.i32($i197, 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i198);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i198);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i279: i32;
$bb0:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 774, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i1);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 775, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, 1);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 777, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$w_buff0_used, 1);
  call {:cexpr "x$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 778, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 778, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 778, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 778, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 778, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix000_rmo.opt_tmp.c:778:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 778, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$r_buff0_thd2, 1);
  call {:cexpr "x$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 785, 19} true;
  assume {:verifier.code 1} true;
  call $i21 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i21);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 785, 17} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i1.i8($i21);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 785, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 786, 19} true;
  assume {:verifier.code 1} true;
  call $i23 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i23);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 786, 17} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 786, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 787, 21} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 787, 21} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 787, 19} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i1.i8($i26);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 787, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 788, 15} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 788, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i28);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i28);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 8} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 8} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 27} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 27} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i8.i1($i31);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 42} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 101} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 7} true;
  assume {:verifier.code 0} true;
  $i40 := $i39;
  goto $bb17;
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 65} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 65} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb12, $bb14;
$bb9:
  assume !(($i32 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 46} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 46} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 61} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb10, $bb11;
$bb10:
...
$bb12:
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 106} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 106} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb18, $bb19;
$bb14:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 84} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i40);
  call {:cexpr "x"} boogie_si_record_i32($i40);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 15} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 124} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 153} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i44 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 789, 141} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i49 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 31} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume !(($i49 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 45} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 45} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i53} true;
  goto $bb27, $bb28;
$bb26:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i51);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i51);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 15} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 64} true;
  assume {:verifier.code 0} true;
  $i54 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 64} true;
  assume {:verifier.code 0} true;
  $i55 := $trunc.i8.i1($i54);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 79} true;
  assume {:verifier.code 0} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 138} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 44} true;
  assume {:verifier.code 0} true;
  $i63 := $i62;
  goto $bb40;
$bb30:
  ...
  goto $bb31;
$bb31:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i59} true;
  goto $bb35, $bb37;
$bb32:
  assume !(($i55 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 83} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 83} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 98} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i57} true;
  goto $bb33, $bb34;
$bb33:
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 151} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 151} true;
  assume {:verifier.code 0} true;
  $i65 := $trunc.i8.i1($i64);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i65} true;
  goto $bb41, $bb42;
$bb37:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 121} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i65 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 169} true;
  assume {:verifier.code 0} true;
...
$bb42:
  ...
  goto $bb43;
$bb43:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 198} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i67 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 790, 186} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i72 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 31} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume !(($i72 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 45} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 45} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i76} true;
  goto $bb50, $bb51;
$bb49:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i74);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i74);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 64} true;
  assume {:verifier.code 0} true;
  $i77 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 64} true;
  assume {:verifier.code 0} true;
  $i78 := $trunc.i8.i1($i77);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 79} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  goto $bb52;
$bb52:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 138} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 44} true;
  assume {:verifier.code 0} true;
  $i86 := $i85;
  goto $bb63;
$bb53:
  ...
  goto $bb54;
$bb54:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 102} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 102} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i82} true;
  goto $bb58, $bb60;
$bb55:
  assume !(($i78 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 83} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 83} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 98} true;
  assume {:verifier.code 0} true;
...
$bb58:
  ...
  goto $bb59;
$bb59:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 151} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 151} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb64, $bb65;
$bb60:
  assume !(($i82 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 121} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i88 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 169} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 198} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i90 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 791, 186} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i95 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 36} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume !(($i95 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i100 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i101 := $trunc.i8.i1($i100);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 70} true;
  assume {:verifier.code 0} true;
...
$bb72:
  ...
  assume {:verifier.code 0} true;
  $i122 := $ne.i32($i99, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
...
$bb73:
  assume ($i101 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 74} true;
  assume {:verifier.code 0} true;
  $i102 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 74} true;
  assume {:verifier.code 0} true;
  $i103 := $trunc.i8.i1($i102);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 89} true;
  assume {:verifier.code 0} true;
...
$bb74:
  ...
  goto $bb75;
$bb75:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 54} true;
  assume {:verifier.code 0} true;
  $i113 := $i112;
  goto $bb86;
$bb76:
  ...
  goto $bb77;
$bb77:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 112} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 112} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i107} true;
  goto $bb81, $bb83;
$bb78:
  assume !(($i103 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 93} true;
  assume {:verifier.code 0} true;
  $i104 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 93} true;
  assume {:verifier.code 0} true;
  $i105 := $trunc.i8.i1($i104);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 108} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 166} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 166} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i115} true;
  goto $bb87, $bb88;
$bb83:
  assume !(($i107 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 131} true;
  assume {:verifier.code 0} true;
...
$bb87:
  assume ($i115 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 184} true;
  assume {:verifier.code 0} true;
...
$bb88:
  ...
  goto $bb89;
$bb89:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 792, 212} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i125 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 36} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i125 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i130 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i131 := $trunc.i8.i1($i130);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 70} true;
  assume {:verifier.code 0} true;
...
$bb95:
  ...
  assume {:verifier.code 0} true;
  $i150 := $ne.i32($i129, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i131 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 74} true;
  assume {:verifier.code 0} true;
  $i132 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 74} true;
  assume {:verifier.code 0} true;
  $i133 := $trunc.i8.i1($i132);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 89} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 54} true;
  assume {:verifier.code 0} true;
  $i143 := $i142;
  goto $bb109;
$bb99:
  ...
  goto $bb100;
$bb100:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 112} true;
  assume {:verifier.code 0} true;
  $i136 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 112} true;
  assume {:verifier.code 0} true;
  $i137 := $trunc.i8.i1($i136);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i137} true;
  goto $bb104, $bb106;
$bb101:
  assume !(($i133 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 93} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 93} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 108} true;
  assume {:verifier.code 0} true;
...
$bb104:
  ...
  goto $bb105;
$bb105:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 166} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 166} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 181} true;
  assume {:verifier.code 0} true;
  $i146 := 0;
...
$bb106:
  assume !(($i137 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 131} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i145 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 793, 184} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i153 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 36} true;
  assume {:verifier.code 0} true;
...
$bb114:
  assume !(($i153 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 55} true;
  assume {:verifier.code 0} true;
  $i158 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 55} true;
  assume {:verifier.code 0} true;
  $i159 := $trunc.i8.i1($i158);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 70} true;
  assume {:verifier.code 0} true;
...
$bb115:
  ...
  assume {:verifier.code 0} true;
  $i180 := $ne.i32($i157, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume ($i159 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
  $i160 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
  $i161 := $trunc.i8.i1($i160);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 89} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  goto $bb118;
$bb118:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 54} true;
  assume {:verifier.code 0} true;
  $i171 := $i170;
  goto $bb129;
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 112} true;
  assume {:verifier.code 0} true;
  $i164 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 112} true;
  assume {:verifier.code 0} true;
  $i165 := $trunc.i8.i1($i164);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i165} true;
  goto $bb124, $bb126;
$bb121:
  assume !(($i161 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 93} true;
  assume {:verifier.code 0} true;
  $i162 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 93} true;
  assume {:verifier.code 0} true;
  $i163 := $trunc.i8.i1($i162);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 108} true;
  assume {:verifier.code 0} true;
...
$bb124:
  ...
  goto $bb125;
$bb125:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 166} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 166} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i173} true;
  goto $bb130, $bb131;
$bb126:
  assume !(($i165 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 131} true;
  assume {:verifier.code 0} true;
...
$bb130:
  assume ($i173 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 184} true;
  assume {:verifier.code 0} true;
...
$bb131:
  ...
  goto $bb132;
$bb132:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 794, 212} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i183 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 36} true;
  assume {:verifier.code 0} true;
...
$bb137:
  assume !(($i183 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 55} true;
  assume {:verifier.code 0} true;
  $i188 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 55} true;
  assume {:verifier.code 0} true;
  $i189 := $trunc.i8.i1($i188);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 70} true;
  assume {:verifier.code 0} true;
...
$bb138:
  ...
  assume {:verifier.code 0} true;
  $i208 := $ne.i32($i187, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 796, 25} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 796, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i210);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i210);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 797, 7} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume ($i189 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 89} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  goto $bb141;
$bb141:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 54} true;
  assume {:verifier.code 0} true;
  $i201 := $i200;
  goto $bb152;
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 112} true;
  assume {:verifier.code 0} true;
  $i194 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 112} true;
  assume {:verifier.code 0} true;
  $i195 := $trunc.i8.i1($i194);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i195} true;
  goto $bb147, $bb149;
$bb144:
  assume !(($i191 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 93} true;
  assume {:verifier.code 0} true;
  $i192 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 93} true;
  assume {:verifier.code 0} true;
  $i193 := $trunc.i8.i1($i192);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 108} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i193} true;
  goto $bb145, $bb146;
$bb145:
...
$bb147:
  ...
  goto $bb148;
$bb148:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 166} true;
  assume {:verifier.code 0} true;
  $i202 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 166} true;
  assume {:verifier.code 0} true;
  $i203 := $trunc.i8.i1($i202);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 181} true;
  assume {:verifier.code 0} true;
  $i204 := 0;
...
$bb149:
  assume !(($i195 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 131} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i203 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 795, 184} true;
  assume {:verifier.code 0} true;
...
$bb156:
  assume ($i212 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 797, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  assume !(($i212 == 1));
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 797, 37} true;
  assume {:verifier.code 0} true;
  $i215 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 797, 7} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 797, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 797, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i214);
  call {:cexpr "x"} boogie_si_record_i32($i214);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 798, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 801, 25} true;
  assume {:verifier.code 0} true;
  $i216 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 801, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i216);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i216);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 7} true;
  assume {:verifier.code 0} true;
  $i217 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 7} true;
  assume {:verifier.code 0} true;
  $i218 := $trunc.i8.i1($i217);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i218} true;
  goto $bb159, $bb160;
$bb159:
  assume ($i218 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 25} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  goto $bb161;
$bb161:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 55} true;
  assume {:verifier.code 0} true;
  $i223 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 55} true;
  assume {:verifier.code 0} true;
  $i224 := $trunc.i8.i1($i223);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i224} true;
  goto $bb165, $bb166;
$bb162:
  assume ($i220 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 42} true;
  assume {:verifier.code 0} true;
...
$bb164:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i222);
  call {:cexpr "x"} boogie_si_record_i32($i222);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i230 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i231 := $trunc.i8.i1($i230);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 805, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i231} true;
  goto $bb171, $bb172;
$bb165:
  assume ($i224 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 73} true;
  assume {:verifier.code 0} true;
...
$bb166:
  ...
  goto $bb167;
$bb167:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 102} true;
  assume {:verifier.code 0} true;
  $i229 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 55} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i226 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 804, 90} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume ($i231 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  goto $bb173;
$bb173:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 805, 66} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  assume {:verifier.code 0} true;
  $i238 := $ne.i32($i234, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $i240 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $i241 := $trunc.i8.i1($i240);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i241} true;
  goto $bb177, $bb178;
$bb177:
  assume ($i241 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 38} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 38} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 53} true;
  assume {:verifier.code 0} true;
...
$bb178:
  ...
  goto $bb179;
$bb179:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 56} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 56} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 71} true;
  assume {:verifier.code 0} true;
...
$bb183:
  assume ($i245 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 74} true;
  assume {:verifier.code 0} true;
...
$bb184:
  ...
  goto $bb185;
$bb185:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 102} true;
  assume {:verifier.code 0} true;
...
$bb188:
  ...
  assume {:verifier.code 0} true;
  $i252 := $ne.i32($i248, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 806, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 807, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i255} true;
  goto $bb189, $bb190;
$bb189:
  assume ($i255 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
...
$bb190:
  ...
  goto $bb191;
$bb191:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 807, 66} true;
  assume {:verifier.code 0} true;
...
$bb194:
  ...
  assume {:verifier.code 0} true;
  $i262 := $ne.i32($i258, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i264 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i265 := $trunc.i8.i1($i264);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i265} true;
  goto $bb195, $bb196;
$bb195:
  assume ($i265 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i266 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i267 := $trunc.i8.i1($i266);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 53} true;
  assume {:verifier.code 0} true;
...
$bb196:
  ...
  goto $bb197;
$bb197:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 56} true;
  assume {:verifier.code 0} true;
  $i268 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 56} true;
  assume {:verifier.code 0} true;
  $i269 := $trunc.i8.i1($i268);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 71} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i269 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 74} true;
  assume {:verifier.code 0} true;
...
$bb202:
  ...
  goto $bb203;
$bb203:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 102} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  assume {:verifier.code 0} true;
  $i276 := $ne.i32($i272, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 811, 22} true;
  assume {:verifier.code 0} true;
  $i278 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 811, 39} true;
  assume {:verifier.code 0} true;
  $i279 := $add.i32($i278, 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 811, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i279);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i279);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 813, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 827, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 829, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 831, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 831, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 831, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 831, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 833, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 833, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i15);
  call {:cexpr "x"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 836, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 836, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 836, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 835, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 836, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 836, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 836, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 836, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 837, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 838, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 838, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 838, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 838, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 838, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 838, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 838, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 840, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 23} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 43} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.i32($i71, 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 48} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i72} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i72 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 51} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i32($M.0, __unbuffered_p0_EBX);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 71} true;
  assume {:verifier.code 0} true;
  $i75 := $eq.i32($i74, 0);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 76} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
...
$bb51:
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix000_rmo.opt_tmp.c:842:21: warning: over-approximating bitwise operation xor;
  $i80 := $xor.i1($i73, 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 843, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 844, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i84 := $zext.i1.i32($i83);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 844, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i84);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 79} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 99} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 104} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
...
$bb54:
  assume ($i77 == 1);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 107} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/mix000_rmo.opt_tmp.c", 842, 127} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 0);
  assume {:verifier.code 0} true;
  $i73 := $i79;
...
axiom (pthread_create == $sub.ref(0, 42179));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 43211));
...
axiom (__SMACK_code == $sub.ref(0, 44243));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 45275));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 46307));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 47339));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 48371));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 49403));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 50435));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 51467));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 52499));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 53531));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 54563));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 55595));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 56627));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 57659));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 58691));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 59723));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 60755));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 61787));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 62819));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 63851));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 64883));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 65915));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 66947));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 67979));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 69011));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 70043));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 71075));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 72107));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 73139));
...
axiom (__SMACK_decls == $sub.ref(0, 74171));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 75203));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 76235));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 77267));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 78299));
...
axiom (llvm.dbg.value == $sub.ref(0, 80363));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 81395));
