...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe010_pso.opt-O0.bpl /Users/ponce/git/Dat3M/output/safe010_pso.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i83: i32;
$bb0:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 735, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 735, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 736, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 736, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i1);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 737, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 2);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 738, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 738, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 738, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 738, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 739, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 740, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 740, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 740, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 740, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 740, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/safe010_pso.opt_tmp.c:740:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 740, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 740, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 741, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 741, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 741, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 741, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 742, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 742, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 742, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 742, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 743, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 743, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 743, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 743, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 744, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd1, 1);
  call {:cexpr "y$r_buff0_thd1"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 747, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 7} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 55} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 55} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i24 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i26);
  call {:cexpr "y"} boogie_si_record_i32($i26);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 751, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i35} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i28 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 102} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 750, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i35 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 751, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 751, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i42 := $ne.i32($i38, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 751, 18} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i1.i8($i42);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 751, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i45 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 38} true;
  assume {:verifier.code 0} true;
  $i46 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 38} true;
  assume {:verifier.code 0} true;
  $i47 := $trunc.i8.i1($i46);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 56} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 56} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i49 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i56 := $ne.i32($i52, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  $i57 := $zext.i1.i8($i56);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 753, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i59} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i59 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 753, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 753, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i66 := $ne.i32($i62, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  $i67 := $zext.i1.i8($i66);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 20} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 20} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i69 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 38} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 38} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 56} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 56} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i73 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i80 := $ne.i32($i76, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 755, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 757, 22} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 757, 39} true;
  assume {:verifier.code 0} true;
  $i83 := $add.i32($i82, 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i83);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i83);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 764, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 764, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 767, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i7);
  call {:cexpr "y"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 771, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 770, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 771, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 771, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 771, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 771, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 772, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 773, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 773, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 773, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 774, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 777, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 777, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 777, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 793, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 796, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 797, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 797, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 797, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 797, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 799, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i15);
  call {:cexpr "y"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 802, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 801, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 802, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 802, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 804, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 804, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 804, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 806, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 807, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 808, 19} true;
  assume {:verifier.code 1} true;
  call $i71 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i71);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 808, 17} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 808, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 809, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 809, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 809, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 810, 21} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 810, 21} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 810, 19} true;
  assume {:verifier.code 0} true;
  $i77 := $zext.i1.i8($i76);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 810, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 811, 15} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 811, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i78);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i78);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 8} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 8} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i80} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i80 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 27} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 27} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 42} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 101} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 7} true;
  assume {:verifier.code 0} true;
  $i90 := $i89;
  goto $bb62;
$bb52:
  ...
  goto $bb53;
$bb53:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 65} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 65} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i86} true;
  goto $bb57, $bb59;
$bb54:
  assume !(($i82 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 46} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 46} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 61} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb58;
$bb58:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 106} true;
  assume {:verifier.code 0} true;
  $i91 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 106} true;
  assume {:verifier.code 0} true;
  $i92 := $trunc.i8.i1($i91);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i92} true;
  goto $bb63, $bb64;
$bb59:
  assume !(($i86 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 84} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i90);
  call {:cexpr "y"} boogie_si_record_i32($i90);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 15} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i92 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 124} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb65;
$bb65:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 153} true;
  assume {:verifier.code 0} true;
...
$bb66:
  assume ($i94 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 812, 141} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i99 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 31} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume !(($i99 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 45} true;
  assume {:verifier.code 0} true;
  $i102 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 45} true;
  assume {:verifier.code 0} true;
  $i103 := $trunc.i8.i1($i102);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 60} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i101);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i101);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 15} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i103 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 64} true;
  assume {:verifier.code 0} true;
  $i104 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 64} true;
  assume {:verifier.code 0} true;
  $i105 := $trunc.i8.i1($i104);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 79} true;
  assume {:verifier.code 0} true;
...
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 138} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 44} true;
  assume {:verifier.code 0} true;
  $i113 := $i112;
  goto $bb85;
$bb75:
  ...
  goto $bb76;
$bb76:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 102} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 102} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i109} true;
  goto $bb80, $bb82;
$bb77:
  assume !(($i105 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 83} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 83} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 98} true;
  assume {:verifier.code 0} true;
...
$bb80:
  ...
  goto $bb81;
$bb81:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 151} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 151} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i115} true;
  goto $bb86, $bb87;
$bb82:
  assume !(($i109 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 121} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i115 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 169} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 198} true;
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i117 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 813, 186} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i122 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 31} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume !(($i122 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 45} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 45} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 60} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i124);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i124);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 20} true;
  assume {:verifier.code 0} true;
...
$bb95:
  assume ($i126 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 64} true;
  assume {:verifier.code 0} true;
  $i127 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 64} true;
  assume {:verifier.code 0} true;
  $i128 := $trunc.i8.i1($i127);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 79} true;
  assume {:verifier.code 0} true;
...
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 138} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 44} true;
  assume {:verifier.code 0} true;
  $i136 := $i135;
  goto $bb108;
$bb98:
  ...
  goto $bb99;
$bb99:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 102} true;
  assume {:verifier.code 0} true;
  $i131 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 102} true;
  assume {:verifier.code 0} true;
  $i132 := $trunc.i8.i1($i131);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i132} true;
  goto $bb103, $bb105;
$bb100:
  assume !(($i128 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 83} true;
  assume {:verifier.code 0} true;
  $i129 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 83} true;
  assume {:verifier.code 0} true;
  $i130 := $trunc.i8.i1($i129);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 98} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb104;
$bb104:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 151} true;
  assume {:verifier.code 0} true;
  $i137 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 151} true;
  assume {:verifier.code 0} true;
  $i138 := $trunc.i8.i1($i137);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i138} true;
  goto $bb109, $bb110;
$bb105:
  assume !(($i132 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 121} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i138 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 169} true;
  assume {:verifier.code 0} true;
...
$bb110:
  ...
  goto $bb111;
$bb111:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 198} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i140 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 814, 186} true;
  assume {:verifier.code 0} true;
...
$bb115:
  assume ($i145 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 36} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume !(($i145 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 55} true;
  assume {:verifier.code 0} true;
  $i150 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 55} true;
  assume {:verifier.code 0} true;
  $i151 := $trunc.i8.i1($i150);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 70} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  assume {:verifier.code 0} true;
  $i172 := $ne.i32($i149, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 20} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i151 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 74} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 74} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 89} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 54} true;
  assume {:verifier.code 0} true;
  $i163 := $i162;
  goto $bb131;
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 112} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 112} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i157} true;
  goto $bb126, $bb128;
$bb123:
  assume !(($i153 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 93} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 93} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 108} true;
  assume {:verifier.code 0} true;
...
$bb126:
  ...
  goto $bb127;
$bb127:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 166} true;
  assume {:verifier.code 0} true;
  $i164 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 166} true;
  assume {:verifier.code 0} true;
  $i165 := $trunc.i8.i1($i164);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i165} true;
  goto $bb132, $bb133;
$bb128:
  assume !(($i157 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 131} true;
  assume {:verifier.code 0} true;
...
$bb132:
  assume ($i165 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 184} true;
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  goto $bb134;
$bb134:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 815, 212} true;
  assume {:verifier.code 0} true;
...
$bb138:
  assume ($i175 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 36} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i175 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 55} true;
  assume {:verifier.code 0} true;
  $i180 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 55} true;
  assume {:verifier.code 0} true;
  $i181 := $trunc.i8.i1($i180);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 70} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  assume {:verifier.code 0} true;
  $i200 := $ne.i32($i179, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i181 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 74} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 74} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 89} true;
  assume {:verifier.code 0} true;
...
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 54} true;
  assume {:verifier.code 0} true;
  $i193 := $i192;
  goto $bb154;
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 112} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 112} true;
  assume {:verifier.code 0} true;
  $i187 := $trunc.i8.i1($i186);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i187} true;
  goto $bb149, $bb151;
$bb146:
  assume !(($i183 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 93} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 93} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 108} true;
  assume {:verifier.code 0} true;
...
$bb149:
  ...
  goto $bb150;
$bb150:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 166} true;
  assume {:verifier.code 0} true;
  $i194 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 166} true;
  assume {:verifier.code 0} true;
  $i195 := $trunc.i8.i1($i194);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 181} true;
  assume {:verifier.code 0} true;
  $i196 := 0;
...
$bb151:
  assume !(($i187 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 131} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume ($i195 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 816, 184} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume ($i203 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 36} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume !(($i203 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 55} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 55} true;
  assume {:verifier.code 0} true;
  $i209 := $trunc.i8.i1($i208);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 70} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  assume {:verifier.code 0} true;
  $i230 := $ne.i32($i207, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 20} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume ($i209 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 74} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 74} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 89} true;
  assume {:verifier.code 0} true;
...
$bb162:
  ...
  goto $bb163;
$bb163:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 54} true;
  assume {:verifier.code 0} true;
  $i221 := $i220;
  goto $bb174;
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 112} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 112} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i215} true;
  goto $bb169, $bb171;
$bb166:
  assume !(($i211 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 93} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 93} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 108} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 166} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 166} true;
  assume {:verifier.code 0} true;
  $i223 := $trunc.i8.i1($i222);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i223} true;
  goto $bb175, $bb176;
$bb171:
  assume !(($i215 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 131} true;
  assume {:verifier.code 0} true;
...
$bb175:
  assume ($i223 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 184} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  goto $bb177;
$bb177:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 817, 212} true;
  assume {:verifier.code 0} true;
...
$bb181:
  assume ($i233 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 36} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume !(($i233 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 55} true;
  assume {:verifier.code 0} true;
  $i238 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 55} true;
  assume {:verifier.code 0} true;
  $i239 := $trunc.i8.i1($i238);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 70} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  assume {:verifier.code 0} true;
  $i258 := $ne.i32($i237, 0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 819, 23} true;
  assume {:verifier.code 0} true;
  $i260 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 819, 25} true;
  assume {:verifier.code 0} true;
  $i261 := $eq.i32($i260, 2);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 819, 30} true;
  assume {:verifier.code 0} true;
  $i262 := 0;
...
$bb184:
  assume ($i239 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 74} true;
  assume {:verifier.code 0} true;
  $i240 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 74} true;
  assume {:verifier.code 0} true;
  $i241 := $trunc.i8.i1($i240);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 89} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  goto $bb186;
$bb186:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 54} true;
  assume {:verifier.code 0} true;
  $i251 := $i250;
  goto $bb197;
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 112} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 112} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i245} true;
  goto $bb192, $bb194;
$bb189:
  assume !(($i241 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 93} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 93} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 108} true;
  assume {:verifier.code 0} true;
...
$bb192:
  ...
  goto $bb193;
$bb193:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 166} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 166} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 181} true;
  assume {:verifier.code 0} true;
  $i254 := 0;
...
$bb194:
  assume !(($i245 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 131} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i253 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 818, 184} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i261 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 819, 33} true;
  assume {:verifier.code 0} true;
  $i263 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 819, 53} true;
  assume {:verifier.code 0} true;
  $i264 := $eq.i32($i263, 1);
  assume {:verifier.code 0} true;
  $i262 := $i264;
...
$bb203:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 819, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe010_pso.opt_tmp.c:819:21: warning: over-approximating bitwise operation xor;
  $i265 := $xor.i1($i262, 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 819, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 820, 7} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume ($i268 == 1);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 820, 25} true;
  assume {:verifier.code 0} true;
...
$bb205:
  assume !(($i268 == 1));
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 820, 37} true;
  assume {:verifier.code 0} true;
  $i271 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 820, 7} true;
  assume {:verifier.code 0} true;
...
$bb206:
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 820, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 820, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i270);
  call {:cexpr "y"} boogie_si_record_i32($i270);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 821, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 823, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 823, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i274);
  assume {:sourceloc "output/safe010_pso.opt_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
