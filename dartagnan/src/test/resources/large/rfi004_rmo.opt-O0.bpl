...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/rfi004_rmo.opt-O0.bpl /Users/ponce/git/Dat3M/output/rfi004_rmo.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i197: i32;
$bb0:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 743, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 746, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 747, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 748, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 748, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 748, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 749, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 749, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 749, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 750, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 750, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 750, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 750, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 751, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 751, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i8);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i20);
  call {:cexpr "y"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 752, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i31);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 753, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i54);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 754, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 755, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 756, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 757, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 759, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 759, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i190);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 758, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 760, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 760, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 760, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i194);
  call {:cexpr "y"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 761, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 766, 22} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 766, 39} true;
  assume {:verifier.code 0} true;
  $i197 := $add.i32($i196, 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 766, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i197);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i197);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i85: i32;
$bb0:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 773, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 773, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i1);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 774, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 1);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 775, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 775, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 775, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 775, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 777, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 777, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 777, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 777, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 777, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/rfi004_rmo.opt_tmp.c:777:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 777, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 777, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 778, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 778, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 778, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 778, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd2, 1);
  call {:cexpr "y$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 784, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 787, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, z);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 787, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i21);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 790, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, x);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 790, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i22);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i22);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i24 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i26 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i28);
  call {:cexpr "y"} boogie_si_record_i32($i28);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 794, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i37} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i30 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 102} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i32 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 793, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i37 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 794, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 794, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i40, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $i45 := $zext.i1.i8($i44);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $trunc.i8.i1($i46);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i47 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 56} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i51 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i58 := $ne.i32($i54, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  $i59 := $zext.i1.i8($i58);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 796, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i61} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i61 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 796, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 796, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i68 := $ne.i32($i64, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i1.i8($i68);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i71 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 38} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 56} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i75} true;
  goto $bb46, $bb47;
$bb43:
...
$bb46:
  assume ($i75 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i82 := $ne.i32($i78, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  $i83 := $zext.i1.i8($i82);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 800, 22} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 800, 39} true;
  assume {:verifier.code 0} true;
  $i85 := $add.i32($i84, 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 800, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i85);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i85);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 818, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 820, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 820, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 820, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 820, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 822, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 822, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i15);
  call {:cexpr "y"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 825, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, y);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 824, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 825, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 825, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 827, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 827, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 827, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 827, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 827, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 827, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 827, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 828, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 829, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 23} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 43} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.i32($i71, 0);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 48} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
...
$bb49:
  assume ($i72 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 51} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 71} true;
  assume {:verifier.code 0} true;
  $i75 := $eq.i32($i74, 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 76} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i75} true;
  goto $bb52, $bb53;
...
$bb51:
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/rfi004_rmo.opt_tmp.c:831:21: warning: over-approximating bitwise operation xor;
  $i78 := $xor.i1($i73, 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 19} true;
  assume {:verifier.code 0} true;
  $i79 := $zext.i1.i8($i78);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 833, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i82 := $zext.i1.i32($i81);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 833, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i82);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i75 == 1);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 79} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/rfi004_rmo.opt_tmp.c", 831, 99} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 0);
  assume {:verifier.code 0} true;
  $i73 := $i77;
