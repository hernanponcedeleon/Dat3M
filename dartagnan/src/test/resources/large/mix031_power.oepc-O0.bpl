...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix031_power.oepc-O0.bpl /Users/ponce/git/Dat3M/output/mix031_power.oepc_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 83454));
...
axiom (weak$$choice0 == $sub.ref(0, 20533));
const weak$$choice2: ref;
axiom (weak$$choice2 == $sub.ref(0, 21558));
const a$flush_delayed: ref;
axiom (a$flush_delayed == $sub.ref(0, 22583));
const a$mem_tmp: ref;
axiom (a$mem_tmp == $sub.ref(0, 23611));
const main$tmp_guard0: ref;
axiom (main$tmp_guard0 == $sub.ref(0, 24636));
const main$tmp_guard1: ref;
axiom (main$tmp_guard1 == $sub.ref(0, 25661));
const a$read_delayed: ref;
axiom (a$read_delayed == $sub.ref(0, 26686));
const a$read_delayed_var: ref;
axiom (a$read_delayed_var == $sub.ref(0, 27718));
const .str: ref;
axiom (.str == $sub.ref(0, 28744));
const {:count 20} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 29788));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 30831));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 31863));
const {:count 3} .str.1.12: ref;
axiom (.str.1.12 == $sub.ref(0, 32890));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 33918));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 34950));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 35982));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 37014));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 38046));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 39078));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 40110));
procedure  llvm.dbg.label($p0: ref);
const P0: ref;
axiom (P0 == $sub.ref(0, 41142));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i85: i32;
$bb0:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 746, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 746, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff1, $i1);
  call {:cexpr "a$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 747, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff0, 1);
  call {:cexpr "a$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 748, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 748, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 748, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 748, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 749, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff0_used, 1);
  call {:cexpr "a$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 750, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 750, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 750, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 750, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 750, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix031_power.oepc_tmp.c:750:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 750, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 750, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 751, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 751, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 752, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 753, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 753, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 754, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff0_thd1, 1);
  call {:cexpr "a$r_buff0_thd1"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 755, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 757, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 760, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 760, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i21);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 761, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 763, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 763, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EBX, $i22);
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i22);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 25} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 25} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 7} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 42} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $i27;
  goto $bb9;
...
$bb9:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i28);
  call {:cexpr "a"} boogie_si_record_i32($i28);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 767, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i37} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 73} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 73} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i8.i1($i31);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 55} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 102} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i32 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 90} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 766, 55} true;
  assume {:verifier.code 0} true;
  $i34 := $i33;
  goto $bb15;
...
$bb16:
  assume ($i37 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 767, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 767, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i40, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  $i45 := $zext.i1.i8($i44);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff0_used, $i45);
  call {:cexpr "a$w_buff0_used"} boogie_si_record_i8($i45);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $trunc.i8.i1($i46);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i51 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 74} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 74} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 20} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i58 := $ne.i32($i54, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  $i59 := $zext.i1.i8($i58);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff1_used, $i59);
  call {:cexpr "a$w_buff1_used"} boogie_si_record_i8($i59);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i61} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i61 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 20} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i68 := $ne.i32($i64, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 18} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i1.i8($i68);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 769, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff0_thd1, $i69);
  call {:cexpr "a$r_buff0_thd1"} boogie_si_record_i8($i69);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 38} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, a$r_buff0_thd1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 56} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 74} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, a$r_buff1_thd1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 74} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 20} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i82 := $ne.i32($i78, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  $i83 := $zext.i1.i8($i82);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff1_thd1, $i83);
  call {:cexpr "a$r_buff1_thd1"} boogie_si_record_i8($i83);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 773, 22} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 773, 39} true;
  assume {:verifier.code 0} true;
  $i85 := $add.i32($i84, 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i85);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i85);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i259: i32;
$bb0:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 780, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 783, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 786, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 786, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 787, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 789, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 789, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 789, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 790, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 790, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 790, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 791, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 791, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 791, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 791, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 792, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 792, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$mem_tmp, $i9);
  call {:cexpr "a$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 84} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 84} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 7} true;
...
$bb14:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i21);
  call {:cexpr "a"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 124} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 124} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 106} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 793, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff0, $i32);
  call {:cexpr "a$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 121} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 121} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 44} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 169} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 169} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 151} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 794, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a$w_buff1, $i55);
  call {:cexpr "a$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 98} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i61} true;
  goto $bb53, $bb54;
$bb53:
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 121} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 121} true;
  assume {:verifier.code 0} true;
  $i65 := $trunc.i8.i1($i64);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 44} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 169} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 169} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 151} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 795, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 131} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 131} true;
  assume {:verifier.code 0} true;
  $i90 := $trunc.i8.i1($i89);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 54} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 184} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 184} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 166} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 796, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 131} true;
  assume {:verifier.code 0} true;
  $i119 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 184} true;
  assume {:verifier.code 0} true;
  $i128 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 797, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 36} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  $i162 := $zext.i1.i8($i161);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff0_thd2, $i162);
  call {:cexpr "a$r_buff0_thd2"} boogie_si_record_i8($i162);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 148} true;
  assume {:verifier.code 0} true;
  $i149 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 131} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 184} true;
  assume {:verifier.code 0} true;
  $i155 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 212} true;
  assume {:verifier.code 0} true;
  $i158 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 798, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 36} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 18} true;
  assume {:verifier.code 0} true;
  $i190 := $zext.i1.i8($i189);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff1_thd2, $i190);
  call {:cexpr "a$r_buff1_thd2"} boogie_si_record_i8($i190);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 800, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 800, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i191);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 148} true;
  assume {:verifier.code 0} true;
  $i179 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 131} true;
  assume {:verifier.code 0} true;
  $i177 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 184} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 799, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 801, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 801, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 801, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 801, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i195);
  call {:cexpr "a"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 802, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$flush_delayed, 0);
  call {:cexpr "a$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 804, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 7} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i198} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i198 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 25} true;
  assume {:verifier.code 0} true;
  $i199 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 55} true;
  assume {:verifier.code 0} true;
  $i204 := $trunc.i8.i1($i203);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i204} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i200 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i202);
  call {:cexpr "a"} boogie_si_record_i32($i202);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 806, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i211} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i204 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 73} true;
  assume {:verifier.code 0} true;
  $i205 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 102} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i206 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 805, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i211 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 806, 38} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 806, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 806, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i214, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 806, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i221 := $trunc.i8.i1($i220);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i221} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i221 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
  $i223 := $trunc.i8.i1($i222);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 53} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 56} true;
  assume {:verifier.code 0} true;
  $i225 := $trunc.i8.i1($i224);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i225 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 74} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i232 := $ne.i32($i228, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
  $i235 := $trunc.i8.i1($i234);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i235} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i235 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
  $i236 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 66} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i242 := $ne.i32($i238, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  $i243 := $zext.i1.i8($i242);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff0_thd2, $i243);
  call {:cexpr "a$r_buff0_thd2"} boogie_si_record_i8($i243);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i245} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i245 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, a$r_buff0_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 38} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 56} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i249 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 74} true;
  assume {:verifier.code 0} true;
  $i250 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 102} true;
  assume {:verifier.code 0} true;
  $i253 := $load.i8($M.0, a$r_buff1_thd2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i256 := $ne.i32($i252, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  $i257 := $zext.i1.i8($i256);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff1_thd2, $i257);
  call {:cexpr "a$r_buff1_thd2"} boogie_si_record_i8($i257);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 810, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 812, 22} true;
  assume {:verifier.code 0} true;
  $i258 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 812, 39} true;
  assume {:verifier.code 0} true;
  $i259 := $add.i32($i258, 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i259);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i259);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 813, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 828, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 831, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 832, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 832, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 832, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 832, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 833, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 834, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 835, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 42} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, a$w_buff0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $i14;
  goto $bb6;
...
$bb6:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, $i15);
  call {:cexpr "a"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 73} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, a$r_buff1_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 73} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 55} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 90} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, a$w_buff1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb12;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 38} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 20} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 837, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff0_used, $i32);
  call {:cexpr "a$w_buff0_used"} boogie_si_record_i8($i32);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 74} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, a$r_buff1_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 74} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 20} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 102} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 102} true;
  assume {:verifier.code 0} true;
  $i43 := $trunc.i8.i1($i42);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 102} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 838, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$w_buff1_used, $i46);
  call {:cexpr "a$w_buff1_used"} boogie_si_record_i8($i46);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 20} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 66} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 66} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 66} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff0_thd0, $i56);
  call {:cexpr "a$r_buff0_thd0"} boogie_si_record_i8($i56);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, a$w_buff0_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, a$r_buff0_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, a$w_buff1_used);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 74} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, a$r_buff1_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 74} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 20} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 102} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, a$r_buff1_thd0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 102} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 102} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, a$r_buff1_thd0, $i70);
  call {:cexpr "a$r_buff1_thd0"} boogie_si_record_i8($i70);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 842, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 23} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 43} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.i32($i71, 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 48} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
...
$bb49:
  assume ($i72 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 51} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i32($M.0, __unbuffered_p0_EBX);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 71} true;
  assume {:verifier.code 0} true;
  $i75 := $eq.i32($i74, 0);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 76} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i75} true;
  goto $bb52, $bb53;
...
$bb51:
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix031_power.oepc_tmp.c:843:21: warning: over-approximating bitwise operation xor;
  $i80 := $xor.i1($i73, 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 845, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i84 := $zext.i1.i32($i83);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 845, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i84);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 846, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 79} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 99} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 104} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i77} true;
  goto $bb54, $bb55;
...
$bb54:
  assume ($i77 == 1);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 107} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/mix031_power.oepc_tmp.c", 843, 127} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 0);
  assume {:verifier.code 0} true;
  $i73 := $i79;
...
axiom (pthread_create == $sub.ref(0, 44238));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 45270));
...
axiom (__SMACK_code == $sub.ref(0, 46302));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 47334));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 48366));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 49398));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 50430));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 51462));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 52494));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 53526));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 54558));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 55590));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 56622));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 57654));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 58686));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 59718));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 60750));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 61782));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 62814));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 63846));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 64878));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 65910));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 66942));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 67974));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 69006));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 70038));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 71070));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 72102));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 73134));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 74166));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 75198));
...
axiom (__SMACK_decls == $sub.ref(0, 76230));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 77262));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 78294));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 79326));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 80358));
...
axiom (llvm.dbg.value == $sub.ref(0, 82422));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 83454));
