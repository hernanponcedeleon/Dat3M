...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe009_pso.oepc-O0.bpl /Users/ponce/git/Dat3M/output/safe009_pso.oepc_tmp.c
...
{
$bb0:
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 722, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 722, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 723, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 723, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 724, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 725, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 726, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 727, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 728, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 729, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 730, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 731, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 731, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 731, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 732, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 733, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 737, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 737, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 738, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 738, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 739, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 740, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 741, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 743, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 746, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 746, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 746, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 747, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 752, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 752, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 753, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 2);
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 755, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 758, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 758, 39} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 758, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i2);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 780, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 780, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 780, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 780, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 782, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 23} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 2);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 30} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 33} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 53} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i15, 2);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 58} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe009_pso.oepc_tmp.c:786:21: warning: over-approximating bitwise operation xor;
  $i19 := $xor.i1($i14, 1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 787, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 788, 21} true;
  ...
  assume {:verifier.code 1} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 788, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i23);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 61} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/safe009_pso.oepc_tmp.c", 786, 81} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i17, 1);
  assume {:verifier.code 0} true;
  $i14 := $i18;
