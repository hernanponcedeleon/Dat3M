...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix009_tso.oepc-O0.bpl /Users/ponce/git/Dat3M/output/mix009_tso.oepc_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i85: i32;
$bb0:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 743, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 743, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 744, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 744, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i1);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 745, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, 1);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 746, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 746, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 746, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 746, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 747, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$w_buff0_used, 1);
  call {:cexpr "z$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 748, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 748, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 748, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 748, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 748, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix009_tso.oepc_tmp.c:748:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 748, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 748, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 749, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 749, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 749, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 749, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 750, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 750, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 750, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 750, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 751, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 751, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 752, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$r_buff0_thd1, 1);
  call {:cexpr "z$r_buff0_thd1"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 754, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 755, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 758, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 758, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i21);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 761, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 761, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EBX, $i22);
  call {:cexpr "__unbuffered_p0_EBX"} boogie_si_record_i32($i22);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i28);
  call {:cexpr "z"} boogie_si_record_i32($i28);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 765, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 765, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 765, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i37} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 102} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i32 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 764, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i37 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 765, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 765, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i40, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 765, 18} true;
  assume {:verifier.code 0} true;
  $i45 := $zext.i1.i8($i44);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 765, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $trunc.i8.i1($i46);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i47 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 38} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 56} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i51 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i58 := $ne.i32($i54, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 18} true;
  assume {:verifier.code 0} true;
  $i59 := $zext.i1.i8($i58);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 766, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 767, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i61} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i61 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 767, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 767, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i68 := $ne.i32($i64, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i1.i8($i68);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $trunc.i8.i1($i70);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, z$r_buff0_thd1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i82 := $ne.i32($i78, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  $i83 := $zext.i1.i8($i82);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 770, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 771, 22} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 771, 39} true;
  assume {:verifier.code 0} true;
  $i85 := $add.i32($i84, 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i85);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i85);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i259: i32;
$bb0:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 778, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 781, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 781, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 784, 19} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 784, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i1.i8($i2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 784, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 785, 19} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i4);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 785, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i8($i4);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 785, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 786, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 786, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i8.i1($i6);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 786, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 786, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 787, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 787, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$mem_tmp, $i9);
  call {:cexpr "z$mem_tmp"} boogie_si_record_i32($i9);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 101} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 65} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i13 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 46} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 106} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i8.i1($i22);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i17 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i21);
  call {:cexpr "z"} boogie_si_record_i32($i21);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 788, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i30 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff0, $i32);
  call {:cexpr "z$w_buff0"} boogie_si_record_i32($i32);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 64} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 138} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i32($M.0, z$w_buff0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 44} true;
  assume {:verifier.code 0} true;
  $i44 := $i43;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i36 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 83} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 151} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i8.i1($i45);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i40 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i46 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 789, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i53 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i8.i1($i56);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z$w_buff1, $i55);
  call {:cexpr "z$w_buff1"} boogie_si_record_i32($i55);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i57 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 64} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i8.i1($i58);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 138} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i32($M.0, z$w_buff1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 44} true;
  assume {:verifier.code 0} true;
  $i67 := $i66;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i59 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 83} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i8.i1($i60);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 98} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i61} true;
  goto $bb53, $bb54;
$bb53:
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 151} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i8.i1($i68);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i63 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i69 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i71 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 790, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i76 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 55} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i103 := $ne.i32($i80, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i82 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 74} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i32($i92);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 54} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 112} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i84 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 93} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 166} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i88 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 791, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i106 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i106 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 55} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i131 := $ne.i32($i110, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i112 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 74} true;
  assume {:verifier.code 0} true;
  $i114 := $trunc.i8.i1($i113);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 54} true;
  assume {:verifier.code 0} true;
  $i124 := $i123;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 112} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i118} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i114 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 93} true;
  assume {:verifier.code 0} true;
  $i116 := $trunc.i8.i1($i115);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 166} true;
  assume {:verifier.code 0} true;
  $i126 := $trunc.i8.i1($i125);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 181} true;
  assume {:verifier.code 0} true;
  $i127 := 0;
...
$bb103:
  assume !(($i118 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 792, 184} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i134 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i134 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i161 := $ne.i32($i138, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i140 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 74} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 54} true;
  assume {:verifier.code 0} true;
  $i152 := $i151;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 112} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i146} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i142 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 93} true;
  assume {:verifier.code 0} true;
  $i144 := $trunc.i8.i1($i143);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 166} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i154} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i146 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i154 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 793, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i164 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i164 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 55} true;
  assume {:verifier.code 0} true;
  $i170 := $trunc.i8.i1($i169);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i168, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 795, 25} true;
  assume {:verifier.code 0} true;
  $i191 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 795, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EBX, $i191);
  call {:cexpr "__unbuffered_p1_EBX"} boogie_si_record_i32($i191);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 796, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i170 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
  $i172 := $trunc.i8.i1($i171);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 54} true;
  assume {:verifier.code 0} true;
  $i182 := $i181;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 112} true;
  assume {:verifier.code 0} true;
  $i176 := $trunc.i8.i1($i175);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i176} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i172 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 93} true;
  assume {:verifier.code 0} true;
  $i174 := $trunc.i8.i1($i173);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 166} true;
  assume {:verifier.code 0} true;
  $i184 := $trunc.i8.i1($i183);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 181} true;
  assume {:verifier.code 0} true;
  $i185 := 0;
...
$bb146:
  assume !(($i176 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i184 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 794, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i193 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 796, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i193 == 1));
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 796, 37} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 796, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 796, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 796, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i195);
  call {:cexpr "z"} boogie_si_record_i32($i195);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 797, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, z$flush_delayed, 0);
  call {:cexpr "z$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 7} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i198} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i198 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 55} true;
  assume {:verifier.code 0} true;
  $i204 := $trunc.i8.i1($i203);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i204} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i200 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i202);
  call {:cexpr "z"} boogie_si_record_i32($i202);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 801, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 801, 20} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 801, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i211} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i204 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 102} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i206 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 800, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i211 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 801, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 801, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i214, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 801, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 20} true;
  assume {:verifier.code 0} true;
  $i221 := $trunc.i8.i1($i220);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i221} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i221 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 38} true;
  assume {:verifier.code 0} true;
  $i223 := $trunc.i8.i1($i222);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 53} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 56} true;
  assume {:verifier.code 0} true;
  $i225 := $trunc.i8.i1($i224);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i225 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i232 := $ne.i32($i228, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 802, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 803, 20} true;
  assume {:verifier.code 0} true;
  $i235 := $trunc.i8.i1($i234);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 803, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i235} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i235 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 803, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 803, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i242 := $ne.i32($i238, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 803, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i245} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i245 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, z$r_buff0_thd2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 38} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 56} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i249 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i256 := $ne.i32($i252, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 806, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 807, 22} true;
  assume {:verifier.code 0} true;
  $i258 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 807, 39} true;
  assume {:verifier.code 0} true;
  $i259 := $add.i32($i258, 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i259);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i259);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 825, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 826, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 827, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 827, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 827, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 827, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 828, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 829, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 829, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, $i15);
  call {:cexpr "z"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 832, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 832, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 831, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 832, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 832, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 832, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 832, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 833, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 834, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 834, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 834, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 834, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 834, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 834, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 834, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, z$w_buff0_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, z$r_buff0_thd0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, z$w_buff1_used);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 835, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 836, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 23} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 43} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.i32($i71, 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 48} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
...
$bb49:
  assume ($i72 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 51} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i32($M.0, __unbuffered_p0_EBX);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 71} true;
  assume {:verifier.code 0} true;
  $i75 := $eq.i32($i74, 0);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 76} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i75} true;
  goto $bb52, $bb53;
...
$bb51:
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix009_tso.oepc_tmp.c:838:21: warning: over-approximating bitwise operation xor;
  $i80 := $xor.i1($i73, 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 839, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 840, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i84 := $zext.i1.i32($i83);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 840, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i84);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb52:
  assume ($i75 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 79} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 99} true;
  assume {:verifier.code 0} true;
  $i77 := $eq.i32($i76, 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 104} true;
  assume {:verifier.code 0} true;
  $i73 := 0;
  assume {:branchcond $i77} true;
  goto $bb54, $bb55;
...
$bb54:
  assume ($i77 == 1);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 107} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i32($M.0, __unbuffered_p1_EBX);
  assume {:sourceloc "output/mix009_tso.oepc_tmp.c", 838, 127} true;
  assume {:verifier.code 0} true;
  $i79 := $eq.i32($i78, 0);
  assume {:verifier.code 0} true;
  $i73 := $i79;
