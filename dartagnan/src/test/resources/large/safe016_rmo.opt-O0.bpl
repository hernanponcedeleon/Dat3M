...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe016_rmo.opt-O0.bpl /Users/ponce/git/Dat3M/output/safe016_rmo.opt_tmp.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 104995));
...
axiom (x$r_buff0_thd4 == $sub.ref(0, 22581));
const x$r_buff1_thd4: ref;
axiom (x$r_buff1_thd4 == $sub.ref(0, 23606));
const main$tmp_guard0: ref;
axiom (main$tmp_guard0 == $sub.ref(0, 24631));
const x$r_buff0_thd0: ref;
axiom (x$r_buff0_thd0 == $sub.ref(0, 25656));
const x$r_buff1_thd0: ref;
axiom (x$r_buff1_thd0 == $sub.ref(0, 26681));
const weak$$choice1: ref;
axiom (weak$$choice1 == $sub.ref(0, 27706));
...
axiom (.str.1 == $sub.ref(0, 49265));
const {:count 19} __PRETTY_FUNCTION__.reach_error: ref;
axiom (__PRETTY_FUNCTION__.reach_error == $sub.ref(0, 50308));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 51340));
const {:count 3} .str.1.12: ref;
axiom (.str.1.12 == $sub.ref(0, 52367));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 53395));
const assume_abort_if_not: ref;
axiom (assume_abort_if_not == $sub.ref(0, 54427));
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 55459));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 56491));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
axiom (__assert_fail == $sub.ref(0, 57523));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 58555));
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.label == $sub.ref(0, 59587));
procedure  llvm.dbg.label($p0: ref);
const P0: ref;
axiom (P0 == $sub.ref(0, 60619));
procedure  P0($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 763, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 763, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 766, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 767, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i7);
  call {:cexpr "x"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 770, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 770, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 769, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 770, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 770, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 770, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 771, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 772, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 772, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 772, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 772, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 772, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 772, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 772, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 776, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 776, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 778, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 783, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 2);
  call {:cexpr "x"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i6);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 787, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 787, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 786, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 787, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 787, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 788, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 789, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 789, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 789, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 789, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 789, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 790, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 793, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 793, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 794, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i258: i32;
$bb0:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 800, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 800, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 800, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 801, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 801, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 801, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 802, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 802, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 802, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 802, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 803, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 803, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i8);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i20);
  call {:cexpr "x"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 804, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i31);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 805, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 60} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i56} true;
  goto $bb47, $bb48;
$bb46:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i54);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 806, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 807, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 808, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 809, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 811, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p2_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p2_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 812, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p2_EAX$read_delayed_var, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 813, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 813, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i190);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 814, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 810, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 814, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 814, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 814, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 814, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 814, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i194);
  call {:cexpr "x"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 815, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 817, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 818, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 820, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 7} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i197} true;
  goto $bb156, $bb157;
$bb156:
  assume ($i197 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 25} true;
  assume {:verifier.code 0} true;
...
$bb157:
  ...
  goto $bb158;
$bb158:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 55} true;
  assume {:verifier.code 0} true;
  $i202 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 55} true;
  assume {:verifier.code 0} true;
  $i203 := $trunc.i8.i1($i202);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i203} true;
  goto $bb162, $bb163;
$bb159:
  assume ($i199 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 42} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i201);
  call {:cexpr "x"} boogie_si_record_i32($i201);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 822, 20} true;
  assume {:verifier.code 0} true;
  $i209 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 822, 20} true;
  assume {:verifier.code 0} true;
  $i210 := $trunc.i8.i1($i209);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 822, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i210} true;
  goto $bb168, $bb169;
$bb162:
  assume ($i203 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 73} true;
  assume {:verifier.code 0} true;
...
$bb163:
  ...
  goto $bb164;
$bb164:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 102} true;
  assume {:verifier.code 0} true;
  $i208 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 55} true;
  assume {:verifier.code 0} true;
...
$bb165:
  assume ($i205 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 821, 90} true;
  assume {:verifier.code 0} true;
...
$bb168:
  assume ($i210 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 822, 38} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 822, 66} true;
  assume {:verifier.code 0} true;
...
$bb173:
  ...
  assume {:verifier.code 0} true;
  $i217 := $ne.i32($i213, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 822, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 20} true;
  assume {:verifier.code 0} true;
  $i219 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 20} true;
  assume {:verifier.code 0} true;
  $i220 := $trunc.i8.i1($i219);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i220} true;
  goto $bb174, $bb175;
$bb174:
  assume ($i220 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 38} true;
  assume {:verifier.code 0} true;
  $i221 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 38} true;
  assume {:verifier.code 0} true;
  $i222 := $trunc.i8.i1($i221);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 53} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb176;
$bb176:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 56} true;
  assume {:verifier.code 0} true;
  $i223 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 56} true;
  assume {:verifier.code 0} true;
  $i224 := $trunc.i8.i1($i223);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 71} true;
  assume {:verifier.code 0} true;
...
$bb180:
  assume ($i224 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 74} true;
  assume {:verifier.code 0} true;
...
$bb181:
  ...
  goto $bb182;
$bb182:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 102} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  assume {:verifier.code 0} true;
  $i231 := $ne.i32($i227, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 823, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 824, 20} true;
  assume {:verifier.code 0} true;
  $i233 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 824, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $trunc.i8.i1($i233);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 824, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i234} true;
  goto $bb186, $bb187;
$bb186:
  assume ($i234 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 824, 38} true;
  assume {:verifier.code 0} true;
...
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 824, 66} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  assume {:verifier.code 0} true;
  $i241 := $ne.i32($i237, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 824, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i243 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i244 := $trunc.i8.i1($i243);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i244} true;
  goto $bb192, $bb193;
$bb192:
  assume ($i244 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 38} true;
  assume {:verifier.code 0} true;
  $i245 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 38} true;
  assume {:verifier.code 0} true;
  $i246 := $trunc.i8.i1($i245);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 53} true;
  assume {:verifier.code 0} true;
...
$bb193:
  ...
  goto $bb194;
$bb194:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 56} true;
  assume {:verifier.code 0} true;
  $i247 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 56} true;
  assume {:verifier.code 0} true;
  $i248 := $trunc.i8.i1($i247);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 71} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i248 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 74} true;
  assume {:verifier.code 0} true;
...
$bb199:
  ...
  goto $bb200;
$bb200:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 102} true;
  assume {:verifier.code 0} true;
...
$bb203:
  ...
  assume {:verifier.code 0} true;
  $i255 := $ne.i32($i251, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 826, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 827, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 828, 22} true;
  assume {:verifier.code 0} true;
  $i257 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 828, 39} true;
  assume {:verifier.code 0} true;
  $i258 := $add.i32($i257, 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i258);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i258);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 829, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 830, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 835, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 2);
  call {:cexpr "y"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 836, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 42} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i6);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 839, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 90} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 838, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 839, 66} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 839, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$w_buff0_used, $i23);
  call {:cexpr "x$w_buff0_used"} boogie_si_record_i8($i23);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, x$r_buff0_thd4);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 102} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$w_buff1_used, $i37);
  call {:cexpr "x$w_buff1_used"} boogie_si_record_i8($i37);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 841, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 841, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 841, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 841, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, x$r_buff0_thd4);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i53} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 842, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 843, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 845, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 845, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 845, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 846, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 861, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 863, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 865, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 868, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 869, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 869, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 869, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 869, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 870, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 871, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 871, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 872, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i19);
  call {:cexpr "x"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 874, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 873, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 874, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 874, 66} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 874, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 876, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 876, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 877, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 878, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 879, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 880, 19} true;
  assume {:verifier.code 1} true;
  call $i75 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i75);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 880, 17} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i8($i75);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 880, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 881, 19} true;
  assume {:verifier.code 1} true;
  call $i77 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i77);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 881, 17} true;
  assume {:verifier.code 0} true;
  $i78 := $zext.i1.i8($i77);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 881, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 882, 21} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 882, 21} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 882, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 882, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 883, 15} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 883, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i82);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i82);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 8} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 8} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i84} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i84 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 27} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 27} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 42} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 101} true;
  assume {:verifier.code 0} true;
  $i93 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 7} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb62;
$bb52:
  ...
  goto $bb53;
$bb53:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 65} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 65} true;
  assume {:verifier.code 0} true;
  $i90 := $trunc.i8.i1($i89);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i90} true;
  goto $bb57, $bb59;
$bb54:
  assume !(($i86 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 46} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 46} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 61} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb58;
$bb58:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 106} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 106} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb63, $bb64;
$bb59:
  assume !(($i90 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 84} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i94);
  call {:cexpr "x"} boogie_si_record_i32($i94);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 15} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i96 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 124} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb65;
$bb65:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 153} true;
  assume {:verifier.code 0} true;
...
$bb66:
  assume ($i98 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 884, 141} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i103 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 31} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume !(($i103 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 45} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 45} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 60} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i105);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i105);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 15} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i107 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 64} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 64} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 79} true;
  assume {:verifier.code 0} true;
...
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 138} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 44} true;
  assume {:verifier.code 0} true;
  $i117 := $i116;
  goto $bb85;
$bb75:
  ...
  goto $bb76;
$bb76:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 102} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 102} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i113} true;
  goto $bb80, $bb82;
$bb77:
  assume !(($i109 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 83} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 83} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 98} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i111} true;
  goto $bb78, $bb79;
$bb78:
...
$bb80:
  ...
  goto $bb81;
$bb81:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 151} true;
  assume {:verifier.code 0} true;
  $i118 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 151} true;
  assume {:verifier.code 0} true;
  $i119 := $trunc.i8.i1($i118);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i119} true;
  goto $bb86, $bb87;
$bb82:
  assume !(($i113 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 121} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i119 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 169} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 198} true;
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i121 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 885, 186} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i126 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 31} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume !(($i126 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 45} true;
  assume {:verifier.code 0} true;
  $i129 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 45} true;
  assume {:verifier.code 0} true;
  $i130 := $trunc.i8.i1($i129);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 60} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i128);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i128);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 20} true;
  assume {:verifier.code 0} true;
...
$bb95:
  assume ($i130 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 64} true;
  assume {:verifier.code 0} true;
  $i131 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 64} true;
  assume {:verifier.code 0} true;
  $i132 := $trunc.i8.i1($i131);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 79} true;
  assume {:verifier.code 0} true;
...
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 138} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 44} true;
  assume {:verifier.code 0} true;
  $i140 := $i139;
  goto $bb108;
$bb98:
  ...
  goto $bb99;
$bb99:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 102} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 102} true;
  assume {:verifier.code 0} true;
  $i136 := $trunc.i8.i1($i135);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i136} true;
  goto $bb103, $bb105;
$bb100:
  assume !(($i132 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 83} true;
  assume {:verifier.code 0} true;
  $i133 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 83} true;
  assume {:verifier.code 0} true;
  $i134 := $trunc.i8.i1($i133);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 98} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb104;
$bb104:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 151} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 151} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i142} true;
  goto $bb109, $bb110;
$bb105:
  assume !(($i136 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 121} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i142 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 169} true;
  assume {:verifier.code 0} true;
...
$bb110:
  ...
  goto $bb111;
$bb111:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 198} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i144 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 886, 186} true;
  assume {:verifier.code 0} true;
...
$bb115:
  assume ($i149 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 36} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume !(($i149 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 55} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 55} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i155} true;
  goto $bb118, $bb119;
$bb117:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i153, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 20} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i155 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 74} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 74} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 89} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i166 := $zext.i1.i32($i165);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 54} true;
  assume {:verifier.code 0} true;
  $i167 := $i166;
  goto $bb131;
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 112} true;
  assume {:verifier.code 0} true;
  $i160 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 112} true;
  assume {:verifier.code 0} true;
  $i161 := $trunc.i8.i1($i160);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i161} true;
  goto $bb126, $bb128;
$bb123:
  assume !(($i157 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 93} true;
  assume {:verifier.code 0} true;
  $i158 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 93} true;
  assume {:verifier.code 0} true;
  $i159 := $trunc.i8.i1($i158);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 108} true;
  assume {:verifier.code 0} true;
...
$bb126:
  ...
  goto $bb127;
$bb127:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 166} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 166} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i169} true;
  goto $bb132, $bb133;
$bb128:
  assume !(($i161 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 131} true;
  assume {:verifier.code 0} true;
...
$bb132:
  assume ($i169 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 184} true;
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  goto $bb134;
$bb134:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 887, 212} true;
  assume {:verifier.code 0} true;
...
$bb138:
  assume ($i179 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 36} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i179 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 70} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  assume {:verifier.code 0} true;
  $i204 := $ne.i32($i183, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 20} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i185 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 74} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 74} true;
  assume {:verifier.code 0} true;
  $i187 := $trunc.i8.i1($i186);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 89} true;
  assume {:verifier.code 0} true;
...
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 54} true;
  assume {:verifier.code 0} true;
  $i197 := $i196;
  goto $bb154;
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 112} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 112} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb149, $bb151;
$bb146:
  assume !(($i187 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 93} true;
  assume {:verifier.code 0} true;
  $i188 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 93} true;
  assume {:verifier.code 0} true;
  $i189 := $trunc.i8.i1($i188);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 108} true;
  assume {:verifier.code 0} true;
...
$bb149:
  ...
  goto $bb150;
$bb150:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 166} true;
  assume {:verifier.code 0} true;
  $i198 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 166} true;
  assume {:verifier.code 0} true;
  $i199 := $trunc.i8.i1($i198);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 181} true;
  assume {:verifier.code 0} true;
  $i200 := 0;
  assume {:branchcond $i199} true;
  goto $bb155, $bb156;
$bb151:
  assume !(($i191 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 131} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume ($i199 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 888, 184} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume ($i207 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 36} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume !(($i207 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 55} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 55} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 70} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  assume {:verifier.code 0} true;
  $i234 := $ne.i32($i211, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 20} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume ($i213 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 74} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 74} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 89} true;
  assume {:verifier.code 0} true;
...
$bb162:
  ...
  goto $bb163;
$bb163:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 54} true;
  assume {:verifier.code 0} true;
  $i225 := $i224;
  goto $bb174;
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 112} true;
  assume {:verifier.code 0} true;
  $i218 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 112} true;
  assume {:verifier.code 0} true;
  $i219 := $trunc.i8.i1($i218);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i219} true;
  goto $bb169, $bb171;
$bb166:
  assume !(($i215 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 93} true;
  assume {:verifier.code 0} true;
  $i216 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 93} true;
  assume {:verifier.code 0} true;
  $i217 := $trunc.i8.i1($i216);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 108} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 166} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 166} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i227} true;
  goto $bb175, $bb176;
$bb171:
  assume !(($i219 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 131} true;
  assume {:verifier.code 0} true;
...
$bb175:
  assume ($i227 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 184} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  goto $bb177;
$bb177:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 889, 212} true;
  assume {:verifier.code 0} true;
...
$bb181:
  assume ($i237 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 36} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume !(($i237 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 55} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 55} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 70} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  assume {:verifier.code 0} true;
  $i262 := $ne.i32($i241, 0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 891, 19} true;
  assume {:verifier.code 1} true;
  call $i264 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i264);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 891, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 892, 25} true;
  assume {:verifier.code 0} true;
...
$bb184:
  assume ($i243 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 74} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 74} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 89} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  goto $bb186;
$bb186:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i254 := $zext.i1.i32($i253);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 54} true;
  assume {:verifier.code 0} true;
  $i255 := $i254;
  goto $bb197;
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 112} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 112} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i249} true;
  goto $bb192, $bb194;
$bb189:
  assume !(($i245 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 93} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 93} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 108} true;
  assume {:verifier.code 0} true;
...
$bb192:
  ...
  goto $bb193;
$bb193:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 166} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 166} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 181} true;
  assume {:verifier.code 0} true;
  $i258 := 0;
...
$bb194:
  assume !(($i249 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 131} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i257 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 890, 184} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i267 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 892, 61} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume !(($i267 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 892, 140} true;
  assume {:verifier.code 0} true;
...
$bb203:
  assume ($i269 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 892, 78} true;
  assume {:verifier.code 0} true;
  $p270 := $load.ref($M.0, __unbuffered_p2_EAX$read_delayed_var);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 892, 77} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume !(($i269 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 892, 117} true;
  assume {:verifier.code 0} true;
...
$bb206:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 892, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 892, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i274);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i274);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 23} true;
  assume {:verifier.code 0} true;
  $i276 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 25} true;
  assume {:verifier.code 0} true;
  $i277 := $eq.i32($i276, 2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 30} true;
  assume {:verifier.code 0} true;
  $i278 := 0;
...
$bb207:
  assume ($i277 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 33} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 35} true;
  assume {:verifier.code 0} true;
  $i280 := $eq.i32($i279, 2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 40} true;
  assume {:verifier.code 0} true;
  $i278 := 0;
...
$bb209:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe016_rmo.opt_tmp.c:893:21: warning: over-approximating bitwise operation xor;
  $i285 := $xor.i1($i278, 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 894, 7} true;
  assume {:verifier.code 0} true;
...
$bb210:
  assume ($i280 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 43} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 63} true;
  assume {:verifier.code 0} true;
  $i282 := $eq.i32($i281, 2);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 68} true;
  assume {:verifier.code 0} true;
  $i278 := 0;
...
$bb212:
  assume ($i282 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 71} true;
  assume {:verifier.code 0} true;
  $i283 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 893, 91} true;
  assume {:verifier.code 0} true;
  $i284 := $eq.i32($i283, 2);
  assume {:verifier.code 0} true;
  $i278 := $i284;
...
$bb214:
  assume ($i288 == 1);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 894, 25} true;
  assume {:verifier.code 0} true;
...
$bb215:
  assume !(($i288 == 1));
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 894, 37} true;
  assume {:verifier.code 0} true;
  $i291 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 894, 7} true;
  assume {:verifier.code 0} true;
...
$bb216:
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 894, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 894, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i290);
  call {:cexpr "x"} boogie_si_record_i32($i290);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 895, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 896, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 897, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 897, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i294);
  assume {:sourceloc "output/safe016_rmo.opt_tmp.c", 898, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_create == $sub.ref(0, 65779));
procedure  pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 66811));
...
axiom (__SMACK_code == $sub.ref(0, 67843));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 68875));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 69907));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 70939));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 71971));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 73003));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 74035));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 75067));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 76099));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 77131));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 78163));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 79195));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 80227));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 81259));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 82291));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 83323));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 84355));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 85387));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 86419));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 87451));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 88483));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 89515));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 90547));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 91579));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 92611));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 93643));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 94675));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 95707));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 96739));
...
axiom (__SMACK_decls == $sub.ref(0, 97771));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 98803));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 99835));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 100867));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 101899));
...
axiom (llvm.dbg.value == $sub.ref(0, 103963));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 104995));
