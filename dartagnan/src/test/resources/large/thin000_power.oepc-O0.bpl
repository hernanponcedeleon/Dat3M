...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/thin000_power.oepc-O0.bpl /Users/ponce/git/Dat3M/output/thin000_power.oepc_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i314: i32;
$bb0:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 754, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 754, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 754, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 755, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 755, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 755, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 756, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 756, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 756, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 756, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 757, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 757, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i8);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 758, 19} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i9);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 758, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 758, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 30} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 45} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb4, $bb5;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i14);
  call {:cexpr "y"} boogie_si_record_i32($i14);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 15} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 48} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 78} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 78} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 93} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i18 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 65} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i22 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 97} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 97} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 112} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 216} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 216} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 231} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i24 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 115} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 115} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 130} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i26 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 134} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume !(($i28 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 152} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i30 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 168} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 152} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i30 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 173} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i34 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 189} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume !(($i34 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 201} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume ($i40 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 234} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 234} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 249} true;
  assume {:verifier.code 0} true;
...
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 331} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i42 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 252} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 252} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i8.i1($i43);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 267} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i44 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 271} true;
  assume {:verifier.code 0} true;
...
$bb34:
  assume !(($i46 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 289} true;
  assume {:verifier.code 0} true;
...
$bb35:
  assume ($i48 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 305} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i48 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 317} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i54 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 347} true;
  assume {:verifier.code 0} true;
...
$bb40:
  assume !(($i54 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 359} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 759, 331} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume ($i59 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 31} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume !(($i59 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 45} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 45} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 44} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i61);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i61);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 15} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume ($i63 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 75} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 75} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i67} true;
  goto $bb48, $bb49;
$bb46:
  assume !(($i63 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 62} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume ($i67 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 93} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 123} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 123} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb54, $bb55;
$bb51:
  assume ($i69 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 110} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume ($i73 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 142} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 142} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 157} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 209} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 209} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 224} true;
  assume {:verifier.code 0} true;
...
$bb58:
  assume !(($i75 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 160} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 160} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb59, $bb60;
$bb59:
  assume ($i77 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 179} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume !(($i79 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 196} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i83 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 227} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 227} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 242} true;
  assume {:verifier.code 0} true;
...
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 293} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i85 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 245} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 245} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 260} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i87 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 264} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume !(($i89 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 760, 281} true;
  assume {:verifier.code 0} true;
...
$bb74:
  assume ($i94 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 31} true;
  assume {:verifier.code 0} true;
...
$bb75:
  assume !(($i94 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 45} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 45} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 44} true;
  assume {:verifier.code 0} true;
...
$bb76:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i96);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i96);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 20} true;
  assume {:verifier.code 0} true;
...
$bb77:
  assume ($i98 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 75} true;
  assume {:verifier.code 0} true;
  $i101 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 75} true;
  assume {:verifier.code 0} true;
  $i102 := $trunc.i8.i1($i101);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  goto $bb80, $bb81;
$bb78:
  assume !(($i98 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 62} true;
  assume {:verifier.code 0} true;
...
$bb80:
  assume ($i102 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 93} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 123} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 123} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i108} true;
  goto $bb86, $bb87;
$bb83:
  assume ($i104 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 110} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i108 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 142} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 142} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 157} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 209} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 209} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 224} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume !(($i110 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 160} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 160} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb91, $bb92;
$bb91:
  assume ($i112 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 179} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i114 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 196} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i118 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 227} true;
  assume {:verifier.code 0} true;
  $i119 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 227} true;
  assume {:verifier.code 0} true;
  $i120 := $trunc.i8.i1($i119);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 242} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 293} true;
  assume {:verifier.code 0} true;
...
$bb99:
  assume ($i120 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 245} true;
  assume {:verifier.code 0} true;
  $i121 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 245} true;
  assume {:verifier.code 0} true;
  $i122 := $trunc.i8.i1($i121);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 260} true;
  assume {:verifier.code 0} true;
...
$bb101:
  assume ($i122 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 264} true;
  assume {:verifier.code 0} true;
...
$bb104:
  assume !(($i124 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 761, 281} true;
  assume {:verifier.code 0} true;
...
$bb106:
  assume ($i129 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 36} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume !(($i129 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 55} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 54} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i133, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 20} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i135 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 90} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 90} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb112, $bb113;
$bb110:
  assume !(($i135 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 72} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i141 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 108} true;
  assume {:verifier.code 0} true;
...
$bb113:
  ...
  goto $bb114;
$bb114:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 137} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 137} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 152} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i146 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 156} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 156} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 171} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 245} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 245} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 260} true;
  assume {:verifier.code 0} true;
...
$bb122:
  assume !(($i148 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 174} true;
  assume {:verifier.code 0} true;
  $i149 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 174} true;
  assume {:verifier.code 0} true;
  $i150 := $trunc.i8.i1($i149);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i150} true;
  goto $bb123, $bb124;
$bb123:
  assume ($i150 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 193} true;
  assume {:verifier.code 0} true;
...
$bb126:
  assume !(($i152 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 210} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, weak$$choice0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 210} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 224} true;
  assume {:verifier.code 0} true;
  $i155 := 1;
...
$bb129:
  assume !(($i154 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 228} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, weak$$choice1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 228} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 227} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin000_power.oepc_tmp.c:762:227: warning: over-approximating bitwise operation xor;
  $i158 := $xor.i1($i157, 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 224} true;
  assume {:verifier.code 0} true;
  $i155 := $i158;
...
$bb131:
  assume ($i162 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 263} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 263} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 278} true;
  assume {:verifier.code 0} true;
...
$bb132:
  ...
  goto $bb133;
$bb133:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 333} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume ($i164 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 281} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 281} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 296} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i166 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 300} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i168 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 762, 317} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i179 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 36} true;
  assume {:verifier.code 0} true;
...
$bb142:
  assume !(($i179 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 54} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i183, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 20} true;
  assume {:verifier.code 0} true;
...
$bb144:
  assume ($i185 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 90} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 90} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb147, $bb148;
$bb145:
  assume !(($i185 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 72} true;
  assume {:verifier.code 0} true;
...
$bb147:
  assume ($i191 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 108} true;
  assume {:verifier.code 0} true;
...
$bb148:
  ...
  goto $bb149;
$bb149:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 137} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 137} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 152} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i196 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 156} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 156} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 171} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  goto $bb155;
$bb155:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 227} true;
  assume {:verifier.code 0} true;
  $i207 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 227} true;
  assume {:verifier.code 0} true;
  $i208 := $trunc.i8.i1($i207);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 242} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb157:
  assume !(($i198 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 174} true;
  assume {:verifier.code 0} true;
  $i199 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 174} true;
  assume {:verifier.code 0} true;
  $i200 := $trunc.i8.i1($i199);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i200} true;
  goto $bb158, $bb159;
$bb158:
  assume ($i200 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 193} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume !(($i202 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 210} true;
  assume {:verifier.code 0} true;
...
$bb163:
  assume ($i208 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 245} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 245} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 260} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 227} true;
  assume {:verifier.code 0} true;
...
$bb166:
  assume ($i211 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 263} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 263} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 278} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb168:
  assume ($i213 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 282} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 282} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 763, 281} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin000_power.oepc_tmp.c:763:281: warning: over-approximating bitwise operation xor;
  $i216 := $xor.i1($i215, 1);
  assume {:verifier.code 0} true;
  $i209 := $i216;
  goto $bb165;
...
$bb170:
  assume ($i221 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 36} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume !(($i221 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 54} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i225, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 20} true;
  assume {:verifier.code 0} true;
...
$bb173:
  assume ($i227 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 90} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 90} true;
  assume {:verifier.code 0} true;
  $i233 := $trunc.i8.i1($i232);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i233} true;
  goto $bb176, $bb177;
$bb174:
  assume !(($i227 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 72} true;
  assume {:verifier.code 0} true;
...
$bb176:
  assume ($i233 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 108} true;
  assume {:verifier.code 0} true;
...
$bb177:
  ...
  goto $bb178;
$bb178:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 137} true;
  assume {:verifier.code 0} true;
  $i237 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 137} true;
  assume {:verifier.code 0} true;
  $i238 := $trunc.i8.i1($i237);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 152} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume ($i238 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 156} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 156} true;
  assume {:verifier.code 0} true;
  $i240 := $trunc.i8.i1($i239);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 171} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  goto $bb184;
$bb184:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 228} true;
  assume {:verifier.code 0} true;
  $i249 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 228} true;
  assume {:verifier.code 0} true;
  $i250 := $trunc.i8.i1($i249);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 243} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb186:
  assume !(($i240 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 174} true;
  assume {:verifier.code 0} true;
  $i241 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 174} true;
  assume {:verifier.code 0} true;
  $i242 := $trunc.i8.i1($i241);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i242} true;
  goto $bb187, $bb188;
$bb187:
  assume ($i242 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 193} true;
  assume {:verifier.code 0} true;
...
$bb190:
  assume !(($i244 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 210} true;
  assume {:verifier.code 0} true;
...
$bb192:
  assume ($i250 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 246} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 246} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 261} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb195:
  assume ($i253 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 264} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 264} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 279} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb197:
  assume ($i255 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 283} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 283} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 764, 282} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin000_power.oepc_tmp.c:764:282: warning: over-approximating bitwise operation xor;
  $i258 := $xor.i1($i257, 1);
  assume {:verifier.code 0} true;
  $i251 := $i258;
  goto $bb194;
...
$bb199:
  assume ($i263 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 36} true;
  assume {:verifier.code 0} true;
...
$bb200:
  assume !(($i263 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 55} true;
  assume {:verifier.code 0} true;
  $i268 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 55} true;
  assume {:verifier.code 0} true;
  $i269 := $trunc.i8.i1($i268);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 54} true;
  assume {:verifier.code 0} true;
...
$bb201:
  ...
  assume {:verifier.code 0} true;
  $i305 := $ne.i32($i267, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 766, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p0_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p0_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 767, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p0_EAX$read_delayed_var, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 768, 25} true;
  assume {:verifier.code 0} true;
  $i307 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 768, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i307);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i307);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 769, 7} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume ($i269 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 90} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 90} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i275} true;
  goto $bb205, $bb206;
$bb203:
  assume !(($i269 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 72} true;
  assume {:verifier.code 0} true;
...
$bb205:
  assume ($i275 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 108} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  goto $bb207;
$bb207:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 137} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 137} true;
  assume {:verifier.code 0} true;
  $i280 := $trunc.i8.i1($i279);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 152} true;
  assume {:verifier.code 0} true;
...
$bb211:
  assume ($i280 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 156} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 156} true;
  assume {:verifier.code 0} true;
  $i282 := $trunc.i8.i1($i281);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 171} true;
  assume {:verifier.code 0} true;
...
$bb212:
  ...
  goto $bb213;
$bb213:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 257} true;
  assume {:verifier.code 0} true;
  $i294 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 257} true;
  assume {:verifier.code 0} true;
  $i295 := $trunc.i8.i1($i294);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 272} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb215:
  assume !(($i282 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 174} true;
  assume {:verifier.code 0} true;
  $i283 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 174} true;
  assume {:verifier.code 0} true;
  $i284 := $trunc.i8.i1($i283);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i284} true;
  goto $bb216, $bb217;
$bb216:
  assume ($i284 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 193} true;
  assume {:verifier.code 0} true;
...
$bb219:
  assume !(($i286 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 211} true;
  assume {:verifier.code 0} true;
...
$bb220:
  assume ($i288 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 227} true;
  assume {:verifier.code 0} true;
...
$bb224:
  assume ($i295 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 275} true;
  assume {:verifier.code 0} true;
  $i297 := $load.i8($M.0, y$r_buff1_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 275} true;
  assume {:verifier.code 0} true;
  $i298 := $trunc.i8.i1($i297);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 290} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb227:
  assume ($i298 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 293} true;
  assume {:verifier.code 0} true;
  $i299 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 293} true;
  assume {:verifier.code 0} true;
  $i300 := $trunc.i8.i1($i299);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 308} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb229:
  assume ($i300 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 312} true;
  assume {:verifier.code 0} true;
  $i301 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 312} true;
  assume {:verifier.code 0} true;
  $i302 := $trunc.i8.i1($i301);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 765, 311} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin000_power.oepc_tmp.c:765:311: warning: over-approximating bitwise operation xor;
  $i303 := $xor.i1($i302, 1);
  assume {:verifier.code 0} true;
  $i296 := $i303;
  goto $bb226;
...
$bb231:
  assume ($i309 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 769, 25} true;
  assume {:verifier.code 0} true;
...
$bb232:
  assume !(($i309 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 769, 37} true;
  assume {:verifier.code 0} true;
  $i312 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 769, 7} true;
  assume {:verifier.code 0} true;
...
$bb233:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 769, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 769, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i311);
  call {:cexpr "y"} boogie_si_record_i32($i311);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 770, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 771, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 773, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 774, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 775, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 776, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 778, 22} true;
  assume {:verifier.code 0} true;
  $i313 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 778, 39} true;
  assume {:verifier.code 0} true;
  $i314 := $add.i32($i313, 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 778, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i314);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i314);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 779, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 784, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 785, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 785, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i1);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 787, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 788, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 790, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i7);
  call {:cexpr "y"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 792, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 791, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 792, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 792, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 794, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 794, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 794, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i54} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 796, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 797, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 798, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 798, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 800, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 814, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 817, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 818, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 818, 38} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 2);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 818, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i8($i5);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 818, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 820, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 820, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i9);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i8.i1($i10);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 55} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 55} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i15);
  call {:cexpr "y"} boogie_si_record_i32($i15);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 823, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 823, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 823, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i17 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 102} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i32($M.0, y);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i19 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 822, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i24 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 823, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 823, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i27, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 823, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i8($i31);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 823, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 20} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i8.i1($i33);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i34 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 38} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 38} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 56} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 56} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i38 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 824, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 825, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i48 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 825, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 825, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i51, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i1.i8($i55);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i58} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i58 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 38} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 38} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 56} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 56} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i62 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 827, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 828, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 829, 19} true;
  assume {:verifier.code 1} true;
  call $i71 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i71);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 829, 17} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 829, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 830, 25} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume ($i74 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 830, 61} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume !(($i74 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 830, 140} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume ($i76 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 830, 78} true;
  assume {:verifier.code 0} true;
  $p77 := $load.ref($M.0, __unbuffered_p0_EAX$read_delayed_var);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 830, 77} true;
  assume {:verifier.code 0} true;
...
$bb52:
  assume !(($i76 == 1));
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 830, 117} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 830, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 830, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i81);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i81);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 831, 23} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 831, 43} true;
  assume {:verifier.code 0} true;
  $i84 := $eq.i32($i83, 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 831, 48} true;
  assume {:verifier.code 0} true;
  $i85 := 0;
...
$bb55:
  assume ($i84 == 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 831, 51} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 831, 71} true;
  assume {:verifier.code 0} true;
  $i87 := $eq.i32($i86, 1);
  assume {:verifier.code 0} true;
  $i85 := $i87;
...
$bb57:
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 831, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/thin000_power.oepc_tmp.c:831:21: warning: over-approximating bitwise operation xor;
  $i88 := $xor.i1($i85, 1);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 831, 19} true;
  assume {:verifier.code 0} true;
  $i89 := $zext.i1.i8($i88);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 831, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 833, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 833, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i92);
  assume {:sourceloc "output/thin000_power.oepc_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
