...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/mix037_tso.oepc-O0.bpl /Users/ponce/git/Dat3M/output/mix037_tso.oepc_tmp.c
...
axiom (main$tmp_guard0 == $sub.ref(0, 25661));
const weak$$choice0: ref;
axiom (weak$$choice0 == $sub.ref(0, 26686));
const weak$$choice2: ref;
axiom (weak$$choice2 == $sub.ref(0, 27711));
const x$flush_delayed: ref;
axiom (x$flush_delayed == $sub.ref(0, 28736));
const x$mem_tmp: ref;
axiom (x$mem_tmp == $sub.ref(0, 29764));
const main$tmp_guard1: ref;
axiom (main$tmp_guard1 == $sub.ref(0, 30789));
const x$read_delayed: ref;
axiom (x$read_delayed == $sub.ref(0, 31814));
const x$read_delayed_var: ref;
axiom (x$read_delayed_var == $sub.ref(0, 32846));
const .str: ref;
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 754, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, b, 1);
  call {:cexpr "b"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 755, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 756, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 757, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 758, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i6);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 761, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 761, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 761, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 760, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 761, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 761, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 761, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 761, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 762, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 763, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 763, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 763, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 763, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 763, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 763, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 763, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 764, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 766, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 767, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 767, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 768, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i90: i32;
$bb0:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 774, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 774, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i1);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 775, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, 2);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32(2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 777, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$w_buff0_used, 1);
  call {:cexpr "x$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 778, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 778, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 778, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 778, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 778, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/mix037_tso.oepc_tmp.c:778:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 778, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 778, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 779, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 779, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 781, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 782, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 782, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, x$r_buff0_thd4);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i8($i25);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$r_buff0_thd2, 1);
  call {:cexpr "x$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 787, 25} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i32($M.0, y);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 787, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p1_EAX, $i27);
  call {:cexpr "__unbuffered_p1_EAX"} boogie_si_record_i32($i27);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 7} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i29 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 25} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 25} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i8.i1($i30);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 7} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 55} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 55} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i35} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i31 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i33);
  call {:cexpr "x"} boogie_si_record_i32($i33);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 791, 20} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 791, 20} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 791, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i35 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 73} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, x$r_buff1_thd2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 73} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 55} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 102} true;
  assume {:verifier.code 0} true;
  $i40 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i37 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 790, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 791, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 791, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 791, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 791, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 38} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 38} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 56} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 56} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i56 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i63 := $ne.i32($i59, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  $i64 := $zext.i1.i8($i63);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 792, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 793, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i66} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i66 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 793, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 793, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$r_buff0_thd2, $i74);
  call {:cexpr "x$r_buff0_thd2"} boogie_si_record_i8($i74);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i76} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i76 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 38} true;
  assume {:verifier.code 0} true;
  $i77 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 38} true;
  assume {:verifier.code 0} true;
  $i78 := $trunc.i8.i1($i77);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 56} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 56} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i80 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, x$r_buff1_thd2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 20} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i87 := $ne.i32($i83, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $i88 := $zext.i1.i8($i87);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$r_buff1_thd2, $i88);
  call {:cexpr "x$r_buff1_thd2"} boogie_si_record_i8($i88);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 795, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 796, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 797, 22} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 797, 39} true;
  assume {:verifier.code 0} true;
  $i90 := $add.i32($i89, 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i90);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i90);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i64: i32;
$bb0:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 803, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 804, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 805, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 806, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 807, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, z);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 807, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i1);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i8.i1($i8);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i7);
  call {:cexpr "x"} boogie_si_record_i32($i7);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 811, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 811, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 811, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 102} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i11 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 810, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 811, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 811, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i19, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 811, 18} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i8($i23);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 811, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i26 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i8.i1($i29);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i30 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 102} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i37 := $ne.i32($i33, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i1.i8($i37);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 812, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 813, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 813, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i40 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 813, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 813, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 813, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i50 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i8.i1($i53);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i54} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i54 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i61 := $ne.i32($i57, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i1.i8($i61);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 814, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 815, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 817, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 817, 39} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i63, 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 817, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i64);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i64);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 818, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 819, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i65: i32;
$bb0:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 824, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 825, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 826, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 827, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, a, 1);
  call {:cexpr "a"} boogie_si_record_i32(1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 828, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 829, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 830, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, a);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 830, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EAX, $i1);
  call {:cexpr "__unbuffered_p3_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 831, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 833, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, b);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 833, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p3_EBX, $i2);
  call {:cexpr "__unbuffered_p3_EBX"} boogie_si_record_i32($i2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 835, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 7} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i8.i1($i3);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i8);
  call {:cexpr "x"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 837, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 837, 20} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i8.i1($i16);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 837, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 102} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i12 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 836, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 837, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 837, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i20, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 837, 18} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i1.i8($i24);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 837, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i27 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 38} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, x$r_buff0_thd4);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 38} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 56} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 56} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i8.i1($i30);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i31 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i38 := $ne.i32($i34, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 18} true;
  assume {:verifier.code 0} true;
  $i39 := $zext.i1.i8($i38);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 838, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 839, 20} true;
  assume {:verifier.code 0} true;
  $i41 := $trunc.i8.i1($i40);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 839, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i41} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i41 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 839, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 839, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i48 := $ne.i32($i44, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i1.i8($i48);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 839, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i51 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, x$r_buff0_thd4);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i53} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 56} true;
  assume {:verifier.code 0} true;
  $i54 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 56} true;
  assume {:verifier.code 0} true;
  $i55 := $trunc.i8.i1($i54);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i55} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i55 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i62 := $ne.i32($i58, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  $i63 := $zext.i1.i8($i62);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 841, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 842, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 843, 22} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 843, 39} true;
  assume {:verifier.code 0} true;
  $i65 := $add.i32($i64, 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i65);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i65);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 859, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 861, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 863, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 865, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p3, $0.ref, P3, $0.ref);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 866, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 867, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 867, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i8, 4);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 867, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 867, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 868, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 869, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i13);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 870, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i15 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 55} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 55} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i8.i1($i20);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i19);
  call {:cexpr "x"} boogie_si_record_i32($i19);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 872, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 872, 20} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i8.i1($i27);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 872, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i21 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 102} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 871, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i28 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 872, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 872, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i31, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 872, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i1.i8($i35);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 872, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 38} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 56} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 56} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i42 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i45, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i1.i8($i49);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 873, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 874, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i52 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 874, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 874, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i62 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 38} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 38} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 56} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 56} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i8.i1($i65);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i66} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i66 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i73 := $ne.i32($i69, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 876, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 877, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 878, 19} true;
  assume {:verifier.code 1} true;
  call $i75 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i75);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 878, 17} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i8($i75);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 878, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 879, 19} true;
  assume {:verifier.code 1} true;
  call $i77 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i77);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 879, 17} true;
  assume {:verifier.code 0} true;
  $i78 := $zext.i1.i8($i77);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 879, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 880, 21} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 880, 21} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i8.i1($i79);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 880, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $zext.i1.i8($i80);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 880, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 881, 15} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 881, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i82);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i82);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 8} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 8} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i84} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i84 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 27} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 27} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 42} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 101} true;
  assume {:verifier.code 0} true;
  $i93 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 7} true;
  assume {:verifier.code 0} true;
  $i94 := $i93;
  goto $bb62;
$bb52:
  ...
  goto $bb53;
$bb53:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 65} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 65} true;
  assume {:verifier.code 0} true;
  $i90 := $trunc.i8.i1($i89);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i90} true;
  goto $bb57, $bb59;
$bb54:
  assume !(($i86 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 46} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 46} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 61} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb58;
$bb58:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 106} true;
  assume {:verifier.code 0} true;
  $i95 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 106} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i8.i1($i95);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i96} true;
  goto $bb63, $bb64;
$bb59:
  assume !(($i90 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 84} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i94);
  call {:cexpr "x"} boogie_si_record_i32($i94);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 15} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i96 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 124} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb65;
$bb65:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 153} true;
  assume {:verifier.code 0} true;
...
$bb66:
  assume ($i98 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 882, 141} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i103 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 31} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume !(($i103 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 45} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 45} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 60} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i105);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i105);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 15} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i107 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 64} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 64} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 79} true;
  assume {:verifier.code 0} true;
...
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 138} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 44} true;
  assume {:verifier.code 0} true;
  $i117 := $i116;
  goto $bb85;
$bb75:
  ...
  goto $bb76;
$bb76:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 102} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 102} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i113} true;
  goto $bb80, $bb82;
$bb77:
  assume !(($i109 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 83} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 83} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 98} true;
  assume {:verifier.code 0} true;
...
$bb80:
  ...
  goto $bb81;
$bb81:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 151} true;
  assume {:verifier.code 0} true;
  $i118 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 151} true;
  assume {:verifier.code 0} true;
  $i119 := $trunc.i8.i1($i118);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i119} true;
  goto $bb86, $bb87;
$bb82:
  assume !(($i113 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 121} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i119 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 169} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 198} true;
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i121 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 883, 186} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i126 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 31} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume !(($i126 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 45} true;
  assume {:verifier.code 0} true;
  $i129 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 45} true;
  assume {:verifier.code 0} true;
  $i130 := $trunc.i8.i1($i129);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 60} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i128);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i128);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 20} true;
  assume {:verifier.code 0} true;
...
$bb95:
  assume ($i130 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 64} true;
  assume {:verifier.code 0} true;
  $i131 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 64} true;
  assume {:verifier.code 0} true;
  $i132 := $trunc.i8.i1($i131);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 79} true;
  assume {:verifier.code 0} true;
...
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 138} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 44} true;
  assume {:verifier.code 0} true;
  $i140 := $i139;
  goto $bb108;
$bb98:
  ...
  goto $bb99;
$bb99:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 102} true;
  assume {:verifier.code 0} true;
  $i135 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 102} true;
  assume {:verifier.code 0} true;
  $i136 := $trunc.i8.i1($i135);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i136} true;
  goto $bb103, $bb105;
$bb100:
  assume !(($i132 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 83} true;
  assume {:verifier.code 0} true;
  $i133 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 83} true;
  assume {:verifier.code 0} true;
  $i134 := $trunc.i8.i1($i133);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 98} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb104;
$bb104:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 151} true;
  assume {:verifier.code 0} true;
  $i141 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 151} true;
  assume {:verifier.code 0} true;
  $i142 := $trunc.i8.i1($i141);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i142} true;
  goto $bb109, $bb110;
$bb105:
  assume !(($i136 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 121} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i142 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 169} true;
  assume {:verifier.code 0} true;
...
$bb110:
  ...
  goto $bb111;
$bb111:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 198} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i144 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 884, 186} true;
  assume {:verifier.code 0} true;
...
$bb115:
  assume ($i149 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 36} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume !(($i149 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 55} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 55} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 70} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i153, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 20} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i155 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 74} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 74} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 89} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 54} true;
  assume {:verifier.code 0} true;
  $i167 := $i166;
  goto $bb131;
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 112} true;
  assume {:verifier.code 0} true;
  $i160 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 112} true;
  assume {:verifier.code 0} true;
  $i161 := $trunc.i8.i1($i160);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i161} true;
  goto $bb126, $bb128;
$bb123:
  assume !(($i157 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 93} true;
  assume {:verifier.code 0} true;
  $i158 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 93} true;
  assume {:verifier.code 0} true;
  $i159 := $trunc.i8.i1($i158);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 108} true;
  assume {:verifier.code 0} true;
...
$bb126:
  ...
  goto $bb127;
$bb127:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 166} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 166} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i169} true;
  goto $bb132, $bb133;
$bb128:
  assume !(($i161 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 131} true;
  assume {:verifier.code 0} true;
...
$bb132:
  assume ($i169 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 184} true;
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  goto $bb134;
$bb134:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 885, 212} true;
  assume {:verifier.code 0} true;
...
$bb138:
  assume ($i179 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 36} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i179 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 70} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  assume {:verifier.code 0} true;
  $i204 := $ne.i32($i183, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 20} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i185 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 74} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 74} true;
  assume {:verifier.code 0} true;
  $i187 := $trunc.i8.i1($i186);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 89} true;
  assume {:verifier.code 0} true;
...
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 54} true;
  assume {:verifier.code 0} true;
  $i197 := $i196;
  goto $bb154;
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 112} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 112} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb149, $bb151;
$bb146:
  assume !(($i187 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 93} true;
  assume {:verifier.code 0} true;
  $i188 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 93} true;
  assume {:verifier.code 0} true;
  $i189 := $trunc.i8.i1($i188);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 108} true;
  assume {:verifier.code 0} true;
...
$bb149:
  ...
  goto $bb150;
$bb150:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 166} true;
  assume {:verifier.code 0} true;
  $i198 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 166} true;
  assume {:verifier.code 0} true;
  $i199 := $trunc.i8.i1($i198);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 181} true;
  assume {:verifier.code 0} true;
  $i200 := 0;
...
$bb151:
  assume !(($i191 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 131} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume ($i199 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 886, 184} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume ($i207 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 36} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume !(($i207 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 55} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 55} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 70} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  assume {:verifier.code 0} true;
  $i234 := $ne.i32($i211, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 20} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume ($i213 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 74} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 74} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 89} true;
  assume {:verifier.code 0} true;
...
$bb162:
  ...
  goto $bb163;
$bb163:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 54} true;
  assume {:verifier.code 0} true;
  $i225 := $i224;
  goto $bb174;
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 112} true;
  assume {:verifier.code 0} true;
  $i218 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 112} true;
  assume {:verifier.code 0} true;
  $i219 := $trunc.i8.i1($i218);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i219} true;
  goto $bb169, $bb171;
$bb166:
  assume !(($i215 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 93} true;
  assume {:verifier.code 0} true;
  $i216 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 93} true;
  assume {:verifier.code 0} true;
  $i217 := $trunc.i8.i1($i216);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 108} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 166} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 166} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i227} true;
  goto $bb175, $bb176;
$bb171:
  assume !(($i219 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 131} true;
  assume {:verifier.code 0} true;
...
$bb175:
  assume ($i227 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 184} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  goto $bb177;
$bb177:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 887, 212} true;
  assume {:verifier.code 0} true;
...
$bb181:
  assume ($i237 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 36} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume !(($i237 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 55} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 55} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 70} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  assume {:verifier.code 0} true;
  $i262 := $ne.i32($i241, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 23} true;
  assume {:verifier.code 0} true;
  $i264 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 25} true;
  assume {:verifier.code 0} true;
  $i265 := $eq.i32($i264, 2);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 30} true;
  assume {:verifier.code 0} true;
  $i266 := 0;
...
$bb184:
  assume ($i243 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 74} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 74} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 89} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  goto $bb186;
$bb186:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 54} true;
  assume {:verifier.code 0} true;
  $i255 := $i254;
  goto $bb197;
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 112} true;
  assume {:verifier.code 0} true;
  $i248 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 112} true;
  assume {:verifier.code 0} true;
  $i249 := $trunc.i8.i1($i248);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i249} true;
  goto $bb192, $bb194;
$bb189:
  assume !(($i245 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 93} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 93} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 108} true;
  assume {:verifier.code 0} true;
...
$bb192:
  ...
  goto $bb193;
$bb193:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 166} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 166} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 181} true;
  assume {:verifier.code 0} true;
  $i258 := 0;
...
$bb194:
  assume !(($i249 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 131} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i257 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 888, 184} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i265 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 33} true;
  assume {:verifier.code 0} true;
  $i267 := $load.i32($M.0, __unbuffered_p1_EAX);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 53} true;
  assume {:verifier.code 0} true;
  $i268 := $eq.i32($i267, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 58} true;
  assume {:verifier.code 0} true;
  $i266 := 0;
...
$bb203:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/mix037_tso.oepc_tmp.c:889:21: warning: over-approximating bitwise operation xor;
  $i275 := $xor.i1($i266, 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 890, 7} true;
  assume {:verifier.code 0} true;
  $i277 := $load.i8($M.0, x$flush_delayed);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 890, 7} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume ($i268 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 61} true;
  assume {:verifier.code 0} true;
  $i269 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 81} true;
  assume {:verifier.code 0} true;
  $i270 := $eq.i32($i269, 0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 86} true;
  assume {:verifier.code 0} true;
  $i266 := 0;
...
$bb206:
  assume ($i270 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 89} true;
  assume {:verifier.code 0} true;
  $i271 := $load.i32($M.0, __unbuffered_p3_EAX);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 109} true;
  assume {:verifier.code 0} true;
  $i272 := $eq.i32($i271, 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 114} true;
  assume {:verifier.code 0} true;
  $i266 := 0;
...
$bb208:
  assume ($i272 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 117} true;
  assume {:verifier.code 0} true;
  $i273 := $load.i32($M.0, __unbuffered_p3_EBX);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 889, 137} true;
  assume {:verifier.code 0} true;
  $i274 := $eq.i32($i273, 0);
  assume {:verifier.code 0} true;
  $i266 := $i274;
...
$bb210:
  assume ($i278 == 1);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 890, 25} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i32($M.0, x$mem_tmp);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 890, 7} true;
  assume {:verifier.code 0} true;
  $i280 := $i279;
  goto $bb212;
$bb211:
  assume !(($i278 == 1));
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 890, 37} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i32($M.0, x);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 890, 7} true;
  assume {:verifier.code 0} true;
...
$bb212:
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 890, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 890, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i280);
  call {:cexpr "x"} boogie_si_record_i32($i280);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 891, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 892, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 893, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 893, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i284);
  assume {:sourceloc "output/mix037_tso.oepc_tmp.c", 894, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
