...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe031_pso.opt-O0.bpl /Users/ponce/git/Dat3M/output/safe031_pso.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 3, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 4, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 3, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 17, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 18, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 18, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 18, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 18, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 18, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 740, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 740, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 741, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 2);
  call {:cexpr "z"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 742, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 743, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 744, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 745, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 746, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 746, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i1);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 747, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 748, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 749, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 750, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 751, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 751, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 751, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i3);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i3);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 752, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 753, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i63: i32;
$bb0:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 757, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 758, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, 1);
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 759, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 761, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i8.i1($i1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i8.i1($i7);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i4 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i6);
  call {:cexpr "y"} boogie_si_record_i32($i6);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 765, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 765, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i8.i1($i14);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 765, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 102} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 764, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 765, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 765, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i18, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 765, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 765, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 20} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 38} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 38} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i8.i1($i26);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 53} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 56} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 56} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i8.i1($i28);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 71} true;
  assume {:verifier.code 0} true;
...
$bb25:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i32, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i8($i36);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 766, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 767, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 767, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i39 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 767, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 767, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i42, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i1.i8($i46);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 767, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i8.i1($i48);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i49 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 38} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i8.i1($i50);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 53} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 56} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i8.i1($i52);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 71} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume ($i53 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i60 := $ne.i32($i56, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i1.i8($i60);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 768, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 769, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 770, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 771, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 771, 39} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62, 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 771, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i63);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i63);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 772, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 773, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i86: i32;
$bb0:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 777, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 778, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 778, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i1);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 779, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, 2);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32(2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 780, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 780, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 781, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$w_buff0_used, 1);
  call {:cexpr "y$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 782, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 782, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 782, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 782, 41} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 782, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/safe031_pso.opt_tmp.c:782:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 782, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 783, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 783, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, y$r_buff0_thd1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 784, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 785, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$r_buff0_thd2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 785, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 785, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 785, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 786, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 786, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 786, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 787, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$r_buff0_thd3, 1);
  call {:cexpr "y$r_buff0_thd3"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 788, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 789, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 790, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, z, 1);
  call {:cexpr "z"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 791, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 792, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i8.i1($i30);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i27 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i29);
  call {:cexpr "y"} boogie_si_record_i32($i29);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 794, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 794, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i31 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 102} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 793, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i38 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 794, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 794, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 71} true;
  assume {:verifier.code 0} true;
...
$bb28:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 795, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 796, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i62 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 796, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 796, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i72 := $trunc.i8.i1($i71);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i72} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i72 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i8($M.0, y$r_buff0_thd3);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 38} true;
  assume {:verifier.code 0} true;
  $i74 := $trunc.i8.i1($i73);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 56} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i83 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  $i84 := $zext.i1.i8($i83);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 798, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 799, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 800, 22} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 800, 39} true;
  assume {:verifier.code 0} true;
  $i86 := $add.i32($i85, 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 800, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i86);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i86);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 818, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 820, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 821, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 822, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 822, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 822, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 822, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 823, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 824, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 824, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 825, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i17);
  call {:cexpr "y"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 827, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 827, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 827, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 826, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 827, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 827, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 827, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 827, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 828, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 829, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 829, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 829, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 829, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 829, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 829, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 829, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 830, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 831, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 832, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 833, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 833, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 833, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 834, 19} true;
  assume {:verifier.code 1} true;
  call $i75 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i75);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 834, 17} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i8($i75);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 834, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 835, 21} true;
  assume {:verifier.code 0} true;
  $i77 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 835, 21} true;
  assume {:verifier.code 0} true;
  $i78 := $trunc.i8.i1($i77);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 835, 19} true;
  assume {:verifier.code 0} true;
  $i79 := $zext.i1.i8($i78);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 835, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 836, 15} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 836, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$mem_tmp, $i80);
  call {:cexpr "y$mem_tmp"} boogie_si_record_i32($i80);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 8} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 8} true;
  assume {:verifier.code 0} true;
  $i82 := $trunc.i8.i1($i81);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i82} true;
  goto $bb49, $bb50;
$bb49:
  assume ($i82 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 27} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 27} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i8.i1($i83);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 42} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 101} true;
  assume {:verifier.code 0} true;
  $i91 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 7} true;
  assume {:verifier.code 0} true;
  $i92 := $i91;
  goto $bb62;
$bb52:
  ...
  goto $bb53;
$bb53:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 65} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 65} true;
  assume {:verifier.code 0} true;
  $i88 := $trunc.i8.i1($i87);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i88} true;
  goto $bb57, $bb59;
$bb54:
  assume !(($i84 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 46} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 46} true;
  assume {:verifier.code 0} true;
  $i86 := $trunc.i8.i1($i85);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 61} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb58;
$bb58:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 106} true;
  assume {:verifier.code 0} true;
  $i93 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 106} true;
  assume {:verifier.code 0} true;
  $i94 := $trunc.i8.i1($i93);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i94} true;
  goto $bb63, $bb64;
$bb59:
  assume !(($i88 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 84} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i92);
  call {:cexpr "y"} boogie_si_record_i32($i92);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 15} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume ($i94 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 124} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb65;
$bb65:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 153} true;
  assume {:verifier.code 0} true;
...
$bb66:
  assume ($i96 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 837, 141} true;
  assume {:verifier.code 0} true;
...
$bb69:
  assume ($i101 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 31} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume !(($i101 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 45} true;
  assume {:verifier.code 0} true;
  $i104 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 45} true;
  assume {:verifier.code 0} true;
  $i105 := $trunc.i8.i1($i104);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 60} true;
  assume {:verifier.code 0} true;
...
$bb71:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff0, $i103);
  call {:cexpr "y$w_buff0"} boogie_si_record_i32($i103);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 15} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i105 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 64} true;
  assume {:verifier.code 0} true;
  $i106 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 64} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i8.i1($i106);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 79} true;
  assume {:verifier.code 0} true;
...
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 138} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i32($M.0, y$w_buff0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 44} true;
  assume {:verifier.code 0} true;
  $i115 := $i114;
  goto $bb85;
$bb75:
  ...
  goto $bb76;
$bb76:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 102} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 102} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i111} true;
  goto $bb80, $bb82;
$bb77:
  assume !(($i107 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 83} true;
  assume {:verifier.code 0} true;
  $i108 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 83} true;
  assume {:verifier.code 0} true;
  $i109 := $trunc.i8.i1($i108);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 98} true;
  assume {:verifier.code 0} true;
...
$bb80:
  ...
  goto $bb81;
$bb81:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 151} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 151} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb86, $bb87;
$bb82:
  assume !(($i111 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 121} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i117 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 169} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 198} true;
  assume {:verifier.code 0} true;
...
$bb89:
  assume ($i119 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 838, 186} true;
  assume {:verifier.code 0} true;
...
$bb92:
  assume ($i124 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 31} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume !(($i124 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 45} true;
  assume {:verifier.code 0} true;
  $i127 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 45} true;
  assume {:verifier.code 0} true;
  $i128 := $trunc.i8.i1($i127);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 60} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y$w_buff1, $i126);
  call {:cexpr "y$w_buff1"} boogie_si_record_i32($i126);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
...
$bb95:
  assume ($i128 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 64} true;
  assume {:verifier.code 0} true;
  $i129 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 64} true;
  assume {:verifier.code 0} true;
  $i130 := $trunc.i8.i1($i129);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 79} true;
  assume {:verifier.code 0} true;
...
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 138} true;
  assume {:verifier.code 0} true;
  $i137 := $load.i32($M.0, y$w_buff1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 44} true;
  assume {:verifier.code 0} true;
  $i138 := $i137;
  goto $bb108;
$bb98:
  ...
  goto $bb99;
$bb99:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 102} true;
  assume {:verifier.code 0} true;
  $i133 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 102} true;
  assume {:verifier.code 0} true;
  $i134 := $trunc.i8.i1($i133);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i134} true;
  goto $bb103, $bb105;
$bb100:
  assume !(($i130 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 83} true;
  assume {:verifier.code 0} true;
  $i131 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 83} true;
  assume {:verifier.code 0} true;
  $i132 := $trunc.i8.i1($i131);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 98} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb104;
$bb104:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 151} true;
  assume {:verifier.code 0} true;
  $i139 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 151} true;
  assume {:verifier.code 0} true;
  $i140 := $trunc.i8.i1($i139);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i140} true;
  goto $bb109, $bb110;
$bb105:
  assume !(($i134 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 121} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i140 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 169} true;
  assume {:verifier.code 0} true;
...
$bb110:
  ...
  goto $bb111;
$bb111:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 198} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i142 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 839, 186} true;
  assume {:verifier.code 0} true;
...
$bb115:
  assume ($i147 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 36} true;
  assume {:verifier.code 0} true;
...
$bb116:
  assume !(($i147 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 55} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 55} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 70} true;
  assume {:verifier.code 0} true;
...
$bb117:
  ...
  assume {:verifier.code 0} true;
  $i174 := $ne.i32($i151, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i153 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 74} true;
  assume {:verifier.code 0} true;
  $i154 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 74} true;
  assume {:verifier.code 0} true;
  $i155 := $trunc.i8.i1($i154);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 89} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 54} true;
  assume {:verifier.code 0} true;
  $i165 := $i164;
  goto $bb131;
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 112} true;
  assume {:verifier.code 0} true;
  $i158 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 112} true;
  assume {:verifier.code 0} true;
  $i159 := $trunc.i8.i1($i158);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i159} true;
  goto $bb126, $bb128;
$bb123:
  assume !(($i155 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 93} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 93} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 108} true;
  assume {:verifier.code 0} true;
...
$bb126:
  ...
  goto $bb127;
$bb127:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 166} true;
  assume {:verifier.code 0} true;
  $i166 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 166} true;
  assume {:verifier.code 0} true;
  $i167 := $trunc.i8.i1($i166);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i167} true;
  goto $bb132, $bb133;
$bb128:
  assume !(($i159 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 131} true;
  assume {:verifier.code 0} true;
...
$bb132:
  assume ($i167 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 184} true;
  assume {:verifier.code 0} true;
...
$bb133:
  ...
  goto $bb134;
$bb134:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 840, 212} true;
  assume {:verifier.code 0} true;
...
$bb138:
  assume ($i177 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 36} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i177 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 55} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 55} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 70} true;
  assume {:verifier.code 0} true;
...
$bb140:
  ...
  assume {:verifier.code 0} true;
  $i202 := $ne.i32($i181, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i183 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 74} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 74} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 89} true;
  assume {:verifier.code 0} true;
...
$bb142:
  ...
  goto $bb143;
$bb143:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 54} true;
  assume {:verifier.code 0} true;
  $i195 := $i194;
  goto $bb154;
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 112} true;
  assume {:verifier.code 0} true;
  $i188 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 112} true;
  assume {:verifier.code 0} true;
  $i189 := $trunc.i8.i1($i188);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i189} true;
  goto $bb149, $bb151;
$bb146:
  assume !(($i185 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 93} true;
  assume {:verifier.code 0} true;
  $i186 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 93} true;
  assume {:verifier.code 0} true;
  $i187 := $trunc.i8.i1($i186);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 108} true;
  assume {:verifier.code 0} true;
...
$bb149:
  ...
  goto $bb150;
$bb150:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 166} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 166} true;
  assume {:verifier.code 0} true;
  $i197 := $trunc.i8.i1($i196);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 181} true;
  assume {:verifier.code 0} true;
  $i198 := 0;
...
$bb151:
  assume !(($i189 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 131} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume ($i197 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 841, 184} true;
  assume {:verifier.code 0} true;
...
$bb158:
  assume ($i205 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 36} true;
  assume {:verifier.code 0} true;
...
$bb159:
  assume !(($i205 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 55} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 70} true;
  assume {:verifier.code 0} true;
...
$bb160:
  ...
  assume {:verifier.code 0} true;
  $i232 := $ne.i32($i209, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume ($i211 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 74} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 74} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 89} true;
  assume {:verifier.code 0} true;
...
$bb162:
  ...
  goto $bb163;
$bb163:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 54} true;
  assume {:verifier.code 0} true;
  $i223 := $i222;
  goto $bb174;
$bb164:
  ...
  goto $bb165;
$bb165:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 112} true;
  assume {:verifier.code 0} true;
  $i216 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 112} true;
  assume {:verifier.code 0} true;
  $i217 := $trunc.i8.i1($i216);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i217} true;
  goto $bb169, $bb171;
$bb166:
  assume !(($i213 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 93} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 93} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 108} true;
  assume {:verifier.code 0} true;
...
$bb169:
  ...
  goto $bb170;
$bb170:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 166} true;
  assume {:verifier.code 0} true;
  $i224 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 166} true;
  assume {:verifier.code 0} true;
  $i225 := $trunc.i8.i1($i224);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i225} true;
  goto $bb175, $bb176;
$bb171:
  assume !(($i217 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 131} true;
  assume {:verifier.code 0} true;
...
$bb175:
  assume ($i225 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 184} true;
  assume {:verifier.code 0} true;
...
$bb176:
  ...
  goto $bb177;
$bb177:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 842, 212} true;
  assume {:verifier.code 0} true;
...
$bb181:
  assume ($i235 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 36} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume !(($i235 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 55} true;
  assume {:verifier.code 0} true;
  $i240 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 55} true;
  assume {:verifier.code 0} true;
  $i241 := $trunc.i8.i1($i240);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 70} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i239, 0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 23} true;
  assume {:verifier.code 0} true;
  $i262 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 25} true;
  assume {:verifier.code 0} true;
  $i263 := $eq.i32($i262, 2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 30} true;
  assume {:verifier.code 0} true;
  $i264 := 0;
...
$bb184:
  assume ($i241 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 74} true;
  assume {:verifier.code 0} true;
  $i242 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 74} true;
  assume {:verifier.code 0} true;
  $i243 := $trunc.i8.i1($i242);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 89} true;
  assume {:verifier.code 0} true;
...
$bb185:
  ...
  goto $bb186;
$bb186:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 54} true;
  assume {:verifier.code 0} true;
  $i253 := $i252;
  goto $bb197;
$bb187:
  ...
  goto $bb188;
$bb188:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 112} true;
  assume {:verifier.code 0} true;
  $i246 := $load.i8($M.0, y$r_buff0_thd0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 112} true;
  assume {:verifier.code 0} true;
  $i247 := $trunc.i8.i1($i246);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i247} true;
  goto $bb192, $bb194;
$bb189:
  assume !(($i243 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 93} true;
  assume {:verifier.code 0} true;
  $i244 := $load.i8($M.0, y$w_buff1_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 93} true;
  assume {:verifier.code 0} true;
  $i245 := $trunc.i8.i1($i244);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 108} true;
  assume {:verifier.code 0} true;
...
$bb192:
  ...
  goto $bb193;
$bb193:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 166} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, y$w_buff0_used);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 166} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 181} true;
  assume {:verifier.code 0} true;
  $i256 := 0;
...
$bb194:
  assume !(($i247 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 131} true;
  assume {:verifier.code 0} true;
...
$bb198:
  assume ($i255 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 843, 184} true;
  assume {:verifier.code 0} true;
...
$bb201:
  assume ($i263 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 33} true;
  assume {:verifier.code 0} true;
  $i265 := $load.i32($M.0, z);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 35} true;
  assume {:verifier.code 0} true;
  $i266 := $eq.i32($i265, 2);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 40} true;
  assume {:verifier.code 0} true;
  $i264 := 0;
...
$bb203:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe031_pso.opt_tmp.c:844:21: warning: over-approximating bitwise operation xor;
  $i269 := $xor.i1($i264, 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 845, 7} true;
  assume {:verifier.code 0} true;
...
$bb204:
  assume ($i266 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 43} true;
  assume {:verifier.code 0} true;
  $i267 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 844, 63} true;
  assume {:verifier.code 0} true;
  $i268 := $eq.i32($i267, 0);
  assume {:verifier.code 0} true;
  $i264 := $i268;
...
$bb206:
  assume ($i272 == 1);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 845, 25} true;
  assume {:verifier.code 0} true;
...
$bb207:
  assume !(($i272 == 1));
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 845, 37} true;
  assume {:verifier.code 0} true;
  $i275 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 845, 7} true;
  assume {:verifier.code 0} true;
...
$bb208:
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 845, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 845, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, $i274);
  call {:cexpr "y"} boogie_si_record_i32($i274);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 846, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, y$flush_delayed, 0);
  call {:cexpr "y$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 848, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 848, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i278);
  assume {:sourceloc "output/safe031_pso.opt_tmp.c", 849, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
