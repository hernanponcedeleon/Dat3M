...
// via /usr/local/bin/smack -q -t --no-memory-splitting --integer-encoding unbounded-integer --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fno-vectorize -fno-slp-vectorize -I/Users/ponce/git/Dat3M/include/ -bpl /Users/ponce/git/Dat3M/output/safe028_power.opt-O0.bpl /Users/ponce/git/Dat3M/output/safe028_power.opt_tmp.c
...
procedure  assume_abort_if_not($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "assume_abort_if_not:arg:cond"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 4, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 4, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 4, 14} true;
  assume {:verifier.code 0} true;
...
{
$bb0:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 18, 83} true;
  assume {:verifier.code 0} true;
...
procedure  __VERIFIER_assert($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__VERIFIER_assert:arg:expression"} boogie_si_record_i32($i0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 19, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 19, 46} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 19, 96} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 19, 59} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 19, 69} true;
  assume {:verifier.code 0} true;
  call reach_error();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 19, 83} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $i197: i32;
$bb0:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 760, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 761, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, y, 1);
  call {:cexpr "y"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 762, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 763, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 764, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 765, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 766, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 766, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 766, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 767, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 767, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 767, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 768, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 768, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 768, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 768, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 769, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 769, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i8);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i8.i1($i9);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 42} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 101} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb14;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 65} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 65} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 80} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb9, $bb11;
$bb6:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 46} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 46} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i8.i1($i13);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 61} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 106} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 106} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 121} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb15, $bb16;
$bb11:
  assume !(($i16 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 84} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i20);
  call {:cexpr "x"} boogie_si_record_i32($i20);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 15} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 124} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 153} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i24 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 770, 141} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i29 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 31} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !(($i29 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i8.i1($i32);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 60} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i31);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i31);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 15} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 64} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i8.i1($i34);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 79} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 138} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 44} true;
  assume {:verifier.code 0} true;
  $i43 := $i42;
  goto $bb37;
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 102} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 102} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i8.i1($i38);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb32, $bb34;
$bb29:
  assume !(($i35 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 83} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 83} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i8.i1($i36);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 98} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 151} true;
  assume {:verifier.code 0} true;
  $i44 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 151} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i8.i1($i44);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb38, $bb39;
$bb34:
  assume !(($i39 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 121} true;
  assume {:verifier.code 0} true;
...
$bb38:
  assume ($i45 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 169} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 198} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i47 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 771, 186} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 31} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume !(($i52 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 45} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 45} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i8.i1($i55);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 60} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i54);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i54);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 20} true;
  assume {:verifier.code 0} true;
...
$bb47:
  assume ($i56 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 64} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 64} true;
  assume {:verifier.code 0} true;
  $i58 := $trunc.i8.i1($i57);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 79} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  goto $bb49;
$bb49:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 138} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i32($M.0, x$w_buff1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 44} true;
  assume {:verifier.code 0} true;
  $i66 := $i65;
  goto $bb60;
$bb50:
  ...
  goto $bb51;
$bb51:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 102} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 102} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 117} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb55, $bb57;
$bb52:
  assume !(($i58 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 83} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 83} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 98} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 151} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 151} true;
  assume {:verifier.code 0} true;
  $i68 := $trunc.i8.i1($i67);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 166} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i68} true;
  goto $bb61, $bb62;
$bb57:
  assume !(($i62 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 121} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume ($i68 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 169} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb63;
$bb63:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 198} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 772, 186} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i75 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 36} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 55} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 55} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i8.i1($i80);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 70} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  assume {:verifier.code 0} true;
  $i102 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 20} true;
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i81 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 74} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 89} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb72;
$bb72:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i92 := $zext.i1.i32($i91);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 54} true;
  assume {:verifier.code 0} true;
  $i93 := $i92;
  goto $bb83;
$bb73:
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 112} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb78, $bb80;
$bb75:
  assume !(($i83 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 93} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 108} true;
  assume {:verifier.code 0} true;
...
$bb78:
  ...
  goto $bb79;
$bb79:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 166} true;
  assume {:verifier.code 0} true;
  $i95 := $trunc.i8.i1($i94);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i95} true;
  goto $bb84, $bb85;
$bb80:
  assume !(($i87 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 131} true;
  assume {:verifier.code 0} true;
...
$bb84:
  assume ($i95 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 184} true;
  assume {:verifier.code 0} true;
...
$bb85:
  ...
  goto $bb86;
$bb86:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 773, 212} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume ($i105 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 36} true;
  assume {:verifier.code 0} true;
...
$bb91:
  assume !(($i105 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 55} true;
  assume {:verifier.code 0} true;
  $i110 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 55} true;
  assume {:verifier.code 0} true;
  $i111 := $trunc.i8.i1($i110);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 70} true;
  assume {:verifier.code 0} true;
...
$bb92:
  ...
  assume {:verifier.code 0} true;
  $i130 := $ne.i32($i109, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 20} true;
  assume {:verifier.code 0} true;
...
$bb93:
  assume ($i111 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 74} true;
  assume {:verifier.code 0} true;
  $i112 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 74} true;
  assume {:verifier.code 0} true;
  $i113 := $trunc.i8.i1($i112);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 89} true;
  assume {:verifier.code 0} true;
...
$bb94:
  ...
  goto $bb95;
$bb95:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 54} true;
  assume {:verifier.code 0} true;
  $i123 := $i122;
  goto $bb106;
$bb96:
  ...
  goto $bb97;
$bb97:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 112} true;
  assume {:verifier.code 0} true;
  $i116 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 112} true;
  assume {:verifier.code 0} true;
  $i117 := $trunc.i8.i1($i116);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i117} true;
  goto $bb101, $bb103;
$bb98:
  assume !(($i113 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 93} true;
  assume {:verifier.code 0} true;
  $i114 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 93} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i8.i1($i114);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 108} true;
  assume {:verifier.code 0} true;
...
$bb101:
  ...
  goto $bb102;
$bb102:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
  $i124 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i8.i1($i124);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 181} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
...
$bb103:
  assume !(($i117 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 131} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume ($i125 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 184} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  goto $bb109;
$bb109:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 774, 166} true;
  assume {:verifier.code 0} true;
...
$bb110:
  assume ($i133 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 36} true;
  assume {:verifier.code 0} true;
...
$bb111:
  assume !(($i133 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 55} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 55} true;
  assume {:verifier.code 0} true;
  $i139 := $trunc.i8.i1($i138);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 70} true;
  assume {:verifier.code 0} true;
...
$bb112:
  ...
  assume {:verifier.code 0} true;
  $i160 := $ne.i32($i137, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 20} true;
  assume {:verifier.code 0} true;
...
$bb113:
  assume ($i139 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 74} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 74} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 89} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  goto $bb115;
$bb115:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 54} true;
  assume {:verifier.code 0} true;
  $i151 := $i150;
  goto $bb126;
$bb116:
  ...
  goto $bb117;
$bb117:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 112} true;
  assume {:verifier.code 0} true;
  $i144 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 112} true;
  assume {:verifier.code 0} true;
  $i145 := $trunc.i8.i1($i144);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb121, $bb123;
$bb118:
  assume !(($i141 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 93} true;
  assume {:verifier.code 0} true;
  $i142 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 93} true;
  assume {:verifier.code 0} true;
  $i143 := $trunc.i8.i1($i142);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 108} true;
  assume {:verifier.code 0} true;
...
$bb121:
  ...
  goto $bb122;
$bb122:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 166} true;
  assume {:verifier.code 0} true;
  $i152 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 166} true;
  assume {:verifier.code 0} true;
  $i153 := $trunc.i8.i1($i152);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 181} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i153} true;
  goto $bb127, $bb128;
$bb123:
  assume !(($i145 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 131} true;
  assume {:verifier.code 0} true;
...
$bb127:
  assume ($i153 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 184} true;
  assume {:verifier.code 0} true;
...
$bb128:
  ...
  goto $bb129;
$bb129:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 775, 212} true;
  assume {:verifier.code 0} true;
...
$bb133:
  assume ($i163 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 36} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume !(($i163 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 55} true;
  assume {:verifier.code 0} true;
  $i168 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 55} true;
  assume {:verifier.code 0} true;
  $i169 := $trunc.i8.i1($i168);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 70} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  assume {:verifier.code 0} true;
  $i188 := $ne.i32($i167, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 777, 25} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 777, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p0_EAX, $i190);
  call {:cexpr "__unbuffered_p0_EAX"} boogie_si_record_i32($i190);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 778, 7} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i169 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 74} true;
  assume {:verifier.code 0} true;
  $i170 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 74} true;
  assume {:verifier.code 0} true;
  $i171 := $trunc.i8.i1($i170);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 89} true;
  assume {:verifier.code 0} true;
...
$bb137:
  ...
  goto $bb138;
$bb138:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 148} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 54} true;
  assume {:verifier.code 0} true;
  $i181 := $i180;
  goto $bb149;
$bb139:
  ...
  goto $bb140;
$bb140:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 112} true;
  assume {:verifier.code 0} true;
  $i174 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 112} true;
  assume {:verifier.code 0} true;
  $i175 := $trunc.i8.i1($i174);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 127} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i175} true;
  goto $bb144, $bb146;
$bb141:
  assume !(($i171 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 93} true;
  assume {:verifier.code 0} true;
  $i172 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 93} true;
  assume {:verifier.code 0} true;
  $i173 := $trunc.i8.i1($i172);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 108} true;
  assume {:verifier.code 0} true;
...
$bb144:
  ...
  goto $bb145;
$bb145:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 166} true;
  assume {:verifier.code 0} true;
  $i182 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 166} true;
  assume {:verifier.code 0} true;
  $i183 := $trunc.i8.i1($i182);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 181} true;
  assume {:verifier.code 0} true;
  $i184 := 0;
...
$bb146:
  assume !(($i175 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 131} true;
  assume {:verifier.code 0} true;
...
$bb150:
  assume ($i183 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 776, 184} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i192 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 778, 25} true;
  assume {:verifier.code 0} true;
...
$bb154:
  assume !(($i192 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 778, 37} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 778, 7} true;
  assume {:verifier.code 0} true;
...
$bb155:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 778, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 778, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i194);
  call {:cexpr "x"} boogie_si_record_i32($i194);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 779, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 780, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 781, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 782, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 783, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 784, 22} true;
  assume {:verifier.code 0} true;
  $i196 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 784, 39} true;
  assume {:verifier.code 0} true;
  $i197 := $add.i32($i196, 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 784, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i197);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i197);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 785, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 786, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i86: i32;
$bb0:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 790, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 790, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 791, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, x$w_buff0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 791, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i1);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 792, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, 1);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32(1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 793, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i8.i1($i2);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 793, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 794, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$w_buff0_used, 1);
  call {:cexpr "x$w_buff0_used"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 795, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 795, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 795, 38} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 795, 41} true;
  assume {:verifier.code 1} true;
...
$bb3:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 795, 21} true;
  assume {:verifier.code 1} true;
  // llvm2bpl: output/safe028_power.opt_tmp.c:795:21: warning: over-approximating bitwise operation xor;
  $i10 := $xor.i1($i7, 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 795, 21} true;
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 795, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i11);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 796, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i8($i13);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 796, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$r_buff0_thd1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 797, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i8($i16);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 797, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 798, 20} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i8($i19);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 798, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 799, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 799, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 799, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i8($i22);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 799, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 800, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$r_buff0_thd2, 1);
  call {:cexpr "x$r_buff0_thd2"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 801, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 802, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i8.i1($i24);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i25 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 25} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 55} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 55} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i8.i1($i30);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i27 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 42} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i29);
  call {:cexpr "x"} boogie_si_record_i32($i29);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 804, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 804, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb16, $bb17;
$bb10:
  assume ($i31 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 73} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 102} true;
  assume {:verifier.code 0} true;
  $i36 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 55} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i33 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 803, 90} true;
  assume {:verifier.code 0} true;
...
$bb16:
  assume ($i38 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 804, 38} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 804, 66} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i41, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i8($i45);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 804, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i8.i1($i47);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i48} true;
  goto $bb22, $bb23;
$bb22:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 38} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 53} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 56} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 56} true;
  assume {:verifier.code 0} true;
  $i52 := $trunc.i8.i1($i51);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i52} true;
  goto $bb28, $bb29;
$bb25:
...
$bb28:
  assume ($i52 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 74} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 102} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  $i59 := $ne.i32($i55, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i8($i59);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 805, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 806, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 806, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb34, $bb35;
$bb34:
  assume ($i62 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 806, 38} true;
  assume {:verifier.code 0} true;
...
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 806, 66} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  assume {:verifier.code 0} true;
  $i69 := $ne.i32($i65, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 806, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i1.i8($i69);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 806, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 20} true;
  assume {:verifier.code 0} true;
  $i72 := $trunc.i8.i1($i71);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i72} true;
  goto $bb40, $bb41;
$bb40:
  assume ($i72 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i8($M.0, x$r_buff0_thd2);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 38} true;
  assume {:verifier.code 0} true;
  $i74 := $trunc.i8.i1($i73);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 53} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb42;
$bb42:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 56} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 56} true;
  assume {:verifier.code 0} true;
  $i76 := $trunc.i8.i1($i75);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 71} true;
  assume {:verifier.code 0} true;
...
$bb46:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 74} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 102} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  assume {:verifier.code 0} true;
  $i83 := $ne.i32($i79, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  $i84 := $zext.i1.i8($i83);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 807, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 808, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 809, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 810, 22} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 810, 39} true;
  assume {:verifier.code 0} true;
  $i86 := $add.i32($i85, 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 810, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i86);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i86);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 811, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 812, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i376: i32;
$bb0:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 816, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 817, 19} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 817, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i8($i1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 817, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, weak$$choice0, $i2);
  call {:cexpr "weak$$choice0"} boogie_si_record_i8($i2);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 818, 19} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 818, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i8($i3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 818, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, weak$$choice2, $i4);
  call {:cexpr "weak$$choice2"} boogie_si_record_i8($i4);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 819, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, weak$$choice2);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 819, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i8.i1($i5);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 819, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i8($i6);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 819, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, $i7);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8($i7);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 820, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 820, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$mem_tmp, $i8);
  call {:cexpr "x$mem_tmp"} boogie_si_record_i32($i8);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 821, 19} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i9);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 821, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i1.i8($i9);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 821, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 8} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i8.i1($i11);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 30} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.i8.i1($i15);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 45} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb4, $bb5;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i14);
  call {:cexpr "x"} boogie_si_record_i32($i14);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 15} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 48} true;
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 78} true;
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 78} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i8.i1($i21);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 93} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb10, $bb11;
$bb7:
  assume ($i18 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 65} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i22 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 97} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 97} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i8.i1($i23);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 112} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb13, $bb14;
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 216} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 216} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 231} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb26, $bb27;
$bb13:
...
$bb14:
  assume !(($i24 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 115} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 115} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 130} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 134} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume !(($i28 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 152} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i30 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 168} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 152} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume !(($i30 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 173} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i34 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 189} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume !(($i34 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 201} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 234} true;
  assume {:verifier.code 0} true;
  $i41 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 234} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i8.i1($i41);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 249} true;
  assume {:verifier.code 0} true;
...
$bb27:
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 331} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i42 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 252} true;
  assume {:verifier.code 0} true;
  $i43 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 252} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i8.i1($i43);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 267} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i44 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 271} true;
  assume {:verifier.code 0} true;
...
$bb34:
  assume !(($i46 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 289} true;
  assume {:verifier.code 0} true;
...
$bb35:
  assume ($i48 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 305} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i48 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 317} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i54 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 347} true;
  assume {:verifier.code 0} true;
...
$bb40:
  assume !(($i54 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 359} true;
  assume {:verifier.code 0} true;
  $i57 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 822, 331} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume ($i59 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 31} true;
  assume {:verifier.code 0} true;
...
$bb43:
  assume !(($i59 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 45} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 45} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i8.i1($i62);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 44} true;
  assume {:verifier.code 0} true;
...
$bb44:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff0, $i61);
  call {:cexpr "x$w_buff0"} boogie_si_record_i32($i61);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 15} true;
  assume {:verifier.code 0} true;
...
$bb45:
  assume ($i63 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 75} true;
  assume {:verifier.code 0} true;
  $i66 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 75} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i8.i1($i66);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i67} true;
  goto $bb48, $bb49;
$bb46:
  assume !(($i63 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 62} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume ($i67 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 93} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 123} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 123} true;
  assume {:verifier.code 0} true;
  $i73 := $trunc.i8.i1($i72);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb54, $bb55;
$bb51:
  assume ($i69 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 110} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume ($i73 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 142} true;
  assume {:verifier.code 0} true;
  $i74 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 142} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i8.i1($i74);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 157} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i75} true;
  goto $bb57, $bb58;
$bb55:
  ...
  goto $bb56;
$bb56:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 209} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 209} true;
  assume {:verifier.code 0} true;
  $i83 := $trunc.i8.i1($i82);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 224} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i83} true;
  goto $bb64, $bb65;
$bb57:
...
$bb58:
  assume !(($i75 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 160} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 160} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i8.i1($i76);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i77} true;
  goto $bb59, $bb60;
$bb59:
  assume ($i77 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 179} true;
  assume {:verifier.code 0} true;
...
$bb62:
  assume !(($i79 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 196} true;
  assume {:verifier.code 0} true;
...
$bb64:
  assume ($i83 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 227} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 227} true;
  assume {:verifier.code 0} true;
  $i85 := $trunc.i8.i1($i84);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 242} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i85} true;
  goto $bb67, $bb68;
$bb65:
  ...
  goto $bb66;
$bb66:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 293} true;
  assume {:verifier.code 0} true;
...
$bb67:
  assume ($i85 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 245} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 245} true;
  assume {:verifier.code 0} true;
  $i87 := $trunc.i8.i1($i86);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 260} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i87} true;
  goto $bb69, $bb70;
$bb68:
...
$bb69:
  assume ($i87 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 264} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume !(($i89 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 823, 281} true;
  assume {:verifier.code 0} true;
...
$bb74:
  assume ($i94 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 31} true;
  assume {:verifier.code 0} true;
...
$bb75:
  assume !(($i94 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 45} true;
  assume {:verifier.code 0} true;
  $i97 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 45} true;
  assume {:verifier.code 0} true;
  $i98 := $trunc.i8.i1($i97);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 44} true;
  assume {:verifier.code 0} true;
...
$bb76:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x$w_buff1, $i96);
  call {:cexpr "x$w_buff1"} boogie_si_record_i32($i96);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 20} true;
  assume {:verifier.code 0} true;
...
$bb77:
  assume ($i98 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 75} true;
  assume {:verifier.code 0} true;
  $i101 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 75} true;
  assume {:verifier.code 0} true;
  $i102 := $trunc.i8.i1($i101);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 90} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  goto $bb80, $bb81;
$bb78:
  assume !(($i98 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 62} true;
  assume {:verifier.code 0} true;
...
$bb80:
  assume ($i102 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 93} true;
  assume {:verifier.code 0} true;
...
$bb81:
  ...
  goto $bb82;
$bb82:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 123} true;
  assume {:verifier.code 0} true;
  $i107 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 123} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i8.i1($i107);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 138} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i108} true;
  goto $bb86, $bb87;
$bb83:
  assume ($i104 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 110} true;
  assume {:verifier.code 0} true;
...
$bb86:
  assume ($i108 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 142} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 142} true;
  assume {:verifier.code 0} true;
  $i110 := $trunc.i8.i1($i109);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 157} true;
  assume {:verifier.code 0} true;
...
$bb87:
  ...
  goto $bb88;
$bb88:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 209} true;
  assume {:verifier.code 0} true;
  $i117 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 209} true;
  assume {:verifier.code 0} true;
  $i118 := $trunc.i8.i1($i117);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 224} true;
  assume {:verifier.code 0} true;
...
$bb90:
  assume !(($i110 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 160} true;
  assume {:verifier.code 0} true;
  $i111 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 160} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i8.i1($i111);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 175} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i112} true;
  goto $bb91, $bb92;
$bb91:
  assume ($i112 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 179} true;
  assume {:verifier.code 0} true;
...
$bb94:
  assume !(($i114 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 196} true;
  assume {:verifier.code 0} true;
...
$bb96:
  assume ($i118 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 227} true;
  assume {:verifier.code 0} true;
  $i119 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 227} true;
  assume {:verifier.code 0} true;
  $i120 := $trunc.i8.i1($i119);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 242} true;
  assume {:verifier.code 0} true;
...
$bb97:
  ...
  goto $bb98;
$bb98:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 293} true;
  assume {:verifier.code 0} true;
...
$bb99:
  assume ($i120 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 245} true;
  assume {:verifier.code 0} true;
  $i121 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 245} true;
  assume {:verifier.code 0} true;
  $i122 := $trunc.i8.i1($i121);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 260} true;
  assume {:verifier.code 0} true;
...
$bb101:
  assume ($i122 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 264} true;
  assume {:verifier.code 0} true;
...
$bb104:
  assume !(($i124 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 824, 281} true;
  assume {:verifier.code 0} true;
...
$bb106:
  assume ($i129 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 36} true;
  assume {:verifier.code 0} true;
...
$bb107:
  assume !(($i129 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 55} true;
  assume {:verifier.code 0} true;
  $i134 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 55} true;
  assume {:verifier.code 0} true;
  $i135 := $trunc.i8.i1($i134);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 54} true;
  assume {:verifier.code 0} true;
...
$bb108:
  ...
  assume {:verifier.code 0} true;
  $i176 := $ne.i32($i133, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 20} true;
  assume {:verifier.code 0} true;
...
$bb109:
  assume ($i135 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 90} true;
  assume {:verifier.code 0} true;
  $i140 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 90} true;
  assume {:verifier.code 0} true;
  $i141 := $trunc.i8.i1($i140);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i141} true;
  goto $bb112, $bb113;
$bb110:
  assume !(($i135 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 72} true;
  assume {:verifier.code 0} true;
...
$bb112:
  assume ($i141 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 108} true;
  assume {:verifier.code 0} true;
...
$bb113:
  ...
  goto $bb114;
$bb114:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 137} true;
  assume {:verifier.code 0} true;
  $i145 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 137} true;
  assume {:verifier.code 0} true;
  $i146 := $trunc.i8.i1($i145);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 152} true;
  assume {:verifier.code 0} true;
...
$bb118:
  assume ($i146 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 156} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 156} true;
  assume {:verifier.code 0} true;
  $i148 := $trunc.i8.i1($i147);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 171} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb120;
$bb120:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 245} true;
  assume {:verifier.code 0} true;
  $i161 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 245} true;
  assume {:verifier.code 0} true;
  $i162 := $trunc.i8.i1($i161);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 260} true;
  assume {:verifier.code 0} true;
...
$bb122:
  assume !(($i148 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 174} true;
  assume {:verifier.code 0} true;
  $i149 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 174} true;
  assume {:verifier.code 0} true;
  $i150 := $trunc.i8.i1($i149);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i150} true;
  goto $bb123, $bb124;
$bb123:
  assume ($i150 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 193} true;
  assume {:verifier.code 0} true;
...
$bb126:
  assume !(($i152 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 210} true;
  assume {:verifier.code 0} true;
  $i153 := $load.i8($M.0, weak$$choice0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 210} true;
  assume {:verifier.code 0} true;
  $i154 := $trunc.i8.i1($i153);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 224} true;
  assume {:verifier.code 0} true;
  $i155 := 1;
...
$bb129:
  assume !(($i154 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 228} true;
  assume {:verifier.code 0} true;
  $i156 := $load.i8($M.0, weak$$choice1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 228} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i8.i1($i156);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 227} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe028_power.opt_tmp.c:825:227: warning: over-approximating bitwise operation xor;
  $i158 := $xor.i1($i157, 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 224} true;
  assume {:verifier.code 0} true;
  $i155 := $i158;
...
$bb131:
  assume ($i162 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 263} true;
  assume {:verifier.code 0} true;
  $i163 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 263} true;
  assume {:verifier.code 0} true;
  $i164 := $trunc.i8.i1($i163);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 278} true;
  assume {:verifier.code 0} true;
...
$bb132:
  ...
  goto $bb133;
$bb133:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 333} true;
  assume {:verifier.code 0} true;
...
$bb134:
  assume ($i164 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 281} true;
  assume {:verifier.code 0} true;
  $i165 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 281} true;
  assume {:verifier.code 0} true;
  $i166 := $trunc.i8.i1($i165);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 296} true;
  assume {:verifier.code 0} true;
...
$bb136:
  assume ($i166 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 300} true;
  assume {:verifier.code 0} true;
...
$bb139:
  assume !(($i168 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 825, 317} true;
  assume {:verifier.code 0} true;
...
$bb141:
  assume ($i179 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 36} true;
  assume {:verifier.code 0} true;
...
$bb142:
  assume !(($i179 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
  $i184 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 55} true;
  assume {:verifier.code 0} true;
  $i185 := $trunc.i8.i1($i184);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 54} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  assume {:verifier.code 0} true;
  $i218 := $ne.i32($i183, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 20} true;
  assume {:verifier.code 0} true;
...
$bb144:
  assume ($i185 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 90} true;
  assume {:verifier.code 0} true;
  $i190 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 90} true;
  assume {:verifier.code 0} true;
  $i191 := $trunc.i8.i1($i190);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i191} true;
  goto $bb147, $bb148;
$bb145:
  assume !(($i185 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 72} true;
  assume {:verifier.code 0} true;
...
$bb147:
  assume ($i191 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 108} true;
  assume {:verifier.code 0} true;
...
$bb148:
  ...
  goto $bb149;
$bb149:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 137} true;
  assume {:verifier.code 0} true;
  $i195 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 137} true;
  assume {:verifier.code 0} true;
  $i196 := $trunc.i8.i1($i195);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 152} true;
  assume {:verifier.code 0} true;
...
$bb153:
  assume ($i196 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 156} true;
  assume {:verifier.code 0} true;
  $i197 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 156} true;
  assume {:verifier.code 0} true;
  $i198 := $trunc.i8.i1($i197);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 171} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  goto $bb155;
$bb155:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 227} true;
  assume {:verifier.code 0} true;
  $i207 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 227} true;
  assume {:verifier.code 0} true;
  $i208 := $trunc.i8.i1($i207);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 242} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb157:
  assume !(($i198 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 174} true;
  assume {:verifier.code 0} true;
  $i199 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 174} true;
  assume {:verifier.code 0} true;
  $i200 := $trunc.i8.i1($i199);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i200} true;
  goto $bb158, $bb159;
$bb158:
  assume ($i200 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 193} true;
  assume {:verifier.code 0} true;
...
$bb161:
  assume !(($i202 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 210} true;
  assume {:verifier.code 0} true;
...
$bb163:
  assume ($i208 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 245} true;
  assume {:verifier.code 0} true;
  $i210 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 245} true;
  assume {:verifier.code 0} true;
  $i211 := $trunc.i8.i1($i210);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 260} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb166:
  assume ($i211 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 263} true;
  assume {:verifier.code 0} true;
  $i212 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 263} true;
  assume {:verifier.code 0} true;
  $i213 := $trunc.i8.i1($i212);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 278} true;
  assume {:verifier.code 0} true;
  $i209 := 0;
...
$bb168:
  assume ($i213 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 282} true;
  assume {:verifier.code 0} true;
  $i214 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 282} true;
  assume {:verifier.code 0} true;
  $i215 := $trunc.i8.i1($i214);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 826, 281} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe028_power.opt_tmp.c:826:281: warning: over-approximating bitwise operation xor;
  $i216 := $xor.i1($i215, 1);
  assume {:verifier.code 0} true;
  $i209 := $i216;
  goto $bb165;
...
$bb170:
  assume ($i221 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 36} true;
  assume {:verifier.code 0} true;
...
$bb171:
  assume !(($i221 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 55} true;
  assume {:verifier.code 0} true;
  $i226 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 55} true;
  assume {:verifier.code 0} true;
  $i227 := $trunc.i8.i1($i226);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 54} true;
  assume {:verifier.code 0} true;
...
$bb172:
  ...
  assume {:verifier.code 0} true;
  $i260 := $ne.i32($i225, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 20} true;
  assume {:verifier.code 0} true;
...
$bb173:
  assume ($i227 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 90} true;
  assume {:verifier.code 0} true;
  $i232 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 90} true;
  assume {:verifier.code 0} true;
  $i233 := $trunc.i8.i1($i232);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i233} true;
  goto $bb176, $bb177;
$bb174:
  assume !(($i227 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 72} true;
  assume {:verifier.code 0} true;
...
$bb176:
  assume ($i233 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 108} true;
  assume {:verifier.code 0} true;
...
$bb177:
  ...
  goto $bb178;
$bb178:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 137} true;
  assume {:verifier.code 0} true;
  $i237 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 137} true;
  assume {:verifier.code 0} true;
  $i238 := $trunc.i8.i1($i237);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 152} true;
  assume {:verifier.code 0} true;
...
$bb182:
  assume ($i238 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 156} true;
  assume {:verifier.code 0} true;
  $i239 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 156} true;
  assume {:verifier.code 0} true;
  $i240 := $trunc.i8.i1($i239);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 171} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  goto $bb184;
$bb184:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 228} true;
  assume {:verifier.code 0} true;
  $i249 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 228} true;
  assume {:verifier.code 0} true;
  $i250 := $trunc.i8.i1($i249);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 243} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb186:
  assume !(($i240 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 174} true;
  assume {:verifier.code 0} true;
  $i241 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 174} true;
  assume {:verifier.code 0} true;
  $i242 := $trunc.i8.i1($i241);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i242} true;
  goto $bb187, $bb188;
$bb187:
  assume ($i242 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 193} true;
  assume {:verifier.code 0} true;
...
$bb190:
  assume !(($i244 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 210} true;
  assume {:verifier.code 0} true;
...
$bb192:
  assume ($i250 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 246} true;
  assume {:verifier.code 0} true;
  $i252 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 246} true;
  assume {:verifier.code 0} true;
  $i253 := $trunc.i8.i1($i252);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 261} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb195:
  assume ($i253 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 264} true;
  assume {:verifier.code 0} true;
  $i254 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 264} true;
  assume {:verifier.code 0} true;
  $i255 := $trunc.i8.i1($i254);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 279} true;
  assume {:verifier.code 0} true;
  $i251 := 0;
...
$bb197:
  assume ($i255 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 283} true;
  assume {:verifier.code 0} true;
  $i256 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 283} true;
  assume {:verifier.code 0} true;
  $i257 := $trunc.i8.i1($i256);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 827, 282} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe028_power.opt_tmp.c:827:282: warning: over-approximating bitwise operation xor;
  $i258 := $xor.i1($i257, 1);
  assume {:verifier.code 0} true;
  $i251 := $i258;
  goto $bb194;
...
$bb199:
  assume ($i263 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 36} true;
  assume {:verifier.code 0} true;
...
$bb200:
  assume !(($i263 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 55} true;
  assume {:verifier.code 0} true;
  $i268 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 55} true;
  assume {:verifier.code 0} true;
  $i269 := $trunc.i8.i1($i268);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 54} true;
  assume {:verifier.code 0} true;
...
$bb201:
  ...
  assume {:verifier.code 0} true;
  $i305 := $ne.i32($i267, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 829, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, __unbuffered_p2_EAX$read_delayed, 1);
  call {:cexpr "__unbuffered_p2_EAX$read_delayed"} boogie_si_record_i8(1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 830, 40} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, __unbuffered_p2_EAX$read_delayed_var, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 831, 25} true;
  assume {:verifier.code 0} true;
  $i307 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 831, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i307);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i307);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 832, 7} true;
  assume {:verifier.code 0} true;
...
$bb202:
  assume ($i269 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 90} true;
  assume {:verifier.code 0} true;
  $i274 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 90} true;
  assume {:verifier.code 0} true;
  $i275 := $trunc.i8.i1($i274);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 105} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i275} true;
  goto $bb205, $bb206;
$bb203:
  assume !(($i269 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 72} true;
  assume {:verifier.code 0} true;
...
$bb205:
  assume ($i275 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 108} true;
  assume {:verifier.code 0} true;
...
$bb206:
  ...
  goto $bb207;
$bb207:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 137} true;
  assume {:verifier.code 0} true;
  $i279 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 137} true;
  assume {:verifier.code 0} true;
  $i280 := $trunc.i8.i1($i279);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 152} true;
  assume {:verifier.code 0} true;
...
$bb211:
  assume ($i280 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 156} true;
  assume {:verifier.code 0} true;
  $i281 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 156} true;
  assume {:verifier.code 0} true;
  $i282 := $trunc.i8.i1($i281);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 171} true;
  assume {:verifier.code 0} true;
...
$bb212:
  ...
  goto $bb213;
$bb213:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 257} true;
  assume {:verifier.code 0} true;
  $i294 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 257} true;
  assume {:verifier.code 0} true;
  $i295 := $trunc.i8.i1($i294);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 272} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb215:
  assume !(($i282 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 174} true;
  assume {:verifier.code 0} true;
  $i283 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 174} true;
  assume {:verifier.code 0} true;
  $i284 := $trunc.i8.i1($i283);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 189} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i284} true;
  goto $bb216, $bb217;
$bb216:
  assume ($i284 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 193} true;
  assume {:verifier.code 0} true;
...
$bb219:
  assume !(($i286 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 211} true;
  assume {:verifier.code 0} true;
...
$bb220:
  assume ($i288 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 227} true;
  assume {:verifier.code 0} true;
...
$bb224:
  assume ($i295 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 275} true;
  assume {:verifier.code 0} true;
  $i297 := $load.i8($M.0, x$r_buff1_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 275} true;
  assume {:verifier.code 0} true;
  $i298 := $trunc.i8.i1($i297);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 290} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb227:
  assume ($i298 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 293} true;
  assume {:verifier.code 0} true;
  $i299 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 293} true;
  assume {:verifier.code 0} true;
  $i300 := $trunc.i8.i1($i299);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 308} true;
  assume {:verifier.code 0} true;
  $i296 := 0;
...
$bb229:
  assume ($i300 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 312} true;
  assume {:verifier.code 0} true;
  $i301 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 312} true;
  assume {:verifier.code 0} true;
  $i302 := $trunc.i8.i1($i301);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 828, 311} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe028_power.opt_tmp.c:828:311: warning: over-approximating bitwise operation xor;
  $i303 := $xor.i1($i302, 1);
  assume {:verifier.code 0} true;
  $i296 := $i303;
  goto $bb226;
...
$bb231:
  assume ($i309 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 832, 25} true;
  assume {:verifier.code 0} true;
...
$bb232:
  assume !(($i309 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 832, 37} true;
  assume {:verifier.code 0} true;
  $i312 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 832, 7} true;
  assume {:verifier.code 0} true;
...
$bb233:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 832, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 832, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i311);
  call {:cexpr "x"} boogie_si_record_i32($i311);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 833, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, x$flush_delayed, 0);
  call {:cexpr "x$flush_delayed"} boogie_si_record_i8(0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 834, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 835, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 836, 25} true;
  assume {:verifier.code 0} true;
  $i313 := $load.i32($M.0, y);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 836, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EBX, $i313);
  call {:cexpr "__unbuffered_p2_EBX"} boogie_si_record_i32($i313);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 837, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 838, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  $i314 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  $i315 := $trunc.i8.i1($i314);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i315} true;
  goto $bb234, $bb235;
$bb234:
  assume ($i315 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 25} true;
  assume {:verifier.code 0} true;
...
$bb235:
  ...
  goto $bb236;
$bb236:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
  $i320 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
  $i321 := $trunc.i8.i1($i320);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i321} true;
  goto $bb240, $bb241;
$bb237:
  assume ($i317 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 42} true;
  assume {:verifier.code 0} true;
...
$bb239:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i319);
  call {:cexpr "x"} boogie_si_record_i32($i319);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i327 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 840, 20} true;
  assume {:verifier.code 0} true;
  $i328 := $trunc.i8.i1($i327);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 840, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i328} true;
  goto $bb246, $bb247;
$bb240:
  assume ($i321 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 73} true;
  assume {:verifier.code 0} true;
...
$bb241:
  ...
  goto $bb242;
$bb242:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 102} true;
  assume {:verifier.code 0} true;
  $i326 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 55} true;
  assume {:verifier.code 0} true;
...
$bb243:
  assume ($i323 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 839, 90} true;
  assume {:verifier.code 0} true;
...
$bb246:
  assume ($i328 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 840, 38} true;
  assume {:verifier.code 0} true;
...
$bb247:
  ...
  goto $bb248;
$bb248:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 840, 66} true;
  assume {:verifier.code 0} true;
...
$bb251:
  ...
  assume {:verifier.code 0} true;
  $i335 := $ne.i32($i331, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 840, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i337 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 20} true;
  assume {:verifier.code 0} true;
  $i338 := $trunc.i8.i1($i337);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i338} true;
  goto $bb252, $bb253;
$bb252:
  assume ($i338 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
  $i339 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 38} true;
  assume {:verifier.code 0} true;
  $i340 := $trunc.i8.i1($i339);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 53} true;
  assume {:verifier.code 0} true;
...
$bb253:
  ...
  goto $bb254;
$bb254:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 56} true;
  assume {:verifier.code 0} true;
  $i341 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 56} true;
  assume {:verifier.code 0} true;
  $i342 := $trunc.i8.i1($i341);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 71} true;
  assume {:verifier.code 0} true;
...
$bb258:
  assume ($i342 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 74} true;
  assume {:verifier.code 0} true;
...
$bb259:
  ...
  goto $bb260;
$bb260:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 102} true;
  assume {:verifier.code 0} true;
...
$bb263:
  ...
  assume {:verifier.code 0} true;
  $i349 := $ne.i32($i345, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 841, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
  $i351 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 842, 20} true;
  assume {:verifier.code 0} true;
  $i352 := $trunc.i8.i1($i351);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 842, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i352} true;
  goto $bb264, $bb265;
$bb264:
  assume ($i352 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 842, 38} true;
  assume {:verifier.code 0} true;
...
$bb265:
  ...
  goto $bb266;
$bb266:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 842, 66} true;
  assume {:verifier.code 0} true;
...
$bb269:
  ...
  assume {:verifier.code 0} true;
  $i359 := $ne.i32($i355, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 842, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i361 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 20} true;
  assume {:verifier.code 0} true;
  $i362 := $trunc.i8.i1($i361);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i362} true;
  goto $bb270, $bb271;
$bb270:
  assume ($i362 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
  $i363 := $load.i8($M.0, x$r_buff0_thd3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 38} true;
  assume {:verifier.code 0} true;
  $i364 := $trunc.i8.i1($i363);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 53} true;
  assume {:verifier.code 0} true;
...
$bb271:
  ...
  goto $bb272;
$bb272:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 56} true;
  assume {:verifier.code 0} true;
  $i365 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 56} true;
  assume {:verifier.code 0} true;
  $i366 := $trunc.i8.i1($i365);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 71} true;
  assume {:verifier.code 0} true;
...
$bb276:
  assume ($i366 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 74} true;
  assume {:verifier.code 0} true;
...
$bb277:
  ...
  goto $bb278;
$bb278:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 102} true;
  assume {:verifier.code 0} true;
...
$bb281:
  ...
  assume {:verifier.code 0} true;
  $i373 := $ne.i32($i369, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 843, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 844, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 845, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 846, 22} true;
  assume {:verifier.code 0} true;
  $i375 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 846, 39} true;
  assume {:verifier.code 0} true;
  $i376 := $add.i32($i375, 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 846, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_cnt, $i376);
  call {:cexpr "__unbuffered_cnt"} boogie_si_record_i32($i376);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 847, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 848, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 862, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 864, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, P1, $0.ref);
  assume true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 866, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p2, $0.ref, P2, $0.ref);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 867, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 868, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, __unbuffered_cnt);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 868, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 3);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 868, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i8($i7);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 868, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 869, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 870, 23} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 870, 3} true;
  assume {:verifier.code 0} true;
  call assume_abort_if_not($i11);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 871, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i8.i1($i12);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 22} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i13 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 25} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 55} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 55} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i8.i1($i18);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 70} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 42} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, x, $i17);
  call {:cexpr "x"} boogie_si_record_i32($i17);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 873, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 873, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i8.i1($i25);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 873, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb13, $bb14;
$bb7:
  assume ($i19 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 73} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 102} true;
  assume {:verifier.code 0} true;
  $i24 := $load.i32($M.0, x);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 55} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 872, 90} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i26 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 873, 38} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 873, 66} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i29, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 873, 18} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i1.i8($i33);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 873, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i8.i1($i35);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i36 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 38} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 38} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i8.i1($i37);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb22, $bb24;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 56} true;
  assume {:verifier.code 0} true;
  $i39 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 56} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i8.i1($i39);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  goto $bb25, $bb26;
$bb22:
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 74} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb27;
$bb27:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 102} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i43, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i8($i47);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 874, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 875, 20} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i8.i1($i49);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 875, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb31, $bb32;
$bb31:
  assume ($i50 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 875, 38} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 875, 66} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  assume {:verifier.code 0} true;
  $i57 := $ne.i32($i53, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i1.i8($i57);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 875, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i8($M.0, x$w_buff0_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 20} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i8.i1($i59);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 35} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb37, $bb38;
$bb37:
  assume ($i60 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i8($M.0, x$r_buff0_thd0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 38} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i8.i1($i61);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 53} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i62} true;
  goto $bb40, $bb42;
$bb38:
  ...
  goto $bb39;
$bb39:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 56} true;
  assume {:verifier.code 0} true;
  $i63 := $load.i8($M.0, x$w_buff1_used);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 56} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i8.i1($i63);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 71} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i64} true;
  goto $bb43, $bb44;
$bb40:
...
$bb43:
  assume ($i64 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 74} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb45;
$bb45:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 102} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:verifier.code 0} true;
  $i71 := $ne.i32($i67, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i1.i8($i71);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 876, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 877, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 878, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 879, 19} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i73);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 879, 17} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i8($i73);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 879, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 880, 25} true;
  assume {:verifier.code 0} true;
...
$bb49:
  assume ($i76 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 880, 61} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume !(($i76 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 880, 140} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume ($i78 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 880, 78} true;
  assume {:verifier.code 0} true;
  $p79 := $load.ref($M.0, __unbuffered_p2_EAX$read_delayed_var);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 880, 77} true;
  assume {:verifier.code 0} true;
...
$bb52:
  assume !(($i78 == 1));
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 880, 117} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 880, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 880, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, __unbuffered_p2_EAX, $i83);
  call {:cexpr "__unbuffered_p2_EAX"} boogie_si_record_i32($i83);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 23} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i32($M.0, __unbuffered_p0_EAX);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 43} true;
  assume {:verifier.code 0} true;
  $i86 := $eq.i32($i85, 0);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 48} true;
  assume {:verifier.code 0} true;
  $i87 := 0;
...
$bb55:
  assume ($i86 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 51} true;
  assume {:verifier.code 0} true;
  $i88 := $load.i32($M.0, __unbuffered_p2_EAX);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 71} true;
  assume {:verifier.code 0} true;
  $i89 := $eq.i32($i88, 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 76} true;
  assume {:verifier.code 0} true;
  $i87 := 0;
  assume {:branchcond $i89} true;
  goto $bb58, $bb59;
...
$bb57:
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: output/safe028_power.opt_tmp.c:881:21: warning: over-approximating bitwise operation xor;
  $i92 := $xor.i1($i87, 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 19} true;
  assume {:verifier.code 0} true;
  $i93 := $zext.i1.i8($i92);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 882, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 883, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:verifier.code 1} true;
  $i96 := $zext.i1.i32($i95);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 883, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assert($i96);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 884, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb58:
  assume ($i89 == 1);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 79} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i32($M.0, __unbuffered_p2_EBX);
  assume {:sourceloc "output/safe028_power.opt_tmp.c", 881, 99} true;
  assume {:verifier.code 0} true;
  $i91 := $eq.i32($i90, 0);
  assume {:verifier.code 0} true;
  $i87 := $i91;
