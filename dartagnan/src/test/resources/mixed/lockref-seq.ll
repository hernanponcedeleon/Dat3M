; ModuleID = '/home/drc/git/Dat3M/benchmarks/mixed/lockref-seq.c'
source_filename = "/home/drc/git/Dat3M/benchmarks/mixed/lockref-seq.c"
...
@.str = private unnamed_addr constant [29 x i8] c"my_lockref.count == NTHREADS\00", align 1
...
25:                                               ; preds = %34, %24
  ...
  br i1 %27, label %28, label %37, !dbg !205

28:                                               ; preds = %25
  %29 = load i32, i32* %6, align 4, !dbg !206
  %30 = sext i32 %29 to i64, !dbg !207
  %31 = getelementptr inbounds [2 x i64], [2 x i64]* %2, i64 0, i64 %30, !dbg !207
  %32 = load i64, i64* %31, align 8, !dbg !207
  %33 = call i32 @pthread_join(i64 noundef %32, i8** noundef null), !dbg !208
  br label %34, !dbg !208

34:                                               ; preds = %28
  %35 = load i32, i32* %6, align 4, !dbg !209
  %36 = add nsw i32 %35, 1, !dbg !209
  store i32 %36, i32* %6, align 4, !dbg !209
  br label %25, !dbg !210, !llvm.loop !211

37:                                               ; preds = %25
  %38 = load atomic i32, i32* getelementptr inbounds (%struct.anon, %struct.anon* bitcast (%struct.lockref* @my_lockref to %struct.anon*), i32 0, i32 1) seq_cst, align 4, !dbg !213
  %39 = icmp eq i32 %38, 2, !dbg !213
  br i1 %39, label %40, label %41, !dbg !216

40:                                               ; preds = %37
  br label %42, !dbg !216

41:                                               ; preds = %37
  call void @__assert_fail(i8* noundef getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([51 x i8], [51 x i8]* @.str.1, i64 0, i64 0), i32 noundef 37, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !213
  unreachable, !dbg !213
...
43:                                               ; preds = %54, %42
  %44 = load i32, i32* %7, align 4, !dbg !221
  %45 = icmp slt i32 %44, 2, !dbg !223
  br i1 %45, label %46, label %57, !dbg !224

46:                                               ; preds = %43
  %47 = load i32, i32* %7, align 4, !dbg !225
  %48 = sext i32 %47 to i64, !dbg !226
  %49 = getelementptr inbounds [2 x i64], [2 x i64]* %3, i64 0, i64 %48, !dbg !226
  %50 = load i32, i32* %7, align 4, !dbg !227
  %51 = sext i32 %50 to i64, !dbg !228
  %52 = inttoptr i64 %51 to i8*, !dbg !229
  %53 = call i32 @pthread_create(i64* noundef %49, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @ret, i8* noundef %52) #6, !dbg !230
  br label %54, !dbg !230

54:                                               ; preds = %46
  %55 = load i32, i32* %7, align 4, !dbg !231
  %56 = add nsw i32 %55, 1, !dbg !231
  store i32 %56, i32* %7, align 4, !dbg !231
  br label %43, !dbg !232, !llvm.loop !233

57:                                               ; preds = %43
  call void @llvm.dbg.declare(metadata i32* %8, metadata !235, metadata !DIExpression()), !dbg !237
  store i32 0, i32* %8, align 4, !dbg !237
  br label %58, !dbg !238

58:                                               ; preds = %67, %57
  %59 = load i32, i32* %8, align 4, !dbg !239
  %60 = icmp slt i32 %59, 2, !dbg !241
  br i1 %60, label %61, label %70, !dbg !242

61:                                               ; preds = %58
  %62 = load i32, i32* %8, align 4, !dbg !243
  %63 = sext i32 %62 to i64, !dbg !244
  %64 = getelementptr inbounds [2 x i64], [2 x i64]* %3, i64 0, i64 %63, !dbg !244
  %65 = load i64, i64* %64, align 8, !dbg !244
  %66 = call i32 @pthread_join(i64 noundef %65, i8** noundef null), !dbg !245
  br label %67, !dbg !245

67:                                               ; preds = %61
  %68 = load i32, i32* %8, align 4, !dbg !246
  %69 = add nsw i32 %68, 1, !dbg !246
  store i32 %69, i32* %8, align 4, !dbg !246
  br label %58, !dbg !247, !llvm.loop !248

70:                                               ; preds = %58
  %71 = load atomic i32, i32* getelementptr inbounds (%struct.anon, %struct.anon* bitcast (%struct.lockref* @my_lockref to %struct.anon*), i32 0, i32 1) seq_cst, align 4, !dbg !250
  %72 = icmp eq i32 %71, 0, !dbg !250
  br i1 %72, label %73, label %74, !dbg !253

73:                                               ; preds = %70
  br label %75, !dbg !253

74:                                               ; preds = %70
  call void @__assert_fail(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([51 x i8], [51 x i8]* @.str.1, i64 0, i64 0), i32 noundef 43, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !250
  unreachable, !dbg !250
...
!3 = !DIFile(filename: "/home/drc/git/Dat3M/benchmarks/mixed/lockref-seq.c", directory: "/home/drc/git/Dat3M", checksumkind: CSK_MD5, checksum: "a6c2766766e5a8e20ec878f3fb3cdfb8")
!4 = !{!5}
...
!26 = !{!0}
!27 = !DIFile(filename: "benchmarks/mixed/lockref-seq.c", directory: "/home/drc/git/Dat3M", checksumkind: CSK_MD5, checksum: "a6c2766766e5a8e20ec878f3fb3cdfb8")
...
!206 = !DILocation(line: 36, column: 24, scope: !203)
!207 = !DILocation(line: 36, column: 22, scope: !203)
!208 = !DILocation(line: 36, column: 9, scope: !203)
!209 = !DILocation(line: 35, column: 36, scope: !203)
!210 = !DILocation(line: 35, column: 5, scope: !203)
!211 = distinct !{!211, !205, !212, !72}
!212 = !DILocation(line: 36, column: 29, scope: !199)
!213 = !DILocation(line: 37, column: 5, scope: !214)
!214 = distinct !DILexicalBlock(scope: !215, file: !27, line: 37, column: 5)
!215 = distinct !DILexicalBlock(scope: !167, file: !27, line: 37, column: 5)
!216 = !DILocation(line: 37, column: 5, scope: !215)
!217 = !DILocalVariable(name: "i", scope: !218, file: !27, line: 39, type: !48)
!218 = distinct !DILexicalBlock(scope: !167, file: !27, line: 39, column: 5)
!219 = !DILocation(line: 39, column: 14, scope: !218)
!220 = !DILocation(line: 39, column: 10, scope: !218)
!221 = !DILocation(line: 39, column: 21, scope: !222)
!222 = distinct !DILexicalBlock(scope: !218, file: !27, line: 39, column: 5)
!223 = !DILocation(line: 39, column: 23, scope: !222)
!224 = !DILocation(line: 39, column: 5, scope: !218)
!225 = !DILocation(line: 40, column: 27, scope: !222)
!226 = !DILocation(line: 40, column: 25, scope: !222)
!227 = !DILocation(line: 40, column: 55, scope: !222)
!228 = !DILocation(line: 40, column: 47, scope: !222)
!229 = !DILocation(line: 40, column: 39, scope: !222)
!230 = !DILocation(line: 40, column: 9, scope: !222)
!231 = !DILocation(line: 39, column: 36, scope: !222)
!232 = !DILocation(line: 39, column: 5, scope: !222)
!233 = distinct !{!233, !224, !234, !72}
!234 = !DILocation(line: 40, column: 56, scope: !218)
!235 = !DILocalVariable(name: "i", scope: !236, file: !27, line: 41, type: !48)
!236 = distinct !DILexicalBlock(scope: !167, file: !27, line: 41, column: 5)
!237 = !DILocation(line: 41, column: 14, scope: !236)
!238 = !DILocation(line: 41, column: 10, scope: !236)
!239 = !DILocation(line: 41, column: 21, scope: !240)
!240 = distinct !DILexicalBlock(scope: !236, file: !27, line: 41, column: 5)
!241 = !DILocation(line: 41, column: 23, scope: !240)
!242 = !DILocation(line: 41, column: 5, scope: !236)
!243 = !DILocation(line: 42, column: 24, scope: !240)
!244 = !DILocation(line: 42, column: 22, scope: !240)
!245 = !DILocation(line: 42, column: 9, scope: !240)
!246 = !DILocation(line: 41, column: 36, scope: !240)
!247 = !DILocation(line: 41, column: 5, scope: !240)
!248 = distinct !{!248, !242, !249, !72}
!249 = !DILocation(line: 42, column: 29, scope: !236)
!250 = !DILocation(line: 43, column: 5, scope: !251)
!251 = distinct !DILexicalBlock(scope: !252, file: !27, line: 43, column: 5)
!252 = distinct !DILexicalBlock(scope: !167, file: !27, line: 43, column: 5)
!253 = !DILocation(line: 43, column: 5, scope: !252)
!254 = !DILocation(line: 45, column: 5, scope: !167)
