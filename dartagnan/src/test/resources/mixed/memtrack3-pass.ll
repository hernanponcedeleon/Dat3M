; ModuleID = 'benchmarks/mixed/memtrack3-pass.c'
source_filename = "benchmarks/mixed/memtrack3-pass.c"
...
define dso_local i32 @main() #0 !dbg !20 {
  ...
  %3 = call ptr @malloc(i64 noundef 4) #3, !dbg !24
  ...
  call void @free(ptr noundef %5), !dbg !31
  ret i32 0, !dbg !32
}
...
!3 = !DIFile(filename: "benchmarks/mixed/memtrack3-pass.c", directory: "/Users/r/git/dat3m", checksumkind: CSK_MD5, checksum: "353986418769baa70e7812e03bea4b1b")
!4 = !{!5, !7}
...
!30 = !DILocation(line: 8, column: 8, scope: !20)
!31 = !DILocation(line: 8, column: 3, scope: !20)
