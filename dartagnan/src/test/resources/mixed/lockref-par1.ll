; ModuleID = '/home/drc/git/Dat3M/benchmarks/mixed/lockref-par1.c'
source_filename = "/home/drc/git/Dat3M/benchmarks/mixed/lockref-par1.c"
...
75:                                               ; preds = %63
  %76 = load atomic i32, i32* getelementptr inbounds (%struct.anon, %struct.anon* bitcast (%struct.lockref* @my_lockref to %struct.anon*), i32 0, i32 1) seq_cst, align 4, !dbg !254
  %77 = icmp eq i32 %76, 0, !dbg !254
...
79:                                               ; preds = %75
  call void @__assert_fail(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([52 x i8], [52 x i8]* @.str.1, i64 0, i64 0), i32 noundef 45, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !254
  unreachable, !dbg !254
...
!3 = !DIFile(filename: "/home/drc/git/Dat3M/benchmarks/mixed/lockref-par1.c", directory: "/home/drc/git/Dat3M", checksumkind: CSK_MD5, checksum: "2566bff4ccf6a4bb6f05a699ea284951")
!4 = !{!5}
...
!26 = !{!0}
!27 = !DIFile(filename: "benchmarks/mixed/lockref-par1.c", directory: "/home/drc/git/Dat3M", checksumkind: CSK_MD5, checksum: "2566bff4ccf6a4bb6f05a699ea284951")
...
!254 = !DILocation(line: 45, column: 5, scope: !255)
!255 = distinct !DILexicalBlock(scope: !256, file: !27, line: 45, column: 5)
!256 = distinct !DILexicalBlock(scope: !167, file: !27, line: 45, column: 5)
!257 = !DILocation(line: 45, column: 5, scope: !256)
!258 = !DILocation(line: 47, column: 5, scope: !167)
