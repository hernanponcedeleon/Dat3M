...
define internal void @vatomicptr_write_rlx(ptr noundef %0, ptr noundef %1) #0 {
  ...
  call void asm sideeffect "str ${0:x}, $1", "r,*Q,~{memory}"(ptr %5, ptr elementtype(ptr) %7) #4, !srcloc !12
  ret void
}
...
define internal void @vatomicptr_write_rel(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %6 = load ptr, ptr %3, align 8
  %7 = getelementptr inbounds %struct.vatomicptr_s, ptr %6, i32 0, i32 0
  call void asm sideeffect "stlr ${0:x}, $1", "r,*Q,~{memory}"(ptr %5, ptr elementtype(ptr) %7) #4, !srcloc !14
  ret void
}
...
define internal ptr @vatomicptr_await_neq_acq(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %9 = call ptr asm sideeffect "1:\0Aldar ${0:x}, $2\0Acmp ${0:x}, ${1:x}\0Ab.eq 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(ptr %6, ptr elementtype(ptr) %8) #4, !srcloc !15
...
define internal ptr @vatomicptr_read_acq(ptr noundef %0) #0 {
  ...
  %6 = call ptr asm sideeffect "ldar ${0:x}, $1", "=&r,*Q,~{memory}"(ptr elementtype(ptr) %5) #4, !srcloc !16
...
define internal ptr @vatomicptr_xchg_rlx(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %8 = load ptr, ptr %3, align 8
  %9 = getelementptr inbounds %struct.vatomicptr_s, ptr %8, i32 0, i32 0
  %10 = call { ptr, i32 } asm sideeffect "prfm pstl1strm, $3\0A1:\0Aldxr ${0:x}, $3\0Astxr  ${1:w}, ${2:x}, $3\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,*Q,~{memory}"(ptr %7, ptr elementtype(ptr) %9) #4, !srcloc !19
  %11 = extractvalue { ptr, i32 } %10, 0
  %12 = extractvalue { ptr, i32 } %10, 1
  store ptr %11, ptr %5, align 8
  store i32 %12, ptr %6, align 4
...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldr ${0:w}, $1", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !21
...
!11 = !{i64 940220}
!12 = !{i64 943009}
!13 = !{i64 997319, i64 997353, i64 997368, i64 997401, i64 997444}
!14 = !{i64 942538}
!15 = !{i64 988175, i64 988191, i64 988222, i64 988255}
!16 = !{i64 938308}
!17 = !{i64 938808}
!18 = !{i64 1007657, i64 1007691, i64 1007706, i64 1007738, i64 1007772, i64 1007792, i64 1007835, i64 1007864}
!19 = !{i64 999288, i64 999322, i64 999337, i64 999369, i64 999411}
!20 = distinct !{!20, !6}
!21 = !{i64 935836}
