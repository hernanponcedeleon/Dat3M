; ModuleID = 'test/thread/mutex_waiters.c'
source_filename = "test/thread/mutex_waiters.c"
...
3:                                                ; preds = %8, %1
  ...
  %6 = call i32 @vatomic32_cmpxchg_acq(ptr noundef %5, i32 noundef 0, i32 noundef 1)
  %7 = icmp ne i32 %6, 0
  br i1 %7, label %8, label %18

8:                                                ; preds = %3
  %9 = load ptr, ptr %2, align 8
  %10 = getelementptr inbounds %struct.vmutex_t, ptr %9, i32 0, i32 1
  call void @vatomic32_inc_rlx(ptr noundef %10)
  %11 = load ptr, ptr %2, align 8
  %12 = getelementptr inbounds %struct.vmutex_t, ptr %11, i32 0, i32 0
  %13 = call i32 @vatomic32_cmpxchg_rlx(ptr noundef %12, i32 noundef 1, i32 noundef 2)
  %14 = load ptr, ptr %2, align 8
  %15 = getelementptr inbounds %struct.vmutex_t, ptr %14, i32 0, i32 0
  call void @vfutex_wait(ptr noundef %15, i32 noundef 2)
  %16 = load ptr, ptr %2, align 8
  %17 = getelementptr inbounds %struct.vmutex_t, ptr %16, i32 0, i32 1
  call void @vatomic32_dec_rel(ptr noundef %17)
...
define internal i32 @vatomic32_cmpxchg_rlx(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %11 = load ptr, ptr %4, align 8
  %12 = getelementptr inbounds %struct.vatomic32_s, ptr %11, i32 0, i32 0
  %13 = call { i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:w}, $4\0Acmp ${0:w}, ${3:w}\0Ab.ne 2f\0Astxr  ${1:w}, ${2:w}, $4\0Acbnz ${1:w}, 1b\0A2:\0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !13
  %14 = extractvalue { i32, i32 } %13, 0
  %15 = extractvalue { i32, i32 } %13, 1
  store i32 %14, ptr %7, align 4
  store i32 %15, ptr %8, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal void @vatomic32_dec_rel(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = call i32 @vatomic32_get_dec_rel(ptr noundef %3)
  ret void
}
...
define internal i32 @vatomic32_get_add_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %11 = call { i32, i32, i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:w}, $4\0Aadd ${1:w}, ${0:w}, ${3:w}\0Astxr ${2:w}, ${1:w}, $4\0Acbnz ${2:w}, 1b\0A", "=&r,=&r,=&r,=&r,*Q,3,~{memory},~{cc}"(ptr elementtype(i32) %10, i32 %8) #4, !srcloc !14
...
define internal i32 @vatomic32_await_neq_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = call i32 asm sideeffect "1:\0Aldr ${0:w}, $2\0Acmp ${0:w}, ${1:w}\0Ab.eq 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(i32 %6, ptr elementtype(i32) %8) #4, !srcloc !17
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal i32 @vatomic32_get_dec_rel(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = call i32 @vatomic32_get_sub_rel(ptr noundef %3, i32 noundef 1)
  ret i32 %4
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal i32 @vatomic32_get_sub_rel(ptr noundef %0, i32 noundef %1) #0 {
  %3 = alloca ptr, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  ...
  %9 = load ptr, ptr %3, align 8
  %10 = getelementptr inbounds %struct.vatomic32_s, ptr %9, i32 0, i32 0
  %11 = call { i32, i32, i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:w}, $4\0Asub ${1:w}, ${0:w}, ${3:w}\0Astlxr ${2:w}, ${1:w}, $4\0Acbnz ${2:w}, 1b\0A", "=&r,=&r,=&r,=&r,*Q,3,~{memory},~{cc}"(ptr elementtype(i32) %10, i32 %8) #4, !srcloc !18
  %12 = extractvalue { i32, i32, i32, i32 } %11, 0
  %13 = extractvalue { i32, i32, i32, i32 } %11, 1
  %14 = extractvalue { i32, i32, i32, i32 } %11, 2
  %15 = extractvalue { i32, i32, i32, i32 } %11, 3
...
define internal i32 @vatomic32_xchg_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %10 = call { i32, i32 } asm sideeffect "prfm pstl1strm, $3\0A1:\0Aldxr ${0:w}, $3\0Astlxr  ${1:w}, ${2:w}, $3\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,*Q,~{memory}"(i32 %7, ptr elementtype(i32) %9) #4, !srcloc !19
...
define internal i32 @vatomic32_get_add_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = load ptr, ptr %3, align 8
  %10 = getelementptr inbounds %struct.vatomic32_s, ptr %9, i32 0, i32 0
  %11 = call { i32, i32, i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:w}, $4\0Aadd ${1:w}, ${0:w}, ${3:w}\0Astlxr ${2:w}, ${1:w}, $4\0Acbnz ${2:w}, 1b\0A", "=&r,=&r,=&r,=&r,*Q,3,~{memory},~{cc}"(ptr elementtype(i32) %10, i32 %8) #4, !srcloc !20
  %12 = extractvalue { i32, i32, i32, i32 } %11, 0
  %13 = extractvalue { i32, i32, i32, i32 } %11, 1
  %14 = extractvalue { i32, i32, i32, i32 } %11, 2
  %15 = extractvalue { i32, i32, i32, i32 } %11, 3
...
!10 = distinct !{!10, !6}
!11 = distinct !{!11, !6}
!12 = !{i64 997788, i64 997822, i64 997837, i64 997870, i64 997904, i64 997924, i64 997966, i64 997995}
!13 = !{i64 999340, i64 999374, i64 999389, i64 999421, i64 999455, i64 999475, i64 999517, i64 999546}
!14 = !{i64 1029972, i64 1030006, i64 1030021, i64 1030053, i64 1030095, i64 1030136}
!15 = !{i64 932387}
!16 = !{i64 932889}
!17 = !{i64 955495, i64 955511, i64 955541, i64 955574}
!18 = !{i64 1026935, i64 1026969, i64 1026984, i64 1027016, i64 1027058, i64 1027100}
!19 = !{i64 990439, i64 990473, i64 990488, i64 990520, i64 990563}
!20 = !{i64 1026174, i64 1026208, i64 1026223, i64 1026255, i64 1026297, i64 1026339}
