...
6:                                                ; preds = %10, %1
  %7 = call i32 @seqlock_rbegin(ptr noundef @lock)
...
10:                                               ; preds = %6
  ...
  %12 = call zeroext i1 @seqlock_rend(ptr noundef @lock, i32 noundef %11)
  %13 = xor i1 %12, true
...
define internal i32 @vatomic32_cmpxchg_acq(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call { i32, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldaxr ${0:w}, $4\0Acmp ${0:w}, ${3:w}\0Ab.ne 2f\0Astxr  ${1:w}, ${2:w}, $4\0Acbnz ${1:w}, 1b\0A2:\0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !11
...
define internal i32 @vatomic32_read_acq(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldar ${0:w}, $1", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !13
  store i32 %6, ptr %3, align 4
  %7 = load i32, ptr %3, align 4
  ret i32 %7
}
...
define internal i32 @vatomic32_await_neq_acq(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = call i32 asm sideeffect "ldar ${0:w}, $2\0Acmp ${0:w}, ${1:w}\0Ab.ne 2f\0Asevl\0A.align 5\0A1:\0Awfe\0Aldaxr ${0:w}, $2\0Acmp ${0:w},  ${1:w}\0Ab.eq 1b\0A2:\0A", "=&r,r,*Q,~{memory},~{cc}"(i32 %6, ptr elementtype(i32) %8) #4, !srcloc !14
...
define internal void @vatomic_fence_acq() #0 {
  call void asm sideeffect "dmb ishld", "~{memory}"() #4, !srcloc !17
  ret void
}
...
!9 = distinct !{!9, !6}
!10 = distinct !{!10, !6}
!11 = !{i64 987479, i64 987513, i64 987528, i64 987561, i64 987595, i64 987615, i64 987657, i64 987686}
!12 = !{i64 921041}
!13 = !{i64 922078}
!14 = !{i64 938618, i64 938650, i64 938683, i64 938703, i64 938720, i64 938741, i64 938756, i64 938772, i64 938804, i64 938838, i64 938858}
!15 = !{i64 922580}
!16 = !{i64 926494}
!17 = !{i64 920883}
