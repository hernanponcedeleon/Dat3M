...
define internal void @vatomicptr_write_rlx(ptr noundef %0, ptr noundef %1) #0 {
  ...
  call void asm sideeffect "str ${0:x}, $1", "r,*Q,~{memory}"(ptr %5, ptr elementtype(ptr) %7) #4, !srcloc !11
  ret void
}
...
define internal ptr @vatomicptr_cmpxchg_acq(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %13 = call { ptr, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldaxr ${0:x}, $4\0Acmp ${0:x}, ${3:x}\0Ab.ne 2f\0Astxr  ${1:w}, ${2:x}, $4\0Acbnz ${1:w}, 1b\0A2:\0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(ptr %9, ptr %10, ptr elementtype(ptr) %12) #4, !srcloc !12
...
define internal ptr @vatomicptr_xchg(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %10 = call { ptr, i32 } asm sideeffect "prfm pstl1strm, $3\0A1:\0Aldaxr ${0:x}, $3\0Astlxr  ${1:w}, ${2:x}, $3\0Acbnz ${1:w}, 1b\0A", "=&r,=&r,r,*Q,~{memory}"(ptr %7, ptr elementtype(ptr) %9) #4, !srcloc !13
...
define internal ptr @vatomicptr_await_eq_acq(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %9 = call ptr asm sideeffect "1:\0Aldar ${0:x}, $2\0Acmp ${0:x}, ${1:x}\0Ab.ne 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(ptr %6, ptr elementtype(ptr) %8) #4, !srcloc !14
...
define internal ptr @vatomicptr_read_rlx(ptr noundef %0) #0 {
  ...
  %6 = call ptr asm sideeffect "ldr ${0:x}, $1", "=&r,*Q,~{memory}"(ptr elementtype(ptr) %5) #4, !srcloc !15
...
define internal ptr @vatomicptr_cmpxchg_rel(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %11 = load ptr, ptr %4, align 8
  %12 = getelementptr inbounds %struct.vatomicptr_s, ptr %11, i32 0, i32 0
  %13 = call { ptr, i32 } asm sideeffect "prfm pstl1strm, $4\0A1:\0Aldxr ${0:x}, $4\0Acmp ${0:x}, ${3:x}\0Ab.ne 2f\0Astlxr  ${1:w}, ${2:x}, $4\0Acbnz ${1:w}, 1b\0A2:\0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(ptr %9, ptr %10, ptr elementtype(ptr) %12) #4, !srcloc !16
  %14 = extractvalue { ptr, i32 } %13, 0
  %15 = extractvalue { ptr, i32 } %13, 1
  store ptr %14, ptr %7, align 8
  store i32 %15, ptr %8, align 4
...
define internal void @vatomicptr_write_rel(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %6 = load ptr, ptr %3, align 8
  %7 = getelementptr inbounds %struct.vatomicptr_s, ptr %6, i32 0, i32 0
  call void asm sideeffect "stlr ${0:x}, $1", "r,*Q,~{memory}"(ptr %5, ptr elementtype(ptr) %7) #4, !srcloc !17
  ret void
}
...
define internal ptr @vatomicptr_await_eq_rlx(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %7 = load ptr, ptr %3, align 8
  %8 = getelementptr inbounds %struct.vatomicptr_s, ptr %7, i32 0, i32 0
  %9 = call ptr asm sideeffect "1:\0Aldr ${0:x}, $2\0Acmp ${0:x}, ${1:x}\0Ab.ne 1b\0A", "=&r,r,*Q,~{memory},~{cc}"(ptr %6, ptr elementtype(ptr) %8) #4, !srcloc !18
  store ptr %9, ptr %5, align 8
  %10 = load ptr, ptr %5, align 8
  ret ptr %10
}
...
!10 = distinct !{!10, !6}
!11 = !{i64 940262}
!12 = !{i64 1004144, i64 1004178, i64 1004193, i64 1004226, i64 1004260, i64 1004280, i64 1004322, i64 1004351}
!13 = !{i64 994572, i64 994606, i64 994621, i64 994654, i64 994697}
!14 = !{i64 984287, i64 984303, i64 984334, i64 984367}
!15 = !{i64 936061}
!16 = !{i64 1004910, i64 1004944, i64 1004959, i64 1004991, i64 1005025, i64 1005045, i64 1005088, i64 1005117}
!17 = !{i64 939791}
!18 = !{i64 986566, i64 986582, i64 986612, i64 986645}
