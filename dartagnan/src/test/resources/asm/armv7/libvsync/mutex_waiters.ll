...
define internal i32 @vatomic32_cmpxchg_rlx(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %11 = load ptr, ptr %4, align 8
  %12 = getelementptr inbounds %struct.vatomic32_s, ptr %11, i32 0, i32 0
  %13 = call { i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Acmp $0, $3\0Abne 2f\0Astrex $1, $2, $4\0Acmp $1, #0 \0Abne 1b\0A2:\0A \0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !14
  %14 = extractvalue { i32, i32 } %13, 0
  %15 = extractvalue { i32, i32 } %13, 1
  store i32 %14, ptr %7, align 4
  store i32 %15, ptr %8, align 4
...
define internal i32 @vatomic32_get_add_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %11 = call { i32, i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Aadd $1, $0, $3\0Astrex $2, $1, $4\0Acmp $2, #0\0Abne 1b\0A \0A", "=&r,=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %8, ptr elementtype(i32) %10) #4, !srcloc !15
...
define internal i32 @vatomic32_read_acq(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldr $0, $1 \0Admb ish\0A", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !16
  store i32 %6, ptr %3, align 4
...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %4 = load ptr, ptr %2, align 8
  %5 = getelementptr inbounds %struct.vatomic32_s, ptr %4, i32 0, i32 0
  %6 = call i32 asm sideeffect "ldr $0, $1 \0A\0A", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !17
  store i32 %6, ptr %3, align 4
  %7 = load i32, ptr %3, align 4
  ret i32 %7
}
...
define internal i32 @vatomic32_get_sub_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = load ptr, ptr %3, align 8
  %10 = getelementptr inbounds %struct.vatomic32_s, ptr %9, i32 0, i32 0
  %11 = call { i32, i32, i32 } asm sideeffect "dmb ish \0A1:\0Aldrex $0, $4\0Asub $1, $0, $3\0Astrex $2, $1, $4\0Acmp $2, #0\0Abne 1b\0A \0A", "=&r,=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %8, ptr elementtype(i32) %10) #4, !srcloc !19
  %12 = extractvalue { i32, i32, i32 } %11, 0
  %13 = extractvalue { i32, i32, i32 } %11, 1
  %14 = extractvalue { i32, i32, i32 } %11, 2
  store i32 %12, ptr %5, align 4
...
define internal i32 @vatomic32_xchg_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %10 = call { i32, i32 } asm sideeffect "dmb ish \0A1:\0Aldrex $0, $3\0Astrex $1, $2, $3\0Acmp $1, #0 \0Abne 1b\0A \0A", "=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %7, ptr elementtype(i32) %9) #4, !srcloc !20
...
define internal i32 @vatomic32_get_add_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = load ptr, ptr %3, align 8
  %10 = getelementptr inbounds %struct.vatomic32_s, ptr %9, i32 0, i32 0
  %11 = call { i32, i32, i32 } asm sideeffect "dmb ish \0A1:\0Aldrex $0, $4\0Aadd $1, $0, $3\0Astrex $2, $1, $4\0Acmp $2, #0\0Abne 1b\0A \0A", "=&r,=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %8, ptr elementtype(i32) %10) #4, !srcloc !21
  %12 = extractvalue { i32, i32, i32 } %11, 0
  %13 = extractvalue { i32, i32, i32 } %11, 1
  %14 = extractvalue { i32, i32, i32 } %11, 2
  store i32 %12, ptr %5, align 4
...
!11 = distinct !{!11, !7}
!12 = distinct !{!12, !7}
!13 = !{i64 950719, i64 950734, i64 950749, i64 950781, i64 950814, i64 950833, i64 950873, i64 950901, i64 950920, i64 950935}
!14 = !{i64 952297, i64 952312, i64 952327, i64 952359, i64 952392, i64 952411, i64 952451, i64 952479, i64 952498, i64 952513}
!15 = !{i64 973395, i64 973410, i64 973425, i64 973457, i64 973496, i64 973536, i64 973563, i64 973582}
!16 = !{i64 932931, i64 932960}
!17 = !{i64 933424, i64 933453}
!18 = distinct !{!18, !7}
!19 = !{i64 970328, i64 970350, i64 970365, i64 970397, i64 970436, i64 970476, i64 970503, i64 970522}
!20 = !{i64 943069, i64 943091, i64 943106, i64 943138, i64 943178, i64 943206, i64 943225}
!21 = !{i64 969555, i64 969577, i64 969592, i64 969624, i64 969663, i64 969703, i64 969730, i64 969749}
