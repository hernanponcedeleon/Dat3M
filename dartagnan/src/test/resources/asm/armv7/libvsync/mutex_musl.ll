...
define internal i32 @vatomic32_cmpxchg_acq(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call { i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Acmp $0, $3\0Abne 2f\0Astrex $1, $2, $4\0Acmp $1, #0 \0Abne 1b\0A2:\0Admb ish \0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !13
...
define internal i32 @vatomic32_cmpxchg_rlx(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %11 = load ptr, ptr %4, align 8
  %12 = getelementptr inbounds %struct.vatomic32_s, ptr %11, i32 0, i32 0
  %13 = call { i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Acmp $0, $3\0Abne 2f\0Astrex $1, $2, $4\0Acmp $1, #0 \0Abne 1b\0A2:\0A \0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !15
  %14 = extractvalue { i32, i32 } %13, 0
  %15 = extractvalue { i32, i32 } %13, 1
  store i32 %14, ptr %7, align 4
  store i32 %15, ptr %8, align 4
...
define internal i32 @vatomic32_get_add_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %11 = call { i32, i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Aadd $1, $0, $3\0Astrex $2, $1, $4\0Acmp $2, #0\0Abne 1b\0A \0A", "=&r,=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %8, ptr elementtype(i32) %10) #4, !srcloc !16
...
define internal i32 @vatomic32_read_acq(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldr $0, $1 \0Admb ish\0A", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !17
  store i32 %6, ptr %3, align 4
...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %4 = load ptr, ptr %2, align 8
  %5 = getelementptr inbounds %struct.vatomic32_s, ptr %4, i32 0, i32 0
  %6 = call i32 asm sideeffect "ldr $0, $1 \0A\0A", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !18
  store i32 %6, ptr %3, align 4
  %7 = load i32, ptr %3, align 4
  ret i32 %7
}
...
define internal i32 @vatomic32_get_sub_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = load ptr, ptr %3, align 8
  %10 = getelementptr inbounds %struct.vatomic32_s, ptr %9, i32 0, i32 0
  %11 = call { i32, i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Asub $1, $0, $3\0Astrex $2, $1, $4\0Acmp $2, #0\0Abne 1b\0A \0A", "=&r,=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %8, ptr elementtype(i32) %10) #4, !srcloc !20
  %12 = extractvalue { i32, i32, i32 } %11, 0
  %13 = extractvalue { i32, i32, i32 } %11, 1
  %14 = extractvalue { i32, i32, i32 } %11, 2
  store i32 %12, ptr %5, align 4
...
define internal i32 @vatomic32_xchg_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %10 = call { i32, i32 } asm sideeffect "dmb ish \0A1:\0Aldrex $0, $3\0Astrex $1, $2, $3\0Acmp $1, #0 \0Abne 1b\0A \0A", "=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %7, ptr elementtype(i32) %9) #4, !srcloc !21
...
define internal i32 @vatomic32_get_add_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %9 = load ptr, ptr %3, align 8
  %10 = getelementptr inbounds %struct.vatomic32_s, ptr %9, i32 0, i32 0
  %11 = call { i32, i32, i32 } asm sideeffect "dmb ish \0A1:\0Aldrex $0, $4\0Aadd $1, $0, $3\0Astrex $2, $1, $4\0Acmp $2, #0\0Abne 1b\0A \0A", "=&r,=&r,=&r,r,*Q,~{memory},~{cc}"(i32 %8, ptr elementtype(i32) %10) #4, !srcloc !22
  %12 = extractvalue { i32, i32, i32 } %11, 0
  %13 = extractvalue { i32, i32, i32 } %11, 1
  %14 = extractvalue { i32, i32, i32 } %11, 2
  store i32 %12, ptr %5, align 4
...
!11 = distinct !{!11, !7}
!12 = distinct !{!12, !7}
!13 = !{i64 950716, i64 950731, i64 950746, i64 950778, i64 950811, i64 950830, i64 950870, i64 950898, i64 950917, i64 950932}
!14 = !{i64 2148477618}
!15 = !{i64 952294, i64 952309, i64 952324, i64 952356, i64 952389, i64 952408, i64 952448, i64 952476, i64 952495, i64 952510}
!16 = !{i64 973392, i64 973407, i64 973422, i64 973454, i64 973493, i64 973533, i64 973560, i64 973579}
!17 = !{i64 932928, i64 932957}
!18 = !{i64 933421, i64 933450}
!19 = distinct !{!19, !7}
!20 = !{i64 974158, i64 974173, i64 974188, i64 974220, i64 974259, i64 974299, i64 974326, i64 974345}
!21 = !{i64 943066, i64 943088, i64 943103, i64 943135, i64 943175, i64 943203, i64 943222}
!22 = !{i64 969552, i64 969574, i64 969589, i64 969621, i64 969660, i64 969700, i64 969727, i64 969746}
