...
@lock = global %struct.rec_seqlock_s zeroinitializer, align 4
...
8:                                                ; preds = %12, %7
  ...
  %9 = call i32 @rec_seqlock_rbegin(ptr noundef @lock)
...
12:                                               ; preds = %8
  ...
  %14 = call zeroext i1 @rec_seqlock_rend(ptr noundef @lock, i32 noundef %13)
  %15 = xor i1 %14, true
  %16 = zext i1 %15 to i8
...
define internal void @vatomic32_write_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect " \0Astr $0, $1\0A \0A", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !14
  ret void
}
...
define internal i32 @vatomic32_cmpxchg_acq(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call { i32, i32 } asm sideeffect " \0A1:\0Aldrex $0, $4\0Acmp $0, $3\0Abne 2f\0Astrex $1, $2, $4\0Acmp $1, #0 \0Abne 1b\0A2:\0Admb ish \0A", "=&r,=&r,r,r,*Q,~{memory},~{cc}"(i32 %9, i32 %10, ptr elementtype(i32) %12) #4, !srcloc !16
...
define internal void @vatomic_fence_acq() #0 {
  call void asm sideeffect "dmb ish", "~{memory}"() #4, !srcloc !21
  ret void
}
...
define internal void @vatomic32_write(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %6 = load ptr, ptr %3, align 8
  %7 = getelementptr inbounds %struct.vatomic32_s, ptr %6, i32 0, i32 0
  call void asm sideeffect "dmb ish \0Astr $0, $1\0Admb ish \0A", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !22
  ret void
}
...
!11 = distinct !{!11, !7}
!12 = distinct !{!12, !7}
!13 = !{i64 933618, i64 933647}
!14 = !{i64 937947, i64 937962, i64 937989}
!15 = distinct !{!15, !7}
!16 = !{i64 950913, i64 950928, i64 950943, i64 950975, i64 951008, i64 951027, i64 951067, i64 951095, i64 951114, i64 951129}
!17 = !{i64 931567}
!18 = !{i64 933125, i64 933154}
!19 = distinct !{!19, !7}
!20 = !{i64 937472, i64 937494, i64 937521}
!21 = !{i64 931905}
!22 = !{i64 936990, i64 937012, i64 937039}
