...
define internal i32 @vatomic32_read_rlx(ptr noundef %0) #0 {
  ...
  %6 = call i32 asm sideeffect "ldr $0, $1 \0A\0A", "=&r,*Q,~{memory}"(ptr elementtype(i32) %5) #4, !srcloc !15
...
define internal void @vatomic32_write_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  call void asm sideeffect "dmb ish \0Astr $0, $1\0A \0A", "r,*Q,~{memory}"(i32 %5, ptr elementtype(i32) %7) #4, !srcloc !16
  ret void
}
...
!10 = distinct !{!10, !7}
!11 = distinct !{!11, !7}
!12 = !{i64 948786, i64 948801, i64 948816, i64 948848, i64 948881, i64 948900, i64 948940, i64 948968, i64 948987, i64 949002}
!13 = distinct !{!13, !7}
!14 = distinct !{!14, !7}
!15 = !{i64 931491, i64 931520}
!16 = !{i64 935345, i64 935367, i64 935394}
