...
define dso_local i32 @main() #0 !dbg !29 {
  ...
  %6 = call noalias i8* @malloc(i64 noundef 8) #4, !dbg !41
  %7 = bitcast i8* %6 to i32*, !dbg !41
  store i32* %7, i32** %3, align 8, !dbg !42
  %8 = load i64, i64* %2, align 8, !dbg !43
  %9 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !44
  %10 = load i32*, i32** %3, align 8, !dbg !45
  %11 = bitcast i32* %10 to i8*, !dbg !45
  call void @free(i8* noundef %11) #4, !dbg !46
  ret i32 0, !dbg !47
}
...
!1 = !DIFile(filename: "benchmarks/alloc/test1_err_race.c", directory: "", checksumkind: CSK_MD5, checksum: "5b343c7c5b5f3d29b761dd3f4bb442b1")
!2 = !{!3, !6}
...
!41 = !DILocation(line: 20, column: 11, scope: !29)
!42 = !DILocation(line: 20, column: 9, scope: !29)
