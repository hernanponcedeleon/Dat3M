...
define dso_local i32 @main() #0 !dbg !31 {
  ...
  %6 = call noalias i8* @malloc(i64 noundef 8) #4, !dbg !43
  %7 = bitcast i8* %6 to i32*, !dbg !43
  store i32* %7, i32** %3, align 8, !dbg !44
  %8 = load i64, i64* %2, align 8, !dbg !45
  %9 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !46
  %10 = load i32*, i32** %3, align 8, !dbg !47
  %11 = bitcast i32* %10 to i8*, !dbg !47
  call void @free(i8* noundef %11) #4, !dbg !48
  ret i32 0, !dbg !49
}
...
!1 = !DIFile(filename: "benchmarks/alloc/test1_err_use_before_alloc.c", directory: "", checksumkind: CSK_MD5, checksum: "38394d88843694d48c1b381d56bd1b78")
!2 = !{!3, !6}
...
!43 = !DILocation(line: 21, column: 11, scope: !31)
!44 = !DILocation(line: 21, column: 9, scope: !31)
!45 = !DILocation(line: 22, column: 18, scope: !31)
!46 = !DILocation(line: 22, column: 5, scope: !31)
!47 = !DILocation(line: 24, column: 10, scope: !31)
!48 = !DILocation(line: 24, column: 5, scope: !31)
!49 = !DILocation(line: 26, column: 2, scope: !31)
