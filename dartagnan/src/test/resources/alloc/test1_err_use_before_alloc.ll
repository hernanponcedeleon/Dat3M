; ModuleID = 'benchmarks/alloc/test1_err_use_before_alloc.c'
source_filename = "benchmarks/alloc/test1_err_use_before_alloc.c"
...
define dso_local i32 @main() #0 !dbg !29 {
  ...
  %7 = call noalias i8* @malloc(i64 noundef 8) #4, !dbg !42
  %8 = bitcast i8* %7 to i32*, !dbg !42
  store i32* %8, i32** %3, align 8, !dbg !43
  %9 = load i64, i64* %2, align 8, !dbg !44
  %10 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !45
  %11 = load i32*, i32** %3, align 8, !dbg !46
  %12 = bitcast i32* %11 to i8*, !dbg !46
  call void @free(i8* noundef %12) #4, !dbg !47
  ret i32 0, !dbg !48
}
...
!1 = !DIFile(filename: "benchmarks/alloc/test1_err_use_before_alloc.c", directory: "/home/ubuntu/Desktop/code/temp2/Dat3M", checksumkind: CSK_MD5, checksum: "5c311e095b3edb7094e54502edfcdbc7")
!2 = !{!3, !5}
...
!43 = !DILocation(line: 21, column: 9, scope: !29)
!44 = !DILocation(line: 22, column: 18, scope: !29)
!45 = !DILocation(line: 22, column: 5, scope: !29)
!46 = !DILocation(line: 24, column: 10, scope: !29)
!47 = !DILocation(line: 24, column: 5, scope: !29)
!48 = !DILocation(line: 26, column: 2, scope: !29)
