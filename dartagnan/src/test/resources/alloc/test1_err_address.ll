; ModuleID = 'benchmarks/alloc/test1_err_address.c'
source_filename = "benchmarks/alloc/test1_err_address.c"
...
define dso_local i32 @main() #0 !dbg !29 {
  ...
  %12 = getelementptr inbounds i32, i32* %11, i64 4, !dbg !46
  %13 = bitcast i32* %12 to i8*, !dbg !45
  call void @free(i8* noundef %13) #4, !dbg !47
  ret i32 0, !dbg !48
}
...
!1 = !DIFile(filename: "benchmarks/alloc/test1_err_address.c", directory: "/home/ubuntu/Desktop/code/temp2/Dat3M", checksumkind: CSK_MD5, checksum: "8114dea52686034471751189f8970f2e")
!2 = !{!3, !5}
...
!46 = !DILocation(line: 23, column: 14, scope: !29)
!47 = !DILocation(line: 23, column: 5, scope: !29)
!48 = !DILocation(line: 25, column: 2, scope: !29)
