...
define dso_local i8* @thread_1(i8* noundef %0) #0 !dbg !14 {
  ...
  %10 = load i32*, i32** %3, align 8, !dbg !28
  %11 = bitcast i32* %10 to i8*, !dbg !28
  call void @free(i8* noundef %11) #4, !dbg !29
  ret i8* null, !dbg !30
}
...
define dso_local i32 @main() #0 !dbg !31 {
  ...
  %6 = load i32*, i32** %3, align 8, !dbg !42
  %7 = bitcast i32* %6 to i8*, !dbg !43
  %8 = call i32 @pthread_create(i64* noundef %2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @thread_1, i8* noundef %7) #4, !dbg !44
  %9 = load i64, i64* %2, align 8, !dbg !45
  %10 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !46
  %11 = load i32*, i32** %3, align 8, !dbg !47
  %12 = bitcast i32* %11 to i8*, !dbg !47
  call void @free(i8* noundef %12) #4, !dbg !48
  ret i32 0, !dbg !49
}
...
!1 = !DIFile(filename: "benchmarks/alloc/test1_err_double_free_2.c", directory: "/home/ubuntu/Desktop/code/temp2/Dat3M", checksumkind: CSK_MD5, checksum: "1db5a6a9c67fb4a0d9e5f2e82df61fa8")
!2 = !{!3, !5}
...
!28 = !DILocation(line: 12, column: 10, scope: !14)
!29 = !DILocation(line: 12, column: 5, scope: !14)
!30 = !DILocation(line: 14, column: 2, scope: !14)
!31 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 17, type: !32, scopeLine: 18, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !17)
!32 = !DISubroutineType(types: !33)
!33 = !{!4}
!34 = !DILocalVariable(name: "t1", scope: !31, file: !1, line: 19, type: !35)
...
!38 = !DILocation(line: 19, column: 15, scope: !31)
!39 = !DILocalVariable(name: "arr", scope: !31, file: !1, line: 20, type: !3)
!40 = !DILocation(line: 20, column: 10, scope: !31)
!41 = !DILocation(line: 20, column: 16, scope: !31)
!42 = !DILocation(line: 22, column: 48, scope: !31)
!43 = !DILocation(line: 22, column: 41, scope: !31)
!44 = !DILocation(line: 22, column: 5, scope: !31)
!45 = !DILocation(line: 23, column: 18, scope: !31)
!46 = !DILocation(line: 23, column: 5, scope: !31)
!47 = !DILocation(line: 25, column: 10, scope: !31)
!48 = !DILocation(line: 25, column: 5, scope: !31)
!49 = !DILocation(line: 27, column: 2, scope: !31)
