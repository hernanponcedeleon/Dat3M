...
define dso_local i32 @main() #0 !dbg !31 {
  ...
  %11 = getelementptr inbounds i32, i32* %10, i64 4, !dbg !47
...
!1 = !DIFile(filename: "benchmarks/alloc/test1_err_address.c", directory: "", checksumkind: CSK_MD5, checksum: "10f0e4c5d76d57d15b440887b3a1fd9f")
!2 = !{!3, !6}
...
!47 = !DILocation(line: 23, column: 14, scope: !31)
!48 = !DILocation(line: 23, column: 5, scope: !31)
!49 = !DILocation(line: 25, column: 2, scope: !31)
