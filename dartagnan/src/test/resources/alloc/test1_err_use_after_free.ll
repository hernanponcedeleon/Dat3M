; ModuleID = 'benchmarks/alloc/test1_err_use_after_free.c'
source_filename = "benchmarks/alloc/test1_err_use_after_free.c"
...
define dso_local i32 @main() #0 !dbg !29 {
  ...
  %9 = load i32*, i32** %3, align 8, !dbg !43
  %10 = bitcast i32* %9 to i8*, !dbg !43
  call void @free(i8* noundef %10) #4, !dbg !44
  %11 = load i64, i64* %2, align 8, !dbg !45
  %12 = call i32 @pthread_join(i64 noundef %11, i8** noundef null), !dbg !46
  ret i32 0, !dbg !47
}
...
!1 = !DIFile(filename: "benchmarks/alloc/test1_err_use_after_free.c", directory: "/home/ubuntu/Desktop/code/temp2/Dat3M", checksumkind: CSK_MD5, checksum: "8d642581889818962a50078c6ebe4f0e")
!2 = !{!3, !5}
...
!43 = !DILocation(line: 21, column: 10, scope: !29)
!44 = !DILocation(line: 21, column: 5, scope: !29)
!45 = !DILocation(line: 22, column: 18, scope: !29)
!46 = !DILocation(line: 22, column: 5, scope: !29)
!47 = !DILocation(line: 24, column: 2, scope: !29)
