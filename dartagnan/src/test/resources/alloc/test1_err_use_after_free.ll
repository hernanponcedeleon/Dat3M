...
define dso_local i32 @main() #0 !dbg !31 {
  ...
  %8 = load i32*, i32** %3, align 8, !dbg !44
  %9 = bitcast i32* %8 to i8*, !dbg !44
  call void @free(i8* noundef %9) #4, !dbg !45
  %10 = load i64, i64* %2, align 8, !dbg !46
  %11 = call i32 @pthread_join(i64 noundef %10, i8** noundef null), !dbg !47
  ret i32 0, !dbg !48
}
...
!1 = !DIFile(filename: "benchmarks/alloc/test1_err_use_after_free.c", directory: "", checksumkind: CSK_MD5, checksum: "b7f8e5ba08709850a328a9a7557694f9")
!2 = !{!3, !6}
...
!44 = !DILocation(line: 21, column: 10, scope: !31)
!45 = !DILocation(line: 21, column: 5, scope: !31)
!46 = !DILocation(line: 22, column: 18, scope: !31)
!47 = !DILocation(line: 22, column: 5, scope: !31)
!48 = !DILocation(line: 24, column: 2, scope: !31)
