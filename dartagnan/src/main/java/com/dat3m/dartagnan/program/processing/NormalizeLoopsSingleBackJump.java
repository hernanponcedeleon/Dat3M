...
/*
    ...
    it transforms it to
        ...
        ...
*/
public class NormalizeLoopsSingleBackJump implements FunctionProcessor {

    public static NormalizeLoopsSingleBackJump newInstance() {
        return new NormalizeLoopsSingleBackJump();
    }
