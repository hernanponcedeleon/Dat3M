...
public class VirtualMemoryObject extends MemoryObject {
    ...
    VirtualMemoryObject(int index, Type datatype, int size, boolean isStaticallyAllocated, boolean generic, VirtualMemoryObject alias) {
        super(index, datatype, size, isStaticallyAllocated);
