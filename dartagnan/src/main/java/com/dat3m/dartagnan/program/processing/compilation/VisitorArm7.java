...
class VisitorArm7 extends VisitorBase {
    ...
    public List<Event> visitAtomicLoad(AtomicLoad e) {
        return eventSequence(
                ...
                isAtomicAcquire(e.getMo()) ? AArch64.newDmbIshBarrier() : null
        );
    }
    ...
    public List<Event> visitAtomicStore(AtomicStore e) {
        return eventSequence(
                isAtomicRelease(e.getMo()) ? AArch64.newDmbIshBarrier() : null,
    ...
    public List<Event> visitAtomicFetchOp(AtomicFetchOp e) {
        ...
        return eventSequence(
                load,
                isAtomicAcquire(e.getMo()) || isAtomicRelease(e.getMo()) ? AArch64.newDmbIshBarrier() : null,
