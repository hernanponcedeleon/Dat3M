...
public class RMWFetchOp extends RMWAbstract implements RegWriter, RegReaderData {
    ...
    public String toString() {
        return resultRegister + " := atomic_fetch_" + op.toLinuxName() + Tag.toText(mo) + "(" + value + ", " + address + ")";
    }
    ...
    public List<Event> compile(Arch target) {
        ...
        RMWStore store = newRMWStore(load, address, new IExprBin(dummy, op, value), Tag.storeMO(mo));
