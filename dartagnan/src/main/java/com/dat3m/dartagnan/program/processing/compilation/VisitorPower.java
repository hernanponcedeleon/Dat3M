...
public class VisitorPower extends VisitorBase {
    ...
    public List<Event> visitLlvmFence(LlvmFence e) {
        GenericVisibleEvent fence = e.getMo().equals(Tag.C11.MO_SC) ? Power.newSyncBarrier() : Power.newLwSyncBarrier();
    ...
    public List<Event> visitAtomicThreadFence(AtomicThreadFence e) {
        String mo = e.getMo();
        GenericVisibleEvent fence = mo.equals(Tag.C11.MO_SC) ? Power.newSyncBarrier() : Power.newLwSyncBarrier();
    ...
    public List<Event> visitLKMMLoad(LKMMLoad e) {
        ...
        // Power does not have mo tags, thus we use the empty string
        Load load = newLoad(resultRegister, address);
        GenericVisibleEvent optionalMemoryBarrier = mo.equals(Tag.Linux.MO_ACQUIRE) ? Power.newLwSyncBarrier() : null;
    ...
    public List<Event> visitLKMMStore(LKMMStore e) {
        ...
        Store store = newStore(address, value);
        GenericVisibleEvent optionalMemoryBarrier = mo.equals(Tag.Linux.MO_RELEASE) ? Power.newLwSyncBarrier() : null;
    ...
    public List<Event> visitLKMMCmpXchg(LKMMCmpXchg e) {
        ...
        GenericVisibleEvent optionalMemoryBarrierBefore = mo.equals(Tag.Linux.MO_MB) ? Power.newSyncBarrier()
                : mo.equals(Tag.Linux.MO_RELEASE) ? Power.newLwSyncBarrier() : null;
        GenericVisibleEvent optionalMemoryBarrierAfter = mo.equals(Tag.Linux.MO_MB) ? Power.newSyncBarrier()
