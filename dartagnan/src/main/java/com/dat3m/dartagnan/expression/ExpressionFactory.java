...
public final class ExpressionFactory {
    ...
    private final BoolLiteral falseConstant;
    private final BoolLiteral trueConstant;

    private ExpressionFactory(TypeFactory typeFactory) {
        types = checkNotNull(typeFactory);
        booleanType = types.getBooleanType();
        falseConstant = new BoolLiteral(booleanType, false);
        trueConstant = new BoolLiteral(booleanType, true);
    }
