...
public enum IOpUn {
    ...
    public int getSrcPrecision() {
        switch(this) {
            case ZEXT18: case ZEXT116: case ZEXT132: case ZEXT164:
            case SEXT18: case SEXT116: case SEXT132: case SEXT164:
                return 1;
            case TRUNC81:
            case ZEXT816: case ZEXT832: case ZEXT864:
            case SEXT816: case SEXT832: case SEXT864:
                return 8;
            case TRUNC168: case TRUNC161:
            case ZEXT1632: case ZEXT1664:
            case SEXT1632: case SEXT1664:
                return 16;
            case TRUNC3216: case TRUNC328: case TRUNC321:
            case ZEXT3264:
            case SEXT3264:
                return 32;  
            case TRUNC6432: case TRUNC6416: case TRUNC648: case TRUNC641:
                return 64;
            default:
                throw new UnsupportedOperationException("getSrcPrecision of IOpUn operation " + this + " not supported.");
        }
    }

    public int getTgtPrecision() {
        switch(this) {
            case TRUNC641: case TRUNC321: case TRUNC161: case TRUNC81:
                return 1;
            case TRUNC648: case TRUNC328: case TRUNC168:
            case ZEXT18: 
            case SEXT18:
                return 8;
            case TRUNC6416: case TRUNC3216:
            case ZEXT116: case ZEXT816: 
            case SEXT116: case SEXT816: 
                return 16;
            case TRUNC6432:
            case ZEXT132: case ZEXT832: case ZEXT1632: 
            case SEXT132: case SEXT832: case SEXT1632: 
                return 32;
            case ZEXT164: case ZEXT864: case ZEXT1664: case ZEXT3264: 
            case SEXT164: case SEXT864: case SEXT1664: case SEXT3264: 
                return 64;
            default:
                throw new UnsupportedOperationException("getSrcPrecision of IOpUn operation " + this + " not supported.");
        }
