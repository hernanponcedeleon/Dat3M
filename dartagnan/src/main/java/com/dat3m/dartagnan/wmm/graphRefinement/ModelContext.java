...
public class ModelContext {
    ...
    // General data
    public VerificationContext getVerificationContext() { return verificationContext; }
    public Wmm getMemoryModel() {
        return verificationContext.getMemoryModel();
    }
    public Program getProgram() {
        return verificationContext.getProgram();
    }
    ...
    public void initialize(Model model, Context ctx) {
        initialize(model, ctx, FilterBasic.get(EType.VISIBLE));
    }

    public void initialize(Model model, Context ctx, FilterAbstract eventFilter) {
