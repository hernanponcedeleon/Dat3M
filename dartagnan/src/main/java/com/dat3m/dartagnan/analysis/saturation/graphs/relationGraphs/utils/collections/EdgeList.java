package com.dat3m.dartagnan.analysis.saturation.graphs.relationGraphs.utils.collections;

import com.dat3m.dartagnan.analysis.saturation.graphs.relationGraphs.Edge;
import com.dat3m.dartagnan.analysis.saturation.graphs.relationGraphs.utils.iteration.IteratorPool;
import com.dat3m.dartagnan.analysis.saturation.graphs.relationGraphs.utils.iteration.ReusableIterator;
...
//TODO: Implement own internal structure (maybe use Vect?)
public class EdgeList implements List<Edge> {
    ...
    //private final Vect<Edge> edgeList;
    ...
    public EdgeList(int initialCapacity) {
        ...
        //edgeList = new Vect<>(initialCapacity);
    }
    ...
    public boolean add(Edge edge) {
        /*edgeList.ensureCapacity(1, size());
        edgeList.appendUnsafe(edge);
        return true;*/
    ...
    public boolean addAll(Collection<? extends Edge> c) {
        //edgeList.ensureCapacity(c.size(), 5);
