...
import com.dat3m.dartagnan.solver.onlineCaat.caat.misc.EdgeList;
...
public final class SimpleGraph extends AbstractBaseGraph {
    ...
    public void backtrackTo(int time) {
        ...
        final int bound = Math.min(getNumEvents(), outgoing.size());
        ...
        final int bound2 = Math.min(getNumEvents(), ingoing.size());
        ...
        private void findNext() {
            ...
            if (++innerIndex >= innerList.size()) {
                ...
                while (++index < outgoing.size()) {
                    DataItem item = outgoing.get(index);
