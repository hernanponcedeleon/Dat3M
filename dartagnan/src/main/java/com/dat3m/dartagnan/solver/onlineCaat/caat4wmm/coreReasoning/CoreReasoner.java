...
import com.dat3m.dartagnan.solver.onlineCaat.caat.reasoning.EdgeLiteral;
import com.dat3m.dartagnan.solver.onlineCaat.caat.reasoning.ElementLiteral;
...
import com.dat3m.dartagnan.solver.onlineCaat.caat4wmm.ExecutionGraph;
...
public class CoreReasoner {
    ...
    public Set<Conjunction<CoreLiteral>> toCoreReasons(Conjunction<CAATLiteral> baseReason) {
        final Domain<Event> domain = (Domain<Event>)executionGraph.getDomain();
