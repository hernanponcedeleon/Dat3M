...
public class VisitorLitmusPPC extends LitmusPPCBaseVisitor<Object> {
    ...
    public Object visitCmpw(CmpwContext ctx) {
        Register r1 = (Register) ctx.register(0).accept(this);
        Register r2 = (Register) ctx.register(1).accept(this);
        Expression cr1 = expressions.makeIntegerCast(r1, types.getIntegerType(32), true);
        Expression cr2 = expressions.makeIntegerCast(r2, types.getIntegerType(32), true);
        lastCmpInstructionPerThread.put(mainThread, new CmpInstruction(cr1, cr2));
        return null;
    }
    ...
    public Object visitCmplwi(CmplwiContext ctx) {
        ...
        IntLiteral constant = expressions.parseValue(ctx.constant().getText(), archType);
        Expression cr1 = expressions.makeIntegerCast(r1, types.getIntegerType(32), false);
        Expression cconst = expressions.makeIntegerCast(constant, types.getIntegerType(32), false);
        lastCmpInstructionPerThread.put(mainThread, new CmpInstruction(cr1, cconst));
        return null;
    }
