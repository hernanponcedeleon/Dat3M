...
public class ProgramBuilder {
    ...
    public void initVirLocEqCon(String leftName, Expression iValue){
        MemoryObject object = locations.computeIfAbsent(
                leftName, k->program.getMemory().allocateVirtual(types.getByteType(), 1, true, true, null));
    ...
    public void initVirLocEqLoc(String leftName, String rightName){
        ...
        MemoryObject object = locations.computeIfAbsent(leftName,
                k->program.getMemory().allocateVirtual(types.getByteType(), 1, true, true, null));
        object.setCVar(leftName);
    ...
    public void initVirLocEqLocAliasGen(String leftName, String rightName){
        ...
        MemoryObject object = locations.computeIfAbsent(leftName,
                k->program.getMemory().allocateVirtual(types.getByteType(), 1, true, true, rightLocation));
        object.setCVar(leftName);
        object.setInitialValue(0,rightLocation.getInitialValue(0));
    }
    ...
    public void initVirLocEqLocAliasProxy(String leftName, String rightName){
        ...
        MemoryObject object = locations.computeIfAbsent(
                leftName, k->program.getMemory().allocateVirtual(types.getByteType(), 1, true, false, rightLocation));
        object.setCVar(leftName);
        object.setInitialValue(0,rightLocation.getInitialValue(0));
    }
