...
java -jar import/antlr-4.7-complete.jar LitmusX86.g4 -visitor -o target/generated-sources/antlr4/dartagnan/

java -jar import/antlr-4.7-complete.jar C11.g4 -visitor -o target/generated-sources/antlr4/porthosc/languages/parsers/

java -jar import/antlr-4.7-complete.jar Cat.g4 -visitor -o target/generated-sources/antlr4/porthosc/languages/parsers/
